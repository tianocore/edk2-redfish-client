...
//
#include <RedfishJsonStructure/RouteEntry/v1_0_1/EfiRouteEntryV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#RouteEntry";
BOOLEAN IsRevisonController = TRUE;

// Support RouteEntry V1_0_1
...
{
  EFI_REDFISH_ROUTEENTRY_V1_0_1 *RouteEntryV1_0_1;
  EFI_REDFISH_ROUTEENTRY_V1_0_1_CS *RouteEntryV1_0_1Cs;
  ...
  Status = (EFI_STATUS)Json_RouteEntry_V1_0_1_To_CS (ResoruceRaw, &RouteEntryV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  RouteEntryV1_0_1 = (EFI_REDFISH_ROUTEENTRY_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ROUTEENTRY_V1_0_1));
  if (RouteEntryV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)RouteEntryV1_0_1;
  RouteEntryV1_0_1->RouteEntry = RouteEntryV1_0_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_RouteEntry_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_RouteEntry_V1_0_1_JSON (*((EFI_REDFISH_ROUTEENTRY_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_RouteEntry_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  RouteEntryV1_0_1 = (EFI_REDFISH_ROUTEENTRY_V1_0_1 *)InterpProp;
  DestroyRouteEntry_V1_0_1_CS (RouteEntryV1_0_1->RouteEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyRouteEntry_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishRouteEntry_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishRouteEntry_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
