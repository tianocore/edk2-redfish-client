...
//
#include <RedfishJsonStructure/OutletGroup/v1_0_0/EfiOutletGroupV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#OutletGroup";
BOOLEAN IsRevisonController = TRUE;

// Support OutletGroup V1_0_0
...
{
  EFI_REDFISH_OUTLETGROUP_V1_0_0 *OutletGroupV1_0_0;
  EFI_REDFISH_OUTLETGROUP_V1_0_0_CS *OutletGroupV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "OutletGroup") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_OutletGroup_V1_0_0_To_CS (ResoruceRaw, &OutletGroupV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  OutletGroupV1_0_0 = (EFI_REDFISH_OUTLETGROUP_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_OUTLETGROUP_V1_0_0));
  if (OutletGroupV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)OutletGroupV1_0_0;
  OutletGroupV1_0_0->OutletGroup = OutletGroupV1_0_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("OutletGroup"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("OutletGroup"), "OutletGroup");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("OutletGroup"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("OutletGroup"), "OutletGroup");
...
/**
  The wrapper function of OutletGroupToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_OutletGroup_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_OutletGroup_V1_0_0_JSON (*((EFI_REDFISH_OUTLETGROUP_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_OutletGroup_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in OutletGroupToStruct.
...
)
{
  ...
  OutletGroupV1_0_0 = (EFI_REDFISH_OUTLETGROUP_V1_0_0 *)InterpProp;
  DestroyOutletGroup_V1_0_0_CS (OutletGroupV1_0_0->OutletGroup); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from OutletGroupFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyOutletGroup_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishOutletGroup_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishOutletGroup_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
