...
//
#include <RedfishJsonStructure/OutletGroup/v1_0_2/EfiOutletGroupV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#OutletGroup";
BOOLEAN IsRevisonController = TRUE;

// Support OutletGroup V1_0_2
...
{
  EFI_REDFISH_OUTLETGROUP_V1_0_2 *OutletGroupV1_0_2;
  EFI_REDFISH_OUTLETGROUP_V1_0_2_CS *OutletGroupV1_0_2Cs;
  ...
  Status = (EFI_STATUS)Json_OutletGroup_V1_0_2_To_CS (ResoruceRaw, &OutletGroupV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  OutletGroupV1_0_2 = (EFI_REDFISH_OUTLETGROUP_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_OUTLETGROUP_V1_0_2));
  if (OutletGroupV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)OutletGroupV1_0_2;
  OutletGroupV1_0_2->OutletGroup = OutletGroupV1_0_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_OutletGroup_V1_0_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_OutletGroup_V1_0_2_JSON (*((EFI_REDFISH_OUTLETGROUP_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_OutletGroup_V1_0_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  OutletGroupV1_0_2 = (EFI_REDFISH_OUTLETGROUP_V1_0_2 *)InterpProp;
  DestroyOutletGroup_V1_0_2_CS (OutletGroupV1_0_2->OutletGroup); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyOutletGroup_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishOutletGroup_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishOutletGroup_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
