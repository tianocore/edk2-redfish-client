...
//
#include <RedfishJsonStructure/OutletGroup/v1_0_1/EfiOutletGroupV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#OutletGroup";
BOOLEAN IsRevisonController = TRUE;

// Support OutletGroup V1_0_1
...
{
  EFI_REDFISH_OUTLETGROUP_V1_0_1 *OutletGroupV1_0_1;
  EFI_REDFISH_OUTLETGROUP_V1_0_1_CS *OutletGroupV1_0_1Cs;
  ...
  Status = (EFI_STATUS)Json_OutletGroup_V1_0_1_To_CS (ResoruceRaw, &OutletGroupV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  OutletGroupV1_0_1 = (EFI_REDFISH_OUTLETGROUP_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_OUTLETGROUP_V1_0_1));
  if (OutletGroupV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)OutletGroupV1_0_1;
  OutletGroupV1_0_1->OutletGroup = OutletGroupV1_0_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_OutletGroup_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_OutletGroup_V1_0_1_JSON (*((EFI_REDFISH_OUTLETGROUP_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_OutletGroup_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  OutletGroupV1_0_1 = (EFI_REDFISH_OUTLETGROUP_V1_0_1 *)InterpProp;
  DestroyOutletGroup_V1_0_1_CS (OutletGroupV1_0_1->OutletGroup); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyOutletGroup_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishOutletGroup_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishOutletGroup_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
