...
//
#include <RedfishJsonStructure/OutletGroup/v1_1_0/EfiOutletGroupV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#OutletGroup";
BOOLEAN IsRevisonController = TRUE;

// Support OutletGroup V1_1_0
...
{
  EFI_REDFISH_OUTLETGROUP_V1_1_0 *OutletGroupV1_1_0;
  EFI_REDFISH_OUTLETGROUP_V1_1_0_CS *OutletGroupV1_1_0Cs;
  ...
  Status = (EFI_STATUS)Json_OutletGroup_V1_1_0_To_CS (ResoruceRaw, &OutletGroupV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  OutletGroupV1_1_0 = (EFI_REDFISH_OUTLETGROUP_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_OUTLETGROUP_V1_1_0));
  if (OutletGroupV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)OutletGroupV1_1_0;
  OutletGroupV1_1_0->OutletGroup = OutletGroupV1_1_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_OutletGroup_V1_1_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_OutletGroup_V1_1_0_JSON (*((EFI_REDFISH_OUTLETGROUP_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_OutletGroup_V1_1_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  OutletGroupV1_1_0 = (EFI_REDFISH_OUTLETGROUP_V1_1_0 *)InterpProp;
  DestroyOutletGroup_V1_1_0_CS (OutletGroupV1_1_0->OutletGroup); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyOutletGroup_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishOutletGroup_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishOutletGroup_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
