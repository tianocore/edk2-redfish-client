...
)
{
  ...
  return (EFI_STATUS)CS_To_EndpointGroupCollection_JSON (*((EFI_REDFISH_ENDPOINTGROUPCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
