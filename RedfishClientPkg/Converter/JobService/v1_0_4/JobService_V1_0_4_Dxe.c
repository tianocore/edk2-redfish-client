...
//
#include <RedfishJsonStructure/JobService/v1_0_4/EfiJobServiceV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#JobService";
BOOLEAN IsRevisonController = TRUE;

// Support JobService V1_0_4
...
{
  EFI_REDFISH_JOBSERVICE_V1_0_4 *JobServiceV1_0_4;
  EFI_REDFISH_JOBSERVICE_V1_0_4_CS *JobServiceV1_0_4Cs;
  ...
  Status = (EFI_STATUS)Json_JobService_V1_0_4_To_CS (ResoruceRaw, &JobServiceV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JobServiceV1_0_4 = (EFI_REDFISH_JOBSERVICE_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JOBSERVICE_V1_0_4));
  if (JobServiceV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)JobServiceV1_0_4;
  JobServiceV1_0_4->JobService = JobServiceV1_0_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_JobService_V1_0_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_JobService_V1_0_4_JSON (*((EFI_REDFISH_JOBSERVICE_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_JobService_V1_0_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  JobServiceV1_0_4 = (EFI_REDFISH_JOBSERVICE_V1_0_4 *)InterpProp;
  DestroyJobService_V1_0_4_CS (JobServiceV1_0_4->JobService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyJobService_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishJobService_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishJobService_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
