...
//
#include <RedfishJsonStructure/JobService/v1_0_3/EfiJobServiceV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#JobService";
BOOLEAN IsRevisonController = TRUE;

// Support JobService V1_0_3
...
{
  EFI_REDFISH_JOBSERVICE_V1_0_3 *JobServiceV1_0_3;
  EFI_REDFISH_JOBSERVICE_V1_0_3_CS *JobServiceV1_0_3Cs;
  ...
  Status = (EFI_STATUS)Json_JobService_V1_0_3_To_CS (ResoruceRaw, &JobServiceV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JobServiceV1_0_3 = (EFI_REDFISH_JOBSERVICE_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JOBSERVICE_V1_0_3));
  if (JobServiceV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)JobServiceV1_0_3;
  JobServiceV1_0_3->JobService = JobServiceV1_0_3Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("JobService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("JobService"), "JobService");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("JobService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("JobService"), "JobService");
...
/**
  The wrapper function of JobServiceToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_JobService_V1_0_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_JobService_V1_0_3_JSON (*((EFI_REDFISH_JOBSERVICE_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_JobService_V1_0_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  JobServiceV1_0_3 = (EFI_REDFISH_JOBSERVICE_V1_0_3 *)InterpProp;
  DestroyJobService_V1_0_3_CS (JobServiceV1_0_3->JobService); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from JobServiceFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyJobService_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishJobService_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishJobService_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
