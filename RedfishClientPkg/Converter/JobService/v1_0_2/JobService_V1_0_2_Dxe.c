...
//
#include <RedfishJsonStructure/JobService/v1_0_2/EfiJobServiceV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#JobService";
BOOLEAN IsRevisonController = TRUE;

// Support JobService V1_0_2
...
{
  EFI_REDFISH_JOBSERVICE_V1_0_2 *JobServiceV1_0_2;
  EFI_REDFISH_JOBSERVICE_V1_0_2_CS *JobServiceV1_0_2Cs;
  ...
  Status = (EFI_STATUS)Json_JobService_V1_0_2_To_CS (ResoruceRaw, &JobServiceV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JobServiceV1_0_2 = (EFI_REDFISH_JOBSERVICE_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JOBSERVICE_V1_0_2));
  if (JobServiceV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)JobServiceV1_0_2;
  JobServiceV1_0_2->JobService = JobServiceV1_0_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_JobService_V1_0_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_JobService_V1_0_2_JSON (*((EFI_REDFISH_JOBSERVICE_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_JobService_V1_0_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  JobServiceV1_0_2 = (EFI_REDFISH_JOBSERVICE_V1_0_2 *)InterpProp;
  DestroyJobService_V1_0_2_CS (JobServiceV1_0_2->JobService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyJobService_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishJobService_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishJobService_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
