...
//
#include <RedfishJsonStructure/JobService/v1_0_1/EfiJobServiceV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#JobService";
BOOLEAN IsRevisonController = TRUE;

// Support JobService V1_0_1
...
{
  EFI_REDFISH_JOBSERVICE_V1_0_1 *JobServiceV1_0_1;
  EFI_REDFISH_JOBSERVICE_V1_0_1_CS *JobServiceV1_0_1Cs;
  ...
  Status = (EFI_STATUS)Json_JobService_V1_0_1_To_CS (ResoruceRaw, &JobServiceV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JobServiceV1_0_1 = (EFI_REDFISH_JOBSERVICE_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JOBSERVICE_V1_0_1));
  if (JobServiceV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)JobServiceV1_0_1;
  JobServiceV1_0_1->JobService = JobServiceV1_0_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_JobService_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_JobService_V1_0_1_JSON (*((EFI_REDFISH_JOBSERVICE_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_JobService_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  JobServiceV1_0_1 = (EFI_REDFISH_JOBSERVICE_V1_0_1 *)InterpProp;
  DestroyJobService_V1_0_1_CS (JobServiceV1_0_1->JobService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyJobService_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishJobService_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishJobService_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
