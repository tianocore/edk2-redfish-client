...
//
#include <RedfishJsonStructure/Chassis/v1_12_3/EfiChassisV1_12_3.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_12_3
...
{
  EFI_REDFISH_CHASSIS_V1_12_3 *ChassisV1_12_3;
  EFI_REDFISH_CHASSIS_V1_12_3_CS *ChassisV1_12_3Cs;
  ...
  Status = (EFI_STATUS)Json_Chassis_V1_12_3_To_CS (ResoruceRaw, &ChassisV1_12_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_12_3 = (EFI_REDFISH_CHASSIS_V1_12_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_12_3));
  if (ChassisV1_12_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ChassisV1_12_3;
  ChassisV1_12_3->Chassis = ChassisV1_12_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Chassis_V1_12_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Chassis_V1_12_3_JSON (*((EFI_REDFISH_CHASSIS_V1_12_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Chassis_V1_12_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ChassisV1_12_3 = (EFI_REDFISH_CHASSIS_V1_12_3 *)InterpProp;
  DestroyChassis_V1_12_3_CS (ChassisV1_12_3->Chassis); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyChassis_V1_12_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_12_3EntryPoint (
