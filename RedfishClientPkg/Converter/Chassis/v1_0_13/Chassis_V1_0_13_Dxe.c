...
//
#include <RedfishJsonStructure/Chassis/v1_0_13/EfiChassisV1_0_13.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_0_13
...
{
  EFI_REDFISH_CHASSIS_V1_0_13 *ChassisV1_0_13;
  EFI_REDFISH_CHASSIS_V1_0_13_CS *ChassisV1_0_13Cs;
  ...
  Status = (EFI_STATUS)Json_Chassis_V1_0_13_To_CS (ResoruceRaw, &ChassisV1_0_13Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_0_13 = (EFI_REDFISH_CHASSIS_V1_0_13 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_0_13));
  if (ChassisV1_0_13 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ChassisV1_0_13;
  ChassisV1_0_13->Chassis = ChassisV1_0_13Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Chassis_V1_0_13_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Chassis_V1_0_13_JSON (*((EFI_REDFISH_CHASSIS_V1_0_13_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Chassis_V1_0_13_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ChassisV1_0_13 = (EFI_REDFISH_CHASSIS_V1_0_13 *)InterpProp;
  DestroyChassis_V1_0_13_CS (ChassisV1_0_13->Chassis); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyChassis_V1_0_13_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_0_13EntryPoint (
