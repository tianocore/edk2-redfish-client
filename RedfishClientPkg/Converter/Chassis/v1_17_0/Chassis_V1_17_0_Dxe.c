...
//
#include <RedfishJsonStructure/Chassis/v1_17_0/EfiChassisV1_17_0.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_17_0
...
{
  EFI_REDFISH_CHASSIS_V1_17_0 *ChassisV1_17_0;
  EFI_REDFISH_CHASSIS_V1_17_0_CS *ChassisV1_17_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.MinorVersion, "17") != 0) ||
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ErrataVersion, "0") != 0) ||
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Chassis") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_Chassis_V1_17_0_To_CS (ResoruceRaw, &ChassisV1_17_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_17_0 = (EFI_REDFISH_CHASSIS_V1_17_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_17_0));
  if (ChassisV1_17_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ChassisV1_17_0;
  ChassisV1_17_0->Chassis = ChassisV1_17_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "17";
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Chassis_V1_17_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Chassis_V1_17_0_JSON (*((EFI_REDFISH_CHASSIS_V1_17_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Chassis_V1_17_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ChassisV1_17_0 = (EFI_REDFISH_CHASSIS_V1_17_0 *)InterpProp;
  DestroyChassis_V1_17_0_CS (ChassisV1_17_0->Chassis); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyChassis_V1_17_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_17_0EntryPoint (
