...
//
#include <RedfishJsonStructure/Chassis/v1_11_4/EfiChassisV1_11_4.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_11_4
...
{
  EFI_REDFISH_CHASSIS_V1_11_4 *ChassisV1_11_4;
  EFI_REDFISH_CHASSIS_V1_11_4_CS *ChassisV1_11_4Cs;
  ...
  Status = (EFI_STATUS)Json_Chassis_V1_11_4_To_CS (ResoruceRaw, &ChassisV1_11_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_11_4 = (EFI_REDFISH_CHASSIS_V1_11_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_11_4));
  if (ChassisV1_11_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ChassisV1_11_4;
  ChassisV1_11_4->Chassis = ChassisV1_11_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Chassis_V1_11_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Chassis_V1_11_4_JSON (*((EFI_REDFISH_CHASSIS_V1_11_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Chassis_V1_11_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ChassisV1_11_4 = (EFI_REDFISH_CHASSIS_V1_11_4 *)InterpProp;
  DestroyChassis_V1_11_4_CS (ChassisV1_11_4->Chassis); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyChassis_V1_11_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_11_4EntryPoint (
