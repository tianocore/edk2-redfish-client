...
//
#include <RedfishJsonStructure/Chassis/v1_9_0/EfiChassisV1_9_0.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_9_0
...
{
  EFI_REDFISH_CHASSIS_V1_9_0 *ChassisV1_9_0;
  EFI_REDFISH_CHASSIS_V1_9_0_CS *ChassisV1_9_0Cs;
  ...
  Status = (EFI_STATUS)Json_Chassis_V1_9_0_To_CS (ResoruceRaw, &ChassisV1_9_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_9_0 = (EFI_REDFISH_CHASSIS_V1_9_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_9_0));
  if (ChassisV1_9_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ChassisV1_9_0;
  ChassisV1_9_0->Chassis = ChassisV1_9_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Chassis_V1_9_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Chassis_V1_9_0_JSON (*((EFI_REDFISH_CHASSIS_V1_9_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Chassis_V1_9_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ChassisV1_9_0 = (EFI_REDFISH_CHASSIS_V1_9_0 *)InterpProp;
  DestroyChassis_V1_9_0_CS (ChassisV1_9_0->Chassis); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyChassis_V1_9_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_9_0EntryPoint (
