...
//
#include <RedfishJsonStructure/Chassis/v1_15_1/EfiChassisV1_15_1.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_15_1
...
{
  EFI_REDFISH_CHASSIS_V1_15_1 *ChassisV1_15_1;
  EFI_REDFISH_CHASSIS_V1_15_1_CS *ChassisV1_15_1Cs;
  ...
  Status = (EFI_STATUS)Json_Chassis_V1_15_1_To_CS (ResoruceRaw, &ChassisV1_15_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_15_1 = (EFI_REDFISH_CHASSIS_V1_15_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_15_1));
  if (ChassisV1_15_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ChassisV1_15_1;
  ChassisV1_15_1->Chassis = ChassisV1_15_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Chassis_V1_15_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Chassis_V1_15_1_JSON (*((EFI_REDFISH_CHASSIS_V1_15_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Chassis_V1_15_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ChassisV1_15_1 = (EFI_REDFISH_CHASSIS_V1_15_1 *)InterpProp;
  DestroyChassis_V1_15_1_CS (ChassisV1_15_1->Chassis); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyChassis_V1_15_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_15_1EntryPoint (
