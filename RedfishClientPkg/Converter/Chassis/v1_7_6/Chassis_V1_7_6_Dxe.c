...
//
#include <RedfishJsonStructure/Chassis/v1_7_6/EfiChassisV1_7_6.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_7_6
...
{
  EFI_REDFISH_CHASSIS_V1_7_6 *ChassisV1_7_6;
  EFI_REDFISH_CHASSIS_V1_7_6_CS *ChassisV1_7_6Cs;
  ...
  Status = (EFI_STATUS)Json_Chassis_V1_7_6_To_CS (ResoruceRaw, &ChassisV1_7_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_7_6 = (EFI_REDFISH_CHASSIS_V1_7_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_7_6));
  if (ChassisV1_7_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ChassisV1_7_6;
  ChassisV1_7_6->Chassis = ChassisV1_7_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Chassis_V1_7_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Chassis_V1_7_6_JSON (*((EFI_REDFISH_CHASSIS_V1_7_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Chassis_V1_7_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ChassisV1_7_6 = (EFI_REDFISH_CHASSIS_V1_7_6 *)InterpProp;
  DestroyChassis_V1_7_6_CS (ChassisV1_7_6->Chassis); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyChassis_V1_7_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_7_6EntryPoint (
