...
//
#include <RedfishJsonStructure/Chassis/v1_2_7/EfiChassisV1_2_7.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_2_7
...
{
  EFI_REDFISH_CHASSIS_V1_2_7 *ChassisV1_2_7;
  EFI_REDFISH_CHASSIS_V1_2_7_CS *ChassisV1_2_7Cs;
  ...
  Status = (EFI_STATUS)Json_Chassis_V1_2_7_To_CS (ResoruceRaw, &ChassisV1_2_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_2_7 = (EFI_REDFISH_CHASSIS_V1_2_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_2_7));
  if (ChassisV1_2_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ChassisV1_2_7;
  ChassisV1_2_7->Chassis = ChassisV1_2_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Chassis_V1_2_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Chassis_V1_2_7_JSON (*((EFI_REDFISH_CHASSIS_V1_2_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Chassis_V1_2_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ChassisV1_2_7 = (EFI_REDFISH_CHASSIS_V1_2_7 *)InterpProp;
  DestroyChassis_V1_2_7_CS (ChassisV1_2_7->Chassis); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyChassis_V1_2_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_2_7EntryPoint (
