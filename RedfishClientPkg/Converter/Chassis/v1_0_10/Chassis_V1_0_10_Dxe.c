...
//
#include <RedfishJsonStructure/Chassis/v1_0_10/EfiChassisV1_0_10.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_0_10
...
{
  EFI_REDFISH_CHASSIS_V1_0_10 *ChassisV1_0_10;
  EFI_REDFISH_CHASSIS_V1_0_10_CS *ChassisV1_0_10Cs;
  ...
  Status = (EFI_STATUS)Json_Chassis_V1_0_10_To_CS (ResoruceRaw, &ChassisV1_0_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_0_10 = (EFI_REDFISH_CHASSIS_V1_0_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_0_10));
  if (ChassisV1_0_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ChassisV1_0_10;
  ChassisV1_0_10->Chassis = ChassisV1_0_10Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Chassis"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("Chassis"), "Chassis");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Chassis"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("Chassis"), "Chassis");
...
/**
  The wrapper function of ChassisToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Chassis_V1_0_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Chassis_V1_0_10_JSON (*((EFI_REDFISH_CHASSIS_V1_0_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Chassis_V1_0_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ChassisV1_0_10 = (EFI_REDFISH_CHASSIS_V1_0_10 *)InterpProp;
  DestroyChassis_V1_0_10_CS (ChassisV1_0_10->Chassis); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ChassisFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyChassis_V1_0_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_0_10EntryPoint (
