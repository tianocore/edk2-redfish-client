...
//
#include <RedfishJsonStructure/Chassis/v1_1_11/EfiChassisV1_1_11.h>
CHAR8 mResourceTypeStr [] = "#Chassis";
BOOLEAN IsRevisonController = TRUE;

// Support Chassis V1_1_11
...
{
  EFI_REDFISH_CHASSIS_V1_1_11 *ChassisV1_1_11;
  EFI_REDFISH_CHASSIS_V1_1_11_CS *ChassisV1_1_11Cs;
  ...
  Status = (EFI_STATUS)Json_Chassis_V1_1_11_To_CS (ResoruceRaw, &ChassisV1_1_11Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ChassisV1_1_11 = (EFI_REDFISH_CHASSIS_V1_1_11 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CHASSIS_V1_1_11));
  if (ChassisV1_1_11 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ChassisV1_1_11;
  ChassisV1_1_11->Chassis = ChassisV1_1_11Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Chassis_V1_1_11_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Chassis_V1_1_11_JSON (*((EFI_REDFISH_CHASSIS_V1_1_11_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Chassis_V1_1_11_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ChassisV1_1_11 = (EFI_REDFISH_CHASSIS_V1_1_11 *)InterpProp;
  DestroyChassis_V1_1_11_CS (ChassisV1_1_11->Chassis); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyChassis_V1_1_11_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishChassis_V1_1_11EntryPoint (
