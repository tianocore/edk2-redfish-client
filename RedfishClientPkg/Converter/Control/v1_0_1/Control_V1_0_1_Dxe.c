...
//
#include <RedfishJsonStructure/Control/v1_0_1/EfiControlV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#Control";
BOOLEAN IsRevisonController = TRUE;

// Support Control V1_0_1
...
{
  EFI_REDFISH_CONTROL_V1_0_1 *ControlV1_0_1;
  EFI_REDFISH_CONTROL_V1_0_1_CS *ControlV1_0_1Cs;
  ...
  Status = (EFI_STATUS)Json_Control_V1_0_1_To_CS (ResoruceRaw, &ControlV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ControlV1_0_1 = (EFI_REDFISH_CONTROL_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CONTROL_V1_0_1));
  if (ControlV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ControlV1_0_1;
  ControlV1_0_1->Control = ControlV1_0_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Control_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Control_V1_0_1_JSON (*((EFI_REDFISH_CONTROL_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Control_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ControlV1_0_1 = (EFI_REDFISH_CONTROL_V1_0_1 *)InterpProp;
  DestroyControl_V1_0_1_CS (ControlV1_0_1->Control); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyControl_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishControl_V1_0_1EntryPoint (
