...
//
#include <RedfishJsonStructure/Control/v1_1_0/EfiControlV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#Control";
BOOLEAN IsRevisonController = TRUE;

// Support Control V1_1_0
...
{
  EFI_REDFISH_CONTROL_V1_1_0 *ControlV1_1_0;
  EFI_REDFISH_CONTROL_V1_1_0_CS *ControlV1_1_0Cs;
  ...
  Status = (EFI_STATUS)Json_Control_V1_1_0_To_CS (ResoruceRaw, &ControlV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ControlV1_1_0 = (EFI_REDFISH_CONTROL_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CONTROL_V1_1_0));
  if (ControlV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ControlV1_1_0;
  ControlV1_1_0->Control = ControlV1_1_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Control_V1_1_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Control_V1_1_0_JSON (*((EFI_REDFISH_CONTROL_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Control_V1_1_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ControlV1_1_0 = (EFI_REDFISH_CONTROL_V1_1_0 *)InterpProp;
  DestroyControl_V1_1_0_CS (ControlV1_1_0->Control); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyControl_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishControl_V1_1_0EntryPoint (
