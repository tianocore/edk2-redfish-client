...
//
#include <RedfishJsonStructure/CertificateService/v1_0_1/EfiCertificateServiceV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#CertificateService";
BOOLEAN IsRevisonController = TRUE;

// Support CertificateService V1_0_1
...
{
  EFI_REDFISH_CERTIFICATESERVICE_V1_0_1 *CertificateServiceV1_0_1;
  EFI_REDFISH_CERTIFICATESERVICE_V1_0_1_CS *CertificateServiceV1_0_1Cs;
  ...
  Status = (EFI_STATUS)Json_CertificateService_V1_0_1_To_CS (ResoruceRaw, &CertificateServiceV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CertificateServiceV1_0_1 = (EFI_REDFISH_CERTIFICATESERVICE_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CERTIFICATESERVICE_V1_0_1));
  if (CertificateServiceV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)CertificateServiceV1_0_1;
  CertificateServiceV1_0_1->CertificateService = CertificateServiceV1_0_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_CertificateService_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_CertificateService_V1_0_1_JSON (*((EFI_REDFISH_CERTIFICATESERVICE_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_CertificateService_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  CertificateServiceV1_0_1 = (EFI_REDFISH_CERTIFICATESERVICE_V1_0_1 *)InterpProp;
  DestroyCertificateService_V1_0_1_CS (CertificateServiceV1_0_1->CertificateService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyCertificateService_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCertificateService_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishCertificateService_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
