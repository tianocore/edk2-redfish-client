...
//
#include <RedfishJsonStructure/CertificateService/v1_0_0/EfiCertificateServiceV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#CertificateService";
BOOLEAN IsRevisonController = TRUE;

// Support CertificateService V1_0_0
...
{
  EFI_REDFISH_CERTIFICATESERVICE_V1_0_0 *CertificateServiceV1_0_0;
  EFI_REDFISH_CERTIFICATESERVICE_V1_0_0_CS *CertificateServiceV1_0_0Cs;
  ...
  Status = (EFI_STATUS)Json_CertificateService_V1_0_0_To_CS (ResoruceRaw, &CertificateServiceV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CertificateServiceV1_0_0 = (EFI_REDFISH_CERTIFICATESERVICE_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CERTIFICATESERVICE_V1_0_0));
  if (CertificateServiceV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)CertificateServiceV1_0_0;
  CertificateServiceV1_0_0->CertificateService = CertificateServiceV1_0_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_CertificateService_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_CertificateService_V1_0_0_JSON (*((EFI_REDFISH_CERTIFICATESERVICE_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_CertificateService_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  CertificateServiceV1_0_0 = (EFI_REDFISH_CERTIFICATESERVICE_V1_0_0 *)InterpProp;
  DestroyCertificateService_V1_0_0_CS (CertificateServiceV1_0_0->CertificateService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyCertificateService_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCertificateService_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishCertificateService_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
