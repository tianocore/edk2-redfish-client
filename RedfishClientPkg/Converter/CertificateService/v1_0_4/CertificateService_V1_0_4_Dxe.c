...
//
#include <RedfishJsonStructure/CertificateService/v1_0_4/EfiCertificateServiceV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#CertificateService";
BOOLEAN IsRevisonController = TRUE;

// Support CertificateService V1_0_4
...
{
  EFI_REDFISH_CERTIFICATESERVICE_V1_0_4 *CertificateServiceV1_0_4;
  EFI_REDFISH_CERTIFICATESERVICE_V1_0_4_CS *CertificateServiceV1_0_4Cs;
  ...
  Status = (EFI_STATUS)Json_CertificateService_V1_0_4_To_CS (ResoruceRaw, &CertificateServiceV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CertificateServiceV1_0_4 = (EFI_REDFISH_CERTIFICATESERVICE_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CERTIFICATESERVICE_V1_0_4));
  if (CertificateServiceV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)CertificateServiceV1_0_4;
  CertificateServiceV1_0_4->CertificateService = CertificateServiceV1_0_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_CertificateService_V1_0_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_CertificateService_V1_0_4_JSON (*((EFI_REDFISH_CERTIFICATESERVICE_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_CertificateService_V1_0_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  CertificateServiceV1_0_4 = (EFI_REDFISH_CERTIFICATESERVICE_V1_0_4 *)InterpProp;
  DestroyCertificateService_V1_0_4_CS (CertificateServiceV1_0_4->CertificateService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyCertificateService_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCertificateService_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishCertificateService_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
