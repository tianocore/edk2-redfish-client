...
//
#include <RedfishJsonStructure/CertificateService/v1_0_2/EfiCertificateServiceV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#CertificateService";
BOOLEAN IsRevisonController = TRUE;

// Support CertificateService V1_0_2
...
{
  EFI_REDFISH_CERTIFICATESERVICE_V1_0_2 *CertificateServiceV1_0_2;
  EFI_REDFISH_CERTIFICATESERVICE_V1_0_2_CS *CertificateServiceV1_0_2Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "CertificateService") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_CertificateService_V1_0_2_To_CS (ResoruceRaw, &CertificateServiceV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CertificateServiceV1_0_2 = (EFI_REDFISH_CERTIFICATESERVICE_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CERTIFICATESERVICE_V1_0_2));
  if (CertificateServiceV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)CertificateServiceV1_0_2;
  CertificateServiceV1_0_2->CertificateService = CertificateServiceV1_0_2Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("CertificateService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("CertificateService"), "CertificateService");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("CertificateService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("CertificateService"), "CertificateService");
...
/**
  The wrapper function of CertificateServiceToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
CertificateServiceToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return CertificateServiceToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_CertificateService_V1_0_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_CertificateService_V1_0_2_JSON (*((EFI_REDFISH_CERTIFICATESERVICE_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_CertificateService_V1_0_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in CertificateServiceToStruct.
...
)
{
  ...
  CertificateServiceV1_0_2 = (EFI_REDFISH_CERTIFICATESERVICE_V1_0_2 *)InterpProp;
  DestroyCertificateService_V1_0_2_CS (CertificateServiceV1_0_2->CertificateService); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from CertificateServiceFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyCertificateService_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCertificateService_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishCertificateService_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
