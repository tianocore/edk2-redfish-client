...
//
#include <RedfishJsonStructure/CertificateService/v1_0_3/EfiCertificateServiceV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#CertificateService";
BOOLEAN IsRevisonController = TRUE;

// Support CertificateService V1_0_3
...
{
  EFI_REDFISH_CERTIFICATESERVICE_V1_0_3 *CertificateServiceV1_0_3;
  EFI_REDFISH_CERTIFICATESERVICE_V1_0_3_CS *CertificateServiceV1_0_3Cs;
  ...
  Status = (EFI_STATUS)Json_CertificateService_V1_0_3_To_CS (ResoruceRaw, &CertificateServiceV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CertificateServiceV1_0_3 = (EFI_REDFISH_CERTIFICATESERVICE_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CERTIFICATESERVICE_V1_0_3));
  if (CertificateServiceV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)CertificateServiceV1_0_3;
  CertificateServiceV1_0_3->CertificateService = CertificateServiceV1_0_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_CertificateService_V1_0_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_CertificateService_V1_0_3_JSON (*((EFI_REDFISH_CERTIFICATESERVICE_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_CertificateService_V1_0_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  CertificateServiceV1_0_3 = (EFI_REDFISH_CERTIFICATESERVICE_V1_0_3 *)InterpProp;
  DestroyCertificateService_V1_0_3_CS (CertificateServiceV1_0_3->CertificateService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyCertificateService_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCertificateService_V1_0_3EntryPoint (
