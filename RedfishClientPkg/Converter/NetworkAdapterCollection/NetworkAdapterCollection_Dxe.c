...
)
{
  ...
  return (EFI_STATUS)CS_To_NetworkAdapterCollection_JSON (*((EFI_REDFISH_NETWORKADAPTERCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
