...
//
#include <RedfishJsonStructure/FabricAdapter/v1_0_0/EfiFabricAdapterV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#FabricAdapter";
BOOLEAN IsRevisonController = TRUE;

// Support FabricAdapter V1_0_0
...
{
  EFI_REDFISH_FABRICADAPTER_V1_0_0 *FabricAdapterV1_0_0;
  EFI_REDFISH_FABRICADAPTER_V1_0_0_CS *FabricAdapterV1_0_0Cs;
  ...
  Status = (EFI_STATUS)Json_FabricAdapter_V1_0_0_To_CS (ResoruceRaw, &FabricAdapterV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  FabricAdapterV1_0_0 = (EFI_REDFISH_FABRICADAPTER_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_FABRICADAPTER_V1_0_0));
  if (FabricAdapterV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)FabricAdapterV1_0_0;
  FabricAdapterV1_0_0->FabricAdapter = FabricAdapterV1_0_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_FabricAdapter_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_FabricAdapter_V1_0_0_JSON (*((EFI_REDFISH_FABRICADAPTER_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_FabricAdapter_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  FabricAdapterV1_0_0 = (EFI_REDFISH_FABRICADAPTER_V1_0_0 *)InterpProp;
  DestroyFabricAdapter_V1_0_0_CS (FabricAdapterV1_0_0->FabricAdapter); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyFabricAdapter_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishFabricAdapter_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishFabricAdapter_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
