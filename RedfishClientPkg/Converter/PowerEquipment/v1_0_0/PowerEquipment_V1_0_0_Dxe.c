...
//
#include <RedfishJsonStructure/PowerEquipment/v1_0_0/EfiPowerEquipmentV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#PowerEquipment";
BOOLEAN IsRevisonController = TRUE;

// Support PowerEquipment V1_0_0
...
{
  EFI_REDFISH_POWEREQUIPMENT_V1_0_0 *PowerEquipmentV1_0_0;
  EFI_REDFISH_POWEREQUIPMENT_V1_0_0_CS *PowerEquipmentV1_0_0Cs;
  ...
  Status = (EFI_STATUS)Json_PowerEquipment_V1_0_0_To_CS (ResoruceRaw, &PowerEquipmentV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerEquipmentV1_0_0 = (EFI_REDFISH_POWEREQUIPMENT_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWEREQUIPMENT_V1_0_0));
  if (PowerEquipmentV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerEquipmentV1_0_0;
  PowerEquipmentV1_0_0->PowerEquipment = PowerEquipmentV1_0_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PowerEquipment_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PowerEquipment_V1_0_0_JSON (*((EFI_REDFISH_POWEREQUIPMENT_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PowerEquipment_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerEquipmentV1_0_0 = (EFI_REDFISH_POWEREQUIPMENT_V1_0_0 *)InterpProp;
  DestroyPowerEquipment_V1_0_0_CS (PowerEquipmentV1_0_0->PowerEquipment); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPowerEquipment_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPowerEquipment_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPowerEquipment_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
