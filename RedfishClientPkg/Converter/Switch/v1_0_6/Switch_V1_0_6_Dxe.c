...
//
#include <RedfishJsonStructure/Switch/v1_0_6/EfiSwitchV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#Switch";
BOOLEAN IsRevisonController = TRUE;

// Support Switch V1_0_6
...
{
  EFI_REDFISH_SWITCH_V1_0_6 *SwitchV1_0_6;
  EFI_REDFISH_SWITCH_V1_0_6_CS *SwitchV1_0_6Cs;
  ...
  Status = (EFI_STATUS)Json_Switch_V1_0_6_To_CS (ResoruceRaw, &SwitchV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SwitchV1_0_6 = (EFI_REDFISH_SWITCH_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SWITCH_V1_0_6));
  if (SwitchV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SwitchV1_0_6;
  SwitchV1_0_6->Switch = SwitchV1_0_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Switch_V1_0_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Switch_V1_0_6_JSON (*((EFI_REDFISH_SWITCH_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Switch_V1_0_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SwitchV1_0_6 = (EFI_REDFISH_SWITCH_V1_0_6 *)InterpProp;
  DestroySwitch_V1_0_6_CS (SwitchV1_0_6->Switch); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySwitch_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSwitch_V1_0_6EntryPoint (
