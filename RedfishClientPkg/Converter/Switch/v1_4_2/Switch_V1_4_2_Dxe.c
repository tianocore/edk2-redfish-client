...
//
#include <RedfishJsonStructure/Switch/v1_4_2/EfiSwitchV1_4_2.h>
CHAR8 mResourceTypeStr [] = "#Switch";
BOOLEAN IsRevisonController = TRUE;

// Support Switch V1_4_2
...
{
  EFI_REDFISH_SWITCH_V1_4_2 *SwitchV1_4_2;
  EFI_REDFISH_SWITCH_V1_4_2_CS *SwitchV1_4_2Cs;
  ...
  Status = (EFI_STATUS)Json_Switch_V1_4_2_To_CS (ResoruceRaw, &SwitchV1_4_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SwitchV1_4_2 = (EFI_REDFISH_SWITCH_V1_4_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SWITCH_V1_4_2));
  if (SwitchV1_4_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SwitchV1_4_2;
  SwitchV1_4_2->Switch = SwitchV1_4_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Switch_V1_4_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Switch_V1_4_2_JSON (*((EFI_REDFISH_SWITCH_V1_4_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Switch_V1_4_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SwitchV1_4_2 = (EFI_REDFISH_SWITCH_V1_4_2 *)InterpProp;
  DestroySwitch_V1_4_2_CS (SwitchV1_4_2->Switch); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySwitch_V1_4_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSwitch_V1_4_2EntryPoint (
