...
//
#include <RedfishJsonStructure/Switch/v1_8_0/EfiSwitchV1_8_0.h>
CHAR8 mResourceTypeStr [] = "#Switch";
BOOLEAN IsRevisonController = TRUE;

// Support Switch V1_8_0
...
{
  EFI_REDFISH_SWITCH_V1_8_0 *SwitchV1_8_0;
  EFI_REDFISH_SWITCH_V1_8_0_CS *SwitchV1_8_0Cs;
  ...
  Status = (EFI_STATUS)Json_Switch_V1_8_0_To_CS (ResoruceRaw, &SwitchV1_8_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SwitchV1_8_0 = (EFI_REDFISH_SWITCH_V1_8_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SWITCH_V1_8_0));
  if (SwitchV1_8_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SwitchV1_8_0;
  SwitchV1_8_0->Switch = SwitchV1_8_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Switch_V1_8_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Switch_V1_8_0_JSON (*((EFI_REDFISH_SWITCH_V1_8_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Switch_V1_8_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SwitchV1_8_0 = (EFI_REDFISH_SWITCH_V1_8_0 *)InterpProp;
  DestroySwitch_V1_8_0_CS (SwitchV1_8_0->Switch); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySwitch_V1_8_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSwitch_V1_8_0EntryPoint (
