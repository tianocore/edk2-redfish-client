...
//
#include <RedfishJsonStructure/Switch/v1_0_7/EfiSwitchV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#Switch";
BOOLEAN IsRevisonController = TRUE;

// Support Switch V1_0_7
...
{
  EFI_REDFISH_SWITCH_V1_0_7 *SwitchV1_0_7;
  EFI_REDFISH_SWITCH_V1_0_7_CS *SwitchV1_0_7Cs;
  ...
  Status = (EFI_STATUS)Json_Switch_V1_0_7_To_CS (ResoruceRaw, &SwitchV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SwitchV1_0_7 = (EFI_REDFISH_SWITCH_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SWITCH_V1_0_7));
  if (SwitchV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SwitchV1_0_7;
  SwitchV1_0_7->Switch = SwitchV1_0_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Switch_V1_0_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Switch_V1_0_7_JSON (*((EFI_REDFISH_SWITCH_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Switch_V1_0_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SwitchV1_0_7 = (EFI_REDFISH_SWITCH_V1_0_7 *)InterpProp;
  DestroySwitch_V1_0_7_CS (SwitchV1_0_7->Switch); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySwitch_V1_0_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSwitch_V1_0_7EntryPoint (
