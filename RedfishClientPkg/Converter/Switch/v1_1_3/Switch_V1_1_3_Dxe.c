...
//
#include <RedfishJsonStructure/Switch/v1_1_3/EfiSwitchV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#Switch";
BOOLEAN IsRevisonController = TRUE;

// Support Switch V1_1_3
...
{
  EFI_REDFISH_SWITCH_V1_1_3 *SwitchV1_1_3;
  EFI_REDFISH_SWITCH_V1_1_3_CS *SwitchV1_1_3Cs;
  ...
  Status = (EFI_STATUS)Json_Switch_V1_1_3_To_CS (ResoruceRaw, &SwitchV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SwitchV1_1_3 = (EFI_REDFISH_SWITCH_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SWITCH_V1_1_3));
  if (SwitchV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SwitchV1_1_3;
  SwitchV1_1_3->Switch = SwitchV1_1_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Switch_V1_1_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Switch_V1_1_3_JSON (*((EFI_REDFISH_SWITCH_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Switch_V1_1_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SwitchV1_1_3 = (EFI_REDFISH_SWITCH_V1_1_3 *)InterpProp;
  DestroySwitch_V1_1_3_CS (SwitchV1_1_3->Switch); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySwitch_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSwitch_V1_1_3EntryPoint (
