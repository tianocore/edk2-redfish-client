...
//
#include <RedfishJsonStructure/Switch/v1_1_4/EfiSwitchV1_1_4.h>
CHAR8 mResourceTypeStr [] = "#Switch";
BOOLEAN IsRevisonController = TRUE;

// Support Switch V1_1_4
...
{
  EFI_REDFISH_SWITCH_V1_1_4 *SwitchV1_1_4;
  EFI_REDFISH_SWITCH_V1_1_4_CS *SwitchV1_1_4Cs;
  ...
  Status = (EFI_STATUS)Json_Switch_V1_1_4_To_CS (ResoruceRaw, &SwitchV1_1_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SwitchV1_1_4 = (EFI_REDFISH_SWITCH_V1_1_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SWITCH_V1_1_4));
  if (SwitchV1_1_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SwitchV1_1_4;
  SwitchV1_1_4->Switch = SwitchV1_1_4Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Switch"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("Switch"), "Switch");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Switch"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("Switch"), "Switch");
...
/**
  The wrapper function of SwitchToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Switch_V1_1_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Switch_V1_1_4_JSON (*((EFI_REDFISH_SWITCH_V1_1_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Switch_V1_1_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SwitchV1_1_4 = (EFI_REDFISH_SWITCH_V1_1_4 *)InterpProp;
  DestroySwitch_V1_1_4_CS (SwitchV1_1_4->Switch); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from SwitchFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroySwitch_V1_1_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSwitch_V1_1_4EntryPoint (
