...
//
#include <RedfishJsonStructure/EndpointGroup/v1_0_4/EfiEndpointGroupV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#EndpointGroup";
BOOLEAN IsRevisonController = TRUE;

// Support EndpointGroup V1_0_4
...
{
  EFI_REDFISH_ENDPOINTGROUP_V1_0_4 *EndpointGroupV1_0_4;
  EFI_REDFISH_ENDPOINTGROUP_V1_0_4_CS *EndpointGroupV1_0_4Cs;
  ...
  Status = (EFI_STATUS)Json_EndpointGroup_V1_0_4_To_CS (ResoruceRaw, &EndpointGroupV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointGroupV1_0_4 = (EFI_REDFISH_ENDPOINTGROUP_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINTGROUP_V1_0_4));
  if (EndpointGroupV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EndpointGroupV1_0_4;
  EndpointGroupV1_0_4->EndpointGroup = EndpointGroupV1_0_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EndpointGroup_V1_0_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EndpointGroup_V1_0_4_JSON (*((EFI_REDFISH_ENDPOINTGROUP_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EndpointGroup_V1_0_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EndpointGroupV1_0_4 = (EFI_REDFISH_ENDPOINTGROUP_V1_0_4 *)InterpProp;
  DestroyEndpointGroup_V1_0_4_CS (EndpointGroupV1_0_4->EndpointGroup); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEndpointGroup_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpointGroup_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEndpointGroup_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
