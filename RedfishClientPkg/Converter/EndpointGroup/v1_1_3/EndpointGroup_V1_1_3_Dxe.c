...
//
#include <RedfishJsonStructure/EndpointGroup/v1_1_3/EfiEndpointGroupV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#EndpointGroup";
BOOLEAN IsRevisonController = TRUE;

// Support EndpointGroup V1_1_3
...
{
  EFI_REDFISH_ENDPOINTGROUP_V1_1_3 *EndpointGroupV1_1_3;
  EFI_REDFISH_ENDPOINTGROUP_V1_1_3_CS *EndpointGroupV1_1_3Cs;
  ...
  Status = (EFI_STATUS)Json_EndpointGroup_V1_1_3_To_CS (ResoruceRaw, &EndpointGroupV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointGroupV1_1_3 = (EFI_REDFISH_ENDPOINTGROUP_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINTGROUP_V1_1_3));
  if (EndpointGroupV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EndpointGroupV1_1_3;
  EndpointGroupV1_1_3->EndpointGroup = EndpointGroupV1_1_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EndpointGroup_V1_1_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EndpointGroup_V1_1_3_JSON (*((EFI_REDFISH_ENDPOINTGROUP_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EndpointGroup_V1_1_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EndpointGroupV1_1_3 = (EFI_REDFISH_ENDPOINTGROUP_V1_1_3 *)InterpProp;
  DestroyEndpointGroup_V1_1_3_CS (EndpointGroupV1_1_3->EndpointGroup); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEndpointGroup_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpointGroup_V1_1_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEndpointGroup_V1_1_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
