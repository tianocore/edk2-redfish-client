...
)
{
  ...
  return (EFI_STATUS)CS_To_EndpointGroup_V1_0_3_JSON (*((EFI_REDFISH_ENDPOINTGROUP_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
