...
//
#include <RedfishJsonStructure/EndpointGroup/v1_0_0/EfiEndpointGroupV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#EndpointGroup";
BOOLEAN IsRevisonController = TRUE;

// Support EndpointGroup V1_0_0
...
{
  EFI_REDFISH_ENDPOINTGROUP_V1_0_0 *EndpointGroupV1_0_0;
  EFI_REDFISH_ENDPOINTGROUP_V1_0_0_CS *EndpointGroupV1_0_0Cs;
  ...
  Status = (EFI_STATUS)Json_EndpointGroup_V1_0_0_To_CS (ResoruceRaw, &EndpointGroupV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointGroupV1_0_0 = (EFI_REDFISH_ENDPOINTGROUP_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINTGROUP_V1_0_0));
  if (EndpointGroupV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EndpointGroupV1_0_0;
  EndpointGroupV1_0_0->EndpointGroup = EndpointGroupV1_0_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EndpointGroup_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EndpointGroup_V1_0_0_JSON (*((EFI_REDFISH_ENDPOINTGROUP_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EndpointGroup_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EndpointGroupV1_0_0 = (EFI_REDFISH_ENDPOINTGROUP_V1_0_0 *)InterpProp;
  DestroyEndpointGroup_V1_0_0_CS (EndpointGroupV1_0_0->EndpointGroup); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEndpointGroup_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpointGroup_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEndpointGroup_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
