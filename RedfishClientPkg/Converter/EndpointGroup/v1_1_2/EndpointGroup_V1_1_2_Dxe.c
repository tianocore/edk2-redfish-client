...
//
#include <RedfishJsonStructure/EndpointGroup/v1_1_2/EfiEndpointGroupV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#EndpointGroup";
BOOLEAN IsRevisonController = TRUE;

// Support EndpointGroup V1_1_2
...
{
  EFI_REDFISH_ENDPOINTGROUP_V1_1_2 *EndpointGroupV1_1_2;
  EFI_REDFISH_ENDPOINTGROUP_V1_1_2_CS *EndpointGroupV1_1_2Cs;
  ...
  Status = (EFI_STATUS)Json_EndpointGroup_V1_1_2_To_CS (ResoruceRaw, &EndpointGroupV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointGroupV1_1_2 = (EFI_REDFISH_ENDPOINTGROUP_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINTGROUP_V1_1_2));
  if (EndpointGroupV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EndpointGroupV1_1_2;
  EndpointGroupV1_1_2->EndpointGroup = EndpointGroupV1_1_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EndpointGroup_V1_1_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EndpointGroup_V1_1_2_JSON (*((EFI_REDFISH_ENDPOINTGROUP_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EndpointGroup_V1_1_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EndpointGroupV1_1_2 = (EFI_REDFISH_ENDPOINTGROUP_V1_1_2 *)InterpProp;
  DestroyEndpointGroup_V1_1_2_CS (EndpointGroupV1_1_2->EndpointGroup); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEndpointGroup_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpointGroup_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEndpointGroup_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
