...
//
#include <RedfishJsonStructure/EndpointGroup/v1_2_1/EfiEndpointGroupV1_2_1.h>
CHAR8 mResourceTypeStr [] = "#EndpointGroup";
BOOLEAN IsRevisonController = TRUE;

// Support EndpointGroup V1_2_1
...
{
  EFI_REDFISH_ENDPOINTGROUP_V1_2_1 *EndpointGroupV1_2_1;
  EFI_REDFISH_ENDPOINTGROUP_V1_2_1_CS *EndpointGroupV1_2_1Cs;
  ...
  Status = (EFI_STATUS)Json_EndpointGroup_V1_2_1_To_CS (ResoruceRaw, &EndpointGroupV1_2_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointGroupV1_2_1 = (EFI_REDFISH_ENDPOINTGROUP_V1_2_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINTGROUP_V1_2_1));
  if (EndpointGroupV1_2_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EndpointGroupV1_2_1;
  EndpointGroupV1_2_1->EndpointGroup = EndpointGroupV1_2_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EndpointGroup_V1_2_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EndpointGroup_V1_2_1_JSON (*((EFI_REDFISH_ENDPOINTGROUP_V1_2_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EndpointGroup_V1_2_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EndpointGroupV1_2_1 = (EFI_REDFISH_ENDPOINTGROUP_V1_2_1 *)InterpProp;
  DestroyEndpointGroup_V1_2_1_CS (EndpointGroupV1_2_1->EndpointGroup); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEndpointGroup_V1_2_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpointGroup_V1_2_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEndpointGroup_V1_2_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
