...
)
{
  ...
  return (EFI_STATUS)CS_To_SerialInterfaceCollection_JSON (*((EFI_REDFISH_SERIALINTERFACECOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
