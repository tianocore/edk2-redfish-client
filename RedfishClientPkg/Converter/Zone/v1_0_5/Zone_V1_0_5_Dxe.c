...
//
#include <RedfishJsonStructure/Zone/v1_0_5/EfiZoneV1_0_5.h>
...
{
  EFI_REDFISH_ZONE_V1_0_5 *ZoneV1_0_5;
  EFI_REDFISH_ZONE_V1_0_5_CS *ZoneV1_0_5Cs;
  ...
  Status = (EFI_STATUS)Json_Zone_V1_0_5_To_CS (ResoruceRaw, &ZoneV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ZoneV1_0_5 = (EFI_REDFISH_ZONE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ZONE_V1_0_5));
  if (ZoneV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ZoneV1_0_5;
  ZoneV1_0_5->Zone = ZoneV1_0_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Zone_V1_0_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Zone_V1_0_5_JSON (*((EFI_REDFISH_ZONE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Zone_V1_0_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ZoneV1_0_5 = (EFI_REDFISH_ZONE_V1_0_5 *)InterpProp;
  DestroyZone_V1_0_5_CS (ZoneV1_0_5->Zone); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyZone_V1_0_5_Json (ResoruceRaw);
}
