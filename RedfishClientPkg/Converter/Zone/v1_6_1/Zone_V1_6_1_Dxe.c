...
//
#include <RedfishJsonStructure/Zone/v1_6_1/EfiZoneV1_6_1.h>
...
{
  EFI_REDFISH_ZONE_V1_6_1 *ZoneV1_6_1;
  EFI_REDFISH_ZONE_V1_6_1_CS *ZoneV1_6_1Cs;
  ...
  Status = (EFI_STATUS)Json_Zone_V1_6_1_To_CS (ResoruceRaw, &ZoneV1_6_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ZoneV1_6_1 = (EFI_REDFISH_ZONE_V1_6_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ZONE_V1_6_1));
  if (ZoneV1_6_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ZoneV1_6_1;
  ZoneV1_6_1->Zone = ZoneV1_6_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Zone_V1_6_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Zone_V1_6_1_JSON (*((EFI_REDFISH_ZONE_V1_6_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Zone_V1_6_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ZoneV1_6_1 = (EFI_REDFISH_ZONE_V1_6_1 *)InterpProp;
  DestroyZone_V1_6_1_CS (ZoneV1_6_1->Zone); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyZone_V1_6_1_Json (ResoruceRaw);
}
