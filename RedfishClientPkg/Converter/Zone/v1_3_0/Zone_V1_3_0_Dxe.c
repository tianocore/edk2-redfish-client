...
//
#include <RedfishJsonStructure/Zone/v1_3_0/EfiZoneV1_3_0.h>
...
{
  EFI_REDFISH_ZONE_V1_3_0 *ZoneV1_3_0;
  EFI_REDFISH_ZONE_V1_3_0_CS *ZoneV1_3_0Cs;
  ...
  Status = (EFI_STATUS)Json_Zone_V1_3_0_To_CS (ResoruceRaw, &ZoneV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ZoneV1_3_0 = (EFI_REDFISH_ZONE_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ZONE_V1_3_0));
  if (ZoneV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ZoneV1_3_0;
  ZoneV1_3_0->Zone = ZoneV1_3_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Zone_V1_3_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Zone_V1_3_0_JSON (*((EFI_REDFISH_ZONE_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Zone_V1_3_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ZoneV1_3_0 = (EFI_REDFISH_ZONE_V1_3_0 *)InterpProp;
  DestroyZone_V1_3_0_CS (ZoneV1_3_0->Zone); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyZone_V1_3_0_Json (ResoruceRaw);
}
