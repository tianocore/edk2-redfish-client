...
//
#include <RedfishJsonStructure/Zone/v1_3_2/EfiZoneV1_3_2.h>
...
{
  EFI_REDFISH_ZONE_V1_3_2 *ZoneV1_3_2;
  EFI_REDFISH_ZONE_V1_3_2_CS *ZoneV1_3_2Cs;
  ...
  Status = (EFI_STATUS)Json_Zone_V1_3_2_To_CS (ResoruceRaw, &ZoneV1_3_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ZoneV1_3_2 = (EFI_REDFISH_ZONE_V1_3_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ZONE_V1_3_2));
  if (ZoneV1_3_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ZoneV1_3_2;
  ZoneV1_3_2->Zone = ZoneV1_3_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Zone_V1_3_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Zone_V1_3_2_JSON (*((EFI_REDFISH_ZONE_V1_3_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Zone_V1_3_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ZoneV1_3_2 = (EFI_REDFISH_ZONE_V1_3_2 *)InterpProp;
  DestroyZone_V1_3_2_CS (ZoneV1_3_2->Zone); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyZone_V1_3_2_Json (ResoruceRaw);
}
