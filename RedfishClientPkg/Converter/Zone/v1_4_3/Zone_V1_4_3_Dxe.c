...
//
#include <RedfishJsonStructure/Zone/v1_4_3/EfiZoneV1_4_3.h>
...
{
  EFI_REDFISH_ZONE_V1_4_3 *ZoneV1_4_3;
  EFI_REDFISH_ZONE_V1_4_3_CS *ZoneV1_4_3Cs;
  ...
  Status = (EFI_STATUS)Json_Zone_V1_4_3_To_CS (ResoruceRaw, &ZoneV1_4_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ZoneV1_4_3 = (EFI_REDFISH_ZONE_V1_4_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ZONE_V1_4_3));
  if (ZoneV1_4_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ZoneV1_4_3;
  ZoneV1_4_3->Zone = ZoneV1_4_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Zone_V1_4_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Zone_V1_4_3_JSON (*((EFI_REDFISH_ZONE_V1_4_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Zone_V1_4_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ZoneV1_4_3 = (EFI_REDFISH_ZONE_V1_4_3 *)InterpProp;
  DestroyZone_V1_4_3_CS (ZoneV1_4_3->Zone); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyZone_V1_4_3_Json (ResoruceRaw);
}
