...
//
#include <RedfishJsonStructure/Zone/v1_0_4/EfiZoneV1_0_4.h>
...
{
  EFI_REDFISH_ZONE_V1_0_4 *ZoneV1_0_4;
  EFI_REDFISH_ZONE_V1_0_4_CS *ZoneV1_0_4Cs;
  ...
  Status = (EFI_STATUS)Json_Zone_V1_0_4_To_CS (ResoruceRaw, &ZoneV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ZoneV1_0_4 = (EFI_REDFISH_ZONE_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ZONE_V1_0_4));
  if (ZoneV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ZoneV1_0_4;
  ZoneV1_0_4->Zone = ZoneV1_0_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Zone_V1_0_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Zone_V1_0_4_JSON (*((EFI_REDFISH_ZONE_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Zone_V1_0_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ZoneV1_0_4 = (EFI_REDFISH_ZONE_V1_0_4 *)InterpProp;
  DestroyZone_V1_0_4_CS (ZoneV1_0_4->Zone); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyZone_V1_0_4_Json (ResoruceRaw);
}
