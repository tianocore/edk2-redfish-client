...
//
#include <RedfishJsonStructure/Zone/v1_2_3/EfiZoneV1_2_3.h>
...
{
  EFI_REDFISH_ZONE_V1_2_3 *ZoneV1_2_3;
  EFI_REDFISH_ZONE_V1_2_3_CS *ZoneV1_2_3Cs;
  ...
  Status = (EFI_STATUS)Json_Zone_V1_2_3_To_CS (ResoruceRaw, &ZoneV1_2_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ZoneV1_2_3 = (EFI_REDFISH_ZONE_V1_2_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ZONE_V1_2_3));
  if (ZoneV1_2_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ZoneV1_2_3;
  ZoneV1_2_3->Zone = ZoneV1_2_3Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Zone"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("Zone"), "Zone");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Zone"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("Zone"), "Zone");
...
/**
  The wrapper function of ZoneToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Zone_V1_2_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Zone_V1_2_3_JSON (*((EFI_REDFISH_ZONE_V1_2_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Zone_V1_2_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ZoneV1_2_3 = (EFI_REDFISH_ZONE_V1_2_3 *)InterpProp;
  DestroyZone_V1_2_3_CS (ZoneV1_2_3->Zone); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ZoneFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyZone_V1_2_3_Json (ResoruceRaw);
}
