...
//
#include <RedfishJsonStructure/PortMetrics/v1_0_0/EfiPortMetricsV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#PortMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support PortMetrics V1_0_0
...
{
  EFI_REDFISH_PORTMETRICS_V1_0_0 *PortMetricsV1_0_0;
  EFI_REDFISH_PORTMETRICS_V1_0_0_CS *PortMetricsV1_0_0Cs;
  ...
  Status = (EFI_STATUS)Json_PortMetrics_V1_0_0_To_CS (ResoruceRaw, &PortMetricsV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PortMetricsV1_0_0 = (EFI_REDFISH_PORTMETRICS_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PORTMETRICS_V1_0_0));
  if (PortMetricsV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PortMetricsV1_0_0;
  PortMetricsV1_0_0->PortMetrics = PortMetricsV1_0_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PortMetrics_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PortMetrics_V1_0_0_JSON (*((EFI_REDFISH_PORTMETRICS_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PortMetrics_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PortMetricsV1_0_0 = (EFI_REDFISH_PORTMETRICS_V1_0_0 *)InterpProp;
  DestroyPortMetrics_V1_0_0_CS (PortMetricsV1_0_0->PortMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPortMetrics_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPortMetrics_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPortMetrics_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
