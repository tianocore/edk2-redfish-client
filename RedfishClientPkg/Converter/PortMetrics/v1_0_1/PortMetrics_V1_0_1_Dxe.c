...
//
#include <RedfishJsonStructure/PortMetrics/v1_0_1/EfiPortMetricsV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#PortMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support PortMetrics V1_0_1
...
{
  EFI_REDFISH_PORTMETRICS_V1_0_1 *PortMetricsV1_0_1;
  EFI_REDFISH_PORTMETRICS_V1_0_1_CS *PortMetricsV1_0_1Cs;
  ...
  Status = (EFI_STATUS)Json_PortMetrics_V1_0_1_To_CS (ResoruceRaw, &PortMetricsV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PortMetricsV1_0_1 = (EFI_REDFISH_PORTMETRICS_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PORTMETRICS_V1_0_1));
  if (PortMetricsV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PortMetricsV1_0_1;
  PortMetricsV1_0_1->PortMetrics = PortMetricsV1_0_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PortMetrics_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PortMetrics_V1_0_1_JSON (*((EFI_REDFISH_PORTMETRICS_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PortMetrics_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PortMetricsV1_0_1 = (EFI_REDFISH_PORTMETRICS_V1_0_1 *)InterpProp;
  DestroyPortMetrics_V1_0_1_CS (PortMetricsV1_0_1->PortMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPortMetrics_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPortMetrics_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPortMetrics_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
