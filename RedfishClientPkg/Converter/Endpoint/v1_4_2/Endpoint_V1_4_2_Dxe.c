...
//
#include <RedfishJsonStructure/Endpoint/v1_4_2/EfiEndpointV1_4_2.h>
CHAR8 mResourceTypeStr [] = "#Endpoint";
BOOLEAN IsRevisonController = TRUE;

// Support Endpoint V1_4_2
...
{
  EFI_REDFISH_ENDPOINT_V1_4_2 *EndpointV1_4_2;
  EFI_REDFISH_ENDPOINT_V1_4_2_CS *EndpointV1_4_2Cs;
  ...
  Status = (EFI_STATUS)Json_Endpoint_V1_4_2_To_CS (ResoruceRaw, &EndpointV1_4_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointV1_4_2 = (EFI_REDFISH_ENDPOINT_V1_4_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINT_V1_4_2));
  if (EndpointV1_4_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EndpointV1_4_2;
  EndpointV1_4_2->Endpoint = EndpointV1_4_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Endpoint_V1_4_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Endpoint_V1_4_2_JSON (*((EFI_REDFISH_ENDPOINT_V1_4_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Endpoint_V1_4_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EndpointV1_4_2 = (EFI_REDFISH_ENDPOINT_V1_4_2 *)InterpProp;
  DestroyEndpoint_V1_4_2_CS (EndpointV1_4_2->Endpoint); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEndpoint_V1_4_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpoint_V1_4_2EntryPoint (
