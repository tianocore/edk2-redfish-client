...
//
#include <RedfishJsonStructure/Endpoint/v1_0_12/EfiEndpointV1_0_12.h>
CHAR8 mResourceTypeStr [] = "#Endpoint";
BOOLEAN IsRevisonController = TRUE;

// Support Endpoint V1_0_12
...
{
  EFI_REDFISH_ENDPOINT_V1_0_12 *EndpointV1_0_12;
  EFI_REDFISH_ENDPOINT_V1_0_12_CS *EndpointV1_0_12Cs;
  ...
  Status = (EFI_STATUS)Json_Endpoint_V1_0_12_To_CS (ResoruceRaw, &EndpointV1_0_12Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointV1_0_12 = (EFI_REDFISH_ENDPOINT_V1_0_12 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINT_V1_0_12));
  if (EndpointV1_0_12 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EndpointV1_0_12;
  EndpointV1_0_12->Endpoint = EndpointV1_0_12Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Endpoint_V1_0_12_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Endpoint_V1_0_12_JSON (*((EFI_REDFISH_ENDPOINT_V1_0_12_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Endpoint_V1_0_12_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EndpointV1_0_12 = (EFI_REDFISH_ENDPOINT_V1_0_12 *)InterpProp;
  DestroyEndpoint_V1_0_12_CS (EndpointV1_0_12->Endpoint); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEndpoint_V1_0_12_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpoint_V1_0_12EntryPoint (
