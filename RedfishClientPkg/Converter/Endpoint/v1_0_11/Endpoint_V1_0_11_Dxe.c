...
//
#include <RedfishJsonStructure/Endpoint/v1_0_11/EfiEndpointV1_0_11.h>
CHAR8 mResourceTypeStr [] = "#Endpoint";
BOOLEAN IsRevisonController = TRUE;

// Support Endpoint V1_0_11
...
{
  EFI_REDFISH_ENDPOINT_V1_0_11 *EndpointV1_0_11;
  EFI_REDFISH_ENDPOINT_V1_0_11_CS *EndpointV1_0_11Cs;
  ...
  Status = (EFI_STATUS)Json_Endpoint_V1_0_11_To_CS (ResoruceRaw, &EndpointV1_0_11Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointV1_0_11 = (EFI_REDFISH_ENDPOINT_V1_0_11 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINT_V1_0_11));
  if (EndpointV1_0_11 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EndpointV1_0_11;
  EndpointV1_0_11->Endpoint = EndpointV1_0_11Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Endpoint"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("Endpoint"), "Endpoint");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Endpoint"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("Endpoint"), "Endpoint");
...
/**
  The wrapper function of EndpointToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Endpoint_V1_0_11_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Endpoint_V1_0_11_JSON (*((EFI_REDFISH_ENDPOINT_V1_0_11_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Endpoint_V1_0_11_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EndpointV1_0_11 = (EFI_REDFISH_ENDPOINT_V1_0_11 *)InterpProp;
  DestroyEndpoint_V1_0_11_CS (EndpointV1_0_11->Endpoint); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from EndpointFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyEndpoint_V1_0_11_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpoint_V1_0_11EntryPoint (
