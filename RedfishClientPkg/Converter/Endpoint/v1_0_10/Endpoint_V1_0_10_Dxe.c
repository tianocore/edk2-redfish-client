...
//
#include <RedfishJsonStructure/Endpoint/v1_0_10/EfiEndpointV1_0_10.h>
CHAR8 mResourceTypeStr [] = "#Endpoint";
BOOLEAN IsRevisonController = TRUE;

// Support Endpoint V1_0_10
...
{
  EFI_REDFISH_ENDPOINT_V1_0_10 *EndpointV1_0_10;
  EFI_REDFISH_ENDPOINT_V1_0_10_CS *EndpointV1_0_10Cs;
  ...
  Status = (EFI_STATUS)Json_Endpoint_V1_0_10_To_CS (ResoruceRaw, &EndpointV1_0_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointV1_0_10 = (EFI_REDFISH_ENDPOINT_V1_0_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINT_V1_0_10));
  if (EndpointV1_0_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EndpointV1_0_10;
  EndpointV1_0_10->Endpoint = EndpointV1_0_10Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Endpoint_V1_0_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Endpoint_V1_0_10_JSON (*((EFI_REDFISH_ENDPOINT_V1_0_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Endpoint_V1_0_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EndpointV1_0_10 = (EFI_REDFISH_ENDPOINT_V1_0_10 *)InterpProp;
  DestroyEndpoint_V1_0_10_CS (EndpointV1_0_10->Endpoint); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEndpoint_V1_0_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpoint_V1_0_10EntryPoint (
