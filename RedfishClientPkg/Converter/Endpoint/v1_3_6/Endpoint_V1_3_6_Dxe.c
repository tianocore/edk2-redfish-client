...
//
#include <RedfishJsonStructure/Endpoint/v1_3_6/EfiEndpointV1_3_6.h>
CHAR8 mResourceTypeStr [] = "#Endpoint";
BOOLEAN IsRevisonController = TRUE;

// Support Endpoint V1_3_6
...
{
  EFI_REDFISH_ENDPOINT_V1_3_6 *EndpointV1_3_6;
  EFI_REDFISH_ENDPOINT_V1_3_6_CS *EndpointV1_3_6Cs;
  ...
  Status = (EFI_STATUS)Json_Endpoint_V1_3_6_To_CS (ResoruceRaw, &EndpointV1_3_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointV1_3_6 = (EFI_REDFISH_ENDPOINT_V1_3_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINT_V1_3_6));
  if (EndpointV1_3_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EndpointV1_3_6;
  EndpointV1_3_6->Endpoint = EndpointV1_3_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Endpoint_V1_3_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Endpoint_V1_3_6_JSON (*((EFI_REDFISH_ENDPOINT_V1_3_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Endpoint_V1_3_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EndpointV1_3_6 = (EFI_REDFISH_ENDPOINT_V1_3_6 *)InterpProp;
  DestroyEndpoint_V1_3_6_CS (EndpointV1_3_6->Endpoint); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEndpoint_V1_3_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpoint_V1_3_6EntryPoint (
