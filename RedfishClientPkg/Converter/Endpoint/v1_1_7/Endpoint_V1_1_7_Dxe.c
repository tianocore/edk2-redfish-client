...
//
#include <RedfishJsonStructure/Endpoint/v1_1_7/EfiEndpointV1_1_7.h>
CHAR8 mResourceTypeStr [] = "#Endpoint";
BOOLEAN IsRevisonController = TRUE;

// Support Endpoint V1_1_7
...
{
  EFI_REDFISH_ENDPOINT_V1_1_7 *EndpointV1_1_7;
  EFI_REDFISH_ENDPOINT_V1_1_7_CS *EndpointV1_1_7Cs;
  ...
  Status = (EFI_STATUS)Json_Endpoint_V1_1_7_To_CS (ResoruceRaw, &EndpointV1_1_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointV1_1_7 = (EFI_REDFISH_ENDPOINT_V1_1_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINT_V1_1_7));
  if (EndpointV1_1_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EndpointV1_1_7;
  EndpointV1_1_7->Endpoint = EndpointV1_1_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Endpoint_V1_1_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Endpoint_V1_1_7_JSON (*((EFI_REDFISH_ENDPOINT_V1_1_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Endpoint_V1_1_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EndpointV1_1_7 = (EFI_REDFISH_ENDPOINT_V1_1_7 *)InterpProp;
  DestroyEndpoint_V1_1_7_CS (EndpointV1_1_7->Endpoint); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEndpoint_V1_1_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpoint_V1_1_7EntryPoint (
