...
//
#include <RedfishJsonStructure/Endpoint/v1_5_1/EfiEndpointV1_5_1.h>
CHAR8 mResourceTypeStr [] = "#Endpoint";
BOOLEAN IsRevisonController = TRUE;

// Support Endpoint V1_5_1
...
{
  EFI_REDFISH_ENDPOINT_V1_5_1 *EndpointV1_5_1;
  EFI_REDFISH_ENDPOINT_V1_5_1_CS *EndpointV1_5_1Cs;
  ...
  Status = (EFI_STATUS)Json_Endpoint_V1_5_1_To_CS (ResoruceRaw, &EndpointV1_5_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointV1_5_1 = (EFI_REDFISH_ENDPOINT_V1_5_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINT_V1_5_1));
  if (EndpointV1_5_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EndpointV1_5_1;
  EndpointV1_5_1->Endpoint = EndpointV1_5_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Endpoint_V1_5_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Endpoint_V1_5_1_JSON (*((EFI_REDFISH_ENDPOINT_V1_5_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Endpoint_V1_5_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EndpointV1_5_1 = (EFI_REDFISH_ENDPOINT_V1_5_1 *)InterpProp;
  DestroyEndpoint_V1_5_1_CS (EndpointV1_5_1->Endpoint); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEndpoint_V1_5_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpoint_V1_5_1EntryPoint (
