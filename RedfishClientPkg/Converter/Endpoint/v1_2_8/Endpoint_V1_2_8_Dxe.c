...
//
#include <RedfishJsonStructure/Endpoint/v1_2_8/EfiEndpointV1_2_8.h>
CHAR8 mResourceTypeStr [] = "#Endpoint";
BOOLEAN IsRevisonController = TRUE;

// Support Endpoint V1_2_8
...
{
  EFI_REDFISH_ENDPOINT_V1_2_8 *EndpointV1_2_8;
  EFI_REDFISH_ENDPOINT_V1_2_8_CS *EndpointV1_2_8Cs;
  ...
  Status = (EFI_STATUS)Json_Endpoint_V1_2_8_To_CS (ResoruceRaw, &EndpointV1_2_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EndpointV1_2_8 = (EFI_REDFISH_ENDPOINT_V1_2_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENDPOINT_V1_2_8));
  if (EndpointV1_2_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EndpointV1_2_8;
  EndpointV1_2_8->Endpoint = EndpointV1_2_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Endpoint_V1_2_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Endpoint_V1_2_8_JSON (*((EFI_REDFISH_ENDPOINT_V1_2_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Endpoint_V1_2_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EndpointV1_2_8 = (EFI_REDFISH_ENDPOINT_V1_2_8 *)InterpProp;
  DestroyEndpoint_V1_2_8_CS (EndpointV1_2_8->Endpoint); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEndpoint_V1_2_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEndpoint_V1_2_8EntryPoint (
