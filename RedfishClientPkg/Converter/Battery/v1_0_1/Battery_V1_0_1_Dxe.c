...
//
#include <RedfishJsonStructure/Battery/v1_0_1/EfiBatteryV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#Battery";
BOOLEAN IsRevisonController = TRUE;

// Support Battery V1_0_1
...
{
  EFI_REDFISH_BATTERY_V1_0_1 *BatteryV1_0_1;
  EFI_REDFISH_BATTERY_V1_0_1_CS *BatteryV1_0_1Cs;
  ...
  Status = (EFI_STATUS)Json_Battery_V1_0_1_To_CS (ResoruceRaw, &BatteryV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  BatteryV1_0_1 = (EFI_REDFISH_BATTERY_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_BATTERY_V1_0_1));
  if (BatteryV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)BatteryV1_0_1;
  BatteryV1_0_1->Battery = BatteryV1_0_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Battery_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Battery_V1_0_1_JSON (*((EFI_REDFISH_BATTERY_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Battery_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  BatteryV1_0_1 = (EFI_REDFISH_BATTERY_V1_0_1 *)InterpProp;
  DestroyBattery_V1_0_1_CS (BatteryV1_0_1->Battery); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyBattery_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishBattery_V1_0_1EntryPoint (
