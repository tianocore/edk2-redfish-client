...
//
#include <RedfishJsonStructure/CompositionReservation/v1_0_0/EfiCompositionReservationV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#CompositionReservation";
BOOLEAN IsRevisonController = TRUE;

// Support CompositionReservation V1_0_0
...
EFI_STATUS
EFIAPI
CompositionReservationToStruct (
...
{
  EFI_REDFISH_COMPOSITIONRESERVATION_V1_0_0 *CompositionReservationV1_0_0;
  EFI_REDFISH_COMPOSITIONRESERVATION_V1_0_0_CS *CompositionReservationV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "CompositionReservation") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_CompositionReservation_V1_0_0_To_CS (ResoruceRaw, &CompositionReservationV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CompositionReservationV1_0_0 = (EFI_REDFISH_COMPOSITIONRESERVATION_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPOSITIONRESERVATION_V1_0_0));
  if (CompositionReservationV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)CompositionReservationV1_0_0;
  CompositionReservationV1_0_0->CompositionReservation = CompositionReservationV1_0_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("CompositionReservation"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("CompositionReservation"), "CompositionReservation");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("CompositionReservation"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("CompositionReservation"), "CompositionReservation");
...
/**
  The wrapper function of CompositionReservationToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
CompositionReservationToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return CompositionReservationToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_CompositionReservation_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_CompositionReservation_V1_0_0_JSON (*((EFI_REDFISH_COMPOSITIONRESERVATION_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_CompositionReservation_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in CompositionReservationToStruct.
...
EFI_STATUS
EFIAPI
CompositionReservationDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  CompositionReservationV1_0_0 = (EFI_REDFISH_COMPOSITIONRESERVATION_V1_0_0 *)InterpProp;
  DestroyCompositionReservation_V1_0_0_CS (CompositionReservationV1_0_0->CompositionReservation); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from CompositionReservationFromStruct
...
EFI_STATUS
EFIAPI
CompositionReservationDestoryJson(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL *This,
...
)
{
  ...
  return (EFI_STATUS)DestroyCompositionReservation_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCompositionReservation_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishCompositionReservation_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
