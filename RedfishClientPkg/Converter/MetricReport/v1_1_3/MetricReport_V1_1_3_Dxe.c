...
//
#include <RedfishJsonStructure/MetricReport/v1_1_3/EfiMetricReportV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#MetricReport";
BOOLEAN IsRevisonController = TRUE;

// Support MetricReport V1_1_3
...
{
  EFI_REDFISH_METRICREPORT_V1_1_3 *MetricReportV1_1_3;
  EFI_REDFISH_METRICREPORT_V1_1_3_CS *MetricReportV1_1_3Cs;
  ...
  Status = (EFI_STATUS)Json_MetricReport_V1_1_3_To_CS (ResoruceRaw, &MetricReportV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MetricReportV1_1_3 = (EFI_REDFISH_METRICREPORT_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_METRICREPORT_V1_1_3));
  if (MetricReportV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MetricReportV1_1_3;
  MetricReportV1_1_3->MetricReport = MetricReportV1_1_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MetricReport_V1_1_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MetricReport_V1_1_3_JSON (*((EFI_REDFISH_METRICREPORT_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MetricReport_V1_1_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MetricReportV1_1_3 = (EFI_REDFISH_METRICREPORT_V1_1_3 *)InterpProp;
  DestroyMetricReport_V1_1_3_CS (MetricReportV1_1_3->MetricReport); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMetricReport_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMetricReport_V1_1_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMetricReport_V1_1_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
