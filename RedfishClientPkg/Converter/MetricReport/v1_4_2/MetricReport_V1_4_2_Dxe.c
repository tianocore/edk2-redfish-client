...
//
#include <RedfishJsonStructure/MetricReport/v1_4_2/EfiMetricReportV1_4_2.h>
CHAR8 mResourceTypeStr [] = "#MetricReport";
BOOLEAN IsRevisonController = TRUE;

// Support MetricReport V1_4_2
...
{
  EFI_REDFISH_METRICREPORT_V1_4_2 *MetricReportV1_4_2;
  EFI_REDFISH_METRICREPORT_V1_4_2_CS *MetricReportV1_4_2Cs;
  ...
  Status = (EFI_STATUS)Json_MetricReport_V1_4_2_To_CS (ResoruceRaw, &MetricReportV1_4_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MetricReportV1_4_2 = (EFI_REDFISH_METRICREPORT_V1_4_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_METRICREPORT_V1_4_2));
  if (MetricReportV1_4_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MetricReportV1_4_2;
  MetricReportV1_4_2->MetricReport = MetricReportV1_4_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MetricReport_V1_4_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MetricReport_V1_4_2_JSON (*((EFI_REDFISH_METRICREPORT_V1_4_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MetricReport_V1_4_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MetricReportV1_4_2 = (EFI_REDFISH_METRICREPORT_V1_4_2 *)InterpProp;
  DestroyMetricReport_V1_4_2_CS (MetricReportV1_4_2->MetricReport); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMetricReport_V1_4_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMetricReport_V1_4_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMetricReport_V1_4_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
