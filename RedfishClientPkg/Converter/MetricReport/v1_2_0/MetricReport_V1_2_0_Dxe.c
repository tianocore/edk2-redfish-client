...
//
#include <RedfishJsonStructure/MetricReport/v1_2_0/EfiMetricReportV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#MetricReport";
BOOLEAN IsRevisonController = TRUE;

// Support MetricReport V1_2_0
...
{
  EFI_REDFISH_METRICREPORT_V1_2_0 *MetricReportV1_2_0;
  EFI_REDFISH_METRICREPORT_V1_2_0_CS *MetricReportV1_2_0Cs;
  ...
  Status = (EFI_STATUS)Json_MetricReport_V1_2_0_To_CS (ResoruceRaw, &MetricReportV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MetricReportV1_2_0 = (EFI_REDFISH_METRICREPORT_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_METRICREPORT_V1_2_0));
  if (MetricReportV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MetricReportV1_2_0;
  MetricReportV1_2_0->MetricReport = MetricReportV1_2_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MetricReport_V1_2_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MetricReport_V1_2_0_JSON (*((EFI_REDFISH_METRICREPORT_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MetricReport_V1_2_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MetricReportV1_2_0 = (EFI_REDFISH_METRICREPORT_V1_2_0 *)InterpProp;
  DestroyMetricReport_V1_2_0_CS (MetricReportV1_2_0->MetricReport); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMetricReport_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMetricReport_V1_2_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMetricReport_V1_2_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
