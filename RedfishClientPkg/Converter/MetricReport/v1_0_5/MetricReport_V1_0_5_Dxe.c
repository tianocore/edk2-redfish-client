...
//
#include <RedfishJsonStructure/MetricReport/v1_0_5/EfiMetricReportV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#MetricReport";
BOOLEAN IsRevisonController = TRUE;

// Support MetricReport V1_0_5
...
{
  EFI_REDFISH_METRICREPORT_V1_0_5 *MetricReportV1_0_5;
  EFI_REDFISH_METRICREPORT_V1_0_5_CS *MetricReportV1_0_5Cs;
  ...
  Status = (EFI_STATUS)Json_MetricReport_V1_0_5_To_CS (ResoruceRaw, &MetricReportV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MetricReportV1_0_5 = (EFI_REDFISH_METRICREPORT_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_METRICREPORT_V1_0_5));
  if (MetricReportV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MetricReportV1_0_5;
  MetricReportV1_0_5->MetricReport = MetricReportV1_0_5Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("MetricReport"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("MetricReport"), "MetricReport");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("MetricReport"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("MetricReport"), "MetricReport");
...
/**
  The wrapper function of MetricReportToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MetricReport_V1_0_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MetricReport_V1_0_5_JSON (*((EFI_REDFISH_METRICREPORT_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MetricReport_V1_0_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MetricReportV1_0_5 = (EFI_REDFISH_METRICREPORT_V1_0_5 *)InterpProp;
  DestroyMetricReport_V1_0_5_CS (MetricReportV1_0_5->MetricReport); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from MetricReportFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyMetricReport_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMetricReport_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMetricReport_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
