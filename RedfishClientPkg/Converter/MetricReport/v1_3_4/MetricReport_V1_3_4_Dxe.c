...
//
#include <RedfishJsonStructure/MetricReport/v1_3_4/EfiMetricReportV1_3_4.h>
CHAR8 mResourceTypeStr [] = "#MetricReport";
BOOLEAN IsRevisonController = TRUE;

// Support MetricReport V1_3_4
...
{
  EFI_REDFISH_METRICREPORT_V1_3_4 *MetricReportV1_3_4;
  EFI_REDFISH_METRICREPORT_V1_3_4_CS *MetricReportV1_3_4Cs;
  ...
  Status = (EFI_STATUS)Json_MetricReport_V1_3_4_To_CS (ResoruceRaw, &MetricReportV1_3_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MetricReportV1_3_4 = (EFI_REDFISH_METRICREPORT_V1_3_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_METRICREPORT_V1_3_4));
  if (MetricReportV1_3_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MetricReportV1_3_4;
  MetricReportV1_3_4->MetricReport = MetricReportV1_3_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MetricReport_V1_3_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MetricReport_V1_3_4_JSON (*((EFI_REDFISH_METRICREPORT_V1_3_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MetricReport_V1_3_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MetricReportV1_3_4 = (EFI_REDFISH_METRICREPORT_V1_3_4 *)InterpProp;
  DestroyMetricReport_V1_3_4_CS (MetricReportV1_3_4->MetricReport); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMetricReport_V1_3_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMetricReport_V1_3_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMetricReport_V1_3_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
