...
)
{
  ...
  return (EFI_STATUS)CS_To_MetricReport_V1_0_4_JSON (*((EFI_REDFISH_METRICREPORT_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
