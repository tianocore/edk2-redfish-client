...
)
{
  ...
  return (EFI_STATUS)CS_To_USBController_V1_0_0_JSON (*((EFI_REDFISH_USBCONTROLLER_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
