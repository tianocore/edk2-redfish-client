...
//
#include <RedfishJsonStructure/MemoryMetrics/v1_2_0/EfiMemoryMetricsV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#MemoryMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryMetrics V1_2_0
...
{
  EFI_REDFISH_MEMORYMETRICS_V1_2_0 *MemoryMetricsV1_2_0;
  EFI_REDFISH_MEMORYMETRICS_V1_2_0_CS *MemoryMetricsV1_2_0Cs;
  ...
  Status = (EFI_STATUS)Json_MemoryMetrics_V1_2_0_To_CS (ResoruceRaw, &MemoryMetricsV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryMetricsV1_2_0 = (EFI_REDFISH_MEMORYMETRICS_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYMETRICS_V1_2_0));
  if (MemoryMetricsV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryMetricsV1_2_0;
  MemoryMetricsV1_2_0->MemoryMetrics = MemoryMetricsV1_2_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MemoryMetrics_V1_2_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MemoryMetrics_V1_2_0_JSON (*((EFI_REDFISH_MEMORYMETRICS_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MemoryMetrics_V1_2_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryMetricsV1_2_0 = (EFI_REDFISH_MEMORYMETRICS_V1_2_0 *)InterpProp;
  DestroyMemoryMetrics_V1_2_0_CS (MemoryMetricsV1_2_0->MemoryMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemoryMetrics_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_2_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_2_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
