...
//
#include <RedfishJsonStructure/MemoryMetrics/v1_4_1/EfiMemoryMetricsV1_4_1.h>
CHAR8 mResourceTypeStr [] = "#MemoryMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryMetrics V1_4_1
...
{
  EFI_REDFISH_MEMORYMETRICS_V1_4_1 *MemoryMetricsV1_4_1;
  EFI_REDFISH_MEMORYMETRICS_V1_4_1_CS *MemoryMetricsV1_4_1Cs;
  ...
  Status = (EFI_STATUS)Json_MemoryMetrics_V1_4_1_To_CS (ResoruceRaw, &MemoryMetricsV1_4_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryMetricsV1_4_1 = (EFI_REDFISH_MEMORYMETRICS_V1_4_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYMETRICS_V1_4_1));
  if (MemoryMetricsV1_4_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryMetricsV1_4_1;
  MemoryMetricsV1_4_1->MemoryMetrics = MemoryMetricsV1_4_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MemoryMetrics_V1_4_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MemoryMetrics_V1_4_1_JSON (*((EFI_REDFISH_MEMORYMETRICS_V1_4_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MemoryMetrics_V1_4_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryMetricsV1_4_1 = (EFI_REDFISH_MEMORYMETRICS_V1_4_1 *)InterpProp;
  DestroyMemoryMetrics_V1_4_1_CS (MemoryMetricsV1_4_1->MemoryMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemoryMetrics_V1_4_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_4_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_4_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
