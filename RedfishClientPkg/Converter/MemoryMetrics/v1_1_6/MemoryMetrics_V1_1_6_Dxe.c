...
//
#include <RedfishJsonStructure/MemoryMetrics/v1_1_6/EfiMemoryMetricsV1_1_6.h>
CHAR8 mResourceTypeStr [] = "#MemoryMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryMetrics V1_1_6
...
{
  EFI_REDFISH_MEMORYMETRICS_V1_1_6 *MemoryMetricsV1_1_6;
  EFI_REDFISH_MEMORYMETRICS_V1_1_6_CS *MemoryMetricsV1_1_6Cs;
  ...
  Status = (EFI_STATUS)Json_MemoryMetrics_V1_1_6_To_CS (ResoruceRaw, &MemoryMetricsV1_1_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryMetricsV1_1_6 = (EFI_REDFISH_MEMORYMETRICS_V1_1_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYMETRICS_V1_1_6));
  if (MemoryMetricsV1_1_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryMetricsV1_1_6;
  MemoryMetricsV1_1_6->MemoryMetrics = MemoryMetricsV1_1_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MemoryMetrics_V1_1_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MemoryMetrics_V1_1_6_JSON (*((EFI_REDFISH_MEMORYMETRICS_V1_1_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MemoryMetrics_V1_1_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryMetricsV1_1_6 = (EFI_REDFISH_MEMORYMETRICS_V1_1_6 *)InterpProp;
  DestroyMemoryMetrics_V1_1_6_CS (MemoryMetricsV1_1_6->MemoryMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemoryMetrics_V1_1_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_1_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_1_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
