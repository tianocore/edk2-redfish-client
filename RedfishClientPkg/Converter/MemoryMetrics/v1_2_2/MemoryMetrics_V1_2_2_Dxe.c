...
//
#include <RedfishJsonStructure/MemoryMetrics/v1_2_2/EfiMemoryMetricsV1_2_2.h>
CHAR8 mResourceTypeStr [] = "#MemoryMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryMetrics V1_2_2
...
{
  EFI_REDFISH_MEMORYMETRICS_V1_2_2 *MemoryMetricsV1_2_2;
  EFI_REDFISH_MEMORYMETRICS_V1_2_2_CS *MemoryMetricsV1_2_2Cs;
  ...
  Status = (EFI_STATUS)Json_MemoryMetrics_V1_2_2_To_CS (ResoruceRaw, &MemoryMetricsV1_2_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryMetricsV1_2_2 = (EFI_REDFISH_MEMORYMETRICS_V1_2_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYMETRICS_V1_2_2));
  if (MemoryMetricsV1_2_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryMetricsV1_2_2;
  MemoryMetricsV1_2_2->MemoryMetrics = MemoryMetricsV1_2_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MemoryMetrics_V1_2_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MemoryMetrics_V1_2_2_JSON (*((EFI_REDFISH_MEMORYMETRICS_V1_2_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MemoryMetrics_V1_2_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryMetricsV1_2_2 = (EFI_REDFISH_MEMORYMETRICS_V1_2_2 *)InterpProp;
  DestroyMemoryMetrics_V1_2_2_CS (MemoryMetricsV1_2_2->MemoryMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemoryMetrics_V1_2_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_2_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_2_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
