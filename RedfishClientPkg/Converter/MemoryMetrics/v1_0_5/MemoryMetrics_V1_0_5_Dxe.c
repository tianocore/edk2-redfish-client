...
//
#include <RedfishJsonStructure/MemoryMetrics/v1_0_5/EfiMemoryMetricsV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#MemoryMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryMetrics V1_0_5
...
{
  EFI_REDFISH_MEMORYMETRICS_V1_0_5 *MemoryMetricsV1_0_5;
  EFI_REDFISH_MEMORYMETRICS_V1_0_5_CS *MemoryMetricsV1_0_5Cs;
  ...
  Status = (EFI_STATUS)Json_MemoryMetrics_V1_0_5_To_CS (ResoruceRaw, &MemoryMetricsV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryMetricsV1_0_5 = (EFI_REDFISH_MEMORYMETRICS_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYMETRICS_V1_0_5));
  if (MemoryMetricsV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryMetricsV1_0_5;
  MemoryMetricsV1_0_5->MemoryMetrics = MemoryMetricsV1_0_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MemoryMetrics_V1_0_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MemoryMetrics_V1_0_5_JSON (*((EFI_REDFISH_MEMORYMETRICS_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MemoryMetrics_V1_0_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryMetricsV1_0_5 = (EFI_REDFISH_MEMORYMETRICS_V1_0_5 *)InterpProp;
  DestroyMemoryMetrics_V1_0_5_CS (MemoryMetricsV1_0_5->MemoryMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemoryMetrics_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
