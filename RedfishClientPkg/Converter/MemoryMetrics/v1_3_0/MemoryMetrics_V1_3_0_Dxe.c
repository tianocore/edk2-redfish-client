...
//
#include <RedfishJsonStructure/MemoryMetrics/v1_3_0/EfiMemoryMetricsV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#MemoryMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryMetrics V1_3_0
...
{
  EFI_REDFISH_MEMORYMETRICS_V1_3_0 *MemoryMetricsV1_3_0;
  EFI_REDFISH_MEMORYMETRICS_V1_3_0_CS *MemoryMetricsV1_3_0Cs;
  ...
  Status = (EFI_STATUS)Json_MemoryMetrics_V1_3_0_To_CS (ResoruceRaw, &MemoryMetricsV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryMetricsV1_3_0 = (EFI_REDFISH_MEMORYMETRICS_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYMETRICS_V1_3_0));
  if (MemoryMetricsV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryMetricsV1_3_0;
  MemoryMetricsV1_3_0->MemoryMetrics = MemoryMetricsV1_3_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MemoryMetrics_V1_3_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MemoryMetrics_V1_3_0_JSON (*((EFI_REDFISH_MEMORYMETRICS_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MemoryMetrics_V1_3_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryMetricsV1_3_0 = (EFI_REDFISH_MEMORYMETRICS_V1_3_0 *)InterpProp;
  DestroyMemoryMetrics_V1_3_0_CS (MemoryMetricsV1_3_0->MemoryMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemoryMetrics_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_3_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryMetrics_V1_3_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
