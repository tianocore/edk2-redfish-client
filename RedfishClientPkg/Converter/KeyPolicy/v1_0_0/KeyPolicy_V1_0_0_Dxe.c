...
//
#include <RedfishJsonStructure/KeyPolicy/v1_0_0/EfiKeyPolicyV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#KeyPolicy";
BOOLEAN IsRevisonController = TRUE;

// Support KeyPolicy V1_0_0
...
{
  EFI_REDFISH_KEYPOLICY_V1_0_0 *KeyPolicyV1_0_0;
  EFI_REDFISH_KEYPOLICY_V1_0_0_CS *KeyPolicyV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "KeyPolicy") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_KeyPolicy_V1_0_0_To_CS (ResoruceRaw, &KeyPolicyV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  KeyPolicyV1_0_0 = (EFI_REDFISH_KEYPOLICY_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_KEYPOLICY_V1_0_0));
  if (KeyPolicyV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)KeyPolicyV1_0_0;
  KeyPolicyV1_0_0->KeyPolicy = KeyPolicyV1_0_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("KeyPolicy"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("KeyPolicy"), "KeyPolicy");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("KeyPolicy"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("KeyPolicy"), "KeyPolicy");
...
/**
  The wrapper function of KeyPolicyToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_KeyPolicy_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_KeyPolicy_V1_0_0_JSON (*((EFI_REDFISH_KEYPOLICY_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_KeyPolicy_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in KeyPolicyToStruct.
...
)
{
  ...
  KeyPolicyV1_0_0 = (EFI_REDFISH_KEYPOLICY_V1_0_0 *)InterpProp;
  DestroyKeyPolicy_V1_0_0_CS (KeyPolicyV1_0_0->KeyPolicy); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from KeyPolicyFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyKeyPolicy_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishKeyPolicy_V1_0_0EntryPoint (
