...
//
#include <RedfishJsonStructure/Volume/v1_2_0/EfiVolumeV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#Volume";
BOOLEAN IsRevisonController = TRUE;

// Support Volume V1_2_0
...
{
  EFI_REDFISH_VOLUME_V1_2_0 *VolumeV1_2_0;
  EFI_REDFISH_VOLUME_V1_2_0_CS *VolumeV1_2_0Cs;
  ...
  Status = (EFI_STATUS)Json_Volume_V1_2_0_To_CS (ResoruceRaw, &VolumeV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VolumeV1_2_0 = (EFI_REDFISH_VOLUME_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VOLUME_V1_2_0));
  if (VolumeV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)VolumeV1_2_0;
  VolumeV1_2_0->Volume = VolumeV1_2_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Volume_V1_2_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Volume_V1_2_0_JSON (*((EFI_REDFISH_VOLUME_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Volume_V1_2_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  VolumeV1_2_0 = (EFI_REDFISH_VOLUME_V1_2_0 *)InterpProp;
  DestroyVolume_V1_2_0_CS (VolumeV1_2_0->Volume); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyVolume_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVolume_V1_2_0EntryPoint (
