...
//
#include <RedfishJsonStructure/Volume/v1_3_2/EfiVolumeV1_3_2.h>
CHAR8 mResourceTypeStr [] = "#Volume";
BOOLEAN IsRevisonController = TRUE;

// Support Volume V1_3_2
...
{
  EFI_REDFISH_VOLUME_V1_3_2 *VolumeV1_3_2;
  EFI_REDFISH_VOLUME_V1_3_2_CS *VolumeV1_3_2Cs;
  ...
  Status = (EFI_STATUS)Json_Volume_V1_3_2_To_CS (ResoruceRaw, &VolumeV1_3_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VolumeV1_3_2 = (EFI_REDFISH_VOLUME_V1_3_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VOLUME_V1_3_2));
  if (VolumeV1_3_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)VolumeV1_3_2;
  VolumeV1_3_2->Volume = VolumeV1_3_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Volume_V1_3_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Volume_V1_3_2_JSON (*((EFI_REDFISH_VOLUME_V1_3_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Volume_V1_3_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  VolumeV1_3_2 = (EFI_REDFISH_VOLUME_V1_3_2 *)InterpProp;
  DestroyVolume_V1_3_2_CS (VolumeV1_3_2->Volume); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyVolume_V1_3_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVolume_V1_3_2EntryPoint (
