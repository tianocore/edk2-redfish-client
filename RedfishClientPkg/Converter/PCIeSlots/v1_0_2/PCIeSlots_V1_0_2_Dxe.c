...
//
#include <RedfishJsonStructure/PCIeSlots/v1_0_2/EfiPCIeSlotsV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#PCIeSlots";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeSlots V1_0_2
...
{
  EFI_REDFISH_PCIESLOTS_V1_0_2 *PCIeSlotsV1_0_2;
  EFI_REDFISH_PCIESLOTS_V1_0_2_CS *PCIeSlotsV1_0_2Cs;
  ...
  Status = (EFI_STATUS)Json_PCIeSlots_V1_0_2_To_CS (ResoruceRaw, &PCIeSlotsV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeSlotsV1_0_2 = (EFI_REDFISH_PCIESLOTS_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIESLOTS_V1_0_2));
  if (PCIeSlotsV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PCIeSlotsV1_0_2;
  PCIeSlotsV1_0_2->PCIeSlots = PCIeSlotsV1_0_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PCIeSlots_V1_0_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PCIeSlots_V1_0_2_JSON (*((EFI_REDFISH_PCIESLOTS_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PCIeSlots_V1_0_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PCIeSlotsV1_0_2 = (EFI_REDFISH_PCIESLOTS_V1_0_2 *)InterpProp;
  DestroyPCIeSlots_V1_0_2_CS (PCIeSlotsV1_0_2->PCIeSlots); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPCIeSlots_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeSlots_V1_0_2EntryPoint (
