...
//
#include <RedfishJsonStructure/PCIeSlots/v1_1_1/EfiPCIeSlotsV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#PCIeSlots";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeSlots V1_1_1
...
{
  EFI_REDFISH_PCIESLOTS_V1_1_1 *PCIeSlotsV1_1_1;
  EFI_REDFISH_PCIESLOTS_V1_1_1_CS *PCIeSlotsV1_1_1Cs;
  ...
  Status = (EFI_STATUS)Json_PCIeSlots_V1_1_1_To_CS (ResoruceRaw, &PCIeSlotsV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeSlotsV1_1_1 = (EFI_REDFISH_PCIESLOTS_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIESLOTS_V1_1_1));
  if (PCIeSlotsV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PCIeSlotsV1_1_1;
  PCIeSlotsV1_1_1->PCIeSlots = PCIeSlotsV1_1_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PCIeSlots_V1_1_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PCIeSlots_V1_1_1_JSON (*((EFI_REDFISH_PCIESLOTS_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PCIeSlots_V1_1_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PCIeSlotsV1_1_1 = (EFI_REDFISH_PCIESLOTS_V1_1_1 *)InterpProp;
  DestroyPCIeSlots_V1_1_1_CS (PCIeSlotsV1_1_1->PCIeSlots); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPCIeSlots_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeSlots_V1_1_1EntryPoint (
