...
//
#include <RedfishJsonStructure/PCIeSlots/v1_4_1/EfiPCIeSlotsV1_4_1.h>
CHAR8 mResourceTypeStr [] = "#PCIeSlots";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeSlots V1_4_1
...
{
  EFI_REDFISH_PCIESLOTS_V1_4_1 *PCIeSlotsV1_4_1;
  EFI_REDFISH_PCIESLOTS_V1_4_1_CS *PCIeSlotsV1_4_1Cs;
  ...
  Status = (EFI_STATUS)Json_PCIeSlots_V1_4_1_To_CS (ResoruceRaw, &PCIeSlotsV1_4_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeSlotsV1_4_1 = (EFI_REDFISH_PCIESLOTS_V1_4_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIESLOTS_V1_4_1));
  if (PCIeSlotsV1_4_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PCIeSlotsV1_4_1;
  PCIeSlotsV1_4_1->PCIeSlots = PCIeSlotsV1_4_1Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("PCIeSlots"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("PCIeSlots"), "PCIeSlots");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("PCIeSlots"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("PCIeSlots"), "PCIeSlots");
...
/**
  The wrapper function of PCIeSlotsToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PCIeSlots_V1_4_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PCIeSlots_V1_4_1_JSON (*((EFI_REDFISH_PCIESLOTS_V1_4_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PCIeSlots_V1_4_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PCIeSlotsV1_4_1 = (EFI_REDFISH_PCIESLOTS_V1_4_1 *)InterpProp;
  DestroyPCIeSlots_V1_4_1_CS (PCIeSlotsV1_4_1->PCIeSlots); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from PCIeSlotsFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyPCIeSlots_V1_4_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeSlots_V1_4_1EntryPoint (
