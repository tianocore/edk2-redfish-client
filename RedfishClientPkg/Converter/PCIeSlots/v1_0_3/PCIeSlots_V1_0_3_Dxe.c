...
//
#include <RedfishJsonStructure/PCIeSlots/v1_0_3/EfiPCIeSlotsV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#PCIeSlots";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeSlots V1_0_3
...
{
  EFI_REDFISH_PCIESLOTS_V1_0_3 *PCIeSlotsV1_0_3;
  EFI_REDFISH_PCIESLOTS_V1_0_3_CS *PCIeSlotsV1_0_3Cs;
  ...
  Status = (EFI_STATUS)Json_PCIeSlots_V1_0_3_To_CS (ResoruceRaw, &PCIeSlotsV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeSlotsV1_0_3 = (EFI_REDFISH_PCIESLOTS_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIESLOTS_V1_0_3));
  if (PCIeSlotsV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PCIeSlotsV1_0_3;
  PCIeSlotsV1_0_3->PCIeSlots = PCIeSlotsV1_0_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PCIeSlots_V1_0_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PCIeSlots_V1_0_3_JSON (*((EFI_REDFISH_PCIESLOTS_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PCIeSlots_V1_0_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PCIeSlotsV1_0_3 = (EFI_REDFISH_PCIESLOTS_V1_0_3 *)InterpProp;
  DestroyPCIeSlots_V1_0_3_CS (PCIeSlotsV1_0_3->PCIeSlots); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPCIeSlots_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeSlots_V1_0_3EntryPoint (
