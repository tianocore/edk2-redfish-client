...
//
#include <RedfishJsonStructure/PCIeSlots/v1_2_0/EfiPCIeSlotsV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#PCIeSlots";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeSlots V1_2_0
...
{
  EFI_REDFISH_PCIESLOTS_V1_2_0 *PCIeSlotsV1_2_0;
  EFI_REDFISH_PCIESLOTS_V1_2_0_CS *PCIeSlotsV1_2_0Cs;
  ...
  Status = (EFI_STATUS)Json_PCIeSlots_V1_2_0_To_CS (ResoruceRaw, &PCIeSlotsV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeSlotsV1_2_0 = (EFI_REDFISH_PCIESLOTS_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIESLOTS_V1_2_0));
  if (PCIeSlotsV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PCIeSlotsV1_2_0;
  PCIeSlotsV1_2_0->PCIeSlots = PCIeSlotsV1_2_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PCIeSlots_V1_2_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PCIeSlots_V1_2_0_JSON (*((EFI_REDFISH_PCIESLOTS_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PCIeSlots_V1_2_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PCIeSlotsV1_2_0 = (EFI_REDFISH_PCIESLOTS_V1_2_0 *)InterpProp;
  DestroyPCIeSlots_V1_2_0_CS (PCIeSlotsV1_2_0->PCIeSlots); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPCIeSlots_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeSlots_V1_2_0EntryPoint (
