...
//
#include <RedfishJsonStructure/BatteryMetrics/v1_0_0/EfiBatteryMetricsV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#BatteryMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support BatteryMetrics V1_0_0
...
{
  EFI_REDFISH_BATTERYMETRICS_V1_0_0 *BatteryMetricsV1_0_0;
  EFI_REDFISH_BATTERYMETRICS_V1_0_0_CS *BatteryMetricsV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "BatteryMetrics") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_BatteryMetrics_V1_0_0_To_CS (ResoruceRaw, &BatteryMetricsV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  BatteryMetricsV1_0_0 = (EFI_REDFISH_BATTERYMETRICS_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_BATTERYMETRICS_V1_0_0));
  if (BatteryMetricsV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)BatteryMetricsV1_0_0;
  BatteryMetricsV1_0_0->BatteryMetrics = BatteryMetricsV1_0_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("BatteryMetrics"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("BatteryMetrics"), "BatteryMetrics");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("BatteryMetrics"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("BatteryMetrics"), "BatteryMetrics");
...
/**
  The wrapper function of BatteryMetricsToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_BatteryMetrics_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_BatteryMetrics_V1_0_0_JSON (*((EFI_REDFISH_BATTERYMETRICS_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_BatteryMetrics_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in BatteryMetricsToStruct.
...
)
{
  ...
  BatteryMetricsV1_0_0 = (EFI_REDFISH_BATTERYMETRICS_V1_0_0 *)InterpProp;
  DestroyBatteryMetrics_V1_0_0_CS (BatteryMetricsV1_0_0->BatteryMetrics); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from BatteryMetricsFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyBatteryMetrics_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishBatteryMetrics_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishBatteryMetrics_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
