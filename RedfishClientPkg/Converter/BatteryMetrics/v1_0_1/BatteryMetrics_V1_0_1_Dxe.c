...
//
#include <RedfishJsonStructure/BatteryMetrics/v1_0_1/EfiBatteryMetricsV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#BatteryMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support BatteryMetrics V1_0_1
...
{
  EFI_REDFISH_BATTERYMETRICS_V1_0_1 *BatteryMetricsV1_0_1;
  EFI_REDFISH_BATTERYMETRICS_V1_0_1_CS *BatteryMetricsV1_0_1Cs;
  ...
  Status = (EFI_STATUS)Json_BatteryMetrics_V1_0_1_To_CS (ResoruceRaw, &BatteryMetricsV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  BatteryMetricsV1_0_1 = (EFI_REDFISH_BATTERYMETRICS_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_BATTERYMETRICS_V1_0_1));
  if (BatteryMetricsV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)BatteryMetricsV1_0_1;
  BatteryMetricsV1_0_1->BatteryMetrics = BatteryMetricsV1_0_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_BatteryMetrics_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_BatteryMetrics_V1_0_1_JSON (*((EFI_REDFISH_BATTERYMETRICS_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_BatteryMetrics_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  BatteryMetricsV1_0_1 = (EFI_REDFISH_BATTERYMETRICS_V1_0_1 *)InterpProp;
  DestroyBatteryMetrics_V1_0_1_CS (BatteryMetricsV1_0_1->BatteryMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyBatteryMetrics_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishBatteryMetrics_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishBatteryMetrics_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
