...
//
#include <RedfishJsonStructure/Outlet/v1_0_2/EfiOutletV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#Outlet";
BOOLEAN IsRevisonController = TRUE;

// Support Outlet V1_0_2
...
{
  EFI_REDFISH_OUTLET_V1_0_2 *OutletV1_0_2;
  EFI_REDFISH_OUTLET_V1_0_2_CS *OutletV1_0_2Cs;
  ...
  Status = (EFI_STATUS)Json_Outlet_V1_0_2_To_CS (ResoruceRaw, &OutletV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  OutletV1_0_2 = (EFI_REDFISH_OUTLET_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_OUTLET_V1_0_2));
  if (OutletV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)OutletV1_0_2;
  OutletV1_0_2->Outlet = OutletV1_0_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Outlet_V1_0_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Outlet_V1_0_2_JSON (*((EFI_REDFISH_OUTLET_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Outlet_V1_0_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  OutletV1_0_2 = (EFI_REDFISH_OUTLET_V1_0_2 *)InterpProp;
  DestroyOutlet_V1_0_2_CS (OutletV1_0_2->Outlet); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyOutlet_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishOutlet_V1_0_2EntryPoint (
