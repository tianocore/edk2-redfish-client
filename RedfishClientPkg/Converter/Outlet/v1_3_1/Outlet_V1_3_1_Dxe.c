...
//
#include <RedfishJsonStructure/Outlet/v1_3_1/EfiOutletV1_3_1.h>
CHAR8 mResourceTypeStr [] = "#Outlet";
BOOLEAN IsRevisonController = TRUE;

// Support Outlet V1_3_1
...
{
  EFI_REDFISH_OUTLET_V1_3_1 *OutletV1_3_1;
  EFI_REDFISH_OUTLET_V1_3_1_CS *OutletV1_3_1Cs;
  ...
  Status = (EFI_STATUS)Json_Outlet_V1_3_1_To_CS (ResoruceRaw, &OutletV1_3_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  OutletV1_3_1 = (EFI_REDFISH_OUTLET_V1_3_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_OUTLET_V1_3_1));
  if (OutletV1_3_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)OutletV1_3_1;
  OutletV1_3_1->Outlet = OutletV1_3_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Outlet_V1_3_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Outlet_V1_3_1_JSON (*((EFI_REDFISH_OUTLET_V1_3_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Outlet_V1_3_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  OutletV1_3_1 = (EFI_REDFISH_OUTLET_V1_3_1 *)InterpProp;
  DestroyOutlet_V1_3_1_CS (OutletV1_3_1->Outlet); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyOutlet_V1_3_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishOutlet_V1_3_1EntryPoint (
