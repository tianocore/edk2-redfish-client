...
//
#include <RedfishJsonStructure/VCATEntry/v1_0_0/EfiVCATEntryV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#VCATEntry";
BOOLEAN IsRevisonController = TRUE;

// Support VCATEntry V1_0_0
...
{
  EFI_REDFISH_VCATENTRY_V1_0_0 *VCATEntryV1_0_0;
  ...
  Status = (EFI_STATUS)Json_VCATEntry_V1_0_0_To_CS (ResoruceRaw, &VCATEntryV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VCATEntryV1_0_0 = (EFI_REDFISH_VCATENTRY_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VCATENTRY_V1_0_0));
  if (VCATEntryV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)VCATEntryV1_0_0;
  VCATEntryV1_0_0->VCATEntry = VCATEntryV1_0_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_VCATEntry_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_VCATEntry_V1_0_0_JSON (*((EFI_REDFISH_VCATENTRY_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_VCATEntry_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  VCATEntryV1_0_0 = (EFI_REDFISH_VCATENTRY_V1_0_0 *)InterpProp;
  DestroyVCATEntry_V1_0_0_CS (VCATEntryV1_0_0->VCATEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyVCATEntry_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVCATEntry_V1_0_0EntryPoint (
