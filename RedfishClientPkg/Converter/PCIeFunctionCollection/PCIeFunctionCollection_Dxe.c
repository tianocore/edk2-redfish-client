...
)
{
  ...
  return (EFI_STATUS)CS_To_PCIeFunctionCollection_JSON (*((EFI_REDFISH_PCIEFUNCTIONCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
