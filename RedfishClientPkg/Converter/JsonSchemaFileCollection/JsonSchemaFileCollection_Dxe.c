...
)
{
  ...
  return (EFI_STATUS)CS_To_JsonSchemaFileCollection_JSON (*((EFI_REDFISH_JSONSCHEMAFILECOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
