...
//
#include <RedfishJsonStructure/ServiceConditions/v1_0_0/EfiServiceConditionsV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#ServiceConditions";
BOOLEAN IsRevisonController = TRUE;

// Support ServiceConditions V1_0_0
...
{
  EFI_REDFISH_SERVICECONDITIONS_V1_0_0 *ServiceConditionsV1_0_0;
  EFI_REDFISH_SERVICECONDITIONS_V1_0_0_CS *ServiceConditionsV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "ServiceConditions") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_ServiceConditions_V1_0_0_To_CS (ResoruceRaw, &ServiceConditionsV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ServiceConditionsV1_0_0 = (EFI_REDFISH_SERVICECONDITIONS_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERVICECONDITIONS_V1_0_0));
  if (ServiceConditionsV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ServiceConditionsV1_0_0;
  ServiceConditionsV1_0_0->ServiceConditions = ServiceConditionsV1_0_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("ServiceConditions"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("ServiceConditions"), "ServiceConditions");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("ServiceConditions"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("ServiceConditions"), "ServiceConditions");
...
/**
  The wrapper function of ServiceConditionsToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
ServiceConditionsToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return ServiceConditionsToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ServiceConditions_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ServiceConditions_V1_0_0_JSON (*((EFI_REDFISH_SERVICECONDITIONS_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ServiceConditions_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in ServiceConditionsToStruct.
...
EFI_STATUS
EFIAPI
ServiceConditionsDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  ServiceConditionsV1_0_0 = (EFI_REDFISH_SERVICECONDITIONS_V1_0_0 *)InterpProp;
  DestroyServiceConditions_V1_0_0_CS (ServiceConditionsV1_0_0->ServiceConditions); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ServiceConditionsFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyServiceConditions_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishServiceConditions_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishServiceConditions_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
