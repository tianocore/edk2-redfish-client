...
//
#include <RedfishJsonStructure/PowerSupply/v1_0_1/EfiPowerSupplyV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#PowerSupply";
BOOLEAN IsRevisonController = TRUE;

// Support PowerSupply V1_0_1
...
{
  EFI_REDFISH_POWERSUPPLY_V1_0_1 *PowerSupplyV1_0_1;
  EFI_REDFISH_POWERSUPPLY_V1_0_1_CS *PowerSupplyV1_0_1Cs;
  ...
  Status = (EFI_STATUS)Json_PowerSupply_V1_0_1_To_CS (ResoruceRaw, &PowerSupplyV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerSupplyV1_0_1 = (EFI_REDFISH_POWERSUPPLY_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWERSUPPLY_V1_0_1));
  if (PowerSupplyV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerSupplyV1_0_1;
  PowerSupplyV1_0_1->PowerSupply = PowerSupplyV1_0_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PowerSupply_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PowerSupply_V1_0_1_JSON (*((EFI_REDFISH_POWERSUPPLY_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PowerSupply_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerSupplyV1_0_1 = (EFI_REDFISH_POWERSUPPLY_V1_0_1 *)InterpProp;
  DestroyPowerSupply_V1_0_1_CS (PowerSupplyV1_0_1->PowerSupply); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPowerSupply_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPowerSupply_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPowerSupply_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
