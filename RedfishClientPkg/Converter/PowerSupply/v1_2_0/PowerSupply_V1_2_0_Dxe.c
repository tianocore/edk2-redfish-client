...
//
#include <RedfishJsonStructure/PowerSupply/v1_2_0/EfiPowerSupplyV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#PowerSupply";
BOOLEAN IsRevisonController = TRUE;

// Support PowerSupply V1_2_0
...
{
  EFI_REDFISH_POWERSUPPLY_V1_2_0 *PowerSupplyV1_2_0;
  EFI_REDFISH_POWERSUPPLY_V1_2_0_CS *PowerSupplyV1_2_0Cs;
  ...
  Status = (EFI_STATUS)Json_PowerSupply_V1_2_0_To_CS (ResoruceRaw, &PowerSupplyV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerSupplyV1_2_0 = (EFI_REDFISH_POWERSUPPLY_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWERSUPPLY_V1_2_0));
  if (PowerSupplyV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerSupplyV1_2_0;
  PowerSupplyV1_2_0->PowerSupply = PowerSupplyV1_2_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PowerSupply_V1_2_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PowerSupply_V1_2_0_JSON (*((EFI_REDFISH_POWERSUPPLY_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PowerSupply_V1_2_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerSupplyV1_2_0 = (EFI_REDFISH_POWERSUPPLY_V1_2_0 *)InterpProp;
  DestroyPowerSupply_V1_2_0_CS (PowerSupplyV1_2_0->PowerSupply); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPowerSupply_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPowerSupply_V1_2_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPowerSupply_V1_2_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
