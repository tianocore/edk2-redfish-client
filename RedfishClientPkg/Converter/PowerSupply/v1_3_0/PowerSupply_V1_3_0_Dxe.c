...
//
#include <RedfishJsonStructure/PowerSupply/v1_3_0/EfiPowerSupplyV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#PowerSupply";
BOOLEAN IsRevisonController = TRUE;

// Support PowerSupply V1_3_0
...
{
  EFI_REDFISH_POWERSUPPLY_V1_3_0 *PowerSupplyV1_3_0;
  EFI_REDFISH_POWERSUPPLY_V1_3_0_CS *PowerSupplyV1_3_0Cs;
  ...
  Status = (EFI_STATUS)Json_PowerSupply_V1_3_0_To_CS (ResoruceRaw, &PowerSupplyV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerSupplyV1_3_0 = (EFI_REDFISH_POWERSUPPLY_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWERSUPPLY_V1_3_0));
  if (PowerSupplyV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerSupplyV1_3_0;
  PowerSupplyV1_3_0->PowerSupply = PowerSupplyV1_3_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PowerSupply_V1_3_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PowerSupply_V1_3_0_JSON (*((EFI_REDFISH_POWERSUPPLY_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PowerSupply_V1_3_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerSupplyV1_3_0 = (EFI_REDFISH_POWERSUPPLY_V1_3_0 *)InterpProp;
  DestroyPowerSupply_V1_3_0_CS (PowerSupplyV1_3_0->PowerSupply); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPowerSupply_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPowerSupply_V1_3_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPowerSupply_V1_3_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
