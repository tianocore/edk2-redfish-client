...
//
#include <RedfishJsonStructure/BootOption/v1_0_3/EfiBootOptionV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#BootOption";
BOOLEAN IsRevisonController = TRUE;

// Support BootOption V1_0_3
...
{
  EFI_REDFISH_BOOTOPTION_V1_0_3 *BootOptionV1_0_3;
  EFI_REDFISH_BOOTOPTION_V1_0_3_CS *BootOptionV1_0_3Cs;
  ...
  Status = (EFI_STATUS)Json_BootOption_V1_0_3_To_CS (ResoruceRaw, &BootOptionV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  BootOptionV1_0_3 = (EFI_REDFISH_BOOTOPTION_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_BOOTOPTION_V1_0_3));
  if (BootOptionV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)BootOptionV1_0_3;
  BootOptionV1_0_3->BootOption = BootOptionV1_0_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_BootOption_V1_0_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_BootOption_V1_0_3_JSON (*((EFI_REDFISH_BOOTOPTION_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_BootOption_V1_0_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  BootOptionV1_0_3 = (EFI_REDFISH_BOOTOPTION_V1_0_3 *)InterpProp;
  DestroyBootOption_V1_0_3_CS (BootOptionV1_0_3->BootOption); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyBootOption_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishBootOption_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishBootOption_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
