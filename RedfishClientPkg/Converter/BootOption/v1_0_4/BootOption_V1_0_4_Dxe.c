...
{
  EFI_REDFISH_BOOTOPTION_V1_0_4 *BootOptionV1_0_4;
  EFI_REDFISH_BOOTOPTION_V1_0_4_CS *BootOptionV1_0_4Cs;
  ...
  Status = (EFI_STATUS)Json_BootOption_V1_0_4_To_CS (ResoruceRaw, &BootOptionV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  BootOptionV1_0_4 = (EFI_REDFISH_BOOTOPTION_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_BOOTOPTION_V1_0_4));
  if (BootOptionV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)BootOptionV1_0_4;
  BootOptionV1_0_4->BootOption = BootOptionV1_0_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_BootOption_V1_0_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_BootOption_V1_0_4_JSON (*((EFI_REDFISH_BOOTOPTION_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_BootOption_V1_0_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  BootOptionV1_0_4 = (EFI_REDFISH_BOOTOPTION_V1_0_4 *)InterpProp;
  DestroyBootOption_V1_0_4_CS (BootOptionV1_0_4->BootOption); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyBootOption_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishBootOption_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishBootOption_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
