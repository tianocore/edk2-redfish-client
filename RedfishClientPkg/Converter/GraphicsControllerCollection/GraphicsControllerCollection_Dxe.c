...
)
{
  ...
  return (EFI_STATUS)CS_To_GraphicsControllerCollection_JSON (*((EFI_REDFISH_GRAPHICSCONTROLLERCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
