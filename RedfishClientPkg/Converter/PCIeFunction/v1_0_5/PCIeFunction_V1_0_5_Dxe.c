...
)
{
  ...
  return (EFI_STATUS)CS_To_PCIeFunction_V1_0_5_JSON (*((EFI_REDFISH_PCIEFUNCTION_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
