...
//
#include <RedfishJsonStructure/PCIeFunction/v1_2_3/EfiPCIeFunctionV1_2_3.h>
CHAR8 mResourceTypeStr [] = "#PCIeFunction";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeFunction V1_2_3
...
{
  EFI_REDFISH_PCIEFUNCTION_V1_2_3 *PCIeFunctionV1_2_3;
  EFI_REDFISH_PCIEFUNCTION_V1_2_3_CS *PCIeFunctionV1_2_3Cs;
  ...
  Status = (EFI_STATUS)Json_PCIeFunction_V1_2_3_To_CS (ResoruceRaw, &PCIeFunctionV1_2_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeFunctionV1_2_3 = (EFI_REDFISH_PCIEFUNCTION_V1_2_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEFUNCTION_V1_2_3));
  if (PCIeFunctionV1_2_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PCIeFunctionV1_2_3;
  PCIeFunctionV1_2_3->PCIeFunction = PCIeFunctionV1_2_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PCIeFunction_V1_2_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PCIeFunction_V1_2_3_JSON (*((EFI_REDFISH_PCIEFUNCTION_V1_2_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PCIeFunction_V1_2_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PCIeFunctionV1_2_3 = (EFI_REDFISH_PCIEFUNCTION_V1_2_3 *)InterpProp;
  DestroyPCIeFunction_V1_2_3_CS (PCIeFunctionV1_2_3->PCIeFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPCIeFunction_V1_2_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_2_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_2_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
