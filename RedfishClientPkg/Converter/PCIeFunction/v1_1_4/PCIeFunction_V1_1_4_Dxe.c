...
//
#include <RedfishJsonStructure/PCIeFunction/v1_1_4/EfiPCIeFunctionV1_1_4.h>
CHAR8 mResourceTypeStr [] = "#PCIeFunction";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeFunction V1_1_4
...
{
  EFI_REDFISH_PCIEFUNCTION_V1_1_4 *PCIeFunctionV1_1_4;
  EFI_REDFISH_PCIEFUNCTION_V1_1_4_CS *PCIeFunctionV1_1_4Cs;
  ...
  Status = (EFI_STATUS)Json_PCIeFunction_V1_1_4_To_CS (ResoruceRaw, &PCIeFunctionV1_1_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeFunctionV1_1_4 = (EFI_REDFISH_PCIEFUNCTION_V1_1_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEFUNCTION_V1_1_4));
  if (PCIeFunctionV1_1_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PCIeFunctionV1_1_4;
  PCIeFunctionV1_1_4->PCIeFunction = PCIeFunctionV1_1_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PCIeFunction_V1_1_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PCIeFunction_V1_1_4_JSON (*((EFI_REDFISH_PCIEFUNCTION_V1_1_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PCIeFunction_V1_1_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PCIeFunctionV1_1_4 = (EFI_REDFISH_PCIEFUNCTION_V1_1_4 *)InterpProp;
  DestroyPCIeFunction_V1_1_4_CS (PCIeFunctionV1_1_4->PCIeFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPCIeFunction_V1_1_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_1_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_1_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
