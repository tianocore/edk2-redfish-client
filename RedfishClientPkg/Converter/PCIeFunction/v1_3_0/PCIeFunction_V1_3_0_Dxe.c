...
//
#include <RedfishJsonStructure/PCIeFunction/v1_3_0/EfiPCIeFunctionV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#PCIeFunction";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeFunction V1_3_0
...
{
  EFI_REDFISH_PCIEFUNCTION_V1_3_0 *PCIeFunctionV1_3_0;
  EFI_REDFISH_PCIEFUNCTION_V1_3_0_CS *PCIeFunctionV1_3_0Cs;
  ...
  Status = (EFI_STATUS)Json_PCIeFunction_V1_3_0_To_CS (ResoruceRaw, &PCIeFunctionV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeFunctionV1_3_0 = (EFI_REDFISH_PCIEFUNCTION_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEFUNCTION_V1_3_0));
  if (PCIeFunctionV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PCIeFunctionV1_3_0;
  PCIeFunctionV1_3_0->PCIeFunction = PCIeFunctionV1_3_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PCIeFunction_V1_3_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PCIeFunction_V1_3_0_JSON (*((EFI_REDFISH_PCIEFUNCTION_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PCIeFunction_V1_3_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PCIeFunctionV1_3_0 = (EFI_REDFISH_PCIEFUNCTION_V1_3_0 *)InterpProp;
  DestroyPCIeFunction_V1_3_0_CS (PCIeFunctionV1_3_0->PCIeFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPCIeFunction_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_3_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_3_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
