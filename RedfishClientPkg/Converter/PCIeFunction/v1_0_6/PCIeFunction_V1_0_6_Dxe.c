...
//
#include <RedfishJsonStructure/PCIeFunction/v1_0_6/EfiPCIeFunctionV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#PCIeFunction";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeFunction V1_0_6
...
{
  EFI_REDFISH_PCIEFUNCTION_V1_0_6 *PCIeFunctionV1_0_6;
  EFI_REDFISH_PCIEFUNCTION_V1_0_6_CS *PCIeFunctionV1_0_6Cs;
  ...
  Status = (EFI_STATUS)Json_PCIeFunction_V1_0_6_To_CS (ResoruceRaw, &PCIeFunctionV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeFunctionV1_0_6 = (EFI_REDFISH_PCIEFUNCTION_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEFUNCTION_V1_0_6));
  if (PCIeFunctionV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PCIeFunctionV1_0_6;
  PCIeFunctionV1_0_6->PCIeFunction = PCIeFunctionV1_0_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PCIeFunction_V1_0_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PCIeFunction_V1_0_6_JSON (*((EFI_REDFISH_PCIEFUNCTION_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PCIeFunction_V1_0_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PCIeFunctionV1_0_6 = (EFI_REDFISH_PCIEFUNCTION_V1_0_6 *)InterpProp;
  DestroyPCIeFunction_V1_0_6_CS (PCIeFunctionV1_0_6->PCIeFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPCIeFunction_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_0_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeFunction_V1_0_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
