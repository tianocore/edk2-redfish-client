...
)
{
  ...
  return (EFI_STATUS)CS_To_PCIeFunction_V1_1_3_JSON (*((EFI_REDFISH_PCIEFUNCTION_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
