...
//
#include <RedfishJsonStructure/Storage/v1_2_4/EfiStorageV1_2_4.h>
CHAR8 mResourceTypeStr [] = "#Storage";
BOOLEAN IsRevisonController = TRUE;

// Support Storage V1_2_4
...
{
  EFI_REDFISH_STORAGE_V1_2_4 *StorageV1_2_4;
  EFI_REDFISH_STORAGE_V1_2_4_CS *StorageV1_2_4Cs;
  ...
  Status = (EFI_STATUS)Json_Storage_V1_2_4_To_CS (ResoruceRaw, &StorageV1_2_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageV1_2_4 = (EFI_REDFISH_STORAGE_V1_2_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGE_V1_2_4));
  if (StorageV1_2_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)StorageV1_2_4;
  StorageV1_2_4->Storage = StorageV1_2_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Storage_V1_2_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Storage_V1_2_4_JSON (*((EFI_REDFISH_STORAGE_V1_2_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Storage_V1_2_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  StorageV1_2_4 = (EFI_REDFISH_STORAGE_V1_2_4 *)InterpProp;
  DestroyStorage_V1_2_4_CS (StorageV1_2_4->Storage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyStorage_V1_2_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorage_V1_2_4EntryPoint (
