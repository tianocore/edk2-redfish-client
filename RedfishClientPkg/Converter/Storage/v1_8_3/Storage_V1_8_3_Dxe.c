...
//
#include <RedfishJsonStructure/Storage/v1_8_3/EfiStorageV1_8_3.h>
CHAR8 mResourceTypeStr [] = "#Storage";
BOOLEAN IsRevisonController = TRUE;

// Support Storage V1_8_3
...
{
  EFI_REDFISH_STORAGE_V1_8_3 *StorageV1_8_3;
  EFI_REDFISH_STORAGE_V1_8_3_CS *StorageV1_8_3Cs;
  ...
  Status = (EFI_STATUS)Json_Storage_V1_8_3_To_CS (ResoruceRaw, &StorageV1_8_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageV1_8_3 = (EFI_REDFISH_STORAGE_V1_8_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGE_V1_8_3));
  if (StorageV1_8_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)StorageV1_8_3;
  StorageV1_8_3->Storage = StorageV1_8_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Storage_V1_8_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Storage_V1_8_3_JSON (*((EFI_REDFISH_STORAGE_V1_8_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Storage_V1_8_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  StorageV1_8_3 = (EFI_REDFISH_STORAGE_V1_8_3 *)InterpProp;
  DestroyStorage_V1_8_3_CS (StorageV1_8_3->Storage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyStorage_V1_8_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorage_V1_8_3EntryPoint (
