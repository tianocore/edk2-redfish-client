...
//
#include <RedfishJsonStructure/Storage/v1_0_9/EfiStorageV1_0_9.h>
CHAR8 mResourceTypeStr [] = "#Storage";
BOOLEAN IsRevisonController = TRUE;

// Support Storage V1_0_9
...
{
  EFI_REDFISH_STORAGE_V1_0_9 *StorageV1_0_9;
  EFI_REDFISH_STORAGE_V1_0_9_CS *StorageV1_0_9Cs;
  ...
  Status = (EFI_STATUS)Json_Storage_V1_0_9_To_CS (ResoruceRaw, &StorageV1_0_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageV1_0_9 = (EFI_REDFISH_STORAGE_V1_0_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGE_V1_0_9));
  if (StorageV1_0_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)StorageV1_0_9;
  StorageV1_0_9->Storage = StorageV1_0_9Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Storage_V1_0_9_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Storage_V1_0_9_JSON (*((EFI_REDFISH_STORAGE_V1_0_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Storage_V1_0_9_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  StorageV1_0_9 = (EFI_REDFISH_STORAGE_V1_0_9 *)InterpProp;
  DestroyStorage_V1_0_9_CS (StorageV1_0_9->Storage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyStorage_V1_0_9_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorage_V1_0_9EntryPoint (
