...
//
#include <RedfishJsonStructure/Storage/v1_2_6/EfiStorageV1_2_6.h>
CHAR8 mResourceTypeStr [] = "#Storage";
BOOLEAN IsRevisonController = TRUE;

// Support Storage V1_2_6
...
{
  EFI_REDFISH_STORAGE_V1_2_6 *StorageV1_2_6;
  EFI_REDFISH_STORAGE_V1_2_6_CS *StorageV1_2_6Cs;
  ...
  Status = (EFI_STATUS)Json_Storage_V1_2_6_To_CS (ResoruceRaw, &StorageV1_2_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageV1_2_6 = (EFI_REDFISH_STORAGE_V1_2_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGE_V1_2_6));
  if (StorageV1_2_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)StorageV1_2_6;
  StorageV1_2_6->Storage = StorageV1_2_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Storage_V1_2_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Storage_V1_2_6_JSON (*((EFI_REDFISH_STORAGE_V1_2_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Storage_V1_2_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  StorageV1_2_6 = (EFI_REDFISH_STORAGE_V1_2_6 *)InterpProp;
  DestroyStorage_V1_2_6_CS (StorageV1_2_6->Storage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyStorage_V1_2_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorage_V1_2_6EntryPoint (
