...
//
#include <RedfishJsonStructure/Storage/v1_10_0/EfiStorageV1_10_0.h>
CHAR8 mResourceTypeStr [] = "#Storage";
BOOLEAN IsRevisonController = TRUE;

// Support Storage V1_10_0
...
{
  EFI_REDFISH_STORAGE_V1_10_0 *StorageV1_10_0;
  EFI_REDFISH_STORAGE_V1_10_0_CS *StorageV1_10_0Cs;
  ...
  Status = (EFI_STATUS)Json_Storage_V1_10_0_To_CS (ResoruceRaw, &StorageV1_10_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageV1_10_0 = (EFI_REDFISH_STORAGE_V1_10_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGE_V1_10_0));
  if (StorageV1_10_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)StorageV1_10_0;
  StorageV1_10_0->Storage = StorageV1_10_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Storage_V1_10_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Storage_V1_10_0_JSON (*((EFI_REDFISH_STORAGE_V1_10_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Storage_V1_10_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  StorageV1_10_0 = (EFI_REDFISH_STORAGE_V1_10_0 *)InterpProp;
  DestroyStorage_V1_10_0_CS (StorageV1_10_0->Storage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyStorage_V1_10_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorage_V1_10_0EntryPoint (
