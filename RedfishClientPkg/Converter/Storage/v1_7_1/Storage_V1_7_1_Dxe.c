...
//
#include <RedfishJsonStructure/Storage/v1_7_1/EfiStorageV1_7_1.h>
CHAR8 mResourceTypeStr [] = "#Storage";
BOOLEAN IsRevisonController = TRUE;

// Support Storage V1_7_1
...
{
  EFI_REDFISH_STORAGE_V1_7_1 *StorageV1_7_1;
  EFI_REDFISH_STORAGE_V1_7_1_CS *StorageV1_7_1Cs;
  ...
  Status = (EFI_STATUS)Json_Storage_V1_7_1_To_CS (ResoruceRaw, &StorageV1_7_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageV1_7_1 = (EFI_REDFISH_STORAGE_V1_7_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGE_V1_7_1));
  if (StorageV1_7_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)StorageV1_7_1;
  StorageV1_7_1->Storage = StorageV1_7_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Storage_V1_7_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Storage_V1_7_1_JSON (*((EFI_REDFISH_STORAGE_V1_7_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Storage_V1_7_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  StorageV1_7_1 = (EFI_REDFISH_STORAGE_V1_7_1 *)InterpProp;
  DestroyStorage_V1_7_1_CS (StorageV1_7_1->Storage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyStorage_V1_7_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorage_V1_7_1EntryPoint (
