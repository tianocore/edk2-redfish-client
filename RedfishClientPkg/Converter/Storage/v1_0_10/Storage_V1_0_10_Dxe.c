...
//
#include <RedfishJsonStructure/Storage/v1_0_10/EfiStorageV1_0_10.h>
CHAR8 mResourceTypeStr [] = "#Storage";
BOOLEAN IsRevisonController = TRUE;

// Support Storage V1_0_10
...
{
  EFI_REDFISH_STORAGE_V1_0_10 *StorageV1_0_10;
  EFI_REDFISH_STORAGE_V1_0_10_CS *StorageV1_0_10Cs;
  ...
  Status = (EFI_STATUS)Json_Storage_V1_0_10_To_CS (ResoruceRaw, &StorageV1_0_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageV1_0_10 = (EFI_REDFISH_STORAGE_V1_0_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGE_V1_0_10));
  if (StorageV1_0_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)StorageV1_0_10;
  StorageV1_0_10->Storage = StorageV1_0_10Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Storage"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("Storage"), "Storage");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Storage"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("Storage"), "Storage");
...
/**
  The wrapper function of StorageToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Storage_V1_0_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Storage_V1_0_10_JSON (*((EFI_REDFISH_STORAGE_V1_0_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Storage_V1_0_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  StorageV1_0_10 = (EFI_REDFISH_STORAGE_V1_0_10 *)InterpProp;
  DestroyStorage_V1_0_10_CS (StorageV1_0_10->Storage); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from StorageFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyStorage_V1_0_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorage_V1_0_10EntryPoint (
