...
//
#include <RedfishJsonStructure/Storage/v1_5_5/EfiStorageV1_5_5.h>
CHAR8 mResourceTypeStr [] = "#Storage";
BOOLEAN IsRevisonController = TRUE;

// Support Storage V1_5_5
...
{
  EFI_REDFISH_STORAGE_V1_5_5 *StorageV1_5_5;
  EFI_REDFISH_STORAGE_V1_5_5_CS *StorageV1_5_5Cs;
  ...
  Status = (EFI_STATUS)Json_Storage_V1_5_5_To_CS (ResoruceRaw, &StorageV1_5_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageV1_5_5 = (EFI_REDFISH_STORAGE_V1_5_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGE_V1_5_5));
  if (StorageV1_5_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)StorageV1_5_5;
  StorageV1_5_5->Storage = StorageV1_5_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Storage_V1_5_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Storage_V1_5_5_JSON (*((EFI_REDFISH_STORAGE_V1_5_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Storage_V1_5_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  StorageV1_5_5 = (EFI_REDFISH_STORAGE_V1_5_5 *)InterpProp;
  DestroyStorage_V1_5_5_CS (StorageV1_5_5->Storage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyStorage_V1_5_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorage_V1_5_5EntryPoint (
