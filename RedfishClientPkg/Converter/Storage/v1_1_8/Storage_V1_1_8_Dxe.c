...
//
#include <RedfishJsonStructure/Storage/v1_1_8/EfiStorageV1_1_8.h>
CHAR8 mResourceTypeStr [] = "#Storage";
BOOLEAN IsRevisonController = TRUE;

// Support Storage V1_1_8
...
{
  EFI_REDFISH_STORAGE_V1_1_8 *StorageV1_1_8;
  EFI_REDFISH_STORAGE_V1_1_8_CS *StorageV1_1_8Cs;
  ...
  Status = (EFI_STATUS)Json_Storage_V1_1_8_To_CS (ResoruceRaw, &StorageV1_1_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageV1_1_8 = (EFI_REDFISH_STORAGE_V1_1_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGE_V1_1_8));
  if (StorageV1_1_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)StorageV1_1_8;
  StorageV1_1_8->Storage = StorageV1_1_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Storage_V1_1_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Storage_V1_1_8_JSON (*((EFI_REDFISH_STORAGE_V1_1_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Storage_V1_1_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  StorageV1_1_8 = (EFI_REDFISH_STORAGE_V1_1_8 *)InterpProp;
  DestroyStorage_V1_1_8_CS (StorageV1_1_8->Storage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyStorage_V1_1_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorage_V1_1_8EntryPoint (
