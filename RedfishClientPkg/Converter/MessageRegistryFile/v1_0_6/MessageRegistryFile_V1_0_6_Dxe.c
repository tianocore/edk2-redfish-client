...
//
#include <RedfishJsonStructure/MessageRegistryFile/v1_0_6/EfiMessageRegistryFileV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistryFile";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistryFile V1_0_6
...
{
  EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_6 *MessageRegistryFileV1_0_6;
  EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_6_CS *MessageRegistryFileV1_0_6Cs;
  ...
  Status = (EFI_STATUS)Json_MessageRegistryFile_V1_0_6_To_CS (ResoruceRaw, &MessageRegistryFileV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryFileV1_0_6 = (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_6));
  if (MessageRegistryFileV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MessageRegistryFileV1_0_6;
  MessageRegistryFileV1_0_6->MessageRegistryFile = MessageRegistryFileV1_0_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MessageRegistryFile_V1_0_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MessageRegistryFile_V1_0_6_JSON (*((EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MessageRegistryFile_V1_0_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MessageRegistryFileV1_0_6 = (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_0_6 *)InterpProp;
  DestroyMessageRegistryFile_V1_0_6_CS (MessageRegistryFileV1_0_6->MessageRegistryFile); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMessageRegistryFile_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistryFile_V1_0_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistryFile_V1_0_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
