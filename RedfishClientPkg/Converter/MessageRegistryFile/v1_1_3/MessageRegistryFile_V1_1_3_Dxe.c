...
//
#include <RedfishJsonStructure/MessageRegistryFile/v1_1_3/EfiMessageRegistryFileV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistryFile";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistryFile V1_1_3
...
{
  EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_3 *MessageRegistryFileV1_1_3;
  EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_3_CS *MessageRegistryFileV1_1_3Cs;
  ...
  Status = (EFI_STATUS)Json_MessageRegistryFile_V1_1_3_To_CS (ResoruceRaw, &MessageRegistryFileV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryFileV1_1_3 = (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_3));
  if (MessageRegistryFileV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MessageRegistryFileV1_1_3;
  MessageRegistryFileV1_1_3->MessageRegistryFile = MessageRegistryFileV1_1_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MessageRegistryFile_V1_1_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MessageRegistryFile_V1_1_3_JSON (*((EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MessageRegistryFile_V1_1_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MessageRegistryFileV1_1_3 = (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_3 *)InterpProp;
  DestroyMessageRegistryFile_V1_1_3_CS (MessageRegistryFileV1_1_3->MessageRegistryFile); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMessageRegistryFile_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistryFile_V1_1_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistryFile_V1_1_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
