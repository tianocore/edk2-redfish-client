...
//
#include <RedfishJsonStructure/MessageRegistryFile/v1_1_2/EfiMessageRegistryFileV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistryFile";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistryFile V1_1_2
...
{
  EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_2 *MessageRegistryFileV1_1_2;
  EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_2_CS *MessageRegistryFileV1_1_2Cs;
  ...
  Status = (EFI_STATUS)Json_MessageRegistryFile_V1_1_2_To_CS (ResoruceRaw, &MessageRegistryFileV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryFileV1_1_2 = (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_2));
  if (MessageRegistryFileV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MessageRegistryFileV1_1_2;
  MessageRegistryFileV1_1_2->MessageRegistryFile = MessageRegistryFileV1_1_2Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("MessageRegistryFile"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("MessageRegistryFile"), "MessageRegistryFile");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("MessageRegistryFile"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("MessageRegistryFile"), "MessageRegistryFile");
...
/**
  The wrapper function of MessageRegistryFileToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
MessageRegistryFileToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return MessageRegistryFileToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MessageRegistryFile_V1_1_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MessageRegistryFile_V1_1_2_JSON (*((EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MessageRegistryFile_V1_1_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
EFI_STATUS
EFIAPI
MessageRegistryFileDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  MessageRegistryFileV1_1_2 = (EFI_REDFISH_MESSAGEREGISTRYFILE_V1_1_2 *)InterpProp;
  DestroyMessageRegistryFile_V1_1_2_CS (MessageRegistryFileV1_1_2->MessageRegistryFile); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from MessageRegistryFileFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyMessageRegistryFile_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistryFile_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistryFile_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
