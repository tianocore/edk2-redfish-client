...
//
#include <RedfishJsonStructure/ResourceBlock/v1_3_1/EfiResourceBlockV1_3_1.h>
CHAR8 mResourceTypeStr [] = "#ResourceBlock";
BOOLEAN IsRevisonController = TRUE;

// Support ResourceBlock V1_3_1
...
{
  EFI_REDFISH_RESOURCEBLOCK_V1_3_1 *ResourceBlockV1_3_1;
  EFI_REDFISH_RESOURCEBLOCK_V1_3_1_CS *ResourceBlockV1_3_1Cs;
  ...
  Status = (EFI_STATUS)Json_ResourceBlock_V1_3_1_To_CS (ResoruceRaw, &ResourceBlockV1_3_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ResourceBlockV1_3_1 = (EFI_REDFISH_RESOURCEBLOCK_V1_3_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_RESOURCEBLOCK_V1_3_1));
  if (ResourceBlockV1_3_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ResourceBlockV1_3_1;
  ResourceBlockV1_3_1->ResourceBlock = ResourceBlockV1_3_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ResourceBlock_V1_3_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ResourceBlock_V1_3_1_JSON (*((EFI_REDFISH_RESOURCEBLOCK_V1_3_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ResourceBlock_V1_3_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ResourceBlockV1_3_1 = (EFI_REDFISH_RESOURCEBLOCK_V1_3_1 *)InterpProp;
  DestroyResourceBlock_V1_3_1_CS (ResourceBlockV1_3_1->ResourceBlock); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyResourceBlock_V1_3_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_3_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_3_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
