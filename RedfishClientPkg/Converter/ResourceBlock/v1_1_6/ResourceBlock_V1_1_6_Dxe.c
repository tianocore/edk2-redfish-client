...
//
#include <RedfishJsonStructure/ResourceBlock/v1_1_6/EfiResourceBlockV1_1_6.h>
CHAR8 mResourceTypeStr [] = "#ResourceBlock";
BOOLEAN IsRevisonController = TRUE;

// Support ResourceBlock V1_1_6
...
{
  EFI_REDFISH_RESOURCEBLOCK_V1_1_6 *ResourceBlockV1_1_6;
  EFI_REDFISH_RESOURCEBLOCK_V1_1_6_CS *ResourceBlockV1_1_6Cs;
  ...
  Status = (EFI_STATUS)Json_ResourceBlock_V1_1_6_To_CS (ResoruceRaw, &ResourceBlockV1_1_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ResourceBlockV1_1_6 = (EFI_REDFISH_RESOURCEBLOCK_V1_1_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_RESOURCEBLOCK_V1_1_6));
  if (ResourceBlockV1_1_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ResourceBlockV1_1_6;
  ResourceBlockV1_1_6->ResourceBlock = ResourceBlockV1_1_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ResourceBlock_V1_1_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ResourceBlock_V1_1_6_JSON (*((EFI_REDFISH_RESOURCEBLOCK_V1_1_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ResourceBlock_V1_1_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ResourceBlockV1_1_6 = (EFI_REDFISH_RESOURCEBLOCK_V1_1_6 *)InterpProp;
  DestroyResourceBlock_V1_1_6_CS (ResourceBlockV1_1_6->ResourceBlock); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyResourceBlock_V1_1_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_1_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_1_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
