...
//
#include <RedfishJsonStructure/ResourceBlock/v1_3_3/EfiResourceBlockV1_3_3.h>
CHAR8 mResourceTypeStr [] = "#ResourceBlock";
BOOLEAN IsRevisonController = TRUE;

// Support ResourceBlock V1_3_3
...
{
  EFI_REDFISH_RESOURCEBLOCK_V1_3_3 *ResourceBlockV1_3_3;
  EFI_REDFISH_RESOURCEBLOCK_V1_3_3_CS *ResourceBlockV1_3_3Cs;
  ...
  Status = (EFI_STATUS)Json_ResourceBlock_V1_3_3_To_CS (ResoruceRaw, &ResourceBlockV1_3_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ResourceBlockV1_3_3 = (EFI_REDFISH_RESOURCEBLOCK_V1_3_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_RESOURCEBLOCK_V1_3_3));
  if (ResourceBlockV1_3_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ResourceBlockV1_3_3;
  ResourceBlockV1_3_3->ResourceBlock = ResourceBlockV1_3_3Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("ResourceBlock"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("ResourceBlock"), "ResourceBlock");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("ResourceBlock"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("ResourceBlock"), "ResourceBlock");
...
/**
  The wrapper function of ResourceBlockToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ResourceBlock_V1_3_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ResourceBlock_V1_3_3_JSON (*((EFI_REDFISH_RESOURCEBLOCK_V1_3_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ResourceBlock_V1_3_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ResourceBlockV1_3_3 = (EFI_REDFISH_RESOURCEBLOCK_V1_3_3 *)InterpProp;
  DestroyResourceBlock_V1_3_3_CS (ResourceBlockV1_3_3->ResourceBlock); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ResourceBlockFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyResourceBlock_V1_3_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_3_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_3_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
