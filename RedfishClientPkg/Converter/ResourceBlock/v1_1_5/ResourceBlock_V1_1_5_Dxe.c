...
//
#include <RedfishJsonStructure/ResourceBlock/v1_1_5/EfiResourceBlockV1_1_5.h>
CHAR8 mResourceTypeStr [] = "#ResourceBlock";
BOOLEAN IsRevisonController = TRUE;

// Support ResourceBlock V1_1_5
...
{
  EFI_REDFISH_RESOURCEBLOCK_V1_1_5 *ResourceBlockV1_1_5;
  EFI_REDFISH_RESOURCEBLOCK_V1_1_5_CS *ResourceBlockV1_1_5Cs;
  ...
  Status = (EFI_STATUS)Json_ResourceBlock_V1_1_5_To_CS (ResoruceRaw, &ResourceBlockV1_1_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ResourceBlockV1_1_5 = (EFI_REDFISH_RESOURCEBLOCK_V1_1_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_RESOURCEBLOCK_V1_1_5));
  if (ResourceBlockV1_1_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ResourceBlockV1_1_5;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ResourceBlock_V1_1_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ResourceBlock_V1_1_5_JSON (*((EFI_REDFISH_RESOURCEBLOCK_V1_1_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ResourceBlock_V1_1_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ResourceBlockV1_1_5 = (EFI_REDFISH_RESOURCEBLOCK_V1_1_5 *)InterpProp;
  DestroyResourceBlock_V1_1_5_CS (ResourceBlockV1_1_5->ResourceBlock); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyResourceBlock_V1_1_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_1_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_1_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
