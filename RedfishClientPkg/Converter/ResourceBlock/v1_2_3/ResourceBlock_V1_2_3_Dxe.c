...
//
#include <RedfishJsonStructure/ResourceBlock/v1_2_3/EfiResourceBlockV1_2_3.h>
CHAR8 mResourceTypeStr [] = "#ResourceBlock";
BOOLEAN IsRevisonController = TRUE;

// Support ResourceBlock V1_2_3
...
{
  EFI_REDFISH_RESOURCEBLOCK_V1_2_3 *ResourceBlockV1_2_3;
  EFI_REDFISH_RESOURCEBLOCK_V1_2_3_CS *ResourceBlockV1_2_3Cs;
  ...
  Status = (EFI_STATUS)Json_ResourceBlock_V1_2_3_To_CS (ResoruceRaw, &ResourceBlockV1_2_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ResourceBlockV1_2_3 = (EFI_REDFISH_RESOURCEBLOCK_V1_2_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_RESOURCEBLOCK_V1_2_3));
  if (ResourceBlockV1_2_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ResourceBlockV1_2_3;
  ResourceBlockV1_2_3->ResourceBlock = ResourceBlockV1_2_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ResourceBlock_V1_2_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ResourceBlock_V1_2_3_JSON (*((EFI_REDFISH_RESOURCEBLOCK_V1_2_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ResourceBlock_V1_2_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ResourceBlockV1_2_3 = (EFI_REDFISH_RESOURCEBLOCK_V1_2_3 *)InterpProp;
  DestroyResourceBlock_V1_2_3_CS (ResourceBlockV1_2_3->ResourceBlock); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyResourceBlock_V1_2_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_2_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_2_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
