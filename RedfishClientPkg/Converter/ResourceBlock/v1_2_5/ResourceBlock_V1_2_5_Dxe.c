...
//
#include <RedfishJsonStructure/ResourceBlock/v1_2_5/EfiResourceBlockV1_2_5.h>
CHAR8 mResourceTypeStr [] = "#ResourceBlock";
BOOLEAN IsRevisonController = TRUE;

// Support ResourceBlock V1_2_5
...
{
  EFI_REDFISH_RESOURCEBLOCK_V1_2_5 *ResourceBlockV1_2_5;
  EFI_REDFISH_RESOURCEBLOCK_V1_2_5_CS *ResourceBlockV1_2_5Cs;
  ...
  Status = (EFI_STATUS)Json_ResourceBlock_V1_2_5_To_CS (ResoruceRaw, &ResourceBlockV1_2_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ResourceBlockV1_2_5 = (EFI_REDFISH_RESOURCEBLOCK_V1_2_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_RESOURCEBLOCK_V1_2_5));
  if (ResourceBlockV1_2_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ResourceBlockV1_2_5;
  ResourceBlockV1_2_5->ResourceBlock = ResourceBlockV1_2_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ResourceBlock_V1_2_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ResourceBlock_V1_2_5_JSON (*((EFI_REDFISH_RESOURCEBLOCK_V1_2_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ResourceBlock_V1_2_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ResourceBlockV1_2_5 = (EFI_REDFISH_RESOURCEBLOCK_V1_2_5 *)InterpProp;
  DestroyResourceBlock_V1_2_5_CS (ResourceBlockV1_2_5->ResourceBlock); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyResourceBlock_V1_2_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_2_5EntryPoint (
