...
//
#include <RedfishJsonStructure/ResourceBlock/v1_4_0/EfiResourceBlockV1_4_0.h>
CHAR8 mResourceTypeStr [] = "#ResourceBlock";
BOOLEAN IsRevisonController = TRUE;

// Support ResourceBlock V1_4_0
...
{
  EFI_REDFISH_RESOURCEBLOCK_V1_4_0 *ResourceBlockV1_4_0;
  EFI_REDFISH_RESOURCEBLOCK_V1_4_0_CS *ResourceBlockV1_4_0Cs;
  ...
  Status = (EFI_STATUS)Json_ResourceBlock_V1_4_0_To_CS (ResoruceRaw, &ResourceBlockV1_4_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ResourceBlockV1_4_0 = (EFI_REDFISH_RESOURCEBLOCK_V1_4_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_RESOURCEBLOCK_V1_4_0));
  if (ResourceBlockV1_4_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ResourceBlockV1_4_0;
  ResourceBlockV1_4_0->ResourceBlock = ResourceBlockV1_4_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ResourceBlock_V1_4_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ResourceBlock_V1_4_0_JSON (*((EFI_REDFISH_RESOURCEBLOCK_V1_4_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ResourceBlock_V1_4_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ResourceBlockV1_4_0 = (EFI_REDFISH_RESOURCEBLOCK_V1_4_0 *)InterpProp;
  DestroyResourceBlock_V1_4_0_CS (ResourceBlockV1_4_0->ResourceBlock); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyResourceBlock_V1_4_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_4_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_4_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
