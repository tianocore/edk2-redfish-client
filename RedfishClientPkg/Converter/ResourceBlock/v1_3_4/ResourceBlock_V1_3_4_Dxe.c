...
//
#include <RedfishJsonStructure/ResourceBlock/v1_3_4/EfiResourceBlockV1_3_4.h>
CHAR8 mResourceTypeStr [] = "#ResourceBlock";
BOOLEAN IsRevisonController = TRUE;

// Support ResourceBlock V1_3_4
...
{
  EFI_REDFISH_RESOURCEBLOCK_V1_3_4 *ResourceBlockV1_3_4;
  EFI_REDFISH_RESOURCEBLOCK_V1_3_4_CS *ResourceBlockV1_3_4Cs;
  ...
  Status = (EFI_STATUS)Json_ResourceBlock_V1_3_4_To_CS (ResoruceRaw, &ResourceBlockV1_3_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ResourceBlockV1_3_4 = (EFI_REDFISH_RESOURCEBLOCK_V1_3_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_RESOURCEBLOCK_V1_3_4));
  if (ResourceBlockV1_3_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ResourceBlockV1_3_4;
  ResourceBlockV1_3_4->ResourceBlock = ResourceBlockV1_3_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ResourceBlock_V1_3_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ResourceBlock_V1_3_4_JSON (*((EFI_REDFISH_RESOURCEBLOCK_V1_3_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ResourceBlock_V1_3_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ResourceBlockV1_3_4 = (EFI_REDFISH_RESOURCEBLOCK_V1_3_4 *)InterpProp;
  DestroyResourceBlock_V1_3_4_CS (ResourceBlockV1_3_4->ResourceBlock); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyResourceBlock_V1_3_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_3_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishResourceBlock_V1_3_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
