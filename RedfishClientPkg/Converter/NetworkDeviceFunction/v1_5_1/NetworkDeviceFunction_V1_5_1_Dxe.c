...
//
#include <RedfishJsonStructure/NetworkDeviceFunction/v1_5_1/EfiNetworkDeviceFunctionV1_5_1.h>
CHAR8 mResourceTypeStr [] = "#NetworkDeviceFunction";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkDeviceFunction V1_5_1
...
{
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_5_1 *NetworkDeviceFunctionV1_5_1;
  ...
  Status = (EFI_STATUS)Json_NetworkDeviceFunction_V1_5_1_To_CS (ResoruceRaw, &NetworkDeviceFunctionV1_5_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkDeviceFunctionV1_5_1 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_5_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_5_1));
  if (NetworkDeviceFunctionV1_5_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkDeviceFunctionV1_5_1;
  NetworkDeviceFunctionV1_5_1->NetworkDeviceFunction = NetworkDeviceFunctionV1_5_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkDeviceFunction_V1_5_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkDeviceFunction_V1_5_1_JSON (*((EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_5_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkDeviceFunction_V1_5_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkDeviceFunctionV1_5_1 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_5_1 *)InterpProp;
  DestroyNetworkDeviceFunction_V1_5_1_CS (NetworkDeviceFunctionV1_5_1->NetworkDeviceFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkDeviceFunction_V1_5_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_5_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_5_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
