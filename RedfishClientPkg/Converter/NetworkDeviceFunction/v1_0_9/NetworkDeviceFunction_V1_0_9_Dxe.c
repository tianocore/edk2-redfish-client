...
//
#include <RedfishJsonStructure/NetworkDeviceFunction/v1_0_9/EfiNetworkDeviceFunctionV1_0_9.h>
CHAR8 mResourceTypeStr [] = "#NetworkDeviceFunction";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkDeviceFunction V1_0_9
...
{
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_9 *NetworkDeviceFunctionV1_0_9;
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_9_CS *NetworkDeviceFunctionV1_0_9Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkDeviceFunction_V1_0_9_To_CS (ResoruceRaw, &NetworkDeviceFunctionV1_0_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkDeviceFunctionV1_0_9 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_9));
  if (NetworkDeviceFunctionV1_0_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkDeviceFunctionV1_0_9;
  NetworkDeviceFunctionV1_0_9->NetworkDeviceFunction = NetworkDeviceFunctionV1_0_9Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkDeviceFunction_V1_0_9_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkDeviceFunction_V1_0_9_JSON (*((EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkDeviceFunction_V1_0_9_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkDeviceFunctionV1_0_9 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_9 *)InterpProp;
  DestroyNetworkDeviceFunction_V1_0_9_CS (NetworkDeviceFunctionV1_0_9->NetworkDeviceFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkDeviceFunction_V1_0_9_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_0_9EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_0_9Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
