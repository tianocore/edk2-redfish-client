...
//
#include <RedfishJsonStructure/NetworkDeviceFunction/v1_4_0/EfiNetworkDeviceFunctionV1_4_0.h>
CHAR8 mResourceTypeStr [] = "#NetworkDeviceFunction";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkDeviceFunction V1_4_0
...
{
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_4_0 *NetworkDeviceFunctionV1_4_0;
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_4_0_CS *NetworkDeviceFunctionV1_4_0Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkDeviceFunction_V1_4_0_To_CS (ResoruceRaw, &NetworkDeviceFunctionV1_4_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkDeviceFunctionV1_4_0 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_4_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_4_0));
  if (NetworkDeviceFunctionV1_4_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkDeviceFunctionV1_4_0;
  NetworkDeviceFunctionV1_4_0->NetworkDeviceFunction = NetworkDeviceFunctionV1_4_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkDeviceFunction_V1_4_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkDeviceFunction_V1_4_0_JSON (*((EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_4_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkDeviceFunction_V1_4_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkDeviceFunctionV1_4_0 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_4_0 *)InterpProp;
  DestroyNetworkDeviceFunction_V1_4_0_CS (NetworkDeviceFunctionV1_4_0->NetworkDeviceFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkDeviceFunction_V1_4_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_4_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_4_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
