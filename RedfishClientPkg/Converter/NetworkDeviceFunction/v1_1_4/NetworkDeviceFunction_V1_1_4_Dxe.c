...
//
#include <RedfishJsonStructure/NetworkDeviceFunction/v1_1_4/EfiNetworkDeviceFunctionV1_1_4.h>
CHAR8 mResourceTypeStr [] = "#NetworkDeviceFunction";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkDeviceFunction V1_1_4
...
{
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_4 *NetworkDeviceFunctionV1_1_4;
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_4_CS *NetworkDeviceFunctionV1_1_4Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkDeviceFunction_V1_1_4_To_CS (ResoruceRaw, &NetworkDeviceFunctionV1_1_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkDeviceFunctionV1_1_4 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_4));
  if (NetworkDeviceFunctionV1_1_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkDeviceFunctionV1_1_4;
  NetworkDeviceFunctionV1_1_4->NetworkDeviceFunction = NetworkDeviceFunctionV1_1_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkDeviceFunction_V1_1_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkDeviceFunction_V1_1_4_JSON (*((EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkDeviceFunction_V1_1_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkDeviceFunctionV1_1_4 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_1_4 *)InterpProp;
  DestroyNetworkDeviceFunction_V1_1_4_CS (NetworkDeviceFunctionV1_1_4->NetworkDeviceFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkDeviceFunction_V1_1_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_1_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_1_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
