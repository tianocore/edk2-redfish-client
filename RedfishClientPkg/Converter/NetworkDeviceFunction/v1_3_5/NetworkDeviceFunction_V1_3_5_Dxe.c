...
//
#include <RedfishJsonStructure/NetworkDeviceFunction/v1_3_5/EfiNetworkDeviceFunctionV1_3_5.h>
CHAR8 mResourceTypeStr [] = "#NetworkDeviceFunction";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkDeviceFunction V1_3_5
...
{
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_5 *NetworkDeviceFunctionV1_3_5;
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_5_CS *NetworkDeviceFunctionV1_3_5Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkDeviceFunction_V1_3_5_To_CS (ResoruceRaw, &NetworkDeviceFunctionV1_3_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkDeviceFunctionV1_3_5 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_5));
  if (NetworkDeviceFunctionV1_3_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkDeviceFunctionV1_3_5;
  NetworkDeviceFunctionV1_3_5->NetworkDeviceFunction = NetworkDeviceFunctionV1_3_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkDeviceFunction_V1_3_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkDeviceFunction_V1_3_5_JSON (*((EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkDeviceFunction_V1_3_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkDeviceFunctionV1_3_5 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_5 *)InterpProp;
  DestroyNetworkDeviceFunction_V1_3_5_CS (NetworkDeviceFunctionV1_3_5->NetworkDeviceFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkDeviceFunction_V1_3_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_3_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_3_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
