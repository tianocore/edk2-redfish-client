...
)
{
  ...
  return (EFI_STATUS)CS_To_NetworkDeviceFunction_V1_3_5_JSON (*((EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
