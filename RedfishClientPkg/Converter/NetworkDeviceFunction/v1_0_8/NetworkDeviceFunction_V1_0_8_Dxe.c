...
//
#include <RedfishJsonStructure/NetworkDeviceFunction/v1_0_8/EfiNetworkDeviceFunctionV1_0_8.h>
CHAR8 mResourceTypeStr [] = "#NetworkDeviceFunction";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkDeviceFunction V1_0_8
...
{
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_8 *NetworkDeviceFunctionV1_0_8;
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_8_CS *NetworkDeviceFunctionV1_0_8Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkDeviceFunction_V1_0_8_To_CS (ResoruceRaw, &NetworkDeviceFunctionV1_0_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkDeviceFunctionV1_0_8 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_8));
  if (NetworkDeviceFunctionV1_0_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkDeviceFunctionV1_0_8;
  NetworkDeviceFunctionV1_0_8->NetworkDeviceFunction = NetworkDeviceFunctionV1_0_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkDeviceFunction_V1_0_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkDeviceFunction_V1_0_8_JSON (*((EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkDeviceFunction_V1_0_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkDeviceFunctionV1_0_8 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_8 *)InterpProp;
  DestroyNetworkDeviceFunction_V1_0_8_CS (NetworkDeviceFunctionV1_0_8->NetworkDeviceFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkDeviceFunction_V1_0_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_0_8EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_0_8Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
