...
//
#include <RedfishJsonStructure/NetworkDeviceFunction/v1_3_3/EfiNetworkDeviceFunctionV1_3_3.h>
CHAR8 mResourceTypeStr [] = "#NetworkDeviceFunction";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkDeviceFunction V1_3_3
...
{
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_3 *NetworkDeviceFunctionV1_3_3;
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_3_CS *NetworkDeviceFunctionV1_3_3Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkDeviceFunction_V1_3_3_To_CS (ResoruceRaw, &NetworkDeviceFunctionV1_3_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkDeviceFunctionV1_3_3 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_3));
  if (NetworkDeviceFunctionV1_3_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkDeviceFunctionV1_3_3;
  NetworkDeviceFunctionV1_3_3->NetworkDeviceFunction = NetworkDeviceFunctionV1_3_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkDeviceFunction_V1_3_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkDeviceFunction_V1_3_3_JSON (*((EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkDeviceFunction_V1_3_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkDeviceFunctionV1_3_3 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_3 *)InterpProp;
  DestroyNetworkDeviceFunction_V1_3_3_CS (NetworkDeviceFunctionV1_3_3->NetworkDeviceFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkDeviceFunction_V1_3_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_3_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_3_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
