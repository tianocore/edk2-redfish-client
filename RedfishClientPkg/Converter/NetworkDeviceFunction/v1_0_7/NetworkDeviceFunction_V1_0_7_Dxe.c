...
//
#include <RedfishJsonStructure/NetworkDeviceFunction/v1_0_7/EfiNetworkDeviceFunctionV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#NetworkDeviceFunction";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkDeviceFunction V1_0_7
...
{
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_7 *NetworkDeviceFunctionV1_0_7;
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_7_CS *NetworkDeviceFunctionV1_0_7Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkDeviceFunction_V1_0_7_To_CS (ResoruceRaw, &NetworkDeviceFunctionV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkDeviceFunctionV1_0_7 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_7));
  if (NetworkDeviceFunctionV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkDeviceFunctionV1_0_7;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkDeviceFunction_V1_0_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkDeviceFunction_V1_0_7_JSON (*((EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkDeviceFunction_V1_0_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkDeviceFunctionV1_0_7 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_0_7 *)InterpProp;
  DestroyNetworkDeviceFunction_V1_0_7_CS (NetworkDeviceFunctionV1_0_7->NetworkDeviceFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkDeviceFunction_V1_0_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_0_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_0_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
