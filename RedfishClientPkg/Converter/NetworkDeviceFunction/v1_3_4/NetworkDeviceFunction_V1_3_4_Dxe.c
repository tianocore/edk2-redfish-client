...
//
#include <RedfishJsonStructure/NetworkDeviceFunction/v1_3_4/EfiNetworkDeviceFunctionV1_3_4.h>
CHAR8 mResourceTypeStr [] = "#NetworkDeviceFunction";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkDeviceFunction V1_3_4
...
{
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_4 *NetworkDeviceFunctionV1_3_4;
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_4_CS *NetworkDeviceFunctionV1_3_4Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkDeviceFunction_V1_3_4_To_CS (ResoruceRaw, &NetworkDeviceFunctionV1_3_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkDeviceFunctionV1_3_4 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_4));
  if (NetworkDeviceFunctionV1_3_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkDeviceFunctionV1_3_4;
  NetworkDeviceFunctionV1_3_4->NetworkDeviceFunction = NetworkDeviceFunctionV1_3_4Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("NetworkDeviceFunction"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("NetworkDeviceFunction"), "NetworkDeviceFunction");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("NetworkDeviceFunction"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("NetworkDeviceFunction"), "NetworkDeviceFunction");
...
/**
  The wrapper function of NetworkDeviceFunctionToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
NetworkDeviceFunctionToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return NetworkDeviceFunctionToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkDeviceFunction_V1_3_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkDeviceFunction_V1_3_4_JSON (*((EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkDeviceFunction_V1_3_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
EFI_STATUS
EFIAPI
NetworkDeviceFunctionDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  NetworkDeviceFunctionV1_3_4 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_4 *)InterpProp;
  DestroyNetworkDeviceFunction_V1_3_4_CS (NetworkDeviceFunctionV1_3_4->NetworkDeviceFunction); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from NetworkDeviceFunctionFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkDeviceFunction_V1_3_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_3_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_3_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
