...
//
#include <RedfishJsonStructure/NetworkDeviceFunction/v1_3_6/EfiNetworkDeviceFunctionV1_3_6.h>
CHAR8 mResourceTypeStr [] = "#NetworkDeviceFunction";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkDeviceFunction V1_3_6
...
{
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_6 *NetworkDeviceFunctionV1_3_6;
  EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_6_CS *NetworkDeviceFunctionV1_3_6Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkDeviceFunction_V1_3_6_To_CS (ResoruceRaw, &NetworkDeviceFunctionV1_3_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkDeviceFunctionV1_3_6 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_6));
  if (NetworkDeviceFunctionV1_3_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkDeviceFunctionV1_3_6;
  NetworkDeviceFunctionV1_3_6->NetworkDeviceFunction = NetworkDeviceFunctionV1_3_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkDeviceFunction_V1_3_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkDeviceFunction_V1_3_6_JSON (*((EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkDeviceFunction_V1_3_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkDeviceFunctionV1_3_6 = (EFI_REDFISH_NETWORKDEVICEFUNCTION_V1_3_6 *)InterpProp;
  DestroyNetworkDeviceFunction_V1_3_6_CS (NetworkDeviceFunctionV1_3_6->NetworkDeviceFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkDeviceFunction_V1_3_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_3_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunction_V1_3_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
