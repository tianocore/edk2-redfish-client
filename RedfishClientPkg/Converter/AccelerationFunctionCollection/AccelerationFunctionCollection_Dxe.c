...
)
{
  ...
  return (EFI_STATUS)CS_To_AccelerationFunctionCollection_JSON (*((EFI_REDFISH_ACCELERATIONFUNCTIONCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
