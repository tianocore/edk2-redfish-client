...
//
#include <RedfishJsonStructure/JsonSchemaFile/v1_0_6/EfiJsonSchemaFileV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#JsonSchemaFile";
BOOLEAN IsRevisonController = TRUE;

// Support JsonSchemaFile V1_0_6
...
{
  EFI_REDFISH_JSONSCHEMAFILE_V1_0_6 *JsonSchemaFileV1_0_6;
  EFI_REDFISH_JSONSCHEMAFILE_V1_0_6_CS *JsonSchemaFileV1_0_6Cs;
  ...
  Status = (EFI_STATUS)Json_JsonSchemaFile_V1_0_6_To_CS (ResoruceRaw, &JsonSchemaFileV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JsonSchemaFileV1_0_6 = (EFI_REDFISH_JSONSCHEMAFILE_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JSONSCHEMAFILE_V1_0_6));
  if (JsonSchemaFileV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)JsonSchemaFileV1_0_6;
  JsonSchemaFileV1_0_6->JsonSchemaFile = JsonSchemaFileV1_0_6Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("JsonSchemaFile"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("JsonSchemaFile"), "JsonSchemaFile");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("JsonSchemaFile"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("JsonSchemaFile"), "JsonSchemaFile");
...
/**
  The wrapper function of JsonSchemaFileToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_JsonSchemaFile_V1_0_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_JsonSchemaFile_V1_0_6_JSON (*((EFI_REDFISH_JSONSCHEMAFILE_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_JsonSchemaFile_V1_0_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  JsonSchemaFileV1_0_6 = (EFI_REDFISH_JSONSCHEMAFILE_V1_0_6 *)InterpProp;
  DestroyJsonSchemaFile_V1_0_6_CS (JsonSchemaFileV1_0_6->JsonSchemaFile); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from JsonSchemaFileFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyJsonSchemaFile_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_0_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_0_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
