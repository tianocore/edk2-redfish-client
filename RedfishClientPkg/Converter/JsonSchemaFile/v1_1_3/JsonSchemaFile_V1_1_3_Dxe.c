...
//
#include <RedfishJsonStructure/JsonSchemaFile/v1_1_3/EfiJsonSchemaFileV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#JsonSchemaFile";
BOOLEAN IsRevisonController = TRUE;

// Support JsonSchemaFile V1_1_3
...
{
  EFI_REDFISH_JSONSCHEMAFILE_V1_1_3 *JsonSchemaFileV1_1_3;
  EFI_REDFISH_JSONSCHEMAFILE_V1_1_3_CS *JsonSchemaFileV1_1_3Cs;
  ...
  Status = (EFI_STATUS)Json_JsonSchemaFile_V1_1_3_To_CS (ResoruceRaw, &JsonSchemaFileV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JsonSchemaFileV1_1_3 = (EFI_REDFISH_JSONSCHEMAFILE_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JSONSCHEMAFILE_V1_1_3));
  if (JsonSchemaFileV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)JsonSchemaFileV1_1_3;
  JsonSchemaFileV1_1_3->JsonSchemaFile = JsonSchemaFileV1_1_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_JsonSchemaFile_V1_1_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_JsonSchemaFile_V1_1_3_JSON (*((EFI_REDFISH_JSONSCHEMAFILE_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_JsonSchemaFile_V1_1_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  JsonSchemaFileV1_1_3 = (EFI_REDFISH_JSONSCHEMAFILE_V1_1_3 *)InterpProp;
  DestroyJsonSchemaFile_V1_1_3_CS (JsonSchemaFileV1_1_3->JsonSchemaFile); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyJsonSchemaFile_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_1_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_1_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
