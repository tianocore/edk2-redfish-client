...
//
#include <RedfishJsonStructure/JsonSchemaFile/v1_1_2/EfiJsonSchemaFileV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#JsonSchemaFile";
BOOLEAN IsRevisonController = TRUE;

// Support JsonSchemaFile V1_1_2
...
{
  EFI_REDFISH_JSONSCHEMAFILE_V1_1_2 *JsonSchemaFileV1_1_2;
  EFI_REDFISH_JSONSCHEMAFILE_V1_1_2_CS *JsonSchemaFileV1_1_2Cs;
  ...
  Status = (EFI_STATUS)Json_JsonSchemaFile_V1_1_2_To_CS (ResoruceRaw, &JsonSchemaFileV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JsonSchemaFileV1_1_2 = (EFI_REDFISH_JSONSCHEMAFILE_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JSONSCHEMAFILE_V1_1_2));
  if (JsonSchemaFileV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)JsonSchemaFileV1_1_2;
  JsonSchemaFileV1_1_2->JsonSchemaFile = JsonSchemaFileV1_1_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_JsonSchemaFile_V1_1_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_JsonSchemaFile_V1_1_2_JSON (*((EFI_REDFISH_JSONSCHEMAFILE_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_JsonSchemaFile_V1_1_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  JsonSchemaFileV1_1_2 = (EFI_REDFISH_JSONSCHEMAFILE_V1_1_2 *)InterpProp;
  DestroyJsonSchemaFile_V1_1_2_CS (JsonSchemaFileV1_1_2->JsonSchemaFile); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyJsonSchemaFile_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
