...
//
#include <RedfishJsonStructure/JsonSchemaFile/v1_0_7/EfiJsonSchemaFileV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#JsonSchemaFile";
BOOLEAN IsRevisonController = TRUE;

// Support JsonSchemaFile V1_0_7
...
{
  EFI_REDFISH_JSONSCHEMAFILE_V1_0_7 *JsonSchemaFileV1_0_7;
  EFI_REDFISH_JSONSCHEMAFILE_V1_0_7_CS *JsonSchemaFileV1_0_7Cs;
  ...
  Status = (EFI_STATUS)Json_JsonSchemaFile_V1_0_7_To_CS (ResoruceRaw, &JsonSchemaFileV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JsonSchemaFileV1_0_7 = (EFI_REDFISH_JSONSCHEMAFILE_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JSONSCHEMAFILE_V1_0_7));
  if (JsonSchemaFileV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)JsonSchemaFileV1_0_7;
  JsonSchemaFileV1_0_7->JsonSchemaFile = JsonSchemaFileV1_0_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_JsonSchemaFile_V1_0_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_JsonSchemaFile_V1_0_7_JSON (*((EFI_REDFISH_JSONSCHEMAFILE_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_JsonSchemaFile_V1_0_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  JsonSchemaFileV1_0_7 = (EFI_REDFISH_JSONSCHEMAFILE_V1_0_7 *)InterpProp;
  DestroyJsonSchemaFile_V1_0_7_CS (JsonSchemaFileV1_0_7->JsonSchemaFile); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyJsonSchemaFile_V1_0_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_0_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_0_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
