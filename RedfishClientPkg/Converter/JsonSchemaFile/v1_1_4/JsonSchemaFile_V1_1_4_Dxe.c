...
//
#include <RedfishJsonStructure/JsonSchemaFile/v1_1_4/EfiJsonSchemaFileV1_1_4.h>
CHAR8 mResourceTypeStr [] = "#JsonSchemaFile";
BOOLEAN IsRevisonController = TRUE;

// Support JsonSchemaFile V1_1_4
...
{
  EFI_REDFISH_JSONSCHEMAFILE_V1_1_4 *JsonSchemaFileV1_1_4;
  EFI_REDFISH_JSONSCHEMAFILE_V1_1_4_CS *JsonSchemaFileV1_1_4Cs;
  ...
  Status = (EFI_STATUS)Json_JsonSchemaFile_V1_1_4_To_CS (ResoruceRaw, &JsonSchemaFileV1_1_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JsonSchemaFileV1_1_4 = (EFI_REDFISH_JSONSCHEMAFILE_V1_1_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JSONSCHEMAFILE_V1_1_4));
  if (JsonSchemaFileV1_1_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)JsonSchemaFileV1_1_4;
  JsonSchemaFileV1_1_4->JsonSchemaFile = JsonSchemaFileV1_1_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_JsonSchemaFile_V1_1_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_JsonSchemaFile_V1_1_4_JSON (*((EFI_REDFISH_JSONSCHEMAFILE_V1_1_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_JsonSchemaFile_V1_1_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  JsonSchemaFileV1_1_4 = (EFI_REDFISH_JSONSCHEMAFILE_V1_1_4 *)InterpProp;
  DestroyJsonSchemaFile_V1_1_4_CS (JsonSchemaFileV1_1_4->JsonSchemaFile); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyJsonSchemaFile_V1_1_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_1_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_1_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
