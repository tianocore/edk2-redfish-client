...
//
#include <RedfishJsonStructure/JsonSchemaFile/v1_0_8/EfiJsonSchemaFileV1_0_8.h>
CHAR8 mResourceTypeStr [] = "#JsonSchemaFile";
BOOLEAN IsRevisonController = TRUE;

// Support JsonSchemaFile V1_0_8
...
{
  EFI_REDFISH_JSONSCHEMAFILE_V1_0_8 *JsonSchemaFileV1_0_8;
  EFI_REDFISH_JSONSCHEMAFILE_V1_0_8_CS *JsonSchemaFileV1_0_8Cs;
  ...
  Status = (EFI_STATUS)Json_JsonSchemaFile_V1_0_8_To_CS (ResoruceRaw, &JsonSchemaFileV1_0_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JsonSchemaFileV1_0_8 = (EFI_REDFISH_JSONSCHEMAFILE_V1_0_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JSONSCHEMAFILE_V1_0_8));
  if (JsonSchemaFileV1_0_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)JsonSchemaFileV1_0_8;
  JsonSchemaFileV1_0_8->JsonSchemaFile = JsonSchemaFileV1_0_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_JsonSchemaFile_V1_0_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_JsonSchemaFile_V1_0_8_JSON (*((EFI_REDFISH_JSONSCHEMAFILE_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_JsonSchemaFile_V1_0_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  JsonSchemaFileV1_0_8 = (EFI_REDFISH_JSONSCHEMAFILE_V1_0_8 *)InterpProp;
  DestroyJsonSchemaFile_V1_0_8_CS (JsonSchemaFileV1_0_8->JsonSchemaFile); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyJsonSchemaFile_V1_0_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_0_8EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishJsonSchemaFile_V1_0_8Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
