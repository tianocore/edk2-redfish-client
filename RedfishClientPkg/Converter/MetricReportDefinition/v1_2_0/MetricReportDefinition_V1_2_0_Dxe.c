...
//
#include <RedfishJsonStructure/MetricReportDefinition/v1_2_0/EfiMetricReportDefinitionV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#MetricReportDefinition";
BOOLEAN IsRevisonController = TRUE;

// Support MetricReportDefinition V1_2_0
...
{
  EFI_REDFISH_METRICREPORTDEFINITION_V1_2_0 *MetricReportDefinitionV1_2_0;
  EFI_REDFISH_METRICREPORTDEFINITION_V1_2_0_CS *MetricReportDefinitionV1_2_0Cs;
  ...
  Status = (EFI_STATUS)Json_MetricReportDefinition_V1_2_0_To_CS (ResoruceRaw, &MetricReportDefinitionV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MetricReportDefinitionV1_2_0 = (EFI_REDFISH_METRICREPORTDEFINITION_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_METRICREPORTDEFINITION_V1_2_0));
  if (MetricReportDefinitionV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MetricReportDefinitionV1_2_0;
  MetricReportDefinitionV1_2_0->MetricReportDefinition = MetricReportDefinitionV1_2_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MetricReportDefinition_V1_2_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MetricReportDefinition_V1_2_0_JSON (*((EFI_REDFISH_METRICREPORTDEFINITION_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MetricReportDefinition_V1_2_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MetricReportDefinitionV1_2_0 = (EFI_REDFISH_METRICREPORTDEFINITION_V1_2_0 *)InterpProp;
  DestroyMetricReportDefinition_V1_2_0_CS (MetricReportDefinitionV1_2_0->MetricReportDefinition); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMetricReportDefinition_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMetricReportDefinition_V1_2_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMetricReportDefinition_V1_2_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
