...
//
#include <RedfishJsonStructure/MetricReportDefinition/v1_0_2/EfiMetricReportDefinitionV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#MetricReportDefinition";
BOOLEAN IsRevisonController = TRUE;

// Support MetricReportDefinition V1_0_2
...
{
  EFI_REDFISH_METRICREPORTDEFINITION_V1_0_2 *MetricReportDefinitionV1_0_2;
  EFI_REDFISH_METRICREPORTDEFINITION_V1_0_2_CS *MetricReportDefinitionV1_0_2Cs;
  ...
  Status = (EFI_STATUS)Json_MetricReportDefinition_V1_0_2_To_CS (ResoruceRaw, &MetricReportDefinitionV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MetricReportDefinitionV1_0_2 = (EFI_REDFISH_METRICREPORTDEFINITION_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_METRICREPORTDEFINITION_V1_0_2));
  if (MetricReportDefinitionV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MetricReportDefinitionV1_0_2;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MetricReportDefinition_V1_0_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MetricReportDefinition_V1_0_2_JSON (*((EFI_REDFISH_METRICREPORTDEFINITION_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MetricReportDefinition_V1_0_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MetricReportDefinitionV1_0_2 = (EFI_REDFISH_METRICREPORTDEFINITION_V1_0_2 *)InterpProp;
  DestroyMetricReportDefinition_V1_0_2_CS (MetricReportDefinitionV1_0_2->MetricReportDefinition); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMetricReportDefinition_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMetricReportDefinition_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMetricReportDefinition_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
