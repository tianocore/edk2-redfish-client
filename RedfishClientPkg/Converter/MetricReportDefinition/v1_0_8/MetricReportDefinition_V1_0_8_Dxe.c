...
)
{
  ...
  return (EFI_STATUS)CS_To_MetricReportDefinition_V1_0_8_JSON (*((EFI_REDFISH_METRICREPORTDEFINITION_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
