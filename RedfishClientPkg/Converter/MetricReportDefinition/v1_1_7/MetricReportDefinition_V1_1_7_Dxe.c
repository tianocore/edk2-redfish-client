...
//
#include <RedfishJsonStructure/MetricReportDefinition/v1_1_7/EfiMetricReportDefinitionV1_1_7.h>
CHAR8 mResourceTypeStr [] = "#MetricReportDefinition";
BOOLEAN IsRevisonController = TRUE;

// Support MetricReportDefinition V1_1_7
...
{
  EFI_REDFISH_METRICREPORTDEFINITION_V1_1_7 *MetricReportDefinitionV1_1_7;
  EFI_REDFISH_METRICREPORTDEFINITION_V1_1_7_CS *MetricReportDefinitionV1_1_7Cs;
  ...
  Status = (EFI_STATUS)Json_MetricReportDefinition_V1_1_7_To_CS (ResoruceRaw, &MetricReportDefinitionV1_1_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MetricReportDefinitionV1_1_7 = (EFI_REDFISH_METRICREPORTDEFINITION_V1_1_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_METRICREPORTDEFINITION_V1_1_7));
  if (MetricReportDefinitionV1_1_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MetricReportDefinitionV1_1_7;
  MetricReportDefinitionV1_1_7->MetricReportDefinition = MetricReportDefinitionV1_1_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MetricReportDefinition_V1_1_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MetricReportDefinition_V1_1_7_JSON (*((EFI_REDFISH_METRICREPORTDEFINITION_V1_1_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MetricReportDefinition_V1_1_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MetricReportDefinitionV1_1_7 = (EFI_REDFISH_METRICREPORTDEFINITION_V1_1_7 *)InterpProp;
  DestroyMetricReportDefinition_V1_1_7_CS (MetricReportDefinitionV1_1_7->MetricReportDefinition); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMetricReportDefinition_V1_1_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMetricReportDefinition_V1_1_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMetricReportDefinition_V1_1_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
