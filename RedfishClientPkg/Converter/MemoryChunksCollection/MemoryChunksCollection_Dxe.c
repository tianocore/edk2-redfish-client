...
)
{
  ...
  return (EFI_STATUS)CS_To_MemoryChunksCollection_JSON (*((EFI_REDFISH_MEMORYCHUNKSCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
