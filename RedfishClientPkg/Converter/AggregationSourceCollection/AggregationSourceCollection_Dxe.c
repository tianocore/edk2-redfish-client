...
)
{
  ...
  return (EFI_STATUS)CS_To_AggregationSourceCollection_JSON (*((EFI_REDFISH_AGGREGATIONSOURCECOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
