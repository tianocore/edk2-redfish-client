...
//
#include <RedfishJsonStructure/AccountService/v1_3_2/EfiAccountServiceV1_3_2.h>
CHAR8 mResourceTypeStr [] = "#AccountService";
BOOLEAN IsRevisonController = TRUE;

// Support AccountService V1_3_2
...
{
  EFI_REDFISH_ACCOUNTSERVICE_V1_3_2 *AccountServiceV1_3_2;
  EFI_REDFISH_ACCOUNTSERVICE_V1_3_2_CS *AccountServiceV1_3_2Cs;
  ...
  Status = (EFI_STATUS)Json_AccountService_V1_3_2_To_CS (ResoruceRaw, &AccountServiceV1_3_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccountServiceV1_3_2 = (EFI_REDFISH_ACCOUNTSERVICE_V1_3_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_3_2));
  if (AccountServiceV1_3_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AccountServiceV1_3_2;
  AccountServiceV1_3_2->AccountService = AccountServiceV1_3_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AccountService_V1_3_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AccountService_V1_3_2_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_3_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AccountService_V1_3_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AccountServiceV1_3_2 = (EFI_REDFISH_ACCOUNTSERVICE_V1_3_2 *)InterpProp;
  DestroyAccountService_V1_3_2_CS (AccountServiceV1_3_2->AccountService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAccountService_V1_3_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_3_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_3_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
