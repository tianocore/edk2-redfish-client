...
//
#include <RedfishJsonStructure/AccountService/v1_0_12/EfiAccountServiceV1_0_12.h>
CHAR8 mResourceTypeStr [] = "#AccountService";
BOOLEAN IsRevisonController = TRUE;

// Support AccountService V1_0_12
...
{
  EFI_REDFISH_ACCOUNTSERVICE_V1_0_12 *AccountServiceV1_0_12;
  EFI_REDFISH_ACCOUNTSERVICE_V1_0_12_CS *AccountServiceV1_0_12Cs;
  ...
  Status = (EFI_STATUS)Json_AccountService_V1_0_12_To_CS (ResoruceRaw, &AccountServiceV1_0_12Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccountServiceV1_0_12 = (EFI_REDFISH_ACCOUNTSERVICE_V1_0_12 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_0_12));
  if (AccountServiceV1_0_12 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AccountServiceV1_0_12;
  AccountServiceV1_0_12->AccountService = AccountServiceV1_0_12Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AccountService_V1_0_12_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AccountService_V1_0_12_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_0_12_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AccountService_V1_0_12_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AccountServiceV1_0_12 = (EFI_REDFISH_ACCOUNTSERVICE_V1_0_12 *)InterpProp;
  DestroyAccountService_V1_0_12_CS (AccountServiceV1_0_12->AccountService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAccountService_V1_0_12_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_0_12EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_0_12Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
