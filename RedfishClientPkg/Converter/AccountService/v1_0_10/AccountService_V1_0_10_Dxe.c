...
//
#include <RedfishJsonStructure/AccountService/v1_0_10/EfiAccountServiceV1_0_10.h>
CHAR8 mResourceTypeStr [] = "#AccountService";
BOOLEAN IsRevisonController = TRUE;

// Support AccountService V1_0_10
...
{
  EFI_REDFISH_ACCOUNTSERVICE_V1_0_10 *AccountServiceV1_0_10;
  EFI_REDFISH_ACCOUNTSERVICE_V1_0_10_CS *AccountServiceV1_0_10Cs;
  ...
  Status = (EFI_STATUS)Json_AccountService_V1_0_10_To_CS (ResoruceRaw, &AccountServiceV1_0_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccountServiceV1_0_10 = (EFI_REDFISH_ACCOUNTSERVICE_V1_0_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_0_10));
  if (AccountServiceV1_0_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AccountServiceV1_0_10;
  AccountServiceV1_0_10->AccountService = AccountServiceV1_0_10Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AccountService_V1_0_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AccountService_V1_0_10_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_0_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AccountService_V1_0_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AccountServiceV1_0_10 = (EFI_REDFISH_ACCOUNTSERVICE_V1_0_10 *)InterpProp;
  DestroyAccountService_V1_0_10_CS (AccountServiceV1_0_10->AccountService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAccountService_V1_0_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_0_10EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_0_10Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
