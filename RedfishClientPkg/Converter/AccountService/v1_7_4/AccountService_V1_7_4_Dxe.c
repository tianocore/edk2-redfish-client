...
//
#include <RedfishJsonStructure/AccountService/v1_7_4/EfiAccountServiceV1_7_4.h>
CHAR8 mResourceTypeStr [] = "#AccountService";
BOOLEAN IsRevisonController = TRUE;

// Support AccountService V1_7_4
...
{
  EFI_REDFISH_ACCOUNTSERVICE_V1_7_4 *AccountServiceV1_7_4;
  EFI_REDFISH_ACCOUNTSERVICE_V1_7_4_CS *AccountServiceV1_7_4Cs;
  ...
  Status = (EFI_STATUS)Json_AccountService_V1_7_4_To_CS (ResoruceRaw, &AccountServiceV1_7_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccountServiceV1_7_4 = (EFI_REDFISH_ACCOUNTSERVICE_V1_7_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_7_4));
  if (AccountServiceV1_7_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AccountServiceV1_7_4;
  AccountServiceV1_7_4->AccountService = AccountServiceV1_7_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AccountService_V1_7_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AccountService_V1_7_4_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_7_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AccountService_V1_7_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AccountServiceV1_7_4 = (EFI_REDFISH_ACCOUNTSERVICE_V1_7_4 *)InterpProp;
  DestroyAccountService_V1_7_4_CS (AccountServiceV1_7_4->AccountService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAccountService_V1_7_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_7_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_7_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
