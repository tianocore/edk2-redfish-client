...
//
#include <RedfishJsonStructure/AccountService/v1_4_6/EfiAccountServiceV1_4_6.h>
CHAR8 mResourceTypeStr [] = "#AccountService";
BOOLEAN IsRevisonController = TRUE;

// Support AccountService V1_4_6
...
{
  EFI_REDFISH_ACCOUNTSERVICE_V1_4_6 *AccountServiceV1_4_6;
  EFI_REDFISH_ACCOUNTSERVICE_V1_4_6_CS *AccountServiceV1_4_6Cs;
  ...
  Status = (EFI_STATUS)Json_AccountService_V1_4_6_To_CS (ResoruceRaw, &AccountServiceV1_4_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccountServiceV1_4_6 = (EFI_REDFISH_ACCOUNTSERVICE_V1_4_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_4_6));
  if (AccountServiceV1_4_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AccountServiceV1_4_6;
  AccountServiceV1_4_6->AccountService = AccountServiceV1_4_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AccountService_V1_4_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AccountService_V1_4_6_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_4_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AccountService_V1_4_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AccountServiceV1_4_6 = (EFI_REDFISH_ACCOUNTSERVICE_V1_4_6 *)InterpProp;
  DestroyAccountService_V1_4_6_CS (AccountServiceV1_4_6->AccountService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAccountService_V1_4_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_4_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_4_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
