...
//
#include <RedfishJsonStructure/AccountService/v1_2_7/EfiAccountServiceV1_2_7.h>
CHAR8 mResourceTypeStr [] = "#AccountService";
BOOLEAN IsRevisonController = TRUE;

// Support AccountService V1_2_7
...
{
  EFI_REDFISH_ACCOUNTSERVICE_V1_2_7 *AccountServiceV1_2_7;
  EFI_REDFISH_ACCOUNTSERVICE_V1_2_7_CS *AccountServiceV1_2_7Cs;
  ...
  Status = (EFI_STATUS)Json_AccountService_V1_2_7_To_CS (ResoruceRaw, &AccountServiceV1_2_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccountServiceV1_2_7 = (EFI_REDFISH_ACCOUNTSERVICE_V1_2_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_2_7));
  if (AccountServiceV1_2_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AccountServiceV1_2_7;
  AccountServiceV1_2_7->AccountService = AccountServiceV1_2_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AccountService_V1_2_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AccountService_V1_2_7_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_2_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AccountService_V1_2_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AccountServiceV1_2_7 = (EFI_REDFISH_ACCOUNTSERVICE_V1_2_7 *)InterpProp;
  DestroyAccountService_V1_2_7_CS (AccountServiceV1_2_7->AccountService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAccountService_V1_2_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_2_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_2_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
