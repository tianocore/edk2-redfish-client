...
//
#include <RedfishJsonStructure/AccountService/v1_0_11/EfiAccountServiceV1_0_11.h>
CHAR8 mResourceTypeStr [] = "#AccountService";
BOOLEAN IsRevisonController = TRUE;

// Support AccountService V1_0_11
...
{
  EFI_REDFISH_ACCOUNTSERVICE_V1_0_11 *AccountServiceV1_0_11;
  EFI_REDFISH_ACCOUNTSERVICE_V1_0_11_CS *AccountServiceV1_0_11Cs;
  ...
  Status = (EFI_STATUS)Json_AccountService_V1_0_11_To_CS (ResoruceRaw, &AccountServiceV1_0_11Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccountServiceV1_0_11 = (EFI_REDFISH_ACCOUNTSERVICE_V1_0_11 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_0_11));
  if (AccountServiceV1_0_11 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AccountServiceV1_0_11;
  AccountServiceV1_0_11->AccountService = AccountServiceV1_0_11Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AccountService_V1_0_11_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AccountService_V1_0_11_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_0_11_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AccountService_V1_0_11_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AccountServiceV1_0_11 = (EFI_REDFISH_ACCOUNTSERVICE_V1_0_11 *)InterpProp;
  DestroyAccountService_V1_0_11_CS (AccountServiceV1_0_11->AccountService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAccountService_V1_0_11_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_0_11EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_0_11Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
