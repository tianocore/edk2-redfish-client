...
//
#include <RedfishJsonStructure/AccountService/v1_10_0/EfiAccountServiceV1_10_0.h>
CHAR8 mResourceTypeStr [] = "#AccountService";
BOOLEAN IsRevisonController = TRUE;

// Support AccountService V1_10_0
...
{
  EFI_REDFISH_ACCOUNTSERVICE_V1_10_0 *AccountServiceV1_10_0;
  EFI_REDFISH_ACCOUNTSERVICE_V1_10_0_CS *AccountServiceV1_10_0Cs;
  ...
  Status = (EFI_STATUS)Json_AccountService_V1_10_0_To_CS (ResoruceRaw, &AccountServiceV1_10_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccountServiceV1_10_0 = (EFI_REDFISH_ACCOUNTSERVICE_V1_10_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_10_0));
  if (AccountServiceV1_10_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AccountServiceV1_10_0;
  AccountServiceV1_10_0->AccountService = AccountServiceV1_10_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AccountService_V1_10_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AccountService_V1_10_0_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_10_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AccountService_V1_10_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AccountServiceV1_10_0 = (EFI_REDFISH_ACCOUNTSERVICE_V1_10_0 *)InterpProp;
  DestroyAccountService_V1_10_0_CS (AccountServiceV1_10_0->AccountService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAccountService_V1_10_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_10_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_10_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
