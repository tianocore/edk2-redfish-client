...
//
#include <RedfishJsonStructure/AccountService/v1_3_5/EfiAccountServiceV1_3_5.h>
CHAR8 mResourceTypeStr [] = "#AccountService";
BOOLEAN IsRevisonController = TRUE;

// Support AccountService V1_3_5
...
{
  EFI_REDFISH_ACCOUNTSERVICE_V1_3_5 *AccountServiceV1_3_5;
  EFI_REDFISH_ACCOUNTSERVICE_V1_3_5_CS *AccountServiceV1_3_5Cs;
  ...
  Status = (EFI_STATUS)Json_AccountService_V1_3_5_To_CS (ResoruceRaw, &AccountServiceV1_3_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccountServiceV1_3_5 = (EFI_REDFISH_ACCOUNTSERVICE_V1_3_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_3_5));
  if (AccountServiceV1_3_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AccountServiceV1_3_5;
  AccountServiceV1_3_5->AccountService = AccountServiceV1_3_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AccountService_V1_3_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AccountService_V1_3_5_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_3_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AccountService_V1_3_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AccountServiceV1_3_5 = (EFI_REDFISH_ACCOUNTSERVICE_V1_3_5 *)InterpProp;
  DestroyAccountService_V1_3_5_CS (AccountServiceV1_3_5->AccountService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAccountService_V1_3_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_3_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_3_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
