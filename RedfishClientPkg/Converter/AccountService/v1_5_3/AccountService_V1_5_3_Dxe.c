...
//
#include <RedfishJsonStructure/AccountService/v1_5_3/EfiAccountServiceV1_5_3.h>
CHAR8 mResourceTypeStr [] = "#AccountService";
BOOLEAN IsRevisonController = TRUE;

// Support AccountService V1_5_3
...
{
  EFI_REDFISH_ACCOUNTSERVICE_V1_5_3 *AccountServiceV1_5_3;
  EFI_REDFISH_ACCOUNTSERVICE_V1_5_3_CS *AccountServiceV1_5_3Cs;
  ...
  Status = (EFI_STATUS)Json_AccountService_V1_5_3_To_CS (ResoruceRaw, &AccountServiceV1_5_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccountServiceV1_5_3 = (EFI_REDFISH_ACCOUNTSERVICE_V1_5_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_5_3));
  if (AccountServiceV1_5_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AccountServiceV1_5_3;
  AccountServiceV1_5_3->AccountService = AccountServiceV1_5_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AccountService_V1_5_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AccountService_V1_5_3_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_5_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AccountService_V1_5_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AccountServiceV1_5_3 = (EFI_REDFISH_ACCOUNTSERVICE_V1_5_3 *)InterpProp;
  DestroyAccountService_V1_5_3_CS (AccountServiceV1_5_3->AccountService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAccountService_V1_5_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_5_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_5_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
