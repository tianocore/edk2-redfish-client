...
)
{
  ...
  return (EFI_STATUS)CS_To_AccountService_V1_1_6_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_1_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
