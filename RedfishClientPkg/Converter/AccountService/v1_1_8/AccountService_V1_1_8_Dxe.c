...
//
#include <RedfishJsonStructure/AccountService/v1_1_8/EfiAccountServiceV1_1_8.h>
CHAR8 mResourceTypeStr [] = "#AccountService";
BOOLEAN IsRevisonController = TRUE;

// Support AccountService V1_1_8
...
{
  EFI_REDFISH_ACCOUNTSERVICE_V1_1_8 *AccountServiceV1_1_8;
  EFI_REDFISH_ACCOUNTSERVICE_V1_1_8_CS *AccountServiceV1_1_8Cs;
  ...
  Status = (EFI_STATUS)Json_AccountService_V1_1_8_To_CS (ResoruceRaw, &AccountServiceV1_1_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccountServiceV1_1_8 = (EFI_REDFISH_ACCOUNTSERVICE_V1_1_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCOUNTSERVICE_V1_1_8));
  if (AccountServiceV1_1_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AccountServiceV1_1_8;
  AccountServiceV1_1_8->AccountService = AccountServiceV1_1_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AccountService_V1_1_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AccountService_V1_1_8_JSON (*((EFI_REDFISH_ACCOUNTSERVICE_V1_1_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AccountService_V1_1_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AccountServiceV1_1_8 = (EFI_REDFISH_ACCOUNTSERVICE_V1_1_8 *)InterpProp;
  DestroyAccountService_V1_1_8_CS (AccountServiceV1_1_8->AccountService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAccountService_V1_1_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_1_8EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccountService_V1_1_8Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
