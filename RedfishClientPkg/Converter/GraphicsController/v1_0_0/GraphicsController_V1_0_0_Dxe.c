...
//
#include <RedfishJsonStructure/GraphicsController/v1_0_0/EfiGraphicsControllerV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#GraphicsController";
BOOLEAN IsRevisonController = TRUE;

// Support GraphicsController V1_0_0
...
{
  EFI_REDFISH_GRAPHICSCONTROLLER_V1_0_0 *GraphicsControllerV1_0_0;
  EFI_REDFISH_GRAPHICSCONTROLLER_V1_0_0_CS *GraphicsControllerV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "GraphicsController") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_GraphicsController_V1_0_0_To_CS (ResoruceRaw, &GraphicsControllerV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  GraphicsControllerV1_0_0 = (EFI_REDFISH_GRAPHICSCONTROLLER_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_GRAPHICSCONTROLLER_V1_0_0));
  if (GraphicsControllerV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)GraphicsControllerV1_0_0;
  GraphicsControllerV1_0_0->GraphicsController = GraphicsControllerV1_0_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("GraphicsController"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("GraphicsController"), "GraphicsController");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("GraphicsController"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("GraphicsController"), "GraphicsController");
...
/**
  The wrapper function of GraphicsControllerToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
GraphicsControllerToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return GraphicsControllerToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_GraphicsController_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_GraphicsController_V1_0_0_JSON (*((EFI_REDFISH_GRAPHICSCONTROLLER_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_GraphicsController_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in GraphicsControllerToStruct.
...
EFI_STATUS
EFIAPI
GraphicsControllerDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  GraphicsControllerV1_0_0 = (EFI_REDFISH_GRAPHICSCONTROLLER_V1_0_0 *)InterpProp;
  DestroyGraphicsController_V1_0_0_CS (GraphicsControllerV1_0_0->GraphicsController); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from GraphicsControllerFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyGraphicsController_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishGraphicsController_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishGraphicsController_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
