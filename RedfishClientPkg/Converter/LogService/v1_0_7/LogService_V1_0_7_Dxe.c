...
//
#include <RedfishJsonStructure/LogService/v1_0_7/EfiLogServiceV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#LogService";
BOOLEAN IsRevisonController = TRUE;

// Support LogService V1_0_7
...
{
  EFI_REDFISH_LOGSERVICE_V1_0_7 *LogServiceV1_0_7;
  EFI_REDFISH_LOGSERVICE_V1_0_7_CS *LogServiceV1_0_7Cs;
  ...
  Status = (EFI_STATUS)Json_LogService_V1_0_7_To_CS (ResoruceRaw, &LogServiceV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogServiceV1_0_7 = (EFI_REDFISH_LOGSERVICE_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGSERVICE_V1_0_7));
  if (LogServiceV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)LogServiceV1_0_7;
  LogServiceV1_0_7->LogService = LogServiceV1_0_7Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("LogService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("LogService"), "LogService");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("LogService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("LogService"), "LogService");
...
/**
  The wrapper function of LogServiceToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_LogService_V1_0_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_LogService_V1_0_7_JSON (*((EFI_REDFISH_LOGSERVICE_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_LogService_V1_0_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  LogServiceV1_0_7 = (EFI_REDFISH_LOGSERVICE_V1_0_7 *)InterpProp;
  DestroyLogService_V1_0_7_CS (LogServiceV1_0_7->LogService); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from LogServiceFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyLogService_V1_0_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_0_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_0_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
