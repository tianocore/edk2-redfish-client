...
//
#include <RedfishJsonStructure/LogService/v1_1_2/EfiLogServiceV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#LogService";
BOOLEAN IsRevisonController = TRUE;

// Support LogService V1_1_2
...
{
  EFI_REDFISH_LOGSERVICE_V1_1_2 *LogServiceV1_1_2;
  EFI_REDFISH_LOGSERVICE_V1_1_2_CS *LogServiceV1_1_2Cs;
  ...
  Status = (EFI_STATUS)Json_LogService_V1_1_2_To_CS (ResoruceRaw, &LogServiceV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogServiceV1_1_2 = (EFI_REDFISH_LOGSERVICE_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGSERVICE_V1_1_2));
  if (LogServiceV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)LogServiceV1_1_2;
  LogServiceV1_1_2->LogService = LogServiceV1_1_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_LogService_V1_1_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_LogService_V1_1_2_JSON (*((EFI_REDFISH_LOGSERVICE_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_LogService_V1_1_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  LogServiceV1_1_2 = (EFI_REDFISH_LOGSERVICE_V1_1_2 *)InterpProp;
  DestroyLogService_V1_1_2_CS (LogServiceV1_1_2->LogService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyLogService_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
