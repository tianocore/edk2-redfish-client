...
//
#include <RedfishJsonStructure/LogService/v1_0_8/EfiLogServiceV1_0_8.h>
CHAR8 mResourceTypeStr [] = "#LogService";
BOOLEAN IsRevisonController = TRUE;

// Support LogService V1_0_8
...
{
  EFI_REDFISH_LOGSERVICE_V1_0_8 *LogServiceV1_0_8;
  EFI_REDFISH_LOGSERVICE_V1_0_8_CS *LogServiceV1_0_8Cs;
  ...
  Status = (EFI_STATUS)Json_LogService_V1_0_8_To_CS (ResoruceRaw, &LogServiceV1_0_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogServiceV1_0_8 = (EFI_REDFISH_LOGSERVICE_V1_0_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGSERVICE_V1_0_8));
  if (LogServiceV1_0_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)LogServiceV1_0_8;
  LogServiceV1_0_8->LogService = LogServiceV1_0_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_LogService_V1_0_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_LogService_V1_0_8_JSON (*((EFI_REDFISH_LOGSERVICE_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_LogService_V1_0_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  LogServiceV1_0_8 = (EFI_REDFISH_LOGSERVICE_V1_0_8 *)InterpProp;
  DestroyLogService_V1_0_8_CS (LogServiceV1_0_8->LogService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyLogService_V1_0_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_0_8EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_0_8Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
