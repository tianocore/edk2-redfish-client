...
//
#include <RedfishJsonStructure/LogService/v1_2_1/EfiLogServiceV1_2_1.h>
CHAR8 mResourceTypeStr [] = "#LogService";
BOOLEAN IsRevisonController = TRUE;

// Support LogService V1_2_1
...
{
  EFI_REDFISH_LOGSERVICE_V1_2_1 *LogServiceV1_2_1;
  EFI_REDFISH_LOGSERVICE_V1_2_1_CS *LogServiceV1_2_1Cs;
  ...
  Status = (EFI_STATUS)Json_LogService_V1_2_1_To_CS (ResoruceRaw, &LogServiceV1_2_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogServiceV1_2_1 = (EFI_REDFISH_LOGSERVICE_V1_2_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGSERVICE_V1_2_1));
  if (LogServiceV1_2_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)LogServiceV1_2_1;
  LogServiceV1_2_1->LogService = LogServiceV1_2_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_LogService_V1_2_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_LogService_V1_2_1_JSON (*((EFI_REDFISH_LOGSERVICE_V1_2_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_LogService_V1_2_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  LogServiceV1_2_1 = (EFI_REDFISH_LOGSERVICE_V1_2_1 *)InterpProp;
  DestroyLogService_V1_2_1_CS (LogServiceV1_2_1->LogService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyLogService_V1_2_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_2_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_2_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
