...
//
#include <RedfishJsonStructure/LogService/v1_1_3/EfiLogServiceV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#LogService";
BOOLEAN IsRevisonController = TRUE;

// Support LogService V1_1_3
...
{
  EFI_REDFISH_LOGSERVICE_V1_1_3 *LogServiceV1_1_3;
  EFI_REDFISH_LOGSERVICE_V1_1_3_CS *LogServiceV1_1_3Cs;
  ...
  Status = (EFI_STATUS)Json_LogService_V1_1_3_To_CS (ResoruceRaw, &LogServiceV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogServiceV1_1_3 = (EFI_REDFISH_LOGSERVICE_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGSERVICE_V1_1_3));
  if (LogServiceV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)LogServiceV1_1_3;
  LogServiceV1_1_3->LogService = LogServiceV1_1_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_LogService_V1_1_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_LogService_V1_1_3_JSON (*((EFI_REDFISH_LOGSERVICE_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_LogService_V1_1_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  LogServiceV1_1_3 = (EFI_REDFISH_LOGSERVICE_V1_1_3 *)InterpProp;
  DestroyLogService_V1_1_3_CS (LogServiceV1_1_3->LogService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyLogService_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_1_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_1_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
