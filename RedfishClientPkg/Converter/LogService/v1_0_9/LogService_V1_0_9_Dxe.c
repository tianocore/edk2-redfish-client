...
//
#include <RedfishJsonStructure/LogService/v1_0_9/EfiLogServiceV1_0_9.h>
CHAR8 mResourceTypeStr [] = "#LogService";
BOOLEAN IsRevisonController = TRUE;

// Support LogService V1_0_9
...
{
  EFI_REDFISH_LOGSERVICE_V1_0_9 *LogServiceV1_0_9;
  EFI_REDFISH_LOGSERVICE_V1_0_9_CS *LogServiceV1_0_9Cs;
  ...
  Status = (EFI_STATUS)Json_LogService_V1_0_9_To_CS (ResoruceRaw, &LogServiceV1_0_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogServiceV1_0_9 = (EFI_REDFISH_LOGSERVICE_V1_0_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGSERVICE_V1_0_9));
  if (LogServiceV1_0_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)LogServiceV1_0_9;
  LogServiceV1_0_9->LogService = LogServiceV1_0_9Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_LogService_V1_0_9_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_LogService_V1_0_9_JSON (*((EFI_REDFISH_LOGSERVICE_V1_0_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_LogService_V1_0_9_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  LogServiceV1_0_9 = (EFI_REDFISH_LOGSERVICE_V1_0_9 *)InterpProp;
  DestroyLogService_V1_0_9_CS (LogServiceV1_0_9->LogService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyLogService_V1_0_9_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_0_9EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_0_9Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
