...
//
#include <RedfishJsonStructure/LogService/v1_3_0/EfiLogServiceV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#LogService";
BOOLEAN IsRevisonController = TRUE;

// Support LogService V1_3_0
...
{
  EFI_REDFISH_LOGSERVICE_V1_3_0 *LogServiceV1_3_0;
  EFI_REDFISH_LOGSERVICE_V1_3_0_CS *LogServiceV1_3_0Cs;
  ...
  Status = (EFI_STATUS)Json_LogService_V1_3_0_To_CS (ResoruceRaw, &LogServiceV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogServiceV1_3_0 = (EFI_REDFISH_LOGSERVICE_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGSERVICE_V1_3_0));
  if (LogServiceV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)LogServiceV1_3_0;
  LogServiceV1_3_0->LogService = LogServiceV1_3_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_LogService_V1_3_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_LogService_V1_3_0_JSON (*((EFI_REDFISH_LOGSERVICE_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_LogService_V1_3_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  LogServiceV1_3_0 = (EFI_REDFISH_LOGSERVICE_V1_3_0 *)InterpProp;
  DestroyLogService_V1_3_0_CS (LogServiceV1_3_0->LogService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyLogService_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_3_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishLogService_V1_3_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
