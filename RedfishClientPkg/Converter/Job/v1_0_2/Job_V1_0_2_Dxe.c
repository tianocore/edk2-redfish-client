...
//
#include <RedfishJsonStructure/Job/v1_0_2/EfiJobV1_0_2.h>
...
{
  EFI_REDFISH_JOB_V1_0_2 *JobV1_0_2;
  EFI_REDFISH_JOB_V1_0_2_CS *JobV1_0_2Cs;
  ...
  Status = (EFI_STATUS)Json_Job_V1_0_2_To_CS (ResoruceRaw, &JobV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JobV1_0_2 = (EFI_REDFISH_JOB_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JOB_V1_0_2));
  if (JobV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)JobV1_0_2;
  JobV1_0_2->Job = JobV1_0_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Job_V1_0_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Job_V1_0_2_JSON (*((EFI_REDFISH_JOB_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Job_V1_0_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  JobV1_0_2 = (EFI_REDFISH_JOB_V1_0_2 *)InterpProp;
  DestroyJob_V1_0_2_CS (JobV1_0_2->Job); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyJob_V1_0_2_Json (ResoruceRaw);
}
