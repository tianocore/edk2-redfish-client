...
//
#include <RedfishJsonStructure/Job/v1_0_4/EfiJobV1_0_4.h>
...
{
  EFI_REDFISH_JOB_V1_0_4 *JobV1_0_4;
  EFI_REDFISH_JOB_V1_0_4_CS *JobV1_0_4Cs;
  ...
  Status = (EFI_STATUS)Json_Job_V1_0_4_To_CS (ResoruceRaw, &JobV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JobV1_0_4 = (EFI_REDFISH_JOB_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JOB_V1_0_4));
  if (JobV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)JobV1_0_4;
  JobV1_0_4->Job = JobV1_0_4Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Job"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("Job"), "Job");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Job"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("Job"), "Job");
...
/**
  The wrapper function of JobToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Job_V1_0_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Job_V1_0_4_JSON (*((EFI_REDFISH_JOB_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Job_V1_0_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  JobV1_0_4 = (EFI_REDFISH_JOB_V1_0_4 *)InterpProp;
  DestroyJob_V1_0_4_CS (JobV1_0_4->Job); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from JobFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyJob_V1_0_4_Json (ResoruceRaw);
}
