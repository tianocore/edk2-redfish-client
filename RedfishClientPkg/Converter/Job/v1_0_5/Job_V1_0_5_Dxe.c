...
//
#include <RedfishJsonStructure/Job/v1_0_5/EfiJobV1_0_5.h>
...
{
  EFI_REDFISH_JOB_V1_0_5 *JobV1_0_5;
  EFI_REDFISH_JOB_V1_0_5_CS *JobV1_0_5Cs;
  ...
  Status = (EFI_STATUS)Json_Job_V1_0_5_To_CS (ResoruceRaw, &JobV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JobV1_0_5 = (EFI_REDFISH_JOB_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JOB_V1_0_5));
  if (JobV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)JobV1_0_5;
  JobV1_0_5->Job = JobV1_0_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Job_V1_0_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Job_V1_0_5_JSON (*((EFI_REDFISH_JOB_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Job_V1_0_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  JobV1_0_5 = (EFI_REDFISH_JOB_V1_0_5 *)InterpProp;
  DestroyJob_V1_0_5_CS (JobV1_0_5->Job); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyJob_V1_0_5_Json (ResoruceRaw);
}
