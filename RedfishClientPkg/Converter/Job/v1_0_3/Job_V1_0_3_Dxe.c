...
//
#include <RedfishJsonStructure/Job/v1_0_3/EfiJobV1_0_3.h>
...
{
  EFI_REDFISH_JOB_V1_0_3 *JobV1_0_3;
  EFI_REDFISH_JOB_V1_0_3_CS *JobV1_0_3Cs;
  ...
  Status = (EFI_STATUS)Json_Job_V1_0_3_To_CS (ResoruceRaw, &JobV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  JobV1_0_3 = (EFI_REDFISH_JOB_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_JOB_V1_0_3));
  if (JobV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)JobV1_0_3;
  JobV1_0_3->Job = JobV1_0_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Job_V1_0_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Job_V1_0_3_JSON (*((EFI_REDFISH_JOB_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Job_V1_0_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  JobV1_0_3 = (EFI_REDFISH_JOB_V1_0_3 *)InterpProp;
  DestroyJob_V1_0_3_CS (JobV1_0_3->Job); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyJob_V1_0_3_Json (ResoruceRaw);
}
