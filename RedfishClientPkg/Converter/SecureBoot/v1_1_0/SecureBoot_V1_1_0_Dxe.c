...
{
  EFI_REDFISH_SECUREBOOT_V1_1_0 *SecureBootV1_1_0;
  EFI_REDFISH_SECUREBOOT_V1_1_0_CS *SecureBootV1_1_0Cs;
  ...
  Status = (EFI_STATUS)Json_SecureBoot_V1_1_0_To_CS (ResoruceRaw, &SecureBootV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SecureBootV1_1_0 = (EFI_REDFISH_SECUREBOOT_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SECUREBOOT_V1_1_0));
  if (SecureBootV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SecureBootV1_1_0;
  SecureBootV1_1_0->SecureBoot = SecureBootV1_1_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SecureBoot_V1_1_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SecureBoot_V1_1_0_JSON (*((EFI_REDFISH_SECUREBOOT_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SecureBoot_V1_1_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SecureBootV1_1_0 = (EFI_REDFISH_SECUREBOOT_V1_1_0 *)InterpProp;
  DestroySecureBoot_V1_1_0_CS (SecureBootV1_1_0->SecureBoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySecureBoot_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSecureBoot_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSecureBoot_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
