...
//
#include <RedfishJsonStructure/SecureBoot/v1_0_5/EfiSecureBootV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#SecureBoot";
BOOLEAN IsRevisonController = TRUE;

// Support SecureBoot V1_0_5
...
{
  EFI_REDFISH_SECUREBOOT_V1_0_5 *SecureBootV1_0_5;
  EFI_REDFISH_SECUREBOOT_V1_0_5_CS *SecureBootV1_0_5Cs;
  ...
  Status = (EFI_STATUS)Json_SecureBoot_V1_0_5_To_CS (ResoruceRaw, &SecureBootV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SecureBootV1_0_5 = (EFI_REDFISH_SECUREBOOT_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SECUREBOOT_V1_0_5));
  if (SecureBootV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SecureBootV1_0_5;
  SecureBootV1_0_5->SecureBoot = SecureBootV1_0_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SecureBoot_V1_0_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SecureBoot_V1_0_5_JSON (*((EFI_REDFISH_SECUREBOOT_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SecureBoot_V1_0_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SecureBootV1_0_5 = (EFI_REDFISH_SECUREBOOT_V1_0_5 *)InterpProp;
  DestroySecureBoot_V1_0_5_CS (SecureBootV1_0_5->SecureBoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySecureBoot_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSecureBoot_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSecureBoot_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
