...
//
#include <RedfishJsonStructure/SecureBoot/v1_0_7/EfiSecureBootV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#SecureBoot";
BOOLEAN IsRevisonController = TRUE;

// Support SecureBoot V1_0_7
...
{
  EFI_REDFISH_SECUREBOOT_V1_0_7 *SecureBootV1_0_7;
  EFI_REDFISH_SECUREBOOT_V1_0_7_CS *SecureBootV1_0_7Cs;
  ...
  Status = (EFI_STATUS)Json_SecureBoot_V1_0_7_To_CS (ResoruceRaw, &SecureBootV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SecureBootV1_0_7 = (EFI_REDFISH_SECUREBOOT_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SECUREBOOT_V1_0_7));
  if (SecureBootV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SecureBootV1_0_7;
  SecureBootV1_0_7->SecureBoot = SecureBootV1_0_7Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("SecureBoot"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("SecureBoot"), "SecureBoot");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("SecureBoot"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("SecureBoot"), "SecureBoot");
...
/**
  The wrapper function of SecureBootToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SecureBoot_V1_0_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SecureBoot_V1_0_7_JSON (*((EFI_REDFISH_SECUREBOOT_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SecureBoot_V1_0_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SecureBootV1_0_7 = (EFI_REDFISH_SECUREBOOT_V1_0_7 *)InterpProp;
  DestroySecureBoot_V1_0_7_CS (SecureBootV1_0_7->SecureBoot); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from SecureBootFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroySecureBoot_V1_0_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSecureBoot_V1_0_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSecureBoot_V1_0_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
