...
//
#include <RedfishJsonStructure/PowerSubsystem/v1_1_0/EfiPowerSubsystemV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#PowerSubsystem";
BOOLEAN IsRevisonController = TRUE;

// Support PowerSubsystem V1_1_0
...
{
  EFI_REDFISH_POWERSUBSYSTEM_V1_1_0 *PowerSubsystemV1_1_0;
  EFI_REDFISH_POWERSUBSYSTEM_V1_1_0_CS *PowerSubsystemV1_1_0Cs;
  ...
  Status = (EFI_STATUS)Json_PowerSubsystem_V1_1_0_To_CS (ResoruceRaw, &PowerSubsystemV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerSubsystemV1_1_0 = (EFI_REDFISH_POWERSUBSYSTEM_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWERSUBSYSTEM_V1_1_0));
  if (PowerSubsystemV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerSubsystemV1_1_0;
  PowerSubsystemV1_1_0->PowerSubsystem = PowerSubsystemV1_1_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PowerSubsystem_V1_1_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PowerSubsystem_V1_1_0_JSON (*((EFI_REDFISH_POWERSUBSYSTEM_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PowerSubsystem_V1_1_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerSubsystemV1_1_0 = (EFI_REDFISH_POWERSUBSYSTEM_V1_1_0 *)InterpProp;
  DestroyPowerSubsystem_V1_1_0_CS (PowerSubsystemV1_1_0->PowerSubsystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPowerSubsystem_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPowerSubsystem_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPowerSubsystem_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
