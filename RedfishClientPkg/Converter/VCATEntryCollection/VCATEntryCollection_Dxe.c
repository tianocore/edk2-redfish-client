...
)
{
  ...
  return (EFI_STATUS)CS_To_VCATEntryCollection_JSON (*((EFI_REDFISH_VCATENTRYCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
