...
)
{
  ...
  return (EFI_STATUS)CS_To_PowerDistributionCollection_JSON (*((EFI_REDFISH_POWERDISTRIBUTIONCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
