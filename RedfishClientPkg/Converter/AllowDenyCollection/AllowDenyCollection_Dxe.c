...
)
{
  ...
  return (EFI_STATUS)CS_To_AllowDenyCollection_JSON (*((EFI_REDFISH_ALLOWDENYCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
