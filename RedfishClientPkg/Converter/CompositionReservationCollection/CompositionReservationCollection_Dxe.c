...
)
{
  ...
  return (EFI_STATUS)CS_To_CompositionReservationCollection_JSON (*((EFI_REDFISH_COMPOSITIONRESERVATIONCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
