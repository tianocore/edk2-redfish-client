...
//
#include <RedfishJsonStructure/ThermalMetrics/v1_0_0/EfiThermalMetricsV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#ThermalMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support ThermalMetrics V1_0_0
...
{
  EFI_REDFISH_THERMALMETRICS_V1_0_0 *ThermalMetricsV1_0_0;
  EFI_REDFISH_THERMALMETRICS_V1_0_0_CS *ThermalMetricsV1_0_0Cs;
  ...
  Status = (EFI_STATUS)Json_ThermalMetrics_V1_0_0_To_CS (ResoruceRaw, &ThermalMetricsV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalMetricsV1_0_0 = (EFI_REDFISH_THERMALMETRICS_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMALMETRICS_V1_0_0));
  if (ThermalMetricsV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ThermalMetricsV1_0_0;
  ThermalMetricsV1_0_0->ThermalMetrics = ThermalMetricsV1_0_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ThermalMetrics_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ThermalMetrics_V1_0_0_JSON (*((EFI_REDFISH_THERMALMETRICS_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ThermalMetrics_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ThermalMetricsV1_0_0 = (EFI_REDFISH_THERMALMETRICS_V1_0_0 *)InterpProp;
  DestroyThermalMetrics_V1_0_0_CS (ThermalMetricsV1_0_0->ThermalMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyThermalMetrics_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermalMetrics_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishThermalMetrics_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
