...
// Support SecureBootDatabase V1_0_1
...
{
  EFI_REDFISH_SECUREBOOTDATABASE_V1_0_1 *SecureBootDatabaseV1_0_1;
  EFI_REDFISH_SECUREBOOTDATABASE_V1_0_1_CS *SecureBootDatabaseV1_0_1Cs;
  ...
  Status = (EFI_STATUS)Json_SecureBootDatabase_V1_0_1_To_CS (ResoruceRaw, &SecureBootDatabaseV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SecureBootDatabaseV1_0_1 = (EFI_REDFISH_SECUREBOOTDATABASE_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SECUREBOOTDATABASE_V1_0_1));
  if (SecureBootDatabaseV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SecureBootDatabaseV1_0_1;
  SecureBootDatabaseV1_0_1->SecureBootDatabase = SecureBootDatabaseV1_0_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SecureBootDatabase_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SecureBootDatabase_V1_0_1_JSON (*((EFI_REDFISH_SECUREBOOTDATABASE_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SecureBootDatabase_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SecureBootDatabaseV1_0_1 = (EFI_REDFISH_SECUREBOOTDATABASE_V1_0_1 *)InterpProp;
  DestroySecureBootDatabase_V1_0_1_CS (SecureBootDatabaseV1_0_1->SecureBootDatabase); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySecureBootDatabase_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSecureBootDatabase_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSecureBootDatabase_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
