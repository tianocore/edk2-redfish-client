...
//
#include <RedfishJsonStructure/Port/v1_2_5/EfiPortV1_2_5.h>
...
{
  EFI_REDFISH_PORT_V1_2_5 *PortV1_2_5;
  EFI_REDFISH_PORT_V1_2_5_CS *PortV1_2_5Cs;
  ...
  Status = (EFI_STATUS)Json_Port_V1_2_5_To_CS (ResoruceRaw, &PortV1_2_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PortV1_2_5 = (EFI_REDFISH_PORT_V1_2_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PORT_V1_2_5));
  if (PortV1_2_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PortV1_2_5;
  PortV1_2_5->Port = PortV1_2_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Port_V1_2_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Port_V1_2_5_JSON (*((EFI_REDFISH_PORT_V1_2_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Port_V1_2_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PortV1_2_5 = (EFI_REDFISH_PORT_V1_2_5 *)InterpProp;
  DestroyPort_V1_2_5_CS (PortV1_2_5->Port); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPort_V1_2_5_Json (ResoruceRaw);
}
