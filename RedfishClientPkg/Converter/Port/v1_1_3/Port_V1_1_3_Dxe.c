...
//
#include <RedfishJsonStructure/Port/v1_1_3/EfiPortV1_1_3.h>
...
{
  EFI_REDFISH_PORT_V1_1_3 *PortV1_1_3;
  EFI_REDFISH_PORT_V1_1_3_CS *PortV1_1_3Cs;
  ...
  Status = (EFI_STATUS)Json_Port_V1_1_3_To_CS (ResoruceRaw, &PortV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PortV1_1_3 = (EFI_REDFISH_PORT_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PORT_V1_1_3));
  if (PortV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PortV1_1_3;
  PortV1_1_3->Port = PortV1_1_3Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Port"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("Port"), "Port");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Port"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("Port"), "Port");
...
/**
  The wrapper function of PortToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Port_V1_1_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Port_V1_1_3_JSON (*((EFI_REDFISH_PORT_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Port_V1_1_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PortV1_1_3 = (EFI_REDFISH_PORT_V1_1_3 *)InterpProp;
  DestroyPort_V1_1_3_CS (PortV1_1_3->Port); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from PortFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyPort_V1_1_3_Json (ResoruceRaw);
}
