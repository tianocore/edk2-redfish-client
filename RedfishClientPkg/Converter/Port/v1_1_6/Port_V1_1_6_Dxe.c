...
//
#include <RedfishJsonStructure/Port/v1_1_6/EfiPortV1_1_6.h>
...
{
  EFI_REDFISH_PORT_V1_1_6 *PortV1_1_6;
  EFI_REDFISH_PORT_V1_1_6_CS *PortV1_1_6Cs;
  ...
  Status = (EFI_STATUS)Json_Port_V1_1_6_To_CS (ResoruceRaw, &PortV1_1_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PortV1_1_6 = (EFI_REDFISH_PORT_V1_1_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PORT_V1_1_6));
  if (PortV1_1_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PortV1_1_6;
  PortV1_1_6->Port = PortV1_1_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Port_V1_1_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Port_V1_1_6_JSON (*((EFI_REDFISH_PORT_V1_1_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Port_V1_1_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PortV1_1_6 = (EFI_REDFISH_PORT_V1_1_6 *)InterpProp;
  DestroyPort_V1_1_6_CS (PortV1_1_6->Port); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPort_V1_1_6_Json (ResoruceRaw);
}
