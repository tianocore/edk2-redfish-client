...
//
#include <RedfishJsonStructure/Port/v1_0_8/EfiPortV1_0_8.h>
...
{
  EFI_REDFISH_PORT_V1_0_8 *PortV1_0_8;
  EFI_REDFISH_PORT_V1_0_8_CS *PortV1_0_8Cs;
  ...
  Status = (EFI_STATUS)Json_Port_V1_0_8_To_CS (ResoruceRaw, &PortV1_0_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PortV1_0_8 = (EFI_REDFISH_PORT_V1_0_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PORT_V1_0_8));
  if (PortV1_0_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PortV1_0_8;
  PortV1_0_8->Port = PortV1_0_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Port_V1_0_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Port_V1_0_8_JSON (*((EFI_REDFISH_PORT_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Port_V1_0_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PortV1_0_8 = (EFI_REDFISH_PORT_V1_0_8 *)InterpProp;
  DestroyPort_V1_0_8_CS (PortV1_0_8->Port); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPort_V1_0_8_Json (ResoruceRaw);
}
