...
//
#include <RedfishJsonStructure/Port/v1_1_2/EfiPortV1_1_2.h>
...
{
  EFI_REDFISH_PORT_V1_1_2 *PortV1_1_2;
  EFI_REDFISH_PORT_V1_1_2_CS *PortV1_1_2Cs;
  ...
  Status = (EFI_STATUS)Json_Port_V1_1_2_To_CS (ResoruceRaw, &PortV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PortV1_1_2 = (EFI_REDFISH_PORT_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PORT_V1_1_2));
  if (PortV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PortV1_1_2;
  PortV1_1_2->Port = PortV1_1_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Port_V1_1_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Port_V1_1_2_JSON (*((EFI_REDFISH_PORT_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Port_V1_1_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PortV1_1_2 = (EFI_REDFISH_PORT_V1_1_2 *)InterpProp;
  DestroyPort_V1_1_2_CS (PortV1_1_2->Port); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPort_V1_1_2_Json (ResoruceRaw);
}
