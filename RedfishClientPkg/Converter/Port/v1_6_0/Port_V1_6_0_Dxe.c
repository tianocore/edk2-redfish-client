...
//
#include <RedfishJsonStructure/Port/v1_6_0/EfiPortV1_6_0.h>
...
{
  EFI_REDFISH_PORT_V1_6_0 *PortV1_6_0;
  EFI_REDFISH_PORT_V1_6_0_CS *PortV1_6_0Cs;
  ...
  Status = (EFI_STATUS)Json_Port_V1_6_0_To_CS (ResoruceRaw, &PortV1_6_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PortV1_6_0 = (EFI_REDFISH_PORT_V1_6_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PORT_V1_6_0));
  if (PortV1_6_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PortV1_6_0;
  PortV1_6_0->Port = PortV1_6_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Port_V1_6_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Port_V1_6_0_JSON (*((EFI_REDFISH_PORT_V1_6_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Port_V1_6_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PortV1_6_0 = (EFI_REDFISH_PORT_V1_6_0 *)InterpProp;
  DestroyPort_V1_6_0_CS (PortV1_6_0->Port); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPort_V1_6_0_Json (ResoruceRaw);
}
