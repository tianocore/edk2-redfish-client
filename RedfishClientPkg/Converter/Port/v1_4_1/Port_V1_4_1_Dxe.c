...
//
#include <RedfishJsonStructure/Port/v1_4_1/EfiPortV1_4_1.h>
...
{
  EFI_REDFISH_PORT_V1_4_1 *PortV1_4_1;
  EFI_REDFISH_PORT_V1_4_1_CS *PortV1_4_1Cs;
  ...
  Status = (EFI_STATUS)Json_Port_V1_4_1_To_CS (ResoruceRaw, &PortV1_4_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PortV1_4_1 = (EFI_REDFISH_PORT_V1_4_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PORT_V1_4_1));
  if (PortV1_4_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PortV1_4_1;
  PortV1_4_1->Port = PortV1_4_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Port_V1_4_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Port_V1_4_1_JSON (*((EFI_REDFISH_PORT_V1_4_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Port_V1_4_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PortV1_4_1 = (EFI_REDFISH_PORT_V1_4_1 *)InterpProp;
  DestroyPort_V1_4_1_CS (PortV1_4_1->Port); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPort_V1_4_1_Json (ResoruceRaw);
}
