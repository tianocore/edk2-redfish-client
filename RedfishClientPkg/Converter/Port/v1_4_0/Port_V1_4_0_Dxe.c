...
//
#include <RedfishJsonStructure/Port/v1_4_0/EfiPortV1_4_0.h>
...
{
  EFI_REDFISH_PORT_V1_4_0 *PortV1_4_0;
  EFI_REDFISH_PORT_V1_4_0_CS *PortV1_4_0Cs;
  ...
  Status = (EFI_STATUS)Json_Port_V1_4_0_To_CS (ResoruceRaw, &PortV1_4_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PortV1_4_0 = (EFI_REDFISH_PORT_V1_4_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PORT_V1_4_0));
  if (PortV1_4_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PortV1_4_0;
  PortV1_4_0->Port = PortV1_4_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Port_V1_4_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Port_V1_4_0_JSON (*((EFI_REDFISH_PORT_V1_4_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Port_V1_4_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PortV1_4_0 = (EFI_REDFISH_PORT_V1_4_0 *)InterpProp;
  DestroyPort_V1_4_0_CS (PortV1_4_0->Port); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPort_V1_4_0_Json (ResoruceRaw);
}
