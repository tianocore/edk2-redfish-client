...
//
#include <RedfishJsonStructure/SwitchMetrics/v1_0_0/EfiSwitchMetricsV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#SwitchMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support SwitchMetrics V1_0_0
...
{
  EFI_REDFISH_SWITCHMETRICS_V1_0_0 *SwitchMetricsV1_0_0;
  EFI_REDFISH_SWITCHMETRICS_V1_0_0_CS *SwitchMetricsV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "SwitchMetrics") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_SwitchMetrics_V1_0_0_To_CS (ResoruceRaw, &SwitchMetricsV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SwitchMetricsV1_0_0 = (EFI_REDFISH_SWITCHMETRICS_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SWITCHMETRICS_V1_0_0));
  if (SwitchMetricsV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SwitchMetricsV1_0_0;
  SwitchMetricsV1_0_0->SwitchMetrics = SwitchMetricsV1_0_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("SwitchMetrics"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("SwitchMetrics"), "SwitchMetrics");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("SwitchMetrics"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("SwitchMetrics"), "SwitchMetrics");
...
/**
  The wrapper function of SwitchMetricsToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SwitchMetrics_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SwitchMetrics_V1_0_0_JSON (*((EFI_REDFISH_SWITCHMETRICS_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SwitchMetrics_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in SwitchMetricsToStruct.
...
)
{
  ...
  SwitchMetricsV1_0_0 = (EFI_REDFISH_SWITCHMETRICS_V1_0_0 *)InterpProp;
  DestroySwitchMetrics_V1_0_0_CS (SwitchMetricsV1_0_0->SwitchMetrics); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from SwitchMetricsFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroySwitchMetrics_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSwitchMetrics_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSwitchMetrics_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
