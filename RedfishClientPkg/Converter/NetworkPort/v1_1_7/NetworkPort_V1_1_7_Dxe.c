...
//
#include <RedfishJsonStructure/NetworkPort/v1_1_7/EfiNetworkPortV1_1_7.h>
CHAR8 mResourceTypeStr [] = "#NetworkPort";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkPort V1_1_7
...
{
  EFI_REDFISH_NETWORKPORT_V1_1_7 *NetworkPortV1_1_7;
  ...
  Status = (EFI_STATUS)Json_NetworkPort_V1_1_7_To_CS (ResoruceRaw, &NetworkPortV1_1_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkPortV1_1_7 = (EFI_REDFISH_NETWORKPORT_V1_1_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKPORT_V1_1_7));
  if (NetworkPortV1_1_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkPortV1_1_7;
  NetworkPortV1_1_7->NetworkPort = NetworkPortV1_1_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkPort_V1_1_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkPort_V1_1_7_JSON (*((EFI_REDFISH_NETWORKPORT_V1_1_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkPort_V1_1_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkPortV1_1_7 = (EFI_REDFISH_NETWORKPORT_V1_1_7 *)InterpProp;
  DestroyNetworkPort_V1_1_7_CS (NetworkPortV1_1_7->NetworkPort); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkPort_V1_1_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_1_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_1_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
