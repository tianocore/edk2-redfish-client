...
//
#include <RedfishJsonStructure/NetworkPort/v1_2_4/EfiNetworkPortV1_2_4.h>
CHAR8 mResourceTypeStr [] = "#NetworkPort";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkPort V1_2_4
...
{
  EFI_REDFISH_NETWORKPORT_V1_2_4 *NetworkPortV1_2_4;
  EFI_REDFISH_NETWORKPORT_V1_2_4_CS *NetworkPortV1_2_4Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkPort_V1_2_4_To_CS (ResoruceRaw, &NetworkPortV1_2_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkPortV1_2_4 = (EFI_REDFISH_NETWORKPORT_V1_2_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKPORT_V1_2_4));
  if (NetworkPortV1_2_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkPortV1_2_4;
  NetworkPortV1_2_4->NetworkPort = NetworkPortV1_2_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkPort_V1_2_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkPort_V1_2_4_JSON (*((EFI_REDFISH_NETWORKPORT_V1_2_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkPort_V1_2_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkPortV1_2_4 = (EFI_REDFISH_NETWORKPORT_V1_2_4 *)InterpProp;
  DestroyNetworkPort_V1_2_4_CS (NetworkPortV1_2_4->NetworkPort); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkPort_V1_2_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_2_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_2_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
