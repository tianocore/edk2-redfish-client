...
//
#include <RedfishJsonStructure/NetworkPort/v1_1_6/EfiNetworkPortV1_1_6.h>
CHAR8 mResourceTypeStr [] = "#NetworkPort";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkPort V1_1_6
...
{
  EFI_REDFISH_NETWORKPORT_V1_1_6 *NetworkPortV1_1_6;
  EFI_REDFISH_NETWORKPORT_V1_1_6_CS *NetworkPortV1_1_6Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkPort_V1_1_6_To_CS (ResoruceRaw, &NetworkPortV1_1_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkPortV1_1_6 = (EFI_REDFISH_NETWORKPORT_V1_1_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKPORT_V1_1_6));
  if (NetworkPortV1_1_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkPortV1_1_6;
  NetworkPortV1_1_6->NetworkPort = NetworkPortV1_1_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkPort_V1_1_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkPort_V1_1_6_JSON (*((EFI_REDFISH_NETWORKPORT_V1_1_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkPort_V1_1_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkPortV1_1_6 = (EFI_REDFISH_NETWORKPORT_V1_1_6 *)InterpProp;
  DestroyNetworkPort_V1_1_6_CS (NetworkPortV1_1_6->NetworkPort); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkPort_V1_1_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_1_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_1_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
