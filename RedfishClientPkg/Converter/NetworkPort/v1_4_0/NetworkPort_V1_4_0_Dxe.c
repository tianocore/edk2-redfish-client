...
//
#include <RedfishJsonStructure/NetworkPort/v1_4_0/EfiNetworkPortV1_4_0.h>
CHAR8 mResourceTypeStr [] = "#NetworkPort";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkPort V1_4_0
...
{
  EFI_REDFISH_NETWORKPORT_V1_4_0 *NetworkPortV1_4_0;
  EFI_REDFISH_NETWORKPORT_V1_4_0_CS *NetworkPortV1_4_0Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkPort_V1_4_0_To_CS (ResoruceRaw, &NetworkPortV1_4_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkPortV1_4_0 = (EFI_REDFISH_NETWORKPORT_V1_4_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKPORT_V1_4_0));
  if (NetworkPortV1_4_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkPortV1_4_0;
  NetworkPortV1_4_0->NetworkPort = NetworkPortV1_4_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkPort_V1_4_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkPort_V1_4_0_JSON (*((EFI_REDFISH_NETWORKPORT_V1_4_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkPort_V1_4_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkPortV1_4_0 = (EFI_REDFISH_NETWORKPORT_V1_4_0 *)InterpProp;
  DestroyNetworkPort_V1_4_0_CS (NetworkPortV1_4_0->NetworkPort); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkPort_V1_4_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_4_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_4_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
