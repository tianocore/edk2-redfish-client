...
//
#include <RedfishJsonStructure/NetworkPort/v1_0_5/EfiNetworkPortV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#NetworkPort";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkPort V1_0_5
...
{
  EFI_REDFISH_NETWORKPORT_V1_0_5 *NetworkPortV1_0_5;
  EFI_REDFISH_NETWORKPORT_V1_0_5_CS *NetworkPortV1_0_5Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkPort_V1_0_5_To_CS (ResoruceRaw, &NetworkPortV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkPortV1_0_5 = (EFI_REDFISH_NETWORKPORT_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKPORT_V1_0_5));
  if (NetworkPortV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkPortV1_0_5;
  NetworkPortV1_0_5->NetworkPort = NetworkPortV1_0_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkPort_V1_0_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkPort_V1_0_5_JSON (*((EFI_REDFISH_NETWORKPORT_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkPort_V1_0_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkPortV1_0_5 = (EFI_REDFISH_NETWORKPORT_V1_0_5 *)InterpProp;
  DestroyNetworkPort_V1_0_5_CS (NetworkPortV1_0_5->NetworkPort); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkPort_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
