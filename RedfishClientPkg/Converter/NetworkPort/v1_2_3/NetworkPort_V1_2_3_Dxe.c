...
//
#include <RedfishJsonStructure/NetworkPort/v1_2_3/EfiNetworkPortV1_2_3.h>
CHAR8 mResourceTypeStr [] = "#NetworkPort";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkPort V1_2_3
...
{
  EFI_REDFISH_NETWORKPORT_V1_2_3 *NetworkPortV1_2_3;
  EFI_REDFISH_NETWORKPORT_V1_2_3_CS *NetworkPortV1_2_3Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkPort_V1_2_3_To_CS (ResoruceRaw, &NetworkPortV1_2_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkPortV1_2_3 = (EFI_REDFISH_NETWORKPORT_V1_2_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKPORT_V1_2_3));
  if (NetworkPortV1_2_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkPortV1_2_3;
  NetworkPortV1_2_3->NetworkPort = NetworkPortV1_2_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkPort_V1_2_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkPort_V1_2_3_JSON (*((EFI_REDFISH_NETWORKPORT_V1_2_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkPort_V1_2_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkPortV1_2_3 = (EFI_REDFISH_NETWORKPORT_V1_2_3 *)InterpProp;
  DestroyNetworkPort_V1_2_3_CS (NetworkPortV1_2_3->NetworkPort); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkPort_V1_2_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_2_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_2_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
