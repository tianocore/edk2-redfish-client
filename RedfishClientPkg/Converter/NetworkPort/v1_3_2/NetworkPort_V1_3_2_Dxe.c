...
//
#include <RedfishJsonStructure/NetworkPort/v1_3_2/EfiNetworkPortV1_3_2.h>
CHAR8 mResourceTypeStr [] = "#NetworkPort";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkPort V1_3_2
...
{
  EFI_REDFISH_NETWORKPORT_V1_3_2 *NetworkPortV1_3_2;
  EFI_REDFISH_NETWORKPORT_V1_3_2_CS *NetworkPortV1_3_2Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkPort_V1_3_2_To_CS (ResoruceRaw, &NetworkPortV1_3_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkPortV1_3_2 = (EFI_REDFISH_NETWORKPORT_V1_3_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKPORT_V1_3_2));
  if (NetworkPortV1_3_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkPortV1_3_2;
  NetworkPortV1_3_2->NetworkPort = NetworkPortV1_3_2Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("NetworkPort"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("NetworkPort"), "NetworkPort");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("NetworkPort"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("NetworkPort"), "NetworkPort");
...
/**
  The wrapper function of NetworkPortToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkPort_V1_3_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkPort_V1_3_2_JSON (*((EFI_REDFISH_NETWORKPORT_V1_3_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkPort_V1_3_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkPortV1_3_2 = (EFI_REDFISH_NETWORKPORT_V1_3_2 *)InterpProp;
  DestroyNetworkPort_V1_3_2_CS (NetworkPortV1_3_2->NetworkPort); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from NetworkPortFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkPort_V1_3_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_3_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkPort_V1_3_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
