...
//
#include <RedfishJsonStructure/AddressPool/v1_1_2/EfiAddressPoolV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#AddressPool";
BOOLEAN IsRevisonController = TRUE;

// Support AddressPool V1_1_2
...
{
  EFI_REDFISH_ADDRESSPOOL_V1_1_2 *AddressPoolV1_1_2;
  EFI_REDFISH_ADDRESSPOOL_V1_1_2_CS *AddressPoolV1_1_2Cs;
  ...
  Status = (EFI_STATUS)Json_AddressPool_V1_1_2_To_CS (ResoruceRaw, &AddressPoolV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AddressPoolV1_1_2 = (EFI_REDFISH_ADDRESSPOOL_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ADDRESSPOOL_V1_1_2));
  if (AddressPoolV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AddressPoolV1_1_2;
  AddressPoolV1_1_2->AddressPool = AddressPoolV1_1_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AddressPool_V1_1_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AddressPool_V1_1_2_JSON (*((EFI_REDFISH_ADDRESSPOOL_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AddressPool_V1_1_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AddressPoolV1_1_2 = (EFI_REDFISH_ADDRESSPOOL_V1_1_2 *)InterpProp;
  DestroyAddressPool_V1_1_2_CS (AddressPoolV1_1_2->AddressPool); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAddressPool_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAddressPool_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAddressPool_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
