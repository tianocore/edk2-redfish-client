...
//
#include <RedfishJsonStructure/AddressPool/v1_1_0/EfiAddressPoolV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#AddressPool";
BOOLEAN IsRevisonController = TRUE;

// Support AddressPool V1_1_0
...
{
  EFI_REDFISH_ADDRESSPOOL_V1_1_0 *AddressPoolV1_1_0;
  EFI_REDFISH_ADDRESSPOOL_V1_1_0_CS *AddressPoolV1_1_0Cs;
  ...
  Status = (EFI_STATUS)Json_AddressPool_V1_1_0_To_CS (ResoruceRaw, &AddressPoolV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AddressPoolV1_1_0 = (EFI_REDFISH_ADDRESSPOOL_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ADDRESSPOOL_V1_1_0));
  if (AddressPoolV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AddressPoolV1_1_0;
  AddressPoolV1_1_0->AddressPool = AddressPoolV1_1_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AddressPool_V1_1_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AddressPool_V1_1_0_JSON (*((EFI_REDFISH_ADDRESSPOOL_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AddressPool_V1_1_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AddressPoolV1_1_0 = (EFI_REDFISH_ADDRESSPOOL_V1_1_0 *)InterpProp;
  DestroyAddressPool_V1_1_0_CS (AddressPoolV1_1_0->AddressPool); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAddressPool_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAddressPool_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAddressPool_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
