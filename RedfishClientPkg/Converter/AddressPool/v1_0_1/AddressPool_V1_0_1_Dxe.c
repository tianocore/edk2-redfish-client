...
//
#include <RedfishJsonStructure/AddressPool/v1_0_1/EfiAddressPoolV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#AddressPool";
BOOLEAN IsRevisonController = TRUE;

// Support AddressPool V1_0_1
...
{
  EFI_REDFISH_ADDRESSPOOL_V1_0_1 *AddressPoolV1_0_1;
  EFI_REDFISH_ADDRESSPOOL_V1_0_1_CS *AddressPoolV1_0_1Cs;
  ...
  Status = (EFI_STATUS)Json_AddressPool_V1_0_1_To_CS (ResoruceRaw, &AddressPoolV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AddressPoolV1_0_1 = (EFI_REDFISH_ADDRESSPOOL_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ADDRESSPOOL_V1_0_1));
  if (AddressPoolV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AddressPoolV1_0_1;
  AddressPoolV1_0_1->AddressPool = AddressPoolV1_0_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AddressPool_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AddressPool_V1_0_1_JSON (*((EFI_REDFISH_ADDRESSPOOL_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AddressPool_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AddressPoolV1_0_1 = (EFI_REDFISH_ADDRESSPOOL_V1_0_1 *)InterpProp;
  DestroyAddressPool_V1_0_1_CS (AddressPoolV1_0_1->AddressPool); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAddressPool_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAddressPool_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAddressPool_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
