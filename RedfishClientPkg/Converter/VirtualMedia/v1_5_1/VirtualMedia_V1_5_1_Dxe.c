...
//
#include <RedfishJsonStructure/VirtualMedia/v1_5_1/EfiVirtualMediaV1_5_1.h>
CHAR8 mResourceTypeStr [] = "#VirtualMedia";
BOOLEAN IsRevisonController = TRUE;

// Support VirtualMedia V1_5_1
...
{
  EFI_REDFISH_VIRTUALMEDIA_V1_5_1 *VirtualMediaV1_5_1;
  EFI_REDFISH_VIRTUALMEDIA_V1_5_1_CS *VirtualMediaV1_5_1Cs;
  ...
  Status = (EFI_STATUS)Json_VirtualMedia_V1_5_1_To_CS (ResoruceRaw, &VirtualMediaV1_5_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VirtualMediaV1_5_1 = (EFI_REDFISH_VIRTUALMEDIA_V1_5_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_5_1));
  if (VirtualMediaV1_5_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)VirtualMediaV1_5_1;
  VirtualMediaV1_5_1->VirtualMedia = VirtualMediaV1_5_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_VirtualMedia_V1_5_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_VirtualMedia_V1_5_1_JSON (*((EFI_REDFISH_VIRTUALMEDIA_V1_5_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_VirtualMedia_V1_5_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  VirtualMediaV1_5_1 = (EFI_REDFISH_VIRTUALMEDIA_V1_5_1 *)InterpProp;
  DestroyVirtualMedia_V1_5_1_CS (VirtualMediaV1_5_1->VirtualMedia); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyVirtualMedia_V1_5_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_5_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_5_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
