...
//
#include <RedfishJsonStructure/VirtualMedia/v1_1_4/EfiVirtualMediaV1_1_4.h>
CHAR8 mResourceTypeStr [] = "#VirtualMedia";
BOOLEAN IsRevisonController = TRUE;

// Support VirtualMedia V1_1_4
...
{
  EFI_REDFISH_VIRTUALMEDIA_V1_1_4 *VirtualMediaV1_1_4;
  EFI_REDFISH_VIRTUALMEDIA_V1_1_4_CS *VirtualMediaV1_1_4Cs;
  ...
  Status = (EFI_STATUS)Json_VirtualMedia_V1_1_4_To_CS (ResoruceRaw, &VirtualMediaV1_1_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VirtualMediaV1_1_4 = (EFI_REDFISH_VIRTUALMEDIA_V1_1_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_1_4));
  if (VirtualMediaV1_1_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)VirtualMediaV1_1_4;
  VirtualMediaV1_1_4->VirtualMedia = VirtualMediaV1_1_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_VirtualMedia_V1_1_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_VirtualMedia_V1_1_4_JSON (*((EFI_REDFISH_VIRTUALMEDIA_V1_1_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_VirtualMedia_V1_1_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  VirtualMediaV1_1_4 = (EFI_REDFISH_VIRTUALMEDIA_V1_1_4 *)InterpProp;
  DestroyVirtualMedia_V1_1_4_CS (VirtualMediaV1_1_4->VirtualMedia); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyVirtualMedia_V1_1_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_1_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_1_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
