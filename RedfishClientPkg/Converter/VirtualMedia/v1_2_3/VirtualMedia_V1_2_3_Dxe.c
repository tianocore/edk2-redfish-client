...
//
#include <RedfishJsonStructure/VirtualMedia/v1_2_3/EfiVirtualMediaV1_2_3.h>
CHAR8 mResourceTypeStr [] = "#VirtualMedia";
BOOLEAN IsRevisonController = TRUE;

// Support VirtualMedia V1_2_3
...
{
  EFI_REDFISH_VIRTUALMEDIA_V1_2_3 *VirtualMediaV1_2_3;
  EFI_REDFISH_VIRTUALMEDIA_V1_2_3_CS *VirtualMediaV1_2_3Cs;
  ...
  Status = (EFI_STATUS)Json_VirtualMedia_V1_2_3_To_CS (ResoruceRaw, &VirtualMediaV1_2_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VirtualMediaV1_2_3 = (EFI_REDFISH_VIRTUALMEDIA_V1_2_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_2_3));
  if (VirtualMediaV1_2_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)VirtualMediaV1_2_3;
  VirtualMediaV1_2_3->VirtualMedia = VirtualMediaV1_2_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_VirtualMedia_V1_2_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_VirtualMedia_V1_2_3_JSON (*((EFI_REDFISH_VIRTUALMEDIA_V1_2_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_VirtualMedia_V1_2_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  VirtualMediaV1_2_3 = (EFI_REDFISH_VIRTUALMEDIA_V1_2_3 *)InterpProp;
  DestroyVirtualMedia_V1_2_3_CS (VirtualMediaV1_2_3->VirtualMedia); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyVirtualMedia_V1_2_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_2_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_2_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
