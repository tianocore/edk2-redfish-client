...
//
#include <RedfishJsonStructure/VirtualMedia/v1_0_6/EfiVirtualMediaV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#VirtualMedia";
BOOLEAN IsRevisonController = TRUE;

// Support VirtualMedia V1_0_6
...
{
  EFI_REDFISH_VIRTUALMEDIA_V1_0_6 *VirtualMediaV1_0_6;
  EFI_REDFISH_VIRTUALMEDIA_V1_0_6_CS *VirtualMediaV1_0_6Cs;
  ...
  Status = (EFI_STATUS)Json_VirtualMedia_V1_0_6_To_CS (ResoruceRaw, &VirtualMediaV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VirtualMediaV1_0_6 = (EFI_REDFISH_VIRTUALMEDIA_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_0_6));
  if (VirtualMediaV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)VirtualMediaV1_0_6;
  VirtualMediaV1_0_6->VirtualMedia = VirtualMediaV1_0_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_VirtualMedia_V1_0_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_VirtualMedia_V1_0_6_JSON (*((EFI_REDFISH_VIRTUALMEDIA_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_VirtualMedia_V1_0_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  VirtualMediaV1_0_6 = (EFI_REDFISH_VIRTUALMEDIA_V1_0_6 *)InterpProp;
  DestroyVirtualMedia_V1_0_6_CS (VirtualMediaV1_0_6->VirtualMedia); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyVirtualMedia_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_0_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_0_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
