...
//
#include <RedfishJsonStructure/VirtualMedia/v1_5_0/EfiVirtualMediaV1_5_0.h>
CHAR8 mResourceTypeStr [] = "#VirtualMedia";
BOOLEAN IsRevisonController = TRUE;

// Support VirtualMedia V1_5_0
...
{
  EFI_REDFISH_VIRTUALMEDIA_V1_5_0 *VirtualMediaV1_5_0;
  EFI_REDFISH_VIRTUALMEDIA_V1_5_0_CS *VirtualMediaV1_5_0Cs;
  ...
  Status = (EFI_STATUS)Json_VirtualMedia_V1_5_0_To_CS (ResoruceRaw, &VirtualMediaV1_5_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VirtualMediaV1_5_0 = (EFI_REDFISH_VIRTUALMEDIA_V1_5_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_5_0));
  if (VirtualMediaV1_5_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)VirtualMediaV1_5_0;
  VirtualMediaV1_5_0->VirtualMedia = VirtualMediaV1_5_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_VirtualMedia_V1_5_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_VirtualMedia_V1_5_0_JSON (*((EFI_REDFISH_VIRTUALMEDIA_V1_5_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_VirtualMedia_V1_5_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  VirtualMediaV1_5_0 = (EFI_REDFISH_VIRTUALMEDIA_V1_5_0 *)InterpProp;
  DestroyVirtualMedia_V1_5_0_CS (VirtualMediaV1_5_0->VirtualMedia); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyVirtualMedia_V1_5_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_5_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_5_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
