...
//
#include <RedfishJsonStructure/VirtualMedia/v1_2_5/EfiVirtualMediaV1_2_5.h>
CHAR8 mResourceTypeStr [] = "#VirtualMedia";
BOOLEAN IsRevisonController = TRUE;

// Support VirtualMedia V1_2_5
...
{
  EFI_REDFISH_VIRTUALMEDIA_V1_2_5 *VirtualMediaV1_2_5;
  EFI_REDFISH_VIRTUALMEDIA_V1_2_5_CS *VirtualMediaV1_2_5Cs;
  ...
  Status = (EFI_STATUS)Json_VirtualMedia_V1_2_5_To_CS (ResoruceRaw, &VirtualMediaV1_2_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VirtualMediaV1_2_5 = (EFI_REDFISH_VIRTUALMEDIA_V1_2_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_2_5));
  if (VirtualMediaV1_2_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)VirtualMediaV1_2_5;
  VirtualMediaV1_2_5->VirtualMedia = VirtualMediaV1_2_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_VirtualMedia_V1_2_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_VirtualMedia_V1_2_5_JSON (*((EFI_REDFISH_VIRTUALMEDIA_V1_2_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_VirtualMedia_V1_2_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  VirtualMediaV1_2_5 = (EFI_REDFISH_VIRTUALMEDIA_V1_2_5 *)InterpProp;
  DestroyVirtualMedia_V1_2_5_CS (VirtualMediaV1_2_5->VirtualMedia); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyVirtualMedia_V1_2_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_2_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_2_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
