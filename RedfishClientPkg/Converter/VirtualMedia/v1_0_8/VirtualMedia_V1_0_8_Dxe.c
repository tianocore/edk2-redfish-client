...
//
#include <RedfishJsonStructure/VirtualMedia/v1_0_8/EfiVirtualMediaV1_0_8.h>
CHAR8 mResourceTypeStr [] = "#VirtualMedia";
BOOLEAN IsRevisonController = TRUE;

// Support VirtualMedia V1_0_8
...
{
  EFI_REDFISH_VIRTUALMEDIA_V1_0_8 *VirtualMediaV1_0_8;
  EFI_REDFISH_VIRTUALMEDIA_V1_0_8_CS *VirtualMediaV1_0_8Cs;
  ...
  Status = (EFI_STATUS)Json_VirtualMedia_V1_0_8_To_CS (ResoruceRaw, &VirtualMediaV1_0_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VirtualMediaV1_0_8 = (EFI_REDFISH_VIRTUALMEDIA_V1_0_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_0_8));
  if (VirtualMediaV1_0_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)VirtualMediaV1_0_8;
  VirtualMediaV1_0_8->VirtualMedia = VirtualMediaV1_0_8Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("VirtualMedia"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("VirtualMedia"), "VirtualMedia");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("VirtualMedia"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("VirtualMedia"), "VirtualMedia");
...
/**
  The wrapper function of VirtualMediaToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_VirtualMedia_V1_0_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_VirtualMedia_V1_0_8_JSON (*((EFI_REDFISH_VIRTUALMEDIA_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_VirtualMedia_V1_0_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  VirtualMediaV1_0_8 = (EFI_REDFISH_VIRTUALMEDIA_V1_0_8 *)InterpProp;
  DestroyVirtualMedia_V1_0_8_CS (VirtualMediaV1_0_8->VirtualMedia); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from VirtualMediaFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyVirtualMedia_V1_0_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_0_8EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_0_8Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
