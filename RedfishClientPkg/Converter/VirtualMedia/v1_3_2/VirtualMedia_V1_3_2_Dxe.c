...
//
#include <RedfishJsonStructure/VirtualMedia/v1_3_2/EfiVirtualMediaV1_3_2.h>
CHAR8 mResourceTypeStr [] = "#VirtualMedia";
BOOLEAN IsRevisonController = TRUE;

// Support VirtualMedia V1_3_2
...
{
  EFI_REDFISH_VIRTUALMEDIA_V1_3_2 *VirtualMediaV1_3_2;
  EFI_REDFISH_VIRTUALMEDIA_V1_3_2_CS *VirtualMediaV1_3_2Cs;
  ...
  Status = (EFI_STATUS)Json_VirtualMedia_V1_3_2_To_CS (ResoruceRaw, &VirtualMediaV1_3_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VirtualMediaV1_3_2 = (EFI_REDFISH_VIRTUALMEDIA_V1_3_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VIRTUALMEDIA_V1_3_2));
  if (VirtualMediaV1_3_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)VirtualMediaV1_3_2;
  VirtualMediaV1_3_2->VirtualMedia = VirtualMediaV1_3_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_VirtualMedia_V1_3_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_VirtualMedia_V1_3_2_JSON (*((EFI_REDFISH_VIRTUALMEDIA_V1_3_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_VirtualMedia_V1_3_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  VirtualMediaV1_3_2 = (EFI_REDFISH_VIRTUALMEDIA_V1_3_2 *)InterpProp;
  DestroyVirtualMedia_V1_3_2_CS (VirtualMediaV1_3_2->VirtualMedia); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyVirtualMedia_V1_3_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_3_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVirtualMedia_V1_3_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
