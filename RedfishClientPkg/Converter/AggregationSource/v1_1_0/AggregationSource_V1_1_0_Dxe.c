...
//
#include <RedfishJsonStructure/AggregationSource/v1_1_0/EfiAggregationSourceV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#AggregationSource";
BOOLEAN IsRevisonController = TRUE;

// Support AggregationSource V1_1_0
...
{
  EFI_REDFISH_AGGREGATIONSOURCE_V1_1_0 *AggregationSourceV1_1_0;
  EFI_REDFISH_AGGREGATIONSOURCE_V1_1_0_CS *AggregationSourceV1_1_0Cs;
  ...
  Status = (EFI_STATUS)Json_AggregationSource_V1_1_0_To_CS (ResoruceRaw, &AggregationSourceV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AggregationSourceV1_1_0 = (EFI_REDFISH_AGGREGATIONSOURCE_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_AGGREGATIONSOURCE_V1_1_0));
  if (AggregationSourceV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AggregationSourceV1_1_0;
  AggregationSourceV1_1_0->AggregationSource = AggregationSourceV1_1_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AggregationSource_V1_1_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AggregationSource_V1_1_0_JSON (*((EFI_REDFISH_AGGREGATIONSOURCE_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AggregationSource_V1_1_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AggregationSourceV1_1_0 = (EFI_REDFISH_AGGREGATIONSOURCE_V1_1_0 *)InterpProp;
  DestroyAggregationSource_V1_1_0_CS (AggregationSourceV1_1_0->AggregationSource); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAggregationSource_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAggregationSource_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAggregationSource_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
