...
)
{
  ...
  return (EFI_STATUS)CS_To_CompositionService_V1_1_1_JSON (*((EFI_REDFISH_COMPOSITIONSERVICE_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
