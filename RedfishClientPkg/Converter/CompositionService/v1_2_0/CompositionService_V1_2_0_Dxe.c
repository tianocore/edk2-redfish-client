...
//
#include <RedfishJsonStructure/CompositionService/v1_2_0/EfiCompositionServiceV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#CompositionService";
BOOLEAN IsRevisonController = TRUE;

// Support CompositionService V1_2_0
...
{
  EFI_REDFISH_COMPOSITIONSERVICE_V1_2_0 *CompositionServiceV1_2_0;
  EFI_REDFISH_COMPOSITIONSERVICE_V1_2_0_CS *CompositionServiceV1_2_0Cs;
  ...
  Status = (EFI_STATUS)Json_CompositionService_V1_2_0_To_CS (ResoruceRaw, &CompositionServiceV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CompositionServiceV1_2_0 = (EFI_REDFISH_COMPOSITIONSERVICE_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPOSITIONSERVICE_V1_2_0));
  if (CompositionServiceV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)CompositionServiceV1_2_0;
  CompositionServiceV1_2_0->CompositionService = CompositionServiceV1_2_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_CompositionService_V1_2_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_CompositionService_V1_2_0_JSON (*((EFI_REDFISH_COMPOSITIONSERVICE_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_CompositionService_V1_2_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  CompositionServiceV1_2_0 = (EFI_REDFISH_COMPOSITIONSERVICE_V1_2_0 *)InterpProp;
  DestroyCompositionService_V1_2_0_CS (CompositionServiceV1_2_0->CompositionService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyCompositionService_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCompositionService_V1_2_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishCompositionService_V1_2_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
