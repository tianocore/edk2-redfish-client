...
//
#include <RedfishJsonStructure/CompositionService/v1_1_2/EfiCompositionServiceV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#CompositionService";
BOOLEAN IsRevisonController = TRUE;

// Support CompositionService V1_1_2
...
{
  EFI_REDFISH_COMPOSITIONSERVICE_V1_1_2 *CompositionServiceV1_1_2;
  EFI_REDFISH_COMPOSITIONSERVICE_V1_1_2_CS *CompositionServiceV1_1_2Cs;
  ...
  Status = (EFI_STATUS)Json_CompositionService_V1_1_2_To_CS (ResoruceRaw, &CompositionServiceV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CompositionServiceV1_1_2 = (EFI_REDFISH_COMPOSITIONSERVICE_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPOSITIONSERVICE_V1_1_2));
  if (CompositionServiceV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)CompositionServiceV1_1_2;
  CompositionServiceV1_1_2->CompositionService = CompositionServiceV1_1_2Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("CompositionService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("CompositionService"), "CompositionService");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("CompositionService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("CompositionService"), "CompositionService");
...
/**
  The wrapper function of CompositionServiceToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
CompositionServiceToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return CompositionServiceToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_CompositionService_V1_1_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_CompositionService_V1_1_2_JSON (*((EFI_REDFISH_COMPOSITIONSERVICE_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_CompositionService_V1_1_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
EFI_STATUS
EFIAPI
CompositionServiceDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  CompositionServiceV1_1_2 = (EFI_REDFISH_COMPOSITIONSERVICE_V1_1_2 *)InterpProp;
  DestroyCompositionService_V1_1_2_CS (CompositionServiceV1_1_2->CompositionService); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from CompositionServiceFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyCompositionService_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCompositionService_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishCompositionService_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
