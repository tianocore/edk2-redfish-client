...
//
#include <RedfishJsonStructure/CompositionService/v1_0_3/EfiCompositionServiceV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#CompositionService";
BOOLEAN IsRevisonController = TRUE;

// Support CompositionService V1_0_3
...
{
  EFI_REDFISH_COMPOSITIONSERVICE_V1_0_3 *CompositionServiceV1_0_3;
  EFI_REDFISH_COMPOSITIONSERVICE_V1_0_3_CS *CompositionServiceV1_0_3Cs;
  ...
  Status = (EFI_STATUS)Json_CompositionService_V1_0_3_To_CS (ResoruceRaw, &CompositionServiceV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CompositionServiceV1_0_3 = (EFI_REDFISH_COMPOSITIONSERVICE_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPOSITIONSERVICE_V1_0_3));
  if (CompositionServiceV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)CompositionServiceV1_0_3;
  CompositionServiceV1_0_3->CompositionService = CompositionServiceV1_0_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_CompositionService_V1_0_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_CompositionService_V1_0_3_JSON (*((EFI_REDFISH_COMPOSITIONSERVICE_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_CompositionService_V1_0_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  CompositionServiceV1_0_3 = (EFI_REDFISH_COMPOSITIONSERVICE_V1_0_3 *)InterpProp;
  DestroyCompositionService_V1_0_3_CS (CompositionServiceV1_0_3->CompositionService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyCompositionService_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCompositionService_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishCompositionService_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
