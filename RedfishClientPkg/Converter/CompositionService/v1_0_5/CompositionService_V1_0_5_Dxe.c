...
//
#include <RedfishJsonStructure/CompositionService/v1_0_5/EfiCompositionServiceV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#CompositionService";
BOOLEAN IsRevisonController = TRUE;

// Support CompositionService V1_0_5
...
{
  EFI_REDFISH_COMPOSITIONSERVICE_V1_0_5 *CompositionServiceV1_0_5;
  EFI_REDFISH_COMPOSITIONSERVICE_V1_0_5_CS *CompositionServiceV1_0_5Cs;
  ...
  Status = (EFI_STATUS)Json_CompositionService_V1_0_5_To_CS (ResoruceRaw, &CompositionServiceV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CompositionServiceV1_0_5 = (EFI_REDFISH_COMPOSITIONSERVICE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPOSITIONSERVICE_V1_0_5));
  if (CompositionServiceV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)CompositionServiceV1_0_5;
  CompositionServiceV1_0_5->CompositionService = CompositionServiceV1_0_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_CompositionService_V1_0_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_CompositionService_V1_0_5_JSON (*((EFI_REDFISH_COMPOSITIONSERVICE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_CompositionService_V1_0_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  CompositionServiceV1_0_5 = (EFI_REDFISH_COMPOSITIONSERVICE_V1_0_5 *)InterpProp;
  DestroyCompositionService_V1_0_5_CS (CompositionServiceV1_0_5->CompositionService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyCompositionService_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCompositionService_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishCompositionService_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
