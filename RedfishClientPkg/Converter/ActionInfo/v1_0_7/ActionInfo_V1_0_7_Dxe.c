...
//
#include <RedfishJsonStructure/ActionInfo/v1_0_7/EfiActionInfoV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#ActionInfo";
BOOLEAN IsRevisonController = TRUE;

// Support ActionInfo V1_0_7
...
{
  EFI_REDFISH_ACTIONINFO_V1_0_7 *ActionInfoV1_0_7;
  EFI_REDFISH_ACTIONINFO_V1_0_7_CS *ActionInfoV1_0_7Cs;
  ...
  Status = (EFI_STATUS)Json_ActionInfo_V1_0_7_To_CS (ResoruceRaw, &ActionInfoV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ActionInfoV1_0_7 = (EFI_REDFISH_ACTIONINFO_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACTIONINFO_V1_0_7));
  if (ActionInfoV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ActionInfoV1_0_7;
  ActionInfoV1_0_7->ActionInfo = ActionInfoV1_0_7Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("ActionInfo"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("ActionInfo"), "ActionInfo");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("ActionInfo"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("ActionInfo"), "ActionInfo");
...
/**
  The wrapper function of ActionInfoToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ActionInfo_V1_0_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ActionInfo_V1_0_7_JSON (*((EFI_REDFISH_ACTIONINFO_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ActionInfo_V1_0_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ActionInfoV1_0_7 = (EFI_REDFISH_ACTIONINFO_V1_0_7 *)InterpProp;
  DestroyActionInfo_V1_0_7_CS (ActionInfoV1_0_7->ActionInfo); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ActionInfoFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyActionInfo_V1_0_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_0_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_0_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
