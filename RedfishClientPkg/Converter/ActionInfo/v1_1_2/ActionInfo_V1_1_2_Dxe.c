...
//
#include <RedfishJsonStructure/ActionInfo/v1_1_2/EfiActionInfoV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#ActionInfo";
BOOLEAN IsRevisonController = TRUE;

// Support ActionInfo V1_1_2
...
{
  EFI_REDFISH_ACTIONINFO_V1_1_2 *ActionInfoV1_1_2;
  EFI_REDFISH_ACTIONINFO_V1_1_2_CS *ActionInfoV1_1_2Cs;
  ...
  Status = (EFI_STATUS)Json_ActionInfo_V1_1_2_To_CS (ResoruceRaw, &ActionInfoV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ActionInfoV1_1_2 = (EFI_REDFISH_ACTIONINFO_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACTIONINFO_V1_1_2));
  if (ActionInfoV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ActionInfoV1_1_2;
  ActionInfoV1_1_2->ActionInfo = ActionInfoV1_1_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ActionInfo_V1_1_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ActionInfo_V1_1_2_JSON (*((EFI_REDFISH_ACTIONINFO_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ActionInfo_V1_1_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ActionInfoV1_1_2 = (EFI_REDFISH_ACTIONINFO_V1_1_2 *)InterpProp;
  DestroyActionInfo_V1_1_2_CS (ActionInfoV1_1_2->ActionInfo); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyActionInfo_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_1_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_1_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
