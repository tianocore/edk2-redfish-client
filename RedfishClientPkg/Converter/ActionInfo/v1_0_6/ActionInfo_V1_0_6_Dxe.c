...
//
#include <RedfishJsonStructure/ActionInfo/v1_0_6/EfiActionInfoV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#ActionInfo";
BOOLEAN IsRevisonController = TRUE;

// Support ActionInfo V1_0_6
...
{
  EFI_REDFISH_ACTIONINFO_V1_0_6 *ActionInfoV1_0_6;
  EFI_REDFISH_ACTIONINFO_V1_0_6_CS *ActionInfoV1_0_6Cs;
  ...
  Status = (EFI_STATUS)Json_ActionInfo_V1_0_6_To_CS (ResoruceRaw, &ActionInfoV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ActionInfoV1_0_6 = (EFI_REDFISH_ACTIONINFO_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACTIONINFO_V1_0_6));
  if (ActionInfoV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ActionInfoV1_0_6;
  ActionInfoV1_0_6->ActionInfo = ActionInfoV1_0_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ActionInfo_V1_0_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ActionInfo_V1_0_6_JSON (*((EFI_REDFISH_ACTIONINFO_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ActionInfo_V1_0_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ActionInfoV1_0_6 = (EFI_REDFISH_ACTIONINFO_V1_0_6 *)InterpProp;
  DestroyActionInfo_V1_0_6_CS (ActionInfoV1_0_6->ActionInfo); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyActionInfo_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_0_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_0_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
