...
//
#include <RedfishJsonStructure/ActionInfo/v1_1_1/EfiActionInfoV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#ActionInfo";
BOOLEAN IsRevisonController = TRUE;

// Support ActionInfo V1_1_1
...
{
  EFI_REDFISH_ACTIONINFO_V1_1_1 *ActionInfoV1_1_1;
  EFI_REDFISH_ACTIONINFO_V1_1_1_CS *ActionInfoV1_1_1Cs;
  ...
  Status = (EFI_STATUS)Json_ActionInfo_V1_1_1_To_CS (ResoruceRaw, &ActionInfoV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ActionInfoV1_1_1 = (EFI_REDFISH_ACTIONINFO_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACTIONINFO_V1_1_1));
  if (ActionInfoV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ActionInfoV1_1_1;
  ActionInfoV1_1_1->ActionInfo = ActionInfoV1_1_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ActionInfo_V1_1_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ActionInfo_V1_1_1_JSON (*((EFI_REDFISH_ACTIONINFO_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ActionInfo_V1_1_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ActionInfoV1_1_1 = (EFI_REDFISH_ACTIONINFO_V1_1_1 *)InterpProp;
  DestroyActionInfo_V1_1_1_CS (ActionInfoV1_1_1->ActionInfo); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyActionInfo_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
