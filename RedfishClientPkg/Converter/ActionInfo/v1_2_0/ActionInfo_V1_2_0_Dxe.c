...
//
#include <RedfishJsonStructure/ActionInfo/v1_2_0/EfiActionInfoV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#ActionInfo";
BOOLEAN IsRevisonController = TRUE;

// Support ActionInfo V1_2_0
...
{
  EFI_REDFISH_ACTIONINFO_V1_2_0 *ActionInfoV1_2_0;
  EFI_REDFISH_ACTIONINFO_V1_2_0_CS *ActionInfoV1_2_0Cs;
  ...
  Status = (EFI_STATUS)Json_ActionInfo_V1_2_0_To_CS (ResoruceRaw, &ActionInfoV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ActionInfoV1_2_0 = (EFI_REDFISH_ACTIONINFO_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACTIONINFO_V1_2_0));
  if (ActionInfoV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ActionInfoV1_2_0;
  ActionInfoV1_2_0->ActionInfo = ActionInfoV1_2_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ActionInfo_V1_2_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ActionInfo_V1_2_0_JSON (*((EFI_REDFISH_ACTIONINFO_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ActionInfo_V1_2_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ActionInfoV1_2_0 = (EFI_REDFISH_ACTIONINFO_V1_2_0 *)InterpProp;
  DestroyActionInfo_V1_2_0_CS (ActionInfoV1_2_0->ActionInfo); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyActionInfo_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_2_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishActionInfo_V1_2_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
