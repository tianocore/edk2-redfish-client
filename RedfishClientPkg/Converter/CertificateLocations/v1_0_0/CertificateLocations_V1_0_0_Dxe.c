...
//
#include <RedfishJsonStructure/CertificateLocations/v1_0_0/EfiCertificateLocationsV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#CertificateLocations";
BOOLEAN IsRevisonController = TRUE;

// Support CertificateLocations V1_0_0
...
{
  EFI_REDFISH_CERTIFICATELOCATIONS_V1_0_0 *CertificateLocationsV1_0_0;
  EFI_REDFISH_CERTIFICATELOCATIONS_V1_0_0_CS *CertificateLocationsV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "CertificateLocations") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_CertificateLocations_V1_0_0_To_CS (ResoruceRaw, &CertificateLocationsV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CertificateLocationsV1_0_0 = (EFI_REDFISH_CERTIFICATELOCATIONS_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CERTIFICATELOCATIONS_V1_0_0));
  if (CertificateLocationsV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)CertificateLocationsV1_0_0;
  CertificateLocationsV1_0_0->CertificateLocations = CertificateLocationsV1_0_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("CertificateLocations"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("CertificateLocations"), "CertificateLocations");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("CertificateLocations"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("CertificateLocations"), "CertificateLocations");
...
/**
  The wrapper function of CertificateLocationsToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
CertificateLocationsToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return CertificateLocationsToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_CertificateLocations_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_CertificateLocations_V1_0_0_JSON (*((EFI_REDFISH_CERTIFICATELOCATIONS_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_CertificateLocations_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in CertificateLocationsToStruct.
...
EFI_STATUS
EFIAPI
CertificateLocationsDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  CertificateLocationsV1_0_0 = (EFI_REDFISH_CERTIFICATELOCATIONS_V1_0_0 *)InterpProp;
  DestroyCertificateLocations_V1_0_0_CS (CertificateLocationsV1_0_0->CertificateLocations); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from CertificateLocationsFromStruct
...
EFI_STATUS
EFIAPI
CertificateLocationsDestoryJson(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL *This,
...
)
{
  ...
  return (EFI_STATUS)DestroyCertificateLocations_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCertificateLocations_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishCertificateLocations_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
