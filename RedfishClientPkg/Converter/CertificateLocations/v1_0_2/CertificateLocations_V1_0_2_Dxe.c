...
//
#include <RedfishJsonStructure/CertificateLocations/v1_0_2/EfiCertificateLocationsV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#CertificateLocations";
BOOLEAN IsRevisonController = TRUE;

// Support CertificateLocations V1_0_2
...
{
  EFI_REDFISH_CERTIFICATELOCATIONS_V1_0_2 *CertificateLocationsV1_0_2;
  EFI_REDFISH_CERTIFICATELOCATIONS_V1_0_2_CS *CertificateLocationsV1_0_2Cs;
  ...
  Status = (EFI_STATUS)Json_CertificateLocations_V1_0_2_To_CS (ResoruceRaw, &CertificateLocationsV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CertificateLocationsV1_0_2 = (EFI_REDFISH_CERTIFICATELOCATIONS_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CERTIFICATELOCATIONS_V1_0_2));
  if (CertificateLocationsV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)CertificateLocationsV1_0_2;
  CertificateLocationsV1_0_2->CertificateLocations = CertificateLocationsV1_0_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_CertificateLocations_V1_0_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_CertificateLocations_V1_0_2_JSON (*((EFI_REDFISH_CERTIFICATELOCATIONS_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_CertificateLocations_V1_0_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  CertificateLocationsV1_0_2 = (EFI_REDFISH_CERTIFICATELOCATIONS_V1_0_2 *)InterpProp;
  DestroyCertificateLocations_V1_0_2_CS (CertificateLocationsV1_0_2->CertificateLocations); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyCertificateLocations_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCertificateLocations_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishCertificateLocations_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
