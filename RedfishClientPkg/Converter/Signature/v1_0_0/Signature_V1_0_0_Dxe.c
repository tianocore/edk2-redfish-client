...
//
#include <RedfishJsonStructure/Signature/v1_0_0/EfiSignatureV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#Signature";
BOOLEAN IsRevisonController = TRUE;

// Support Signature V1_0_0
...
{
  EFI_REDFISH_SIGNATURE_V1_0_0 *SignatureV1_0_0;
  EFI_REDFISH_SIGNATURE_V1_0_0_CS *SignatureV1_0_0Cs;
  ...
  Status = (EFI_STATUS)Json_Signature_V1_0_0_To_CS (ResoruceRaw, &SignatureV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SignatureV1_0_0 = (EFI_REDFISH_SIGNATURE_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SIGNATURE_V1_0_0));
  if (SignatureV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SignatureV1_0_0;
  SignatureV1_0_0->Signature = SignatureV1_0_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Signature_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Signature_V1_0_0_JSON (*((EFI_REDFISH_SIGNATURE_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Signature_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SignatureV1_0_0 = (EFI_REDFISH_SIGNATURE_V1_0_0 *)InterpProp;
  DestroySignature_V1_0_0_CS (SignatureV1_0_0->Signature); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySignature_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSignature_V1_0_0EntryPoint (
