...
//
#include <RedfishJsonStructure/Signature/v1_0_2/EfiSignatureV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#Signature";
BOOLEAN IsRevisonController = TRUE;

// Support Signature V1_0_2
...
{
  EFI_REDFISH_SIGNATURE_V1_0_2 *SignatureV1_0_2;
  EFI_REDFISH_SIGNATURE_V1_0_2_CS *SignatureV1_0_2Cs;
  ...
  Status = (EFI_STATUS)Json_Signature_V1_0_2_To_CS (ResoruceRaw, &SignatureV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SignatureV1_0_2 = (EFI_REDFISH_SIGNATURE_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SIGNATURE_V1_0_2));
  if (SignatureV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SignatureV1_0_2;
  SignatureV1_0_2->Signature = SignatureV1_0_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Signature_V1_0_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Signature_V1_0_2_JSON (*((EFI_REDFISH_SIGNATURE_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Signature_V1_0_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SignatureV1_0_2 = (EFI_REDFISH_SIGNATURE_V1_0_2 *)InterpProp;
  DestroySignature_V1_0_2_CS (SignatureV1_0_2->Signature); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySignature_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSignature_V1_0_2EntryPoint (
