...
//
#include <RedfishJsonStructure/ManagerNetworkProtocol/v1_6_0/EfiManagerNetworkProtocolV1_6_0.h>
CHAR8 mResourceTypeStr [] = "#ManagerNetworkProtocol";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerNetworkProtocol V1_6_0
...
{
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_6_0 *ManagerNetworkProtocolV1_6_0;
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_6_0_CS *ManagerNetworkProtocolV1_6_0Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerNetworkProtocol_V1_6_0_To_CS (ResoruceRaw, &ManagerNetworkProtocolV1_6_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerNetworkProtocolV1_6_0 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_6_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_6_0));
  if (ManagerNetworkProtocolV1_6_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerNetworkProtocolV1_6_0;
  ManagerNetworkProtocolV1_6_0->ManagerNetworkProtocol = ManagerNetworkProtocolV1_6_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerNetworkProtocol_V1_6_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerNetworkProtocol_V1_6_0_JSON (*((EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_6_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerNetworkProtocol_V1_6_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerNetworkProtocolV1_6_0 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_6_0 *)InterpProp;
  DestroyManagerNetworkProtocol_V1_6_0_CS (ManagerNetworkProtocolV1_6_0->ManagerNetworkProtocol); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerNetworkProtocol_V1_6_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_6_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_6_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
