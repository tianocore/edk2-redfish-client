...
//
#include <RedfishJsonStructure/ManagerNetworkProtocol/v1_0_8/EfiManagerNetworkProtocolV1_0_8.h>
CHAR8 mResourceTypeStr [] = "#ManagerNetworkProtocol";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerNetworkProtocol V1_0_8
...
{
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_8 *ManagerNetworkProtocolV1_0_8;
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_8_CS *ManagerNetworkProtocolV1_0_8Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerNetworkProtocol_V1_0_8_To_CS (ResoruceRaw, &ManagerNetworkProtocolV1_0_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerNetworkProtocolV1_0_8 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_8));
  if (ManagerNetworkProtocolV1_0_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerNetworkProtocolV1_0_8;
  ManagerNetworkProtocolV1_0_8->ManagerNetworkProtocol = ManagerNetworkProtocolV1_0_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerNetworkProtocol_V1_0_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerNetworkProtocol_V1_0_8_JSON (*((EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerNetworkProtocol_V1_0_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerNetworkProtocolV1_0_8 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_0_8 *)InterpProp;
  DestroyManagerNetworkProtocol_V1_0_8_CS (ManagerNetworkProtocolV1_0_8->ManagerNetworkProtocol); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerNetworkProtocol_V1_0_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_0_8EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_0_8Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
