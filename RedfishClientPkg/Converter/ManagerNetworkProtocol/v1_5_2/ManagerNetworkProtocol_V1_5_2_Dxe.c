...
//
#include <RedfishJsonStructure/ManagerNetworkProtocol/v1_5_2/EfiManagerNetworkProtocolV1_5_2.h>
CHAR8 mResourceTypeStr [] = "#ManagerNetworkProtocol";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerNetworkProtocol V1_5_2
...
{
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_5_2 *ManagerNetworkProtocolV1_5_2;
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_5_2_CS *ManagerNetworkProtocolV1_5_2Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerNetworkProtocol_V1_5_2_To_CS (ResoruceRaw, &ManagerNetworkProtocolV1_5_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerNetworkProtocolV1_5_2 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_5_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_5_2));
  if (ManagerNetworkProtocolV1_5_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerNetworkProtocolV1_5_2;
  ManagerNetworkProtocolV1_5_2->ManagerNetworkProtocol = ManagerNetworkProtocolV1_5_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerNetworkProtocol_V1_5_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerNetworkProtocol_V1_5_2_JSON (*((EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_5_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerNetworkProtocol_V1_5_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerNetworkProtocolV1_5_2 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_5_2 *)InterpProp;
  DestroyManagerNetworkProtocol_V1_5_2_CS (ManagerNetworkProtocolV1_5_2->ManagerNetworkProtocol); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerNetworkProtocol_V1_5_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_5_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_5_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
