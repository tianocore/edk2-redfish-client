...
//
#include <RedfishJsonStructure/ManagerNetworkProtocol/v1_4_3/EfiManagerNetworkProtocolV1_4_3.h>
CHAR8 mResourceTypeStr [] = "#ManagerNetworkProtocol";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerNetworkProtocol V1_4_3
...
{
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_4_3 *ManagerNetworkProtocolV1_4_3;
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_4_3_CS *ManagerNetworkProtocolV1_4_3Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerNetworkProtocol_V1_4_3_To_CS (ResoruceRaw, &ManagerNetworkProtocolV1_4_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerNetworkProtocolV1_4_3 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_4_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_4_3));
  if (ManagerNetworkProtocolV1_4_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerNetworkProtocolV1_4_3;
  ManagerNetworkProtocolV1_4_3->ManagerNetworkProtocol = ManagerNetworkProtocolV1_4_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerNetworkProtocol_V1_4_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerNetworkProtocol_V1_4_3_JSON (*((EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_4_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerNetworkProtocol_V1_4_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerNetworkProtocolV1_4_3 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_4_3 *)InterpProp;
  DestroyManagerNetworkProtocol_V1_4_3_CS (ManagerNetworkProtocolV1_4_3->ManagerNetworkProtocol); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerNetworkProtocol_V1_4_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_4_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_4_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
