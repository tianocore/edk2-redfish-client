...
)
{
  ...
  return (EFI_STATUS)CS_To_ManagerNetworkProtocol_V1_7_0_JSON (*((EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_7_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
