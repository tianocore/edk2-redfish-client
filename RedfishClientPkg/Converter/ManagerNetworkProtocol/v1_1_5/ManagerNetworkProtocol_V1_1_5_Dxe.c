...
//
#include <RedfishJsonStructure/ManagerNetworkProtocol/v1_1_5/EfiManagerNetworkProtocolV1_1_5.h>
CHAR8 mResourceTypeStr [] = "#ManagerNetworkProtocol";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerNetworkProtocol V1_1_5
...
{
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_1_5 *ManagerNetworkProtocolV1_1_5;
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_1_5_CS *ManagerNetworkProtocolV1_1_5Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerNetworkProtocol_V1_1_5_To_CS (ResoruceRaw, &ManagerNetworkProtocolV1_1_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerNetworkProtocolV1_1_5 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_1_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_1_5));
  if (ManagerNetworkProtocolV1_1_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerNetworkProtocolV1_1_5;
  ManagerNetworkProtocolV1_1_5->ManagerNetworkProtocol = ManagerNetworkProtocolV1_1_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerNetworkProtocol_V1_1_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerNetworkProtocol_V1_1_5_JSON (*((EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_1_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerNetworkProtocol_V1_1_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerNetworkProtocolV1_1_5 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_1_5 *)InterpProp;
  DestroyManagerNetworkProtocol_V1_1_5_CS (ManagerNetworkProtocolV1_1_5->ManagerNetworkProtocol); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerNetworkProtocol_V1_1_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_1_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_1_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
