...
//
#include <RedfishJsonStructure/ManagerNetworkProtocol/v1_3_4/EfiManagerNetworkProtocolV1_3_4.h>
CHAR8 mResourceTypeStr [] = "#ManagerNetworkProtocol";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerNetworkProtocol V1_3_4
...
{
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_3_4 *ManagerNetworkProtocolV1_3_4;
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_3_4_CS *ManagerNetworkProtocolV1_3_4Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerNetworkProtocol_V1_3_4_To_CS (ResoruceRaw, &ManagerNetworkProtocolV1_3_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerNetworkProtocolV1_3_4 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_3_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_3_4));
  if (ManagerNetworkProtocolV1_3_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerNetworkProtocolV1_3_4;
  ManagerNetworkProtocolV1_3_4->ManagerNetworkProtocol = ManagerNetworkProtocolV1_3_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerNetworkProtocol_V1_3_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerNetworkProtocol_V1_3_4_JSON (*((EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_3_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerNetworkProtocol_V1_3_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerNetworkProtocolV1_3_4 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_3_4 *)InterpProp;
  DestroyManagerNetworkProtocol_V1_3_4_CS (ManagerNetworkProtocolV1_3_4->ManagerNetworkProtocol); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerNetworkProtocol_V1_3_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_3_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_3_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
