...
//
#include <RedfishJsonStructure/ManagerNetworkProtocol/v1_4_4/EfiManagerNetworkProtocolV1_4_4.h>
CHAR8 mResourceTypeStr [] = "#ManagerNetworkProtocol";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerNetworkProtocol V1_4_4
...
EFI_STATUS
EFIAPI
ManagerNetworkProtocolToStruct (
...
{
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_4_4 *ManagerNetworkProtocolV1_4_4;
  EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_4_4_CS *ManagerNetworkProtocolV1_4_4Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerNetworkProtocol_V1_4_4_To_CS (ResoruceRaw, &ManagerNetworkProtocolV1_4_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerNetworkProtocolV1_4_4 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_4_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_4_4));
  if (ManagerNetworkProtocolV1_4_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerNetworkProtocolV1_4_4;
  ManagerNetworkProtocolV1_4_4->ManagerNetworkProtocol = ManagerNetworkProtocolV1_4_4Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("ManagerNetworkProtocol"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("ManagerNetworkProtocol"), "ManagerNetworkProtocol");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("ManagerNetworkProtocol"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("ManagerNetworkProtocol"), "ManagerNetworkProtocol");
...
/**
  The wrapper function of ManagerNetworkProtocolToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
ManagerNetworkProtocolToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return ManagerNetworkProtocolToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerNetworkProtocol_V1_4_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerNetworkProtocol_V1_4_4_JSON (*((EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_4_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerNetworkProtocol_V1_4_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
EFI_STATUS
EFIAPI
ManagerNetworkProtocolDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  ManagerNetworkProtocolV1_4_4 = (EFI_REDFISH_MANAGERNETWORKPROTOCOL_V1_4_4 *)InterpProp;
  DestroyManagerNetworkProtocol_V1_4_4_CS (ManagerNetworkProtocolV1_4_4->ManagerNetworkProtocol); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ManagerNetworkProtocolFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerNetworkProtocol_V1_4_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_4_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerNetworkProtocol_V1_4_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
