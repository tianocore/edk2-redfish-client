...
//
#include <RedfishJsonStructure/ComponentIntegrity/v1_0_0/EfiComponentIntegrityV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#ComponentIntegrity";
BOOLEAN IsRevisonController = TRUE;

// Support ComponentIntegrity V1_0_0
...
{
  EFI_REDFISH_COMPONENTINTEGRITY_V1_0_0 *ComponentIntegrityV1_0_0;
  EFI_REDFISH_COMPONENTINTEGRITY_V1_0_0_CS *ComponentIntegrityV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "ComponentIntegrity") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_ComponentIntegrity_V1_0_0_To_CS (ResoruceRaw, &ComponentIntegrityV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComponentIntegrityV1_0_0 = (EFI_REDFISH_COMPONENTINTEGRITY_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPONENTINTEGRITY_V1_0_0));
  if (ComponentIntegrityV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ComponentIntegrityV1_0_0;
  ComponentIntegrityV1_0_0->ComponentIntegrity = ComponentIntegrityV1_0_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("ComponentIntegrity"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("ComponentIntegrity"), "ComponentIntegrity");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("ComponentIntegrity"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("ComponentIntegrity"), "ComponentIntegrity");
...
/**
  The wrapper function of ComponentIntegrityToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
ComponentIntegrityToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return ComponentIntegrityToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ComponentIntegrity_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ComponentIntegrity_V1_0_0_JSON (*((EFI_REDFISH_COMPONENTINTEGRITY_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ComponentIntegrity_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in ComponentIntegrityToStruct.
...
EFI_STATUS
EFIAPI
ComponentIntegrityDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  ComponentIntegrityV1_0_0 = (EFI_REDFISH_COMPONENTINTEGRITY_V1_0_0 *)InterpProp;
  DestroyComponentIntegrity_V1_0_0_CS (ComponentIntegrityV1_0_0->ComponentIntegrity); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ComponentIntegrityFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyComponentIntegrity_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComponentIntegrity_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComponentIntegrity_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
