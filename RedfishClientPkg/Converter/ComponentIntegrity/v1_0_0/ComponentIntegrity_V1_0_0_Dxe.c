...
)
{
  ...
  return (EFI_STATUS)CS_To_ComponentIntegrity_V1_0_0_JSON (*((EFI_REDFISH_COMPONENTINTEGRITY_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
