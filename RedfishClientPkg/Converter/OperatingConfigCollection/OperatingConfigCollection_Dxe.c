...
)
{
  ...
  return (EFI_STATUS)CS_To_OperatingConfigCollection_JSON (*((EFI_REDFISH_OPERATINGCONFIGCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
