...
//
#include <RedfishJsonStructure/PCIeDevice/v1_4_1/EfiPCIeDeviceV1_4_1.h>
CHAR8 mResourceTypeStr [] = "#PCIeDevice";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeDevice V1_4_1
...
{
  EFI_REDFISH_PCIEDEVICE_V1_4_1 *PCIeDeviceV1_4_1;
  EFI_REDFISH_PCIEDEVICE_V1_4_1_CS *PCIeDeviceV1_4_1Cs;
  ...
  Status = (EFI_STATUS)Json_PCIeDevice_V1_4_1_To_CS (ResoruceRaw, &PCIeDeviceV1_4_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeDeviceV1_4_1 = (EFI_REDFISH_PCIEDEVICE_V1_4_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEDEVICE_V1_4_1));
  if (PCIeDeviceV1_4_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PCIeDeviceV1_4_1;
  PCIeDeviceV1_4_1->PCIeDevice = PCIeDeviceV1_4_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PCIeDevice_V1_4_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PCIeDevice_V1_4_1_JSON (*((EFI_REDFISH_PCIEDEVICE_V1_4_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PCIeDevice_V1_4_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PCIeDeviceV1_4_1 = (EFI_REDFISH_PCIEDEVICE_V1_4_1 *)InterpProp;
  DestroyPCIeDevice_V1_4_1_CS (PCIeDeviceV1_4_1->PCIeDevice); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPCIeDevice_V1_4_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_4_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_4_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
