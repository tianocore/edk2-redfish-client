...
//
#include <RedfishJsonStructure/PCIeDevice/v1_1_3/EfiPCIeDeviceV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#PCIeDevice";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeDevice V1_1_3
...
{
  EFI_REDFISH_PCIEDEVICE_V1_1_3 *PCIeDeviceV1_1_3;
  EFI_REDFISH_PCIEDEVICE_V1_1_3_CS *PCIeDeviceV1_1_3Cs;
  ...
  Status = (EFI_STATUS)Json_PCIeDevice_V1_1_3_To_CS (ResoruceRaw, &PCIeDeviceV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeDeviceV1_1_3 = (EFI_REDFISH_PCIEDEVICE_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEDEVICE_V1_1_3));
  if (PCIeDeviceV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PCIeDeviceV1_1_3;
  PCIeDeviceV1_1_3->PCIeDevice = PCIeDeviceV1_1_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PCIeDevice_V1_1_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PCIeDevice_V1_1_3_JSON (*((EFI_REDFISH_PCIEDEVICE_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PCIeDevice_V1_1_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PCIeDeviceV1_1_3 = (EFI_REDFISH_PCIEDEVICE_V1_1_3 *)InterpProp;
  DestroyPCIeDevice_V1_1_3_CS (PCIeDeviceV1_1_3->PCIeDevice); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPCIeDevice_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_1_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_1_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
