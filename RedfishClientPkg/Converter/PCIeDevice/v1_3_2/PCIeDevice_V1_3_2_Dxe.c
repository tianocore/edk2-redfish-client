...
//
#include <RedfishJsonStructure/PCIeDevice/v1_3_2/EfiPCIeDeviceV1_3_2.h>
CHAR8 mResourceTypeStr [] = "#PCIeDevice";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeDevice V1_3_2
...
{
  EFI_REDFISH_PCIEDEVICE_V1_3_2 *PCIeDeviceV1_3_2;
  EFI_REDFISH_PCIEDEVICE_V1_3_2_CS *PCIeDeviceV1_3_2Cs;
  ...
  Status = (EFI_STATUS)Json_PCIeDevice_V1_3_2_To_CS (ResoruceRaw, &PCIeDeviceV1_3_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeDeviceV1_3_2 = (EFI_REDFISH_PCIEDEVICE_V1_3_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEDEVICE_V1_3_2));
  if (PCIeDeviceV1_3_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PCIeDeviceV1_3_2;
  PCIeDeviceV1_3_2->PCIeDevice = PCIeDeviceV1_3_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PCIeDevice_V1_3_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PCIeDevice_V1_3_2_JSON (*((EFI_REDFISH_PCIEDEVICE_V1_3_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PCIeDevice_V1_3_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PCIeDeviceV1_3_2 = (EFI_REDFISH_PCIEDEVICE_V1_3_2 *)InterpProp;
  DestroyPCIeDevice_V1_3_2_CS (PCIeDeviceV1_3_2->PCIeDevice); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPCIeDevice_V1_3_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_3_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_3_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
