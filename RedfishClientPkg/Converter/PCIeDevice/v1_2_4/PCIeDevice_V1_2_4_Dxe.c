...
//
#include <RedfishJsonStructure/PCIeDevice/v1_2_4/EfiPCIeDeviceV1_2_4.h>
CHAR8 mResourceTypeStr [] = "#PCIeDevice";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeDevice V1_2_4
...
{
  EFI_REDFISH_PCIEDEVICE_V1_2_4 *PCIeDeviceV1_2_4;
  EFI_REDFISH_PCIEDEVICE_V1_2_4_CS *PCIeDeviceV1_2_4Cs;
  ...
  Status = (EFI_STATUS)Json_PCIeDevice_V1_2_4_To_CS (ResoruceRaw, &PCIeDeviceV1_2_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeDeviceV1_2_4 = (EFI_REDFISH_PCIEDEVICE_V1_2_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEDEVICE_V1_2_4));
  if (PCIeDeviceV1_2_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PCIeDeviceV1_2_4;
  PCIeDeviceV1_2_4->PCIeDevice = PCIeDeviceV1_2_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PCIeDevice_V1_2_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PCIeDevice_V1_2_4_JSON (*((EFI_REDFISH_PCIEDEVICE_V1_2_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PCIeDevice_V1_2_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PCIeDeviceV1_2_4 = (EFI_REDFISH_PCIEDEVICE_V1_2_4 *)InterpProp;
  DestroyPCIeDevice_V1_2_4_CS (PCIeDeviceV1_2_4->PCIeDevice); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPCIeDevice_V1_2_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_2_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_2_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
