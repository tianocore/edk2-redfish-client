...
//
#include <RedfishJsonStructure/PCIeDevice/v1_5_0/EfiPCIeDeviceV1_5_0.h>
CHAR8 mResourceTypeStr [] = "#PCIeDevice";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeDevice V1_5_0
...
{
  EFI_REDFISH_PCIEDEVICE_V1_5_0 *PCIeDeviceV1_5_0;
  EFI_REDFISH_PCIEDEVICE_V1_5_0_CS *PCIeDeviceV1_5_0Cs;
  ...
  Status = (EFI_STATUS)Json_PCIeDevice_V1_5_0_To_CS (ResoruceRaw, &PCIeDeviceV1_5_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeDeviceV1_5_0 = (EFI_REDFISH_PCIEDEVICE_V1_5_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEDEVICE_V1_5_0));
  if (PCIeDeviceV1_5_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PCIeDeviceV1_5_0;
  PCIeDeviceV1_5_0->PCIeDevice = PCIeDeviceV1_5_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PCIeDevice_V1_5_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PCIeDevice_V1_5_0_JSON (*((EFI_REDFISH_PCIEDEVICE_V1_5_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PCIeDevice_V1_5_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PCIeDeviceV1_5_0 = (EFI_REDFISH_PCIEDEVICE_V1_5_0 *)InterpProp;
  DestroyPCIeDevice_V1_5_0_CS (PCIeDeviceV1_5_0->PCIeDevice); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPCIeDevice_V1_5_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_5_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_5_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
