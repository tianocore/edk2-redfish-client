...
{
  EFI_REDFISH_PCIEDEVICE_V1_9_0 *PCIeDeviceV1_9_0;
  EFI_REDFISH_PCIEDEVICE_V1_9_0_CS *PCIeDeviceV1_9_0Cs;
  ...
  Status = (EFI_STATUS)Json_PCIeDevice_V1_9_0_To_CS (ResoruceRaw, &PCIeDeviceV1_9_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeDeviceV1_9_0 = (EFI_REDFISH_PCIEDEVICE_V1_9_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEDEVICE_V1_9_0));
  if (PCIeDeviceV1_9_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PCIeDeviceV1_9_0;
  PCIeDeviceV1_9_0->PCIeDevice = PCIeDeviceV1_9_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("PCIeDevice"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("PCIeDevice"), "PCIeDevice");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("PCIeDevice"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("PCIeDevice"), "PCIeDevice");
...
/**
  The wrapper function of PCIeDeviceToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PCIeDevice_V1_9_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PCIeDevice_V1_9_0_JSON (*((EFI_REDFISH_PCIEDEVICE_V1_9_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PCIeDevice_V1_9_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PCIeDeviceV1_9_0 = (EFI_REDFISH_PCIEDEVICE_V1_9_0 *)InterpProp;
  DestroyPCIeDevice_V1_9_0_CS (PCIeDeviceV1_9_0->PCIeDevice); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from PCIeDeviceFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyPCIeDevice_V1_9_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_9_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_9_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
