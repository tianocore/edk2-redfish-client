...
//
#include <RedfishJsonStructure/PCIeDevice/v1_0_5/EfiPCIeDeviceV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#PCIeDevice";
BOOLEAN IsRevisonController = TRUE;

// Support PCIeDevice V1_0_5
...
{
  EFI_REDFISH_PCIEDEVICE_V1_0_5 *PCIeDeviceV1_0_5;
  EFI_REDFISH_PCIEDEVICE_V1_0_5_CS *PCIeDeviceV1_0_5Cs;
  ...
  Status = (EFI_STATUS)Json_PCIeDevice_V1_0_5_To_CS (ResoruceRaw, &PCIeDeviceV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PCIeDeviceV1_0_5 = (EFI_REDFISH_PCIEDEVICE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PCIEDEVICE_V1_0_5));
  if (PCIeDeviceV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PCIeDeviceV1_0_5;
  PCIeDeviceV1_0_5->PCIeDevice = PCIeDeviceV1_0_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PCIeDevice_V1_0_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PCIeDevice_V1_0_5_JSON (*((EFI_REDFISH_PCIEDEVICE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PCIeDevice_V1_0_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PCIeDeviceV1_0_5 = (EFI_REDFISH_PCIEDEVICE_V1_0_5 *)InterpProp;
  DestroyPCIeDevice_V1_0_5_CS (PCIeDeviceV1_0_5->PCIeDevice); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPCIeDevice_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPCIeDevice_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
