...
)
{
  ...
  return (EFI_STATUS)CS_To_LogServiceCollection_JSON (*((EFI_REDFISH_LOGSERVICECOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
