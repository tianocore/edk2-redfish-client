...
)
{
  ...
  return (EFI_STATUS)CS_To_MessageRegistryCollection_JSON (*((EFI_REDFISH_MESSAGEREGISTRYCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
