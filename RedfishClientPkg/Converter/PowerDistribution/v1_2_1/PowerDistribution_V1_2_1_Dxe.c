...
//
#include <RedfishJsonStructure/PowerDistribution/v1_2_1/EfiPowerDistributionV1_2_1.h>
CHAR8 mResourceTypeStr [] = "#PowerDistribution";
BOOLEAN IsRevisonController = TRUE;

// Support PowerDistribution V1_2_1
...
{
  EFI_REDFISH_POWERDISTRIBUTION_V1_2_1 *PowerDistributionV1_2_1;
  EFI_REDFISH_POWERDISTRIBUTION_V1_2_1_CS *PowerDistributionV1_2_1Cs;
  ...
  Status = (EFI_STATUS)Json_PowerDistribution_V1_2_1_To_CS (ResoruceRaw, &PowerDistributionV1_2_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerDistributionV1_2_1 = (EFI_REDFISH_POWERDISTRIBUTION_V1_2_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWERDISTRIBUTION_V1_2_1));
  if (PowerDistributionV1_2_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerDistributionV1_2_1;
  PowerDistributionV1_2_1->PowerDistribution = PowerDistributionV1_2_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PowerDistribution_V1_2_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PowerDistribution_V1_2_1_JSON (*((EFI_REDFISH_POWERDISTRIBUTION_V1_2_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PowerDistribution_V1_2_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerDistributionV1_2_1 = (EFI_REDFISH_POWERDISTRIBUTION_V1_2_1 *)InterpProp;
  DestroyPowerDistribution_V1_2_1_CS (PowerDistributionV1_2_1->PowerDistribution); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPowerDistribution_V1_2_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPowerDistribution_V1_2_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPowerDistribution_V1_2_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
