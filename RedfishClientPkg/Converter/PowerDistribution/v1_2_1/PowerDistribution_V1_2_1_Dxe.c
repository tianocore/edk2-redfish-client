...
)
{
  ...
  return (EFI_STATUS)CS_To_PowerDistribution_V1_2_1_JSON (*((EFI_REDFISH_POWERDISTRIBUTION_V1_2_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
