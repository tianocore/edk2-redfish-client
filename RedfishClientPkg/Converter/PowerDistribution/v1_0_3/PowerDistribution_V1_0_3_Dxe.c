...
//
#include <RedfishJsonStructure/PowerDistribution/v1_0_3/EfiPowerDistributionV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#PowerDistribution";
BOOLEAN IsRevisonController = TRUE;

// Support PowerDistribution V1_0_3
...
{
  EFI_REDFISH_POWERDISTRIBUTION_V1_0_3 *PowerDistributionV1_0_3;
  EFI_REDFISH_POWERDISTRIBUTION_V1_0_3_CS *PowerDistributionV1_0_3Cs;
  ...
  Status = (EFI_STATUS)Json_PowerDistribution_V1_0_3_To_CS (ResoruceRaw, &PowerDistributionV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerDistributionV1_0_3 = (EFI_REDFISH_POWERDISTRIBUTION_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWERDISTRIBUTION_V1_0_3));
  if (PowerDistributionV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerDistributionV1_0_3;
  PowerDistributionV1_0_3->PowerDistribution = PowerDistributionV1_0_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PowerDistribution_V1_0_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PowerDistribution_V1_0_3_JSON (*((EFI_REDFISH_POWERDISTRIBUTION_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PowerDistribution_V1_0_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerDistributionV1_0_3 = (EFI_REDFISH_POWERDISTRIBUTION_V1_0_3 *)InterpProp;
  DestroyPowerDistribution_V1_0_3_CS (PowerDistributionV1_0_3->PowerDistribution); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPowerDistribution_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPowerDistribution_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPowerDistribution_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
