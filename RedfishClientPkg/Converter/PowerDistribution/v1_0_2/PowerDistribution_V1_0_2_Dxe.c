...
//
#include <RedfishJsonStructure/PowerDistribution/v1_0_2/EfiPowerDistributionV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#PowerDistribution";
BOOLEAN IsRevisonController = TRUE;

// Support PowerDistribution V1_0_2
...
{
  EFI_REDFISH_POWERDISTRIBUTION_V1_0_2 *PowerDistributionV1_0_2;
  EFI_REDFISH_POWERDISTRIBUTION_V1_0_2_CS *PowerDistributionV1_0_2Cs;
  ...
  Status = (EFI_STATUS)Json_PowerDistribution_V1_0_2_To_CS (ResoruceRaw, &PowerDistributionV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerDistributionV1_0_2 = (EFI_REDFISH_POWERDISTRIBUTION_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWERDISTRIBUTION_V1_0_2));
  if (PowerDistributionV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerDistributionV1_0_2;
  PowerDistributionV1_0_2->PowerDistribution = PowerDistributionV1_0_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PowerDistribution_V1_0_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PowerDistribution_V1_0_2_JSON (*((EFI_REDFISH_POWERDISTRIBUTION_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PowerDistribution_V1_0_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerDistributionV1_0_2 = (EFI_REDFISH_POWERDISTRIBUTION_V1_0_2 *)InterpProp;
  DestroyPowerDistribution_V1_0_2_CS (PowerDistributionV1_0_2->PowerDistribution); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPowerDistribution_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPowerDistribution_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPowerDistribution_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
