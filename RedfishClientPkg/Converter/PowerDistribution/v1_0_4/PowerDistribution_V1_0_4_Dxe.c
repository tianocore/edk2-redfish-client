...
//
#include <RedfishJsonStructure/PowerDistribution/v1_0_4/EfiPowerDistributionV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#PowerDistribution";
BOOLEAN IsRevisonController = TRUE;

// Support PowerDistribution V1_0_4
...
{
  EFI_REDFISH_POWERDISTRIBUTION_V1_0_4 *PowerDistributionV1_0_4;
  EFI_REDFISH_POWERDISTRIBUTION_V1_0_4_CS *PowerDistributionV1_0_4Cs;
  ...
  Status = (EFI_STATUS)Json_PowerDistribution_V1_0_4_To_CS (ResoruceRaw, &PowerDistributionV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerDistributionV1_0_4 = (EFI_REDFISH_POWERDISTRIBUTION_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWERDISTRIBUTION_V1_0_4));
  if (PowerDistributionV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerDistributionV1_0_4;
  PowerDistributionV1_0_4->PowerDistribution = PowerDistributionV1_0_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PowerDistribution_V1_0_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PowerDistribution_V1_0_4_JSON (*((EFI_REDFISH_POWERDISTRIBUTION_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PowerDistribution_V1_0_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerDistributionV1_0_4 = (EFI_REDFISH_POWERDISTRIBUTION_V1_0_4 *)InterpProp;
  DestroyPowerDistribution_V1_0_4_CS (PowerDistributionV1_0_4->PowerDistribution); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPowerDistribution_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPowerDistribution_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPowerDistribution_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
