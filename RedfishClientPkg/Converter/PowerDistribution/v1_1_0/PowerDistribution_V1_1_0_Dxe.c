...
//
#include <RedfishJsonStructure/PowerDistribution/v1_1_0/EfiPowerDistributionV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#PowerDistribution";
BOOLEAN IsRevisonController = TRUE;

// Support PowerDistribution V1_1_0
...
{
  EFI_REDFISH_POWERDISTRIBUTION_V1_1_0 *PowerDistributionV1_1_0;
  EFI_REDFISH_POWERDISTRIBUTION_V1_1_0_CS *PowerDistributionV1_1_0Cs;
  ...
  Status = (EFI_STATUS)Json_PowerDistribution_V1_1_0_To_CS (ResoruceRaw, &PowerDistributionV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerDistributionV1_1_0 = (EFI_REDFISH_POWERDISTRIBUTION_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWERDISTRIBUTION_V1_1_0));
  if (PowerDistributionV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerDistributionV1_1_0;
  PowerDistributionV1_1_0->PowerDistribution = PowerDistributionV1_1_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PowerDistribution_V1_1_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PowerDistribution_V1_1_0_JSON (*((EFI_REDFISH_POWERDISTRIBUTION_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PowerDistribution_V1_1_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerDistributionV1_1_0 = (EFI_REDFISH_POWERDISTRIBUTION_V1_1_0 *)InterpProp;
  DestroyPowerDistribution_V1_1_0_CS (PowerDistributionV1_1_0->PowerDistribution); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPowerDistribution_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPowerDistribution_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPowerDistribution_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
