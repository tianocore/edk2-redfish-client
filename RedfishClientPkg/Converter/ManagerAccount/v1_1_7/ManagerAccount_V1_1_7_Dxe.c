...
//
#include <RedfishJsonStructure/ManagerAccount/v1_1_7/EfiManagerAccountV1_1_7.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_1_7
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_1_7 *ManagerAccountV1_1_7;
  EFI_REDFISH_MANAGERACCOUNT_V1_1_7_CS *ManagerAccountV1_1_7Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerAccount_V1_1_7_To_CS (ResoruceRaw, &ManagerAccountV1_1_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_1_7 = (EFI_REDFISH_MANAGERACCOUNT_V1_1_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_1_7));
  if (ManagerAccountV1_1_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerAccountV1_1_7;
  ManagerAccountV1_1_7->ManagerAccount = ManagerAccountV1_1_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerAccount_V1_1_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerAccount_V1_1_7_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_1_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerAccount_V1_1_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerAccountV1_1_7 = (EFI_REDFISH_MANAGERACCOUNT_V1_1_7 *)InterpProp;
  DestroyManagerAccount_V1_1_7_CS (ManagerAccountV1_1_7->ManagerAccount); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerAccount_V1_1_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_1_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_1_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
