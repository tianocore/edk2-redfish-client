...
//
#include <RedfishJsonStructure/ManagerAccount/v1_0_12/EfiManagerAccountV1_0_12.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_0_12
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_0_12 *ManagerAccountV1_0_12;
  EFI_REDFISH_MANAGERACCOUNT_V1_0_12_CS *ManagerAccountV1_0_12Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerAccount_V1_0_12_To_CS (ResoruceRaw, &ManagerAccountV1_0_12Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_0_12 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_12 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_0_12));
  if (ManagerAccountV1_0_12 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerAccountV1_0_12;
  ManagerAccountV1_0_12->ManagerAccount = ManagerAccountV1_0_12Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("ManagerAccount"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("ManagerAccount"), "ManagerAccount");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("ManagerAccount"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("ManagerAccount"), "ManagerAccount");
...
/**
  The wrapper function of ManagerAccountToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerAccount_V1_0_12_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerAccount_V1_0_12_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_0_12_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerAccount_V1_0_12_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerAccountV1_0_12 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_12 *)InterpProp;
  DestroyManagerAccount_V1_0_12_CS (ManagerAccountV1_0_12->ManagerAccount); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ManagerAccountFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerAccount_V1_0_12_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_12EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_12Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
