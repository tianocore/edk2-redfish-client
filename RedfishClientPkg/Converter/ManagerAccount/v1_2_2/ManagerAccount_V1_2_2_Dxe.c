...
//
#include <RedfishJsonStructure/ManagerAccount/v1_2_2/EfiManagerAccountV1_2_2.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_2_2
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_2_2 *ManagerAccountV1_2_2;
  EFI_REDFISH_MANAGERACCOUNT_V1_2_2_CS *ManagerAccountV1_2_2Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerAccount_V1_2_2_To_CS (ResoruceRaw, &ManagerAccountV1_2_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_2_2 = (EFI_REDFISH_MANAGERACCOUNT_V1_2_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_2_2));
  if (ManagerAccountV1_2_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerAccountV1_2_2;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerAccount_V1_2_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerAccount_V1_2_2_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_2_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerAccount_V1_2_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerAccountV1_2_2 = (EFI_REDFISH_MANAGERACCOUNT_V1_2_2 *)InterpProp;
  DestroyManagerAccount_V1_2_2_CS (ManagerAccountV1_2_2->ManagerAccount); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerAccount_V1_2_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_2_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_2_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
