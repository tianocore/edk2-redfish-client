...
//
#include <RedfishJsonStructure/ManagerAccount/v1_0_10/EfiManagerAccountV1_0_10.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_0_10
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_0_10 *ManagerAccountV1_0_10;
  EFI_REDFISH_MANAGERACCOUNT_V1_0_10_CS *ManagerAccountV1_0_10Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerAccount_V1_0_10_To_CS (ResoruceRaw, &ManagerAccountV1_0_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_0_10 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_0_10));
  if (ManagerAccountV1_0_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerAccountV1_0_10;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerAccount_V1_0_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerAccount_V1_0_10_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_0_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerAccount_V1_0_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerAccountV1_0_10 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_10 *)InterpProp;
  DestroyManagerAccount_V1_0_10_CS (ManagerAccountV1_0_10->ManagerAccount); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerAccount_V1_0_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_10EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_10Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
