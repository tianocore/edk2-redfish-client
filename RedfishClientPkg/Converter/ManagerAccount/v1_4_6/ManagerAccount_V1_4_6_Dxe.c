...
//
#include <RedfishJsonStructure/ManagerAccount/v1_4_6/EfiManagerAccountV1_4_6.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_4_6
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_4_6 *ManagerAccountV1_4_6;
  EFI_REDFISH_MANAGERACCOUNT_V1_4_6_CS *ManagerAccountV1_4_6Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerAccount_V1_4_6_To_CS (ResoruceRaw, &ManagerAccountV1_4_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_4_6 = (EFI_REDFISH_MANAGERACCOUNT_V1_4_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_4_6));
  if (ManagerAccountV1_4_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerAccountV1_4_6;
  ManagerAccountV1_4_6->ManagerAccount = ManagerAccountV1_4_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerAccount_V1_4_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerAccount_V1_4_6_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_4_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerAccount_V1_4_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerAccountV1_4_6 = (EFI_REDFISH_MANAGERACCOUNT_V1_4_6 *)InterpProp;
  DestroyManagerAccount_V1_4_6_CS (ManagerAccountV1_4_6->ManagerAccount); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerAccount_V1_4_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_4_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_4_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
