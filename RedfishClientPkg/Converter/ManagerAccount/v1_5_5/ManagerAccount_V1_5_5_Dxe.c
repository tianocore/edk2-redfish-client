...
//
#include <RedfishJsonStructure/ManagerAccount/v1_5_5/EfiManagerAccountV1_5_5.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_5_5
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_5_5 *ManagerAccountV1_5_5;
  EFI_REDFISH_MANAGERACCOUNT_V1_5_5_CS *ManagerAccountV1_5_5Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerAccount_V1_5_5_To_CS (ResoruceRaw, &ManagerAccountV1_5_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_5_5 = (EFI_REDFISH_MANAGERACCOUNT_V1_5_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_5_5));
  if (ManagerAccountV1_5_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerAccountV1_5_5;
  ManagerAccountV1_5_5->ManagerAccount = ManagerAccountV1_5_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerAccount_V1_5_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerAccount_V1_5_5_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_5_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerAccount_V1_5_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerAccountV1_5_5 = (EFI_REDFISH_MANAGERACCOUNT_V1_5_5 *)InterpProp;
  DestroyManagerAccount_V1_5_5_CS (ManagerAccountV1_5_5->ManagerAccount); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerAccount_V1_5_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_5_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_5_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
