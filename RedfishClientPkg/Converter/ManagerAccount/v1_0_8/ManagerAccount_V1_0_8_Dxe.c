...
//
#include <RedfishJsonStructure/ManagerAccount/v1_0_8/EfiManagerAccountV1_0_8.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_0_8
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_0_8 *ManagerAccountV1_0_8;
  EFI_REDFISH_MANAGERACCOUNT_V1_0_8_CS *ManagerAccountV1_0_8Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerAccount_V1_0_8_To_CS (ResoruceRaw, &ManagerAccountV1_0_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_0_8 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_0_8));
  if (ManagerAccountV1_0_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerAccountV1_0_8;
  ManagerAccountV1_0_8->ManagerAccount = ManagerAccountV1_0_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerAccount_V1_0_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerAccount_V1_0_8_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerAccount_V1_0_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerAccountV1_0_8 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_8 *)InterpProp;
  DestroyManagerAccount_V1_0_8_CS (ManagerAccountV1_0_8->ManagerAccount); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerAccount_V1_0_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_8EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_8Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
