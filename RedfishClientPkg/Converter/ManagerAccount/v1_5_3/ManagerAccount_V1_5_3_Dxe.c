...
//
#include <RedfishJsonStructure/ManagerAccount/v1_5_3/EfiManagerAccountV1_5_3.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_5_3
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_5_3 *ManagerAccountV1_5_3;
  EFI_REDFISH_MANAGERACCOUNT_V1_5_3_CS *ManagerAccountV1_5_3Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerAccount_V1_5_3_To_CS (ResoruceRaw, &ManagerAccountV1_5_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_5_3 = (EFI_REDFISH_MANAGERACCOUNT_V1_5_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_5_3));
  if (ManagerAccountV1_5_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerAccountV1_5_3;
  ManagerAccountV1_5_3->ManagerAccount = ManagerAccountV1_5_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerAccount_V1_5_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerAccount_V1_5_3_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_5_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerAccount_V1_5_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerAccountV1_5_3 = (EFI_REDFISH_MANAGERACCOUNT_V1_5_3 *)InterpProp;
  DestroyManagerAccount_V1_5_3_CS (ManagerAccountV1_5_3->ManagerAccount); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerAccount_V1_5_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_5_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_5_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
