...
//
#include <RedfishJsonStructure/ManagerAccount/v1_0_11/EfiManagerAccountV1_0_11.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_0_11
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_0_11 *ManagerAccountV1_0_11;
  EFI_REDFISH_MANAGERACCOUNT_V1_0_11_CS *ManagerAccountV1_0_11Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerAccount_V1_0_11_To_CS (ResoruceRaw, &ManagerAccountV1_0_11Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_0_11 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_11 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_0_11));
  if (ManagerAccountV1_0_11 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerAccountV1_0_11;
  ManagerAccountV1_0_11->ManagerAccount = ManagerAccountV1_0_11Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerAccount_V1_0_11_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerAccount_V1_0_11_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_0_11_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerAccount_V1_0_11_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerAccountV1_0_11 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_11 *)InterpProp;
  DestroyManagerAccount_V1_0_11_CS (ManagerAccountV1_0_11->ManagerAccount); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerAccount_V1_0_11_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_11EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_11Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
