...
//
#include <RedfishJsonStructure/ManagerAccount/v1_2_0/EfiManagerAccountV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_2_0
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_2_0 *ManagerAccountV1_2_0;
  EFI_REDFISH_MANAGERACCOUNT_V1_2_0_CS *ManagerAccountV1_2_0Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerAccount_V1_2_0_To_CS (ResoruceRaw, &ManagerAccountV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_2_0 = (EFI_REDFISH_MANAGERACCOUNT_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_2_0));
  if (ManagerAccountV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerAccountV1_2_0;
  ManagerAccountV1_2_0->ManagerAccount = ManagerAccountV1_2_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerAccount_V1_2_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerAccount_V1_2_0_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerAccount_V1_2_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerAccountV1_2_0 = (EFI_REDFISH_MANAGERACCOUNT_V1_2_0 *)InterpProp;
  DestroyManagerAccount_V1_2_0_CS (ManagerAccountV1_2_0->ManagerAccount); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerAccount_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_2_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_2_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
