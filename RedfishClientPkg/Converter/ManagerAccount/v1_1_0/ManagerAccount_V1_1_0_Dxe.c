...
)
{
  ...
  return (EFI_STATUS)CS_To_ManagerAccount_V1_1_0_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
