...
//
#include <RedfishJsonStructure/ManagerAccount/v1_4_1/EfiManagerAccountV1_4_1.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_4_1
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_4_1 *ManagerAccountV1_4_1;
  EFI_REDFISH_MANAGERACCOUNT_V1_4_1_CS *ManagerAccountV1_4_1Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerAccount_V1_4_1_To_CS (ResoruceRaw, &ManagerAccountV1_4_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_4_1 = (EFI_REDFISH_MANAGERACCOUNT_V1_4_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_4_1));
  if (ManagerAccountV1_4_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerAccountV1_4_1;
  ManagerAccountV1_4_1->ManagerAccount = ManagerAccountV1_4_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerAccount_V1_4_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerAccount_V1_4_1_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_4_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerAccount_V1_4_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerAccountV1_4_1 = (EFI_REDFISH_MANAGERACCOUNT_V1_4_1 *)InterpProp;
  DestroyManagerAccount_V1_4_1_CS (ManagerAccountV1_4_1->ManagerAccount); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerAccount_V1_4_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_4_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_4_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
