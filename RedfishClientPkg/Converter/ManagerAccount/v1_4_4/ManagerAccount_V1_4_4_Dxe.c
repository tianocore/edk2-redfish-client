...
//
#include <RedfishJsonStructure/ManagerAccount/v1_4_4/EfiManagerAccountV1_4_4.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_4_4
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_4_4 *ManagerAccountV1_4_4;
  EFI_REDFISH_MANAGERACCOUNT_V1_4_4_CS *ManagerAccountV1_4_4Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerAccount_V1_4_4_To_CS (ResoruceRaw, &ManagerAccountV1_4_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_4_4 = (EFI_REDFISH_MANAGERACCOUNT_V1_4_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_4_4));
  if (ManagerAccountV1_4_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerAccountV1_4_4;
  ManagerAccountV1_4_4->ManagerAccount = ManagerAccountV1_4_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerAccount_V1_4_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerAccount_V1_4_4_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_4_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerAccount_V1_4_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerAccountV1_4_4 = (EFI_REDFISH_MANAGERACCOUNT_V1_4_4 *)InterpProp;
  DestroyManagerAccount_V1_4_4_CS (ManagerAccountV1_4_4->ManagerAccount); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerAccount_V1_4_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_4_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_4_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
