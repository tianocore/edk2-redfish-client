...
//
#include <RedfishJsonStructure/ManagerAccount/v1_0_9/EfiManagerAccountV1_0_9.h>
CHAR8 mResourceTypeStr [] = "#ManagerAccount";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerAccount V1_0_9
...
{
  EFI_REDFISH_MANAGERACCOUNT_V1_0_9 *ManagerAccountV1_0_9;
  EFI_REDFISH_MANAGERACCOUNT_V1_0_9_CS *ManagerAccountV1_0_9Cs;
  ...
  Status = (EFI_STATUS)Json_ManagerAccount_V1_0_9_To_CS (ResoruceRaw, &ManagerAccountV1_0_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerAccountV1_0_9 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERACCOUNT_V1_0_9));
  if (ManagerAccountV1_0_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerAccountV1_0_9;
  ManagerAccountV1_0_9->ManagerAccount = ManagerAccountV1_0_9Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerAccount_V1_0_9_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerAccount_V1_0_9_JSON (*((EFI_REDFISH_MANAGERACCOUNT_V1_0_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerAccount_V1_0_9_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerAccountV1_0_9 = (EFI_REDFISH_MANAGERACCOUNT_V1_0_9 *)InterpProp;
  DestroyManagerAccount_V1_0_9_CS (ManagerAccountV1_0_9->ManagerAccount); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerAccount_V1_0_9_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_9EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerAccount_V1_0_9Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
