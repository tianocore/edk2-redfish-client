...
//
#include <RedfishJsonStructure/MessageRegistry/v1_0_7/EfiMessageRegistryV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistry V1_0_7
...
{
  EFI_REDFISH_MESSAGEREGISTRY_V1_0_7 *MessageRegistryV1_0_7;
  EFI_REDFISH_MESSAGEREGISTRY_V1_0_7_CS *MessageRegistryV1_0_7Cs;
  ...
  Status = (EFI_STATUS)Json_MessageRegistry_V1_0_7_To_CS (ResoruceRaw, &MessageRegistryV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryV1_0_7 = (EFI_REDFISH_MESSAGEREGISTRY_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_0_7));
  if (MessageRegistryV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MessageRegistryV1_0_7;
  MessageRegistryV1_0_7->MessageRegistry = MessageRegistryV1_0_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MessageRegistry_V1_0_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MessageRegistry_V1_0_7_JSON (*((EFI_REDFISH_MESSAGEREGISTRY_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MessageRegistry_V1_0_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MessageRegistryV1_0_7 = (EFI_REDFISH_MESSAGEREGISTRY_V1_0_7 *)InterpProp;
  DestroyMessageRegistry_V1_0_7_CS (MessageRegistryV1_0_7->MessageRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMessageRegistry_V1_0_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_0_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_0_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
