...
//
#include <RedfishJsonStructure/MessageRegistry/v1_4_1/EfiMessageRegistryV1_4_1.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistry V1_4_1
...
{
  EFI_REDFISH_MESSAGEREGISTRY_V1_4_1 *MessageRegistryV1_4_1;
  EFI_REDFISH_MESSAGEREGISTRY_V1_4_1_CS *MessageRegistryV1_4_1Cs;
  ...
  Status = (EFI_STATUS)Json_MessageRegistry_V1_4_1_To_CS (ResoruceRaw, &MessageRegistryV1_4_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryV1_4_1 = (EFI_REDFISH_MESSAGEREGISTRY_V1_4_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_4_1));
  if (MessageRegistryV1_4_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MessageRegistryV1_4_1;
  MessageRegistryV1_4_1->MessageRegistry = MessageRegistryV1_4_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MessageRegistry_V1_4_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MessageRegistry_V1_4_1_JSON (*((EFI_REDFISH_MESSAGEREGISTRY_V1_4_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MessageRegistry_V1_4_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MessageRegistryV1_4_1 = (EFI_REDFISH_MESSAGEREGISTRY_V1_4_1 *)InterpProp;
  DestroyMessageRegistry_V1_4_1_CS (MessageRegistryV1_4_1->MessageRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMessageRegistry_V1_4_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_4_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_4_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
