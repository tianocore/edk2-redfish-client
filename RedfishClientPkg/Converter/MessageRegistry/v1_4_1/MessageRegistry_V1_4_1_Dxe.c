...
)
{
  ...
  return (EFI_STATUS)CS_To_MessageRegistry_V1_4_1_JSON (*((EFI_REDFISH_MESSAGEREGISTRY_V1_4_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
