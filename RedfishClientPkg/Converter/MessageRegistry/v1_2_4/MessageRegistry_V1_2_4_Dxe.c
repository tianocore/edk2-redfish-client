...
//
#include <RedfishJsonStructure/MessageRegistry/v1_2_4/EfiMessageRegistryV1_2_4.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistry V1_2_4
...
{
  EFI_REDFISH_MESSAGEREGISTRY_V1_2_4 *MessageRegistryV1_2_4;
  EFI_REDFISH_MESSAGEREGISTRY_V1_2_4_CS *MessageRegistryV1_2_4Cs;
  ...
  Status = (EFI_STATUS)Json_MessageRegistry_V1_2_4_To_CS (ResoruceRaw, &MessageRegistryV1_2_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryV1_2_4 = (EFI_REDFISH_MESSAGEREGISTRY_V1_2_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_2_4));
  if (MessageRegistryV1_2_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MessageRegistryV1_2_4;
  MessageRegistryV1_2_4->MessageRegistry = MessageRegistryV1_2_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MessageRegistry_V1_2_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MessageRegistry_V1_2_4_JSON (*((EFI_REDFISH_MESSAGEREGISTRY_V1_2_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MessageRegistry_V1_2_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MessageRegistryV1_2_4 = (EFI_REDFISH_MESSAGEREGISTRY_V1_2_4 *)InterpProp;
  DestroyMessageRegistry_V1_2_4_CS (MessageRegistryV1_2_4->MessageRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMessageRegistry_V1_2_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_2_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_2_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
