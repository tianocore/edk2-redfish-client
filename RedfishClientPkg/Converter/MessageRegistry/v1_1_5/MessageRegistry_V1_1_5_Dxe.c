...
//
#include <RedfishJsonStructure/MessageRegistry/v1_1_5/EfiMessageRegistryV1_1_5.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistry V1_1_5
...
{
  EFI_REDFISH_MESSAGEREGISTRY_V1_1_5 *MessageRegistryV1_1_5;
  EFI_REDFISH_MESSAGEREGISTRY_V1_1_5_CS *MessageRegistryV1_1_5Cs;
  ...
  Status = (EFI_STATUS)Json_MessageRegistry_V1_1_5_To_CS (ResoruceRaw, &MessageRegistryV1_1_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryV1_1_5 = (EFI_REDFISH_MESSAGEREGISTRY_V1_1_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_1_5));
  if (MessageRegistryV1_1_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MessageRegistryV1_1_5;
  MessageRegistryV1_1_5->MessageRegistry = MessageRegistryV1_1_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MessageRegistry_V1_1_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MessageRegistry_V1_1_5_JSON (*((EFI_REDFISH_MESSAGEREGISTRY_V1_1_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MessageRegistry_V1_1_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MessageRegistryV1_1_5 = (EFI_REDFISH_MESSAGEREGISTRY_V1_1_5 *)InterpProp;
  DestroyMessageRegistry_V1_1_5_CS (MessageRegistryV1_1_5->MessageRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMessageRegistry_V1_1_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_1_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_1_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
