...
//
#include <RedfishJsonStructure/MessageRegistry/v1_4_0/EfiMessageRegistryV1_4_0.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistry V1_4_0
...
{
  EFI_REDFISH_MESSAGEREGISTRY_V1_4_0 *MessageRegistryV1_4_0;
  EFI_REDFISH_MESSAGEREGISTRY_V1_4_0_CS *MessageRegistryV1_4_0Cs;
  ...
  Status = (EFI_STATUS)Json_MessageRegistry_V1_4_0_To_CS (ResoruceRaw, &MessageRegistryV1_4_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryV1_4_0 = (EFI_REDFISH_MESSAGEREGISTRY_V1_4_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_4_0));
  if (MessageRegistryV1_4_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MessageRegistryV1_4_0;
  MessageRegistryV1_4_0->MessageRegistry = MessageRegistryV1_4_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MessageRegistry_V1_4_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MessageRegistry_V1_4_0_JSON (*((EFI_REDFISH_MESSAGEREGISTRY_V1_4_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MessageRegistry_V1_4_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MessageRegistryV1_4_0 = (EFI_REDFISH_MESSAGEREGISTRY_V1_4_0 *)InterpProp;
  DestroyMessageRegistry_V1_4_0_CS (MessageRegistryV1_4_0->MessageRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMessageRegistry_V1_4_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_4_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_4_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
