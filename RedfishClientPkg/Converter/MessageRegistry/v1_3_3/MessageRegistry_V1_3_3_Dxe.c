...
//
#include <RedfishJsonStructure/MessageRegistry/v1_3_3/EfiMessageRegistryV1_3_3.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistry V1_3_3
...
{
  EFI_REDFISH_MESSAGEREGISTRY_V1_3_3 *MessageRegistryV1_3_3;
  EFI_REDFISH_MESSAGEREGISTRY_V1_3_3_CS *MessageRegistryV1_3_3Cs;
  ...
  Status = (EFI_STATUS)Json_MessageRegistry_V1_3_3_To_CS (ResoruceRaw, &MessageRegistryV1_3_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryV1_3_3 = (EFI_REDFISH_MESSAGEREGISTRY_V1_3_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_3_3));
  if (MessageRegistryV1_3_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MessageRegistryV1_3_3;
  MessageRegistryV1_3_3->MessageRegistry = MessageRegistryV1_3_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MessageRegistry_V1_3_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MessageRegistry_V1_3_3_JSON (*((EFI_REDFISH_MESSAGEREGISTRY_V1_3_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MessageRegistry_V1_3_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MessageRegistryV1_3_3 = (EFI_REDFISH_MESSAGEREGISTRY_V1_3_3 *)InterpProp;
  DestroyMessageRegistry_V1_3_3_CS (MessageRegistryV1_3_3->MessageRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMessageRegistry_V1_3_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_3_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_3_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
