...
//
#include <RedfishJsonStructure/MessageRegistry/v1_0_10/EfiMessageRegistryV1_0_10.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistry V1_0_10
...
{
  EFI_REDFISH_MESSAGEREGISTRY_V1_0_10 *MessageRegistryV1_0_10;
  EFI_REDFISH_MESSAGEREGISTRY_V1_0_10_CS *MessageRegistryV1_0_10Cs;
  ...
  Status = (EFI_STATUS)Json_MessageRegistry_V1_0_10_To_CS (ResoruceRaw, &MessageRegistryV1_0_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryV1_0_10 = (EFI_REDFISH_MESSAGEREGISTRY_V1_0_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_0_10));
  if (MessageRegistryV1_0_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MessageRegistryV1_0_10;
  MessageRegistryV1_0_10->MessageRegistry = MessageRegistryV1_0_10Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("MessageRegistry"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("MessageRegistry"), "MessageRegistry");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("MessageRegistry"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("MessageRegistry"), "MessageRegistry");
...
/**
  The wrapper function of MessageRegistryToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
MessageRegistryToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return MessageRegistryToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MessageRegistry_V1_0_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MessageRegistry_V1_0_10_JSON (*((EFI_REDFISH_MESSAGEREGISTRY_V1_0_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MessageRegistry_V1_0_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MessageRegistryV1_0_10 = (EFI_REDFISH_MESSAGEREGISTRY_V1_0_10 *)InterpProp;
  DestroyMessageRegistry_V1_0_10_CS (MessageRegistryV1_0_10->MessageRegistry); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from MessageRegistryFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyMessageRegistry_V1_0_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_0_10EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_0_10Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
