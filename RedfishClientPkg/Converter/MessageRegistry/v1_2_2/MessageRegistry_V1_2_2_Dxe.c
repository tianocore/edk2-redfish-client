...
//
#include <RedfishJsonStructure/MessageRegistry/v1_2_2/EfiMessageRegistryV1_2_2.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistry V1_2_2
...
{
  EFI_REDFISH_MESSAGEREGISTRY_V1_2_2 *MessageRegistryV1_2_2;
  EFI_REDFISH_MESSAGEREGISTRY_V1_2_2_CS *MessageRegistryV1_2_2Cs;
  ...
  Status = (EFI_STATUS)Json_MessageRegistry_V1_2_2_To_CS (ResoruceRaw, &MessageRegistryV1_2_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryV1_2_2 = (EFI_REDFISH_MESSAGEREGISTRY_V1_2_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_2_2));
  if (MessageRegistryV1_2_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MessageRegistryV1_2_2;
  MessageRegistryV1_2_2->MessageRegistry = MessageRegistryV1_2_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MessageRegistry_V1_2_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MessageRegistry_V1_2_2_JSON (*((EFI_REDFISH_MESSAGEREGISTRY_V1_2_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MessageRegistry_V1_2_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MessageRegistryV1_2_2 = (EFI_REDFISH_MESSAGEREGISTRY_V1_2_2 *)InterpProp;
  DestroyMessageRegistry_V1_2_2_CS (MessageRegistryV1_2_2->MessageRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMessageRegistry_V1_2_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_2_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_2_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
