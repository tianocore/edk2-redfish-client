...
//
#include <RedfishJsonStructure/MessageRegistry/v1_4_2/EfiMessageRegistryV1_4_2.h>
CHAR8 mResourceTypeStr [] = "#MessageRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support MessageRegistry V1_4_2
...
{
  EFI_REDFISH_MESSAGEREGISTRY_V1_4_2 *MessageRegistryV1_4_2;
  EFI_REDFISH_MESSAGEREGISTRY_V1_4_2_CS *MessageRegistryV1_4_2Cs;
  ...
  Status = (EFI_STATUS)Json_MessageRegistry_V1_4_2_To_CS (ResoruceRaw, &MessageRegistryV1_4_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MessageRegistryV1_4_2 = (EFI_REDFISH_MESSAGEREGISTRY_V1_4_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MESSAGEREGISTRY_V1_4_2));
  if (MessageRegistryV1_4_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MessageRegistryV1_4_2;
  MessageRegistryV1_4_2->MessageRegistry = MessageRegistryV1_4_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MessageRegistry_V1_4_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MessageRegistry_V1_4_2_JSON (*((EFI_REDFISH_MESSAGEREGISTRY_V1_4_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MessageRegistry_V1_4_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MessageRegistryV1_4_2 = (EFI_REDFISH_MESSAGEREGISTRY_V1_4_2 *)InterpProp;
  DestroyMessageRegistry_V1_4_2_CS (MessageRegistryV1_4_2->MessageRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMessageRegistry_V1_4_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_4_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMessageRegistry_V1_4_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
