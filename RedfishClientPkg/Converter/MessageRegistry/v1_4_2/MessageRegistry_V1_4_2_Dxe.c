...
)
{
  ...
  return (EFI_STATUS)CS_To_MessageRegistry_V1_4_2_JSON (*((EFI_REDFISH_MESSAGEREGISTRY_V1_4_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
