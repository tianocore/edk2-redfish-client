...
//
#include <RedfishJsonStructure/HostInterface/v1_3_0/EfiHostInterfaceV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#HostInterface";
BOOLEAN IsRevisonController = TRUE;

// Support HostInterface V1_3_0
...
{
  EFI_REDFISH_HOSTINTERFACE_V1_3_0 *HostInterfaceV1_3_0;
  EFI_REDFISH_HOSTINTERFACE_V1_3_0_CS *HostInterfaceV1_3_0Cs;
  ...
  Status = (EFI_STATUS)Json_HostInterface_V1_3_0_To_CS (ResoruceRaw, &HostInterfaceV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  HostInterfaceV1_3_0 = (EFI_REDFISH_HOSTINTERFACE_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_HOSTINTERFACE_V1_3_0));
  if (HostInterfaceV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)HostInterfaceV1_3_0;
  HostInterfaceV1_3_0->HostInterface = HostInterfaceV1_3_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_HostInterface_V1_3_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_HostInterface_V1_3_0_JSON (*((EFI_REDFISH_HOSTINTERFACE_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_HostInterface_V1_3_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  HostInterfaceV1_3_0 = (EFI_REDFISH_HOSTINTERFACE_V1_3_0 *)InterpProp;
  DestroyHostInterface_V1_3_0_CS (HostInterfaceV1_3_0->HostInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyHostInterface_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_3_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_3_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
