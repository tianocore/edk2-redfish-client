...
//
#include <RedfishJsonStructure/HostInterface/v1_0_5/EfiHostInterfaceV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#HostInterface";
BOOLEAN IsRevisonController = TRUE;

// Support HostInterface V1_0_5
...
{
  EFI_REDFISH_HOSTINTERFACE_V1_0_5 *HostInterfaceV1_0_5;
  EFI_REDFISH_HOSTINTERFACE_V1_0_5_CS *HostInterfaceV1_0_5Cs;
  ...
  Status = (EFI_STATUS)Json_HostInterface_V1_0_5_To_CS (ResoruceRaw, &HostInterfaceV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  HostInterfaceV1_0_5 = (EFI_REDFISH_HOSTINTERFACE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_HOSTINTERFACE_V1_0_5));
  if (HostInterfaceV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)HostInterfaceV1_0_5;
  HostInterfaceV1_0_5->HostInterface = HostInterfaceV1_0_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_HostInterface_V1_0_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_HostInterface_V1_0_5_JSON (*((EFI_REDFISH_HOSTINTERFACE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_HostInterface_V1_0_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  HostInterfaceV1_0_5 = (EFI_REDFISH_HOSTINTERFACE_V1_0_5 *)InterpProp;
  DestroyHostInterface_V1_0_5_CS (HostInterfaceV1_0_5->HostInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyHostInterface_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
