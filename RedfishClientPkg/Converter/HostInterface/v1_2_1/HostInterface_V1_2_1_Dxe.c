...
//
#include <RedfishJsonStructure/HostInterface/v1_2_1/EfiHostInterfaceV1_2_1.h>
CHAR8 mResourceTypeStr [] = "#HostInterface";
BOOLEAN IsRevisonController = TRUE;

// Support HostInterface V1_2_1
...
{
  EFI_REDFISH_HOSTINTERFACE_V1_2_1 *HostInterfaceV1_2_1;
  EFI_REDFISH_HOSTINTERFACE_V1_2_1_CS *HostInterfaceV1_2_1Cs;
  ...
  Status = (EFI_STATUS)Json_HostInterface_V1_2_1_To_CS (ResoruceRaw, &HostInterfaceV1_2_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  HostInterfaceV1_2_1 = (EFI_REDFISH_HOSTINTERFACE_V1_2_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_HOSTINTERFACE_V1_2_1));
  if (HostInterfaceV1_2_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)HostInterfaceV1_2_1;
  HostInterfaceV1_2_1->HostInterface = HostInterfaceV1_2_1Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("HostInterface"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("HostInterface"), "HostInterface");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("HostInterface"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("HostInterface"), "HostInterface");
...
/**
  The wrapper function of HostInterfaceToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_HostInterface_V1_2_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_HostInterface_V1_2_1_JSON (*((EFI_REDFISH_HOSTINTERFACE_V1_2_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_HostInterface_V1_2_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  HostInterfaceV1_2_1 = (EFI_REDFISH_HOSTINTERFACE_V1_2_1 *)InterpProp;
  DestroyHostInterface_V1_2_1_CS (HostInterfaceV1_2_1->HostInterface); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from HostInterfaceFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyHostInterface_V1_2_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_2_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_2_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
