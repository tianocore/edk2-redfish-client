...
//
#include <RedfishJsonStructure/HostInterface/v1_2_2/EfiHostInterfaceV1_2_2.h>
CHAR8 mResourceTypeStr [] = "#HostInterface";
BOOLEAN IsRevisonController = TRUE;

// Support HostInterface V1_2_2
...
{
  EFI_REDFISH_HOSTINTERFACE_V1_2_2 *HostInterfaceV1_2_2;
  EFI_REDFISH_HOSTINTERFACE_V1_2_2_CS *HostInterfaceV1_2_2Cs;
  ...
  Status = (EFI_STATUS)Json_HostInterface_V1_2_2_To_CS (ResoruceRaw, &HostInterfaceV1_2_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  HostInterfaceV1_2_2 = (EFI_REDFISH_HOSTINTERFACE_V1_2_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_HOSTINTERFACE_V1_2_2));
  if (HostInterfaceV1_2_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)HostInterfaceV1_2_2;
  HostInterfaceV1_2_2->HostInterface = HostInterfaceV1_2_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_HostInterface_V1_2_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_HostInterface_V1_2_2_JSON (*((EFI_REDFISH_HOSTINTERFACE_V1_2_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_HostInterface_V1_2_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  HostInterfaceV1_2_2 = (EFI_REDFISH_HOSTINTERFACE_V1_2_2 *)InterpProp;
  DestroyHostInterface_V1_2_2_CS (HostInterfaceV1_2_2->HostInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyHostInterface_V1_2_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_2_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishHostInterface_V1_2_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
