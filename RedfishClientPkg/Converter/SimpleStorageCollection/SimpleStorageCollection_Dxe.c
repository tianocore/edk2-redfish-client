...
)
{
  ...
  return (EFI_STATUS)CS_To_SimpleStorageCollection_JSON (*((EFI_REDFISH_SIMPLESTORAGECOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
