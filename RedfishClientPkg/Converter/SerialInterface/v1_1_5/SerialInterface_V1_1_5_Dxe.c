...
)
{
  ...
  return (EFI_STATUS)CS_To_SerialInterface_V1_1_5_JSON (*((EFI_REDFISH_SERIALINTERFACE_V1_1_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
