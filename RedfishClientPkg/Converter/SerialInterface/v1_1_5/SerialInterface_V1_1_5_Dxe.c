...
//
#include <RedfishJsonStructure/SerialInterface/v1_1_5/EfiSerialInterfaceV1_1_5.h>
CHAR8 mResourceTypeStr [] = "#SerialInterface";
BOOLEAN IsRevisonController = TRUE;

// Support SerialInterface V1_1_5
...
{
  EFI_REDFISH_SERIALINTERFACE_V1_1_5 *SerialInterfaceV1_1_5;
  EFI_REDFISH_SERIALINTERFACE_V1_1_5_CS *SerialInterfaceV1_1_5Cs;
  ...
  Status = (EFI_STATUS)Json_SerialInterface_V1_1_5_To_CS (ResoruceRaw, &SerialInterfaceV1_1_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SerialInterfaceV1_1_5 = (EFI_REDFISH_SERIALINTERFACE_V1_1_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERIALINTERFACE_V1_1_5));
  if (SerialInterfaceV1_1_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SerialInterfaceV1_1_5;
  SerialInterfaceV1_1_5->SerialInterface = SerialInterfaceV1_1_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SerialInterface_V1_1_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SerialInterface_V1_1_5_JSON (*((EFI_REDFISH_SERIALINTERFACE_V1_1_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SerialInterface_V1_1_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SerialInterfaceV1_1_5 = (EFI_REDFISH_SERIALINTERFACE_V1_1_5 *)InterpProp;
  DestroySerialInterface_V1_1_5_CS (SerialInterfaceV1_1_5->SerialInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySerialInterface_V1_1_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_1_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_1_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
