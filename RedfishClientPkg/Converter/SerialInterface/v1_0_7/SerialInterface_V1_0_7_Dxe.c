...
//
#include <RedfishJsonStructure/SerialInterface/v1_0_7/EfiSerialInterfaceV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#SerialInterface";
BOOLEAN IsRevisonController = TRUE;

// Support SerialInterface V1_0_7
...
{
  EFI_REDFISH_SERIALINTERFACE_V1_0_7 *SerialInterfaceV1_0_7;
  EFI_REDFISH_SERIALINTERFACE_V1_0_7_CS *SerialInterfaceV1_0_7Cs;
  ...
  Status = (EFI_STATUS)Json_SerialInterface_V1_0_7_To_CS (ResoruceRaw, &SerialInterfaceV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SerialInterfaceV1_0_7 = (EFI_REDFISH_SERIALINTERFACE_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERIALINTERFACE_V1_0_7));
  if (SerialInterfaceV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SerialInterfaceV1_0_7;
  SerialInterfaceV1_0_7->SerialInterface = SerialInterfaceV1_0_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SerialInterface_V1_0_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SerialInterface_V1_0_7_JSON (*((EFI_REDFISH_SERIALINTERFACE_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SerialInterface_V1_0_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SerialInterfaceV1_0_7 = (EFI_REDFISH_SERIALINTERFACE_V1_0_7 *)InterpProp;
  DestroySerialInterface_V1_0_7_CS (SerialInterfaceV1_0_7->SerialInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySerialInterface_V1_0_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_0_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_0_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
