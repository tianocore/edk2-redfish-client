...
//
#include <RedfishJsonStructure/SerialInterface/v1_0_11/EfiSerialInterfaceV1_0_11.h>
CHAR8 mResourceTypeStr [] = "#SerialInterface";
BOOLEAN IsRevisonController = TRUE;

// Support SerialInterface V1_0_11
...
{
  EFI_REDFISH_SERIALINTERFACE_V1_0_11 *SerialInterfaceV1_0_11;
  EFI_REDFISH_SERIALINTERFACE_V1_0_11_CS *SerialInterfaceV1_0_11Cs;
  ...
  Status = (EFI_STATUS)Json_SerialInterface_V1_0_11_To_CS (ResoruceRaw, &SerialInterfaceV1_0_11Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SerialInterfaceV1_0_11 = (EFI_REDFISH_SERIALINTERFACE_V1_0_11 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERIALINTERFACE_V1_0_11));
  if (SerialInterfaceV1_0_11 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SerialInterfaceV1_0_11;
  SerialInterfaceV1_0_11->SerialInterface = SerialInterfaceV1_0_11Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SerialInterface_V1_0_11_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SerialInterface_V1_0_11_JSON (*((EFI_REDFISH_SERIALINTERFACE_V1_0_11_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SerialInterface_V1_0_11_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SerialInterfaceV1_0_11 = (EFI_REDFISH_SERIALINTERFACE_V1_0_11 *)InterpProp;
  DestroySerialInterface_V1_0_11_CS (SerialInterfaceV1_0_11->SerialInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySerialInterface_V1_0_11_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_0_11EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_0_11Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
