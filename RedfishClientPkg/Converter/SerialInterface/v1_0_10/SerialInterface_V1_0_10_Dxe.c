...
//
#include <RedfishJsonStructure/SerialInterface/v1_0_10/EfiSerialInterfaceV1_0_10.h>
CHAR8 mResourceTypeStr [] = "#SerialInterface";
BOOLEAN IsRevisonController = TRUE;

// Support SerialInterface V1_0_10
...
{
  EFI_REDFISH_SERIALINTERFACE_V1_0_10 *SerialInterfaceV1_0_10;
  EFI_REDFISH_SERIALINTERFACE_V1_0_10_CS *SerialInterfaceV1_0_10Cs;
  ...
  Status = (EFI_STATUS)Json_SerialInterface_V1_0_10_To_CS (ResoruceRaw, &SerialInterfaceV1_0_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SerialInterfaceV1_0_10 = (EFI_REDFISH_SERIALINTERFACE_V1_0_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERIALINTERFACE_V1_0_10));
  if (SerialInterfaceV1_0_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SerialInterfaceV1_0_10;
  SerialInterfaceV1_0_10->SerialInterface = SerialInterfaceV1_0_10Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("SerialInterface"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("SerialInterface"), "SerialInterface");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("SerialInterface"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("SerialInterface"), "SerialInterface");
...
/**
  The wrapper function of SerialInterfaceToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
SerialInterfaceToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return SerialInterfaceToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SerialInterface_V1_0_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SerialInterface_V1_0_10_JSON (*((EFI_REDFISH_SERIALINTERFACE_V1_0_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SerialInterface_V1_0_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SerialInterfaceV1_0_10 = (EFI_REDFISH_SERIALINTERFACE_V1_0_10 *)InterpProp;
  DestroySerialInterface_V1_0_10_CS (SerialInterfaceV1_0_10->SerialInterface); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from SerialInterfaceFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroySerialInterface_V1_0_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_0_10EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSerialInterface_V1_0_10Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
