/** @file 
  ...
  Redfish schema.
   - PowerDistributionMetrics.v1_1_0 
...
//
#include <RedfishJsonStructure/PowerDistributionMetrics/v1_1_0/EfiPowerDistributionMetricsV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#PowerDistributionMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support PowerDistributionMetrics V1_1_0
...
{
  EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_1_0 *PowerDistributionMetricsV1_1_0;
  EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_1_0_CS *PowerDistributionMetricsV1_1_0Cs;
  ...
  Status = (EFI_STATUS)Json_PowerDistributionMetrics_V1_1_0_To_CS (ResoruceRaw, &PowerDistributionMetricsV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerDistributionMetricsV1_1_0 = (EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_1_0));
  if (PowerDistributionMetricsV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerDistributionMetricsV1_1_0;
  PowerDistributionMetricsV1_1_0->PowerDistributionMetrics = PowerDistributionMetricsV1_1_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PowerDistributionMetrics_V1_1_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PowerDistributionMetrics_V1_1_0_JSON (*((EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PowerDistributionMetrics_V1_1_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerDistributionMetricsV1_1_0 = (EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_1_0 *)InterpProp;
  DestroyPowerDistributionMetrics_V1_1_0_CS (PowerDistributionMetricsV1_1_0->PowerDistributionMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPowerDistributionMetrics_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPowerDistributionMetrics_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPowerDistributionMetrics_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
