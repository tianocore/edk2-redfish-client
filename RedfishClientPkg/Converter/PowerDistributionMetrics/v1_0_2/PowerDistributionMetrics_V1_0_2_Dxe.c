/** @file 
  ...
  Redfish schema.
   - PowerDistributionMetrics.v1_0_2 
...
//
#include <RedfishJsonStructure/PowerDistributionMetrics/v1_0_2/EfiPowerDistributionMetricsV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#PowerDistributionMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support PowerDistributionMetrics V1_0_2
...
{
  EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_0_2 *PowerDistributionMetricsV1_0_2;
  EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_0_2_CS *PowerDistributionMetricsV1_0_2Cs;
  ...
  Status = (EFI_STATUS)Json_PowerDistributionMetrics_V1_0_2_To_CS (ResoruceRaw, &PowerDistributionMetricsV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerDistributionMetricsV1_0_2 = (EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_0_2));
  if (PowerDistributionMetricsV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerDistributionMetricsV1_0_2;
  PowerDistributionMetricsV1_0_2->PowerDistributionMetrics = PowerDistributionMetricsV1_0_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PowerDistributionMetrics_V1_0_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PowerDistributionMetrics_V1_0_2_JSON (*((EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PowerDistributionMetrics_V1_0_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerDistributionMetricsV1_0_2 = (EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_0_2 *)InterpProp;
  DestroyPowerDistributionMetrics_V1_0_2_CS (PowerDistributionMetricsV1_0_2->PowerDistributionMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPowerDistributionMetrics_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPowerDistributionMetrics_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPowerDistributionMetrics_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
