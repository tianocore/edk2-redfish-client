/** @file 
  ...
  Redfish schema.
   - PowerDistributionMetrics.v1_0_1 
...
//
#include <RedfishJsonStructure/PowerDistributionMetrics/v1_0_1/EfiPowerDistributionMetricsV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#PowerDistributionMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support PowerDistributionMetrics V1_0_1
...
EFI_STATUS
EFIAPI
PowerDistributionMetricsToStruct (
...
{
  EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_0_1 *PowerDistributionMetricsV1_0_1;
  EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_0_1_CS *PowerDistributionMetricsV1_0_1Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "PowerDistributionMetrics") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_PowerDistributionMetrics_V1_0_1_To_CS (ResoruceRaw, &PowerDistributionMetricsV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerDistributionMetricsV1_0_1 = (EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_0_1));
  if (PowerDistributionMetricsV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerDistributionMetricsV1_0_1;
  PowerDistributionMetricsV1_0_1->PowerDistributionMetrics = PowerDistributionMetricsV1_0_1Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("PowerDistributionMetrics"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("PowerDistributionMetrics"), "PowerDistributionMetrics");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("PowerDistributionMetrics"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("PowerDistributionMetrics"), "PowerDistributionMetrics");
...
/**
  The wrapper function of PowerDistributionMetricsToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
PowerDistributionMetricsToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return PowerDistributionMetricsToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
EFI_STATUS
EFIAPI
PowerDistributionMetricsToJson(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL *This,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PowerDistributionMetrics_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PowerDistributionMetrics_V1_0_1_JSON (*((EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PowerDistributionMetrics_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in PowerDistributionMetricsToStruct.
...
EFI_STATUS
EFIAPI
PowerDistributionMetricsDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  PowerDistributionMetricsV1_0_1 = (EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_0_1 *)InterpProp;
  DestroyPowerDistributionMetrics_V1_0_1_CS (PowerDistributionMetricsV1_0_1->PowerDistributionMetrics); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from PowerDistributionMetricsFromStruct
...
EFI_STATUS
EFIAPI
PowerDistributionMetricsDestoryJson(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL *This,
...
)
{
  ...
  return (EFI_STATUS)DestroyPowerDistributionMetrics_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPowerDistributionMetrics_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPowerDistributionMetrics_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
