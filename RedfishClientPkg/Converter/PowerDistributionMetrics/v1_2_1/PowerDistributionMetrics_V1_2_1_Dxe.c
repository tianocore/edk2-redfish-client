/** @file 
  ...
  Redfish schema.
   - PowerDistributionMetrics.v1_2_1 
...
//
#include <RedfishJsonStructure/PowerDistributionMetrics/v1_2_1/EfiPowerDistributionMetricsV1_2_1.h>
CHAR8 mResourceTypeStr [] = "#PowerDistributionMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support PowerDistributionMetrics V1_2_1
...
{
  EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_2_1 *PowerDistributionMetricsV1_2_1;
  EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_2_1_CS *PowerDistributionMetricsV1_2_1Cs;
  ...
  Status = (EFI_STATUS)Json_PowerDistributionMetrics_V1_2_1_To_CS (ResoruceRaw, &PowerDistributionMetricsV1_2_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerDistributionMetricsV1_2_1 = (EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_2_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_2_1));
  if (PowerDistributionMetricsV1_2_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerDistributionMetricsV1_2_1;
  PowerDistributionMetricsV1_2_1->PowerDistributionMetrics = PowerDistributionMetricsV1_2_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PowerDistributionMetrics_V1_2_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PowerDistributionMetrics_V1_2_1_JSON (*((EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_2_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PowerDistributionMetrics_V1_2_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerDistributionMetricsV1_2_1 = (EFI_REDFISH_POWERDISTRIBUTIONMETRICS_V1_2_1 *)InterpProp;
  DestroyPowerDistributionMetrics_V1_2_1_CS (PowerDistributionMetricsV1_2_1->PowerDistributionMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPowerDistributionMetrics_V1_2_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPowerDistributionMetrics_V1_2_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPowerDistributionMetrics_V1_2_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
