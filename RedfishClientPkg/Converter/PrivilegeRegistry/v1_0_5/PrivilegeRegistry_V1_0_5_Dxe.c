...
//
#include <RedfishJsonStructure/PrivilegeRegistry/v1_0_5/EfiPrivilegeRegistryV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#PrivilegeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support PrivilegeRegistry V1_0_5
...
{
  EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_5 *PrivilegeRegistryV1_0_5;
  EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_5_CS *PrivilegeRegistryV1_0_5Cs;
  ...
  Status = (EFI_STATUS)Json_PrivilegeRegistry_V1_0_5_To_CS (ResoruceRaw, &PrivilegeRegistryV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PrivilegeRegistryV1_0_5 = (EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_5));
  if (PrivilegeRegistryV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PrivilegeRegistryV1_0_5;
  PrivilegeRegistryV1_0_5->PrivilegeRegistry = PrivilegeRegistryV1_0_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PrivilegeRegistry_V1_0_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PrivilegeRegistry_V1_0_5_JSON (*((EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PrivilegeRegistry_V1_0_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PrivilegeRegistryV1_0_5 = (EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_5 *)InterpProp;
  DestroyPrivilegeRegistry_V1_0_5_CS (PrivilegeRegistryV1_0_5->PrivilegeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPrivilegeRegistry_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPrivilegeRegistry_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPrivilegeRegistry_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
