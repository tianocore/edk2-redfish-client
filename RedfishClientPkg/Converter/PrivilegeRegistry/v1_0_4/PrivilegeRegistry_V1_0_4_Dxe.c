...
//
#include <RedfishJsonStructure/PrivilegeRegistry/v1_0_4/EfiPrivilegeRegistryV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#PrivilegeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support PrivilegeRegistry V1_0_4
...
{
  EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_4 *PrivilegeRegistryV1_0_4;
  EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_4_CS *PrivilegeRegistryV1_0_4Cs;
  ...
  Status = (EFI_STATUS)Json_PrivilegeRegistry_V1_0_4_To_CS (ResoruceRaw, &PrivilegeRegistryV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PrivilegeRegistryV1_0_4 = (EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_4));
  if (PrivilegeRegistryV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PrivilegeRegistryV1_0_4;
  PrivilegeRegistryV1_0_4->PrivilegeRegistry = PrivilegeRegistryV1_0_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PrivilegeRegistry_V1_0_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PrivilegeRegistry_V1_0_4_JSON (*((EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PrivilegeRegistry_V1_0_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PrivilegeRegistryV1_0_4 = (EFI_REDFISH_PRIVILEGEREGISTRY_V1_0_4 *)InterpProp;
  DestroyPrivilegeRegistry_V1_0_4_CS (PrivilegeRegistryV1_0_4->PrivilegeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPrivilegeRegistry_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPrivilegeRegistry_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPrivilegeRegistry_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
