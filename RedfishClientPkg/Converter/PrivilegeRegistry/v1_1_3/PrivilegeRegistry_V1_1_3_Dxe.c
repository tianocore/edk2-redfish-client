...
//
#include <RedfishJsonStructure/PrivilegeRegistry/v1_1_3/EfiPrivilegeRegistryV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#PrivilegeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support PrivilegeRegistry V1_1_3
...
{
  EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_3 *PrivilegeRegistryV1_1_3;
  EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_3_CS *PrivilegeRegistryV1_1_3Cs;
  ...
  Status = (EFI_STATUS)Json_PrivilegeRegistry_V1_1_3_To_CS (ResoruceRaw, &PrivilegeRegistryV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PrivilegeRegistryV1_1_3 = (EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_3));
  if (PrivilegeRegistryV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PrivilegeRegistryV1_1_3;
  PrivilegeRegistryV1_1_3->PrivilegeRegistry = PrivilegeRegistryV1_1_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PrivilegeRegistry_V1_1_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PrivilegeRegistry_V1_1_3_JSON (*((EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PrivilegeRegistry_V1_1_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PrivilegeRegistryV1_1_3 = (EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_3 *)InterpProp;
  DestroyPrivilegeRegistry_V1_1_3_CS (PrivilegeRegistryV1_1_3->PrivilegeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPrivilegeRegistry_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPrivilegeRegistry_V1_1_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPrivilegeRegistry_V1_1_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
