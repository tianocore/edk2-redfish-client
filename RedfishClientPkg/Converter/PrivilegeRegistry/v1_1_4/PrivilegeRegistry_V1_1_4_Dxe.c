...
//
#include <RedfishJsonStructure/PrivilegeRegistry/v1_1_4/EfiPrivilegeRegistryV1_1_4.h>
CHAR8 mResourceTypeStr [] = "#PrivilegeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support PrivilegeRegistry V1_1_4
...
{
  EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_4 *PrivilegeRegistryV1_1_4;
  EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_4_CS *PrivilegeRegistryV1_1_4Cs;
  ...
  Status = (EFI_STATUS)Json_PrivilegeRegistry_V1_1_4_To_CS (ResoruceRaw, &PrivilegeRegistryV1_1_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PrivilegeRegistryV1_1_4 = (EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_4));
  if (PrivilegeRegistryV1_1_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PrivilegeRegistryV1_1_4;
  PrivilegeRegistryV1_1_4->PrivilegeRegistry = PrivilegeRegistryV1_1_4Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("PrivilegeRegistry"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("PrivilegeRegistry"), "PrivilegeRegistry");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("PrivilegeRegistry"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("PrivilegeRegistry"), "PrivilegeRegistry");
...
/**
  The wrapper function of PrivilegeRegistryToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
PrivilegeRegistryToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return PrivilegeRegistryToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PrivilegeRegistry_V1_1_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PrivilegeRegistry_V1_1_4_JSON (*((EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PrivilegeRegistry_V1_1_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PrivilegeRegistryV1_1_4 = (EFI_REDFISH_PRIVILEGEREGISTRY_V1_1_4 *)InterpProp;
  DestroyPrivilegeRegistry_V1_1_4_CS (PrivilegeRegistryV1_1_4->PrivilegeRegistry); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from PrivilegeRegistryFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyPrivilegeRegistry_V1_1_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPrivilegeRegistry_V1_1_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPrivilegeRegistry_V1_1_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
