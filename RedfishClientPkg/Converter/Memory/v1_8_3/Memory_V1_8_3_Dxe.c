...
//
#include <RedfishJsonStructure/Memory/v1_8_3/EfiMemoryV1_8_3.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_8_3
...
{
  EFI_REDFISH_MEMORY_V1_8_3 *MemoryV1_8_3;
  EFI_REDFISH_MEMORY_V1_8_3_CS *MemoryV1_8_3Cs;
  ...
  Status = (EFI_STATUS)Json_Memory_V1_8_3_To_CS (ResoruceRaw, &MemoryV1_8_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_8_3 = (EFI_REDFISH_MEMORY_V1_8_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_8_3));
  if (MemoryV1_8_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryV1_8_3;
  MemoryV1_8_3->Memory = MemoryV1_8_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Memory_V1_8_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Memory_V1_8_3_JSON (*((EFI_REDFISH_MEMORY_V1_8_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Memory_V1_8_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryV1_8_3 = (EFI_REDFISH_MEMORY_V1_8_3 *)InterpProp;
  DestroyMemory_V1_8_3_CS (MemoryV1_8_3->Memory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemory_V1_8_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_8_3EntryPoint (
