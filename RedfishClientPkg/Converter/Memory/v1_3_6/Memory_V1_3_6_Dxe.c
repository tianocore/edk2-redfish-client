...
//
#include <RedfishJsonStructure/Memory/v1_3_6/EfiMemoryV1_3_6.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_3_6
...
{
  EFI_REDFISH_MEMORY_V1_3_6 *MemoryV1_3_6;
  EFI_REDFISH_MEMORY_V1_3_6_CS *MemoryV1_3_6Cs;
  ...
  Status = (EFI_STATUS)Json_Memory_V1_3_6_To_CS (ResoruceRaw, &MemoryV1_3_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_3_6 = (EFI_REDFISH_MEMORY_V1_3_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_3_6));
  if (MemoryV1_3_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryV1_3_6;
  MemoryV1_3_6->Memory = MemoryV1_3_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Memory_V1_3_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Memory_V1_3_6_JSON (*((EFI_REDFISH_MEMORY_V1_3_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Memory_V1_3_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryV1_3_6 = (EFI_REDFISH_MEMORY_V1_3_6 *)InterpProp;
  DestroyMemory_V1_3_6_CS (MemoryV1_3_6->Memory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemory_V1_3_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_3_6EntryPoint (
