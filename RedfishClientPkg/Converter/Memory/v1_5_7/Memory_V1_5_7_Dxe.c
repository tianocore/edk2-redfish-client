...
//
#include <RedfishJsonStructure/Memory/v1_5_7/EfiMemoryV1_5_7.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_5_7
...
{
  EFI_REDFISH_MEMORY_V1_5_7 *MemoryV1_5_7;
  EFI_REDFISH_MEMORY_V1_5_7_CS *MemoryV1_5_7Cs;
  ...
  Status = (EFI_STATUS)Json_Memory_V1_5_7_To_CS (ResoruceRaw, &MemoryV1_5_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_5_7 = (EFI_REDFISH_MEMORY_V1_5_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_5_7));
  if (MemoryV1_5_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryV1_5_7;
  MemoryV1_5_7->Memory = MemoryV1_5_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Memory_V1_5_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Memory_V1_5_7_JSON (*((EFI_REDFISH_MEMORY_V1_5_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Memory_V1_5_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryV1_5_7 = (EFI_REDFISH_MEMORY_V1_5_7 *)InterpProp;
  DestroyMemory_V1_5_7_CS (MemoryV1_5_7->Memory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemory_V1_5_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_5_7EntryPoint (
