...
//
#include <RedfishJsonStructure/Memory/v1_13_1/EfiMemoryV1_13_1.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_13_1
...
{
  EFI_REDFISH_MEMORY_V1_13_1 *MemoryV1_13_1;
  EFI_REDFISH_MEMORY_V1_13_1_CS *MemoryV1_13_1Cs;
  ...
  Status = (EFI_STATUS)Json_Memory_V1_13_1_To_CS (ResoruceRaw, &MemoryV1_13_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_13_1 = (EFI_REDFISH_MEMORY_V1_13_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_13_1));
  if (MemoryV1_13_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryV1_13_1;
  MemoryV1_13_1->Memory = MemoryV1_13_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Memory_V1_13_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Memory_V1_13_1_JSON (*((EFI_REDFISH_MEMORY_V1_13_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Memory_V1_13_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryV1_13_1 = (EFI_REDFISH_MEMORY_V1_13_1 *)InterpProp;
  DestroyMemory_V1_13_1_CS (MemoryV1_13_1->Memory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemory_V1_13_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_13_1EntryPoint (
