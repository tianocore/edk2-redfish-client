...
//
#include <RedfishJsonStructure/Memory/v1_10_0/EfiMemoryV1_10_0.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_10_0
...
{
  EFI_REDFISH_MEMORY_V1_10_0 *MemoryV1_10_0;
  EFI_REDFISH_MEMORY_V1_10_0_CS *MemoryV1_10_0Cs;
  ...
  Status = (EFI_STATUS)Json_Memory_V1_10_0_To_CS (ResoruceRaw, &MemoryV1_10_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_10_0 = (EFI_REDFISH_MEMORY_V1_10_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_10_0));
  if (MemoryV1_10_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryV1_10_0;
  MemoryV1_10_0->Memory = MemoryV1_10_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Memory_V1_10_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Memory_V1_10_0_JSON (*((EFI_REDFISH_MEMORY_V1_10_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Memory_V1_10_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryV1_10_0 = (EFI_REDFISH_MEMORY_V1_10_0 *)InterpProp;
  DestroyMemory_V1_10_0_CS (MemoryV1_10_0->Memory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemory_V1_10_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_10_0EntryPoint (
