...
//
#include <RedfishJsonStructure/Memory/v1_0_11/EfiMemoryV1_0_11.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_0_11
...
{
  EFI_REDFISH_MEMORY_V1_0_11 *MemoryV1_0_11;
  EFI_REDFISH_MEMORY_V1_0_11_CS *MemoryV1_0_11Cs;
  ...
  Status = (EFI_STATUS)Json_Memory_V1_0_11_To_CS (ResoruceRaw, &MemoryV1_0_11Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_0_11 = (EFI_REDFISH_MEMORY_V1_0_11 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_0_11));
  if (MemoryV1_0_11 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryV1_0_11;
  MemoryV1_0_11->Memory = MemoryV1_0_11Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Memory_V1_0_11_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Memory_V1_0_11_JSON (*((EFI_REDFISH_MEMORY_V1_0_11_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Memory_V1_0_11_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryV1_0_11 = (EFI_REDFISH_MEMORY_V1_0_11 *)InterpProp;
  DestroyMemory_V1_0_11_CS (MemoryV1_0_11->Memory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemory_V1_0_11_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_0_11EntryPoint (
