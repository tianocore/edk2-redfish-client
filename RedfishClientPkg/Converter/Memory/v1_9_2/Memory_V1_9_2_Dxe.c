...
//
#include <RedfishJsonStructure/Memory/v1_9_2/EfiMemoryV1_9_2.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_9_2
...
{
  EFI_REDFISH_MEMORY_V1_9_2 *MemoryV1_9_2;
  EFI_REDFISH_MEMORY_V1_9_2_CS *MemoryV1_9_2Cs;
  ...
  Status = (EFI_STATUS)Json_Memory_V1_9_2_To_CS (ResoruceRaw, &MemoryV1_9_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_9_2 = (EFI_REDFISH_MEMORY_V1_9_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_9_2));
  if (MemoryV1_9_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryV1_9_2;
  MemoryV1_9_2->Memory = MemoryV1_9_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Memory_V1_9_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Memory_V1_9_2_JSON (*((EFI_REDFISH_MEMORY_V1_9_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Memory_V1_9_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryV1_9_2 = (EFI_REDFISH_MEMORY_V1_9_2 *)InterpProp;
  DestroyMemory_V1_9_2_CS (MemoryV1_9_2->Memory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemory_V1_9_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_9_2EntryPoint (
