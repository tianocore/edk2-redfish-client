...
//
#include <RedfishJsonStructure/Memory/v1_7_3/EfiMemoryV1_7_3.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_7_3
...
{
  EFI_REDFISH_MEMORY_V1_7_3 *MemoryV1_7_3;
  EFI_REDFISH_MEMORY_V1_7_3_CS *MemoryV1_7_3Cs;
  ...
  Status = (EFI_STATUS)Json_Memory_V1_7_3_To_CS (ResoruceRaw, &MemoryV1_7_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_7_3 = (EFI_REDFISH_MEMORY_V1_7_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_7_3));
  if (MemoryV1_7_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryV1_7_3;
  MemoryV1_7_3->Memory = MemoryV1_7_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Memory_V1_7_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Memory_V1_7_3_JSON (*((EFI_REDFISH_MEMORY_V1_7_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Memory_V1_7_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryV1_7_3 = (EFI_REDFISH_MEMORY_V1_7_3 *)InterpProp;
  DestroyMemory_V1_7_3_CS (MemoryV1_7_3->Memory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemory_V1_7_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_7_3EntryPoint (
