...
//
#include <RedfishJsonStructure/Memory/v1_7_2/EfiMemoryV1_7_2.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_7_2
...
{
  EFI_REDFISH_MEMORY_V1_7_2 *MemoryV1_7_2;
  EFI_REDFISH_MEMORY_V1_7_2_CS *MemoryV1_7_2Cs;
  ...
  Status = (EFI_STATUS)Json_Memory_V1_7_2_To_CS (ResoruceRaw, &MemoryV1_7_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_7_2 = (EFI_REDFISH_MEMORY_V1_7_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_7_2));
  if (MemoryV1_7_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryV1_7_2;
  MemoryV1_7_2->Memory = MemoryV1_7_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Memory_V1_7_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Memory_V1_7_2_JSON (*((EFI_REDFISH_MEMORY_V1_7_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Memory_V1_7_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryV1_7_2 = (EFI_REDFISH_MEMORY_V1_7_2 *)InterpProp;
  DestroyMemory_V1_7_2_CS (MemoryV1_7_2->Memory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemory_V1_7_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_7_2EntryPoint (
