...
//
#include <RedfishJsonStructure/Memory/v1_1_10/EfiMemoryV1_1_10.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_1_10
...
{
  EFI_REDFISH_MEMORY_V1_1_10 *MemoryV1_1_10;
  EFI_REDFISH_MEMORY_V1_1_10_CS *MemoryV1_1_10Cs;
  ...
  Status = (EFI_STATUS)Json_Memory_V1_1_10_To_CS (ResoruceRaw, &MemoryV1_1_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_1_10 = (EFI_REDFISH_MEMORY_V1_1_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_1_10));
  if (MemoryV1_1_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryV1_1_10;
  MemoryV1_1_10->Memory = MemoryV1_1_10Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Memory_V1_1_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Memory_V1_1_10_JSON (*((EFI_REDFISH_MEMORY_V1_1_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Memory_V1_1_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryV1_1_10 = (EFI_REDFISH_MEMORY_V1_1_10 *)InterpProp;
  DestroyMemory_V1_1_10_CS (MemoryV1_1_10->Memory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemory_V1_1_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_1_10EntryPoint (
