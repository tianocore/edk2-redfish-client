...
//
#include <RedfishJsonStructure/Memory/v1_0_10/EfiMemoryV1_0_10.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_0_10
...
{
  EFI_REDFISH_MEMORY_V1_0_10 *MemoryV1_0_10;
  EFI_REDFISH_MEMORY_V1_0_10_CS *MemoryV1_0_10Cs;
  ...
  Status = (EFI_STATUS)Json_Memory_V1_0_10_To_CS (ResoruceRaw, &MemoryV1_0_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_0_10 = (EFI_REDFISH_MEMORY_V1_0_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_0_10));
  if (MemoryV1_0_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryV1_0_10;
  MemoryV1_0_10->Memory = MemoryV1_0_10Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Memory"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("Memory"), "Memory");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Memory"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("Memory"), "Memory");
...
/**
  The wrapper function of MemoryToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Memory_V1_0_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Memory_V1_0_10_JSON (*((EFI_REDFISH_MEMORY_V1_0_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Memory_V1_0_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryV1_0_10 = (EFI_REDFISH_MEMORY_V1_0_10 *)InterpProp;
  DestroyMemory_V1_0_10_CS (MemoryV1_0_10->Memory); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from MemoryFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyMemory_V1_0_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_0_10EntryPoint (
