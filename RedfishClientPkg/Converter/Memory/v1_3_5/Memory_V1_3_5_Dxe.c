...
//
#include <RedfishJsonStructure/Memory/v1_3_5/EfiMemoryV1_3_5.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_3_5
...
{
  EFI_REDFISH_MEMORY_V1_3_5 *MemoryV1_3_5;
  EFI_REDFISH_MEMORY_V1_3_5_CS *MemoryV1_3_5Cs;
  ...
  Status = (EFI_STATUS)Json_Memory_V1_3_5_To_CS (ResoruceRaw, &MemoryV1_3_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_3_5 = (EFI_REDFISH_MEMORY_V1_3_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_3_5));
  if (MemoryV1_3_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryV1_3_5;
  MemoryV1_3_5->Memory = MemoryV1_3_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Memory_V1_3_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Memory_V1_3_5_JSON (*((EFI_REDFISH_MEMORY_V1_3_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Memory_V1_3_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryV1_3_5 = (EFI_REDFISH_MEMORY_V1_3_5 *)InterpProp;
  DestroyMemory_V1_3_5_CS (MemoryV1_3_5->Memory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemory_V1_3_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_3_5EntryPoint (
