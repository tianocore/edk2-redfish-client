...
{
  EFI_REDFISH_MEMORY_V1_7_1 *MemoryV1_7_1;
  EFI_REDFISH_MEMORY_V1_7_1_CS *MemoryV1_7_1Cs;
  ...
  Status = (EFI_STATUS)Json_Memory_V1_7_1_To_CS (ResoruceRaw, &MemoryV1_7_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_7_1 = (EFI_REDFISH_MEMORY_V1_7_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_7_1));
  if (MemoryV1_7_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryV1_7_1;
  MemoryV1_7_1->Memory = MemoryV1_7_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Memory_V1_7_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Memory_V1_7_1_JSON (*((EFI_REDFISH_MEMORY_V1_7_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Memory_V1_7_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryV1_7_1 = (EFI_REDFISH_MEMORY_V1_7_1 *)InterpProp;
  DestroyMemory_V1_7_1_CS (MemoryV1_7_1->Memory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemory_V1_7_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_7_1EntryPoint (
