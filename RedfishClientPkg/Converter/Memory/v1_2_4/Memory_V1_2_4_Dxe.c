...
//
#include <RedfishJsonStructure/Memory/v1_2_4/EfiMemoryV1_2_4.h>
CHAR8 mResourceTypeStr [] = "#Memory";
BOOLEAN IsRevisonController = TRUE;

// Support Memory V1_2_4
...
{
  EFI_REDFISH_MEMORY_V1_2_4 *MemoryV1_2_4;
  EFI_REDFISH_MEMORY_V1_2_4_CS *MemoryV1_2_4Cs;
  ...
  Status = (EFI_STATUS)Json_Memory_V1_2_4_To_CS (ResoruceRaw, &MemoryV1_2_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryV1_2_4 = (EFI_REDFISH_MEMORY_V1_2_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORY_V1_2_4));
  if (MemoryV1_2_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryV1_2_4;
  MemoryV1_2_4->Memory = MemoryV1_2_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Memory_V1_2_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Memory_V1_2_4_JSON (*((EFI_REDFISH_MEMORY_V1_2_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Memory_V1_2_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryV1_2_4 = (EFI_REDFISH_MEMORY_V1_2_4 *)InterpProp;
  DestroyMemory_V1_2_4_CS (MemoryV1_2_4->Memory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemory_V1_2_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemory_V1_2_4EntryPoint (
