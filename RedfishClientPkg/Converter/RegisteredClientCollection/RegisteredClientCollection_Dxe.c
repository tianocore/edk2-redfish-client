...
)
{
  ...
  return (EFI_STATUS)CS_To_RegisteredClientCollection_JSON (*((EFI_REDFISH_REGISTEREDCLIENTCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
