...
)
{
  ...
  return (EFI_STATUS)CS_To_VirtualMediaCollection_JSON (*((EFI_REDFISH_VIRTUALMEDIACOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
