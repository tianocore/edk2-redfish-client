...
)
{
  ...
  return (EFI_STATUS)CS_To_PCIeDeviceCollection_JSON (*((EFI_REDFISH_PCIEDEVICECOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
