...
{
  EFI_REDFISH_BIOS_V1_2_0 *BiosV1_2_0;
  EFI_REDFISH_BIOS_V1_2_0_CS *BiosV1_2_0Cs;
  ...
  Status = (EFI_STATUS)Json_Bios_V1_2_0_To_CS (ResoruceRaw, &BiosV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  BiosV1_2_0 = (EFI_REDFISH_BIOS_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_BIOS_V1_2_0));
  if (BiosV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)BiosV1_2_0;
  BiosV1_2_0->Bios = BiosV1_2_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Bios_V1_2_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Bios_V1_2_0_JSON (*((EFI_REDFISH_BIOS_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Bios_V1_2_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  BiosV1_2_0 = (EFI_REDFISH_BIOS_V1_2_0 *)InterpProp;
  DestroyBios_V1_2_0_CS (BiosV1_2_0->Bios); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyBios_V1_2_0_Json (ResoruceRaw);
}
