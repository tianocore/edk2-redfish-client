...
//
#include <RedfishJsonStructure/Bios/v1_1_2/EfiBiosV1_1_2.h>
...
{
  EFI_REDFISH_BIOS_V1_1_2 *BiosV1_1_2;
  EFI_REDFISH_BIOS_V1_1_2_CS *BiosV1_1_2Cs;
  ...
  Status = (EFI_STATUS)Json_Bios_V1_1_2_To_CS (ResoruceRaw, &BiosV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  BiosV1_1_2 = (EFI_REDFISH_BIOS_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_BIOS_V1_1_2));
  if (BiosV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)BiosV1_1_2;
  BiosV1_1_2->Bios = BiosV1_1_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Bios_V1_1_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Bios_V1_1_2_JSON (*((EFI_REDFISH_BIOS_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Bios_V1_1_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  BiosV1_1_2 = (EFI_REDFISH_BIOS_V1_1_2 *)InterpProp;
  DestroyBios_V1_1_2_CS (BiosV1_1_2->Bios); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyBios_V1_1_2_Json (ResoruceRaw);
}
