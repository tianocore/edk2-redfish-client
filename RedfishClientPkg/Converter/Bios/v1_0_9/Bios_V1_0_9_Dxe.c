...
{
  EFI_REDFISH_BIOS_V1_0_9 *BiosV1_0_9;
  EFI_REDFISH_BIOS_V1_0_9_CS *BiosV1_0_9Cs;
  ...
  Status = (EFI_STATUS)Json_Bios_V1_0_9_To_CS (ResoruceRaw, &BiosV1_0_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  BiosV1_0_9 = (EFI_REDFISH_BIOS_V1_0_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_BIOS_V1_0_9));
  if (BiosV1_0_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)BiosV1_0_9;
  BiosV1_0_9->Bios = BiosV1_0_9Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Bios_V1_0_9_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Bios_V1_0_9_JSON (*((EFI_REDFISH_BIOS_V1_0_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Bios_V1_0_9_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  BiosV1_0_9 = (EFI_REDFISH_BIOS_V1_0_9 *)InterpProp;
  DestroyBios_V1_0_9_CS (BiosV1_0_9->Bios); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyBios_V1_0_9_Json (ResoruceRaw);
}
