...
//
#include <RedfishJsonStructure/Bios/v1_0_8/EfiBiosV1_0_8.h>
...
{
  EFI_REDFISH_BIOS_V1_0_8 *BiosV1_0_8;
  EFI_REDFISH_BIOS_V1_0_8_CS *BiosV1_0_8Cs;
  ...
  Status = (EFI_STATUS)Json_Bios_V1_0_8_To_CS (ResoruceRaw, &BiosV1_0_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  BiosV1_0_8 = (EFI_REDFISH_BIOS_V1_0_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_BIOS_V1_0_8));
  if (BiosV1_0_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)BiosV1_0_8;
  BiosV1_0_8->Bios = BiosV1_0_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Bios_V1_0_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Bios_V1_0_8_JSON (*((EFI_REDFISH_BIOS_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Bios_V1_0_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  BiosV1_0_8 = (EFI_REDFISH_BIOS_V1_0_8 *)InterpProp;
  DestroyBios_V1_0_8_CS (BiosV1_0_8->Bios); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyBios_V1_0_8_Json (ResoruceRaw);
}
