...
//
#include <RedfishJsonStructure/Processor/v1_5_2/EfiProcessorV1_5_2.h>
CHAR8 mResourceTypeStr [] = "#Processor";
BOOLEAN IsRevisonController = TRUE;

// Support Processor V1_5_2
...
{
  EFI_REDFISH_PROCESSOR_V1_5_2 *ProcessorV1_5_2;
  ...
  Status = (EFI_STATUS)Json_Processor_V1_5_2_To_CS (ResoruceRaw, &ProcessorV1_5_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_5_2 = (EFI_REDFISH_PROCESSOR_V1_5_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_5_2));
  if (ProcessorV1_5_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ProcessorV1_5_2;
  ProcessorV1_5_2->Processor = ProcessorV1_5_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Processor_V1_5_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Processor_V1_5_2_JSON (*((EFI_REDFISH_PROCESSOR_V1_5_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Processor_V1_5_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ProcessorV1_5_2 = (EFI_REDFISH_PROCESSOR_V1_5_2 *)InterpProp;
  DestroyProcessor_V1_5_2_CS (ProcessorV1_5_2->Processor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyProcessor_V1_5_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_5_2EntryPoint (
