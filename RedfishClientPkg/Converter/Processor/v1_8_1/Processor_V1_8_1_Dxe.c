...
//
#include <RedfishJsonStructure/Processor/v1_8_1/EfiProcessorV1_8_1.h>
CHAR8 mResourceTypeStr [] = "#Processor";
BOOLEAN IsRevisonController = TRUE;

// Support Processor V1_8_1
...
{
  EFI_REDFISH_PROCESSOR_V1_8_1 *ProcessorV1_8_1;
  EFI_REDFISH_PROCESSOR_V1_8_1_CS *ProcessorV1_8_1Cs;
  ...
  Status = (EFI_STATUS)Json_Processor_V1_8_1_To_CS (ResoruceRaw, &ProcessorV1_8_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_8_1 = (EFI_REDFISH_PROCESSOR_V1_8_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_8_1));
  if (ProcessorV1_8_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ProcessorV1_8_1;
  ProcessorV1_8_1->Processor = ProcessorV1_8_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Processor_V1_8_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Processor_V1_8_1_JSON (*((EFI_REDFISH_PROCESSOR_V1_8_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Processor_V1_8_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ProcessorV1_8_1 = (EFI_REDFISH_PROCESSOR_V1_8_1 *)InterpProp;
...
)
{
  ...
  return (EFI_STATUS)DestroyProcessor_V1_8_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_8_1EntryPoint (
