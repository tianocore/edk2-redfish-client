...
{
  EFI_REDFISH_PROCESSOR_V1_14_0 *ProcessorV1_14_0;
  EFI_REDFISH_PROCESSOR_V1_14_0_CS *ProcessorV1_14_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.MinorVersion, "14") != 0) ||
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ErrataVersion, "0") != 0) ||
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Processor") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_Processor_V1_14_0_To_CS (ResoruceRaw, &ProcessorV1_14_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_14_0 = (EFI_REDFISH_PROCESSOR_V1_14_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_14_0));
  if (ProcessorV1_14_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ProcessorV1_14_0;
  ProcessorV1_14_0->Processor = ProcessorV1_14_0Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "14";
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Processor_V1_14_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Processor_V1_14_0_JSON (*((EFI_REDFISH_PROCESSOR_V1_14_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Processor_V1_14_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ProcessorV1_14_0 = (EFI_REDFISH_PROCESSOR_V1_14_0 *)InterpProp;
  DestroyProcessor_V1_14_0_CS (ProcessorV1_14_0->Processor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyProcessor_V1_14_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_14_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_14_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
