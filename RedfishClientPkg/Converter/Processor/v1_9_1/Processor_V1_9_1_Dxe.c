...
//
#include <RedfishJsonStructure/Processor/v1_9_1/EfiProcessorV1_9_1.h>
CHAR8 mResourceTypeStr [] = "#Processor";
BOOLEAN IsRevisonController = TRUE;

// Support Processor V1_9_1
...
{
  EFI_REDFISH_PROCESSOR_V1_9_1 *ProcessorV1_9_1;
  EFI_REDFISH_PROCESSOR_V1_9_1_CS *ProcessorV1_9_1Cs;
  ...
  Status = (EFI_STATUS)Json_Processor_V1_9_1_To_CS (ResoruceRaw, &ProcessorV1_9_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_9_1 = (EFI_REDFISH_PROCESSOR_V1_9_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_9_1));
  if (ProcessorV1_9_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ProcessorV1_9_1;
  ProcessorV1_9_1->Processor = ProcessorV1_9_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Processor_V1_9_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Processor_V1_9_1_JSON (*((EFI_REDFISH_PROCESSOR_V1_9_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Processor_V1_9_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ProcessorV1_9_1 = (EFI_REDFISH_PROCESSOR_V1_9_1 *)InterpProp;
  DestroyProcessor_V1_9_1_CS (ProcessorV1_9_1->Processor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyProcessor_V1_9_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_9_1EntryPoint (
