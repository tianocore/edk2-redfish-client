...
//
#include <RedfishJsonStructure/Processor/v1_10_0/EfiProcessorV1_10_0.h>
CHAR8 mResourceTypeStr [] = "#Processor";
BOOLEAN IsRevisonController = TRUE;

// Support Processor V1_10_0
...
{
  EFI_REDFISH_PROCESSOR_V1_10_0 *ProcessorV1_10_0;
  EFI_REDFISH_PROCESSOR_V1_10_0_CS *ProcessorV1_10_0Cs;
  ...
  Status = (EFI_STATUS)Json_Processor_V1_10_0_To_CS (ResoruceRaw, &ProcessorV1_10_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_10_0 = (EFI_REDFISH_PROCESSOR_V1_10_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_10_0));
  if (ProcessorV1_10_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ProcessorV1_10_0;
  ProcessorV1_10_0->Processor = ProcessorV1_10_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Processor_V1_10_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Processor_V1_10_0_JSON (*((EFI_REDFISH_PROCESSOR_V1_10_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Processor_V1_10_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ProcessorV1_10_0 = (EFI_REDFISH_PROCESSOR_V1_10_0 *)InterpProp;
  DestroyProcessor_V1_10_0_CS (ProcessorV1_10_0->Processor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyProcessor_V1_10_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_10_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_10_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
