...
//
#include <RedfishJsonStructure/Processor/v1_0_11/EfiProcessorV1_0_11.h>
CHAR8 mResourceTypeStr [] = "#Processor";
BOOLEAN IsRevisonController = TRUE;

// Support Processor V1_0_11
...
{
  EFI_REDFISH_PROCESSOR_V1_0_11 *ProcessorV1_0_11;
  EFI_REDFISH_PROCESSOR_V1_0_11_CS *ProcessorV1_0_11Cs;
  ...
  Status = (EFI_STATUS)Json_Processor_V1_0_11_To_CS (ResoruceRaw, &ProcessorV1_0_11Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_0_11 = (EFI_REDFISH_PROCESSOR_V1_0_11 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_0_11));
  if (ProcessorV1_0_11 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ProcessorV1_0_11;
  ProcessorV1_0_11->Processor = ProcessorV1_0_11Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Processor"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("Processor"), "Processor");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Processor"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("Processor"), "Processor");
...
/**
  The wrapper function of ProcessorToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Processor_V1_0_11_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Processor_V1_0_11_JSON (*((EFI_REDFISH_PROCESSOR_V1_0_11_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Processor_V1_0_11_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ProcessorV1_0_11 = (EFI_REDFISH_PROCESSOR_V1_0_11 *)InterpProp;
  DestroyProcessor_V1_0_11_CS (ProcessorV1_0_11->Processor); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ProcessorFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyProcessor_V1_0_11_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_0_11EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_0_11Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
