...
//
#include <RedfishJsonStructure/Processor/v1_5_6/EfiProcessorV1_5_6.h>
CHAR8 mResourceTypeStr [] = "#Processor";
BOOLEAN IsRevisonController = TRUE;

// Support Processor V1_5_6
...
{
  EFI_REDFISH_PROCESSOR_V1_5_6 *ProcessorV1_5_6;
  EFI_REDFISH_PROCESSOR_V1_5_6_CS *ProcessorV1_5_6Cs;
  ...
  Status = (EFI_STATUS)Json_Processor_V1_5_6_To_CS (ResoruceRaw, &ProcessorV1_5_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_5_6 = (EFI_REDFISH_PROCESSOR_V1_5_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_5_6));
  if (ProcessorV1_5_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ProcessorV1_5_6;
  ProcessorV1_5_6->Processor = ProcessorV1_5_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Processor_V1_5_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Processor_V1_5_6_JSON (*((EFI_REDFISH_PROCESSOR_V1_5_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Processor_V1_5_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ProcessorV1_5_6 = (EFI_REDFISH_PROCESSOR_V1_5_6 *)InterpProp;
  DestroyProcessor_V1_5_6_CS (ProcessorV1_5_6->Processor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyProcessor_V1_5_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_5_6EntryPoint (
