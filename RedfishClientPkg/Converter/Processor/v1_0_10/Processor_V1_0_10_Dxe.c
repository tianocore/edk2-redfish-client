...
//
#include <RedfishJsonStructure/Processor/v1_0_10/EfiProcessorV1_0_10.h>
CHAR8 mResourceTypeStr [] = "#Processor";
BOOLEAN IsRevisonController = TRUE;

// Support Processor V1_0_10
...
{
  EFI_REDFISH_PROCESSOR_V1_0_10 *ProcessorV1_0_10;
  EFI_REDFISH_PROCESSOR_V1_0_10_CS *ProcessorV1_0_10Cs;
  ...
  Status = (EFI_STATUS)Json_Processor_V1_0_10_To_CS (ResoruceRaw, &ProcessorV1_0_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_0_10 = (EFI_REDFISH_PROCESSOR_V1_0_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_0_10));
  if (ProcessorV1_0_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ProcessorV1_0_10;
  ProcessorV1_0_10->Processor = ProcessorV1_0_10Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Processor_V1_0_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Processor_V1_0_10_JSON (*((EFI_REDFISH_PROCESSOR_V1_0_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Processor_V1_0_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ProcessorV1_0_10 = (EFI_REDFISH_PROCESSOR_V1_0_10 *)InterpProp;
  DestroyProcessor_V1_0_10_CS (ProcessorV1_0_10->Processor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyProcessor_V1_0_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_0_10EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_0_10Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
