...
//
#include <RedfishJsonStructure/Processor/v1_2_7/EfiProcessorV1_2_7.h>
CHAR8 mResourceTypeStr [] = "#Processor";
BOOLEAN IsRevisonController = TRUE;

// Support Processor V1_2_7
...
{
  EFI_REDFISH_PROCESSOR_V1_2_7 *ProcessorV1_2_7;
  EFI_REDFISH_PROCESSOR_V1_2_7_CS *ProcessorV1_2_7Cs;
  ...
  Status = (EFI_STATUS)Json_Processor_V1_2_7_To_CS (ResoruceRaw, &ProcessorV1_2_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_2_7 = (EFI_REDFISH_PROCESSOR_V1_2_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_2_7));
  if (ProcessorV1_2_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ProcessorV1_2_7;
  ProcessorV1_2_7->Processor = ProcessorV1_2_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Processor_V1_2_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Processor_V1_2_7_JSON (*((EFI_REDFISH_PROCESSOR_V1_2_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Processor_V1_2_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ProcessorV1_2_7 = (EFI_REDFISH_PROCESSOR_V1_2_7 *)InterpProp;
  DestroyProcessor_V1_2_7_CS (ProcessorV1_2_7->Processor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyProcessor_V1_2_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_2_7EntryPoint (
