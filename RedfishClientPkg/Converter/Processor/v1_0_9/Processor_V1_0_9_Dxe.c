...
//
#include <RedfishJsonStructure/Processor/v1_0_9/EfiProcessorV1_0_9.h>
CHAR8 mResourceTypeStr [] = "#Processor";
BOOLEAN IsRevisonController = TRUE;

// Support Processor V1_0_9
...
{
  EFI_REDFISH_PROCESSOR_V1_0_9 *ProcessorV1_0_9;
  EFI_REDFISH_PROCESSOR_V1_0_9_CS *ProcessorV1_0_9Cs;
  ...
  Status = (EFI_STATUS)Json_Processor_V1_0_9_To_CS (ResoruceRaw, &ProcessorV1_0_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_0_9 = (EFI_REDFISH_PROCESSOR_V1_0_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_0_9));
  if (ProcessorV1_0_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ProcessorV1_0_9;
  ProcessorV1_0_9->Processor = ProcessorV1_0_9Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Processor_V1_0_9_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Processor_V1_0_9_JSON (*((EFI_REDFISH_PROCESSOR_V1_0_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Processor_V1_0_9_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ProcessorV1_0_9 = (EFI_REDFISH_PROCESSOR_V1_0_9 *)InterpProp;
  DestroyProcessor_V1_0_9_CS (ProcessorV1_0_9->Processor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyProcessor_V1_0_9_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_0_9EntryPoint (
