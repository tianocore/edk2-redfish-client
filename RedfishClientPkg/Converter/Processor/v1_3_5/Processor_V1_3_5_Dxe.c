...
//
#include <RedfishJsonStructure/Processor/v1_3_5/EfiProcessorV1_3_5.h>
CHAR8 mResourceTypeStr [] = "#Processor";
BOOLEAN IsRevisonController = TRUE;

// Support Processor V1_3_5
...
{
  EFI_REDFISH_PROCESSOR_V1_3_5 *ProcessorV1_3_5;
  EFI_REDFISH_PROCESSOR_V1_3_5_CS *ProcessorV1_3_5Cs;
  ...
  Status = (EFI_STATUS)Json_Processor_V1_3_5_To_CS (ResoruceRaw, &ProcessorV1_3_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_3_5 = (EFI_REDFISH_PROCESSOR_V1_3_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_3_5));
  if (ProcessorV1_3_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ProcessorV1_3_5;
  ProcessorV1_3_5->Processor = ProcessorV1_3_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Processor_V1_3_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Processor_V1_3_5_JSON (*((EFI_REDFISH_PROCESSOR_V1_3_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Processor_V1_3_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ProcessorV1_3_5 = (EFI_REDFISH_PROCESSOR_V1_3_5 *)InterpProp;
  DestroyProcessor_V1_3_5_CS (ProcessorV1_3_5->Processor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyProcessor_V1_3_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_3_5EntryPoint (
