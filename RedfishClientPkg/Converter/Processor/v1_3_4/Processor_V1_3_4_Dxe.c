...
//
#include <RedfishJsonStructure/Processor/v1_3_4/EfiProcessorV1_3_4.h>
CHAR8 mResourceTypeStr [] = "#Processor";
BOOLEAN IsRevisonController = TRUE;

// Support Processor V1_3_4
...
{
  EFI_REDFISH_PROCESSOR_V1_3_4 *ProcessorV1_3_4;
  EFI_REDFISH_PROCESSOR_V1_3_4_CS *ProcessorV1_3_4Cs;
  ...
  Status = (EFI_STATUS)Json_Processor_V1_3_4_To_CS (ResoruceRaw, &ProcessorV1_3_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_3_4 = (EFI_REDFISH_PROCESSOR_V1_3_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_3_4));
  if (ProcessorV1_3_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ProcessorV1_3_4;
  ProcessorV1_3_4->Processor = ProcessorV1_3_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Processor_V1_3_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Processor_V1_3_4_JSON (*((EFI_REDFISH_PROCESSOR_V1_3_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Processor_V1_3_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ProcessorV1_3_4 = (EFI_REDFISH_PROCESSOR_V1_3_4 *)InterpProp;
  DestroyProcessor_V1_3_4_CS (ProcessorV1_3_4->Processor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyProcessor_V1_3_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_3_4EntryPoint (
