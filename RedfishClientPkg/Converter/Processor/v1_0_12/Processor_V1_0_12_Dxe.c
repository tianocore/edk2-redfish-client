...
//
#include <RedfishJsonStructure/Processor/v1_0_12/EfiProcessorV1_0_12.h>
CHAR8 mResourceTypeStr [] = "#Processor";
BOOLEAN IsRevisonController = TRUE;

// Support Processor V1_0_12
...
{
  EFI_REDFISH_PROCESSOR_V1_0_12 *ProcessorV1_0_12;
  EFI_REDFISH_PROCESSOR_V1_0_12_CS *ProcessorV1_0_12Cs;
  ...
  Status = (EFI_STATUS)Json_Processor_V1_0_12_To_CS (ResoruceRaw, &ProcessorV1_0_12Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorV1_0_12 = (EFI_REDFISH_PROCESSOR_V1_0_12 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSOR_V1_0_12));
  if (ProcessorV1_0_12 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ProcessorV1_0_12;
  ProcessorV1_0_12->Processor = ProcessorV1_0_12Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Processor_V1_0_12_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Processor_V1_0_12_JSON (*((EFI_REDFISH_PROCESSOR_V1_0_12_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Processor_V1_0_12_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ProcessorV1_0_12 = (EFI_REDFISH_PROCESSOR_V1_0_12 *)InterpProp;
  DestroyProcessor_V1_0_12_CS (ProcessorV1_0_12->Processor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyProcessor_V1_0_12_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_0_12EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishProcessor_V1_0_12Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
