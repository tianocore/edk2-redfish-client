...
//
#include <RedfishJsonStructure/SimpleStorage/v1_3_0/EfiSimpleStorageV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#SimpleStorage";
BOOLEAN IsRevisonController = TRUE;

// Support SimpleStorage V1_3_0
...
{
  EFI_REDFISH_SIMPLESTORAGE_V1_3_0 *SimpleStorageV1_3_0;
  EFI_REDFISH_SIMPLESTORAGE_V1_3_0_CS *SimpleStorageV1_3_0Cs;
  ...
  Status = (EFI_STATUS)Json_SimpleStorage_V1_3_0_To_CS (ResoruceRaw, &SimpleStorageV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SimpleStorageV1_3_0 = (EFI_REDFISH_SIMPLESTORAGE_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SIMPLESTORAGE_V1_3_0));
  if (SimpleStorageV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SimpleStorageV1_3_0;
  SimpleStorageV1_3_0->SimpleStorage = SimpleStorageV1_3_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SimpleStorage_V1_3_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SimpleStorage_V1_3_0_JSON (*((EFI_REDFISH_SIMPLESTORAGE_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SimpleStorage_V1_3_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SimpleStorageV1_3_0 = (EFI_REDFISH_SIMPLESTORAGE_V1_3_0 *)InterpProp;
  DestroySimpleStorage_V1_3_0_CS (SimpleStorageV1_3_0->SimpleStorage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySimpleStorage_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_3_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_3_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
