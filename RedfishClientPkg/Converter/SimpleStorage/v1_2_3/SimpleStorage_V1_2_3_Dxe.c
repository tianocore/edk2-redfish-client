...
//
#include <RedfishJsonStructure/SimpleStorage/v1_2_3/EfiSimpleStorageV1_2_3.h>
CHAR8 mResourceTypeStr [] = "#SimpleStorage";
BOOLEAN IsRevisonController = TRUE;

// Support SimpleStorage V1_2_3
...
{
  EFI_REDFISH_SIMPLESTORAGE_V1_2_3 *SimpleStorageV1_2_3;
  EFI_REDFISH_SIMPLESTORAGE_V1_2_3_CS *SimpleStorageV1_2_3Cs;
  ...
  Status = (EFI_STATUS)Json_SimpleStorage_V1_2_3_To_CS (ResoruceRaw, &SimpleStorageV1_2_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SimpleStorageV1_2_3 = (EFI_REDFISH_SIMPLESTORAGE_V1_2_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SIMPLESTORAGE_V1_2_3));
  if (SimpleStorageV1_2_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SimpleStorageV1_2_3;
  SimpleStorageV1_2_3->SimpleStorage = SimpleStorageV1_2_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SimpleStorage_V1_2_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SimpleStorage_V1_2_3_JSON (*((EFI_REDFISH_SIMPLESTORAGE_V1_2_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SimpleStorage_V1_2_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SimpleStorageV1_2_3 = (EFI_REDFISH_SIMPLESTORAGE_V1_2_3 *)InterpProp;
  DestroySimpleStorage_V1_2_3_CS (SimpleStorageV1_2_3->SimpleStorage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySimpleStorage_V1_2_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_2_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_2_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
