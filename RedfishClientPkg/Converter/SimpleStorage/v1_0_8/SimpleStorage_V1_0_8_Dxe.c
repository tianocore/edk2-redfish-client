...
//
#include <RedfishJsonStructure/SimpleStorage/v1_0_8/EfiSimpleStorageV1_0_8.h>
CHAR8 mResourceTypeStr [] = "#SimpleStorage";
BOOLEAN IsRevisonController = TRUE;

// Support SimpleStorage V1_0_8
...
{
  EFI_REDFISH_SIMPLESTORAGE_V1_0_8 *SimpleStorageV1_0_8;
  EFI_REDFISH_SIMPLESTORAGE_V1_0_8_CS *SimpleStorageV1_0_8Cs;
  ...
  Status = (EFI_STATUS)Json_SimpleStorage_V1_0_8_To_CS (ResoruceRaw, &SimpleStorageV1_0_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SimpleStorageV1_0_8 = (EFI_REDFISH_SIMPLESTORAGE_V1_0_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SIMPLESTORAGE_V1_0_8));
  if (SimpleStorageV1_0_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SimpleStorageV1_0_8;
  SimpleStorageV1_0_8->SimpleStorage = SimpleStorageV1_0_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SimpleStorage_V1_0_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SimpleStorage_V1_0_8_JSON (*((EFI_REDFISH_SIMPLESTORAGE_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SimpleStorage_V1_0_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SimpleStorageV1_0_8 = (EFI_REDFISH_SIMPLESTORAGE_V1_0_8 *)InterpProp;
  DestroySimpleStorage_V1_0_8_CS (SimpleStorageV1_0_8->SimpleStorage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySimpleStorage_V1_0_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_0_8EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_0_8Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
