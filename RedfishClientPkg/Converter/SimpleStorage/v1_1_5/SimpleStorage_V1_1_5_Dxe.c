...
//
#include <RedfishJsonStructure/SimpleStorage/v1_1_5/EfiSimpleStorageV1_1_5.h>
CHAR8 mResourceTypeStr [] = "#SimpleStorage";
BOOLEAN IsRevisonController = TRUE;

// Support SimpleStorage V1_1_5
...
{
  EFI_REDFISH_SIMPLESTORAGE_V1_1_5 *SimpleStorageV1_1_5;
  EFI_REDFISH_SIMPLESTORAGE_V1_1_5_CS *SimpleStorageV1_1_5Cs;
  ...
  Status = (EFI_STATUS)Json_SimpleStorage_V1_1_5_To_CS (ResoruceRaw, &SimpleStorageV1_1_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SimpleStorageV1_1_5 = (EFI_REDFISH_SIMPLESTORAGE_V1_1_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SIMPLESTORAGE_V1_1_5));
  if (SimpleStorageV1_1_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SimpleStorageV1_1_5;
  SimpleStorageV1_1_5->SimpleStorage = SimpleStorageV1_1_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SimpleStorage_V1_1_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SimpleStorage_V1_1_5_JSON (*((EFI_REDFISH_SIMPLESTORAGE_V1_1_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SimpleStorage_V1_1_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SimpleStorageV1_1_5 = (EFI_REDFISH_SIMPLESTORAGE_V1_1_5 *)InterpProp;
  DestroySimpleStorage_V1_1_5_CS (SimpleStorageV1_1_5->SimpleStorage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySimpleStorage_V1_1_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_1_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_1_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
