...
//
#include <RedfishJsonStructure/SimpleStorage/v1_0_7/EfiSimpleStorageV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#SimpleStorage";
BOOLEAN IsRevisonController = TRUE;

// Support SimpleStorage V1_0_7
...
{
  EFI_REDFISH_SIMPLESTORAGE_V1_0_7 *SimpleStorageV1_0_7;
  EFI_REDFISH_SIMPLESTORAGE_V1_0_7_CS *SimpleStorageV1_0_7Cs;
  ...
  Status = (EFI_STATUS)Json_SimpleStorage_V1_0_7_To_CS (ResoruceRaw, &SimpleStorageV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SimpleStorageV1_0_7 = (EFI_REDFISH_SIMPLESTORAGE_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SIMPLESTORAGE_V1_0_7));
  if (SimpleStorageV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SimpleStorageV1_0_7;
  SimpleStorageV1_0_7->SimpleStorage = SimpleStorageV1_0_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SimpleStorage_V1_0_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SimpleStorage_V1_0_7_JSON (*((EFI_REDFISH_SIMPLESTORAGE_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SimpleStorage_V1_0_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SimpleStorageV1_0_7 = (EFI_REDFISH_SIMPLESTORAGE_V1_0_7 *)InterpProp;
  DestroySimpleStorage_V1_0_7_CS (SimpleStorageV1_0_7->SimpleStorage); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySimpleStorage_V1_0_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_0_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSimpleStorage_V1_0_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
