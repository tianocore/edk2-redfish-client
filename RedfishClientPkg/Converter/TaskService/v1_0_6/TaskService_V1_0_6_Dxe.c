...
//
#include <RedfishJsonStructure/TaskService/v1_0_6/EfiTaskServiceV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#TaskService";
BOOLEAN IsRevisonController = TRUE;

// Support TaskService V1_0_6
...
{
  EFI_REDFISH_TASKSERVICE_V1_0_6 *TaskServiceV1_0_6;
  EFI_REDFISH_TASKSERVICE_V1_0_6_CS *TaskServiceV1_0_6Cs;
  ...
  Status = (EFI_STATUS)Json_TaskService_V1_0_6_To_CS (ResoruceRaw, &TaskServiceV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskServiceV1_0_6 = (EFI_REDFISH_TASKSERVICE_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASKSERVICE_V1_0_6));
  if (TaskServiceV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TaskServiceV1_0_6;
  TaskServiceV1_0_6->TaskService = TaskServiceV1_0_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_TaskService_V1_0_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_TaskService_V1_0_6_JSON (*((EFI_REDFISH_TASKSERVICE_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_TaskService_V1_0_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TaskServiceV1_0_6 = (EFI_REDFISH_TASKSERVICE_V1_0_6 *)InterpProp;
  DestroyTaskService_V1_0_6_CS (TaskServiceV1_0_6->TaskService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyTaskService_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_0_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_0_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
