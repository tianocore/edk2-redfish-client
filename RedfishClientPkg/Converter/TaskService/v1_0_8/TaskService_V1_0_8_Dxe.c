...
//
#include <RedfishJsonStructure/TaskService/v1_0_8/EfiTaskServiceV1_0_8.h>
CHAR8 mResourceTypeStr [] = "#TaskService";
BOOLEAN IsRevisonController = TRUE;

// Support TaskService V1_0_8
...
{
  EFI_REDFISH_TASKSERVICE_V1_0_8 *TaskServiceV1_0_8;
  EFI_REDFISH_TASKSERVICE_V1_0_8_CS *TaskServiceV1_0_8Cs;
  ...
  Status = (EFI_STATUS)Json_TaskService_V1_0_8_To_CS (ResoruceRaw, &TaskServiceV1_0_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskServiceV1_0_8 = (EFI_REDFISH_TASKSERVICE_V1_0_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASKSERVICE_V1_0_8));
  if (TaskServiceV1_0_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TaskServiceV1_0_8;
  TaskServiceV1_0_8->TaskService = TaskServiceV1_0_8Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("TaskService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("TaskService"), "TaskService");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("TaskService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("TaskService"), "TaskService");
...
/**
  The wrapper function of TaskServiceToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_TaskService_V1_0_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_TaskService_V1_0_8_JSON (*((EFI_REDFISH_TASKSERVICE_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_TaskService_V1_0_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TaskServiceV1_0_8 = (EFI_REDFISH_TASKSERVICE_V1_0_8 *)InterpProp;
  DestroyTaskService_V1_0_8_CS (TaskServiceV1_0_8->TaskService); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from TaskServiceFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyTaskService_V1_0_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_0_8EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_0_8Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
