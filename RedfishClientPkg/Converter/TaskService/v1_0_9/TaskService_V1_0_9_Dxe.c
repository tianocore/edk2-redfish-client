...
//
#include <RedfishJsonStructure/TaskService/v1_0_9/EfiTaskServiceV1_0_9.h>
CHAR8 mResourceTypeStr [] = "#TaskService";
BOOLEAN IsRevisonController = TRUE;

// Support TaskService V1_0_9
...
{
  EFI_REDFISH_TASKSERVICE_V1_0_9 *TaskServiceV1_0_9;
  EFI_REDFISH_TASKSERVICE_V1_0_9_CS *TaskServiceV1_0_9Cs;
  ...
  Status = (EFI_STATUS)Json_TaskService_V1_0_9_To_CS (ResoruceRaw, &TaskServiceV1_0_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskServiceV1_0_9 = (EFI_REDFISH_TASKSERVICE_V1_0_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASKSERVICE_V1_0_9));
  if (TaskServiceV1_0_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TaskServiceV1_0_9;
  TaskServiceV1_0_9->TaskService = TaskServiceV1_0_9Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_TaskService_V1_0_9_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_TaskService_V1_0_9_JSON (*((EFI_REDFISH_TASKSERVICE_V1_0_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_TaskService_V1_0_9_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TaskServiceV1_0_9 = (EFI_REDFISH_TASKSERVICE_V1_0_9 *)InterpProp;
  DestroyTaskService_V1_0_9_CS (TaskServiceV1_0_9->TaskService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyTaskService_V1_0_9_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_0_9EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_0_9Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
