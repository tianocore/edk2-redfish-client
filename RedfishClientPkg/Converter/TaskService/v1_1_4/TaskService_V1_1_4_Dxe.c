...
//
#include <RedfishJsonStructure/TaskService/v1_1_4/EfiTaskServiceV1_1_4.h>
CHAR8 mResourceTypeStr [] = "#TaskService";
BOOLEAN IsRevisonController = TRUE;

// Support TaskService V1_1_4
...
{
  EFI_REDFISH_TASKSERVICE_V1_1_4 *TaskServiceV1_1_4;
  EFI_REDFISH_TASKSERVICE_V1_1_4_CS *TaskServiceV1_1_4Cs;
  ...
  Status = (EFI_STATUS)Json_TaskService_V1_1_4_To_CS (ResoruceRaw, &TaskServiceV1_1_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskServiceV1_1_4 = (EFI_REDFISH_TASKSERVICE_V1_1_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASKSERVICE_V1_1_4));
  if (TaskServiceV1_1_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TaskServiceV1_1_4;
  TaskServiceV1_1_4->TaskService = TaskServiceV1_1_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_TaskService_V1_1_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_TaskService_V1_1_4_JSON (*((EFI_REDFISH_TASKSERVICE_V1_1_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_TaskService_V1_1_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TaskServiceV1_1_4 = (EFI_REDFISH_TASKSERVICE_V1_1_4 *)InterpProp;
  DestroyTaskService_V1_1_4_CS (TaskServiceV1_1_4->TaskService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyTaskService_V1_1_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_1_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_1_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
