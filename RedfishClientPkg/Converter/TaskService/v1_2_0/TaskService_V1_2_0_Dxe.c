...
//
#include <RedfishJsonStructure/TaskService/v1_2_0/EfiTaskServiceV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#TaskService";
BOOLEAN IsRevisonController = TRUE;

// Support TaskService V1_2_0
...
{
  EFI_REDFISH_TASKSERVICE_V1_2_0 *TaskServiceV1_2_0;
  EFI_REDFISH_TASKSERVICE_V1_2_0_CS *TaskServiceV1_2_0Cs;
  ...
  Status = (EFI_STATUS)Json_TaskService_V1_2_0_To_CS (ResoruceRaw, &TaskServiceV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskServiceV1_2_0 = (EFI_REDFISH_TASKSERVICE_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASKSERVICE_V1_2_0));
  if (TaskServiceV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TaskServiceV1_2_0;
  TaskServiceV1_2_0->TaskService = TaskServiceV1_2_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_TaskService_V1_2_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_TaskService_V1_2_0_JSON (*((EFI_REDFISH_TASKSERVICE_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_TaskService_V1_2_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TaskServiceV1_2_0 = (EFI_REDFISH_TASKSERVICE_V1_2_0 *)InterpProp;
  DestroyTaskService_V1_2_0_CS (TaskServiceV1_2_0->TaskService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyTaskService_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_2_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishTaskService_V1_2_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
