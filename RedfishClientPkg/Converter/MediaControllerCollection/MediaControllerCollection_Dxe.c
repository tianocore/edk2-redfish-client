...
)
{
  ...
  return (EFI_STATUS)CS_To_MediaControllerCollection_JSON (*((EFI_REDFISH_MEDIACONTROLLERCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
