...
//
#include <RedfishJsonStructure/AttributeRegistry/v1_3_1/EfiAttributeRegistryV1_3_1.h>
CHAR8 mResourceTypeStr [] = "#AttributeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support AttributeRegistry V1_3_1
...
{
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_3_1 *AttributeRegistryV1_3_1;
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_3_1_CS *AttributeRegistryV1_3_1Cs;
  ...
  Status = (EFI_STATUS)Json_AttributeRegistry_V1_3_1_To_CS (ResoruceRaw, &AttributeRegistryV1_3_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AttributeRegistryV1_3_1 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_3_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_3_1));
  if (AttributeRegistryV1_3_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AttributeRegistryV1_3_1;
  AttributeRegistryV1_3_1->AttributeRegistry = AttributeRegistryV1_3_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AttributeRegistry_V1_3_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AttributeRegistry_V1_3_1_JSON (*((EFI_REDFISH_ATTRIBUTEREGISTRY_V1_3_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AttributeRegistry_V1_3_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AttributeRegistryV1_3_1 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_3_1 *)InterpProp;
  DestroyAttributeRegistry_V1_3_1_CS (AttributeRegistryV1_3_1->AttributeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAttributeRegistry_V1_3_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_3_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_3_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
