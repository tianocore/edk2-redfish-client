...
//
#include <RedfishJsonStructure/AttributeRegistry/v1_0_9/EfiAttributeRegistryV1_0_9.h>
CHAR8 mResourceTypeStr [] = "#AttributeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support AttributeRegistry V1_0_9
...
{
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_9 *AttributeRegistryV1_0_9;
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_9_CS *AttributeRegistryV1_0_9Cs;
  ...
  Status = (EFI_STATUS)Json_AttributeRegistry_V1_0_9_To_CS (ResoruceRaw, &AttributeRegistryV1_0_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AttributeRegistryV1_0_9 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_9));
  if (AttributeRegistryV1_0_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AttributeRegistryV1_0_9;
  AttributeRegistryV1_0_9->AttributeRegistry = AttributeRegistryV1_0_9Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AttributeRegistry_V1_0_9_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AttributeRegistry_V1_0_9_JSON (*((EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AttributeRegistry_V1_0_9_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AttributeRegistryV1_0_9 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_9 *)InterpProp;
  DestroyAttributeRegistry_V1_0_9_CS (AttributeRegistryV1_0_9->AttributeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAttributeRegistry_V1_0_9_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_0_9EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_0_9Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
