...
//
#include <RedfishJsonStructure/AttributeRegistry/v1_0_10/EfiAttributeRegistryV1_0_10.h>
CHAR8 mResourceTypeStr [] = "#AttributeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support AttributeRegistry V1_0_10
...
{
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_10 *AttributeRegistryV1_0_10;
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_10_CS *AttributeRegistryV1_0_10Cs;
  ...
  Status = (EFI_STATUS)Json_AttributeRegistry_V1_0_10_To_CS (ResoruceRaw, &AttributeRegistryV1_0_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AttributeRegistryV1_0_10 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_10));
  if (AttributeRegistryV1_0_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AttributeRegistryV1_0_10;
  AttributeRegistryV1_0_10->AttributeRegistry = AttributeRegistryV1_0_10Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("AttributeRegistry"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("AttributeRegistry"), "AttributeRegistry");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("AttributeRegistry"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("AttributeRegistry"), "AttributeRegistry");
...
/**
  The wrapper function of AttributeRegistryToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
AttributeRegistryToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return AttributeRegistryToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AttributeRegistry_V1_0_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AttributeRegistry_V1_0_10_JSON (*((EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AttributeRegistry_V1_0_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
EFI_STATUS
EFIAPI
AttributeRegistryDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  AttributeRegistryV1_0_10 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_0_10 *)InterpProp;
  DestroyAttributeRegistry_V1_0_10_CS (AttributeRegistryV1_0_10->AttributeRegistry); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from AttributeRegistryFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyAttributeRegistry_V1_0_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_0_10EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_0_10Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
