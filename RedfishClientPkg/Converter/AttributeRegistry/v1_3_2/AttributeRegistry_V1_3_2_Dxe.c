...
//
#include <RedfishJsonStructure/AttributeRegistry/v1_3_2/EfiAttributeRegistryV1_3_2.h>
CHAR8 mResourceTypeStr [] = "#AttributeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support AttributeRegistry V1_3_2
...
{
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_3_2 *AttributeRegistryV1_3_2;
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_3_2_CS *AttributeRegistryV1_3_2Cs;
  ...
  Status = (EFI_STATUS)Json_AttributeRegistry_V1_3_2_To_CS (ResoruceRaw, &AttributeRegistryV1_3_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AttributeRegistryV1_3_2 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_3_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_3_2));
  if (AttributeRegistryV1_3_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AttributeRegistryV1_3_2;
  AttributeRegistryV1_3_2->AttributeRegistry = AttributeRegistryV1_3_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AttributeRegistry_V1_3_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AttributeRegistry_V1_3_2_JSON (*((EFI_REDFISH_ATTRIBUTEREGISTRY_V1_3_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AttributeRegistry_V1_3_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AttributeRegistryV1_3_2 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_3_2 *)InterpProp;
  DestroyAttributeRegistry_V1_3_2_CS (AttributeRegistryV1_3_2->AttributeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAttributeRegistry_V1_3_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_3_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_3_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
