...
//
#include <RedfishJsonStructure/AttributeRegistry/v1_2_8/EfiAttributeRegistryV1_2_8.h>
CHAR8 mResourceTypeStr [] = "#AttributeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support AttributeRegistry V1_2_8
...
{
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_2_8 *AttributeRegistryV1_2_8;
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_2_8_CS *AttributeRegistryV1_2_8Cs;
  ...
  Status = (EFI_STATUS)Json_AttributeRegistry_V1_2_8_To_CS (ResoruceRaw, &AttributeRegistryV1_2_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AttributeRegistryV1_2_8 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_2_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_2_8));
  if (AttributeRegistryV1_2_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AttributeRegistryV1_2_8;
  AttributeRegistryV1_2_8->AttributeRegistry = AttributeRegistryV1_2_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AttributeRegistry_V1_2_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AttributeRegistry_V1_2_8_JSON (*((EFI_REDFISH_ATTRIBUTEREGISTRY_V1_2_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AttributeRegistry_V1_2_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AttributeRegistryV1_2_8 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_2_8 *)InterpProp;
  DestroyAttributeRegistry_V1_2_8_CS (AttributeRegistryV1_2_8->AttributeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAttributeRegistry_V1_2_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_2_8EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_2_8Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
