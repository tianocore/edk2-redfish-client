...
//
#include <RedfishJsonStructure/AttributeRegistry/v1_1_7/EfiAttributeRegistryV1_1_7.h>
CHAR8 mResourceTypeStr [] = "#AttributeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support AttributeRegistry V1_1_7
...
{
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_7 *AttributeRegistryV1_1_7;
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_7_CS *AttributeRegistryV1_1_7Cs;
  ...
  Status = (EFI_STATUS)Json_AttributeRegistry_V1_1_7_To_CS (ResoruceRaw, &AttributeRegistryV1_1_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AttributeRegistryV1_1_7 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_7));
  if (AttributeRegistryV1_1_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AttributeRegistryV1_1_7;
  AttributeRegistryV1_1_7->AttributeRegistry = AttributeRegistryV1_1_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AttributeRegistry_V1_1_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AttributeRegistry_V1_1_7_JSON (*((EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AttributeRegistry_V1_1_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AttributeRegistryV1_1_7 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_7 *)InterpProp;
  DestroyAttributeRegistry_V1_1_7_CS (AttributeRegistryV1_1_7->AttributeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAttributeRegistry_V1_1_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_1_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_1_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
