...
//
#include <RedfishJsonStructure/AttributeRegistry/v1_1_10/EfiAttributeRegistryV1_1_10.h>
CHAR8 mResourceTypeStr [] = "#AttributeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support AttributeRegistry V1_1_10
...
{
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_10 *AttributeRegistryV1_1_10;
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_10_CS *AttributeRegistryV1_1_10Cs;
  ...
  Status = (EFI_STATUS)Json_AttributeRegistry_V1_1_10_To_CS (ResoruceRaw, &AttributeRegistryV1_1_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AttributeRegistryV1_1_10 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_10));
  if (AttributeRegistryV1_1_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AttributeRegistryV1_1_10;
  AttributeRegistryV1_1_10->AttributeRegistry = AttributeRegistryV1_1_10Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AttributeRegistry_V1_1_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AttributeRegistry_V1_1_10_JSON (*((EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AttributeRegistry_V1_1_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AttributeRegistryV1_1_10 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_1_10 *)InterpProp;
  DestroyAttributeRegistry_V1_1_10_CS (AttributeRegistryV1_1_10->AttributeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAttributeRegistry_V1_1_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_1_10EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_1_10Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
