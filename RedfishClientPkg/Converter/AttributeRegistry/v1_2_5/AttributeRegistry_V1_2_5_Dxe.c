...
//
#include <RedfishJsonStructure/AttributeRegistry/v1_2_5/EfiAttributeRegistryV1_2_5.h>
CHAR8 mResourceTypeStr [] = "#AttributeRegistry";
BOOLEAN IsRevisonController = TRUE;

// Support AttributeRegistry V1_2_5
...
{
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_2_5 *AttributeRegistryV1_2_5;
  EFI_REDFISH_ATTRIBUTEREGISTRY_V1_2_5_CS *AttributeRegistryV1_2_5Cs;
  ...
  Status = (EFI_STATUS)Json_AttributeRegistry_V1_2_5_To_CS (ResoruceRaw, &AttributeRegistryV1_2_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AttributeRegistryV1_2_5 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_2_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_2_5));
  if (AttributeRegistryV1_2_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AttributeRegistryV1_2_5;
  AttributeRegistryV1_2_5->AttributeRegistry = AttributeRegistryV1_2_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AttributeRegistry_V1_2_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AttributeRegistry_V1_2_5_JSON (*((EFI_REDFISH_ATTRIBUTEREGISTRY_V1_2_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AttributeRegistry_V1_2_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AttributeRegistryV1_2_5 = (EFI_REDFISH_ATTRIBUTEREGISTRY_V1_2_5 *)InterpProp;
  DestroyAttributeRegistry_V1_2_5_CS (AttributeRegistryV1_2_5->AttributeRegistry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAttributeRegistry_V1_2_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_2_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAttributeRegistry_V1_2_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
