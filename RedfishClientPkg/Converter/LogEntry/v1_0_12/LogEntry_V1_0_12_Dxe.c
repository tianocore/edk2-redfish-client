...
//
#include <RedfishJsonStructure/LogEntry/v1_0_12/EfiLogEntryV1_0_12.h>
CHAR8 mResourceTypeStr [] = "#LogEntry";
BOOLEAN IsRevisonController = TRUE;

// Support LogEntry V1_0_12
...
{
  EFI_REDFISH_LOGENTRY_V1_0_12 *LogEntryV1_0_12;
  EFI_REDFISH_LOGENTRY_V1_0_12_CS *LogEntryV1_0_12Cs;
  ...
  Status = (EFI_STATUS)Json_LogEntry_V1_0_12_To_CS (ResoruceRaw, &LogEntryV1_0_12Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogEntryV1_0_12 = (EFI_REDFISH_LOGENTRY_V1_0_12 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGENTRY_V1_0_12));
  if (LogEntryV1_0_12 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)LogEntryV1_0_12;
  LogEntryV1_0_12->LogEntry = LogEntryV1_0_12Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_LogEntry_V1_0_12_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_LogEntry_V1_0_12_JSON (*((EFI_REDFISH_LOGENTRY_V1_0_12_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_LogEntry_V1_0_12_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  LogEntryV1_0_12 = (EFI_REDFISH_LOGENTRY_V1_0_12 *)InterpProp;
  DestroyLogEntry_V1_0_12_CS (LogEntryV1_0_12->LogEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyLogEntry_V1_0_12_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogEntry_V1_0_12EntryPoint (
