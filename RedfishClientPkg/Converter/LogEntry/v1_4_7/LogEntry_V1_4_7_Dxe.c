...
//
#include <RedfishJsonStructure/LogEntry/v1_4_7/EfiLogEntryV1_4_7.h>
CHAR8 mResourceTypeStr [] = "#LogEntry";
BOOLEAN IsRevisonController = TRUE;

// Support LogEntry V1_4_7
...
{
  EFI_REDFISH_LOGENTRY_V1_4_7 *LogEntryV1_4_7;
  EFI_REDFISH_LOGENTRY_V1_4_7_CS *LogEntryV1_4_7Cs;
  ...
  Status = (EFI_STATUS)Json_LogEntry_V1_4_7_To_CS (ResoruceRaw, &LogEntryV1_4_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogEntryV1_4_7 = (EFI_REDFISH_LOGENTRY_V1_4_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGENTRY_V1_4_7));
  if (LogEntryV1_4_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)LogEntryV1_4_7;
  LogEntryV1_4_7->LogEntry = LogEntryV1_4_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_LogEntry_V1_4_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_LogEntry_V1_4_7_JSON (*((EFI_REDFISH_LOGENTRY_V1_4_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_LogEntry_V1_4_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  LogEntryV1_4_7 = (EFI_REDFISH_LOGENTRY_V1_4_7 *)InterpProp;
  DestroyLogEntry_V1_4_7_CS (LogEntryV1_4_7->LogEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyLogEntry_V1_4_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogEntry_V1_4_7EntryPoint (
