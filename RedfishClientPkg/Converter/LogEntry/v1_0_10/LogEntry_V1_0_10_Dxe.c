...
//
#include <RedfishJsonStructure/LogEntry/v1_0_10/EfiLogEntryV1_0_10.h>
CHAR8 mResourceTypeStr [] = "#LogEntry";
BOOLEAN IsRevisonController = TRUE;

// Support LogEntry V1_0_10
...
{
  EFI_REDFISH_LOGENTRY_V1_0_10 *LogEntryV1_0_10;
  EFI_REDFISH_LOGENTRY_V1_0_10_CS *LogEntryV1_0_10Cs;
  ...
  Status = (EFI_STATUS)Json_LogEntry_V1_0_10_To_CS (ResoruceRaw, &LogEntryV1_0_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogEntryV1_0_10 = (EFI_REDFISH_LOGENTRY_V1_0_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGENTRY_V1_0_10));
  if (LogEntryV1_0_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)LogEntryV1_0_10;
  LogEntryV1_0_10->LogEntry = LogEntryV1_0_10Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_LogEntry_V1_0_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_LogEntry_V1_0_10_JSON (*((EFI_REDFISH_LOGENTRY_V1_0_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_LogEntry_V1_0_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  LogEntryV1_0_10 = (EFI_REDFISH_LOGENTRY_V1_0_10 *)InterpProp;
  DestroyLogEntry_V1_0_10_CS (LogEntryV1_0_10->LogEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyLogEntry_V1_0_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogEntry_V1_0_10EntryPoint (
