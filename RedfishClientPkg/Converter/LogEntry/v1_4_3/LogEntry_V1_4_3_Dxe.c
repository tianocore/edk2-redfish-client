...
//
#include <RedfishJsonStructure/LogEntry/v1_4_3/EfiLogEntryV1_4_3.h>
CHAR8 mResourceTypeStr [] = "#LogEntry";
BOOLEAN IsRevisonController = TRUE;

// Support LogEntry V1_4_3
...
{
  EFI_REDFISH_LOGENTRY_V1_4_3 *LogEntryV1_4_3;
  EFI_REDFISH_LOGENTRY_V1_4_3_CS *LogEntryV1_4_3Cs;
  ...
  Status = (EFI_STATUS)Json_LogEntry_V1_4_3_To_CS (ResoruceRaw, &LogEntryV1_4_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogEntryV1_4_3 = (EFI_REDFISH_LOGENTRY_V1_4_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGENTRY_V1_4_3));
  if (LogEntryV1_4_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)LogEntryV1_4_3;
  LogEntryV1_4_3->LogEntry = LogEntryV1_4_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_LogEntry_V1_4_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_LogEntry_V1_4_3_JSON (*((EFI_REDFISH_LOGENTRY_V1_4_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_LogEntry_V1_4_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  LogEntryV1_4_3 = (EFI_REDFISH_LOGENTRY_V1_4_3 *)InterpProp;
  DestroyLogEntry_V1_4_3_CS (LogEntryV1_4_3->LogEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyLogEntry_V1_4_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogEntry_V1_4_3EntryPoint (
