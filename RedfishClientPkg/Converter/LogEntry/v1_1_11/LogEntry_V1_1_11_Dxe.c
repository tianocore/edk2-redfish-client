...
//
#include <RedfishJsonStructure/LogEntry/v1_1_11/EfiLogEntryV1_1_11.h>
CHAR8 mResourceTypeStr [] = "#LogEntry";
BOOLEAN IsRevisonController = TRUE;

// Support LogEntry V1_1_11
...
{
  EFI_REDFISH_LOGENTRY_V1_1_11 *LogEntryV1_1_11;
  EFI_REDFISH_LOGENTRY_V1_1_11_CS *LogEntryV1_1_11Cs;
  ...
  Status = (EFI_STATUS)Json_LogEntry_V1_1_11_To_CS (ResoruceRaw, &LogEntryV1_1_11Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogEntryV1_1_11 = (EFI_REDFISH_LOGENTRY_V1_1_11 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGENTRY_V1_1_11));
  if (LogEntryV1_1_11 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)LogEntryV1_1_11;
  LogEntryV1_1_11->LogEntry = LogEntryV1_1_11Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_LogEntry_V1_1_11_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_LogEntry_V1_1_11_JSON (*((EFI_REDFISH_LOGENTRY_V1_1_11_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_LogEntry_V1_1_11_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  LogEntryV1_1_11 = (EFI_REDFISH_LOGENTRY_V1_1_11 *)InterpProp;
  DestroyLogEntry_V1_1_11_CS (LogEntryV1_1_11->LogEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyLogEntry_V1_1_11_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogEntry_V1_1_11EntryPoint (
