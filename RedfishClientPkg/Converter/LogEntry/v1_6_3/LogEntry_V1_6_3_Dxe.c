...
//
#include <RedfishJsonStructure/LogEntry/v1_6_3/EfiLogEntryV1_6_3.h>
CHAR8 mResourceTypeStr [] = "#LogEntry";
BOOLEAN IsRevisonController = TRUE;

// Support LogEntry V1_6_3
...
{
  EFI_REDFISH_LOGENTRY_V1_6_3 *LogEntryV1_6_3;
  EFI_REDFISH_LOGENTRY_V1_6_3_CS *LogEntryV1_6_3Cs;
  ...
  Status = (EFI_STATUS)Json_LogEntry_V1_6_3_To_CS (ResoruceRaw, &LogEntryV1_6_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogEntryV1_6_3 = (EFI_REDFISH_LOGENTRY_V1_6_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGENTRY_V1_6_3));
  if (LogEntryV1_6_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)LogEntryV1_6_3;
  LogEntryV1_6_3->LogEntry = LogEntryV1_6_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_LogEntry_V1_6_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_LogEntry_V1_6_3_JSON (*((EFI_REDFISH_LOGENTRY_V1_6_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_LogEntry_V1_6_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  LogEntryV1_6_3 = (EFI_REDFISH_LOGENTRY_V1_6_3 *)InterpProp;
  DestroyLogEntry_V1_6_3_CS (LogEntryV1_6_3->LogEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyLogEntry_V1_6_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogEntry_V1_6_3EntryPoint (
