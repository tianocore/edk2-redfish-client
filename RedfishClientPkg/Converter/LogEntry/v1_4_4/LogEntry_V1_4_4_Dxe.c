...
//
#include <RedfishJsonStructure/LogEntry/v1_4_4/EfiLogEntryV1_4_4.h>
CHAR8 mResourceTypeStr [] = "#LogEntry";
BOOLEAN IsRevisonController = TRUE;

// Support LogEntry V1_4_4
...
{
  EFI_REDFISH_LOGENTRY_V1_4_4 *LogEntryV1_4_4;
  EFI_REDFISH_LOGENTRY_V1_4_4_CS *LogEntryV1_4_4Cs;
  ...
  Status = (EFI_STATUS)Json_LogEntry_V1_4_4_To_CS (ResoruceRaw, &LogEntryV1_4_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogEntryV1_4_4 = (EFI_REDFISH_LOGENTRY_V1_4_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGENTRY_V1_4_4));
  if (LogEntryV1_4_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)LogEntryV1_4_4;
  LogEntryV1_4_4->LogEntry = LogEntryV1_4_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_LogEntry_V1_4_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_LogEntry_V1_4_4_JSON (*((EFI_REDFISH_LOGENTRY_V1_4_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_LogEntry_V1_4_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  LogEntryV1_4_4 = (EFI_REDFISH_LOGENTRY_V1_4_4 *)InterpProp;
  DestroyLogEntry_V1_4_4_CS (LogEntryV1_4_4->LogEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyLogEntry_V1_4_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogEntry_V1_4_4EntryPoint (
