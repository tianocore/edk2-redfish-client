...
//
#include <RedfishJsonStructure/LogEntry/v1_3_6/EfiLogEntryV1_3_6.h>
CHAR8 mResourceTypeStr [] = "#LogEntry";
BOOLEAN IsRevisonController = TRUE;

// Support LogEntry V1_3_6
...
{
  EFI_REDFISH_LOGENTRY_V1_3_6 *LogEntryV1_3_6;
  EFI_REDFISH_LOGENTRY_V1_3_6_CS *LogEntryV1_3_6Cs;
  ...
  Status = (EFI_STATUS)Json_LogEntry_V1_3_6_To_CS (ResoruceRaw, &LogEntryV1_3_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LogEntryV1_3_6 = (EFI_REDFISH_LOGENTRY_V1_3_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LOGENTRY_V1_3_6));
  if (LogEntryV1_3_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)LogEntryV1_3_6;
  LogEntryV1_3_6->LogEntry = LogEntryV1_3_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_LogEntry_V1_3_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_LogEntry_V1_3_6_JSON (*((EFI_REDFISH_LOGENTRY_V1_3_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_LogEntry_V1_3_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  LogEntryV1_3_6 = (EFI_REDFISH_LOGENTRY_V1_3_6 *)InterpProp;
  DestroyLogEntry_V1_3_6_CS (LogEntryV1_3_6->LogEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyLogEntry_V1_3_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLogEntry_V1_3_6EntryPoint (
