...
//
#include <RedfishJsonStructure/Fabric/v1_0_7/EfiFabricV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#Fabric";
BOOLEAN IsRevisonController = TRUE;

// Support Fabric V1_0_7
...
{
  EFI_REDFISH_FABRIC_V1_0_7 *FabricV1_0_7;
  EFI_REDFISH_FABRIC_V1_0_7_CS *FabricV1_0_7Cs;
  ...
  Status = (EFI_STATUS)Json_Fabric_V1_0_7_To_CS (ResoruceRaw, &FabricV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  FabricV1_0_7 = (EFI_REDFISH_FABRIC_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_FABRIC_V1_0_7));
  if (FabricV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)FabricV1_0_7;
  FabricV1_0_7->Fabric = FabricV1_0_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Fabric_V1_0_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Fabric_V1_0_7_JSON (*((EFI_REDFISH_FABRIC_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Fabric_V1_0_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  FabricV1_0_7 = (EFI_REDFISH_FABRIC_V1_0_7 *)InterpProp;
  DestroyFabric_V1_0_7_CS (FabricV1_0_7->Fabric); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyFabric_V1_0_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishFabric_V1_0_7EntryPoint (
