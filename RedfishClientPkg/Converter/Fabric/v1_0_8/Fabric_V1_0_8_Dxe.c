...
//
#include <RedfishJsonStructure/Fabric/v1_0_8/EfiFabricV1_0_8.h>
CHAR8 mResourceTypeStr [] = "#Fabric";
BOOLEAN IsRevisonController = TRUE;

// Support Fabric V1_0_8
...
{
  EFI_REDFISH_FABRIC_V1_0_8 *FabricV1_0_8;
  EFI_REDFISH_FABRIC_V1_0_8_CS *FabricV1_0_8Cs;
  ...
  Status = (EFI_STATUS)Json_Fabric_V1_0_8_To_CS (ResoruceRaw, &FabricV1_0_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  FabricV1_0_8 = (EFI_REDFISH_FABRIC_V1_0_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_FABRIC_V1_0_8));
  if (FabricV1_0_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)FabricV1_0_8;
  FabricV1_0_8->Fabric = FabricV1_0_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Fabric_V1_0_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Fabric_V1_0_8_JSON (*((EFI_REDFISH_FABRIC_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Fabric_V1_0_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  FabricV1_0_8 = (EFI_REDFISH_FABRIC_V1_0_8 *)InterpProp;
  DestroyFabric_V1_0_8_CS (FabricV1_0_8->Fabric); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyFabric_V1_0_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishFabric_V1_0_8EntryPoint (
