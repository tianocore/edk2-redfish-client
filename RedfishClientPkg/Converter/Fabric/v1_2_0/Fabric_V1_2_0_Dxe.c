...
//
#include <RedfishJsonStructure/Fabric/v1_2_0/EfiFabricV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#Fabric";
BOOLEAN IsRevisonController = TRUE;

// Support Fabric V1_2_0
...
{
  EFI_REDFISH_FABRIC_V1_2_0 *FabricV1_2_0;
  EFI_REDFISH_FABRIC_V1_2_0_CS *FabricV1_2_0Cs;
  ...
  Status = (EFI_STATUS)Json_Fabric_V1_2_0_To_CS (ResoruceRaw, &FabricV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  FabricV1_2_0 = (EFI_REDFISH_FABRIC_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_FABRIC_V1_2_0));
  if (FabricV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)FabricV1_2_0;
  FabricV1_2_0->Fabric = FabricV1_2_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Fabric_V1_2_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Fabric_V1_2_0_JSON (*((EFI_REDFISH_FABRIC_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Fabric_V1_2_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  FabricV1_2_0 = (EFI_REDFISH_FABRIC_V1_2_0 *)InterpProp;
  DestroyFabric_V1_2_0_CS (FabricV1_2_0->Fabric); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyFabric_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishFabric_V1_2_0EntryPoint (
