...
//
#include <RedfishJsonStructure/Fabric/v1_1_3/EfiFabricV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#Fabric";
BOOLEAN IsRevisonController = TRUE;

// Support Fabric V1_1_3
...
{
  EFI_REDFISH_FABRIC_V1_1_3 *FabricV1_1_3;
  EFI_REDFISH_FABRIC_V1_1_3_CS *FabricV1_1_3Cs;
  ...
  Status = (EFI_STATUS)Json_Fabric_V1_1_3_To_CS (ResoruceRaw, &FabricV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  FabricV1_1_3 = (EFI_REDFISH_FABRIC_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_FABRIC_V1_1_3));
  if (FabricV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)FabricV1_1_3;
  FabricV1_1_3->Fabric = FabricV1_1_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Fabric_V1_1_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Fabric_V1_1_3_JSON (*((EFI_REDFISH_FABRIC_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Fabric_V1_1_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  FabricV1_1_3 = (EFI_REDFISH_FABRIC_V1_1_3 *)InterpProp;
  DestroyFabric_V1_1_3_CS (FabricV1_1_3->Fabric); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyFabric_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishFabric_V1_1_3EntryPoint (
