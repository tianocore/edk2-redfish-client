...
)
{
  ...
  return (EFI_STATUS)CS_To_RouteSetEntryCollection_JSON (*((EFI_REDFISH_ROUTESETENTRYCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
