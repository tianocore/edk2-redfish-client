...
//
#include <RedfishJsonStructure/MetricDefinition/v1_1_3/EfiMetricDefinitionV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#MetricDefinition";
BOOLEAN IsRevisonController = TRUE;

// Support MetricDefinition V1_1_3
...
{
  EFI_REDFISH_METRICDEFINITION_V1_1_3 *MetricDefinitionV1_1_3;
  EFI_REDFISH_METRICDEFINITION_V1_1_3_CS *MetricDefinitionV1_1_3Cs;
  ...
  Status = (EFI_STATUS)Json_MetricDefinition_V1_1_3_To_CS (ResoruceRaw, &MetricDefinitionV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MetricDefinitionV1_1_3 = (EFI_REDFISH_METRICDEFINITION_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_METRICDEFINITION_V1_1_3));
  if (MetricDefinitionV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MetricDefinitionV1_1_3;
  MetricDefinitionV1_1_3->MetricDefinition = MetricDefinitionV1_1_3Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("MetricDefinition"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("MetricDefinition"), "MetricDefinition");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("MetricDefinition"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("MetricDefinition"), "MetricDefinition");
...
/**
  The wrapper function of MetricDefinitionToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
MetricDefinitionToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return MetricDefinitionToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MetricDefinition_V1_1_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MetricDefinition_V1_1_3_JSON (*((EFI_REDFISH_METRICDEFINITION_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MetricDefinition_V1_1_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MetricDefinitionV1_1_3 = (EFI_REDFISH_METRICDEFINITION_V1_1_3 *)InterpProp;
  DestroyMetricDefinition_V1_1_3_CS (MetricDefinitionV1_1_3->MetricDefinition); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from MetricDefinitionFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyMetricDefinition_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMetricDefinition_V1_1_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMetricDefinition_V1_1_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
