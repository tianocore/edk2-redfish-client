...
//
#include <RedfishJsonStructure/MetricDefinition/v1_1_1/EfiMetricDefinitionV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#MetricDefinition";
BOOLEAN IsRevisonController = TRUE;

// Support MetricDefinition V1_1_1
...
{
  EFI_REDFISH_METRICDEFINITION_V1_1_1 *MetricDefinitionV1_1_1;
  EFI_REDFISH_METRICDEFINITION_V1_1_1_CS *MetricDefinitionV1_1_1Cs;
  ...
  Status = (EFI_STATUS)Json_MetricDefinition_V1_1_1_To_CS (ResoruceRaw, &MetricDefinitionV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MetricDefinitionV1_1_1 = (EFI_REDFISH_METRICDEFINITION_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_METRICDEFINITION_V1_1_1));
  if (MetricDefinitionV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MetricDefinitionV1_1_1;
  MetricDefinitionV1_1_1->MetricDefinition = MetricDefinitionV1_1_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MetricDefinition_V1_1_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MetricDefinition_V1_1_1_JSON (*((EFI_REDFISH_METRICDEFINITION_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MetricDefinition_V1_1_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MetricDefinitionV1_1_1 = (EFI_REDFISH_METRICDEFINITION_V1_1_1 *)InterpProp;
  DestroyMetricDefinition_V1_1_1_CS (MetricDefinitionV1_1_1->MetricDefinition); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMetricDefinition_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMetricDefinition_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMetricDefinition_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
