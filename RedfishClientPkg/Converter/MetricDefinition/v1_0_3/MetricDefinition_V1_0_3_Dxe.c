...
//
#include <RedfishJsonStructure/MetricDefinition/v1_0_3/EfiMetricDefinitionV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#MetricDefinition";
BOOLEAN IsRevisonController = TRUE;

// Support MetricDefinition V1_0_3
...
{
  EFI_REDFISH_METRICDEFINITION_V1_0_3 *MetricDefinitionV1_0_3;
  EFI_REDFISH_METRICDEFINITION_V1_0_3_CS *MetricDefinitionV1_0_3Cs;
  ...
  Status = (EFI_STATUS)Json_MetricDefinition_V1_0_3_To_CS (ResoruceRaw, &MetricDefinitionV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MetricDefinitionV1_0_3 = (EFI_REDFISH_METRICDEFINITION_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_METRICDEFINITION_V1_0_3));
  if (MetricDefinitionV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MetricDefinitionV1_0_3;
  MetricDefinitionV1_0_3->MetricDefinition = MetricDefinitionV1_0_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MetricDefinition_V1_0_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MetricDefinition_V1_0_3_JSON (*((EFI_REDFISH_METRICDEFINITION_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MetricDefinition_V1_0_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MetricDefinitionV1_0_3 = (EFI_REDFISH_METRICDEFINITION_V1_0_3 *)InterpProp;
  DestroyMetricDefinition_V1_0_3_CS (MetricDefinitionV1_0_3->MetricDefinition); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMetricDefinition_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMetricDefinition_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMetricDefinition_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
