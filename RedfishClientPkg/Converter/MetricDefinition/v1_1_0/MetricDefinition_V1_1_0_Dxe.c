...
//
#include <RedfishJsonStructure/MetricDefinition/v1_1_0/EfiMetricDefinitionV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#MetricDefinition";
BOOLEAN IsRevisonController = TRUE;

// Support MetricDefinition V1_1_0
...
{
  EFI_REDFISH_METRICDEFINITION_V1_1_0 *MetricDefinitionV1_1_0;
  EFI_REDFISH_METRICDEFINITION_V1_1_0_CS *MetricDefinitionV1_1_0Cs;
  ...
  Status = (EFI_STATUS)Json_MetricDefinition_V1_1_0_To_CS (ResoruceRaw, &MetricDefinitionV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MetricDefinitionV1_1_0 = (EFI_REDFISH_METRICDEFINITION_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_METRICDEFINITION_V1_1_0));
  if (MetricDefinitionV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MetricDefinitionV1_1_0;
  MetricDefinitionV1_1_0->MetricDefinition = MetricDefinitionV1_1_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MetricDefinition_V1_1_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MetricDefinition_V1_1_0_JSON (*((EFI_REDFISH_METRICDEFINITION_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MetricDefinition_V1_1_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MetricDefinitionV1_1_0 = (EFI_REDFISH_METRICDEFINITION_V1_1_0 *)InterpProp;
  DestroyMetricDefinition_V1_1_0_CS (MetricDefinitionV1_1_0->MetricDefinition); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMetricDefinition_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMetricDefinition_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMetricDefinition_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
