...
//
#include <RedfishJsonStructure/MetricDefinition/v1_0_4/EfiMetricDefinitionV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#MetricDefinition";
BOOLEAN IsRevisonController = TRUE;

// Support MetricDefinition V1_0_4
...
{
  EFI_REDFISH_METRICDEFINITION_V1_0_4 *MetricDefinitionV1_0_4;
  EFI_REDFISH_METRICDEFINITION_V1_0_4_CS *MetricDefinitionV1_0_4Cs;
  ...
  Status = (EFI_STATUS)Json_MetricDefinition_V1_0_4_To_CS (ResoruceRaw, &MetricDefinitionV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MetricDefinitionV1_0_4 = (EFI_REDFISH_METRICDEFINITION_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_METRICDEFINITION_V1_0_4));
  if (MetricDefinitionV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MetricDefinitionV1_0_4;
  MetricDefinitionV1_0_4->MetricDefinition = MetricDefinitionV1_0_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MetricDefinition_V1_0_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MetricDefinition_V1_0_4_JSON (*((EFI_REDFISH_METRICDEFINITION_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MetricDefinition_V1_0_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MetricDefinitionV1_0_4 = (EFI_REDFISH_METRICDEFINITION_V1_0_4 *)InterpProp;
  DestroyMetricDefinition_V1_0_4_CS (MetricDefinitionV1_0_4->MetricDefinition); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMetricDefinition_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMetricDefinition_V1_0_4EntryPoint (
