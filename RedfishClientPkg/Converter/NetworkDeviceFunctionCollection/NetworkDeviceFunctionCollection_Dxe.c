...
)
{
  ...
  return (EFI_STATUS)CS_To_NetworkDeviceFunctionCollection_JSON (*((EFI_REDFISH_NETWORKDEVICEFUNCTIONCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
