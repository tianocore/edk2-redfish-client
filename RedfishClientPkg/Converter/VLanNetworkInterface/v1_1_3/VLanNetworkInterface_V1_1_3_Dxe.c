...
//
#include <RedfishJsonStructure/VLanNetworkInterface/v1_1_3/EfiVLanNetworkInterfaceV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#VLanNetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support VLanNetworkInterface V1_1_3
...
{
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_3 *VLanNetworkInterfaceV1_1_3;
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_3_CS *VLanNetworkInterfaceV1_1_3Cs;
  ...
  Status = (EFI_STATUS)Json_VLanNetworkInterface_V1_1_3_To_CS (ResoruceRaw, &VLanNetworkInterfaceV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VLanNetworkInterfaceV1_1_3 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_3));
  if (VLanNetworkInterfaceV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)VLanNetworkInterfaceV1_1_3;
  VLanNetworkInterfaceV1_1_3->VLanNetworkInterface = VLanNetworkInterfaceV1_1_3Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("VLanNetworkInterface"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("VLanNetworkInterface"), "VLanNetworkInterface");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("VLanNetworkInterface"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("VLanNetworkInterface"), "VLanNetworkInterface");
...
/**
  The wrapper function of VLanNetworkInterfaceToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
VLanNetworkInterfaceToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return VLanNetworkInterfaceToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_VLanNetworkInterface_V1_1_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_VLanNetworkInterface_V1_1_3_JSON (*((EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_VLanNetworkInterface_V1_1_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
EFI_STATUS
EFIAPI
VLanNetworkInterfaceDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  VLanNetworkInterfaceV1_1_3 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_3 *)InterpProp;
  DestroyVLanNetworkInterface_V1_1_3_CS (VLanNetworkInterfaceV1_1_3->VLanNetworkInterface); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from VLanNetworkInterfaceFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyVLanNetworkInterface_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_1_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_1_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
