...
//
#include <RedfishJsonStructure/VLanNetworkInterface/v1_1_5/EfiVLanNetworkInterfaceV1_1_5.h>
CHAR8 mResourceTypeStr [] = "#VLanNetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support VLanNetworkInterface V1_1_5
...
{
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_5 *VLanNetworkInterfaceV1_1_5;
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_5_CS *VLanNetworkInterfaceV1_1_5Cs;
  ...
  Status = (EFI_STATUS)Json_VLanNetworkInterface_V1_1_5_To_CS (ResoruceRaw, &VLanNetworkInterfaceV1_1_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VLanNetworkInterfaceV1_1_5 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_5));
  if (VLanNetworkInterfaceV1_1_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)VLanNetworkInterfaceV1_1_5;
  VLanNetworkInterfaceV1_1_5->VLanNetworkInterface = VLanNetworkInterfaceV1_1_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_VLanNetworkInterface_V1_1_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_VLanNetworkInterface_V1_1_5_JSON (*((EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_VLanNetworkInterface_V1_1_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  VLanNetworkInterfaceV1_1_5 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_5 *)InterpProp;
  DestroyVLanNetworkInterface_V1_1_5_CS (VLanNetworkInterfaceV1_1_5->VLanNetworkInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyVLanNetworkInterface_V1_1_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_1_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_1_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
