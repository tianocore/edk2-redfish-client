...
//
#include <RedfishJsonStructure/VLanNetworkInterface/v1_1_4/EfiVLanNetworkInterfaceV1_1_4.h>
CHAR8 mResourceTypeStr [] = "#VLanNetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support VLanNetworkInterface V1_1_4
...
{
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_4 *VLanNetworkInterfaceV1_1_4;
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_4_CS *VLanNetworkInterfaceV1_1_4Cs;
  ...
  Status = (EFI_STATUS)Json_VLanNetworkInterface_V1_1_4_To_CS (ResoruceRaw, &VLanNetworkInterfaceV1_1_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VLanNetworkInterfaceV1_1_4 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_4));
  if (VLanNetworkInterfaceV1_1_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)VLanNetworkInterfaceV1_1_4;
  VLanNetworkInterfaceV1_1_4->VLanNetworkInterface = VLanNetworkInterfaceV1_1_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_VLanNetworkInterface_V1_1_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_VLanNetworkInterface_V1_1_4_JSON (*((EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_VLanNetworkInterface_V1_1_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  VLanNetworkInterfaceV1_1_4 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_1_4 *)InterpProp;
  DestroyVLanNetworkInterface_V1_1_4_CS (VLanNetworkInterfaceV1_1_4->VLanNetworkInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyVLanNetworkInterface_V1_1_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_1_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_1_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
