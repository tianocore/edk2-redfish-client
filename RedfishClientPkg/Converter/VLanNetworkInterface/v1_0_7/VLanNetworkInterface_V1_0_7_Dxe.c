...
//
#include <RedfishJsonStructure/VLanNetworkInterface/v1_0_7/EfiVLanNetworkInterfaceV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#VLanNetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support VLanNetworkInterface V1_0_7
...
{
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_7 *VLanNetworkInterfaceV1_0_7;
  ...
  Status = (EFI_STATUS)Json_VLanNetworkInterface_V1_0_7_To_CS (ResoruceRaw, &VLanNetworkInterfaceV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VLanNetworkInterfaceV1_0_7 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_7));
  if (VLanNetworkInterfaceV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)VLanNetworkInterfaceV1_0_7;
  VLanNetworkInterfaceV1_0_7->VLanNetworkInterface = VLanNetworkInterfaceV1_0_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_VLanNetworkInterface_V1_0_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_VLanNetworkInterface_V1_0_7_JSON (*((EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_VLanNetworkInterface_V1_0_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  VLanNetworkInterfaceV1_0_7 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_7 *)InterpProp;
  DestroyVLanNetworkInterface_V1_0_7_CS (VLanNetworkInterfaceV1_0_7->VLanNetworkInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyVLanNetworkInterface_V1_0_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_0_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_0_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
