...
//
#include <RedfishJsonStructure/VLanNetworkInterface/v1_2_0/EfiVLanNetworkInterfaceV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#VLanNetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support VLanNetworkInterface V1_2_0
...
{
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_2_0 *VLanNetworkInterfaceV1_2_0;
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_2_0_CS *VLanNetworkInterfaceV1_2_0Cs;
  ...
  Status = (EFI_STATUS)Json_VLanNetworkInterface_V1_2_0_To_CS (ResoruceRaw, &VLanNetworkInterfaceV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VLanNetworkInterfaceV1_2_0 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_2_0));
  if (VLanNetworkInterfaceV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)VLanNetworkInterfaceV1_2_0;
  VLanNetworkInterfaceV1_2_0->VLanNetworkInterface = VLanNetworkInterfaceV1_2_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_VLanNetworkInterface_V1_2_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_VLanNetworkInterface_V1_2_0_JSON (*((EFI_REDFISH_VLANNETWORKINTERFACE_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_VLanNetworkInterface_V1_2_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  VLanNetworkInterfaceV1_2_0 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_2_0 *)InterpProp;
  DestroyVLanNetworkInterface_V1_2_0_CS (VLanNetworkInterfaceV1_2_0->VLanNetworkInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyVLanNetworkInterface_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_2_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_2_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
