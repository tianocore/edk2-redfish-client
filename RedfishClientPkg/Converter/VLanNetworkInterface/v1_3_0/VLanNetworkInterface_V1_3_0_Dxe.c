...
)
{
  ...
  return (EFI_STATUS)CS_To_VLanNetworkInterface_V1_3_0_JSON (*((EFI_REDFISH_VLANNETWORKINTERFACE_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
