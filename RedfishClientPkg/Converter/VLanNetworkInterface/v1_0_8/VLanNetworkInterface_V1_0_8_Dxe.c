...
//
#include <RedfishJsonStructure/VLanNetworkInterface/v1_0_8/EfiVLanNetworkInterfaceV1_0_8.h>
CHAR8 mResourceTypeStr [] = "#VLanNetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support VLanNetworkInterface V1_0_8
...
{
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_8 *VLanNetworkInterfaceV1_0_8;
  EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_8_CS *VLanNetworkInterfaceV1_0_8Cs;
  ...
  Status = (EFI_STATUS)Json_VLanNetworkInterface_V1_0_8_To_CS (ResoruceRaw, &VLanNetworkInterfaceV1_0_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  VLanNetworkInterfaceV1_0_8 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_8));
  if (VLanNetworkInterfaceV1_0_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)VLanNetworkInterfaceV1_0_8;
  VLanNetworkInterfaceV1_0_8->VLanNetworkInterface = VLanNetworkInterfaceV1_0_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_VLanNetworkInterface_V1_0_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_VLanNetworkInterface_V1_0_8_JSON (*((EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_VLanNetworkInterface_V1_0_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  VLanNetworkInterfaceV1_0_8 = (EFI_REDFISH_VLANNETWORKINTERFACE_V1_0_8 *)InterpProp;
  DestroyVLanNetworkInterface_V1_0_8_CS (VLanNetworkInterfaceV1_0_8->VLanNetworkInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyVLanNetworkInterface_V1_0_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_0_8EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishVLanNetworkInterface_V1_0_8Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
