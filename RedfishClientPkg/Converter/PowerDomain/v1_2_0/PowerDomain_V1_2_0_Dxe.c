...
//
#include <RedfishJsonStructure/PowerDomain/v1_2_0/EfiPowerDomainV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#PowerDomain";
BOOLEAN IsRevisonController = TRUE;

// Support PowerDomain V1_2_0
...
{
  EFI_REDFISH_POWERDOMAIN_V1_2_0 *PowerDomainV1_2_0;
  EFI_REDFISH_POWERDOMAIN_V1_2_0_CS *PowerDomainV1_2_0Cs;
  ...
  Status = (EFI_STATUS)Json_PowerDomain_V1_2_0_To_CS (ResoruceRaw, &PowerDomainV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerDomainV1_2_0 = (EFI_REDFISH_POWERDOMAIN_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWERDOMAIN_V1_2_0));
  if (PowerDomainV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerDomainV1_2_0;
  PowerDomainV1_2_0->PowerDomain = PowerDomainV1_2_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PowerDomain_V1_2_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PowerDomain_V1_2_0_JSON (*((EFI_REDFISH_POWERDOMAIN_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PowerDomain_V1_2_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerDomainV1_2_0 = (EFI_REDFISH_POWERDOMAIN_V1_2_0 *)InterpProp;
  DestroyPowerDomain_V1_2_0_CS (PowerDomainV1_2_0->PowerDomain); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPowerDomain_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPowerDomain_V1_2_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPowerDomain_V1_2_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
