...
//
#include <RedfishJsonStructure/PowerDomain/v1_0_0/EfiPowerDomainV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#PowerDomain";
BOOLEAN IsRevisonController = TRUE;

// Support PowerDomain V1_0_0
...
{
  EFI_REDFISH_POWERDOMAIN_V1_0_0 *PowerDomainV1_0_0;
  EFI_REDFISH_POWERDOMAIN_V1_0_0_CS *PowerDomainV1_0_0Cs;
  ...
  Status = (EFI_STATUS)Json_PowerDomain_V1_0_0_To_CS (ResoruceRaw, &PowerDomainV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerDomainV1_0_0 = (EFI_REDFISH_POWERDOMAIN_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWERDOMAIN_V1_0_0));
  if (PowerDomainV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerDomainV1_0_0;
  PowerDomainV1_0_0->PowerDomain = PowerDomainV1_0_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PowerDomain_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PowerDomain_V1_0_0_JSON (*((EFI_REDFISH_POWERDOMAIN_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PowerDomain_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerDomainV1_0_0 = (EFI_REDFISH_POWERDOMAIN_V1_0_0 *)InterpProp;
  DestroyPowerDomain_V1_0_0_CS (PowerDomainV1_0_0->PowerDomain); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPowerDomain_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPowerDomain_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPowerDomain_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
