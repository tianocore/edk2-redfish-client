...
//
#include <RedfishJsonStructure/PowerDomain/v1_0_1/EfiPowerDomainV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#PowerDomain";
BOOLEAN IsRevisonController = TRUE;

// Support PowerDomain V1_0_1
...
{
  EFI_REDFISH_POWERDOMAIN_V1_0_1 *PowerDomainV1_0_1;
  EFI_REDFISH_POWERDOMAIN_V1_0_1_CS *PowerDomainV1_0_1Cs;
  ...
  Status = (EFI_STATUS)Json_PowerDomain_V1_0_1_To_CS (ResoruceRaw, &PowerDomainV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerDomainV1_0_1 = (EFI_REDFISH_POWERDOMAIN_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWERDOMAIN_V1_0_1));
  if (PowerDomainV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerDomainV1_0_1;
  PowerDomainV1_0_1->PowerDomain = PowerDomainV1_0_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PowerDomain_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PowerDomain_V1_0_1_JSON (*((EFI_REDFISH_POWERDOMAIN_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PowerDomain_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerDomainV1_0_1 = (EFI_REDFISH_POWERDOMAIN_V1_0_1 *)InterpProp;
  DestroyPowerDomain_V1_0_1_CS (PowerDomainV1_0_1->PowerDomain); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPowerDomain_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPowerDomain_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPowerDomain_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
