...
//
#include <RedfishJsonStructure/Assembly/v1_2_3/EfiAssemblyV1_2_3.h>
CHAR8 mResourceTypeStr [] = "#Assembly";
BOOLEAN IsRevisonController = TRUE;

// Support Assembly V1_2_3
...
{
  EFI_REDFISH_ASSEMBLY_V1_2_3 *AssemblyV1_2_3;
  EFI_REDFISH_ASSEMBLY_V1_2_3_CS *AssemblyV1_2_3Cs;
  ...
  Status = (EFI_STATUS)Json_Assembly_V1_2_3_To_CS (ResoruceRaw, &AssemblyV1_2_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AssemblyV1_2_3 = (EFI_REDFISH_ASSEMBLY_V1_2_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ASSEMBLY_V1_2_3));
  if (AssemblyV1_2_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AssemblyV1_2_3;
  AssemblyV1_2_3->Assembly = AssemblyV1_2_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Assembly_V1_2_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Assembly_V1_2_3_JSON (*((EFI_REDFISH_ASSEMBLY_V1_2_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Assembly_V1_2_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AssemblyV1_2_3 = (EFI_REDFISH_ASSEMBLY_V1_2_3 *)InterpProp;
  DestroyAssembly_V1_2_3_CS (AssemblyV1_2_3->Assembly); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAssembly_V1_2_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAssembly_V1_2_3EntryPoint (
