...
//
#include <RedfishJsonStructure/Assembly/v1_3_0/EfiAssemblyV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#Assembly";
BOOLEAN IsRevisonController = TRUE;

// Support Assembly V1_3_0
...
{
  EFI_REDFISH_ASSEMBLY_V1_3_0 *AssemblyV1_3_0;
  EFI_REDFISH_ASSEMBLY_V1_3_0_CS *AssemblyV1_3_0Cs;
  ...
  Status = (EFI_STATUS)Json_Assembly_V1_3_0_To_CS (ResoruceRaw, &AssemblyV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AssemblyV1_3_0 = (EFI_REDFISH_ASSEMBLY_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ASSEMBLY_V1_3_0));
  if (AssemblyV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AssemblyV1_3_0;
  AssemblyV1_3_0->Assembly = AssemblyV1_3_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Assembly_V1_3_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Assembly_V1_3_0_JSON (*((EFI_REDFISH_ASSEMBLY_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Assembly_V1_3_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AssemblyV1_3_0 = (EFI_REDFISH_ASSEMBLY_V1_3_0 *)InterpProp;
  DestroyAssembly_V1_3_0_CS (AssemblyV1_3_0->Assembly); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAssembly_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAssembly_V1_3_0EntryPoint (
