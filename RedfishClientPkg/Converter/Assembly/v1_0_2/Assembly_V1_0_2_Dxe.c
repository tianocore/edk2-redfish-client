...
//
#include <RedfishJsonStructure/Assembly/v1_0_2/EfiAssemblyV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#Assembly";
BOOLEAN IsRevisonController = TRUE;

// Support Assembly V1_0_2
...
{
  EFI_REDFISH_ASSEMBLY_V1_0_2 *AssemblyV1_0_2;
  EFI_REDFISH_ASSEMBLY_V1_0_2_CS *AssemblyV1_0_2Cs;
  ...
  Status = (EFI_STATUS)Json_Assembly_V1_0_2_To_CS (ResoruceRaw, &AssemblyV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AssemblyV1_0_2 = (EFI_REDFISH_ASSEMBLY_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ASSEMBLY_V1_0_2));
  if (AssemblyV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AssemblyV1_0_2;
  AssemblyV1_0_2->Assembly = AssemblyV1_0_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Assembly_V1_0_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Assembly_V1_0_2_JSON (*((EFI_REDFISH_ASSEMBLY_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Assembly_V1_0_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AssemblyV1_0_2 = (EFI_REDFISH_ASSEMBLY_V1_0_2 *)InterpProp;
  DestroyAssembly_V1_0_2_CS (AssemblyV1_0_2->Assembly); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAssembly_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAssembly_V1_0_2EntryPoint (
