...
)
{
  ...
  return (EFI_STATUS)CS_To_ConnectionCollection_JSON (*((EFI_REDFISH_CONNECTIONCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
