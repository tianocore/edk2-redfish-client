...
//
#include <RedfishJsonStructure/Connection/v1_0_0/EfiConnectionV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#Connection";
BOOLEAN IsRevisonController = TRUE;

// Support Connection V1_0_0
...
{
  EFI_REDFISH_CONNECTION_V1_0_0 *ConnectionV1_0_0;
  EFI_REDFISH_CONNECTION_V1_0_0_CS *ConnectionV1_0_0Cs;
  ...
  Status = (EFI_STATUS)Json_Connection_V1_0_0_To_CS (ResoruceRaw, &ConnectionV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ConnectionV1_0_0 = (EFI_REDFISH_CONNECTION_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CONNECTION_V1_0_0));
  if (ConnectionV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ConnectionV1_0_0;
  ConnectionV1_0_0->Connection = ConnectionV1_0_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Connection_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Connection_V1_0_0_JSON (*((EFI_REDFISH_CONNECTION_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Connection_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ConnectionV1_0_0 = (EFI_REDFISH_CONNECTION_V1_0_0 *)InterpProp;
  DestroyConnection_V1_0_0_CS (ConnectionV1_0_0->Connection); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyConnection_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishConnection_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishConnection_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
