...
)
{
  ...
  return (EFI_STATUS)CS_To_ExternalAccountProviderCollection_JSON (*((EFI_REDFISH_EXTERNALACCOUNTPROVIDERCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
