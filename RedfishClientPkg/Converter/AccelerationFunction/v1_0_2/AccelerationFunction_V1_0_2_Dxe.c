...
//
#include <RedfishJsonStructure/AccelerationFunction/v1_0_2/EfiAccelerationFunctionV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#AccelerationFunction";
BOOLEAN IsRevisonController = TRUE;

// Support AccelerationFunction V1_0_2
...
{
  EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_2 *AccelerationFunctionV1_0_2;
  EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_2_CS *AccelerationFunctionV1_0_2Cs;
  ...
  Status = (EFI_STATUS)Json_AccelerationFunction_V1_0_2_To_CS (ResoruceRaw, &AccelerationFunctionV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccelerationFunctionV1_0_2 = (EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_2));
  if (AccelerationFunctionV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AccelerationFunctionV1_0_2;
  AccelerationFunctionV1_0_2->AccelerationFunction = AccelerationFunctionV1_0_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AccelerationFunction_V1_0_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AccelerationFunction_V1_0_2_JSON (*((EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AccelerationFunction_V1_0_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AccelerationFunctionV1_0_2 = (EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_2 *)InterpProp;
  DestroyAccelerationFunction_V1_0_2_CS (AccelerationFunctionV1_0_2->AccelerationFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAccelerationFunction_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccelerationFunction_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccelerationFunction_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
