...
//
#include <RedfishJsonStructure/AccelerationFunction/v1_0_3/EfiAccelerationFunctionV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#AccelerationFunction";
BOOLEAN IsRevisonController = TRUE;

// Support AccelerationFunction V1_0_3
...
{
  EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_3 *AccelerationFunctionV1_0_3;
  EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_3_CS *AccelerationFunctionV1_0_3Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "AccelerationFunction") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_AccelerationFunction_V1_0_3_To_CS (ResoruceRaw, &AccelerationFunctionV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccelerationFunctionV1_0_3 = (EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_3));
  if (AccelerationFunctionV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AccelerationFunctionV1_0_3;
  AccelerationFunctionV1_0_3->AccelerationFunction = AccelerationFunctionV1_0_3Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("AccelerationFunction"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("AccelerationFunction"), "AccelerationFunction");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("AccelerationFunction"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("AccelerationFunction"), "AccelerationFunction");
...
/**
  The wrapper function of AccelerationFunctionToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
AccelerationFunctionToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return AccelerationFunctionToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AccelerationFunction_V1_0_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AccelerationFunction_V1_0_3_JSON (*((EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AccelerationFunction_V1_0_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in AccelerationFunctionToStruct.
...
EFI_STATUS
EFIAPI
AccelerationFunctionDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  AccelerationFunctionV1_0_3 = (EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_3 *)InterpProp;
  DestroyAccelerationFunction_V1_0_3_CS (AccelerationFunctionV1_0_3->AccelerationFunction); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from AccelerationFunctionFromStruct
...
EFI_STATUS
EFIAPI
AccelerationFunctionDestoryJson(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL *This,
...
)
{
  ...
  return (EFI_STATUS)DestroyAccelerationFunction_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccelerationFunction_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccelerationFunction_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
