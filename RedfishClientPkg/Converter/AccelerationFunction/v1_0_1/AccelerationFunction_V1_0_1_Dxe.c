...
//
#include <RedfishJsonStructure/AccelerationFunction/v1_0_1/EfiAccelerationFunctionV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#AccelerationFunction";
BOOLEAN IsRevisonController = TRUE;

// Support AccelerationFunction V1_0_1
...
{
  EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_1 *AccelerationFunctionV1_0_1;
  EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_1_CS *AccelerationFunctionV1_0_1Cs;
  ...
  Status = (EFI_STATUS)Json_AccelerationFunction_V1_0_1_To_CS (ResoruceRaw, &AccelerationFunctionV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccelerationFunctionV1_0_1 = (EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_1));
  if (AccelerationFunctionV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AccelerationFunctionV1_0_1;
  AccelerationFunctionV1_0_1->AccelerationFunction = AccelerationFunctionV1_0_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AccelerationFunction_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AccelerationFunction_V1_0_1_JSON (*((EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AccelerationFunction_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AccelerationFunctionV1_0_1 = (EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_1 *)InterpProp;
  DestroyAccelerationFunction_V1_0_1_CS (AccelerationFunctionV1_0_1->AccelerationFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAccelerationFunction_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccelerationFunction_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccelerationFunction_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
