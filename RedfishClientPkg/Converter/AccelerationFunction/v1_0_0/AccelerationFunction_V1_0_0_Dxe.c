...
//
#include <RedfishJsonStructure/AccelerationFunction/v1_0_0/EfiAccelerationFunctionV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#AccelerationFunction";
BOOLEAN IsRevisonController = TRUE;

// Support AccelerationFunction V1_0_0
...
{
  EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_0 *AccelerationFunctionV1_0_0;
  EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_0_CS *AccelerationFunctionV1_0_0Cs;
  ...
  Status = (EFI_STATUS)Json_AccelerationFunction_V1_0_0_To_CS (ResoruceRaw, &AccelerationFunctionV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AccelerationFunctionV1_0_0 = (EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_0));
  if (AccelerationFunctionV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AccelerationFunctionV1_0_0;
  AccelerationFunctionV1_0_0->AccelerationFunction = AccelerationFunctionV1_0_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AccelerationFunction_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AccelerationFunction_V1_0_0_JSON (*((EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AccelerationFunction_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AccelerationFunctionV1_0_0 = (EFI_REDFISH_ACCELERATIONFUNCTION_V1_0_0 *)InterpProp;
  DestroyAccelerationFunction_V1_0_0_CS (AccelerationFunctionV1_0_0->AccelerationFunction); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAccelerationFunction_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAccelerationFunction_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAccelerationFunction_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
