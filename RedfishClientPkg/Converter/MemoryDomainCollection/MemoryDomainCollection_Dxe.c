...
)
{
  ...
  return (EFI_STATUS)CS_To_MemoryDomainCollection_JSON (*((EFI_REDFISH_MEMORYDOMAINCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
