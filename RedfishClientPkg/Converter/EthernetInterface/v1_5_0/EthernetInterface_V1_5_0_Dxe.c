...
//
#include <RedfishJsonStructure/EthernetInterface/v1_5_0/EfiEthernetInterfaceV1_5_0.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_5_0
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_5_0 *EthernetInterfaceV1_5_0;
  EFI_REDFISH_ETHERNETINTERFACE_V1_5_0_CS *EthernetInterfaceV1_5_0Cs;
  ...
  Status = (EFI_STATUS)Json_EthernetInterface_V1_5_0_To_CS (ResoruceRaw, &EthernetInterfaceV1_5_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_5_0 = (EFI_REDFISH_ETHERNETINTERFACE_V1_5_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_5_0));
  if (EthernetInterfaceV1_5_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EthernetInterfaceV1_5_0;
  EthernetInterfaceV1_5_0->EthernetInterface = EthernetInterfaceV1_5_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EthernetInterface_V1_5_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EthernetInterface_V1_5_0_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_5_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EthernetInterface_V1_5_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EthernetInterfaceV1_5_0 = (EFI_REDFISH_ETHERNETINTERFACE_V1_5_0 *)InterpProp;
  DestroyEthernetInterface_V1_5_0_CS (EthernetInterfaceV1_5_0->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEthernetInterface_V1_5_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_5_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_5_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
