...
//
#include <RedfishJsonStructure/EthernetInterface/v1_4_3/EfiEthernetInterfaceV1_4_3.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_4_3
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_4_3 *EthernetInterfaceV1_4_3;
  EFI_REDFISH_ETHERNETINTERFACE_V1_4_3_CS *EthernetInterfaceV1_4_3Cs;
  ...
  Status = (EFI_STATUS)Json_EthernetInterface_V1_4_3_To_CS (ResoruceRaw, &EthernetInterfaceV1_4_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_4_3 = (EFI_REDFISH_ETHERNETINTERFACE_V1_4_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_4_3));
  if (EthernetInterfaceV1_4_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EthernetInterfaceV1_4_3;
  EthernetInterfaceV1_4_3->EthernetInterface = EthernetInterfaceV1_4_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EthernetInterface_V1_4_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EthernetInterface_V1_4_3_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_4_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EthernetInterface_V1_4_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EthernetInterfaceV1_4_3 = (EFI_REDFISH_ETHERNETINTERFACE_V1_4_3 *)InterpProp;
  DestroyEthernetInterface_V1_4_3_CS (EthernetInterfaceV1_4_3->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEthernetInterface_V1_4_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_4_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_4_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
