...
)
{
  ...
  return (EFI_STATUS)CS_To_EthernetInterface_V1_4_6_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_4_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
