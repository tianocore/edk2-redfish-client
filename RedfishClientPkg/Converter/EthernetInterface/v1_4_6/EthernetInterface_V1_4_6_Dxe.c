...
//
#include <RedfishJsonStructure/EthernetInterface/v1_4_6/EfiEthernetInterfaceV1_4_6.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_4_6
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_4_6 *EthernetInterfaceV1_4_6;
  EFI_REDFISH_ETHERNETINTERFACE_V1_4_6_CS *EthernetInterfaceV1_4_6Cs;
  ...
  Status = (EFI_STATUS)Json_EthernetInterface_V1_4_6_To_CS (ResoruceRaw, &EthernetInterfaceV1_4_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_4_6 = (EFI_REDFISH_ETHERNETINTERFACE_V1_4_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_4_6));
  if (EthernetInterfaceV1_4_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EthernetInterfaceV1_4_6;
  EthernetInterfaceV1_4_6->EthernetInterface = EthernetInterfaceV1_4_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EthernetInterface_V1_4_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EthernetInterface_V1_4_6_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_4_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EthernetInterface_V1_4_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EthernetInterfaceV1_4_6 = (EFI_REDFISH_ETHERNETINTERFACE_V1_4_6 *)InterpProp;
  DestroyEthernetInterface_V1_4_6_CS (EthernetInterfaceV1_4_6->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEthernetInterface_V1_4_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_4_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_4_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
