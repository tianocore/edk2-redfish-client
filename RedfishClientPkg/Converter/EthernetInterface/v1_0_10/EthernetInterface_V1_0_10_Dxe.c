...
//
#include <RedfishJsonStructure/EthernetInterface/v1_0_10/EfiEthernetInterfaceV1_0_10.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_0_10
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_0_10 *EthernetInterfaceV1_0_10;
  EFI_REDFISH_ETHERNETINTERFACE_V1_0_10_CS *EthernetInterfaceV1_0_10Cs;
  ...
  Status = (EFI_STATUS)Json_EthernetInterface_V1_0_10_To_CS (ResoruceRaw, &EthernetInterfaceV1_0_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_0_10 = (EFI_REDFISH_ETHERNETINTERFACE_V1_0_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_0_10));
  if (EthernetInterfaceV1_0_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EthernetInterfaceV1_0_10;
  EthernetInterfaceV1_0_10->EthernetInterface = EthernetInterfaceV1_0_10Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EthernetInterface_V1_0_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EthernetInterface_V1_0_10_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_0_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EthernetInterface_V1_0_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EthernetInterfaceV1_0_10 = (EFI_REDFISH_ETHERNETINTERFACE_V1_0_10 *)InterpProp;
  DestroyEthernetInterface_V1_0_10_CS (EthernetInterfaceV1_0_10->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEthernetInterface_V1_0_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_0_10EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_0_10Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
