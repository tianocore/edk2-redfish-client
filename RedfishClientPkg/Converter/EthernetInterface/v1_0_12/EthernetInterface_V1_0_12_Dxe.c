...
//
#include <RedfishJsonStructure/EthernetInterface/v1_0_12/EfiEthernetInterfaceV1_0_12.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_0_12
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_0_12 *EthernetInterfaceV1_0_12;
  EFI_REDFISH_ETHERNETINTERFACE_V1_0_12_CS *EthernetInterfaceV1_0_12Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ErrataVersion, "12") != 0) ||
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "EthernetInterface") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_EthernetInterface_V1_0_12_To_CS (ResoruceRaw, &EthernetInterfaceV1_0_12Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_0_12 = (EFI_REDFISH_ETHERNETINTERFACE_V1_0_12 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_0_12));
  if (EthernetInterfaceV1_0_12 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EthernetInterfaceV1_0_12;
  EthernetInterfaceV1_0_12->EthernetInterface = EthernetInterfaceV1_0_12Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "12";
  //
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("EthernetInterface"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("EthernetInterface"), "EthernetInterface");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("EthernetInterface"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("EthernetInterface"), "EthernetInterface");
...
/**
  The wrapper function of EthernetInterfaceToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
EthernetInterfaceToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return EthernetInterfaceToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EthernetInterface_V1_0_12_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EthernetInterface_V1_0_12_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_0_12_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EthernetInterface_V1_0_12_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
EFI_STATUS
EFIAPI
EthernetInterfaceDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  EthernetInterfaceV1_0_12 = (EFI_REDFISH_ETHERNETINTERFACE_V1_0_12 *)InterpProp;
  DestroyEthernetInterface_V1_0_12_CS (EthernetInterfaceV1_0_12->EthernetInterface); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from EthernetInterfaceFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyEthernetInterface_V1_0_12_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_0_12EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_0_12Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
