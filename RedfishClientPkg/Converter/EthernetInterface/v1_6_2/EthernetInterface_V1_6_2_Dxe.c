...
//
#include <RedfishJsonStructure/EthernetInterface/v1_6_2/EfiEthernetInterfaceV1_6_2.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_6_2
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_6_2 *EthernetInterfaceV1_6_2;
  EFI_REDFISH_ETHERNETINTERFACE_V1_6_2_CS *EthernetInterfaceV1_6_2Cs;
  ...
  Status = (EFI_STATUS)Json_EthernetInterface_V1_6_2_To_CS (ResoruceRaw, &EthernetInterfaceV1_6_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_6_2 = (EFI_REDFISH_ETHERNETINTERFACE_V1_6_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_6_2));
  if (EthernetInterfaceV1_6_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EthernetInterfaceV1_6_2;
  EthernetInterfaceV1_6_2->EthernetInterface = EthernetInterfaceV1_6_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EthernetInterface_V1_6_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EthernetInterface_V1_6_2_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_6_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EthernetInterface_V1_6_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EthernetInterfaceV1_6_2 = (EFI_REDFISH_ETHERNETINTERFACE_V1_6_2 *)InterpProp;
  DestroyEthernetInterface_V1_6_2_CS (EthernetInterfaceV1_6_2->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEthernetInterface_V1_6_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_6_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_6_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
