...
//
#include <RedfishJsonStructure/EthernetInterface/v1_6_1/EfiEthernetInterfaceV1_6_1.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_6_1
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_6_1 *EthernetInterfaceV1_6_1;
  EFI_REDFISH_ETHERNETINTERFACE_V1_6_1_CS *EthernetInterfaceV1_6_1Cs;
  ...
  Status = (EFI_STATUS)Json_EthernetInterface_V1_6_1_To_CS (ResoruceRaw, &EthernetInterfaceV1_6_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_6_1 = (EFI_REDFISH_ETHERNETINTERFACE_V1_6_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_6_1));
  if (EthernetInterfaceV1_6_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EthernetInterfaceV1_6_1;
  EthernetInterfaceV1_6_1->EthernetInterface = EthernetInterfaceV1_6_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EthernetInterface_V1_6_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EthernetInterface_V1_6_1_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_6_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EthernetInterface_V1_6_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EthernetInterfaceV1_6_1 = (EFI_REDFISH_ETHERNETINTERFACE_V1_6_1 *)InterpProp;
  DestroyEthernetInterface_V1_6_1_CS (EthernetInterfaceV1_6_1->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEthernetInterface_V1_6_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_6_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_6_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
