...
//
#include <RedfishJsonStructure/EthernetInterface/v1_1_9/EfiEthernetInterfaceV1_1_9.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_1_9
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_1_9 *EthernetInterfaceV1_1_9;
  EFI_REDFISH_ETHERNETINTERFACE_V1_1_9_CS *EthernetInterfaceV1_1_9Cs;
  ...
  Status = (EFI_STATUS)Json_EthernetInterface_V1_1_9_To_CS (ResoruceRaw, &EthernetInterfaceV1_1_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_1_9 = (EFI_REDFISH_ETHERNETINTERFACE_V1_1_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_1_9));
  if (EthernetInterfaceV1_1_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EthernetInterfaceV1_1_9;
  EthernetInterfaceV1_1_9->EthernetInterface = EthernetInterfaceV1_1_9Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EthernetInterface_V1_1_9_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EthernetInterface_V1_1_9_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_1_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EthernetInterface_V1_1_9_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EthernetInterfaceV1_1_9 = (EFI_REDFISH_ETHERNETINTERFACE_V1_1_9 *)InterpProp;
  DestroyEthernetInterface_V1_1_9_CS (EthernetInterfaceV1_1_9->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEthernetInterface_V1_1_9_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_1_9EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_1_9Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
