...
//
#include <RedfishJsonStructure/EthernetInterface/v1_4_7/EfiEthernetInterfaceV1_4_7.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_4_7
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_4_7 *EthernetInterfaceV1_4_7;
  EFI_REDFISH_ETHERNETINTERFACE_V1_4_7_CS *EthernetInterfaceV1_4_7Cs;
  ...
  Status = (EFI_STATUS)Json_EthernetInterface_V1_4_7_To_CS (ResoruceRaw, &EthernetInterfaceV1_4_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_4_7 = (EFI_REDFISH_ETHERNETINTERFACE_V1_4_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_4_7));
  if (EthernetInterfaceV1_4_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EthernetInterfaceV1_4_7;
  EthernetInterfaceV1_4_7->EthernetInterface = EthernetInterfaceV1_4_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EthernetInterface_V1_4_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EthernetInterface_V1_4_7_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_4_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EthernetInterface_V1_4_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EthernetInterfaceV1_4_7 = (EFI_REDFISH_ETHERNETINTERFACE_V1_4_7 *)InterpProp;
  DestroyEthernetInterface_V1_4_7_CS (EthernetInterfaceV1_4_7->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEthernetInterface_V1_4_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_4_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_4_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
