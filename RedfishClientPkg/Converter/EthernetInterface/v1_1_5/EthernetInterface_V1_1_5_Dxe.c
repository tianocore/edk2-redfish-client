...
//
#include <RedfishJsonStructure/EthernetInterface/v1_1_5/EfiEthernetInterfaceV1_1_5.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_1_5
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_1_5 *EthernetInterfaceV1_1_5;
  EFI_REDFISH_ETHERNETINTERFACE_V1_1_5_CS *EthernetInterfaceV1_1_5Cs;
  ...
  Status = (EFI_STATUS)Json_EthernetInterface_V1_1_5_To_CS (ResoruceRaw, &EthernetInterfaceV1_1_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_1_5 = (EFI_REDFISH_ETHERNETINTERFACE_V1_1_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_1_5));
  if (EthernetInterfaceV1_1_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EthernetInterfaceV1_1_5;
  EthernetInterfaceV1_1_5->EthernetInterface = EthernetInterfaceV1_1_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EthernetInterface_V1_1_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EthernetInterface_V1_1_5_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_1_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EthernetInterface_V1_1_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EthernetInterfaceV1_1_5 = (EFI_REDFISH_ETHERNETINTERFACE_V1_1_5 *)InterpProp;
  DestroyEthernetInterface_V1_1_5_CS (EthernetInterfaceV1_1_5->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEthernetInterface_V1_1_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_1_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_1_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
