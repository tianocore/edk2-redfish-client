...
//
#include <RedfishJsonStructure/EthernetInterface/v1_1_8/EfiEthernetInterfaceV1_1_8.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_1_8
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_1_8 *EthernetInterfaceV1_1_8;
  EFI_REDFISH_ETHERNETINTERFACE_V1_1_8_CS *EthernetInterfaceV1_1_8Cs;
  ...
  Status = (EFI_STATUS)Json_EthernetInterface_V1_1_8_To_CS (ResoruceRaw, &EthernetInterfaceV1_1_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_1_8 = (EFI_REDFISH_ETHERNETINTERFACE_V1_1_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_1_8));
  if (EthernetInterfaceV1_1_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EthernetInterfaceV1_1_8;
  EthernetInterfaceV1_1_8->EthernetInterface = EthernetInterfaceV1_1_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EthernetInterface_V1_1_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EthernetInterface_V1_1_8_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_1_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EthernetInterface_V1_1_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EthernetInterfaceV1_1_8 = (EFI_REDFISH_ETHERNETINTERFACE_V1_1_8 *)InterpProp;
  DestroyEthernetInterface_V1_1_8_CS (EthernetInterfaceV1_1_8->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEthernetInterface_V1_1_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_1_8EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_1_8Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
