...
//
#include <RedfishJsonStructure/EthernetInterface/v1_0_11/EfiEthernetInterfaceV1_0_11.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_0_11
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_0_11 *EthernetInterfaceV1_0_11;
  EFI_REDFISH_ETHERNETINTERFACE_V1_0_11_CS *EthernetInterfaceV1_0_11Cs;
  ...
  Status = (EFI_STATUS)Json_EthernetInterface_V1_0_11_To_CS (ResoruceRaw, &EthernetInterfaceV1_0_11Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_0_11 = (EFI_REDFISH_ETHERNETINTERFACE_V1_0_11 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_0_11));
  if (EthernetInterfaceV1_0_11 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EthernetInterfaceV1_0_11;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EthernetInterface_V1_0_11_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EthernetInterface_V1_0_11_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_0_11_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EthernetInterface_V1_0_11_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EthernetInterfaceV1_0_11 = (EFI_REDFISH_ETHERNETINTERFACE_V1_0_11 *)InterpProp;
  DestroyEthernetInterface_V1_0_11_CS (EthernetInterfaceV1_0_11->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEthernetInterface_V1_0_11_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_0_11EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_0_11Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
