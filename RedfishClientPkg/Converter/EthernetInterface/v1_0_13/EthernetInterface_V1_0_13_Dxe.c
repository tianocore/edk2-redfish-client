...
//
#include <RedfishJsonStructure/EthernetInterface/v1_0_13/EfiEthernetInterfaceV1_0_13.h>
CHAR8 mResourceTypeStr [] = "#EthernetInterface";
BOOLEAN IsRevisonController = TRUE;

// Support EthernetInterface V1_0_13
...
{
  EFI_REDFISH_ETHERNETINTERFACE_V1_0_13 *EthernetInterfaceV1_0_13;
  EFI_REDFISH_ETHERNETINTERFACE_V1_0_13_CS *EthernetInterfaceV1_0_13Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ErrataVersion, "13") != 0) ||
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "EthernetInterface") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_EthernetInterface_V1_0_13_To_CS (ResoruceRaw, &EthernetInterfaceV1_0_13Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EthernetInterfaceV1_0_13 = (EFI_REDFISH_ETHERNETINTERFACE_V1_0_13 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ETHERNETINTERFACE_V1_0_13));
  if (EthernetInterfaceV1_0_13 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EthernetInterfaceV1_0_13;
  EthernetInterfaceV1_0_13->EthernetInterface = EthernetInterfaceV1_0_13Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "13";
  //
  // Set header.
  //
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EthernetInterface_V1_0_13_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EthernetInterface_V1_0_13_JSON (*((EFI_REDFISH_ETHERNETINTERFACE_V1_0_13_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EthernetInterface_V1_0_13_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EthernetInterfaceV1_0_13 = (EFI_REDFISH_ETHERNETINTERFACE_V1_0_13 *)InterpProp;
  DestroyEthernetInterface_V1_0_13_CS (EthernetInterfaceV1_0_13->EthernetInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEthernetInterface_V1_0_13_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_0_13EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEthernetInterface_V1_0_13Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
