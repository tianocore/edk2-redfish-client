...
//
#include <RedfishJsonStructure/Aggregate/v1_0_0/EfiAggregateV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#Aggregate";
BOOLEAN IsRevisonController = TRUE;

// Support Aggregate V1_0_0
...
{
  EFI_REDFISH_AGGREGATE_V1_0_0 *AggregateV1_0_0;
  EFI_REDFISH_AGGREGATE_V1_0_0_CS *AggregateV1_0_0Cs;
  ...
  Status = (EFI_STATUS)Json_Aggregate_V1_0_0_To_CS (ResoruceRaw, &AggregateV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AggregateV1_0_0 = (EFI_REDFISH_AGGREGATE_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_AGGREGATE_V1_0_0));
  if (AggregateV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AggregateV1_0_0;
  AggregateV1_0_0->Aggregate = AggregateV1_0_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Aggregate_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Aggregate_V1_0_0_JSON (*((EFI_REDFISH_AGGREGATE_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Aggregate_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AggregateV1_0_0 = (EFI_REDFISH_AGGREGATE_V1_0_0 *)InterpProp;
  DestroyAggregate_V1_0_0_CS (AggregateV1_0_0->Aggregate); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAggregate_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAggregate_V1_0_0EntryPoint (
