...
)
{
  ...
  return (EFI_STATUS)CS_To_SoftwareInventoryCollection_JSON (*((EFI_REDFISH_SOFTWAREINVENTORYCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
