...
//
#include <RedfishJsonStructure/Cable/v1_0_0/EfiCableV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#Cable";
BOOLEAN IsRevisonController = TRUE;

// Support Cable V1_0_0
...
{
  EFI_REDFISH_CABLE_V1_0_0 *CableV1_0_0;
  EFI_REDFISH_CABLE_V1_0_0_CS *CableV1_0_0Cs;
  ...
  Status = (EFI_STATUS)Json_Cable_V1_0_0_To_CS (ResoruceRaw, &CableV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CableV1_0_0 = (EFI_REDFISH_CABLE_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CABLE_V1_0_0));
  if (CableV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)CableV1_0_0;
  CableV1_0_0->Cable = CableV1_0_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Cable_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Cable_V1_0_0_JSON (*((EFI_REDFISH_CABLE_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Cable_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  CableV1_0_0 = (EFI_REDFISH_CABLE_V1_0_0 *)InterpProp;
  DestroyCable_V1_0_0_CS (CableV1_0_0->Cable); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyCable_V1_0_0_Json (ResoruceRaw);
}
