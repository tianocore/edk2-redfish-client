...
)
{
  ...
  return (EFI_STATUS)CS_To_ConnectionMethodCollection_JSON (*((EFI_REDFISH_CONNECTIONMETHODCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
