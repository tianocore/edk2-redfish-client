...
//
#include <RedfishJsonStructure/NetworkAdapterMetrics/v1_0_0/EfiNetworkAdapterMetricsV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#NetworkAdapterMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkAdapterMetrics V1_0_0
...
{
  EFI_REDFISH_NETWORKADAPTERMETRICS_V1_0_0 *NetworkAdapterMetricsV1_0_0;
  EFI_REDFISH_NETWORKADAPTERMETRICS_V1_0_0_CS *NetworkAdapterMetricsV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "NetworkAdapterMetrics") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_NetworkAdapterMetrics_V1_0_0_To_CS (ResoruceRaw, &NetworkAdapterMetricsV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkAdapterMetricsV1_0_0 = (EFI_REDFISH_NETWORKADAPTERMETRICS_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKADAPTERMETRICS_V1_0_0));
  if (NetworkAdapterMetricsV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkAdapterMetricsV1_0_0;
  NetworkAdapterMetricsV1_0_0->NetworkAdapterMetrics = NetworkAdapterMetricsV1_0_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("NetworkAdapterMetrics"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("NetworkAdapterMetrics"), "NetworkAdapterMetrics");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("NetworkAdapterMetrics"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("NetworkAdapterMetrics"), "NetworkAdapterMetrics");
...
/**
  The wrapper function of NetworkAdapterMetricsToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
NetworkAdapterMetricsToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return NetworkAdapterMetricsToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkAdapterMetrics_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkAdapterMetrics_V1_0_0_JSON (*((EFI_REDFISH_NETWORKADAPTERMETRICS_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkAdapterMetrics_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in NetworkAdapterMetricsToStruct.
...
EFI_STATUS
EFIAPI
NetworkAdapterMetricsDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  NetworkAdapterMetricsV1_0_0 = (EFI_REDFISH_NETWORKADAPTERMETRICS_V1_0_0 *)InterpProp;
  DestroyNetworkAdapterMetrics_V1_0_0_CS (NetworkAdapterMetricsV1_0_0->NetworkAdapterMetrics); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from NetworkAdapterMetricsFromStruct
...
EFI_STATUS
EFIAPI
NetworkAdapterMetricsDestoryJson(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL *This,
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkAdapterMetrics_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapterMetrics_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapterMetrics_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
