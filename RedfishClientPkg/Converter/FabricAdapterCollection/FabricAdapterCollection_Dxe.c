...
)
{
  ...
  return (EFI_STATUS)CS_To_FabricAdapterCollection_JSON (*((EFI_REDFISH_FABRICADAPTERCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
