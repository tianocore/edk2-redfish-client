/** @file 
  ...
  Redfish schema.
   - ExternalAccountProvider.v1_0_2 
...
//
#include <RedfishJsonStructure/ExternalAccountProvider/v1_0_2/EfiExternalAccountProviderV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#ExternalAccountProvider";
BOOLEAN IsRevisonController = TRUE;

// Support ExternalAccountProvider V1_0_2
...
{
  EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_2 *ExternalAccountProviderV1_0_2;
  EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_2_CS *ExternalAccountProviderV1_0_2Cs;
  ...
  Status = (EFI_STATUS)Json_ExternalAccountProvider_V1_0_2_To_CS (ResoruceRaw, &ExternalAccountProviderV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ExternalAccountProviderV1_0_2 = (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_2));
  if (ExternalAccountProviderV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ExternalAccountProviderV1_0_2;
  ExternalAccountProviderV1_0_2->ExternalAccountProvider = ExternalAccountProviderV1_0_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ExternalAccountProvider_V1_0_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ExternalAccountProvider_V1_0_2_JSON (*((EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ExternalAccountProvider_V1_0_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ExternalAccountProviderV1_0_2 = (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_2 *)InterpProp;
  DestroyExternalAccountProvider_V1_0_2_CS (ExternalAccountProviderV1_0_2->ExternalAccountProvider); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyExternalAccountProvider_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishExternalAccountProvider_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishExternalAccountProvider_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
