/** @file 
  ...
  Redfish schema.
   - ExternalAccountProvider.v1_2_0 
...
//
#include <RedfishJsonStructure/ExternalAccountProvider/v1_2_0/EfiExternalAccountProviderV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#ExternalAccountProvider";
BOOLEAN IsRevisonController = TRUE;

// Support ExternalAccountProvider V1_2_0
...
{
  EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_2_0 *ExternalAccountProviderV1_2_0;
  EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_2_0_CS *ExternalAccountProviderV1_2_0Cs;
  ...
  Status = (EFI_STATUS)Json_ExternalAccountProvider_V1_2_0_To_CS (ResoruceRaw, &ExternalAccountProviderV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ExternalAccountProviderV1_2_0 = (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_2_0));
  if (ExternalAccountProviderV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ExternalAccountProviderV1_2_0;
  ExternalAccountProviderV1_2_0->ExternalAccountProvider = ExternalAccountProviderV1_2_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ExternalAccountProvider_V1_2_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ExternalAccountProvider_V1_2_0_JSON (*((EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ExternalAccountProvider_V1_2_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ExternalAccountProviderV1_2_0 = (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_2_0 *)InterpProp;
  DestroyExternalAccountProvider_V1_2_0_CS (ExternalAccountProviderV1_2_0->ExternalAccountProvider); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyExternalAccountProvider_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishExternalAccountProvider_V1_2_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishExternalAccountProvider_V1_2_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
