/** @file 
  ...
  Redfish schema.
   - ExternalAccountProvider.v1_1_1 
...
//
#include <RedfishJsonStructure/ExternalAccountProvider/v1_1_1/EfiExternalAccountProviderV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#ExternalAccountProvider";
BOOLEAN IsRevisonController = TRUE;

// Support ExternalAccountProvider V1_1_1
...
{
  EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_1_1 *ExternalAccountProviderV1_1_1;
  EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_1_1_CS *ExternalAccountProviderV1_1_1Cs;
  ...
  Status = (EFI_STATUS)Json_ExternalAccountProvider_V1_1_1_To_CS (ResoruceRaw, &ExternalAccountProviderV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ExternalAccountProviderV1_1_1 = (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_1_1));
  if (ExternalAccountProviderV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ExternalAccountProviderV1_1_1;
  ExternalAccountProviderV1_1_1->ExternalAccountProvider = ExternalAccountProviderV1_1_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ExternalAccountProvider_V1_1_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ExternalAccountProvider_V1_1_1_JSON (*((EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ExternalAccountProvider_V1_1_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ExternalAccountProviderV1_1_1 = (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_1_1 *)InterpProp;
  DestroyExternalAccountProvider_V1_1_1_CS (ExternalAccountProviderV1_1_1->ExternalAccountProvider); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyExternalAccountProvider_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishExternalAccountProvider_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishExternalAccountProvider_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
