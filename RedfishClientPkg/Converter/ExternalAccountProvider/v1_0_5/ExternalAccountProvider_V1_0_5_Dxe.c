/** @file 
  ...
  Redfish schema.
   - ExternalAccountProvider.v1_0_5 
...
//
#include <RedfishJsonStructure/ExternalAccountProvider/v1_0_5/EfiExternalAccountProviderV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#ExternalAccountProvider";
BOOLEAN IsRevisonController = TRUE;

// Support ExternalAccountProvider V1_0_5
...
{
  EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_5 *ExternalAccountProviderV1_0_5;
  EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_5_CS *ExternalAccountProviderV1_0_5Cs;
  ...
  Status = (EFI_STATUS)Json_ExternalAccountProvider_V1_0_5_To_CS (ResoruceRaw, &ExternalAccountProviderV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ExternalAccountProviderV1_0_5 = (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_5));
  if (ExternalAccountProviderV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ExternalAccountProviderV1_0_5;
  ExternalAccountProviderV1_0_5->ExternalAccountProvider = ExternalAccountProviderV1_0_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ExternalAccountProvider_V1_0_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ExternalAccountProvider_V1_0_5_JSON (*((EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ExternalAccountProvider_V1_0_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ExternalAccountProviderV1_0_5 = (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_0_5 *)InterpProp;
  DestroyExternalAccountProvider_V1_0_5_CS (ExternalAccountProviderV1_0_5->ExternalAccountProvider); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyExternalAccountProvider_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishExternalAccountProvider_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishExternalAccountProvider_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
