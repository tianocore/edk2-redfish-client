/** @file 
  ...
  Redfish schema.
   - ExternalAccountProvider.v1_3_0 
...
//
#include <RedfishJsonStructure/ExternalAccountProvider/v1_3_0/EfiExternalAccountProviderV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#ExternalAccountProvider";
BOOLEAN IsRevisonController = TRUE;

// Support ExternalAccountProvider V1_3_0
...
EFI_STATUS
EFIAPI
ExternalAccountProviderToStruct (
...
{
  EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_3_0 *ExternalAccountProviderV1_3_0;
  EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_3_0_CS *ExternalAccountProviderV1_3_0Cs;
  ...
  Status = (EFI_STATUS)Json_ExternalAccountProvider_V1_3_0_To_CS (ResoruceRaw, &ExternalAccountProviderV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ExternalAccountProviderV1_3_0 = (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_3_0));
  if (ExternalAccountProviderV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ExternalAccountProviderV1_3_0;
  ExternalAccountProviderV1_3_0->ExternalAccountProvider = ExternalAccountProviderV1_3_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("ExternalAccountProvider"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("ExternalAccountProvider"), "ExternalAccountProvider");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("ExternalAccountProvider"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("ExternalAccountProvider"), "ExternalAccountProvider");
...
/**
  The wrapper function of ExternalAccountProviderToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
ExternalAccountProviderToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return ExternalAccountProviderToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ExternalAccountProvider_V1_3_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ExternalAccountProvider_V1_3_0_JSON (*((EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ExternalAccountProvider_V1_3_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
EFI_STATUS
EFIAPI
ExternalAccountProviderDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  ExternalAccountProviderV1_3_0 = (EFI_REDFISH_EXTERNALACCOUNTPROVIDER_V1_3_0 *)InterpProp;
  DestroyExternalAccountProvider_V1_3_0_CS (ExternalAccountProviderV1_3_0->ExternalAccountProvider); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ExternalAccountProviderFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyExternalAccountProvider_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishExternalAccountProvider_V1_3_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishExternalAccountProvider_V1_3_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
