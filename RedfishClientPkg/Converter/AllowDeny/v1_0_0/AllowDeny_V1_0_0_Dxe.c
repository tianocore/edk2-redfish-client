...
//
#include <RedfishJsonStructure/AllowDeny/v1_0_0/EfiAllowDenyV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#AllowDeny";
BOOLEAN IsRevisonController = TRUE;

// Support AllowDeny V1_0_0
...
{
  EFI_REDFISH_ALLOWDENY_V1_0_0 *AllowDenyV1_0_0;
  EFI_REDFISH_ALLOWDENY_V1_0_0_CS *AllowDenyV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "AllowDeny") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_AllowDeny_V1_0_0_To_CS (ResoruceRaw, &AllowDenyV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AllowDenyV1_0_0 = (EFI_REDFISH_ALLOWDENY_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ALLOWDENY_V1_0_0));
  if (AllowDenyV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AllowDenyV1_0_0;
  AllowDenyV1_0_0->AllowDeny = AllowDenyV1_0_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("AllowDeny"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("AllowDeny"), "AllowDeny");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("AllowDeny"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("AllowDeny"), "AllowDeny");
...
/**
  The wrapper function of AllowDenyToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AllowDeny_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AllowDeny_V1_0_0_JSON (*((EFI_REDFISH_ALLOWDENY_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AllowDeny_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in AllowDenyToStruct.
...
)
{
  ...
  AllowDenyV1_0_0 = (EFI_REDFISH_ALLOWDENY_V1_0_0 *)InterpProp;
  DestroyAllowDeny_V1_0_0_CS (AllowDenyV1_0_0->AllowDeny); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from AllowDenyFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyAllowDeny_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAllowDeny_V1_0_0EntryPoint (
