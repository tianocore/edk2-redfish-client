...
//
#include <RedfishJsonStructure/StorageController/v1_0_2/EfiStorageControllerV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#StorageController";
BOOLEAN IsRevisonController = TRUE;

// Support StorageController V1_0_2
...
{
  EFI_REDFISH_STORAGECONTROLLER_V1_0_2 *StorageControllerV1_0_2;
  EFI_REDFISH_STORAGECONTROLLER_V1_0_2_CS *StorageControllerV1_0_2Cs;
  ...
  Status = (EFI_STATUS)Json_StorageController_V1_0_2_To_CS (ResoruceRaw, &StorageControllerV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageControllerV1_0_2 = (EFI_REDFISH_STORAGECONTROLLER_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGECONTROLLER_V1_0_2));
  if (StorageControllerV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)StorageControllerV1_0_2;
  StorageControllerV1_0_2->StorageController = StorageControllerV1_0_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_StorageController_V1_0_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_StorageController_V1_0_2_JSON (*((EFI_REDFISH_STORAGECONTROLLER_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_StorageController_V1_0_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  StorageControllerV1_0_2 = (EFI_REDFISH_STORAGECONTROLLER_V1_0_2 *)InterpProp;
  DestroyStorageController_V1_0_2_CS (StorageControllerV1_0_2->StorageController); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyStorageController_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorageController_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishStorageController_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
