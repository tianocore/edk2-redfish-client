...
//
#include <RedfishJsonStructure/StorageController/v1_1_0/EfiStorageControllerV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#StorageController";
BOOLEAN IsRevisonController = TRUE;

// Support StorageController V1_1_0
...
{
  EFI_REDFISH_STORAGECONTROLLER_V1_1_0 *StorageControllerV1_1_0;
  EFI_REDFISH_STORAGECONTROLLER_V1_1_0_CS *StorageControllerV1_1_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "StorageController") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_StorageController_V1_1_0_To_CS (ResoruceRaw, &StorageControllerV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageControllerV1_1_0 = (EFI_REDFISH_STORAGECONTROLLER_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGECONTROLLER_V1_1_0));
  if (StorageControllerV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)StorageControllerV1_1_0;
  StorageControllerV1_1_0->StorageController = StorageControllerV1_1_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("StorageController"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("StorageController"), "StorageController");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("StorageController"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("StorageController"), "StorageController");
...
/**
  The wrapper function of StorageControllerToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
StorageControllerToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return StorageControllerToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_StorageController_V1_1_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_StorageController_V1_1_0_JSON (*((EFI_REDFISH_STORAGECONTROLLER_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_StorageController_V1_1_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in StorageControllerToStruct.
...
EFI_STATUS
EFIAPI
StorageControllerDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  StorageControllerV1_1_0 = (EFI_REDFISH_STORAGECONTROLLER_V1_1_0 *)InterpProp;
  DestroyStorageController_V1_1_0_CS (StorageControllerV1_1_0->StorageController); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from StorageControllerFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyStorageController_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorageController_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishStorageController_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
