...
)
{
  ...
  return (EFI_STATUS)CS_To_StorageController_V1_1_0_JSON (*((EFI_REDFISH_STORAGECONTROLLER_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
