...
//
#include <RedfishJsonStructure/StorageController/v1_1_1/EfiStorageControllerV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#StorageController";
BOOLEAN IsRevisonController = TRUE;

// Support StorageController V1_1_1
...
{
  EFI_REDFISH_STORAGECONTROLLER_V1_1_1 *StorageControllerV1_1_1;
  EFI_REDFISH_STORAGECONTROLLER_V1_1_1_CS *StorageControllerV1_1_1Cs;
  ...
  Status = (EFI_STATUS)Json_StorageController_V1_1_1_To_CS (ResoruceRaw, &StorageControllerV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageControllerV1_1_1 = (EFI_REDFISH_STORAGECONTROLLER_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGECONTROLLER_V1_1_1));
  if (StorageControllerV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)StorageControllerV1_1_1;
  StorageControllerV1_1_1->StorageController = StorageControllerV1_1_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_StorageController_V1_1_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_StorageController_V1_1_1_JSON (*((EFI_REDFISH_STORAGECONTROLLER_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_StorageController_V1_1_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  StorageControllerV1_1_1 = (EFI_REDFISH_STORAGECONTROLLER_V1_1_1 *)InterpProp;
  DestroyStorageController_V1_1_1_CS (StorageControllerV1_1_1->StorageController); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyStorageController_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorageController_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishStorageController_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
