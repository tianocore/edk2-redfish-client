...
//
#include <RedfishJsonStructure/StorageController/v1_3_0/EfiStorageControllerV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#StorageController";
BOOLEAN IsRevisonController = TRUE;

// Support StorageController V1_3_0
...
{
  EFI_REDFISH_STORAGECONTROLLER_V1_3_0 *StorageControllerV1_3_0;
  EFI_REDFISH_STORAGECONTROLLER_V1_3_0_CS *StorageControllerV1_3_0Cs;
  ...
  Status = (EFI_STATUS)Json_StorageController_V1_3_0_To_CS (ResoruceRaw, &StorageControllerV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  StorageControllerV1_3_0 = (EFI_REDFISH_STORAGECONTROLLER_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_STORAGECONTROLLER_V1_3_0));
  if (StorageControllerV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)StorageControllerV1_3_0;
  StorageControllerV1_3_0->StorageController = StorageControllerV1_3_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_StorageController_V1_3_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_StorageController_V1_3_0_JSON (*((EFI_REDFISH_STORAGECONTROLLER_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_StorageController_V1_3_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  StorageControllerV1_3_0 = (EFI_REDFISH_STORAGECONTROLLER_V1_3_0 *)InterpProp;
  DestroyStorageController_V1_3_0_CS (StorageControllerV1_3_0->StorageController); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyStorageController_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishStorageController_V1_3_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishStorageController_V1_3_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
