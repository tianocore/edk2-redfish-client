...
//
#include <RedfishJsonStructure/Drive/v1_1_13/EfiDriveV1_1_13.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_1_13
...
{
  EFI_REDFISH_DRIVE_V1_1_13 *DriveV1_1_13;
  EFI_REDFISH_DRIVE_V1_1_13_CS *DriveV1_1_13Cs;
  ...
  Status = (EFI_STATUS)Json_Drive_V1_1_13_To_CS (ResoruceRaw, &DriveV1_1_13Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_1_13 = (EFI_REDFISH_DRIVE_V1_1_13 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_1_13));
  if (DriveV1_1_13 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)DriveV1_1_13;
  DriveV1_1_13->Drive = DriveV1_1_13Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Drive_V1_1_13_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Drive_V1_1_13_JSON (*((EFI_REDFISH_DRIVE_V1_1_13_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Drive_V1_1_13_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  DriveV1_1_13 = (EFI_REDFISH_DRIVE_V1_1_13 *)InterpProp;
  DestroyDrive_V1_1_13_CS (DriveV1_1_13->Drive); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyDrive_V1_1_13_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishDrive_V1_1_13EntryPoint (
