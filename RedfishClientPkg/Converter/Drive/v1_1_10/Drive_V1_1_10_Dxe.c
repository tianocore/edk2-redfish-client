...
//
#include <RedfishJsonStructure/Drive/v1_1_10/EfiDriveV1_1_10.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_1_10
...
{
  EFI_REDFISH_DRIVE_V1_1_10 *DriveV1_1_10;
  EFI_REDFISH_DRIVE_V1_1_10_CS *DriveV1_1_10Cs;
  ...
  Status = (EFI_STATUS)Json_Drive_V1_1_10_To_CS (ResoruceRaw, &DriveV1_1_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_1_10 = (EFI_REDFISH_DRIVE_V1_1_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_1_10));
  if (DriveV1_1_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)DriveV1_1_10;
  DriveV1_1_10->Drive = DriveV1_1_10Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Drive_V1_1_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Drive_V1_1_10_JSON (*((EFI_REDFISH_DRIVE_V1_1_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Drive_V1_1_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  DriveV1_1_10 = (EFI_REDFISH_DRIVE_V1_1_10 *)InterpProp;
  DestroyDrive_V1_1_10_CS (DriveV1_1_10->Drive); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyDrive_V1_1_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishDrive_V1_1_10EntryPoint (
