...
//
#include <RedfishJsonStructure/Drive/v1_0_12/EfiDriveV1_0_12.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_0_12
...
{
  EFI_REDFISH_DRIVE_V1_0_12 *DriveV1_0_12;
  EFI_REDFISH_DRIVE_V1_0_12_CS *DriveV1_0_12Cs;
  ...
  Status = (EFI_STATUS)Json_Drive_V1_0_12_To_CS (ResoruceRaw, &DriveV1_0_12Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_0_12 = (EFI_REDFISH_DRIVE_V1_0_12 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_0_12));
  if (DriveV1_0_12 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)DriveV1_0_12;
  DriveV1_0_12->Drive = DriveV1_0_12Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Drive"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("Drive"), "Drive");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Drive"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("Drive"), "Drive");
...
/**
  The wrapper function of DriveToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Drive_V1_0_12_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Drive_V1_0_12_JSON (*((EFI_REDFISH_DRIVE_V1_0_12_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Drive_V1_0_12_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  DriveV1_0_12 = (EFI_REDFISH_DRIVE_V1_0_12 *)InterpProp;
  DestroyDrive_V1_0_12_CS (DriveV1_0_12->Drive); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from DriveFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyDrive_V1_0_12_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishDrive_V1_0_12EntryPoint (
