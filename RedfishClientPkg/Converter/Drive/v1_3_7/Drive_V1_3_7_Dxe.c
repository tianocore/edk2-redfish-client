...
//
#include <RedfishJsonStructure/Drive/v1_3_7/EfiDriveV1_3_7.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_3_7
...
{
  EFI_REDFISH_DRIVE_V1_3_7 *DriveV1_3_7;
  EFI_REDFISH_DRIVE_V1_3_7_CS *DriveV1_3_7Cs;
  ...
  Status = (EFI_STATUS)Json_Drive_V1_3_7_To_CS (ResoruceRaw, &DriveV1_3_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_3_7 = (EFI_REDFISH_DRIVE_V1_3_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_3_7));
  if (DriveV1_3_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)DriveV1_3_7;
  DriveV1_3_7->Drive = DriveV1_3_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Drive_V1_3_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Drive_V1_3_7_JSON (*((EFI_REDFISH_DRIVE_V1_3_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Drive_V1_3_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  DriveV1_3_7 = (EFI_REDFISH_DRIVE_V1_3_7 *)InterpProp;
  DestroyDrive_V1_3_7_CS (DriveV1_3_7->Drive); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyDrive_V1_3_7_Json (ResoruceRaw);
}
