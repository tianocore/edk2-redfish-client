...
//
#include <RedfishJsonStructure/Drive/v1_6_0/EfiDriveV1_6_0.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_6_0
...
{
  EFI_REDFISH_DRIVE_V1_6_0 *DriveV1_6_0;
  EFI_REDFISH_DRIVE_V1_6_0_CS *DriveV1_6_0Cs;
  ...
  Status = (EFI_STATUS)Json_Drive_V1_6_0_To_CS (ResoruceRaw, &DriveV1_6_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_6_0 = (EFI_REDFISH_DRIVE_V1_6_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_6_0));
  if (DriveV1_6_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)DriveV1_6_0;
  DriveV1_6_0->Drive = DriveV1_6_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Drive_V1_6_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Drive_V1_6_0_JSON (*((EFI_REDFISH_DRIVE_V1_6_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Drive_V1_6_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  DriveV1_6_0 = (EFI_REDFISH_DRIVE_V1_6_0 *)InterpProp;
  DestroyDrive_V1_6_0_CS (DriveV1_6_0->Drive); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyDrive_V1_6_0_Json (ResoruceRaw);
}
