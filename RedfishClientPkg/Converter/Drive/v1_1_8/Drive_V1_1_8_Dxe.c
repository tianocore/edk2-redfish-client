...
//
#include <RedfishJsonStructure/Drive/v1_1_8/EfiDriveV1_1_8.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_1_8
...
{
  EFI_REDFISH_DRIVE_V1_1_8 *DriveV1_1_8;
  EFI_REDFISH_DRIVE_V1_1_8_CS *DriveV1_1_8Cs;
  ...
  Status = (EFI_STATUS)Json_Drive_V1_1_8_To_CS (ResoruceRaw, &DriveV1_1_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_1_8 = (EFI_REDFISH_DRIVE_V1_1_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_1_8));
  if (DriveV1_1_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)DriveV1_1_8;
  DriveV1_1_8->Drive = DriveV1_1_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Drive_V1_1_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Drive_V1_1_8_JSON (*((EFI_REDFISH_DRIVE_V1_1_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Drive_V1_1_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  DriveV1_1_8 = (EFI_REDFISH_DRIVE_V1_1_8 *)InterpProp;
  DestroyDrive_V1_1_8_CS (DriveV1_1_8->Drive); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyDrive_V1_1_8_Json (ResoruceRaw);
}
