...
//
#include <RedfishJsonStructure/Drive/v1_9_1/EfiDriveV1_9_1.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_9_1
...
{
  EFI_REDFISH_DRIVE_V1_9_1 *DriveV1_9_1;
  EFI_REDFISH_DRIVE_V1_9_1_CS *DriveV1_9_1Cs;
  ...
  Status = (EFI_STATUS)Json_Drive_V1_9_1_To_CS (ResoruceRaw, &DriveV1_9_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_9_1 = (EFI_REDFISH_DRIVE_V1_9_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_9_1));
  if (DriveV1_9_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)DriveV1_9_1;
  DriveV1_9_1->Drive = DriveV1_9_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Drive_V1_9_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Drive_V1_9_1_JSON (*((EFI_REDFISH_DRIVE_V1_9_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Drive_V1_9_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  DriveV1_9_1 = (EFI_REDFISH_DRIVE_V1_9_1 *)InterpProp;
  DestroyDrive_V1_9_1_CS (DriveV1_9_1->Drive); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyDrive_V1_9_1_Json (ResoruceRaw);
}
