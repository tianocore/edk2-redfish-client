...
//
#include <RedfishJsonStructure/Drive/v1_2_6/EfiDriveV1_2_6.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_2_6
...
{
  EFI_REDFISH_DRIVE_V1_2_6 *DriveV1_2_6;
  EFI_REDFISH_DRIVE_V1_2_6_CS *DriveV1_2_6Cs;
  ...
  Status = (EFI_STATUS)Json_Drive_V1_2_6_To_CS (ResoruceRaw, &DriveV1_2_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_2_6 = (EFI_REDFISH_DRIVE_V1_2_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_2_6));
  if (DriveV1_2_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)DriveV1_2_6;
  DriveV1_2_6->Drive = DriveV1_2_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Drive_V1_2_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Drive_V1_2_6_JSON (*((EFI_REDFISH_DRIVE_V1_2_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Drive_V1_2_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  DriveV1_2_6 = (EFI_REDFISH_DRIVE_V1_2_6 *)InterpProp;
  DestroyDrive_V1_2_6_CS (DriveV1_2_6->Drive); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyDrive_V1_2_6_Json (ResoruceRaw);
}
