...
//
#include <RedfishJsonStructure/Drive/v1_0_9/EfiDriveV1_0_9.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_0_9
...
{
  EFI_REDFISH_DRIVE_V1_0_9 *DriveV1_0_9;
  EFI_REDFISH_DRIVE_V1_0_9_CS *DriveV1_0_9Cs;
  ...
  Status = (EFI_STATUS)Json_Drive_V1_0_9_To_CS (ResoruceRaw, &DriveV1_0_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_0_9 = (EFI_REDFISH_DRIVE_V1_0_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_0_9));
  if (DriveV1_0_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)DriveV1_0_9;
  DriveV1_0_9->Drive = DriveV1_0_9Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Drive_V1_0_9_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Drive_V1_0_9_JSON (*((EFI_REDFISH_DRIVE_V1_0_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Drive_V1_0_9_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  DriveV1_0_9 = (EFI_REDFISH_DRIVE_V1_0_9 *)InterpProp;
  DestroyDrive_V1_0_9_CS (DriveV1_0_9->Drive); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyDrive_V1_0_9_Json (ResoruceRaw);
}
