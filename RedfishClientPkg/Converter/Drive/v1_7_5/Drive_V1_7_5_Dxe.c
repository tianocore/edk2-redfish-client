...
//
#include <RedfishJsonStructure/Drive/v1_7_5/EfiDriveV1_7_5.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_7_5
...
{
  EFI_REDFISH_DRIVE_V1_7_5 *DriveV1_7_5;
  EFI_REDFISH_DRIVE_V1_7_5_CS *DriveV1_7_5Cs;
  ...
  Status = (EFI_STATUS)Json_Drive_V1_7_5_To_CS (ResoruceRaw, &DriveV1_7_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_7_5 = (EFI_REDFISH_DRIVE_V1_7_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_7_5));
  if (DriveV1_7_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)DriveV1_7_5;
  DriveV1_7_5->Drive = DriveV1_7_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Drive_V1_7_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Drive_V1_7_5_JSON (*((EFI_REDFISH_DRIVE_V1_7_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Drive_V1_7_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  DriveV1_7_5 = (EFI_REDFISH_DRIVE_V1_7_5 *)InterpProp;
  DestroyDrive_V1_7_5_CS (DriveV1_7_5->Drive); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyDrive_V1_7_5_Json (ResoruceRaw);
}
