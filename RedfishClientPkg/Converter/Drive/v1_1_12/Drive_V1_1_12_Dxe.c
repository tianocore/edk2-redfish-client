...
//
#include <RedfishJsonStructure/Drive/v1_1_12/EfiDriveV1_1_12.h>
CHAR8 mResourceTypeStr [] = "#Drive";
BOOLEAN IsRevisonController = TRUE;

// Support Drive V1_1_12
...
{
  EFI_REDFISH_DRIVE_V1_1_12 *DriveV1_1_12;
  EFI_REDFISH_DRIVE_V1_1_12_CS *DriveV1_1_12Cs;
  ...
  Status = (EFI_STATUS)Json_Drive_V1_1_12_To_CS (ResoruceRaw, &DriveV1_1_12Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  DriveV1_1_12 = (EFI_REDFISH_DRIVE_V1_1_12 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_DRIVE_V1_1_12));
  if (DriveV1_1_12 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)DriveV1_1_12;
  DriveV1_1_12->Drive = DriveV1_1_12Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Drive_V1_1_12_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Drive_V1_1_12_JSON (*((EFI_REDFISH_DRIVE_V1_1_12_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Drive_V1_1_12_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  DriveV1_1_12 = (EFI_REDFISH_DRIVE_V1_1_12 *)InterpProp;
  DestroyDrive_V1_1_12_CS (DriveV1_1_12->Drive); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyDrive_V1_1_12_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishDrive_V1_1_12EntryPoint (
