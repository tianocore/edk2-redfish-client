...
//
#include <RedfishJsonStructure/EventDestination/v1_0_10/EfiEventDestinationV1_0_10.h>
CHAR8 mResourceTypeStr [] = "#EventDestination";
BOOLEAN IsRevisonController = TRUE;

// Support EventDestination V1_0_10
...
{
  EFI_REDFISH_EVENTDESTINATION_V1_0_10 *EventDestinationV1_0_10;
  EFI_REDFISH_EVENTDESTINATION_V1_0_10_CS *EventDestinationV1_0_10Cs;
  ...
  Status = (EFI_STATUS)Json_EventDestination_V1_0_10_To_CS (ResoruceRaw, &EventDestinationV1_0_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventDestinationV1_0_10 = (EFI_REDFISH_EVENTDESTINATION_V1_0_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTDESTINATION_V1_0_10));
  if (EventDestinationV1_0_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventDestinationV1_0_10;
  EventDestinationV1_0_10->EventDestination = EventDestinationV1_0_10Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("EventDestination"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("EventDestination"), "EventDestination");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("EventDestination"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("EventDestination"), "EventDestination");
...
/**
  The wrapper function of EventDestinationToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
EventDestinationToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return EventDestinationToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EventDestination_V1_0_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EventDestination_V1_0_10_JSON (*((EFI_REDFISH_EVENTDESTINATION_V1_0_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EventDestination_V1_0_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventDestinationV1_0_10 = (EFI_REDFISH_EVENTDESTINATION_V1_0_10 *)InterpProp;
  DestroyEventDestination_V1_0_10_CS (EventDestinationV1_0_10->EventDestination); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from EventDestinationFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyEventDestination_V1_0_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_0_10EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_0_10Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
