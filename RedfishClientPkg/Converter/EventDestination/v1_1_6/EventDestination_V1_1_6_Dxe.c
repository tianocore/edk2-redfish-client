...
//
#include <RedfishJsonStructure/EventDestination/v1_1_6/EfiEventDestinationV1_1_6.h>
CHAR8 mResourceTypeStr [] = "#EventDestination";
BOOLEAN IsRevisonController = TRUE;

// Support EventDestination V1_1_6
...
{
  EFI_REDFISH_EVENTDESTINATION_V1_1_6 *EventDestinationV1_1_6;
  EFI_REDFISH_EVENTDESTINATION_V1_1_6_CS *EventDestinationV1_1_6Cs;
  ...
  Status = (EFI_STATUS)Json_EventDestination_V1_1_6_To_CS (ResoruceRaw, &EventDestinationV1_1_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventDestinationV1_1_6 = (EFI_REDFISH_EVENTDESTINATION_V1_1_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTDESTINATION_V1_1_6));
  if (EventDestinationV1_1_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventDestinationV1_1_6;
  EventDestinationV1_1_6->EventDestination = EventDestinationV1_1_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EventDestination_V1_1_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EventDestination_V1_1_6_JSON (*((EFI_REDFISH_EVENTDESTINATION_V1_1_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EventDestination_V1_1_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventDestinationV1_1_6 = (EFI_REDFISH_EVENTDESTINATION_V1_1_6 *)InterpProp;
  DestroyEventDestination_V1_1_6_CS (EventDestinationV1_1_6->EventDestination); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEventDestination_V1_1_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_1_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_1_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
