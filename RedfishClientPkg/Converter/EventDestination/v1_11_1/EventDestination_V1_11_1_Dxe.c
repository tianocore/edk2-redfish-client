...
//
#include <RedfishJsonStructure/EventDestination/v1_11_1/EfiEventDestinationV1_11_1.h>
CHAR8 mResourceTypeStr [] = "#EventDestination";
BOOLEAN IsRevisonController = TRUE;

// Support EventDestination V1_11_1
...
{
  EFI_REDFISH_EVENTDESTINATION_V1_11_1 *EventDestinationV1_11_1;
  EFI_REDFISH_EVENTDESTINATION_V1_11_1_CS *EventDestinationV1_11_1Cs;
  ...
  Status = (EFI_STATUS)Json_EventDestination_V1_11_1_To_CS (ResoruceRaw, &EventDestinationV1_11_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventDestinationV1_11_1 = (EFI_REDFISH_EVENTDESTINATION_V1_11_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTDESTINATION_V1_11_1));
  if (EventDestinationV1_11_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventDestinationV1_11_1;
  EventDestinationV1_11_1->EventDestination = EventDestinationV1_11_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EventDestination_V1_11_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EventDestination_V1_11_1_JSON (*((EFI_REDFISH_EVENTDESTINATION_V1_11_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EventDestination_V1_11_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventDestinationV1_11_1 = (EFI_REDFISH_EVENTDESTINATION_V1_11_1 *)InterpProp;
  DestroyEventDestination_V1_11_1_CS (EventDestinationV1_11_1->EventDestination); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEventDestination_V1_11_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_11_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_11_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
