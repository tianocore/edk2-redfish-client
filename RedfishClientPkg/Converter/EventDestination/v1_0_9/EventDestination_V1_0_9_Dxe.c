...
//
#include <RedfishJsonStructure/EventDestination/v1_0_9/EfiEventDestinationV1_0_9.h>
CHAR8 mResourceTypeStr [] = "#EventDestination";
BOOLEAN IsRevisonController = TRUE;

// Support EventDestination V1_0_9
...
{
  EFI_REDFISH_EVENTDESTINATION_V1_0_9 *EventDestinationV1_0_9;
  ...
  Status = (EFI_STATUS)Json_EventDestination_V1_0_9_To_CS (ResoruceRaw, &EventDestinationV1_0_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventDestinationV1_0_9 = (EFI_REDFISH_EVENTDESTINATION_V1_0_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTDESTINATION_V1_0_9));
  if (EventDestinationV1_0_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventDestinationV1_0_9;
  EventDestinationV1_0_9->EventDestination = EventDestinationV1_0_9Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EventDestination_V1_0_9_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EventDestination_V1_0_9_JSON (*((EFI_REDFISH_EVENTDESTINATION_V1_0_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EventDestination_V1_0_9_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventDestinationV1_0_9 = (EFI_REDFISH_EVENTDESTINATION_V1_0_9 *)InterpProp;
  DestroyEventDestination_V1_0_9_CS (EventDestinationV1_0_9->EventDestination); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEventDestination_V1_0_9_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_0_9EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_0_9Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
