...
//
#include <RedfishJsonStructure/EventDestination/v1_3_4/EfiEventDestinationV1_3_4.h>
CHAR8 mResourceTypeStr [] = "#EventDestination";
BOOLEAN IsRevisonController = TRUE;

// Support EventDestination V1_3_4
...
{
  EFI_REDFISH_EVENTDESTINATION_V1_3_4 *EventDestinationV1_3_4;
  EFI_REDFISH_EVENTDESTINATION_V1_3_4_CS *EventDestinationV1_3_4Cs;
  ...
  Status = (EFI_STATUS)Json_EventDestination_V1_3_4_To_CS (ResoruceRaw, &EventDestinationV1_3_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventDestinationV1_3_4 = (EFI_REDFISH_EVENTDESTINATION_V1_3_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTDESTINATION_V1_3_4));
  if (EventDestinationV1_3_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventDestinationV1_3_4;
  EventDestinationV1_3_4->EventDestination = EventDestinationV1_3_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EventDestination_V1_3_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EventDestination_V1_3_4_JSON (*((EFI_REDFISH_EVENTDESTINATION_V1_3_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EventDestination_V1_3_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventDestinationV1_3_4 = (EFI_REDFISH_EVENTDESTINATION_V1_3_4 *)InterpProp;
  DestroyEventDestination_V1_3_4_CS (EventDestinationV1_3_4->EventDestination); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEventDestination_V1_3_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_3_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_3_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
