...
)
{
  ...
  return (EFI_STATUS)CS_To_EventDestination_V1_4_0_JSON (*((EFI_REDFISH_EVENTDESTINATION_V1_4_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
