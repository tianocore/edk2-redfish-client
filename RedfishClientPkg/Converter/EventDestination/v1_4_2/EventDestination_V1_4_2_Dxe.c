...
//
#include <RedfishJsonStructure/EventDestination/v1_4_2/EfiEventDestinationV1_4_2.h>
CHAR8 mResourceTypeStr [] = "#EventDestination";
BOOLEAN IsRevisonController = TRUE;

// Support EventDestination V1_4_2
...
{
  EFI_REDFISH_EVENTDESTINATION_V1_4_2 *EventDestinationV1_4_2;
  EFI_REDFISH_EVENTDESTINATION_V1_4_2_CS *EventDestinationV1_4_2Cs;
  ...
  Status = (EFI_STATUS)Json_EventDestination_V1_4_2_To_CS (ResoruceRaw, &EventDestinationV1_4_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventDestinationV1_4_2 = (EFI_REDFISH_EVENTDESTINATION_V1_4_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTDESTINATION_V1_4_2));
  if (EventDestinationV1_4_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventDestinationV1_4_2;
  EventDestinationV1_4_2->EventDestination = EventDestinationV1_4_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EventDestination_V1_4_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EventDestination_V1_4_2_JSON (*((EFI_REDFISH_EVENTDESTINATION_V1_4_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EventDestination_V1_4_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventDestinationV1_4_2 = (EFI_REDFISH_EVENTDESTINATION_V1_4_2 *)InterpProp;
  DestroyEventDestination_V1_4_2_CS (EventDestinationV1_4_2->EventDestination); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEventDestination_V1_4_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_4_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_4_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
