...
//
#include <RedfishJsonStructure/EventDestination/v1_5_0/EfiEventDestinationV1_5_0.h>
CHAR8 mResourceTypeStr [] = "#EventDestination";
BOOLEAN IsRevisonController = TRUE;

// Support EventDestination V1_5_0
...
{
  EFI_REDFISH_EVENTDESTINATION_V1_5_0 *EventDestinationV1_5_0;
  EFI_REDFISH_EVENTDESTINATION_V1_5_0_CS *EventDestinationV1_5_0Cs;
  ...
  Status = (EFI_STATUS)Json_EventDestination_V1_5_0_To_CS (ResoruceRaw, &EventDestinationV1_5_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventDestinationV1_5_0 = (EFI_REDFISH_EVENTDESTINATION_V1_5_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTDESTINATION_V1_5_0));
  if (EventDestinationV1_5_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventDestinationV1_5_0;
  EventDestinationV1_5_0->EventDestination = EventDestinationV1_5_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EventDestination_V1_5_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EventDestination_V1_5_0_JSON (*((EFI_REDFISH_EVENTDESTINATION_V1_5_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EventDestination_V1_5_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventDestinationV1_5_0 = (EFI_REDFISH_EVENTDESTINATION_V1_5_0 *)InterpProp;
  DestroyEventDestination_V1_5_0_CS (EventDestinationV1_5_0->EventDestination); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEventDestination_V1_5_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_5_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_5_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
