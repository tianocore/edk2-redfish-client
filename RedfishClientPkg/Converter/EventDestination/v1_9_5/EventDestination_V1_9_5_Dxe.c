...
//
#include <RedfishJsonStructure/EventDestination/v1_9_5/EfiEventDestinationV1_9_5.h>
CHAR8 mResourceTypeStr [] = "#EventDestination";
BOOLEAN IsRevisonController = TRUE;

// Support EventDestination V1_9_5
...
{
  EFI_REDFISH_EVENTDESTINATION_V1_9_5 *EventDestinationV1_9_5;
  EFI_REDFISH_EVENTDESTINATION_V1_9_5_CS *EventDestinationV1_9_5Cs;
  ...
  Status = (EFI_STATUS)Json_EventDestination_V1_9_5_To_CS (ResoruceRaw, &EventDestinationV1_9_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventDestinationV1_9_5 = (EFI_REDFISH_EVENTDESTINATION_V1_9_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTDESTINATION_V1_9_5));
  if (EventDestinationV1_9_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventDestinationV1_9_5;
  EventDestinationV1_9_5->EventDestination = EventDestinationV1_9_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EventDestination_V1_9_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EventDestination_V1_9_5_JSON (*((EFI_REDFISH_EVENTDESTINATION_V1_9_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EventDestination_V1_9_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventDestinationV1_9_5 = (EFI_REDFISH_EVENTDESTINATION_V1_9_5 *)InterpProp;
  DestroyEventDestination_V1_9_5_CS (EventDestinationV1_9_5->EventDestination); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEventDestination_V1_9_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_9_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventDestination_V1_9_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
