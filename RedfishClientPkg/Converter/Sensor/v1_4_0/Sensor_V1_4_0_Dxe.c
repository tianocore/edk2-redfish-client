...
//
#include <RedfishJsonStructure/Sensor/v1_4_0/EfiSensorV1_4_0.h>
CHAR8 mResourceTypeStr [] = "#Sensor";
BOOLEAN IsRevisonController = TRUE;

// Support Sensor V1_4_0
...
{
  EFI_REDFISH_SENSOR_V1_4_0 *SensorV1_4_0;
  EFI_REDFISH_SENSOR_V1_4_0_CS *SensorV1_4_0Cs;
  ...
  Status = (EFI_STATUS)Json_Sensor_V1_4_0_To_CS (ResoruceRaw, &SensorV1_4_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SensorV1_4_0 = (EFI_REDFISH_SENSOR_V1_4_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SENSOR_V1_4_0));
  if (SensorV1_4_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SensorV1_4_0;
  SensorV1_4_0->Sensor = SensorV1_4_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Sensor_V1_4_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Sensor_V1_4_0_JSON (*((EFI_REDFISH_SENSOR_V1_4_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Sensor_V1_4_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SensorV1_4_0 = (EFI_REDFISH_SENSOR_V1_4_0 *)InterpProp;
  DestroySensor_V1_4_0_CS (SensorV1_4_0->Sensor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySensor_V1_4_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSensor_V1_4_0EntryPoint (
