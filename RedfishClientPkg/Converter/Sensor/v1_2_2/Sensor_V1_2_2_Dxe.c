...
//
#include <RedfishJsonStructure/Sensor/v1_2_2/EfiSensorV1_2_2.h>
CHAR8 mResourceTypeStr [] = "#Sensor";
BOOLEAN IsRevisonController = TRUE;

// Support Sensor V1_2_2
...
{
  EFI_REDFISH_SENSOR_V1_2_2 *SensorV1_2_2;
  EFI_REDFISH_SENSOR_V1_2_2_CS *SensorV1_2_2Cs;
  ...
  Status = (EFI_STATUS)Json_Sensor_V1_2_2_To_CS (ResoruceRaw, &SensorV1_2_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SensorV1_2_2 = (EFI_REDFISH_SENSOR_V1_2_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SENSOR_V1_2_2));
  if (SensorV1_2_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SensorV1_2_2;
  SensorV1_2_2->Sensor = SensorV1_2_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Sensor_V1_2_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Sensor_V1_2_2_JSON (*((EFI_REDFISH_SENSOR_V1_2_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Sensor_V1_2_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SensorV1_2_2 = (EFI_REDFISH_SENSOR_V1_2_2 *)InterpProp;
  DestroySensor_V1_2_2_CS (SensorV1_2_2->Sensor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySensor_V1_2_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSensor_V1_2_2EntryPoint (
