...
//
#include <RedfishJsonStructure/Sensor/v1_0_5/EfiSensorV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#Sensor";
BOOLEAN IsRevisonController = TRUE;

// Support Sensor V1_0_5
...
{
  EFI_REDFISH_SENSOR_V1_0_5 *SensorV1_0_5;
  EFI_REDFISH_SENSOR_V1_0_5_CS *SensorV1_0_5Cs;
  ...
  Status = (EFI_STATUS)Json_Sensor_V1_0_5_To_CS (ResoruceRaw, &SensorV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SensorV1_0_5 = (EFI_REDFISH_SENSOR_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SENSOR_V1_0_5));
  if (SensorV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SensorV1_0_5;
  SensorV1_0_5->Sensor = SensorV1_0_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Sensor_V1_0_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Sensor_V1_0_5_JSON (*((EFI_REDFISH_SENSOR_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Sensor_V1_0_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SensorV1_0_5 = (EFI_REDFISH_SENSOR_V1_0_5 *)InterpProp;
  DestroySensor_V1_0_5_CS (SensorV1_0_5->Sensor); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySensor_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSensor_V1_0_5EntryPoint (
