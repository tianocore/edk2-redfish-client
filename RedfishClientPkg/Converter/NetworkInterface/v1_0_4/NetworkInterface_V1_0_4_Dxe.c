...
//
#include <RedfishJsonStructure/NetworkInterface/v1_0_4/EfiNetworkInterfaceV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#NetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkInterface V1_0_4
...
{
  EFI_REDFISH_NETWORKINTERFACE_V1_0_4 *NetworkInterfaceV1_0_4;
  ...
  Status = (EFI_STATUS)Json_NetworkInterface_V1_0_4_To_CS (ResoruceRaw, &NetworkInterfaceV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkInterfaceV1_0_4 = (EFI_REDFISH_NETWORKINTERFACE_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKINTERFACE_V1_0_4));
  if (NetworkInterfaceV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkInterfaceV1_0_4;
  NetworkInterfaceV1_0_4->NetworkInterface = NetworkInterfaceV1_0_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkInterface_V1_0_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkInterface_V1_0_4_JSON (*((EFI_REDFISH_NETWORKINTERFACE_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkInterface_V1_0_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkInterfaceV1_0_4 = (EFI_REDFISH_NETWORKINTERFACE_V1_0_4 *)InterpProp;
  DestroyNetworkInterface_V1_0_4_CS (NetworkInterfaceV1_0_4->NetworkInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkInterface_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkInterface_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkInterface_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
