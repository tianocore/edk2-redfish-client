...
//
#include <RedfishJsonStructure/NetworkInterface/v1_0_5/EfiNetworkInterfaceV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#NetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkInterface V1_0_5
...
{
  EFI_REDFISH_NETWORKINTERFACE_V1_0_5 *NetworkInterfaceV1_0_5;
  EFI_REDFISH_NETWORKINTERFACE_V1_0_5_CS *NetworkInterfaceV1_0_5Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkInterface_V1_0_5_To_CS (ResoruceRaw, &NetworkInterfaceV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkInterfaceV1_0_5 = (EFI_REDFISH_NETWORKINTERFACE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKINTERFACE_V1_0_5));
  if (NetworkInterfaceV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkInterfaceV1_0_5;
  NetworkInterfaceV1_0_5->NetworkInterface = NetworkInterfaceV1_0_5Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("NetworkInterface"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("NetworkInterface"), "NetworkInterface");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("NetworkInterface"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("NetworkInterface"), "NetworkInterface");
...
/**
  The wrapper function of NetworkInterfaceToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
NetworkInterfaceToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return NetworkInterfaceToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkInterface_V1_0_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkInterface_V1_0_5_JSON (*((EFI_REDFISH_NETWORKINTERFACE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkInterface_V1_0_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkInterfaceV1_0_5 = (EFI_REDFISH_NETWORKINTERFACE_V1_0_5 *)InterpProp;
  DestroyNetworkInterface_V1_0_5_CS (NetworkInterfaceV1_0_5->NetworkInterface); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from NetworkInterfaceFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkInterface_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkInterface_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkInterface_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
