...
)
{
  ...
  return (EFI_STATUS)CS_To_NetworkInterface_V1_0_5_JSON (*((EFI_REDFISH_NETWORKINTERFACE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
