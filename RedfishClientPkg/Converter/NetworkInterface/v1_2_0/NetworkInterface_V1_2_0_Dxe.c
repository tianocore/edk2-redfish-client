...
//
#include <RedfishJsonStructure/NetworkInterface/v1_2_0/EfiNetworkInterfaceV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#NetworkInterface";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkInterface V1_2_0
...
{
  EFI_REDFISH_NETWORKINTERFACE_V1_2_0 *NetworkInterfaceV1_2_0;
  EFI_REDFISH_NETWORKINTERFACE_V1_2_0_CS *NetworkInterfaceV1_2_0Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkInterface_V1_2_0_To_CS (ResoruceRaw, &NetworkInterfaceV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkInterfaceV1_2_0 = (EFI_REDFISH_NETWORKINTERFACE_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKINTERFACE_V1_2_0));
  if (NetworkInterfaceV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkInterfaceV1_2_0;
  NetworkInterfaceV1_2_0->NetworkInterface = NetworkInterfaceV1_2_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkInterface_V1_2_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkInterface_V1_2_0_JSON (*((EFI_REDFISH_NETWORKINTERFACE_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkInterface_V1_2_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkInterfaceV1_2_0 = (EFI_REDFISH_NETWORKINTERFACE_V1_2_0 *)InterpProp;
  DestroyNetworkInterface_V1_2_0_CS (NetworkInterfaceV1_2_0->NetworkInterface); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkInterface_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkInterface_V1_2_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkInterface_V1_2_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
