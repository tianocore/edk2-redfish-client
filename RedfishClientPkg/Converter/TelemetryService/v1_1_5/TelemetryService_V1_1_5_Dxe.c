...
//
#include <RedfishJsonStructure/TelemetryService/v1_1_5/EfiTelemetryServiceV1_1_5.h>
CHAR8 mResourceTypeStr [] = "#TelemetryService";
BOOLEAN IsRevisonController = TRUE;

// Support TelemetryService V1_1_5
...
{
  EFI_REDFISH_TELEMETRYSERVICE_V1_1_5 *TelemetryServiceV1_1_5;
  EFI_REDFISH_TELEMETRYSERVICE_V1_1_5_CS *TelemetryServiceV1_1_5Cs;
  ...
  Status = (EFI_STATUS)Json_TelemetryService_V1_1_5_To_CS (ResoruceRaw, &TelemetryServiceV1_1_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TelemetryServiceV1_1_5 = (EFI_REDFISH_TELEMETRYSERVICE_V1_1_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TELEMETRYSERVICE_V1_1_5));
  if (TelemetryServiceV1_1_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TelemetryServiceV1_1_5;
  TelemetryServiceV1_1_5->TelemetryService = TelemetryServiceV1_1_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_TelemetryService_V1_1_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_TelemetryService_V1_1_5_JSON (*((EFI_REDFISH_TELEMETRYSERVICE_V1_1_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_TelemetryService_V1_1_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TelemetryServiceV1_1_5 = (EFI_REDFISH_TELEMETRYSERVICE_V1_1_5 *)InterpProp;
  DestroyTelemetryService_V1_1_5_CS (TelemetryServiceV1_1_5->TelemetryService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyTelemetryService_V1_1_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTelemetryService_V1_1_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishTelemetryService_V1_1_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
