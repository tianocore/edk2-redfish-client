...
//
#include <RedfishJsonStructure/TelemetryService/v1_0_5/EfiTelemetryServiceV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#TelemetryService";
BOOLEAN IsRevisonController = TRUE;

// Support TelemetryService V1_0_5
...
{
  EFI_REDFISH_TELEMETRYSERVICE_V1_0_5 *TelemetryServiceV1_0_5;
  EFI_REDFISH_TELEMETRYSERVICE_V1_0_5_CS *TelemetryServiceV1_0_5Cs;
  ...
  Status = (EFI_STATUS)Json_TelemetryService_V1_0_5_To_CS (ResoruceRaw, &TelemetryServiceV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TelemetryServiceV1_0_5 = (EFI_REDFISH_TELEMETRYSERVICE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TELEMETRYSERVICE_V1_0_5));
  if (TelemetryServiceV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TelemetryServiceV1_0_5;
  TelemetryServiceV1_0_5->TelemetryService = TelemetryServiceV1_0_5Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("TelemetryService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("TelemetryService"), "TelemetryService");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("TelemetryService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("TelemetryService"), "TelemetryService");
...
/**
  The wrapper function of TelemetryServiceToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
TelemetryServiceToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return TelemetryServiceToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_TelemetryService_V1_0_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_TelemetryService_V1_0_5_JSON (*((EFI_REDFISH_TELEMETRYSERVICE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_TelemetryService_V1_0_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TelemetryServiceV1_0_5 = (EFI_REDFISH_TELEMETRYSERVICE_V1_0_5 *)InterpProp;
  DestroyTelemetryService_V1_0_5_CS (TelemetryServiceV1_0_5->TelemetryService); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from TelemetryServiceFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyTelemetryService_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTelemetryService_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishTelemetryService_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
