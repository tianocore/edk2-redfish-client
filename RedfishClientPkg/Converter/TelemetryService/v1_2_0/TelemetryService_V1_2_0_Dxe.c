...
//
#include <RedfishJsonStructure/TelemetryService/v1_2_0/EfiTelemetryServiceV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#TelemetryService";
BOOLEAN IsRevisonController = TRUE;

// Support TelemetryService V1_2_0
...
{
  EFI_REDFISH_TELEMETRYSERVICE_V1_2_0 *TelemetryServiceV1_2_0;
  EFI_REDFISH_TELEMETRYSERVICE_V1_2_0_CS *TelemetryServiceV1_2_0Cs;
  ...
  Status = (EFI_STATUS)Json_TelemetryService_V1_2_0_To_CS (ResoruceRaw, &TelemetryServiceV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TelemetryServiceV1_2_0 = (EFI_REDFISH_TELEMETRYSERVICE_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TELEMETRYSERVICE_V1_2_0));
  if (TelemetryServiceV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TelemetryServiceV1_2_0;
  TelemetryServiceV1_2_0->TelemetryService = TelemetryServiceV1_2_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_TelemetryService_V1_2_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_TelemetryService_V1_2_0_JSON (*((EFI_REDFISH_TELEMETRYSERVICE_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_TelemetryService_V1_2_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TelemetryServiceV1_2_0 = (EFI_REDFISH_TELEMETRYSERVICE_V1_2_0 *)InterpProp;
  DestroyTelemetryService_V1_2_0_CS (TelemetryServiceV1_2_0->TelemetryService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyTelemetryService_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTelemetryService_V1_2_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishTelemetryService_V1_2_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
