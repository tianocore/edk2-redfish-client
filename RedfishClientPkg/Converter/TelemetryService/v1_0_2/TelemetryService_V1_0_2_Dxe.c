...
//
#include <RedfishJsonStructure/TelemetryService/v1_0_2/EfiTelemetryServiceV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#TelemetryService";
BOOLEAN IsRevisonController = TRUE;

// Support TelemetryService V1_0_2
...
{
  EFI_REDFISH_TELEMETRYSERVICE_V1_0_2 *TelemetryServiceV1_0_2;
  EFI_REDFISH_TELEMETRYSERVICE_V1_0_2_CS *TelemetryServiceV1_0_2Cs;
  ...
  Status = (EFI_STATUS)Json_TelemetryService_V1_0_2_To_CS (ResoruceRaw, &TelemetryServiceV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TelemetryServiceV1_0_2 = (EFI_REDFISH_TELEMETRYSERVICE_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TELEMETRYSERVICE_V1_0_2));
  if (TelemetryServiceV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TelemetryServiceV1_0_2;
  TelemetryServiceV1_0_2->TelemetryService = TelemetryServiceV1_0_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_TelemetryService_V1_0_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_TelemetryService_V1_0_2_JSON (*((EFI_REDFISH_TELEMETRYSERVICE_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_TelemetryService_V1_0_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TelemetryServiceV1_0_2 = (EFI_REDFISH_TELEMETRYSERVICE_V1_0_2 *)InterpProp;
  DestroyTelemetryService_V1_0_2_CS (TelemetryServiceV1_0_2->TelemetryService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyTelemetryService_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTelemetryService_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishTelemetryService_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
