...
//
#include <RedfishJsonStructure/TelemetryService/v1_0_4/EfiTelemetryServiceV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#TelemetryService";
BOOLEAN IsRevisonController = TRUE;

// Support TelemetryService V1_0_4
...
{
  EFI_REDFISH_TELEMETRYSERVICE_V1_0_4 *TelemetryServiceV1_0_4;
  EFI_REDFISH_TELEMETRYSERVICE_V1_0_4_CS *TelemetryServiceV1_0_4Cs;
  ...
  Status = (EFI_STATUS)Json_TelemetryService_V1_0_4_To_CS (ResoruceRaw, &TelemetryServiceV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TelemetryServiceV1_0_4 = (EFI_REDFISH_TELEMETRYSERVICE_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TELEMETRYSERVICE_V1_0_4));
  if (TelemetryServiceV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TelemetryServiceV1_0_4;
  TelemetryServiceV1_0_4->TelemetryService = TelemetryServiceV1_0_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_TelemetryService_V1_0_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_TelemetryService_V1_0_4_JSON (*((EFI_REDFISH_TELEMETRYSERVICE_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_TelemetryService_V1_0_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TelemetryServiceV1_0_4 = (EFI_REDFISH_TELEMETRYSERVICE_V1_0_4 *)InterpProp;
  DestroyTelemetryService_V1_0_4_CS (TelemetryServiceV1_0_4->TelemetryService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyTelemetryService_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTelemetryService_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishTelemetryService_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
