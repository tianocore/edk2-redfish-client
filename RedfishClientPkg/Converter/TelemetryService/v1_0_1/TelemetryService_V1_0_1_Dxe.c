...
//
#include <RedfishJsonStructure/TelemetryService/v1_0_1/EfiTelemetryServiceV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#TelemetryService";
BOOLEAN IsRevisonController = TRUE;

// Support TelemetryService V1_0_1
...
{
  EFI_REDFISH_TELEMETRYSERVICE_V1_0_1 *TelemetryServiceV1_0_1;
  EFI_REDFISH_TELEMETRYSERVICE_V1_0_1_CS *TelemetryServiceV1_0_1Cs;
  ...
  Status = (EFI_STATUS)Json_TelemetryService_V1_0_1_To_CS (ResoruceRaw, &TelemetryServiceV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TelemetryServiceV1_0_1 = (EFI_REDFISH_TELEMETRYSERVICE_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TELEMETRYSERVICE_V1_0_1));
  if (TelemetryServiceV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TelemetryServiceV1_0_1;
  TelemetryServiceV1_0_1->TelemetryService = TelemetryServiceV1_0_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_TelemetryService_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_TelemetryService_V1_0_1_JSON (*((EFI_REDFISH_TELEMETRYSERVICE_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_TelemetryService_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TelemetryServiceV1_0_1 = (EFI_REDFISH_TELEMETRYSERVICE_V1_0_1 *)InterpProp;
  DestroyTelemetryService_V1_0_1_CS (TelemetryServiceV1_0_1->TelemetryService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyTelemetryService_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTelemetryService_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishTelemetryService_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
