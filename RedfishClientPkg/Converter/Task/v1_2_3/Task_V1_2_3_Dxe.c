...
//
#include <RedfishJsonStructure/Task/v1_2_3/EfiTaskV1_2_3.h>
...
{
  EFI_REDFISH_TASK_V1_2_3 *TaskV1_2_3;
  EFI_REDFISH_TASK_V1_2_3_CS *TaskV1_2_3Cs;
  ...
  Status = (EFI_STATUS)Json_Task_V1_2_3_To_CS (ResoruceRaw, &TaskV1_2_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskV1_2_3 = (EFI_REDFISH_TASK_V1_2_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASK_V1_2_3));
  if (TaskV1_2_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TaskV1_2_3;
  TaskV1_2_3->Task = TaskV1_2_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Task_V1_2_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Task_V1_2_3_JSON (*((EFI_REDFISH_TASK_V1_2_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Task_V1_2_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TaskV1_2_3 = (EFI_REDFISH_TASK_V1_2_3 *)InterpProp;
  DestroyTask_V1_2_3_CS (TaskV1_2_3->Task); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyTask_V1_2_3_Json (ResoruceRaw);
}
