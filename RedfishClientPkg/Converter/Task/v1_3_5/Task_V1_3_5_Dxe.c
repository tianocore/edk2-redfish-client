...
//
#include <RedfishJsonStructure/Task/v1_3_5/EfiTaskV1_3_5.h>
...
{
  EFI_REDFISH_TASK_V1_3_5 *TaskV1_3_5;
  EFI_REDFISH_TASK_V1_3_5_CS *TaskV1_3_5Cs;
  ...
  Status = (EFI_STATUS)Json_Task_V1_3_5_To_CS (ResoruceRaw, &TaskV1_3_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskV1_3_5 = (EFI_REDFISH_TASK_V1_3_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASK_V1_3_5));
  if (TaskV1_3_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TaskV1_3_5;
  TaskV1_3_5->Task = TaskV1_3_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Task_V1_3_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Task_V1_3_5_JSON (*((EFI_REDFISH_TASK_V1_3_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Task_V1_3_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TaskV1_3_5 = (EFI_REDFISH_TASK_V1_3_5 *)InterpProp;
  DestroyTask_V1_3_5_CS (TaskV1_3_5->Task); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyTask_V1_3_5_Json (ResoruceRaw);
}
