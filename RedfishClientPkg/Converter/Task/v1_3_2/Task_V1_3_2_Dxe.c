...
//
#include <RedfishJsonStructure/Task/v1_3_2/EfiTaskV1_3_2.h>
...
{
  EFI_REDFISH_TASK_V1_3_2 *TaskV1_3_2;
  EFI_REDFISH_TASK_V1_3_2_CS *TaskV1_3_2Cs;
  ...
  Status = (EFI_STATUS)Json_Task_V1_3_2_To_CS (ResoruceRaw, &TaskV1_3_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskV1_3_2 = (EFI_REDFISH_TASK_V1_3_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASK_V1_3_2));
  if (TaskV1_3_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TaskV1_3_2;
  TaskV1_3_2->Task = TaskV1_3_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Task_V1_3_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Task_V1_3_2_JSON (*((EFI_REDFISH_TASK_V1_3_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Task_V1_3_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TaskV1_3_2 = (EFI_REDFISH_TASK_V1_3_2 *)InterpProp;
  DestroyTask_V1_3_2_CS (TaskV1_3_2->Task); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyTask_V1_3_2_Json (ResoruceRaw);
}
