...
//
#include <RedfishJsonStructure/Task/v1_0_9/EfiTaskV1_0_9.h>
...
{
  EFI_REDFISH_TASK_V1_0_9 *TaskV1_0_9;
  EFI_REDFISH_TASK_V1_0_9_CS *TaskV1_0_9Cs;
  ...
  Status = (EFI_STATUS)Json_Task_V1_0_9_To_CS (ResoruceRaw, &TaskV1_0_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskV1_0_9 = (EFI_REDFISH_TASK_V1_0_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASK_V1_0_9));
  if (TaskV1_0_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TaskV1_0_9;
  TaskV1_0_9->Task = TaskV1_0_9Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Task_V1_0_9_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Task_V1_0_9_JSON (*((EFI_REDFISH_TASK_V1_0_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Task_V1_0_9_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TaskV1_0_9 = (EFI_REDFISH_TASK_V1_0_9 *)InterpProp;
  DestroyTask_V1_0_9_CS (TaskV1_0_9->Task); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyTask_V1_0_9_Json (ResoruceRaw);
}
