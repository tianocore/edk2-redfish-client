...
//
#include <RedfishJsonStructure/Task/v1_0_7/EfiTaskV1_0_7.h>
...
{
  EFI_REDFISH_TASK_V1_0_7 *TaskV1_0_7;
  EFI_REDFISH_TASK_V1_0_7_CS *TaskV1_0_7Cs;
  ...
  Status = (EFI_STATUS)Json_Task_V1_0_7_To_CS (ResoruceRaw, &TaskV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskV1_0_7 = (EFI_REDFISH_TASK_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASK_V1_0_7));
  if (TaskV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TaskV1_0_7;
  TaskV1_0_7->Task = TaskV1_0_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Task_V1_0_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Task_V1_0_7_JSON (*((EFI_REDFISH_TASK_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Task_V1_0_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TaskV1_0_7 = (EFI_REDFISH_TASK_V1_0_7 *)InterpProp;
  DestroyTask_V1_0_7_CS (TaskV1_0_7->Task); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyTask_V1_0_7_Json (ResoruceRaw);
}
