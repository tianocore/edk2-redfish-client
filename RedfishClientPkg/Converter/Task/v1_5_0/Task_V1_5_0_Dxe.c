...
//
#include <RedfishJsonStructure/Task/v1_5_0/EfiTaskV1_5_0.h>
...
{
  EFI_REDFISH_TASK_V1_5_0 *TaskV1_5_0;
  EFI_REDFISH_TASK_V1_5_0_CS *TaskV1_5_0Cs;
  ...
  Status = (EFI_STATUS)Json_Task_V1_5_0_To_CS (ResoruceRaw, &TaskV1_5_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskV1_5_0 = (EFI_REDFISH_TASK_V1_5_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASK_V1_5_0));
  if (TaskV1_5_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TaskV1_5_0;
  TaskV1_5_0->Task = TaskV1_5_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Task_V1_5_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Task_V1_5_0_JSON (*((EFI_REDFISH_TASK_V1_5_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Task_V1_5_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TaskV1_5_0 = (EFI_REDFISH_TASK_V1_5_0 *)InterpProp;
  DestroyTask_V1_5_0_CS (TaskV1_5_0->Task); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyTask_V1_5_0_Json (ResoruceRaw);
}
