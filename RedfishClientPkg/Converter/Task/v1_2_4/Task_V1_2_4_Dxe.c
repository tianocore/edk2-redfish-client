...
//
#include <RedfishJsonStructure/Task/v1_2_4/EfiTaskV1_2_4.h>
...
{
  EFI_REDFISH_TASK_V1_2_4 *TaskV1_2_4;
  EFI_REDFISH_TASK_V1_2_4_CS *TaskV1_2_4Cs;
  ...
  Status = (EFI_STATUS)Json_Task_V1_2_4_To_CS (ResoruceRaw, &TaskV1_2_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TaskV1_2_4 = (EFI_REDFISH_TASK_V1_2_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TASK_V1_2_4));
  if (TaskV1_2_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TaskV1_2_4;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Task_V1_2_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Task_V1_2_4_JSON (*((EFI_REDFISH_TASK_V1_2_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Task_V1_2_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TaskV1_2_4 = (EFI_REDFISH_TASK_V1_2_4 *)InterpProp;
  DestroyTask_V1_2_4_CS (TaskV1_2_4->Task); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyTask_V1_2_4_Json (ResoruceRaw);
}
