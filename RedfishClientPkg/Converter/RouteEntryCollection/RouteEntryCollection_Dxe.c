...
)
{
  ...
  return (EFI_STATUS)CS_To_RouteEntryCollection_JSON (*((EFI_REDFISH_ROUTEENTRYCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
