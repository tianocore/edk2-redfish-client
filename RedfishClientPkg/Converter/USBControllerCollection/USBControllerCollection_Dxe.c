...
)
{
  ...
  return (EFI_STATUS)CS_To_USBControllerCollection_JSON (*((EFI_REDFISH_USBCONTROLLERCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
