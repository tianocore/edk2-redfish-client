...
)
{
  ...
  return (EFI_STATUS)CS_To_AddressPoolCollection_JSON (*((EFI_REDFISH_ADDRESSPOOLCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
