...
//
#include <RedfishJsonStructure/SoftwareInventory/v1_1_3/EfiSoftwareInventoryV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#SoftwareInventory";
BOOLEAN IsRevisonController = TRUE;

// Support SoftwareInventory V1_1_3
...
{
  EFI_REDFISH_SOFTWAREINVENTORY_V1_1_3 *SoftwareInventoryV1_1_3;
  EFI_REDFISH_SOFTWAREINVENTORY_V1_1_3_CS *SoftwareInventoryV1_1_3Cs;
  ...
  Status = (EFI_STATUS)Json_SoftwareInventory_V1_1_3_To_CS (ResoruceRaw, &SoftwareInventoryV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SoftwareInventoryV1_1_3 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SOFTWAREINVENTORY_V1_1_3));
  if (SoftwareInventoryV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SoftwareInventoryV1_1_3;
  SoftwareInventoryV1_1_3->SoftwareInventory = SoftwareInventoryV1_1_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SoftwareInventory_V1_1_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SoftwareInventory_V1_1_3_JSON (*((EFI_REDFISH_SOFTWAREINVENTORY_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SoftwareInventory_V1_1_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SoftwareInventoryV1_1_3 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_1_3 *)InterpProp;
  DestroySoftwareInventory_V1_1_3_CS (SoftwareInventoryV1_1_3->SoftwareInventory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySoftwareInventory_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_1_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_1_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
