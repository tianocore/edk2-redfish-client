...
//
#include <RedfishJsonStructure/SoftwareInventory/v1_2_2/EfiSoftwareInventoryV1_2_2.h>
CHAR8 mResourceTypeStr [] = "#SoftwareInventory";
BOOLEAN IsRevisonController = TRUE;

// Support SoftwareInventory V1_2_2
...
{
  EFI_REDFISH_SOFTWAREINVENTORY_V1_2_2 *SoftwareInventoryV1_2_2;
  EFI_REDFISH_SOFTWAREINVENTORY_V1_2_2_CS *SoftwareInventoryV1_2_2Cs;
  ...
  Status = (EFI_STATUS)Json_SoftwareInventory_V1_2_2_To_CS (ResoruceRaw, &SoftwareInventoryV1_2_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SoftwareInventoryV1_2_2 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_2_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SOFTWAREINVENTORY_V1_2_2));
  if (SoftwareInventoryV1_2_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SoftwareInventoryV1_2_2;
  SoftwareInventoryV1_2_2->SoftwareInventory = SoftwareInventoryV1_2_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SoftwareInventory_V1_2_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SoftwareInventory_V1_2_2_JSON (*((EFI_REDFISH_SOFTWAREINVENTORY_V1_2_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SoftwareInventory_V1_2_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SoftwareInventoryV1_2_2 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_2_2 *)InterpProp;
  DestroySoftwareInventory_V1_2_2_CS (SoftwareInventoryV1_2_2->SoftwareInventory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySoftwareInventory_V1_2_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_2_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_2_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
