...
//
#include <RedfishJsonStructure/SoftwareInventory/v1_3_0/EfiSoftwareInventoryV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#SoftwareInventory";
BOOLEAN IsRevisonController = TRUE;

// Support SoftwareInventory V1_3_0
...
{
  EFI_REDFISH_SOFTWAREINVENTORY_V1_3_0 *SoftwareInventoryV1_3_0;
  EFI_REDFISH_SOFTWAREINVENTORY_V1_3_0_CS *SoftwareInventoryV1_3_0Cs;
  ...
  Status = (EFI_STATUS)Json_SoftwareInventory_V1_3_0_To_CS (ResoruceRaw, &SoftwareInventoryV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SoftwareInventoryV1_3_0 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SOFTWAREINVENTORY_V1_3_0));
  if (SoftwareInventoryV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SoftwareInventoryV1_3_0;
  SoftwareInventoryV1_3_0->SoftwareInventory = SoftwareInventoryV1_3_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SoftwareInventory_V1_3_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SoftwareInventory_V1_3_0_JSON (*((EFI_REDFISH_SOFTWAREINVENTORY_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SoftwareInventory_V1_3_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SoftwareInventoryV1_3_0 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_3_0 *)InterpProp;
  DestroySoftwareInventory_V1_3_0_CS (SoftwareInventoryV1_3_0->SoftwareInventory); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySoftwareInventory_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_3_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_3_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
