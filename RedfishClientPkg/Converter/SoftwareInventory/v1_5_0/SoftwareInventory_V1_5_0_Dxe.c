...
//
#include <RedfishJsonStructure/SoftwareInventory/v1_5_0/EfiSoftwareInventoryV1_5_0.h>
CHAR8 mResourceTypeStr [] = "#SoftwareInventory";
BOOLEAN IsRevisonController = TRUE;

// Support SoftwareInventory V1_5_0
...
{
  EFI_REDFISH_SOFTWAREINVENTORY_V1_5_0 *SoftwareInventoryV1_5_0;
  EFI_REDFISH_SOFTWAREINVENTORY_V1_5_0_CS *SoftwareInventoryV1_5_0Cs;
  ...
  Status = (EFI_STATUS)Json_SoftwareInventory_V1_5_0_To_CS (ResoruceRaw, &SoftwareInventoryV1_5_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SoftwareInventoryV1_5_0 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_5_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SOFTWAREINVENTORY_V1_5_0));
  if (SoftwareInventoryV1_5_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SoftwareInventoryV1_5_0;
  SoftwareInventoryV1_5_0->SoftwareInventory = SoftwareInventoryV1_5_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("SoftwareInventory"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("SoftwareInventory"), "SoftwareInventory");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("SoftwareInventory"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("SoftwareInventory"), "SoftwareInventory");
...
/**
  The wrapper function of SoftwareInventoryToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
SoftwareInventoryToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return SoftwareInventoryToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SoftwareInventory_V1_5_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SoftwareInventory_V1_5_0_JSON (*((EFI_REDFISH_SOFTWAREINVENTORY_V1_5_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SoftwareInventory_V1_5_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
EFI_STATUS
EFIAPI
SoftwareInventoryDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  SoftwareInventoryV1_5_0 = (EFI_REDFISH_SOFTWAREINVENTORY_V1_5_0 *)InterpProp;
  DestroySoftwareInventory_V1_5_0_CS (SoftwareInventoryV1_5_0->SoftwareInventory); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from SoftwareInventoryFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroySoftwareInventory_V1_5_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_5_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSoftwareInventory_V1_5_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
