...
)
{
  ...
  return (EFI_STATUS)CS_To_SoftwareInventory_V1_1_2_JSON (*((EFI_REDFISH_SOFTWAREINVENTORY_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
