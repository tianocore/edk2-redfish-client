...
)
{
  ...
  return (EFI_STATUS)CS_To_MetricReportDefinitionCollection_JSON (*((EFI_REDFISH_METRICREPORTDEFINITIONCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
