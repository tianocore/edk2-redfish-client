...
//
#include <RedfishJsonStructure/PowerSupplyMetrics/v1_0_0/EfiPowerSupplyMetricsV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#PowerSupplyMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support PowerSupplyMetrics V1_0_0
...
{
  EFI_REDFISH_POWERSUPPLYMETRICS_V1_0_0 *PowerSupplyMetricsV1_0_0;
  EFI_REDFISH_POWERSUPPLYMETRICS_V1_0_0_CS *PowerSupplyMetricsV1_0_0Cs;
  ...
  Status = (EFI_STATUS)Json_PowerSupplyMetrics_V1_0_0_To_CS (ResoruceRaw, &PowerSupplyMetricsV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerSupplyMetricsV1_0_0 = (EFI_REDFISH_POWERSUPPLYMETRICS_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWERSUPPLYMETRICS_V1_0_0));
  if (PowerSupplyMetricsV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerSupplyMetricsV1_0_0;
  PowerSupplyMetricsV1_0_0->PowerSupplyMetrics = PowerSupplyMetricsV1_0_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PowerSupplyMetrics_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PowerSupplyMetrics_V1_0_0_JSON (*((EFI_REDFISH_POWERSUPPLYMETRICS_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PowerSupplyMetrics_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerSupplyMetricsV1_0_0 = (EFI_REDFISH_POWERSUPPLYMETRICS_V1_0_0 *)InterpProp;
  DestroyPowerSupplyMetrics_V1_0_0_CS (PowerSupplyMetricsV1_0_0->PowerSupplyMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPowerSupplyMetrics_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPowerSupplyMetrics_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPowerSupplyMetrics_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
