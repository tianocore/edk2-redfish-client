...
//
#include <RedfishJsonStructure/PowerSupplyMetrics/v1_0_1/EfiPowerSupplyMetricsV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#PowerSupplyMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support PowerSupplyMetrics V1_0_1
...
{
  EFI_REDFISH_POWERSUPPLYMETRICS_V1_0_1 *PowerSupplyMetricsV1_0_1;
  EFI_REDFISH_POWERSUPPLYMETRICS_V1_0_1_CS *PowerSupplyMetricsV1_0_1Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "PowerSupplyMetrics") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_PowerSupplyMetrics_V1_0_1_To_CS (ResoruceRaw, &PowerSupplyMetricsV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerSupplyMetricsV1_0_1 = (EFI_REDFISH_POWERSUPPLYMETRICS_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWERSUPPLYMETRICS_V1_0_1));
  if (PowerSupplyMetricsV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerSupplyMetricsV1_0_1;
  PowerSupplyMetricsV1_0_1->PowerSupplyMetrics = PowerSupplyMetricsV1_0_1Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("PowerSupplyMetrics"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("PowerSupplyMetrics"), "PowerSupplyMetrics");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("PowerSupplyMetrics"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("PowerSupplyMetrics"), "PowerSupplyMetrics");
...
/**
  The wrapper function of PowerSupplyMetricsToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
PowerSupplyMetricsToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return PowerSupplyMetricsToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_PowerSupplyMetrics_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_PowerSupplyMetrics_V1_0_1_JSON (*((EFI_REDFISH_POWERSUPPLYMETRICS_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_PowerSupplyMetrics_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in PowerSupplyMetricsToStruct.
...
EFI_STATUS
EFIAPI
PowerSupplyMetricsDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  PowerSupplyMetricsV1_0_1 = (EFI_REDFISH_POWERSUPPLYMETRICS_V1_0_1 *)InterpProp;
  DestroyPowerSupplyMetrics_V1_0_1_CS (PowerSupplyMetricsV1_0_1->PowerSupplyMetrics); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from PowerSupplyMetricsFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyPowerSupplyMetrics_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPowerSupplyMetrics_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishPowerSupplyMetrics_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
