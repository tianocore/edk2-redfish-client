...
)
{
  ...
  return (EFI_STATUS)CS_To_ComponentIntegrityCollection_JSON (*((EFI_REDFISH_COMPONENTINTEGRITYCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
