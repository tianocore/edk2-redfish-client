...
//
#include <RedfishJsonStructure/ComputerSystem/v1_8_4/EfiComputerSystemV1_8_4.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_8_4
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_8_4 *ComputerSystemV1_8_4;
  EFI_REDFISH_COMPUTERSYSTEM_V1_8_4_CS *ComputerSystemV1_8_4Cs;
  ...
  Status = (EFI_STATUS)Json_ComputerSystem_V1_8_4_To_CS (ResoruceRaw, &ComputerSystemV1_8_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_8_4 = (EFI_REDFISH_COMPUTERSYSTEM_V1_8_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_8_4));
  if (ComputerSystemV1_8_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ComputerSystemV1_8_4;
  ComputerSystemV1_8_4->ComputerSystem = ComputerSystemV1_8_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ComputerSystem_V1_8_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ComputerSystem_V1_8_4_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_8_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ComputerSystem_V1_8_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ComputerSystemV1_8_4 = (EFI_REDFISH_COMPUTERSYSTEM_V1_8_4 *)InterpProp;
  DestroyComputerSystem_V1_8_4_CS (ComputerSystemV1_8_4->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyComputerSystem_V1_8_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_8_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_8_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
