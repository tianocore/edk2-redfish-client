...
//
#include <RedfishJsonStructure/ComputerSystem/v1_1_9/EfiComputerSystemV1_1_9.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_1_9
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_1_9 *ComputerSystemV1_1_9;
  EFI_REDFISH_COMPUTERSYSTEM_V1_1_9_CS *ComputerSystemV1_1_9Cs;
  ...
  Status = (EFI_STATUS)Json_ComputerSystem_V1_1_9_To_CS (ResoruceRaw, &ComputerSystemV1_1_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_1_9 = (EFI_REDFISH_COMPUTERSYSTEM_V1_1_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_1_9));
  if (ComputerSystemV1_1_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ComputerSystemV1_1_9;
  ComputerSystemV1_1_9->ComputerSystem = ComputerSystemV1_1_9Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ComputerSystem_V1_1_9_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ComputerSystem_V1_1_9_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_1_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ComputerSystem_V1_1_9_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ComputerSystemV1_1_9 = (EFI_REDFISH_COMPUTERSYSTEM_V1_1_9 *)InterpProp;
  DestroyComputerSystem_V1_1_9_CS (ComputerSystemV1_1_9->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyComputerSystem_V1_1_9_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_1_9EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_1_9Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
