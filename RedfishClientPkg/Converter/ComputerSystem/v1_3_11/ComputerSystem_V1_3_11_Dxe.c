...
//
#include <RedfishJsonStructure/ComputerSystem/v1_3_11/EfiComputerSystemV1_3_11.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_3_11
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_3_11 *ComputerSystemV1_3_11;
  EFI_REDFISH_COMPUTERSYSTEM_V1_3_11_CS *ComputerSystemV1_3_11Cs;
  ...
  Status = (EFI_STATUS)Json_ComputerSystem_V1_3_11_To_CS (ResoruceRaw, &ComputerSystemV1_3_11Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_3_11 = (EFI_REDFISH_COMPUTERSYSTEM_V1_3_11 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_3_11));
  if (ComputerSystemV1_3_11 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ComputerSystemV1_3_11;
  ComputerSystemV1_3_11->ComputerSystem = ComputerSystemV1_3_11Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ComputerSystem_V1_3_11_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ComputerSystem_V1_3_11_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_3_11_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ComputerSystem_V1_3_11_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ComputerSystemV1_3_11 = (EFI_REDFISH_COMPUTERSYSTEM_V1_3_11 *)InterpProp;
  DestroyComputerSystem_V1_3_11_CS (ComputerSystemV1_3_11->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyComputerSystem_V1_3_11_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_3_11EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_3_11Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
