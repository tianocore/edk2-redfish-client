...
)
{
  ...
  EFI_REDFISH_COMPUTERSYSTEM_V1_13_0_CS *ComputerSystemV1_13_0Cs;
  ...
  ComputerSystemV1_13_0 = (EFI_REDFISH_COMPUTERSYSTEM_V1_13_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_13_0));
  if (ComputerSystemV1_13_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ComputerSystemV1_13_0;
  ComputerSystemV1_13_0->ComputerSystem = ComputerSystemV1_13_0Cs;
...
)
{
  ...
  return (EFI_STATUS)DestroyComputerSystem_V1_13_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_13_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_13_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
