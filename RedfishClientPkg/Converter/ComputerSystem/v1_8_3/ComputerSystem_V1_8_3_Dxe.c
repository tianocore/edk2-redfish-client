...
//
#include <RedfishJsonStructure/ComputerSystem/v1_8_3/EfiComputerSystemV1_8_3.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_8_3
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_8_3 *ComputerSystemV1_8_3;
  EFI_REDFISH_COMPUTERSYSTEM_V1_8_3_CS *ComputerSystemV1_8_3Cs;
  ...
  Status = (EFI_STATUS)Json_ComputerSystem_V1_8_3_To_CS (ResoruceRaw, &ComputerSystemV1_8_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_8_3 = (EFI_REDFISH_COMPUTERSYSTEM_V1_8_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_8_3));
  if (ComputerSystemV1_8_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ComputerSystemV1_8_3;
  ComputerSystemV1_8_3->ComputerSystem = ComputerSystemV1_8_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ComputerSystem_V1_8_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ComputerSystem_V1_8_3_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_8_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ComputerSystem_V1_8_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ComputerSystemV1_8_3 = (EFI_REDFISH_COMPUTERSYSTEM_V1_8_3 *)InterpProp;
  DestroyComputerSystem_V1_8_3_CS (ComputerSystemV1_8_3->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyComputerSystem_V1_8_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_8_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_8_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
