...
//
#include <RedfishJsonStructure/ComputerSystem/v1_0_17/EfiComputerSystemV1_0_17.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_0_17
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_0_17 *ComputerSystemV1_0_17;
  EFI_REDFISH_COMPUTERSYSTEM_V1_0_17_CS *ComputerSystemV1_0_17Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ErrataVersion, "17") != 0) ||
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "ComputerSystem") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_ComputerSystem_V1_0_17_To_CS (ResoruceRaw, &ComputerSystemV1_0_17Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_0_17 = (EFI_REDFISH_COMPUTERSYSTEM_V1_0_17 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_0_17));
  if (ComputerSystemV1_0_17 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ComputerSystemV1_0_17;
  ComputerSystemV1_0_17->ComputerSystem = ComputerSystemV1_0_17Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "17";
  //
  // Set header.
  //
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ComputerSystem_V1_0_17_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ComputerSystem_V1_0_17_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_0_17_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ComputerSystem_V1_0_17_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ComputerSystemV1_0_17 = (EFI_REDFISH_COMPUTERSYSTEM_V1_0_17 *)InterpProp;
  DestroyComputerSystem_V1_0_17_CS (ComputerSystemV1_0_17->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyComputerSystem_V1_0_17_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_0_17EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_0_17Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
