...
//
#include <RedfishJsonStructure/ComputerSystem/v1_0_14/EfiComputerSystemV1_0_14.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_0_14
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_0_14 *ComputerSystemV1_0_14;
  EFI_REDFISH_COMPUTERSYSTEM_V1_0_14_CS *ComputerSystemV1_0_14Cs;
  ...
  Status = (EFI_STATUS)Json_ComputerSystem_V1_0_14_To_CS (ResoruceRaw, &ComputerSystemV1_0_14Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_0_14 = (EFI_REDFISH_COMPUTERSYSTEM_V1_0_14 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_0_14));
  if (ComputerSystemV1_0_14 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ComputerSystemV1_0_14;
  ComputerSystemV1_0_14->ComputerSystem = ComputerSystemV1_0_14Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ComputerSystem_V1_0_14_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ComputerSystem_V1_0_14_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_0_14_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ComputerSystem_V1_0_14_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ComputerSystemV1_0_14 = (EFI_REDFISH_COMPUTERSYSTEM_V1_0_14 *)InterpProp;
  DestroyComputerSystem_V1_0_14_CS (ComputerSystemV1_0_14->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyComputerSystem_V1_0_14_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_0_14EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_0_14Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
