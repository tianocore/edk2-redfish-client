...
//
#include <RedfishJsonStructure/ComputerSystem/v1_5_9/EfiComputerSystemV1_5_9.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_5_9
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_5_9 *ComputerSystemV1_5_9;
  EFI_REDFISH_COMPUTERSYSTEM_V1_5_9_CS *ComputerSystemV1_5_9Cs;
  ...
  Status = (EFI_STATUS)Json_ComputerSystem_V1_5_9_To_CS (ResoruceRaw, &ComputerSystemV1_5_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_5_9 = (EFI_REDFISH_COMPUTERSYSTEM_V1_5_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_5_9));
  if (ComputerSystemV1_5_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ComputerSystemV1_5_9;
  ComputerSystemV1_5_9->ComputerSystem = ComputerSystemV1_5_9Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ComputerSystem_V1_5_9_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ComputerSystem_V1_5_9_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_5_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ComputerSystem_V1_5_9_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ComputerSystemV1_5_9 = (EFI_REDFISH_COMPUTERSYSTEM_V1_5_9 *)InterpProp;
  DestroyComputerSystem_V1_5_9_CS (ComputerSystemV1_5_9->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyComputerSystem_V1_5_9_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_5_9EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_5_9Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
