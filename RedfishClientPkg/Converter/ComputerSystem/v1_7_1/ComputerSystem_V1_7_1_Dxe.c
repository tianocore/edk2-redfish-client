...
//
#include <RedfishJsonStructure/ComputerSystem/v1_7_1/EfiComputerSystemV1_7_1.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_7_1
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_7_1 *ComputerSystemV1_7_1;
  EFI_REDFISH_COMPUTERSYSTEM_V1_7_1_CS *ComputerSystemV1_7_1Cs;
  ...
  Status = (EFI_STATUS)Json_ComputerSystem_V1_7_1_To_CS (ResoruceRaw, &ComputerSystemV1_7_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_7_1 = (EFI_REDFISH_COMPUTERSYSTEM_V1_7_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_7_1));
  if (ComputerSystemV1_7_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ComputerSystemV1_7_1;
  ComputerSystemV1_7_1->ComputerSystem = ComputerSystemV1_7_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ComputerSystem_V1_7_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ComputerSystem_V1_7_1_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_7_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ComputerSystem_V1_7_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ComputerSystemV1_7_1 = (EFI_REDFISH_COMPUTERSYSTEM_V1_7_1 *)InterpProp;
  DestroyComputerSystem_V1_7_1_CS (ComputerSystemV1_7_1->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyComputerSystem_V1_7_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_7_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_7_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
