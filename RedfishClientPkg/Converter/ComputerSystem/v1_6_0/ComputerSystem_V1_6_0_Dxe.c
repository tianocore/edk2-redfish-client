...
//
#include <RedfishJsonStructure/ComputerSystem/v1_6_0/EfiComputerSystemV1_6_0.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_6_0
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_6_0 *ComputerSystemV1_6_0;
  EFI_REDFISH_COMPUTERSYSTEM_V1_6_0_CS *ComputerSystemV1_6_0Cs;
  ...
  Status = (EFI_STATUS)Json_ComputerSystem_V1_6_0_To_CS (ResoruceRaw, &ComputerSystemV1_6_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_6_0 = (EFI_REDFISH_COMPUTERSYSTEM_V1_6_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_6_0));
  if (ComputerSystemV1_6_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ComputerSystemV1_6_0;
  ComputerSystemV1_6_0->ComputerSystem = ComputerSystemV1_6_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ComputerSystem_V1_6_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ComputerSystem_V1_6_0_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_6_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ComputerSystem_V1_6_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ComputerSystemV1_6_0 = (EFI_REDFISH_COMPUTERSYSTEM_V1_6_0 *)InterpProp;
  DestroyComputerSystem_V1_6_0_CS (ComputerSystemV1_6_0->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyComputerSystem_V1_6_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_6_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_6_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
