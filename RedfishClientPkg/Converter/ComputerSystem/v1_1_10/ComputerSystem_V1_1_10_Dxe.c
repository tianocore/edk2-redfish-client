...
//
#include <RedfishJsonStructure/ComputerSystem/v1_1_10/EfiComputerSystemV1_1_10.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_1_10
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_1_10 *ComputerSystemV1_1_10;
  EFI_REDFISH_COMPUTERSYSTEM_V1_1_10_CS *ComputerSystemV1_1_10Cs;
  ...
  Status = (EFI_STATUS)Json_ComputerSystem_V1_1_10_To_CS (ResoruceRaw, &ComputerSystemV1_1_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_1_10 = (EFI_REDFISH_COMPUTERSYSTEM_V1_1_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_1_10));
  if (ComputerSystemV1_1_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ComputerSystemV1_1_10;
  ComputerSystemV1_1_10->ComputerSystem = ComputerSystemV1_1_10Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ComputerSystem_V1_1_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ComputerSystem_V1_1_10_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_1_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ComputerSystem_V1_1_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ComputerSystemV1_1_10 = (EFI_REDFISH_COMPUTERSYSTEM_V1_1_10 *)InterpProp;
  DestroyComputerSystem_V1_1_10_CS (ComputerSystemV1_1_10->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyComputerSystem_V1_1_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_1_10EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_1_10Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
