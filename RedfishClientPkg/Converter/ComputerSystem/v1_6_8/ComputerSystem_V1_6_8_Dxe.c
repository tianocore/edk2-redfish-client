...
//
#include <RedfishJsonStructure/ComputerSystem/v1_6_8/EfiComputerSystemV1_6_8.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_6_8
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_6_8 *ComputerSystemV1_6_8;
  EFI_REDFISH_COMPUTERSYSTEM_V1_6_8_CS *ComputerSystemV1_6_8Cs;
  ...
  Status = (EFI_STATUS)Json_ComputerSystem_V1_6_8_To_CS (ResoruceRaw, &ComputerSystemV1_6_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_6_8 = (EFI_REDFISH_COMPUTERSYSTEM_V1_6_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_6_8));
  if (ComputerSystemV1_6_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ComputerSystemV1_6_8;
  ComputerSystemV1_6_8->ComputerSystem = ComputerSystemV1_6_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ComputerSystem_V1_6_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ComputerSystem_V1_6_8_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_6_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ComputerSystem_V1_6_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ComputerSystemV1_6_8 = (EFI_REDFISH_COMPUTERSYSTEM_V1_6_8 *)InterpProp;
  DestroyComputerSystem_V1_6_8_CS (ComputerSystemV1_6_8->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyComputerSystem_V1_6_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_6_8EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_6_8Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
