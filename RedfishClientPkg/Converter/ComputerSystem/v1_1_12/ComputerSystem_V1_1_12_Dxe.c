...
//
#include <RedfishJsonStructure/ComputerSystem/v1_1_12/EfiComputerSystemV1_1_12.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_1_12
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_1_12 *ComputerSystemV1_1_12;
  EFI_REDFISH_COMPUTERSYSTEM_V1_1_12_CS *ComputerSystemV1_1_12Cs;
  ...
  Status = (EFI_STATUS)Json_ComputerSystem_V1_1_12_To_CS (ResoruceRaw, &ComputerSystemV1_1_12Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_1_12 = (EFI_REDFISH_COMPUTERSYSTEM_V1_1_12 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_1_12));
  if (ComputerSystemV1_1_12 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ComputerSystemV1_1_12;
  ComputerSystemV1_1_12->ComputerSystem = ComputerSystemV1_1_12Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ComputerSystem_V1_1_12_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ComputerSystem_V1_1_12_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_1_12_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ComputerSystem_V1_1_12_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ComputerSystemV1_1_12 = (EFI_REDFISH_COMPUTERSYSTEM_V1_1_12 *)InterpProp;
  DestroyComputerSystem_V1_1_12_CS (ComputerSystemV1_1_12->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyComputerSystem_V1_1_12_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_1_12EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_1_12Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
