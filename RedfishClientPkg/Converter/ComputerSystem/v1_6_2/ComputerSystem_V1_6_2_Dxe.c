...
//
#include <RedfishJsonStructure/ComputerSystem/v1_6_2/EfiComputerSystemV1_6_2.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_6_2
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_6_2 *ComputerSystemV1_6_2;
  EFI_REDFISH_COMPUTERSYSTEM_V1_6_2_CS *ComputerSystemV1_6_2Cs;
  ...
  Status = (EFI_STATUS)Json_ComputerSystem_V1_6_2_To_CS (ResoruceRaw, &ComputerSystemV1_6_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_6_2 = (EFI_REDFISH_COMPUTERSYSTEM_V1_6_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_6_2));
  if (ComputerSystemV1_6_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ComputerSystemV1_6_2;
  ComputerSystemV1_6_2->ComputerSystem = ComputerSystemV1_6_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ComputerSystem_V1_6_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ComputerSystem_V1_6_2_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_6_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ComputerSystem_V1_6_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ComputerSystemV1_6_2 = (EFI_REDFISH_COMPUTERSYSTEM_V1_6_2 *)InterpProp;
  DestroyComputerSystem_V1_6_2_CS (ComputerSystemV1_6_2->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyComputerSystem_V1_6_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_6_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_6_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
