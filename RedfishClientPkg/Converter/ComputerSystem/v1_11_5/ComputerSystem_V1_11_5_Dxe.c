...
//
#include <RedfishJsonStructure/ComputerSystem/v1_11_5/EfiComputerSystemV1_11_5.h>
CHAR8 mResourceTypeStr [] = "#ComputerSystem";
BOOLEAN IsRevisonController = TRUE;

// Support ComputerSystem V1_11_5
...
{
  EFI_REDFISH_COMPUTERSYSTEM_V1_11_5 *ComputerSystemV1_11_5;
  EFI_REDFISH_COMPUTERSYSTEM_V1_11_5_CS *ComputerSystemV1_11_5Cs;
  ...
  Status = (EFI_STATUS)Json_ComputerSystem_V1_11_5_To_CS (ResoruceRaw, &ComputerSystemV1_11_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ComputerSystemV1_11_5 = (EFI_REDFISH_COMPUTERSYSTEM_V1_11_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_COMPUTERSYSTEM_V1_11_5));
  if (ComputerSystemV1_11_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ComputerSystemV1_11_5;
  ComputerSystemV1_11_5->ComputerSystem = ComputerSystemV1_11_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ComputerSystem_V1_11_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ComputerSystem_V1_11_5_JSON (*((EFI_REDFISH_COMPUTERSYSTEM_V1_11_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ComputerSystem_V1_11_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ComputerSystemV1_11_5 = (EFI_REDFISH_COMPUTERSYSTEM_V1_11_5 *)InterpProp;
  DestroyComputerSystem_V1_11_5_CS (ComputerSystemV1_11_5->ComputerSystem); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyComputerSystem_V1_11_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_11_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishComputerSystem_V1_11_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
