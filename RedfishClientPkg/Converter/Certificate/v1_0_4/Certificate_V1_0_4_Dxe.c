...
//
#include <RedfishJsonStructure/Certificate/v1_0_4/EfiCertificateV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#Certificate";
BOOLEAN IsRevisonController = TRUE;

// Support Certificate V1_0_4
...
{
  EFI_REDFISH_CERTIFICATE_V1_0_4 *CertificateV1_0_4;
  EFI_REDFISH_CERTIFICATE_V1_0_4_CS *CertificateV1_0_4Cs;
  ...
  Status = (EFI_STATUS)Json_Certificate_V1_0_4_To_CS (ResoruceRaw, &CertificateV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CertificateV1_0_4 = (EFI_REDFISH_CERTIFICATE_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CERTIFICATE_V1_0_4));
  if (CertificateV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)CertificateV1_0_4;
  CertificateV1_0_4->Certificate = CertificateV1_0_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Certificate_V1_0_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Certificate_V1_0_4_JSON (*((EFI_REDFISH_CERTIFICATE_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Certificate_V1_0_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  CertificateV1_0_4 = (EFI_REDFISH_CERTIFICATE_V1_0_4 *)InterpProp;
  DestroyCertificate_V1_0_4_CS (CertificateV1_0_4->Certificate); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyCertificate_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCertificate_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishCertificate_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
