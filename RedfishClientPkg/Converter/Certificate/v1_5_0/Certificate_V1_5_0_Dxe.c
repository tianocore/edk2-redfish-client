...
//
#include <RedfishJsonStructure/Certificate/v1_5_0/EfiCertificateV1_5_0.h>
CHAR8 mResourceTypeStr [] = "#Certificate";
BOOLEAN IsRevisonController = TRUE;

// Support Certificate V1_5_0
...
{
  EFI_REDFISH_CERTIFICATE_V1_5_0 *CertificateV1_5_0;
  EFI_REDFISH_CERTIFICATE_V1_5_0_CS *CertificateV1_5_0Cs;
  ...
  Status = (EFI_STATUS)Json_Certificate_V1_5_0_To_CS (ResoruceRaw, &CertificateV1_5_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CertificateV1_5_0 = (EFI_REDFISH_CERTIFICATE_V1_5_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CERTIFICATE_V1_5_0));
  if (CertificateV1_5_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)CertificateV1_5_0;
  CertificateV1_5_0->Certificate = CertificateV1_5_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Certificate_V1_5_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Certificate_V1_5_0_JSON (*((EFI_REDFISH_CERTIFICATE_V1_5_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Certificate_V1_5_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  CertificateV1_5_0 = (EFI_REDFISH_CERTIFICATE_V1_5_0 *)InterpProp;
  DestroyCertificate_V1_5_0_CS (CertificateV1_5_0->Certificate); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyCertificate_V1_5_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCertificate_V1_5_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishCertificate_V1_5_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
