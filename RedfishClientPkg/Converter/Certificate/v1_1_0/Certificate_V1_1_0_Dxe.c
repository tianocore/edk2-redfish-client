...
//
#include <RedfishJsonStructure/Certificate/v1_1_0/EfiCertificateV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#Certificate";
BOOLEAN IsRevisonController = TRUE;

// Support Certificate V1_1_0
...
{
  EFI_REDFISH_CERTIFICATE_V1_1_0 *CertificateV1_1_0;
  EFI_REDFISH_CERTIFICATE_V1_1_0_CS *CertificateV1_1_0Cs;
  ...
  Status = (EFI_STATUS)Json_Certificate_V1_1_0_To_CS (ResoruceRaw, &CertificateV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CertificateV1_1_0 = (EFI_REDFISH_CERTIFICATE_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CERTIFICATE_V1_1_0));
  if (CertificateV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)CertificateV1_1_0;
  CertificateV1_1_0->Certificate = CertificateV1_1_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Certificate_V1_1_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Certificate_V1_1_0_JSON (*((EFI_REDFISH_CERTIFICATE_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Certificate_V1_1_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  CertificateV1_1_0 = (EFI_REDFISH_CERTIFICATE_V1_1_0 *)InterpProp;
  DestroyCertificate_V1_1_0_CS (CertificateV1_1_0->Certificate); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyCertificate_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCertificate_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishCertificate_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
