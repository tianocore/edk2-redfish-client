...
//
#include <RedfishJsonStructure/Role/v1_3_0/EfiRoleV1_3_0.h>
...
{
  EFI_REDFISH_ROLE_V1_3_0 *RoleV1_3_0;
  EFI_REDFISH_ROLE_V1_3_0_CS *RoleV1_3_0Cs;
  ...
  Status = (EFI_STATUS)Json_Role_V1_3_0_To_CS (ResoruceRaw, &RoleV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  RoleV1_3_0 = (EFI_REDFISH_ROLE_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ROLE_V1_3_0));
  if (RoleV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)RoleV1_3_0;
  RoleV1_3_0->Role = RoleV1_3_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Role_V1_3_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Role_V1_3_0_JSON (*((EFI_REDFISH_ROLE_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Role_V1_3_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  RoleV1_3_0 = (EFI_REDFISH_ROLE_V1_3_0 *)InterpProp;
  DestroyRole_V1_3_0_CS (RoleV1_3_0->Role); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyRole_V1_3_0_Json (ResoruceRaw);
}
