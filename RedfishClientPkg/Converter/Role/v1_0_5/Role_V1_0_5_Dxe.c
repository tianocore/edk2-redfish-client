...
//
#include <RedfishJsonStructure/Role/v1_0_5/EfiRoleV1_0_5.h>
...
{
  EFI_REDFISH_ROLE_V1_0_5 *RoleV1_0_5;
  EFI_REDFISH_ROLE_V1_0_5_CS *RoleV1_0_5Cs;
  ...
  Status = (EFI_STATUS)Json_Role_V1_0_5_To_CS (ResoruceRaw, &RoleV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  RoleV1_0_5 = (EFI_REDFISH_ROLE_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ROLE_V1_0_5));
  if (RoleV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)RoleV1_0_5;
  RoleV1_0_5->Role = RoleV1_0_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Role_V1_0_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Role_V1_0_5_JSON (*((EFI_REDFISH_ROLE_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Role_V1_0_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  RoleV1_0_5 = (EFI_REDFISH_ROLE_V1_0_5 *)InterpProp;
  DestroyRole_V1_0_5_CS (RoleV1_0_5->Role); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyRole_V1_0_5_Json (ResoruceRaw);
}
