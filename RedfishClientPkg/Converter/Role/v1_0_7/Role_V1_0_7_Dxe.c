...
//
#include <RedfishJsonStructure/Role/v1_0_7/EfiRoleV1_0_7.h>
...
{
  EFI_REDFISH_ROLE_V1_0_7 *RoleV1_0_7;
  EFI_REDFISH_ROLE_V1_0_7_CS *RoleV1_0_7Cs;
  ...
  Status = (EFI_STATUS)Json_Role_V1_0_7_To_CS (ResoruceRaw, &RoleV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  RoleV1_0_7 = (EFI_REDFISH_ROLE_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ROLE_V1_0_7));
  if (RoleV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)RoleV1_0_7;
  RoleV1_0_7->Role = RoleV1_0_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Role_V1_0_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Role_V1_0_7_JSON (*((EFI_REDFISH_ROLE_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Role_V1_0_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  RoleV1_0_7 = (EFI_REDFISH_ROLE_V1_0_7 *)InterpProp;
  DestroyRole_V1_0_7_CS (RoleV1_0_7->Role); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyRole_V1_0_7_Json (ResoruceRaw);
}
