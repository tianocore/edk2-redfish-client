...
//
#include <RedfishJsonStructure/Role/v1_1_3/EfiRoleV1_1_3.h>
...
{
  EFI_REDFISH_ROLE_V1_1_3 *RoleV1_1_3;
  EFI_REDFISH_ROLE_V1_1_3_CS *RoleV1_1_3Cs;
  ...
  Status = (EFI_STATUS)Json_Role_V1_1_3_To_CS (ResoruceRaw, &RoleV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  RoleV1_1_3 = (EFI_REDFISH_ROLE_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ROLE_V1_1_3));
  if (RoleV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)RoleV1_1_3;
  RoleV1_1_3->Role = RoleV1_1_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Role_V1_1_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Role_V1_1_3_JSON (*((EFI_REDFISH_ROLE_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Role_V1_1_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  RoleV1_1_3 = (EFI_REDFISH_ROLE_V1_1_3 *)InterpProp;
  DestroyRole_V1_1_3_CS (RoleV1_1_3->Role); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyRole_V1_1_3_Json (ResoruceRaw);
}
