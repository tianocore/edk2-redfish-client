...
//
#include <RedfishJsonStructure/Role/v1_2_6/EfiRoleV1_2_6.h>
...
{
  EFI_REDFISH_ROLE_V1_2_6 *RoleV1_2_6;
  EFI_REDFISH_ROLE_V1_2_6_CS *RoleV1_2_6Cs;
  ...
  Status = (EFI_STATUS)Json_Role_V1_2_6_To_CS (ResoruceRaw, &RoleV1_2_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  RoleV1_2_6 = (EFI_REDFISH_ROLE_V1_2_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ROLE_V1_2_6));
  if (RoleV1_2_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)RoleV1_2_6;
  RoleV1_2_6->Role = RoleV1_2_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Role_V1_2_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Role_V1_2_6_JSON (*((EFI_REDFISH_ROLE_V1_2_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Role_V1_2_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  RoleV1_2_6 = (EFI_REDFISH_ROLE_V1_2_6 *)InterpProp;
  DestroyRole_V1_2_6_CS (RoleV1_2_6->Role); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyRole_V1_2_6_Json (ResoruceRaw);
}
