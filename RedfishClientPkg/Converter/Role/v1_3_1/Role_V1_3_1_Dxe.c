...
//
#include <RedfishJsonStructure/Role/v1_3_1/EfiRoleV1_3_1.h>
...
{
  EFI_REDFISH_ROLE_V1_3_1 *RoleV1_3_1;
  EFI_REDFISH_ROLE_V1_3_1_CS *RoleV1_3_1Cs;
  ...
  Status = (EFI_STATUS)Json_Role_V1_3_1_To_CS (ResoruceRaw, &RoleV1_3_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  RoleV1_3_1 = (EFI_REDFISH_ROLE_V1_3_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ROLE_V1_3_1));
  if (RoleV1_3_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)RoleV1_3_1;
  RoleV1_3_1->Role = RoleV1_3_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Role_V1_3_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Role_V1_3_1_JSON (*((EFI_REDFISH_ROLE_V1_3_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Role_V1_3_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  RoleV1_3_1 = (EFI_REDFISH_ROLE_V1_3_1 *)InterpProp;
  DestroyRole_V1_3_1_CS (RoleV1_3_1->Role); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyRole_V1_3_1_Json (ResoruceRaw);
}
