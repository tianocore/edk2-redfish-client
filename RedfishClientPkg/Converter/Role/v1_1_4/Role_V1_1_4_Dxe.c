...
//
#include <RedfishJsonStructure/Role/v1_1_4/EfiRoleV1_1_4.h>
...
{
  EFI_REDFISH_ROLE_V1_1_4 *RoleV1_1_4;
  EFI_REDFISH_ROLE_V1_1_4_CS *RoleV1_1_4Cs;
  ...
  Status = (EFI_STATUS)Json_Role_V1_1_4_To_CS (ResoruceRaw, &RoleV1_1_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  RoleV1_1_4 = (EFI_REDFISH_ROLE_V1_1_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ROLE_V1_1_4));
  if (RoleV1_1_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)RoleV1_1_4;
  RoleV1_1_4->Role = RoleV1_1_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Role_V1_1_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Role_V1_1_4_JSON (*((EFI_REDFISH_ROLE_V1_1_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Role_V1_1_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  RoleV1_1_4 = (EFI_REDFISH_ROLE_V1_1_4 *)InterpProp;
  DestroyRole_V1_1_4_CS (RoleV1_1_4->Role); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyRole_V1_1_4_Json (ResoruceRaw);
}
