...
)
{
  ...
  return (EFI_STATUS)CS_To_NetworkInterfaceCollection_JSON (*((EFI_REDFISH_NETWORKINTERFACECOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
