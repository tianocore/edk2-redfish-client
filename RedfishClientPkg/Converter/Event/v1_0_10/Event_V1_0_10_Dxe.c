...
//
#include <RedfishJsonStructure/Event/v1_0_10/EfiEventV1_0_10.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_0_10
...
{
  EFI_REDFISH_EVENT_V1_0_10 *EventV1_0_10;
  EFI_REDFISH_EVENT_V1_0_10_CS *EventV1_0_10Cs;
  ...
  Status = (EFI_STATUS)Json_Event_V1_0_10_To_CS (ResoruceRaw, &EventV1_0_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_0_10 = (EFI_REDFISH_EVENT_V1_0_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_0_10));
  if (EventV1_0_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventV1_0_10;
  EventV1_0_10->Event = EventV1_0_10Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Event_V1_0_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Event_V1_0_10_JSON (*((EFI_REDFISH_EVENT_V1_0_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Event_V1_0_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventV1_0_10 = (EFI_REDFISH_EVENT_V1_0_10 *)InterpProp;
  DestroyEvent_V1_0_10_CS (EventV1_0_10->Event); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEvent_V1_0_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEvent_V1_0_10EntryPoint (
