...
//
#include <RedfishJsonStructure/Event/v1_0_11/EfiEventV1_0_11.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_0_11
...
{
  EFI_REDFISH_EVENT_V1_0_11 *EventV1_0_11;
  EFI_REDFISH_EVENT_V1_0_11_CS *EventV1_0_11Cs;
  ...
  Status = (EFI_STATUS)Json_Event_V1_0_11_To_CS (ResoruceRaw, &EventV1_0_11Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_0_11 = (EFI_REDFISH_EVENT_V1_0_11 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_0_11));
  if (EventV1_0_11 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventV1_0_11;
  EventV1_0_11->Event = EventV1_0_11Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Event"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("Event"), "Event");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Event"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("Event"), "Event");
...
/**
  The wrapper function of EventToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Event_V1_0_11_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Event_V1_0_11_JSON (*((EFI_REDFISH_EVENT_V1_0_11_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Event_V1_0_11_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventV1_0_11 = (EFI_REDFISH_EVENT_V1_0_11 *)InterpProp;
  DestroyEvent_V1_0_11_CS (EventV1_0_11->Event); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from EventFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyEvent_V1_0_11_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEvent_V1_0_11EntryPoint (
