...
//
#include <RedfishJsonStructure/Event/v1_0_12/EfiEventV1_0_12.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_0_12
...
{
  EFI_REDFISH_EVENT_V1_0_12 *EventV1_0_12;
  EFI_REDFISH_EVENT_V1_0_12_CS *EventV1_0_12Cs;
  ...
  Status = (EFI_STATUS)Json_Event_V1_0_12_To_CS (ResoruceRaw, &EventV1_0_12Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_0_12 = (EFI_REDFISH_EVENT_V1_0_12 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_0_12));
  if (EventV1_0_12 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventV1_0_12;
  EventV1_0_12->Event = EventV1_0_12Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Event_V1_0_12_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Event_V1_0_12_JSON (*((EFI_REDFISH_EVENT_V1_0_12_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Event_V1_0_12_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventV1_0_12 = (EFI_REDFISH_EVENT_V1_0_12 *)InterpProp;
  DestroyEvent_V1_0_12_CS (EventV1_0_12->Event); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEvent_V1_0_12_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEvent_V1_0_12EntryPoint (
