...
//
#include <RedfishJsonStructure/Event/v1_4_0/EfiEventV1_4_0.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_4_0
...
{
  EFI_REDFISH_EVENT_V1_4_0 *EventV1_4_0;
  EFI_REDFISH_EVENT_V1_4_0_CS *EventV1_4_0Cs;
  ...
  Status = (EFI_STATUS)Json_Event_V1_4_0_To_CS (ResoruceRaw, &EventV1_4_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_4_0 = (EFI_REDFISH_EVENT_V1_4_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_4_0));
  if (EventV1_4_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventV1_4_0;
  EventV1_4_0->Event = EventV1_4_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Event_V1_4_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Event_V1_4_0_JSON (*((EFI_REDFISH_EVENT_V1_4_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Event_V1_4_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventV1_4_0 = (EFI_REDFISH_EVENT_V1_4_0 *)InterpProp;
  DestroyEvent_V1_4_0_CS (EventV1_4_0->Event); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEvent_V1_4_0_Json (ResoruceRaw);
}
