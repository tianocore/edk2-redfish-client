...
//
#include <RedfishJsonStructure/Event/v1_6_1/EfiEventV1_6_1.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_6_1
...
{
  EFI_REDFISH_EVENT_V1_6_1 *EventV1_6_1;
  EFI_REDFISH_EVENT_V1_6_1_CS *EventV1_6_1Cs;
  ...
  Status = (EFI_STATUS)Json_Event_V1_6_1_To_CS (ResoruceRaw, &EventV1_6_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_6_1 = (EFI_REDFISH_EVENT_V1_6_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_6_1));
  if (EventV1_6_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventV1_6_1;
  EventV1_6_1->Event = EventV1_6_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Event_V1_6_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Event_V1_6_1_JSON (*((EFI_REDFISH_EVENT_V1_6_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Event_V1_6_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventV1_6_1 = (EFI_REDFISH_EVENT_V1_6_1 *)InterpProp;
  DestroyEvent_V1_6_1_CS (EventV1_6_1->Event); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEvent_V1_6_1_Json (ResoruceRaw);
}
