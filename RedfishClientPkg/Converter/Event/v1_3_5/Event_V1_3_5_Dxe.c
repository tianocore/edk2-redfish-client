...
//
#include <RedfishJsonStructure/Event/v1_3_5/EfiEventV1_3_5.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_3_5
...
{
  EFI_REDFISH_EVENT_V1_3_5 *EventV1_3_5;
  EFI_REDFISH_EVENT_V1_3_5_CS *EventV1_3_5Cs;
  ...
  Status = (EFI_STATUS)Json_Event_V1_3_5_To_CS (ResoruceRaw, &EventV1_3_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_3_5 = (EFI_REDFISH_EVENT_V1_3_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_3_5));
  if (EventV1_3_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventV1_3_5;
  EventV1_3_5->Event = EventV1_3_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Event_V1_3_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Event_V1_3_5_JSON (*((EFI_REDFISH_EVENT_V1_3_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Event_V1_3_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventV1_3_5 = (EFI_REDFISH_EVENT_V1_3_5 *)InterpProp;
  DestroyEvent_V1_3_5_CS (EventV1_3_5->Event); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEvent_V1_3_5_Json (ResoruceRaw);
}
