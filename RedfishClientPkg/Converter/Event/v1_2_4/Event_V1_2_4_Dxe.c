...
//
#include <RedfishJsonStructure/Event/v1_2_4/EfiEventV1_2_4.h>
CHAR8 mResourceTypeStr [] = "#Event";
BOOLEAN IsRevisonController = TRUE;

// Support Event V1_2_4
...
{
  EFI_REDFISH_EVENT_V1_2_4 *EventV1_2_4;
  EFI_REDFISH_EVENT_V1_2_4_CS *EventV1_2_4Cs;
  ...
  Status = (EFI_STATUS)Json_Event_V1_2_4_To_CS (ResoruceRaw, &EventV1_2_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventV1_2_4 = (EFI_REDFISH_EVENT_V1_2_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENT_V1_2_4));
  if (EventV1_2_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventV1_2_4;
  EventV1_2_4->Event = EventV1_2_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Event_V1_2_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Event_V1_2_4_JSON (*((EFI_REDFISH_EVENT_V1_2_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Event_V1_2_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventV1_2_4 = (EFI_REDFISH_EVENT_V1_2_4 *)InterpProp;
  DestroyEvent_V1_2_4_CS (EventV1_2_4->Event); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEvent_V1_2_4_Json (ResoruceRaw);
}
