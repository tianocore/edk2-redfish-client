...
)
{
  ...
  return (EFI_STATUS)CS_To_OutletGroupCollection_JSON (*((EFI_REDFISH_OUTLETGROUPCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
