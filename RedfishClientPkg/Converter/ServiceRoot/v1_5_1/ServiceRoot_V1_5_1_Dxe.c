...
//
#include <RedfishJsonStructure/ServiceRoot/v1_5_1/EfiServiceRootV1_5_1.h>
CHAR8 mResourceTypeStr [] = "#ServiceRoot";
BOOLEAN IsRevisonController = TRUE;

// Support ServiceRoot V1_5_1
...
{
  EFI_REDFISH_SERVICEROOT_V1_5_1 *ServiceRootV1_5_1;
  EFI_REDFISH_SERVICEROOT_V1_5_1_CS *ServiceRootV1_5_1Cs;
  ...
  Status = (EFI_STATUS)Json_ServiceRoot_V1_5_1_To_CS (ResoruceRaw, &ServiceRootV1_5_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ServiceRootV1_5_1 = (EFI_REDFISH_SERVICEROOT_V1_5_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERVICEROOT_V1_5_1));
  if (ServiceRootV1_5_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ServiceRootV1_5_1;
  ServiceRootV1_5_1->ServiceRoot = ServiceRootV1_5_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ServiceRoot_V1_5_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ServiceRoot_V1_5_1_JSON (*((EFI_REDFISH_SERVICEROOT_V1_5_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ServiceRoot_V1_5_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ServiceRootV1_5_1 = (EFI_REDFISH_SERVICEROOT_V1_5_1 *)InterpProp;
  DestroyServiceRoot_V1_5_1_CS (ServiceRootV1_5_1->ServiceRoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyServiceRoot_V1_5_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_5_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_5_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
