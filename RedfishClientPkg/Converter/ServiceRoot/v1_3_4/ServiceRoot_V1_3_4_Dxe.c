...
//
#include <RedfishJsonStructure/ServiceRoot/v1_3_4/EfiServiceRootV1_3_4.h>
CHAR8 mResourceTypeStr [] = "#ServiceRoot";
BOOLEAN IsRevisonController = TRUE;

// Support ServiceRoot V1_3_4
...
{
  EFI_REDFISH_SERVICEROOT_V1_3_4 *ServiceRootV1_3_4;
  EFI_REDFISH_SERVICEROOT_V1_3_4_CS *ServiceRootV1_3_4Cs;
  ...
  Status = (EFI_STATUS)Json_ServiceRoot_V1_3_4_To_CS (ResoruceRaw, &ServiceRootV1_3_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ServiceRootV1_3_4 = (EFI_REDFISH_SERVICEROOT_V1_3_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERVICEROOT_V1_3_4));
  if (ServiceRootV1_3_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ServiceRootV1_3_4;
  ServiceRootV1_3_4->ServiceRoot = ServiceRootV1_3_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ServiceRoot_V1_3_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ServiceRoot_V1_3_4_JSON (*((EFI_REDFISH_SERVICEROOT_V1_3_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ServiceRoot_V1_3_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ServiceRootV1_3_4 = (EFI_REDFISH_SERVICEROOT_V1_3_4 *)InterpProp;
  DestroyServiceRoot_V1_3_4_CS (ServiceRootV1_3_4->ServiceRoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyServiceRoot_V1_3_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_3_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_3_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
