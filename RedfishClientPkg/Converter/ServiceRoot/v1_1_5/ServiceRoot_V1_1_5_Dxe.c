...
//
#include <RedfishJsonStructure/ServiceRoot/v1_1_5/EfiServiceRootV1_1_5.h>
CHAR8 mResourceTypeStr [] = "#ServiceRoot";
BOOLEAN IsRevisonController = TRUE;

// Support ServiceRoot V1_1_5
...
{
  EFI_REDFISH_SERVICEROOT_V1_1_5 *ServiceRootV1_1_5;
  EFI_REDFISH_SERVICEROOT_V1_1_5_CS *ServiceRootV1_1_5Cs;
  ...
  Status = (EFI_STATUS)Json_ServiceRoot_V1_1_5_To_CS (ResoruceRaw, &ServiceRootV1_1_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ServiceRootV1_1_5 = (EFI_REDFISH_SERVICEROOT_V1_1_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERVICEROOT_V1_1_5));
  if (ServiceRootV1_1_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ServiceRootV1_1_5;
  ServiceRootV1_1_5->ServiceRoot = ServiceRootV1_1_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ServiceRoot_V1_1_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ServiceRoot_V1_1_5_JSON (*((EFI_REDFISH_SERVICEROOT_V1_1_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ServiceRoot_V1_1_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ServiceRootV1_1_5 = (EFI_REDFISH_SERVICEROOT_V1_1_5 *)InterpProp;
  DestroyServiceRoot_V1_1_5_CS (ServiceRootV1_1_5->ServiceRoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyServiceRoot_V1_1_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_1_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_1_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
