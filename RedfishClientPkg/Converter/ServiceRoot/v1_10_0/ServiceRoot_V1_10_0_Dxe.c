...
//
#include <RedfishJsonStructure/ServiceRoot/v1_10_0/EfiServiceRootV1_10_0.h>
CHAR8 mResourceTypeStr [] = "#ServiceRoot";
BOOLEAN IsRevisonController = TRUE;

// Support ServiceRoot V1_10_0
...
{
  EFI_REDFISH_SERVICEROOT_V1_10_0 *ServiceRootV1_10_0;
  EFI_REDFISH_SERVICEROOT_V1_10_0_CS *ServiceRootV1_10_0Cs;
  ...
  Status = (EFI_STATUS)Json_ServiceRoot_V1_10_0_To_CS (ResoruceRaw, &ServiceRootV1_10_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ServiceRootV1_10_0 = (EFI_REDFISH_SERVICEROOT_V1_10_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERVICEROOT_V1_10_0));
  if (ServiceRootV1_10_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ServiceRootV1_10_0;
  ServiceRootV1_10_0->ServiceRoot = ServiceRootV1_10_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("ServiceRoot"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("ServiceRoot"), "ServiceRoot");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("ServiceRoot"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("ServiceRoot"), "ServiceRoot");
...
/**
  The wrapper function of ServiceRootToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ServiceRoot_V1_10_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ServiceRoot_V1_10_0_JSON (*((EFI_REDFISH_SERVICEROOT_V1_10_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ServiceRoot_V1_10_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ServiceRootV1_10_0 = (EFI_REDFISH_SERVICEROOT_V1_10_0 *)InterpProp;
  DestroyServiceRoot_V1_10_0_CS (ServiceRootV1_10_0->ServiceRoot); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ServiceRootFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyServiceRoot_V1_10_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_10_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_10_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
