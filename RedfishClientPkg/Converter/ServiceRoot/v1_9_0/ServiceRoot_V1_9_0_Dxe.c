...
//
#include <RedfishJsonStructure/ServiceRoot/v1_9_0/EfiServiceRootV1_9_0.h>
CHAR8 mResourceTypeStr [] = "#ServiceRoot";
BOOLEAN IsRevisonController = TRUE;

// Support ServiceRoot V1_9_0
...
{
  EFI_REDFISH_SERVICEROOT_V1_9_0 *ServiceRootV1_9_0;
  EFI_REDFISH_SERVICEROOT_V1_9_0_CS *ServiceRootV1_9_0Cs;
  ...
  Status = (EFI_STATUS)Json_ServiceRoot_V1_9_0_To_CS (ResoruceRaw, &ServiceRootV1_9_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ServiceRootV1_9_0 = (EFI_REDFISH_SERVICEROOT_V1_9_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERVICEROOT_V1_9_0));
  if (ServiceRootV1_9_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ServiceRootV1_9_0;
  ServiceRootV1_9_0->ServiceRoot = ServiceRootV1_9_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ServiceRoot_V1_9_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ServiceRoot_V1_9_0_JSON (*((EFI_REDFISH_SERVICEROOT_V1_9_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ServiceRoot_V1_9_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ServiceRootV1_9_0 = (EFI_REDFISH_SERVICEROOT_V1_9_0 *)InterpProp;
  DestroyServiceRoot_V1_9_0_CS (ServiceRootV1_9_0->ServiceRoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyServiceRoot_V1_9_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_9_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_9_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
