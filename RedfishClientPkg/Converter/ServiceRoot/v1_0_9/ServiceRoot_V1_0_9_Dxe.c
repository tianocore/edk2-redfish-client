...
//
#include <RedfishJsonStructure/ServiceRoot/v1_0_9/EfiServiceRootV1_0_9.h>
CHAR8 mResourceTypeStr [] = "#ServiceRoot";
BOOLEAN IsRevisonController = TRUE;

// Support ServiceRoot V1_0_9
...
{
  EFI_REDFISH_SERVICEROOT_V1_0_9 *ServiceRootV1_0_9;
  EFI_REDFISH_SERVICEROOT_V1_0_9_CS *ServiceRootV1_0_9Cs;
  ...
  Status = (EFI_STATUS)Json_ServiceRoot_V1_0_9_To_CS (ResoruceRaw, &ServiceRootV1_0_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ServiceRootV1_0_9 = (EFI_REDFISH_SERVICEROOT_V1_0_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERVICEROOT_V1_0_9));
  if (ServiceRootV1_0_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ServiceRootV1_0_9;
  ServiceRootV1_0_9->ServiceRoot = ServiceRootV1_0_9Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ServiceRoot_V1_0_9_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ServiceRoot_V1_0_9_JSON (*((EFI_REDFISH_SERVICEROOT_V1_0_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ServiceRoot_V1_0_9_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ServiceRootV1_0_9 = (EFI_REDFISH_SERVICEROOT_V1_0_9 *)InterpProp;
  DestroyServiceRoot_V1_0_9_CS (ServiceRootV1_0_9->ServiceRoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyServiceRoot_V1_0_9_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_0_9EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_0_9Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
