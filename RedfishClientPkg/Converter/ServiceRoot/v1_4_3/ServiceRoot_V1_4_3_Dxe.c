...
//
#include <RedfishJsonStructure/ServiceRoot/v1_4_3/EfiServiceRootV1_4_3.h>
CHAR8 mResourceTypeStr [] = "#ServiceRoot";
BOOLEAN IsRevisonController = TRUE;

// Support ServiceRoot V1_4_3
...
{
  EFI_REDFISH_SERVICEROOT_V1_4_3 *ServiceRootV1_4_3;
  EFI_REDFISH_SERVICEROOT_V1_4_3_CS *ServiceRootV1_4_3Cs;
  ...
  Status = (EFI_STATUS)Json_ServiceRoot_V1_4_3_To_CS (ResoruceRaw, &ServiceRootV1_4_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ServiceRootV1_4_3 = (EFI_REDFISH_SERVICEROOT_V1_4_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SERVICEROOT_V1_4_3));
  if (ServiceRootV1_4_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ServiceRootV1_4_3;
  ServiceRootV1_4_3->ServiceRoot = ServiceRootV1_4_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ServiceRoot_V1_4_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ServiceRoot_V1_4_3_JSON (*((EFI_REDFISH_SERVICEROOT_V1_4_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ServiceRoot_V1_4_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ServiceRootV1_4_3 = (EFI_REDFISH_SERVICEROOT_V1_4_3 *)InterpProp;
  DestroyServiceRoot_V1_4_3_CS (ServiceRootV1_4_3->ServiceRoot); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyServiceRoot_V1_4_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_4_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishServiceRoot_V1_4_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
