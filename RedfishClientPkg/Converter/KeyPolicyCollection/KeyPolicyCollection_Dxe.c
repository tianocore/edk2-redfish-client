...
)
{
  ...
  return (EFI_STATUS)CS_To_KeyPolicyCollection_JSON (*((EFI_REDFISH_KEYPOLICYCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
