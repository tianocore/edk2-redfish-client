...
)
{
  ...
  return (EFI_STATUS)CS_To_ProcessorCollection_JSON (*((EFI_REDFISH_PROCESSORCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
