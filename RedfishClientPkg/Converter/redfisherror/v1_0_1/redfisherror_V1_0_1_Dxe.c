...
//
#include <RedfishJsonStructure/redfisherror/v1_0_1/EfiredfisherrorV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#redfisherror";
BOOLEAN IsRevisonController = TRUE;

// Support redfisherror V1_0_1
...
{
  EFI_REDFISH_REDFISHERROR_V1_0_1 *redfisherrorV1_0_1;
  EFI_REDFISH_REDFISHERROR_V1_0_1_CS *redfisherrorV1_0_1Cs;
  ...
  Status = (EFI_STATUS)Json_redfisherror_V1_0_1_To_CS (ResoruceRaw, &redfisherrorV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  redfisherrorV1_0_1 = (EFI_REDFISH_REDFISHERROR_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_REDFISHERROR_V1_0_1));
  if (redfisherrorV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)redfisherrorV1_0_1;
  redfisherrorV1_0_1->redfisherror = redfisherrorV1_0_1Cs;
  ...
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("redfisherror"), "redfisherror");
  ...
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("redfisherror"), "redfisherror");
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_redfisherror_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_redfisherror_V1_0_1_JSON (*((EFI_REDFISH_REDFISHERROR_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_redfisherror_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  redfisherrorV1_0_1 = (EFI_REDFISH_REDFISHERROR_V1_0_1 *)InterpProp;
  Destroyredfisherror_V1_0_1_CS (redfisherrorV1_0_1->redfisherror); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)Destroyredfisherror_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
Redfishredfisherror_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
Redfishredfisherror_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
