...
//
#include <RedfishJsonStructure/OperatingConfig/v1_0_0/EfiOperatingConfigV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#OperatingConfig";
BOOLEAN IsRevisonController = TRUE;

// Support OperatingConfig V1_0_0
...
{
  EFI_REDFISH_OPERATINGCONFIG_V1_0_0 *OperatingConfigV1_0_0;
  EFI_REDFISH_OPERATINGCONFIG_V1_0_0_CS *OperatingConfigV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "OperatingConfig") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_OperatingConfig_V1_0_0_To_CS (ResoruceRaw, &OperatingConfigV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  OperatingConfigV1_0_0 = (EFI_REDFISH_OPERATINGCONFIG_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_OPERATINGCONFIG_V1_0_0));
  if (OperatingConfigV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)OperatingConfigV1_0_0;
  OperatingConfigV1_0_0->OperatingConfig = OperatingConfigV1_0_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("OperatingConfig"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("OperatingConfig"), "OperatingConfig");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("OperatingConfig"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("OperatingConfig"), "OperatingConfig");
...
/**
  The wrapper function of OperatingConfigToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
OperatingConfigToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return OperatingConfigToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_OperatingConfig_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_OperatingConfig_V1_0_0_JSON (*((EFI_REDFISH_OPERATINGCONFIG_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_OperatingConfig_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in OperatingConfigToStruct.
...
)
{
  ...
  OperatingConfigV1_0_0 = (EFI_REDFISH_OPERATINGCONFIG_V1_0_0 *)InterpProp;
  DestroyOperatingConfig_V1_0_0_CS (OperatingConfigV1_0_0->OperatingConfig); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from OperatingConfigFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyOperatingConfig_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishOperatingConfig_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishOperatingConfig_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
