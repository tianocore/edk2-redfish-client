...
//
#include <RedfishJsonStructure/OperatingConfig/v1_0_2/EfiOperatingConfigV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#OperatingConfig";
BOOLEAN IsRevisonController = TRUE;

// Support OperatingConfig V1_0_2
...
{
  EFI_REDFISH_OPERATINGCONFIG_V1_0_2 *OperatingConfigV1_0_2;
  EFI_REDFISH_OPERATINGCONFIG_V1_0_2_CS *OperatingConfigV1_0_2Cs;
  ...
  Status = (EFI_STATUS)Json_OperatingConfig_V1_0_2_To_CS (ResoruceRaw, &OperatingConfigV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  OperatingConfigV1_0_2 = (EFI_REDFISH_OPERATINGCONFIG_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_OPERATINGCONFIG_V1_0_2));
  if (OperatingConfigV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)OperatingConfigV1_0_2;
  OperatingConfigV1_0_2->OperatingConfig = OperatingConfigV1_0_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_OperatingConfig_V1_0_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_OperatingConfig_V1_0_2_JSON (*((EFI_REDFISH_OPERATINGCONFIG_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_OperatingConfig_V1_0_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  OperatingConfigV1_0_2 = (EFI_REDFISH_OPERATINGCONFIG_V1_0_2 *)InterpProp;
  DestroyOperatingConfig_V1_0_2_CS (OperatingConfigV1_0_2->OperatingConfig); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyOperatingConfig_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishOperatingConfig_V1_0_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishOperatingConfig_V1_0_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
