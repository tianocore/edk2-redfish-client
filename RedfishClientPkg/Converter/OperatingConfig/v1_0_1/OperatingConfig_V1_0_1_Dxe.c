...
//
#include <RedfishJsonStructure/OperatingConfig/v1_0_1/EfiOperatingConfigV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#OperatingConfig";
BOOLEAN IsRevisonController = TRUE;

// Support OperatingConfig V1_0_1
...
{
  EFI_REDFISH_OPERATINGCONFIG_V1_0_1 *OperatingConfigV1_0_1;
  EFI_REDFISH_OPERATINGCONFIG_V1_0_1_CS *OperatingConfigV1_0_1Cs;
  ...
  Status = (EFI_STATUS)Json_OperatingConfig_V1_0_1_To_CS (ResoruceRaw, &OperatingConfigV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  OperatingConfigV1_0_1 = (EFI_REDFISH_OPERATINGCONFIG_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_OPERATINGCONFIG_V1_0_1));
  if (OperatingConfigV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)OperatingConfigV1_0_1;
  OperatingConfigV1_0_1->OperatingConfig = OperatingConfigV1_0_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_OperatingConfig_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_OperatingConfig_V1_0_1_JSON (*((EFI_REDFISH_OPERATINGCONFIG_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_OperatingConfig_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  OperatingConfigV1_0_1 = (EFI_REDFISH_OPERATINGCONFIG_V1_0_1 *)InterpProp;
  DestroyOperatingConfig_V1_0_1_CS (OperatingConfigV1_0_1->OperatingConfig); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyOperatingConfig_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishOperatingConfig_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishOperatingConfig_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
