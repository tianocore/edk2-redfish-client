...
//
#include <RedfishJsonStructure/License/v1_0_0/EfiLicenseV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#License";
BOOLEAN IsRevisonController = TRUE;

// Support License V1_0_0
...
{
  EFI_REDFISH_LICENSE_V1_0_0 *LicenseV1_0_0;
  EFI_REDFISH_LICENSE_V1_0_0_CS *LicenseV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "License") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_License_V1_0_0_To_CS (ResoruceRaw, &LicenseV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LicenseV1_0_0 = (EFI_REDFISH_LICENSE_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LICENSE_V1_0_0));
  if (LicenseV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)LicenseV1_0_0;
  LicenseV1_0_0->License = LicenseV1_0_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("License"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("License"), "License");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("License"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("License"), "License");
...
/**
  The wrapper function of LicenseToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_License_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_License_V1_0_0_JSON (*((EFI_REDFISH_LICENSE_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_License_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in LicenseToStruct.
...
)
{
  ...
  LicenseV1_0_0 = (EFI_REDFISH_LICENSE_V1_0_0 *)InterpProp;
  DestroyLicense_V1_0_0_CS (LicenseV1_0_0->License); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from LicenseFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyLicense_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLicense_V1_0_0EntryPoint (
