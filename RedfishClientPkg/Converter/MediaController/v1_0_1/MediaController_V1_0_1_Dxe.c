...
//
#include <RedfishJsonStructure/MediaController/v1_0_1/EfiMediaControllerV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#MediaController";
BOOLEAN IsRevisonController = TRUE;

// Support MediaController V1_0_1
...
{
  EFI_REDFISH_MEDIACONTROLLER_V1_0_1 *MediaControllerV1_0_1;
  EFI_REDFISH_MEDIACONTROLLER_V1_0_1_CS *MediaControllerV1_0_1Cs;
  ...
  Status = (EFI_STATUS)Json_MediaController_V1_0_1_To_CS (ResoruceRaw, &MediaControllerV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MediaControllerV1_0_1 = (EFI_REDFISH_MEDIACONTROLLER_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEDIACONTROLLER_V1_0_1));
  if (MediaControllerV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MediaControllerV1_0_1;
  MediaControllerV1_0_1->MediaController = MediaControllerV1_0_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MediaController_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MediaController_V1_0_1_JSON (*((EFI_REDFISH_MEDIACONTROLLER_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MediaController_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MediaControllerV1_0_1 = (EFI_REDFISH_MEDIACONTROLLER_V1_0_1 *)InterpProp;
  DestroyMediaController_V1_0_1_CS (MediaControllerV1_0_1->MediaController); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMediaController_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMediaController_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMediaController_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
