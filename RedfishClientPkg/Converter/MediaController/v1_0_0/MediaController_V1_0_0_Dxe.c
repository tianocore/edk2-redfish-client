...
//
#include <RedfishJsonStructure/MediaController/v1_0_0/EfiMediaControllerV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#MediaController";
BOOLEAN IsRevisonController = TRUE;

// Support MediaController V1_0_0
...
{
  EFI_REDFISH_MEDIACONTROLLER_V1_0_0 *MediaControllerV1_0_0;
  EFI_REDFISH_MEDIACONTROLLER_V1_0_0_CS *MediaControllerV1_0_0Cs;
  ...
  Status = (EFI_STATUS)Json_MediaController_V1_0_0_To_CS (ResoruceRaw, &MediaControllerV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MediaControllerV1_0_0 = (EFI_REDFISH_MEDIACONTROLLER_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEDIACONTROLLER_V1_0_0));
  if (MediaControllerV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MediaControllerV1_0_0;
  MediaControllerV1_0_0->MediaController = MediaControllerV1_0_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MediaController_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MediaController_V1_0_0_JSON (*((EFI_REDFISH_MEDIACONTROLLER_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MediaController_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MediaControllerV1_0_0 = (EFI_REDFISH_MEDIACONTROLLER_V1_0_0 *)InterpProp;
  DestroyMediaController_V1_0_0_CS (MediaControllerV1_0_0->MediaController); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMediaController_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMediaController_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMediaController_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
