...
//
#include <RedfishJsonStructure/Power/v1_5_6/EfiPowerV1_5_6.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_5_6
...
{
  EFI_REDFISH_POWER_V1_5_6 *PowerV1_5_6;
  EFI_REDFISH_POWER_V1_5_6_CS *PowerV1_5_6Cs;
  ...
  Status = (EFI_STATUS)Json_Power_V1_5_6_To_CS (ResoruceRaw, &PowerV1_5_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_5_6 = (EFI_REDFISH_POWER_V1_5_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_5_6));
  if (PowerV1_5_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerV1_5_6;
  PowerV1_5_6->Power = PowerV1_5_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Power_V1_5_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Power_V1_5_6_JSON (*((EFI_REDFISH_POWER_V1_5_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Power_V1_5_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerV1_5_6 = (EFI_REDFISH_POWER_V1_5_6 *)InterpProp;
  DestroyPower_V1_5_6_CS (PowerV1_5_6->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPower_V1_5_6_Json (ResoruceRaw);
}
