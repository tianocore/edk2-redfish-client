...
//
#include <RedfishJsonStructure/Power/v1_2_11/EfiPowerV1_2_11.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_2_11
...
{
  EFI_REDFISH_POWER_V1_2_11 *PowerV1_2_11;
  EFI_REDFISH_POWER_V1_2_11_CS *PowerV1_2_11Cs;
  ...
  Status = (EFI_STATUS)Json_Power_V1_2_11_To_CS (ResoruceRaw, &PowerV1_2_11Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_2_11 = (EFI_REDFISH_POWER_V1_2_11 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_2_11));
  if (PowerV1_2_11 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerV1_2_11;
  PowerV1_2_11->Power = PowerV1_2_11Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Power_V1_2_11_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Power_V1_2_11_JSON (*((EFI_REDFISH_POWER_V1_2_11_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Power_V1_2_11_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerV1_2_11 = (EFI_REDFISH_POWER_V1_2_11 *)InterpProp;
  DestroyPower_V1_2_11_CS (PowerV1_2_11->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPower_V1_2_11_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPower_V1_2_11EntryPoint (
