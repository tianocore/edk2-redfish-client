...
//
#include <RedfishJsonStructure/Power/v1_4_5/EfiPowerV1_4_5.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_4_5
...
{
  EFI_REDFISH_POWER_V1_4_5 *PowerV1_4_5;
  EFI_REDFISH_POWER_V1_4_5_CS *PowerV1_4_5Cs;
  ...
  Status = (EFI_STATUS)Json_Power_V1_4_5_To_CS (ResoruceRaw, &PowerV1_4_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_4_5 = (EFI_REDFISH_POWER_V1_4_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_4_5));
  if (PowerV1_4_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerV1_4_5;
  PowerV1_4_5->Power = PowerV1_4_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Power_V1_4_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Power_V1_4_5_JSON (*((EFI_REDFISH_POWER_V1_4_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Power_V1_4_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerV1_4_5 = (EFI_REDFISH_POWER_V1_4_5 *)InterpProp;
  DestroyPower_V1_4_5_CS (PowerV1_4_5->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPower_V1_4_5_Json (ResoruceRaw);
}
