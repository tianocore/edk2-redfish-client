...
//
#include <RedfishJsonStructure/Power/v1_6_0/EfiPowerV1_6_0.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_6_0
...
{
  EFI_REDFISH_POWER_V1_6_0 *PowerV1_6_0;
  EFI_REDFISH_POWER_V1_6_0_CS *PowerV1_6_0Cs;
  ...
  Status = (EFI_STATUS)Json_Power_V1_6_0_To_CS (ResoruceRaw, &PowerV1_6_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_6_0 = (EFI_REDFISH_POWER_V1_6_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_6_0));
  if (PowerV1_6_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerV1_6_0;
  PowerV1_6_0->Power = PowerV1_6_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Power_V1_6_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Power_V1_6_0_JSON (*((EFI_REDFISH_POWER_V1_6_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Power_V1_6_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerV1_6_0 = (EFI_REDFISH_POWER_V1_6_0 *)InterpProp;
  DestroyPower_V1_6_0_CS (PowerV1_6_0->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPower_V1_6_0_Json (ResoruceRaw);
}
