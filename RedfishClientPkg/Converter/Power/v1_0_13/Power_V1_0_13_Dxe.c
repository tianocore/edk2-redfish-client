...
//
#include <RedfishJsonStructure/Power/v1_0_13/EfiPowerV1_0_13.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_0_13
...
{
  EFI_REDFISH_POWER_V1_0_13 *PowerV1_0_13;
  EFI_REDFISH_POWER_V1_0_13_CS *PowerV1_0_13Cs;
  ...
  Status = (EFI_STATUS)Json_Power_V1_0_13_To_CS (ResoruceRaw, &PowerV1_0_13Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_0_13 = (EFI_REDFISH_POWER_V1_0_13 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_0_13));
  if (PowerV1_0_13 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerV1_0_13;
  PowerV1_0_13->Power = PowerV1_0_13Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Power"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("Power"), "Power");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Power"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("Power"), "Power");
...
/**
  The wrapper function of PowerToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Power_V1_0_13_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Power_V1_0_13_JSON (*((EFI_REDFISH_POWER_V1_0_13_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Power_V1_0_13_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerV1_0_13 = (EFI_REDFISH_POWER_V1_0_13 *)InterpProp;
  DestroyPower_V1_0_13_CS (PowerV1_0_13->Power); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from PowerFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyPower_V1_0_13_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishPower_V1_0_13EntryPoint (
