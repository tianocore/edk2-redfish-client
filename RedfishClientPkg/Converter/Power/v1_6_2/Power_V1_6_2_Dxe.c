...
//
#include <RedfishJsonStructure/Power/v1_6_2/EfiPowerV1_6_2.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_6_2
...
{
  EFI_REDFISH_POWER_V1_6_2 *PowerV1_6_2;
  EFI_REDFISH_POWER_V1_6_2_CS *PowerV1_6_2Cs;
  ...
  Status = (EFI_STATUS)Json_Power_V1_6_2_To_CS (ResoruceRaw, &PowerV1_6_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_6_2 = (EFI_REDFISH_POWER_V1_6_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_6_2));
  if (PowerV1_6_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerV1_6_2;
  PowerV1_6_2->Power = PowerV1_6_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Power_V1_6_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Power_V1_6_2_JSON (*((EFI_REDFISH_POWER_V1_6_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Power_V1_6_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerV1_6_2 = (EFI_REDFISH_POWER_V1_6_2 *)InterpProp;
  DestroyPower_V1_6_2_CS (PowerV1_6_2->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPower_V1_6_2_Json (ResoruceRaw);
}
