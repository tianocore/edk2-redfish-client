...
//
#include <RedfishJsonStructure/Power/v1_2_7/EfiPowerV1_2_7.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_2_7
...
{
  EFI_REDFISH_POWER_V1_2_7 *PowerV1_2_7;
  EFI_REDFISH_POWER_V1_2_7_CS *PowerV1_2_7Cs;
  ...
  Status = (EFI_STATUS)Json_Power_V1_2_7_To_CS (ResoruceRaw, &PowerV1_2_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_2_7 = (EFI_REDFISH_POWER_V1_2_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_2_7));
  if (PowerV1_2_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerV1_2_7;
  PowerV1_2_7->Power = PowerV1_2_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Power_V1_2_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Power_V1_2_7_JSON (*((EFI_REDFISH_POWER_V1_2_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Power_V1_2_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerV1_2_7 = (EFI_REDFISH_POWER_V1_2_7 *)InterpProp;
  DestroyPower_V1_2_7_CS (PowerV1_2_7->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPower_V1_2_7_Json (ResoruceRaw);
}
