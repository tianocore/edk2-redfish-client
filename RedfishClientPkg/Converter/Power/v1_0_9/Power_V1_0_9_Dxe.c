...
//
#include <RedfishJsonStructure/Power/v1_0_9/EfiPowerV1_0_9.h>
CHAR8 mResourceTypeStr [] = "#Power";
BOOLEAN IsRevisonController = TRUE;

// Support Power V1_0_9
...
{
  EFI_REDFISH_POWER_V1_0_9 *PowerV1_0_9;
  EFI_REDFISH_POWER_V1_0_9_CS *PowerV1_0_9Cs;
  ...
  Status = (EFI_STATUS)Json_Power_V1_0_9_To_CS (ResoruceRaw, &PowerV1_0_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  PowerV1_0_9 = (EFI_REDFISH_POWER_V1_0_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_POWER_V1_0_9));
  if (PowerV1_0_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)PowerV1_0_9;
  PowerV1_0_9->Power = PowerV1_0_9Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Power_V1_0_9_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Power_V1_0_9_JSON (*((EFI_REDFISH_POWER_V1_0_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Power_V1_0_9_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  PowerV1_0_9 = (EFI_REDFISH_POWER_V1_0_9 *)InterpProp;
  DestroyPower_V1_0_9_CS (PowerV1_0_9->Power); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyPower_V1_0_9_Json (ResoruceRaw);
}
