...
//
#include <RedfishJsonStructure/AggregationService/v1_0_0/EfiAggregationServiceV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#AggregationService";
BOOLEAN IsRevisonController = TRUE;

// Support AggregationService V1_0_0
...
{
  EFI_REDFISH_AGGREGATIONSERVICE_V1_0_0 *AggregationServiceV1_0_0;
  EFI_REDFISH_AGGREGATIONSERVICE_V1_0_0_CS *AggregationServiceV1_0_0Cs;
  ...
  Status = (EFI_STATUS)Json_AggregationService_V1_0_0_To_CS (ResoruceRaw, &AggregationServiceV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  AggregationServiceV1_0_0 = (EFI_REDFISH_AGGREGATIONSERVICE_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_AGGREGATIONSERVICE_V1_0_0));
  if (AggregationServiceV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)AggregationServiceV1_0_0;
  AggregationServiceV1_0_0->AggregationService = AggregationServiceV1_0_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_AggregationService_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_AggregationService_V1_0_0_JSON (*((EFI_REDFISH_AGGREGATIONSERVICE_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_AggregationService_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  AggregationServiceV1_0_0 = (EFI_REDFISH_AGGREGATIONSERVICE_V1_0_0 *)InterpProp;
  DestroyAggregationService_V1_0_0_CS (AggregationServiceV1_0_0->AggregationService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyAggregationService_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishAggregationService_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishAggregationService_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
