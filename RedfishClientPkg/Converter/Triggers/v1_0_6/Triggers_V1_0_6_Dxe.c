...
//
#include <RedfishJsonStructure/Triggers/v1_0_6/EfiTriggersV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#Triggers";
BOOLEAN IsRevisonController = TRUE;

// Support Triggers V1_0_6
...
{
  EFI_REDFISH_TRIGGERS_V1_0_6 *TriggersV1_0_6;
  EFI_REDFISH_TRIGGERS_V1_0_6_CS *TriggersV1_0_6Cs;
  ...
  Status = (EFI_STATUS)Json_Triggers_V1_0_6_To_CS (ResoruceRaw, &TriggersV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TriggersV1_0_6 = (EFI_REDFISH_TRIGGERS_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TRIGGERS_V1_0_6));
  if (TriggersV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TriggersV1_0_6;
  TriggersV1_0_6->Triggers = TriggersV1_0_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Triggers_V1_0_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Triggers_V1_0_6_JSON (*((EFI_REDFISH_TRIGGERS_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Triggers_V1_0_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TriggersV1_0_6 = (EFI_REDFISH_TRIGGERS_V1_0_6 *)InterpProp;
  DestroyTriggers_V1_0_6_CS (TriggersV1_0_6->Triggers); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyTriggers_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTriggers_V1_0_6EntryPoint (
