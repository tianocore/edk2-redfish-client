...
//
#include <RedfishJsonStructure/Triggers/v1_0_4/EfiTriggersV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#Triggers";
BOOLEAN IsRevisonController = TRUE;

// Support Triggers V1_0_4
...
{
  EFI_REDFISH_TRIGGERS_V1_0_4 *TriggersV1_0_4;
  EFI_REDFISH_TRIGGERS_V1_0_4_CS *TriggersV1_0_4Cs;
  ...
  Status = (EFI_STATUS)Json_Triggers_V1_0_4_To_CS (ResoruceRaw, &TriggersV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TriggersV1_0_4 = (EFI_REDFISH_TRIGGERS_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TRIGGERS_V1_0_4));
  if (TriggersV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TriggersV1_0_4;
  TriggersV1_0_4->Triggers = TriggersV1_0_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Triggers_V1_0_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Triggers_V1_0_4_JSON (*((EFI_REDFISH_TRIGGERS_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Triggers_V1_0_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TriggersV1_0_4 = (EFI_REDFISH_TRIGGERS_V1_0_4 *)InterpProp;
  DestroyTriggers_V1_0_4_CS (TriggersV1_0_4->Triggers); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyTriggers_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTriggers_V1_0_4EntryPoint (
