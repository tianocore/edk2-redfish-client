...
//
#include <RedfishJsonStructure/Triggers/v1_1_0/EfiTriggersV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#Triggers";
BOOLEAN IsRevisonController = TRUE;

// Support Triggers V1_1_0
...
{
  EFI_REDFISH_TRIGGERS_V1_1_0 *TriggersV1_1_0;
  EFI_REDFISH_TRIGGERS_V1_1_0_CS *TriggersV1_1_0Cs;
  ...
  Status = (EFI_STATUS)Json_Triggers_V1_1_0_To_CS (ResoruceRaw, &TriggersV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  TriggersV1_1_0 = (EFI_REDFISH_TRIGGERS_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_TRIGGERS_V1_1_0));
  if (TriggersV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)TriggersV1_1_0;
  TriggersV1_1_0->Triggers = TriggersV1_1_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Triggers_V1_1_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Triggers_V1_1_0_JSON (*((EFI_REDFISH_TRIGGERS_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Triggers_V1_1_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  TriggersV1_1_0 = (EFI_REDFISH_TRIGGERS_V1_1_0 *)InterpProp;
  DestroyTriggers_V1_1_0_CS (TriggersV1_1_0->Triggers); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyTriggers_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishTriggers_V1_1_0EntryPoint (
