...
//
#include <RedfishJsonStructure/MemoryDomain/v1_1_4/EfiMemoryDomainV1_1_4.h>
CHAR8 mResourceTypeStr [] = "#MemoryDomain";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryDomain V1_1_4
...
{
  EFI_REDFISH_MEMORYDOMAIN_V1_1_4 *MemoryDomainV1_1_4;
  EFI_REDFISH_MEMORYDOMAIN_V1_1_4_CS *MemoryDomainV1_1_4Cs;
  ...
  Status = (EFI_STATUS)Json_MemoryDomain_V1_1_4_To_CS (ResoruceRaw, &MemoryDomainV1_1_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryDomainV1_1_4 = (EFI_REDFISH_MEMORYDOMAIN_V1_1_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYDOMAIN_V1_1_4));
  if (MemoryDomainV1_1_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryDomainV1_1_4;
  MemoryDomainV1_1_4->MemoryDomain = MemoryDomainV1_1_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MemoryDomain_V1_1_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MemoryDomain_V1_1_4_JSON (*((EFI_REDFISH_MEMORYDOMAIN_V1_1_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MemoryDomain_V1_1_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryDomainV1_1_4 = (EFI_REDFISH_MEMORYDOMAIN_V1_1_4 *)InterpProp;
  DestroyMemoryDomain_V1_1_4_CS (MemoryDomainV1_1_4->MemoryDomain); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemoryDomain_V1_1_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_1_4EntryPoint (
