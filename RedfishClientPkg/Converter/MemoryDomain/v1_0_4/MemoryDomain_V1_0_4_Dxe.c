...
//
#include <RedfishJsonStructure/MemoryDomain/v1_0_4/EfiMemoryDomainV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#MemoryDomain";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryDomain V1_0_4
...
{
  EFI_REDFISH_MEMORYDOMAIN_V1_0_4 *MemoryDomainV1_0_4;
  EFI_REDFISH_MEMORYDOMAIN_V1_0_4_CS *MemoryDomainV1_0_4Cs;
  ...
  Status = (EFI_STATUS)Json_MemoryDomain_V1_0_4_To_CS (ResoruceRaw, &MemoryDomainV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryDomainV1_0_4 = (EFI_REDFISH_MEMORYDOMAIN_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYDOMAIN_V1_0_4));
  if (MemoryDomainV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryDomainV1_0_4;
  MemoryDomainV1_0_4->MemoryDomain = MemoryDomainV1_0_4Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("MemoryDomain"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("MemoryDomain"), "MemoryDomain");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("MemoryDomain"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("MemoryDomain"), "MemoryDomain");
...
/**
  The wrapper function of MemoryDomainToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MemoryDomain_V1_0_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MemoryDomain_V1_0_4_JSON (*((EFI_REDFISH_MEMORYDOMAIN_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MemoryDomain_V1_0_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryDomainV1_0_4 = (EFI_REDFISH_MEMORYDOMAIN_V1_0_4 *)InterpProp;
  DestroyMemoryDomain_V1_0_4_CS (MemoryDomainV1_0_4->MemoryDomain); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from MemoryDomainFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyMemoryDomain_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
