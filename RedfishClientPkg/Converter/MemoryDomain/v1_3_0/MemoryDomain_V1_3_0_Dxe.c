...
//
#include <RedfishJsonStructure/MemoryDomain/v1_3_0/EfiMemoryDomainV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#MemoryDomain";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryDomain V1_3_0
...
{
  EFI_REDFISH_MEMORYDOMAIN_V1_3_0 *MemoryDomainV1_3_0;
  EFI_REDFISH_MEMORYDOMAIN_V1_3_0_CS *MemoryDomainV1_3_0Cs;
  ...
  Status = (EFI_STATUS)Json_MemoryDomain_V1_3_0_To_CS (ResoruceRaw, &MemoryDomainV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryDomainV1_3_0 = (EFI_REDFISH_MEMORYDOMAIN_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYDOMAIN_V1_3_0));
  if (MemoryDomainV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryDomainV1_3_0;
  MemoryDomainV1_3_0->MemoryDomain = MemoryDomainV1_3_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MemoryDomain_V1_3_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MemoryDomain_V1_3_0_JSON (*((EFI_REDFISH_MEMORYDOMAIN_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MemoryDomain_V1_3_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryDomainV1_3_0 = (EFI_REDFISH_MEMORYDOMAIN_V1_3_0 *)InterpProp;
  DestroyMemoryDomain_V1_3_0_CS (MemoryDomainV1_3_0->MemoryDomain); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemoryDomain_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_3_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_3_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
