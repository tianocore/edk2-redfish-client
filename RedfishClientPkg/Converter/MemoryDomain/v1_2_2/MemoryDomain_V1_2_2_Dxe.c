...
//
#include <RedfishJsonStructure/MemoryDomain/v1_2_2/EfiMemoryDomainV1_2_2.h>
CHAR8 mResourceTypeStr [] = "#MemoryDomain";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryDomain V1_2_2
...
{
  EFI_REDFISH_MEMORYDOMAIN_V1_2_2 *MemoryDomainV1_2_2;
  EFI_REDFISH_MEMORYDOMAIN_V1_2_2_CS *MemoryDomainV1_2_2Cs;
  ...
  Status = (EFI_STATUS)Json_MemoryDomain_V1_2_2_To_CS (ResoruceRaw, &MemoryDomainV1_2_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryDomainV1_2_2 = (EFI_REDFISH_MEMORYDOMAIN_V1_2_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYDOMAIN_V1_2_2));
  if (MemoryDomainV1_2_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryDomainV1_2_2;
  MemoryDomainV1_2_2->MemoryDomain = MemoryDomainV1_2_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MemoryDomain_V1_2_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MemoryDomain_V1_2_2_JSON (*((EFI_REDFISH_MEMORYDOMAIN_V1_2_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MemoryDomain_V1_2_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryDomainV1_2_2 = (EFI_REDFISH_MEMORYDOMAIN_V1_2_2 *)InterpProp;
  DestroyMemoryDomain_V1_2_2_CS (MemoryDomainV1_2_2->MemoryDomain); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemoryDomain_V1_2_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_2_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_2_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
