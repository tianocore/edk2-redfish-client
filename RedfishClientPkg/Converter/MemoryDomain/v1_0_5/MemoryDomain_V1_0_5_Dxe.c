...
//
#include <RedfishJsonStructure/MemoryDomain/v1_0_5/EfiMemoryDomainV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#MemoryDomain";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryDomain V1_0_5
...
{
  EFI_REDFISH_MEMORYDOMAIN_V1_0_5 *MemoryDomainV1_0_5;
  EFI_REDFISH_MEMORYDOMAIN_V1_0_5_CS *MemoryDomainV1_0_5Cs;
  ...
  Status = (EFI_STATUS)Json_MemoryDomain_V1_0_5_To_CS (ResoruceRaw, &MemoryDomainV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryDomainV1_0_5 = (EFI_REDFISH_MEMORYDOMAIN_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYDOMAIN_V1_0_5));
  if (MemoryDomainV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryDomainV1_0_5;
  MemoryDomainV1_0_5->MemoryDomain = MemoryDomainV1_0_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MemoryDomain_V1_0_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MemoryDomain_V1_0_5_JSON (*((EFI_REDFISH_MEMORYDOMAIN_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MemoryDomain_V1_0_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryDomainV1_0_5 = (EFI_REDFISH_MEMORYDOMAIN_V1_0_5 *)InterpProp;
  DestroyMemoryDomain_V1_0_5_CS (MemoryDomainV1_0_5->MemoryDomain); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemoryDomain_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
