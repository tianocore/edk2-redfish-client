...
//
#include <RedfishJsonStructure/MemoryDomain/v1_2_3/EfiMemoryDomainV1_2_3.h>
CHAR8 mResourceTypeStr [] = "#MemoryDomain";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryDomain V1_2_3
...
{
  EFI_REDFISH_MEMORYDOMAIN_V1_2_3 *MemoryDomainV1_2_3;
  EFI_REDFISH_MEMORYDOMAIN_V1_2_3_CS *MemoryDomainV1_2_3Cs;
  ...
  Status = (EFI_STATUS)Json_MemoryDomain_V1_2_3_To_CS (ResoruceRaw, &MemoryDomainV1_2_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryDomainV1_2_3 = (EFI_REDFISH_MEMORYDOMAIN_V1_2_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYDOMAIN_V1_2_3));
  if (MemoryDomainV1_2_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryDomainV1_2_3;
  MemoryDomainV1_2_3->MemoryDomain = MemoryDomainV1_2_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MemoryDomain_V1_2_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MemoryDomain_V1_2_3_JSON (*((EFI_REDFISH_MEMORYDOMAIN_V1_2_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MemoryDomain_V1_2_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryDomainV1_2_3 = (EFI_REDFISH_MEMORYDOMAIN_V1_2_3 *)InterpProp;
  DestroyMemoryDomain_V1_2_3_CS (MemoryDomainV1_2_3->MemoryDomain); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemoryDomain_V1_2_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_2_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryDomain_V1_2_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
