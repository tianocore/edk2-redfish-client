...
)
{
  ...
  return (EFI_STATUS)CS_To_EthernetInterfaceCollection_JSON (*((EFI_REDFISH_ETHERNETINTERFACECOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
