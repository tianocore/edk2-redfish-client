...
//
#include <RedfishJsonStructure/EventService/v1_0_9/EfiEventServiceV1_0_9.h>
CHAR8 mResourceTypeStr [] = "#EventService";
BOOLEAN IsRevisonController = TRUE;

// Support EventService V1_0_9
...
{
  EFI_REDFISH_EVENTSERVICE_V1_0_9 *EventServiceV1_0_9;
  EFI_REDFISH_EVENTSERVICE_V1_0_9_CS *EventServiceV1_0_9Cs;
  ...
  Status = (EFI_STATUS)Json_EventService_V1_0_9_To_CS (ResoruceRaw, &EventServiceV1_0_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventServiceV1_0_9 = (EFI_REDFISH_EVENTSERVICE_V1_0_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTSERVICE_V1_0_9));
  if (EventServiceV1_0_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventServiceV1_0_9;
  EventServiceV1_0_9->EventService = EventServiceV1_0_9Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EventService_V1_0_9_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EventService_V1_0_9_JSON (*((EFI_REDFISH_EVENTSERVICE_V1_0_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EventService_V1_0_9_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventServiceV1_0_9 = (EFI_REDFISH_EVENTSERVICE_V1_0_9 *)InterpProp;
  DestroyEventService_V1_0_9_CS (EventServiceV1_0_9->EventService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEventService_V1_0_9_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_0_9EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_0_9Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
