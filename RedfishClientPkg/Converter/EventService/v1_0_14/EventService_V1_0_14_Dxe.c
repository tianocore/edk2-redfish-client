...
//
#include <RedfishJsonStructure/EventService/v1_0_14/EfiEventServiceV1_0_14.h>
CHAR8 mResourceTypeStr [] = "#EventService";
BOOLEAN IsRevisonController = TRUE;

// Support EventService V1_0_14
...
{
  EFI_REDFISH_EVENTSERVICE_V1_0_14 *EventServiceV1_0_14;
  EFI_REDFISH_EVENTSERVICE_V1_0_14_CS *EventServiceV1_0_14Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ErrataVersion, "14") != 0) ||
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "EventService") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_EventService_V1_0_14_To_CS (ResoruceRaw, &EventServiceV1_0_14Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventServiceV1_0_14 = (EFI_REDFISH_EVENTSERVICE_V1_0_14 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTSERVICE_V1_0_14));
  if (EventServiceV1_0_14 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventServiceV1_0_14;
  EventServiceV1_0_14->EventService = EventServiceV1_0_14Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "14";
  //
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("EventService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("EventService"), "EventService");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("EventService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("EventService"), "EventService");
...
/**
  The wrapper function of EventServiceToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EventService_V1_0_14_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EventService_V1_0_14_JSON (*((EFI_REDFISH_EVENTSERVICE_V1_0_14_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EventService_V1_0_14_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventServiceV1_0_14 = (EFI_REDFISH_EVENTSERVICE_V1_0_14 *)InterpProp;
  DestroyEventService_V1_0_14_CS (EventServiceV1_0_14->EventService); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from EventServiceFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyEventService_V1_0_14_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_0_14EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_0_14Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
