...
)
{
  ...
  return (EFI_STATUS)CS_To_EventService_V1_2_0_JSON (*((EFI_REDFISH_EVENTSERVICE_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
