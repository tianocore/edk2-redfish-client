...
//
#include <RedfishJsonStructure/EventService/v1_4_1/EfiEventServiceV1_4_1.h>
CHAR8 mResourceTypeStr [] = "#EventService";
BOOLEAN IsRevisonController = TRUE;

// Support EventService V1_4_1
...
{
  EFI_REDFISH_EVENTSERVICE_V1_4_1 *EventServiceV1_4_1;
  EFI_REDFISH_EVENTSERVICE_V1_4_1_CS *EventServiceV1_4_1Cs;
  ...
  Status = (EFI_STATUS)Json_EventService_V1_4_1_To_CS (ResoruceRaw, &EventServiceV1_4_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventServiceV1_4_1 = (EFI_REDFISH_EVENTSERVICE_V1_4_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTSERVICE_V1_4_1));
  if (EventServiceV1_4_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventServiceV1_4_1;
  EventServiceV1_4_1->EventService = EventServiceV1_4_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EventService_V1_4_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EventService_V1_4_1_JSON (*((EFI_REDFISH_EVENTSERVICE_V1_4_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EventService_V1_4_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventServiceV1_4_1 = (EFI_REDFISH_EVENTSERVICE_V1_4_1 *)InterpProp;
  DestroyEventService_V1_4_1_CS (EventServiceV1_4_1->EventService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEventService_V1_4_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_4_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_4_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
