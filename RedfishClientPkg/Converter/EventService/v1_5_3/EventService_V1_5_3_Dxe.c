...
//
#include <RedfishJsonStructure/EventService/v1_5_3/EfiEventServiceV1_5_3.h>
CHAR8 mResourceTypeStr [] = "#EventService";
BOOLEAN IsRevisonController = TRUE;

// Support EventService V1_5_3
...
{
  EFI_REDFISH_EVENTSERVICE_V1_5_3 *EventServiceV1_5_3;
  EFI_REDFISH_EVENTSERVICE_V1_5_3_CS *EventServiceV1_5_3Cs;
  ...
  Status = (EFI_STATUS)Json_EventService_V1_5_3_To_CS (ResoruceRaw, &EventServiceV1_5_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventServiceV1_5_3 = (EFI_REDFISH_EVENTSERVICE_V1_5_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTSERVICE_V1_5_3));
  if (EventServiceV1_5_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventServiceV1_5_3;
  EventServiceV1_5_3->EventService = EventServiceV1_5_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EventService_V1_5_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EventService_V1_5_3_JSON (*((EFI_REDFISH_EVENTSERVICE_V1_5_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EventService_V1_5_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  DestroyEventService_V1_5_3_CS (EventServiceV1_5_3->EventService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEventService_V1_5_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_5_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_5_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
