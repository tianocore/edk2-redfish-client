...
//
#include <RedfishJsonStructure/EventService/v1_1_7/EfiEventServiceV1_1_7.h>
CHAR8 mResourceTypeStr [] = "#EventService";
BOOLEAN IsRevisonController = TRUE;

// Support EventService V1_1_7
...
{
  EFI_REDFISH_EVENTSERVICE_V1_1_7 *EventServiceV1_1_7;
  EFI_REDFISH_EVENTSERVICE_V1_1_7_CS *EventServiceV1_1_7Cs;
  ...
  Status = (EFI_STATUS)Json_EventService_V1_1_7_To_CS (ResoruceRaw, &EventServiceV1_1_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventServiceV1_1_7 = (EFI_REDFISH_EVENTSERVICE_V1_1_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTSERVICE_V1_1_7));
  if (EventServiceV1_1_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventServiceV1_1_7;
  EventServiceV1_1_7->EventService = EventServiceV1_1_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EventService_V1_1_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EventService_V1_1_7_JSON (*((EFI_REDFISH_EVENTSERVICE_V1_1_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EventService_V1_1_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventServiceV1_1_7 = (EFI_REDFISH_EVENTSERVICE_V1_1_7 *)InterpProp;
  DestroyEventService_V1_1_7_CS (EventServiceV1_1_7->EventService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEventService_V1_1_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_1_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_1_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
