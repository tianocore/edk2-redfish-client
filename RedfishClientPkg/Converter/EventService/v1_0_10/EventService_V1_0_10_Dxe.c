...
//
#include <RedfishJsonStructure/EventService/v1_0_10/EfiEventServiceV1_0_10.h>
CHAR8 mResourceTypeStr [] = "#EventService";
BOOLEAN IsRevisonController = TRUE;

// Support EventService V1_0_10
...
{
  EFI_REDFISH_EVENTSERVICE_V1_0_10 *EventServiceV1_0_10;
  EFI_REDFISH_EVENTSERVICE_V1_0_10_CS *EventServiceV1_0_10Cs;
  ...
  Status = (EFI_STATUS)Json_EventService_V1_0_10_To_CS (ResoruceRaw, &EventServiceV1_0_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventServiceV1_0_10 = (EFI_REDFISH_EVENTSERVICE_V1_0_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTSERVICE_V1_0_10));
  if (EventServiceV1_0_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventServiceV1_0_10;
  EventServiceV1_0_10->EventService = EventServiceV1_0_10Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EventService_V1_0_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EventService_V1_0_10_JSON (*((EFI_REDFISH_EVENTSERVICE_V1_0_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EventService_V1_0_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventServiceV1_0_10 = (EFI_REDFISH_EVENTSERVICE_V1_0_10 *)InterpProp;
  DestroyEventService_V1_0_10_CS (EventServiceV1_0_10->EventService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEventService_V1_0_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_0_10EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_0_10Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
