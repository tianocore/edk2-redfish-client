...
//
#include <RedfishJsonStructure/EventService/v1_2_2/EfiEventServiceV1_2_2.h>
CHAR8 mResourceTypeStr [] = "#EventService";
BOOLEAN IsRevisonController = TRUE;

// Support EventService V1_2_2
...
{
  EFI_REDFISH_EVENTSERVICE_V1_2_2 *EventServiceV1_2_2;
  EFI_REDFISH_EVENTSERVICE_V1_2_2_CS *EventServiceV1_2_2Cs;
  ...
  Status = (EFI_STATUS)Json_EventService_V1_2_2_To_CS (ResoruceRaw, &EventServiceV1_2_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventServiceV1_2_2 = (EFI_REDFISH_EVENTSERVICE_V1_2_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTSERVICE_V1_2_2));
  if (EventServiceV1_2_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventServiceV1_2_2;
  EventServiceV1_2_2->EventService = EventServiceV1_2_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EventService_V1_2_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EventService_V1_2_2_JSON (*((EFI_REDFISH_EVENTSERVICE_V1_2_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EventService_V1_2_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventServiceV1_2_2 = (EFI_REDFISH_EVENTSERVICE_V1_2_2 *)InterpProp;
  DestroyEventService_V1_2_2_CS (EventServiceV1_2_2->EventService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEventService_V1_2_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_2_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_2_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
