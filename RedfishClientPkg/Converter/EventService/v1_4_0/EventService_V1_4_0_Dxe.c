...
//
#include <RedfishJsonStructure/EventService/v1_4_0/EfiEventServiceV1_4_0.h>
CHAR8 mResourceTypeStr [] = "#EventService";
BOOLEAN IsRevisonController = TRUE;

// Support EventService V1_4_0
...
{
  EFI_REDFISH_EVENTSERVICE_V1_4_0 *EventServiceV1_4_0;
  EFI_REDFISH_EVENTSERVICE_V1_4_0_CS *EventServiceV1_4_0Cs;
  ...
  Status = (EFI_STATUS)Json_EventService_V1_4_0_To_CS (ResoruceRaw, &EventServiceV1_4_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EventServiceV1_4_0 = (EFI_REDFISH_EVENTSERVICE_V1_4_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_EVENTSERVICE_V1_4_0));
  if (EventServiceV1_4_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EventServiceV1_4_0;
  EventServiceV1_4_0->EventService = EventServiceV1_4_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EventService_V1_4_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EventService_V1_4_0_JSON (*((EFI_REDFISH_EVENTSERVICE_V1_4_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EventService_V1_4_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EventServiceV1_4_0 = (EFI_REDFISH_EVENTSERVICE_V1_4_0 *)InterpProp;
  DestroyEventService_V1_4_0_CS (EventServiceV1_4_0->EventService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEventService_V1_4_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_4_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEventService_V1_4_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
