...
//
#include <RedfishJsonStructure/Facility/v1_0_0/EfiFacilityV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#Facility";
BOOLEAN IsRevisonController = TRUE;

// Support Facility V1_0_0
...
{
  EFI_REDFISH_FACILITY_V1_0_0 *FacilityV1_0_0;
  EFI_REDFISH_FACILITY_V1_0_0_CS *FacilityV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Facility") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_Facility_V1_0_0_To_CS (ResoruceRaw, &FacilityV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  FacilityV1_0_0 = (EFI_REDFISH_FACILITY_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_FACILITY_V1_0_0));
  if (FacilityV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)FacilityV1_0_0;
  FacilityV1_0_0->Facility = FacilityV1_0_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Facility"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("Facility"), "Facility");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Facility"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("Facility"), "Facility");
...
/**
  The wrapper function of FacilityToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Facility_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Facility_V1_0_0_JSON (*((EFI_REDFISH_FACILITY_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Facility_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in FacilityToStruct.
...
)
{
  ...
  FacilityV1_0_0 = (EFI_REDFISH_FACILITY_V1_0_0 *)InterpProp;
  DestroyFacility_V1_0_0_CS (FacilityV1_0_0->Facility); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from FacilityFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyFacility_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishFacility_V1_0_0EntryPoint (
