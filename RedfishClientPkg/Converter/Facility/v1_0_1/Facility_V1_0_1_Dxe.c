...
//
#include <RedfishJsonStructure/Facility/v1_0_1/EfiFacilityV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#Facility";
BOOLEAN IsRevisonController = TRUE;

// Support Facility V1_0_1
...
{
  EFI_REDFISH_FACILITY_V1_0_1 *FacilityV1_0_1;
  EFI_REDFISH_FACILITY_V1_0_1_CS *FacilityV1_0_1Cs;
  ...
  Status = (EFI_STATUS)Json_Facility_V1_0_1_To_CS (ResoruceRaw, &FacilityV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  FacilityV1_0_1 = (EFI_REDFISH_FACILITY_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_FACILITY_V1_0_1));
  if (FacilityV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)FacilityV1_0_1;
  FacilityV1_0_1->Facility = FacilityV1_0_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Facility_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Facility_V1_0_1_JSON (*((EFI_REDFISH_FACILITY_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Facility_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  FacilityV1_0_1 = (EFI_REDFISH_FACILITY_V1_0_1 *)InterpProp;
  DestroyFacility_V1_0_1_CS (FacilityV1_0_1->Facility); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyFacility_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishFacility_V1_0_1EntryPoint (
