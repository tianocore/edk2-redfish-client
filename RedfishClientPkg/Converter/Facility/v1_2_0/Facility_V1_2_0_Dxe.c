...
//
#include <RedfishJsonStructure/Facility/v1_2_0/EfiFacilityV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#Facility";
BOOLEAN IsRevisonController = TRUE;

// Support Facility V1_2_0
...
{
  EFI_REDFISH_FACILITY_V1_2_0 *FacilityV1_2_0;
  EFI_REDFISH_FACILITY_V1_2_0_CS *FacilityV1_2_0Cs;
  ...
  Status = (EFI_STATUS)Json_Facility_V1_2_0_To_CS (ResoruceRaw, &FacilityV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  FacilityV1_2_0 = (EFI_REDFISH_FACILITY_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_FACILITY_V1_2_0));
  if (FacilityV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)FacilityV1_2_0;
  FacilityV1_2_0->Facility = FacilityV1_2_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Facility_V1_2_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Facility_V1_2_0_JSON (*((EFI_REDFISH_FACILITY_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Facility_V1_2_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  FacilityV1_2_0 = (EFI_REDFISH_FACILITY_V1_2_0 *)InterpProp;
  DestroyFacility_V1_2_0_CS (FacilityV1_2_0->Facility); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyFacility_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishFacility_V1_2_0EntryPoint (
