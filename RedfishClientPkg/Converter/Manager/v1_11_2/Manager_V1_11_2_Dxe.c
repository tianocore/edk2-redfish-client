...
//
#include <RedfishJsonStructure/Manager/v1_11_2/EfiManagerV1_11_2.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_11_2
...
{
  EFI_REDFISH_MANAGER_V1_11_2 *ManagerV1_11_2;
  EFI_REDFISH_MANAGER_V1_11_2_CS *ManagerV1_11_2Cs;
  ...
  Status = (EFI_STATUS)Json_Manager_V1_11_2_To_CS (ResoruceRaw, &ManagerV1_11_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_11_2 = (EFI_REDFISH_MANAGER_V1_11_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_11_2));
  if (ManagerV1_11_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerV1_11_2;
  ManagerV1_11_2->Manager = ManagerV1_11_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Manager_V1_11_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Manager_V1_11_2_JSON (*((EFI_REDFISH_MANAGER_V1_11_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Manager_V1_11_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerV1_11_2 = (EFI_REDFISH_MANAGER_V1_11_2 *)InterpProp;
  DestroyManager_V1_11_2_CS (ManagerV1_11_2->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManager_V1_11_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_11_2EntryPoint (
