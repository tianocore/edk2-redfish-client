...
//
#include <RedfishJsonStructure/Manager/v1_14_0/EfiManagerV1_14_0.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_14_0
...
{
  EFI_REDFISH_MANAGER_V1_14_0 *ManagerV1_14_0;
  EFI_REDFISH_MANAGER_V1_14_0_CS *ManagerV1_14_0Cs;
  ...
  Status = (EFI_STATUS)Json_Manager_V1_14_0_To_CS (ResoruceRaw, &ManagerV1_14_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_14_0 = (EFI_REDFISH_MANAGER_V1_14_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_14_0));
  if (ManagerV1_14_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerV1_14_0;
  ManagerV1_14_0->Manager = ManagerV1_14_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Manager_V1_14_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Manager_V1_14_0_JSON (*((EFI_REDFISH_MANAGER_V1_14_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Manager_V1_14_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerV1_14_0 = (EFI_REDFISH_MANAGER_V1_14_0 *)InterpProp;
  DestroyManager_V1_14_0_CS (ManagerV1_14_0->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManager_V1_14_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_14_0EntryPoint (
