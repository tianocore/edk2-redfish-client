...
//
#include <RedfishJsonStructure/Manager/v1_7_2/EfiManagerV1_7_2.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_7_2
...
{
  EFI_REDFISH_MANAGER_V1_7_2 *ManagerV1_7_2;
  EFI_REDFISH_MANAGER_V1_7_2_CS *ManagerV1_7_2Cs;
  ...
  Status = (EFI_STATUS)Json_Manager_V1_7_2_To_CS (ResoruceRaw, &ManagerV1_7_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_7_2 = (EFI_REDFISH_MANAGER_V1_7_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_7_2));
  if (ManagerV1_7_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerV1_7_2;
  ManagerV1_7_2->Manager = ManagerV1_7_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Manager_V1_7_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Manager_V1_7_2_JSON (*((EFI_REDFISH_MANAGER_V1_7_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Manager_V1_7_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerV1_7_2 = (EFI_REDFISH_MANAGER_V1_7_2 *)InterpProp;
  DestroyManager_V1_7_2_CS (ManagerV1_7_2->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManager_V1_7_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_7_2EntryPoint (
