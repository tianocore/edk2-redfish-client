...
//
#include <RedfishJsonStructure/Manager/v1_4_5/EfiManagerV1_4_5.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_4_5
...
{
  EFI_REDFISH_MANAGER_V1_4_5 *ManagerV1_4_5;
  EFI_REDFISH_MANAGER_V1_4_5_CS *ManagerV1_4_5Cs;
  ...
  Status = (EFI_STATUS)Json_Manager_V1_4_5_To_CS (ResoruceRaw, &ManagerV1_4_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_4_5 = (EFI_REDFISH_MANAGER_V1_4_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_4_5));
  if (ManagerV1_4_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerV1_4_5;
  ManagerV1_4_5->Manager = ManagerV1_4_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Manager_V1_4_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Manager_V1_4_5_JSON (*((EFI_REDFISH_MANAGER_V1_4_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Manager_V1_4_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerV1_4_5 = (EFI_REDFISH_MANAGER_V1_4_5 *)InterpProp;
  DestroyManager_V1_4_5_CS (ManagerV1_4_5->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManager_V1_4_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_4_5EntryPoint (
