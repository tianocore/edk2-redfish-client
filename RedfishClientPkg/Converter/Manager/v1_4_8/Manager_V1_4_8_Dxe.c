...
//
#include <RedfishJsonStructure/Manager/v1_4_8/EfiManagerV1_4_8.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_4_8
...
{
  EFI_REDFISH_MANAGER_V1_4_8 *ManagerV1_4_8;
  EFI_REDFISH_MANAGER_V1_4_8_CS *ManagerV1_4_8Cs;
  ...
  Status = (EFI_STATUS)Json_Manager_V1_4_8_To_CS (ResoruceRaw, &ManagerV1_4_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_4_8 = (EFI_REDFISH_MANAGER_V1_4_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_4_8));
  if (ManagerV1_4_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerV1_4_8;
  ManagerV1_4_8->Manager = ManagerV1_4_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Manager_V1_4_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Manager_V1_4_8_JSON (*((EFI_REDFISH_MANAGER_V1_4_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Manager_V1_4_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerV1_4_8 = (EFI_REDFISH_MANAGER_V1_4_8 *)InterpProp;
  DestroyManager_V1_4_8_CS (ManagerV1_4_8->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManager_V1_4_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_4_8EntryPoint (
