...
//
#include <RedfishJsonStructure/Manager/v1_7_3/EfiManagerV1_7_3.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_7_3
...
{
  EFI_REDFISH_MANAGER_V1_7_3 *ManagerV1_7_3;
  EFI_REDFISH_MANAGER_V1_7_3_CS *ManagerV1_7_3Cs;
  ...
  Status = (EFI_STATUS)Json_Manager_V1_7_3_To_CS (ResoruceRaw, &ManagerV1_7_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_7_3 = (EFI_REDFISH_MANAGER_V1_7_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_7_3));
  if (ManagerV1_7_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerV1_7_3;
  ManagerV1_7_3->Manager = ManagerV1_7_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Manager_V1_7_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Manager_V1_7_3_JSON (*((EFI_REDFISH_MANAGER_V1_7_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Manager_V1_7_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerV1_7_3 = (EFI_REDFISH_MANAGER_V1_7_3 *)InterpProp;
  DestroyManager_V1_7_3_CS (ManagerV1_7_3->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManager_V1_7_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_7_3EntryPoint (
