...
//
#include <RedfishJsonStructure/Manager/v1_8_4/EfiManagerV1_8_4.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_8_4
...
{
  EFI_REDFISH_MANAGER_V1_8_4 *ManagerV1_8_4;
  EFI_REDFISH_MANAGER_V1_8_4_CS *ManagerV1_8_4Cs;
  ...
  Status = (EFI_STATUS)Json_Manager_V1_8_4_To_CS (ResoruceRaw, &ManagerV1_8_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_8_4 = (EFI_REDFISH_MANAGER_V1_8_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_8_4));
  if (ManagerV1_8_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerV1_8_4;
  ManagerV1_8_4->Manager = ManagerV1_8_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Manager_V1_8_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Manager_V1_8_4_JSON (*((EFI_REDFISH_MANAGER_V1_8_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Manager_V1_8_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerV1_8_4 = (EFI_REDFISH_MANAGER_V1_8_4 *)InterpProp;
  DestroyManager_V1_8_4_CS (ManagerV1_8_4->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManager_V1_8_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_8_4EntryPoint (
