...
//
#include <RedfishJsonStructure/Manager/v1_0_12/EfiManagerV1_0_12.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_0_12
...
{
  EFI_REDFISH_MANAGER_V1_0_12 *ManagerV1_0_12;
  EFI_REDFISH_MANAGER_V1_0_12_CS *ManagerV1_0_12Cs;
  ...
  Status = (EFI_STATUS)Json_Manager_V1_0_12_To_CS (ResoruceRaw, &ManagerV1_0_12Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_0_12 = (EFI_REDFISH_MANAGER_V1_0_12 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_0_12));
  if (ManagerV1_0_12 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerV1_0_12;
  ManagerV1_0_12->Manager = ManagerV1_0_12Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Manager_V1_0_12_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Manager_V1_0_12_JSON (*((EFI_REDFISH_MANAGER_V1_0_12_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Manager_V1_0_12_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerV1_0_12 = (EFI_REDFISH_MANAGER_V1_0_12 *)InterpProp;
  DestroyManager_V1_0_12_CS (ManagerV1_0_12->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManager_V1_0_12_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_0_12EntryPoint (
