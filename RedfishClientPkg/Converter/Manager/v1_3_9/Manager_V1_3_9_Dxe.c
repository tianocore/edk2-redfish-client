...
//
#include <RedfishJsonStructure/Manager/v1_3_9/EfiManagerV1_3_9.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_3_9
...
{
  EFI_REDFISH_MANAGER_V1_3_9 *ManagerV1_3_9;
  EFI_REDFISH_MANAGER_V1_3_9_CS *ManagerV1_3_9Cs;
  ...
  Status = (EFI_STATUS)Json_Manager_V1_3_9_To_CS (ResoruceRaw, &ManagerV1_3_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_3_9 = (EFI_REDFISH_MANAGER_V1_3_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_3_9));
  if (ManagerV1_3_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerV1_3_9;
  ManagerV1_3_9->Manager = ManagerV1_3_9Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Manager_V1_3_9_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Manager_V1_3_9_JSON (*((EFI_REDFISH_MANAGER_V1_3_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Manager_V1_3_9_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerV1_3_9 = (EFI_REDFISH_MANAGER_V1_3_9 *)InterpProp;
  DestroyManager_V1_3_9_CS (ManagerV1_3_9->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManager_V1_3_9_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_3_9EntryPoint (
