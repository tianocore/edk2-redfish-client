...
//
#include <RedfishJsonStructure/Manager/v1_3_7/EfiManagerV1_3_7.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_3_7
...
{
  EFI_REDFISH_MANAGER_V1_3_7 *ManagerV1_3_7;
  EFI_REDFISH_MANAGER_V1_3_7_CS *ManagerV1_3_7Cs;
  ...
  Status = (EFI_STATUS)Json_Manager_V1_3_7_To_CS (ResoruceRaw, &ManagerV1_3_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_3_7 = (EFI_REDFISH_MANAGER_V1_3_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_3_7));
  if (ManagerV1_3_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerV1_3_7;
  ManagerV1_3_7->Manager = ManagerV1_3_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Manager_V1_3_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Manager_V1_3_7_JSON (*((EFI_REDFISH_MANAGER_V1_3_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Manager_V1_3_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerV1_3_7 = (EFI_REDFISH_MANAGER_V1_3_7 *)InterpProp;
  DestroyManager_V1_3_7_CS (ManagerV1_3_7->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManager_V1_3_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_3_7EntryPoint (
