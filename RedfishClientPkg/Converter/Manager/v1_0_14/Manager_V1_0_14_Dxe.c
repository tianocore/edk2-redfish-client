...
//
#include <RedfishJsonStructure/Manager/v1_0_14/EfiManagerV1_0_14.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_0_14
...
{
  EFI_REDFISH_MANAGER_V1_0_14 *ManagerV1_0_14;
  EFI_REDFISH_MANAGER_V1_0_14_CS *ManagerV1_0_14Cs;
  ...
  Status = (EFI_STATUS)Json_Manager_V1_0_14_To_CS (ResoruceRaw, &ManagerV1_0_14Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_0_14 = (EFI_REDFISH_MANAGER_V1_0_14 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_0_14));
  if (ManagerV1_0_14 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerV1_0_14;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Manager_V1_0_14_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Manager_V1_0_14_JSON (*((EFI_REDFISH_MANAGER_V1_0_14_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Manager_V1_0_14_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerV1_0_14 = (EFI_REDFISH_MANAGER_V1_0_14 *)InterpProp;
  DestroyManager_V1_0_14_CS (ManagerV1_0_14->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManager_V1_0_14_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_0_14EntryPoint (
