...
//
#include <RedfishJsonStructure/Manager/v1_6_6/EfiManagerV1_6_6.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_6_6
...
{
  EFI_REDFISH_MANAGER_V1_6_6 *ManagerV1_6_6;
  EFI_REDFISH_MANAGER_V1_6_6_CS *ManagerV1_6_6Cs;
  ...
  Status = (EFI_STATUS)Json_Manager_V1_6_6_To_CS (ResoruceRaw, &ManagerV1_6_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_6_6 = (EFI_REDFISH_MANAGER_V1_6_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_6_6));
  if (ManagerV1_6_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerV1_6_6;
  ManagerV1_6_6->Manager = ManagerV1_6_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Manager_V1_6_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Manager_V1_6_6_JSON (*((EFI_REDFISH_MANAGER_V1_6_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Manager_V1_6_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerV1_6_6 = (EFI_REDFISH_MANAGER_V1_6_6 *)InterpProp;
  DestroyManager_V1_6_6_CS (ManagerV1_6_6->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManager_V1_6_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_6_6EntryPoint (
