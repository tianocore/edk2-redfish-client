...
//
#include <RedfishJsonStructure/Manager/v1_0_15/EfiManagerV1_0_15.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_0_15
...
{
  EFI_REDFISH_MANAGER_V1_0_15 *ManagerV1_0_15;
  EFI_REDFISH_MANAGER_V1_0_15_CS *ManagerV1_0_15Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ErrataVersion, "15") != 0) ||
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "Manager") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_Manager_V1_0_15_To_CS (ResoruceRaw, &ManagerV1_0_15Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_0_15 = (EFI_REDFISH_MANAGER_V1_0_15 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_0_15));
  if (ManagerV1_0_15 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerV1_0_15;
  ManagerV1_0_15->Manager = ManagerV1_0_15Cs;
  ResourceTypeMajorVersion = "1";
  ResourceTypeMinorVersion = "0";
  ResourceTypeErrataVersion = "15";
  //
  // Set header.
  //
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Manager_V1_0_15_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Manager_V1_0_15_JSON (*((EFI_REDFISH_MANAGER_V1_0_15_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Manager_V1_0_15_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerV1_0_15 = (EFI_REDFISH_MANAGER_V1_0_15 *)InterpProp;
  DestroyManager_V1_0_15_CS (ManagerV1_0_15->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManager_V1_0_15_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_0_15EntryPoint (
