...
//
#include <RedfishJsonStructure/Manager/v1_1_13/EfiManagerV1_1_13.h>
CHAR8 mResourceTypeStr [] = "#Manager";
BOOLEAN IsRevisonController = TRUE;

// Support Manager V1_1_13
...
{
  EFI_REDFISH_MANAGER_V1_1_13 *ManagerV1_1_13;
  EFI_REDFISH_MANAGER_V1_1_13_CS *ManagerV1_1_13Cs;
  ...
  Status = (EFI_STATUS)Json_Manager_V1_1_13_To_CS (ResoruceRaw, &ManagerV1_1_13Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerV1_1_13 = (EFI_REDFISH_MANAGER_V1_1_13 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGER_V1_1_13));
  if (ManagerV1_1_13 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerV1_1_13;
  ManagerV1_1_13->Manager = ManagerV1_1_13Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Manager_V1_1_13_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Manager_V1_1_13_JSON (*((EFI_REDFISH_MANAGER_V1_1_13_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Manager_V1_1_13_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ManagerV1_1_13 = (EFI_REDFISH_MANAGER_V1_1_13 *)InterpProp;
  DestroyManager_V1_1_13_CS (ManagerV1_1_13->Manager); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyManager_V1_1_13_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManager_V1_1_13EntryPoint (
