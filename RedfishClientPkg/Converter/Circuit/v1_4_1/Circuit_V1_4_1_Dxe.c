...
//
#include <RedfishJsonStructure/Circuit/v1_4_1/EfiCircuitV1_4_1.h>
CHAR8 mResourceTypeStr [] = "#Circuit";
BOOLEAN IsRevisonController = TRUE;

// Support Circuit V1_4_1
...
{
  EFI_REDFISH_CIRCUIT_V1_4_1 *CircuitV1_4_1;
  EFI_REDFISH_CIRCUIT_V1_4_1_CS *CircuitV1_4_1Cs;
  ...
  Status = (EFI_STATUS)Json_Circuit_V1_4_1_To_CS (ResoruceRaw, &CircuitV1_4_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CircuitV1_4_1 = (EFI_REDFISH_CIRCUIT_V1_4_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CIRCUIT_V1_4_1));
  if (CircuitV1_4_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)CircuitV1_4_1;
  CircuitV1_4_1->Circuit = CircuitV1_4_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Circuit_V1_4_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Circuit_V1_4_1_JSON (*((EFI_REDFISH_CIRCUIT_V1_4_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Circuit_V1_4_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  CircuitV1_4_1 = (EFI_REDFISH_CIRCUIT_V1_4_1 *)InterpProp;
  DestroyCircuit_V1_4_1_CS (CircuitV1_4_1->Circuit); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyCircuit_V1_4_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCircuit_V1_4_1EntryPoint (
