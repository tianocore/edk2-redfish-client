...
//
#include <RedfishJsonStructure/Circuit/v1_0_0/EfiCircuitV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#Circuit";
BOOLEAN IsRevisonController = TRUE;

// Support Circuit V1_0_0
...
{
  EFI_REDFISH_CIRCUIT_V1_0_0 *CircuitV1_0_0;
  EFI_REDFISH_CIRCUIT_V1_0_0_CS *CircuitV1_0_0Cs;
  ...
  Status = (EFI_STATUS)Json_Circuit_V1_0_0_To_CS (ResoruceRaw, &CircuitV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CircuitV1_0_0 = (EFI_REDFISH_CIRCUIT_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CIRCUIT_V1_0_0));
  if (CircuitV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)CircuitV1_0_0;
  CircuitV1_0_0->Circuit = CircuitV1_0_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Circuit_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Circuit_V1_0_0_JSON (*((EFI_REDFISH_CIRCUIT_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Circuit_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  CircuitV1_0_0 = (EFI_REDFISH_CIRCUIT_V1_0_0 *)InterpProp;
  DestroyCircuit_V1_0_0_CS (CircuitV1_0_0->Circuit); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyCircuit_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCircuit_V1_0_0EntryPoint (
