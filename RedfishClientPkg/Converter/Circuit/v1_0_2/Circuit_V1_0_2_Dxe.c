...
//
#include <RedfishJsonStructure/Circuit/v1_0_2/EfiCircuitV1_0_2.h>
CHAR8 mResourceTypeStr [] = "#Circuit";
BOOLEAN IsRevisonController = TRUE;

// Support Circuit V1_0_2
...
{
  EFI_REDFISH_CIRCUIT_V1_0_2 *CircuitV1_0_2;
  EFI_REDFISH_CIRCUIT_V1_0_2_CS *CircuitV1_0_2Cs;
  ...
  Status = (EFI_STATUS)Json_Circuit_V1_0_2_To_CS (ResoruceRaw, &CircuitV1_0_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  CircuitV1_0_2 = (EFI_REDFISH_CIRCUIT_V1_0_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_CIRCUIT_V1_0_2));
  if (CircuitV1_0_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)CircuitV1_0_2;
  CircuitV1_0_2->Circuit = CircuitV1_0_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Circuit_V1_0_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Circuit_V1_0_2_JSON (*((EFI_REDFISH_CIRCUIT_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Circuit_V1_0_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  CircuitV1_0_2 = (EFI_REDFISH_CIRCUIT_V1_0_2 *)InterpProp;
  DestroyCircuit_V1_0_2_CS (CircuitV1_0_2->Circuit); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyCircuit_V1_0_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishCircuit_V1_0_2EntryPoint (
