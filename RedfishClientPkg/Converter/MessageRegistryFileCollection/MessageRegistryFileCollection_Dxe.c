...
)
{
  ...
  return (EFI_STATUS)CS_To_MessageRegistryFileCollection_JSON (*((EFI_REDFISH_MESSAGEREGISTRYFILECOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
