...
//
#include <RedfishJsonStructure/ProcessorMetrics/v1_0_5/EfiProcessorMetricsV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#ProcessorMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support ProcessorMetrics V1_0_5
...
{
  EFI_REDFISH_PROCESSORMETRICS_V1_0_5 *ProcessorMetricsV1_0_5;
  EFI_REDFISH_PROCESSORMETRICS_V1_0_5_CS *ProcessorMetricsV1_0_5Cs;
  ...
  Status = (EFI_STATUS)Json_ProcessorMetrics_V1_0_5_To_CS (ResoruceRaw, &ProcessorMetricsV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorMetricsV1_0_5 = (EFI_REDFISH_PROCESSORMETRICS_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSORMETRICS_V1_0_5));
  if (ProcessorMetricsV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ProcessorMetricsV1_0_5;
  ProcessorMetricsV1_0_5->ProcessorMetrics = ProcessorMetricsV1_0_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ProcessorMetrics_V1_0_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ProcessorMetrics_V1_0_5_JSON (*((EFI_REDFISH_PROCESSORMETRICS_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ProcessorMetrics_V1_0_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ProcessorMetricsV1_0_5 = (EFI_REDFISH_PROCESSORMETRICS_V1_0_5 *)InterpProp;
  DestroyProcessorMetrics_V1_0_5_CS (ProcessorMetricsV1_0_5->ProcessorMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyProcessorMetrics_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessorMetrics_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishProcessorMetrics_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
