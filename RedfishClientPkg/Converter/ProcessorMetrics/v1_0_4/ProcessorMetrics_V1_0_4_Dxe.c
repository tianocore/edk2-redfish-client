...
//
#include <RedfishJsonStructure/ProcessorMetrics/v1_0_4/EfiProcessorMetricsV1_0_4.h>
CHAR8 mResourceTypeStr [] = "#ProcessorMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support ProcessorMetrics V1_0_4
...
{
  EFI_REDFISH_PROCESSORMETRICS_V1_0_4 *ProcessorMetricsV1_0_4;
  EFI_REDFISH_PROCESSORMETRICS_V1_0_4_CS *ProcessorMetricsV1_0_4Cs;
  ...
  Status = (EFI_STATUS)Json_ProcessorMetrics_V1_0_4_To_CS (ResoruceRaw, &ProcessorMetricsV1_0_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorMetricsV1_0_4 = (EFI_REDFISH_PROCESSORMETRICS_V1_0_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSORMETRICS_V1_0_4));
  if (ProcessorMetricsV1_0_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ProcessorMetricsV1_0_4;
  ProcessorMetricsV1_0_4->ProcessorMetrics = ProcessorMetricsV1_0_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ProcessorMetrics_V1_0_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ProcessorMetrics_V1_0_4_JSON (*((EFI_REDFISH_PROCESSORMETRICS_V1_0_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ProcessorMetrics_V1_0_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ProcessorMetricsV1_0_4 = (EFI_REDFISH_PROCESSORMETRICS_V1_0_4 *)InterpProp;
  DestroyProcessorMetrics_V1_0_4_CS (ProcessorMetricsV1_0_4->ProcessorMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyProcessorMetrics_V1_0_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessorMetrics_V1_0_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishProcessorMetrics_V1_0_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
