...
//
#include <RedfishJsonStructure/ProcessorMetrics/v1_0_3/EfiProcessorMetricsV1_0_3.h>
CHAR8 mResourceTypeStr [] = "#ProcessorMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support ProcessorMetrics V1_0_3
...
{
  EFI_REDFISH_PROCESSORMETRICS_V1_0_3 *ProcessorMetricsV1_0_3;
  EFI_REDFISH_PROCESSORMETRICS_V1_0_3_CS *ProcessorMetricsV1_0_3Cs;
  ...
  Status = (EFI_STATUS)Json_ProcessorMetrics_V1_0_3_To_CS (ResoruceRaw, &ProcessorMetricsV1_0_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorMetricsV1_0_3 = (EFI_REDFISH_PROCESSORMETRICS_V1_0_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSORMETRICS_V1_0_3));
  if (ProcessorMetricsV1_0_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ProcessorMetricsV1_0_3;
  ProcessorMetricsV1_0_3->ProcessorMetrics = ProcessorMetricsV1_0_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ProcessorMetrics_V1_0_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ProcessorMetrics_V1_0_3_JSON (*((EFI_REDFISH_PROCESSORMETRICS_V1_0_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ProcessorMetrics_V1_0_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ProcessorMetricsV1_0_3 = (EFI_REDFISH_PROCESSORMETRICS_V1_0_3 *)InterpProp;
  DestroyProcessorMetrics_V1_0_3_CS (ProcessorMetricsV1_0_3->ProcessorMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyProcessorMetrics_V1_0_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessorMetrics_V1_0_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishProcessorMetrics_V1_0_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
