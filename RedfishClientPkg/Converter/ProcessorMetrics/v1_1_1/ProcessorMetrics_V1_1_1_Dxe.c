...
//
#include <RedfishJsonStructure/ProcessorMetrics/v1_1_1/EfiProcessorMetricsV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#ProcessorMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support ProcessorMetrics V1_1_1
...
{
  EFI_REDFISH_PROCESSORMETRICS_V1_1_1 *ProcessorMetricsV1_1_1;
  EFI_REDFISH_PROCESSORMETRICS_V1_1_1_CS *ProcessorMetricsV1_1_1Cs;
  ...
  Status = (EFI_STATUS)Json_ProcessorMetrics_V1_1_1_To_CS (ResoruceRaw, &ProcessorMetricsV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorMetricsV1_1_1 = (EFI_REDFISH_PROCESSORMETRICS_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSORMETRICS_V1_1_1));
  if (ProcessorMetricsV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ProcessorMetricsV1_1_1;
  ProcessorMetricsV1_1_1->ProcessorMetrics = ProcessorMetricsV1_1_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ProcessorMetrics_V1_1_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ProcessorMetrics_V1_1_1_JSON (*((EFI_REDFISH_PROCESSORMETRICS_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ProcessorMetrics_V1_1_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ProcessorMetricsV1_1_1 = (EFI_REDFISH_PROCESSORMETRICS_V1_1_1 *)InterpProp;
  DestroyProcessorMetrics_V1_1_1_CS (ProcessorMetricsV1_1_1->ProcessorMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyProcessorMetrics_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessorMetrics_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishProcessorMetrics_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
