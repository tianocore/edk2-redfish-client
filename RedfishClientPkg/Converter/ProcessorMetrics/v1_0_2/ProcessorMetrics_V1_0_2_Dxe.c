...
)
{
  ...
  return (EFI_STATUS)CS_To_ProcessorMetrics_V1_0_2_JSON (*((EFI_REDFISH_PROCESSORMETRICS_V1_0_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
