...
//
#include <RedfishJsonStructure/ProcessorMetrics/v1_1_0/EfiProcessorMetricsV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#ProcessorMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support ProcessorMetrics V1_1_0
...
{
  EFI_REDFISH_PROCESSORMETRICS_V1_1_0 *ProcessorMetricsV1_1_0;
  EFI_REDFISH_PROCESSORMETRICS_V1_1_0_CS *ProcessorMetricsV1_1_0Cs;
  ...
  Status = (EFI_STATUS)Json_ProcessorMetrics_V1_1_0_To_CS (ResoruceRaw, &ProcessorMetricsV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ProcessorMetricsV1_1_0 = (EFI_REDFISH_PROCESSORMETRICS_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_PROCESSORMETRICS_V1_1_0));
  if (ProcessorMetricsV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ProcessorMetricsV1_1_0;
  ProcessorMetricsV1_1_0->ProcessorMetrics = ProcessorMetricsV1_1_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ProcessorMetrics_V1_1_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ProcessorMetrics_V1_1_0_JSON (*((EFI_REDFISH_PROCESSORMETRICS_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ProcessorMetrics_V1_1_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ProcessorMetricsV1_1_0 = (EFI_REDFISH_PROCESSORMETRICS_V1_1_0 *)InterpProp;
  DestroyProcessorMetrics_V1_1_0_CS (ProcessorMetricsV1_1_0->ProcessorMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyProcessorMetrics_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishProcessorMetrics_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishProcessorMetrics_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
