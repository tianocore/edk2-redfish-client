...
//
#include <RedfishJsonStructure/UpdateService/v1_0_10/EfiUpdateServiceV1_0_10.h>
CHAR8 mResourceTypeStr [] = "#UpdateService";
BOOLEAN IsRevisonController = TRUE;

// Support UpdateService V1_0_10
...
{
  EFI_REDFISH_UPDATESERVICE_V1_0_10 *UpdateServiceV1_0_10;
  EFI_REDFISH_UPDATESERVICE_V1_0_10_CS *UpdateServiceV1_0_10Cs;
  ...
  Status = (EFI_STATUS)Json_UpdateService_V1_0_10_To_CS (ResoruceRaw, &UpdateServiceV1_0_10Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  UpdateServiceV1_0_10 = (EFI_REDFISH_UPDATESERVICE_V1_0_10 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_UPDATESERVICE_V1_0_10));
  if (UpdateServiceV1_0_10 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)UpdateServiceV1_0_10;
  UpdateServiceV1_0_10->UpdateService = UpdateServiceV1_0_10Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("UpdateService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("UpdateService"), "UpdateService");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("UpdateService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("UpdateService"), "UpdateService");
...
/**
  The wrapper function of UpdateServiceToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_UpdateService_V1_0_10_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_UpdateService_V1_0_10_JSON (*((EFI_REDFISH_UPDATESERVICE_V1_0_10_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_UpdateService_V1_0_10_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  UpdateServiceV1_0_10 = (EFI_REDFISH_UPDATESERVICE_V1_0_10 *)InterpProp;
  DestroyUpdateService_V1_0_10_CS (UpdateServiceV1_0_10->UpdateService); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from UpdateServiceFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyUpdateService_V1_0_10_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_0_10EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_0_10Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
