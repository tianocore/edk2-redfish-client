...
//
#include <RedfishJsonStructure/UpdateService/v1_4_3/EfiUpdateServiceV1_4_3.h>
CHAR8 mResourceTypeStr [] = "#UpdateService";
BOOLEAN IsRevisonController = TRUE;

// Support UpdateService V1_4_3
...
{
  EFI_REDFISH_UPDATESERVICE_V1_4_3 *UpdateServiceV1_4_3;
  EFI_REDFISH_UPDATESERVICE_V1_4_3_CS *UpdateServiceV1_4_3Cs;
  ...
  Status = (EFI_STATUS)Json_UpdateService_V1_4_3_To_CS (ResoruceRaw, &UpdateServiceV1_4_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  UpdateServiceV1_4_3 = (EFI_REDFISH_UPDATESERVICE_V1_4_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_UPDATESERVICE_V1_4_3));
  if (UpdateServiceV1_4_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)UpdateServiceV1_4_3;
  UpdateServiceV1_4_3->UpdateService = UpdateServiceV1_4_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_UpdateService_V1_4_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_UpdateService_V1_4_3_JSON (*((EFI_REDFISH_UPDATESERVICE_V1_4_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_UpdateService_V1_4_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  UpdateServiceV1_4_3 = (EFI_REDFISH_UPDATESERVICE_V1_4_3 *)InterpProp;
  DestroyUpdateService_V1_4_3_CS (UpdateServiceV1_4_3->UpdateService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyUpdateService_V1_4_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_4_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_4_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
