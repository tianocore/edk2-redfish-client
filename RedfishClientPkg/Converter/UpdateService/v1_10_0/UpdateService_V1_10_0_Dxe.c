...
//
#include <RedfishJsonStructure/UpdateService/v1_10_0/EfiUpdateServiceV1_10_0.h>
CHAR8 mResourceTypeStr [] = "#UpdateService";
BOOLEAN IsRevisonController = TRUE;

// Support UpdateService V1_10_0
...
{
  EFI_REDFISH_UPDATESERVICE_V1_10_0 *UpdateServiceV1_10_0;
  EFI_REDFISH_UPDATESERVICE_V1_10_0_CS *UpdateServiceV1_10_0Cs;
  ...
  Status = (EFI_STATUS)Json_UpdateService_V1_10_0_To_CS (ResoruceRaw, &UpdateServiceV1_10_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  UpdateServiceV1_10_0 = (EFI_REDFISH_UPDATESERVICE_V1_10_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_UPDATESERVICE_V1_10_0));
  if (UpdateServiceV1_10_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)UpdateServiceV1_10_0;
  UpdateServiceV1_10_0->UpdateService = UpdateServiceV1_10_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_UpdateService_V1_10_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_UpdateService_V1_10_0_JSON (*((EFI_REDFISH_UPDATESERVICE_V1_10_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_UpdateService_V1_10_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  UpdateServiceV1_10_0 = (EFI_REDFISH_UPDATESERVICE_V1_10_0 *)InterpProp;
  DestroyUpdateService_V1_10_0_CS (UpdateServiceV1_10_0->UpdateService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyUpdateService_V1_10_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_10_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_10_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
