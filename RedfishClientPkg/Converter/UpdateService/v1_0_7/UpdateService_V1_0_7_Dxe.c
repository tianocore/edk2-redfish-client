...
//
#include <RedfishJsonStructure/UpdateService/v1_0_7/EfiUpdateServiceV1_0_7.h>
CHAR8 mResourceTypeStr [] = "#UpdateService";
BOOLEAN IsRevisonController = TRUE;

// Support UpdateService V1_0_7
...
{
  EFI_REDFISH_UPDATESERVICE_V1_0_7 *UpdateServiceV1_0_7;
  EFI_REDFISH_UPDATESERVICE_V1_0_7_CS *UpdateServiceV1_0_7Cs;
  ...
  Status = (EFI_STATUS)Json_UpdateService_V1_0_7_To_CS (ResoruceRaw, &UpdateServiceV1_0_7Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  UpdateServiceV1_0_7 = (EFI_REDFISH_UPDATESERVICE_V1_0_7 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_UPDATESERVICE_V1_0_7));
  if (UpdateServiceV1_0_7 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)UpdateServiceV1_0_7;
  UpdateServiceV1_0_7->UpdateService = UpdateServiceV1_0_7Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_UpdateService_V1_0_7_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_UpdateService_V1_0_7_JSON (*((EFI_REDFISH_UPDATESERVICE_V1_0_7_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_UpdateService_V1_0_7_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  UpdateServiceV1_0_7 = (EFI_REDFISH_UPDATESERVICE_V1_0_7 *)InterpProp;
  DestroyUpdateService_V1_0_7_CS (UpdateServiceV1_0_7->UpdateService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyUpdateService_V1_0_7_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_0_7EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_0_7Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
