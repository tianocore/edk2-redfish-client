...
//
#include <RedfishJsonStructure/UpdateService/v1_7_1/EfiUpdateServiceV1_7_1.h>
CHAR8 mResourceTypeStr [] = "#UpdateService";
BOOLEAN IsRevisonController = TRUE;

// Support UpdateService V1_7_1
...
{
  EFI_REDFISH_UPDATESERVICE_V1_7_1 *UpdateServiceV1_7_1;
  EFI_REDFISH_UPDATESERVICE_V1_7_1_CS *UpdateServiceV1_7_1Cs;
  ...
  Status = (EFI_STATUS)Json_UpdateService_V1_7_1_To_CS (ResoruceRaw, &UpdateServiceV1_7_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  UpdateServiceV1_7_1 = (EFI_REDFISH_UPDATESERVICE_V1_7_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_UPDATESERVICE_V1_7_1));
  if (UpdateServiceV1_7_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)UpdateServiceV1_7_1;
  UpdateServiceV1_7_1->UpdateService = UpdateServiceV1_7_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_UpdateService_V1_7_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_UpdateService_V1_7_1_JSON (*((EFI_REDFISH_UPDATESERVICE_V1_7_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_UpdateService_V1_7_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  UpdateServiceV1_7_1 = (EFI_REDFISH_UPDATESERVICE_V1_7_1 *)InterpProp;
  DestroyUpdateService_V1_7_1_CS (UpdateServiceV1_7_1->UpdateService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyUpdateService_V1_7_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_7_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_7_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
