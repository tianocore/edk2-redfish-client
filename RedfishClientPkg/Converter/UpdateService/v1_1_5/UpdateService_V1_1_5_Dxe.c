...
//
#include <RedfishJsonStructure/UpdateService/v1_1_5/EfiUpdateServiceV1_1_5.h>
CHAR8 mResourceTypeStr [] = "#UpdateService";
BOOLEAN IsRevisonController = TRUE;

// Support UpdateService V1_1_5
...
{
  EFI_REDFISH_UPDATESERVICE_V1_1_5 *UpdateServiceV1_1_5;
  EFI_REDFISH_UPDATESERVICE_V1_1_5_CS *UpdateServiceV1_1_5Cs;
  ...
  Status = (EFI_STATUS)Json_UpdateService_V1_1_5_To_CS (ResoruceRaw, &UpdateServiceV1_1_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  UpdateServiceV1_1_5 = (EFI_REDFISH_UPDATESERVICE_V1_1_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_UPDATESERVICE_V1_1_5));
  if (UpdateServiceV1_1_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)UpdateServiceV1_1_5;
  UpdateServiceV1_1_5->UpdateService = UpdateServiceV1_1_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_UpdateService_V1_1_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_UpdateService_V1_1_5_JSON (*((EFI_REDFISH_UPDATESERVICE_V1_1_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_UpdateService_V1_1_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  UpdateServiceV1_1_5 = (EFI_REDFISH_UPDATESERVICE_V1_1_5 *)InterpProp;
  DestroyUpdateService_V1_1_5_CS (UpdateServiceV1_1_5->UpdateService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyUpdateService_V1_1_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_1_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_1_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
