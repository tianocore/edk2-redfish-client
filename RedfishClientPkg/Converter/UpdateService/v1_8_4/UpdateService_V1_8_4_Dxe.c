...
//
#include <RedfishJsonStructure/UpdateService/v1_8_4/EfiUpdateServiceV1_8_4.h>
CHAR8 mResourceTypeStr [] = "#UpdateService";
BOOLEAN IsRevisonController = TRUE;

// Support UpdateService V1_8_4
...
{
  EFI_REDFISH_UPDATESERVICE_V1_8_4 *UpdateServiceV1_8_4;
  EFI_REDFISH_UPDATESERVICE_V1_8_4_CS *UpdateServiceV1_8_4Cs;
  ...
  Status = (EFI_STATUS)Json_UpdateService_V1_8_4_To_CS (ResoruceRaw, &UpdateServiceV1_8_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  UpdateServiceV1_8_4 = (EFI_REDFISH_UPDATESERVICE_V1_8_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_UPDATESERVICE_V1_8_4));
  if (UpdateServiceV1_8_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)UpdateServiceV1_8_4;
  UpdateServiceV1_8_4->UpdateService = UpdateServiceV1_8_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_UpdateService_V1_8_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_UpdateService_V1_8_4_JSON (*((EFI_REDFISH_UPDATESERVICE_V1_8_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_UpdateService_V1_8_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  UpdateServiceV1_8_4 = (EFI_REDFISH_UPDATESERVICE_V1_8_4 *)InterpProp;
  DestroyUpdateService_V1_8_4_CS (UpdateServiceV1_8_4->UpdateService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyUpdateService_V1_8_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_8_4EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_8_4Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
