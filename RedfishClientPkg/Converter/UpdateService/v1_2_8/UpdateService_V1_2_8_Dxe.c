...
//
#include <RedfishJsonStructure/UpdateService/v1_2_8/EfiUpdateServiceV1_2_8.h>
CHAR8 mResourceTypeStr [] = "#UpdateService";
BOOLEAN IsRevisonController = TRUE;

// Support UpdateService V1_2_8
...
{
  EFI_REDFISH_UPDATESERVICE_V1_2_8 *UpdateServiceV1_2_8;
  EFI_REDFISH_UPDATESERVICE_V1_2_8_CS *UpdateServiceV1_2_8Cs;
  ...
  Status = (EFI_STATUS)Json_UpdateService_V1_2_8_To_CS (ResoruceRaw, &UpdateServiceV1_2_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  UpdateServiceV1_2_8 = (EFI_REDFISH_UPDATESERVICE_V1_2_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_UPDATESERVICE_V1_2_8));
  if (UpdateServiceV1_2_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)UpdateServiceV1_2_8;
  UpdateServiceV1_2_8->UpdateService = UpdateServiceV1_2_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_UpdateService_V1_2_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_UpdateService_V1_2_8_JSON (*((EFI_REDFISH_UPDATESERVICE_V1_2_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_UpdateService_V1_2_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  UpdateServiceV1_2_8 = (EFI_REDFISH_UPDATESERVICE_V1_2_8 *)InterpProp;
  DestroyUpdateService_V1_2_8_CS (UpdateServiceV1_2_8->UpdateService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyUpdateService_V1_2_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_2_8EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishUpdateService_V1_2_8Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
