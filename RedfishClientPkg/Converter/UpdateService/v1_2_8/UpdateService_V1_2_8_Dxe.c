...
)
{
  ...
  return (EFI_STATUS)CS_To_UpdateService_V1_2_8_JSON (*((EFI_REDFISH_UPDATESERVICE_V1_2_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
