...
//
#include <RedfishJsonStructure/Fan/v1_1_1/EfiFanV1_1_1.h>
...
{
  EFI_REDFISH_FAN_V1_1_1 *FanV1_1_1;
  EFI_REDFISH_FAN_V1_1_1_CS *FanV1_1_1Cs;
  ...
  Status = (EFI_STATUS)Json_Fan_V1_1_1_To_CS (ResoruceRaw, &FanV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  FanV1_1_1 = (EFI_REDFISH_FAN_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_FAN_V1_1_1));
  if (FanV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)FanV1_1_1;
  FanV1_1_1->Fan = FanV1_1_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Fan_V1_1_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Fan_V1_1_1_JSON (*((EFI_REDFISH_FAN_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Fan_V1_1_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  FanV1_1_1 = (EFI_REDFISH_FAN_V1_1_1 *)InterpProp;
  DestroyFan_V1_1_1_CS (FanV1_1_1->Fan); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyFan_V1_1_1_Json (ResoruceRaw);
}
