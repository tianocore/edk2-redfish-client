...
//
#include <RedfishJsonStructure/Fan/v1_0_0/EfiFanV1_0_0.h>
...
{
  EFI_REDFISH_FAN_V1_0_0 *FanV1_0_0;
  EFI_REDFISH_FAN_V1_0_0_CS *FanV1_0_0Cs;
  ...
  Status = (EFI_STATUS)Json_Fan_V1_0_0_To_CS (ResoruceRaw, &FanV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  FanV1_0_0 = (EFI_REDFISH_FAN_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_FAN_V1_0_0));
  if (FanV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)FanV1_0_0;
  FanV1_0_0->Fan = FanV1_0_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Fan_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Fan_V1_0_0_JSON (*((EFI_REDFISH_FAN_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Fan_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  FanV1_0_0 = (EFI_REDFISH_FAN_V1_0_0 *)InterpProp;
  DestroyFan_V1_0_0_CS (FanV1_0_0->Fan); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyFan_V1_0_0_Json (ResoruceRaw);
}
