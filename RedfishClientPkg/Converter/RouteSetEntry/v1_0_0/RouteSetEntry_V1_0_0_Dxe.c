...
//
#include <RedfishJsonStructure/RouteSetEntry/v1_0_0/EfiRouteSetEntryV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#RouteSetEntry";
BOOLEAN IsRevisonController = TRUE;

// Support RouteSetEntry V1_0_0
...
{
  EFI_REDFISH_ROUTESETENTRY_V1_0_0 *RouteSetEntryV1_0_0;
  EFI_REDFISH_ROUTESETENTRY_V1_0_0_CS *RouteSetEntryV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "RouteSetEntry") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_RouteSetEntry_V1_0_0_To_CS (ResoruceRaw, &RouteSetEntryV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  RouteSetEntryV1_0_0 = (EFI_REDFISH_ROUTESETENTRY_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ROUTESETENTRY_V1_0_0));
  if (RouteSetEntryV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)RouteSetEntryV1_0_0;
  RouteSetEntryV1_0_0->RouteSetEntry = RouteSetEntryV1_0_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("RouteSetEntry"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("RouteSetEntry"), "RouteSetEntry");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("RouteSetEntry"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("RouteSetEntry"), "RouteSetEntry");
...
/**
  The wrapper function of RouteSetEntryToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_RouteSetEntry_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_RouteSetEntry_V1_0_0_JSON (*((EFI_REDFISH_ROUTESETENTRY_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_RouteSetEntry_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in RouteSetEntryToStruct.
...
)
{
  ...
  RouteSetEntryV1_0_0 = (EFI_REDFISH_ROUTESETENTRY_V1_0_0 *)InterpProp;
  DestroyRouteSetEntry_V1_0_0_CS (RouteSetEntryV1_0_0->RouteSetEntry); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from RouteSetEntryFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyRouteSetEntry_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishRouteSetEntry_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishRouteSetEntry_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
