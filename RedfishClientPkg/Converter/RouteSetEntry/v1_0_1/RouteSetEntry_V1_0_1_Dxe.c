...
//
#include <RedfishJsonStructure/RouteSetEntry/v1_0_1/EfiRouteSetEntryV1_0_1.h>
CHAR8 mResourceTypeStr [] = "#RouteSetEntry";
BOOLEAN IsRevisonController = TRUE;

// Support RouteSetEntry V1_0_1
...
{
  EFI_REDFISH_ROUTESETENTRY_V1_0_1 *RouteSetEntryV1_0_1;
  EFI_REDFISH_ROUTESETENTRY_V1_0_1_CS *RouteSetEntryV1_0_1Cs;
  ...
  Status = (EFI_STATUS)Json_RouteSetEntry_V1_0_1_To_CS (ResoruceRaw, &RouteSetEntryV1_0_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  RouteSetEntryV1_0_1 = (EFI_REDFISH_ROUTESETENTRY_V1_0_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ROUTESETENTRY_V1_0_1));
  if (RouteSetEntryV1_0_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)RouteSetEntryV1_0_1;
  RouteSetEntryV1_0_1->RouteSetEntry = RouteSetEntryV1_0_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_RouteSetEntry_V1_0_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_RouteSetEntry_V1_0_1_JSON (*((EFI_REDFISH_ROUTESETENTRY_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_RouteSetEntry_V1_0_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  RouteSetEntryV1_0_1 = (EFI_REDFISH_ROUTESETENTRY_V1_0_1 *)InterpProp;
  DestroyRouteSetEntry_V1_0_1_CS (RouteSetEntryV1_0_1->RouteSetEntry); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyRouteSetEntry_V1_0_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishRouteSetEntry_V1_0_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishRouteSetEntry_V1_0_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
