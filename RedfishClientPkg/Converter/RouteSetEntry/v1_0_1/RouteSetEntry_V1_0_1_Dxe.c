...
)
{
  ...
  return (EFI_STATUS)CS_To_RouteSetEntry_V1_0_1_JSON (*((EFI_REDFISH_ROUTESETENTRY_V1_0_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
