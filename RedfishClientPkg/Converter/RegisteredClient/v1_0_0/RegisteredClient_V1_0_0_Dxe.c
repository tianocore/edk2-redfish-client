...
//
#include <RedfishJsonStructure/RegisteredClient/v1_0_0/EfiRegisteredClientV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#RegisteredClient";
BOOLEAN IsRevisonController = TRUE;

// Support RegisteredClient V1_0_0
...
{
  EFI_REDFISH_REGISTEREDCLIENT_V1_0_0 *RegisteredClientV1_0_0;
  EFI_REDFISH_REGISTEREDCLIENT_V1_0_0_CS *RegisteredClientV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "RegisteredClient") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_RegisteredClient_V1_0_0_To_CS (ResoruceRaw, &RegisteredClientV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  RegisteredClientV1_0_0 = (EFI_REDFISH_REGISTEREDCLIENT_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_REGISTEREDCLIENT_V1_0_0));
  if (RegisteredClientV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)RegisteredClientV1_0_0;
  RegisteredClientV1_0_0->RegisteredClient = RegisteredClientV1_0_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("RegisteredClient"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("RegisteredClient"), "RegisteredClient");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("RegisteredClient"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("RegisteredClient"), "RegisteredClient");
...
/**
  The wrapper function of RegisteredClientToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
RegisteredClientToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return RegisteredClientToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_RegisteredClient_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_RegisteredClient_V1_0_0_JSON (*((EFI_REDFISH_REGISTEREDCLIENT_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_RegisteredClient_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in RegisteredClientToStruct.
...
)
{
  ...
  RegisteredClientV1_0_0 = (EFI_REDFISH_REGISTEREDCLIENT_V1_0_0 *)InterpProp;
  DestroyRegisteredClient_V1_0_0_CS (RegisteredClientV1_0_0->RegisteredClient); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from RegisteredClientFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyRegisteredClient_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishRegisteredClient_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishRegisteredClient_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
