...
)
{
  ...
  return (EFI_STATUS)CS_To_VLanNetworkInterfaceCollection_JSON (*((EFI_REDFISH_VLANNETWORKINTERFACECOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
