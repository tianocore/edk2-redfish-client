...
//
#include <RedfishJsonStructure/Thermal/v1_2_8/EfiThermalV1_2_8.h>
CHAR8 mResourceTypeStr [] = "#Thermal";
BOOLEAN IsRevisonController = TRUE;

// Support Thermal V1_2_8
...
{
  EFI_REDFISH_THERMAL_V1_2_8 *ThermalV1_2_8;
  EFI_REDFISH_THERMAL_V1_2_8_CS *ThermalV1_2_8Cs;
  ...
  Status = (EFI_STATUS)Json_Thermal_V1_2_8_To_CS (ResoruceRaw, &ThermalV1_2_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalV1_2_8 = (EFI_REDFISH_THERMAL_V1_2_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMAL_V1_2_8));
  if (ThermalV1_2_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ThermalV1_2_8;
  ThermalV1_2_8->Thermal = ThermalV1_2_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Thermal_V1_2_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Thermal_V1_2_8_JSON (*((EFI_REDFISH_THERMAL_V1_2_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Thermal_V1_2_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ThermalV1_2_8 = (EFI_REDFISH_THERMAL_V1_2_8 *)InterpProp;
  DestroyThermal_V1_2_8_CS (ThermalV1_2_8->Thermal); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyThermal_V1_2_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermal_V1_2_8EntryPoint (
