...
//
#include <RedfishJsonStructure/Thermal/v1_3_6/EfiThermalV1_3_6.h>
CHAR8 mResourceTypeStr [] = "#Thermal";
BOOLEAN IsRevisonController = TRUE;

// Support Thermal V1_3_6
...
{
  EFI_REDFISH_THERMAL_V1_3_6 *ThermalV1_3_6;
  EFI_REDFISH_THERMAL_V1_3_6_CS *ThermalV1_3_6Cs;
  ...
  Status = (EFI_STATUS)Json_Thermal_V1_3_6_To_CS (ResoruceRaw, &ThermalV1_3_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalV1_3_6 = (EFI_REDFISH_THERMAL_V1_3_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMAL_V1_3_6));
  if (ThermalV1_3_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ThermalV1_3_6;
  ThermalV1_3_6->Thermal = ThermalV1_3_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Thermal_V1_3_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Thermal_V1_3_6_JSON (*((EFI_REDFISH_THERMAL_V1_3_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Thermal_V1_3_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ThermalV1_3_6 = (EFI_REDFISH_THERMAL_V1_3_6 *)InterpProp;
  DestroyThermal_V1_3_6_CS (ThermalV1_3_6->Thermal); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyThermal_V1_3_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermal_V1_3_6EntryPoint (
