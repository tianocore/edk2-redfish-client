...
//
#include <RedfishJsonStructure/Thermal/v1_6_0/EfiThermalV1_6_0.h>
CHAR8 mResourceTypeStr [] = "#Thermal";
BOOLEAN IsRevisonController = TRUE;

// Support Thermal V1_6_0
...
{
  EFI_REDFISH_THERMAL_V1_6_0 *ThermalV1_6_0;
  EFI_REDFISH_THERMAL_V1_6_0_CS *ThermalV1_6_0Cs;
  ...
  Status = (EFI_STATUS)Json_Thermal_V1_6_0_To_CS (ResoruceRaw, &ThermalV1_6_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalV1_6_0 = (EFI_REDFISH_THERMAL_V1_6_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMAL_V1_6_0));
  if (ThermalV1_6_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ThermalV1_6_0;
  ThermalV1_6_0->Thermal = ThermalV1_6_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Thermal_V1_6_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Thermal_V1_6_0_JSON (*((EFI_REDFISH_THERMAL_V1_6_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Thermal_V1_6_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ThermalV1_6_0 = (EFI_REDFISH_THERMAL_V1_6_0 *)InterpProp;
  DestroyThermal_V1_6_0_CS (ThermalV1_6_0->Thermal); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyThermal_V1_6_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermal_V1_6_0EntryPoint (
