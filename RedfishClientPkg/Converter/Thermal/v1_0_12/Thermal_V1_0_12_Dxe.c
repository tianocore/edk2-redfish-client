...
//
#include <RedfishJsonStructure/Thermal/v1_0_12/EfiThermalV1_0_12.h>
CHAR8 mResourceTypeStr [] = "#Thermal";
BOOLEAN IsRevisonController = TRUE;

// Support Thermal V1_0_12
...
{
  EFI_REDFISH_THERMAL_V1_0_12 *ThermalV1_0_12;
  EFI_REDFISH_THERMAL_V1_0_12_CS *ThermalV1_0_12Cs;
  ...
  Status = (EFI_STATUS)Json_Thermal_V1_0_12_To_CS (ResoruceRaw, &ThermalV1_0_12Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalV1_0_12 = (EFI_REDFISH_THERMAL_V1_0_12 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMAL_V1_0_12));
  if (ThermalV1_0_12 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ThermalV1_0_12;
  ThermalV1_0_12->Thermal = ThermalV1_0_12Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Thermal_V1_0_12_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Thermal_V1_0_12_JSON (*((EFI_REDFISH_THERMAL_V1_0_12_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Thermal_V1_0_12_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ThermalV1_0_12 = (EFI_REDFISH_THERMAL_V1_0_12 *)InterpProp;
  DestroyThermal_V1_0_12_CS (ThermalV1_0_12->Thermal); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyThermal_V1_0_12_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermal_V1_0_12EntryPoint (
