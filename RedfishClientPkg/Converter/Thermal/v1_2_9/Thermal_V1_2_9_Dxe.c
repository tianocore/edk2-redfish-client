...
//
#include <RedfishJsonStructure/Thermal/v1_2_9/EfiThermalV1_2_9.h>
CHAR8 mResourceTypeStr [] = "#Thermal";
BOOLEAN IsRevisonController = TRUE;

// Support Thermal V1_2_9
...
{
  EFI_REDFISH_THERMAL_V1_2_9 *ThermalV1_2_9;
  EFI_REDFISH_THERMAL_V1_2_9_CS *ThermalV1_2_9Cs;
  ...
  Status = (EFI_STATUS)Json_Thermal_V1_2_9_To_CS (ResoruceRaw, &ThermalV1_2_9Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalV1_2_9 = (EFI_REDFISH_THERMAL_V1_2_9 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMAL_V1_2_9));
  if (ThermalV1_2_9 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ThermalV1_2_9;
  ThermalV1_2_9->Thermal = ThermalV1_2_9Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Thermal_V1_2_9_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Thermal_V1_2_9_JSON (*((EFI_REDFISH_THERMAL_V1_2_9_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Thermal_V1_2_9_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ThermalV1_2_9 = (EFI_REDFISH_THERMAL_V1_2_9 *)InterpProp;
  DestroyThermal_V1_2_9_CS (ThermalV1_2_9->Thermal); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyThermal_V1_2_9_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermal_V1_2_9EntryPoint (
