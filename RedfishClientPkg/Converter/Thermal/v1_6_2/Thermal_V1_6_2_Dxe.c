...
//
#include <RedfishJsonStructure/Thermal/v1_6_2/EfiThermalV1_6_2.h>
CHAR8 mResourceTypeStr [] = "#Thermal";
BOOLEAN IsRevisonController = TRUE;

// Support Thermal V1_6_2
...
{
  EFI_REDFISH_THERMAL_V1_6_2 *ThermalV1_6_2;
  EFI_REDFISH_THERMAL_V1_6_2_CS *ThermalV1_6_2Cs;
  ...
  Status = (EFI_STATUS)Json_Thermal_V1_6_2_To_CS (ResoruceRaw, &ThermalV1_6_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalV1_6_2 = (EFI_REDFISH_THERMAL_V1_6_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMAL_V1_6_2));
  if (ThermalV1_6_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ThermalV1_6_2;
  ThermalV1_6_2->Thermal = ThermalV1_6_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Thermal_V1_6_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Thermal_V1_6_2_JSON (*((EFI_REDFISH_THERMAL_V1_6_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Thermal_V1_6_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ThermalV1_6_2 = (EFI_REDFISH_THERMAL_V1_6_2 *)InterpProp;
  DestroyThermal_V1_6_2_CS (ThermalV1_6_2->Thermal); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyThermal_V1_6_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermal_V1_6_2EntryPoint (
