...
//
#include <RedfishJsonStructure/Thermal/v1_4_3/EfiThermalV1_4_3.h>
CHAR8 mResourceTypeStr [] = "#Thermal";
BOOLEAN IsRevisonController = TRUE;

// Support Thermal V1_4_3
...
{
  EFI_REDFISH_THERMAL_V1_4_3 *ThermalV1_4_3;
  EFI_REDFISH_THERMAL_V1_4_3_CS *ThermalV1_4_3Cs;
  ...
  Status = (EFI_STATUS)Json_Thermal_V1_4_3_To_CS (ResoruceRaw, &ThermalV1_4_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalV1_4_3 = (EFI_REDFISH_THERMAL_V1_4_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMAL_V1_4_3));
  if (ThermalV1_4_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ThermalV1_4_3;
  ThermalV1_4_3->Thermal = ThermalV1_4_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Thermal_V1_4_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Thermal_V1_4_3_JSON (*((EFI_REDFISH_THERMAL_V1_4_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Thermal_V1_4_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ThermalV1_4_3 = (EFI_REDFISH_THERMAL_V1_4_3 *)InterpProp;
  DestroyThermal_V1_4_3_CS (ThermalV1_4_3->Thermal); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyThermal_V1_4_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermal_V1_4_3EntryPoint (
