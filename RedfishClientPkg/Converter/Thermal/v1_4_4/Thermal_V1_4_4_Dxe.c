...
//
#include <RedfishJsonStructure/Thermal/v1_4_4/EfiThermalV1_4_4.h>
CHAR8 mResourceTypeStr [] = "#Thermal";
BOOLEAN IsRevisonController = TRUE;

// Support Thermal V1_4_4
...
{
  EFI_REDFISH_THERMAL_V1_4_4 *ThermalV1_4_4;
  EFI_REDFISH_THERMAL_V1_4_4_CS *ThermalV1_4_4Cs;
  ...
  Status = (EFI_STATUS)Json_Thermal_V1_4_4_To_CS (ResoruceRaw, &ThermalV1_4_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ThermalV1_4_4 = (EFI_REDFISH_THERMAL_V1_4_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_THERMAL_V1_4_4));
  if (ThermalV1_4_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ThermalV1_4_4;
  ThermalV1_4_4->Thermal = ThermalV1_4_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Thermal_V1_4_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Thermal_V1_4_4_JSON (*((EFI_REDFISH_THERMAL_V1_4_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Thermal_V1_4_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  ThermalV1_4_4 = (EFI_REDFISH_THERMAL_V1_4_4 *)InterpProp;
  DestroyThermal_V1_4_4_CS (ThermalV1_4_4->Thermal); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyThermal_V1_4_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishThermal_V1_4_4EntryPoint (
