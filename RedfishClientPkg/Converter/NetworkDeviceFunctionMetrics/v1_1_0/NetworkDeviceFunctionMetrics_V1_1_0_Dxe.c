/** @file 
  ...
  Redfish schema.
   - NetworkDeviceFunctionMetrics.v1_1_0 
...
//
#include <RedfishJsonStructure/NetworkDeviceFunctionMetrics/v1_1_0/EfiNetworkDeviceFunctionMetricsV1_1_0.h>
CHAR8 mResourceTypeStr [] = "#NetworkDeviceFunctionMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkDeviceFunctionMetrics V1_1_0
...
{
  EFI_REDFISH_NETWORKDEVICEFUNCTIONMETRICS_V1_1_0 *NetworkDeviceFunctionMetricsV1_1_0;
  EFI_REDFISH_NETWORKDEVICEFUNCTIONMETRICS_V1_1_0_CS *NetworkDeviceFunctionMetricsV1_1_0Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkDeviceFunctionMetrics_V1_1_0_To_CS (ResoruceRaw, &NetworkDeviceFunctionMetricsV1_1_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkDeviceFunctionMetricsV1_1_0 = (EFI_REDFISH_NETWORKDEVICEFUNCTIONMETRICS_V1_1_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKDEVICEFUNCTIONMETRICS_V1_1_0));
  if (NetworkDeviceFunctionMetricsV1_1_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkDeviceFunctionMetricsV1_1_0;
  NetworkDeviceFunctionMetricsV1_1_0->NetworkDeviceFunctionMetrics = NetworkDeviceFunctionMetricsV1_1_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkDeviceFunctionMetrics_V1_1_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkDeviceFunctionMetrics_V1_1_0_JSON (*((EFI_REDFISH_NETWORKDEVICEFUNCTIONMETRICS_V1_1_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkDeviceFunctionMetrics_V1_1_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkDeviceFunctionMetricsV1_1_0 = (EFI_REDFISH_NETWORKDEVICEFUNCTIONMETRICS_V1_1_0 *)InterpProp;
  DestroyNetworkDeviceFunctionMetrics_V1_1_0_CS (NetworkDeviceFunctionMetricsV1_1_0->NetworkDeviceFunctionMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkDeviceFunctionMetrics_V1_1_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunctionMetrics_V1_1_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkDeviceFunctionMetrics_V1_1_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
