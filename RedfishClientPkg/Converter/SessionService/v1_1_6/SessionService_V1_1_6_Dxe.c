...
//
#include <RedfishJsonStructure/SessionService/v1_1_6/EfiSessionServiceV1_1_6.h>
CHAR8 mResourceTypeStr [] = "#SessionService";
BOOLEAN IsRevisonController = TRUE;

// Support SessionService V1_1_6
...
{
  EFI_REDFISH_SESSIONSERVICE_V1_1_6 *SessionServiceV1_1_6;
  EFI_REDFISH_SESSIONSERVICE_V1_1_6_CS *SessionServiceV1_1_6Cs;
  ...
  Status = (EFI_STATUS)Json_SessionService_V1_1_6_To_CS (ResoruceRaw, &SessionServiceV1_1_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionServiceV1_1_6 = (EFI_REDFISH_SESSIONSERVICE_V1_1_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSIONSERVICE_V1_1_6));
  if (SessionServiceV1_1_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SessionServiceV1_1_6;
  SessionServiceV1_1_6->SessionService = SessionServiceV1_1_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SessionService_V1_1_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SessionService_V1_1_6_JSON (*((EFI_REDFISH_SESSIONSERVICE_V1_1_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SessionService_V1_1_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SessionServiceV1_1_6 = (EFI_REDFISH_SESSIONSERVICE_V1_1_6 *)InterpProp;
  DestroySessionService_V1_1_6_CS (SessionServiceV1_1_6->SessionService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySessionService_V1_1_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_1_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_1_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
