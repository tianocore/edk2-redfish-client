...
//
#include <RedfishJsonStructure/SessionService/v1_0_8/EfiSessionServiceV1_0_8.h>
CHAR8 mResourceTypeStr [] = "#SessionService";
BOOLEAN IsRevisonController = TRUE;

// Support SessionService V1_0_8
...
{
  EFI_REDFISH_SESSIONSERVICE_V1_0_8 *SessionServiceV1_0_8;
  EFI_REDFISH_SESSIONSERVICE_V1_0_8_CS *SessionServiceV1_0_8Cs;
  ...
  Status = (EFI_STATUS)Json_SessionService_V1_0_8_To_CS (ResoruceRaw, &SessionServiceV1_0_8Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionServiceV1_0_8 = (EFI_REDFISH_SESSIONSERVICE_V1_0_8 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSIONSERVICE_V1_0_8));
  if (SessionServiceV1_0_8 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SessionServiceV1_0_8;
  SessionServiceV1_0_8->SessionService = SessionServiceV1_0_8Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SessionService_V1_0_8_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SessionService_V1_0_8_JSON (*((EFI_REDFISH_SESSIONSERVICE_V1_0_8_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SessionService_V1_0_8_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SessionServiceV1_0_8 = (EFI_REDFISH_SESSIONSERVICE_V1_0_8 *)InterpProp;
  DestroySessionService_V1_0_8_CS (SessionServiceV1_0_8->SessionService); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySessionService_V1_0_8_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_0_8EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_0_8Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
