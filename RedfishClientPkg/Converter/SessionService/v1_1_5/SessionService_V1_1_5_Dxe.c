...
//
#include <RedfishJsonStructure/SessionService/v1_1_5/EfiSessionServiceV1_1_5.h>
CHAR8 mResourceTypeStr [] = "#SessionService";
BOOLEAN IsRevisonController = TRUE;

// Support SessionService V1_1_5
...
{
  EFI_REDFISH_SESSIONSERVICE_V1_1_5 *SessionServiceV1_1_5;
  EFI_REDFISH_SESSIONSERVICE_V1_1_5_CS *SessionServiceV1_1_5Cs;
  ...
  Status = (EFI_STATUS)Json_SessionService_V1_1_5_To_CS (ResoruceRaw, &SessionServiceV1_1_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionServiceV1_1_5 = (EFI_REDFISH_SESSIONSERVICE_V1_1_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSIONSERVICE_V1_1_5));
  if (SessionServiceV1_1_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SessionServiceV1_1_5;
  SessionServiceV1_1_5->SessionService = SessionServiceV1_1_5Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("SessionService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("SessionService"), "SessionService");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("SessionService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("SessionService"), "SessionService");
...
/**
  The wrapper function of SessionServiceToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_SessionService_V1_1_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_SessionService_V1_1_5_JSON (*((EFI_REDFISH_SESSIONSERVICE_V1_1_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_SessionService_V1_1_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SessionServiceV1_1_5 = (EFI_REDFISH_SESSIONSERVICE_V1_1_5 *)InterpProp;
  DestroySessionService_V1_1_5_CS (SessionServiceV1_1_5->SessionService); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from SessionServiceFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroySessionService_V1_1_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_1_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishSessionService_V1_1_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
