...
)
{
  ...
  return (EFI_STATUS)CS_To_NetworkPortCollection_JSON (*((EFI_REDFISH_NETWORKPORTCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
