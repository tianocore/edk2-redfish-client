...
)
{
  ...
  return (EFI_STATUS)CS_To_AggregateCollection_JSON (*((EFI_REDFISH_AGGREGATECOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
