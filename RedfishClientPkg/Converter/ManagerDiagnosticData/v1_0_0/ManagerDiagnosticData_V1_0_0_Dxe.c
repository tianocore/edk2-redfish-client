...
//
#include <RedfishJsonStructure/ManagerDiagnosticData/v1_0_0/EfiManagerDiagnosticDataV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#ManagerDiagnosticData";
BOOLEAN IsRevisonController = TRUE;

// Support ManagerDiagnosticData V1_0_0
...
{
  EFI_REDFISH_MANAGERDIAGNOSTICDATA_V1_0_0 *ManagerDiagnosticDataV1_0_0;
  EFI_REDFISH_MANAGERDIAGNOSTICDATA_V1_0_0_CS *ManagerDiagnosticDataV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "ManagerDiagnosticData") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_ManagerDiagnosticData_V1_0_0_To_CS (ResoruceRaw, &ManagerDiagnosticDataV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  ManagerDiagnosticDataV1_0_0 = (EFI_REDFISH_MANAGERDIAGNOSTICDATA_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MANAGERDIAGNOSTICDATA_V1_0_0));
  if (ManagerDiagnosticDataV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)ManagerDiagnosticDataV1_0_0;
  ManagerDiagnosticDataV1_0_0->ManagerDiagnosticData = ManagerDiagnosticDataV1_0_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("ManagerDiagnosticData"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("ManagerDiagnosticData"), "ManagerDiagnosticData");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("ManagerDiagnosticData"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("ManagerDiagnosticData"), "ManagerDiagnosticData");
...
/**
  The wrapper function of ManagerDiagnosticDataToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
EFI_STATUS
EFIAPI
ManagerDiagnosticDataToStructWrapper (
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL         *This,
  IN EFI_REST_JSON_RESOURCE_TYPE_IDENTIFIER   *RsrcIdentifier OPTIONAL,
  IN CHAR8                                    *ResoruceRaw,
  OUT EFI_REST_JSON_STRUCTURE_HEADER          **InterpProp
...
{
  return ManagerDiagnosticDataToStruct (
			  This,
			  RsrcIdentifier,
			  ResoruceRaw,
			  NULL,
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_ManagerDiagnosticData_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_ManagerDiagnosticData_V1_0_0_JSON (*((EFI_REDFISH_MANAGERDIAGNOSTICDATA_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_ManagerDiagnosticData_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in ManagerDiagnosticDataToStruct.
...
EFI_STATUS
EFIAPI
ManagerDiagnosticDataDestoryStruct(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL   *This,
  IN EFI_REST_JSON_STRUCTURE_HEADER  *InterpProp
)
{
  ...
  ManagerDiagnosticDataV1_0_0 = (EFI_REDFISH_MANAGERDIAGNOSTICDATA_V1_0_0 *)InterpProp;
  DestroyManagerDiagnosticData_V1_0_0_CS (ManagerDiagnosticDataV1_0_0->ManagerDiagnosticData); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from ManagerDiagnosticDataFromStruct
...
EFI_STATUS
EFIAPI
ManagerDiagnosticDataDestoryJson(
  IN EFI_REST_JSON_STRUCTURE_PROTOCOL *This,
...
)
{
  ...
  return (EFI_STATUS)DestroyManagerDiagnosticData_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishManagerDiagnosticData_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishManagerDiagnosticData_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
