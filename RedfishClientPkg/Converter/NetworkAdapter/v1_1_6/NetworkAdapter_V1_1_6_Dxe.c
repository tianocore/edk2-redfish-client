...
//
#include <RedfishJsonStructure/NetworkAdapter/v1_1_6/EfiNetworkAdapterV1_1_6.h>
CHAR8 mResourceTypeStr [] = "#NetworkAdapter";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkAdapter V1_1_6
...
{
  EFI_REDFISH_NETWORKADAPTER_V1_1_6 *NetworkAdapterV1_1_6;
  EFI_REDFISH_NETWORKADAPTER_V1_1_6_CS *NetworkAdapterV1_1_6Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkAdapter_V1_1_6_To_CS (ResoruceRaw, &NetworkAdapterV1_1_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkAdapterV1_1_6 = (EFI_REDFISH_NETWORKADAPTER_V1_1_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKADAPTER_V1_1_6));
  if (NetworkAdapterV1_1_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkAdapterV1_1_6;
  NetworkAdapterV1_1_6->NetworkAdapter = NetworkAdapterV1_1_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkAdapter_V1_1_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkAdapter_V1_1_6_JSON (*((EFI_REDFISH_NETWORKADAPTER_V1_1_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkAdapter_V1_1_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkAdapterV1_1_6 = (EFI_REDFISH_NETWORKADAPTER_V1_1_6 *)InterpProp;
  DestroyNetworkAdapter_V1_1_6_CS (NetworkAdapterV1_1_6->NetworkAdapter); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkAdapter_V1_1_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_1_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_1_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
