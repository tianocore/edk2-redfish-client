...
//
#include <RedfishJsonStructure/NetworkAdapter/v1_3_2/EfiNetworkAdapterV1_3_2.h>
CHAR8 mResourceTypeStr [] = "#NetworkAdapter";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkAdapter V1_3_2
...
{
  EFI_REDFISH_NETWORKADAPTER_V1_3_2 *NetworkAdapterV1_3_2;
  ...
  Status = (EFI_STATUS)Json_NetworkAdapter_V1_3_2_To_CS (ResoruceRaw, &NetworkAdapterV1_3_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkAdapterV1_3_2 = (EFI_REDFISH_NETWORKADAPTER_V1_3_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKADAPTER_V1_3_2));
  if (NetworkAdapterV1_3_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkAdapterV1_3_2;
  NetworkAdapterV1_3_2->NetworkAdapter = NetworkAdapterV1_3_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkAdapter_V1_3_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkAdapter_V1_3_2_JSON (*((EFI_REDFISH_NETWORKADAPTER_V1_3_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkAdapter_V1_3_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  DestroyNetworkAdapter_V1_3_2_CS (NetworkAdapterV1_3_2->NetworkAdapter); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkAdapter_V1_3_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_3_2EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_3_2Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
