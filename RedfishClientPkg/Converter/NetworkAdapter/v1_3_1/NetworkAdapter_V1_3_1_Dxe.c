...
//
#include <RedfishJsonStructure/NetworkAdapter/v1_3_1/EfiNetworkAdapterV1_3_1.h>
CHAR8 mResourceTypeStr [] = "#NetworkAdapter";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkAdapter V1_3_1
...
{
  EFI_REDFISH_NETWORKADAPTER_V1_3_1 *NetworkAdapterV1_3_1;
  EFI_REDFISH_NETWORKADAPTER_V1_3_1_CS *NetworkAdapterV1_3_1Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkAdapter_V1_3_1_To_CS (ResoruceRaw, &NetworkAdapterV1_3_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkAdapterV1_3_1 = (EFI_REDFISH_NETWORKADAPTER_V1_3_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKADAPTER_V1_3_1));
  if (NetworkAdapterV1_3_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkAdapterV1_3_1;
  NetworkAdapterV1_3_1->NetworkAdapter = NetworkAdapterV1_3_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkAdapter_V1_3_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkAdapter_V1_3_1_JSON (*((EFI_REDFISH_NETWORKADAPTER_V1_3_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkAdapter_V1_3_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkAdapterV1_3_1 = (EFI_REDFISH_NETWORKADAPTER_V1_3_1 *)InterpProp;
  DestroyNetworkAdapter_V1_3_1_CS (NetworkAdapterV1_3_1->NetworkAdapter); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkAdapter_V1_3_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_3_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_3_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
