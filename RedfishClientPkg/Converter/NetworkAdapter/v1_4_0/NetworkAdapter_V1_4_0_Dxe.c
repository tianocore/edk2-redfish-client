...
//
#include <RedfishJsonStructure/NetworkAdapter/v1_4_0/EfiNetworkAdapterV1_4_0.h>
CHAR8 mResourceTypeStr [] = "#NetworkAdapter";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkAdapter V1_4_0
...
{
  EFI_REDFISH_NETWORKADAPTER_V1_4_0 *NetworkAdapterV1_4_0;
  EFI_REDFISH_NETWORKADAPTER_V1_4_0_CS *NetworkAdapterV1_4_0Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkAdapter_V1_4_0_To_CS (ResoruceRaw, &NetworkAdapterV1_4_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkAdapterV1_4_0 = (EFI_REDFISH_NETWORKADAPTER_V1_4_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKADAPTER_V1_4_0));
  if (NetworkAdapterV1_4_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkAdapterV1_4_0;
  NetworkAdapterV1_4_0->NetworkAdapter = NetworkAdapterV1_4_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkAdapter_V1_4_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkAdapter_V1_4_0_JSON (*((EFI_REDFISH_NETWORKADAPTER_V1_4_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkAdapter_V1_4_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkAdapterV1_4_0 = (EFI_REDFISH_NETWORKADAPTER_V1_4_0 *)InterpProp;
  DestroyNetworkAdapter_V1_4_0_CS (NetworkAdapterV1_4_0->NetworkAdapter); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkAdapter_V1_4_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_4_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_4_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
