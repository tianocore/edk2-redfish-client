...
)
{
  ...
  return (EFI_STATUS)CS_To_NetworkAdapter_V1_2_4_JSON (*((EFI_REDFISH_NETWORKADAPTER_V1_2_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
