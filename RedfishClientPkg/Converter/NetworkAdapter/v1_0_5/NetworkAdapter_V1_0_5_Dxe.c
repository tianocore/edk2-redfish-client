...
//
#include <RedfishJsonStructure/NetworkAdapter/v1_0_5/EfiNetworkAdapterV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#NetworkAdapter";
BOOLEAN IsRevisonController = TRUE;

// Support NetworkAdapter V1_0_5
...
{
  EFI_REDFISH_NETWORKADAPTER_V1_0_5 *NetworkAdapterV1_0_5;
  EFI_REDFISH_NETWORKADAPTER_V1_0_5_CS *NetworkAdapterV1_0_5Cs;
  ...
  Status = (EFI_STATUS)Json_NetworkAdapter_V1_0_5_To_CS (ResoruceRaw, &NetworkAdapterV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  NetworkAdapterV1_0_5 = (EFI_REDFISH_NETWORKADAPTER_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_NETWORKADAPTER_V1_0_5));
  if (NetworkAdapterV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)NetworkAdapterV1_0_5;
  NetworkAdapterV1_0_5->NetworkAdapter = NetworkAdapterV1_0_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_NetworkAdapter_V1_0_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_NetworkAdapter_V1_0_5_JSON (*((EFI_REDFISH_NETWORKADAPTER_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_NetworkAdapter_V1_0_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  NetworkAdapterV1_0_5 = (EFI_REDFISH_NETWORKADAPTER_V1_0_5 *)InterpProp;
  DestroyNetworkAdapter_V1_0_5_CS (NetworkAdapterV1_0_5->NetworkAdapter); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyNetworkAdapter_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_0_5EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishNetworkAdapter_V1_0_5Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
