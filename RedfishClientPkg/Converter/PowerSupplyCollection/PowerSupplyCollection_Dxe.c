...
)
{
  ...
  return (EFI_STATUS)CS_To_PowerSupplyCollection_JSON (*((EFI_REDFISH_POWERSUPPLYCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
