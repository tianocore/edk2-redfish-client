...
)
{
  ...
  return (EFI_STATUS)CS_To_ManagerAccountCollection_JSON (*((EFI_REDFISH_MANAGERACCOUNTCOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
