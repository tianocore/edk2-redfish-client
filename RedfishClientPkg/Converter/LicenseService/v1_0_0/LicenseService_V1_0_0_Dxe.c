...
//
#include <RedfishJsonStructure/LicenseService/v1_0_0/EfiLicenseServiceV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#LicenseService";
BOOLEAN IsRevisonController = TRUE;

// Support LicenseService V1_0_0
...
{
  EFI_REDFISH_LICENSESERVICE_V1_0_0 *LicenseServiceV1_0_0;
  EFI_REDFISH_LICENSESERVICE_V1_0_0_CS *LicenseServiceV1_0_0Cs;
  ...
  if (RsrcIdentifier == NULL ||
    ...
    if (!CheckSupportedSchema (ResoruceRaw)) {
      return EFI_UNSUPPORTED;
             ...
             (AsciiStrCmp (RsrcIdentifier->NameSpace.ResourceTypeName, "LicenseService") != 0)) {
    return EFI_UNSUPPORTED;
  }

  Status = (EFI_STATUS)Json_LicenseService_V1_0_0_To_CS (ResoruceRaw, &LicenseServiceV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  LicenseServiceV1_0_0 = (EFI_REDFISH_LICENSESERVICE_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_LICENSESERVICE_V1_0_0));
  if (LicenseServiceV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)LicenseServiceV1_0_0;
  LicenseServiceV1_0_0->LicenseService = LicenseServiceV1_0_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("LicenseService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("LicenseService"), "LicenseService");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("LicenseService"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("LicenseService"), "LicenseService");
...
/**
  The wrapper function of LicenseServiceToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_LicenseService_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_LicenseService_V1_0_0_JSON (*((EFI_REDFISH_LICENSESERVICE_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_LicenseService_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
  return RedfishStatus;
}

/**
  This function destory structure retunred in LicenseServiceToStruct.
...
)
{
  ...
  LicenseServiceV1_0_0 = (EFI_REDFISH_LICENSESERVICE_V1_0_0 *)InterpProp;
  DestroyLicenseService_V1_0_0_CS (LicenseServiceV1_0_0->LicenseService); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from LicenseServiceFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroyLicenseService_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishLicenseService_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishLicenseService_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
