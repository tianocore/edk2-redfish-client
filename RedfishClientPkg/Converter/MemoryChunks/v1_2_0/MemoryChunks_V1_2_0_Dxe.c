...
)
{
  ...
  return (EFI_STATUS)CS_To_MemoryChunks_V1_2_0_JSON (*((EFI_REDFISH_MEMORYCHUNKS_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
