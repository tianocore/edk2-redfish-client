...
//
#include <RedfishJsonStructure/MemoryChunks/v1_2_4/EfiMemoryChunksV1_2_4.h>
CHAR8 mResourceTypeStr [] = "#MemoryChunks";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryChunks V1_2_4
...
{
  EFI_REDFISH_MEMORYCHUNKS_V1_2_4 *MemoryChunksV1_2_4;
  EFI_REDFISH_MEMORYCHUNKS_V1_2_4_CS *MemoryChunksV1_2_4Cs;
  ...
  Status = (EFI_STATUS)Json_MemoryChunks_V1_2_4_To_CS (ResoruceRaw, &MemoryChunksV1_2_4Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryChunksV1_2_4 = (EFI_REDFISH_MEMORYCHUNKS_V1_2_4 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYCHUNKS_V1_2_4));
  if (MemoryChunksV1_2_4 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryChunksV1_2_4;
  MemoryChunksV1_2_4->MemoryChunks = MemoryChunksV1_2_4Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MemoryChunks_V1_2_4_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MemoryChunks_V1_2_4_JSON (*((EFI_REDFISH_MEMORYCHUNKS_V1_2_4_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MemoryChunks_V1_2_4_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryChunksV1_2_4 = (EFI_REDFISH_MEMORYCHUNKS_V1_2_4 *)InterpProp;
  DestroyMemoryChunks_V1_2_4_CS (MemoryChunksV1_2_4->MemoryChunks); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemoryChunks_V1_2_4_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryChunks_V1_2_4EntryPoint (
