...
//
#include <RedfishJsonStructure/MemoryChunks/v1_0_6/EfiMemoryChunksV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#MemoryChunks";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryChunks V1_0_6
...
{
  EFI_REDFISH_MEMORYCHUNKS_V1_0_6 *MemoryChunksV1_0_6;
  EFI_REDFISH_MEMORYCHUNKS_V1_0_6_CS *MemoryChunksV1_0_6Cs;
  ...
  Status = (EFI_STATUS)Json_MemoryChunks_V1_0_6_To_CS (ResoruceRaw, &MemoryChunksV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryChunksV1_0_6 = (EFI_REDFISH_MEMORYCHUNKS_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYCHUNKS_V1_0_6));
  if (MemoryChunksV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryChunksV1_0_6;
  MemoryChunksV1_0_6->MemoryChunks = MemoryChunksV1_0_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MemoryChunks_V1_0_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MemoryChunks_V1_0_6_JSON (*((EFI_REDFISH_MEMORYCHUNKS_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MemoryChunks_V1_0_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryChunksV1_0_6 = (EFI_REDFISH_MEMORYCHUNKS_V1_0_6 *)InterpProp;
  DestroyMemoryChunks_V1_0_6_CS (MemoryChunksV1_0_6->MemoryChunks); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemoryChunks_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryChunks_V1_0_6EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryChunks_V1_0_6Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
