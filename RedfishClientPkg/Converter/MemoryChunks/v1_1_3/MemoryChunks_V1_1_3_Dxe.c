...
//
#include <RedfishJsonStructure/MemoryChunks/v1_1_3/EfiMemoryChunksV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#MemoryChunks";
BOOLEAN IsRevisonController = TRUE;

// Support MemoryChunks V1_1_3
...
{
  EFI_REDFISH_MEMORYCHUNKS_V1_1_3 *MemoryChunksV1_1_3;
  EFI_REDFISH_MEMORYCHUNKS_V1_1_3_CS *MemoryChunksV1_1_3Cs;
  ...
  Status = (EFI_STATUS)Json_MemoryChunks_V1_1_3_To_CS (ResoruceRaw, &MemoryChunksV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  MemoryChunksV1_1_3 = (EFI_REDFISH_MEMORYCHUNKS_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_MEMORYCHUNKS_V1_1_3));
  if (MemoryChunksV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)MemoryChunksV1_1_3;
  MemoryChunksV1_1_3->MemoryChunks = MemoryChunksV1_1_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_MemoryChunks_V1_1_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_MemoryChunks_V1_1_3_JSON (*((EFI_REDFISH_MEMORYCHUNKS_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_MemoryChunks_V1_1_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  MemoryChunksV1_1_3 = (EFI_REDFISH_MEMORYCHUNKS_V1_1_3 *)InterpProp;
  DestroyMemoryChunks_V1_1_3_CS (MemoryChunksV1_1_3->MemoryChunks); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyMemoryChunks_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishMemoryChunks_V1_1_3EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishMemoryChunks_V1_1_3Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
