...
//
#include <RedfishJsonStructure/Session/v1_1_2/EfiSessionV1_1_2.h>
CHAR8 mResourceTypeStr [] = "#Session";
BOOLEAN IsRevisonController = TRUE;

// Support Session V1_1_2
...
{
  EFI_REDFISH_SESSION_V1_1_2 *SessionV1_1_2;
  EFI_REDFISH_SESSION_V1_1_2_CS *SessionV1_1_2Cs;
  ...
  Status = (EFI_STATUS)Json_Session_V1_1_2_To_CS (ResoruceRaw, &SessionV1_1_2Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionV1_1_2 = (EFI_REDFISH_SESSION_V1_1_2 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSION_V1_1_2));
  if (SessionV1_1_2 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SessionV1_1_2;
  SessionV1_1_2->Session = SessionV1_1_2Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Session_V1_1_2_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Session_V1_1_2_JSON (*((EFI_REDFISH_SESSION_V1_1_2_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Session_V1_1_2_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SessionV1_1_2 = (EFI_REDFISH_SESSION_V1_1_2 *)InterpProp;
  DestroySession_V1_1_2_CS (SessionV1_1_2->Session); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySession_V1_1_2_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSession_V1_1_2EntryPoint (
