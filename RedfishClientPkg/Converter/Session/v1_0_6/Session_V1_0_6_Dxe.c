...
//
#include <RedfishJsonStructure/Session/v1_0_6/EfiSessionV1_0_6.h>
CHAR8 mResourceTypeStr [] = "#Session";
BOOLEAN IsRevisonController = TRUE;

// Support Session V1_0_6
...
{
  EFI_REDFISH_SESSION_V1_0_6 *SessionV1_0_6;
  EFI_REDFISH_SESSION_V1_0_6_CS *SessionV1_0_6Cs;
  ...
  Status = (EFI_STATUS)Json_Session_V1_0_6_To_CS (ResoruceRaw, &SessionV1_0_6Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionV1_0_6 = (EFI_REDFISH_SESSION_V1_0_6 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSION_V1_0_6));
  if (SessionV1_0_6 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SessionV1_0_6;
  SessionV1_0_6->Session = SessionV1_0_6Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Session_V1_0_6_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Session_V1_0_6_JSON (*((EFI_REDFISH_SESSION_V1_0_6_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Session_V1_0_6_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SessionV1_0_6 = (EFI_REDFISH_SESSION_V1_0_6 *)InterpProp;
  DestroySession_V1_0_6_CS (SessionV1_0_6->Session); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySession_V1_0_6_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSession_V1_0_6EntryPoint (
