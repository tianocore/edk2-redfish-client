...
//
#include <RedfishJsonStructure/Session/v1_0_5/EfiSessionV1_0_5.h>
CHAR8 mResourceTypeStr [] = "#Session";
BOOLEAN IsRevisonController = TRUE;

// Support Session V1_0_5
...
{
  EFI_REDFISH_SESSION_V1_0_5 *SessionV1_0_5;
  EFI_REDFISH_SESSION_V1_0_5_CS *SessionV1_0_5Cs;
  ...
  Status = (EFI_STATUS)Json_Session_V1_0_5_To_CS (ResoruceRaw, &SessionV1_0_5Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionV1_0_5 = (EFI_REDFISH_SESSION_V1_0_5 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSION_V1_0_5));
  if (SessionV1_0_5 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SessionV1_0_5;
  SessionV1_0_5->Session = SessionV1_0_5Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Session_V1_0_5_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Session_V1_0_5_JSON (*((EFI_REDFISH_SESSION_V1_0_5_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Session_V1_0_5_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SessionV1_0_5 = (EFI_REDFISH_SESSION_V1_0_5 *)InterpProp;
  DestroySession_V1_0_5_CS (SessionV1_0_5->Session); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySession_V1_0_5_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSession_V1_0_5EntryPoint (
