...
//
#include <RedfishJsonStructure/Session/v1_3_0/EfiSessionV1_3_0.h>
CHAR8 mResourceTypeStr [] = "#Session";
BOOLEAN IsRevisonController = TRUE;

// Support Session V1_3_0
...
{
  EFI_REDFISH_SESSION_V1_3_0 *SessionV1_3_0;
  EFI_REDFISH_SESSION_V1_3_0_CS *SessionV1_3_0Cs;
  ...
  Status = (EFI_STATUS)Json_Session_V1_3_0_To_CS (ResoruceRaw, &SessionV1_3_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionV1_3_0 = (EFI_REDFISH_SESSION_V1_3_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSION_V1_3_0));
  if (SessionV1_3_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SessionV1_3_0;
  SessionV1_3_0->Session = SessionV1_3_0Cs;
  ...
  // Set header.
  //
  RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName = (CHAR8 *)AllocatePool (AsciiStrSize ("Session"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.NameSpace.ResourceTypeName, AsciiStrSize ("Session"), "Session");
  ...
  RestIntrpHeader->JsonRsrcIdentifier.DataType = (CHAR8 *)AllocatePool (AsciiStrSize ("Session"));
  AsciiStrCpyS (RestIntrpHeader->JsonRsrcIdentifier.DataType, AsciiStrSize ("Session"), "Session");
...
/**
  The wrapper function of SessionToStruct which invokes **RESOURCE_TYPE**!ToStruct
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Session_V1_3_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Session_V1_3_0_JSON (*((EFI_REDFISH_SESSION_V1_3_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Session_V1_3_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SessionV1_3_0 = (EFI_REDFISH_SESSION_V1_3_0 *)InterpProp;
  DestroySession_V1_3_0_CS (SessionV1_3_0->Session); 
  return EFI_SUCCESS;
}

/**
  This function destory JSON raw text returned from SessionFromStruct
...
)
{
  ...
  return (EFI_STATUS)DestroySession_V1_3_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSession_V1_3_0EntryPoint (
