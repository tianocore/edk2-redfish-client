...
//
#include <RedfishJsonStructure/Session/v1_1_3/EfiSessionV1_1_3.h>
CHAR8 mResourceTypeStr [] = "#Session";
BOOLEAN IsRevisonController = TRUE;

// Support Session V1_1_3
...
{
  EFI_REDFISH_SESSION_V1_1_3 *SessionV1_1_3;
  EFI_REDFISH_SESSION_V1_1_3_CS *SessionV1_1_3Cs;
  ...
  Status = (EFI_STATUS)Json_Session_V1_1_3_To_CS (ResoruceRaw, &SessionV1_1_3Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionV1_1_3 = (EFI_REDFISH_SESSION_V1_1_3 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSION_V1_1_3));
  if (SessionV1_1_3 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SessionV1_1_3;
  SessionV1_1_3->Session = SessionV1_1_3Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Session_V1_1_3_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Session_V1_1_3_JSON (*((EFI_REDFISH_SESSION_V1_1_3_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Session_V1_1_3_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SessionV1_1_3 = (EFI_REDFISH_SESSION_V1_1_3 *)InterpProp;
  DestroySession_V1_1_3_CS (SessionV1_1_3->Session); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySession_V1_1_3_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSession_V1_1_3EntryPoint (
