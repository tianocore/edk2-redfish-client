...
//
#include <RedfishJsonStructure/Session/v1_2_0/EfiSessionV1_2_0.h>
CHAR8 mResourceTypeStr [] = "#Session";
BOOLEAN IsRevisonController = TRUE;

// Support Session V1_2_0
...
{
  EFI_REDFISH_SESSION_V1_2_0 *SessionV1_2_0;
  EFI_REDFISH_SESSION_V1_2_0_CS *SessionV1_2_0Cs;
  ...
  Status = (EFI_STATUS)Json_Session_V1_2_0_To_CS (ResoruceRaw, &SessionV1_2_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionV1_2_0 = (EFI_REDFISH_SESSION_V1_2_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSION_V1_2_0));
  if (SessionV1_2_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SessionV1_2_0;
  SessionV1_2_0->Session = SessionV1_2_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Session_V1_2_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Session_V1_2_0_JSON (*((EFI_REDFISH_SESSION_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Session_V1_2_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SessionV1_2_0 = (EFI_REDFISH_SESSION_V1_2_0 *)InterpProp;
  DestroySession_V1_2_0_CS (SessionV1_2_0->Session); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySession_V1_2_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSession_V1_2_0EntryPoint (
