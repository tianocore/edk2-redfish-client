...
//
#include <RedfishJsonStructure/Session/v1_2_1/EfiSessionV1_2_1.h>
CHAR8 mResourceTypeStr [] = "#Session";
BOOLEAN IsRevisonController = TRUE;

// Support Session V1_2_1
...
{
  EFI_REDFISH_SESSION_V1_2_1 *SessionV1_2_1;
  EFI_REDFISH_SESSION_V1_2_1_CS *SessionV1_2_1Cs;
  ...
  Status = (EFI_STATUS)Json_Session_V1_2_1_To_CS (ResoruceRaw, &SessionV1_2_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  SessionV1_2_1 = (EFI_REDFISH_SESSION_V1_2_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_SESSION_V1_2_1));
  if (SessionV1_2_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)SessionV1_2_1;
  SessionV1_2_1->Session = SessionV1_2_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_Session_V1_2_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_Session_V1_2_1_JSON (*((EFI_REDFISH_SESSION_V1_2_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_Session_V1_2_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  SessionV1_2_1 = (EFI_REDFISH_SESSION_V1_2_1 *)InterpProp;
  DestroySession_V1_2_1_CS (SessionV1_2_1->Session); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroySession_V1_2_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishSession_V1_2_1EntryPoint (
