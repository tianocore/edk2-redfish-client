...
//
#include <RedfishJsonStructure/EnvironmentMetrics/v1_0_0/EfiEnvironmentMetricsV1_0_0.h>
CHAR8 mResourceTypeStr [] = "#EnvironmentMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support EnvironmentMetrics V1_0_0
...
{
  EFI_REDFISH_ENVIRONMENTMETRICS_V1_0_0 *EnvironmentMetricsV1_0_0;
  EFI_REDFISH_ENVIRONMENTMETRICS_V1_0_0_CS *EnvironmentMetricsV1_0_0Cs;
  ...
  Status = (EFI_STATUS)Json_EnvironmentMetrics_V1_0_0_To_CS (ResoruceRaw, &EnvironmentMetricsV1_0_0Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EnvironmentMetricsV1_0_0 = (EFI_REDFISH_ENVIRONMENTMETRICS_V1_0_0 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENVIRONMENTMETRICS_V1_0_0));
  if (EnvironmentMetricsV1_0_0 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EnvironmentMetricsV1_0_0;
  EnvironmentMetricsV1_0_0->EnvironmentMetrics = EnvironmentMetricsV1_0_0Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EnvironmentMetrics_V1_0_0_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EnvironmentMetrics_V1_0_0_JSON (*((EFI_REDFISH_ENVIRONMENTMETRICS_V1_0_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EnvironmentMetrics_V1_0_0_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EnvironmentMetricsV1_0_0 = (EFI_REDFISH_ENVIRONMENTMETRICS_V1_0_0 *)InterpProp;
  DestroyEnvironmentMetrics_V1_0_0_CS (EnvironmentMetricsV1_0_0->EnvironmentMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEnvironmentMetrics_V1_0_0_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEnvironmentMetrics_V1_0_0EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEnvironmentMetrics_V1_0_0Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
