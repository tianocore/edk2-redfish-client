...
)
{
  ...
  return (EFI_STATUS)CS_To_EnvironmentMetrics_V1_2_0_JSON (*((EFI_REDFISH_ENVIRONMENTMETRICS_V1_2_0_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
