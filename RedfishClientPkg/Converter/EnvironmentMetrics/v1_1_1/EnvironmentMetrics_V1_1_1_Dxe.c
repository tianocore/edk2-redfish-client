...
//
#include <RedfishJsonStructure/EnvironmentMetrics/v1_1_1/EfiEnvironmentMetricsV1_1_1.h>
CHAR8 mResourceTypeStr [] = "#EnvironmentMetrics";
BOOLEAN IsRevisonController = TRUE;

// Support EnvironmentMetrics V1_1_1
...
{
  EFI_REDFISH_ENVIRONMENTMETRICS_V1_1_1 *EnvironmentMetricsV1_1_1;
  EFI_REDFISH_ENVIRONMENTMETRICS_V1_1_1_CS *EnvironmentMetricsV1_1_1Cs;
  ...
  Status = (EFI_STATUS)Json_EnvironmentMetrics_V1_1_1_To_CS (ResoruceRaw, &EnvironmentMetricsV1_1_1Cs);
  if (EFI_ERROR (Status)){
    return Status;
  }
  EnvironmentMetricsV1_1_1 = (EFI_REDFISH_ENVIRONMENTMETRICS_V1_1_1 *)AllocateZeroPool (
                        sizeof (EFI_REDFISH_ENVIRONMENTMETRICS_V1_1_1));
  if (EnvironmentMetricsV1_1_1 == NULL){
    return EFI_OUT_OF_RESOURCES;
  }
  RestIntrpHeader = (EFI_REST_JSON_STRUCTURE_HEADER *)EnvironmentMetricsV1_1_1;
  EnvironmentMetricsV1_1_1->EnvironmentMetrics = EnvironmentMetricsV1_1_1Cs;
...
)
{
  ...
  DEBUG((DEBUG_MANAGEABILITY, "%a: Call to CS_To_EnvironmentMetrics_V1_1_1_JSON\n", __func__));
  RedfishStatus = (EFI_STATUS)CS_To_EnvironmentMetrics_V1_1_1_JSON (*((EFI_REDFISH_ENVIRONMENTMETRICS_V1_1_1_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);
  if (EFI_ERROR(RedfishStatus)) {
    DEBUG((DEBUG_MANAGEABILITY, "%a Call to CS_To_EnvironmentMetrics_V1_1_1_JSON fail (%d)\n", __func__, RedfishStatus));
  }
...
)
{
  ...
  EnvironmentMetricsV1_1_1 = (EFI_REDFISH_ENVIRONMENTMETRICS_V1_1_1 *)InterpProp;
  DestroyEnvironmentMetrics_V1_1_1_CS (EnvironmentMetricsV1_1_1->EnvironmentMetrics); 
  return EFI_SUCCESS;
}
...
)
{
  ...
  return (EFI_STATUS)DestroyEnvironmentMetrics_V1_1_1_Json (ResoruceRaw);
}
...
EFI_STATUS
EFIAPI
RedfishEnvironmentMetrics_V1_1_1EntryPoint (
...
EFI_STATUS
EFIAPI
RedfishEnvironmentMetrics_V1_1_1Unload (
  IN EFI_HANDLE ImageHandle
  )
{
  //
