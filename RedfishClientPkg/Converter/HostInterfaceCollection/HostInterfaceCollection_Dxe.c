...
)
{
  ...
  return (EFI_STATUS)CS_To_HostInterfaceCollection_JSON (*((EFI_REDFISH_HOSTINTERFACECOLLECTION_CS **)((UINT8 *)InterpProp + sizeof (EFI_REST_JSON_STRUCTURE_HEADER))), ResoruceRaw);  
}
