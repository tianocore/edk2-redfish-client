...
#include"Redfish_Bios_v1_0_6_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenChangePasswordCs(RedfishBios_V1_0_6_Bios_CS *Cs, json_t *JsonObj, char *Key, RedfishBios_V1_0_6_ChangePassword_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishBios_V1_0_6_ChangePassword_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenResetBiosCs(RedfishBios_V1_0_6_Bios_CS *Cs, json_t *JsonObj, char *Key, RedfishBios_V1_0_6_ResetBios_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishBios_V1_0_6_ResetBios_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishBios_V1_0_6_Bios_CS *Cs, json_t *JsonObj, char *Key, RedfishBios_V1_0_6_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishBios_V1_0_6_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishBios_V1_0_6_Bios_CS *Cs, json_t *JsonObj, char *Key, RedfishBios_V1_0_6_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishBios_V1_0_6_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #Bios.ChangePassword
...
//
static RedfishCS_status GenAttributesCs(RedfishBios_V1_0_6_Bios_CS *Cs, json_t *JsonObj, char *Key, RedfishBios_V1_0_6_Attributes_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishBios_V1_0_6_Attributes_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  InitializeLinkHead (&(*Dst)->Prop);
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishBios_V1_0_6_Bios_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsBios_ChangePassword(json_t *CsJson, char *Key, RedfishBios_V1_0_6_ChangePassword_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsBios_ResetBios(json_t *CsJson, char *Key, RedfishBios_V1_0_6_ResetBios_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishBios_V1_0_6_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishBios_V1_0_6_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Attributes(json_t *CsJson, char *Key, RedfishBios_V1_0_6_Attributes_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Bios.V1_0_6.Bios
//
RedfishCS_status CS_To_Bios_V1_0_6_JSON(RedfishBios_V1_0_6_Bios_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Bios.V1_0_6.Bios
//
RedfishCS_status DestroyBios_V1_0_6_CS(RedfishBios_V1_0_6_Bios_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Bios.V1_0_6.Bios
//
RedfishCS_status DestroyBios_V1_0_6_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Bios.V1_0_6.Bios
//
RedfishCS_status
Json_Bios_V1_0_6_To_CS(RedfishCS_char *JsonRawText, RedfishBios_V1_0_6_Bios_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishBios_V1_0_6_Bios_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Bios", "v1_0_6", "Bios", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishBios_V1_0_6_Bios_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
