# Definition of PowerDomainCollection and functions<br><br>
...
## Redfish PowerDomainCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish PowerDomainCollection  JSON Function
    RedfishCS_status
    CS_To_PowerDomainCollection_JSON (RedfishPowerDomainCollection_PowerDomainCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish PowerDomainCollection  C Structure Function
    RedfishCS_status
