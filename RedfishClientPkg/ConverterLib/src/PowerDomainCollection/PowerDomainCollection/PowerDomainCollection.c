...
#include"Redfish_PowerDomainCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishPowerDomainCollection_PowerDomainCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for PowerDomainCollection.PowerDomainCollection
//
RedfishCS_status CS_To_PowerDomainCollection_JSON(RedfishPowerDomainCollection_PowerDomainCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for PowerDomainCollection.PowerDomainCollection
//
RedfishCS_status DestroyPowerDomainCollection_CS(RedfishPowerDomainCollection_PowerDomainCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PowerDomainCollection.PowerDomainCollection
//
RedfishCS_status DestroyPowerDomainCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PowerDomainCollection.NOVERSIONED.PowerDomainCollection
//
RedfishCS_status
Json_PowerDomainCollection_To_CS(RedfishCS_char *JsonRawText, RedfishPowerDomainCollection_PowerDomainCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPowerDomainCollection_PowerDomainCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PowerDomainCollection", "noversioned", "PowerDomainCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPowerDomainCollection_PowerDomainCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyPowerDomainCollection_CS (Cs);
  return Status;
}
