...
#include"Redfish_OperatingConfigCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishOperatingConfigCollection_OperatingConfigCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for OperatingConfigCollection.OperatingConfigCollection
//
RedfishCS_status CS_To_OperatingConfigCollection_JSON(RedfishOperatingConfigCollection_OperatingConfigCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for OperatingConfigCollection.OperatingConfigCollection
//
RedfishCS_status DestroyOperatingConfigCollection_CS(RedfishOperatingConfigCollection_OperatingConfigCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for OperatingConfigCollection.OperatingConfigCollection
//
RedfishCS_status DestroyOperatingConfigCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for OperatingConfigCollection.NOVERSIONED.OperatingConfigCollection
//
RedfishCS_status
Json_OperatingConfigCollection_To_CS(RedfishCS_char *JsonRawText, RedfishOperatingConfigCollection_OperatingConfigCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishOperatingConfigCollection_OperatingConfigCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "OperatingConfigCollection", "noversioned", "OperatingConfigCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishOperatingConfigCollection_OperatingConfigCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyOperatingConfigCollection_CS (Cs);
  return Status;
}
