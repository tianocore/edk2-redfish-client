...
#include"Redfish_SecureBootDatabase_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
//Generate C structure for #SecureBootDatabase.ResetKeys
//
static RedfishCS_status GenResetKeysCs(RedfishSecureBootDatabase_V1_0_0_SecureBootDatabase_CS *Cs, json_t *JsonObj, char *Key, RedfishSecureBootDatabase_V1_0_0_ResetKeys_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSecureBootDatabase_V1_0_0_ResetKeys_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishSecureBootDatabase_V1_0_0_SecureBootDatabase_CS *Cs, json_t *JsonObj, char *Key, RedfishSecureBootDatabase_V1_0_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSecureBootDatabase_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishSecureBootDatabase_V1_0_0_SecureBootDatabase_CS *Cs, json_t *JsonObj, char *Key, RedfishSecureBootDatabase_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSecureBootDatabase_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #SecureBootDatabase.ResetKeys
  Status = GenResetKeysCs (Cs, TempJsonObj, "#SecureBootDatabase.ResetKeys", &(*Dst)->SecureBootDatabase_ResetKeys);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishSecureBootDatabase_V1_0_0_SecureBootDatabase_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishSecureBootDatabase_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsSecureBootDatabase_ResetKeys(json_t *CsJson, char *Key, RedfishSecureBootDatabase_V1_0_0_ResetKeys_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishSecureBootDatabase_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // #SecureBootDatabase.ResetKeys
  if (CS_To_JSON_ActionsSecureBootDatabase_ResetKeys(CsJson, "#SecureBootDatabase.ResetKeys", CSPtr->SecureBootDatabase_ResetKeys) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for SecureBootDatabase.V1_0_0.SecureBootDatabase
//
RedfishCS_status CS_To_SecureBootDatabase_V1_0_0_JSON(RedfishSecureBootDatabase_V1_0_0_SecureBootDatabase_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // DatabaseId 
  if (InsertJsonStringObj (CsJson, "DatabaseId", CSPtr->DatabaseId) != RedfishCS_status_success) {goto Error;}
  ...
  // Signatures 
  if (InsertJsonLinkObj (CsJson, "Signatures", &CSPtr->Signatures) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for SecureBootDatabase.V1_0_0.SecureBootDatabase
//
RedfishCS_status DestroySecureBootDatabase_V1_0_0_CS(RedfishSecureBootDatabase_V1_0_0_SecureBootDatabase_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for SecureBootDatabase.V1_0_0.SecureBootDatabase
//
RedfishCS_status DestroySecureBootDatabase_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for SecureBootDatabase.V1_0_0.SecureBootDatabase
//
RedfishCS_status
Json_SecureBootDatabase_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishSecureBootDatabase_V1_0_0_SecureBootDatabase_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSecureBootDatabase_V1_0_0_SecureBootDatabase_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "SecureBootDatabase", "v1_0_0", "SecureBootDatabase", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSecureBootDatabase_V1_0_0_SecureBootDatabase_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // DatabaseId
  Status = GetRedfishPropertyStr (Cs, JsonObj, "DatabaseId", &Cs->DatabaseId);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // Signatures
  InitializeLinkHead (&Cs->Signatures);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "Signatures", Cs->Header.ThisUri, &Cs->Signatures);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroySecureBootDatabase_V1_0_0_CS (Cs);
  return Status;
}
