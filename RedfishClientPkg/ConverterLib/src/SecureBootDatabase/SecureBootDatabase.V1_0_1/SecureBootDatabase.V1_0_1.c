...
#include"Redfish_SecureBootDatabase_v1_0_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenResetKeysCs(RedfishSecureBootDatabase_V1_0_1_SecureBootDatabase_CS *Cs, json_t *JsonObj, char *Key, RedfishSecureBootDatabase_V1_0_1_ResetKeys_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSecureBootDatabase_V1_0_1_ResetKeys_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishSecureBootDatabase_V1_0_1_SecureBootDatabase_CS *Cs, json_t *JsonObj, char *Key, RedfishSecureBootDatabase_V1_0_1_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSecureBootDatabase_V1_0_1_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishSecureBootDatabase_V1_0_1_SecureBootDatabase_CS *Cs, json_t *JsonObj, char *Key, RedfishSecureBootDatabase_V1_0_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSecureBootDatabase_V1_0_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishSecureBootDatabase_V1_0_1_SecureBootDatabase_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishSecureBootDatabase_V1_0_1_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsSecureBootDatabase_ResetKeys(json_t *CsJson, char *Key, RedfishSecureBootDatabase_V1_0_1_ResetKeys_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishSecureBootDatabase_V1_0_1_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for SecureBootDatabase.V1_0_1.SecureBootDatabase
//
RedfishCS_status CS_To_SecureBootDatabase_V1_0_1_JSON(RedfishSecureBootDatabase_V1_0_1_SecureBootDatabase_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for SecureBootDatabase.V1_0_1.SecureBootDatabase
//
RedfishCS_status DestroySecureBootDatabase_V1_0_1_CS(RedfishSecureBootDatabase_V1_0_1_SecureBootDatabase_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for SecureBootDatabase.V1_0_1.SecureBootDatabase
//
RedfishCS_status DestroySecureBootDatabase_V1_0_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for SecureBootDatabase.V1_0_1.SecureBootDatabase
//
RedfishCS_status
Json_SecureBootDatabase_V1_0_1_To_CS(RedfishCS_char *JsonRawText, RedfishSecureBootDatabase_V1_0_1_SecureBootDatabase_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSecureBootDatabase_V1_0_1_SecureBootDatabase_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "SecureBootDatabase", "v1_0_1", "SecureBootDatabase", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSecureBootDatabase_V1_0_1_SecureBootDatabase_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroySecureBootDatabase_V1_0_1_CS (Cs);
  return Status;
}
