...
#include"Redfish_AddressPoolCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishAddressPoolCollection_AddressPoolCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for AddressPoolCollection.AddressPoolCollection
//
RedfishCS_status CS_To_AddressPoolCollection_JSON(RedfishAddressPoolCollection_AddressPoolCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for AddressPoolCollection.AddressPoolCollection
//
RedfishCS_status DestroyAddressPoolCollection_CS(RedfishAddressPoolCollection_AddressPoolCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for AddressPoolCollection.AddressPoolCollection
//
RedfishCS_status DestroyAddressPoolCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for AddressPoolCollection.NOVERSIONED.AddressPoolCollection
//
RedfishCS_status
Json_AddressPoolCollection_To_CS(RedfishCS_char *JsonRawText, RedfishAddressPoolCollection_AddressPoolCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAddressPoolCollection_AddressPoolCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "AddressPoolCollection", "noversioned", "AddressPoolCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAddressPoolCollection_AddressPoolCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyAddressPoolCollection_CS (Cs);
  return Status;
}
