...
#include"Redfish_USBControllerCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishUSBControllerCollection_USBControllerCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for USBControllerCollection.USBControllerCollection
//
RedfishCS_status CS_To_USBControllerCollection_JSON(RedfishUSBControllerCollection_USBControllerCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for USBControllerCollection.USBControllerCollection
//
RedfishCS_status DestroyUSBControllerCollection_CS(RedfishUSBControllerCollection_USBControllerCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for USBControllerCollection.USBControllerCollection
//
RedfishCS_status DestroyUSBControllerCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for USBControllerCollection.NOVERSIONED.USBControllerCollection
//
RedfishCS_status
Json_USBControllerCollection_To_CS(RedfishCS_char *JsonRawText, RedfishUSBControllerCollection_USBControllerCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishUSBControllerCollection_USBControllerCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "USBControllerCollection", "noversioned", "USBControllerCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishUSBControllerCollection_USBControllerCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyUSBControllerCollection_CS (Cs);
  return Status;
}
