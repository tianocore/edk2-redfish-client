# Definition of USBControllerCollection and functions<br><br>
...
## Redfish USBControllerCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish USBControllerCollection  JSON Function
    RedfishCS_status
    CS_To_USBControllerCollection_JSON (RedfishUSBControllerCollection_USBControllerCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish USBControllerCollection  C Structure Function
    RedfishCS_status
