# Definition of ComputerSystem.V1_14_0 and functions<br><br>
...
|**HostWatchdogTimer**|RedfishComputerSystem_V1_14_0_WatchdogTimer_CS| Structure points to **HostWatchdogTimer** property.| No| No
