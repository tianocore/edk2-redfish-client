# Definition of ComputerSystem.V1_13_1 and functions<br><br>
...
## Actions
    typedef struct _RedfishComputerSystem_V1_13_1_Actions_CS {
        ...
        RedfishComputerSystem_V1_13_1_OemActions_CS *Oem;
    } RedfishComputerSystem_V1_13_1_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**ComputerSystem_AddResourceBlock**|RedfishComputerSystem_V1_13_1_AddResourceBlock_CS| Structure points to **#ComputerSystem.AddResourceBlock** property.| No| No
|**ComputerSystem_RemoveResourceBlock**|RedfishComputerSystem_V1_13_1_RemoveResourceBlock_CS| Structure points to **#ComputerSystem.RemoveResourceBlock** property.| No| No
|**ComputerSystem_Reset**|RedfishComputerSystem_V1_13_1_Reset_CS| Structure points to **#ComputerSystem.Reset** property.| No| No
|**ComputerSystem_SetDefaultBootOrder**|RedfishComputerSystem_V1_13_1_SetDefaultBootOrder_CS| Structure points to **#ComputerSystem.SetDefaultBootOrder** property.| No| No
|**Oem**|RedfishComputerSystem_V1_13_1_OemActions_CS| Structure points to **Oem** property.| No| No
...
## HostSerialConsole
    typedef struct _RedfishComputerSystem_V1_13_1_HostSerialConsole_CS {
        RedfishComputerSystem_V1_13_1_SerialConsoleProtocol_CS *IPMI;
        RedfishCS_int64 *MaxConcurrentSessions;
        RedfishComputerSystem_V1_13_1_SerialConsoleProtocol_CS *SSH;
        RedfishComputerSystem_V1_13_1_SerialConsoleProtocol_CS *Telnet;
    } RedfishComputerSystem_V1_13_1_HostSerialConsole_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**IPMI**|RedfishComputerSystem_V1_13_1_SerialConsoleProtocol_CS| Structure points to **IPMI** property.| No| No
|**MaxConcurrentSessions**|RedfishCS_int64| 64-bit long long interger pointer to **MaxConcurrentSessions** property.| No| Yes
|**SSH**|RedfishComputerSystem_V1_13_1_SerialConsoleProtocol_CS| Structure points to **SSH** property.| No| No
|**Telnet**|RedfishComputerSystem_V1_13_1_SerialConsoleProtocol_CS| Structure points to **Telnet** property.| No| No
...
## ComputerSystem
    typedef struct _RedfishComputerSystem_V1_13_1_ComputerSystem_CS {
        ...
        RedfishComputerSystem_V1_13_1_Actions_CS *Actions;
        RedfishCS_char *AssetTag;
        RedfishCS_Link Bios;
        RedfishCS_char *BiosVersion;
        RedfishComputerSystem_V1_13_1_Boot_CS *Boot;
        RedfishComputerSystem_V1_13_1_BootProgress_CS *BootProgress;
        RedfishCS_char *Description;
        RedfishCS_Link EthernetInterfaces;
        RedfishCS_Link FabricAdapters;
        RedfishComputerSystem_V1_13_1_HostGraphicalConsole_CS *GraphicalConsole;
        RedfishCS_char *HostName;
        RedfishComputerSystem_V1_13_1_WatchdogTimer_CS *HostWatchdogTimer;
        RedfishComputerSystem_V1_13_1_HostedServices_CS *HostedServices;
        RedfishCS_char *HostingRoles;
        RedfishCS_char *Id;
        RedfishCS_char *IndicatorLED;
        RedfishCS_char *LastResetTime;
        RedfishComputerSystem_V1_13_1_Links_CS *Links;
        RedfishCS_bool *LocationIndicatorActive;
        RedfishCS_Link LogServices;
        RedfishCS_char *Manufacturer;
        RedfishCS_Link Memory;
        RedfishCS_Link MemoryDomains;
        RedfishComputerSystem_V1_13_1_MemorySummary_CS *MemorySummary;
        RedfishCS_char *Model;
        RedfishCS_char *Name;
        ...
        RedfishComputerSystem_V1_13_1_ProcessorSummary_CS *ProcessorSummary;
        RedfishCS_Link Processors;
        RedfishCS_Link Redundancy;
        RedfishCS_int64 *Redundancyodata_count;
        RedfishCS_char *SKU;
        RedfishCS_Link SecureBoot;
        RedfishComputerSystem_V1_13_1_HostSerialConsole_CS *SerialConsole;
        ...
        RedfishComputerSystem_V1_13_1_TrustedModules_CS *TrustedModules;
        RedfishCS_char *UUID;
        RedfishCS_Link VirtualMedia;
        RedfishComputerSystem_V1_13_1_VirtualMediaConfig_CS *VirtualMediaConfig;
...
|**Actions**|RedfishComputerSystem_V1_13_1_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Boot**|RedfishComputerSystem_V1_13_1_Boot_CS| Structure points to **Boot** property.| No| No
|**BootProgress**|RedfishComputerSystem_V1_13_1_BootProgress_CS| Structure points to **BootProgress** property.| No| No
...
|**GraphicalConsole**|RedfishComputerSystem_V1_13_1_HostGraphicalConsole_CS| Structure points to **GraphicalConsole** property.| No| No
|**HostName**|RedfishCS_char| String pointer to **HostName** property.| No| No
|**HostWatchdogTimer**|RedfishComputerSystem_V1_13_1_WatchdogTimer_CS| Structure points to **HostWatchdogTimer** property.| No| No
|**HostedServices**|RedfishComputerSystem_V1_13_1_HostedServices_CS| Structure points to **HostedServices** property.| No| No
...
|**Links**|RedfishComputerSystem_V1_13_1_Links_CS| Structure points to **Links** property.| No| No
...
|**MemorySummary**|RedfishComputerSystem_V1_13_1_MemorySummary_CS| Structure points to **MemorySummary** property.| No| No
|**Model**|RedfishCS_char| String pointer to **Model** property.| No| Yes
...
|**ProcessorSummary**|RedfishComputerSystem_V1_13_1_ProcessorSummary_CS| Structure points to **ProcessorSummary** property.| No| No
...
|**SerialConsole**|RedfishComputerSystem_V1_13_1_HostSerialConsole_CS| Structure points to **SerialConsole** property.| No| No
...
|**TrustedModules**|RedfishComputerSystem_V1_13_1_TrustedModules_CS| Structure points to **TrustedModules** property.| No| No
|**UUID**|RedfishCS_char| String pointer to **UUID** property.| No| Yes
|**VirtualMedia**|RedfishCS_Link| Structure link list to **VirtualMedia** property.| No| Yes
|**VirtualMediaConfig**|RedfishComputerSystem_V1_13_1_VirtualMediaConfig_CS| Structure points to **VirtualMediaConfig** property.| No| No
## Redfish ComputerSystem V1_13_1 to C Structure Function
    RedfishCS_status
    Json_ComputerSystem_V1_13_1_To_CS (RedfishCS_char *JsonRawText, RedfishComputerSystem_V1_13_1_ComputerSystem_CS **ReturnedCS);

## C Structure to Redfish ComputerSystem V1_13_1 JSON Function
    RedfishCS_status
    CS_To_ComputerSystem_V1_13_1_JSON (RedfishComputerSystem_V1_13_1_ComputerSystem_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ComputerSystem V1_13_1 C Structure Function
    RedfishCS_status
