# Definition of ComputerSystem.V1_15_1 and functions<br><br>
...
|**SerialConsole**|RedfishComputerSystem_V1_15_1_HostSerialConsole_CS| Structure points to **SerialConsole** property.| No| No
