# Definition of ComputerSystem.V1_11_3 and functions<br><br>
...
|**ProcessorSummary**|RedfishComputerSystem_V1_11_3_ProcessorSummary_CS| Structure points to **ProcessorSummary** property.| No| No
