# Definition of ComputerSystem.V1_7_8 and functions<br><br>
...
## Actions
    typedef struct _RedfishComputerSystem_V1_7_8_Actions_CS {
        ...
        RedfishComputerSystem_V1_7_8_OemActions_CS *Oem;
    } RedfishComputerSystem_V1_7_8_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**ComputerSystem_AddResourceBlock**|RedfishComputerSystem_V1_7_8_AddResourceBlock_CS| Structure points to **#ComputerSystem.AddResourceBlock** property.| No| No
|**ComputerSystem_RemoveResourceBlock**|RedfishComputerSystem_V1_7_8_RemoveResourceBlock_CS| Structure points to **#ComputerSystem.RemoveResourceBlock** property.| No| No
|**ComputerSystem_Reset**|RedfishComputerSystem_V1_7_8_Reset_CS| Structure points to **#ComputerSystem.Reset** property.| No| No
|**ComputerSystem_SetDefaultBootOrder**|RedfishComputerSystem_V1_7_8_SetDefaultBootOrder_CS| Structure points to **#ComputerSystem.SetDefaultBootOrder** property.| No| No
|**Oem**|RedfishComputerSystem_V1_7_8_OemActions_CS| Structure points to **Oem** property.| No| No
...
## ComputerSystem
    typedef struct _RedfishComputerSystem_V1_7_8_ComputerSystem_CS {
        ...
        RedfishComputerSystem_V1_7_8_Actions_CS *Actions;
        RedfishCS_char *AssetTag;
        RedfishCS_Link Bios;
        RedfishCS_char *BiosVersion;
        RedfishComputerSystem_V1_7_8_Boot_CS *Boot;
        RedfishCS_char *Description;
        RedfishCS_Link EthernetInterfaces;
        RedfishCS_char *HostName;
        RedfishComputerSystem_V1_7_8_WatchdogTimer_CS *HostWatchdogTimer;
        RedfishComputerSystem_V1_7_8_HostedServices_CS *HostedServices;
        RedfishCS_char *HostingRoles;
        RedfishCS_char *Id;
        RedfishCS_char *IndicatorLED;
        RedfishComputerSystem_V1_7_8_Links_CS *Links;
        RedfishCS_Link LogServices;
        RedfishCS_char *Manufacturer;
        RedfishCS_Link Memory;
        RedfishCS_Link MemoryDomains;
        RedfishComputerSystem_V1_7_8_MemorySummary_CS *MemorySummary;
        RedfishCS_char *Model;
        RedfishCS_char *Name;
        ...
        RedfishComputerSystem_V1_7_8_ProcessorSummary_CS *ProcessorSummary;
        ...
        RedfishComputerSystem_V1_7_8_TrustedModules_CS *TrustedModules;
        RedfishCS_char *UUID;
...
|**Actions**|RedfishComputerSystem_V1_7_8_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Boot**|RedfishComputerSystem_V1_7_8_Boot_CS| Structure points to **Boot** property.| No| No
...
|**HostWatchdogTimer**|RedfishComputerSystem_V1_7_8_WatchdogTimer_CS| Structure points to **HostWatchdogTimer** property.| No| No
|**HostedServices**|RedfishComputerSystem_V1_7_8_HostedServices_CS| Structure points to **HostedServices** property.| No| No
...
|**Links**|RedfishComputerSystem_V1_7_8_Links_CS| Structure points to **Links** property.| No| No
...
|**MemorySummary**|RedfishComputerSystem_V1_7_8_MemorySummary_CS| Structure points to **MemorySummary** property.| No| No
|**Model**|RedfishCS_char| String pointer to **Model** property.| No| Yes
...
|**ProcessorSummary**|RedfishComputerSystem_V1_7_8_ProcessorSummary_CS| Structure points to **ProcessorSummary** property.| No| No
...
|**TrustedModules**|RedfishComputerSystem_V1_7_8_TrustedModules_CS| Structure points to **TrustedModules** property.| No| No
|**UUID**|RedfishCS_char| String pointer to **UUID** property.| No| Yes
## Redfish ComputerSystem V1_7_8 to C Structure Function
    RedfishCS_status
    Json_ComputerSystem_V1_7_8_To_CS (RedfishCS_char *JsonRawText, RedfishComputerSystem_V1_7_8_ComputerSystem_CS **ReturnedCS);

## C Structure to Redfish ComputerSystem V1_7_8 JSON Function
    RedfishCS_status
    CS_To_ComputerSystem_V1_7_8_JSON (RedfishComputerSystem_V1_7_8_ComputerSystem_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ComputerSystem V1_7_8 C Structure Function
    RedfishCS_status
