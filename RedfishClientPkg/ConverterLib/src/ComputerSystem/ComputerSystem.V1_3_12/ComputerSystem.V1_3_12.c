...
#include"Redfish_ComputerSystem_v1_3_12_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenidRef_ArrayCs(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_Array_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenStatusCs(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst);
//
//Generate C structure for #ComputerSystem.Reset
//
static RedfishCS_status GenResetCs(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_3_12_Reset_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishComputerSystem_V1_3_12_Reset_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_3_12_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishComputerSystem_V1_3_12_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_3_12_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishComputerSystem_V1_3_12_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenBootCs(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_3_12_Boot_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishComputerSystem_V1_3_12_Boot_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenHostedServicesCs(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_3_12_HostedServices_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishComputerSystem_V1_3_12_HostedServices_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenidRef_Array_ElementCs(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenLinksCs(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_3_12_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishComputerSystem_V1_3_12_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Chassis
...
//
static RedfishCS_status GenidRefCs(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenMemorySummaryCs(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_3_12_MemorySummary_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishComputerSystem_V1_3_12_MemorySummary_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MemoryMirroring
...
//
static RedfishCS_status GenProcessorSummaryCs(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_3_12_ProcessorSummary_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishComputerSystem_V1_3_12_ProcessorSummary_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Count
...
static RedfishCS_status GenTrustedModules_Array_ElementCs(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishComputerSystem_V1_3_12_TrustedModules_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishComputerSystem_V1_3_12_TrustedModules_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // FirmwareVersion
...
//
//Generate C structure for RedfishComputerSystem_V1_3_12_TrustedModules_Array_CS
//
static RedfishCS_status GenTrustedModules_ArrayCs(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *Cs, json_t *JsonObj, char *Key, RedfishComputerSystem_V1_3_12_TrustedModules_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishComputerSystem_V1_3_12_TrustedModules_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishComputerSystem_V1_3_12_TrustedModules_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsComputerSystem_Reset(json_t *CsJson, char *Key, RedfishComputerSystem_V1_3_12_Reset_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishComputerSystem_V1_3_12_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishComputerSystem_V1_3_12_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Boot(json_t *CsJson, char *Key, RedfishComputerSystem_V1_3_12_Boot_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_HostedServices(json_t *CsJson, char *Key, RedfishComputerSystem_V1_3_12_HostedServices_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishComputerSystem_V1_3_12_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_MemorySummary(json_t *CsJson, char *Key, RedfishComputerSystem_V1_3_12_MemorySummary_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ProcessorSummary(json_t *CsJson, char *Key, RedfishComputerSystem_V1_3_12_ProcessorSummary_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_TrustedModules(json_t *CsJson, char *Key, RedfishComputerSystem_V1_3_12_TrustedModules_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishComputerSystem_V1_3_12_TrustedModules_Array_CS *NextArray;
  RedfishComputerSystem_V1_3_12_TrustedModules_CS *NextArrayItem;
...
//
// C structure to JSON for ComputerSystem.V1_3_12.ComputerSystem
//
RedfishCS_status CS_To_ComputerSystem_V1_3_12_JSON(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ComputerSystem.V1_3_12.ComputerSystem
//
RedfishCS_status DestroyComputerSystem_V1_3_12_CS(RedfishComputerSystem_V1_3_12_ComputerSystem_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ComputerSystem.V1_3_12.ComputerSystem
//
RedfishCS_status DestroyComputerSystem_V1_3_12_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ComputerSystem.V1_3_12.ComputerSystem
//
RedfishCS_status
Json_ComputerSystem_V1_3_12_To_CS(RedfishCS_char *JsonRawText, RedfishComputerSystem_V1_3_12_ComputerSystem_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishComputerSystem_V1_3_12_ComputerSystem_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ComputerSystem", "v1_3_12", "ComputerSystem", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishComputerSystem_V1_3_12_ComputerSystem_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyComputerSystem_V1_3_12_CS (Cs);
  return Status;
}
