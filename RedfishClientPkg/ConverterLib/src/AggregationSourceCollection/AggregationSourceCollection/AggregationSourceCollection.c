...
#include"Redfish_AggregationSourceCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishAggregationSourceCollection_AggregationSourceCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for AggregationSourceCollection.AggregationSourceCollection
//
RedfishCS_status CS_To_AggregationSourceCollection_JSON(RedfishAggregationSourceCollection_AggregationSourceCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for AggregationSourceCollection.AggregationSourceCollection
//
RedfishCS_status DestroyAggregationSourceCollection_CS(RedfishAggregationSourceCollection_AggregationSourceCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for AggregationSourceCollection.AggregationSourceCollection
//
RedfishCS_status DestroyAggregationSourceCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for AggregationSourceCollection.NOVERSIONED.AggregationSourceCollection
//
RedfishCS_status
Json_AggregationSourceCollection_To_CS(RedfishCS_char *JsonRawText, RedfishAggregationSourceCollection_AggregationSourceCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAggregationSourceCollection_AggregationSourceCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "AggregationSourceCollection", "noversioned", "AggregationSourceCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAggregationSourceCollection_AggregationSourceCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyAggregationSourceCollection_CS (Cs);
  return Status;
}
