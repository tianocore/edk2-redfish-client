...
#include"Redfish_Battery_v1_0_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishBattery_V1_0_1_Battery_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #Battery.Calibrate
//
static RedfishCS_status GenCalibrateCs(RedfishBattery_V1_0_1_Battery_CS *Cs, json_t *JsonObj, char *Key, RedfishBattery_V1_0_1_Calibrate_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishBattery_V1_0_1_Calibrate_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenResetCs(RedfishBattery_V1_0_1_Battery_CS *Cs, json_t *JsonObj, char *Key, RedfishBattery_V1_0_1_Reset_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishBattery_V1_0_1_Reset_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenSelfTestCs(RedfishBattery_V1_0_1_Battery_CS *Cs, json_t *JsonObj, char *Key, RedfishBattery_V1_0_1_SelfTest_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishBattery_V1_0_1_SelfTest_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishBattery_V1_0_1_Battery_CS *Cs, json_t *JsonObj, char *Key, RedfishBattery_V1_0_1_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishBattery_V1_0_1_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishBattery_V1_0_1_Battery_CS *Cs, json_t *JsonObj, char *Key, RedfishBattery_V1_0_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishBattery_V1_0_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #Battery.Calibrate
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishBattery_V1_0_1_Battery_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishBattery_V1_0_1_Battery_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishBattery_V1_0_1_Battery_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishBattery_V1_0_1_Battery_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishBattery_V1_0_1_Battery_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsBattery_Calibrate(json_t *CsJson, char *Key, RedfishBattery_V1_0_1_Calibrate_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsBattery_Reset(json_t *CsJson, char *Key, RedfishBattery_V1_0_1_Reset_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsBattery_SelfTest(json_t *CsJson, char *Key, RedfishBattery_V1_0_1_SelfTest_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishBattery_V1_0_1_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishBattery_V1_0_1_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
//
// C structure to JSON for Battery.V1_0_1.Battery
//
RedfishCS_status CS_To_Battery_V1_0_1_JSON(RedfishBattery_V1_0_1_Battery_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Battery.V1_0_1.Battery
//
RedfishCS_status DestroyBattery_V1_0_1_CS(RedfishBattery_V1_0_1_Battery_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Battery.V1_0_1.Battery
//
RedfishCS_status DestroyBattery_V1_0_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Battery.V1_0_1.Battery
//
RedfishCS_status
Json_Battery_V1_0_1_To_CS(RedfishCS_char *JsonRawText, RedfishBattery_V1_0_1_Battery_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishBattery_V1_0_1_Battery_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Battery", "v1_0_1", "Battery", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishBattery_V1_0_1_Battery_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
