# Definition of ProcessorMetrics.V1_0_2 and functions<br><br>

## Actions
    typedef struct _RedfishProcessorMetrics_V1_0_2_Actions_CS {
        RedfishProcessorMetrics_V1_0_2_OemActions_CS *Oem;
    } RedfishProcessorMetrics_V1_0_2_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishProcessorMetrics_V1_0_2_OemActions_CS| Structure points to **Oem** property.| No| No
...
## CoreMetrics
    typedef struct _RedfishProcessorMetrics_V1_0_2_CoreMetrics_CS {
        RedfishProcessorMetrics_V1_0_2tateResidency_Array_CS *CStateResidency;
        RedfishProcessorMetrics_V1_0_2_CacheMetrics_Array_CS *CoreCache;
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**CStateResidency**|RedfishProcessorMetrics_V1_0_2tateResidency_Array_CS| Structure array points to one or more than one **RedfishProcessorMetrics_V1_0_2tateResidency_Array_CS** structures for property **CStateResidency**.| No| No
|**CoreCache**|RedfishProcessorMetrics_V1_0_2_CacheMetrics_Array_CS| Structure array points to one or more than one **RedfishProcessorMetrics_V1_0_2_CacheMetrics_Array_CS** structures for property **CoreCache**.| No| No
...
## RedfishProcessorMetrics_V1_0_2tateResidency_Array_CS
    typedef struct _RedfishProcessorMetrics_V1_0_2tateResidency_Array_CS  {
        RedfishCS_Link *Next;
...
## ProcessorMetrics
    typedef struct _RedfishProcessorMetrics_V1_0_2_ProcessorMetrics_CS {
        ...
        RedfishProcessorMetrics_V1_0_2_Actions_CS *Actions;
        RedfishCS_int64 *AverageFrequencyMHz;
        RedfishCS_int64 *BandwidthPercent;
        RedfishProcessorMetrics_V1_0_2_CacheMetrics_CS *Cache;
        RedfishCS_int64 *ConsumedPowerWatt;
        RedfishProcessorMetrics_V1_0_2_CoreMetrics_CS *CoreMetrics;
...
|**Actions**|RedfishProcessorMetrics_V1_0_2_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Cache**|RedfishProcessorMetrics_V1_0_2_CacheMetrics_CS| Structure points to **Cache** property.| No| No
|**ConsumedPowerWatt**|RedfishCS_int64| 64-bit long long interger pointer to **ConsumedPowerWatt** property.| No| Yes
|**CoreMetrics**|RedfishProcessorMetrics_V1_0_2_CoreMetrics_CS| Structure points to **CoreMetrics** property.| No| No
...
## Redfish ProcessorMetrics V1_0_2 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish ProcessorMetrics V1_0_2 JSON Function
    RedfishCS_status
    CS_To_ProcessorMetrics_V1_0_2_JSON (RedfishProcessorMetrics_V1_0_2_ProcessorMetrics_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ProcessorMetrics V1_0_2 C Structure Function
    RedfishCS_status
