...
#include"Redfish_ProcessorMetrics_v1_0_3_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenCacheMetrics_ArrayCs(RedfishProcessorMetrics_V1_0_3_ProcessorMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishProcessorMetrics_V1_0_3_CacheMetrics_Array_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishProcessorMetrics_V1_0_3_ProcessorMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishProcessorMetrics_V1_0_3_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishProcessorMetrics_V1_0_3_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishProcessorMetrics_V1_0_3_ProcessorMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishProcessorMetrics_V1_0_3_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishProcessorMetrics_V1_0_3_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenCacheMetrics_Array_ElementCs(RedfishProcessorMetrics_V1_0_3_ProcessorMetrics_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishProcessorMetrics_V1_0_3_CacheMetrics_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishProcessorMetrics_V1_0_3_CacheMetrics_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // CacheMiss
...
//
//Generate C structure for RedfishProcessorMetrics_V1_0_3_CacheMetrics_Array_CS
//
static RedfishCS_status GenCacheMetrics_ArrayCs(RedfishProcessorMetrics_V1_0_3_ProcessorMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishProcessorMetrics_V1_0_3_CacheMetrics_Array_CS **Dst)
{
  RedfishCS_status Status;
  ...
  RedfishProcessorMetrics_V1_0_3_CacheMetrics_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishProcessorMetrics_V1_0_3_CacheMetrics_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenCStateResidency_Array_ElementCs(RedfishProcessorMetrics_V1_0_3_ProcessorMetrics_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishProcessorMetrics_V1_0_3_CStateResidency_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishProcessorMetrics_V1_0_3_CStateResidency_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Level
...
//
//Generate C structure for RedfishProcessorMetrics_V1_0_3_CStateResidency_Array_CS
//
static RedfishCS_status GenCStateResidency_ArrayCs(RedfishProcessorMetrics_V1_0_3_ProcessorMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishProcessorMetrics_V1_0_3_CStateResidency_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishProcessorMetrics_V1_0_3_CStateResidency_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishProcessorMetrics_V1_0_3_CStateResidency_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenCoreMetrics_Array_ElementCs(RedfishProcessorMetrics_V1_0_3_ProcessorMetrics_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishProcessorMetrics_V1_0_3_CoreMetrics_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishProcessorMetrics_V1_0_3_CoreMetrics_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // CStateResidency
...
//
//Generate C structure for RedfishProcessorMetrics_V1_0_3_CoreMetrics_Array_CS
//
static RedfishCS_status GenCoreMetrics_ArrayCs(RedfishProcessorMetrics_V1_0_3_ProcessorMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishProcessorMetrics_V1_0_3_CoreMetrics_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishProcessorMetrics_V1_0_3_CoreMetrics_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishProcessorMetrics_V1_0_3_CoreMetrics_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishProcessorMetrics_V1_0_3_ProcessorMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishProcessorMetrics_V1_0_3_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishProcessorMetrics_V1_0_3_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Cache(json_t *CsJson, char *Key, RedfishProcessorMetrics_V1_0_3_CacheMetrics_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishProcessorMetrics_V1_0_3_CacheMetrics_Array_CS *NextArray;
  RedfishProcessorMetrics_V1_0_3_CacheMetrics_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_CoreMetricsCStateResidency(json_t *CsJson, char *Key, RedfishProcessorMetrics_V1_0_3_CStateResidency_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishProcessorMetrics_V1_0_3_CStateResidency_Array_CS *NextArray;
  RedfishProcessorMetrics_V1_0_3_CStateResidency_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_CoreMetricsCoreCache(json_t *CsJson, char *Key, RedfishProcessorMetrics_V1_0_3_CacheMetrics_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishProcessorMetrics_V1_0_3_CacheMetrics_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_CoreMetrics(json_t *CsJson, char *Key, RedfishProcessorMetrics_V1_0_3_CoreMetrics_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishProcessorMetrics_V1_0_3_CoreMetrics_Array_CS *NextArray;
  RedfishProcessorMetrics_V1_0_3_CoreMetrics_CS *NextArrayItem;
...
//
// C structure to JSON for ProcessorMetrics.V1_0_3.ProcessorMetrics
//
RedfishCS_status CS_To_ProcessorMetrics_V1_0_3_JSON(RedfishProcessorMetrics_V1_0_3_ProcessorMetrics_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ProcessorMetrics.V1_0_3.ProcessorMetrics
//
RedfishCS_status DestroyProcessorMetrics_V1_0_3_CS(RedfishProcessorMetrics_V1_0_3_ProcessorMetrics_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ProcessorMetrics.V1_0_3.ProcessorMetrics
//
RedfishCS_status DestroyProcessorMetrics_V1_0_3_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ProcessorMetrics.V1_0_3.ProcessorMetrics
//
RedfishCS_status
Json_ProcessorMetrics_V1_0_3_To_CS(RedfishCS_char *JsonRawText, RedfishProcessorMetrics_V1_0_3_ProcessorMetrics_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishProcessorMetrics_V1_0_3_ProcessorMetrics_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ProcessorMetrics", "v1_0_3", "ProcessorMetrics", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishProcessorMetrics_V1_0_3_ProcessorMetrics_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyProcessorMetrics_V1_0_3_CS (Cs);
  return Status;
}
