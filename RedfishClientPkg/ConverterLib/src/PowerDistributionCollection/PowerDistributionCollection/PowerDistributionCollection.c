...
#include"Redfish_PowerDistributionCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishPowerDistributionCollection_PowerDistributionCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for PowerDistributionCollection.PowerDistributionCollection
//
RedfishCS_status CS_To_PowerDistributionCollection_JSON(RedfishPowerDistributionCollection_PowerDistributionCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for PowerDistributionCollection.PowerDistributionCollection
//
RedfishCS_status DestroyPowerDistributionCollection_CS(RedfishPowerDistributionCollection_PowerDistributionCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PowerDistributionCollection.PowerDistributionCollection
//
RedfishCS_status DestroyPowerDistributionCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PowerDistributionCollection.NOVERSIONED.PowerDistributionCollection
//
RedfishCS_status
Json_PowerDistributionCollection_To_CS(RedfishCS_char *JsonRawText, RedfishPowerDistributionCollection_PowerDistributionCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPowerDistributionCollection_PowerDistributionCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PowerDistributionCollection", "noversioned", "PowerDistributionCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPowerDistributionCollection_PowerDistributionCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyPowerDistributionCollection_CS (Cs);
  return Status;
}
