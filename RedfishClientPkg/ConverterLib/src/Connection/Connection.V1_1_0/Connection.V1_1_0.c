...
#include"Redfish_Connection_v1_1_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishConnection_V1_1_0_Connection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishConnection_V1_1_0_Connection_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishConnection_V1_1_0_Connection_CS *Cs, json_t *JsonObj, char *Key, RedfishConnection_V1_1_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishConnection_V1_1_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishConnection_V1_1_0_Connection_CS *Cs, json_t *JsonObj, char *Key, RedfishConnection_V1_1_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishConnection_V1_1_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenGenZConnectionKeyCs(RedfishConnection_V1_1_0_Connection_CS *Cs, json_t *JsonObj, char *Key, RedfishConnection_V1_1_0_GenZConnectionKey_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishConnection_V1_1_0_GenZConnectionKey_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AccessKey
  ...
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "RKeyDomainCheckingEnabled", &(*Dst)->RKeyDomainCheckingEnabled);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // RKeyReadOnlyKey
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "RKeyReadOnlyKey", &(*Dst)->RKeyReadOnlyKey);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // RKeyReadWriteKey
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "RKeyReadWriteKey", &(*Dst)->RKeyReadWriteKey);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for ConnectionKeys
//
static RedfishCS_status GenConnectionKeyCs(RedfishConnection_V1_1_0_Connection_CS *Cs, json_t *JsonObj, char *Key, RedfishConnection_V1_1_0_ConnectionKey_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishConnection_V1_1_0_ConnectionKey_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // GenZ
  Status = GenGenZConnectionKeyCs (Cs, TempJsonObj, "GenZ", &(*Dst)->GenZ);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenLinksCs(RedfishConnection_V1_1_0_Connection_CS *Cs, json_t *JsonObj, char *Key, RedfishConnection_V1_1_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishConnection_V1_1_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // InitiatorEndpointGroups
  InitializeLinkHead (&(*Dst)->InitiatorEndpointGroups);
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "InitiatorEndpointGroups", Cs->Header.ThisUri, &(*Dst)->InitiatorEndpointGroups);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // InitiatorEndpointGroups@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "InitiatorEndpointGroups@odata.count", &(*Dst)->InitiatorEndpointGroupsodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // InitiatorEndpoints
  InitializeLinkHead (&(*Dst)->InitiatorEndpoints);
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "InitiatorEndpoints", Cs->Header.ThisUri, &(*Dst)->InitiatorEndpoints);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // InitiatorEndpoints@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "InitiatorEndpoints@odata.count", &(*Dst)->InitiatorEndpointsodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  InitializeLinkHead (&(*Dst)->TargetEndpointGroups);
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "TargetEndpointGroups", Cs->Header.ThisUri, &(*Dst)->TargetEndpointGroups);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // TargetEndpointGroups@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "TargetEndpointGroups@odata.count", &(*Dst)->TargetEndpointGroupsodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // TargetEndpoints
  InitializeLinkHead (&(*Dst)->TargetEndpoints);
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "TargetEndpoints", Cs->Header.ThisUri, &(*Dst)->TargetEndpoints);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // TargetEndpoints@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "TargetEndpoints@odata.count", &(*Dst)->TargetEndpointsodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status GenMemoryChunkInfo_Array_ElementCs(RedfishConnection_V1_1_0_Connection_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishConnection_V1_1_0_MemoryChunkInfo_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishConnection_V1_1_0_MemoryChunkInfo_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AccessCapabilities
  Status = GenRedfishCS_char_ArrayCs (Cs, TempJsonObj, "AccessCapabilities", &(*Dst)->AccessCapabilities);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // MemoryChunk
  InitializeLinkHead (&(*Dst)->MemoryChunk);
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "MemoryChunk", Cs->Header.ThisUri, &(*Dst)->MemoryChunk);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishConnection_V1_1_0_MemoryChunkInfo_Array_CS
//
static RedfishCS_status GenMemoryChunkInfo_ArrayCs(RedfishConnection_V1_1_0_Connection_CS *Cs, json_t *JsonObj, char *Key, RedfishConnection_V1_1_0_MemoryChunkInfo_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishConnection_V1_1_0_MemoryChunkInfo_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishConnection_V1_1_0_MemoryChunkInfo_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
  ...
  ThisElement = *Dst;
  for (Index = 0; Index < ArraySize; Index ++) {
    Status = GenMemoryChunkInfo_Array_ElementCs(Cs, TempJsonObj, Index, &ThisElement->ArrayValue);
    if (Status != RedfishCS_status_success){
      goto Error;
    }
    ThisElement = ThisElement->Next;
...
//
static RedfishCS_status GenidRefCs(RedfishConnection_V1_1_0_Connection_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishConnection_V1_1_0_Connection_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishConnection_V1_1_0_Connection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishConnection_V1_1_0_Connection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenVolumeInfo_Array_ElementCs(RedfishConnection_V1_1_0_Connection_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishConnection_V1_1_0_VolumeInfo_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishConnection_V1_1_0_VolumeInfo_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AccessCapabilities
...
//
//Generate C structure for RedfishConnection_V1_1_0_VolumeInfo_Array_CS
//
static RedfishCS_status GenVolumeInfo_ArrayCs(RedfishConnection_V1_1_0_Connection_CS *Cs, json_t *JsonObj, char *Key, RedfishConnection_V1_1_0_VolumeInfo_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishConnection_V1_1_0_VolumeInfo_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishConnection_V1_1_0_VolumeInfo_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
  ...
  ThisElement = *Dst;
  for (Index = 0; Index < ArraySize; Index ++) {
    Status = GenVolumeInfo_Array_ElementCs(Cs, TempJsonObj, Index, &ThisElement->ArrayValue);
    if (Status != RedfishCS_status_success){
      goto Error;
    }
    ThisElement = ThisElement->Next;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishConnection_V1_1_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishConnection_V1_1_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ConnectionKeysGenZ(json_t *CsJson, char *Key, RedfishConnection_V1_1_0_GenZConnectionKey_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // RKeyDomainCheckingEnabled 
  if (InsertJsonBoolObj (CsJson, "RKeyDomainCheckingEnabled", CSPtr->RKeyDomainCheckingEnabled) != RedfishCS_status_success) {goto Error;}

  // RKeyReadOnlyKey 
  if (InsertJsonStringObj (CsJson, "RKeyReadOnlyKey", CSPtr->RKeyReadOnlyKey) != RedfishCS_status_success) {goto Error;}

  // RKeyReadWriteKey 
  if (InsertJsonStringObj (CsJson, "RKeyReadWriteKey", CSPtr->RKeyReadWriteKey) != RedfishCS_status_success) {goto Error;}

  return RedfishCS_status_success;
Error:;
  return RedfishCS_status_unsupported;
}
static RedfishCS_status CS_To_JSON_ConnectionKeys(json_t *CsJson, char *Key, RedfishConnection_V1_1_0_ConnectionKey_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // GenZ
  if (CS_To_JSON_ConnectionKeysGenZ(CsJson, "GenZ", CSPtr->GenZ) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishConnection_V1_1_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // InitiatorEndpointGroups 
  if (InsertJsonLinkArrayObj (CsJson, "InitiatorEndpointGroups", &CSPtr->InitiatorEndpointGroups) != RedfishCS_status_success) {goto Error;}

  // InitiatorEndpointGroups@odata.count 
  if (InsertJsonInt64Obj (CsJson, "InitiatorEndpointGroups@odata.count", CSPtr->InitiatorEndpointGroupsodata_count) != RedfishCS_status_success) {goto Error;}

  // InitiatorEndpoints 
  if (InsertJsonLinkArrayObj (CsJson, "InitiatorEndpoints", &CSPtr->InitiatorEndpoints) != RedfishCS_status_success) {goto Error;}

  // InitiatorEndpoints@odata.count 
  if (InsertJsonInt64Obj (CsJson, "InitiatorEndpoints@odata.count", CSPtr->InitiatorEndpointsodata_count) != RedfishCS_status_success) {goto Error;}

  // Oem
  if (CS_To_JSON_LinksOem(CsJson, "Oem", CSPtr->Oem) != RedfishCS_status_success) {goto Error;}

  // TargetEndpointGroups 
  if (InsertJsonLinkArrayObj (CsJson, "TargetEndpointGroups", &CSPtr->TargetEndpointGroups) != RedfishCS_status_success) {goto Error;}

  // TargetEndpointGroups@odata.count 
  if (InsertJsonInt64Obj (CsJson, "TargetEndpointGroups@odata.count", CSPtr->TargetEndpointGroupsodata_count) != RedfishCS_status_success) {goto Error;}

  // TargetEndpoints 
  if (InsertJsonLinkArrayObj (CsJson, "TargetEndpoints", &CSPtr->TargetEndpoints) != RedfishCS_status_success) {goto Error;}

  // TargetEndpoints@odata.count 
  if (InsertJsonInt64Obj (CsJson, "TargetEndpoints@odata.count", CSPtr->TargetEndpointsodata_count) != RedfishCS_status_success) {goto Error;}

  return RedfishCS_status_success;
Error:;
  return RedfishCS_status_unsupported;
}
static RedfishCS_status CS_To_JSON_MemoryChunkInfo(json_t *CsJson, char *Key, RedfishConnection_V1_1_0_MemoryChunkInfo_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishConnection_V1_1_0_MemoryChunkInfo_Array_CS *NextArray;
  RedfishConnection_V1_1_0_MemoryChunkInfo_CS *NextArrayItem;
  ...
  do {
    ...
    // AccessCapabilities 
    if (InsertJsonStringArrayObj (ArrayMember, "AccessCapabilities", NextArrayItem->AccessCapabilities) != RedfishCS_status_success) {goto Error;}

    // AccessState 
    if (InsertJsonStringObj (ArrayMember, "AccessState", NextArrayItem->AccessState) != RedfishCS_status_success) {goto Error;}

    // MemoryChunk 
    if (InsertJsonLinkObj (ArrayMember, "MemoryChunk", &NextArrayItem->MemoryChunk) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_VolumeInfo(json_t *CsJson, char *Key, RedfishConnection_V1_1_0_VolumeInfo_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishConnection_V1_1_0_VolumeInfo_Array_CS *NextArray;
  RedfishConnection_V1_1_0_VolumeInfo_CS *NextArrayItem;
...
//
// C structure to JSON for Connection.V1_1_0.Connection
//
RedfishCS_status CS_To_Connection_V1_1_0_JSON(RedfishConnection_V1_1_0_Connection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // ConnectionKeys
  if (CS_To_JSON_ConnectionKeys(CsJson, "ConnectionKeys", CSPtr->ConnectionKeys) != RedfishCS_status_success) {goto Error;}

  // ConnectionType 
  if (InsertJsonStringObj (CsJson, "ConnectionType", CSPtr->ConnectionType) != RedfishCS_status_success) {goto Error;}
  ...
  // MemoryChunkInfo
  if (CS_To_JSON_MemoryChunkInfo(CsJson, "MemoryChunkInfo", CSPtr->MemoryChunkInfo) != RedfishCS_status_success) {goto Error;}
  ...
  // VolumeInfo
  if (CS_To_JSON_VolumeInfo(CsJson, "VolumeInfo", CSPtr->VolumeInfo) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for Connection.V1_1_0.Connection
//
RedfishCS_status DestroyConnection_V1_1_0_CS(RedfishConnection_V1_1_0_Connection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Connection.V1_1_0.Connection
//
RedfishCS_status DestroyConnection_V1_1_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Connection.V1_1_0.Connection
//
RedfishCS_status
Json_Connection_V1_1_0_To_CS(RedfishCS_char *JsonRawText, RedfishConnection_V1_1_0_Connection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishConnection_V1_1_0_Connection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Connection", "v1_1_0", "Connection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishConnection_V1_1_0_Connection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // ConnectionKeys
  Status = GenConnectionKeyCs (Cs, JsonObj, "ConnectionKeys", &Cs->ConnectionKeys);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ConnectionType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "ConnectionType", &Cs->ConnectionType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // MemoryChunkInfo
  Status = GenMemoryChunkInfo_ArrayCs (Cs, JsonObj, "MemoryChunkInfo", &Cs->MemoryChunkInfo);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // VolumeInfo
  Status = GenVolumeInfo_ArrayCs (Cs, JsonObj, "VolumeInfo", &Cs->VolumeInfo);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyConnection_V1_1_0_CS (Cs);
  return Status;
}
