...
#include"Redfish_Connection_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishConnection_V1_0_0_Connection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishConnection_V1_0_0_Connection_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishConnection_V1_0_0_Connection_CS *Cs, json_t *JsonObj, char *Key, RedfishConnection_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishConnection_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishConnection_V1_0_0_Connection_CS *Cs, json_t *JsonObj, char *Key, RedfishConnection_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishConnection_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishConnection_V1_0_0_Connection_CS *Cs, json_t *JsonObj, char *Key, RedfishConnection_V1_0_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishConnection_V1_0_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenidRefCs(RedfishConnection_V1_0_0_Connection_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishConnection_V1_0_0_Connection_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishConnection_V1_0_0_Connection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishConnection_V1_0_0_Connection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenVolumeInfo_Array_ElementCs(RedfishConnection_V1_0_0_Connection_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishConnection_V1_0_0_VolumeInfo_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishConnection_V1_0_0_VolumeInfo_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AccessCapabilities
...
//
//Generate C structure for RedfishConnection_V1_0_0_VolumeInfo_Array_CS
//
static RedfishCS_status GenVolumeInfo_ArrayCs(RedfishConnection_V1_0_0_Connection_CS *Cs, json_t *JsonObj, char *Key, RedfishConnection_V1_0_0_VolumeInfo_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishConnection_V1_0_0_VolumeInfo_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishConnection_V1_0_0_VolumeInfo_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishConnection_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishConnection_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishConnection_V1_0_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_VolumeInfo(json_t *CsJson, char *Key, RedfishConnection_V1_0_0_VolumeInfo_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishConnection_V1_0_0_VolumeInfo_Array_CS *NextArray;
  RedfishConnection_V1_0_0_VolumeInfo_CS *NextArrayItem;
...
//
// C structure to JSON for Connection.V1_0_0.Connection
//
RedfishCS_status CS_To_Connection_V1_0_0_JSON(RedfishConnection_V1_0_0_Connection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Connection.V1_0_0.Connection
//
RedfishCS_status DestroyConnection_V1_0_0_CS(RedfishConnection_V1_0_0_Connection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Connection.V1_0_0.Connection
//
RedfishCS_status DestroyConnection_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Connection.V1_0_0.Connection
//
RedfishCS_status
Json_Connection_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishConnection_V1_0_0_Connection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishConnection_V1_0_0_Connection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Connection", "v1_0_0", "Connection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishConnection_V1_0_0_Connection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyConnection_V1_0_0_CS (Cs);
  return Status;
}
