...
#include"Redfish_PrivilegeRegistry_v1_0_4_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOperationPrivilege_ArrayCs(RedfishPrivilegeRegistry_V1_0_4_PrivilegeRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS **Dst);
static RedfishCS_status GenOperationMapCs(RedfishPrivilegeRegistry_V1_0_4_PrivilegeRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationMap_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishPrivilegeRegistry_V1_0_4_PrivilegeRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenTarget_PrivilegeMap_ArrayCs(RedfishPrivilegeRegistry_V1_0_4_PrivilegeRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishPrivilegeRegistry_V1_0_4_Target_PrivilegeMap_Array_CS **Dst);
//
...
static RedfishCS_status GenOperationPrivilege_Array_ElementCs(RedfishPrivilegeRegistry_V1_0_4_PrivilegeRegistry_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Privilege
...
//
//Generate C structure for RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS
//
static RedfishCS_status GenOperationPrivilege_ArrayCs(RedfishPrivilegeRegistry_V1_0_4_PrivilegeRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS **Dst)
{
  RedfishCS_status Status;
  ...
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenOperationMapCs(RedfishPrivilegeRegistry_V1_0_4_PrivilegeRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationMap_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPrivilegeRegistry_V1_0_4_OperationMap_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // DELETE
...
static RedfishCS_status GenTarget_PrivilegeMap_Array_ElementCs(RedfishPrivilegeRegistry_V1_0_4_PrivilegeRegistry_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPrivilegeRegistry_V1_0_4_Target_PrivilegeMap_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPrivilegeRegistry_V1_0_4_Target_PrivilegeMap_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // OperationMap
...
//
//Generate C structure for RedfishPrivilegeRegistry_V1_0_4_Target_PrivilegeMap_Array_CS
//
static RedfishCS_status GenTarget_PrivilegeMap_ArrayCs(RedfishPrivilegeRegistry_V1_0_4_PrivilegeRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishPrivilegeRegistry_V1_0_4_Target_PrivilegeMap_Array_CS **Dst)
{
  RedfishCS_status Status;
  ...
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPrivilegeRegistry_V1_0_4_Target_PrivilegeMap_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPrivilegeRegistry_V1_0_4_Target_PrivilegeMap_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenMapping_Array_ElementCs(RedfishPrivilegeRegistry_V1_0_4_PrivilegeRegistry_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPrivilegeRegistry_V1_0_4_Mapping_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPrivilegeRegistry_V1_0_4_Mapping_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Entity
...
//
//Generate C structure for RedfishPrivilegeRegistry_V1_0_4_Mapping_Array_CS
//
static RedfishCS_status GenMapping_ArrayCs(RedfishPrivilegeRegistry_V1_0_4_PrivilegeRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishPrivilegeRegistry_V1_0_4_Mapping_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPrivilegeRegistry_V1_0_4_Mapping_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPrivilegeRegistry_V1_0_4_Mapping_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenOemCs(RedfishPrivilegeRegistry_V1_0_4_PrivilegeRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
...
static RedfishCS_status CS_To_JSON_MappingsOperationMapDELETE(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_MappingsOperationMapGET(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsOperationMapHEAD(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsOperationMapPATCH(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsOperationMapPOST(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsOperationMapPUT(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsOperationMap(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationMap_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_MappingsPropertyOverridesOperationMapDELETE(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsPropertyOverridesOperationMapGET(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsPropertyOverridesOperationMapHEAD(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsPropertyOverridesOperationMapPATCH(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsPropertyOverridesOperationMapPOST(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsPropertyOverridesOperationMapPUT(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsPropertyOverridesOperationMap(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationMap_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_MappingsPropertyOverrides(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_Target_PrivilegeMap_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_Target_PrivilegeMap_Array_CS *NextArray;
  RedfishPrivilegeRegistry_V1_0_4_Target_PrivilegeMap_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_MappingsResourceURIOverridesOperationMapDELETE(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsResourceURIOverridesOperationMapGET(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsResourceURIOverridesOperationMapHEAD(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsResourceURIOverridesOperationMapPATCH(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsResourceURIOverridesOperationMapPOST(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsResourceURIOverridesOperationMapPUT(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsResourceURIOverridesOperationMap(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationMap_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_MappingsResourceURIOverrides(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_Target_PrivilegeMap_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_Target_PrivilegeMap_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsSubordinateOverridesOperationMapDELETE(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsSubordinateOverridesOperationMapGET(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsSubordinateOverridesOperationMapHEAD(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsSubordinateOverridesOperationMapPATCH(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsSubordinateOverridesOperationMapPOST(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsSubordinateOverridesOperationMapPUT(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_OperationPrivilege_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_MappingsSubordinateOverridesOperationMap(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_OperationMap_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_MappingsSubordinateOverrides(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_Target_PrivilegeMap_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_Target_PrivilegeMap_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_Mappings(json_t *CsJson, char *Key, RedfishPrivilegeRegistry_V1_0_4_Mapping_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPrivilegeRegistry_V1_0_4_Mapping_Array_CS *NextArray;
  RedfishPrivilegeRegistry_V1_0_4_Mapping_CS *NextArrayItem;
...
//
// C structure to JSON for PrivilegeRegistry.V1_0_4.PrivilegeRegistry
//
RedfishCS_status CS_To_PrivilegeRegistry_V1_0_4_JSON(RedfishPrivilegeRegistry_V1_0_4_PrivilegeRegistry_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for PrivilegeRegistry.V1_0_4.PrivilegeRegistry
//
RedfishCS_status DestroyPrivilegeRegistry_V1_0_4_CS(RedfishPrivilegeRegistry_V1_0_4_PrivilegeRegistry_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PrivilegeRegistry.V1_0_4.PrivilegeRegistry
//
RedfishCS_status DestroyPrivilegeRegistry_V1_0_4_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PrivilegeRegistry.V1_0_4.PrivilegeRegistry
//
RedfishCS_status
Json_PrivilegeRegistry_V1_0_4_To_CS(RedfishCS_char *JsonRawText, RedfishPrivilegeRegistry_V1_0_4_PrivilegeRegistry_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPrivilegeRegistry_V1_0_4_PrivilegeRegistry_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PrivilegeRegistry", "v1_0_4", "PrivilegeRegistry", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPrivilegeRegistry_V1_0_4_PrivilegeRegistry_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyPrivilegeRegistry_V1_0_4_CS (Cs);
  return Status;
}
