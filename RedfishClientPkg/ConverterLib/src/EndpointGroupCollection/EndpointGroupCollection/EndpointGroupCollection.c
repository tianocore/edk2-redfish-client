...
#include"Redfish_EndpointGroupCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishEndpointGroupCollection_EndpointGroupCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for EndpointGroupCollection.EndpointGroupCollection
//
RedfishCS_status CS_To_EndpointGroupCollection_JSON(RedfishEndpointGroupCollection_EndpointGroupCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for EndpointGroupCollection.EndpointGroupCollection
//
RedfishCS_status DestroyEndpointGroupCollection_CS(RedfishEndpointGroupCollection_EndpointGroupCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for EndpointGroupCollection.EndpointGroupCollection
//
RedfishCS_status DestroyEndpointGroupCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for EndpointGroupCollection.NOVERSIONED.EndpointGroupCollection
//
RedfishCS_status
Json_EndpointGroupCollection_To_CS(RedfishCS_char *JsonRawText, RedfishEndpointGroupCollection_EndpointGroupCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEndpointGroupCollection_EndpointGroupCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "EndpointGroupCollection", "noversioned", "EndpointGroupCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEndpointGroupCollection_EndpointGroupCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyEndpointGroupCollection_CS (Cs);
  return Status;
}
