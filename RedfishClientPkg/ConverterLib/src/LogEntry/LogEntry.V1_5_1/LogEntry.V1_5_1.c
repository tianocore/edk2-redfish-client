...
#include"Redfish_LogEntry_v1_5_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishLogEntry_V1_5_1_LogEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishLogEntry_V1_5_1_LogEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishLogEntry_V1_5_1_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLogEntry_V1_5_1_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishLogEntry_V1_5_1_LogEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishLogEntry_V1_5_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLogEntry_V1_5_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenidRefCs(RedfishLogEntry_V1_5_1_LogEntry_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenLinksCs(RedfishLogEntry_V1_5_1_LogEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishLogEntry_V1_5_1_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLogEntry_V1_5_1_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishLogEntry_V1_5_1_LogEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishLogEntry_V1_5_1_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishLogEntry_V1_5_1_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishLogEntry_V1_5_1_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for LogEntry.V1_5_1.LogEntry
//
RedfishCS_status CS_To_LogEntry_V1_5_1_JSON(RedfishLogEntry_V1_5_1_LogEntry_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for LogEntry.V1_5_1.LogEntry
//
RedfishCS_status DestroyLogEntry_V1_5_1_CS(RedfishLogEntry_V1_5_1_LogEntry_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for LogEntry.V1_5_1.LogEntry
//
RedfishCS_status DestroyLogEntry_V1_5_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for LogEntry.V1_5_1.LogEntry
//
RedfishCS_status
Json_LogEntry_V1_5_1_To_CS(RedfishCS_char *JsonRawText, RedfishLogEntry_V1_5_1_LogEntry_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishLogEntry_V1_5_1_LogEntry_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "LogEntry", "v1_5_1", "LogEntry", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishLogEntry_V1_5_1_LogEntry_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
