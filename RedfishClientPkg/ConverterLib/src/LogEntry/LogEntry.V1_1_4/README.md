# Definition of LogEntry.V1_1_4 and functions<br><br>
...
## LogEntry
    typedef struct _RedfishLogEntry_V1_1_4_LogEntry_CS {
        ...
        RedfishCS_char *Id;
        RedfishLogEntry_V1_1_4_Links_CS *Links;
...
|**Links**|RedfishLogEntry_V1_1_4_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish LogEntry V1_1_4 to C Structure Function
    RedfishCS_status
    Json_LogEntry_V1_1_4_To_CS (RedfishCS_char *JsonRawText, RedfishLogEntry_V1_1_4_LogEntry_CS **ReturnedCS);

## C Structure to Redfish LogEntry V1_1_4 JSON Function
    RedfishCS_status
    CS_To_LogEntry_V1_1_4_JSON (RedfishLogEntry_V1_1_4_LogEntry_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish LogEntry V1_1_4 C Structure Function
    RedfishCS_status
