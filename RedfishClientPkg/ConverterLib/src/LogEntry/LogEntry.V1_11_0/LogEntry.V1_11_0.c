...
#include"Redfish_LogEntry_v1_11_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishLogEntry_V1_11_0_LogEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishLogEntry_V1_11_0_LogEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishLogEntry_V1_11_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLogEntry_V1_11_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishLogEntry_V1_11_0_LogEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishLogEntry_V1_11_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLogEntry_V1_11_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenidRefCs(RedfishLogEntry_V1_11_0_LogEntry_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenLinksCs(RedfishLogEntry_V1_11_0_LogEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishLogEntry_V1_11_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLogEntry_V1_11_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishLogEntry_V1_11_0_LogEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishLogEntry_V1_11_0_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishLogEntry_V1_11_0_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_LinksOriginOfCondition(json_t *CsJson, char *Key, Redfishodatav4_idRef_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishLogEntry_V1_11_0_Links_CS *CSPtr)
{
  json_t *CsParentJson;
...
//
// C structure to JSON for LogEntry.V1_11_0.LogEntry
//
RedfishCS_status CS_To_LogEntry_V1_11_0_JSON(RedfishLogEntry_V1_11_0_LogEntry_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  if (InsertJsonInt64Obj (CsJson, "AdditionalDataSizeBytes", CSPtr->AdditionalDataSizeBytes) != RedfishCS_status_success) {goto Error;}

  // AdditionalDataURI 
  if (InsertJsonStringObj (CsJson, "AdditionalDataURI", CSPtr->AdditionalDataURI) != RedfishCS_status_success) {goto Error;}
  ...
  // DiagnosticDataType 
  if (InsertJsonStringObj (CsJson, "DiagnosticDataType", CSPtr->DiagnosticDataType) != RedfishCS_status_success) {goto Error;}
  ...
  // GeneratorId 
  if (InsertJsonStringObj (CsJson, "GeneratorId", CSPtr->GeneratorId) != RedfishCS_status_success) {goto Error;}
  ...
  // Modified 
  if (InsertJsonStringObj (CsJson, "Modified", CSPtr->Modified) != RedfishCS_status_success) {goto Error;}

  // Name 
  if (InsertJsonStringObj (CsJson, "Name", CSPtr->Name) != RedfishCS_status_success) {goto Error;}

  // OEMDiagnosticDataType 
  if (InsertJsonStringObj (CsJson, "OEMDiagnosticDataType", CSPtr->OEMDiagnosticDataType) != RedfishCS_status_success) {goto Error;}
  ...
  // Originator 
  if (InsertJsonStringObj (CsJson, "Originator", CSPtr->Originator) != RedfishCS_status_success) {goto Error;}

  // OriginatorType 
  if (InsertJsonStringObj (CsJson, "OriginatorType", CSPtr->OriginatorType) != RedfishCS_status_success) {goto Error;}

  // Resolution 
  if (InsertJsonStringObj (CsJson, "Resolution", CSPtr->Resolution) != RedfishCS_status_success) {goto Error;}

  // Resolved 
  if (InsertJsonBoolObj (CsJson, "Resolved", CSPtr->Resolved) != RedfishCS_status_success) {goto Error;}
  ...
  if (InsertJsonBoolObj (CsJson, "ServiceProviderNotified", CSPtr->ServiceProviderNotified) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for LogEntry.V1_11_0.LogEntry
//
RedfishCS_status DestroyLogEntry_V1_11_0_CS(RedfishLogEntry_V1_11_0_LogEntry_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for LogEntry.V1_11_0.LogEntry
//
RedfishCS_status DestroyLogEntry_V1_11_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for LogEntry.V1_11_0.LogEntry
//
RedfishCS_status
Json_LogEntry_V1_11_0_To_CS(RedfishCS_char *JsonRawText, RedfishLogEntry_V1_11_0_LogEntry_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishLogEntry_V1_11_0_LogEntry_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "LogEntry", "v1_11_0", "LogEntry", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishLogEntry_V1_11_0_LogEntry_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // AdditionalDataSizeBytes
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "AdditionalDataSizeBytes", &Cs->AdditionalDataSizeBytes);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // AdditionalDataURI
  Status = GetRedfishPropertyStr (Cs, JsonObj, "AdditionalDataURI", &Cs->AdditionalDataURI);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // DiagnosticDataType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "DiagnosticDataType", &Cs->DiagnosticDataType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // GeneratorId
  Status = GetRedfishPropertyStr (Cs, JsonObj, "GeneratorId", &Cs->GeneratorId);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // Modified
  Status = GetRedfishPropertyStr (Cs, JsonObj, "Modified", &Cs->Modified);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // OEMDiagnosticDataType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "OEMDiagnosticDataType", &Cs->OEMDiagnosticDataType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // Originator
  Status = GetRedfishPropertyStr (Cs, JsonObj, "Originator", &Cs->Originator);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // OriginatorType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "OriginatorType", &Cs->OriginatorType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Resolution
  Status = GetRedfishPropertyStr (Cs, JsonObj, "Resolution", &Cs->Resolution);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Resolved
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "Resolved", &Cs->Resolved);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // ServiceProviderNotified
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "ServiceProviderNotified", &Cs->ServiceProviderNotified);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
