# Definition of LogEntry.V1_1_3 and functions<br><br>
...
## LogEntry
    typedef struct _RedfishLogEntry_V1_1_3_LogEntry_CS {
        ...
        RedfishCS_char *Id;
        RedfishLogEntry_V1_1_3_Links_CS *Links;
...
|**Links**|RedfishLogEntry_V1_1_3_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish LogEntry V1_1_3 to C Structure Function
    RedfishCS_status
    Json_LogEntry_V1_1_3_To_CS (RedfishCS_char *JsonRawText, RedfishLogEntry_V1_1_3_LogEntry_CS **ReturnedCS);

## C Structure to Redfish LogEntry V1_1_3 JSON Function
    RedfishCS_status
    CS_To_LogEntry_V1_1_3_JSON (RedfishLogEntry_V1_1_3_LogEntry_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish LogEntry V1_1_3 C Structure Function
    RedfishCS_status
