# Definition of LogEntry.V1_4_0 and functions<br><br>

## Actions
    typedef struct _RedfishLogEntry_V1_4_0_Actions_CS {
        RedfishLogEntry_V1_4_0_OemActions_CS *Oem;
    } RedfishLogEntry_V1_4_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishLogEntry_V1_4_0_OemActions_CS| Structure points to **Oem** property.| No| No
...
## LogEntry
    typedef struct _RedfishLogEntry_V1_4_0_LogEntry_CS {
        ...
        RedfishLogEntry_V1_4_0_Actions_CS *Actions;
        ...
        RedfishCS_char *Id;
        RedfishLogEntry_V1_4_0_Links_CS *Links;
...
|**Actions**|RedfishLogEntry_V1_4_0_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishLogEntry_V1_4_0_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish LogEntry V1_4_0 to C Structure Function
    RedfishCS_status
    Json_LogEntry_V1_4_0_To_CS (RedfishCS_char *JsonRawText, RedfishLogEntry_V1_4_0_LogEntry_CS **ReturnedCS);

## C Structure to Redfish LogEntry V1_4_0 JSON Function
    RedfishCS_status
    CS_To_LogEntry_V1_4_0_JSON (RedfishLogEntry_V1_4_0_LogEntry_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish LogEntry V1_4_0 C Structure Function
    RedfishCS_status
