...
#include"Redfish_NetworkAdapter_v1_1_2_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #NetworkAdapter.ResetSettingsToDefault
//
static RedfishCS_status GenResetSettingsToDefaultCs(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkAdapter_V1_1_2_ResetSettingsToDefault_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkAdapter_V1_1_2_ResetSettingsToDefault_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkAdapter_V1_1_2_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkAdapter_V1_1_2_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkAdapter_V1_1_2_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkAdapter_V1_1_2_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenDataCenterBridgingCs(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkAdapter_V1_1_2_DataCenterBridging_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkAdapter_V1_1_2_DataCenterBridging_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Capable
...
//
static RedfishCS_status GenNPIVCs(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkAdapter_V1_1_2_NPIV_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkAdapter_V1_1_2_NPIV_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MaxDeviceLogins
...
//
static RedfishCS_status GenSRIOVCs(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkAdapter_V1_1_2_SRIOV_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkAdapter_V1_1_2_SRIOV_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // SRIOVVEPACapable
...
//
static RedfishCS_status GenVirtualFunctionCs(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkAdapter_V1_1_2_VirtualFunction_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkAdapter_V1_1_2_VirtualFunction_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // DeviceMaxCount
...
//
static RedfishCS_status GenVirtualizationOffloadCs(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkAdapter_V1_1_2_VirtualizationOffload_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkAdapter_V1_1_2_VirtualizationOffload_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // SRIOV
...
//
static RedfishCS_status GenControllerCapabilitiesCs(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkAdapter_V1_1_2_ControllerCapabilities_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkAdapter_V1_1_2_ControllerCapabilities_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // DataCenterBridging
...
//
static RedfishCS_status GenControllerLinksCs(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkAdapter_V1_1_2_ControllerLinks_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkAdapter_V1_1_2_ControllerLinks_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
static RedfishCS_status GenControllers_Array_ElementCs(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishNetworkAdapter_V1_1_2_Controllers_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishNetworkAdapter_V1_1_2_Controllers_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
//Generate C structure for RedfishNetworkAdapter_V1_1_2_Controllers_Array_CS
//
static RedfishCS_status GenControllers_ArrayCs(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkAdapter_V1_1_2_Controllers_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishNetworkAdapter_V1_1_2_Controllers_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishNetworkAdapter_V1_1_2_Controllers_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenidRefCs(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsNetworkAdapter_ResetSettingsToDefault(json_t *CsJson, char *Key, RedfishNetworkAdapter_V1_1_2_ResetSettingsToDefault_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishNetworkAdapter_V1_1_2_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishNetworkAdapter_V1_1_2_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ControllersControllerCapabilitiesDataCenterBridging(json_t *CsJson, char *Key, RedfishNetworkAdapter_V1_1_2_DataCenterBridging_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ControllersControllerCapabilitiesNPIV(json_t *CsJson, char *Key, RedfishNetworkAdapter_V1_1_2_NPIV_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ControllersControllerCapabilitiesVirtualizationOffloadSRIOV(json_t *CsJson, char *Key, RedfishNetworkAdapter_V1_1_2_SRIOV_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ControllersControllerCapabilitiesVirtualizationOffloadVirtualFunction(json_t *CsJson, char *Key, RedfishNetworkAdapter_V1_1_2_VirtualFunction_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ControllersControllerCapabilitiesVirtualizationOffload(json_t *CsJson, char *Key, RedfishNetworkAdapter_V1_1_2_VirtualizationOffload_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ControllersControllerCapabilities(json_t *CsJson, char *Key, RedfishNetworkAdapter_V1_1_2_ControllerCapabilities_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ControllersLinks(json_t *CsJson, char *Key, RedfishNetworkAdapter_V1_1_2_ControllerLinks_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Controllers(json_t *CsJson, char *Key, RedfishNetworkAdapter_V1_1_2_Controllers_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishNetworkAdapter_V1_1_2_Controllers_Array_CS *NextArray;
  RedfishNetworkAdapter_V1_1_2_Controllers_CS *NextArrayItem;
...
//
// C structure to JSON for NetworkAdapter.V1_1_2.NetworkAdapter
//
RedfishCS_status CS_To_NetworkAdapter_V1_1_2_JSON(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for NetworkAdapter.V1_1_2.NetworkAdapter
//
RedfishCS_status DestroyNetworkAdapter_V1_1_2_CS(RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for NetworkAdapter.V1_1_2.NetworkAdapter
//
RedfishCS_status DestroyNetworkAdapter_V1_1_2_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for NetworkAdapter.V1_1_2.NetworkAdapter
//
RedfishCS_status
Json_NetworkAdapter_V1_1_2_To_CS(RedfishCS_char *JsonRawText, RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "NetworkAdapter", "v1_1_2", "NetworkAdapter", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishNetworkAdapter_V1_1_2_NetworkAdapter_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyNetworkAdapter_V1_1_2_CS (Cs);
  return Status;
}
