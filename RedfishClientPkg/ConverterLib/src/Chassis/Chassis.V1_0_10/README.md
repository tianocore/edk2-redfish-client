# Definition of Chassis.V1_0_10 and functions<br><br>

## Actions
    typedef struct _RedfishChassis_V1_0_10_Actions_CS {
        RedfishChassis_V1_0_10_Reset_CS *Chassis_Reset;
        RedfishChassis_V1_0_10_OemActions_CS *Oem;
    } RedfishChassis_V1_0_10_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Chassis_Reset**|RedfishChassis_V1_0_10_Reset_CS| Structure points to **#Chassis.Reset** property.| No| No
|**Oem**|RedfishChassis_V1_0_10_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Chassis
    typedef struct _RedfishChassis_V1_0_10_Chassis_CS {
        ...
        RedfishChassis_V1_0_10_Actions_CS *Actions;
        RedfishCS_char *AssetTag;
        RedfishCS_char *ChassisType;
        RedfishCS_char *Description;
        RedfishCS_char *Id;
        RedfishCS_char *IndicatorLED;
        RedfishChassis_V1_0_10_Links_CS *Links;
...
|**Actions**|RedfishChassis_V1_0_10_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishChassis_V1_0_10_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish Chassis V1_0_10 to C Structure Function
    RedfishCS_status
    Json_Chassis_V1_0_10_To_CS (RedfishCS_char *JsonRawText, RedfishChassis_V1_0_10_Chassis_CS **ReturnedCS);

## C Structure to Redfish Chassis V1_0_10 JSON Function
    RedfishCS_status
    CS_To_Chassis_V1_0_10_JSON (RedfishChassis_V1_0_10_Chassis_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Chassis V1_0_10 C Structure Function
    RedfishCS_status
