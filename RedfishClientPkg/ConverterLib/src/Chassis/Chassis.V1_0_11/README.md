# Definition of Chassis.V1_0_11 and functions<br><br>

## Actions
    typedef struct _RedfishChassis_V1_0_11_Actions_CS {
        RedfishChassis_V1_0_11_Reset_CS *Chassis_Reset;
        RedfishChassis_V1_0_11_OemActions_CS *Oem;
    } RedfishChassis_V1_0_11_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Chassis_Reset**|RedfishChassis_V1_0_11_Reset_CS| Structure points to **#Chassis.Reset** property.| No| No
|**Oem**|RedfishChassis_V1_0_11_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Chassis
    typedef struct _RedfishChassis_V1_0_11_Chassis_CS {
        ...
        RedfishChassis_V1_0_11_Actions_CS *Actions;
        RedfishCS_char *AssetTag;
        RedfishCS_char *ChassisType;
        RedfishCS_char *Description;
        RedfishCS_char *Id;
        RedfishCS_char *IndicatorLED;
        RedfishChassis_V1_0_11_Links_CS *Links;
...
|**Actions**|RedfishChassis_V1_0_11_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishChassis_V1_0_11_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish Chassis V1_0_11 to C Structure Function
    RedfishCS_status
    Json_Chassis_V1_0_11_To_CS (RedfishCS_char *JsonRawText, RedfishChassis_V1_0_11_Chassis_CS **ReturnedCS);

## C Structure to Redfish Chassis V1_0_11 JSON Function
    RedfishCS_status
    CS_To_Chassis_V1_0_11_JSON (RedfishChassis_V1_0_11_Chassis_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Chassis V1_0_11 C Structure Function
    RedfishCS_status
