...
#include"Redfish_Chassis_v1_5_9_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenidRef_ArrayCs(RedfishChassis_V1_5_9_Chassis_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_Array_CS **Dst);
static RedfishCS_status GenOemCs(RedfishChassis_V1_5_9_Chassis_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #Chassis.Reset
//
static RedfishCS_status GenResetCs(RedfishChassis_V1_5_9_Chassis_CS *Cs, json_t *JsonObj, char *Key, RedfishChassis_V1_5_9_Reset_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishChassis_V1_5_9_Reset_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishChassis_V1_5_9_Chassis_CS *Cs, json_t *JsonObj, char *Key, RedfishChassis_V1_5_9_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishChassis_V1_5_9_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishChassis_V1_5_9_Chassis_CS *Cs, json_t *JsonObj, char *Key, RedfishChassis_V1_5_9_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishChassis_V1_5_9_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #Chassis.Reset
...
static RedfishCS_status GenidRef_Array_ElementCs(RedfishChassis_V1_5_9_Chassis_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenLinksCs(RedfishChassis_V1_5_9_Chassis_CS *Cs, json_t *JsonObj, char *Key, RedfishChassis_V1_5_9_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishChassis_V1_5_9_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ComputerSystems
...
//
static RedfishCS_status GenPhysicalSecurityCs(RedfishChassis_V1_5_9_Chassis_CS *Cs, json_t *JsonObj, char *Key, RedfishChassis_V1_5_9_PhysicalSecurity_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishChassis_V1_5_9_PhysicalSecurity_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // IntrusionSensor
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishChassis_V1_5_9_Chassis_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenidRefCs(RedfishChassis_V1_5_9_Chassis_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishChassis_V1_5_9_Chassis_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishChassis_V1_5_9_Chassis_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishChassis_V1_5_9_Chassis_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsChassis_Reset(json_t *CsJson, char *Key, RedfishChassis_V1_5_9_Reset_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishChassis_V1_5_9_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishChassis_V1_5_9_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishChassis_V1_5_9_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_PhysicalSecurity(json_t *CsJson, char *Key, RedfishChassis_V1_5_9_PhysicalSecurity_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Chassis.V1_5_9.Chassis
//
RedfishCS_status CS_To_Chassis_V1_5_9_JSON(RedfishChassis_V1_5_9_Chassis_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Chassis.V1_5_9.Chassis
//
RedfishCS_status DestroyChassis_V1_5_9_CS(RedfishChassis_V1_5_9_Chassis_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Chassis.V1_5_9.Chassis
//
RedfishCS_status DestroyChassis_V1_5_9_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Chassis.V1_5_9.Chassis
//
RedfishCS_status
Json_Chassis_V1_5_9_To_CS(RedfishCS_char *JsonRawText, RedfishChassis_V1_5_9_Chassis_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishChassis_V1_5_9_Chassis_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Chassis", "v1_5_9", "Chassis", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishChassis_V1_5_9_Chassis_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
