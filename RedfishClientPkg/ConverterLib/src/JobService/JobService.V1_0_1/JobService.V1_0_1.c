...
#include"Redfish_JobService_v1_0_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishJobService_V1_0_1_JobService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishJobService_V1_0_1_JobService_CS *Cs, json_t *JsonObj, char *Key, RedfishJobService_V1_0_1_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishJobService_V1_0_1_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishJobService_V1_0_1_JobService_CS *Cs, json_t *JsonObj, char *Key, RedfishJobService_V1_0_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishJobService_V1_0_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenJobServiceCapabilitiesCs(RedfishJobService_V1_0_1_JobService_CS *Cs, json_t *JsonObj, char *Key, RedfishJobService_V1_0_1_JobServiceCapabilities_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishJobService_V1_0_1_JobServiceCapabilities_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MaxJobs
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishJobService_V1_0_1_JobService_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishJobService_V1_0_1_JobService_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishJobService_V1_0_1_JobService_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishJobService_V1_0_1_JobService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishJobService_V1_0_1_JobService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishJobService_V1_0_1_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishJobService_V1_0_1_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ServiceCapabilities(json_t *CsJson, char *Key, RedfishJobService_V1_0_1_JobServiceCapabilities_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for JobService.V1_0_1.JobService
//
RedfishCS_status CS_To_JobService_V1_0_1_JSON(RedfishJobService_V1_0_1_JobService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for JobService.V1_0_1.JobService
//
RedfishCS_status DestroyJobService_V1_0_1_CS(RedfishJobService_V1_0_1_JobService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for JobService.V1_0_1.JobService
//
RedfishCS_status DestroyJobService_V1_0_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for JobService.V1_0_1.JobService
//
RedfishCS_status
Json_JobService_V1_0_1_To_CS(RedfishCS_char *JsonRawText, RedfishJobService_V1_0_1_JobService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishJobService_V1_0_1_JobService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "JobService", "v1_0_1", "JobService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishJobService_V1_0_1_JobService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyJobService_V1_0_1_CS (Cs);
  return Status;
}
