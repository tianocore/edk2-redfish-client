# Definition of JobService.V1_0_1 and functions<br><br>

## Actions
    typedef struct _RedfishJobService_V1_0_1_Actions_CS {
        RedfishJobService_V1_0_1_OemActions_CS *Oem;
    } RedfishJobService_V1_0_1_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishJobService_V1_0_1_OemActions_CS| Structure points to **Oem** property.| No| No
...
## JobService
    typedef struct _RedfishJobService_V1_0_1_JobService_CS {
        ...
        RedfishJobService_V1_0_1_Actions_CS *Actions;
        ...
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishJobService_V1_0_1_JobServiceCapabilities_CS *ServiceCapabilities;
...
|**Actions**|RedfishJobService_V1_0_1_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**ServiceCapabilities**|RedfishJobService_V1_0_1_JobServiceCapabilities_CS| Structure points to **ServiceCapabilities** property.| No| No
|**ServiceEnabled**|RedfishCS_bool| Boolean pointer to **ServiceEnabled** property.| No| No
|**Status**|RedfishResource_Status_CS| Structure points to **Status** property.| No| No
## Redfish JobService V1_0_1 to C Structure Function
    RedfishCS_status
    Json_JobService_V1_0_1_To_CS (RedfishCS_char *JsonRawText, RedfishJobService_V1_0_1_JobService_CS **ReturnedCS);

## C Structure to Redfish JobService V1_0_1 JSON Function
    RedfishCS_status
    CS_To_JobService_V1_0_1_JSON (RedfishJobService_V1_0_1_JobService_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish JobService V1_0_1 C Structure Function
    RedfishCS_status
