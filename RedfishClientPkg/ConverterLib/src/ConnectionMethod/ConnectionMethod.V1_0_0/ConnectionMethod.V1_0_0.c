...
#include"Redfish_ConnectionMethod_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishConnectionMethod_V1_0_0_ConnectionMethod_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishConnectionMethod_V1_0_0_ConnectionMethod_CS *Cs, json_t *JsonObj, char *Key, RedfishConnectionMethod_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishConnectionMethod_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishConnectionMethod_V1_0_0_ConnectionMethod_CS *Cs, json_t *JsonObj, char *Key, RedfishConnectionMethod_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishConnectionMethod_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishConnectionMethod_V1_0_0_ConnectionMethod_CS *Cs, json_t *JsonObj, char *Key, RedfishConnectionMethod_V1_0_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishConnectionMethod_V1_0_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AggregationSources
  InitializeLinkHead (&(*Dst)->AggregationSources);
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "AggregationSources", Cs->Header.ThisUri, &(*Dst)->AggregationSources);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // AggregationSources@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "AggregationSources@odata.count", &(*Dst)->AggregationSourcesodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishConnectionMethod_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishConnectionMethod_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishConnectionMethod_V1_0_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // AggregationSources 
  if (InsertJsonLinkArrayObj (CsJson, "AggregationSources", &CSPtr->AggregationSources) != RedfishCS_status_success) {goto Error;}

  // AggregationSources@odata.count 
  if (InsertJsonInt64Obj (CsJson, "AggregationSources@odata.count", CSPtr->AggregationSourcesodata_count) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for ConnectionMethod.V1_0_0.ConnectionMethod
//
RedfishCS_status CS_To_ConnectionMethod_V1_0_0_JSON(RedfishConnectionMethod_V1_0_0_ConnectionMethod_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  if (InsertJsonStringObj (CsJson, "ConnectionMethodType", CSPtr->ConnectionMethodType) != RedfishCS_status_success) {goto Error;}

  // ConnectionMethodVariant 
  if (InsertJsonStringObj (CsJson, "ConnectionMethodVariant", CSPtr->ConnectionMethodVariant) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for ConnectionMethod.V1_0_0.ConnectionMethod
//
RedfishCS_status DestroyConnectionMethod_V1_0_0_CS(RedfishConnectionMethod_V1_0_0_ConnectionMethod_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ConnectionMethod.V1_0_0.ConnectionMethod
//
RedfishCS_status DestroyConnectionMethod_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ConnectionMethod.V1_0_0.ConnectionMethod
//
RedfishCS_status
Json_ConnectionMethod_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishConnectionMethod_V1_0_0_ConnectionMethod_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishConnectionMethod_V1_0_0_ConnectionMethod_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ConnectionMethod", "v1_0_0", "ConnectionMethod", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishConnectionMethod_V1_0_0_ConnectionMethod_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // ConnectionMethodType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "ConnectionMethodType", &Cs->ConnectionMethodType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ConnectionMethodVariant
  Status = GetRedfishPropertyStr (Cs, JsonObj, "ConnectionMethodVariant", &Cs->ConnectionMethodVariant);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyConnectionMethod_V1_0_0_CS (Cs);
  return Status;
}
