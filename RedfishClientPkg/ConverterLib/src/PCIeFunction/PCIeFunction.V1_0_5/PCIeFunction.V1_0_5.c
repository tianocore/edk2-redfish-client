...
#include"Redfish_PCIeFunction_v1_0_5_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishPCIeFunction_V1_0_5_PCIeFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
...
//
static RedfishCS_status GenLinksCs(RedfishPCIeFunction_V1_0_5_PCIeFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishPCIeFunction_V1_0_5_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPCIeFunction_V1_0_5_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Drives
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishPCIeFunction_V1_0_5_PCIeFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishPCIeFunction_V1_0_5_PCIeFunction_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishPCIeFunction_V1_0_5_PCIeFunction_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishPCIeFunction_V1_0_5_PCIeFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishPCIeFunction_V1_0_5_PCIeFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishPCIeFunction_V1_0_5_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for PCIeFunction.V1_0_5.PCIeFunction
//
RedfishCS_status CS_To_PCIeFunction_V1_0_5_JSON(RedfishPCIeFunction_V1_0_5_PCIeFunction_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for PCIeFunction.V1_0_5.PCIeFunction
//
RedfishCS_status DestroyPCIeFunction_V1_0_5_CS(RedfishPCIeFunction_V1_0_5_PCIeFunction_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PCIeFunction.V1_0_5.PCIeFunction
//
RedfishCS_status DestroyPCIeFunction_V1_0_5_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PCIeFunction.V1_0_5.PCIeFunction
//
RedfishCS_status
Json_PCIeFunction_V1_0_5_To_CS(RedfishCS_char *JsonRawText, RedfishPCIeFunction_V1_0_5_PCIeFunction_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPCIeFunction_V1_0_5_PCIeFunction_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PCIeFunction", "v1_0_5", "PCIeFunction", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPCIeFunction_V1_0_5_PCIeFunction_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyPCIeFunction_V1_0_5_CS (Cs);
  return Status;
}
