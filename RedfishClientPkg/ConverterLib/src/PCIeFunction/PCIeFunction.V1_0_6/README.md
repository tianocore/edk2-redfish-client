# Definition of PCIeFunction.V1_0_6 and functions<br><br>
...
## PCIeFunction
    typedef struct _RedfishPCIeFunction_V1_0_6_PCIeFunction_CS {
        ...
        RedfishCS_char *Id;
        RedfishPCIeFunction_V1_0_6_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
...
|**Links**|RedfishPCIeFunction_V1_0_6_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish PCIeFunction V1_0_6 to C Structure Function
    RedfishCS_status
    Json_PCIeFunction_V1_0_6_To_CS (RedfishCS_char *JsonRawText, RedfishPCIeFunction_V1_0_6_PCIeFunction_CS **ReturnedCS);

## C Structure to Redfish PCIeFunction V1_0_6 JSON Function
    RedfishCS_status
    CS_To_PCIeFunction_V1_0_6_JSON (RedfishPCIeFunction_V1_0_6_PCIeFunction_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish PCIeFunction V1_0_6 C Structure Function
    RedfishCS_status
