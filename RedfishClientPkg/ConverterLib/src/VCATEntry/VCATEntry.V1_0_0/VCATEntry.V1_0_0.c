...
#include"Redfish_VCATEntry_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishVCATEntry_V1_0_0_VCATEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishVCATEntry_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVCATEntry_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishVCATEntry_V1_0_0_VCATEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishVCATEntry_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVCATEntry_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishVCATEntry_V1_0_0_VCATEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
//
static RedfishCS_status GenVCATableEntryCs(RedfishVCATEntry_V1_0_0_VCATEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishVCATEntry_V1_0_0_VCATableEntry_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVCATEntry_V1_0_0_VCATableEntry_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Threshold
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishVCATEntry_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishVCATEntry_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_VCEntries(json_t *CsJson, char *Key, RedfishVCATEntry_V1_0_0_VCATableEntry_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for VCATEntry.V1_0_0.VCATEntry
//
RedfishCS_status CS_To_VCATEntry_V1_0_0_JSON(RedfishVCATEntry_V1_0_0_VCATEntry_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for VCATEntry.V1_0_0.VCATEntry
//
RedfishCS_status DestroyVCATEntry_V1_0_0_CS(RedfishVCATEntry_V1_0_0_VCATEntry_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for VCATEntry.V1_0_0.VCATEntry
//
RedfishCS_status DestroyVCATEntry_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for VCATEntry.V1_0_0.VCATEntry
//
RedfishCS_status
Json_VCATEntry_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishVCATEntry_V1_0_0_VCATEntry_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishVCATEntry_V1_0_0_VCATEntry_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "VCATEntry", "v1_0_0", "VCATEntry", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishVCATEntry_V1_0_0_VCATEntry_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
