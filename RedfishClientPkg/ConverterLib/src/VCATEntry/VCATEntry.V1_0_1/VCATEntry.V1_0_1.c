...
#include"Redfish_VCATEntry_v1_0_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishVCATEntry_V1_0_1_VCATEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishVCATEntry_V1_0_1_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVCATEntry_V1_0_1_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishVCATEntry_V1_0_1_VCATEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishVCATEntry_V1_0_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVCATEntry_V1_0_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishVCATEntry_V1_0_1_VCATEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
//
//Generate C structure for VCEntries
//
static RedfishCS_status GenVCATableEntryCs(RedfishVCATEntry_V1_0_1_VCATEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishVCATEntry_V1_0_1_VCATableEntry_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVCATEntry_V1_0_1_VCATableEntry_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Threshold
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "Threshold", &(*Dst)->Threshold);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // VCMask
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "VCMask", &(*Dst)->VCMask);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishVCATEntry_V1_0_1_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishVCATEntry_V1_0_1_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_VCEntries(json_t *CsJson, char *Key, RedfishVCATEntry_V1_0_1_VCATableEntry_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // Threshold 
  if (InsertJsonStringObj (CsJson, "Threshold", CSPtr->Threshold) != RedfishCS_status_success) {goto Error;}

  // VCMask 
  if (InsertJsonStringObj (CsJson, "VCMask", CSPtr->VCMask) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for VCATEntry.V1_0_1.VCATEntry
//
RedfishCS_status CS_To_VCATEntry_V1_0_1_JSON(RedfishVCATEntry_V1_0_1_VCATEntry_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // RawEntryHex 
  if (InsertJsonStringObj (CsJson, "RawEntryHex", CSPtr->RawEntryHex) != RedfishCS_status_success) {goto Error;}

  // VCEntries
  if (CS_To_JSON_VCEntries(CsJson, "VCEntries", CSPtr->VCEntries) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for VCATEntry.V1_0_1.VCATEntry
//
RedfishCS_status DestroyVCATEntry_V1_0_1_CS(RedfishVCATEntry_V1_0_1_VCATEntry_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for VCATEntry.V1_0_1.VCATEntry
//
RedfishCS_status DestroyVCATEntry_V1_0_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for VCATEntry.V1_0_1.VCATEntry
//
RedfishCS_status
Json_VCATEntry_V1_0_1_To_CS(RedfishCS_char *JsonRawText, RedfishVCATEntry_V1_0_1_VCATEntry_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishVCATEntry_V1_0_1_VCATEntry_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "VCATEntry", "v1_0_1", "VCATEntry", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishVCATEntry_V1_0_1_VCATEntry_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // RawEntryHex
  Status = GetRedfishPropertyStr (Cs, JsonObj, "RawEntryHex", &Cs->RawEntryHex);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // VCEntries
  Status = GenVCATableEntryCs (Cs, JsonObj, "VCEntries", &Cs->VCEntries);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
