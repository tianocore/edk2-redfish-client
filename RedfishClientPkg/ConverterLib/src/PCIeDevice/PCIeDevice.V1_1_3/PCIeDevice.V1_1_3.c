...
#include"Redfish_PCIeDevice_v1_1_3_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishPCIeDevice_V1_1_3_PCIeDevice_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishPCIeDevice_V1_1_3_PCIeDevice_CS *Cs, json_t *JsonObj, char *Key, RedfishPCIeDevice_V1_1_3_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPCIeDevice_V1_1_3_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishPCIeDevice_V1_1_3_PCIeDevice_CS *Cs, json_t *JsonObj, char *Key, RedfishPCIeDevice_V1_1_3_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPCIeDevice_V1_1_3_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishPCIeDevice_V1_1_3_PCIeDevice_CS *Cs, json_t *JsonObj, char *Key, RedfishPCIeDevice_V1_1_3_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPCIeDevice_V1_1_3_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Chassis
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishPCIeDevice_V1_1_3_PCIeDevice_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishPCIeDevice_V1_1_3_PCIeDevice_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishPCIeDevice_V1_1_3_PCIeDevice_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishPCIeDevice_V1_1_3_PCIeDevice_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishPCIeDevice_V1_1_3_PCIeDevice_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishPCIeDevice_V1_1_3_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishPCIeDevice_V1_1_3_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishPCIeDevice_V1_1_3_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for PCIeDevice.V1_1_3.PCIeDevice
//
RedfishCS_status CS_To_PCIeDevice_V1_1_3_JSON(RedfishPCIeDevice_V1_1_3_PCIeDevice_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for PCIeDevice.V1_1_3.PCIeDevice
//
RedfishCS_status DestroyPCIeDevice_V1_1_3_CS(RedfishPCIeDevice_V1_1_3_PCIeDevice_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PCIeDevice.V1_1_3.PCIeDevice
//
RedfishCS_status DestroyPCIeDevice_V1_1_3_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PCIeDevice.V1_1_3.PCIeDevice
//
RedfishCS_status
Json_PCIeDevice_V1_1_3_To_CS(RedfishCS_char *JsonRawText, RedfishPCIeDevice_V1_1_3_PCIeDevice_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPCIeDevice_V1_1_3_PCIeDevice_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PCIeDevice", "v1_1_3", "PCIeDevice", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPCIeDevice_V1_1_3_PCIeDevice_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyPCIeDevice_V1_1_3_CS (Cs);
  return Status;
}
