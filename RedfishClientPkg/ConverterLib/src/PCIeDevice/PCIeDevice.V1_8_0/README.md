# Definition of PCIeDevice.V1_8_0 and functions<br><br>

## Actions
    typedef struct _RedfishPCIeDevice_V1_8_0_Actions_CS {
        RedfishPCIeDevice_V1_8_0_OemActions_CS *Oem;
    } RedfishPCIeDevice_V1_8_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishPCIeDevice_V1_8_0_OemActions_CS| Structure points to **Oem** property.| No| No
...
## PCIeDevice
    typedef struct _RedfishPCIeDevice_V1_8_0_PCIeDevice_CS {
        ...
        RedfishPCIeDevice_V1_8_0_Actions_CS *Actions;
        ...
        RedfishCS_char *Id;
        RedfishPCIeDevice_V1_8_0_Links_CS *Links;
        RedfishCS_char *Manufacturer;
        RedfishCS_char *Model;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishCS_Link PCIeFunctions;
        RedfishPCIeDevice_V1_8_0_PCIeInterface_CS *PCIeInterface;
...
|**Actions**|RedfishPCIeDevice_V1_8_0_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishPCIeDevice_V1_8_0_Links_CS| Structure points to **Links** property.| No| No
|**Manufacturer**|RedfishCS_char| String pointer to **Manufacturer** property.| No| Yes
|**Model**|RedfishCS_char| String pointer to **Model** property.| No| Yes
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**PCIeFunctions**|RedfishCS_Link| Structure link list to **PCIeFunctions** property.| No| Yes
|**PCIeInterface**|RedfishPCIeDevice_V1_8_0_PCIeInterface_CS| Structure points to **PCIeInterface** property.| No| No
...
## Redfish PCIeDevice V1_8_0 to C Structure Function
    RedfishCS_status
    Json_PCIeDevice_V1_8_0_To_CS (RedfishCS_char *JsonRawText, RedfishPCIeDevice_V1_8_0_PCIeDevice_CS **ReturnedCS);

## C Structure to Redfish PCIeDevice V1_8_0 JSON Function
    RedfishCS_status
    CS_To_PCIeDevice_V1_8_0_JSON (RedfishPCIeDevice_V1_8_0_PCIeDevice_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish PCIeDevice V1_8_0 C Structure Function
    RedfishCS_status
