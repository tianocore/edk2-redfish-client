# Definition of MetricReportDefinition.V1_2_0 and functions<br><br>

## Actions
    typedef struct _RedfishMetricReportDefinition_V1_2_0_Actions_CS {
        RedfishMetricReportDefinition_V1_2_0_OemActions_CS *Oem;
    } RedfishMetricReportDefinition_V1_2_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishMetricReportDefinition_V1_2_0_OemActions_CS| Structure points to **Oem** property.| No| No
...
## MetricReportDefinition
    typedef struct _RedfishMetricReportDefinition_V1_2_0_MetricReportDefinition_CS {
        ...
        RedfishMetricReportDefinition_V1_2_0_Actions_CS *Actions;
        RedfishCS_int64 *AppendLimit;
        RedfishCS_char *Description;
        RedfishCS_char *Id;
        RedfishMetricReportDefinition_V1_2_0_Links_CS *Links;
        ...
        RedfishMetricReportDefinition_V1_2_0_Metric_CS *Metrics;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        ...
        RedfishMetricReportDefinition_V1_2_0_Wildcard_CS *Wildcards;
...
|**Actions**|RedfishMetricReportDefinition_V1_2_0_Actions_CS| Structure points to **Actions** property.| No| No
|**AppendLimit**|RedfishCS_int64| 64-bit long long interger pointer to **AppendLimit** property.| No| Yes
|**Description**|RedfishCS_char| String pointer to **Description** property.| No| Yes
|**Id**|RedfishCS_char| String pointer to **Id** property.| Yes| Yes
|**Links**|RedfishMetricReportDefinition_V1_2_0_Links_CS| Structure points to **Links** property.| No| No
...
|**Metrics**|RedfishMetricReportDefinition_V1_2_0_Metric_CS| Structure points to **Metrics** property.| No| No
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
...
|**Wildcards**|RedfishMetricReportDefinition_V1_2_0_Wildcard_CS| Structure points to **Wildcards** property.| No| No
## Redfish MetricReportDefinition V1_2_0 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish MetricReportDefinition V1_2_0 JSON Function
    RedfishCS_status
    CS_To_MetricReportDefinition_V1_2_0_JSON (RedfishMetricReportDefinition_V1_2_0_MetricReportDefinition_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish MetricReportDefinition V1_2_0 C Structure Function
    RedfishCS_status
