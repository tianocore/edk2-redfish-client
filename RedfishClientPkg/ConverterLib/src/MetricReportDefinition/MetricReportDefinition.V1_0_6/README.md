# Definition of MetricReportDefinition.V1_0_6 and functions<br><br>

## Actions
    typedef struct _RedfishMetricReportDefinition_V1_0_6_Actions_CS {
        RedfishMetricReportDefinition_V1_0_6_OemActions_CS *Oem;
    } RedfishMetricReportDefinition_V1_0_6_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishMetricReportDefinition_V1_0_6_OemActions_CS| Structure points to **Oem** property.| No| No
...
## MetricReportDefinition
    typedef struct _RedfishMetricReportDefinition_V1_0_6_MetricReportDefinition_CS {
        ...
        RedfishMetricReportDefinition_V1_0_6_Actions_CS *Actions;
        ...
        RedfishMetricReportDefinition_V1_0_6_Metric_CS *Metrics;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        ...
        RedfishMetricReportDefinition_V1_0_6_Wildcard_CS *Wildcards;
...
|**Actions**|RedfishMetricReportDefinition_V1_0_6_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Metrics**|RedfishMetricReportDefinition_V1_0_6_Metric_CS| Structure points to **Metrics** property.| No| No
...
|**Wildcards**|RedfishMetricReportDefinition_V1_0_6_Wildcard_CS| Structure points to **Wildcards** property.| No| No
## Redfish MetricReportDefinition V1_0_6 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish MetricReportDefinition V1_0_6 JSON Function
    RedfishCS_status
    CS_To_MetricReportDefinition_V1_0_6_JSON (RedfishMetricReportDefinition_V1_0_6_MetricReportDefinition_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish MetricReportDefinition V1_0_6 C Structure Function
    RedfishCS_status
