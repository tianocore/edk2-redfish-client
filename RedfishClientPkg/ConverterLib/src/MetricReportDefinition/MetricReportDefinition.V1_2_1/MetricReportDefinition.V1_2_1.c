...
#include"Redfish_MetricReportDefinition_v1_2_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishMetricReportDefinition_V1_2_1_MetricReportDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenOemCs(RedfishMetricReportDefinition_V1_2_1_MetricReportDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishMetricReportDefinition_V1_2_1_MetricReportDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishMetricReportDefinition_V1_2_1_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMetricReportDefinition_V1_2_1_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishMetricReportDefinition_V1_2_1_MetricReportDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishMetricReportDefinition_V1_2_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMetricReportDefinition_V1_2_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishMetricReportDefinition_V1_2_1_MetricReportDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishMetricReportDefinition_V1_2_1_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMetricReportDefinition_V1_2_1_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenMetric_Array_ElementCs(RedfishMetricReportDefinition_V1_2_1_MetricReportDefinition_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishMetricReportDefinition_V1_2_1_Metric_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishMetricReportDefinition_V1_2_1_Metric_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // CollectionDuration
...
//
//Generate C structure for RedfishMetricReportDefinition_V1_2_1_Metric_Array_CS
//
static RedfishCS_status GenMetric_ArrayCs(RedfishMetricReportDefinition_V1_2_1_MetricReportDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishMetricReportDefinition_V1_2_1_Metric_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishMetricReportDefinition_V1_2_1_Metric_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishMetricReportDefinition_V1_2_1_Metric_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenidRefCs(RedfishMetricReportDefinition_V1_2_1_MetricReportDefinition_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishMetricReportDefinition_V1_2_1_MetricReportDefinition_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishMetricReportDefinition_V1_2_1_MetricReportDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishMetricReportDefinition_V1_2_1_MetricReportDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenWildcard_Array_ElementCs(RedfishMetricReportDefinition_V1_2_1_MetricReportDefinition_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishMetricReportDefinition_V1_2_1_Wildcard_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishMetricReportDefinition_V1_2_1_Wildcard_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Keys
...
//
//Generate C structure for RedfishMetricReportDefinition_V1_2_1_Wildcard_Array_CS
//
static RedfishCS_status GenWildcard_ArrayCs(RedfishMetricReportDefinition_V1_2_1_MetricReportDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishMetricReportDefinition_V1_2_1_Wildcard_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishMetricReportDefinition_V1_2_1_Wildcard_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishMetricReportDefinition_V1_2_1_Wildcard_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishMetricReportDefinition_V1_2_1_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishMetricReportDefinition_V1_2_1_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishMetricReportDefinition_V1_2_1_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Metrics(json_t *CsJson, char *Key, RedfishMetricReportDefinition_V1_2_1_Metric_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishMetricReportDefinition_V1_2_1_Metric_Array_CS *NextArray;
  RedfishMetricReportDefinition_V1_2_1_Metric_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_Wildcards(json_t *CsJson, char *Key, RedfishMetricReportDefinition_V1_2_1_Wildcard_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishMetricReportDefinition_V1_2_1_Wildcard_Array_CS *NextArray;
  RedfishMetricReportDefinition_V1_2_1_Wildcard_CS *NextArrayItem;
...
//
// C structure to JSON for MetricReportDefinition.V1_2_1.MetricReportDefinition
//
RedfishCS_status CS_To_MetricReportDefinition_V1_2_1_JSON(RedfishMetricReportDefinition_V1_2_1_MetricReportDefinition_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for MetricReportDefinition.V1_2_1.MetricReportDefinition
//
RedfishCS_status DestroyMetricReportDefinition_V1_2_1_CS(RedfishMetricReportDefinition_V1_2_1_MetricReportDefinition_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MetricReportDefinition.V1_2_1.MetricReportDefinition
//
RedfishCS_status DestroyMetricReportDefinition_V1_2_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MetricReportDefinition.V1_2_1.MetricReportDefinition
//
RedfishCS_status
Json_MetricReportDefinition_V1_2_1_To_CS(RedfishCS_char *JsonRawText, RedfishMetricReportDefinition_V1_2_1_MetricReportDefinition_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMetricReportDefinition_V1_2_1_MetricReportDefinition_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MetricReportDefinition", "v1_2_1", "MetricReportDefinition", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMetricReportDefinition_V1_2_1_MetricReportDefinition_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyMetricReportDefinition_V1_2_1_CS (Cs);
  return Status;
}
