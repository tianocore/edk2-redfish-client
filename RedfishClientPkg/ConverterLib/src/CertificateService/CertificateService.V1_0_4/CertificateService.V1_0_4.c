...
#include"Redfish_CertificateService_v1_0_4_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenGenerateCSRCs(RedfishCertificateService_V1_0_4_CertificateService_CS *Cs, json_t *JsonObj, char *Key, RedfishCertificateService_V1_0_4_GenerateCSR_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCertificateService_V1_0_4_GenerateCSR_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenReplaceCertificateCs(RedfishCertificateService_V1_0_4_CertificateService_CS *Cs, json_t *JsonObj, char *Key, RedfishCertificateService_V1_0_4_ReplaceCertificate_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCertificateService_V1_0_4_ReplaceCertificate_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishCertificateService_V1_0_4_CertificateService_CS *Cs, json_t *JsonObj, char *Key, RedfishCertificateService_V1_0_4_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCertificateService_V1_0_4_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishCertificateService_V1_0_4_CertificateService_CS *Cs, json_t *JsonObj, char *Key, RedfishCertificateService_V1_0_4_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCertificateService_V1_0_4_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishCertificateService_V1_0_4_CertificateService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsCertificateService_GenerateCSR(json_t *CsJson, char *Key, RedfishCertificateService_V1_0_4_GenerateCSR_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsCertificateService_ReplaceCertificate(json_t *CsJson, char *Key, RedfishCertificateService_V1_0_4_ReplaceCertificate_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishCertificateService_V1_0_4_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishCertificateService_V1_0_4_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for CertificateService.V1_0_4.CertificateService
//
RedfishCS_status CS_To_CertificateService_V1_0_4_JSON(RedfishCertificateService_V1_0_4_CertificateService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for CertificateService.V1_0_4.CertificateService
//
RedfishCS_status DestroyCertificateService_V1_0_4_CS(RedfishCertificateService_V1_0_4_CertificateService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for CertificateService.V1_0_4.CertificateService
//
RedfishCS_status DestroyCertificateService_V1_0_4_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for CertificateService.V1_0_4.CertificateService
//
RedfishCS_status
Json_CertificateService_V1_0_4_To_CS(RedfishCS_char *JsonRawText, RedfishCertificateService_V1_0_4_CertificateService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishCertificateService_V1_0_4_CertificateService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "CertificateService", "v1_0_4", "CertificateService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishCertificateService_V1_0_4_CertificateService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyCertificateService_V1_0_4_CS (Cs);
  return Status;
}
