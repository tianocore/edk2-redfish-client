# Definition of Circuit.V1_2_1 and functions<br><br>
...
## Actions
    typedef struct _RedfishCircuit_V1_2_1_Actions_CS {
        ...
        RedfishCircuit_V1_2_1_OemActions_CS *Oem;
    } RedfishCircuit_V1_2_1_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Circuit_BreakerControl**|RedfishCircuit_V1_2_1_BreakerControl_CS| Structure points to **#Circuit.BreakerControl** property.| No| No
|**Circuit_PowerControl**|RedfishCircuit_V1_2_1_PowerControl_CS| Structure points to **#Circuit.PowerControl** property.| No| No
|**Circuit_ResetMetrics**|RedfishCircuit_V1_2_1_ResetMetrics_CS| Structure points to **#Circuit.ResetMetrics** property.| No| No
|**Oem**|RedfishCircuit_V1_2_1_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Circuit
    typedef struct _RedfishCircuit_V1_2_1_Circuit_CS {
        ...
        RedfishCircuit_V1_2_1_Actions_CS *Actions;
        ...
        RedfishCircuit_V1_2_1_Links_CS *Links;
        ...
        RedfishCircuit_V1_2_1_CurrentSensors_CS *PolyPhaseCurrentAmps;
        RedfishCircuit_V1_2_1_EnergySensors_CS *PolyPhaseEnergykWh;
        RedfishCircuit_V1_2_1_PowerSensors_CS *PolyPhasePowerWatts;
        RedfishCircuit_V1_2_1_VoltageSensors_CS *PolyPhaseVoltage;
...
|**Actions**|RedfishCircuit_V1_2_1_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishCircuit_V1_2_1_Links_CS| Structure points to **Links** property.| No| No
...
|**PolyPhaseCurrentAmps**|RedfishCircuit_V1_2_1_CurrentSensors_CS| Structure points to **PolyPhaseCurrentAmps** property.| No| No
|**PolyPhaseEnergykWh**|RedfishCircuit_V1_2_1_EnergySensors_CS| Structure points to **PolyPhaseEnergykWh** property.| No| No
|**PolyPhasePowerWatts**|RedfishCircuit_V1_2_1_PowerSensors_CS| Structure points to **PolyPhasePowerWatts** property.| No| No
|**PolyPhaseVoltage**|RedfishCircuit_V1_2_1_VoltageSensors_CS| Structure points to **PolyPhaseVoltage** property.| No| No
...
## Redfish Circuit V1_2_1 to C Structure Function
    RedfishCS_status
    Json_Circuit_V1_2_1_To_CS (RedfishCS_char *JsonRawText, RedfishCircuit_V1_2_1_Circuit_CS **ReturnedCS);

## C Structure to Redfish Circuit V1_2_1 JSON Function
    RedfishCS_status
    CS_To_Circuit_V1_2_1_JSON (RedfishCircuit_V1_2_1_Circuit_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Circuit V1_2_1 C Structure Function
    RedfishCS_status
