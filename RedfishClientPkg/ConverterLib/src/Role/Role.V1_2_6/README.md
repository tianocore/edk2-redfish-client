# Definition of Role.V1_2_6 and functions<br><br>
...
## Actions
    typedef struct _RedfishRole_V1_2_6_Actions_CS {
        RedfishRole_V1_2_6_OemActions_CS *Oem;
    } RedfishRole_V1_2_6_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishRole_V1_2_6_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Role
    typedef struct _RedfishRole_V1_2_6_Role_CS {
        ...
        RedfishRole_V1_2_6_Actions_CS *Actions;
...
|**Actions**|RedfishRole_V1_2_6_Actions_CS| Structure points to **Actions** property.| No| No
...
## Redfish Role V1_2_6 to C Structure Function
    RedfishCS_status
    Json_Role_V1_2_6_To_CS (RedfishCS_char *JsonRawText, RedfishRole_V1_2_6_Role_CS **ReturnedCS);

## C Structure to Redfish Role V1_2_6 JSON Function
    RedfishCS_status
    CS_To_Role_V1_2_6_JSON (RedfishRole_V1_2_6_Role_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Role V1_2_6 C Structure Function
    RedfishCS_status
