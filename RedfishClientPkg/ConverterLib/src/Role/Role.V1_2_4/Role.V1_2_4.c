...
#include"Redfish_Role_v1_2_4_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishRole_V1_2_4_Role_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishRole_V1_2_4_Role_CS *Cs, json_t *JsonObj, char *Key, RedfishRole_V1_2_4_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishRole_V1_2_4_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishRole_V1_2_4_Role_CS *Cs, json_t *JsonObj, char *Key, RedfishRole_V1_2_4_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishRole_V1_2_4_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishRole_V1_2_4_Role_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishRole_V1_2_4_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishRole_V1_2_4_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Role.V1_2_4.Role
//
RedfishCS_status CS_To_Role_V1_2_4_JSON(RedfishRole_V1_2_4_Role_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Role.V1_2_4.Role
//
RedfishCS_status DestroyRole_V1_2_4_CS(RedfishRole_V1_2_4_Role_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Role.V1_2_4.Role
//
RedfishCS_status DestroyRole_V1_2_4_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Role.V1_2_4.Role
//
RedfishCS_status
Json_Role_V1_2_4_To_CS(RedfishCS_char *JsonRawText, RedfishRole_V1_2_4_Role_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishRole_V1_2_4_Role_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Role", "v1_2_4", "Role", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishRole_V1_2_4_Role_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
