# Definition of Role.V1_0_3 and functions<br><br>
...
## Redfish Role V1_0_3 to C Structure Function
    RedfishCS_status
    Json_Role_V1_0_3_To_CS (RedfishCS_char *JsonRawText, RedfishRole_V1_0_3_Role_CS **ReturnedCS);

## C Structure to Redfish Role V1_0_3 JSON Function
    RedfishCS_status
    CS_To_Role_V1_0_3_JSON (RedfishRole_V1_0_3_Role_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Role V1_0_3 C Structure Function
    RedfishCS_status
