...
#include"Redfish_Role_v1_0_8_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishRole_V1_0_8_Role_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
...
//
static RedfishCS_status GenOemCs(RedfishRole_V1_0_8_Role_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
...
//
// C structure to JSON for Role.V1_0_8.Role
//
RedfishCS_status CS_To_Role_V1_0_8_JSON(RedfishRole_V1_0_8_Role_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Role.V1_0_8.Role
//
RedfishCS_status DestroyRole_V1_0_8_CS(RedfishRole_V1_0_8_Role_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Role.V1_0_8.Role
//
RedfishCS_status DestroyRole_V1_0_8_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Role.V1_0_8.Role
//
RedfishCS_status
Json_Role_V1_0_8_To_CS(RedfishCS_char *JsonRawText, RedfishRole_V1_0_8_Role_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishRole_V1_0_8_Role_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Role", "v1_0_8", "Role", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishRole_V1_0_8_Role_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
