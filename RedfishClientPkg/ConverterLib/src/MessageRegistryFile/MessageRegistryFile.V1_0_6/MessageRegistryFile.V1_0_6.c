...
#include"Redfish_MessageRegistryFile_v1_0_6_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishMessageRegistryFile_V1_0_6_MessageRegistryFile_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenLocation_Array_ElementCs(RedfishMessageRegistryFile_V1_0_6_MessageRegistryFile_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishMessageRegistryFile_V1_0_6_Location_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishMessageRegistryFile_V1_0_6_Location_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ArchiveFile
...
//
//Generate C structure for RedfishMessageRegistryFile_V1_0_6_Location_Array_CS
//
static RedfishCS_status GenLocation_ArrayCs(RedfishMessageRegistryFile_V1_0_6_MessageRegistryFile_CS *Cs, json_t *JsonObj, char *Key, RedfishMessageRegistryFile_V1_0_6_Location_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishMessageRegistryFile_V1_0_6_Location_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishMessageRegistryFile_V1_0_6_Location_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenOemCs(RedfishMessageRegistryFile_V1_0_6_MessageRegistryFile_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
...
static RedfishCS_status CS_To_JSON_Location(json_t *CsJson, char *Key, RedfishMessageRegistryFile_V1_0_6_Location_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishMessageRegistryFile_V1_0_6_Location_Array_CS *NextArray;
  RedfishMessageRegistryFile_V1_0_6_Location_CS *NextArrayItem;
...
//
// C structure to JSON for MessageRegistryFile.V1_0_6.MessageRegistryFile
//
RedfishCS_status CS_To_MessageRegistryFile_V1_0_6_JSON(RedfishMessageRegistryFile_V1_0_6_MessageRegistryFile_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for MessageRegistryFile.V1_0_6.MessageRegistryFile
//
RedfishCS_status DestroyMessageRegistryFile_V1_0_6_CS(RedfishMessageRegistryFile_V1_0_6_MessageRegistryFile_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MessageRegistryFile.V1_0_6.MessageRegistryFile
//
RedfishCS_status DestroyMessageRegistryFile_V1_0_6_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MessageRegistryFile.V1_0_6.MessageRegistryFile
//
RedfishCS_status
Json_MessageRegistryFile_V1_0_6_To_CS(RedfishCS_char *JsonRawText, RedfishMessageRegistryFile_V1_0_6_MessageRegistryFile_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMessageRegistryFile_V1_0_6_MessageRegistryFile_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MessageRegistryFile", "v1_0_6", "MessageRegistryFile", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMessageRegistryFile_V1_0_6_MessageRegistryFile_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyMessageRegistryFile_V1_0_6_CS (Cs);
  return Status;
}
