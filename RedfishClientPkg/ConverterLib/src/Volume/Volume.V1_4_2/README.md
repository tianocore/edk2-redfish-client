# Definition of Volume.V1_4_2 and functions<br><br>
...
## Actions
    typedef struct _RedfishVolume_V1_4_2_Actions_CS {
        RedfishVolume_V1_4_2_AssignReplicaTarget_CS *Volume_AssignReplicaTarget;
        RedfishVolume_V1_4_2_CheckConsistency_CS *Volume_CheckConsistency;
        RedfishVolume_V1_4_2_CreateReplicaTarget_CS *Volume_CreateReplicaTarget;
        RedfishVolume_V1_4_2_RemoveReplicaRelationship_CS *Volume_RemoveReplicaRelationship;
        RedfishVolume_V1_4_2_ResumeReplication_CS *Volume_ResumeReplication;
        RedfishVolume_V1_4_2_ReverseReplicationRelationship_CS *Volume_ReverseReplicationRelationship;
        RedfishVolume_V1_4_2_SplitReplication_CS *Volume_SplitReplication;
        RedfishVolume_V1_4_2_SuspendReplication_CS *Volume_SuspendReplication;
        RedfishVolume_V1_4_2_OemActions_CS *Oem;
    } RedfishVolume_V1_4_2_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Volume_AssignReplicaTarget**|RedfishVolume_V1_4_2_AssignReplicaTarget_CS| Structure points to **#Volume.AssignReplicaTarget** property.| No| No
|**Volume_CheckConsistency**|RedfishVolume_V1_4_2_CheckConsistency_CS| Structure points to **#Volume.CheckConsistency** property.| No| No
|**Volume_CreateReplicaTarget**|RedfishVolume_V1_4_2_CreateReplicaTarget_CS| Structure points to **#Volume.CreateReplicaTarget** property.| No| No
|**Volume_RemoveReplicaRelationship**|RedfishVolume_V1_4_2_RemoveReplicaRelationship_CS| Structure points to **#Volume.RemoveReplicaRelationship** property.| No| No
|**Volume_ResumeReplication**|RedfishVolume_V1_4_2_ResumeReplication_CS| Structure points to **#Volume.ResumeReplication** property.| No| No
|**Volume_ReverseReplicationRelationship**|RedfishVolume_V1_4_2_ReverseReplicationRelationship_CS| Structure points to **#Volume.ReverseReplicationRelationship** property.| No| No
|**Volume_SplitReplication**|RedfishVolume_V1_4_2_SplitReplication_CS| Structure points to **#Volume.SplitReplication** property.| No| No
|**Volume_SuspendReplication**|RedfishVolume_V1_4_2_SuspendReplication_CS| Structure points to **#Volume.SuspendReplication** property.| No| No
|**Oem**|RedfishVolume_V1_4_2_OemActions_CS| Structure points to **Oem** property.| No| No


## AssignReplicaTarget
    typedef struct _RedfishVolume_V1_4_2_AssignReplicaTarget_CS {
        RedfishCS_char *target;
        RedfishCS_char *title;
    } RedfishVolume_V1_4_2_AssignReplicaTarget_CS;
...
## CheckConsistency
    typedef struct _RedfishVolume_V1_4_2_CheckConsistency_CS {
        RedfishCS_char *target;
        RedfishCS_char *title;
    } RedfishVolume_V1_4_2_CheckConsistency_CS;
...
## CreateReplicaTarget
    typedef struct _RedfishVolume_V1_4_2_CreateReplicaTarget_CS {
        RedfishCS_char *target;
        RedfishCS_char *title;
    } RedfishVolume_V1_4_2_CreateReplicaTarget_CS;
...
## Links
    typedef struct _RedfishVolume_V1_4_2_Links_CS {
...
## OemActions
    typedef struct _RedfishVolume_V1_4_2_OemActions_CS {
        RedfishCS_Link Prop;
    } RedfishVolume_V1_4_2_OemActions_CS;
...
## RemoveReplicaRelationship
    typedef struct _RedfishVolume_V1_4_2_RemoveReplicaRelationship_CS {
        RedfishCS_char *target;
        RedfishCS_char *title;
    } RedfishVolume_V1_4_2_RemoveReplicaRelationship_CS;
...
## ResumeReplication
    typedef struct _RedfishVolume_V1_4_2_ResumeReplication_CS {
        RedfishCS_char *target;
        RedfishCS_char *title;
    } RedfishVolume_V1_4_2_ResumeReplication_CS;
...
## ReverseReplicationRelationship
    typedef struct _RedfishVolume_V1_4_2_ReverseReplicationRelationship_CS {
        RedfishCS_char *target;
        RedfishCS_char *title;
    } RedfishVolume_V1_4_2_ReverseReplicationRelationship_CS;
...
## SplitReplication
    typedef struct _RedfishVolume_V1_4_2_SplitReplication_CS {
        RedfishCS_char *target;
        RedfishCS_char *title;
    } RedfishVolume_V1_4_2_SplitReplication_CS;
...
## SuspendReplication
    typedef struct _RedfishVolume_V1_4_2_SuspendReplication_CS {
        RedfishCS_char *target;
        RedfishCS_char *title;
    } RedfishVolume_V1_4_2_SuspendReplication_CS;
...
## Volume
    typedef struct _RedfishVolume_V1_4_2_Volume_CS {
        ...
        RedfishVolume_V1_4_2_Actions_CS *Actions;
        ...
        RedfishVolume_V1_4_2_Links_CS *Links;
        ...
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishVolume_V1_4_2_Operation_CS *Operations;
    ...
    } RedfishVolume_V1_4_2_Volume_CS;
...
|**Actions**|RedfishVolume_V1_4_2_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishVolume_V1_4_2_Links_CS| Structure points to **Links** property.| No| No
...
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**Operations**|RedfishVolume_V1_4_2_Operation_CS| Structure points to **Operations** property.| No| No
...
## Redfish Volume V1_4_2 to C Structure Function
    RedfishCS_status
    Json_Volume_V1_4_2_To_CS (RedfishCS_char *JsonRawText, RedfishVolume_V1_4_2_Volume_CS **ReturnedCS);

## C Structure to Redfish Volume V1_4_2 JSON Function
    RedfishCS_status
    CS_To_Volume_V1_4_2_JSON (RedfishVolume_V1_4_2_Volume_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Volume V1_4_2 C Structure Function
    RedfishCS_status
    DestroyVolume_V1_4_2_CS (RedfishVolume_V1_4_2_Volume_CS *CSPtr);
