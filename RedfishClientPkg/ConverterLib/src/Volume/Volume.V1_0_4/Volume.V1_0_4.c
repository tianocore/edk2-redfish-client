...
#include"Redfish_Volume_v1_0_4_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishVolume_V1_0_4_Volume_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #Volume.CheckConsistency
//
static RedfishCS_status GenCheckConsistencyCs(RedfishVolume_V1_0_4_Volume_CS *Cs, json_t *JsonObj, char *Key, RedfishVolume_V1_0_4_CheckConsistency_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVolume_V1_0_4_CheckConsistency_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishVolume_V1_0_4_Volume_CS *Cs, json_t *JsonObj, char *Key, RedfishVolume_V1_0_4_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVolume_V1_0_4_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishVolume_V1_0_4_Volume_CS *Cs, json_t *JsonObj, char *Key, RedfishVolume_V1_0_4_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVolume_V1_0_4_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenLinksCs(RedfishVolume_V1_0_4_Volume_CS *Cs, json_t *JsonObj, char *Key, RedfishVolume_V1_0_4_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVolume_V1_0_4_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Drives
...
//
static RedfishCS_status GenOperationCs(RedfishVolume_V1_0_4_Volume_CS *Cs, json_t *JsonObj, char *Key, RedfishVolume_V1_0_4_Operation_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVolume_V1_0_4_Operation_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishVolume_V1_0_4_Volume_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishVolume_V1_0_4_Volume_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishVolume_V1_0_4_Volume_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishVolume_V1_0_4_Volume_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishVolume_V1_0_4_Volume_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishVolume_V1_0_4_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsVolume_CheckConsistency(json_t *CsJson, char *Key, RedfishVolume_V1_0_4_CheckConsistency_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishVolume_V1_0_4_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishVolume_V1_0_4_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Operations(json_t *CsJson, char *Key, RedfishVolume_V1_0_4_Operation_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Volume.V1_0_4.Volume
//
RedfishCS_status CS_To_Volume_V1_0_4_JSON(RedfishVolume_V1_0_4_Volume_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Volume.V1_0_4.Volume
//
RedfishCS_status DestroyVolume_V1_0_4_CS(RedfishVolume_V1_0_4_Volume_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Volume.V1_0_4.Volume
//
RedfishCS_status DestroyVolume_V1_0_4_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Volume.V1_0_4.Volume
//
RedfishCS_status
Json_Volume_V1_0_4_To_CS(RedfishCS_char *JsonRawText, RedfishVolume_V1_0_4_Volume_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishVolume_V1_0_4_Volume_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Volume", "v1_0_4", "Volume", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishVolume_V1_0_4_Volume_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
