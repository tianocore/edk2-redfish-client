# Definition of Volume.V1_0_4 and functions<br><br>
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Volume_CheckConsistency**|RedfishVolume_V1_0_4_CheckConsistency_CS| Structure points to **#Volume.CheckConsistency** property.| No| No
|**Oem**|RedfishVolume_V1_0_4_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Volume
    typedef struct _RedfishVolume_V1_0_4_Volume_CS {
        ...
        RedfishVolume_V1_0_4_Actions_CS *Actions;
        ...
        RedfishVolume_V1_0_4_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishVolume_V1_0_4_Operation_CS *Operations;
...
|**Actions**|RedfishVolume_V1_0_4_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishVolume_V1_0_4_Links_CS| Structure points to **Links** property.| No| No
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**Operations**|RedfishVolume_V1_0_4_Operation_CS| Structure points to **Operations** property.| No| No
...
## Redfish Volume V1_0_4 to C Structure Function
    RedfishCS_status
    Json_Volume_V1_0_4_To_CS (RedfishCS_char *JsonRawText, RedfishVolume_V1_0_4_Volume_CS **ReturnedCS);

## C Structure to Redfish Volume V1_0_4 JSON Function
    RedfishCS_status
    CS_To_Volume_V1_0_4_JSON (RedfishVolume_V1_0_4_Volume_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Volume V1_0_4 C Structure Function
    RedfishCS_status
