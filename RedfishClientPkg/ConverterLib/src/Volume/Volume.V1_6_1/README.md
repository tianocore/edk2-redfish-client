# Definition of Volume.V1_6_1 and functions<br><br>
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Volume_AssignReplicaTarget**|RedfishVolume_V1_6_1_AssignReplicaTarget_CS| Structure points to **#Volume.AssignReplicaTarget** property.| No| No
|**Volume_ChangeRAIDLayout**|RedfishVolume_V1_6_1_ChangeRAIDLayout_CS| Structure points to **#Volume.ChangeRAIDLayout** property.| No| No
|**Volume_CheckConsistency**|RedfishVolume_V1_6_1_CheckConsistency_CS| Structure points to **#Volume.CheckConsistency** property.| No| No
|**Volume_CreateReplicaTarget**|RedfishVolume_V1_6_1_CreateReplicaTarget_CS| Structure points to **#Volume.CreateReplicaTarget** property.| No| No
|**Volume_ForceEnable**|RedfishVolume_V1_6_1_ForceEnable_CS| Structure points to **#Volume.ForceEnable** property.| No| No
|**Volume_Initialize**|RedfishVolume_V1_6_1_Initialize_CS| Structure points to **#Volume.Initialize** property.| No| No
|**Volume_RemoveReplicaRelationship**|RedfishVolume_V1_6_1_RemoveReplicaRelationship_CS| Structure points to **#Volume.RemoveReplicaRelationship** property.| No| No
|**Volume_ResumeReplication**|RedfishVolume_V1_6_1_ResumeReplication_CS| Structure points to **#Volume.ResumeReplication** property.| No| No
|**Volume_ReverseReplicationRelationship**|RedfishVolume_V1_6_1_ReverseReplicationRelationship_CS| Structure points to **#Volume.ReverseReplicationRelationship** property.| No| No
|**Volume_SplitReplication**|RedfishVolume_V1_6_1_SplitReplication_CS| Structure points to **#Volume.SplitReplication** property.| No| No
|**Volume_SuspendReplication**|RedfishVolume_V1_6_1_SuspendReplication_CS| Structure points to **#Volume.SuspendReplication** property.| No| No
|**Oem**|RedfishVolume_V1_6_1_OemActions_CS| Structure points to **Oem** property.| No| No
...
## NVMeNamespaceProperties
    typedef struct _RedfishVolume_V1_6_1_NVMeNamespaceProperties_CS {
        ...
        RedfishVolume_V1_6_1_NamespaceFeatures_CS *NamespaceFeatures;
...
|**NamespaceFeatures**|RedfishVolume_V1_6_1_NamespaceFeatures_CS| Structure points to **NamespaceFeatures** property.| No| No
...
## Volume
    typedef struct _RedfishVolume_V1_6_1_Volume_CS {
        ...
        RedfishVolume_V1_6_1_Actions_CS *Actions;
        ...
        RedfishVolume_V1_6_1_Links_CS *Links;
        ...
        RedfishVolume_V1_6_1_NVMeNamespaceProperties_CS *NVMeNamespaceProperties;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishVolume_V1_6_1_Operation_CS *Operations;
...
|**Actions**|RedfishVolume_V1_6_1_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishVolume_V1_6_1_Links_CS| Structure points to **Links** property.| No| No
...
|**NVMeNamespaceProperties**|RedfishVolume_V1_6_1_NVMeNamespaceProperties_CS| Structure points to **NVMeNamespaceProperties** property.| No| No
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**Operations**|RedfishVolume_V1_6_1_Operation_CS| Structure points to **Operations** property.| No| No
...
## Redfish Volume V1_6_1 to C Structure Function
    RedfishCS_status
    Json_Volume_V1_6_1_To_CS (RedfishCS_char *JsonRawText, RedfishVolume_V1_6_1_Volume_CS **ReturnedCS);

## C Structure to Redfish Volume V1_6_1 JSON Function
    RedfishCS_status
    CS_To_Volume_V1_6_1_JSON (RedfishVolume_V1_6_1_Volume_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Volume V1_6_1 C Structure Function
    RedfishCS_status
