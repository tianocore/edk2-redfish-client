...
#include"Redfish_TaskService_v1_2_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishTaskService_V1_2_0_TaskService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishTaskService_V1_2_0_TaskService_CS *Cs, json_t *JsonObj, char *Key, RedfishTaskService_V1_2_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTaskService_V1_2_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishTaskService_V1_2_0_TaskService_CS *Cs, json_t *JsonObj, char *Key, RedfishTaskService_V1_2_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTaskService_V1_2_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishTaskService_V1_2_0_TaskService_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishTaskService_V1_2_0_TaskService_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishTaskService_V1_2_0_TaskService_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishTaskService_V1_2_0_TaskService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishTaskService_V1_2_0_TaskService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishTaskService_V1_2_0_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishTaskService_V1_2_0_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
//
// C structure to JSON for TaskService.V1_2_0.TaskService
//
RedfishCS_status CS_To_TaskService_V1_2_0_JSON(RedfishTaskService_V1_2_0_TaskService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  if (InsertJsonInt64Obj (CsJson, "TaskAutoDeleteTimeoutMinutes", CSPtr->TaskAutoDeleteTimeoutMinutes) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for TaskService.V1_2_0.TaskService
//
RedfishCS_status DestroyTaskService_V1_2_0_CS(RedfishTaskService_V1_2_0_TaskService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for TaskService.V1_2_0.TaskService
//
RedfishCS_status DestroyTaskService_V1_2_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for TaskService.V1_2_0.TaskService
//
RedfishCS_status
Json_TaskService_V1_2_0_To_CS(RedfishCS_char *JsonRawText, RedfishTaskService_V1_2_0_TaskService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishTaskService_V1_2_0_TaskService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "TaskService", "v1_2_0", "TaskService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishTaskService_V1_2_0_TaskService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // TaskAutoDeleteTimeoutMinutes
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "TaskAutoDeleteTimeoutMinutes", &Cs->TaskAutoDeleteTimeoutMinutes);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyTaskService_V1_2_0_CS (Cs);
  return Status;
}
