...
#include"Redfish_TaskService_v1_0_6_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishTaskService_V1_0_6_TaskService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishTaskService_V1_0_6_TaskService_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishTaskService_V1_0_6_TaskService_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishTaskService_V1_0_6_TaskService_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishTaskService_V1_0_6_TaskService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishTaskService_V1_0_6_TaskService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
// C structure to JSON for TaskService.V1_0_6.TaskService
//
RedfishCS_status CS_To_TaskService_V1_0_6_JSON(RedfishTaskService_V1_0_6_TaskService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for TaskService.V1_0_6.TaskService
//
RedfishCS_status DestroyTaskService_V1_0_6_CS(RedfishTaskService_V1_0_6_TaskService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for TaskService.V1_0_6.TaskService
//
RedfishCS_status DestroyTaskService_V1_0_6_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for TaskService.V1_0_6.TaskService
//
RedfishCS_status
Json_TaskService_V1_0_6_To_CS(RedfishCS_char *JsonRawText, RedfishTaskService_V1_0_6_TaskService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishTaskService_V1_0_6_TaskService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "TaskService", "v1_0_6", "TaskService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishTaskService_V1_0_6_TaskService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyTaskService_V1_0_6_CS (Cs);
  return Status;
}
