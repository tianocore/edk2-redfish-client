# Definition of TaskService.V1_1_6 and functions<br><br>
...
## Actions
    typedef struct _RedfishTaskService_V1_1_6_Actions_CS {
        RedfishTaskService_V1_1_6_OemActions_CS *Oem;
    } RedfishTaskService_V1_1_6_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishTaskService_V1_1_6_OemActions_CS| Structure points to **Oem** property.| No| No
...
## TaskService
    typedef struct _RedfishTaskService_V1_1_6_TaskService_CS {
        ...
        RedfishTaskService_V1_1_6_Actions_CS *Actions;
...
|**Actions**|RedfishTaskService_V1_1_6_Actions_CS| Structure points to **Actions** property.| No| No
...
## Redfish TaskService V1_1_6 to C Structure Function
    RedfishCS_status
    Json_TaskService_V1_1_6_To_CS (RedfishCS_char *JsonRawText, RedfishTaskService_V1_1_6_TaskService_CS **ReturnedCS);

## C Structure to Redfish TaskService V1_1_6 JSON Function
    RedfishCS_status
    CS_To_TaskService_V1_1_6_JSON (RedfishTaskService_V1_1_6_TaskService_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish TaskService V1_1_6 C Structure Function
    RedfishCS_status
