...
#include"Redfish_OutletGroup_v1_1_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishOutletGroup_V1_1_0_OutletGroup_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #OutletGroup.PowerControl
//
static RedfishCS_status GenPowerControlCs(RedfishOutletGroup_V1_1_0_OutletGroup_CS *Cs, json_t *JsonObj, char *Key, RedfishOutletGroup_V1_1_0_PowerControl_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishOutletGroup_V1_1_0_PowerControl_CS), (RedfishCS_void **)Dst);
...
//
//Generate C structure for #OutletGroup.ResetMetrics
//
static RedfishCS_status GenResetMetricsCs(RedfishOutletGroup_V1_1_0_OutletGroup_CS *Cs, json_t *JsonObj, char *Key, RedfishOutletGroup_V1_1_0_ResetMetrics_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishOutletGroup_V1_1_0_ResetMetrics_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishOutletGroup_V1_1_0_OutletGroup_CS *Cs, json_t *JsonObj, char *Key, RedfishOutletGroup_V1_1_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishOutletGroup_V1_1_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishOutletGroup_V1_1_0_OutletGroup_CS *Cs, json_t *JsonObj, char *Key, RedfishOutletGroup_V1_1_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishOutletGroup_V1_1_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #OutletGroup.PowerControl
  Status = GenPowerControlCs (Cs, TempJsonObj, "#OutletGroup.PowerControl", &(*Dst)->OutletGroup_PowerControl);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // #OutletGroup.ResetMetrics
  Status = GenResetMetricsCs (Cs, TempJsonObj, "#OutletGroup.ResetMetrics", &(*Dst)->OutletGroup_ResetMetrics);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenLinksCs(RedfishOutletGroup_V1_1_0_OutletGroup_CS *Cs, json_t *JsonObj, char *Key, RedfishOutletGroup_V1_1_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishOutletGroup_V1_1_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishOutletGroup_V1_1_0_OutletGroup_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishOutletGroup_V1_1_0_OutletGroup_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishOutletGroup_V1_1_0_OutletGroup_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishOutletGroup_V1_1_0_OutletGroup_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishOutletGroup_V1_1_0_OutletGroup_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishOutletGroup_V1_1_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOutletGroup_PowerControl(json_t *CsJson, char *Key, RedfishOutletGroup_V1_1_0_PowerControl_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOutletGroup_ResetMetrics(json_t *CsJson, char *Key, RedfishOutletGroup_V1_1_0_ResetMetrics_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishOutletGroup_V1_1_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // #OutletGroup.PowerControl
  if (CS_To_JSON_ActionsOutletGroup_PowerControl(CsJson, "#OutletGroup.PowerControl", CSPtr->OutletGroup_PowerControl) != RedfishCS_status_success) {goto Error;}

  // #OutletGroup.ResetMetrics
  if (CS_To_JSON_ActionsOutletGroup_ResetMetrics(CsJson, "#OutletGroup.ResetMetrics", CSPtr->OutletGroup_ResetMetrics) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishOutletGroup_V1_1_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for OutletGroup.V1_1_0.OutletGroup
//
RedfishCS_status CS_To_OutletGroup_V1_1_0_JSON(RedfishOutletGroup_V1_1_0_OutletGroup_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for OutletGroup.V1_1_0.OutletGroup
//
RedfishCS_status DestroyOutletGroup_V1_1_0_CS(RedfishOutletGroup_V1_1_0_OutletGroup_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for OutletGroup.V1_1_0.OutletGroup
//
RedfishCS_status DestroyOutletGroup_V1_1_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for OutletGroup.V1_1_0.OutletGroup
//
RedfishCS_status
Json_OutletGroup_V1_1_0_To_CS(RedfishCS_char *JsonRawText, RedfishOutletGroup_V1_1_0_OutletGroup_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishOutletGroup_V1_1_0_OutletGroup_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "OutletGroup", "v1_1_0", "OutletGroup", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishOutletGroup_V1_1_0_OutletGroup_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyOutletGroup_V1_1_0_CS (Cs);
  return Status;
}
