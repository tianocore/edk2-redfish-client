...
#include"Redfish_Fan_v1_0_2_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishFan_V1_0_2_Fan_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishFan_V1_0_2_Fan_CS *Cs, json_t *JsonObj, char *Key, RedfishFan_V1_0_2_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishFan_V1_0_2_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishFan_V1_0_2_Fan_CS *Cs, json_t *JsonObj, char *Key, RedfishFan_V1_0_2_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishFan_V1_0_2_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishFan_V1_0_2_Fan_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishFan_V1_0_2_Fan_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishFan_V1_0_2_Fan_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishFan_V1_0_2_Fan_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishFan_V1_0_2_Fan_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishFan_V1_0_2_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishFan_V1_0_2_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Fan.V1_0_2.Fan
//
RedfishCS_status CS_To_Fan_V1_0_2_JSON(RedfishFan_V1_0_2_Fan_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Fan.V1_0_2.Fan
//
RedfishCS_status DestroyFan_V1_0_2_CS(RedfishFan_V1_0_2_Fan_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Fan.V1_0_2.Fan
//
RedfishCS_status DestroyFan_V1_0_2_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Fan.V1_0_2.Fan
//
RedfishCS_status
Json_Fan_V1_0_2_To_CS(RedfishCS_char *JsonRawText, RedfishFan_V1_0_2_Fan_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishFan_V1_0_2_Fan_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Fan", "v1_0_2", "Fan", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishFan_V1_0_2_Fan_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
