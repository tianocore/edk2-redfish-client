...
#include"Redfish_ServiceConditions_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishServiceConditions_V1_0_0_ServiceConditions_CS *Cs, json_t *JsonObj, char *Key, RedfishServiceConditions_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishServiceConditions_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishServiceConditions_V1_0_0_ServiceConditions_CS *Cs, json_t *JsonObj, char *Key, RedfishServiceConditions_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishServiceConditions_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishServiceConditions_V1_0_0_ServiceConditions_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishServiceConditions_V1_0_0_ServiceConditions_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishServiceConditions_V1_0_0_ServiceConditions_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishServiceConditions_V1_0_0_ServiceConditions_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishServiceConditions_V1_0_0_ServiceConditions_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishServiceConditions_V1_0_0_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishServiceConditions_V1_0_0_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ConditionsOriginOfCondition(json_t *CsJson, char *Key, Redfishodatav4_idRef_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Conditions(json_t *CsJson, char *Key, RedfishResource_Condition_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  ...
  do {
    ...
    // OriginOfCondition
    if (CS_To_JSON_ConditionsOriginOfCondition(ArrayMember, "OriginOfCondition", NextArrayItem->OriginOfCondition) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for ServiceConditions.V1_0_0.ServiceConditions
//
RedfishCS_status CS_To_ServiceConditions_V1_0_0_JSON(RedfishServiceConditions_V1_0_0_ServiceConditions_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // Conditions
  if (CS_To_JSON_Conditions(CsJson, "Conditions", CSPtr->Conditions) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for ServiceConditions.V1_0_0.ServiceConditions
//
RedfishCS_status DestroyServiceConditions_V1_0_0_CS(RedfishServiceConditions_V1_0_0_ServiceConditions_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ServiceConditions.V1_0_0.ServiceConditions
//
RedfishCS_status DestroyServiceConditions_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ServiceConditions.V1_0_0.ServiceConditions
//
RedfishCS_status
Json_ServiceConditions_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishServiceConditions_V1_0_0_ServiceConditions_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishServiceConditions_V1_0_0_ServiceConditions_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ServiceConditions", "v1_0_0", "ServiceConditions", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishServiceConditions_V1_0_0_ServiceConditions_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // Conditions
  Status = GenCondition_ArrayCs (Cs, JsonObj, "Conditions", &Cs->Conditions);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // HealthRollup
  Status = GetRedfishPropertyStr (Cs, JsonObj, "HealthRollup", &Cs->HealthRollup);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyServiceConditions_V1_0_0_CS (Cs);
  return Status;
}
