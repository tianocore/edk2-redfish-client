...
#include"Redfish_GraphicsController_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishGraphicsController_V1_0_0_GraphicsController_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishGraphicsController_V1_0_0_GraphicsController_CS *Cs, json_t *JsonObj, char *Key, RedfishGraphicsController_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishGraphicsController_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishGraphicsController_V1_0_0_GraphicsController_CS *Cs, json_t *JsonObj, char *Key, RedfishGraphicsController_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishGraphicsController_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishGraphicsController_V1_0_0_GraphicsController_CS *Cs, json_t *JsonObj, char *Key, RedfishGraphicsController_V1_0_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishGraphicsController_V1_0_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishGraphicsController_V1_0_0_GraphicsController_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishGraphicsController_V1_0_0_GraphicsController_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishGraphicsController_V1_0_0_GraphicsController_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishGraphicsController_V1_0_0_GraphicsController_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishGraphicsController_V1_0_0_GraphicsController_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishGraphicsController_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishGraphicsController_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishGraphicsController_V1_0_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for GraphicsController.V1_0_0.GraphicsController
//
RedfishCS_status CS_To_GraphicsController_V1_0_0_JSON(RedfishGraphicsController_V1_0_0_GraphicsController_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // DriverVersion 
  if (InsertJsonStringObj (CsJson, "DriverVersion", CSPtr->DriverVersion) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for GraphicsController.V1_0_0.GraphicsController
//
RedfishCS_status DestroyGraphicsController_V1_0_0_CS(RedfishGraphicsController_V1_0_0_GraphicsController_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for GraphicsController.V1_0_0.GraphicsController
//
RedfishCS_status DestroyGraphicsController_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for GraphicsController.V1_0_0.GraphicsController
//
RedfishCS_status
Json_GraphicsController_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishGraphicsController_V1_0_0_GraphicsController_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishGraphicsController_V1_0_0_GraphicsController_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "GraphicsController", "v1_0_0", "GraphicsController", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishGraphicsController_V1_0_0_GraphicsController_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // DriverVersion
  Status = GetRedfishPropertyStr (Cs, JsonObj, "DriverVersion", &Cs->DriverVersion);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyGraphicsController_V1_0_0_CS (Cs);
  return Status;
}
