...
#include"Redfish_StorageController_v1_4_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishStorageController_V1_4_0_StorageController_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenStatusCs(RedfishStorageController_V1_4_0_StorageController_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishStorageController_V1_4_0_StorageController_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishStorageController_V1_4_0_StorageController_CS *Cs, json_t *JsonObj, char *Key, RedfishStorageController_V1_4_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorageController_V1_4_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishStorageController_V1_4_0_StorageController_CS *Cs, json_t *JsonObj, char *Key, RedfishStorageController_V1_4_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorageController_V1_4_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenidRefCs(RedfishStorageController_V1_4_0_StorageController_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishStorageController_V1_4_0_StorageController_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishStorageController_V1_4_0_StorageController_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenCacheSummaryCs(RedfishStorageController_V1_4_0_StorageController_CS *Cs, json_t *JsonObj, char *Key, RedfishStorageController_V1_4_0_CacheSummary_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorageController_V1_4_0_CacheSummary_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenRatesCs(RedfishStorageController_V1_4_0_StorageController_CS *Cs, json_t *JsonObj, char *Key, RedfishStorageController_V1_4_0_Rates_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorageController_V1_4_0_Rates_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenLinksCs(RedfishStorageController_V1_4_0_StorageController_CS *Cs, json_t *JsonObj, char *Key, RedfishStorageController_V1_4_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorageController_V1_4_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AttachedVolumes
...
static RedfishCS_status GenANACharacteristics_Array_ElementCs(RedfishStorageController_V1_4_0_StorageController_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishStorageController_V1_4_0_ANACharacteristics_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishStorageController_V1_4_0_ANACharacteristics_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AccessState
...
//
//Generate C structure for RedfishStorageController_V1_4_0_ANACharacteristics_Array_CS
//
static RedfishCS_status GenANACharacteristics_ArrayCs(RedfishStorageController_V1_4_0_StorageController_CS *Cs, json_t *JsonObj, char *Key, RedfishStorageController_V1_4_0_ANACharacteristics_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishStorageController_V1_4_0_ANACharacteristics_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishStorageController_V1_4_0_ANACharacteristics_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenNVMeControllerAttributesCs(RedfishStorageController_V1_4_0_StorageController_CS *Cs, json_t *JsonObj, char *Key, RedfishStorageController_V1_4_0_NVMeControllerAttributes_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorageController_V1_4_0_NVMeControllerAttributes_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  ...
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "SupportsReservations", &(*Dst)->SupportsReservations);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenNVMeSMARTCriticalWarningsCs(RedfishStorageController_V1_4_0_StorageController_CS *Cs, json_t *JsonObj, char *Key, RedfishStorageController_V1_4_0_NVMeSMARTCriticalWarnings_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorageController_V1_4_0_NVMeSMARTCriticalWarnings_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MediaInReadOnly
...
//
static RedfishCS_status GenNVMeControllerPropertiesCs(RedfishStorageController_V1_4_0_StorageController_CS *Cs, json_t *JsonObj, char *Key, RedfishStorageController_V1_4_0_NVMeControllerProperties_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorageController_V1_4_0_NVMeControllerProperties_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ANACharacteristics
  ...
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "AllocatedCompletionQueues", &(*Dst)->AllocatedCompletionQueues);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // AllocatedSubmissionQueues
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "AllocatedSubmissionQueues", &(*Dst)->AllocatedSubmissionQueues);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishStorageController_V1_4_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishStorageController_V1_4_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_CacheSummary(json_t *CsJson, char *Key, RedfishStorageController_V1_4_0_CacheSummary_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ControllerRates(json_t *CsJson, char *Key, RedfishStorageController_V1_4_0_Rates_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishStorageController_V1_4_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_NVMeControllerPropertiesANACharacteristics(json_t *CsJson, char *Key, RedfishStorageController_V1_4_0_ANACharacteristics_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishStorageController_V1_4_0_ANACharacteristics_Array_CS *NextArray;
  RedfishStorageController_V1_4_0_ANACharacteristics_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_NVMeControllerPropertiesNVMeControllerAttributes(json_t *CsJson, char *Key, RedfishStorageController_V1_4_0_NVMeControllerAttributes_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // SupportsReservations 
  if (InsertJsonBoolObj (CsJson, "SupportsReservations", CSPtr->SupportsReservations) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_NVMeControllerPropertiesNVMeSMARTCriticalWarnings(json_t *CsJson, char *Key, RedfishStorageController_V1_4_0_NVMeSMARTCriticalWarnings_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_NVMeControllerProperties(json_t *CsJson, char *Key, RedfishStorageController_V1_4_0_NVMeControllerProperties_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // AllocatedCompletionQueues 
  if (InsertJsonInt64Obj (CsJson, "AllocatedCompletionQueues", CSPtr->AllocatedCompletionQueues) != RedfishCS_status_success) {goto Error;}

  // AllocatedSubmissionQueues 
  if (InsertJsonInt64Obj (CsJson, "AllocatedSubmissionQueues", CSPtr->AllocatedSubmissionQueues) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for StorageController.V1_4_0.StorageController
//
RedfishCS_status CS_To_StorageController_V1_4_0_JSON(RedfishStorageController_V1_4_0_StorageController_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for StorageController.V1_4_0.StorageController
//
RedfishCS_status DestroyStorageController_V1_4_0_CS(RedfishStorageController_V1_4_0_StorageController_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for StorageController.V1_4_0.StorageController
//
RedfishCS_status DestroyStorageController_V1_4_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for StorageController.V1_4_0.StorageController
//
RedfishCS_status
Json_StorageController_V1_4_0_To_CS(RedfishCS_char *JsonRawText, RedfishStorageController_V1_4_0_StorageController_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishStorageController_V1_4_0_StorageController_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "StorageController", "v1_4_0", "StorageController", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishStorageController_V1_4_0_StorageController_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyStorageController_V1_4_0_CS (Cs);
  return Status;
}
