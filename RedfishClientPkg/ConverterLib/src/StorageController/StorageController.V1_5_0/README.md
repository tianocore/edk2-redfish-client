# Definition of StorageController.V1_5_0 and functions<br><br>
...
## Actions
    typedef struct _RedfishStorageController_V1_5_0_Actions_CS {
        RedfishStorageController_V1_5_0_OemActions_CS *Oem;
    } RedfishStorageController_V1_5_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishStorageController_V1_5_0_OemActions_CS| Structure points to **Oem** property.| No| No
...
## NVMeControllerProperties
    typedef struct _RedfishStorageController_V1_5_0_NVMeControllerProperties_CS {
        RedfishStorageController_V1_5_0_ANACharacteristics_Array_CS *ANACharacteristics;
        ...
        RedfishStorageController_V1_5_0_NVMeControllerAttributes_CS *NVMeControllerAttributes;
        RedfishStorageController_V1_5_0_NVMeSMARTCriticalWarnings_CS *NVMeSMARTCriticalWarnings;
        RedfishCS_char *NVMeVersion;
    } RedfishStorageController_V1_5_0_NVMeControllerProperties_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**ANACharacteristics**|RedfishStorageController_V1_5_0_ANACharacteristics_Array_CS| Structure array points to one or more than one **RedfishStorageController_V1_5_0_ANACharacteristics_Array_CS** structures for property **ANACharacteristics**.| No| No
...
|**NVMeControllerAttributes**|RedfishStorageController_V1_5_0_NVMeControllerAttributes_CS| Structure points to **NVMeControllerAttributes** property.| No| No
|**NVMeSMARTCriticalWarnings**|RedfishStorageController_V1_5_0_NVMeSMARTCriticalWarnings_CS| Structure points to **NVMeSMARTCriticalWarnings** property.| No| No
...
## StorageController
    typedef struct _RedfishStorageController_V1_5_0_StorageController_CS {
        ...
        RedfishStorageController_V1_5_0_Actions_CS *Actions;
        RedfishCS_Link Assembly;
        RedfishCS_char *AssetTag;
        RedfishStorageController_V1_5_0_CacheSummary_CS *CacheSummary;
        RedfishCS_Link Certificates;
        RedfishStorageController_V1_5_0_Rates_CS *ControllerRates;
        RedfishCS_char *Description;
        RedfishCS_Link EnvironmentMetrics;
        RedfishCS_char *FirmwareVersion;
        RedfishCS_char *Id;
        RedfishCS_Link Identifiers;
        RedfishStorageController_V1_5_0_Links_CS *Links;
        RedfishCS_Link Location;
        RedfishCS_char *Manufacturer;
        RedfishCS_Link Measurements;
        RedfishCS_char *Model;
        RedfishStorageController_V1_5_0_NVMeControllerProperties_CS *NVMeControllerProperties;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
...
|**Actions**|RedfishStorageController_V1_5_0_Actions_CS| Structure points to **Actions** property.| No| No
|**Assembly**|RedfishCS_Link| Structure link list to **Assembly** property.| No| Yes
|**AssetTag**|RedfishCS_char| String pointer to **AssetTag** property.| No| No
|**CacheSummary**|RedfishStorageController_V1_5_0_CacheSummary_CS| Structure points to **CacheSummary** property.| No| No
|**Certificates**|RedfishCS_Link| Structure link list to **Certificates** property.| No| Yes
|**ControllerRates**|RedfishStorageController_V1_5_0_Rates_CS| Structure points to **ControllerRates** property.| No| No
...
|**Links**|RedfishStorageController_V1_5_0_Links_CS| Structure points to **Links** property.| No| No
|**Location**|RedfishCS_Link| Structure link list to **Location** property.| No| No
|**Manufacturer**|RedfishCS_char| String pointer to **Manufacturer** property.| No| Yes
|**Measurements**|RedfishCS_Link| Structure link list to **Measurements** property.| No| No
|**Model**|RedfishCS_char| String pointer to **Model** property.| No| Yes
|**NVMeControllerProperties**|RedfishStorageController_V1_5_0_NVMeControllerProperties_CS| Structure points to **NVMeControllerProperties** property.| No| No
...
## Redfish StorageController V1_5_0 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish StorageController V1_5_0 JSON Function
    RedfishCS_status
    CS_To_StorageController_V1_5_0_JSON (RedfishStorageController_V1_5_0_StorageController_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish StorageController V1_5_0 C Structure Function
    RedfishCS_status
