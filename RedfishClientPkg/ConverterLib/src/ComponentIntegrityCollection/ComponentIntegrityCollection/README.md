# Definition of ComponentIntegrityCollection and functions<br><br>
...
## Redfish ComponentIntegrityCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish ComponentIntegrityCollection  JSON Function
    RedfishCS_status
    CS_To_ComponentIntegrityCollection_JSON (RedfishComponentIntegrityCollection_ComponentIntegrityCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ComponentIntegrityCollection  C Structure Function
    RedfishCS_status
