...
#include"Redfish_ComponentIntegrityCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishComponentIntegrityCollection_ComponentIntegrityCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for ComponentIntegrityCollection.ComponentIntegrityCollection
//
RedfishCS_status CS_To_ComponentIntegrityCollection_JSON(RedfishComponentIntegrityCollection_ComponentIntegrityCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ComponentIntegrityCollection.ComponentIntegrityCollection
//
RedfishCS_status DestroyComponentIntegrityCollection_CS(RedfishComponentIntegrityCollection_ComponentIntegrityCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ComponentIntegrityCollection.ComponentIntegrityCollection
//
RedfishCS_status DestroyComponentIntegrityCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ComponentIntegrityCollection.NOVERSIONED.ComponentIntegrityCollection
//
RedfishCS_status
Json_ComponentIntegrityCollection_To_CS(RedfishCS_char *JsonRawText, RedfishComponentIntegrityCollection_ComponentIntegrityCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishComponentIntegrityCollection_ComponentIntegrityCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ComponentIntegrityCollection", "noversioned", "ComponentIntegrityCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishComponentIntegrityCollection_ComponentIntegrityCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyComponentIntegrityCollection_CS (Cs);
  return Status;
}
