...
#include"Redfish_AttributeRegistry_v1_0_8_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
static RedfishCS_status GenAttributeValue_Array_ElementCs(RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishAttributeRegistry_V1_0_8_AttributeValue_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishAttributeRegistry_V1_0_8_AttributeValue_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ValueDisplayName
...
//
//Generate C structure for RedfishAttributeRegistry_V1_0_8_AttributeValue_Array_CS
//
static RedfishCS_status GenAttributeValue_ArrayCs(RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishAttributeRegistry_V1_0_8_AttributeValue_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishAttributeRegistry_V1_0_8_AttributeValue_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishAttributeRegistry_V1_0_8_AttributeValue_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenAttributes_Array_ElementCs(RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishAttributeRegistry_V1_0_8_Attributes_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishAttributeRegistry_V1_0_8_Attributes_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AttributeName
...
//
//Generate C structure for RedfishAttributeRegistry_V1_0_8_Attributes_Array_CS
//
static RedfishCS_status GenAttributes_ArrayCs(RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishAttributeRegistry_V1_0_8_Attributes_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishAttributeRegistry_V1_0_8_Attributes_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishAttributeRegistry_V1_0_8_Attributes_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenMapFrom_Array_ElementCs(RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishAttributeRegistry_V1_0_8_MapFrom_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishAttributeRegistry_V1_0_8_MapFrom_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MapFromAttribute
...
//
//Generate C structure for RedfishAttributeRegistry_V1_0_8_MapFrom_Array_CS
//
static RedfishCS_status GenMapFrom_ArrayCs(RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishAttributeRegistry_V1_0_8_MapFrom_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishAttributeRegistry_V1_0_8_MapFrom_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishAttributeRegistry_V1_0_8_MapFrom_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenDependencyCs(RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishAttributeRegistry_V1_0_8_Dependency_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAttributeRegistry_V1_0_8_Dependency_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MapFrom
...
static RedfishCS_status GenDependencies_Array_ElementCs(RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishAttributeRegistry_V1_0_8_Dependencies_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishAttributeRegistry_V1_0_8_Dependencies_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Dependency
...
//
//Generate C structure for RedfishAttributeRegistry_V1_0_8_Dependencies_Array_CS
//
static RedfishCS_status GenDependencies_ArrayCs(RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishAttributeRegistry_V1_0_8_Dependencies_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishAttributeRegistry_V1_0_8_Dependencies_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishAttributeRegistry_V1_0_8_Dependencies_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenMenus_Array_ElementCs(RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishAttributeRegistry_V1_0_8_Menus_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishAttributeRegistry_V1_0_8_Menus_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // DisplayName
...
//
//Generate C structure for RedfishAttributeRegistry_V1_0_8_Menus_Array_CS
//
static RedfishCS_status GenMenus_ArrayCs(RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishAttributeRegistry_V1_0_8_Menus_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishAttributeRegistry_V1_0_8_Menus_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishAttributeRegistry_V1_0_8_Menus_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenRegistryEntriesCs(RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishAttributeRegistry_V1_0_8_RegistryEntries_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAttributeRegistry_V1_0_8_RegistryEntries_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Attributes
...
static RedfishCS_status GenSupportedSystems_Array_ElementCs(RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishAttributeRegistry_V1_0_8_SupportedSystems_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishAttributeRegistry_V1_0_8_SupportedSystems_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ProductName
...
//
//Generate C structure for RedfishAttributeRegistry_V1_0_8_SupportedSystems_Array_CS
//
static RedfishCS_status GenSupportedSystems_ArrayCs(RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishAttributeRegistry_V1_0_8_SupportedSystems_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishAttributeRegistry_V1_0_8_SupportedSystems_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishAttributeRegistry_V1_0_8_SupportedSystems_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_RegistryEntriesAttributesValue(json_t *CsJson, char *Key, RedfishAttributeRegistry_V1_0_8_AttributeValue_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishAttributeRegistry_V1_0_8_AttributeValue_Array_CS *NextArray;
  RedfishAttributeRegistry_V1_0_8_AttributeValue_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_RegistryEntriesAttributes(json_t *CsJson, char *Key, RedfishAttributeRegistry_V1_0_8_Attributes_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishAttributeRegistry_V1_0_8_Attributes_Array_CS *NextArray;
  RedfishAttributeRegistry_V1_0_8_Attributes_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_RegistryEntriesDependenciesDependencyMapFrom(json_t *CsJson, char *Key, RedfishAttributeRegistry_V1_0_8_MapFrom_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishAttributeRegistry_V1_0_8_MapFrom_Array_CS *NextArray;
  RedfishAttributeRegistry_V1_0_8_MapFrom_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_RegistryEntriesDependenciesDependency(json_t *CsJson, char *Key, RedfishAttributeRegistry_V1_0_8_Dependency_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_RegistryEntriesDependencies(json_t *CsJson, char *Key, RedfishAttributeRegistry_V1_0_8_Dependencies_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishAttributeRegistry_V1_0_8_Dependencies_Array_CS *NextArray;
  RedfishAttributeRegistry_V1_0_8_Dependencies_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_RegistryEntriesMenus(json_t *CsJson, char *Key, RedfishAttributeRegistry_V1_0_8_Menus_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishAttributeRegistry_V1_0_8_Menus_Array_CS *NextArray;
  RedfishAttributeRegistry_V1_0_8_Menus_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_RegistryEntries(json_t *CsJson, char *Key, RedfishAttributeRegistry_V1_0_8_RegistryEntries_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_SupportedSystems(json_t *CsJson, char *Key, RedfishAttributeRegistry_V1_0_8_SupportedSystems_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishAttributeRegistry_V1_0_8_SupportedSystems_Array_CS *NextArray;
  RedfishAttributeRegistry_V1_0_8_SupportedSystems_CS *NextArrayItem;
...
//
// C structure to JSON for AttributeRegistry.V1_0_8.AttributeRegistry
//
RedfishCS_status CS_To_AttributeRegistry_V1_0_8_JSON(RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for AttributeRegistry.V1_0_8.AttributeRegistry
//
RedfishCS_status DestroyAttributeRegistry_V1_0_8_CS(RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for AttributeRegistry.V1_0_8.AttributeRegistry
//
RedfishCS_status DestroyAttributeRegistry_V1_0_8_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for AttributeRegistry.V1_0_8.AttributeRegistry
//
RedfishCS_status
Json_AttributeRegistry_V1_0_8_To_CS(RedfishCS_char *JsonRawText, RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "AttributeRegistry", "v1_0_8", "AttributeRegistry", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAttributeRegistry_V1_0_8_AttributeRegistry_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyAttributeRegistry_V1_0_8_CS (Cs);
  return Status;
}
