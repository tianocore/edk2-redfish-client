...
#include"Redfish_SecureBoot_v1_1_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenResetKeysCs(RedfishSecureBoot_V1_1_0_SecureBoot_CS *Cs, json_t *JsonObj, char *Key, RedfishSecureBoot_V1_1_0_ResetKeys_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSecureBoot_V1_1_0_ResetKeys_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishSecureBoot_V1_1_0_SecureBoot_CS *Cs, json_t *JsonObj, char *Key, RedfishSecureBoot_V1_1_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSecureBoot_V1_1_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishSecureBoot_V1_1_0_SecureBoot_CS *Cs, json_t *JsonObj, char *Key, RedfishSecureBoot_V1_1_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSecureBoot_V1_1_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishSecureBoot_V1_1_0_SecureBoot_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishSecureBoot_V1_1_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsSecureBoot_ResetKeys(json_t *CsJson, char *Key, RedfishSecureBoot_V1_1_0_ResetKeys_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishSecureBoot_V1_1_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for SecureBoot.V1_1_0.SecureBoot
//
RedfishCS_status CS_To_SecureBoot_V1_1_0_JSON(RedfishSecureBoot_V1_1_0_SecureBoot_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // SecureBootDatabases 
  if (InsertJsonLinkObj (CsJson, "SecureBootDatabases", &CSPtr->SecureBootDatabases) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for SecureBoot.V1_1_0.SecureBoot
//
RedfishCS_status DestroySecureBoot_V1_1_0_CS(RedfishSecureBoot_V1_1_0_SecureBoot_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for SecureBoot.V1_1_0.SecureBoot
//
RedfishCS_status DestroySecureBoot_V1_1_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for SecureBoot.V1_1_0.SecureBoot
//
RedfishCS_status
Json_SecureBoot_V1_1_0_To_CS(RedfishCS_char *JsonRawText, RedfishSecureBoot_V1_1_0_SecureBoot_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSecureBoot_V1_1_0_SecureBoot_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "SecureBoot", "v1_1_0", "SecureBoot", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSecureBoot_V1_1_0_SecureBoot_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // SecureBootDatabases
  InitializeLinkHead (&Cs->SecureBootDatabases);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "SecureBootDatabases", Cs->Header.ThisUri, &Cs->SecureBootDatabases);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroySecureBoot_V1_1_0_CS (Cs);
  return Status;
}
