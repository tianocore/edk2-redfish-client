...
#include"Redfish_GraphicsControllerCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishGraphicsControllerCollection_GraphicsControllerCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for GraphicsControllerCollection.GraphicsControllerCollection
//
RedfishCS_status CS_To_GraphicsControllerCollection_JSON(RedfishGraphicsControllerCollection_GraphicsControllerCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for GraphicsControllerCollection.GraphicsControllerCollection
//
RedfishCS_status DestroyGraphicsControllerCollection_CS(RedfishGraphicsControllerCollection_GraphicsControllerCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for GraphicsControllerCollection.GraphicsControllerCollection
//
RedfishCS_status DestroyGraphicsControllerCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for GraphicsControllerCollection.NOVERSIONED.GraphicsControllerCollection
//
RedfishCS_status
Json_GraphicsControllerCollection_To_CS(RedfishCS_char *JsonRawText, RedfishGraphicsControllerCollection_GraphicsControllerCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishGraphicsControllerCollection_GraphicsControllerCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "GraphicsControllerCollection", "noversioned", "GraphicsControllerCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishGraphicsControllerCollection_GraphicsControllerCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyGraphicsControllerCollection_CS (Cs);
  return Status;
}
