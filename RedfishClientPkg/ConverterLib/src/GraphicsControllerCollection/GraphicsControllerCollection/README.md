# Definition of GraphicsControllerCollection and functions<br><br>
...
## Redfish GraphicsControllerCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish GraphicsControllerCollection  JSON Function
    RedfishCS_status
    CS_To_GraphicsControllerCollection_JSON (RedfishGraphicsControllerCollection_GraphicsControllerCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish GraphicsControllerCollection  C Structure Function
    RedfishCS_status
