# Definition of ExternalAccountProvider.V1_2_0 and functions<br><br>

## Actions
    typedef struct _RedfishExternalAccountProvider_V1_2_0_Actions_CS {
        RedfishExternalAccountProvider_V1_2_0_OemActions_CS *Oem;
    } RedfishExternalAccountProvider_V1_2_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishExternalAccountProvider_V1_2_0_OemActions_CS| Structure points to **Oem** property.| No| No
...
## LDAPService
    typedef struct _RedfishExternalAccountProvider_V1_2_0_LDAPService_CS {
        RedfishResource_Oem_CS *Oem;
        RedfishExternalAccountProvider_V1_2_0_LDAPSearchSettings_CS *SearchSettings;
    } RedfishExternalAccountProvider_V1_2_0_LDAPService_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**SearchSettings**|RedfishExternalAccountProvider_V1_2_0_LDAPSearchSettings_CS| Structure points to **SearchSettings** property.| No| No
...
## ExternalAccountProvider
    typedef struct _RedfishExternalAccountProvider_V1_2_0_ExternalAccountProvider_CS {
        ...
        RedfishExternalAccountProvider_V1_2_0_Actions_CS *Actions;
        RedfishExternalAccountProvider_V1_2_0_Authentication_CS *Authentication;
        RedfishCS_Link Certificates;
        RedfishCS_char *Description;
        RedfishCS_char *Id;
        RedfishExternalAccountProvider_V1_2_0_LDAPService_CS *LDAPService;
        RedfishExternalAccountProvider_V1_2_0_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishCS_int64 *Priority;
        RedfishExternalAccountProvider_V1_2_0_RoleMapping_CS *RemoteRoleMapping;
        RedfishCS_char *ServiceAddresses;
        RedfishCS_bool *ServiceEnabled;
        RedfishExternalAccountProvider_V1_2_0_TACACSplusService_CS *TACACSplusService;
...
|**Actions**|RedfishExternalAccountProvider_V1_2_0_Actions_CS| Structure points to **Actions** property.| No| No
|**Authentication**|RedfishExternalAccountProvider_V1_2_0_Authentication_CS| Structure points to **Authentication** property.| No| No
|**Certificates**|RedfishCS_Link| Structure link list to **Certificates** property.| No| Yes
|**Description**|RedfishCS_char| String pointer to **Description** property.| No| Yes
|**Id**|RedfishCS_char| String pointer to **Id** property.| Yes| Yes
|**LDAPService**|RedfishExternalAccountProvider_V1_2_0_LDAPService_CS| Structure points to **LDAPService** property.| No| No
|**Links**|RedfishExternalAccountProvider_V1_2_0_Links_CS| Structure points to **Links** property.| No| No
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**Priority**|RedfishCS_int64| 64-bit long long interger pointer to **Priority** property.| No| No
|**RemoteRoleMapping**|RedfishExternalAccountProvider_V1_2_0_RoleMapping_CS| Structure points to **RemoteRoleMapping** property.| No| No
|**ServiceAddresses**|RedfishCS_char| String pointer to **ServiceAddresses** property.| No| No
|**ServiceEnabled**|RedfishCS_bool| Boolean pointer to **ServiceEnabled** property.| No| No
|**TACACSplusService**|RedfishExternalAccountProvider_V1_2_0_TACACSplusService_CS| Structure points to **TACACSplusService** property.| No| No
## Redfish ExternalAccountProvider V1_2_0 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish ExternalAccountProvider V1_2_0 JSON Function
    RedfishCS_status
    CS_To_ExternalAccountProvider_V1_2_0_JSON (RedfishExternalAccountProvider_V1_2_0_ExternalAccountProvider_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ExternalAccountProvider V1_2_0 C Structure Function
    RedfishCS_status
