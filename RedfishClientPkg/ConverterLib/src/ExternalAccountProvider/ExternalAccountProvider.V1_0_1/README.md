# Definition of ExternalAccountProvider.V1_0_1 and functions<br><br>

## Actions
    typedef struct _RedfishExternalAccountProvider_V1_0_1_Actions_CS {
        RedfishExternalAccountProvider_V1_0_1_OemActions_CS *Oem;
    } RedfishExternalAccountProvider_V1_0_1_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishExternalAccountProvider_V1_0_1_OemActions_CS| Structure points to **Oem** property.| No| No
...
## LDAPService
    typedef struct _RedfishExternalAccountProvider_V1_0_1_LDAPService_CS {
        RedfishResource_Oem_CS *Oem;
        RedfishExternalAccountProvider_V1_0_1_LDAPSearchSettings_CS *SearchSettings;
    } RedfishExternalAccountProvider_V1_0_1_LDAPService_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**SearchSettings**|RedfishExternalAccountProvider_V1_0_1_LDAPSearchSettings_CS| Structure points to **SearchSettings** property.| No| No
...
## ExternalAccountProvider
    typedef struct _RedfishExternalAccountProvider_V1_0_1_ExternalAccountProvider_CS {
        ...
        RedfishExternalAccountProvider_V1_0_1_Actions_CS *Actions;
        RedfishExternalAccountProvider_V1_0_1_Authentication_CS *Authentication;
        RedfishCS_char *Description;
        RedfishCS_char *Id;
        RedfishExternalAccountProvider_V1_0_1_LDAPService_CS *LDAPService;
        RedfishExternalAccountProvider_V1_0_1_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishExternalAccountProvider_V1_0_1_RoleMapping_CS *RemoteRoleMapping;
...
|**Actions**|RedfishExternalAccountProvider_V1_0_1_Actions_CS| Structure points to **Actions** property.| No| No
|**Authentication**|RedfishExternalAccountProvider_V1_0_1_Authentication_CS| Structure points to **Authentication** property.| No| No
|**Description**|RedfishCS_char| String pointer to **Description** property.| No| Yes
|**Id**|RedfishCS_char| String pointer to **Id** property.| Yes| Yes
|**LDAPService**|RedfishExternalAccountProvider_V1_0_1_LDAPService_CS| Structure points to **LDAPService** property.| No| No
|**Links**|RedfishExternalAccountProvider_V1_0_1_Links_CS| Structure points to **Links** property.| No| No
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**RemoteRoleMapping**|RedfishExternalAccountProvider_V1_0_1_RoleMapping_CS| Structure points to **RemoteRoleMapping** property.| No| No
|**ServiceAddresses**|RedfishCS_char| String pointer to **ServiceAddresses** property.| No| No
|**ServiceEnabled**|RedfishCS_bool| Boolean pointer to **ServiceEnabled** property.| No| No
## Redfish ExternalAccountProvider V1_0_1 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish ExternalAccountProvider V1_0_1 JSON Function
    RedfishCS_status
    CS_To_ExternalAccountProvider_V1_0_1_JSON (RedfishExternalAccountProvider_V1_0_1_ExternalAccountProvider_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ExternalAccountProvider V1_0_1 C Structure Function
    RedfishCS_status
