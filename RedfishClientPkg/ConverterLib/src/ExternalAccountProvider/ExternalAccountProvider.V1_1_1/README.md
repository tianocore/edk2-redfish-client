# Definition of ExternalAccountProvider.V1_1_1 and functions<br><br>
...
|**Links**|RedfishExternalAccountProvider_V1_1_1_Links_CS| Structure points to **Links** property.| No| No
