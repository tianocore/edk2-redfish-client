...
#include"Redfish_ExternalAccountProvider_v1_1_3_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishExternalAccountProvider_V1_1_3_ExternalAccountProvider_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishExternalAccountProvider_V1_1_3_ExternalAccountProvider_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishExternalAccountProvider_V1_1_3_ExternalAccountProvider_CS *Cs, json_t *JsonObj, char *Key, RedfishExternalAccountProvider_V1_1_3_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishExternalAccountProvider_V1_1_3_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishExternalAccountProvider_V1_1_3_ExternalAccountProvider_CS *Cs, json_t *JsonObj, char *Key, RedfishExternalAccountProvider_V1_1_3_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishExternalAccountProvider_V1_1_3_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenAuthenticationCs(RedfishExternalAccountProvider_V1_1_3_ExternalAccountProvider_CS *Cs, json_t *JsonObj, char *Key, RedfishExternalAccountProvider_V1_1_3_Authentication_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishExternalAccountProvider_V1_1_3_Authentication_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AuthenticationType
...
//
static RedfishCS_status GenLDAPSearchSettingsCs(RedfishExternalAccountProvider_V1_1_3_ExternalAccountProvider_CS *Cs, json_t *JsonObj, char *Key, RedfishExternalAccountProvider_V1_1_3_LDAPSearchSettings_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishExternalAccountProvider_V1_1_3_LDAPSearchSettings_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenLDAPServiceCs(RedfishExternalAccountProvider_V1_1_3_ExternalAccountProvider_CS *Cs, json_t *JsonObj, char *Key, RedfishExternalAccountProvider_V1_1_3_LDAPService_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishExternalAccountProvider_V1_1_3_LDAPService_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishExternalAccountProvider_V1_1_3_ExternalAccountProvider_CS *Cs, json_t *JsonObj, char *Key, RedfishExternalAccountProvider_V1_1_3_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishExternalAccountProvider_V1_1_3_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenRoleMapping_Array_ElementCs(RedfishExternalAccountProvider_V1_1_3_ExternalAccountProvider_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishExternalAccountProvider_V1_1_3_RoleMapping_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishExternalAccountProvider_V1_1_3_RoleMapping_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // LocalRole
...
//
//Generate C structure for RedfishExternalAccountProvider_V1_1_3_RoleMapping_Array_CS
//
static RedfishCS_status GenRoleMapping_ArrayCs(RedfishExternalAccountProvider_V1_1_3_ExternalAccountProvider_CS *Cs, json_t *JsonObj, char *Key, RedfishExternalAccountProvider_V1_1_3_RoleMapping_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishExternalAccountProvider_V1_1_3_RoleMapping_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishExternalAccountProvider_V1_1_3_RoleMapping_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishExternalAccountProvider_V1_1_3_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishExternalAccountProvider_V1_1_3_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Authentication(json_t *CsJson, char *Key, RedfishExternalAccountProvider_V1_1_3_Authentication_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_LDAPServiceSearchSettings(json_t *CsJson, char *Key, RedfishExternalAccountProvider_V1_1_3_LDAPSearchSettings_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_LDAPService(json_t *CsJson, char *Key, RedfishExternalAccountProvider_V1_1_3_LDAPService_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishExternalAccountProvider_V1_1_3_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_RemoteRoleMapping(json_t *CsJson, char *Key, RedfishExternalAccountProvider_V1_1_3_RoleMapping_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishExternalAccountProvider_V1_1_3_RoleMapping_Array_CS *NextArray;
  RedfishExternalAccountProvider_V1_1_3_RoleMapping_CS *NextArrayItem;
...
//
// C structure to JSON for ExternalAccountProvider.V1_1_3.ExternalAccountProvider
//
RedfishCS_status CS_To_ExternalAccountProvider_V1_1_3_JSON(RedfishExternalAccountProvider_V1_1_3_ExternalAccountProvider_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ExternalAccountProvider.V1_1_3.ExternalAccountProvider
//
RedfishCS_status DestroyExternalAccountProvider_V1_1_3_CS(RedfishExternalAccountProvider_V1_1_3_ExternalAccountProvider_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ExternalAccountProvider.V1_1_3.ExternalAccountProvider
//
RedfishCS_status DestroyExternalAccountProvider_V1_1_3_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ExternalAccountProvider.V1_1_3.ExternalAccountProvider
//
RedfishCS_status
Json_ExternalAccountProvider_V1_1_3_To_CS(RedfishCS_char *JsonRawText, RedfishExternalAccountProvider_V1_1_3_ExternalAccountProvider_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishExternalAccountProvider_V1_1_3_ExternalAccountProvider_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ExternalAccountProvider", "v1_1_3", "ExternalAccountProvider", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishExternalAccountProvider_V1_1_3_ExternalAccountProvider_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyExternalAccountProvider_V1_1_3_CS (Cs);
  return Status;
}
