# Definition of Processor.V1_11_2 and functions<br><br>

## Actions
    typedef struct _RedfishProcessor_V1_11_2_Actions_CS {
        RedfishProcessor_V1_11_2_Reset_CS *Processor_Reset;
        RedfishProcessor_V1_11_2_OemActions_CS *Oem;
    } RedfishProcessor_V1_11_2_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Processor_Reset**|RedfishProcessor_V1_11_2_Reset_CS| Structure points to **#Processor.Reset** property.| No| No
|**Oem**|RedfishProcessor_V1_11_2_OemActions_CS| Structure points to **Oem** property.| No| No
...
## FPGA
    typedef struct _RedfishProcessor_V1_11_2_FPGA_CS {
        RedfishProcessor_V1_11_2_ProcessorInterface_Array_CS *ExternalInterfaces;
        RedfishCS_char *FirmwareId;
        RedfishCS_char *FirmwareManufacturer;
        RedfishCS_char *FirmwareVersion;
        RedfishCS_char *FpgaType;
        RedfishProcessor_V1_11_2_ProcessorInterface_CS *HostInterface;
        RedfishCS_char *Model;
        RedfishResource_Oem_CS *Oem;
        RedfishCS_int64 *PCIeVirtualFunctions;
        RedfishCS_bool *ProgrammableFromHost;
        RedfishProcessor_V1_11_2_FpgaReconfigurationSlot_Array_CS *ReconfigurationSlots;
    } RedfishProcessor_V1_11_2_FPGA_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**ExternalInterfaces**|RedfishProcessor_V1_11_2_ProcessorInterface_Array_CS| Structure array points to one or more than one **RedfishProcessor_V1_11_2_ProcessorInterface_Array_CS** structures for property **ExternalInterfaces**.| No| No
...
|**HostInterface**|RedfishProcessor_V1_11_2_ProcessorInterface_CS| Structure points to **HostInterface** property.| No| No
...
|**ReconfigurationSlots**|RedfishProcessor_V1_11_2_FpgaReconfigurationSlot_Array_CS| Structure array points to one or more than one **RedfishProcessor_V1_11_2_FpgaReconfigurationSlot_Array_CS** structures for property **ReconfigurationSlots**.| No| No
...
## ProcessorInterface
    typedef struct _RedfishProcessor_V1_11_2_ProcessorInterface_CS {
        RedfishProcessor_V1_11_2_EthernetInterface_CS *Ethernet;
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Ethernet**|RedfishProcessor_V1_11_2_EthernetInterface_CS| Structure points to **Ethernet** property.| No| No
...
## Processor
    typedef struct _RedfishProcessor_V1_11_2_Processor_CS {
        ...
        RedfishProcessor_V1_11_2_Actions_CS *Actions;
        ...
        RedfishProcessor_V1_11_2_FPGA_CS *FPGA;
        RedfishCS_char *FirmwareVersion;
        RedfishCS_int64 *HighSpeedCoreIDs;
        RedfishCS_char *Id;
        RedfishCS_char *InstructionSet;
        RedfishProcessor_V1_11_2_Links_CS *Links;
        ...
        RedfishProcessor_V1_11_2_MemorySummary_CS *MemorySummary;
        RedfishCS_Link Metrics;
        ...
        RedfishProcessor_V1_11_2_ProcessorId_CS *ProcessorId;
        RedfishProcessor_V1_11_2_ProcessorMemory_CS *ProcessorMemory;
        ...
        RedfishProcessor_V1_11_2_ProcessorInterface_CS *SystemInterface;
...
|**Actions**|RedfishProcessor_V1_11_2_Actions_CS| Structure points to **Actions** property.| No| No
...
|**FPGA**|RedfishProcessor_V1_11_2_FPGA_CS| Structure points to **FPGA** property.| No| No
|**FirmwareVersion**|RedfishCS_char| String pointer to **FirmwareVersion** property.| No| Yes
...
|**Links**|RedfishProcessor_V1_11_2_Links_CS| Structure points to **Links** property.| No| No
...
|**MemorySummary**|RedfishProcessor_V1_11_2_MemorySummary_CS| Structure points to **MemorySummary** property.| No| No
|**Metrics**|RedfishCS_Link| Structure link list to **Metrics** property.| No| Yes
...
|**ProcessorId**|RedfishProcessor_V1_11_2_ProcessorId_CS| Structure points to **ProcessorId** property.| No| No
|**ProcessorMemory**|RedfishProcessor_V1_11_2_ProcessorMemory_CS| Structure points to **ProcessorMemory** property.| No| No
...
|**SystemInterface**|RedfishProcessor_V1_11_2_ProcessorInterface_CS| Structure points to **SystemInterface** property.| No| No
...
## Redfish Processor V1_11_2 to C Structure Function
    RedfishCS_status
    Json_Processor_V1_11_2_To_CS (RedfishCS_char *JsonRawText, RedfishProcessor_V1_11_2_Processor_CS **ReturnedCS);

## C Structure to Redfish Processor V1_11_2 JSON Function
    RedfishCS_status
    CS_To_Processor_V1_11_2_JSON (RedfishProcessor_V1_11_2_Processor_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Processor V1_11_2 C Structure Function
    RedfishCS_status
