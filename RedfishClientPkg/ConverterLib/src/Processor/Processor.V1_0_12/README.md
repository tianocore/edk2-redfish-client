# Definition of Processor.V1_0_12 and functions<br><br>
...
## Processor
    typedef struct _RedfishProcessor_V1_0_12_Processor_CS {
        ...
        RedfishProcessor_V1_0_12_ProcessorId_CS *ProcessorId;
...
|**ProcessorId**|RedfishProcessor_V1_0_12_ProcessorId_CS| Structure points to **ProcessorId** property.| No| No
...
## Redfish Processor V1_0_12 to C Structure Function
    RedfishCS_status
    Json_Processor_V1_0_12_To_CS (RedfishCS_char *JsonRawText, RedfishProcessor_V1_0_12_Processor_CS **ReturnedCS);

## C Structure to Redfish Processor V1_0_12 JSON Function
    RedfishCS_status
    CS_To_Processor_V1_0_12_JSON (RedfishProcessor_V1_0_12_Processor_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Processor V1_0_12 C Structure Function
    RedfishCS_status
