# Definition of Processor.V1_4_1 and functions<br><br>

## Actions
    typedef struct _RedfishProcessor_V1_4_1_Actions_CS {
        RedfishProcessor_V1_4_1_OemActions_CS *Oem;
    } RedfishProcessor_V1_4_1_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishProcessor_V1_4_1_OemActions_CS| Structure points to **Oem** property.| No| No
...
## FPGA
    typedef struct _RedfishProcessor_V1_4_1_FPGA_CS {
        RedfishProcessor_V1_4_1_FpgaInterface_Array_CS *ExternalInterfaces;
        RedfishCS_char *FirmwareId;
        RedfishCS_char *FirmwareManufacturer;
        RedfishCS_char *FirmwareVersion;
        RedfishCS_char *FpgaType;
        RedfishProcessor_V1_4_1_FpgaInterface_CS *HostInterface;
        RedfishCS_char *Model;
        RedfishResource_Oem_CS *Oem;
        RedfishCS_int64 *PCIeVirtualFunctions;
        RedfishCS_bool *ProgrammableFromHost;
        RedfishProcessor_V1_4_1_FpgaReconfigurationSlot_Array_CS *ReconfigurationSlots;
    } RedfishProcessor_V1_4_1_FPGA_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**ExternalInterfaces**|RedfishProcessor_V1_4_1_FpgaInterface_Array_CS| Structure array points to one or more than one **RedfishProcessor_V1_4_1_FpgaInterface_Array_CS** structures for property **ExternalInterfaces**.| No| No
...
|**HostInterface**|RedfishProcessor_V1_4_1_FpgaInterface_CS| Structure points to **HostInterface** property.| No| No
...
|**ReconfigurationSlots**|RedfishProcessor_V1_4_1_FpgaReconfigurationSlot_Array_CS| Structure array points to one or more than one **RedfishProcessor_V1_4_1_FpgaReconfigurationSlot_Array_CS** structures for property **ReconfigurationSlots**.| No| No


## FpgaInterface
    typedef struct _RedfishProcessor_V1_4_1_FpgaInterface_CS {
        RedfishProcessor_V1_4_1_EthernetInterface_CS *Ethernet;
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Ethernet**|RedfishProcessor_V1_4_1_EthernetInterface_CS| Structure points to **Ethernet** property.| No| No
...
## Processor
    typedef struct _RedfishProcessor_V1_4_1_Processor_CS {
        ...
        RedfishProcessor_V1_4_1_Actions_CS *Actions;
        RedfishCS_Link Assembly;
        RedfishCS_char *Description;
        RedfishProcessor_V1_4_1_FPGA_CS *FPGA;
        RedfishCS_char *Id;
        RedfishCS_char *InstructionSet;
        RedfishProcessor_V1_4_1_Links_CS *Links;
        ...
        RedfishProcessor_V1_4_1_ProcessorId_CS *ProcessorId;
        RedfishProcessor_V1_4_1_ProcessorMemory_CS *ProcessorMemory;
...
|**Actions**|RedfishProcessor_V1_4_1_Actions_CS| Structure points to **Actions** property.| No| No
|**Assembly**|RedfishCS_Link| Structure link list to **Assembly** property.| No| Yes
|**Description**|RedfishCS_char| String pointer to **Description** property.| No| Yes
|**FPGA**|RedfishProcessor_V1_4_1_FPGA_CS| Structure points to **FPGA** property.| No| No
|**Id**|RedfishCS_char| String pointer to **Id** property.| Yes| Yes
|**InstructionSet**|RedfishCS_char| String pointer to **InstructionSet** property.| No| Yes
|**Links**|RedfishProcessor_V1_4_1_Links_CS| Structure points to **Links** property.| No| No
...
|**ProcessorId**|RedfishProcessor_V1_4_1_ProcessorId_CS| Structure points to **ProcessorId** property.| No| No
|**ProcessorMemory**|RedfishProcessor_V1_4_1_ProcessorMemory_CS| Structure points to **ProcessorMemory** property.| No| No
...
|**UUID**|RedfishCS_char| String pointer to **UUID** property.| No| Yes
## Redfish Processor V1_4_1 to C Structure Function
    RedfishCS_status
    Json_Processor_V1_4_1_To_CS (RedfishCS_char *JsonRawText, RedfishProcessor_V1_4_1_Processor_CS **ReturnedCS);

## C Structure to Redfish Processor V1_4_1 JSON Function
    RedfishCS_status
    CS_To_Processor_V1_4_1_JSON (RedfishProcessor_V1_4_1_Processor_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Processor V1_4_1 C Structure Function
    RedfishCS_status
