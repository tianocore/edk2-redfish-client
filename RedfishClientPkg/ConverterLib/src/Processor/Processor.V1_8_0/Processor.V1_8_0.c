...
#include"Redfish_Processor_v1_8_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenEthernetInterfaceCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, char *Key, RedfishProcessor_V1_8_0_EthernetInterface_CS **Dst);
static RedfishCS_status GenOemCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenProcessorInterfaceCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, char *Key, RedfishProcessor_V1_8_0_ProcessorInterface_CS **Dst);
//
//Generate C structure for #Processor.Reset
//
static RedfishCS_status GenResetCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, char *Key, RedfishProcessor_V1_8_0_Reset_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishProcessor_V1_8_0_Reset_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, char *Key, RedfishProcessor_V1_8_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishProcessor_V1_8_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, char *Key, RedfishProcessor_V1_8_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishProcessor_V1_8_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #Processor.Reset
...
static RedfishCS_status GenEthernetInterfaceCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, char *Key, RedfishProcessor_V1_8_0_EthernetInterface_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishProcessor_V1_8_0_EthernetInterface_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MaxLanes
...
static RedfishCS_status GenProcessorInterface_Array_ElementCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishProcessor_V1_8_0_ProcessorInterface_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishProcessor_V1_8_0_ProcessorInterface_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Ethernet
...
//
//Generate C structure for RedfishProcessor_V1_8_0_ProcessorInterface_Array_CS
//
static RedfishCS_status GenProcessorInterface_ArrayCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, char *Key, RedfishProcessor_V1_8_0_ProcessorInterface_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishProcessor_V1_8_0_ProcessorInterface_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishProcessor_V1_8_0_ProcessorInterface_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenProcessorInterfaceCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, char *Key, RedfishProcessor_V1_8_0_ProcessorInterface_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishProcessor_V1_8_0_ProcessorInterface_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Ethernet
...
static RedfishCS_status GenFpgaReconfigurationSlot_Array_ElementCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishProcessor_V1_8_0_FpgaReconfigurationSlot_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishProcessor_V1_8_0_FpgaReconfigurationSlot_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
//Generate C structure for RedfishProcessor_V1_8_0_FpgaReconfigurationSlot_Array_CS
//
static RedfishCS_status GenFpgaReconfigurationSlot_ArrayCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, char *Key, RedfishProcessor_V1_8_0_FpgaReconfigurationSlot_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishProcessor_V1_8_0_FpgaReconfigurationSlot_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishProcessor_V1_8_0_FpgaReconfigurationSlot_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenFPGACs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, char *Key, RedfishProcessor_V1_8_0_FPGA_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishProcessor_V1_8_0_FPGA_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ExternalInterfaces
...
//
static RedfishCS_status GenLinksCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, char *Key, RedfishProcessor_V1_8_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishProcessor_V1_8_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Chassis
...
//
static RedfishCS_status GenProcessorIdCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, char *Key, RedfishProcessor_V1_8_0_ProcessorId_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishProcessor_V1_8_0_ProcessorId_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // EffectiveFamily
...
static RedfishCS_status GenProcessorMemory_Array_ElementCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishProcessor_V1_8_0_ProcessorMemory_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishProcessor_V1_8_0_ProcessorMemory_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // CapacityMiB
...
//
//Generate C structure for RedfishProcessor_V1_8_0_ProcessorMemory_Array_CS
//
static RedfishCS_status GenProcessorMemory_ArrayCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, char *Key, RedfishProcessor_V1_8_0_ProcessorMemory_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishProcessor_V1_8_0_ProcessorMemory_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishProcessor_V1_8_0_ProcessorMemory_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenidRefCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishProcessor_V1_8_0_Processor_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishProcessor_V1_8_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsProcessor_Reset(json_t *CsJson, char *Key, RedfishProcessor_V1_8_0_Reset_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishProcessor_V1_8_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_FPGAExternalInterfacesEthernet(json_t *CsJson, char *Key, RedfishProcessor_V1_8_0_EthernetInterface_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_FPGAExternalInterfaces(json_t *CsJson, char *Key, RedfishProcessor_V1_8_0_ProcessorInterface_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishProcessor_V1_8_0_ProcessorInterface_Array_CS *NextArray;
  RedfishProcessor_V1_8_0_ProcessorInterface_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_FPGAHostInterfaceEthernet(json_t *CsJson, char *Key, RedfishProcessor_V1_8_0_EthernetInterface_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_FPGAHostInterface(json_t *CsJson, char *Key, RedfishProcessor_V1_8_0_ProcessorInterface_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_FPGAReconfigurationSlots(json_t *CsJson, char *Key, RedfishProcessor_V1_8_0_FpgaReconfigurationSlot_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishProcessor_V1_8_0_FpgaReconfigurationSlot_Array_CS *NextArray;
  RedfishProcessor_V1_8_0_FpgaReconfigurationSlot_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_FPGA(json_t *CsJson, char *Key, RedfishProcessor_V1_8_0_FPGA_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishProcessor_V1_8_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ProcessorId(json_t *CsJson, char *Key, RedfishProcessor_V1_8_0_ProcessorId_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ProcessorMemory(json_t *CsJson, char *Key, RedfishProcessor_V1_8_0_ProcessorMemory_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishProcessor_V1_8_0_ProcessorMemory_Array_CS *NextArray;
  RedfishProcessor_V1_8_0_ProcessorMemory_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_SystemInterfaceEthernet(json_t *CsJson, char *Key, RedfishProcessor_V1_8_0_EthernetInterface_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_SystemInterface(json_t *CsJson, char *Key, RedfishProcessor_V1_8_0_ProcessorInterface_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Processor.V1_8_0.Processor
//
RedfishCS_status CS_To_Processor_V1_8_0_JSON(RedfishProcessor_V1_8_0_Processor_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Processor.V1_8_0.Processor
//
RedfishCS_status DestroyProcessor_V1_8_0_CS(RedfishProcessor_V1_8_0_Processor_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Processor.V1_8_0.Processor
//
RedfishCS_status DestroyProcessor_V1_8_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Processor.V1_8_0.Processor
//
RedfishCS_status
Json_Processor_V1_8_0_To_CS(RedfishCS_char *JsonRawText, RedfishProcessor_V1_8_0_Processor_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishProcessor_V1_8_0_Processor_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Processor", "v1_8_0", "Processor", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishProcessor_V1_8_0_Processor_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
