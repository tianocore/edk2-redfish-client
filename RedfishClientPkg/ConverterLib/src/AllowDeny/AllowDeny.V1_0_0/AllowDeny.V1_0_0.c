...
#include"Redfish_AllowDeny_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishAllowDeny_V1_0_0_AllowDeny_CS *Cs, json_t *JsonObj, char *Key, RedfishAllowDeny_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAllowDeny_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishAllowDeny_V1_0_0_AllowDeny_CS *Cs, json_t *JsonObj, char *Key, RedfishAllowDeny_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAllowDeny_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishAllowDeny_V1_0_0_AllowDeny_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishAllowDeny_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishAllowDeny_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for AllowDeny.V1_0_0.AllowDeny
//
RedfishCS_status CS_To_AllowDeny_V1_0_0_JSON(RedfishAllowDeny_V1_0_0_AllowDeny_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // AllowType 
  if (InsertJsonStringObj (CsJson, "AllowType", CSPtr->AllowType) != RedfishCS_status_success) {goto Error;}

  // Description 
  if (InsertJsonStringObj (CsJson, "Description", CSPtr->Description) != RedfishCS_status_success) {goto Error;}

  // DestinationPortLower 
  if (InsertJsonInt64Obj (CsJson, "DestinationPortLower", CSPtr->DestinationPortLower) != RedfishCS_status_success) {goto Error;}

  // DestinationPortUpper 
  if (InsertJsonInt64Obj (CsJson, "DestinationPortUpper", CSPtr->DestinationPortUpper) != RedfishCS_status_success) {goto Error;}

  // Direction 
  if (InsertJsonStringObj (CsJson, "Direction", CSPtr->Direction) != RedfishCS_status_success) {goto Error;}

  // IANAProtocolNumber 
  if (InsertJsonInt64Obj (CsJson, "IANAProtocolNumber", CSPtr->IANAProtocolNumber) != RedfishCS_status_success) {goto Error;}

  // IPAddressLower 
  if (InsertJsonStringObj (CsJson, "IPAddressLower", CSPtr->IPAddressLower) != RedfishCS_status_success) {goto Error;}

  // IPAddressType 
  if (InsertJsonStringObj (CsJson, "IPAddressType", CSPtr->IPAddressType) != RedfishCS_status_success) {goto Error;}

  // IPAddressUpper 
  if (InsertJsonStringObj (CsJson, "IPAddressUpper", CSPtr->IPAddressUpper) != RedfishCS_status_success) {goto Error;}
  ...
  // SourcePortLower 
  if (InsertJsonInt64Obj (CsJson, "SourcePortLower", CSPtr->SourcePortLower) != RedfishCS_status_success) {goto Error;}

  // SourcePortUpper 
  if (InsertJsonInt64Obj (CsJson, "SourcePortUpper", CSPtr->SourcePortUpper) != RedfishCS_status_success) {goto Error;}

  // StatefulSession 
  if (InsertJsonBoolObj (CsJson, "StatefulSession", CSPtr->StatefulSession) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for AllowDeny.V1_0_0.AllowDeny
//
RedfishCS_status DestroyAllowDeny_V1_0_0_CS(RedfishAllowDeny_V1_0_0_AllowDeny_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for AllowDeny.V1_0_0.AllowDeny
//
RedfishCS_status DestroyAllowDeny_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for AllowDeny.V1_0_0.AllowDeny
//
RedfishCS_status
Json_AllowDeny_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishAllowDeny_V1_0_0_AllowDeny_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAllowDeny_V1_0_0_AllowDeny_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "AllowDeny", "v1_0_0", "AllowDeny", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAllowDeny_V1_0_0_AllowDeny_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // AllowType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "AllowType", &Cs->AllowType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // DestinationPortLower
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "DestinationPortLower", &Cs->DestinationPortLower);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // DestinationPortUpper
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "DestinationPortUpper", &Cs->DestinationPortUpper);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Direction
  Status = GetRedfishPropertyStr (Cs, JsonObj, "Direction", &Cs->Direction);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // IANAProtocolNumber
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "IANAProtocolNumber", &Cs->IANAProtocolNumber);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // IPAddressLower
  Status = GetRedfishPropertyStr (Cs, JsonObj, "IPAddressLower", &Cs->IPAddressLower);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // IPAddressType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "IPAddressType", &Cs->IPAddressType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // IPAddressUpper
  Status = GetRedfishPropertyStr (Cs, JsonObj, "IPAddressUpper", &Cs->IPAddressUpper);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // SourcePortLower
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "SourcePortLower", &Cs->SourcePortLower);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // SourcePortUpper
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "SourcePortUpper", &Cs->SourcePortUpper);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // StatefulSession
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "StatefulSession", &Cs->StatefulSession);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
