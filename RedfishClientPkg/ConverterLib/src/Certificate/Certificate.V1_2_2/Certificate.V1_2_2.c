...
#include"Redfish_Certificate_v1_2_2_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenIdentifierCs(RedfishCertificate_V1_2_2_Certificate_CS *Cs, json_t *JsonObj, char *Key, RedfishCertificate_V1_2_2_Identifier_CS **Dst);
//
//Generate C structure for #Certificate.Rekey
//
static RedfishCS_status GenRekeyCs(RedfishCertificate_V1_2_2_Certificate_CS *Cs, json_t *JsonObj, char *Key, RedfishCertificate_V1_2_2_Rekey_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCertificate_V1_2_2_Rekey_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenRenewCs(RedfishCertificate_V1_2_2_Certificate_CS *Cs, json_t *JsonObj, char *Key, RedfishCertificate_V1_2_2_Renew_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCertificate_V1_2_2_Renew_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishCertificate_V1_2_2_Certificate_CS *Cs, json_t *JsonObj, char *Key, RedfishCertificate_V1_2_2_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCertificate_V1_2_2_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishCertificate_V1_2_2_Certificate_CS *Cs, json_t *JsonObj, char *Key, RedfishCertificate_V1_2_2_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCertificate_V1_2_2_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #Certificate.Rekey
...
static RedfishCS_status GenIdentifierCs(RedfishCertificate_V1_2_2_Certificate_CS *Cs, json_t *JsonObj, char *Key, RedfishCertificate_V1_2_2_Identifier_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCertificate_V1_2_2_Identifier_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // City
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishCertificate_V1_2_2_Certificate_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishCertificate_V1_2_2_Certificate_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsCertificate_Rekey(json_t *CsJson, char *Key, RedfishCertificate_V1_2_2_Rekey_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsCertificate_Renew(json_t *CsJson, char *Key, RedfishCertificate_V1_2_2_Renew_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishCertificate_V1_2_2_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishCertificate_V1_2_2_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Issuer(json_t *CsJson, char *Key, RedfishCertificate_V1_2_2_Identifier_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Subject(json_t *CsJson, char *Key, RedfishCertificate_V1_2_2_Identifier_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Certificate.V1_2_2.Certificate
//
RedfishCS_status CS_To_Certificate_V1_2_2_JSON(RedfishCertificate_V1_2_2_Certificate_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Certificate.V1_2_2.Certificate
//
RedfishCS_status DestroyCertificate_V1_2_2_CS(RedfishCertificate_V1_2_2_Certificate_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Certificate.V1_2_2.Certificate
//
RedfishCS_status DestroyCertificate_V1_2_2_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Certificate.V1_2_2.Certificate
//
RedfishCS_status
Json_Certificate_V1_2_2_To_CS(RedfishCS_char *JsonRawText, RedfishCertificate_V1_2_2_Certificate_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishCertificate_V1_2_2_Certificate_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Certificate", "v1_2_2", "Certificate", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishCertificate_V1_2_2_Certificate_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyCertificate_V1_2_2_CS (Cs);
  return Status;
}
