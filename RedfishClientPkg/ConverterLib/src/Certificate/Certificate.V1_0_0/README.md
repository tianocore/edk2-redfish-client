# Definition of Certificate.V1_0_0 and functions<br><br>

## Actions
    typedef struct _RedfishCertificate_V1_0_0_Actions_CS {
        RedfishCertificate_V1_0_0_OemActions_CS *Oem;
    } RedfishCertificate_V1_0_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishCertificate_V1_0_0_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Certificate
    typedef struct _RedfishCertificate_V1_0_0_Certificate_CS {
        ...
        RedfishCertificate_V1_0_0_Actions_CS *Actions;
        RedfishCS_char *CertificateString;
        RedfishCS_char *CertificateType;
        RedfishCS_char *Description;
        RedfishCS_char *Id;
        RedfishCertificate_V1_0_0_Identifier_CS *Issuer;
        RedfishCS_char *KeyUsage;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishCertificate_V1_0_0_Identifier_CS *Subject;
...
|**Actions**|RedfishCertificate_V1_0_0_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Issuer**|RedfishCertificate_V1_0_0_Identifier_CS| Structure points to **Issuer** property.| No| No
|**KeyUsage**|RedfishCS_char| String pointer to **KeyUsage** property.| No| Yes
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**Subject**|RedfishCertificate_V1_0_0_Identifier_CS| Structure points to **Subject** property.| No| No
...
## Redfish Certificate V1_0_0 to C Structure Function
    RedfishCS_status
    Json_Certificate_V1_0_0_To_CS (RedfishCS_char *JsonRawText, RedfishCertificate_V1_0_0_Certificate_CS **ReturnedCS);

## C Structure to Redfish Certificate V1_0_0 JSON Function
    RedfishCS_status
    CS_To_Certificate_V1_0_0_JSON (RedfishCertificate_V1_0_0_Certificate_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Certificate V1_0_0 C Structure Function
    RedfishCS_status
