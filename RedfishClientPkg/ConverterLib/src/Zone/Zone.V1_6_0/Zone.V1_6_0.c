...
#include"Redfish_Zone_v1_6_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishZone_V1_6_0_Zone_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #Zone.AddEndpoint
//
static RedfishCS_status GenAddEndpointCs(RedfishZone_V1_6_0_Zone_CS *Cs, json_t *JsonObj, char *Key, RedfishZone_V1_6_0_AddEndpoint_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishZone_V1_6_0_AddEndpoint_CS), (RedfishCS_void **)Dst);
...
//
//Generate C structure for #Zone.RemoveEndpoint
//
static RedfishCS_status GenRemoveEndpointCs(RedfishZone_V1_6_0_Zone_CS *Cs, json_t *JsonObj, char *Key, RedfishZone_V1_6_0_RemoveEndpoint_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishZone_V1_6_0_RemoveEndpoint_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishZone_V1_6_0_Zone_CS *Cs, json_t *JsonObj, char *Key, RedfishZone_V1_6_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishZone_V1_6_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishZone_V1_6_0_Zone_CS *Cs, json_t *JsonObj, char *Key, RedfishZone_V1_6_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishZone_V1_6_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #Zone.AddEndpoint
  Status = GenAddEndpointCs (Cs, TempJsonObj, "#Zone.AddEndpoint", &(*Dst)->Zone_AddEndpoint);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // #Zone.RemoveEndpoint
  Status = GenRemoveEndpointCs (Cs, TempJsonObj, "#Zone.RemoveEndpoint", &(*Dst)->Zone_RemoveEndpoint);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenLinksCs(RedfishZone_V1_6_0_Zone_CS *Cs, json_t *JsonObj, char *Key, RedfishZone_V1_6_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishZone_V1_6_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AddressPools
  ...
  // ContainedByZones
  InitializeLinkHead (&(*Dst)->ContainedByZones);
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "ContainedByZones", Cs->Header.ThisUri, &(*Dst)->ContainedByZones);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ContainedByZones@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "ContainedByZones@odata.count", &(*Dst)->ContainedByZonesodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ContainsZones
  InitializeLinkHead (&(*Dst)->ContainsZones);
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "ContainsZones", Cs->Header.ThisUri, &(*Dst)->ContainsZones);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ContainsZones@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "ContainsZones@odata.count", &(*Dst)->ContainsZonesodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishZone_V1_6_0_Zone_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishZone_V1_6_0_Zone_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishZone_V1_6_0_Zone_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishZone_V1_6_0_Zone_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishZone_V1_6_0_Zone_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishZone_V1_6_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsZone_AddEndpoint(json_t *CsJson, char *Key, RedfishZone_V1_6_0_AddEndpoint_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsZone_RemoveEndpoint(json_t *CsJson, char *Key, RedfishZone_V1_6_0_RemoveEndpoint_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishZone_V1_6_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // #Zone.AddEndpoint
  if (CS_To_JSON_ActionsZone_AddEndpoint(CsJson, "#Zone.AddEndpoint", CSPtr->Zone_AddEndpoint) != RedfishCS_status_success) {goto Error;}

  // #Zone.RemoveEndpoint
  if (CS_To_JSON_ActionsZone_RemoveEndpoint(CsJson, "#Zone.RemoveEndpoint", CSPtr->Zone_RemoveEndpoint) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishZone_V1_6_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // ContainedByZones 
  if (InsertJsonLinkArrayObj (CsJson, "ContainedByZones", &CSPtr->ContainedByZones) != RedfishCS_status_success) {goto Error;}

  // ContainedByZones@odata.count 
  if (InsertJsonInt64Obj (CsJson, "ContainedByZones@odata.count", CSPtr->ContainedByZonesodata_count) != RedfishCS_status_success) {goto Error;}

  // ContainsZones 
  if (InsertJsonLinkArrayObj (CsJson, "ContainsZones", &CSPtr->ContainsZones) != RedfishCS_status_success) {goto Error;}

  // ContainsZones@odata.count 
  if (InsertJsonInt64Obj (CsJson, "ContainsZones@odata.count", CSPtr->ContainsZonesodata_count) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for Zone.V1_6_0.Zone
//
RedfishCS_status CS_To_Zone_V1_6_0_JSON(RedfishZone_V1_6_0_Zone_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  if (InsertJsonBoolObj (CsJson, "DefaultRoutingEnabled", CSPtr->DefaultRoutingEnabled) != RedfishCS_status_success) {goto Error;}

  // Description 
  if (InsertJsonStringObj (CsJson, "Description", CSPtr->Description) != RedfishCS_status_success) {goto Error;}

  // ExternalAccessibility 
  if (InsertJsonStringObj (CsJson, "ExternalAccessibility", CSPtr->ExternalAccessibility) != RedfishCS_status_success) {goto Error;}
  ...
  // ZoneType 
  if (InsertJsonStringObj (CsJson, "ZoneType", CSPtr->ZoneType) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for Zone.V1_6_0.Zone
//
RedfishCS_status DestroyZone_V1_6_0_CS(RedfishZone_V1_6_0_Zone_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Zone.V1_6_0.Zone
//
RedfishCS_status DestroyZone_V1_6_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Zone.V1_6_0.Zone
//
RedfishCS_status
Json_Zone_V1_6_0_To_CS(RedfishCS_char *JsonRawText, RedfishZone_V1_6_0_Zone_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishZone_V1_6_0_Zone_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Zone", "v1_6_0", "Zone", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishZone_V1_6_0_Zone_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // DefaultRoutingEnabled
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "DefaultRoutingEnabled", &Cs->DefaultRoutingEnabled);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // ExternalAccessibility
  Status = GetRedfishPropertyStr (Cs, JsonObj, "ExternalAccessibility", &Cs->ExternalAccessibility);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // ZoneType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "ZoneType", &Cs->ZoneType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
