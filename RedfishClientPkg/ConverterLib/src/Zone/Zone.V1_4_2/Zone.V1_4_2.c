...
#include"Redfish_Zone_v1_4_2_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishZone_V1_4_2_Zone_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishZone_V1_4_2_Zone_CS *Cs, json_t *JsonObj, char *Key, RedfishZone_V1_4_2_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishZone_V1_4_2_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishZone_V1_4_2_Zone_CS *Cs, json_t *JsonObj, char *Key, RedfishZone_V1_4_2_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishZone_V1_4_2_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishZone_V1_4_2_Zone_CS *Cs, json_t *JsonObj, char *Key, RedfishZone_V1_4_2_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishZone_V1_4_2_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AddressPools
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishZone_V1_4_2_Zone_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishZone_V1_4_2_Zone_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishZone_V1_4_2_Zone_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishZone_V1_4_2_Zone_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishZone_V1_4_2_Zone_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishZone_V1_4_2_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishZone_V1_4_2_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishZone_V1_4_2_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Zone.V1_4_2.Zone
//
RedfishCS_status CS_To_Zone_V1_4_2_JSON(RedfishZone_V1_4_2_Zone_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Zone.V1_4_2.Zone
//
RedfishCS_status DestroyZone_V1_4_2_CS(RedfishZone_V1_4_2_Zone_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Zone.V1_4_2.Zone
//
RedfishCS_status DestroyZone_V1_4_2_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Zone.V1_4_2.Zone
//
RedfishCS_status
Json_Zone_V1_4_2_To_CS(RedfishCS_char *JsonRawText, RedfishZone_V1_4_2_Zone_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishZone_V1_4_2_Zone_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Zone", "v1_4_2", "Zone", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishZone_V1_4_2_Zone_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
