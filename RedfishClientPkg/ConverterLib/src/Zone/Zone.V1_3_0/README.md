# Definition of Zone.V1_3_0 and functions<br><br>
...
## Actions
    typedef struct _RedfishZone_V1_3_0_Actions_CS {
        RedfishZone_V1_3_0_OemActions_CS *Oem;
    } RedfishZone_V1_3_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishZone_V1_3_0_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Zone
    typedef struct _RedfishZone_V1_3_0_Zone_CS {
        ...
        RedfishZone_V1_3_0_Actions_CS *Actions;
        RedfishCS_char *Description;
        RedfishCS_char *ExternalAccessibility;
        RedfishCS_char *Id;
        RedfishCS_Link Identifiers;
        RedfishZone_V1_3_0_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
...
|**Actions**|RedfishZone_V1_3_0_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishZone_V1_3_0_Links_CS| Structure points to **Links** property.| No| No
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**Status**|RedfishResource_Status_CS| Structure points to **Status** property.| No| No
## Redfish Zone V1_3_0 to C Structure Function
    RedfishCS_status
    Json_Zone_V1_3_0_To_CS (RedfishCS_char *JsonRawText, RedfishZone_V1_3_0_Zone_CS **ReturnedCS);

## C Structure to Redfish Zone V1_3_0 JSON Function
    RedfishCS_status
    CS_To_Zone_V1_3_0_JSON (RedfishZone_V1_3_0_Zone_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Zone V1_3_0 C Structure Function
    RedfishCS_status
