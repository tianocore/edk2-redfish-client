...
#include"Redfish_Power_v1_1_10_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishPower_V1_1_10_Power_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenidRef_ArrayCs(RedfishPower_V1_1_10_Power_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_Array_CS **Dst);
static RedfishCS_status GenStatusCs(RedfishPower_V1_1_10_Power_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst);
//
...
//
static RedfishCS_status GenPowerLimitCs(RedfishPower_V1_1_10_Power_CS *Cs, json_t *JsonObj, char *Key, RedfishPower_V1_1_10_PowerLimit_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPower_V1_1_10_PowerLimit_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // CorrectionInMs
...
//
static RedfishCS_status GenPowerMetricCs(RedfishPower_V1_1_10_Power_CS *Cs, json_t *JsonObj, char *Key, RedfishPower_V1_1_10_PowerMetric_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPower_V1_1_10_PowerMetric_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
static RedfishCS_status GenidRef_Array_ElementCs(RedfishPower_V1_1_10_Power_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishPower_V1_1_10_Power_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenidRefCs(RedfishPower_V1_1_10_Power_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishPower_V1_1_10_Power_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishPower_V1_1_10_Power_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
static RedfishCS_status GenPowerControl_Array_ElementCs(RedfishPower_V1_1_10_Power_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPower_V1_1_10_PowerControl_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPower_V1_1_10_PowerControl_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // @odata.id
...
//
//Generate C structure for RedfishPower_V1_1_10_PowerControl_Array_CS
//
static RedfishCS_status GenPowerControl_ArrayCs(RedfishPower_V1_1_10_Power_CS *Cs, json_t *JsonObj, char *Key, RedfishPower_V1_1_10_PowerControl_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPower_V1_1_10_PowerControl_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPower_V1_1_10_PowerControl_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenInputRange_Array_ElementCs(RedfishPower_V1_1_10_Power_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPower_V1_1_10_InputRange_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPower_V1_1_10_InputRange_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // InputType
...
//
//Generate C structure for RedfishPower_V1_1_10_InputRange_Array_CS
//
static RedfishCS_status GenInputRange_ArrayCs(RedfishPower_V1_1_10_Power_CS *Cs, json_t *JsonObj, char *Key, RedfishPower_V1_1_10_InputRange_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPower_V1_1_10_InputRange_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPower_V1_1_10_InputRange_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenPowerSupply_Array_ElementCs(RedfishPower_V1_1_10_Power_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPower_V1_1_10_PowerSupply_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPower_V1_1_10_PowerSupply_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // @odata.id
...
//
//Generate C structure for RedfishPower_V1_1_10_PowerSupply_Array_CS
//
static RedfishCS_status GenPowerSupply_ArrayCs(RedfishPower_V1_1_10_Power_CS *Cs, json_t *JsonObj, char *Key, RedfishPower_V1_1_10_PowerSupply_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPower_V1_1_10_PowerSupply_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPower_V1_1_10_PowerSupply_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenVoltage_Array_ElementCs(RedfishPower_V1_1_10_Power_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPower_V1_1_10_Voltage_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPower_V1_1_10_Voltage_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // @odata.id
...
//
//Generate C structure for RedfishPower_V1_1_10_Voltage_Array_CS
//
static RedfishCS_status GenVoltage_ArrayCs(RedfishPower_V1_1_10_Power_CS *Cs, json_t *JsonObj, char *Key, RedfishPower_V1_1_10_Voltage_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPower_V1_1_10_Voltage_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPower_V1_1_10_Voltage_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_PowerControlPowerLimit(json_t *CsJson, char *Key, RedfishPower_V1_1_10_PowerLimit_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_PowerControlPowerMetrics(json_t *CsJson, char *Key, RedfishPower_V1_1_10_PowerMetric_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_PowerControl(json_t *CsJson, char *Key, RedfishPower_V1_1_10_PowerControl_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPower_V1_1_10_PowerControl_Array_CS *NextArray;
  RedfishPower_V1_1_10_PowerControl_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_PowerSuppliesInputRanges(json_t *CsJson, char *Key, RedfishPower_V1_1_10_InputRange_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPower_V1_1_10_InputRange_Array_CS *NextArray;
  RedfishPower_V1_1_10_InputRange_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_PowerSupplies(json_t *CsJson, char *Key, RedfishPower_V1_1_10_PowerSupply_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPower_V1_1_10_PowerSupply_Array_CS *NextArray;
  RedfishPower_V1_1_10_PowerSupply_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_Voltages(json_t *CsJson, char *Key, RedfishPower_V1_1_10_Voltage_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPower_V1_1_10_Voltage_Array_CS *NextArray;
  RedfishPower_V1_1_10_Voltage_CS *NextArrayItem;
...
//
// C structure to JSON for Power.V1_1_10.Power
//
RedfishCS_status CS_To_Power_V1_1_10_JSON(RedfishPower_V1_1_10_Power_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Power.V1_1_10.Power
//
RedfishCS_status DestroyPower_V1_1_10_CS(RedfishPower_V1_1_10_Power_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Power.V1_1_10.Power
//
RedfishCS_status DestroyPower_V1_1_10_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Power.V1_1_10.Power
//
RedfishCS_status
Json_Power_V1_1_10_To_CS(RedfishCS_char *JsonRawText, RedfishPower_V1_1_10_Power_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPower_V1_1_10_Power_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Power", "v1_1_10", "Power", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPower_V1_1_10_Power_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
