# Definition of Power.V1_1_9 and functions<br><br>
...
## PowerControl
    typedef struct _RedfishPower_V1_1_9_PowerControl_CS {
        ...
        RedfishPower_V1_1_9_PowerLimit_CS *PowerLimit;
        RedfishPower_V1_1_9_PowerMetric_CS *PowerMetrics;
...
|**PowerLimit**|RedfishPower_V1_1_9_PowerLimit_CS| Structure points to **PowerLimit** property.| No| No
|**PowerMetrics**|RedfishPower_V1_1_9_PowerMetric_CS| Structure points to **PowerMetrics** property.| No| No
...
## PowerSupply
    typedef struct _RedfishPower_V1_1_9_PowerSupply_CS {
        ...
        RedfishPower_V1_1_9_InputRange_Array_CS *InputRanges;
...
|**InputRanges**|RedfishPower_V1_1_9_InputRange_Array_CS| Structure array points to one or more than one **RedfishPower_V1_1_9_InputRange_Array_CS** structures for property **InputRanges**.| No| No
...
## Power
    typedef struct _RedfishPower_V1_1_9_Power_CS {
        ...
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishPower_V1_1_9_PowerControl_CS *PowerControl;
        RedfishCS_int64 *PowerControlodata_count;
        RedfishPower_V1_1_9_PowerSupply_CS *PowerSupplies;
        RedfishCS_int64 *PowerSuppliesodata_count;
        RedfishCS_Link Redundancy;
        RedfishCS_int64 *Redundancyodata_count;
        RedfishPower_V1_1_9_Voltage_CS *Voltages;
...
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**PowerControl**|RedfishPower_V1_1_9_PowerControl_CS| Structure points to **PowerControl** property.| No| No
|**PowerControlodata_count**|RedfishCS_int64| 64-bit long long interger pointer to **PowerControl@odata.count** property.| No| No
|**PowerSupplies**|RedfishPower_V1_1_9_PowerSupply_CS| Structure points to **PowerSupplies** property.| No| No
|**PowerSuppliesodata_count**|RedfishCS_int64| 64-bit long long interger pointer to **PowerSupplies@odata.count** property.| No| No
|**Redundancy**|RedfishCS_Link| Structure link list to **Redundancy** property.| No| No
|**Redundancyodata_count**|RedfishCS_int64| 64-bit long long interger pointer to **Redundancy@odata.count** property.| No| No
|**Voltages**|RedfishPower_V1_1_9_Voltage_CS| Structure points to **Voltages** property.| No| No
|**Voltagesodata_count**|RedfishCS_int64| 64-bit long long interger pointer to **Voltages@odata.count** property.| No| No
## Redfish Power V1_1_9 to C Structure Function
    RedfishCS_status
    Json_Power_V1_1_9_To_CS (RedfishCS_char *JsonRawText, RedfishPower_V1_1_9_Power_CS **ReturnedCS);

## C Structure to Redfish Power V1_1_9 JSON Function
    RedfishCS_status
    CS_To_Power_V1_1_9_JSON (RedfishPower_V1_1_9_Power_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Power V1_1_9 C Structure Function
    RedfishCS_status
