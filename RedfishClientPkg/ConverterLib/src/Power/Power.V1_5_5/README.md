# Definition of Power.V1_5_5 and functions<br><br>

## Actions
    typedef struct _RedfishPower_V1_5_5_Actions_CS {
        RedfishPower_V1_5_5_OemActions_CS *Oem;
    } RedfishPower_V1_5_5_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishPower_V1_5_5_OemActions_CS| Structure points to **Oem** property.| No| No
...
## PowerControl
    typedef struct _RedfishPower_V1_5_5_PowerControl_CS {
        ...
        RedfishPower_V1_5_5_PowerControlActions_CS *Actions;
        ...
        RedfishPower_V1_5_5_PowerLimit_CS *PowerLimit;
        RedfishPower_V1_5_5_PowerMetric_CS *PowerMetrics;
...
|**Actions**|RedfishPower_V1_5_5_PowerControlActions_CS| Structure points to **Actions** property.| No| No
...
|**PowerLimit**|RedfishPower_V1_5_5_PowerLimit_CS| Structure points to **PowerLimit** property.| No| No
|**PowerMetrics**|RedfishPower_V1_5_5_PowerMetric_CS| Structure points to **PowerMetrics** property.| No| No
...
## PowerControlActions
    typedef struct _RedfishPower_V1_5_5_PowerControlActions_CS {
        RedfishPower_V1_5_5_PowerControlOemActions_CS *Oem;
    } RedfishPower_V1_5_5_PowerControlActions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishPower_V1_5_5_PowerControlOemActions_CS| Structure points to **Oem** property.| No| No
...
## PowerSupply
    typedef struct _RedfishPower_V1_5_5_PowerSupply_CS {
        RedfishCS_char *odata_id;
        RedfishPower_V1_5_5_PowerSupplyActions_CS *Actions;
        RedfishCS_Link Assembly;
        RedfishCS_int64 *EfficiencyPercent;
        RedfishCS_char *FirmwareVersion;
        RedfishCS_bool *HotPluggable;
        RedfishCS_char *IndicatorLED;
        RedfishPower_V1_5_5_InputRange_Array_CS *InputRanges;
...
| ---  | --- | --- | --- | ---
|**odata_id**|RedfishCS_char| String pointer to **@odata.id** property.| Yes| No
|**Actions**|RedfishPower_V1_5_5_PowerSupplyActions_CS| Structure points to **Actions** property.| No| No
...
|**InputRanges**|RedfishPower_V1_5_5_InputRange_Array_CS| Structure array points to one or more than one **RedfishPower_V1_5_5_InputRange_Array_CS** structures for property **InputRanges**.| No| No
...
## PowerSupplyActions
    typedef struct _RedfishPower_V1_5_5_PowerSupplyActions_CS {
        RedfishPower_V1_5_5_PowerSupplyOemActions_CS *Oem;
    } RedfishPower_V1_5_5_PowerSupplyActions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishPower_V1_5_5_PowerSupplyOemActions_CS| Structure points to **Oem** property.| No| No
...
## Voltage
    typedef struct _RedfishPower_V1_5_5_Voltage_CS {
        RedfishCS_char *odata_id;
        RedfishPower_V1_5_5_VoltageActions_CS *Actions;
...
| ---  | --- | --- | --- | ---
|**odata_id**|RedfishCS_char| String pointer to **@odata.id** property.| Yes| No
|**Actions**|RedfishPower_V1_5_5_VoltageActions_CS| Structure points to **Actions** property.| No| No
...
## VoltageActions
    typedef struct _RedfishPower_V1_5_5_VoltageActions_CS {
        RedfishPower_V1_5_5_VoltageOemActions_CS *Oem;
    } RedfishPower_V1_5_5_VoltageActions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishPower_V1_5_5_VoltageOemActions_CS| Structure points to **Oem** property.| No| No
...
## Power
    typedef struct _RedfishPower_V1_5_5_Power_CS {
        ...
        RedfishPower_V1_5_5_Actions_CS *Actions;
        RedfishCS_char *Description;
        RedfishCS_char *Id;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishPower_V1_5_5_PowerControl_CS *PowerControl;
        RedfishCS_int64 *PowerControlodata_count;
        RedfishPower_V1_5_5_PowerSupply_CS *PowerSupplies;
        RedfishCS_int64 *PowerSuppliesodata_count;
        RedfishCS_Link Redundancy;
        RedfishCS_int64 *Redundancyodata_count;
        RedfishPower_V1_5_5_Voltage_CS *Voltages;
...
|**Actions**|RedfishPower_V1_5_5_Actions_CS| Structure points to **Actions** property.| No| No
|**Description**|RedfishCS_char| String pointer to **Description** property.| No| Yes
|**Id**|RedfishCS_char| String pointer to **Id** property.| Yes| Yes
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**PowerControl**|RedfishPower_V1_5_5_PowerControl_CS| Structure points to **PowerControl** property.| No| No
|**PowerControlodata_count**|RedfishCS_int64| 64-bit long long interger pointer to **PowerControl@odata.count** property.| No| No
|**PowerSupplies**|RedfishPower_V1_5_5_PowerSupply_CS| Structure points to **PowerSupplies** property.| No| No
|**PowerSuppliesodata_count**|RedfishCS_int64| 64-bit long long interger pointer to **PowerSupplies@odata.count** property.| No| No
|**Redundancy**|RedfishCS_Link| Structure link list to **Redundancy** property.| No| No
|**Redundancyodata_count**|RedfishCS_int64| 64-bit long long interger pointer to **Redundancy@odata.count** property.| No| No
|**Voltages**|RedfishPower_V1_5_5_Voltage_CS| Structure points to **Voltages** property.| No| No
|**Voltagesodata_count**|RedfishCS_int64| 64-bit long long interger pointer to **Voltages@odata.count** property.| No| No
## Redfish Power V1_5_5 to C Structure Function
    RedfishCS_status
    Json_Power_V1_5_5_To_CS (RedfishCS_char *JsonRawText, RedfishPower_V1_5_5_Power_CS **ReturnedCS);

## C Structure to Redfish Power V1_5_5 JSON Function
    RedfishCS_status
    CS_To_Power_V1_5_5_JSON (RedfishPower_V1_5_5_Power_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Power V1_5_5 C Structure Function
    RedfishCS_status
