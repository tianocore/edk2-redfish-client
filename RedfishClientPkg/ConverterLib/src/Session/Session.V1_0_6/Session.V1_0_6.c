...
#include"Redfish_Session_v1_0_6_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishSession_V1_0_6_Session_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for Session.V1_0_6.Session
//
RedfishCS_status CS_To_Session_V1_0_6_JSON(RedfishSession_V1_0_6_Session_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Session.V1_0_6.Session
//
RedfishCS_status DestroySession_V1_0_6_CS(RedfishSession_V1_0_6_Session_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Session.V1_0_6.Session
//
RedfishCS_status DestroySession_V1_0_6_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Session.V1_0_6.Session
//
RedfishCS_status
Json_Session_V1_0_6_To_CS(RedfishCS_char *JsonRawText, RedfishSession_V1_0_6_Session_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSession_V1_0_6_Session_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Session", "v1_0_6", "Session", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSession_V1_0_6_Session_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
