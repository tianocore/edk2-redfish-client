...
#include"Redfish_Session_v1_2_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishSession_V1_2_1_Session_CS *Cs, json_t *JsonObj, char *Key, RedfishSession_V1_2_1_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSession_V1_2_1_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishSession_V1_2_1_Session_CS *Cs, json_t *JsonObj, char *Key, RedfishSession_V1_2_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSession_V1_2_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishSession_V1_2_1_Session_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishSession_V1_2_1_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishSession_V1_2_1_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Session.V1_2_1.Session
//
RedfishCS_status CS_To_Session_V1_2_1_JSON(RedfishSession_V1_2_1_Session_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Session.V1_2_1.Session
//
RedfishCS_status DestroySession_V1_2_1_CS(RedfishSession_V1_2_1_Session_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Session.V1_2_1.Session
//
RedfishCS_status DestroySession_V1_2_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Session.V1_2_1.Session
//
RedfishCS_status
Json_Session_V1_2_1_To_CS(RedfishCS_char *JsonRawText, RedfishSession_V1_2_1_Session_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSession_V1_2_1_Session_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Session", "v1_2_1", "Session", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSession_V1_2_1_Session_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
