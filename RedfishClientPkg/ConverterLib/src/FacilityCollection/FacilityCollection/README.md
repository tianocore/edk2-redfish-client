# Definition of FacilityCollection and functions<br><br>
...
## Redfish FacilityCollection  to C Structure Function
    RedfishCS_status
    Json_FacilityCollection_To_CS (RedfishCS_char *JsonRawText, RedfishFacilityCollection_FacilityCollection_CS **ReturnedCS);

## C Structure to Redfish FacilityCollection  JSON Function
    RedfishCS_status
    CS_To_FacilityCollection_JSON (RedfishFacilityCollection_FacilityCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish FacilityCollection  C Structure Function
    RedfishCS_status
