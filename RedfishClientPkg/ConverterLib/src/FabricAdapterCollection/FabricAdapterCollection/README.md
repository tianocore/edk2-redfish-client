# Definition of FabricAdapterCollection and functions<br><br>
...
## Redfish FabricAdapterCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish FabricAdapterCollection  JSON Function
    RedfishCS_status
    CS_To_FabricAdapterCollection_JSON (RedfishFabricAdapterCollection_FabricAdapterCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish FabricAdapterCollection  C Structure Function
    RedfishCS_status
