...
#include"Redfish_FabricAdapterCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishFabricAdapterCollection_FabricAdapterCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for FabricAdapterCollection.FabricAdapterCollection
//
RedfishCS_status CS_To_FabricAdapterCollection_JSON(RedfishFabricAdapterCollection_FabricAdapterCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for FabricAdapterCollection.FabricAdapterCollection
//
RedfishCS_status DestroyFabricAdapterCollection_CS(RedfishFabricAdapterCollection_FabricAdapterCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for FabricAdapterCollection.FabricAdapterCollection
//
RedfishCS_status DestroyFabricAdapterCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for FabricAdapterCollection.NOVERSIONED.FabricAdapterCollection
//
RedfishCS_status
Json_FabricAdapterCollection_To_CS(RedfishCS_char *JsonRawText, RedfishFabricAdapterCollection_FabricAdapterCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishFabricAdapterCollection_FabricAdapterCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "FabricAdapterCollection", "noversioned", "FabricAdapterCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishFabricAdapterCollection_FabricAdapterCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyFabricAdapterCollection_CS (Cs);
  return Status;
}
