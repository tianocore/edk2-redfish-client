...
#include"Redfish_AggregationSource_v1_2_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishAggregationSource_V1_2_0_AggregationSource_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishAggregationSource_V1_2_0_AggregationSource_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregationSource_V1_2_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregationSource_V1_2_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishAggregationSource_V1_2_0_AggregationSource_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregationSource_V1_2_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregationSource_V1_2_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishAggregationSource_V1_2_0_AggregationSource_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregationSource_V1_2_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregationSource_V1_2_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ConnectionMethod
  InitializeLinkHead (&(*Dst)->ConnectionMethod);
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "ConnectionMethod", Cs->Header.ThisUri, &(*Dst)->ConnectionMethod);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // ResourcesAccessed
  InitializeLinkHead (&(*Dst)->ResourcesAccessed);
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "ResourcesAccessed", Cs->Header.ThisUri, &(*Dst)->ResourcesAccessed);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ResourcesAccessed@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "ResourcesAccessed@odata.count", &(*Dst)->ResourcesAccessedodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenSNMPSettingsCs(RedfishAggregationSource_V1_2_0_AggregationSource_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregationSource_V1_2_0_SNMPSettings_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregationSource_V1_2_0_SNMPSettings_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AuthenticationKey
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishAggregationSource_V1_2_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishAggregationSource_V1_2_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishAggregationSource_V1_2_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // ConnectionMethod 
  if (InsertJsonLinkObj (CsJson, "ConnectionMethod", &CSPtr->ConnectionMethod) != RedfishCS_status_success) {goto Error;}

  // Oem
  if (CS_To_JSON_LinksOem(CsJson, "Oem", CSPtr->Oem) != RedfishCS_status_success) {goto Error;}

  // ResourcesAccessed 
  if (InsertJsonLinkArrayObj (CsJson, "ResourcesAccessed", &CSPtr->ResourcesAccessed) != RedfishCS_status_success) {goto Error;}

  // ResourcesAccessed@odata.count 
  if (InsertJsonInt64Obj (CsJson, "ResourcesAccessed@odata.count", CSPtr->ResourcesAccessedodata_count) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_SNMP(json_t *CsJson, char *Key, RedfishAggregationSource_V1_2_0_SNMPSettings_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for AggregationSource.V1_2_0.AggregationSource
//
RedfishCS_status CS_To_AggregationSource_V1_2_0_JSON(RedfishAggregationSource_V1_2_0_AggregationSource_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // AggregationType 
  if (InsertJsonStringObj (CsJson, "AggregationType", CSPtr->AggregationType) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for AggregationSource.V1_2_0.AggregationSource
//
RedfishCS_status DestroyAggregationSource_V1_2_0_CS(RedfishAggregationSource_V1_2_0_AggregationSource_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for AggregationSource.V1_2_0.AggregationSource
//
RedfishCS_status DestroyAggregationSource_V1_2_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for AggregationSource.V1_2_0.AggregationSource
//
RedfishCS_status
Json_AggregationSource_V1_2_0_To_CS(RedfishCS_char *JsonRawText, RedfishAggregationSource_V1_2_0_AggregationSource_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAggregationSource_V1_2_0_AggregationSource_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "AggregationSource", "v1_2_0", "AggregationSource", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAggregationSource_V1_2_0_AggregationSource_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // AggregationType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "AggregationType", &Cs->AggregationType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyAggregationSource_V1_2_0_CS (Cs);
  return Status;
}
