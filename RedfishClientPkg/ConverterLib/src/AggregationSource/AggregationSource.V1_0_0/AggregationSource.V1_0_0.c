...
#include"Redfish_AggregationSource_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishAggregationSource_V1_0_0_AggregationSource_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishAggregationSource_V1_0_0_AggregationSource_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregationSource_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregationSource_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishAggregationSource_V1_0_0_AggregationSource_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregationSource_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregationSource_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishAggregationSource_V1_0_0_AggregationSource_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregationSource_V1_0_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregationSource_V1_0_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ConnectionMethod
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishAggregationSource_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishAggregationSource_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishAggregationSource_V1_0_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for AggregationSource.V1_0_0.AggregationSource
//
RedfishCS_status CS_To_AggregationSource_V1_0_0_JSON(RedfishAggregationSource_V1_0_0_AggregationSource_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for AggregationSource.V1_0_0.AggregationSource
//
RedfishCS_status DestroyAggregationSource_V1_0_0_CS(RedfishAggregationSource_V1_0_0_AggregationSource_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for AggregationSource.V1_0_0.AggregationSource
//
RedfishCS_status DestroyAggregationSource_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for AggregationSource.V1_0_0.AggregationSource
//
RedfishCS_status
Json_AggregationSource_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishAggregationSource_V1_0_0_AggregationSource_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAggregationSource_V1_0_0_AggregationSource_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "AggregationSource", "v1_0_0", "AggregationSource", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAggregationSource_V1_0_0_AggregationSource_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyAggregationSource_V1_0_0_CS (Cs);
  return Status;
}
