...
#include"Redfish_AccelerationFunction_v1_0_2_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishAccelerationFunction_V1_0_2_AccelerationFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishAccelerationFunction_V1_0_2_AccelerationFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishAccelerationFunction_V1_0_2_AccelerationFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishAccelerationFunction_V1_0_2_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAccelerationFunction_V1_0_2_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishAccelerationFunction_V1_0_2_AccelerationFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishAccelerationFunction_V1_0_2_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAccelerationFunction_V1_0_2_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishAccelerationFunction_V1_0_2_AccelerationFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishAccelerationFunction_V1_0_2_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAccelerationFunction_V1_0_2_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Endpoints
...
//
static RedfishCS_status GenidRefCs(RedfishAccelerationFunction_V1_0_2_AccelerationFunction_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishAccelerationFunction_V1_0_2_AccelerationFunction_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishAccelerationFunction_V1_0_2_AccelerationFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishAccelerationFunction_V1_0_2_AccelerationFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishAccelerationFunction_V1_0_2_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishAccelerationFunction_V1_0_2_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishAccelerationFunction_V1_0_2_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for AccelerationFunction.V1_0_2.AccelerationFunction
//
RedfishCS_status CS_To_AccelerationFunction_V1_0_2_JSON(RedfishAccelerationFunction_V1_0_2_AccelerationFunction_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  if (InsertJsonStringObj (CsJson, "AccelerationFunctionType", CSPtr->AccelerationFunctionType) != RedfishCS_status_success) {goto Error;}
  ...
  if (InsertJsonStringArrayObj (CsJson, "FpgaReconfigurationSlots", CSPtr->FpgaReconfigurationSlots) != RedfishCS_status_success) {goto Error;}
  ...
  // PowerWatts 
  if (InsertJsonInt64Obj (CsJson, "PowerWatts", CSPtr->PowerWatts) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for AccelerationFunction.V1_0_2.AccelerationFunction
//
RedfishCS_status DestroyAccelerationFunction_V1_0_2_CS(RedfishAccelerationFunction_V1_0_2_AccelerationFunction_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for AccelerationFunction.V1_0_2.AccelerationFunction
//
RedfishCS_status DestroyAccelerationFunction_V1_0_2_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for AccelerationFunction.V1_0_2.AccelerationFunction
//
RedfishCS_status
Json_AccelerationFunction_V1_0_2_To_CS(RedfishCS_char *JsonRawText, RedfishAccelerationFunction_V1_0_2_AccelerationFunction_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAccelerationFunction_V1_0_2_AccelerationFunction_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "AccelerationFunction", "v1_0_2", "AccelerationFunction", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAccelerationFunction_V1_0_2_AccelerationFunction_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // AccelerationFunctionType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "AccelerationFunctionType", &Cs->AccelerationFunctionType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // FpgaReconfigurationSlots
  Status = GenRedfishCS_char_ArrayCs (Cs, JsonObj, "FpgaReconfigurationSlots", &Cs->FpgaReconfigurationSlots);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // PowerWatts
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "PowerWatts", &Cs->PowerWatts);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyAccelerationFunction_V1_0_2_CS (Cs);
  return Status;
}
