# Definition of VirtualMedia.V1_4_2 and functions<br><br>
...
## Actions
    typedef struct _RedfishVirtualMedia_V1_4_2_Actions_CS {
        ...
        RedfishVirtualMedia_V1_4_2_OemActions_CS *Oem;
    } RedfishVirtualMedia_V1_4_2_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**VirtualMedia_EjectMedia**|RedfishVirtualMedia_V1_4_2_EjectMedia_CS| Structure points to **#VirtualMedia.EjectMedia** property.| No| No
|**VirtualMedia_InsertMedia**|RedfishVirtualMedia_V1_4_2_InsertMedia_CS| Structure points to **#VirtualMedia.InsertMedia** property.| No| No
|**Oem**|RedfishVirtualMedia_V1_4_2_OemActions_CS| Structure points to **Oem** property.| No| No
...
## VirtualMedia
    typedef struct _RedfishVirtualMedia_V1_4_2_VirtualMedia_CS {
        ...
        RedfishVirtualMedia_V1_4_2_Actions_CS *Actions;
...
|**Actions**|RedfishVirtualMedia_V1_4_2_Actions_CS| Structure points to **Actions** property.| No| No
...
## Redfish VirtualMedia V1_4_2 to C Structure Function
    RedfishCS_status
    Json_VirtualMedia_V1_4_2_To_CS (RedfishCS_char *JsonRawText, RedfishVirtualMedia_V1_4_2_VirtualMedia_CS **ReturnedCS);

## C Structure to Redfish VirtualMedia V1_4_2 JSON Function
    RedfishCS_status
    CS_To_VirtualMedia_V1_4_2_JSON (RedfishVirtualMedia_V1_4_2_VirtualMedia_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish VirtualMedia V1_4_2 C Structure Function
    RedfishCS_status
