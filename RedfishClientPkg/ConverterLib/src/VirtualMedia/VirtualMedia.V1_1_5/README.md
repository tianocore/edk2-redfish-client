# Definition of VirtualMedia.V1_1_5 and functions<br><br>
...
## Actions
    typedef struct _RedfishVirtualMedia_V1_1_5_Actions_CS {
        RedfishVirtualMedia_V1_1_5_OemActions_CS *Oem;
    } RedfishVirtualMedia_V1_1_5_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishVirtualMedia_V1_1_5_OemActions_CS| Structure points to **Oem** property.| No| No
...
## VirtualMedia
    typedef struct _RedfishVirtualMedia_V1_1_5_VirtualMedia_CS {
        ...
        RedfishVirtualMedia_V1_1_5_Actions_CS *Actions;
...
|**Actions**|RedfishVirtualMedia_V1_1_5_Actions_CS| Structure points to **Actions** property.| No| No
...
## Redfish VirtualMedia V1_1_5 to C Structure Function
    RedfishCS_status
    Json_VirtualMedia_V1_1_5_To_CS (RedfishCS_char *JsonRawText, RedfishVirtualMedia_V1_1_5_VirtualMedia_CS **ReturnedCS);

## C Structure to Redfish VirtualMedia V1_1_5 JSON Function
    RedfishCS_status
    CS_To_VirtualMedia_V1_1_5_JSON (RedfishVirtualMedia_V1_1_5_VirtualMedia_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish VirtualMedia V1_1_5 C Structure Function
    RedfishCS_status
