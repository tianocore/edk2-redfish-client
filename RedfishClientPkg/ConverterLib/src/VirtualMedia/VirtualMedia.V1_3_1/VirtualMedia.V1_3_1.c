...
#include"Redfish_VirtualMedia_v1_3_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenEjectMediaCs(RedfishVirtualMedia_V1_3_1_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, RedfishVirtualMedia_V1_3_1_EjectMedia_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVirtualMedia_V1_3_1_EjectMedia_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenInsertMediaCs(RedfishVirtualMedia_V1_3_1_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, RedfishVirtualMedia_V1_3_1_InsertMedia_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVirtualMedia_V1_3_1_InsertMedia_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishVirtualMedia_V1_3_1_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, RedfishVirtualMedia_V1_3_1_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVirtualMedia_V1_3_1_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishVirtualMedia_V1_3_1_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, RedfishVirtualMedia_V1_3_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVirtualMedia_V1_3_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishVirtualMedia_V1_3_1_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishVirtualMedia_V1_3_1_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsVirtualMedia_EjectMedia(json_t *CsJson, char *Key, RedfishVirtualMedia_V1_3_1_EjectMedia_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsVirtualMedia_InsertMedia(json_t *CsJson, char *Key, RedfishVirtualMedia_V1_3_1_InsertMedia_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishVirtualMedia_V1_3_1_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for VirtualMedia.V1_3_1.VirtualMedia
//
RedfishCS_status CS_To_VirtualMedia_V1_3_1_JSON(RedfishVirtualMedia_V1_3_1_VirtualMedia_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for VirtualMedia.V1_3_1.VirtualMedia
//
RedfishCS_status DestroyVirtualMedia_V1_3_1_CS(RedfishVirtualMedia_V1_3_1_VirtualMedia_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for VirtualMedia.V1_3_1.VirtualMedia
//
RedfishCS_status DestroyVirtualMedia_V1_3_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for VirtualMedia.V1_3_1.VirtualMedia
//
RedfishCS_status
Json_VirtualMedia_V1_3_1_To_CS(RedfishCS_char *JsonRawText, RedfishVirtualMedia_V1_3_1_VirtualMedia_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishVirtualMedia_V1_3_1_VirtualMedia_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "VirtualMedia", "v1_3_1", "VirtualMedia", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishVirtualMedia_V1_3_1_VirtualMedia_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyVirtualMedia_V1_3_1_CS (Cs);
  return Status;
}
