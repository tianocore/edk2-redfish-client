...
#include"Redfish_VirtualMedia_v1_0_6_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishVirtualMedia_V1_0_6_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for VirtualMedia.V1_0_6.VirtualMedia
//
RedfishCS_status CS_To_VirtualMedia_V1_0_6_JSON(RedfishVirtualMedia_V1_0_6_VirtualMedia_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for VirtualMedia.V1_0_6.VirtualMedia
//
RedfishCS_status DestroyVirtualMedia_V1_0_6_CS(RedfishVirtualMedia_V1_0_6_VirtualMedia_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for VirtualMedia.V1_0_6.VirtualMedia
//
RedfishCS_status DestroyVirtualMedia_V1_0_6_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for VirtualMedia.V1_0_6.VirtualMedia
//
RedfishCS_status
Json_VirtualMedia_V1_0_6_To_CS(RedfishCS_char *JsonRawText, RedfishVirtualMedia_V1_0_6_VirtualMedia_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishVirtualMedia_V1_0_6_VirtualMedia_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "VirtualMedia", "v1_0_6", "VirtualMedia", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishVirtualMedia_V1_0_6_VirtualMedia_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyVirtualMedia_V1_0_6_CS (Cs);
  return Status;
}
