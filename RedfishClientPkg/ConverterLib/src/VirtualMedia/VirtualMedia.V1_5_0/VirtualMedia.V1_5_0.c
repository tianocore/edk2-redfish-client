...
#include"Redfish_VirtualMedia_v1_5_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishVirtualMedia_V1_5_0_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #VirtualMedia.EjectMedia
//
static RedfishCS_status GenEjectMediaCs(RedfishVirtualMedia_V1_5_0_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, RedfishVirtualMedia_V1_5_0_EjectMedia_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVirtualMedia_V1_5_0_EjectMedia_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenInsertMediaCs(RedfishVirtualMedia_V1_5_0_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, RedfishVirtualMedia_V1_5_0_InsertMedia_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVirtualMedia_V1_5_0_InsertMedia_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishVirtualMedia_V1_5_0_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, RedfishVirtualMedia_V1_5_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVirtualMedia_V1_5_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishVirtualMedia_V1_5_0_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, RedfishVirtualMedia_V1_5_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVirtualMedia_V1_5_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishVirtualMedia_V1_5_0_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishVirtualMedia_V1_5_0_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishVirtualMedia_V1_5_0_VirtualMedia_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishVirtualMedia_V1_5_0_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishVirtualMedia_V1_5_0_VirtualMedia_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishVirtualMedia_V1_5_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsVirtualMedia_EjectMedia(json_t *CsJson, char *Key, RedfishVirtualMedia_V1_5_0_EjectMedia_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsVirtualMedia_InsertMedia(json_t *CsJson, char *Key, RedfishVirtualMedia_V1_5_0_InsertMedia_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishVirtualMedia_V1_5_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for VirtualMedia.V1_5_0.VirtualMedia
//
RedfishCS_status CS_To_VirtualMedia_V1_5_0_JSON(RedfishVirtualMedia_V1_5_0_VirtualMedia_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // TransferMethod 
  if (InsertJsonStringObj (CsJson, "TransferMethod", CSPtr->TransferMethod) != RedfishCS_status_success) {goto Error;}

  // TransferProtocolType 
  if (InsertJsonStringObj (CsJson, "TransferProtocolType", CSPtr->TransferProtocolType) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for VirtualMedia.V1_5_0.VirtualMedia
//
RedfishCS_status DestroyVirtualMedia_V1_5_0_CS(RedfishVirtualMedia_V1_5_0_VirtualMedia_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for VirtualMedia.V1_5_0.VirtualMedia
//
RedfishCS_status DestroyVirtualMedia_V1_5_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for VirtualMedia.V1_5_0.VirtualMedia
//
RedfishCS_status
Json_VirtualMedia_V1_5_0_To_CS(RedfishCS_char *JsonRawText, RedfishVirtualMedia_V1_5_0_VirtualMedia_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishVirtualMedia_V1_5_0_VirtualMedia_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "VirtualMedia", "v1_5_0", "VirtualMedia", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishVirtualMedia_V1_5_0_VirtualMedia_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // TransferMethod
  Status = GetRedfishPropertyStr (Cs, JsonObj, "TransferMethod", &Cs->TransferMethod);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // TransferProtocolType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "TransferProtocolType", &Cs->TransferProtocolType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyVirtualMedia_V1_5_0_CS (Cs);
  return Status;
}
