...
#include"Redfish_JsonSchemaFile_v1_0_6_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishJsonSchemaFile_V1_0_6_JsonSchemaFile_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenLocation_Array_ElementCs(RedfishJsonSchemaFile_V1_0_6_JsonSchemaFile_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishJsonSchemaFile_V1_0_6_Location_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishJsonSchemaFile_V1_0_6_Location_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ArchiveFile
...
//
//Generate C structure for RedfishJsonSchemaFile_V1_0_6_Location_Array_CS
//
static RedfishCS_status GenLocation_ArrayCs(RedfishJsonSchemaFile_V1_0_6_JsonSchemaFile_CS *Cs, json_t *JsonObj, char *Key, RedfishJsonSchemaFile_V1_0_6_Location_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishJsonSchemaFile_V1_0_6_Location_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishJsonSchemaFile_V1_0_6_Location_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenOemCs(RedfishJsonSchemaFile_V1_0_6_JsonSchemaFile_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
...
static RedfishCS_status CS_To_JSON_Location(json_t *CsJson, char *Key, RedfishJsonSchemaFile_V1_0_6_Location_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishJsonSchemaFile_V1_0_6_Location_Array_CS *NextArray;
  RedfishJsonSchemaFile_V1_0_6_Location_CS *NextArrayItem;
...
//
// C structure to JSON for JsonSchemaFile.V1_0_6.JsonSchemaFile
//
RedfishCS_status CS_To_JsonSchemaFile_V1_0_6_JSON(RedfishJsonSchemaFile_V1_0_6_JsonSchemaFile_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for JsonSchemaFile.V1_0_6.JsonSchemaFile
//
RedfishCS_status DestroyJsonSchemaFile_V1_0_6_CS(RedfishJsonSchemaFile_V1_0_6_JsonSchemaFile_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for JsonSchemaFile.V1_0_6.JsonSchemaFile
//
RedfishCS_status DestroyJsonSchemaFile_V1_0_6_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for JsonSchemaFile.V1_0_6.JsonSchemaFile
//
RedfishCS_status
Json_JsonSchemaFile_V1_0_6_To_CS(RedfishCS_char *JsonRawText, RedfishJsonSchemaFile_V1_0_6_JsonSchemaFile_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishJsonSchemaFile_V1_0_6_JsonSchemaFile_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "JsonSchemaFile", "v1_0_6", "JsonSchemaFile", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishJsonSchemaFile_V1_0_6_JsonSchemaFile_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyJsonSchemaFile_V1_0_6_CS (Cs);
  return Status;
}
