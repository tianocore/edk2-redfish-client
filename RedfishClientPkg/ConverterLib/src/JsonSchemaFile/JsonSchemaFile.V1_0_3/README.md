# Definition of JsonSchemaFile.V1_0_3 and functions<br><br>
...
## JsonSchemaFile
    typedef struct _RedfishJsonSchemaFile_V1_0_3_JsonSchemaFile_CS {
        ...
        RedfishJsonSchemaFile_V1_0_3_Location_CS *Location;
        RedfishCS_char *Name;
...
|**Location**|RedfishJsonSchemaFile_V1_0_3_Location_CS| Structure points to **Location** property.| Yes| No
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**Schema**|RedfishCS_char| String pointer to **Schema** property.| Yes| Yes
## Redfish JsonSchemaFile V1_0_3 to C Structure Function
    RedfishCS_status
    Json_JsonSchemaFile_V1_0_3_To_CS (RedfishCS_char *JsonRawText, RedfishJsonSchemaFile_V1_0_3_JsonSchemaFile_CS **ReturnedCS);

## C Structure to Redfish JsonSchemaFile V1_0_3 JSON Function
    RedfishCS_status
    CS_To_JsonSchemaFile_V1_0_3_JSON (RedfishJsonSchemaFile_V1_0_3_JsonSchemaFile_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish JsonSchemaFile V1_0_3 C Structure Function
    RedfishCS_status
