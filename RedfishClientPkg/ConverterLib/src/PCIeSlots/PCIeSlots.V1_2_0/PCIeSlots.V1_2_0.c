...
#include"Redfish_PCIeSlots_v1_2_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishPCIeSlots_V1_2_0_PCIeSlots_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishPCIeSlots_V1_2_0_PCIeSlots_CS *Cs, json_t *JsonObj, char *Key, RedfishPCIeSlots_V1_2_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPCIeSlots_V1_2_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishPCIeSlots_V1_2_0_PCIeSlots_CS *Cs, json_t *JsonObj, char *Key, RedfishPCIeSlots_V1_2_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPCIeSlots_V1_2_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenPCIeLinksCs(RedfishPCIeSlots_V1_2_0_PCIeSlots_CS *Cs, json_t *JsonObj, char *Key, RedfishPCIeSlots_V1_2_0_PCIeLinks_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPCIeSlots_V1_2_0_PCIeLinks_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishPCIeSlots_V1_2_0_PCIeSlots_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishPCIeSlots_V1_2_0_PCIeSlots_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishPCIeSlots_V1_2_0_PCIeSlots_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishPCIeSlots_V1_2_0_PCIeSlots_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishPCIeSlots_V1_2_0_PCIeSlots_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenPCIeSlot_Array_ElementCs(RedfishPCIeSlots_V1_2_0_PCIeSlots_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPCIeSlots_V1_2_0_PCIeSlot_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPCIeSlots_V1_2_0_PCIeSlot_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // HotPluggable
...
//
//Generate C structure for RedfishPCIeSlots_V1_2_0_PCIeSlot_Array_CS
//
static RedfishCS_status GenPCIeSlot_ArrayCs(RedfishPCIeSlots_V1_2_0_PCIeSlots_CS *Cs, json_t *JsonObj, char *Key, RedfishPCIeSlots_V1_2_0_PCIeSlot_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPCIeSlots_V1_2_0_PCIeSlot_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPCIeSlots_V1_2_0_PCIeSlot_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishPCIeSlots_V1_2_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishPCIeSlots_V1_2_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_SlotsLinks(json_t *CsJson, char *Key, RedfishPCIeSlots_V1_2_0_PCIeLinks_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Slots(json_t *CsJson, char *Key, RedfishPCIeSlots_V1_2_0_PCIeSlot_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPCIeSlots_V1_2_0_PCIeSlot_Array_CS *NextArray;
  RedfishPCIeSlots_V1_2_0_PCIeSlot_CS *NextArrayItem;
...
//
// C structure to JSON for PCIeSlots.V1_2_0.PCIeSlots
//
RedfishCS_status CS_To_PCIeSlots_V1_2_0_JSON(RedfishPCIeSlots_V1_2_0_PCIeSlots_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for PCIeSlots.V1_2_0.PCIeSlots
//
RedfishCS_status DestroyPCIeSlots_V1_2_0_CS(RedfishPCIeSlots_V1_2_0_PCIeSlots_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PCIeSlots.V1_2_0.PCIeSlots
//
RedfishCS_status DestroyPCIeSlots_V1_2_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PCIeSlots.V1_2_0.PCIeSlots
//
RedfishCS_status
Json_PCIeSlots_V1_2_0_To_CS(RedfishCS_char *JsonRawText, RedfishPCIeSlots_V1_2_0_PCIeSlots_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPCIeSlots_V1_2_0_PCIeSlots_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PCIeSlots", "v1_2_0", "PCIeSlots", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPCIeSlots_V1_2_0_PCIeSlots_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
