# Definition of PCIeSlots.V1_1_0 and functions<br><br>

## Actions
    typedef struct _RedfishPCIeSlots_V1_1_0_Actions_CS {
        RedfishPCIeSlots_V1_1_0_OemActions_CS *Oem;
    } RedfishPCIeSlots_V1_1_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishPCIeSlots_V1_1_0_OemActions_CS| Structure points to **Oem** property.| No| No
...
## PCIeSlot
    typedef struct _RedfishPCIeSlots_V1_1_0_PCIeSlot_CS {
        ...
        RedfishPCIeSlots_V1_1_0_PCIeLinks_CS *Links;
...
|**Links**|RedfishPCIeSlots_V1_1_0_PCIeLinks_CS| Structure points to **Links** property.| No| No
...
## PCIeSlots
    typedef struct _RedfishPCIeSlots_V1_1_0_PCIeSlots_CS {
        ...
        RedfishPCIeSlots_V1_1_0_Actions_CS *Actions;
        RedfishCS_char *Description;
        RedfishCS_bool *HotPluggable;
        RedfishCS_char *Id;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishPCIeSlots_V1_1_0_PCIeSlot_CS *Slots;
...
|**Actions**|RedfishPCIeSlots_V1_1_0_Actions_CS| Structure points to **Actions** property.| No| No
|**Description**|RedfishCS_char| String pointer to **Description** property.| No| Yes
|**HotPluggable**|RedfishCS_bool| Boolean pointer to **HotPluggable** property.| No| Yes
|**Id**|RedfishCS_char| String pointer to **Id** property.| Yes| Yes
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**Slots**|RedfishPCIeSlots_V1_1_0_PCIeSlot_CS| Structure points to **Slots** property.| No| No
## Redfish PCIeSlots V1_1_0 to C Structure Function
    RedfishCS_status
    Json_PCIeSlots_V1_1_0_To_CS (RedfishCS_char *JsonRawText, RedfishPCIeSlots_V1_1_0_PCIeSlots_CS **ReturnedCS);

## C Structure to Redfish PCIeSlots V1_1_0 JSON Function
    RedfishCS_status
    CS_To_PCIeSlots_V1_1_0_JSON (RedfishPCIeSlots_V1_1_0_PCIeSlots_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish PCIeSlots V1_1_0 C Structure Function
    RedfishCS_status
