...
#include"Redfish_SimpleStorage_v1_1_6_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishSimpleStorage_V1_1_6_SimpleStorage_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenStatusCs(RedfishSimpleStorage_V1_1_6_SimpleStorage_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst);
//
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishSimpleStorage_V1_1_6_SimpleStorage_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishSimpleStorage_V1_1_6_SimpleStorage_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishSimpleStorage_V1_1_6_SimpleStorage_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishSimpleStorage_V1_1_6_SimpleStorage_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
static RedfishCS_status GenDevice_Array_ElementCs(RedfishSimpleStorage_V1_1_6_SimpleStorage_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishSimpleStorage_V1_1_6_Device_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishSimpleStorage_V1_1_6_Device_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // CapacityBytes
...
//
//Generate C structure for RedfishSimpleStorage_V1_1_6_Device_Array_CS
//
static RedfishCS_status GenDevice_ArrayCs(RedfishSimpleStorage_V1_1_6_SimpleStorage_CS *Cs, json_t *JsonObj, char *Key, RedfishSimpleStorage_V1_1_6_Device_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishSimpleStorage_V1_1_6_Device_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishSimpleStorage_V1_1_6_Device_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_Devices(json_t *CsJson, char *Key, RedfishSimpleStorage_V1_1_6_Device_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishSimpleStorage_V1_1_6_Device_Array_CS *NextArray;
  RedfishSimpleStorage_V1_1_6_Device_CS *NextArrayItem;
...
//
// C structure to JSON for SimpleStorage.V1_1_6.SimpleStorage
//
RedfishCS_status CS_To_SimpleStorage_V1_1_6_JSON(RedfishSimpleStorage_V1_1_6_SimpleStorage_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for SimpleStorage.V1_1_6.SimpleStorage
//
RedfishCS_status DestroySimpleStorage_V1_1_6_CS(RedfishSimpleStorage_V1_1_6_SimpleStorage_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for SimpleStorage.V1_1_6.SimpleStorage
//
RedfishCS_status DestroySimpleStorage_V1_1_6_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for SimpleStorage.V1_1_6.SimpleStorage
//
RedfishCS_status
Json_SimpleStorage_V1_1_6_To_CS(RedfishCS_char *JsonRawText, RedfishSimpleStorage_V1_1_6_SimpleStorage_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSimpleStorage_V1_1_6_SimpleStorage_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "SimpleStorage", "v1_1_6", "SimpleStorage", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSimpleStorage_V1_1_6_SimpleStorage_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroySimpleStorage_V1_1_6_CS (Cs);
  return Status;
}
