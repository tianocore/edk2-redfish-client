...
#include"Redfish_EventDestination_v1_1_7_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishEventDestination_V1_1_7_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
...
static RedfishCS_status GenHttpHeaderProperty_Array_ElementCs(RedfishEventDestination_V1_1_7_EventDestination_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishEventDestination_V1_1_7_HttpHeaderProperty_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishEventDestination_V1_1_7_HttpHeaderProperty_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
//Generate C structure for RedfishEventDestination_V1_1_7_HttpHeaderProperty_Array_CS
//
static RedfishCS_status GenHttpHeaderProperty_ArrayCs(RedfishEventDestination_V1_1_7_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishEventDestination_V1_1_7_HttpHeaderProperty_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishEventDestination_V1_1_7_HttpHeaderProperty_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishEventDestination_V1_1_7_HttpHeaderProperty_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenOemCs(RedfishEventDestination_V1_1_7_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
...
static RedfishCS_status GenidRef_Array_ElementCs(RedfishEventDestination_V1_1_7_EventDestination_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRef_ArrayCs(RedfishEventDestination_V1_1_7_EventDestination_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
static RedfishCS_status CS_To_JSON_HttpHeaders(json_t *CsJson, char *Key, RedfishEventDestination_V1_1_7_HttpHeaderProperty_Array_CS *CSPtr)
{
...
//
// C structure to JSON for EventDestination.V1_1_7.EventDestination
//
RedfishCS_status CS_To_EventDestination_V1_1_7_JSON(RedfishEventDestination_V1_1_7_EventDestination_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for EventDestination.V1_1_7.EventDestination
//
RedfishCS_status DestroyEventDestination_V1_1_7_CS(RedfishEventDestination_V1_1_7_EventDestination_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for EventDestination.V1_1_7.EventDestination
//
RedfishCS_status DestroyEventDestination_V1_1_7_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for EventDestination.V1_1_7.EventDestination
//
RedfishCS_status
Json_EventDestination_V1_1_7_To_CS(RedfishCS_char *JsonRawText, RedfishEventDestination_V1_1_7_EventDestination_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEventDestination_V1_1_7_EventDestination_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "EventDestination", "v1_1_7", "EventDestination", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEventDestination_V1_1_7_EventDestination_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyEventDestination_V1_1_7_CS (Cs);
  return Status;
}
