# Definition of EventDestination.V1_9_1 and functions<br><br>
...
|**HttpHeaders**|RedfishEventDestination_V1_9_1_HttpHeaderProperty_CS| Structure points to **HttpHeaders** property.| No| No
