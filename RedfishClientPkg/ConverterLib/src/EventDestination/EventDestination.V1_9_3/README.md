# Definition of EventDestination.V1_9_3 and functions<br><br>
...
## Actions
    typedef struct _RedfishEventDestination_V1_9_3_Actions_CS {
        ...
        RedfishEventDestination_V1_9_3_OemActions_CS *Oem;
    } RedfishEventDestination_V1_9_3_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**EventDestination_ResumeSubscription**|RedfishEventDestination_V1_9_3_ResumeSubscription_CS| Structure points to **#EventDestination.ResumeSubscription** property.| No| No
|**Oem**|RedfishEventDestination_V1_9_3_OemActions_CS| Structure points to **Oem** property.| No| No
...
## EventDestination
    typedef struct _RedfishEventDestination_V1_9_3_EventDestination_CS {
        ...
        RedfishEventDestination_V1_9_3_Actions_CS *Actions;
        ...
        RedfishEventDestination_V1_9_3_HttpHeaderProperty_CS *HttpHeaders;
        RedfishCS_char *Id;
        ...
        RedfishEventDestination_V1_9_3_SNMPSettings_CS *SNMP;
        RedfishResource_Status_CS *Status;
        RedfishCS_bool *SubordinateResources;
        RedfishCS_char *SubscriptionType;
        RedfishEventDestination_V1_9_3_SyslogFilter_CS *SyslogFilters;
...
|**Actions**|RedfishEventDestination_V1_9_3_Actions_CS| Structure points to **Actions** property.| No| No
...
|**HttpHeaders**|RedfishEventDestination_V1_9_3_HttpHeaderProperty_CS| Structure points to **HttpHeaders** property.| No| No
...
|**SNMP**|RedfishEventDestination_V1_9_3_SNMPSettings_CS| Structure points to **SNMP** property.| No| No
...
|**SyslogFilters**|RedfishEventDestination_V1_9_3_SyslogFilter_CS| Structure points to **SyslogFilters** property.| No| No
|**VerifyCertificate**|RedfishCS_bool| Boolean pointer to **VerifyCertificate** property.| No| No
## Redfish EventDestination V1_9_3 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish EventDestination V1_9_3 JSON Function
    RedfishCS_status
    CS_To_EventDestination_V1_9_3_JSON (RedfishEventDestination_V1_9_3_EventDestination_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish EventDestination V1_9_3 C Structure Function
    RedfishCS_status
