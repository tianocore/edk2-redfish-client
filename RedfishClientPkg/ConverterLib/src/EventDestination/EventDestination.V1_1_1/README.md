# Definition of EventDestination.V1_1_1 and functions<br><br>
...
## EventDestination
    typedef struct _RedfishEventDestination_V1_1_1_EventDestination_CS {
        ...
        RedfishEventDestination_V1_1_1_HttpHeaderProperty_CS *HttpHeaders;
        RedfishCS_char *Id;
...
|**HttpHeaders**|RedfishEventDestination_V1_1_1_HttpHeaderProperty_CS| Structure points to **HttpHeaders** property.| No| No
...
## Redfish EventDestination V1_1_1 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish EventDestination V1_1_1 JSON Function
    RedfishCS_status
    CS_To_EventDestination_V1_1_1_JSON (RedfishEventDestination_V1_1_1_EventDestination_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish EventDestination V1_1_1 C Structure Function
    RedfishCS_status
