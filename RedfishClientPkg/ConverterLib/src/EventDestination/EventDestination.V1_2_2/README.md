# Definition of EventDestination.V1_2_2 and functions<br><br>
...
| ---  | --- | --- | --- | ---
|**Oem**|RedfishEventDestination_V1_2_2_OemActions_CS| Structure points to **Oem** property.| No| No
...
## EventDestination
    typedef struct _RedfishEventDestination_V1_2_2_EventDestination_CS {
        ...
        RedfishEventDestination_V1_2_2_Actions_CS *Actions;
        RedfishCS_char *Context;
        RedfishCS_char *Description;
        RedfishCS_char *Destination;
        RedfishCS_char *EventTypes;
        RedfishEventDestination_V1_2_2_HttpHeaderProperty_CS *HttpHeaders;
        RedfishCS_char *Id;
...
|**Actions**|RedfishEventDestination_V1_2_2_Actions_CS| Structure points to **Actions** property.| No| No
...
|**HttpHeaders**|RedfishEventDestination_V1_2_2_HttpHeaderProperty_CS| Structure points to **HttpHeaders** property.| No| No
...
## Redfish EventDestination V1_2_2 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish EventDestination V1_2_2 JSON Function
    RedfishCS_status
    CS_To_EventDestination_V1_2_2_JSON (RedfishEventDestination_V1_2_2_EventDestination_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish EventDestination V1_2_2 C Structure Function
    RedfishCS_status
