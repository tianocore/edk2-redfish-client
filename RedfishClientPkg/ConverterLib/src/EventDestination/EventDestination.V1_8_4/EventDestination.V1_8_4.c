...
#include"Redfish_EventDestination_v1_8_4_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishEventDestination_V1_8_4_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenOemCs(RedfishEventDestination_V1_8_4_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #EventDestination.ResumeSubscription
//
static RedfishCS_status GenResumeSubscriptionCs(RedfishEventDestination_V1_8_4_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishEventDestination_V1_8_4_ResumeSubscription_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventDestination_V1_8_4_ResumeSubscription_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishEventDestination_V1_8_4_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishEventDestination_V1_8_4_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventDestination_V1_8_4_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishEventDestination_V1_8_4_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishEventDestination_V1_8_4_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventDestination_V1_8_4_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
static RedfishCS_status GenHttpHeaderProperty_Array_ElementCs(RedfishEventDestination_V1_8_4_EventDestination_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishEventDestination_V1_8_4_HttpHeaderProperty_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishEventDestination_V1_8_4_HttpHeaderProperty_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  InitializeLinkHead (&(*Dst)->Prop);
...
//
//Generate C structure for RedfishEventDestination_V1_8_4_HttpHeaderProperty_Array_CS
//
static RedfishCS_status GenHttpHeaderProperty_ArrayCs(RedfishEventDestination_V1_8_4_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishEventDestination_V1_8_4_HttpHeaderProperty_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishEventDestination_V1_8_4_HttpHeaderProperty_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishEventDestination_V1_8_4_HttpHeaderProperty_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenidRef_Array_ElementCs(RedfishEventDestination_V1_8_4_EventDestination_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRef_ArrayCs(RedfishEventDestination_V1_8_4_EventDestination_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenSNMPSettingsCs(RedfishEventDestination_V1_8_4_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishEventDestination_V1_8_4_SNMPSettings_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventDestination_V1_8_4_SNMPSettings_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AuthenticationKey
...
//
static RedfishCS_status GenidRefCs(RedfishEventDestination_V1_8_4_EventDestination_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishEventDestination_V1_8_4_EventDestination_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishEventDestination_V1_8_4_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishEventDestination_V1_8_4_EventDestination_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsEventDestination_ResumeSubscription(json_t *CsJson, char *Key, RedfishEventDestination_V1_8_4_ResumeSubscription_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishEventDestination_V1_8_4_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishEventDestination_V1_8_4_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_HttpHeaders(json_t *CsJson, char *Key, RedfishEventDestination_V1_8_4_HttpHeaderProperty_Array_CS *CSPtr)
{
  // No JSON property for this structure.
  return RedfishCS_status_success;
}
...
static RedfishCS_status CS_To_JSON_SNMP(json_t *CsJson, char *Key, RedfishEventDestination_V1_8_4_SNMPSettings_CS *CSPtr)
{
  json_t *CsParentJson;
...
//
// C structure to JSON for EventDestination.V1_8_4.EventDestination
//
RedfishCS_status CS_To_EventDestination_V1_8_4_JSON(RedfishEventDestination_V1_8_4_EventDestination_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for EventDestination.V1_8_4.EventDestination
//
RedfishCS_status DestroyEventDestination_V1_8_4_CS(RedfishEventDestination_V1_8_4_EventDestination_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for EventDestination.V1_8_4.EventDestination
//
RedfishCS_status DestroyEventDestination_V1_8_4_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for EventDestination.V1_8_4.EventDestination
//
RedfishCS_status
Json_EventDestination_V1_8_4_To_CS(RedfishCS_char *JsonRawText, RedfishEventDestination_V1_8_4_EventDestination_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEventDestination_V1_8_4_EventDestination_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "EventDestination", "v1_8_4", "EventDestination", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEventDestination_V1_8_4_EventDestination_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyEventDestination_V1_8_4_CS (Cs);
  return Status;
}
