...
#include"Redfish_NetworkDeviceFunction_v1_7_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunction_V1_7_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkDeviceFunction_V1_7_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunction_V1_7_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkDeviceFunction_V1_7_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenEthernetCs(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunction_V1_7_0_Ethernet_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkDeviceFunction_V1_7_0_Ethernet_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // EthernetInterfaces
  InitializeLinkHead (&(*Dst)->EthernetInterfaces);
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "EthernetInterfaces", Cs->Header.ThisUri, &(*Dst)->EthernetInterfaces);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // MTUSizeMaximum
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "MTUSizeMaximum", &(*Dst)->MTUSizeMaximum);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status GenBootTargets_Array_ElementCs(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishNetworkDeviceFunction_V1_7_0_BootTargets_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishNetworkDeviceFunction_V1_7_0_BootTargets_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // BootPriority
...
//
//Generate C structure for RedfishNetworkDeviceFunction_V1_7_0_BootTargets_Array_CS
//
static RedfishCS_status GenBootTargets_ArrayCs(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunction_V1_7_0_BootTargets_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishNetworkDeviceFunction_V1_7_0_BootTargets_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishNetworkDeviceFunction_V1_7_0_BootTargets_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenFibreChannelCs(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunction_V1_7_0_FibreChannel_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkDeviceFunction_V1_7_0_FibreChannel_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//Generate C structure for RedfishCS_int64_Array
//
static RedfishCS_status GenRedfishCS_int64_ArrayCs(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_int64_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
//Generate C structure for InfiniBand
//
static RedfishCS_status GenInfiniBandCs(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunction_V1_7_0_InfiniBand_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkDeviceFunction_V1_7_0_InfiniBand_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MTUSize
  ...
  // NodeGUID
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "NodeGUID", &(*Dst)->NodeGUID);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // PermanentNodeGUID
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "PermanentNodeGUID", &(*Dst)->PermanentNodeGUID);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // PermanentPortGUID
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "PermanentPortGUID", &(*Dst)->PermanentPortGUID);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // PermanentSystemGUID
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "PermanentSystemGUID", &(*Dst)->PermanentSystemGUID);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // PortGUID
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "PortGUID", &(*Dst)->PortGUID);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // SupportedMTUSizes
  Status = GenRedfishCS_int64_ArrayCs (Cs, TempJsonObj, "SupportedMTUSizes", &(*Dst)->SupportedMTUSizes);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // SystemGUID
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "SystemGUID", &(*Dst)->SystemGUID);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status GenLimit_Array_ElementCs(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishNetworkDeviceFunction_V1_7_0_Limit_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishNetworkDeviceFunction_V1_7_0_Limit_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // BurstBytesPerSecond
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "BurstBytesPerSecond", &(*Dst)->BurstBytesPerSecond);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // BurstPacketsPerSecond
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "BurstPacketsPerSecond", &(*Dst)->BurstPacketsPerSecond);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Direction
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "Direction", &(*Dst)->Direction);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // SustainedBytesPerSecond
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "SustainedBytesPerSecond", &(*Dst)->SustainedBytesPerSecond);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // SustainedPacketsPerSecond
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "SustainedPacketsPerSecond", &(*Dst)->SustainedPacketsPerSecond);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishNetworkDeviceFunction_V1_7_0_Limit_Array_CS
//
static RedfishCS_status GenLimit_ArrayCs(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunction_V1_7_0_Limit_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishNetworkDeviceFunction_V1_7_0_Limit_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishNetworkDeviceFunction_V1_7_0_Limit_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
  ...
  ThisElement = *Dst;
  for (Index = 0; Index < ArraySize; Index ++) {
    Status = GenLimit_Array_ElementCs(Cs, TempJsonObj, Index, &ThisElement->ArrayValue);
    if (Status != RedfishCS_status_success){
      goto Error;
    }
    ThisElement = ThisElement->Next;
...
//
static RedfishCS_status GenLinksCs(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunction_V1_7_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkDeviceFunction_V1_7_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Endpoints
  ...
  // EthernetInterface
  InitializeLinkHead (&(*Dst)->EthernetInterface);
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "EthernetInterface", Cs->Header.ThisUri, &(*Dst)->EthernetInterface);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // OffloadProcessors
  InitializeLinkHead (&(*Dst)->OffloadProcessors);
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "OffloadProcessors", Cs->Header.ThisUri, &(*Dst)->OffloadProcessors);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // OffloadProcessors@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "OffloadProcessors@odata.count", &(*Dst)->OffloadProcessorsodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // OffloadSystem
  InitializeLinkHead (&(*Dst)->OffloadSystem);
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "OffloadSystem", Cs->Header.ThisUri, &(*Dst)->OffloadSystem);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  InitializeLinkHead (&(*Dst)->PhysicalNetworkPortAssignment);
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "PhysicalNetworkPortAssignment", Cs->Header.ThisUri, &(*Dst)->PhysicalNetworkPortAssignment);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenidRefCs(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GeniSCSIBootCs(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunction_V1_7_0_iSCSIBoot_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkDeviceFunction_V1_7_0_iSCSIBoot_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishNetworkDeviceFunction_V1_7_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishNetworkDeviceFunction_V1_7_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Ethernet(json_t *CsJson, char *Key, RedfishNetworkDeviceFunction_V1_7_0_Ethernet_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // MTUSizeMaximum 
  if (InsertJsonInt64Obj (CsJson, "MTUSizeMaximum", CSPtr->MTUSizeMaximum) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_FibreChannelBootTargets(json_t *CsJson, char *Key, RedfishNetworkDeviceFunction_V1_7_0_BootTargets_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishNetworkDeviceFunction_V1_7_0_BootTargets_Array_CS *NextArray;
  RedfishNetworkDeviceFunction_V1_7_0_BootTargets_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_FibreChannel(json_t *CsJson, char *Key, RedfishNetworkDeviceFunction_V1_7_0_FibreChannel_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_InfiniBand(json_t *CsJson, char *Key, RedfishNetworkDeviceFunction_V1_7_0_InfiniBand_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // NodeGUID 
  if (InsertJsonStringObj (CsJson, "NodeGUID", CSPtr->NodeGUID) != RedfishCS_status_success) {goto Error;}

  // PermanentNodeGUID 
  if (InsertJsonStringObj (CsJson, "PermanentNodeGUID", CSPtr->PermanentNodeGUID) != RedfishCS_status_success) {goto Error;}

  // PermanentPortGUID 
  if (InsertJsonStringObj (CsJson, "PermanentPortGUID", CSPtr->PermanentPortGUID) != RedfishCS_status_success) {goto Error;}

  // PermanentSystemGUID 
  if (InsertJsonStringObj (CsJson, "PermanentSystemGUID", CSPtr->PermanentSystemGUID) != RedfishCS_status_success) {goto Error;}

  // PortGUID 
  if (InsertJsonStringObj (CsJson, "PortGUID", CSPtr->PortGUID) != RedfishCS_status_success) {goto Error;}

  // SupportedMTUSizes 
  if (InsertJsonInt64ArrayObj (CsJson, "SupportedMTUSizes", CSPtr->SupportedMTUSizes) != RedfishCS_status_success) {goto Error;}

  // SystemGUID 
  if (InsertJsonStringObj (CsJson, "SystemGUID", CSPtr->SystemGUID) != RedfishCS_status_success) {goto Error;}

  return RedfishCS_status_success;
Error:;
  return RedfishCS_status_unsupported;
}
static RedfishCS_status CS_To_JSON_Limits(json_t *CsJson, char *Key, RedfishNetworkDeviceFunction_V1_7_0_Limit_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishNetworkDeviceFunction_V1_7_0_Limit_Array_CS *NextArray;
  RedfishNetworkDeviceFunction_V1_7_0_Limit_CS *NextArrayItem;
  ...
  do {
    ...
    NextArrayItem = NextArray->ArrayValue;
    // BurstBytesPerSecond 
    if (InsertJsonInt64Obj (ArrayMember, "BurstBytesPerSecond", NextArrayItem->BurstBytesPerSecond) != RedfishCS_status_success) {goto Error;}

    // BurstPacketsPerSecond 
    if (InsertJsonInt64Obj (ArrayMember, "BurstPacketsPerSecond", NextArrayItem->BurstPacketsPerSecond) != RedfishCS_status_success) {goto Error;}

    // Direction 
    if (InsertJsonStringObj (ArrayMember, "Direction", NextArrayItem->Direction) != RedfishCS_status_success) {goto Error;}

    // SustainedBytesPerSecond 
    if (InsertJsonInt64Obj (ArrayMember, "SustainedBytesPerSecond", NextArrayItem->SustainedBytesPerSecond) != RedfishCS_status_success) {goto Error;}

    // SustainedPacketsPerSecond 
    if (InsertJsonInt64Obj (ArrayMember, "SustainedPacketsPerSecond", NextArrayItem->SustainedPacketsPerSecond) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishNetworkDeviceFunction_V1_7_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // EthernetInterface 
  if (InsertJsonLinkObj (CsJson, "EthernetInterface", &CSPtr->EthernetInterface) != RedfishCS_status_success) {goto Error;}
  ...
  // OffloadProcessors 
  if (InsertJsonLinkArrayObj (CsJson, "OffloadProcessors", &CSPtr->OffloadProcessors) != RedfishCS_status_success) {goto Error;}

  // OffloadProcessors@odata.count 
  if (InsertJsonInt64Obj (CsJson, "OffloadProcessors@odata.count", CSPtr->OffloadProcessorsodata_count) != RedfishCS_status_success) {goto Error;}

  // OffloadSystem 
  if (InsertJsonLinkObj (CsJson, "OffloadSystem", &CSPtr->OffloadSystem) != RedfishCS_status_success) {goto Error;}

  // PCIeFunction 
  if (InsertJsonLinkObj (CsJson, "PCIeFunction", &CSPtr->PCIeFunction) != RedfishCS_status_success) {goto Error;}

  // PhysicalNetworkPortAssignment 
  if (InsertJsonLinkObj (CsJson, "PhysicalNetworkPortAssignment", &CSPtr->PhysicalNetworkPortAssignment) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_iSCSIBoot(json_t *CsJson, char *Key, RedfishNetworkDeviceFunction_V1_7_0_iSCSIBoot_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for NetworkDeviceFunction.V1_7_0.NetworkDeviceFunction
//
RedfishCS_status CS_To_NetworkDeviceFunction_V1_7_0_JSON(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // AllowDeny 
  if (InsertJsonLinkObj (CsJson, "AllowDeny", &CSPtr->AllowDeny) != RedfishCS_status_success) {goto Error;}

  // AssignablePhysicalNetworkPorts 
  if (InsertJsonLinkArrayObj (CsJson, "AssignablePhysicalNetworkPorts", &CSPtr->AssignablePhysicalNetworkPorts) != RedfishCS_status_success) {goto Error;}

  // AssignablePhysicalNetworkPorts@odata.count 
  if (InsertJsonInt64Obj (CsJson, "AssignablePhysicalNetworkPorts@odata.count", CSPtr->AssignablePhysicalNetworkPortsodata_count) != RedfishCS_status_success) {goto Error;}
  ...
  // InfiniBand
  if (CS_To_JSON_InfiniBand(CsJson, "InfiniBand", CSPtr->InfiniBand) != RedfishCS_status_success) {goto Error;}

  // Limits
  if (CS_To_JSON_Limits(CsJson, "Limits", CSPtr->Limits) != RedfishCS_status_success) {goto Error;}
  ...
  // SAVIEnabled 
  if (InsertJsonBoolObj (CsJson, "SAVIEnabled", CSPtr->SAVIEnabled) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for NetworkDeviceFunction.V1_7_0.NetworkDeviceFunction
//
RedfishCS_status DestroyNetworkDeviceFunction_V1_7_0_CS(RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for NetworkDeviceFunction.V1_7_0.NetworkDeviceFunction
//
RedfishCS_status DestroyNetworkDeviceFunction_V1_7_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for NetworkDeviceFunction.V1_7_0.NetworkDeviceFunction
//
RedfishCS_status
Json_NetworkDeviceFunction_V1_7_0_To_CS(RedfishCS_char *JsonRawText, RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "NetworkDeviceFunction", "v1_7_0", "NetworkDeviceFunction", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishNetworkDeviceFunction_V1_7_0_NetworkDeviceFunction_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // AllowDeny
  InitializeLinkHead (&Cs->AllowDeny);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "AllowDeny", Cs->Header.ThisUri, &Cs->AllowDeny);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // AssignablePhysicalNetworkPorts
  InitializeLinkHead (&Cs->AssignablePhysicalNetworkPorts);
  Status = CreateCsUriOrJsonByNodeArray (Cs, JsonObj, "AssignablePhysicalNetworkPorts", Cs->Header.ThisUri, &Cs->AssignablePhysicalNetworkPorts);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // AssignablePhysicalNetworkPorts@odata.count
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "AssignablePhysicalNetworkPorts@odata.count", &Cs->AssignablePhysicalNetworkPortsodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // InfiniBand
  Status = GenInfiniBandCs (Cs, JsonObj, "InfiniBand", &Cs->InfiniBand);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Limits
  Status = GenLimit_ArrayCs (Cs, JsonObj, "Limits", &Cs->Limits);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // PhysicalNetworkPortAssignment
  InitializeLinkHead (&Cs->PhysicalNetworkPortAssignment);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "PhysicalNetworkPortAssignment", Cs->Header.ThisUri, &Cs->PhysicalNetworkPortAssignment);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // SAVIEnabled
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "SAVIEnabled", &Cs->SAVIEnabled);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyNetworkDeviceFunction_V1_7_0_CS (Cs);
  return Status;
}
