...
#include"Redfish_NetworkDeviceFunction_v1_4_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishNetworkDeviceFunction_V1_4_1_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenOemCs(RedfishNetworkDeviceFunction_V1_4_1_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishNetworkDeviceFunction_V1_4_1_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunction_V1_4_1_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkDeviceFunction_V1_4_1_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishNetworkDeviceFunction_V1_4_1_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunction_V1_4_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkDeviceFunction_V1_4_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenEthernetCs(RedfishNetworkDeviceFunction_V1_4_1_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunction_V1_4_1_Ethernet_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkDeviceFunction_V1_4_1_Ethernet_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MACAddress
...
static RedfishCS_status GenBootTargets_Array_ElementCs(RedfishNetworkDeviceFunction_V1_4_1_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishNetworkDeviceFunction_V1_4_1_BootTargets_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishNetworkDeviceFunction_V1_4_1_BootTargets_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // BootPriority
...
//
//Generate C structure for RedfishNetworkDeviceFunction_V1_4_1_BootTargets_Array_CS
//
static RedfishCS_status GenBootTargets_ArrayCs(RedfishNetworkDeviceFunction_V1_4_1_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunction_V1_4_1_BootTargets_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishNetworkDeviceFunction_V1_4_1_BootTargets_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishNetworkDeviceFunction_V1_4_1_BootTargets_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenFibreChannelCs(RedfishNetworkDeviceFunction_V1_4_1_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunction_V1_4_1_FibreChannel_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkDeviceFunction_V1_4_1_FibreChannel_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenLinksCs(RedfishNetworkDeviceFunction_V1_4_1_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunction_V1_4_1_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkDeviceFunction_V1_4_1_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Endpoints
...
//
static RedfishCS_status GenidRefCs(RedfishNetworkDeviceFunction_V1_4_1_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishNetworkDeviceFunction_V1_4_1_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishNetworkDeviceFunction_V1_4_1_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishNetworkDeviceFunction_V1_4_1_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GeniSCSIBootCs(RedfishNetworkDeviceFunction_V1_4_1_NetworkDeviceFunction_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunction_V1_4_1_iSCSIBoot_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkDeviceFunction_V1_4_1_iSCSIBoot_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishNetworkDeviceFunction_V1_4_1_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishNetworkDeviceFunction_V1_4_1_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Ethernet(json_t *CsJson, char *Key, RedfishNetworkDeviceFunction_V1_4_1_Ethernet_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_FibreChannelBootTargets(json_t *CsJson, char *Key, RedfishNetworkDeviceFunction_V1_4_1_BootTargets_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishNetworkDeviceFunction_V1_4_1_BootTargets_Array_CS *NextArray;
  RedfishNetworkDeviceFunction_V1_4_1_BootTargets_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_FibreChannel(json_t *CsJson, char *Key, RedfishNetworkDeviceFunction_V1_4_1_FibreChannel_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishNetworkDeviceFunction_V1_4_1_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_iSCSIBoot(json_t *CsJson, char *Key, RedfishNetworkDeviceFunction_V1_4_1_iSCSIBoot_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for NetworkDeviceFunction.V1_4_1.NetworkDeviceFunction
//
RedfishCS_status CS_To_NetworkDeviceFunction_V1_4_1_JSON(RedfishNetworkDeviceFunction_V1_4_1_NetworkDeviceFunction_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for NetworkDeviceFunction.V1_4_1.NetworkDeviceFunction
//
RedfishCS_status DestroyNetworkDeviceFunction_V1_4_1_CS(RedfishNetworkDeviceFunction_V1_4_1_NetworkDeviceFunction_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for NetworkDeviceFunction.V1_4_1.NetworkDeviceFunction
//
RedfishCS_status DestroyNetworkDeviceFunction_V1_4_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for NetworkDeviceFunction.V1_4_1.NetworkDeviceFunction
//
RedfishCS_status
Json_NetworkDeviceFunction_V1_4_1_To_CS(RedfishCS_char *JsonRawText, RedfishNetworkDeviceFunction_V1_4_1_NetworkDeviceFunction_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishNetworkDeviceFunction_V1_4_1_NetworkDeviceFunction_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "NetworkDeviceFunction", "v1_4_1", "NetworkDeviceFunction", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishNetworkDeviceFunction_V1_4_1_NetworkDeviceFunction_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyNetworkDeviceFunction_V1_4_1_CS (Cs);
  return Status;
}
