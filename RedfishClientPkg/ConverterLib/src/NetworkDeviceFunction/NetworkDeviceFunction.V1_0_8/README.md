# Definition of NetworkDeviceFunction.V1_0_8 and functions<br><br>
...
## FibreChannel
    typedef struct _RedfishNetworkDeviceFunction_V1_0_8_FibreChannel_CS {
        ...
        RedfishNetworkDeviceFunction_V1_0_8_BootTargets_Array_CS *BootTargets;
...
|**BootTargets**|RedfishNetworkDeviceFunction_V1_0_8_BootTargets_Array_CS| Structure array points to one or more than one **RedfishNetworkDeviceFunction_V1_0_8_BootTargets_Array_CS** structures for property **BootTargets**.| No| No
