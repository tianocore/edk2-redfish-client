# Definition of NetworkDeviceFunction.V1_3_4 and functions<br><br>
...
|**Links**|RedfishNetworkDeviceFunction_V1_3_4_Links_CS| Structure points to **Links** property.| No| No
