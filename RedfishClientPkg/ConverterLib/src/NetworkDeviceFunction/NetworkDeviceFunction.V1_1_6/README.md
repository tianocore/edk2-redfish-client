# Definition of NetworkDeviceFunction.V1_1_6 and functions<br><br>

## Actions
    typedef struct _RedfishNetworkDeviceFunction_V1_1_6_Actions_CS {
        RedfishNetworkDeviceFunction_V1_1_6_OemActions_CS *Oem;
    } RedfishNetworkDeviceFunction_V1_1_6_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishNetworkDeviceFunction_V1_1_6_OemActions_CS| Structure points to **Oem** property.| No| No
...
## FibreChannel
    typedef struct _RedfishNetworkDeviceFunction_V1_1_6_FibreChannel_CS {
        ...
        RedfishNetworkDeviceFunction_V1_1_6_BootTargets_Array_CS *BootTargets;
...
|**BootTargets**|RedfishNetworkDeviceFunction_V1_1_6_BootTargets_Array_CS| Structure array points to one or more than one **RedfishNetworkDeviceFunction_V1_1_6_BootTargets_Array_CS** structures for property **BootTargets**.| No| No
...
## NetworkDeviceFunction
    typedef struct _RedfishNetworkDeviceFunction_V1_1_6_NetworkDeviceFunction_CS {
        ...
        RedfishNetworkDeviceFunction_V1_1_6_Actions_CS *Actions;
        ...
        RedfishNetworkDeviceFunction_V1_1_6_Ethernet_CS *Ethernet;
        RedfishNetworkDeviceFunction_V1_1_6_FibreChannel_CS *FibreChannel;
        RedfishCS_char *Id;
        RedfishNetworkDeviceFunction_V1_1_6_Links_CS *Links;
        ...
        RedfishNetworkDeviceFunction_V1_1_6_iSCSIBoot_CS *iSCSIBoot;
...
|**Actions**|RedfishNetworkDeviceFunction_V1_1_6_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Ethernet**|RedfishNetworkDeviceFunction_V1_1_6_Ethernet_CS| Structure points to **Ethernet** property.| No| No
|**FibreChannel**|RedfishNetworkDeviceFunction_V1_1_6_FibreChannel_CS| Structure points to **FibreChannel** property.| No| No
|**Id**|RedfishCS_char| String pointer to **Id** property.| Yes| Yes
|**Links**|RedfishNetworkDeviceFunction_V1_1_6_Links_CS| Structure points to **Links** property.| No| No
...
|**iSCSIBoot**|RedfishNetworkDeviceFunction_V1_1_6_iSCSIBoot_CS| Structure points to **iSCSIBoot** property.| No| No
## Redfish NetworkDeviceFunction V1_1_6 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish NetworkDeviceFunction V1_1_6 JSON Function
    RedfishCS_status
    CS_To_NetworkDeviceFunction_V1_1_6_JSON (RedfishNetworkDeviceFunction_V1_1_6_NetworkDeviceFunction_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish NetworkDeviceFunction V1_1_6 C Structure Function
    RedfishCS_status
