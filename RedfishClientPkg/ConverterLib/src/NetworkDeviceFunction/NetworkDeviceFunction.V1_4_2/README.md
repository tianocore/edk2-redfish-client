# Definition of NetworkDeviceFunction.V1_4_2 and functions<br><br>
...
|**Links**|RedfishNetworkDeviceFunction_V1_4_2_Links_CS| Structure points to **Links** property.| No| No
