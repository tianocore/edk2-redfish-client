# Definition of NetworkDeviceFunction.V1_8_0 and functions<br><br>
...
## FibreChannel
    typedef struct _RedfishNetworkDeviceFunction_V1_8_0_FibreChannel_CS {
        ...
        RedfishNetworkDeviceFunction_V1_8_0_BootTargets_Array_CS *BootTargets;
...
|**BootTargets**|RedfishNetworkDeviceFunction_V1_8_0_BootTargets_Array_CS| Structure array points to one or more than one **RedfishNetworkDeviceFunction_V1_8_0_BootTargets_Array_CS** structures for property **BootTargets**.| No| No
...
## C Structure to Redfish NetworkDeviceFunction V1_8_0 JSON Function
    RedfishCS_status
