# Definition of NetworkDeviceFunction.V1_0_7 and functions<br><br>
...
## FibreChannel
    typedef struct _RedfishNetworkDeviceFunction_V1_0_7_FibreChannel_CS {
        ...
        RedfishNetworkDeviceFunction_V1_0_7_BootTargets_Array_CS *BootTargets;
...
|**BootTargets**|RedfishNetworkDeviceFunction_V1_0_7_BootTargets_Array_CS| Structure array points to one or more than one **RedfishNetworkDeviceFunction_V1_0_7_BootTargets_Array_CS** structures for property **BootTargets**.| No| No
...
## NetworkDeviceFunction
    typedef struct _RedfishNetworkDeviceFunction_V1_0_7_NetworkDeviceFunction_CS {
        ...
        RedfishNetworkDeviceFunction_V1_0_7_Ethernet_CS *Ethernet;
        RedfishNetworkDeviceFunction_V1_0_7_FibreChannel_CS *FibreChannel;
        RedfishCS_char *Id;
        RedfishNetworkDeviceFunction_V1_0_7_Links_CS *Links;
        ...
        RedfishNetworkDeviceFunction_V1_0_7_iSCSIBoot_CS *iSCSIBoot;
...
|**Ethernet**|RedfishNetworkDeviceFunction_V1_0_7_Ethernet_CS| Structure points to **Ethernet** property.| No| No
|**FibreChannel**|RedfishNetworkDeviceFunction_V1_0_7_FibreChannel_CS| Structure points to **FibreChannel** property.| No| No
|**Id**|RedfishCS_char| String pointer to **Id** property.| Yes| Yes
|**Links**|RedfishNetworkDeviceFunction_V1_0_7_Links_CS| Structure points to **Links** property.| No| No
...
|**iSCSIBoot**|RedfishNetworkDeviceFunction_V1_0_7_iSCSIBoot_CS| Structure points to **iSCSIBoot** property.| No| No
## Redfish NetworkDeviceFunction V1_0_7 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish NetworkDeviceFunction V1_0_7 JSON Function
    RedfishCS_status
    CS_To_NetworkDeviceFunction_V1_0_7_JSON (RedfishNetworkDeviceFunction_V1_0_7_NetworkDeviceFunction_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish NetworkDeviceFunction V1_0_7 C Structure Function
    RedfishCS_status
