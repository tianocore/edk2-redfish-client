...
#include"Redfish_Manager_v1_1_9_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishManager_V1_1_9_Manager_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenOemCs(RedfishManager_V1_1_9_Manager_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #Manager.ForceFailover
//
static RedfishCS_status GenForceFailoverCs(RedfishManager_V1_1_9_Manager_CS *Cs, json_t *JsonObj, char *Key, RedfishManager_V1_1_9_ForceFailover_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManager_V1_1_9_ForceFailover_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenModifyRedundancySetCs(RedfishManager_V1_1_9_Manager_CS *Cs, json_t *JsonObj, char *Key, RedfishManager_V1_1_9_ModifyRedundancySet_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManager_V1_1_9_ModifyRedundancySet_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenResetCs(RedfishManager_V1_1_9_Manager_CS *Cs, json_t *JsonObj, char *Key, RedfishManager_V1_1_9_Reset_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManager_V1_1_9_Reset_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishManager_V1_1_9_Manager_CS *Cs, json_t *JsonObj, char *Key, RedfishManager_V1_1_9_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManager_V1_1_9_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishManager_V1_1_9_Manager_CS *Cs, json_t *JsonObj, char *Key, RedfishManager_V1_1_9_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManager_V1_1_9_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenCommandShellCs(RedfishManager_V1_1_9_Manager_CS *Cs, json_t *JsonObj, char *Key, RedfishManager_V1_1_9_CommandShell_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManager_V1_1_9_CommandShell_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenGraphicalConsoleCs(RedfishManager_V1_1_9_Manager_CS *Cs, json_t *JsonObj, char *Key, RedfishManager_V1_1_9_GraphicalConsole_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManager_V1_1_9_GraphicalConsole_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ConnectTypesSupported
...
//
static RedfishCS_status GenLinksCs(RedfishManager_V1_1_9_Manager_CS *Cs, json_t *JsonObj, char *Key, RedfishManager_V1_1_9_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManager_V1_1_9_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ManagerForChassis
...
//
static RedfishCS_status GenSerialConsoleCs(RedfishManager_V1_1_9_Manager_CS *Cs, json_t *JsonObj, char *Key, RedfishManager_V1_1_9_SerialConsole_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManager_V1_1_9_SerialConsole_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ConnectTypesSupported
...
//
static RedfishCS_status GenidRefCs(RedfishManager_V1_1_9_Manager_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishManager_V1_1_9_Manager_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishManager_V1_1_9_Manager_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishManager_V1_1_9_Manager_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsManager_ForceFailover(json_t *CsJson, char *Key, RedfishManager_V1_1_9_ForceFailover_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsManager_ModifyRedundancySet(json_t *CsJson, char *Key, RedfishManager_V1_1_9_ModifyRedundancySet_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsManager_Reset(json_t *CsJson, char *Key, RedfishManager_V1_1_9_Reset_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishManager_V1_1_9_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishManager_V1_1_9_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_CommandShell(json_t *CsJson, char *Key, RedfishManager_V1_1_9_CommandShell_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_GraphicalConsole(json_t *CsJson, char *Key, RedfishManager_V1_1_9_GraphicalConsole_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishManager_V1_1_9_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_SerialConsole(json_t *CsJson, char *Key, RedfishManager_V1_1_9_SerialConsole_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Manager.V1_1_9.Manager
//
RedfishCS_status CS_To_Manager_V1_1_9_JSON(RedfishManager_V1_1_9_Manager_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Manager.V1_1_9.Manager
//
RedfishCS_status DestroyManager_V1_1_9_CS(RedfishManager_V1_1_9_Manager_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Manager.V1_1_9.Manager
//
RedfishCS_status DestroyManager_V1_1_9_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Manager.V1_1_9.Manager
//
RedfishCS_status
Json_Manager_V1_1_9_To_CS(RedfishCS_char *JsonRawText, RedfishManager_V1_1_9_Manager_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishManager_V1_1_9_Manager_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Manager", "v1_1_9", "Manager", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishManager_V1_1_9_Manager_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
