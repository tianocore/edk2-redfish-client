# Definition of Manager.V1_11_0 and functions<br><br>
...
## Actions
    typedef struct _RedfishManager_V1_11_0_Actions_CS {
        ...
        RedfishManager_V1_11_0_OemActions_CS *Oem;
    } RedfishManager_V1_11_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Manager_ForceFailover**|RedfishManager_V1_11_0_ForceFailover_CS| Structure points to **#Manager.ForceFailover** property.| No| No
|**Manager_ModifyRedundancySet**|RedfishManager_V1_11_0_ModifyRedundancySet_CS| Structure points to **#Manager.ModifyRedundancySet** property.| No| No
|**Manager_Reset**|RedfishManager_V1_11_0_Reset_CS| Structure points to **#Manager.Reset** property.| No| No
|**Manager_ResetToDefaults**|RedfishManager_V1_11_0_ResetToDefaults_CS| Structure points to **#Manager.ResetToDefaults** property.| No| No
|**Oem**|RedfishManager_V1_11_0_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Manager
    typedef struct _RedfishManager_V1_11_0_Manager_CS {
        ...
        RedfishManager_V1_11_0_Actions_CS *Actions;
        RedfishCS_bool *AutoDSTEnabled;
        RedfishManager_V1_11_0_CommandShell_CS *CommandShell;
        RedfishCS_char *DateTime;
        RedfishCS_char *DateTimeLocalOffset;
        RedfishCS_char *Description;
        RedfishCS_Link EthernetInterfaces;
        RedfishCS_char *FirmwareVersion;
        RedfishManager_V1_11_0_GraphicalConsole_CS *GraphicalConsole;
        RedfishCS_Link HostInterfaces;
        RedfishCS_char *Id;
        RedfishCS_char *LastResetTime;
        RedfishManager_V1_11_0_Links_CS *Links;
        ...
        RedfishManager_V1_11_0_SerialConsole_CS *SerialConsole;
...
|**Actions**|RedfishManager_V1_11_0_Actions_CS| Structure points to **Actions** property.| No| No
|**AutoDSTEnabled**|RedfishCS_bool| Boolean pointer to **AutoDSTEnabled** property.| No| No
|**CommandShell**|RedfishManager_V1_11_0_CommandShell_CS| Structure points to **CommandShell** property.| No| No
...
|**GraphicalConsole**|RedfishManager_V1_11_0_GraphicalConsole_CS| Structure points to **GraphicalConsole** property.| No| No
...
|**Links**|RedfishManager_V1_11_0_Links_CS| Structure points to **Links** property.| No| No
...
|**SerialConsole**|RedfishManager_V1_11_0_SerialConsole_CS| Structure points to **SerialConsole** property.| No| No
...
## Redfish Manager V1_11_0 to C Structure Function
    RedfishCS_status
    Json_Manager_V1_11_0_To_CS (RedfishCS_char *JsonRawText, RedfishManager_V1_11_0_Manager_CS **ReturnedCS);

## C Structure to Redfish Manager V1_11_0 JSON Function
    RedfishCS_status
    CS_To_Manager_V1_11_0_JSON (RedfishManager_V1_11_0_Manager_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Manager V1_11_0 C Structure Function
    RedfishCS_status
