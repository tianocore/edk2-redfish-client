...
#include"Redfish_KeyService_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishKeyService_V1_0_0_KeyService_CS *Cs, json_t *JsonObj, char *Key, RedfishKeyService_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishKeyService_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishKeyService_V1_0_0_KeyService_CS *Cs, json_t *JsonObj, char *Key, RedfishKeyService_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishKeyService_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishKeyService_V1_0_0_KeyService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishKeyService_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishKeyService_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for KeyService.V1_0_0.KeyService
//
RedfishCS_status CS_To_KeyService_V1_0_0_JSON(RedfishKeyService_V1_0_0_KeyService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // NVMeoFKeyPolicies 
  if (InsertJsonLinkObj (CsJson, "NVMeoFKeyPolicies", &CSPtr->NVMeoFKeyPolicies) != RedfishCS_status_success) {goto Error;}

  // NVMeoFSecrets 
  if (InsertJsonLinkObj (CsJson, "NVMeoFSecrets", &CSPtr->NVMeoFSecrets) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for KeyService.V1_0_0.KeyService
//
RedfishCS_status DestroyKeyService_V1_0_0_CS(RedfishKeyService_V1_0_0_KeyService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for KeyService.V1_0_0.KeyService
//
RedfishCS_status DestroyKeyService_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for KeyService.V1_0_0.KeyService
//
RedfishCS_status
Json_KeyService_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishKeyService_V1_0_0_KeyService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishKeyService_V1_0_0_KeyService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "KeyService", "v1_0_0", "KeyService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishKeyService_V1_0_0_KeyService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // NVMeoFKeyPolicies
  InitializeLinkHead (&Cs->NVMeoFKeyPolicies);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "NVMeoFKeyPolicies", Cs->Header.ThisUri, &Cs->NVMeoFKeyPolicies);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // NVMeoFSecrets
  InitializeLinkHead (&Cs->NVMeoFSecrets);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "NVMeoFSecrets", Cs->Header.ThisUri, &Cs->NVMeoFSecrets);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyKeyService_V1_0_0_CS (Cs);
  return Status;
}
