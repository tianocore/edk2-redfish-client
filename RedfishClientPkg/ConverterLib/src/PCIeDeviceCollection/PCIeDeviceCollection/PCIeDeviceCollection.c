...
#include"Redfish_PCIeDeviceCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishPCIeDeviceCollection_PCIeDeviceCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for PCIeDeviceCollection.PCIeDeviceCollection
//
RedfishCS_status CS_To_PCIeDeviceCollection_JSON(RedfishPCIeDeviceCollection_PCIeDeviceCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for PCIeDeviceCollection.PCIeDeviceCollection
//
RedfishCS_status DestroyPCIeDeviceCollection_CS(RedfishPCIeDeviceCollection_PCIeDeviceCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PCIeDeviceCollection.PCIeDeviceCollection
//
RedfishCS_status DestroyPCIeDeviceCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PCIeDeviceCollection.NOVERSIONED.PCIeDeviceCollection
//
RedfishCS_status
Json_PCIeDeviceCollection_To_CS(RedfishCS_char *JsonRawText, RedfishPCIeDeviceCollection_PCIeDeviceCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPCIeDeviceCollection_PCIeDeviceCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PCIeDeviceCollection", "noversioned", "PCIeDeviceCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPCIeDeviceCollection_PCIeDeviceCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyPCIeDeviceCollection_CS (Cs);
  return Status;
}
