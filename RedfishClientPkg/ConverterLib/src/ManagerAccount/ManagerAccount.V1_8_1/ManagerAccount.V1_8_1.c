...
#include"Redfish_ManagerAccount_v1_8_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishManagerAccount_V1_8_1_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenOemCs(RedfishManagerAccount_V1_8_1_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
...
//
static RedfishCS_status GenOemActionsCs(RedfishManagerAccount_V1_8_1_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerAccount_V1_8_1_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerAccount_V1_8_1_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishManagerAccount_V1_8_1_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerAccount_V1_8_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerAccount_V1_8_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishManagerAccount_V1_8_1_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerAccount_V1_8_1_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerAccount_V1_8_1_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenSNMPUserInfoCs(RedfishManagerAccount_V1_8_1_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerAccount_V1_8_1_SNMPUserInfo_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerAccount_V1_8_1_SNMPUserInfo_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AuthenticationKey
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishManagerAccount_V1_8_1_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishManagerAccount_V1_8_1_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishManagerAccount_V1_8_1_Links_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_SNMP(json_t *CsJson, char *Key, RedfishManagerAccount_V1_8_1_SNMPUserInfo_CS *CSPtr)
{
  json_t *CsParentJson;
...
//
// C structure to JSON for ManagerAccount.V1_8_1.ManagerAccount
//
RedfishCS_status CS_To_ManagerAccount_V1_8_1_JSON(RedfishManagerAccount_V1_8_1_ManagerAccount_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // AccountExpiration 
  if (InsertJsonStringObj (CsJson, "AccountExpiration", CSPtr->AccountExpiration) != RedfishCS_status_success) {goto Error;}

  // AccountTypes 
  if (InsertJsonStringArrayObj (CsJson, "AccountTypes", CSPtr->AccountTypes) != RedfishCS_status_success) {goto Error;}
  ...
  if (InsertJsonBoolObj (CsJson, "HostBootstrapAccount", CSPtr->HostBootstrapAccount) != RedfishCS_status_success) {goto Error;}
  ...
  // OEMAccountTypes 
  if (InsertJsonStringArrayObj (CsJson, "OEMAccountTypes", CSPtr->OEMAccountTypes) != RedfishCS_status_success) {goto Error;}
  ...
  if (InsertJsonBoolObj (CsJson, "PasswordChangeRequired", CSPtr->PasswordChangeRequired) != RedfishCS_status_success) {goto Error;}

  // PasswordExpiration 
  if (InsertJsonStringObj (CsJson, "PasswordExpiration", CSPtr->PasswordExpiration) != RedfishCS_status_success) {goto Error;}
  ...
  // StrictAccountTypes 
  if (InsertJsonBoolObj (CsJson, "StrictAccountTypes", CSPtr->StrictAccountTypes) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for ManagerAccount.V1_8_1.ManagerAccount
//
RedfishCS_status DestroyManagerAccount_V1_8_1_CS(RedfishManagerAccount_V1_8_1_ManagerAccount_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ManagerAccount.V1_8_1.ManagerAccount
//
RedfishCS_status DestroyManagerAccount_V1_8_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ManagerAccount.V1_8_1.ManagerAccount
//
RedfishCS_status
Json_ManagerAccount_V1_8_1_To_CS(RedfishCS_char *JsonRawText, RedfishManagerAccount_V1_8_1_ManagerAccount_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishManagerAccount_V1_8_1_ManagerAccount_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ManagerAccount", "v1_8_1", "ManagerAccount", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishManagerAccount_V1_8_1_ManagerAccount_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // AccountExpiration
  Status = GetRedfishPropertyStr (Cs, JsonObj, "AccountExpiration", &Cs->AccountExpiration);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // AccountTypes
  Status = GenRedfishCS_char_ArrayCs (Cs, JsonObj, "AccountTypes", &Cs->AccountTypes);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){goto Error;}}
  ...
  // HostBootstrapAccount
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "HostBootstrapAccount", &Cs->HostBootstrapAccount);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // OEMAccountTypes
  Status = GenRedfishCS_char_ArrayCs (Cs, JsonObj, "OEMAccountTypes", &Cs->OEMAccountTypes);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // PasswordChangeRequired
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "PasswordChangeRequired", &Cs->PasswordChangeRequired);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // PasswordExpiration
  Status = GetRedfishPropertyStr (Cs, JsonObj, "PasswordExpiration", &Cs->PasswordExpiration);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // SNMP
  Status = GenSNMPUserInfoCs (Cs, JsonObj, "SNMP", &Cs->SNMP);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // StrictAccountTypes
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "StrictAccountTypes", &Cs->StrictAccountTypes);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyManagerAccount_V1_8_1_CS (Cs);
  return Status;
}
