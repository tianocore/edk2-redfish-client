# Definition of ManagerAccount.V1_5_4 and functions<br><br>

## Actions
    typedef struct _RedfishManagerAccount_V1_5_4_Actions_CS {
        RedfishManagerAccount_V1_5_4_OemActions_CS *Oem;
    } RedfishManagerAccount_V1_5_4_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishManagerAccount_V1_5_4_OemActions_CS| Structure points to **Oem** property.| No| No
...
## ManagerAccount
    typedef struct _RedfishManagerAccount_V1_5_4_ManagerAccount_CS {
        ...
        RedfishManagerAccount_V1_5_4_Actions_CS *Actions;
        RedfishCS_Link Certificates;
        RedfishCS_char *Description;
        RedfishCS_bool *Enabled;
        RedfishCS_char *Id;
        RedfishManagerAccount_V1_5_4_Links_CS *Links;
        ...
        RedfishManagerAccount_V1_5_4_SNMPUserInfo_CS *SNMP;
...
|**Actions**|RedfishManagerAccount_V1_5_4_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishManagerAccount_V1_5_4_Links_CS| Structure points to **Links** property.| No| No
...
|**SNMP**|RedfishManagerAccount_V1_5_4_SNMPUserInfo_CS| Structure points to **SNMP** property.| No| No
|**UserName**|RedfishCS_char| String pointer to **UserName** property.| No| No
## Redfish ManagerAccount V1_5_4 to C Structure Function
    RedfishCS_status
    Json_ManagerAccount_V1_5_4_To_CS (RedfishCS_char *JsonRawText, RedfishManagerAccount_V1_5_4_ManagerAccount_CS **ReturnedCS);

## C Structure to Redfish ManagerAccount V1_5_4 JSON Function
    RedfishCS_status
    CS_To_ManagerAccount_V1_5_4_JSON (RedfishManagerAccount_V1_5_4_ManagerAccount_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ManagerAccount V1_5_4 C Structure Function
    RedfishCS_status
