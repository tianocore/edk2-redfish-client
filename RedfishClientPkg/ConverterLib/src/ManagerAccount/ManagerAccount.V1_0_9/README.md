# Definition of ManagerAccount.V1_0_9 and functions<br><br>
...
## ManagerAccount
    typedef struct _RedfishManagerAccount_V1_0_9_ManagerAccount_CS {
        ...
        RedfishCS_char *Id;
        RedfishManagerAccount_V1_0_9_Links_CS *Links;
...
|**Links**|RedfishManagerAccount_V1_0_9_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish ManagerAccount V1_0_9 to C Structure Function
    RedfishCS_status
    Json_ManagerAccount_V1_0_9_To_CS (RedfishCS_char *JsonRawText, RedfishManagerAccount_V1_0_9_ManagerAccount_CS **ReturnedCS);

## C Structure to Redfish ManagerAccount V1_0_9 JSON Function
    RedfishCS_status
    CS_To_ManagerAccount_V1_0_9_JSON (RedfishManagerAccount_V1_0_9_ManagerAccount_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ManagerAccount V1_0_9 C Structure Function
    RedfishCS_status
