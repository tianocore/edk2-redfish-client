...
#include"Redfish_ManagerAccount_v1_1_6_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishManagerAccount_V1_1_6_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishManagerAccount_V1_1_6_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerAccount_V1_1_6_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerAccount_V1_1_6_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishManagerAccount_V1_1_6_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerAccount_V1_1_6_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerAccount_V1_1_6_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishManagerAccount_V1_1_6_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerAccount_V1_1_6_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerAccount_V1_1_6_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishManagerAccount_V1_1_6_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishManagerAccount_V1_1_6_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishManagerAccount_V1_1_6_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for ManagerAccount.V1_1_6.ManagerAccount
//
RedfishCS_status CS_To_ManagerAccount_V1_1_6_JSON(RedfishManagerAccount_V1_1_6_ManagerAccount_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ManagerAccount.V1_1_6.ManagerAccount
//
RedfishCS_status DestroyManagerAccount_V1_1_6_CS(RedfishManagerAccount_V1_1_6_ManagerAccount_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ManagerAccount.V1_1_6.ManagerAccount
//
RedfishCS_status DestroyManagerAccount_V1_1_6_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ManagerAccount.V1_1_6.ManagerAccount
//
RedfishCS_status
Json_ManagerAccount_V1_1_6_To_CS(RedfishCS_char *JsonRawText, RedfishManagerAccount_V1_1_6_ManagerAccount_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishManagerAccount_V1_1_6_ManagerAccount_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ManagerAccount", "v1_1_6", "ManagerAccount", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishManagerAccount_V1_1_6_ManagerAccount_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyManagerAccount_V1_1_6_CS (Cs);
  return Status;
}
