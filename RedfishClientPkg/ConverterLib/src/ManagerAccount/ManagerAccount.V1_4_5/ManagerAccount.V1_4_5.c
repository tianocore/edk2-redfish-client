...
#include"Redfish_ManagerAccount_v1_4_5_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishManagerAccount_V1_4_5_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenOemCs(RedfishManagerAccount_V1_4_5_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
...
//
static RedfishCS_status GenOemActionsCs(RedfishManagerAccount_V1_4_5_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerAccount_V1_4_5_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerAccount_V1_4_5_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishManagerAccount_V1_4_5_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerAccount_V1_4_5_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerAccount_V1_4_5_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishManagerAccount_V1_4_5_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerAccount_V1_4_5_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerAccount_V1_4_5_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenSNMPUserInfoCs(RedfishManagerAccount_V1_4_5_ManagerAccount_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerAccount_V1_4_5_SNMPUserInfo_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerAccount_V1_4_5_SNMPUserInfo_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AuthenticationKey
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishManagerAccount_V1_4_5_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishManagerAccount_V1_4_5_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishManagerAccount_V1_4_5_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_SNMP(json_t *CsJson, char *Key, RedfishManagerAccount_V1_4_5_SNMPUserInfo_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for ManagerAccount.V1_4_5.ManagerAccount
//
RedfishCS_status CS_To_ManagerAccount_V1_4_5_JSON(RedfishManagerAccount_V1_4_5_ManagerAccount_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ManagerAccount.V1_4_5.ManagerAccount
//
RedfishCS_status DestroyManagerAccount_V1_4_5_CS(RedfishManagerAccount_V1_4_5_ManagerAccount_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ManagerAccount.V1_4_5.ManagerAccount
//
RedfishCS_status DestroyManagerAccount_V1_4_5_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ManagerAccount.V1_4_5.ManagerAccount
//
RedfishCS_status
Json_ManagerAccount_V1_4_5_To_CS(RedfishCS_char *JsonRawText, RedfishManagerAccount_V1_4_5_ManagerAccount_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishManagerAccount_V1_4_5_ManagerAccount_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ManagerAccount", "v1_4_5", "ManagerAccount", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishManagerAccount_V1_4_5_ManagerAccount_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyManagerAccount_V1_4_5_CS (Cs);
  return Status;
}
