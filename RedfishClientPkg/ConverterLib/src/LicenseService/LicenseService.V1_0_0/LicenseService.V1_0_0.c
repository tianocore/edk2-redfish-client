...
#include"Redfish_LicenseService_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
//Generate C structure for #LicenseService.Install
//
static RedfishCS_status GenInstallCs(RedfishLicenseService_V1_0_0_LicenseService_CS *Cs, json_t *JsonObj, char *Key, RedfishLicenseService_V1_0_0_Install_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLicenseService_V1_0_0_Install_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishLicenseService_V1_0_0_LicenseService_CS *Cs, json_t *JsonObj, char *Key, RedfishLicenseService_V1_0_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLicenseService_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishLicenseService_V1_0_0_LicenseService_CS *Cs, json_t *JsonObj, char *Key, RedfishLicenseService_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLicenseService_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #LicenseService.Install
  Status = GenInstallCs (Cs, TempJsonObj, "#LicenseService.Install", &(*Dst)->LicenseService_Install);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishLicenseService_V1_0_0_LicenseService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsLicenseService_Install(json_t *CsJson, char *Key, RedfishLicenseService_V1_0_0_Install_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishLicenseService_V1_0_0_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishLicenseService_V1_0_0_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
  ...
  // #LicenseService.Install
  if (CS_To_JSON_ActionsLicenseService_Install(CsJson, "#LicenseService.Install", CSPtr->LicenseService_Install) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for LicenseService.V1_0_0.LicenseService
//
RedfishCS_status CS_To_LicenseService_V1_0_0_JSON(RedfishLicenseService_V1_0_0_LicenseService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  if (InsertJsonInt64Obj (CsJson, "LicenseExpirationWarningDays", CSPtr->LicenseExpirationWarningDays) != RedfishCS_status_success) {goto Error;}

  // Licenses 
  if (InsertJsonLinkObj (CsJson, "Licenses", &CSPtr->Licenses) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for LicenseService.V1_0_0.LicenseService
//
RedfishCS_status DestroyLicenseService_V1_0_0_CS(RedfishLicenseService_V1_0_0_LicenseService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for LicenseService.V1_0_0.LicenseService
//
RedfishCS_status DestroyLicenseService_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for LicenseService.V1_0_0.LicenseService
//
RedfishCS_status
Json_LicenseService_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishLicenseService_V1_0_0_LicenseService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishLicenseService_V1_0_0_LicenseService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "LicenseService", "v1_0_0", "LicenseService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishLicenseService_V1_0_0_LicenseService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // LicenseExpirationWarningDays
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "LicenseExpirationWarningDays", &Cs->LicenseExpirationWarningDays);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Licenses
  InitializeLinkHead (&Cs->Licenses);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "Licenses", Cs->Header.ThisUri, &Cs->Licenses);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyLicenseService_V1_0_0_CS (Cs);
  return Status;
}
