# Definition of FanCollection and functions<br><br>
...
## Redfish FanCollection  to C Structure Function
    RedfishCS_status
    Json_FanCollection_To_CS (RedfishCS_char *JsonRawText, RedfishFanCollection_FanCollection_CS **ReturnedCS);

## C Structure to Redfish FanCollection  JSON Function
    RedfishCS_status
    CS_To_FanCollection_JSON (RedfishFanCollection_FanCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish FanCollection  C Structure Function
    RedfishCS_status
