...
#include"Redfish_Fabric_v1_1_3_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishFabric_V1_1_3_Fabric_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishFabric_V1_1_3_Fabric_CS *Cs, json_t *JsonObj, char *Key, RedfishFabric_V1_1_3_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishFabric_V1_1_3_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishFabric_V1_1_3_Fabric_CS *Cs, json_t *JsonObj, char *Key, RedfishFabric_V1_1_3_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishFabric_V1_1_3_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishFabric_V1_1_3_Fabric_CS *Cs, json_t *JsonObj, char *Key, RedfishFabric_V1_1_3_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishFabric_V1_1_3_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishFabric_V1_1_3_Fabric_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishFabric_V1_1_3_Fabric_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishFabric_V1_1_3_Fabric_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishFabric_V1_1_3_Fabric_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishFabric_V1_1_3_Fabric_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishFabric_V1_1_3_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishFabric_V1_1_3_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishFabric_V1_1_3_Links_CS *CSPtr)
{
  json_t *CsParentJson;
...
//
// C structure to JSON for Fabric.V1_1_3.Fabric
//
RedfishCS_status CS_To_Fabric_V1_1_3_JSON(RedfishFabric_V1_1_3_Fabric_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Fabric.V1_1_3.Fabric
//
RedfishCS_status DestroyFabric_V1_1_3_CS(RedfishFabric_V1_1_3_Fabric_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Fabric.V1_1_3.Fabric
//
RedfishCS_status DestroyFabric_V1_1_3_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Fabric.V1_1_3.Fabric
//
RedfishCS_status
Json_Fabric_V1_1_3_To_CS(RedfishCS_char *JsonRawText, RedfishFabric_V1_1_3_Fabric_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishFabric_V1_1_3_Fabric_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Fabric", "v1_1_3", "Fabric", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishFabric_V1_1_3_Fabric_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
