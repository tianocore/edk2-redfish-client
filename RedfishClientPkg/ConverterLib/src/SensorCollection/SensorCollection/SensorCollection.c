...
#include"Redfish_SensorCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishSensorCollection_SensorCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for SensorCollection.SensorCollection
//
RedfishCS_status CS_To_SensorCollection_JSON(RedfishSensorCollection_SensorCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for SensorCollection.SensorCollection
//
RedfishCS_status DestroySensorCollection_CS(RedfishSensorCollection_SensorCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for SensorCollection.SensorCollection
//
RedfishCS_status DestroySensorCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for SensorCollection.NOVERSIONED.SensorCollection
//
RedfishCS_status
Json_SensorCollection_To_CS(RedfishCS_char *JsonRawText, RedfishSensorCollection_SensorCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSensorCollection_SensorCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "SensorCollection", "noversioned", "SensorCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSensorCollection_SensorCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
