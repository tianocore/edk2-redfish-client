...
#include"Redfish_FabricAdapter_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishFabricAdapter_V1_0_0_FabricAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenOemCs(RedfishFabricAdapter_V1_0_0_FabricAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishFabricAdapter_V1_0_0_FabricAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishFabricAdapter_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishFabricAdapter_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishFabricAdapter_V1_0_0_FabricAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishFabricAdapter_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishFabricAdapter_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenGenZCs(RedfishFabricAdapter_V1_0_0_FabricAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishFabricAdapter_V1_0_0_GenZ_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishFabricAdapter_V1_0_0_GenZ_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MSDT
  InitializeLinkHead (&(*Dst)->MSDT);
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "MSDT", Cs->Header.ThisUri, &(*Dst)->MSDT);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // PIDT
  Status = GenRedfishCS_char_ArrayCs (Cs, TempJsonObj, "PIDT", &(*Dst)->PIDT);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // RITable
  Status = GenRedfishCS_char_ArrayCs (Cs, TempJsonObj, "RITable", &(*Dst)->RITable);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // RequestorVCAT
  InitializeLinkHead (&(*Dst)->RequestorVCAT);
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "RequestorVCAT", Cs->Header.ThisUri, &(*Dst)->RequestorVCAT);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ResponderVCAT
  InitializeLinkHead (&(*Dst)->ResponderVCAT);
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "ResponderVCAT", Cs->Header.ThisUri, &(*Dst)->ResponderVCAT);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // SSDT
  InitializeLinkHead (&(*Dst)->SSDT);
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "SSDT", Cs->Header.ThisUri, &(*Dst)->SSDT);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenLinksCs(RedfishFabricAdapter_V1_0_0_FabricAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishFabricAdapter_V1_0_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishFabricAdapter_V1_0_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Endpoints
...
//
static RedfishCS_status GenidRefCs(RedfishFabricAdapter_V1_0_0_FabricAdapter_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishFabricAdapter_V1_0_0_FabricAdapter_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishFabricAdapter_V1_0_0_FabricAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishFabricAdapter_V1_0_0_FabricAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishFabricAdapter_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishFabricAdapter_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_GenZ(json_t *CsJson, char *Key, RedfishFabricAdapter_V1_0_0_GenZ_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // MSDT 
  if (InsertJsonLinkObj (CsJson, "MSDT", &CSPtr->MSDT) != RedfishCS_status_success) {goto Error;}

  // PIDT 
  if (InsertJsonStringArrayObj (CsJson, "PIDT", CSPtr->PIDT) != RedfishCS_status_success) {goto Error;}

  // RITable 
  if (InsertJsonStringArrayObj (CsJson, "RITable", CSPtr->RITable) != RedfishCS_status_success) {goto Error;}

  // RequestorVCAT 
  if (InsertJsonLinkObj (CsJson, "RequestorVCAT", &CSPtr->RequestorVCAT) != RedfishCS_status_success) {goto Error;}

  // ResponderVCAT 
  if (InsertJsonLinkObj (CsJson, "ResponderVCAT", &CSPtr->ResponderVCAT) != RedfishCS_status_success) {goto Error;}

  // SSDT 
  if (InsertJsonLinkObj (CsJson, "SSDT", &CSPtr->SSDT) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishFabricAdapter_V1_0_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for FabricAdapter.V1_0_0.FabricAdapter
//
RedfishCS_status CS_To_FabricAdapter_V1_0_0_JSON(RedfishFabricAdapter_V1_0_0_FabricAdapter_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // ASICManufacturer 
  if (InsertJsonStringObj (CsJson, "ASICManufacturer", CSPtr->ASICManufacturer) != RedfishCS_status_success) {goto Error;}

  // ASICPartNumber 
  if (InsertJsonStringObj (CsJson, "ASICPartNumber", CSPtr->ASICPartNumber) != RedfishCS_status_success) {goto Error;}

  // ASICRevisionIdentifier 
  if (InsertJsonStringObj (CsJson, "ASICRevisionIdentifier", CSPtr->ASICRevisionIdentifier) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for FabricAdapter.V1_0_0.FabricAdapter
//
RedfishCS_status DestroyFabricAdapter_V1_0_0_CS(RedfishFabricAdapter_V1_0_0_FabricAdapter_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for FabricAdapter.V1_0_0.FabricAdapter
//
RedfishCS_status DestroyFabricAdapter_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for FabricAdapter.V1_0_0.FabricAdapter
//
RedfishCS_status
Json_FabricAdapter_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishFabricAdapter_V1_0_0_FabricAdapter_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishFabricAdapter_V1_0_0_FabricAdapter_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "FabricAdapter", "v1_0_0", "FabricAdapter", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishFabricAdapter_V1_0_0_FabricAdapter_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // ASICManufacturer
  Status = GetRedfishPropertyStr (Cs, JsonObj, "ASICManufacturer", &Cs->ASICManufacturer);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ASICPartNumber
  Status = GetRedfishPropertyStr (Cs, JsonObj, "ASICPartNumber", &Cs->ASICPartNumber);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ASICRevisionIdentifier
  Status = GetRedfishPropertyStr (Cs, JsonObj, "ASICRevisionIdentifier", &Cs->ASICRevisionIdentifier);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyFabricAdapter_V1_0_0_CS (Cs);
  return Status;
}
