...
#include"Redfish_FabricAdapter_v1_2_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishFabricAdapter_V1_2_0_FabricAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenOemCs(RedfishFabricAdapter_V1_2_0_FabricAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishFabricAdapter_V1_2_0_FabricAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishFabricAdapter_V1_2_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishFabricAdapter_V1_2_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishFabricAdapter_V1_2_0_FabricAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishFabricAdapter_V1_2_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishFabricAdapter_V1_2_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenGenZCs(RedfishFabricAdapter_V1_2_0_FabricAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishFabricAdapter_V1_2_0_GenZ_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishFabricAdapter_V1_2_0_GenZ_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MSDT
...
//
static RedfishCS_status GenLinksCs(RedfishFabricAdapter_V1_2_0_FabricAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishFabricAdapter_V1_2_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishFabricAdapter_V1_2_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Endpoints
...
//
static RedfishCS_status GenidRefCs(RedfishFabricAdapter_V1_2_0_FabricAdapter_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishFabricAdapter_V1_2_0_FabricAdapter_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishFabricAdapter_V1_2_0_FabricAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishFabricAdapter_V1_2_0_FabricAdapter_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishFabricAdapter_V1_2_0_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishFabricAdapter_V1_2_0_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_GenZ(json_t *CsJson, char *Key, RedfishFabricAdapter_V1_2_0_GenZ_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishFabricAdapter_V1_2_0_Links_CS *CSPtr)
{
  json_t *CsParentJson;
...
//
// C structure to JSON for FabricAdapter.V1_2_0.FabricAdapter
//
RedfishCS_status CS_To_FabricAdapter_V1_2_0_JSON(RedfishFabricAdapter_V1_2_0_FabricAdapter_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for FabricAdapter.V1_2_0.FabricAdapter
//
RedfishCS_status DestroyFabricAdapter_V1_2_0_CS(RedfishFabricAdapter_V1_2_0_FabricAdapter_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for FabricAdapter.V1_2_0.FabricAdapter
//
RedfishCS_status DestroyFabricAdapter_V1_2_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for FabricAdapter.V1_2_0.FabricAdapter
//
RedfishCS_status
Json_FabricAdapter_V1_2_0_To_CS(RedfishCS_char *JsonRawText, RedfishFabricAdapter_V1_2_0_FabricAdapter_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishFabricAdapter_V1_2_0_FabricAdapter_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "FabricAdapter", "v1_2_0", "FabricAdapter", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishFabricAdapter_V1_2_0_FabricAdapter_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyFabricAdapter_V1_2_0_CS (Cs);
  return Status;
}
