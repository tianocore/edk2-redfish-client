...
#include"Redfish_Triggers_v1_1_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishTriggers_V1_1_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenThresholdCs(RedfishTriggers_V1_1_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishTriggers_V1_1_0_Threshold_CS **Dst);
static RedfishCS_status GenOemCs(RedfishTriggers_V1_1_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishTriggers_V1_1_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishTriggers_V1_1_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTriggers_V1_1_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishTriggers_V1_1_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishTriggers_V1_1_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTriggers_V1_1_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenDiscreteTrigger_Array_ElementCs(RedfishTriggers_V1_1_0_Triggers_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishTriggers_V1_1_0_DiscreteTrigger_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishTriggers_V1_1_0_DiscreteTrigger_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // DwellTime
...
//
//Generate C structure for RedfishTriggers_V1_1_0_DiscreteTrigger_Array_CS
//
static RedfishCS_status GenDiscreteTrigger_ArrayCs(RedfishTriggers_V1_1_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishTriggers_V1_1_0_DiscreteTrigger_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishTriggers_V1_1_0_DiscreteTrigger_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishTriggers_V1_1_0_DiscreteTrigger_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenLinksCs(RedfishTriggers_V1_1_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishTriggers_V1_1_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTriggers_V1_1_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
static RedfishCS_status GenThresholdCs(RedfishTriggers_V1_1_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishTriggers_V1_1_0_Threshold_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTriggers_V1_1_0_Threshold_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Activation
...
//
static RedfishCS_status GenThresholdsCs(RedfishTriggers_V1_1_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishTriggers_V1_1_0_Thresholds_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTriggers_V1_1_0_Thresholds_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // LowerCritical
...
//
static RedfishCS_status GenidRefCs(RedfishTriggers_V1_1_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishTriggers_V1_1_0_Triggers_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishTriggers_V1_1_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishTriggers_V1_1_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenWildcard_Array_ElementCs(RedfishTriggers_V1_1_0_Triggers_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishTriggers_V1_1_0_Wildcard_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishTriggers_V1_1_0_Wildcard_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Name
...
//
//Generate C structure for RedfishTriggers_V1_1_0_Wildcard_Array_CS
//
static RedfishCS_status GenWildcard_ArrayCs(RedfishTriggers_V1_1_0_Triggers_CS *Cs, json_t *JsonObj, char *Key, RedfishTriggers_V1_1_0_Wildcard_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishTriggers_V1_1_0_Wildcard_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishTriggers_V1_1_0_Wildcard_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishTriggers_V1_1_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishTriggers_V1_1_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_DiscreteTriggers(json_t *CsJson, char *Key, RedfishTriggers_V1_1_0_DiscreteTrigger_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishTriggers_V1_1_0_DiscreteTrigger_Array_CS *NextArray;
  RedfishTriggers_V1_1_0_DiscreteTrigger_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishTriggers_V1_1_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_NumericThresholdsLowerCritical(json_t *CsJson, char *Key, RedfishTriggers_V1_1_0_Threshold_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_NumericThresholdsLowerWarning(json_t *CsJson, char *Key, RedfishTriggers_V1_1_0_Threshold_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_NumericThresholdsUpperCritical(json_t *CsJson, char *Key, RedfishTriggers_V1_1_0_Threshold_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_NumericThresholdsUpperWarning(json_t *CsJson, char *Key, RedfishTriggers_V1_1_0_Threshold_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_NumericThresholds(json_t *CsJson, char *Key, RedfishTriggers_V1_1_0_Thresholds_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Wildcards(json_t *CsJson, char *Key, RedfishTriggers_V1_1_0_Wildcard_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishTriggers_V1_1_0_Wildcard_Array_CS *NextArray;
  RedfishTriggers_V1_1_0_Wildcard_CS *NextArrayItem;
...
//
// C structure to JSON for Triggers.V1_1_0.Triggers
//
RedfishCS_status CS_To_Triggers_V1_1_0_JSON(RedfishTriggers_V1_1_0_Triggers_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Triggers.V1_1_0.Triggers
//
RedfishCS_status DestroyTriggers_V1_1_0_CS(RedfishTriggers_V1_1_0_Triggers_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Triggers.V1_1_0.Triggers
//
RedfishCS_status DestroyTriggers_V1_1_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Triggers.V1_1_0.Triggers
//
RedfishCS_status
Json_Triggers_V1_1_0_To_CS(RedfishCS_char *JsonRawText, RedfishTriggers_V1_1_0_Triggers_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishTriggers_V1_1_0_Triggers_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Triggers", "v1_1_0", "Triggers", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishTriggers_V1_1_0_Triggers_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
