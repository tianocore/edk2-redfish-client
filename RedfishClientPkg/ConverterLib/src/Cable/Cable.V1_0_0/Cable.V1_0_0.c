...
#include"Redfish_Cable_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishCable_V1_0_0_Cable_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishCable_V1_0_0_Cable_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishCable_V1_0_0_Cable_CS *Cs, json_t *JsonObj, char *Key, RedfishCable_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCable_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishCable_V1_0_0_Cable_CS *Cs, json_t *JsonObj, char *Key, RedfishCable_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCable_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishCable_V1_0_0_Cable_CS *Cs, json_t *JsonObj, char *Key, RedfishCable_V1_0_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCable_V1_0_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // DownstreamChassis
...
//
static RedfishCS_status GenidRefCs(RedfishCable_V1_0_0_Cable_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishCable_V1_0_0_Cable_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishCable_V1_0_0_Cable_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishCable_V1_0_0_Cable_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishCable_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishCable_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishCable_V1_0_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Cable.V1_0_0.Cable
//
RedfishCS_status CS_To_Cable_V1_0_0_JSON(RedfishCable_V1_0_0_Cable_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Cable.V1_0_0.Cable
//
RedfishCS_status DestroyCable_V1_0_0_CS(RedfishCable_V1_0_0_Cable_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Cable.V1_0_0.Cable
//
RedfishCS_status DestroyCable_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Cable.V1_0_0.Cable
//
RedfishCS_status
Json_Cable_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishCable_V1_0_0_Cable_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishCable_V1_0_0_Cable_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Cable", "v1_0_0", "Cable", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishCable_V1_0_0_Cable_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
