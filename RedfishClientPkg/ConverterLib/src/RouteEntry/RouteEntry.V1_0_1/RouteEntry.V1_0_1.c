...
#include"Redfish_RouteEntry_v1_0_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishRouteEntry_V1_0_1_RouteEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishRouteEntry_V1_0_1_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishRouteEntry_V1_0_1_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishRouteEntry_V1_0_1_RouteEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishRouteEntry_V1_0_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishRouteEntry_V1_0_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishRouteEntry_V1_0_1_RouteEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishRouteEntry_V1_0_1_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishRouteEntry_V1_0_1_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for RouteEntry.V1_0_1.RouteEntry
//
RedfishCS_status CS_To_RouteEntry_V1_0_1_JSON(RedfishRouteEntry_V1_0_1_RouteEntry_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for RouteEntry.V1_0_1.RouteEntry
//
RedfishCS_status DestroyRouteEntry_V1_0_1_CS(RedfishRouteEntry_V1_0_1_RouteEntry_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for RouteEntry.V1_0_1.RouteEntry
//
RedfishCS_status DestroyRouteEntry_V1_0_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for RouteEntry.V1_0_1.RouteEntry
//
RedfishCS_status
Json_RouteEntry_V1_0_1_To_CS(RedfishCS_char *JsonRawText, RedfishRouteEntry_V1_0_1_RouteEntry_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishRouteEntry_V1_0_1_RouteEntry_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "RouteEntry", "v1_0_1", "RouteEntry", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishRouteEntry_V1_0_1_RouteEntry_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyRouteEntry_V1_0_1_CS (Cs);
  return Status;
}
