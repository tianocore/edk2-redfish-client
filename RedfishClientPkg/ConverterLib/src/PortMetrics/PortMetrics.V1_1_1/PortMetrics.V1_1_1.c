...
#include"Redfish_PortMetrics_v1_1_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishPortMetrics_V1_1_1_PortMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishPortMetrics_V1_1_1_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPortMetrics_V1_1_1_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishPortMetrics_V1_1_1_PortMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishPortMetrics_V1_1_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPortMetrics_V1_1_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenGenZCs(RedfishPortMetrics_V1_1_1_PortMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishPortMetrics_V1_1_1_GenZ_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPortMetrics_V1_1_1_GenZ_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AccessKeyViolations
...
//
static RedfishCS_status GenNetworkingCs(RedfishPortMetrics_V1_1_1_PortMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishPortMetrics_V1_1_1_Networking_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPortMetrics_V1_1_1_Networking_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishPortMetrics_V1_1_1_PortMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status GenSAS_Array_ElementCs(RedfishPortMetrics_V1_1_1_PortMetrics_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPortMetrics_V1_1_1_SAS_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPortMetrics_V1_1_1_SAS_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // InvalidDwordCount
...
//
//Generate C structure for RedfishPortMetrics_V1_1_1_SAS_Array_CS
//
static RedfishCS_status GenSAS_ArrayCs(RedfishPortMetrics_V1_1_1_PortMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishPortMetrics_V1_1_1_SAS_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPortMetrics_V1_1_1_SAS_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPortMetrics_V1_1_1_SAS_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenTransceiver_Array_ElementCs(RedfishPortMetrics_V1_1_1_PortMetrics_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPortMetrics_V1_1_1_Transceiver_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPortMetrics_V1_1_1_Transceiver_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
//Generate C structure for RedfishPortMetrics_V1_1_1_Transceiver_Array_CS
//
static RedfishCS_status GenTransceiver_ArrayCs(RedfishPortMetrics_V1_1_1_PortMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishPortMetrics_V1_1_1_Transceiver_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPortMetrics_V1_1_1_Transceiver_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPortMetrics_V1_1_1_Transceiver_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishPortMetrics_V1_1_1_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishPortMetrics_V1_1_1_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_GenZ(json_t *CsJson, char *Key, RedfishPortMetrics_V1_1_1_GenZ_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Networking(json_t *CsJson, char *Key, RedfishPortMetrics_V1_1_1_Networking_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_SAS(json_t *CsJson, char *Key, RedfishPortMetrics_V1_1_1_SAS_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPortMetrics_V1_1_1_SAS_Array_CS *NextArray;
  RedfishPortMetrics_V1_1_1_SAS_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_Transceivers(json_t *CsJson, char *Key, RedfishPortMetrics_V1_1_1_Transceiver_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPortMetrics_V1_1_1_Transceiver_Array_CS *NextArray;
  RedfishPortMetrics_V1_1_1_Transceiver_CS *NextArrayItem;
...
//
// C structure to JSON for PortMetrics.V1_1_1.PortMetrics
//
RedfishCS_status CS_To_PortMetrics_V1_1_1_JSON(RedfishPortMetrics_V1_1_1_PortMetrics_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for PortMetrics.V1_1_1.PortMetrics
//
RedfishCS_status DestroyPortMetrics_V1_1_1_CS(RedfishPortMetrics_V1_1_1_PortMetrics_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PortMetrics.V1_1_1.PortMetrics
//
RedfishCS_status DestroyPortMetrics_V1_1_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PortMetrics.V1_1_1.PortMetrics
//
RedfishCS_status
Json_PortMetrics_V1_1_1_To_CS(RedfishCS_char *JsonRawText, RedfishPortMetrics_V1_1_1_PortMetrics_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPortMetrics_V1_1_1_PortMetrics_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PortMetrics", "v1_1_1", "PortMetrics", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPortMetrics_V1_1_1_PortMetrics_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyPortMetrics_V1_1_1_CS (Cs);
  return Status;
}
