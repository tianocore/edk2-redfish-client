# Definition of KeyPolicyCollection and functions<br><br>
...
## Redfish KeyPolicyCollection  to C Structure Function
    RedfishCS_status
    Json_KeyPolicyCollection_To_CS (RedfishCS_char *JsonRawText, RedfishKeyPolicyCollection_KeyPolicyCollection_CS **ReturnedCS);

## C Structure to Redfish KeyPolicyCollection  JSON Function
    RedfishCS_status
    CS_To_KeyPolicyCollection_JSON (RedfishKeyPolicyCollection_KeyPolicyCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish KeyPolicyCollection  C Structure Function
    RedfishCS_status
