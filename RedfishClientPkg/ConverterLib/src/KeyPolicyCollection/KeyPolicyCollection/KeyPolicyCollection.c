...
#include"Redfish_KeyPolicyCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishKeyPolicyCollection_KeyPolicyCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for KeyPolicyCollection.KeyPolicyCollection
//
RedfishCS_status CS_To_KeyPolicyCollection_JSON(RedfishKeyPolicyCollection_KeyPolicyCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for KeyPolicyCollection.KeyPolicyCollection
//
RedfishCS_status DestroyKeyPolicyCollection_CS(RedfishKeyPolicyCollection_KeyPolicyCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for KeyPolicyCollection.KeyPolicyCollection
//
RedfishCS_status DestroyKeyPolicyCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for KeyPolicyCollection.NOVERSIONED.KeyPolicyCollection
//
RedfishCS_status
Json_KeyPolicyCollection_To_CS(RedfishCS_char *JsonRawText, RedfishKeyPolicyCollection_KeyPolicyCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishKeyPolicyCollection_KeyPolicyCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "KeyPolicyCollection", "noversioned", "KeyPolicyCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishKeyPolicyCollection_KeyPolicyCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyKeyPolicyCollection_CS (Cs);
  return Status;
}
