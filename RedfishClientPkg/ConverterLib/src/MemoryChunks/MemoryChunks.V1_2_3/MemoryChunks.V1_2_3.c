...
#include"Redfish_MemoryChunks_v1_2_3_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenidRefCs(RedfishMemoryChunks_V1_2_3_MemoryChunks_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst);
static RedfishCS_status GenOemCs(RedfishMemoryChunks_V1_2_3_MemoryChunks_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishMemoryChunks_V1_2_3_MemoryChunks_CS *Cs, json_t *JsonObj, char *Key, RedfishMemoryChunks_V1_2_3_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemoryChunks_V1_2_3_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishMemoryChunks_V1_2_3_MemoryChunks_CS *Cs, json_t *JsonObj, char *Key, RedfishMemoryChunks_V1_2_3_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemoryChunks_V1_2_3_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenInterleaveSet_Array_ElementCs(RedfishMemoryChunks_V1_2_3_MemoryChunks_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishMemoryChunks_V1_2_3_InterleaveSet_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishMemoryChunks_V1_2_3_InterleaveSet_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Memory
...
//
//Generate C structure for RedfishMemoryChunks_V1_2_3_InterleaveSet_Array_CS
//
static RedfishCS_status GenInterleaveSet_ArrayCs(RedfishMemoryChunks_V1_2_3_MemoryChunks_CS *Cs, json_t *JsonObj, char *Key, RedfishMemoryChunks_V1_2_3_InterleaveSet_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishMemoryChunks_V1_2_3_InterleaveSet_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishMemoryChunks_V1_2_3_InterleaveSet_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishMemoryChunks_V1_2_3_MemoryChunks_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishMemoryChunks_V1_2_3_MemoryChunks_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishMemoryChunks_V1_2_3_MemoryChunks_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishMemoryChunks_V1_2_3_MemoryChunks_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishMemoryChunks_V1_2_3_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishMemoryChunks_V1_2_3_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_InterleaveSets(json_t *CsJson, char *Key, RedfishMemoryChunks_V1_2_3_InterleaveSet_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishMemoryChunks_V1_2_3_InterleaveSet_Array_CS *NextArray;
  RedfishMemoryChunks_V1_2_3_InterleaveSet_CS *NextArrayItem;
...
//
// C structure to JSON for MemoryChunks.V1_2_3.MemoryChunks
//
RedfishCS_status CS_To_MemoryChunks_V1_2_3_JSON(RedfishMemoryChunks_V1_2_3_MemoryChunks_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for MemoryChunks.V1_2_3.MemoryChunks
//
RedfishCS_status DestroyMemoryChunks_V1_2_3_CS(RedfishMemoryChunks_V1_2_3_MemoryChunks_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MemoryChunks.V1_2_3.MemoryChunks
//
RedfishCS_status DestroyMemoryChunks_V1_2_3_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MemoryChunks.V1_2_3.MemoryChunks
//
RedfishCS_status
Json_MemoryChunks_V1_2_3_To_CS(RedfishCS_char *JsonRawText, RedfishMemoryChunks_V1_2_3_MemoryChunks_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMemoryChunks_V1_2_3_MemoryChunks_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MemoryChunks", "v1_2_3", "MemoryChunks", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMemoryChunks_V1_2_3_MemoryChunks_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyMemoryChunks_V1_2_3_CS (Cs);
  return Status;
}
