...
#include"Redfish_MemoryChunks_v1_0_5_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenidRefCs(RedfishMemoryChunks_V1_0_5_MemoryChunks_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
...
static RedfishCS_status GenInterleaveSet_Array_ElementCs(RedfishMemoryChunks_V1_0_5_MemoryChunks_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishMemoryChunks_V1_0_5_InterleaveSet_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishMemoryChunks_V1_0_5_InterleaveSet_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Memory
...
//
//Generate C structure for RedfishMemoryChunks_V1_0_5_InterleaveSet_Array_CS
//
static RedfishCS_status GenInterleaveSet_ArrayCs(RedfishMemoryChunks_V1_0_5_MemoryChunks_CS *Cs, json_t *JsonObj, char *Key, RedfishMemoryChunks_V1_0_5_InterleaveSet_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishMemoryChunks_V1_0_5_InterleaveSet_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishMemoryChunks_V1_0_5_InterleaveSet_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenOemCs(RedfishMemoryChunks_V1_0_5_MemoryChunks_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
...
static RedfishCS_status CS_To_JSON_InterleaveSets(json_t *CsJson, char *Key, RedfishMemoryChunks_V1_0_5_InterleaveSet_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishMemoryChunks_V1_0_5_InterleaveSet_Array_CS *NextArray;
  RedfishMemoryChunks_V1_0_5_InterleaveSet_CS *NextArrayItem;
...
//
// C structure to JSON for MemoryChunks.V1_0_5.MemoryChunks
//
RedfishCS_status CS_To_MemoryChunks_V1_0_5_JSON(RedfishMemoryChunks_V1_0_5_MemoryChunks_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for MemoryChunks.V1_0_5.MemoryChunks
//
RedfishCS_status DestroyMemoryChunks_V1_0_5_CS(RedfishMemoryChunks_V1_0_5_MemoryChunks_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MemoryChunks.V1_0_5.MemoryChunks
//
RedfishCS_status DestroyMemoryChunks_V1_0_5_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MemoryChunks.V1_0_5.MemoryChunks
//
RedfishCS_status
Json_MemoryChunks_V1_0_5_To_CS(RedfishCS_char *JsonRawText, RedfishMemoryChunks_V1_0_5_MemoryChunks_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMemoryChunks_V1_0_5_MemoryChunks_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MemoryChunks", "v1_0_5", "MemoryChunks", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMemoryChunks_V1_0_5_MemoryChunks_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyMemoryChunks_V1_0_5_CS (Cs);
  return Status;
}
