# Definition of MemoryChunks.V1_0_0 and functions<br><br>
...
## MemoryChunks
    typedef struct _RedfishMemoryChunks_V1_0_0_MemoryChunks_CS {
        ...
        RedfishCS_char *Id;
        RedfishMemoryChunks_V1_0_0_InterleaveSet_CS *InterleaveSets;
...
|**InterleaveSets**|RedfishMemoryChunks_V1_0_0_InterleaveSet_CS| Structure points to **InterleaveSets** property.| No| Yes
...
## Redfish MemoryChunks V1_0_0 to C Structure Function
    RedfishCS_status
    Json_MemoryChunks_V1_0_0_To_CS (RedfishCS_char *JsonRawText, RedfishMemoryChunks_V1_0_0_MemoryChunks_CS **ReturnedCS);

## C Structure to Redfish MemoryChunks V1_0_0 JSON Function
    RedfishCS_status
    CS_To_MemoryChunks_V1_0_0_JSON (RedfishMemoryChunks_V1_0_0_MemoryChunks_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish MemoryChunks V1_0_0 C Structure Function
    RedfishCS_status
