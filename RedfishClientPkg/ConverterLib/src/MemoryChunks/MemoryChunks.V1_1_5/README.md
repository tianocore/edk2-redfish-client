# Definition of MemoryChunks.V1_1_5 and functions<br><br>

## Actions
    typedef struct _RedfishMemoryChunks_V1_1_5_Actions_CS {
        RedfishMemoryChunks_V1_1_5_OemActions_CS *Oem;
    } RedfishMemoryChunks_V1_1_5_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishMemoryChunks_V1_1_5_OemActions_CS| Structure points to **Oem** property.| No| No
...
## MemoryChunks
    typedef struct _RedfishMemoryChunks_V1_1_5_MemoryChunks_CS {
        ...
        RedfishMemoryChunks_V1_1_5_Actions_CS *Actions;
        RedfishCS_char *AddressRangeType;
        RedfishCS_char *Description;
        RedfishCS_char *Id;
        RedfishMemoryChunks_V1_1_5_InterleaveSet_CS *InterleaveSets;
...
|**Actions**|RedfishMemoryChunks_V1_1_5_Actions_CS| Structure points to **Actions** property.| No| No
|**AddressRangeType**|RedfishCS_char| String pointer to **AddressRangeType** property.| No| Yes
|**Description**|RedfishCS_char| String pointer to **Description** property.| No| Yes
|**Id**|RedfishCS_char| String pointer to **Id** property.| Yes| Yes
|**InterleaveSets**|RedfishMemoryChunks_V1_1_5_InterleaveSet_CS| Structure points to **InterleaveSets** property.| No| No
...
## Redfish MemoryChunks V1_1_5 to C Structure Function
    RedfishCS_status
    Json_MemoryChunks_V1_1_5_To_CS (RedfishCS_char *JsonRawText, RedfishMemoryChunks_V1_1_5_MemoryChunks_CS **ReturnedCS);

## C Structure to Redfish MemoryChunks V1_1_5 JSON Function
    RedfishCS_status
    CS_To_MemoryChunks_V1_1_5_JSON (RedfishMemoryChunks_V1_1_5_MemoryChunks_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish MemoryChunks V1_1_5 C Structure Function
    RedfishCS_status
