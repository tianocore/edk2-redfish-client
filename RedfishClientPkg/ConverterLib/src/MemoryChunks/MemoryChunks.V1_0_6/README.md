# Definition of MemoryChunks.V1_0_6 and functions<br><br>
...
## MemoryChunks
    typedef struct _RedfishMemoryChunks_V1_0_6_MemoryChunks_CS {
        ...
        RedfishCS_char *Id;
        RedfishMemoryChunks_V1_0_6_InterleaveSet_CS *InterleaveSets;
...
|**InterleaveSets**|RedfishMemoryChunks_V1_0_6_InterleaveSet_CS| Structure points to **InterleaveSets** property.| No| No
...
## Redfish MemoryChunks V1_0_6 to C Structure Function
    RedfishCS_status
    Json_MemoryChunks_V1_0_6_To_CS (RedfishCS_char *JsonRawText, RedfishMemoryChunks_V1_0_6_MemoryChunks_CS **ReturnedCS);

## C Structure to Redfish MemoryChunks V1_0_6 JSON Function
    RedfishCS_status
    CS_To_MemoryChunks_V1_0_6_JSON (RedfishMemoryChunks_V1_0_6_MemoryChunks_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish MemoryChunks V1_0_6 C Structure Function
    RedfishCS_status
