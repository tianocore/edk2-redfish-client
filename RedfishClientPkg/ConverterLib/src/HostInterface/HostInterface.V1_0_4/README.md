# Definition of HostInterface.V1_0_4 and functions<br><br>
...
## HostInterface
    typedef struct _RedfishHostInterface_V1_0_4_HostInterface_CS {
        ...
        RedfishHostInterface_V1_0_4_Links_CS *Links;
...
|**Links**|RedfishHostInterface_V1_0_4_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish HostInterface V1_0_4 to C Structure Function
    RedfishCS_status
    Json_HostInterface_V1_0_4_To_CS (RedfishCS_char *JsonRawText, RedfishHostInterface_V1_0_4_HostInterface_CS **ReturnedCS);

## C Structure to Redfish HostInterface V1_0_4 JSON Function
    RedfishCS_status
    CS_To_HostInterface_V1_0_4_JSON (RedfishHostInterface_V1_0_4_HostInterface_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish HostInterface V1_0_4 C Structure Function
    RedfishCS_status
