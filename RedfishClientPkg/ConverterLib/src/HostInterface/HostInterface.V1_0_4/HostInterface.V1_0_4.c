...
#include"Redfish_HostInterface_v1_0_4_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishHostInterface_V1_0_4_HostInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishHostInterface_V1_0_4_HostInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
...
//
static RedfishCS_status GenLinksCs(RedfishHostInterface_V1_0_4_HostInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishHostInterface_V1_0_4_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishHostInterface_V1_0_4_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ComputerSystems
...
//
static RedfishCS_status GenidRefCs(RedfishHostInterface_V1_0_4_HostInterface_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishHostInterface_V1_0_4_HostInterface_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishHostInterface_V1_0_4_HostInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishHostInterface_V1_0_4_HostInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishHostInterface_V1_0_4_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for HostInterface.V1_0_4.HostInterface
//
RedfishCS_status CS_To_HostInterface_V1_0_4_JSON(RedfishHostInterface_V1_0_4_HostInterface_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for HostInterface.V1_0_4.HostInterface
//
RedfishCS_status DestroyHostInterface_V1_0_4_CS(RedfishHostInterface_V1_0_4_HostInterface_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for HostInterface.V1_0_4.HostInterface
//
RedfishCS_status DestroyHostInterface_V1_0_4_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for HostInterface.V1_0_4.HostInterface
//
RedfishCS_status
Json_HostInterface_V1_0_4_To_CS(RedfishCS_char *JsonRawText, RedfishHostInterface_V1_0_4_HostInterface_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishHostInterface_V1_0_4_HostInterface_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "HostInterface", "v1_0_4", "HostInterface", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishHostInterface_V1_0_4_HostInterface_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyHostInterface_V1_0_4_CS (Cs);
  return Status;
}
