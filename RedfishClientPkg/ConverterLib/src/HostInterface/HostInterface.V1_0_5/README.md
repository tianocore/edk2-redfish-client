# Definition of HostInterface.V1_0_5 and functions<br><br>
...
## HostInterface
    typedef struct _RedfishHostInterface_V1_0_5_HostInterface_CS {
        ...
        RedfishHostInterface_V1_0_5_Links_CS *Links;
...
|**Links**|RedfishHostInterface_V1_0_5_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish HostInterface V1_0_5 to C Structure Function
    RedfishCS_status
    Json_HostInterface_V1_0_5_To_CS (RedfishCS_char *JsonRawText, RedfishHostInterface_V1_0_5_HostInterface_CS **ReturnedCS);

## C Structure to Redfish HostInterface V1_0_5 JSON Function
    RedfishCS_status
    CS_To_HostInterface_V1_0_5_JSON (RedfishHostInterface_V1_0_5_HostInterface_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish HostInterface V1_0_5 C Structure Function
    RedfishCS_status
