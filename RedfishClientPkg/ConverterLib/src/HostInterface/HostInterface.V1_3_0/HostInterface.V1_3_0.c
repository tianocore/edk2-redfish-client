...
#include"Redfish_HostInterface_v1_3_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishHostInterface_V1_3_0_HostInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishHostInterface_V1_3_0_HostInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishHostInterface_V1_3_0_HostInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishHostInterface_V1_3_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishHostInterface_V1_3_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishHostInterface_V1_3_0_HostInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishHostInterface_V1_3_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishHostInterface_V1_3_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
//Generate C structure for CredentialBootstrapping
//
static RedfishCS_status GenCredentialBootstrappingCs(RedfishHostInterface_V1_3_0_HostInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishHostInterface_V1_3_0_CredentialBootstrapping_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishHostInterface_V1_3_0_CredentialBootstrapping_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // EnableAfterReset
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "EnableAfterReset", &(*Dst)->EnableAfterReset);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // RoleId
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "RoleId", &(*Dst)->RoleId);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenLinksCs(RedfishHostInterface_V1_3_0_HostInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishHostInterface_V1_3_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishHostInterface_V1_3_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AuthNoneRole
  ...
  InitializeLinkHead (&(*Dst)->CredentialBootstrappingRole);
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "CredentialBootstrappingRole", Cs->Header.ThisUri, &(*Dst)->CredentialBootstrappingRole);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenidRefCs(RedfishHostInterface_V1_3_0_HostInterface_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishHostInterface_V1_3_0_HostInterface_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishHostInterface_V1_3_0_HostInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishHostInterface_V1_3_0_HostInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishHostInterface_V1_3_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishHostInterface_V1_3_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_CredentialBootstrapping(json_t *CsJson, char *Key, RedfishHostInterface_V1_3_0_CredentialBootstrapping_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // EnableAfterReset 
  if (InsertJsonBoolObj (CsJson, "EnableAfterReset", CSPtr->EnableAfterReset) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishHostInterface_V1_3_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // CredentialBootstrappingRole 
  if (InsertJsonLinkObj (CsJson, "CredentialBootstrappingRole", &CSPtr->CredentialBootstrappingRole) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for HostInterface.V1_3_0.HostInterface
//
RedfishCS_status CS_To_HostInterface_V1_3_0_JSON(RedfishHostInterface_V1_3_0_HostInterface_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  if (CS_To_JSON_CredentialBootstrapping(CsJson, "CredentialBootstrapping", CSPtr->CredentialBootstrapping) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for HostInterface.V1_3_0.HostInterface
//
RedfishCS_status DestroyHostInterface_V1_3_0_CS(RedfishHostInterface_V1_3_0_HostInterface_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for HostInterface.V1_3_0.HostInterface
//
RedfishCS_status DestroyHostInterface_V1_3_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for HostInterface.V1_3_0.HostInterface
//
RedfishCS_status
Json_HostInterface_V1_3_0_To_CS(RedfishCS_char *JsonRawText, RedfishHostInterface_V1_3_0_HostInterface_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishHostInterface_V1_3_0_HostInterface_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "HostInterface", "v1_3_0", "HostInterface", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishHostInterface_V1_3_0_HostInterface_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // CredentialBootstrapping
  Status = GenCredentialBootstrappingCs (Cs, JsonObj, "CredentialBootstrapping", &Cs->CredentialBootstrapping);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyHostInterface_V1_3_0_CS (Cs);
  return Status;
}
