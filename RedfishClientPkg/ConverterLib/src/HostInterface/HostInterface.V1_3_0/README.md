# Definition of HostInterface.V1_3_0 and functions<br><br>

## Actions
    typedef struct _RedfishHostInterface_V1_3_0_Actions_CS {
        RedfishHostInterface_V1_3_0_OemActions_CS *Oem;
    } RedfishHostInterface_V1_3_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishHostInterface_V1_3_0_OemActions_CS| Structure points to **Oem** property.| No| No


## CredentialBootstrapping
    typedef struct _RedfishHostInterface_V1_3_0_CredentialBootstrapping_CS {
        RedfishCS_bool *EnableAfterReset;
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**EnableAfterReset**|RedfishCS_bool| Boolean pointer to **EnableAfterReset** property.| No| No
...
## Links
    typedef struct _RedfishHostInterface_V1_3_0_Links_CS {
        ...
        RedfishCS_Link CredentialBootstrappingRole;
...
|**CredentialBootstrappingRole**|RedfishCS_Link| Structure link list to **CredentialBootstrappingRole** property.| No| Yes
...
## HostInterface
    typedef struct _RedfishHostInterface_V1_3_0_HostInterface_CS {
        ...
        RedfishHostInterface_V1_3_0_Actions_CS *Actions;
        RedfishCS_char *AuthNoneRoleId;
        RedfishCS_char *AuthenticationModes;
        RedfishHostInterface_V1_3_0_CredentialBootstrapping_CS *CredentialBootstrapping;
        ...
        RedfishHostInterface_V1_3_0_Links_CS *Links;
...
|**Actions**|RedfishHostInterface_V1_3_0_Actions_CS| Structure points to **Actions** property.| No| No
...
|**CredentialBootstrapping**|RedfishHostInterface_V1_3_0_CredentialBootstrapping_CS| Structure points to **CredentialBootstrapping** property.| No| No
...
|**Links**|RedfishHostInterface_V1_3_0_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish HostInterface V1_3_0 to C Structure Function
    RedfishCS_status
    Json_HostInterface_V1_3_0_To_CS (RedfishCS_char *JsonRawText, RedfishHostInterface_V1_3_0_HostInterface_CS **ReturnedCS);

## C Structure to Redfish HostInterface V1_3_0 JSON Function
    RedfishCS_status
    CS_To_HostInterface_V1_3_0_JSON (RedfishHostInterface_V1_3_0_HostInterface_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish HostInterface V1_3_0 C Structure Function
    RedfishCS_status
