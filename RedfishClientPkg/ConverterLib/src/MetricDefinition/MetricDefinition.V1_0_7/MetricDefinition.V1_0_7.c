...
#include"Redfish_MetricDefinition_v1_0_7_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishMetricDefinition_V1_0_7_MetricDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishMetricDefinition_V1_0_7_MetricDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishMetricDefinition_V1_0_7_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMetricDefinition_V1_0_7_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishMetricDefinition_V1_0_7_MetricDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishMetricDefinition_V1_0_7_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMetricDefinition_V1_0_7_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenCalculationParamsType_Array_ElementCs(RedfishMetricDefinition_V1_0_7_MetricDefinition_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishMetricDefinition_V1_0_7_CalculationParamsType_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishMetricDefinition_V1_0_7_CalculationParamsType_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ResultMetric
...
//
//Generate C structure for RedfishMetricDefinition_V1_0_7_CalculationParamsType_Array_CS
//
static RedfishCS_status GenCalculationParamsType_ArrayCs(RedfishMetricDefinition_V1_0_7_MetricDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishMetricDefinition_V1_0_7_CalculationParamsType_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishMetricDefinition_V1_0_7_CalculationParamsType_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishMetricDefinition_V1_0_7_CalculationParamsType_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishMetricDefinition_V1_0_7_MetricDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status GenWildcard_Array_ElementCs(RedfishMetricDefinition_V1_0_7_MetricDefinition_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishMetricDefinition_V1_0_7_Wildcard_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishMetricDefinition_V1_0_7_Wildcard_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Name
...
//
//Generate C structure for RedfishMetricDefinition_V1_0_7_Wildcard_Array_CS
//
static RedfishCS_status GenWildcard_ArrayCs(RedfishMetricDefinition_V1_0_7_MetricDefinition_CS *Cs, json_t *JsonObj, char *Key, RedfishMetricDefinition_V1_0_7_Wildcard_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishMetricDefinition_V1_0_7_Wildcard_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishMetricDefinition_V1_0_7_Wildcard_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishMetricDefinition_V1_0_7_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishMetricDefinition_V1_0_7_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_CalculationParameters(json_t *CsJson, char *Key, RedfishMetricDefinition_V1_0_7_CalculationParamsType_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishMetricDefinition_V1_0_7_CalculationParamsType_Array_CS *NextArray;
  RedfishMetricDefinition_V1_0_7_CalculationParamsType_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_Wildcards(json_t *CsJson, char *Key, RedfishMetricDefinition_V1_0_7_Wildcard_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishMetricDefinition_V1_0_7_Wildcard_Array_CS *NextArray;
  RedfishMetricDefinition_V1_0_7_Wildcard_CS *NextArrayItem;
...
//
// C structure to JSON for MetricDefinition.V1_0_7.MetricDefinition
//
RedfishCS_status CS_To_MetricDefinition_V1_0_7_JSON(RedfishMetricDefinition_V1_0_7_MetricDefinition_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for MetricDefinition.V1_0_7.MetricDefinition
//
RedfishCS_status DestroyMetricDefinition_V1_0_7_CS(RedfishMetricDefinition_V1_0_7_MetricDefinition_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MetricDefinition.V1_0_7.MetricDefinition
//
RedfishCS_status DestroyMetricDefinition_V1_0_7_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MetricDefinition.V1_0_7.MetricDefinition
//
RedfishCS_status
Json_MetricDefinition_V1_0_7_To_CS(RedfishCS_char *JsonRawText, RedfishMetricDefinition_V1_0_7_MetricDefinition_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMetricDefinition_V1_0_7_MetricDefinition_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MetricDefinition", "v1_0_7", "MetricDefinition", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMetricDefinition_V1_0_7_MetricDefinition_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyMetricDefinition_V1_0_7_CS (Cs);
  return Status;
}
