# Definition of MetricDefinition.V1_0_7 and functions<br><br>

## Actions
    typedef struct _RedfishMetricDefinition_V1_0_7_Actions_CS {
        RedfishMetricDefinition_V1_0_7_OemActions_CS *Oem;
    } RedfishMetricDefinition_V1_0_7_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishMetricDefinition_V1_0_7_OemActions_CS| Structure points to **Oem** property.| No| No
...
## MetricDefinition
    typedef struct _RedfishMetricDefinition_V1_0_7_MetricDefinition_CS {
        ...
        RedfishMetricDefinition_V1_0_7_Actions_CS *Actions;
        RedfishCS_char *Calculable;
        RedfishCS_char *CalculationAlgorithm;
        RedfishMetricDefinition_V1_0_7_CalculationParamsType_CS *CalculationParameters;
        ...
        RedfishMetricDefinition_V1_0_7_Wildcard_CS *Wildcards;
...
|**Actions**|RedfishMetricDefinition_V1_0_7_Actions_CS| Structure points to **Actions** property.| No| No
...
|**CalculationParameters**|RedfishMetricDefinition_V1_0_7_CalculationParamsType_CS| Structure points to **CalculationParameters** property.| No| No
...
|**Wildcards**|RedfishMetricDefinition_V1_0_7_Wildcard_CS| Structure points to **Wildcards** property.| No| No
## Redfish MetricDefinition V1_0_7 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish MetricDefinition V1_0_7 JSON Function
    RedfishCS_status
    CS_To_MetricDefinition_V1_0_7_JSON (RedfishMetricDefinition_V1_0_7_MetricDefinition_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish MetricDefinition V1_0_7 C Structure Function
    RedfishCS_status
