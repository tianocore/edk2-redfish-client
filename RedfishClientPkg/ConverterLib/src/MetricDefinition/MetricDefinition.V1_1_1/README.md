# Definition of MetricDefinition.V1_1_1 and functions<br><br>

## Actions
    typedef struct _RedfishMetricDefinition_V1_1_1_Actions_CS {
        RedfishMetricDefinition_V1_1_1_OemActions_CS *Oem;
    } RedfishMetricDefinition_V1_1_1_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishMetricDefinition_V1_1_1_OemActions_CS| Structure points to **Oem** property.| No| No
...
## MetricDefinition
    typedef struct _RedfishMetricDefinition_V1_1_1_MetricDefinition_CS {
        ...
        RedfishMetricDefinition_V1_1_1_Actions_CS *Actions;
        RedfishCS_char *Calculable;
        RedfishCS_char *CalculationAlgorithm;
        RedfishMetricDefinition_V1_1_1_CalculationParamsType_CS *CalculationParameters;
        ...
        RedfishCS_char *Name;
        RedfishCS_char *OEMCalculationAlgorithm;
        ...
        RedfishMetricDefinition_V1_1_1_Wildcard_CS *Wildcards;
...
|**Actions**|RedfishMetricDefinition_V1_1_1_Actions_CS| Structure points to **Actions** property.| No| No
...
|**CalculationParameters**|RedfishMetricDefinition_V1_1_1_CalculationParamsType_CS| Structure points to **CalculationParameters** property.| No| No
...
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**OEMCalculationAlgorithm**|RedfishCS_char| String pointer to **OEMCalculationAlgorithm** property.| No| Yes
...
|**Wildcards**|RedfishMetricDefinition_V1_1_1_Wildcard_CS| Structure points to **Wildcards** property.| No| No
## Redfish MetricDefinition V1_1_1 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish MetricDefinition V1_1_1 JSON Function
    RedfishCS_status
    CS_To_MetricDefinition_V1_1_1_JSON (RedfishMetricDefinition_V1_1_1_MetricDefinition_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish MetricDefinition V1_1_1 C Structure Function
    RedfishCS_status
