# Definition of MetricDefinition.V1_1_3 and functions<br><br>

## Actions
    typedef struct _RedfishMetricDefinition_V1_1_3_Actions_CS {
        RedfishMetricDefinition_V1_1_3_OemActions_CS *Oem;
    } RedfishMetricDefinition_V1_1_3_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishMetricDefinition_V1_1_3_OemActions_CS| Structure points to **Oem** property.| No| No
...
## MetricDefinition
    typedef struct _RedfishMetricDefinition_V1_1_3_MetricDefinition_CS {
        ...
        RedfishMetricDefinition_V1_1_3_Actions_CS *Actions;
        RedfishCS_char *Calculable;
        RedfishCS_char *CalculationAlgorithm;
        RedfishMetricDefinition_V1_1_3_CalculationParamsType_CS *CalculationParameters;
        ...
        RedfishMetricDefinition_V1_1_3_Wildcard_CS *Wildcards;
...
|**Actions**|RedfishMetricDefinition_V1_1_3_Actions_CS| Structure points to **Actions** property.| No| No
...
|**CalculationParameters**|RedfishMetricDefinition_V1_1_3_CalculationParamsType_CS| Structure points to **CalculationParameters** property.| No| No
...
|**Wildcards**|RedfishMetricDefinition_V1_1_3_Wildcard_CS| Structure points to **Wildcards** property.| No| No
## Redfish MetricDefinition V1_1_3 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish MetricDefinition V1_1_3 JSON Function
    RedfishCS_status
    CS_To_MetricDefinition_V1_1_3_JSON (RedfishMetricDefinition_V1_1_3_MetricDefinition_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish MetricDefinition V1_1_3 C Structure Function
    RedfishCS_status
