...
#include"Redfish_Control_v1_0_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishControl_V1_0_1_Control_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishControl_V1_0_1_Control_CS *Cs, json_t *JsonObj, char *Key, RedfishControl_V1_0_1_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishControl_V1_0_1_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishControl_V1_0_1_Control_CS *Cs, json_t *JsonObj, char *Key, RedfishControl_V1_0_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishControl_V1_0_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for RedfishCS_int64_Array
//
static RedfishCS_status GenRedfishCS_int64_ArrayCs(RedfishControl_V1_0_1_Control_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_int64_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenControlLoopCs(RedfishControl_V1_0_1_Control_CS *Cs, json_t *JsonObj, char *Key, RedfishControl_V1_0_1_ControlLoop_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishControl_V1_0_1_ControlLoop_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
static RedfishCS_status GenidRef_Array_ElementCs(RedfishControl_V1_0_1_Control_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRef_ArrayCs(RedfishControl_V1_0_1_Control_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishControl_V1_0_1_Control_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenidRefCs(RedfishControl_V1_0_1_Control_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishControl_V1_0_1_Control_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishControl_V1_0_1_Control_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishControl_V1_0_1_Control_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishControl_V1_0_1_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishControl_V1_0_1_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ControlLoop(json_t *CsJson, char *Key, RedfishControl_V1_0_1_ControlLoop_CS *CSPtr)
{
  json_t *CsParentJson;
...
//
// C structure to JSON for Control.V1_0_1.Control
//
RedfishCS_status CS_To_Control_V1_0_1_JSON(RedfishControl_V1_0_1_Control_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Control.V1_0_1.Control
//
RedfishCS_status DestroyControl_V1_0_1_CS(RedfishControl_V1_0_1_Control_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Control.V1_0_1.Control
//
RedfishCS_status DestroyControl_V1_0_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Control.V1_0_1.Control
//
RedfishCS_status
Json_Control_V1_0_1_To_CS(RedfishCS_char *JsonRawText, RedfishControl_V1_0_1_Control_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishControl_V1_0_1_Control_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Control", "v1_0_1", "Control", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishControl_V1_0_1_Control_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
