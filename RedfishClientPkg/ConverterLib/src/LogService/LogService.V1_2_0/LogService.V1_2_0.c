...
#include"Redfish_LogService_v1_2_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishLogService_V1_2_0_LogService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishLogService_V1_2_0_LogService_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for #LogService.ClearLog
//
static RedfishCS_status GenClearLogCs(RedfishLogService_V1_2_0_LogService_CS *Cs, json_t *JsonObj, char *Key, RedfishLogService_V1_2_0_ClearLog_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLogService_V1_2_0_ClearLog_CS), (RedfishCS_void **)Dst);
...
//
//Generate C structure for #LogService.CollectDiagnosticData
//
static RedfishCS_status GenCollectDiagnosticDataCs(RedfishLogService_V1_2_0_LogService_CS *Cs, json_t *JsonObj, char *Key, RedfishLogService_V1_2_0_CollectDiagnosticData_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLogService_V1_2_0_CollectDiagnosticData_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishLogService_V1_2_0_LogService_CS *Cs, json_t *JsonObj, char *Key, RedfishLogService_V1_2_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLogService_V1_2_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishLogService_V1_2_0_LogService_CS *Cs, json_t *JsonObj, char *Key, RedfishLogService_V1_2_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLogService_V1_2_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #LogService.ClearLog
  ...
  Status = GenCollectDiagnosticDataCs (Cs, TempJsonObj, "#LogService.CollectDiagnosticData", &(*Dst)->LogService_CollectDiagnosticData);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenidRefCs(RedfishLogService_V1_2_0_LogService_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishLogService_V1_2_0_LogService_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishLogService_V1_2_0_LogService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishLogService_V1_2_0_LogService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenSyslogFilter_Array_ElementCs(RedfishLogService_V1_2_0_LogService_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishLogService_V1_2_0_SyslogFilter_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishLogService_V1_2_0_SyslogFilter_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // LogFacilities
...
//
//Generate C structure for RedfishLogService_V1_2_0_SyslogFilter_Array_CS
//
static RedfishCS_status GenSyslogFilter_ArrayCs(RedfishLogService_V1_2_0_LogService_CS *Cs, json_t *JsonObj, char *Key, RedfishLogService_V1_2_0_SyslogFilter_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishLogService_V1_2_0_SyslogFilter_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishLogService_V1_2_0_SyslogFilter_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsLogService_ClearLog(json_t *CsJson, char *Key, RedfishLogService_V1_2_0_ClearLog_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsLogService_CollectDiagnosticData(json_t *CsJson, char *Key, RedfishLogService_V1_2_0_CollectDiagnosticData_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishLogService_V1_2_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishLogService_V1_2_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // #LogService.CollectDiagnosticData
  if (CS_To_JSON_ActionsLogService_CollectDiagnosticData(CsJson, "#LogService.CollectDiagnosticData", CSPtr->LogService_CollectDiagnosticData) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_SyslogFilters(json_t *CsJson, char *Key, RedfishLogService_V1_2_0_SyslogFilter_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishLogService_V1_2_0_SyslogFilter_Array_CS *NextArray;
  RedfishLogService_V1_2_0_SyslogFilter_CS *NextArrayItem;
...
//
// C structure to JSON for LogService.V1_2_0.LogService
//
RedfishCS_status CS_To_LogService_V1_2_0_JSON(RedfishLogService_V1_2_0_LogService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for LogService.V1_2_0.LogService
//
RedfishCS_status DestroyLogService_V1_2_0_CS(RedfishLogService_V1_2_0_LogService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for LogService.V1_2_0.LogService
//
RedfishCS_status DestroyLogService_V1_2_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for LogService.V1_2_0.LogService
//
RedfishCS_status
Json_LogService_V1_2_0_To_CS(RedfishCS_char *JsonRawText, RedfishLogService_V1_2_0_LogService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishLogService_V1_2_0_LogService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "LogService", "v1_2_0", "LogService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishLogService_V1_2_0_LogService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyLogService_V1_2_0_CS (Cs);
  return Status;
}
