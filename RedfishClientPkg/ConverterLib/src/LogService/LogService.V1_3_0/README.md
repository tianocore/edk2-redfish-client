# Definition of LogService.V1_3_0 and functions<br><br>
...
## Actions
    typedef struct _RedfishLogService_V1_3_0_Actions_CS {
        ...
        RedfishLogService_V1_3_0_OemActions_CS *Oem;
    } RedfishLogService_V1_3_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**LogService_ClearLog**|RedfishLogService_V1_3_0_ClearLog_CS| Structure points to **#LogService.ClearLog** property.| No| No
|**LogService_CollectDiagnosticData**|RedfishLogService_V1_3_0_CollectDiagnosticData_CS| Structure points to **#LogService.CollectDiagnosticData** property.| No| No
|**Oem**|RedfishLogService_V1_3_0_OemActions_CS| Structure points to **Oem** property.| No| No
...
## LogService
    typedef struct _RedfishLogService_V1_3_0_LogService_CS {
        ...
        RedfishLogService_V1_3_0_Actions_CS *Actions;
        ...
        RedfishLogService_V1_3_0_SyslogFilter_CS *SyslogFilters;
...
|**Actions**|RedfishLogService_V1_3_0_Actions_CS| Structure points to **Actions** property.| No| No
...
|**SyslogFilters**|RedfishLogService_V1_3_0_SyslogFilter_CS| Structure points to **SyslogFilters** property.| No| No
## Redfish LogService V1_3_0 to C Structure Function
    RedfishCS_status
    Json_LogService_V1_3_0_To_CS (RedfishCS_char *JsonRawText, RedfishLogService_V1_3_0_LogService_CS **ReturnedCS);

## C Structure to Redfish LogService V1_3_0 JSON Function
    RedfishCS_status
    CS_To_LogService_V1_3_0_JSON (RedfishLogService_V1_3_0_LogService_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish LogService V1_3_0 C Structure Function
    RedfishCS_status
