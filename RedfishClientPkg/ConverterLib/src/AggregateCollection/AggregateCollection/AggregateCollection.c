...
#include"Redfish_AggregateCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishAggregateCollection_AggregateCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for AggregateCollection.AggregateCollection
//
RedfishCS_status CS_To_AggregateCollection_JSON(RedfishAggregateCollection_AggregateCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for AggregateCollection.AggregateCollection
//
RedfishCS_status DestroyAggregateCollection_CS(RedfishAggregateCollection_AggregateCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for AggregateCollection.AggregateCollection
//
RedfishCS_status DestroyAggregateCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for AggregateCollection.NOVERSIONED.AggregateCollection
//
RedfishCS_status
Json_AggregateCollection_To_CS(RedfishCS_char *JsonRawText, RedfishAggregateCollection_AggregateCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAggregateCollection_AggregateCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "AggregateCollection", "noversioned", "AggregateCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAggregateCollection_AggregateCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyAggregateCollection_CS (Cs);
  return Status;
}
