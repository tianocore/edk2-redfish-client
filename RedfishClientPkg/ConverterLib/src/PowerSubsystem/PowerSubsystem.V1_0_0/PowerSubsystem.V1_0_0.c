...
#include"Redfish_PowerSubsystem_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishPowerSubsystem_V1_0_0_PowerSubsystem_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishPowerSubsystem_V1_0_0_PowerSubsystem_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerSubsystem_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerSubsystem_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishPowerSubsystem_V1_0_0_PowerSubsystem_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerSubsystem_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerSubsystem_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenPowerAllocationCs(RedfishPowerSubsystem_V1_0_0_PowerSubsystem_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerSubsystem_V1_0_0_PowerAllocation_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerSubsystem_V1_0_0_PowerAllocation_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AllocatedWatts
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishPowerSubsystem_V1_0_0_PowerSubsystem_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishPowerSubsystem_V1_0_0_PowerSubsystem_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishPowerSubsystem_V1_0_0_PowerSubsystem_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishPowerSubsystem_V1_0_0_PowerSubsystem_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishPowerSubsystem_V1_0_0_PowerSubsystem_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishPowerSubsystem_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishPowerSubsystem_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Allocation(json_t *CsJson, char *Key, RedfishPowerSubsystem_V1_0_0_PowerAllocation_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for PowerSubsystem.V1_0_0.PowerSubsystem
//
RedfishCS_status CS_To_PowerSubsystem_V1_0_0_JSON(RedfishPowerSubsystem_V1_0_0_PowerSubsystem_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for PowerSubsystem.V1_0_0.PowerSubsystem
//
RedfishCS_status DestroyPowerSubsystem_V1_0_0_CS(RedfishPowerSubsystem_V1_0_0_PowerSubsystem_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PowerSubsystem.V1_0_0.PowerSubsystem
//
RedfishCS_status DestroyPowerSubsystem_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PowerSubsystem.V1_0_0.PowerSubsystem
//
RedfishCS_status
Json_PowerSubsystem_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishPowerSubsystem_V1_0_0_PowerSubsystem_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPowerSubsystem_V1_0_0_PowerSubsystem_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PowerSubsystem", "v1_0_0", "PowerSubsystem", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPowerSubsystem_V1_0_0_PowerSubsystem_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyPowerSubsystem_V1_0_0_CS (Cs);
  return Status;
}
