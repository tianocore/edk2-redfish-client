# Definition of VCATEntryCollection and functions<br><br>
...
## Redfish VCATEntryCollection  to C Structure Function
    RedfishCS_status
    Json_VCATEntryCollection_To_CS (RedfishCS_char *JsonRawText, RedfishVCATEntryCollection_VCATEntryCollection_CS **ReturnedCS);

## C Structure to Redfish VCATEntryCollection  JSON Function
    RedfishCS_status
    CS_To_VCATEntryCollection_JSON (RedfishVCATEntryCollection_VCATEntryCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish VCATEntryCollection  C Structure Function
    RedfishCS_status
