...
#include"Redfish_NetworkInterface_v1_1_2_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishNetworkInterface_V1_1_2_NetworkInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishNetworkInterface_V1_1_2_NetworkInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkInterface_V1_1_2_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkInterface_V1_1_2_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishNetworkInterface_V1_1_2_NetworkInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkInterface_V1_1_2_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkInterface_V1_1_2_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishNetworkInterface_V1_1_2_NetworkInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkInterface_V1_1_2_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkInterface_V1_1_2_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // NetworkAdapter
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishNetworkInterface_V1_1_2_NetworkInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishNetworkInterface_V1_1_2_NetworkInterface_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishNetworkInterface_V1_1_2_NetworkInterface_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishNetworkInterface_V1_1_2_NetworkInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishNetworkInterface_V1_1_2_NetworkInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishNetworkInterface_V1_1_2_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishNetworkInterface_V1_1_2_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishNetworkInterface_V1_1_2_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for NetworkInterface.V1_1_2.NetworkInterface
//
RedfishCS_status CS_To_NetworkInterface_V1_1_2_JSON(RedfishNetworkInterface_V1_1_2_NetworkInterface_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for NetworkInterface.V1_1_2.NetworkInterface
//
RedfishCS_status DestroyNetworkInterface_V1_1_2_CS(RedfishNetworkInterface_V1_1_2_NetworkInterface_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for NetworkInterface.V1_1_2.NetworkInterface
//
RedfishCS_status DestroyNetworkInterface_V1_1_2_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for NetworkInterface.V1_1_2.NetworkInterface
//
RedfishCS_status
Json_NetworkInterface_V1_1_2_To_CS(RedfishCS_char *JsonRawText, RedfishNetworkInterface_V1_1_2_NetworkInterface_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishNetworkInterface_V1_1_2_NetworkInterface_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "NetworkInterface", "v1_1_2", "NetworkInterface", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishNetworkInterface_V1_1_2_NetworkInterface_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyNetworkInterface_V1_1_2_CS (Cs);
  return Status;
}
