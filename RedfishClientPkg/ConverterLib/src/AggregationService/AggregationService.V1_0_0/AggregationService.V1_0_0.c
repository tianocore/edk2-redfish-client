...
#include"Redfish_AggregationService_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishAggregationService_V1_0_0_AggregationService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #AggregationService.Reset
//
static RedfishCS_status GenResetCs(RedfishAggregationService_V1_0_0_AggregationService_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregationService_V1_0_0_Reset_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregationService_V1_0_0_Reset_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenSetDefaultBootOrderCs(RedfishAggregationService_V1_0_0_AggregationService_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregationService_V1_0_0_SetDefaultBootOrder_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregationService_V1_0_0_SetDefaultBootOrder_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishAggregationService_V1_0_0_AggregationService_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregationService_V1_0_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregationService_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishAggregationService_V1_0_0_AggregationService_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregationService_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregationService_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishAggregationService_V1_0_0_AggregationService_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishAggregationService_V1_0_0_AggregationService_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishAggregationService_V1_0_0_AggregationService_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishAggregationService_V1_0_0_AggregationService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishAggregationService_V1_0_0_AggregationService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsAggregationService_Reset(json_t *CsJson, char *Key, RedfishAggregationService_V1_0_0_Reset_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsAggregationService_SetDefaultBootOrder(json_t *CsJson, char *Key, RedfishAggregationService_V1_0_0_SetDefaultBootOrder_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishAggregationService_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishAggregationService_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for AggregationService.V1_0_0.AggregationService
//
RedfishCS_status CS_To_AggregationService_V1_0_0_JSON(RedfishAggregationService_V1_0_0_AggregationService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for AggregationService.V1_0_0.AggregationService
//
RedfishCS_status DestroyAggregationService_V1_0_0_CS(RedfishAggregationService_V1_0_0_AggregationService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for AggregationService.V1_0_0.AggregationService
//
RedfishCS_status DestroyAggregationService_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for AggregationService.V1_0_0.AggregationService
//
RedfishCS_status
Json_AggregationService_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishAggregationService_V1_0_0_AggregationService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAggregationService_V1_0_0_AggregationService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "AggregationService", "v1_0_0", "AggregationService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAggregationService_V1_0_0_AggregationService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyAggregationService_V1_0_0_CS (Cs);
  return Status;
}
