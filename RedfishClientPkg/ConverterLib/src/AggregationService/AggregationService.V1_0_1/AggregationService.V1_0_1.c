...
#include"Redfish_AggregationService_v1_0_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishAggregationService_V1_0_1_AggregationService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #AggregationService.Reset
//
static RedfishCS_status GenResetCs(RedfishAggregationService_V1_0_1_AggregationService_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregationService_V1_0_1_Reset_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregationService_V1_0_1_Reset_CS), (RedfishCS_void **)Dst);
...
//
//Generate C structure for #AggregationService.SetDefaultBootOrder
//
static RedfishCS_status GenSetDefaultBootOrderCs(RedfishAggregationService_V1_0_1_AggregationService_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregationService_V1_0_1_SetDefaultBootOrder_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregationService_V1_0_1_SetDefaultBootOrder_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishAggregationService_V1_0_1_AggregationService_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregationService_V1_0_1_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregationService_V1_0_1_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishAggregationService_V1_0_1_AggregationService_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregationService_V1_0_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregationService_V1_0_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #AggregationService.Reset
  Status = GenResetCs (Cs, TempJsonObj, "#AggregationService.Reset", &(*Dst)->AggregationService_Reset);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // #AggregationService.SetDefaultBootOrder
  Status = GenSetDefaultBootOrderCs (Cs, TempJsonObj, "#AggregationService.SetDefaultBootOrder", &(*Dst)->AggregationService_SetDefaultBootOrder);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishAggregationService_V1_0_1_AggregationService_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishAggregationService_V1_0_1_AggregationService_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishAggregationService_V1_0_1_AggregationService_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishAggregationService_V1_0_1_AggregationService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishAggregationService_V1_0_1_AggregationService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsAggregationService_Reset(json_t *CsJson, char *Key, RedfishAggregationService_V1_0_1_Reset_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsAggregationService_SetDefaultBootOrder(json_t *CsJson, char *Key, RedfishAggregationService_V1_0_1_SetDefaultBootOrder_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishAggregationService_V1_0_1_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishAggregationService_V1_0_1_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // #AggregationService.Reset
  if (CS_To_JSON_ActionsAggregationService_Reset(CsJson, "#AggregationService.Reset", CSPtr->AggregationService_Reset) != RedfishCS_status_success) {goto Error;}

  // #AggregationService.SetDefaultBootOrder
  if (CS_To_JSON_ActionsAggregationService_SetDefaultBootOrder(CsJson, "#AggregationService.SetDefaultBootOrder", CSPtr->AggregationService_SetDefaultBootOrder) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for AggregationService.V1_0_1.AggregationService
//
RedfishCS_status CS_To_AggregationService_V1_0_1_JSON(RedfishAggregationService_V1_0_1_AggregationService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // Aggregates 
  if (InsertJsonLinkObj (CsJson, "Aggregates", &CSPtr->Aggregates) != RedfishCS_status_success) {goto Error;}

  // AggregationSources 
  if (InsertJsonLinkObj (CsJson, "AggregationSources", &CSPtr->AggregationSources) != RedfishCS_status_success) {goto Error;}

  // ConnectionMethods 
  if (InsertJsonLinkObj (CsJson, "ConnectionMethods", &CSPtr->ConnectionMethods) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for AggregationService.V1_0_1.AggregationService
//
RedfishCS_status DestroyAggregationService_V1_0_1_CS(RedfishAggregationService_V1_0_1_AggregationService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for AggregationService.V1_0_1.AggregationService
//
RedfishCS_status DestroyAggregationService_V1_0_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for AggregationService.V1_0_1.AggregationService
//
RedfishCS_status
Json_AggregationService_V1_0_1_To_CS(RedfishCS_char *JsonRawText, RedfishAggregationService_V1_0_1_AggregationService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAggregationService_V1_0_1_AggregationService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "AggregationService", "v1_0_1", "AggregationService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAggregationService_V1_0_1_AggregationService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // Aggregates
  InitializeLinkHead (&Cs->Aggregates);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "Aggregates", Cs->Header.ThisUri, &Cs->Aggregates);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // AggregationSources
  InitializeLinkHead (&Cs->AggregationSources);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "AggregationSources", Cs->Header.ThisUri, &Cs->AggregationSources);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ConnectionMethods
  InitializeLinkHead (&Cs->ConnectionMethods);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "ConnectionMethods", Cs->Header.ThisUri, &Cs->ConnectionMethods);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyAggregationService_V1_0_1_CS (Cs);
  return Status;
}
