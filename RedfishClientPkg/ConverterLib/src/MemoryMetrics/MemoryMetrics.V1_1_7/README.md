# Definition of MemoryMetrics.V1_1_7 and functions<br><br>
...
## Actions
    typedef struct _RedfishMemoryMetrics_V1_1_7_Actions_CS {
        ...
        RedfishMemoryMetrics_V1_1_7_OemActions_CS *Oem;
    } RedfishMemoryMetrics_V1_1_7_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**MemoryMetrics_ClearCurrentPeriod**|RedfishMemoryMetrics_V1_1_7_ClearCurrentPeriod_CS| Structure points to **#MemoryMetrics.ClearCurrentPeriod** property.| No| No
|**Oem**|RedfishMemoryMetrics_V1_1_7_OemActions_CS| Structure points to **Oem** property.| No| No
...
## HealthData
    typedef struct _RedfishMemoryMetrics_V1_1_7_HealthData_CS {
        RedfishMemoryMetrics_V1_1_7_AlarmTrips_CS *AlarmTrips;
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**AlarmTrips**|RedfishMemoryMetrics_V1_1_7_AlarmTrips_CS| Structure points to **AlarmTrips** property.| No| No
...
## MemoryMetrics
    typedef struct _RedfishMemoryMetrics_V1_1_7_MemoryMetrics_CS {
        ...
        RedfishMemoryMetrics_V1_1_7_Actions_CS *Actions;
        RedfishCS_int64 *BlockSizeBytes;
        RedfishMemoryMetrics_V1_1_7_CurrentPeriod_CS *CurrentPeriod;
        RedfishCS_char *Description;
        RedfishMemoryMetrics_V1_1_7_HealthData_CS *HealthData;
        RedfishCS_char *Id;
        RedfishMemoryMetrics_V1_1_7_LifeTime_CS *LifeTime;
        RedfishCS_char *Name;
...
|**Actions**|RedfishMemoryMetrics_V1_1_7_Actions_CS| Structure points to **Actions** property.| No| No
|**BlockSizeBytes**|RedfishCS_int64| 64-bit long long interger pointer to **BlockSizeBytes** property.| No| Yes
|**CurrentPeriod**|RedfishMemoryMetrics_V1_1_7_CurrentPeriod_CS| Structure points to **CurrentPeriod** property.| No| No
|**Description**|RedfishCS_char| String pointer to **Description** property.| No| Yes
|**HealthData**|RedfishMemoryMetrics_V1_1_7_HealthData_CS| Structure points to **HealthData** property.| No| No
|**Id**|RedfishCS_char| String pointer to **Id** property.| Yes| Yes
|**LifeTime**|RedfishMemoryMetrics_V1_1_7_LifeTime_CS| Structure points to **LifeTime** property.| No| No
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
## Redfish MemoryMetrics V1_1_7 to C Structure Function
    RedfishCS_status
    Json_MemoryMetrics_V1_1_7_To_CS (RedfishCS_char *JsonRawText, RedfishMemoryMetrics_V1_1_7_MemoryMetrics_CS **ReturnedCS);

## C Structure to Redfish MemoryMetrics V1_1_7 JSON Function
    RedfishCS_status
    CS_To_MemoryMetrics_V1_1_7_JSON (RedfishMemoryMetrics_V1_1_7_MemoryMetrics_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish MemoryMetrics V1_1_7 C Structure Function
    RedfishCS_status
