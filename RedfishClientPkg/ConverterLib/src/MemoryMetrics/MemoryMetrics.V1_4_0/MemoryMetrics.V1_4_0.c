...
#include"Redfish_MemoryMetrics_v1_4_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenClearCurrentPeriodCs(RedfishMemoryMetrics_V1_4_0_MemoryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishMemoryMetrics_V1_4_0_ClearCurrentPeriod_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemoryMetrics_V1_4_0_ClearCurrentPeriod_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishMemoryMetrics_V1_4_0_MemoryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishMemoryMetrics_V1_4_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemoryMetrics_V1_4_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishMemoryMetrics_V1_4_0_MemoryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishMemoryMetrics_V1_4_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemoryMetrics_V1_4_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenCurrentPeriodCs(RedfishMemoryMetrics_V1_4_0_MemoryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishMemoryMetrics_V1_4_0_CurrentPeriod_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemoryMetrics_V1_4_0_CurrentPeriod_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // BlocksRead
...
//
static RedfishCS_status GenAlarmTripsCs(RedfishMemoryMetrics_V1_4_0_MemoryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishMemoryMetrics_V1_4_0_AlarmTrips_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemoryMetrics_V1_4_0_AlarmTrips_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AddressParityError
...
//
static RedfishCS_status GenHealthDataCs(RedfishMemoryMetrics_V1_4_0_MemoryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishMemoryMetrics_V1_4_0_HealthData_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemoryMetrics_V1_4_0_HealthData_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AlarmTrips
...
//
static RedfishCS_status GenLifeTimeCs(RedfishMemoryMetrics_V1_4_0_MemoryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishMemoryMetrics_V1_4_0_LifeTime_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemoryMetrics_V1_4_0_LifeTime_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // BlocksRead
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishMemoryMetrics_V1_4_0_MemoryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsMemoryMetrics_ClearCurrentPeriod(json_t *CsJson, char *Key, RedfishMemoryMetrics_V1_4_0_ClearCurrentPeriod_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishMemoryMetrics_V1_4_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishMemoryMetrics_V1_4_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_CurrentPeriod(json_t *CsJson, char *Key, RedfishMemoryMetrics_V1_4_0_CurrentPeriod_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_HealthDataAlarmTrips(json_t *CsJson, char *Key, RedfishMemoryMetrics_V1_4_0_AlarmTrips_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_HealthData(json_t *CsJson, char *Key, RedfishMemoryMetrics_V1_4_0_HealthData_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_LifeTime(json_t *CsJson, char *Key, RedfishMemoryMetrics_V1_4_0_LifeTime_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for MemoryMetrics.V1_4_0.MemoryMetrics
//
RedfishCS_status CS_To_MemoryMetrics_V1_4_0_JSON(RedfishMemoryMetrics_V1_4_0_MemoryMetrics_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for MemoryMetrics.V1_4_0.MemoryMetrics
//
RedfishCS_status DestroyMemoryMetrics_V1_4_0_CS(RedfishMemoryMetrics_V1_4_0_MemoryMetrics_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MemoryMetrics.V1_4_0.MemoryMetrics
//
RedfishCS_status DestroyMemoryMetrics_V1_4_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MemoryMetrics.V1_4_0.MemoryMetrics
//
RedfishCS_status
Json_MemoryMetrics_V1_4_0_To_CS(RedfishCS_char *JsonRawText, RedfishMemoryMetrics_V1_4_0_MemoryMetrics_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMemoryMetrics_V1_4_0_MemoryMetrics_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MemoryMetrics", "v1_4_0", "MemoryMetrics", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMemoryMetrics_V1_4_0_MemoryMetrics_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyMemoryMetrics_V1_4_0_CS (Cs);
  return Status;
}
