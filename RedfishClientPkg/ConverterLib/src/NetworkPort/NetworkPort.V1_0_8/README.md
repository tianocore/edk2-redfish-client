# Definition of NetworkPort.V1_0_8 and functions<br><br>
...
## NetworkPort
    typedef struct _RedfishNetworkPort_V1_0_8_NetworkPort_CS {
        ...
        RedfishCS_char *Name;
        RedfishNetworkPort_V1_0_8_NetDevFuncMaxBWAlloc_CS *NetDevFuncMaxBWAlloc;
        RedfishNetworkPort_V1_0_8_NetDevFuncMinBWAlloc_CS *NetDevFuncMinBWAlloc;
        RedfishResource_Oem_CS *Oem;
        ...
        RedfishNetworkPort_V1_0_8_SupportedLinkCapabilities_CS *SupportedLinkCapabilities;
...
|**NetDevFuncMaxBWAlloc**|RedfishNetworkPort_V1_0_8_NetDevFuncMaxBWAlloc_CS| Structure points to **NetDevFuncMaxBWAlloc** property.| No| No
|**NetDevFuncMinBWAlloc**|RedfishNetworkPort_V1_0_8_NetDevFuncMinBWAlloc_CS| Structure points to **NetDevFuncMinBWAlloc** property.| No| No
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
...
|**SupportedLinkCapabilities**|RedfishNetworkPort_V1_0_8_SupportedLinkCapabilities_CS| Structure points to **SupportedLinkCapabilities** property.| No| No
|**WakeOnLANEnabled**|RedfishCS_bool| Boolean pointer to **WakeOnLANEnabled** property.| No| No
## Redfish NetworkPort V1_0_8 to C Structure Function
    RedfishCS_status
    Json_NetworkPort_V1_0_8_To_CS (RedfishCS_char *JsonRawText, RedfishNetworkPort_V1_0_8_NetworkPort_CS **ReturnedCS);

## C Structure to Redfish NetworkPort V1_0_8 JSON Function
    RedfishCS_status
    CS_To_NetworkPort_V1_0_8_JSON (RedfishNetworkPort_V1_0_8_NetworkPort_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish NetworkPort V1_0_8 C Structure Function
    RedfishCS_status
