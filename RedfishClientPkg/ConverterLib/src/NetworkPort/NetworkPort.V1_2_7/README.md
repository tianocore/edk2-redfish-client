# Definition of NetworkPort.V1_2_7 and functions<br><br>

## Actions
    typedef struct _RedfishNetworkPort_V1_2_7_Actions_CS {
        RedfishNetworkPort_V1_2_7_OemActions_CS *Oem;
    } RedfishNetworkPort_V1_2_7_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishNetworkPort_V1_2_7_OemActions_CS| Structure points to **Oem** property.| No| No
...
## NetworkPort
    typedef struct _RedfishNetworkPort_V1_2_7_NetworkPort_CS {
        ...
        RedfishNetworkPort_V1_2_7_Actions_CS *Actions;
        ...
        RedfishCS_char *Name;
        RedfishNetworkPort_V1_2_7_NetDevFuncMaxBWAlloc_CS *NetDevFuncMaxBWAlloc;
        RedfishNetworkPort_V1_2_7_NetDevFuncMinBWAlloc_CS *NetDevFuncMinBWAlloc;
        ...
        RedfishNetworkPort_V1_2_7_SupportedLinkCapabilities_CS *SupportedLinkCapabilities;
...
|**Actions**|RedfishNetworkPort_V1_2_7_Actions_CS| Structure points to **Actions** property.| No| No
...
|**NetDevFuncMaxBWAlloc**|RedfishNetworkPort_V1_2_7_NetDevFuncMaxBWAlloc_CS| Structure points to **NetDevFuncMaxBWAlloc** property.| No| No
|**NetDevFuncMinBWAlloc**|RedfishNetworkPort_V1_2_7_NetDevFuncMinBWAlloc_CS| Structure points to **NetDevFuncMinBWAlloc** property.| No| No
...
|**SupportedLinkCapabilities**|RedfishNetworkPort_V1_2_7_SupportedLinkCapabilities_CS| Structure points to **SupportedLinkCapabilities** property.| No| No
...
## Redfish NetworkPort V1_2_7 to C Structure Function
    RedfishCS_status
    Json_NetworkPort_V1_2_7_To_CS (RedfishCS_char *JsonRawText, RedfishNetworkPort_V1_2_7_NetworkPort_CS **ReturnedCS);

## C Structure to Redfish NetworkPort V1_2_7 JSON Function
    RedfishCS_status
    CS_To_NetworkPort_V1_2_7_JSON (RedfishNetworkPort_V1_2_7_NetworkPort_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish NetworkPort V1_2_7 C Structure Function
    RedfishCS_status
