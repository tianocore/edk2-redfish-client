...
#include"Redfish_NetworkPort_v1_0_5_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishNetworkPort_V1_0_5_NetworkPort_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenOemCs(RedfishNetworkPort_V1_0_5_NetworkPort_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
...
static RedfishCS_status GenNetDevFuncMaxBWAlloc_Array_ElementCs(RedfishNetworkPort_V1_0_5_NetworkPort_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishNetworkPort_V1_0_5_NetDevFuncMaxBWAlloc_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishNetworkPort_V1_0_5_NetDevFuncMaxBWAlloc_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MaxBWAllocPercent
...
//
//Generate C structure for RedfishNetworkPort_V1_0_5_NetDevFuncMaxBWAlloc_Array_CS
//
static RedfishCS_status GenNetDevFuncMaxBWAlloc_ArrayCs(RedfishNetworkPort_V1_0_5_NetworkPort_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkPort_V1_0_5_NetDevFuncMaxBWAlloc_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishNetworkPort_V1_0_5_NetDevFuncMaxBWAlloc_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishNetworkPort_V1_0_5_NetDevFuncMaxBWAlloc_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenNetDevFuncMinBWAlloc_Array_ElementCs(RedfishNetworkPort_V1_0_5_NetworkPort_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishNetworkPort_V1_0_5_NetDevFuncMinBWAlloc_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishNetworkPort_V1_0_5_NetDevFuncMinBWAlloc_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MinBWAllocPercent
...
//
//Generate C structure for RedfishNetworkPort_V1_0_5_NetDevFuncMinBWAlloc_Array_CS
//
static RedfishCS_status GenNetDevFuncMinBWAlloc_ArrayCs(RedfishNetworkPort_V1_0_5_NetworkPort_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkPort_V1_0_5_NetDevFuncMinBWAlloc_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishNetworkPort_V1_0_5_NetDevFuncMinBWAlloc_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishNetworkPort_V1_0_5_NetDevFuncMinBWAlloc_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenidRefCs(RedfishNetworkPort_V1_0_5_NetworkPort_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishNetworkPort_V1_0_5_NetworkPort_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishNetworkPort_V1_0_5_NetworkPort_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishNetworkPort_V1_0_5_NetworkPort_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenSupportedLinkCapabilities_Array_ElementCs(RedfishNetworkPort_V1_0_5_NetworkPort_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishNetworkPort_V1_0_5_SupportedLinkCapabilities_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishNetworkPort_V1_0_5_SupportedLinkCapabilities_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
//Generate C structure for RedfishNetworkPort_V1_0_5_SupportedLinkCapabilities_Array_CS
//
static RedfishCS_status GenSupportedLinkCapabilities_ArrayCs(RedfishNetworkPort_V1_0_5_NetworkPort_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkPort_V1_0_5_SupportedLinkCapabilities_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishNetworkPort_V1_0_5_SupportedLinkCapabilities_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishNetworkPort_V1_0_5_SupportedLinkCapabilities_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_NetDevFuncMaxBWAlloc(json_t *CsJson, char *Key, RedfishNetworkPort_V1_0_5_NetDevFuncMaxBWAlloc_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishNetworkPort_V1_0_5_NetDevFuncMaxBWAlloc_Array_CS *NextArray;
  RedfishNetworkPort_V1_0_5_NetDevFuncMaxBWAlloc_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_NetDevFuncMinBWAlloc(json_t *CsJson, char *Key, RedfishNetworkPort_V1_0_5_NetDevFuncMinBWAlloc_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishNetworkPort_V1_0_5_NetDevFuncMinBWAlloc_Array_CS *NextArray;
  RedfishNetworkPort_V1_0_5_NetDevFuncMinBWAlloc_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_SupportedLinkCapabilities(json_t *CsJson, char *Key, RedfishNetworkPort_V1_0_5_SupportedLinkCapabilities_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishNetworkPort_V1_0_5_SupportedLinkCapabilities_Array_CS *NextArray;
  RedfishNetworkPort_V1_0_5_SupportedLinkCapabilities_CS *NextArrayItem;
...
//
// C structure to JSON for NetworkPort.V1_0_5.NetworkPort
//
RedfishCS_status CS_To_NetworkPort_V1_0_5_JSON(RedfishNetworkPort_V1_0_5_NetworkPort_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for NetworkPort.V1_0_5.NetworkPort
//
RedfishCS_status DestroyNetworkPort_V1_0_5_CS(RedfishNetworkPort_V1_0_5_NetworkPort_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for NetworkPort.V1_0_5.NetworkPort
//
RedfishCS_status DestroyNetworkPort_V1_0_5_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for NetworkPort.V1_0_5.NetworkPort
//
RedfishCS_status
Json_NetworkPort_V1_0_5_To_CS(RedfishCS_char *JsonRawText, RedfishNetworkPort_V1_0_5_NetworkPort_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishNetworkPort_V1_0_5_NetworkPort_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "NetworkPort", "v1_0_5", "NetworkPort", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishNetworkPort_V1_0_5_NetworkPort_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyNetworkPort_V1_0_5_CS (Cs);
  return Status;
}
