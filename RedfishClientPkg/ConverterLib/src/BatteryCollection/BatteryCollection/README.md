# Definition of BatteryCollection and functions<br><br>
...
## Redfish BatteryCollection  to C Structure Function
    RedfishCS_status
    Json_BatteryCollection_To_CS (RedfishCS_char *JsonRawText, RedfishBatteryCollection_BatteryCollection_CS **ReturnedCS);

## C Structure to Redfish BatteryCollection  JSON Function
    RedfishCS_status
    CS_To_BatteryCollection_JSON (RedfishBatteryCollection_BatteryCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish BatteryCollection  C Structure Function
    RedfishCS_status
