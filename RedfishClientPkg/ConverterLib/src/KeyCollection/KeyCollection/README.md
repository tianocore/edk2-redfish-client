# Definition of KeyCollection and functions<br><br>
...
## Redfish KeyCollection  to C Structure Function
    RedfishCS_status
    Json_KeyCollection_To_CS (RedfishCS_char *JsonRawText, RedfishKeyCollection_KeyCollection_CS **ReturnedCS);

## C Structure to Redfish KeyCollection  JSON Function
    RedfishCS_status
    CS_To_KeyCollection_JSON (RedfishKeyCollection_KeyCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish KeyCollection  C Structure Function
    RedfishCS_status
