...
#include"Redfish_KeyCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishKeyCollection_KeyCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for KeyCollection.KeyCollection
//
RedfishCS_status CS_To_KeyCollection_JSON(RedfishKeyCollection_KeyCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for KeyCollection.KeyCollection
//
RedfishCS_status DestroyKeyCollection_CS(RedfishKeyCollection_KeyCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for KeyCollection.KeyCollection
//
RedfishCS_status DestroyKeyCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for KeyCollection.NOVERSIONED.KeyCollection
//
RedfishCS_status
Json_KeyCollection_To_CS(RedfishCS_char *JsonRawText, RedfishKeyCollection_KeyCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishKeyCollection_KeyCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "KeyCollection", "noversioned", "KeyCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishKeyCollection_KeyCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
