...
#include"Redfish_CompositionReservation_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishCompositionReservation_V1_0_0_CompositionReservation_CS *Cs, json_t *JsonObj, char *Key, RedfishCompositionReservation_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCompositionReservation_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishCompositionReservation_V1_0_0_CompositionReservation_CS *Cs, json_t *JsonObj, char *Key, RedfishCompositionReservation_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCompositionReservation_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishCompositionReservation_V1_0_0_CompositionReservation_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishCompositionReservation_V1_0_0_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishCompositionReservation_V1_0_0_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
//
// C structure to JSON for CompositionReservation.V1_0_0.CompositionReservation
//
RedfishCS_status CS_To_CompositionReservation_V1_0_0_JSON(RedfishCompositionReservation_V1_0_0_CompositionReservation_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // Manifest 
  if (InsertJsonLinkObj (CsJson, "Manifest", &CSPtr->Manifest) != RedfishCS_status_success) {goto Error;}
  ...
  // ReservationTime 
  if (InsertJsonStringObj (CsJson, "ReservationTime", CSPtr->ReservationTime) != RedfishCS_status_success) {goto Error;}

  // ReservedResourceBlocks 
  if (InsertJsonLinkArrayObj (CsJson, "ReservedResourceBlocks", &CSPtr->ReservedResourceBlocks) != RedfishCS_status_success) {goto Error;}

  // ReservedResourceBlocks@odata.count 
  if (InsertJsonInt64Obj (CsJson, "ReservedResourceBlocks@odata.count", CSPtr->ReservedResourceBlocksodata_count) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for CompositionReservation.V1_0_0.CompositionReservation
//
RedfishCS_status DestroyCompositionReservation_V1_0_0_CS(RedfishCompositionReservation_V1_0_0_CompositionReservation_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for CompositionReservation.V1_0_0.CompositionReservation
//
RedfishCS_status DestroyCompositionReservation_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for CompositionReservation.V1_0_0.CompositionReservation
//
RedfishCS_status
Json_CompositionReservation_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishCompositionReservation_V1_0_0_CompositionReservation_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishCompositionReservation_V1_0_0_CompositionReservation_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "CompositionReservation", "v1_0_0", "CompositionReservation", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishCompositionReservation_V1_0_0_CompositionReservation_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // Manifest
  InitializeLinkHead (&Cs->Manifest);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "Manifest", Cs->Header.ThisUri, &Cs->Manifest);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // ReservationTime
  Status = GetRedfishPropertyStr (Cs, JsonObj, "ReservationTime", &Cs->ReservationTime);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ReservedResourceBlocks
  InitializeLinkHead (&Cs->ReservedResourceBlocks);
  Status = CreateCsUriOrJsonByNodeArray (Cs, JsonObj, "ReservedResourceBlocks", Cs->Header.ThisUri, &Cs->ReservedResourceBlocks);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ReservedResourceBlocks@odata.count
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "ReservedResourceBlocks@odata.count", &Cs->ReservedResourceBlocksodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyCompositionReservation_V1_0_0_CS (Cs);
  return Status;
}
