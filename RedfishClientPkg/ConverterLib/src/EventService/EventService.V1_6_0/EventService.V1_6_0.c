...
#include"Redfish_EventService_v1_6_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishEventService_V1_6_0_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenOemCs(RedfishEventService_V1_6_0_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #EventService.SubmitTestEvent
//
static RedfishCS_status GenSubmitTestEventCs(RedfishEventService_V1_6_0_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishEventService_V1_6_0_SubmitTestEvent_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventService_V1_6_0_SubmitTestEvent_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishEventService_V1_6_0_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishEventService_V1_6_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventService_V1_6_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishEventService_V1_6_0_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishEventService_V1_6_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventService_V1_6_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
//Generate C structure for SMTP
//
static RedfishCS_status GenSMTPCs(RedfishEventService_V1_6_0_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishEventService_V1_6_0_SMTP_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventService_V1_6_0_SMTP_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Authentication
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "Authentication", &(*Dst)->Authentication);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ConnectionProtocol
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "ConnectionProtocol", &(*Dst)->ConnectionProtocol);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // FromAddress
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "FromAddress", &(*Dst)->FromAddress);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // ServerAddress
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "ServerAddress", &(*Dst)->ServerAddress);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenSSEFilterPropertiesSupportedCs(RedfishEventService_V1_6_0_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishEventService_V1_6_0_SSEFilterPropertiesSupported_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventService_V1_6_0_SSEFilterPropertiesSupported_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // EventFormatType
  ...
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "SubordinateResources", &(*Dst)->SubordinateResources);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenidRefCs(RedfishEventService_V1_6_0_EventService_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishEventService_V1_6_0_EventService_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishEventService_V1_6_0_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishEventService_V1_6_0_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsEventService_SubmitTestEvent(json_t *CsJson, char *Key, RedfishEventService_V1_6_0_SubmitTestEvent_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishEventService_V1_6_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishEventService_V1_6_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_SMTP(json_t *CsJson, char *Key, RedfishEventService_V1_6_0_SMTP_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // Authentication 
  if (InsertJsonStringObj (CsJson, "Authentication", CSPtr->Authentication) != RedfishCS_status_success) {goto Error;}

  // ConnectionProtocol 
  if (InsertJsonStringObj (CsJson, "ConnectionProtocol", CSPtr->ConnectionProtocol) != RedfishCS_status_success) {goto Error;}

  // FromAddress 
  if (InsertJsonStringObj (CsJson, "FromAddress", CSPtr->FromAddress) != RedfishCS_status_success) {goto Error;}
  ...
  // ServerAddress 
  if (InsertJsonStringObj (CsJson, "ServerAddress", CSPtr->ServerAddress) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_SSEFilterPropertiesSupported(json_t *CsJson, char *Key, RedfishEventService_V1_6_0_SSEFilterPropertiesSupported_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for EventService.V1_6_0.EventService
//
RedfishCS_status CS_To_EventService_V1_6_0_JSON(RedfishEventService_V1_6_0_EventService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  if (InsertJsonBoolObj (CsJson, "IncludeOriginOfConditionSupported", CSPtr->IncludeOriginOfConditionSupported) != RedfishCS_status_success) {goto Error;}
  ...
  // SMTP
  if (CS_To_JSON_SMTP(CsJson, "SMTP", CSPtr->SMTP) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for EventService.V1_6_0.EventService
//
RedfishCS_status DestroyEventService_V1_6_0_CS(RedfishEventService_V1_6_0_EventService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for EventService.V1_6_0.EventService
//
RedfishCS_status DestroyEventService_V1_6_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for EventService.V1_6_0.EventService
//
RedfishCS_status
Json_EventService_V1_6_0_To_CS(RedfishCS_char *JsonRawText, RedfishEventService_V1_6_0_EventService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEventService_V1_6_0_EventService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "EventService", "v1_6_0", "EventService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEventService_V1_6_0_EventService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // IncludeOriginOfConditionSupported
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "IncludeOriginOfConditionSupported", &Cs->IncludeOriginOfConditionSupported);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // SMTP
  Status = GenSMTPCs (Cs, JsonObj, "SMTP", &Cs->SMTP);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyEventService_V1_6_0_CS (Cs);
  return Status;
}
