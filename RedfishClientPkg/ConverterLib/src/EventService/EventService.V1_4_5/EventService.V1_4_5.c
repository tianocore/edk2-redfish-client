...
#include"Redfish_EventService_v1_4_5_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishEventService_V1_4_5_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenOemCs(RedfishEventService_V1_4_5_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #EventService.SubmitTestEvent
//
static RedfishCS_status GenSubmitTestEventCs(RedfishEventService_V1_4_5_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishEventService_V1_4_5_SubmitTestEvent_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventService_V1_4_5_SubmitTestEvent_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishEventService_V1_4_5_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishEventService_V1_4_5_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventService_V1_4_5_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishEventService_V1_4_5_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishEventService_V1_4_5_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventService_V1_4_5_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenSSEFilterPropertiesSupportedCs(RedfishEventService_V1_4_5_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishEventService_V1_4_5_SSEFilterPropertiesSupported_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEventService_V1_4_5_SSEFilterPropertiesSupported_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // EventFormatType
...
//
static RedfishCS_status GenidRefCs(RedfishEventService_V1_4_5_EventService_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishEventService_V1_4_5_EventService_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishEventService_V1_4_5_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishEventService_V1_4_5_EventService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsEventService_SubmitTestEvent(json_t *CsJson, char *Key, RedfishEventService_V1_4_5_SubmitTestEvent_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishEventService_V1_4_5_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishEventService_V1_4_5_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_SSEFilterPropertiesSupported(json_t *CsJson, char *Key, RedfishEventService_V1_4_5_SSEFilterPropertiesSupported_CS *CSPtr)
{
  json_t *CsParentJson;
...
//
// C structure to JSON for EventService.V1_4_5.EventService
//
RedfishCS_status CS_To_EventService_V1_4_5_JSON(RedfishEventService_V1_4_5_EventService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for EventService.V1_4_5.EventService
//
RedfishCS_status DestroyEventService_V1_4_5_CS(RedfishEventService_V1_4_5_EventService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for EventService.V1_4_5.EventService
//
RedfishCS_status DestroyEventService_V1_4_5_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for EventService.V1_4_5.EventService
//
RedfishCS_status
Json_EventService_V1_4_5_To_CS(RedfishCS_char *JsonRawText, RedfishEventService_V1_4_5_EventService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEventService_V1_4_5_EventService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "EventService", "v1_4_5", "EventService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEventService_V1_4_5_EventService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyEventService_V1_4_5_CS (Cs);
  return Status;
}
