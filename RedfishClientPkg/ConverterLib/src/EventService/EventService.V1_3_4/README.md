# Definition of EventService.V1_3_4 and functions<br><br>
...
## Actions
    typedef struct _RedfishEventService_V1_3_4_Actions_CS {
        ...
        RedfishEventService_V1_3_4_OemActions_CS *Oem;
    } RedfishEventService_V1_3_4_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**EventService_SubmitTestEvent**|RedfishEventService_V1_3_4_SubmitTestEvent_CS| Structure points to **#EventService.SubmitTestEvent** property.| No| No
|**Oem**|RedfishEventService_V1_3_4_OemActions_CS| Structure points to **Oem** property.| No| No
...
## EventService
    typedef struct _RedfishEventService_V1_3_4_EventService_CS {
        ...
        RedfishEventService_V1_3_4_Actions_CS *Actions;
        ...
        RedfishEventService_V1_3_4_SSEFilterPropertiesSupported_CS *SSEFilterPropertiesSupported;
...
|**Actions**|RedfishEventService_V1_3_4_Actions_CS| Structure points to **Actions** property.| No| No
...
|**SSEFilterPropertiesSupported**|RedfishEventService_V1_3_4_SSEFilterPropertiesSupported_CS| Structure points to **SSEFilterPropertiesSupported** property.| No| No
...
## Redfish EventService V1_3_4 to C Structure Function
    RedfishCS_status
    Json_EventService_V1_3_4_To_CS (RedfishCS_char *JsonRawText, RedfishEventService_V1_3_4_EventService_CS **ReturnedCS);

## C Structure to Redfish EventService V1_3_4 JSON Function
    RedfishCS_status
    CS_To_EventService_V1_3_4_JSON (RedfishEventService_V1_3_4_EventService_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish EventService V1_3_4 C Structure Function
    RedfishCS_status
