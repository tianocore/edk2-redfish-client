...
#include"Redfish_EthernetInterface_v1_0_13_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishEthernetInterface_V1_0_13_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenOemCs(RedfishEthernetInterface_V1_0_13_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenIPv6AddressPolicyEntry_Array_ElementCs(RedfishEthernetInterface_V1_0_13_EthernetInterface_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishEthernetInterface_V1_0_13_IPv6AddressPolicyEntry_CS **Dst)
{
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishEthernetInterface_V1_0_13_IPv6AddressPolicyEntry_CS), (RedfishCS_void **)Dst);
...
//
//Generate C structure for RedfishEthernetInterface_V1_0_13_IPv6AddressPolicyEntry_Array_CS
//
static RedfishCS_status GenIPv6AddressPolicyEntry_ArrayCs(RedfishEthernetInterface_V1_0_13_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishEthernetInterface_V1_0_13_IPv6AddressPolicyEntry_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishEthernetInterface_V1_0_13_IPv6AddressPolicyEntry_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishEthernetInterface_V1_0_13_IPv6AddressPolicyEntry_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenidRefCs(RedfishEthernetInterface_V1_0_13_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishEthernetInterface_V1_0_13_EthernetInterface_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishEthernetInterface_V1_0_13_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishEthernetInterface_V1_0_13_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_IPv6AddressPolicyTable(json_t *CsJson, char *Key, RedfishEthernetInterface_V1_0_13_IPv6AddressPolicyEntry_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishEthernetInterface_V1_0_13_IPv6AddressPolicyEntry_Array_CS *NextArray;
  RedfishEthernetInterface_V1_0_13_IPv6AddressPolicyEntry_CS *NextArrayItem;
...
//
// C structure to JSON for EthernetInterface.V1_0_13.EthernetInterface
//
RedfishCS_status CS_To_EthernetInterface_V1_0_13_JSON(RedfishEthernetInterface_V1_0_13_EthernetInterface_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for EthernetInterface.V1_0_13.EthernetInterface
//
RedfishCS_status DestroyEthernetInterface_V1_0_13_CS(RedfishEthernetInterface_V1_0_13_EthernetInterface_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for EthernetInterface.V1_0_13.EthernetInterface
//
RedfishCS_status DestroyEthernetInterface_V1_0_13_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for EthernetInterface.V1_0_13.EthernetInterface
//
RedfishCS_status
Json_EthernetInterface_V1_0_13_To_CS(RedfishCS_char *JsonRawText, RedfishEthernetInterface_V1_0_13_EthernetInterface_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEthernetInterface_V1_0_13_EthernetInterface_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "EthernetInterface", "v1_0_13", "EthernetInterface", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEthernetInterface_V1_0_13_EthernetInterface_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyEthernetInterface_V1_0_13_CS (Cs);
  return Status;
}
