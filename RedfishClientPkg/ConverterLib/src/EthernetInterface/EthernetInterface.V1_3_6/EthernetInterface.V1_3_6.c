...
#include"Redfish_EthernetInterface_v1_3_6_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishEthernetInterface_V1_3_6_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishEthernetInterface_V1_3_6_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishEthernetInterface_V1_3_6_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishEthernetInterface_V1_3_6_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEthernetInterface_V1_3_6_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishEthernetInterface_V1_3_6_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishEthernetInterface_V1_3_6_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEthernetInterface_V1_3_6_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenIPv6AddressPolicyEntry_Array_ElementCs(RedfishEthernetInterface_V1_3_6_EthernetInterface_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishEthernetInterface_V1_3_6_IPv6AddressPolicyEntry_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishEthernetInterface_V1_3_6_IPv6AddressPolicyEntry_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Label
...
//
//Generate C structure for RedfishEthernetInterface_V1_3_6_IPv6AddressPolicyEntry_Array_CS
//
static RedfishCS_status GenIPv6AddressPolicyEntry_ArrayCs(RedfishEthernetInterface_V1_3_6_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishEthernetInterface_V1_3_6_IPv6AddressPolicyEntry_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishEthernetInterface_V1_3_6_IPv6AddressPolicyEntry_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishEthernetInterface_V1_3_6_IPv6AddressPolicyEntry_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenLinksCs(RedfishEthernetInterface_V1_3_6_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishEthernetInterface_V1_3_6_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEthernetInterface_V1_3_6_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Chassis
...
//
static RedfishCS_status GenidRefCs(RedfishEthernetInterface_V1_3_6_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishEthernetInterface_V1_3_6_EthernetInterface_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishEthernetInterface_V1_3_6_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishEthernetInterface_V1_3_6_EthernetInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishEthernetInterface_V1_3_6_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishEthernetInterface_V1_3_6_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_IPv6AddressPolicyTable(json_t *CsJson, char *Key, RedfishEthernetInterface_V1_3_6_IPv6AddressPolicyEntry_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishEthernetInterface_V1_3_6_IPv6AddressPolicyEntry_Array_CS *NextArray;
  RedfishEthernetInterface_V1_3_6_IPv6AddressPolicyEntry_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishEthernetInterface_V1_3_6_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for EthernetInterface.V1_3_6.EthernetInterface
//
RedfishCS_status CS_To_EthernetInterface_V1_3_6_JSON(RedfishEthernetInterface_V1_3_6_EthernetInterface_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for EthernetInterface.V1_3_6.EthernetInterface
//
RedfishCS_status DestroyEthernetInterface_V1_3_6_CS(RedfishEthernetInterface_V1_3_6_EthernetInterface_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for EthernetInterface.V1_3_6.EthernetInterface
//
RedfishCS_status DestroyEthernetInterface_V1_3_6_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for EthernetInterface.V1_3_6.EthernetInterface
//
RedfishCS_status
Json_EthernetInterface_V1_3_6_To_CS(RedfishCS_char *JsonRawText, RedfishEthernetInterface_V1_3_6_EthernetInterface_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEthernetInterface_V1_3_6_EthernetInterface_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "EthernetInterface", "v1_3_6", "EthernetInterface", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEthernetInterface_V1_3_6_EthernetInterface_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyEthernetInterface_V1_3_6_CS (Cs);
  return Status;
}
