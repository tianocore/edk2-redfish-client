# Definition of EthernetInterface.V1_5_1 and functions<br><br>

## Actions
    typedef struct _RedfishEthernetInterface_V1_5_1_Actions_CS {
        RedfishEthernetInterface_V1_5_1_OemActions_CS *Oem;
    } RedfishEthernetInterface_V1_5_1_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishEthernetInterface_V1_5_1_OemActions_CS| Structure points to **Oem** property.| No| No
...
## EthernetInterface
    typedef struct _RedfishEthernetInterface_V1_5_1_EthernetInterface_CS {
        ...
        RedfishEthernetInterface_V1_5_1_Actions_CS *Actions;
        RedfishCS_bool *AutoNeg;
        RedfishEthernetInterface_V1_5_1_DHCPv4Configuration_CS *DHCPv4;
        RedfishEthernetInterface_V1_5_1_DHCPv6Configuration_CS *DHCPv6;
        ...
        RedfishEthernetInterface_V1_5_1_IPv6AddressPolicyEntry_CS *IPv6AddressPolicyTable;
        ...
        RedfishEthernetInterface_V1_5_1_Links_CS *Links;
        ...
        RedfishEthernetInterface_V1_5_1_StatelessAddressAutoConfiguration_CS *StatelessAddressAutoConfig;
...
|**Actions**|RedfishEthernetInterface_V1_5_1_Actions_CS| Structure points to **Actions** property.| No| No
|**AutoNeg**|RedfishCS_bool| Boolean pointer to **AutoNeg** property.| No| No
|**DHCPv4**|RedfishEthernetInterface_V1_5_1_DHCPv4Configuration_CS| Structure points to **DHCPv4** property.| No| No
|**DHCPv6**|RedfishEthernetInterface_V1_5_1_DHCPv6Configuration_CS| Structure points to **DHCPv6** property.| No| No
...
|**IPv6AddressPolicyTable**|RedfishEthernetInterface_V1_5_1_IPv6AddressPolicyEntry_CS| Structure points to **IPv6AddressPolicyTable** property.| No| No
...
|**Links**|RedfishEthernetInterface_V1_5_1_Links_CS| Structure points to **Links** property.| No| No
...
|**StatelessAddressAutoConfig**|RedfishEthernetInterface_V1_5_1_StatelessAddressAutoConfiguration_CS| Structure points to **StatelessAddressAutoConfig** property.| No| No
...
## Redfish EthernetInterface V1_5_1 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish EthernetInterface V1_5_1 JSON Function
    RedfishCS_status
    CS_To_EthernetInterface_V1_5_1_JSON (RedfishEthernetInterface_V1_5_1_EthernetInterface_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish EthernetInterface V1_5_1 C Structure Function
    RedfishCS_status
