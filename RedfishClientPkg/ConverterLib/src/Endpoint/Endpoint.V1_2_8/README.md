# Definition of Endpoint.V1_2_8 and functions<br><br>

## Actions
    typedef struct _RedfishEndpoint_V1_2_8_Actions_CS {
        RedfishEndpoint_V1_2_8_OemActions_CS *Oem;
    } RedfishEndpoint_V1_2_8_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishEndpoint_V1_2_8_OemActions_CS| Structure points to **Oem** property.| No| No


## ConnectedEntity
    typedef struct _RedfishEndpoint_V1_2_8_ConnectedEntity_CS {
        RedfishCS_Link EntityLink;
        RedfishEndpoint_V1_2_8_PciId_CS *EntityPciId;
...
|**EntityPciId**|RedfishEndpoint_V1_2_8_PciId_CS| Structure points to **EntityPciId** property.| No| No
...
## Endpoint
    typedef struct _RedfishEndpoint_V1_2_8_Endpoint_CS {
        ...
        RedfishEndpoint_V1_2_8_Actions_CS *Actions;
        RedfishEndpoint_V1_2_8_ConnectedEntity_CS *ConnectedEntities;
        RedfishCS_char *Description;
        RedfishCS_char *EndpointProtocol;
        RedfishCS_int64 *HostReservationMemoryBytes;
        RedfishEndpoint_V1_2_8_IPTransportDetails_CS *IPTransportDetails;
        RedfishCS_char *Id;
        RedfishCS_Link Identifiers;
        RedfishEndpoint_V1_2_8_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishEndpoint_V1_2_8_PciId_CS *PciId;
...
|**Actions**|RedfishEndpoint_V1_2_8_Actions_CS| Structure points to **Actions** property.| No| No
|**ConnectedEntities**|RedfishEndpoint_V1_2_8_ConnectedEntity_CS| Structure points to **ConnectedEntities** property.| No| No
...
|**IPTransportDetails**|RedfishEndpoint_V1_2_8_IPTransportDetails_CS| Structure points to **IPTransportDetails** property.| No| No
|**Id**|RedfishCS_char| String pointer to **Id** property.| Yes| Yes
|**Identifiers**|RedfishCS_Link| Structure link list to **Identifiers** property.| No| No
|**Links**|RedfishEndpoint_V1_2_8_Links_CS| Structure points to **Links** property.| No| No
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**PciId**|RedfishEndpoint_V1_2_8_PciId_CS| Structure points to **PciId** property.| No| No
...
## Redfish Endpoint V1_2_8 to C Structure Function
    RedfishCS_status
    Json_Endpoint_V1_2_8_To_CS (RedfishCS_char *JsonRawText, RedfishEndpoint_V1_2_8_Endpoint_CS **ReturnedCS);

## C Structure to Redfish Endpoint V1_2_8 JSON Function
    RedfishCS_status
    CS_To_Endpoint_V1_2_8_JSON (RedfishEndpoint_V1_2_8_Endpoint_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Endpoint V1_2_8 C Structure Function
    RedfishCS_status
