...
#include"Redfish_Endpoint_v1_2_5_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishEndpoint_V1_2_5_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenPciIdCs(RedfishEndpoint_V1_2_5_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpoint_V1_2_5_PciId_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishEndpoint_V1_2_5_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpoint_V1_2_5_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEndpoint_V1_2_5_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishEndpoint_V1_2_5_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpoint_V1_2_5_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEndpoint_V1_2_5_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenPciIdCs(RedfishEndpoint_V1_2_5_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpoint_V1_2_5_PciId_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEndpoint_V1_2_5_PciId_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ClassCode
...
static RedfishCS_status GenConnectedEntity_Array_ElementCs(RedfishEndpoint_V1_2_5_Endpoint_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishEndpoint_V1_2_5_ConnectedEntity_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishEndpoint_V1_2_5_ConnectedEntity_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // EntityLink
...
//
//Generate C structure for RedfishEndpoint_V1_2_5_ConnectedEntity_Array_CS
//
static RedfishCS_status GenConnectedEntity_ArrayCs(RedfishEndpoint_V1_2_5_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpoint_V1_2_5_ConnectedEntity_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishEndpoint_V1_2_5_ConnectedEntity_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishEndpoint_V1_2_5_ConnectedEntity_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenIPTransportDetails_Array_ElementCs(RedfishEndpoint_V1_2_5_Endpoint_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishEndpoint_V1_2_5_IPTransportDetails_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishEndpoint_V1_2_5_IPTransportDetails_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // IPv4Address
...
//
//Generate C structure for RedfishEndpoint_V1_2_5_IPTransportDetails_Array_CS
//
static RedfishCS_status GenIPTransportDetails_ArrayCs(RedfishEndpoint_V1_2_5_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpoint_V1_2_5_IPTransportDetails_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishEndpoint_V1_2_5_IPTransportDetails_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishEndpoint_V1_2_5_IPTransportDetails_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenLinksCs(RedfishEndpoint_V1_2_5_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpoint_V1_2_5_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEndpoint_V1_2_5_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishEndpoint_V1_2_5_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenidRefCs(RedfishEndpoint_V1_2_5_Endpoint_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishEndpoint_V1_2_5_Endpoint_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishEndpoint_V1_2_5_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishEndpoint_V1_2_5_Endpoint_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishEndpoint_V1_2_5_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishEndpoint_V1_2_5_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ConnectedEntitiesEntityPciId(json_t *CsJson, char *Key, RedfishEndpoint_V1_2_5_PciId_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ConnectedEntities(json_t *CsJson, char *Key, RedfishEndpoint_V1_2_5_ConnectedEntity_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishEndpoint_V1_2_5_ConnectedEntity_Array_CS *NextArray;
  RedfishEndpoint_V1_2_5_ConnectedEntity_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_IPTransportDetails(json_t *CsJson, char *Key, RedfishEndpoint_V1_2_5_IPTransportDetails_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishEndpoint_V1_2_5_IPTransportDetails_Array_CS *NextArray;
  RedfishEndpoint_V1_2_5_IPTransportDetails_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishEndpoint_V1_2_5_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_PciId(json_t *CsJson, char *Key, RedfishEndpoint_V1_2_5_PciId_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Endpoint.V1_2_5.Endpoint
//
RedfishCS_status CS_To_Endpoint_V1_2_5_JSON(RedfishEndpoint_V1_2_5_Endpoint_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Endpoint.V1_2_5.Endpoint
//
RedfishCS_status DestroyEndpoint_V1_2_5_CS(RedfishEndpoint_V1_2_5_Endpoint_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Endpoint.V1_2_5.Endpoint
//
RedfishCS_status DestroyEndpoint_V1_2_5_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Endpoint.V1_2_5.Endpoint
//
RedfishCS_status
Json_Endpoint_V1_2_5_To_CS(RedfishCS_char *JsonRawText, RedfishEndpoint_V1_2_5_Endpoint_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEndpoint_V1_2_5_Endpoint_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Endpoint", "v1_2_5", "Endpoint", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEndpoint_V1_2_5_Endpoint_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
