# Definition of Endpoint.V1_0_12 and functions<br><br>

## Actions
    typedef struct _RedfishEndpoint_V1_0_12_Actions_CS {
        RedfishEndpoint_V1_0_12_OemActions_CS *Oem;
    } RedfishEndpoint_V1_0_12_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishEndpoint_V1_0_12_OemActions_CS| Structure points to **Oem** property.| No| No


## ConnectedEntity
    typedef struct _RedfishEndpoint_V1_0_12_ConnectedEntity_CS {
        RedfishCS_Link EntityLink;
        RedfishEndpoint_V1_0_12_PciId_CS *EntityPciId;
...
|**EntityPciId**|RedfishEndpoint_V1_0_12_PciId_CS| Structure points to **EntityPciId** property.| No| No
...
## Endpoint
    typedef struct _RedfishEndpoint_V1_0_12_Endpoint_CS {
        ...
        RedfishEndpoint_V1_0_12_Actions_CS *Actions;
        RedfishEndpoint_V1_0_12_ConnectedEntity_CS *ConnectedEntities;
        RedfishCS_char *Description;
        RedfishCS_char *EndpointProtocol;
        RedfishCS_int64 *HostReservationMemoryBytes;
        RedfishCS_char *Id;
        RedfishCS_Link Identifiers;
        RedfishEndpoint_V1_0_12_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishEndpoint_V1_0_12_PciId_CS *PciId;
...
|**Actions**|RedfishEndpoint_V1_0_12_Actions_CS| Structure points to **Actions** property.| No| No
|**ConnectedEntities**|RedfishEndpoint_V1_0_12_ConnectedEntity_CS| Structure points to **ConnectedEntities** property.| No| No
...
|**Identifiers**|RedfishCS_Link| Structure link list to **Identifiers** property.| No| No
|**Links**|RedfishEndpoint_V1_0_12_Links_CS| Structure points to **Links** property.| No| No
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**PciId**|RedfishEndpoint_V1_0_12_PciId_CS| Structure points to **PciId** property.| No| No
...
## Redfish Endpoint V1_0_12 to C Structure Function
    RedfishCS_status
    Json_Endpoint_V1_0_12_To_CS (RedfishCS_char *JsonRawText, RedfishEndpoint_V1_0_12_Endpoint_CS **ReturnedCS);

## C Structure to Redfish Endpoint V1_0_12 JSON Function
    RedfishCS_status
    CS_To_Endpoint_V1_0_12_JSON (RedfishEndpoint_V1_0_12_Endpoint_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Endpoint V1_0_12 C Structure Function
    RedfishCS_status
