...
#include"Redfish_AddressPool_v1_0_2_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishAddressPool_V1_0_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishAddressPool_V1_0_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_0_2_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_0_2_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishAddressPool_V1_0_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_0_2_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_0_2_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenGenZCs(RedfishAddressPool_V1_0_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_0_2_GenZ_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_0_2_GenZ_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AccessKey
...
//
static RedfishCS_status GenLinksCs(RedfishAddressPool_V1_0_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_0_2_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_0_2_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Endpoints
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishAddressPool_V1_0_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishAddressPool_V1_0_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishAddressPool_V1_0_2_AddressPool_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishAddressPool_V1_0_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishAddressPool_V1_0_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishAddressPool_V1_0_2_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishAddressPool_V1_0_2_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_GenZ(json_t *CsJson, char *Key, RedfishAddressPool_V1_0_2_GenZ_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishAddressPool_V1_0_2_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for AddressPool.V1_0_2.AddressPool
//
RedfishCS_status CS_To_AddressPool_V1_0_2_JSON(RedfishAddressPool_V1_0_2_AddressPool_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for AddressPool.V1_0_2.AddressPool
//
RedfishCS_status DestroyAddressPool_V1_0_2_CS(RedfishAddressPool_V1_0_2_AddressPool_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for AddressPool.V1_0_2.AddressPool
//
RedfishCS_status DestroyAddressPool_V1_0_2_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for AddressPool.V1_0_2.AddressPool
//
RedfishCS_status
Json_AddressPool_V1_0_2_To_CS(RedfishCS_char *JsonRawText, RedfishAddressPool_V1_0_2_AddressPool_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAddressPool_V1_0_2_AddressPool_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "AddressPool", "v1_0_2", "AddressPool", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAddressPool_V1_0_2_AddressPool_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyAddressPool_V1_0_2_CS (Cs);
  return Status;
}
