# Definition of AddressPool.V1_1_0 and functions<br><br>
...
## BGPEvpn
    typedef struct _RedfishAddressPool_V1_1_0_BGPEvpn_CS {
        ...
        RedfishAddressPool_V1_1_0_ESINumberRange_CS *ESINumberRange;
        RedfishAddressPool_V1_1_0_EVINumberRange_CS *EVINumberRange;
        RedfishCS_char *GatewayIPAddress;
        RedfishCS_bool *NDPProxyEnabled;
        RedfishCS_bool *NDPSupressionEnabled;
        RedfishAddressPool_V1_1_0_RouteDistinguisherRange_CS *RouteDistinguisherRange;
        RedfishAddressPool_V1_1_0_RouteTargetRange_CS *RouteTargetRange;
        RedfishCS_bool *UnderlayMulticastEnabled;
        RedfishCS_bool *UnknownUnicastSuppressionEnabled;
        RedfishAddressPool_V1_1_0_VLANIdentifierAddressRange_CS *VLANIdentifierAddressRange;
...
|**ESINumberRange**|RedfishAddressPool_V1_1_0_ESINumberRange_CS| Structure points to **ESINumberRange** property.| No| No
|**EVINumberRange**|RedfishAddressPool_V1_1_0_EVINumberRange_CS| Structure points to **EVINumberRange** property.| No| No
...
|**RouteDistinguisherRange**|RedfishAddressPool_V1_1_0_RouteDistinguisherRange_CS| Structure points to **RouteDistinguisherRange** property.| No| No
|**RouteTargetRange**|RedfishAddressPool_V1_1_0_RouteTargetRange_CS| Structure points to **RouteTargetRange** property.| No| No
...
|**VLANIdentifierAddressRange**|RedfishAddressPool_V1_1_0_VLANIdentifierAddressRange_CS| Structure points to **VLANIdentifierAddressRange** property.| No| No
...
## BGPNeighbor
    typedef struct _RedfishAddressPool_V1_1_0_BGPNeighbor_CS {
        ...
        RedfishAddressPool_V1_1_0_MaxPrefix_CS *MaxPrefix;
...
## IPv4
    typedef struct _RedfishAddressPool_V1_1_0_IPv4_CS {
        RedfishCS_char *AnycastGatewayIPAddress;
        RedfishCS_char *AnycastGatewayMACAddress;
        RedfishAddressPool_V1_1_0_DHCP_CS *DHCP;
        RedfishCS_char *DNSDomainName;
        RedfishCS_char_Array *DNSServer;
        RedfishCS_bool *DistributeIntoUnderlayEnabled;
        RedfishAddressPool_V1_1_0_IPv4AddressRange_CS *EBGPAddressRange;
        RedfishAddressPool_V1_1_0_IPv4AddressRange_CS *FabricLinkAddressRange;
        RedfishCS_char *GatewayIPAddress;
        RedfishAddressPool_V1_1_0_IPv4AddressRange_CS *HostAddressRange;
        RedfishAddressPool_V1_1_0_IPv4AddressRange_CS *IBGPAddressRange;
        RedfishAddressPool_V1_1_0_IPv4AddressRange_CS *LoopbackAddressRange;
        RedfishAddressPool_V1_1_0_IPv4AddressRange_CS *ManagementAddressRange;
...
|**AnycastGatewayIPAddress**|RedfishCS_char| String pointer to **AnycastGatewayIPAddress** property.| No| No
|**AnycastGatewayMACAddress**|RedfishCS_char| String pointer to **AnycastGatewayMACAddress** property.| No| No
|**DHCP**|RedfishAddressPool_V1_1_0_DHCP_CS| Structure points to **DHCP** property.| No| No
...
|**EBGPAddressRange**|RedfishAddressPool_V1_1_0_IPv4AddressRange_CS| Structure points to **EBGPAddressRange** property.| No| No
|**FabricLinkAddressRange**|RedfishAddressPool_V1_1_0_IPv4AddressRange_CS| Structure points to **FabricLinkAddressRange** property.| No| No
|**GatewayIPAddress**|RedfishCS_char| String pointer to **GatewayIPAddress** property.| No| No
|**HostAddressRange**|RedfishAddressPool_V1_1_0_IPv4AddressRange_CS| Structure points to **HostAddressRange** property.| No| No
|**IBGPAddressRange**|RedfishAddressPool_V1_1_0_IPv4AddressRange_CS| Structure points to **IBGPAddressRange** property.| No| No
|**LoopbackAddressRange**|RedfishAddressPool_V1_1_0_IPv4AddressRange_CS| Structure points to **LoopbackAddressRange** property.| No| No
|**ManagementAddressRange**|RedfishAddressPool_V1_1_0_IPv4AddressRange_CS| Structure points to **ManagementAddressRange** property.| No| No
