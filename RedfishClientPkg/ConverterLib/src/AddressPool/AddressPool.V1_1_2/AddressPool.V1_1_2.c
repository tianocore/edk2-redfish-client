...
#include"Redfish_AddressPool_v1_1_2_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenIPv4AddressRangeCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_IPv4AddressRange_CS **Dst);
static RedfishCS_status GenVLANIdentifierAddressRangeCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_VLANIdentifierAddressRange_CS **Dst);
static RedfishCS_status GenEBGPCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_EBGP_CS **Dst);
static RedfishCS_status GenASNumberRangeCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_ASNumberRange_CS **Dst);
static RedfishCS_status GenBGPNeighborCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_BGPNeighbor_CS **Dst);
static RedfishCS_status GenBGPRouteCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_BGPRoute_CS **Dst);
static RedfishCS_status GenGracefulRestartCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_GracefulRestart_CS **Dst);
static RedfishCS_status GenMultiplePathsCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_MultiplePaths_CS **Dst);
static RedfishCS_status GenOemCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenBFDSingleHopOnlyCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_BFDSingleHopOnly_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_BFDSingleHopOnly_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // DemandModeEnabled
...
//
static RedfishCS_status GenESINumberRangeCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_ESINumberRange_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_ESINumberRange_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Lower
...
//
static RedfishCS_status GenEVINumberRangeCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_EVINumberRange_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_EVINumberRange_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Lower
...
//
static RedfishCS_status GenRouteDistinguisherRangeCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_RouteDistinguisherRange_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_RouteDistinguisherRange_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Lower
...
//
static RedfishCS_status GenRouteTargetRangeCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_RouteTargetRange_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_RouteTargetRange_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Lower
...
static RedfishCS_status GenVLANIdentifierAddressRangeCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_VLANIdentifierAddressRange_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_VLANIdentifierAddressRange_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Lower
...
//
static RedfishCS_status GenBGPEvpnCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_BGPEvpn_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_BGPEvpn_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ARPProxyEnabled
...
static RedfishCS_status GenASNumberRangeCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_ASNumberRange_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_ASNumberRange_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Lower
...
//
static RedfishCS_status GenMaxPrefixCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_MaxPrefix_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_MaxPrefix_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MaxPrefixNumber
...
static RedfishCS_status GenBGPNeighborCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_BGPNeighbor_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_BGPNeighbor_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Address
...
static RedfishCS_status GenBGPRouteCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_BGPRoute_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_BGPRoute_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
static RedfishCS_status GenGracefulRestartCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_GracefulRestart_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_GracefulRestart_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
static RedfishCS_status GenMultiplePathsCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_MultiplePaths_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_MultiplePaths_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MaximumPaths
...
static RedfishCS_status GenEBGPCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_EBGP_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_EBGP_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ASNumberRange
...
//
static RedfishCS_status GenDHCPCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_DHCP_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_DHCP_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
static RedfishCS_status GenIPv4AddressRangeCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_IPv4AddressRange_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_IPv4AddressRange_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Lower
...
//
static RedfishCS_status GenIPv4Cs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_IPv4_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_IPv4_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AnycastGatewayIPAddress
...
//
static RedfishCS_status GenCommonBGPPropertiesCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_CommonBGPProperties_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_CommonBGPProperties_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ASNumberRange
...
//
static RedfishCS_status GenEthernetCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_Ethernet_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_Ethernet_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // BFDSingleHopOnly
...
//
static RedfishCS_status GenGenZCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_GenZ_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_GenZ_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AccessKey
...
//
static RedfishCS_status GenLinksCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishAddressPool_V1_1_2_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAddressPool_V1_1_2_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Endpoints
...
//
static RedfishCS_status GenidRefCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishAddressPool_V1_1_2_AddressPool_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetBFDSingleHopOnly(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_BFDSingleHopOnly_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetBGPEvpnESINumberRange(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_ESINumberRange_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetBGPEvpnEVINumberRange(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_EVINumberRange_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetBGPEvpnRouteDistinguisherRange(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_RouteDistinguisherRange_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetBGPEvpnRouteTargetRange(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_RouteTargetRange_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetBGPEvpnVLANIdentifierAddressRange(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_VLANIdentifierAddressRange_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetBGPEvpn(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_BGPEvpn_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetEBGPASNumberRange(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_ASNumberRange_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetEBGPBGPNeighborMaxPrefix(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_MaxPrefix_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetEBGPBGPNeighbor(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_BGPNeighbor_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetEBGPBGPRoute(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_BGPRoute_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetEBGPGracefulRestart(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_GracefulRestart_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetEBGPMultiplePaths(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_MultiplePaths_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetEBGP(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_EBGP_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetIPv4DHCP(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_DHCP_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetIPv4EBGPAddressRange(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_IPv4AddressRange_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetIPv4FabricLinkAddressRange(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_IPv4AddressRange_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetIPv4HostAddressRange(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_IPv4AddressRange_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetIPv4IBGPAddressRange(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_IPv4AddressRange_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetIPv4LoopbackAddressRange(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_IPv4AddressRange_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetIPv4ManagementAddressRange(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_IPv4AddressRange_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetIPv4VLANIdentifierAddressRange(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_VLANIdentifierAddressRange_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetIPv4(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_IPv4_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetMultiProtocolEBGPASNumberRange(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_ASNumberRange_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetMultiProtocolEBGPBGPNeighborMaxPrefix(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_MaxPrefix_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetMultiProtocolEBGPBGPNeighbor(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_BGPNeighbor_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetMultiProtocolEBGPBGPRoute(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_BGPRoute_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetMultiProtocolEBGPGracefulRestart(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_GracefulRestart_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetMultiProtocolEBGPMultiplePaths(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_MultiplePaths_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetMultiProtocolEBGP(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_EBGP_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetMultiProtocolIBGPASNumberRange(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_ASNumberRange_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetMultiProtocolIBGPBGPNeighborMaxPrefix(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_MaxPrefix_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetMultiProtocolIBGPBGPNeighbor(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_BGPNeighbor_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetMultiProtocolIBGPBGPRoute(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_BGPRoute_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetMultiProtocolIBGPGracefulRestart(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_GracefulRestart_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetMultiProtocolIBGPMultiplePaths(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_MultiplePaths_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetMultiProtocolIBGP(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_CommonBGPProperties_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Ethernet(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_Ethernet_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_GenZ(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_GenZ_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishAddressPool_V1_1_2_Links_CS *CSPtr)
{
  json_t *CsParentJson;
...
//
// C structure to JSON for AddressPool.V1_1_2.AddressPool
//
RedfishCS_status CS_To_AddressPool_V1_1_2_JSON(RedfishAddressPool_V1_1_2_AddressPool_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for AddressPool.V1_1_2.AddressPool
//
RedfishCS_status DestroyAddressPool_V1_1_2_CS(RedfishAddressPool_V1_1_2_AddressPool_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for AddressPool.V1_1_2.AddressPool
//
RedfishCS_status DestroyAddressPool_V1_1_2_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for AddressPool.V1_1_2.AddressPool
//
RedfishCS_status
Json_AddressPool_V1_1_2_To_CS(RedfishCS_char *JsonRawText, RedfishAddressPool_V1_1_2_AddressPool_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAddressPool_V1_1_2_AddressPool_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "AddressPool", "v1_1_2", "AddressPool", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAddressPool_V1_1_2_AddressPool_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyAddressPool_V1_1_2_CS (Cs);
  return Status;
}
