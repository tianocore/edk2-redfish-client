# Definition of AddressPool.V1_1_2 and functions<br><br>
...
## Actions
    typedef struct _RedfishAddressPool_V1_1_2_Actions_CS {
        RedfishAddressPool_V1_1_2_OemActions_CS *Oem;
    } RedfishAddressPool_V1_1_2_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishAddressPool_V1_1_2_OemActions_CS| Structure points to **Oem** property.| No| No
...
## BGPEvpn
    typedef struct _RedfishAddressPool_V1_1_2_BGPEvpn_CS {
        ...
        RedfishAddressPool_V1_1_2_ESINumberRange_CS *ESINumberRange;
        RedfishAddressPool_V1_1_2_EVINumberRange_CS *EVINumberRange;
        RedfishCS_char *GatewayIPAddress;
        RedfishCS_bool *NDPProxyEnabled;
        RedfishCS_bool *NDPSupressionEnabled;
        RedfishAddressPool_V1_1_2_RouteDistinguisherRange_CS *RouteDistinguisherRange;
        RedfishAddressPool_V1_1_2_RouteTargetRange_CS *RouteTargetRange;
        RedfishCS_bool *UnderlayMulticastEnabled;
        RedfishCS_bool *UnknownUnicastSuppressionEnabled;
        RedfishAddressPool_V1_1_2_VLANIdentifierAddressRange_CS *VLANIdentifierAddressRange;
...
|**ESINumberRange**|RedfishAddressPool_V1_1_2_ESINumberRange_CS| Structure points to **ESINumberRange** property.| No| No
|**EVINumberRange**|RedfishAddressPool_V1_1_2_EVINumberRange_CS| Structure points to **EVINumberRange** property.| No| No
...
|**RouteDistinguisherRange**|RedfishAddressPool_V1_1_2_RouteDistinguisherRange_CS| Structure points to **RouteDistinguisherRange** property.| No| No
|**RouteTargetRange**|RedfishAddressPool_V1_1_2_RouteTargetRange_CS| Structure points to **RouteTargetRange** property.| No| No
...
|**VLANIdentifierAddressRange**|RedfishAddressPool_V1_1_2_VLANIdentifierAddressRange_CS| Structure points to **VLANIdentifierAddressRange** property.| No| No
...
## BGPNeighbor
    typedef struct _RedfishAddressPool_V1_1_2_BGPNeighbor_CS {
        ...
        RedfishAddressPool_V1_1_2_MaxPrefix_CS *MaxPrefix;
...
|**MaxPrefix**|RedfishAddressPool_V1_1_2_MaxPrefix_CS| Structure points to **MaxPrefix** property.| No| No
...
## CommonBGPProperties
    typedef struct _RedfishAddressPool_V1_1_2_CommonBGPProperties_CS {
        RedfishAddressPool_V1_1_2_ASNumberRange_CS *ASNumberRange;
        RedfishAddressPool_V1_1_2_BGPNeighbor_CS *BGPNeighbor;
        RedfishAddressPool_V1_1_2_BGPRoute_CS *BGPRoute;
        RedfishAddressPool_V1_1_2_GracefulRestart_CS *GracefulRestart;
        RedfishAddressPool_V1_1_2_MultiplePaths_CS *MultiplePaths;
        RedfishCS_bool *SendCommunityEnabled;
    } RedfishAddressPool_V1_1_2_CommonBGPProperties_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**ASNumberRange**|RedfishAddressPool_V1_1_2_ASNumberRange_CS| Structure points to **ASNumberRange** property.| No| No
|**BGPNeighbor**|RedfishAddressPool_V1_1_2_BGPNeighbor_CS| Structure points to **BGPNeighbor** property.| No| No
|**BGPRoute**|RedfishAddressPool_V1_1_2_BGPRoute_CS| Structure points to **BGPRoute** property.| No| No
|**GracefulRestart**|RedfishAddressPool_V1_1_2_GracefulRestart_CS| Structure points to **GracefulRestart** property.| No| No
|**MultiplePaths**|RedfishAddressPool_V1_1_2_MultiplePaths_CS| Structure points to **MultiplePaths** property.| No| No
...
## Ethernet
    typedef struct _RedfishAddressPool_V1_1_2_Ethernet_CS {
        RedfishAddressPool_V1_1_2_BFDSingleHopOnly_CS *BFDSingleHopOnly;
        RedfishAddressPool_V1_1_2_BGPEvpn_CS *BGPEvpn;
        RedfishAddressPool_V1_1_2_EBGP_CS *EBGP;
        RedfishAddressPool_V1_1_2_IPv4_CS *IPv4;
        RedfishAddressPool_V1_1_2_EBGP_CS *MultiProtocolEBGP;
        RedfishAddressPool_V1_1_2_CommonBGPProperties_CS *MultiProtocolIBGP;
    } RedfishAddressPool_V1_1_2_Ethernet_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**BFDSingleHopOnly**|RedfishAddressPool_V1_1_2_BFDSingleHopOnly_CS| Structure points to **BFDSingleHopOnly** property.| No| No
|**BGPEvpn**|RedfishAddressPool_V1_1_2_BGPEvpn_CS| Structure points to **BGPEvpn** property.| No| No
|**EBGP**|RedfishAddressPool_V1_1_2_EBGP_CS| Structure points to **EBGP** property.| No| No
|**IPv4**|RedfishAddressPool_V1_1_2_IPv4_CS| Structure points to **IPv4** property.| No| No
|**MultiProtocolEBGP**|RedfishAddressPool_V1_1_2_EBGP_CS| Structure points to **MultiProtocolEBGP** property.| No| No
|**MultiProtocolIBGP**|RedfishAddressPool_V1_1_2_CommonBGPProperties_CS| Structure points to **MultiProtocolIBGP** property.| No| No
...
## IPv4
    typedef struct _RedfishAddressPool_V1_1_2_IPv4_CS {
        RedfishCS_char *AnycastGatewayIPAddress;
        RedfishCS_char *AnycastGatewayMACAddress;
        RedfishAddressPool_V1_1_2_DHCP_CS *DHCP;
        RedfishCS_char *DNSDomainName;
        RedfishCS_char_Array *DNSServer;
        RedfishCS_bool *DistributeIntoUnderlayEnabled;
        RedfishAddressPool_V1_1_2_IPv4AddressRange_CS *EBGPAddressRange;
        RedfishAddressPool_V1_1_2_IPv4AddressRange_CS *FabricLinkAddressRange;
        RedfishCS_char *GatewayIPAddress;
        RedfishAddressPool_V1_1_2_IPv4AddressRange_CS *HostAddressRange;
        RedfishAddressPool_V1_1_2_IPv4AddressRange_CS *IBGPAddressRange;
        RedfishAddressPool_V1_1_2_IPv4AddressRange_CS *LoopbackAddressRange;
        RedfishAddressPool_V1_1_2_IPv4AddressRange_CS *ManagementAddressRange;
...
|**AnycastGatewayIPAddress**|RedfishCS_char| String pointer to **AnycastGatewayIPAddress** property.| No| No
|**AnycastGatewayMACAddress**|RedfishCS_char| String pointer to **AnycastGatewayMACAddress** property.| No| No
|**DHCP**|RedfishAddressPool_V1_1_2_DHCP_CS| Structure points to **DHCP** property.| No| No
...
|**EBGPAddressRange**|RedfishAddressPool_V1_1_2_IPv4AddressRange_CS| Structure points to **EBGPAddressRange** property.| No| No
|**FabricLinkAddressRange**|RedfishAddressPool_V1_1_2_IPv4AddressRange_CS| Structure points to **FabricLinkAddressRange** property.| No| No
|**GatewayIPAddress**|RedfishCS_char| String pointer to **GatewayIPAddress** property.| No| No
|**HostAddressRange**|RedfishAddressPool_V1_1_2_IPv4AddressRange_CS| Structure points to **HostAddressRange** property.| No| No
|**IBGPAddressRange**|RedfishAddressPool_V1_1_2_IPv4AddressRange_CS| Structure points to **IBGPAddressRange** property.| No| No
|**LoopbackAddressRange**|RedfishAddressPool_V1_1_2_IPv4AddressRange_CS| Structure points to **LoopbackAddressRange** property.| No| No
|**ManagementAddressRange**|RedfishAddressPool_V1_1_2_IPv4AddressRange_CS| Structure points to **ManagementAddressRange** property.| No| No
...
## AddressPool
    typedef struct _RedfishAddressPool_V1_1_2_AddressPool_CS {
        ...
        RedfishAddressPool_V1_1_2_Actions_CS *Actions;
        RedfishCS_char *Description;
        RedfishAddressPool_V1_1_2_Ethernet_CS *Ethernet;
        RedfishAddressPool_V1_1_2_GenZ_CS *GenZ;
        RedfishCS_char *Id;
        RedfishAddressPool_V1_1_2_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
...
|**Actions**|RedfishAddressPool_V1_1_2_Actions_CS| Structure points to **Actions** property.| No| No
|**Description**|RedfishCS_char| String pointer to **Description** property.| No| Yes
|**Ethernet**|RedfishAddressPool_V1_1_2_Ethernet_CS| Structure points to **Ethernet** property.| No| No
|**GenZ**|RedfishAddressPool_V1_1_2_GenZ_CS| Structure points to **GenZ** property.| No| No
|**Id**|RedfishCS_char| String pointer to **Id** property.| Yes| Yes
|**Links**|RedfishAddressPool_V1_1_2_Links_CS| Structure points to **Links** property.| No| No
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**Status**|RedfishResource_Status_CS| Structure points to **Status** property.| No| No
## Redfish AddressPool V1_1_2 to C Structure Function
    RedfishCS_status
    Json_AddressPool_V1_1_2_To_CS (RedfishCS_char *JsonRawText, RedfishAddressPool_V1_1_2_AddressPool_CS **ReturnedCS);

## C Structure to Redfish AddressPool V1_1_2 JSON Function
    RedfishCS_status
    CS_To_AddressPool_V1_1_2_JSON (RedfishAddressPool_V1_1_2_AddressPool_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish AddressPool V1_1_2 C Structure Function
    RedfishCS_status
