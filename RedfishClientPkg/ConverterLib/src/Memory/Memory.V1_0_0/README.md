# Definition of Memory.V1_0_0 and functions<br><br>
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Memory_DisablePassphrase**|RedfishMemory_V1_0_0_DisablePassphrase_CS| Structure points to **#Memory.DisablePassphrase** property.| No| No
|**Memory_SecureEraseUnit**|RedfishMemory_V1_0_0_SecureEraseUnit_CS| Structure points to **#Memory.SecureEraseUnit** property.| No| No
|**Memory_SetPassphrase**|RedfishMemory_V1_0_0_SetPassphrase_CS| Structure points to **#Memory.SetPassphrase** property.| No| No
|**Memory_UnlockUnit**|RedfishMemory_V1_0_0_UnlockUnit_CS| Structure points to **#Memory.UnlockUnit** property.| No| No
|**Oem**|RedfishMemory_V1_0_0_Memory_Actions_Oem_CS| Structure points to **Oem** property.| No| No
...
## Memory
    typedef struct _RedfishMemory_V1_0_0_Memory_CS {
        ...
        RedfishMemory_V1_0_0_Memory_Actions_CS *Actions;
        ...
        RedfishMemory_V1_0_0_MemoryLocation_CS *MemoryLocation;
        ...
        RedfishMemory_V1_0_0_PowerManagementPolicy_CS *PowerManagementPolicy;
        RedfishCS_int64 *RankCount;
        RedfishMemory_V1_0_0_RegionSet_CS *Regions;
        RedfishMemory_V1_0_0_SecurityCapabilities_CS *SecurityCapabilities;
...
|**Actions**|RedfishMemory_V1_0_0_Memory_Actions_CS| Structure points to **Actions** property.| No| Yes
...
|**MemoryLocation**|RedfishMemory_V1_0_0_MemoryLocation_CS| Structure points to **MemoryLocation** property.| No| No
...
|**Metrics**|RedfishCS_Link| Structure link list to **Metrics** property.| No| No
...
|**PowerManagementPolicy**|RedfishMemory_V1_0_0_PowerManagementPolicy_CS| Structure points to **PowerManagementPolicy** property.| No| No
|**RankCount**|RedfishCS_int64| 64-bit long long interger pointer to **RankCount** property.| No| Yes
|**Regions**|RedfishMemory_V1_0_0_RegionSet_CS| Structure points to **Regions** property.| No| Yes
|**SecurityCapabilities**|RedfishMemory_V1_0_0_SecurityCapabilities_CS| Structure points to **SecurityCapabilities** property.| No| No
...
## Redfish Memory V1_0_0 to C Structure Function
    RedfishCS_status
    Json_Memory_V1_0_0_To_CS (RedfishCS_char *JsonRawText, RedfishMemory_V1_0_0_Memory_CS **ReturnedCS);

## C Structure to Redfish Memory V1_0_0 JSON Function
    RedfishCS_status
    CS_To_Memory_V1_0_0_JSON (RedfishMemory_V1_0_0_Memory_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Memory V1_0_0 C Structure Function
    RedfishCS_status
