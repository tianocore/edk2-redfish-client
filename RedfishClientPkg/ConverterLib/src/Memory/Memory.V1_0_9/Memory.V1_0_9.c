...
#include"Redfish_Memory_v1_0_9_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_int64_ArrayCs(RedfishMemory_V1_0_9_Memory_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_int64_Array **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishMemory_V1_0_9_Memory_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for #Memory.DisablePassphrase
//
static RedfishCS_status GenDisablePassphraseCs(RedfishMemory_V1_0_9_Memory_CS *Cs, json_t *JsonObj, char *Key, RedfishMemory_V1_0_9_DisablePassphrase_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemory_V1_0_9_DisablePassphrase_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenSecureEraseUnitCs(RedfishMemory_V1_0_9_Memory_CS *Cs, json_t *JsonObj, char *Key, RedfishMemory_V1_0_9_SecureEraseUnit_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemory_V1_0_9_SecureEraseUnit_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenSetPassphraseCs(RedfishMemory_V1_0_9_Memory_CS *Cs, json_t *JsonObj, char *Key, RedfishMemory_V1_0_9_SetPassphrase_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemory_V1_0_9_SetPassphrase_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenUnlockUnitCs(RedfishMemory_V1_0_9_Memory_CS *Cs, json_t *JsonObj, char *Key, RedfishMemory_V1_0_9_UnlockUnit_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemory_V1_0_9_UnlockUnit_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishMemory_V1_0_9_Memory_CS *Cs, json_t *JsonObj, char *Key, RedfishMemory_V1_0_9_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemory_V1_0_9_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishMemory_V1_0_9_Memory_CS *Cs, json_t *JsonObj, char *Key, RedfishMemory_V1_0_9_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemory_V1_0_9_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenMemoryLocationCs(RedfishMemory_V1_0_9_Memory_CS *Cs, json_t *JsonObj, char *Key, RedfishMemory_V1_0_9_MemoryLocation_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemory_V1_0_9_MemoryLocation_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Channel
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishMemory_V1_0_9_Memory_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
//
static RedfishCS_status GenPowerManagementPolicyCs(RedfishMemory_V1_0_9_Memory_CS *Cs, json_t *JsonObj, char *Key, RedfishMemory_V1_0_9_PowerManagementPolicy_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemory_V1_0_9_PowerManagementPolicy_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
static RedfishCS_status GenRegionSet_Array_ElementCs(RedfishMemory_V1_0_9_Memory_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishMemory_V1_0_9_RegionSet_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishMemory_V1_0_9_RegionSet_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
//Generate C structure for RedfishMemory_V1_0_9_RegionSet_Array_CS
//
static RedfishCS_status GenRegionSet_ArrayCs(RedfishMemory_V1_0_9_Memory_CS *Cs, json_t *JsonObj, char *Key, RedfishMemory_V1_0_9_RegionSet_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishMemory_V1_0_9_RegionSet_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishMemory_V1_0_9_RegionSet_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenSecurityCapabilitiesCs(RedfishMemory_V1_0_9_Memory_CS *Cs, json_t *JsonObj, char *Key, RedfishMemory_V1_0_9_SecurityCapabilities_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemory_V1_0_9_SecurityCapabilities_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MaxPassphraseCount
...
static RedfishCS_status CS_To_JSON_ActionsMemory_DisablePassphrase(json_t *CsJson, char *Key, RedfishMemory_V1_0_9_DisablePassphrase_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsMemory_SecureEraseUnit(json_t *CsJson, char *Key, RedfishMemory_V1_0_9_SecureEraseUnit_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsMemory_SetPassphrase(json_t *CsJson, char *Key, RedfishMemory_V1_0_9_SetPassphrase_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsMemory_UnlockUnit(json_t *CsJson, char *Key, RedfishMemory_V1_0_9_UnlockUnit_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishMemory_V1_0_9_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishMemory_V1_0_9_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_MemoryLocation(json_t *CsJson, char *Key, RedfishMemory_V1_0_9_MemoryLocation_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_PowerManagementPolicy(json_t *CsJson, char *Key, RedfishMemory_V1_0_9_PowerManagementPolicy_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Regions(json_t *CsJson, char *Key, RedfishMemory_V1_0_9_RegionSet_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishMemory_V1_0_9_RegionSet_Array_CS *NextArray;
  RedfishMemory_V1_0_9_RegionSet_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_SecurityCapabilities(json_t *CsJson, char *Key, RedfishMemory_V1_0_9_SecurityCapabilities_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Memory.V1_0_9.Memory
//
RedfishCS_status CS_To_Memory_V1_0_9_JSON(RedfishMemory_V1_0_9_Memory_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Memory.V1_0_9.Memory
//
RedfishCS_status DestroyMemory_V1_0_9_CS(RedfishMemory_V1_0_9_Memory_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Memory.V1_0_9.Memory
//
RedfishCS_status DestroyMemory_V1_0_9_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Memory.V1_0_9.Memory
//
RedfishCS_status
Json_Memory_V1_0_9_To_CS(RedfishCS_char *JsonRawText, RedfishMemory_V1_0_9_Memory_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMemory_V1_0_9_Memory_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Memory", "v1_0_9", "Memory", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMemory_V1_0_9_Memory_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
