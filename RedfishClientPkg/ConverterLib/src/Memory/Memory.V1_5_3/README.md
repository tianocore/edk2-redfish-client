# Definition of Memory.V1_5_3 and functions<br><br>
...
## Actions
    typedef struct _RedfishMemory_V1_5_3_Actions_CS {
        ...
        RedfishMemory_V1_5_3_OemActions_CS *Oem;
    } RedfishMemory_V1_5_3_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Memory_DisablePassphrase**|RedfishMemory_V1_5_3_DisablePassphrase_CS| Structure points to **#Memory.DisablePassphrase** property.| No| No
|**Memory_SecureEraseUnit**|RedfishMemory_V1_5_3_SecureEraseUnit_CS| Structure points to **#Memory.SecureEraseUnit** property.| No| No
|**Memory_SetPassphrase**|RedfishMemory_V1_5_3_SetPassphrase_CS| Structure points to **#Memory.SetPassphrase** property.| No| No
|**Memory_UnlockUnit**|RedfishMemory_V1_5_3_UnlockUnit_CS| Structure points to **#Memory.UnlockUnit** property.| No| No
|**Oem**|RedfishMemory_V1_5_3_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Memory
    typedef struct _RedfishMemory_V1_5_3_Memory_CS {
        ...
        RedfishMemory_V1_5_3_Actions_CS *Actions;
        ...
        RedfishMemory_V1_5_3_Links_CS *Links;
        RedfishCS_Link Location;
        RedfishCS_int64 *LogicalSizeMiB;
        RedfishCS_char *Manufacturer;
        RedfishCS_int64 *MaxTDPMilliWatts;
        RedfishCS_char *MemoryDeviceType;
        RedfishMemory_V1_5_3_MemoryLocation_CS *MemoryLocation;
        ...
        RedfishMemory_V1_5_3_PowerManagementPolicy_CS *PowerManagementPolicy;
        RedfishCS_int64 *RankCount;
        RedfishMemory_V1_5_3_RegionSet_CS *Regions;
        RedfishMemory_V1_5_3_SecurityCapabilities_CS *SecurityCapabilities;
...
|**Actions**|RedfishMemory_V1_5_3_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishMemory_V1_5_3_Links_CS| Structure points to **Links** property.| No| No
...
|**MemoryLocation**|RedfishMemory_V1_5_3_MemoryLocation_CS| Structure points to **MemoryLocation** property.| No| No
...
|**PowerManagementPolicy**|RedfishMemory_V1_5_3_PowerManagementPolicy_CS| Structure points to **PowerManagementPolicy** property.| No| No
|**RankCount**|RedfishCS_int64| 64-bit long long interger pointer to **RankCount** property.| No| Yes
|**Regions**|RedfishMemory_V1_5_3_RegionSet_CS| Structure points to **Regions** property.| No| No
|**SecurityCapabilities**|RedfishMemory_V1_5_3_SecurityCapabilities_CS| Structure points to **SecurityCapabilities** property.| No| No
...
## Redfish Memory V1_5_3 to C Structure Function
    RedfishCS_status
    Json_Memory_V1_5_3_To_CS (RedfishCS_char *JsonRawText, RedfishMemory_V1_5_3_Memory_CS **ReturnedCS);

## C Structure to Redfish Memory V1_5_3 JSON Function
    RedfishCS_status
    CS_To_Memory_V1_5_3_JSON (RedfishMemory_V1_5_3_Memory_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Memory V1_5_3 C Structure Function
    RedfishCS_status
