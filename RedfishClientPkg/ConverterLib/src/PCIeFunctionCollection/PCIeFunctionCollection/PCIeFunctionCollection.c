...
#include"Redfish_PCIeFunctionCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishPCIeFunctionCollection_PCIeFunctionCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for PCIeFunctionCollection.PCIeFunctionCollection
//
RedfishCS_status CS_To_PCIeFunctionCollection_JSON(RedfishPCIeFunctionCollection_PCIeFunctionCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for PCIeFunctionCollection.PCIeFunctionCollection
//
RedfishCS_status DestroyPCIeFunctionCollection_CS(RedfishPCIeFunctionCollection_PCIeFunctionCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PCIeFunctionCollection.PCIeFunctionCollection
//
RedfishCS_status DestroyPCIeFunctionCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PCIeFunctionCollection.NOVERSIONED.PCIeFunctionCollection
//
RedfishCS_status
Json_PCIeFunctionCollection_To_CS(RedfishCS_char *JsonRawText, RedfishPCIeFunctionCollection_PCIeFunctionCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPCIeFunctionCollection_PCIeFunctionCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PCIeFunctionCollection", "noversioned", "PCIeFunctionCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPCIeFunctionCollection_PCIeFunctionCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyPCIeFunctionCollection_CS (Cs);
  return Status;
}
