# Definition of Thermal.V1_6_0 and functions<br><br>
...
## Fan
    typedef struct _RedfishThermal_V1_6_0_Fan_CS {
        ...
        RedfishThermal_V1_6_0_FanActions_CS *Actions;
...
|**Actions**|RedfishThermal_V1_6_0_FanActions_CS| Structure points to **Actions** property.| No| No
...
## FanActions
    typedef struct _RedfishThermal_V1_6_0_FanActions_CS {
        RedfishThermal_V1_6_0_FanOemActions_CS *Oem;
    } RedfishThermal_V1_6_0_FanActions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishThermal_V1_6_0_FanOemActions_CS| Structure points to **Oem** property.| No| No
...
## Temperature
    typedef struct _RedfishThermal_V1_6_0_Temperature_CS {
        RedfishCS_char *odata_id;
        RedfishThermal_V1_6_0_TemperatureActions_CS *Actions;
...
| ---  | --- | --- | --- | ---
|**odata_id**|RedfishCS_char| String pointer to **@odata.id** property.| Yes| No
|**Actions**|RedfishThermal_V1_6_0_TemperatureActions_CS| Structure points to **Actions** property.| No| No
...
## TemperatureActions
    typedef struct _RedfishThermal_V1_6_0_TemperatureActions_CS {
        RedfishThermal_V1_6_0_TemperatureOemActions_CS *Oem;
    } RedfishThermal_V1_6_0_TemperatureActions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishThermal_V1_6_0_TemperatureOemActions_CS| Structure points to **Oem** property.| No| No
...
## ThermalActions
    typedef struct _RedfishThermal_V1_6_0_ThermalActions_CS {
        RedfishThermal_V1_6_0_ThermalOemActions_CS *Oem;
    } RedfishThermal_V1_6_0_ThermalActions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishThermal_V1_6_0_ThermalOemActions_CS| Structure points to **Oem** property.| No| No
...
## Thermal
    typedef struct _RedfishThermal_V1_6_0_Thermal_CS {
        ...
        RedfishThermal_V1_6_0_ThermalActions_CS *Actions;
        RedfishCS_char *Description;
        RedfishThermal_V1_6_0_Fan_CS *Fans;
        ...
        RedfishCS_int64 *Redundancyodata_count;
        RedfishResource_Status_CS *Status;
        RedfishThermal_V1_6_0_Temperature_CS *Temperatures;
...
|**Actions**|RedfishThermal_V1_6_0_ThermalActions_CS| Structure points to **Actions** property.| No| No
|**Description**|RedfishCS_char| String pointer to **Description** property.| No| Yes
|**Fans**|RedfishThermal_V1_6_0_Fan_CS| Structure points to **Fans** property.| No| No
...
|**Redundancyodata_count**|RedfishCS_int64| 64-bit long long interger pointer to **Redundancy@odata.count** property.| No| No
|**Status**|RedfishResource_Status_CS| Structure points to **Status** property.| No| No
|**Temperatures**|RedfishThermal_V1_6_0_Temperature_CS| Structure points to **Temperatures** property.| No| No
|**Temperaturesodata_count**|RedfishCS_int64| 64-bit long long interger pointer to **Temperatures@odata.count** property.| No| No
## Redfish Thermal V1_6_0 to C Structure Function
    RedfishCS_status
    Json_Thermal_V1_6_0_To_CS (RedfishCS_char *JsonRawText, RedfishThermal_V1_6_0_Thermal_CS **ReturnedCS);

## C Structure to Redfish Thermal V1_6_0 JSON Function
    RedfishCS_status
    CS_To_Thermal_V1_6_0_JSON (RedfishThermal_V1_6_0_Thermal_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Thermal V1_6_0 C Structure Function
    RedfishCS_status
