...
#include"Redfish_Thermal_v1_5_3_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishThermal_V1_5_3_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenStatusCs(RedfishThermal_V1_5_3_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst);
static RedfishCS_status GenidRef_ArrayCs(RedfishThermal_V1_5_3_Thermal_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_Array_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenThermalOemActionsCs(RedfishThermal_V1_5_3_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishThermal_V1_5_3_ThermalOemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishThermal_V1_5_3_ThermalOemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenThermalActionsCs(RedfishThermal_V1_5_3_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishThermal_V1_5_3_ThermalActions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishThermal_V1_5_3_ThermalActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenFanOemActionsCs(RedfishThermal_V1_5_3_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishThermal_V1_5_3_FanOemActions_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishThermal_V1_5_3_FanOemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  InitializeLinkHead (&(*Dst)->Prop);
...
//Generate C structure for Actions
//
static RedfishCS_status GenFanActionsCs(RedfishThermal_V1_5_3_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishThermal_V1_5_3_FanActions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishThermal_V1_5_3_FanActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenidRef_Array_ElementCs(RedfishThermal_V1_5_3_Thermal_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishThermal_V1_5_3_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenidRefCs(RedfishThermal_V1_5_3_Thermal_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishThermal_V1_5_3_Thermal_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishThermal_V1_5_3_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
static RedfishCS_status GenFan_Array_ElementCs(RedfishThermal_V1_5_3_Thermal_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishThermal_V1_5_3_Fan_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishThermal_V1_5_3_Fan_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // @odata.id
...
//
//Generate C structure for RedfishThermal_V1_5_3_Fan_Array_CS
//
static RedfishCS_status GenFan_ArrayCs(RedfishThermal_V1_5_3_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishThermal_V1_5_3_Fan_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishThermal_V1_5_3_Fan_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishThermal_V1_5_3_Fan_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//Generate C structure for Oem
//
static RedfishCS_status GenTemperatureOemActionsCs(RedfishThermal_V1_5_3_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishThermal_V1_5_3_TemperatureOemActions_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishThermal_V1_5_3_TemperatureOemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  InitializeLinkHead (&(*Dst)->Prop);
...
//Generate C structure for Actions
//
static RedfishCS_status GenTemperatureActionsCs(RedfishThermal_V1_5_3_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishThermal_V1_5_3_TemperatureActions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishThermal_V1_5_3_TemperatureActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenTemperature_Array_ElementCs(RedfishThermal_V1_5_3_Thermal_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishThermal_V1_5_3_Temperature_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishThermal_V1_5_3_Temperature_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // @odata.id
...
//
//Generate C structure for RedfishThermal_V1_5_3_Temperature_Array_CS
//
static RedfishCS_status GenTemperature_ArrayCs(RedfishThermal_V1_5_3_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishThermal_V1_5_3_Temperature_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishThermal_V1_5_3_Temperature_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishThermal_V1_5_3_Temperature_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishThermal_V1_5_3_ThermalOemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishThermal_V1_5_3_ThermalActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_FansActionsOem(json_t *CsJson, char *Key, RedfishThermal_V1_5_3_FanOemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_FansActions(json_t *CsJson, char *Key, RedfishThermal_V1_5_3_FanActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Fans(json_t *CsJson, char *Key, RedfishThermal_V1_5_3_Fan_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishThermal_V1_5_3_Fan_Array_CS *NextArray;
  RedfishThermal_V1_5_3_Fan_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_TemperaturesActionsOem(json_t *CsJson, char *Key, RedfishThermal_V1_5_3_TemperatureOemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_TemperaturesActions(json_t *CsJson, char *Key, RedfishThermal_V1_5_3_TemperatureActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Temperatures(json_t *CsJson, char *Key, RedfishThermal_V1_5_3_Temperature_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishThermal_V1_5_3_Temperature_Array_CS *NextArray;
  RedfishThermal_V1_5_3_Temperature_CS *NextArrayItem;
...
//
// C structure to JSON for Thermal.V1_5_3.Thermal
//
RedfishCS_status CS_To_Thermal_V1_5_3_JSON(RedfishThermal_V1_5_3_Thermal_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Thermal.V1_5_3.Thermal
//
RedfishCS_status DestroyThermal_V1_5_3_CS(RedfishThermal_V1_5_3_Thermal_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Thermal.V1_5_3.Thermal
//
RedfishCS_status DestroyThermal_V1_5_3_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Thermal.V1_5_3.Thermal
//
RedfishCS_status
Json_Thermal_V1_5_3_To_CS(RedfishCS_char *JsonRawText, RedfishThermal_V1_5_3_Thermal_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishThermal_V1_5_3_Thermal_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Thermal", "v1_5_3", "Thermal", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishThermal_V1_5_3_Thermal_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
