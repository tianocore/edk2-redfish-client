...
#include"Redfish_Thermal_v1_2_9_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishThermal_V1_2_9_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenStatusCs(RedfishThermal_V1_2_9_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst);
static RedfishCS_status GenidRef_ArrayCs(RedfishThermal_V1_2_9_Thermal_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_Array_CS **Dst);
//
...
static RedfishCS_status GenidRef_Array_ElementCs(RedfishThermal_V1_2_9_Thermal_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishThermal_V1_2_9_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenidRefCs(RedfishThermal_V1_2_9_Thermal_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishThermal_V1_2_9_Thermal_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishThermal_V1_2_9_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
static RedfishCS_status GenFan_Array_ElementCs(RedfishThermal_V1_2_9_Thermal_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishThermal_V1_2_9_Fan_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishThermal_V1_2_9_Fan_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // @odata.id
...
//
//Generate C structure for RedfishThermal_V1_2_9_Fan_Array_CS
//
static RedfishCS_status GenFan_ArrayCs(RedfishThermal_V1_2_9_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishThermal_V1_2_9_Fan_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishThermal_V1_2_9_Fan_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishThermal_V1_2_9_Fan_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenTemperature_Array_ElementCs(RedfishThermal_V1_2_9_Thermal_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishThermal_V1_2_9_Temperature_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishThermal_V1_2_9_Temperature_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // @odata.id
...
//
//Generate C structure for RedfishThermal_V1_2_9_Temperature_Array_CS
//
static RedfishCS_status GenTemperature_ArrayCs(RedfishThermal_V1_2_9_Thermal_CS *Cs, json_t *JsonObj, char *Key, RedfishThermal_V1_2_9_Temperature_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishThermal_V1_2_9_Temperature_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishThermal_V1_2_9_Temperature_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_Fans(json_t *CsJson, char *Key, RedfishThermal_V1_2_9_Fan_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishThermal_V1_2_9_Fan_Array_CS *NextArray;
  RedfishThermal_V1_2_9_Fan_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_Temperatures(json_t *CsJson, char *Key, RedfishThermal_V1_2_9_Temperature_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishThermal_V1_2_9_Temperature_Array_CS *NextArray;
  RedfishThermal_V1_2_9_Temperature_CS *NextArrayItem;
...
//
// C structure to JSON for Thermal.V1_2_9.Thermal
//
RedfishCS_status CS_To_Thermal_V1_2_9_JSON(RedfishThermal_V1_2_9_Thermal_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Thermal.V1_2_9.Thermal
//
RedfishCS_status DestroyThermal_V1_2_9_CS(RedfishThermal_V1_2_9_Thermal_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Thermal.V1_2_9.Thermal
//
RedfishCS_status DestroyThermal_V1_2_9_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Thermal.V1_2_9.Thermal
//
RedfishCS_status
Json_Thermal_V1_2_9_To_CS(RedfishCS_char *JsonRawText, RedfishThermal_V1_2_9_Thermal_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishThermal_V1_2_9_Thermal_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Thermal", "v1_2_9", "Thermal", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishThermal_V1_2_9_Thermal_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
