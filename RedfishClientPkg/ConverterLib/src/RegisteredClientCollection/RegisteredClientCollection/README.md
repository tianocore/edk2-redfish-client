# Definition of RegisteredClientCollection and functions<br><br>
...
## Redfish RegisteredClientCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish RegisteredClientCollection  JSON Function
    RedfishCS_status
    CS_To_RegisteredClientCollection_JSON (RedfishRegisteredClientCollection_RegisteredClientCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish RegisteredClientCollection  C Structure Function
    RedfishCS_status
