...
#include"Redfish_RegisteredClientCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishRegisteredClientCollection_RegisteredClientCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for RegisteredClientCollection.RegisteredClientCollection
//
RedfishCS_status CS_To_RegisteredClientCollection_JSON(RedfishRegisteredClientCollection_RegisteredClientCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for RegisteredClientCollection.RegisteredClientCollection
//
RedfishCS_status DestroyRegisteredClientCollection_CS(RedfishRegisteredClientCollection_RegisteredClientCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for RegisteredClientCollection.RegisteredClientCollection
//
RedfishCS_status DestroyRegisteredClientCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for RegisteredClientCollection.NOVERSIONED.RegisteredClientCollection
//
RedfishCS_status
Json_RegisteredClientCollection_To_CS(RedfishCS_char *JsonRawText, RedfishRegisteredClientCollection_RegisteredClientCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishRegisteredClientCollection_RegisteredClientCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "RegisteredClientCollection", "noversioned", "RegisteredClientCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishRegisteredClientCollection_RegisteredClientCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyRegisteredClientCollection_CS (Cs);
  return Status;
}
