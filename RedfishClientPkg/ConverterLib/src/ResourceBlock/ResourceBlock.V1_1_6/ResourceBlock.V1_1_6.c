...
#include"Redfish_ResourceBlock_v1_1_6_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishResourceBlock_V1_1_6_ResourceBlock_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishResourceBlock_V1_1_6_ResourceBlock_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishResourceBlock_V1_1_6_ResourceBlock_CS *Cs, json_t *JsonObj, char *Key, RedfishResourceBlock_V1_1_6_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishResourceBlock_V1_1_6_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishResourceBlock_V1_1_6_ResourceBlock_CS *Cs, json_t *JsonObj, char *Key, RedfishResourceBlock_V1_1_6_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishResourceBlock_V1_1_6_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenCompositionStatusCs(RedfishResourceBlock_V1_1_6_ResourceBlock_CS *Cs, json_t *JsonObj, char *Key, RedfishResourceBlock_V1_1_6_CompositionStatus_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishResourceBlock_V1_1_6_CompositionStatus_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // CompositionState
...
//
static RedfishCS_status GenLinksCs(RedfishResourceBlock_V1_1_6_ResourceBlock_CS *Cs, json_t *JsonObj, char *Key, RedfishResourceBlock_V1_1_6_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishResourceBlock_V1_1_6_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Chassis
...
//
static RedfishCS_status GenidRefCs(RedfishResourceBlock_V1_1_6_ResourceBlock_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishResourceBlock_V1_1_6_ResourceBlock_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishResourceBlock_V1_1_6_ResourceBlock_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishResourceBlock_V1_1_6_ResourceBlock_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishResourceBlock_V1_1_6_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishResourceBlock_V1_1_6_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_CompositionStatus(json_t *CsJson, char *Key, RedfishResourceBlock_V1_1_6_CompositionStatus_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishResourceBlock_V1_1_6_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for ResourceBlock.V1_1_6.ResourceBlock
//
RedfishCS_status CS_To_ResourceBlock_V1_1_6_JSON(RedfishResourceBlock_V1_1_6_ResourceBlock_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ResourceBlock.V1_1_6.ResourceBlock
//
RedfishCS_status DestroyResourceBlock_V1_1_6_CS(RedfishResourceBlock_V1_1_6_ResourceBlock_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ResourceBlock.V1_1_6.ResourceBlock
//
RedfishCS_status DestroyResourceBlock_V1_1_6_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ResourceBlock.V1_1_6.ResourceBlock
//
RedfishCS_status
Json_ResourceBlock_V1_1_6_To_CS(RedfishCS_char *JsonRawText, RedfishResourceBlock_V1_1_6_ResourceBlock_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishResourceBlock_V1_1_6_ResourceBlock_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ResourceBlock", "v1_1_6", "ResourceBlock", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishResourceBlock_V1_1_6_ResourceBlock_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyResourceBlock_V1_1_6_CS (Cs);
  return Status;
}
