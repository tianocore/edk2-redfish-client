...
#include"Redfish_PowerSupply_v1_3_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishPowerSupply_V1_3_0_PowerSupply_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenOemCs(RedfishPowerSupply_V1_3_0_PowerSupply_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #PowerSupply.Reset
//
static RedfishCS_status GenResetCs(RedfishPowerSupply_V1_3_0_PowerSupply_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerSupply_V1_3_0_Reset_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerSupply_V1_3_0_Reset_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishPowerSupply_V1_3_0_PowerSupply_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerSupply_V1_3_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerSupply_V1_3_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishPowerSupply_V1_3_0_PowerSupply_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerSupply_V1_3_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerSupply_V1_3_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #PowerSupply.Reset
...
static RedfishCS_status GenEfficiencyRating_Array_ElementCs(RedfishPowerSupply_V1_3_0_PowerSupply_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPowerSupply_V1_3_0_EfficiencyRating_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPowerSupply_V1_3_0_EfficiencyRating_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // EfficiencyPercent
...
//
//Generate C structure for RedfishPowerSupply_V1_3_0_EfficiencyRating_Array_CS
//
static RedfishCS_status GenEfficiencyRating_ArrayCs(RedfishPowerSupply_V1_3_0_PowerSupply_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerSupply_V1_3_0_EfficiencyRating_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPowerSupply_V1_3_0_EfficiencyRating_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPowerSupply_V1_3_0_EfficiencyRating_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenInputRange_Array_ElementCs(RedfishPowerSupply_V1_3_0_PowerSupply_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPowerSupply_V1_3_0_InputRange_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPowerSupply_V1_3_0_InputRange_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // CapacityWatts
...
//
//Generate C structure for RedfishPowerSupply_V1_3_0_InputRange_Array_CS
//
static RedfishCS_status GenInputRange_ArrayCs(RedfishPowerSupply_V1_3_0_PowerSupply_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerSupply_V1_3_0_InputRange_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPowerSupply_V1_3_0_InputRange_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPowerSupply_V1_3_0_InputRange_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenLinksCs(RedfishPowerSupply_V1_3_0_PowerSupply_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerSupply_V1_3_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerSupply_V1_3_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
  ...
  // PowerOutlets
  InitializeLinkHead (&(*Dst)->PowerOutlets);
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "PowerOutlets", Cs->Header.ThisUri, &(*Dst)->PowerOutlets);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // PowerOutlets@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "PowerOutlets@odata.count", &(*Dst)->PowerOutletsodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status GenOutputRail_Array_ElementCs(RedfishPowerSupply_V1_3_0_PowerSupply_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPowerSupply_V1_3_0_OutputRail_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPowerSupply_V1_3_0_OutputRail_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // NominalVoltage
...
//
//Generate C structure for RedfishPowerSupply_V1_3_0_OutputRail_Array_CS
//
static RedfishCS_status GenOutputRail_ArrayCs(RedfishPowerSupply_V1_3_0_PowerSupply_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerSupply_V1_3_0_OutputRail_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPowerSupply_V1_3_0_OutputRail_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPowerSupply_V1_3_0_OutputRail_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenidRefCs(RedfishPowerSupply_V1_3_0_PowerSupply_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishPowerSupply_V1_3_0_PowerSupply_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishPowerSupply_V1_3_0_PowerSupply_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishPowerSupply_V1_3_0_PowerSupply_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishPowerSupply_V1_3_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsPowerSupply_Reset(json_t *CsJson, char *Key, RedfishPowerSupply_V1_3_0_Reset_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishPowerSupply_V1_3_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_EfficiencyRatings(json_t *CsJson, char *Key, RedfishPowerSupply_V1_3_0_EfficiencyRating_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPowerSupply_V1_3_0_EfficiencyRating_Array_CS *NextArray;
  RedfishPowerSupply_V1_3_0_EfficiencyRating_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_InputRanges(json_t *CsJson, char *Key, RedfishPowerSupply_V1_3_0_InputRange_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPowerSupply_V1_3_0_InputRange_Array_CS *NextArray;
  RedfishPowerSupply_V1_3_0_InputRange_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishPowerSupply_V1_3_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // PowerOutlets 
  if (InsertJsonLinkArrayObj (CsJson, "PowerOutlets", &CSPtr->PowerOutlets) != RedfishCS_status_success) {goto Error;}

  // PowerOutlets@odata.count 
  if (InsertJsonInt64Obj (CsJson, "PowerOutlets@odata.count", CSPtr->PowerOutletsodata_count) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_OutputRails(json_t *CsJson, char *Key, RedfishPowerSupply_V1_3_0_OutputRail_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPowerSupply_V1_3_0_OutputRail_Array_CS *NextArray;
  RedfishPowerSupply_V1_3_0_OutputRail_CS *NextArrayItem;
...
//
// C structure to JSON for PowerSupply.V1_3_0.PowerSupply
//
RedfishCS_status CS_To_PowerSupply_V1_3_0_JSON(RedfishPowerSupply_V1_3_0_PowerSupply_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  if (InsertJsonStringArrayObj (CsJson, "ElectricalSourceManagerURIs", CSPtr->ElectricalSourceManagerURIs) != RedfishCS_status_success) {goto Error;}

  // ElectricalSourceNames 
  if (InsertJsonStringArrayObj (CsJson, "ElectricalSourceNames", CSPtr->ElectricalSourceNames) != RedfishCS_status_success) {goto Error;}
  ...
  // LineInputStatus 
  if (InsertJsonStringObj (CsJson, "LineInputStatus", CSPtr->LineInputStatus) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for PowerSupply.V1_3_0.PowerSupply
//
RedfishCS_status DestroyPowerSupply_V1_3_0_CS(RedfishPowerSupply_V1_3_0_PowerSupply_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PowerSupply.V1_3_0.PowerSupply
//
RedfishCS_status DestroyPowerSupply_V1_3_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PowerSupply.V1_3_0.PowerSupply
//
RedfishCS_status
Json_PowerSupply_V1_3_0_To_CS(RedfishCS_char *JsonRawText, RedfishPowerSupply_V1_3_0_PowerSupply_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPowerSupply_V1_3_0_PowerSupply_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PowerSupply", "v1_3_0", "PowerSupply", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPowerSupply_V1_3_0_PowerSupply_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // ElectricalSourceManagerURIs
  Status = GenRedfishCS_char_ArrayCs (Cs, JsonObj, "ElectricalSourceManagerURIs", &Cs->ElectricalSourceManagerURIs);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ElectricalSourceNames
  Status = GenRedfishCS_char_ArrayCs (Cs, JsonObj, "ElectricalSourceNames", &Cs->ElectricalSourceNames);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // LineInputStatus
  Status = GetRedfishPropertyStr (Cs, JsonObj, "LineInputStatus", &Cs->LineInputStatus);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyPowerSupply_V1_3_0_CS (Cs);
  return Status;
}
