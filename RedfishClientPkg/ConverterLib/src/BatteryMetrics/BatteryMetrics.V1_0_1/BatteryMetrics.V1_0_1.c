...
#include"Redfish_BatteryMetrics_v1_0_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishBatteryMetrics_V1_0_1_BatteryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishBatteryMetrics_V1_0_1_BatteryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishBatteryMetrics_V1_0_1_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishBatteryMetrics_V1_0_1_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishBatteryMetrics_V1_0_1_BatteryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishBatteryMetrics_V1_0_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishBatteryMetrics_V1_0_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishBatteryMetrics_V1_0_1_BatteryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishBatteryMetrics_V1_0_1_BatteryMetrics_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishBatteryMetrics_V1_0_1_BatteryMetrics_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishBatteryMetrics_V1_0_1_BatteryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishBatteryMetrics_V1_0_1_BatteryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishBatteryMetrics_V1_0_1_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishBatteryMetrics_V1_0_1_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
//
// C structure to JSON for BatteryMetrics.V1_0_1.BatteryMetrics
//
RedfishCS_status CS_To_BatteryMetrics_V1_0_1_JSON(RedfishBatteryMetrics_V1_0_1_BatteryMetrics_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for BatteryMetrics.V1_0_1.BatteryMetrics
//
RedfishCS_status DestroyBatteryMetrics_V1_0_1_CS(RedfishBatteryMetrics_V1_0_1_BatteryMetrics_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for BatteryMetrics.V1_0_1.BatteryMetrics
//
RedfishCS_status DestroyBatteryMetrics_V1_0_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for BatteryMetrics.V1_0_1.BatteryMetrics
//
RedfishCS_status
Json_BatteryMetrics_V1_0_1_To_CS(RedfishCS_char *JsonRawText, RedfishBatteryMetrics_V1_0_1_BatteryMetrics_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishBatteryMetrics_V1_0_1_BatteryMetrics_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "BatteryMetrics", "v1_0_1", "BatteryMetrics", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishBatteryMetrics_V1_0_1_BatteryMetrics_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyBatteryMetrics_V1_0_1_CS (Cs);
  return Status;
}
