...
#include"Redfish_BatteryMetrics_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishBatteryMetrics_V1_0_0_BatteryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishBatteryMetrics_V1_0_0_BatteryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishBatteryMetrics_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishBatteryMetrics_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishBatteryMetrics_V1_0_0_BatteryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishBatteryMetrics_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishBatteryMetrics_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishBatteryMetrics_V1_0_0_BatteryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishBatteryMetrics_V1_0_0_BatteryMetrics_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishBatteryMetrics_V1_0_0_BatteryMetrics_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishBatteryMetrics_V1_0_0_BatteryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishBatteryMetrics_V1_0_0_BatteryMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishBatteryMetrics_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishBatteryMetrics_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for BatteryMetrics.V1_0_0.BatteryMetrics
//
RedfishCS_status CS_To_BatteryMetrics_V1_0_0_JSON(RedfishBatteryMetrics_V1_0_0_BatteryMetrics_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // CellVoltages 
  if (InsertJsonLinkArrayObj (CsJson, "CellVoltages", &CSPtr->CellVoltages) != RedfishCS_status_success) {goto Error;}

  // CellVoltages@odata.count 
  if (InsertJsonInt64Obj (CsJson, "CellVoltages@odata.count", CSPtr->CellVoltagesodata_count) != RedfishCS_status_success) {goto Error;}

  // ChargePercent 
  if (InsertJsonLinkObj (CsJson, "ChargePercent", &CSPtr->ChargePercent) != RedfishCS_status_success) {goto Error;}

  // Description 
  if (InsertJsonStringObj (CsJson, "Description", CSPtr->Description) != RedfishCS_status_success) {goto Error;}

  // DischargeCycles 
  if (InsertJsonInt64Obj (CsJson, "DischargeCycles", CSPtr->DischargeCycles) != RedfishCS_status_success) {goto Error;}
  ...
  // OutputCurrentAmps 
  if (InsertJsonLinkArrayObj (CsJson, "OutputCurrentAmps", &CSPtr->OutputCurrentAmps) != RedfishCS_status_success) {goto Error;}

  // OutputCurrentAmps@odata.count 
  if (InsertJsonInt64Obj (CsJson, "OutputCurrentAmps@odata.count", CSPtr->OutputCurrentAmpsodata_count) != RedfishCS_status_success) {goto Error;}

  // OutputVoltages 
  if (InsertJsonLinkArrayObj (CsJson, "OutputVoltages", &CSPtr->OutputVoltages) != RedfishCS_status_success) {goto Error;}

  // OutputVoltages@odata.count 
  if (InsertJsonInt64Obj (CsJson, "OutputVoltages@odata.count", CSPtr->OutputVoltagesodata_count) != RedfishCS_status_success) {goto Error;}

  // Status
  if (CS_To_JSON_Status(CsJson, "Status", CSPtr->Status) != RedfishCS_status_success) {goto Error;}

  // StoredChargeAmpHours 
  if (InsertJsonLinkObj (CsJson, "StoredChargeAmpHours", &CSPtr->StoredChargeAmpHours) != RedfishCS_status_success) {goto Error;}

  // StoredEnergyWattHours 
  if (InsertJsonLinkObj (CsJson, "StoredEnergyWattHours", &CSPtr->StoredEnergyWattHours) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for BatteryMetrics.V1_0_0.BatteryMetrics
//
RedfishCS_status DestroyBatteryMetrics_V1_0_0_CS(RedfishBatteryMetrics_V1_0_0_BatteryMetrics_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for BatteryMetrics.V1_0_0.BatteryMetrics
//
RedfishCS_status DestroyBatteryMetrics_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for BatteryMetrics.V1_0_0.BatteryMetrics
//
RedfishCS_status
Json_BatteryMetrics_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishBatteryMetrics_V1_0_0_BatteryMetrics_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishBatteryMetrics_V1_0_0_BatteryMetrics_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "BatteryMetrics", "v1_0_0", "BatteryMetrics", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishBatteryMetrics_V1_0_0_BatteryMetrics_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // CellVoltages
  InitializeLinkHead (&Cs->CellVoltages);
  Status = CreateCsUriOrJsonByNodeArray (Cs, JsonObj, "CellVoltages", Cs->Header.ThisUri, &Cs->CellVoltages);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // CellVoltages@odata.count
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "CellVoltages@odata.count", &Cs->CellVoltagesodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ChargePercent
  InitializeLinkHead (&Cs->ChargePercent);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "ChargePercent", Cs->Header.ThisUri, &Cs->ChargePercent);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // DischargeCycles
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "DischargeCycles", &Cs->DischargeCycles);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // OutputCurrentAmps
  InitializeLinkHead (&Cs->OutputCurrentAmps);
  Status = CreateCsUriOrJsonByNodeArray (Cs, JsonObj, "OutputCurrentAmps", Cs->Header.ThisUri, &Cs->OutputCurrentAmps);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // OutputCurrentAmps@odata.count
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "OutputCurrentAmps@odata.count", &Cs->OutputCurrentAmpsodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // OutputVoltages
  InitializeLinkHead (&Cs->OutputVoltages);
  Status = CreateCsUriOrJsonByNodeArray (Cs, JsonObj, "OutputVoltages", Cs->Header.ThisUri, &Cs->OutputVoltages);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // OutputVoltages@odata.count
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "OutputVoltages@odata.count", &Cs->OutputVoltagesodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // StoredChargeAmpHours
  InitializeLinkHead (&Cs->StoredChargeAmpHours);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "StoredChargeAmpHours", Cs->Header.ThisUri, &Cs->StoredChargeAmpHours);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // StoredEnergyWattHours
  InitializeLinkHead (&Cs->StoredEnergyWattHours);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "StoredEnergyWattHours", Cs->Header.ThisUri, &Cs->StoredEnergyWattHours);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyBatteryMetrics_V1_0_0_CS (Cs);
  return Status;
}
