# Definition of ActionInfo.V1_1_0 and functions<br><br>
...
## ActionInfo
    typedef struct _RedfishActionInfo_V1_1_0_ActionInfo_CS {
        ...
        RedfishActionInfo_V1_1_0_Parameters_CS *Parameters;
...
|**Parameters**|RedfishActionInfo_V1_1_0_Parameters_CS| Structure points to **Parameters** property.| No| No
## Redfish ActionInfo V1_1_0 to C Structure Function
    RedfishCS_status
    Json_ActionInfo_V1_1_0_To_CS (RedfishCS_char *JsonRawText, RedfishActionInfo_V1_1_0_ActionInfo_CS **ReturnedCS);

## C Structure to Redfish ActionInfo V1_1_0 JSON Function
    RedfishCS_status
    CS_To_ActionInfo_V1_1_0_JSON (RedfishActionInfo_V1_1_0_ActionInfo_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ActionInfo V1_1_0 C Structure Function
    RedfishCS_status
