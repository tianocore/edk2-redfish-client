# Definition of ActionInfo.V1_0_1 and functions<br><br>
...
## ActionInfo
    typedef struct _RedfishActionInfo_V1_0_1_ActionInfo_CS {
        ...
        RedfishActionInfo_V1_0_1_Parameters_CS *Parameters;
...
|**Parameters**|RedfishActionInfo_V1_0_1_Parameters_CS| Structure points to **Parameters** property.| No| No
## Redfish ActionInfo V1_0_1 to C Structure Function
    RedfishCS_status
    Json_ActionInfo_V1_0_1_To_CS (RedfishCS_char *JsonRawText, RedfishActionInfo_V1_0_1_ActionInfo_CS **ReturnedCS);

## C Structure to Redfish ActionInfo V1_0_1 JSON Function
    RedfishCS_status
    CS_To_ActionInfo_V1_0_1_JSON (RedfishActionInfo_V1_0_1_ActionInfo_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ActionInfo V1_0_1 C Structure Function
    RedfishCS_status
