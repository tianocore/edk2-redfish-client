...
#include"Redfish_ActionInfo_v1_1_3_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishActionInfo_V1_1_3_ActionInfo_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishActionInfo_V1_1_3_ActionInfo_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenParameters_Array_ElementCs(RedfishActionInfo_V1_1_3_ActionInfo_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishActionInfo_V1_1_3_Parameters_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishActionInfo_V1_1_3_Parameters_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AllowableValues
...
//
//Generate C structure for RedfishActionInfo_V1_1_3_Parameters_Array_CS
//
static RedfishCS_status GenParameters_ArrayCs(RedfishActionInfo_V1_1_3_ActionInfo_CS *Cs, json_t *JsonObj, char *Key, RedfishActionInfo_V1_1_3_Parameters_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishActionInfo_V1_1_3_Parameters_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishActionInfo_V1_1_3_Parameters_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_Parameters(json_t *CsJson, char *Key, RedfishActionInfo_V1_1_3_Parameters_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishActionInfo_V1_1_3_Parameters_Array_CS *NextArray;
  RedfishActionInfo_V1_1_3_Parameters_CS *NextArrayItem;
...
//
// C structure to JSON for ActionInfo.V1_1_3.ActionInfo
//
RedfishCS_status CS_To_ActionInfo_V1_1_3_JSON(RedfishActionInfo_V1_1_3_ActionInfo_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ActionInfo.V1_1_3.ActionInfo
//
RedfishCS_status DestroyActionInfo_V1_1_3_CS(RedfishActionInfo_V1_1_3_ActionInfo_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ActionInfo.V1_1_3.ActionInfo
//
RedfishCS_status DestroyActionInfo_V1_1_3_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ActionInfo.V1_1_3.ActionInfo
//
RedfishCS_status
Json_ActionInfo_V1_1_3_To_CS(RedfishCS_char *JsonRawText, RedfishActionInfo_V1_1_3_ActionInfo_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishActionInfo_V1_1_3_ActionInfo_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ActionInfo", "v1_1_3", "ActionInfo", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishActionInfo_V1_1_3_ActionInfo_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyActionInfo_V1_1_3_CS (Cs);
  return Status;
}
