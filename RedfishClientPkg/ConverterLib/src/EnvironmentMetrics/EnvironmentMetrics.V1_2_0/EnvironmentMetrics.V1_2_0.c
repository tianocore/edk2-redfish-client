...
#include"Redfish_EnvironmentMetrics_v1_2_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
//Generate C structure for #EnvironmentMetrics.ResetMetrics
//
static RedfishCS_status GenResetMetricsCs(RedfishEnvironmentMetrics_V1_2_0_EnvironmentMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishEnvironmentMetrics_V1_2_0_ResetMetrics_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEnvironmentMetrics_V1_2_0_ResetMetrics_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishEnvironmentMetrics_V1_2_0_EnvironmentMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishEnvironmentMetrics_V1_2_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEnvironmentMetrics_V1_2_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishEnvironmentMetrics_V1_2_0_EnvironmentMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishEnvironmentMetrics_V1_2_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEnvironmentMetrics_V1_2_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #EnvironmentMetrics.ResetMetrics
  Status = GenResetMetricsCs (Cs, TempJsonObj, "#EnvironmentMetrics.ResetMetrics", &(*Dst)->EnvironmentMetrics_ResetMetrics);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishEnvironmentMetrics_V1_2_0_EnvironmentMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsEnvironmentMetrics_ResetMetrics(json_t *CsJson, char *Key, RedfishEnvironmentMetrics_V1_2_0_ResetMetrics_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishEnvironmentMetrics_V1_2_0_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishEnvironmentMetrics_V1_2_0_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
  ...
  // #EnvironmentMetrics.ResetMetrics
  if (CS_To_JSON_ActionsEnvironmentMetrics_ResetMetrics(CsJson, "#EnvironmentMetrics.ResetMetrics", CSPtr->EnvironmentMetrics_ResetMetrics) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for EnvironmentMetrics.V1_2_0.EnvironmentMetrics
//
RedfishCS_status CS_To_EnvironmentMetrics_V1_2_0_JSON(RedfishEnvironmentMetrics_V1_2_0_EnvironmentMetrics_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // AbsoluteHumidity 
  if (InsertJsonLinkObj (CsJson, "AbsoluteHumidity", &CSPtr->AbsoluteHumidity) != RedfishCS_status_success) {goto Error;}
  ...
  // DewPointCelsius 
  if (InsertJsonLinkObj (CsJson, "DewPointCelsius", &CSPtr->DewPointCelsius) != RedfishCS_status_success) {goto Error;}

  // EnergyJoules 
  if (InsertJsonLinkObj (CsJson, "EnergyJoules", &CSPtr->EnergyJoules) != RedfishCS_status_success) {goto Error;}

  // EnergykWh 
  if (InsertJsonLinkObj (CsJson, "EnergykWh", &CSPtr->EnergykWh) != RedfishCS_status_success) {goto Error;}

  // FanSpeedsPercent 
  if (InsertJsonLinkArrayObj (CsJson, "FanSpeedsPercent", &CSPtr->FanSpeedsPercent) != RedfishCS_status_success) {goto Error;}

  // FanSpeedsPercent@odata.count 
  if (InsertJsonInt64Obj (CsJson, "FanSpeedsPercent@odata.count", CSPtr->FanSpeedsPercentodata_count) != RedfishCS_status_success) {goto Error;}

  // HumidityPercent 
  if (InsertJsonLinkObj (CsJson, "HumidityPercent", &CSPtr->HumidityPercent) != RedfishCS_status_success) {goto Error;}
  ...
  // PowerLimitWatts 
  if (InsertJsonLinkObj (CsJson, "PowerLimitWatts", &CSPtr->PowerLimitWatts) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for EnvironmentMetrics.V1_2_0.EnvironmentMetrics
//
RedfishCS_status DestroyEnvironmentMetrics_V1_2_0_CS(RedfishEnvironmentMetrics_V1_2_0_EnvironmentMetrics_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for EnvironmentMetrics.V1_2_0.EnvironmentMetrics
//
RedfishCS_status DestroyEnvironmentMetrics_V1_2_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for EnvironmentMetrics.V1_2_0.EnvironmentMetrics
//
RedfishCS_status
Json_EnvironmentMetrics_V1_2_0_To_CS(RedfishCS_char *JsonRawText, RedfishEnvironmentMetrics_V1_2_0_EnvironmentMetrics_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEnvironmentMetrics_V1_2_0_EnvironmentMetrics_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "EnvironmentMetrics", "v1_2_0", "EnvironmentMetrics", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEnvironmentMetrics_V1_2_0_EnvironmentMetrics_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // AbsoluteHumidity
  InitializeLinkHead (&Cs->AbsoluteHumidity);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "AbsoluteHumidity", Cs->Header.ThisUri, &Cs->AbsoluteHumidity);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // DewPointCelsius
  InitializeLinkHead (&Cs->DewPointCelsius);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "DewPointCelsius", Cs->Header.ThisUri, &Cs->DewPointCelsius);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // EnergyJoules
  InitializeLinkHead (&Cs->EnergyJoules);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "EnergyJoules", Cs->Header.ThisUri, &Cs->EnergyJoules);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // FanSpeedsPercent
  InitializeLinkHead (&Cs->FanSpeedsPercent);
  Status = CreateCsUriOrJsonByNodeArray (Cs, JsonObj, "FanSpeedsPercent", Cs->Header.ThisUri, &Cs->FanSpeedsPercent);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // FanSpeedsPercent@odata.count
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "FanSpeedsPercent@odata.count", &Cs->FanSpeedsPercentodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // HumidityPercent
  InitializeLinkHead (&Cs->HumidityPercent);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "HumidityPercent", Cs->Header.ThisUri, &Cs->HumidityPercent);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // PowerLimitWatts
  InitializeLinkHead (&Cs->PowerLimitWatts);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "PowerLimitWatts", Cs->Header.ThisUri, &Cs->PowerLimitWatts);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyEnvironmentMetrics_V1_2_0_CS (Cs);
  return Status;
}
