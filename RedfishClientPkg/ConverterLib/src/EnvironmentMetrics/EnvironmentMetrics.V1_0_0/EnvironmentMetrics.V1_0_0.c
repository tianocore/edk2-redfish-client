...
#include"Redfish_EnvironmentMetrics_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenResetMetricsCs(RedfishEnvironmentMetrics_V1_0_0_EnvironmentMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishEnvironmentMetrics_V1_0_0_ResetMetrics_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEnvironmentMetrics_V1_0_0_ResetMetrics_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishEnvironmentMetrics_V1_0_0_EnvironmentMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishEnvironmentMetrics_V1_0_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEnvironmentMetrics_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishEnvironmentMetrics_V1_0_0_EnvironmentMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishEnvironmentMetrics_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEnvironmentMetrics_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishEnvironmentMetrics_V1_0_0_EnvironmentMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsEnvironmentMetrics_ResetMetrics(json_t *CsJson, char *Key, RedfishEnvironmentMetrics_V1_0_0_ResetMetrics_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishEnvironmentMetrics_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishEnvironmentMetrics_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for EnvironmentMetrics.V1_0_0.EnvironmentMetrics
//
RedfishCS_status CS_To_EnvironmentMetrics_V1_0_0_JSON(RedfishEnvironmentMetrics_V1_0_0_EnvironmentMetrics_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for EnvironmentMetrics.V1_0_0.EnvironmentMetrics
//
RedfishCS_status DestroyEnvironmentMetrics_V1_0_0_CS(RedfishEnvironmentMetrics_V1_0_0_EnvironmentMetrics_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for EnvironmentMetrics.V1_0_0.EnvironmentMetrics
//
RedfishCS_status DestroyEnvironmentMetrics_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for EnvironmentMetrics.V1_0_0.EnvironmentMetrics
//
RedfishCS_status
Json_EnvironmentMetrics_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishEnvironmentMetrics_V1_0_0_EnvironmentMetrics_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEnvironmentMetrics_V1_0_0_EnvironmentMetrics_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "EnvironmentMetrics", "v1_0_0", "EnvironmentMetrics", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEnvironmentMetrics_V1_0_0_EnvironmentMetrics_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyEnvironmentMetrics_V1_0_0_CS (Cs);
  return Status;
}
