...
#include"Redfish_USBController_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishUSBController_V1_0_0_USBController_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishUSBController_V1_0_0_USBController_CS *Cs, json_t *JsonObj, char *Key, RedfishUSBController_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishUSBController_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishUSBController_V1_0_0_USBController_CS *Cs, json_t *JsonObj, char *Key, RedfishUSBController_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishUSBController_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishUSBController_V1_0_0_USBController_CS *Cs, json_t *JsonObj, char *Key, RedfishUSBController_V1_0_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishUSBController_V1_0_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishUSBController_V1_0_0_USBController_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishUSBController_V1_0_0_USBController_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishUSBController_V1_0_0_USBController_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishUSBController_V1_0_0_USBController_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishUSBController_V1_0_0_USBController_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishUSBController_V1_0_0_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishUSBController_V1_0_0_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishUSBController_V1_0_0_Links_CS *CSPtr)
{
  json_t *CsParentJson;
...
//
// C structure to JSON for USBController.V1_0_0.USBController
//
RedfishCS_status CS_To_USBController_V1_0_0_JSON(RedfishUSBController_V1_0_0_USBController_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for USBController.V1_0_0.USBController
//
RedfishCS_status DestroyUSBController_V1_0_0_CS(RedfishUSBController_V1_0_0_USBController_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for USBController.V1_0_0.USBController
//
RedfishCS_status DestroyUSBController_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for USBController.V1_0_0.USBController
//
RedfishCS_status
Json_USBController_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishUSBController_V1_0_0_USBController_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishUSBController_V1_0_0_USBController_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "USBController", "v1_0_0", "USBController", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishUSBController_V1_0_0_USBController_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyUSBController_V1_0_0_CS (Cs);
  return Status;
}
