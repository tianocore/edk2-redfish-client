...
#include"Redfish_MediaControllerCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishMediaControllerCollection_MediaControllerCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for MediaControllerCollection.MediaControllerCollection
//
RedfishCS_status CS_To_MediaControllerCollection_JSON(RedfishMediaControllerCollection_MediaControllerCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for MediaControllerCollection.MediaControllerCollection
//
RedfishCS_status DestroyMediaControllerCollection_CS(RedfishMediaControllerCollection_MediaControllerCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MediaControllerCollection.MediaControllerCollection
//
RedfishCS_status DestroyMediaControllerCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MediaControllerCollection.NOVERSIONED.MediaControllerCollection
//
RedfishCS_status
Json_MediaControllerCollection_To_CS(RedfishCS_char *JsonRawText, RedfishMediaControllerCollection_MediaControllerCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMediaControllerCollection_MediaControllerCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MediaControllerCollection", "noversioned", "MediaControllerCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMediaControllerCollection_MediaControllerCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyMediaControllerCollection_CS (Cs);
  return Status;
}
