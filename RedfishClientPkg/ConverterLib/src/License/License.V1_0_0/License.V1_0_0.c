...
#include"Redfish_License_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishLicense_V1_0_0_License_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishLicense_V1_0_0_License_CS *Cs, json_t *JsonObj, char *Key, RedfishLicense_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLicense_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishLicense_V1_0_0_License_CS *Cs, json_t *JsonObj, char *Key, RedfishLicense_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLicense_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
//Generate C structure for Contact
//
static RedfishCS_status GenContactInfoCs(RedfishLicense_V1_0_0_License_CS *Cs, json_t *JsonObj, char *Key, RedfishLicense_V1_0_0_ContactInfo_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLicense_V1_0_0_ContactInfo_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ContactName
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "ContactName", &(*Dst)->ContactName);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // EmailAddress
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "EmailAddress", &(*Dst)->EmailAddress);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // PhoneNumber
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "PhoneNumber", &(*Dst)->PhoneNumber);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status GenidRef_Array_ElementCs(RedfishLicense_V1_0_0_License_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRef_ArrayCs(RedfishLicense_V1_0_0_License_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenLinksCs(RedfishLicense_V1_0_0_License_CS *Cs, json_t *JsonObj, char *Key, RedfishLicense_V1_0_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishLicense_V1_0_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AuthorizedDevices
  Status = GenidRef_ArrayCs (Cs, TempJsonObj, "AuthorizedDevices", &(*Dst)->AuthorizedDevices);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // AuthorizedDevices@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "AuthorizedDevices@odata.count", &(*Dst)->AuthorizedDevicesodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishLicense_V1_0_0_License_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenidRefCs(RedfishLicense_V1_0_0_License_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishLicense_V1_0_0_License_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishLicense_V1_0_0_License_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishLicense_V1_0_0_License_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishLicense_V1_0_0_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishLicense_V1_0_0_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Contact(json_t *CsJson, char *Key, RedfishLicense_V1_0_0_ContactInfo_CS *CSPtr)
{
  json_t *CsParentJson;
  ...
  // ContactName 
  if (InsertJsonStringObj (CsJson, "ContactName", CSPtr->ContactName) != RedfishCS_status_success) {goto Error;}

  // EmailAddress 
  if (InsertJsonStringObj (CsJson, "EmailAddress", CSPtr->EmailAddress) != RedfishCS_status_success) {goto Error;}

  // PhoneNumber 
  if (InsertJsonStringObj (CsJson, "PhoneNumber", CSPtr->PhoneNumber) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_LinksAuthorizedDevices(json_t *CsJson, char *Key, Redfishodatav4_idRef_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishLicense_V1_0_0_Links_CS *CSPtr)
{
  json_t *CsParentJson;
  ...
  // AuthorizedDevices
  if (CS_To_JSON_LinksAuthorizedDevices(CsJson, "AuthorizedDevices", CSPtr->AuthorizedDevices) != RedfishCS_status_success) {goto Error;}

  // AuthorizedDevices@odata.count 
  if (InsertJsonInt64Obj (CsJson, "AuthorizedDevices@odata.count", CSPtr->AuthorizedDevicesodata_count) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for License.V1_0_0.License
//
RedfishCS_status CS_To_License_V1_0_0_JSON(RedfishLicense_V1_0_0_License_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // AuthorizationScope 
  if (InsertJsonStringObj (CsJson, "AuthorizationScope", CSPtr->AuthorizationScope) != RedfishCS_status_success) {goto Error;}

  // Contact
  if (CS_To_JSON_Contact(CsJson, "Contact", CSPtr->Contact) != RedfishCS_status_success) {goto Error;}

  // Description 
  if (InsertJsonStringObj (CsJson, "Description", CSPtr->Description) != RedfishCS_status_success) {goto Error;}

  // DownloadURI 
  if (InsertJsonStringObj (CsJson, "DownloadURI", CSPtr->DownloadURI) != RedfishCS_status_success) {goto Error;}

  // EntitlementId 
  if (InsertJsonStringObj (CsJson, "EntitlementId", CSPtr->EntitlementId) != RedfishCS_status_success) {goto Error;}

  // ExpirationDate 
  if (InsertJsonStringObj (CsJson, "ExpirationDate", CSPtr->ExpirationDate) != RedfishCS_status_success) {goto Error;}

  // GracePeriodDays 
  if (InsertJsonInt64Obj (CsJson, "GracePeriodDays", CSPtr->GracePeriodDays) != RedfishCS_status_success) {goto Error;}

  // Id 
  if (InsertJsonStringObj (CsJson, "Id", CSPtr->Id) != RedfishCS_status_success) {goto Error;}

  // InstallDate 
  if (InsertJsonStringObj (CsJson, "InstallDate", CSPtr->InstallDate) != RedfishCS_status_success) {goto Error;}

  // LicenseInfoURI 
  if (InsertJsonStringObj (CsJson, "LicenseInfoURI", CSPtr->LicenseInfoURI) != RedfishCS_status_success) {goto Error;}

  // LicenseOrigin 
  if (InsertJsonStringObj (CsJson, "LicenseOrigin", CSPtr->LicenseOrigin) != RedfishCS_status_success) {goto Error;}

  // LicenseString 
  if (InsertJsonStringObj (CsJson, "LicenseString", CSPtr->LicenseString) != RedfishCS_status_success) {goto Error;}

  // LicenseType 
  if (InsertJsonStringObj (CsJson, "LicenseType", CSPtr->LicenseType) != RedfishCS_status_success) {goto Error;}
  ...
  if (InsertJsonInt64Obj (CsJson, "MaxAuthorizedDevices", CSPtr->MaxAuthorizedDevices) != RedfishCS_status_success) {goto Error;}
  ...
  // RemainingDuration 
  if (InsertJsonStringObj (CsJson, "RemainingDuration", CSPtr->RemainingDuration) != RedfishCS_status_success) {goto Error;}

  // RemainingUseCount 
  if (InsertJsonInt64Obj (CsJson, "RemainingUseCount", CSPtr->RemainingUseCount) != RedfishCS_status_success) {goto Error;}

  // Removable 
  if (InsertJsonBoolObj (CsJson, "Removable", CSPtr->Removable) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for License.V1_0_0.License
//
RedfishCS_status DestroyLicense_V1_0_0_CS(RedfishLicense_V1_0_0_License_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for License.V1_0_0.License
//
RedfishCS_status DestroyLicense_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for License.V1_0_0.License
//
RedfishCS_status
Json_License_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishLicense_V1_0_0_License_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishLicense_V1_0_0_License_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "License", "v1_0_0", "License", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishLicense_V1_0_0_License_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // AuthorizationScope
  Status = GetRedfishPropertyStr (Cs, JsonObj, "AuthorizationScope", &Cs->AuthorizationScope);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Contact
  Status = GenContactInfoCs (Cs, JsonObj, "Contact", &Cs->Contact);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // DownloadURI
  Status = GetRedfishPropertyStr (Cs, JsonObj, "DownloadURI", &Cs->DownloadURI);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // EntitlementId
  Status = GetRedfishPropertyStr (Cs, JsonObj, "EntitlementId", &Cs->EntitlementId);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ExpirationDate
  Status = GetRedfishPropertyStr (Cs, JsonObj, "ExpirationDate", &Cs->ExpirationDate);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // GracePeriodDays
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "GracePeriodDays", &Cs->GracePeriodDays);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // InstallDate
  Status = GetRedfishPropertyStr (Cs, JsonObj, "InstallDate", &Cs->InstallDate);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // LicenseInfoURI
  Status = GetRedfishPropertyStr (Cs, JsonObj, "LicenseInfoURI", &Cs->LicenseInfoURI);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // LicenseOrigin
  Status = GetRedfishPropertyStr (Cs, JsonObj, "LicenseOrigin", &Cs->LicenseOrigin);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // LicenseString
  Status = GetRedfishPropertyStr (Cs, JsonObj, "LicenseString", &Cs->LicenseString);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // LicenseType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "LicenseType", &Cs->LicenseType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // MaxAuthorizedDevices
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "MaxAuthorizedDevices", &Cs->MaxAuthorizedDevices);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // RemainingDuration
  Status = GetRedfishPropertyStr (Cs, JsonObj, "RemainingDuration", &Cs->RemainingDuration);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // RemainingUseCount
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "RemainingUseCount", &Cs->RemainingUseCount);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Removable
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "Removable", &Cs->Removable);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
