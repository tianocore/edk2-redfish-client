# Definition of VLanNetworkInterface.V1_0_1 and functions<br><br>
...
|**VLANEnable**|RedfishCS_bool| Boolean pointer to **VLANEnable** property.| No| No
|**VLANId**|RedfishCS_int64| 64-bit long long interger pointer to **VLANId** property.| No| No
## Redfish VLanNetworkInterface V1_0_1 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish VLanNetworkInterface V1_0_1 JSON Function
    RedfishCS_status
    CS_To_VLanNetworkInterface_V1_0_1_JSON (RedfishVLanNetworkInterface_V1_0_1_VLanNetworkInterface_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish VLanNetworkInterface V1_0_1 C Structure Function
    RedfishCS_status
