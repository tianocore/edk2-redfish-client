...
#include"Redfish_VLanNetworkInterface_v1_0_9_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishVLanNetworkInterface_V1_0_9_VLanNetworkInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for VLanNetworkInterface.V1_0_9.VLanNetworkInterface
//
RedfishCS_status CS_To_VLanNetworkInterface_V1_0_9_JSON(RedfishVLanNetworkInterface_V1_0_9_VLanNetworkInterface_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for VLanNetworkInterface.V1_0_9.VLanNetworkInterface
//
RedfishCS_status DestroyVLanNetworkInterface_V1_0_9_CS(RedfishVLanNetworkInterface_V1_0_9_VLanNetworkInterface_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for VLanNetworkInterface.V1_0_9.VLanNetworkInterface
//
RedfishCS_status DestroyVLanNetworkInterface_V1_0_9_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for VLanNetworkInterface.V1_0_9.VLanNetworkInterface
//
RedfishCS_status
Json_VLanNetworkInterface_V1_0_9_To_CS(RedfishCS_char *JsonRawText, RedfishVLanNetworkInterface_V1_0_9_VLanNetworkInterface_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishVLanNetworkInterface_V1_0_9_VLanNetworkInterface_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "VLanNetworkInterface", "v1_0_9", "VLanNetworkInterface", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishVLanNetworkInterface_V1_0_9_VLanNetworkInterface_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyVLanNetworkInterface_V1_0_9_CS (Cs);
  return Status;
}
