...
#include"Redfish_VLanNetworkInterface_v1_1_4_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishVLanNetworkInterface_V1_1_4_VLanNetworkInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishVLanNetworkInterface_V1_1_4_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVLanNetworkInterface_V1_1_4_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishVLanNetworkInterface_V1_1_4_VLanNetworkInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishVLanNetworkInterface_V1_1_4_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishVLanNetworkInterface_V1_1_4_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishVLanNetworkInterface_V1_1_4_VLanNetworkInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishVLanNetworkInterface_V1_1_4_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishVLanNetworkInterface_V1_1_4_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for VLanNetworkInterface.V1_1_4.VLanNetworkInterface
//
RedfishCS_status CS_To_VLanNetworkInterface_V1_1_4_JSON(RedfishVLanNetworkInterface_V1_1_4_VLanNetworkInterface_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for VLanNetworkInterface.V1_1_4.VLanNetworkInterface
//
RedfishCS_status DestroyVLanNetworkInterface_V1_1_4_CS(RedfishVLanNetworkInterface_V1_1_4_VLanNetworkInterface_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for VLanNetworkInterface.V1_1_4.VLanNetworkInterface
//
RedfishCS_status DestroyVLanNetworkInterface_V1_1_4_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for VLanNetworkInterface.V1_1_4.VLanNetworkInterface
//
RedfishCS_status
Json_VLanNetworkInterface_V1_1_4_To_CS(RedfishCS_char *JsonRawText, RedfishVLanNetworkInterface_V1_1_4_VLanNetworkInterface_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishVLanNetworkInterface_V1_1_4_VLanNetworkInterface_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "VLanNetworkInterface", "v1_1_4", "VLanNetworkInterface", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishVLanNetworkInterface_V1_1_4_VLanNetworkInterface_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyVLanNetworkInterface_V1_1_4_CS (Cs);
  return Status;
}
