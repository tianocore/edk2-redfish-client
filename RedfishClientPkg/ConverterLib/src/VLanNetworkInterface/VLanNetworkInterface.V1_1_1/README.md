# Definition of VLanNetworkInterface.V1_1_1 and functions<br><br>
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishVLanNetworkInterface_V1_1_1_OemActions_CS| Structure points to **Oem** property.| No| No
...
## VLanNetworkInterface
    typedef struct _RedfishVLanNetworkInterface_V1_1_1_VLanNetworkInterface_CS {
        ...
        RedfishVLanNetworkInterface_V1_1_1_Actions_CS *Actions;
...
|**Actions**|RedfishVLanNetworkInterface_V1_1_1_Actions_CS| Structure points to **Actions** property.| No| No
...
|**VLANEnable**|RedfishCS_bool| Boolean pointer to **VLANEnable** property.| No| No
|**VLANId**|RedfishCS_int64| 64-bit long long interger pointer to **VLANId** property.| No| No
## Redfish VLanNetworkInterface V1_1_1 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish VLanNetworkInterface V1_1_1 JSON Function
    RedfishCS_status
    CS_To_VLanNetworkInterface_V1_1_1_JSON (RedfishVLanNetworkInterface_V1_1_1_VLanNetworkInterface_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish VLanNetworkInterface V1_1_1 C Structure Function
    RedfishCS_status
