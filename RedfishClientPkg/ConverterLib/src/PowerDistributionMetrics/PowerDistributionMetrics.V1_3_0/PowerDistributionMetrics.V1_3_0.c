...
#include"Redfish_PowerDistributionMetrics_v1_3_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
//Generate C structure for #PowerDistributionMetrics.ResetMetrics
//
static RedfishCS_status GenResetMetricsCs(RedfishPowerDistributionMetrics_V1_3_0_PowerDistributionMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerDistributionMetrics_V1_3_0_ResetMetrics_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerDistributionMetrics_V1_3_0_ResetMetrics_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishPowerDistributionMetrics_V1_3_0_PowerDistributionMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerDistributionMetrics_V1_3_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerDistributionMetrics_V1_3_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishPowerDistributionMetrics_V1_3_0_PowerDistributionMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerDistributionMetrics_V1_3_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerDistributionMetrics_V1_3_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #PowerDistributionMetrics.ResetMetrics
  Status = GenResetMetricsCs (Cs, TempJsonObj, "#PowerDistributionMetrics.ResetMetrics", &(*Dst)->PowerDistributionMetrics_ResetMetrics);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishPowerDistributionMetrics_V1_3_0_PowerDistributionMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishPowerDistributionMetrics_V1_3_0_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsPowerDistributionMetrics_ResetMetrics(json_t *CsJson, char *Key, RedfishPowerDistributionMetrics_V1_3_0_ResetMetrics_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishPowerDistributionMetrics_V1_3_0_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
  ...
  // #PowerDistributionMetrics.ResetMetrics
  if (CS_To_JSON_ActionsPowerDistributionMetrics_ResetMetrics(CsJson, "#PowerDistributionMetrics.ResetMetrics", CSPtr->PowerDistributionMetrics_ResetMetrics) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for PowerDistributionMetrics.V1_3_0.PowerDistributionMetrics
//
RedfishCS_status CS_To_PowerDistributionMetrics_V1_3_0_JSON(RedfishPowerDistributionMetrics_V1_3_0_PowerDistributionMetrics_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for PowerDistributionMetrics.V1_3_0.PowerDistributionMetrics
//
RedfishCS_status DestroyPowerDistributionMetrics_V1_3_0_CS(RedfishPowerDistributionMetrics_V1_3_0_PowerDistributionMetrics_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PowerDistributionMetrics.V1_3_0.PowerDistributionMetrics
//
RedfishCS_status DestroyPowerDistributionMetrics_V1_3_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PowerDistributionMetrics.V1_3_0.PowerDistributionMetrics
//
RedfishCS_status
Json_PowerDistributionMetrics_V1_3_0_To_CS(RedfishCS_char *JsonRawText, RedfishPowerDistributionMetrics_V1_3_0_PowerDistributionMetrics_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPowerDistributionMetrics_V1_3_0_PowerDistributionMetrics_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PowerDistributionMetrics", "v1_3_0", "PowerDistributionMetrics", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPowerDistributionMetrics_V1_3_0_PowerDistributionMetrics_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyPowerDistributionMetrics_V1_3_0_CS (Cs);
  return Status;
}
