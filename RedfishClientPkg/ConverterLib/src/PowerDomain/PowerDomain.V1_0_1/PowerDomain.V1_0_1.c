...
#include"Redfish_PowerDomain_v1_0_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishPowerDomain_V1_0_1_PowerDomain_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishPowerDomain_V1_0_1_PowerDomain_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerDomain_V1_0_1_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerDomain_V1_0_1_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishPowerDomain_V1_0_1_PowerDomain_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerDomain_V1_0_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerDomain_V1_0_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishPowerDomain_V1_0_1_PowerDomain_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerDomain_V1_0_1_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerDomain_V1_0_1_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // FloorPDUs
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishPowerDomain_V1_0_1_PowerDomain_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishPowerDomain_V1_0_1_PowerDomain_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishPowerDomain_V1_0_1_PowerDomain_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishPowerDomain_V1_0_1_PowerDomain_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishPowerDomain_V1_0_1_PowerDomain_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishPowerDomain_V1_0_1_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishPowerDomain_V1_0_1_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishPowerDomain_V1_0_1_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for PowerDomain.V1_0_1.PowerDomain
//
RedfishCS_status CS_To_PowerDomain_V1_0_1_JSON(RedfishPowerDomain_V1_0_1_PowerDomain_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for PowerDomain.V1_0_1.PowerDomain
//
RedfishCS_status DestroyPowerDomain_V1_0_1_CS(RedfishPowerDomain_V1_0_1_PowerDomain_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PowerDomain.V1_0_1.PowerDomain
//
RedfishCS_status DestroyPowerDomain_V1_0_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PowerDomain.V1_0_1.PowerDomain
//
RedfishCS_status
Json_PowerDomain_V1_0_1_To_CS(RedfishCS_char *JsonRawText, RedfishPowerDomain_V1_0_1_PowerDomain_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPowerDomain_V1_0_1_PowerDomain_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PowerDomain", "v1_0_1", "PowerDomain", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPowerDomain_V1_0_1_PowerDomain_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyPowerDomain_V1_0_1_CS (Cs);
  return Status;
}
