...
#include"Redfish_CertificateLocations_v1_0_2_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishCertificateLocations_V1_0_2_CertificateLocations_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishCertificateLocations_V1_0_2_CertificateLocations_CS *Cs, json_t *JsonObj, char *Key, RedfishCertificateLocations_V1_0_2_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCertificateLocations_V1_0_2_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishCertificateLocations_V1_0_2_CertificateLocations_CS *Cs, json_t *JsonObj, char *Key, RedfishCertificateLocations_V1_0_2_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCertificateLocations_V1_0_2_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishCertificateLocations_V1_0_2_CertificateLocations_CS *Cs, json_t *JsonObj, char *Key, RedfishCertificateLocations_V1_0_2_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCertificateLocations_V1_0_2_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Certificates
  InitializeLinkHead (&(*Dst)->Certificates);
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "Certificates", Cs->Header.ThisUri, &(*Dst)->Certificates);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Certificates@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "Certificates@odata.count", &(*Dst)->Certificatesodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishCertificateLocations_V1_0_2_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishCertificateLocations_V1_0_2_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishCertificateLocations_V1_0_2_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // Certificates 
  if (InsertJsonLinkArrayObj (CsJson, "Certificates", &CSPtr->Certificates) != RedfishCS_status_success) {goto Error;}

  // Certificates@odata.count 
  if (InsertJsonInt64Obj (CsJson, "Certificates@odata.count", CSPtr->Certificatesodata_count) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for CertificateLocations.V1_0_2.CertificateLocations
//
RedfishCS_status CS_To_CertificateLocations_V1_0_2_JSON(RedfishCertificateLocations_V1_0_2_CertificateLocations_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for CertificateLocations.V1_0_2.CertificateLocations
//
RedfishCS_status DestroyCertificateLocations_V1_0_2_CS(RedfishCertificateLocations_V1_0_2_CertificateLocations_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for CertificateLocations.V1_0_2.CertificateLocations
//
RedfishCS_status DestroyCertificateLocations_V1_0_2_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for CertificateLocations.V1_0_2.CertificateLocations
//
RedfishCS_status
Json_CertificateLocations_V1_0_2_To_CS(RedfishCS_char *JsonRawText, RedfishCertificateLocations_V1_0_2_CertificateLocations_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishCertificateLocations_V1_0_2_CertificateLocations_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "CertificateLocations", "v1_0_2", "CertificateLocations", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishCertificateLocations_V1_0_2_CertificateLocations_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyCertificateLocations_V1_0_2_CS (Cs);
  return Status;
}
