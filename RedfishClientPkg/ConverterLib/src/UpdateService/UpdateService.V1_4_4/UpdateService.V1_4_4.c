...
#include"Redfish_UpdateService_v1_4_4_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishUpdateService_V1_4_4_UpdateService_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenOemCs(RedfishUpdateService_V1_4_4_UpdateService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #UpdateService.SimpleUpdate
//
static RedfishCS_status GenSimpleUpdateCs(RedfishUpdateService_V1_4_4_UpdateService_CS *Cs, json_t *JsonObj, char *Key, RedfishUpdateService_V1_4_4_SimpleUpdate_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishUpdateService_V1_4_4_SimpleUpdate_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishUpdateService_V1_4_4_UpdateService_CS *Cs, json_t *JsonObj, char *Key, RedfishUpdateService_V1_4_4_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishUpdateService_V1_4_4_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishUpdateService_V1_4_4_UpdateService_CS *Cs, json_t *JsonObj, char *Key, RedfishUpdateService_V1_4_4_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishUpdateService_V1_4_4_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenHttpPushUriApplyTimeCs(RedfishUpdateService_V1_4_4_UpdateService_CS *Cs, json_t *JsonObj, char *Key, RedfishUpdateService_V1_4_4_HttpPushUriApplyTime_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishUpdateService_V1_4_4_HttpPushUriApplyTime_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ApplyTime
...
//
static RedfishCS_status GenHttpPushUriOptionsCs(RedfishUpdateService_V1_4_4_UpdateService_CS *Cs, json_t *JsonObj, char *Key, RedfishUpdateService_V1_4_4_HttpPushUriOptions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishUpdateService_V1_4_4_HttpPushUriOptions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenidRefCs(RedfishUpdateService_V1_4_4_UpdateService_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishUpdateService_V1_4_4_UpdateService_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishUpdateService_V1_4_4_UpdateService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishUpdateService_V1_4_4_UpdateService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishUpdateService_V1_4_4_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsUpdateService_SimpleUpdate(json_t *CsJson, char *Key, RedfishUpdateService_V1_4_4_SimpleUpdate_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishUpdateService_V1_4_4_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_HttpPushUriOptionsHttpPushUriApplyTime(json_t *CsJson, char *Key, RedfishUpdateService_V1_4_4_HttpPushUriApplyTime_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_HttpPushUriOptions(json_t *CsJson, char *Key, RedfishUpdateService_V1_4_4_HttpPushUriOptions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for UpdateService.V1_4_4.UpdateService
//
RedfishCS_status CS_To_UpdateService_V1_4_4_JSON(RedfishUpdateService_V1_4_4_UpdateService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for UpdateService.V1_4_4.UpdateService
//
RedfishCS_status DestroyUpdateService_V1_4_4_CS(RedfishUpdateService_V1_4_4_UpdateService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for UpdateService.V1_4_4.UpdateService
//
RedfishCS_status DestroyUpdateService_V1_4_4_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for UpdateService.V1_4_4.UpdateService
//
RedfishCS_status
Json_UpdateService_V1_4_4_To_CS(RedfishCS_char *JsonRawText, RedfishUpdateService_V1_4_4_UpdateService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishUpdateService_V1_4_4_UpdateService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "UpdateService", "v1_4_4", "UpdateService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishUpdateService_V1_4_4_UpdateService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyUpdateService_V1_4_4_CS (Cs);
  return Status;
}
