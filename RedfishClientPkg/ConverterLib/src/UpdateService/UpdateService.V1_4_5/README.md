# Definition of UpdateService.V1_4_5 and functions<br><br>
...
## Actions
    typedef struct _RedfishUpdateService_V1_4_5_Actions_CS {
        ...
        RedfishUpdateService_V1_4_5_OemActions_CS *Oem;
    } RedfishUpdateService_V1_4_5_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**UpdateService_SimpleUpdate**|RedfishUpdateService_V1_4_5_SimpleUpdate_CS| Structure points to **#UpdateService.SimpleUpdate** property.| No| No
|**Oem**|RedfishUpdateService_V1_4_5_OemActions_CS| Structure points to **Oem** property.| No| No
...
## HttpPushUriOptions
    typedef struct _RedfishUpdateService_V1_4_5_HttpPushUriOptions_CS {
        RedfishUpdateService_V1_4_5_HttpPushUriApplyTime_CS *HttpPushUriApplyTime;
    } RedfishUpdateService_V1_4_5_HttpPushUriOptions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**HttpPushUriApplyTime**|RedfishUpdateService_V1_4_5_HttpPushUriApplyTime_CS| Structure points to **HttpPushUriApplyTime** property.| No| No
...
## UpdateService
    typedef struct _RedfishUpdateService_V1_4_5_UpdateService_CS {
        ...
        RedfishUpdateService_V1_4_5_Actions_CS *Actions;
        RedfishCS_char *Description;
        RedfishCS_Link FirmwareInventory;
        RedfishCS_char *HttpPushUri;
        RedfishUpdateService_V1_4_5_HttpPushUriOptions_CS *HttpPushUriOptions;
...
|**Actions**|RedfishUpdateService_V1_4_5_Actions_CS| Structure points to **Actions** property.| No| No
...
|**HttpPushUriOptions**|RedfishUpdateService_V1_4_5_HttpPushUriOptions_CS| Structure points to **HttpPushUriOptions** property.| No| No
...
## Redfish UpdateService V1_4_5 to C Structure Function
    RedfishCS_status
    Json_UpdateService_V1_4_5_To_CS (RedfishCS_char *JsonRawText, RedfishUpdateService_V1_4_5_UpdateService_CS **ReturnedCS);

## C Structure to Redfish UpdateService V1_4_5 JSON Function
    RedfishCS_status
    CS_To_UpdateService_V1_4_5_JSON (RedfishUpdateService_V1_4_5_UpdateService_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish UpdateService V1_4_5 C Structure Function
    RedfishCS_status
