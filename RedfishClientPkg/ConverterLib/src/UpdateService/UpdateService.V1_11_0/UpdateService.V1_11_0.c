...
#include"Redfish_UpdateService_v1_11_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishUpdateService_V1_11_0_UpdateService_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenOemCs(RedfishUpdateService_V1_11_0_UpdateService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #UpdateService.SimpleUpdate
//
static RedfishCS_status GenSimpleUpdateCs(RedfishUpdateService_V1_11_0_UpdateService_CS *Cs, json_t *JsonObj, char *Key, RedfishUpdateService_V1_11_0_SimpleUpdate_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishUpdateService_V1_11_0_SimpleUpdate_CS), (RedfishCS_void **)Dst);
...
//
//Generate C structure for #UpdateService.StartUpdate
//
static RedfishCS_status GenStartUpdateCs(RedfishUpdateService_V1_11_0_UpdateService_CS *Cs, json_t *JsonObj, char *Key, RedfishUpdateService_V1_11_0_StartUpdate_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishUpdateService_V1_11_0_StartUpdate_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishUpdateService_V1_11_0_UpdateService_CS *Cs, json_t *JsonObj, char *Key, RedfishUpdateService_V1_11_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishUpdateService_V1_11_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishUpdateService_V1_11_0_UpdateService_CS *Cs, json_t *JsonObj, char *Key, RedfishUpdateService_V1_11_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishUpdateService_V1_11_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  ...
  Status = GenStartUpdateCs (Cs, TempJsonObj, "#UpdateService.StartUpdate", &(*Dst)->UpdateService_StartUpdate);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for HttpPushUriApplyTime
//
static RedfishCS_status GenHttpPushUriApplyTimeCs(RedfishUpdateService_V1_11_0_UpdateService_CS *Cs, json_t *JsonObj, char *Key, RedfishUpdateService_V1_11_0_HttpPushUriApplyTime_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishUpdateService_V1_11_0_HttpPushUriApplyTime_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ApplyTime
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "ApplyTime", &(*Dst)->ApplyTime);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // MaintenanceWindowDurationInSeconds
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "MaintenanceWindowDurationInSeconds", &(*Dst)->MaintenanceWindowDurationInSeconds);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // MaintenanceWindowStartTime
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "MaintenanceWindowStartTime", &(*Dst)->MaintenanceWindowStartTime);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for HttpPushUriOptions
//
static RedfishCS_status GenHttpPushUriOptionsCs(RedfishUpdateService_V1_11_0_UpdateService_CS *Cs, json_t *JsonObj, char *Key, RedfishUpdateService_V1_11_0_HttpPushUriOptions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishUpdateService_V1_11_0_HttpPushUriOptions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ForceUpdate
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "ForceUpdate", &(*Dst)->ForceUpdate);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // HttpPushUriApplyTime
  Status = GenHttpPushUriApplyTimeCs (Cs, TempJsonObj, "HttpPushUriApplyTime", &(*Dst)->HttpPushUriApplyTime);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenidRefCs(RedfishUpdateService_V1_11_0_UpdateService_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishUpdateService_V1_11_0_UpdateService_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishUpdateService_V1_11_0_UpdateService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishUpdateService_V1_11_0_UpdateService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishUpdateService_V1_11_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsUpdateService_SimpleUpdate(json_t *CsJson, char *Key, RedfishUpdateService_V1_11_0_SimpleUpdate_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsUpdateService_StartUpdate(json_t *CsJson, char *Key, RedfishUpdateService_V1_11_0_StartUpdate_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishUpdateService_V1_11_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // #UpdateService.StartUpdate
  if (CS_To_JSON_ActionsUpdateService_StartUpdate(CsJson, "#UpdateService.StartUpdate", CSPtr->UpdateService_StartUpdate) != RedfishCS_status_success) {goto Error;}

  return RedfishCS_status_success;
Error:;
  return RedfishCS_status_unsupported;
}
static RedfishCS_status CS_To_JSON_HttpPushUriOptionsHttpPushUriApplyTime(json_t *CsJson, char *Key, RedfishUpdateService_V1_11_0_HttpPushUriApplyTime_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // ApplyTime 
  if (InsertJsonStringObj (CsJson, "ApplyTime", CSPtr->ApplyTime) != RedfishCS_status_success) {goto Error;}

  // MaintenanceWindowDurationInSeconds 
  if (InsertJsonInt64Obj (CsJson, "MaintenanceWindowDurationInSeconds", CSPtr->MaintenanceWindowDurationInSeconds) != RedfishCS_status_success) {goto Error;}

  // MaintenanceWindowStartTime 
  if (InsertJsonStringObj (CsJson, "MaintenanceWindowStartTime", CSPtr->MaintenanceWindowStartTime) != RedfishCS_status_success) {goto Error;}

  return RedfishCS_status_success;
Error:;
  return RedfishCS_status_unsupported;
}
static RedfishCS_status CS_To_JSON_HttpPushUriOptions(json_t *CsJson, char *Key, RedfishUpdateService_V1_11_0_HttpPushUriOptions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // ForceUpdate 
  if (InsertJsonBoolObj (CsJson, "ForceUpdate", CSPtr->ForceUpdate) != RedfishCS_status_success) {goto Error;}

  // HttpPushUriApplyTime
  if (CS_To_JSON_HttpPushUriOptionsHttpPushUriApplyTime(CsJson, "HttpPushUriApplyTime", CSPtr->HttpPushUriApplyTime) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for UpdateService.V1_11_0.UpdateService
//
RedfishCS_status CS_To_UpdateService_V1_11_0_JSON(RedfishUpdateService_V1_11_0_UpdateService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // HttpPushUriOptions
  if (CS_To_JSON_HttpPushUriOptions(CsJson, "HttpPushUriOptions", CSPtr->HttpPushUriOptions) != RedfishCS_status_success) {goto Error;}

  // HttpPushUriOptionsBusy 
  if (InsertJsonBoolObj (CsJson, "HttpPushUriOptionsBusy", CSPtr->HttpPushUriOptionsBusy) != RedfishCS_status_success) {goto Error;}
  ...
  // MaxImageSizeBytes 
  if (InsertJsonInt64Obj (CsJson, "MaxImageSizeBytes", CSPtr->MaxImageSizeBytes) != RedfishCS_status_success) {goto Error;}

  // MultipartHttpPushUri 
  if (InsertJsonStringObj (CsJson, "MultipartHttpPushUri", CSPtr->MultipartHttpPushUri) != RedfishCS_status_success) {goto Error;}
  ...
  if (InsertJsonLinkObj (CsJson, "RemoteServerCertificates", &CSPtr->RemoteServerCertificates) != RedfishCS_status_success) {goto Error;}
  ...
  if (InsertJsonBoolObj (CsJson, "VerifyRemoteServerCertificate", CSPtr->VerifyRemoteServerCertificate) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for UpdateService.V1_11_0.UpdateService
//
RedfishCS_status DestroyUpdateService_V1_11_0_CS(RedfishUpdateService_V1_11_0_UpdateService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for UpdateService.V1_11_0.UpdateService
//
RedfishCS_status DestroyUpdateService_V1_11_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for UpdateService.V1_11_0.UpdateService
//
RedfishCS_status
Json_UpdateService_V1_11_0_To_CS(RedfishCS_char *JsonRawText, RedfishUpdateService_V1_11_0_UpdateService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishUpdateService_V1_11_0_UpdateService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "UpdateService", "v1_11_0", "UpdateService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishUpdateService_V1_11_0_UpdateService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // HttpPushUriOptions
  Status = GenHttpPushUriOptionsCs (Cs, JsonObj, "HttpPushUriOptions", &Cs->HttpPushUriOptions);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // HttpPushUriOptionsBusy
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "HttpPushUriOptionsBusy", &Cs->HttpPushUriOptionsBusy);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // MaxImageSizeBytes
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "MaxImageSizeBytes", &Cs->MaxImageSizeBytes);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // MultipartHttpPushUri
  Status = GetRedfishPropertyStr (Cs, JsonObj, "MultipartHttpPushUri", &Cs->MultipartHttpPushUri);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // RemoteServerCertificates
  InitializeLinkHead (&Cs->RemoteServerCertificates);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "RemoteServerCertificates", Cs->Header.ThisUri, &Cs->RemoteServerCertificates);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // VerifyRemoteServerCertificate
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "VerifyRemoteServerCertificate", &Cs->VerifyRemoteServerCertificate);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyUpdateService_V1_11_0_CS (Cs);
  return Status;
}
