# Definition of Sensor.V1_0_7 and functions<br><br>
...
## Actions
    typedef struct _RedfishSensor_V1_0_7_Actions_CS {
        ...
        RedfishSensor_V1_0_7_OemActions_CS *Oem;
    } RedfishSensor_V1_0_7_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Sensor_ResetMetrics**|RedfishSensor_V1_0_7_ResetMetrics_CS| Structure points to **#Sensor.ResetMetrics** property.| No| No
|**Oem**|RedfishSensor_V1_0_7_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Thresholds
    typedef struct _RedfishSensor_V1_0_7_Thresholds_CS {
        RedfishSensor_V1_0_7_Threshold_CS *LowerCaution;
        RedfishSensor_V1_0_7_Threshold_CS *LowerCritical;
        RedfishSensor_V1_0_7_Threshold_CS *LowerFatal;
        RedfishSensor_V1_0_7_Threshold_CS *UpperCaution;
        RedfishSensor_V1_0_7_Threshold_CS *UpperCritical;
        RedfishSensor_V1_0_7_Threshold_CS *UpperFatal;
    } RedfishSensor_V1_0_7_Thresholds_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**LowerCaution**|RedfishSensor_V1_0_7_Threshold_CS| Structure points to **LowerCaution** property.| No| No
|**LowerCritical**|RedfishSensor_V1_0_7_Threshold_CS| Structure points to **LowerCritical** property.| No| No
|**LowerFatal**|RedfishSensor_V1_0_7_Threshold_CS| Structure points to **LowerFatal** property.| No| No
|**UpperCaution**|RedfishSensor_V1_0_7_Threshold_CS| Structure points to **UpperCaution** property.| No| No
|**UpperCritical**|RedfishSensor_V1_0_7_Threshold_CS| Structure points to **UpperCritical** property.| No| No
|**UpperFatal**|RedfishSensor_V1_0_7_Threshold_CS| Structure points to **UpperFatal** property.| No| No
...
## Sensor
    typedef struct _RedfishSensor_V1_0_7_Sensor_CS {
        ...
        RedfishSensor_V1_0_7_Actions_CS *Actions;
        ...
        RedfishSensor_V1_0_7_Thresholds_CS *Thresholds;
...
|**Actions**|RedfishSensor_V1_0_7_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Thresholds**|RedfishSensor_V1_0_7_Thresholds_CS| Structure points to **Thresholds** property.| No| No
|**VoltageType**|RedfishCS_char| String pointer to **VoltageType** property.| No| Yes
## Redfish Sensor V1_0_7 to C Structure Function
    RedfishCS_status
    Json_Sensor_V1_0_7_To_CS (RedfishCS_char *JsonRawText, RedfishSensor_V1_0_7_Sensor_CS **ReturnedCS);

## C Structure to Redfish Sensor V1_0_7 JSON Function
    RedfishCS_status
    CS_To_Sensor_V1_0_7_JSON (RedfishSensor_V1_0_7_Sensor_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Sensor V1_0_7 C Structure Function
    RedfishCS_status
