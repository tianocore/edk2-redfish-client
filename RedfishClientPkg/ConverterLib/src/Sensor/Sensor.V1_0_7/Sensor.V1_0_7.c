...
#include"Redfish_Sensor_v1_0_7_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishSensor_V1_0_7_Sensor_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenThresholdCs(RedfishSensor_V1_0_7_Sensor_CS *Cs, json_t *JsonObj, char *Key, RedfishSensor_V1_0_7_Threshold_CS **Dst);
//
//Generate C structure for #Sensor.ResetMetrics
//
static RedfishCS_status GenResetMetricsCs(RedfishSensor_V1_0_7_Sensor_CS *Cs, json_t *JsonObj, char *Key, RedfishSensor_V1_0_7_ResetMetrics_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSensor_V1_0_7_ResetMetrics_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishSensor_V1_0_7_Sensor_CS *Cs, json_t *JsonObj, char *Key, RedfishSensor_V1_0_7_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSensor_V1_0_7_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishSensor_V1_0_7_Sensor_CS *Cs, json_t *JsonObj, char *Key, RedfishSensor_V1_0_7_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSensor_V1_0_7_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #Sensor.ResetMetrics
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishSensor_V1_0_7_Sensor_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishSensor_V1_0_7_Sensor_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishSensor_V1_0_7_Sensor_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishSensor_V1_0_7_Sensor_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishSensor_V1_0_7_Sensor_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenThresholdCs(RedfishSensor_V1_0_7_Sensor_CS *Cs, json_t *JsonObj, char *Key, RedfishSensor_V1_0_7_Threshold_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSensor_V1_0_7_Threshold_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Activation
...
//
static RedfishCS_status GenThresholdsCs(RedfishSensor_V1_0_7_Sensor_CS *Cs, json_t *JsonObj, char *Key, RedfishSensor_V1_0_7_Thresholds_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSensor_V1_0_7_Thresholds_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // LowerCaution
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishSensor_V1_0_7_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsSensor_ResetMetrics(json_t *CsJson, char *Key, RedfishSensor_V1_0_7_ResetMetrics_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishSensor_V1_0_7_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ThresholdsLowerCaution(json_t *CsJson, char *Key, RedfishSensor_V1_0_7_Threshold_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ThresholdsLowerCritical(json_t *CsJson, char *Key, RedfishSensor_V1_0_7_Threshold_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ThresholdsLowerFatal(json_t *CsJson, char *Key, RedfishSensor_V1_0_7_Threshold_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ThresholdsUpperCaution(json_t *CsJson, char *Key, RedfishSensor_V1_0_7_Threshold_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ThresholdsUpperCritical(json_t *CsJson, char *Key, RedfishSensor_V1_0_7_Threshold_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ThresholdsUpperFatal(json_t *CsJson, char *Key, RedfishSensor_V1_0_7_Threshold_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Thresholds(json_t *CsJson, char *Key, RedfishSensor_V1_0_7_Thresholds_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Sensor.V1_0_7.Sensor
//
RedfishCS_status CS_To_Sensor_V1_0_7_JSON(RedfishSensor_V1_0_7_Sensor_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Sensor.V1_0_7.Sensor
//
RedfishCS_status DestroySensor_V1_0_7_CS(RedfishSensor_V1_0_7_Sensor_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Sensor.V1_0_7.Sensor
//
RedfishCS_status DestroySensor_V1_0_7_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Sensor.V1_0_7.Sensor
//
RedfishCS_status
Json_Sensor_V1_0_7_To_CS(RedfishCS_char *JsonRawText, RedfishSensor_V1_0_7_Sensor_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSensor_V1_0_7_Sensor_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Sensor", "v1_0_7", "Sensor", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSensor_V1_0_7_Sensor_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
