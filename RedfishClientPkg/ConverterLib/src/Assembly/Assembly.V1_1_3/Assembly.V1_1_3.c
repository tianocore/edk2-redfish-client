...
#include"Redfish_Assembly_v1_1_3_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishAssembly_V1_1_3_Assembly_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishAssembly_V1_1_3_Assembly_CS *Cs, json_t *JsonObj, char *Key, RedfishAssembly_V1_1_3_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAssembly_V1_1_3_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishAssembly_V1_1_3_Assembly_CS *Cs, json_t *JsonObj, char *Key, RedfishAssembly_V1_1_3_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAssembly_V1_1_3_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenAssemblyDataOemActionsCs(RedfishAssembly_V1_1_3_Assembly_CS *Cs, json_t *JsonObj, char *Key, RedfishAssembly_V1_1_3_AssemblyDataOemActions_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAssembly_V1_1_3_AssemblyDataOemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  InitializeLinkHead (&(*Dst)->Prop);
...
//Generate C structure for Actions
//
static RedfishCS_status GenAssemblyDataActionsCs(RedfishAssembly_V1_1_3_Assembly_CS *Cs, json_t *JsonObj, char *Key, RedfishAssembly_V1_1_3_AssemblyDataActions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAssembly_V1_1_3_AssemblyDataActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishAssembly_V1_1_3_Assembly_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishAssembly_V1_1_3_Assembly_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishAssembly_V1_1_3_Assembly_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishAssembly_V1_1_3_Assembly_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishAssembly_V1_1_3_Assembly_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenAssemblyData_Array_ElementCs(RedfishAssembly_V1_1_3_Assembly_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishAssembly_V1_1_3_AssemblyData_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishAssembly_V1_1_3_AssemblyData_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // @odata.id
...
//
//Generate C structure for RedfishAssembly_V1_1_3_AssemblyData_Array_CS
//
static RedfishCS_status GenAssemblyData_ArrayCs(RedfishAssembly_V1_1_3_Assembly_CS *Cs, json_t *JsonObj, char *Key, RedfishAssembly_V1_1_3_AssemblyData_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishAssembly_V1_1_3_AssemblyData_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishAssembly_V1_1_3_AssemblyData_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishAssembly_V1_1_3_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishAssembly_V1_1_3_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_AssembliesActionsOem(json_t *CsJson, char *Key, RedfishAssembly_V1_1_3_AssemblyDataOemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_AssembliesActions(json_t *CsJson, char *Key, RedfishAssembly_V1_1_3_AssemblyDataActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Assemblies(json_t *CsJson, char *Key, RedfishAssembly_V1_1_3_AssemblyData_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishAssembly_V1_1_3_AssemblyData_Array_CS *NextArray;
  RedfishAssembly_V1_1_3_AssemblyData_CS *NextArrayItem;
...
//
// C structure to JSON for Assembly.V1_1_3.Assembly
//
RedfishCS_status CS_To_Assembly_V1_1_3_JSON(RedfishAssembly_V1_1_3_Assembly_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Assembly.V1_1_3.Assembly
//
RedfishCS_status DestroyAssembly_V1_1_3_CS(RedfishAssembly_V1_1_3_Assembly_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Assembly.V1_1_3.Assembly
//
RedfishCS_status DestroyAssembly_V1_1_3_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Assembly.V1_1_3.Assembly
//
RedfishCS_status
Json_Assembly_V1_1_3_To_CS(RedfishCS_char *JsonRawText, RedfishAssembly_V1_1_3_Assembly_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAssembly_V1_1_3_Assembly_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Assembly", "v1_1_3", "Assembly", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAssembly_V1_1_3_Assembly_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
