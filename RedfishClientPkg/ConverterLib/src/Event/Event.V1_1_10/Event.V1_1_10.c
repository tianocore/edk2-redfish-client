...
#include"Redfish_Event_v1_1_10_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishEvent_V1_1_10_Event_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishEvent_V1_1_10_Event_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishEvent_V1_1_10_Event_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenEventRecord_Array_ElementCs(RedfishEvent_V1_1_10_Event_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishEvent_V1_1_10_EventRecord_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishEvent_V1_1_10_EventRecord_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Context
...
//
//Generate C structure for RedfishEvent_V1_1_10_EventRecord_Array_CS
//
static RedfishCS_status GenEventRecord_ArrayCs(RedfishEvent_V1_1_10_Event_CS *Cs, json_t *JsonObj, char *Key, RedfishEvent_V1_1_10_EventRecord_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishEvent_V1_1_10_EventRecord_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishEvent_V1_1_10_EventRecord_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_Events(json_t *CsJson, char *Key, RedfishEvent_V1_1_10_EventRecord_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishEvent_V1_1_10_EventRecord_Array_CS *NextArray;
  RedfishEvent_V1_1_10_EventRecord_CS *NextArrayItem;
...
//
// C structure to JSON for Event.V1_1_10.Event
//
RedfishCS_status CS_To_Event_V1_1_10_JSON(RedfishEvent_V1_1_10_Event_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Event.V1_1_10.Event
//
RedfishCS_status DestroyEvent_V1_1_10_CS(RedfishEvent_V1_1_10_Event_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Event.V1_1_10.Event
//
RedfishCS_status DestroyEvent_V1_1_10_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Event.V1_1_10.Event
//
RedfishCS_status
Json_Event_V1_1_10_To_CS(RedfishCS_char *JsonRawText, RedfishEvent_V1_1_10_Event_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEvent_V1_1_10_Event_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Event", "v1_1_10", "Event", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEvent_V1_1_10_Event_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
