# Definition of Event.V1_1_0 and functions<br><br>
...
## Event
    typedef struct _RedfishEvent_V1_1_0_Event_CS {
        ...
        RedfishEvent_V1_1_0_EventRecord_CS *Events;
...
|**Events**|RedfishEvent_V1_1_0_EventRecord_CS| Structure points to **Events** property.| Yes| No
...
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
## Redfish Event V1_1_0 to C Structure Function
    RedfishCS_status
    Json_Event_V1_1_0_To_CS (RedfishCS_char *JsonRawText, RedfishEvent_V1_1_0_Event_CS **ReturnedCS);

## C Structure to Redfish Event V1_1_0 JSON Function
    RedfishCS_status
    CS_To_Event_V1_1_0_JSON (RedfishEvent_V1_1_0_Event_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Event V1_1_0 C Structure Function
    RedfishCS_status
