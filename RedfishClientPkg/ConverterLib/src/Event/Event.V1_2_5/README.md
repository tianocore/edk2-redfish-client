# Definition of Event.V1_2_5 and functions<br><br>

## Actions
    typedef struct _RedfishEvent_V1_2_5_Actions_CS {
        RedfishEvent_V1_2_5_OemActions_CS *Oem;
    } RedfishEvent_V1_2_5_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishEvent_V1_2_5_OemActions_CS| Structure points to **Oem** property.| No| No


## EventRecord
    typedef struct _RedfishEvent_V1_2_5_EventRecord_CS {
        RedfishEvent_V1_2_5_EventRecordActions_CS *Actions;
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Actions**|RedfishEvent_V1_2_5_EventRecordActions_CS| Structure points to **Actions** property.| No| No
...
## EventRecordActions
    typedef struct _RedfishEvent_V1_2_5_EventRecordActions_CS {
        RedfishEvent_V1_2_5_EventRecordOemActions_CS *Oem;
    } RedfishEvent_V1_2_5_EventRecordActions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishEvent_V1_2_5_EventRecordOemActions_CS| Structure points to **Oem** property.| No| No
...
## Event
    typedef struct _RedfishEvent_V1_2_5_Event_CS {
        ...
        RedfishEvent_V1_2_5_Actions_CS *Actions;
        RedfishCS_char *Context;
        RedfishCS_char *Description;
        RedfishEvent_V1_2_5_EventRecord_CS *Events;
...
|**Actions**|RedfishEvent_V1_2_5_Actions_CS| Structure points to **Actions** property.| No| No
|**Context**|RedfishCS_char| String pointer to **Context** property.| No| Yes
|**Description**|RedfishCS_char| String pointer to **Description** property.| No| Yes
|**Events**|RedfishEvent_V1_2_5_EventRecord_CS| Structure points to **Events** property.| Yes| No
...
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
## Redfish Event V1_2_5 to C Structure Function
    RedfishCS_status
    Json_Event_V1_2_5_To_CS (RedfishCS_char *JsonRawText, RedfishEvent_V1_2_5_Event_CS **ReturnedCS);

## C Structure to Redfish Event V1_2_5 JSON Function
    RedfishCS_status
    CS_To_Event_V1_2_5_JSON (RedfishEvent_V1_2_5_Event_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Event V1_2_5 C Structure Function
    RedfishCS_status
