...
#include"Redfish_CompositionService_v1_2_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishCompositionService_V1_2_0_CompositionService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #CompositionService.Compose
//
static RedfishCS_status GenComposeCs(RedfishCompositionService_V1_2_0_CompositionService_CS *Cs, json_t *JsonObj, char *Key, RedfishCompositionService_V1_2_0_Compose_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCompositionService_V1_2_0_Compose_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishCompositionService_V1_2_0_CompositionService_CS *Cs, json_t *JsonObj, char *Key, RedfishCompositionService_V1_2_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCompositionService_V1_2_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishCompositionService_V1_2_0_CompositionService_CS *Cs, json_t *JsonObj, char *Key, RedfishCompositionService_V1_2_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCompositionService_V1_2_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #CompositionService.Compose
  Status = GenComposeCs (Cs, TempJsonObj, "#CompositionService.Compose", &(*Dst)->CompositionService_Compose);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishCompositionService_V1_2_0_CompositionService_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishCompositionService_V1_2_0_CompositionService_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishCompositionService_V1_2_0_CompositionService_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishCompositionService_V1_2_0_CompositionService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishCompositionService_V1_2_0_CompositionService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsCompositionService_Compose(json_t *CsJson, char *Key, RedfishCompositionService_V1_2_0_Compose_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishCompositionService_V1_2_0_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishCompositionService_V1_2_0_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
  ...
  // #CompositionService.Compose
  if (CS_To_JSON_ActionsCompositionService_Compose(CsJson, "#CompositionService.Compose", CSPtr->CompositionService_Compose) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for CompositionService.V1_2_0.CompositionService
//
RedfishCS_status CS_To_CompositionService_V1_2_0_JSON(RedfishCompositionService_V1_2_0_CompositionService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // ActivePool 
  if (InsertJsonLinkObj (CsJson, "ActivePool", &CSPtr->ActivePool) != RedfishCS_status_success) {goto Error;}
  ...
  if (InsertJsonLinkObj (CsJson, "CompositionReservations", &CSPtr->CompositionReservations) != RedfishCS_status_success) {goto Error;}

  // Description 
  if (InsertJsonStringObj (CsJson, "Description", CSPtr->Description) != RedfishCS_status_success) {goto Error;}

  // FreePool 
  if (InsertJsonLinkObj (CsJson, "FreePool", &CSPtr->FreePool) != RedfishCS_status_success) {goto Error;}
  ...
  // ReservationDuration 
  if (InsertJsonStringObj (CsJson, "ReservationDuration", CSPtr->ReservationDuration) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for CompositionService.V1_2_0.CompositionService
//
RedfishCS_status DestroyCompositionService_V1_2_0_CS(RedfishCompositionService_V1_2_0_CompositionService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for CompositionService.V1_2_0.CompositionService
//
RedfishCS_status DestroyCompositionService_V1_2_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for CompositionService.V1_2_0.CompositionService
//
RedfishCS_status
Json_CompositionService_V1_2_0_To_CS(RedfishCS_char *JsonRawText, RedfishCompositionService_V1_2_0_CompositionService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishCompositionService_V1_2_0_CompositionService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "CompositionService", "v1_2_0", "CompositionService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishCompositionService_V1_2_0_CompositionService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // ActivePool
  InitializeLinkHead (&Cs->ActivePool);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "ActivePool", Cs->Header.ThisUri, &Cs->ActivePool);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // CompositionReservations
  InitializeLinkHead (&Cs->CompositionReservations);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "CompositionReservations", Cs->Header.ThisUri, &Cs->CompositionReservations);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // FreePool
  InitializeLinkHead (&Cs->FreePool);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "FreePool", Cs->Header.ThisUri, &Cs->FreePool);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // ReservationDuration
  Status = GetRedfishPropertyStr (Cs, JsonObj, "ReservationDuration", &Cs->ReservationDuration);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyCompositionService_V1_2_0_CS (Cs);
  return Status;
}
