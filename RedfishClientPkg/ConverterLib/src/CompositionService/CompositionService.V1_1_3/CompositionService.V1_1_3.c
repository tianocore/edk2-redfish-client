...
#include"Redfish_CompositionService_v1_1_3_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishCompositionService_V1_1_3_CompositionService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishCompositionService_V1_1_3_CompositionService_CS *Cs, json_t *JsonObj, char *Key, RedfishCompositionService_V1_1_3_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCompositionService_V1_1_3_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishCompositionService_V1_1_3_CompositionService_CS *Cs, json_t *JsonObj, char *Key, RedfishCompositionService_V1_1_3_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishCompositionService_V1_1_3_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishCompositionService_V1_1_3_CompositionService_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishCompositionService_V1_1_3_CompositionService_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishCompositionService_V1_1_3_CompositionService_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishCompositionService_V1_1_3_CompositionService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishCompositionService_V1_1_3_CompositionService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishCompositionService_V1_1_3_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishCompositionService_V1_1_3_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for CompositionService.V1_1_3.CompositionService
//
RedfishCS_status CS_To_CompositionService_V1_1_3_JSON(RedfishCompositionService_V1_1_3_CompositionService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for CompositionService.V1_1_3.CompositionService
//
RedfishCS_status DestroyCompositionService_V1_1_3_CS(RedfishCompositionService_V1_1_3_CompositionService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for CompositionService.V1_1_3.CompositionService
//
RedfishCS_status DestroyCompositionService_V1_1_3_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for CompositionService.V1_1_3.CompositionService
//
RedfishCS_status
Json_CompositionService_V1_1_3_To_CS(RedfishCS_char *JsonRawText, RedfishCompositionService_V1_1_3_CompositionService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishCompositionService_V1_1_3_CompositionService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "CompositionService", "v1_1_3", "CompositionService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishCompositionService_V1_1_3_CompositionService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyCompositionService_V1_1_3_CS (Cs);
  return Status;
}
