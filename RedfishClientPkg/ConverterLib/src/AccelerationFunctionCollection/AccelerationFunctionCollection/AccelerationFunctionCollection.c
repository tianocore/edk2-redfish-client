...
#include"Redfish_AccelerationFunctionCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishAccelerationFunctionCollection_AccelerationFunctionCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for AccelerationFunctionCollection.AccelerationFunctionCollection
//
RedfishCS_status CS_To_AccelerationFunctionCollection_JSON(RedfishAccelerationFunctionCollection_AccelerationFunctionCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for AccelerationFunctionCollection.AccelerationFunctionCollection
//
RedfishCS_status DestroyAccelerationFunctionCollection_CS(RedfishAccelerationFunctionCollection_AccelerationFunctionCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for AccelerationFunctionCollection.AccelerationFunctionCollection
//
RedfishCS_status DestroyAccelerationFunctionCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for AccelerationFunctionCollection.NOVERSIONED.AccelerationFunctionCollection
//
RedfishCS_status
Json_AccelerationFunctionCollection_To_CS(RedfishCS_char *JsonRawText, RedfishAccelerationFunctionCollection_AccelerationFunctionCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAccelerationFunctionCollection_AccelerationFunctionCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "AccelerationFunctionCollection", "noversioned", "AccelerationFunctionCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAccelerationFunctionCollection_AccelerationFunctionCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyAccelerationFunctionCollection_CS (Cs);
  return Status;
}
