# Definition of AccelerationFunctionCollection and functions<br><br>
...
## Redfish AccelerationFunctionCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish AccelerationFunctionCollection  JSON Function
    RedfishCS_status
    CS_To_AccelerationFunctionCollection_JSON (RedfishAccelerationFunctionCollection_AccelerationFunctionCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish AccelerationFunctionCollection  C Structure Function
    RedfishCS_status
