...
#include"Redfish_ThermalMetrics_v1_0_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenResetMetricsCs(RedfishThermalMetrics_V1_0_1_ThermalMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishThermalMetrics_V1_0_1_ResetMetrics_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishThermalMetrics_V1_0_1_ResetMetrics_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishThermalMetrics_V1_0_1_ThermalMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishThermalMetrics_V1_0_1_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishThermalMetrics_V1_0_1_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishThermalMetrics_V1_0_1_ThermalMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishThermalMetrics_V1_0_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishThermalMetrics_V1_0_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishThermalMetrics_V1_0_1_ThermalMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
//
static RedfishCS_status GenTemperatureSummaryCs(RedfishThermalMetrics_V1_0_1_ThermalMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishThermalMetrics_V1_0_1_TemperatureSummary_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishThermalMetrics_V1_0_1_TemperatureSummary_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Ambient
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishThermalMetrics_V1_0_1_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsThermalMetrics_ResetMetrics(json_t *CsJson, char *Key, RedfishThermalMetrics_V1_0_1_ResetMetrics_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishThermalMetrics_V1_0_1_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_TemperatureSummaryCelsius(json_t *CsJson, char *Key, RedfishThermalMetrics_V1_0_1_TemperatureSummary_CS *CSPtr)
{
  json_t *CsParentJson;
...
//
// C structure to JSON for ThermalMetrics.V1_0_1.ThermalMetrics
//
RedfishCS_status CS_To_ThermalMetrics_V1_0_1_JSON(RedfishThermalMetrics_V1_0_1_ThermalMetrics_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ThermalMetrics.V1_0_1.ThermalMetrics
//
RedfishCS_status DestroyThermalMetrics_V1_0_1_CS(RedfishThermalMetrics_V1_0_1_ThermalMetrics_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ThermalMetrics.V1_0_1.ThermalMetrics
//
RedfishCS_status DestroyThermalMetrics_V1_0_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ThermalMetrics.V1_0_1.ThermalMetrics
//
RedfishCS_status
Json_ThermalMetrics_V1_0_1_To_CS(RedfishCS_char *JsonRawText, RedfishThermalMetrics_V1_0_1_ThermalMetrics_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishThermalMetrics_V1_0_1_ThermalMetrics_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ThermalMetrics", "v1_0_1", "ThermalMetrics", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishThermalMetrics_V1_0_1_ThermalMetrics_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyThermalMetrics_V1_0_1_CS (Cs);
  return Status;
}
