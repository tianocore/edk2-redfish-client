...
#include"Redfish_RouteSetEntryCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishRouteSetEntryCollection_RouteSetEntryCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for RouteSetEntryCollection.RouteSetEntryCollection
//
RedfishCS_status CS_To_RouteSetEntryCollection_JSON(RedfishRouteSetEntryCollection_RouteSetEntryCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for RouteSetEntryCollection.RouteSetEntryCollection
//
RedfishCS_status DestroyRouteSetEntryCollection_CS(RedfishRouteSetEntryCollection_RouteSetEntryCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for RouteSetEntryCollection.RouteSetEntryCollection
//
RedfishCS_status DestroyRouteSetEntryCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for RouteSetEntryCollection.NOVERSIONED.RouteSetEntryCollection
//
RedfishCS_status
Json_RouteSetEntryCollection_To_CS(RedfishCS_char *JsonRawText, RedfishRouteSetEntryCollection_RouteSetEntryCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishRouteSetEntryCollection_RouteSetEntryCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "RouteSetEntryCollection", "noversioned", "RouteSetEntryCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishRouteSetEntryCollection_RouteSetEntryCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyRouteSetEntryCollection_CS (Cs);
  return Status;
}
