...
#include"Redfish_StorageControllerCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishStorageControllerCollection_StorageControllerCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for StorageControllerCollection.StorageControllerCollection
//
RedfishCS_status CS_To_StorageControllerCollection_JSON(RedfishStorageControllerCollection_StorageControllerCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for StorageControllerCollection.StorageControllerCollection
//
RedfishCS_status DestroyStorageControllerCollection_CS(RedfishStorageControllerCollection_StorageControllerCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for StorageControllerCollection.StorageControllerCollection
//
RedfishCS_status DestroyStorageControllerCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for StorageControllerCollection.NOVERSIONED.StorageControllerCollection
//
RedfishCS_status
Json_StorageControllerCollection_To_CS(RedfishCS_char *JsonRawText, RedfishStorageControllerCollection_StorageControllerCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishStorageControllerCollection_StorageControllerCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "StorageControllerCollection", "noversioned", "StorageControllerCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishStorageControllerCollection_StorageControllerCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyStorageControllerCollection_CS (Cs);
  return Status;
}
