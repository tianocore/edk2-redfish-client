...
#include"Redfish_CompositionReservationCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishCompositionReservationCollection_CompositionReservationCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for CompositionReservationCollection.CompositionReservationCollection
//
RedfishCS_status CS_To_CompositionReservationCollection_JSON(RedfishCompositionReservationCollection_CompositionReservationCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for CompositionReservationCollection.CompositionReservationCollection
//
RedfishCS_status DestroyCompositionReservationCollection_CS(RedfishCompositionReservationCollection_CompositionReservationCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for CompositionReservationCollection.CompositionReservationCollection
//
RedfishCS_status DestroyCompositionReservationCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for CompositionReservationCollection.NOVERSIONED.CompositionReservationCollection
//
RedfishCS_status
Json_CompositionReservationCollection_To_CS(RedfishCS_char *JsonRawText, RedfishCompositionReservationCollection_CompositionReservationCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishCompositionReservationCollection_CompositionReservationCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "CompositionReservationCollection", "noversioned", "CompositionReservationCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishCompositionReservationCollection_CompositionReservationCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyCompositionReservationCollection_CS (Cs);
  return Status;
}
