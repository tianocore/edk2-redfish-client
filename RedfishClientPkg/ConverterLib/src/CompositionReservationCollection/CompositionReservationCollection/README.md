# Definition of CompositionReservationCollection and functions<br><br>
...
## Redfish CompositionReservationCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish CompositionReservationCollection  JSON Function
    RedfishCS_status
    CS_To_CompositionReservationCollection_JSON (RedfishCompositionReservationCollection_CompositionReservationCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish CompositionReservationCollection  C Structure Function
    RedfishCS_status
