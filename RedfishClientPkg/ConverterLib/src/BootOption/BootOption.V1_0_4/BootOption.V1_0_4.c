...
//
static RedfishCS_status GenOemActionsCs(RedfishBootOption_V1_0_4_BootOption_CS *Cs, json_t *JsonObj, char *Key, RedfishBootOption_V1_0_4_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishBootOption_V1_0_4_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishBootOption_V1_0_4_BootOption_CS *Cs, json_t *JsonObj, char *Key, RedfishBootOption_V1_0_4_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishBootOption_V1_0_4_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishBootOption_V1_0_4_BootOption_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status GenidRef_Array_ElementCs(RedfishBootOption_V1_0_4_BootOption_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRef_ArrayCs(RedfishBootOption_V1_0_4_BootOption_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishBootOption_V1_0_4_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishBootOption_V1_0_4_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
RedfishCS_status CS_To_BootOption_V1_0_4_JSON(RedfishBootOption_V1_0_4_BootOption_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
RedfishCS_status DestroyBootOption_V1_0_4_CS(RedfishBootOption_V1_0_4_BootOption_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
RedfishCS_status DestroyBootOption_V1_0_4_Json(RedfishCS_char *JsonText)
{
...
Json_BootOption_V1_0_4_To_CS(RedfishCS_char *JsonRawText, RedfishBootOption_V1_0_4_BootOption_CS **ReturnedCs)
{
  ...
  Status = CreateJsonPayloadAndCs (JsonRawText, "BootOption", "v1_0_4", "BootOption", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishBootOption_V1_0_4_BootOption_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
