# Definition of LicenseCollection and functions<br><br>
...
## Redfish LicenseCollection  to C Structure Function
    RedfishCS_status
    Json_LicenseCollection_To_CS (RedfishCS_char *JsonRawText, RedfishLicenseCollection_LicenseCollection_CS **ReturnedCS);

## C Structure to Redfish LicenseCollection  JSON Function
    RedfishCS_status
    CS_To_LicenseCollection_JSON (RedfishLicenseCollection_LicenseCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish LicenseCollection  C Structure Function
    RedfishCS_status
