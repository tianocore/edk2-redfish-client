...
#include"Redfish_LicenseCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishLicenseCollection_LicenseCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for LicenseCollection.LicenseCollection
//
RedfishCS_status CS_To_LicenseCollection_JSON(RedfishLicenseCollection_LicenseCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for LicenseCollection.LicenseCollection
//
RedfishCS_status DestroyLicenseCollection_CS(RedfishLicenseCollection_LicenseCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for LicenseCollection.LicenseCollection
//
RedfishCS_status DestroyLicenseCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for LicenseCollection.NOVERSIONED.LicenseCollection
//
RedfishCS_status
Json_LicenseCollection_To_CS(RedfishCS_char *JsonRawText, RedfishLicenseCollection_LicenseCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishLicenseCollection_LicenseCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "LicenseCollection", "noversioned", "LicenseCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishLicenseCollection_LicenseCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyLicenseCollection_CS (Cs);
  return Status;
}
