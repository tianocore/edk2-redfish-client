...
#include"Redfish_Aggregate_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
//Generate C structure for #Aggregate.AddElements
//
static RedfishCS_status GenAddElementsCs(RedfishAggregate_V1_0_0_Aggregate_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregate_V1_0_0_AddElements_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregate_V1_0_0_AddElements_CS), (RedfishCS_void **)Dst);
...
//
//Generate C structure for #Aggregate.RemoveElements
//
static RedfishCS_status GenRemoveElementsCs(RedfishAggregate_V1_0_0_Aggregate_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregate_V1_0_0_RemoveElements_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregate_V1_0_0_RemoveElements_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
//Generate C structure for #Aggregate.Reset
//
static RedfishCS_status GenResetCs(RedfishAggregate_V1_0_0_Aggregate_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregate_V1_0_0_Reset_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregate_V1_0_0_Reset_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
//Generate C structure for #Aggregate.SetDefaultBootOrder
//
static RedfishCS_status GenSetDefaultBootOrderCs(RedfishAggregate_V1_0_0_Aggregate_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregate_V1_0_0_SetDefaultBootOrder_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregate_V1_0_0_SetDefaultBootOrder_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishAggregate_V1_0_0_Aggregate_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregate_V1_0_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregate_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishAggregate_V1_0_0_Aggregate_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregate_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregate_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #Aggregate.AddElements
  Status = GenAddElementsCs (Cs, TempJsonObj, "#Aggregate.AddElements", &(*Dst)->Aggregate_AddElements);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // #Aggregate.RemoveElements
  Status = GenRemoveElementsCs (Cs, TempJsonObj, "#Aggregate.RemoveElements", &(*Dst)->Aggregate_RemoveElements);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // #Aggregate.Reset
  Status = GenResetCs (Cs, TempJsonObj, "#Aggregate.Reset", &(*Dst)->Aggregate_Reset);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // #Aggregate.SetDefaultBootOrder
  Status = GenSetDefaultBootOrderCs (Cs, TempJsonObj, "#Aggregate.SetDefaultBootOrder", &(*Dst)->Aggregate_SetDefaultBootOrder);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishAggregate_V1_0_0_Aggregate_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsAggregate_AddElements(json_t *CsJson, char *Key, RedfishAggregate_V1_0_0_AddElements_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsAggregate_RemoveElements(json_t *CsJson, char *Key, RedfishAggregate_V1_0_0_RemoveElements_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsAggregate_Reset(json_t *CsJson, char *Key, RedfishAggregate_V1_0_0_Reset_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsAggregate_SetDefaultBootOrder(json_t *CsJson, char *Key, RedfishAggregate_V1_0_0_SetDefaultBootOrder_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishAggregate_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishAggregate_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // #Aggregate.AddElements
  if (CS_To_JSON_ActionsAggregate_AddElements(CsJson, "#Aggregate.AddElements", CSPtr->Aggregate_AddElements) != RedfishCS_status_success) {goto Error;}

  // #Aggregate.RemoveElements
  if (CS_To_JSON_ActionsAggregate_RemoveElements(CsJson, "#Aggregate.RemoveElements", CSPtr->Aggregate_RemoveElements) != RedfishCS_status_success) {goto Error;}

  // #Aggregate.Reset
  if (CS_To_JSON_ActionsAggregate_Reset(CsJson, "#Aggregate.Reset", CSPtr->Aggregate_Reset) != RedfishCS_status_success) {goto Error;}

  // #Aggregate.SetDefaultBootOrder
  if (CS_To_JSON_ActionsAggregate_SetDefaultBootOrder(CsJson, "#Aggregate.SetDefaultBootOrder", CSPtr->Aggregate_SetDefaultBootOrder) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for Aggregate.V1_0_0.Aggregate
//
RedfishCS_status CS_To_Aggregate_V1_0_0_JSON(RedfishAggregate_V1_0_0_Aggregate_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // Elements 
  if (InsertJsonLinkArrayObj (CsJson, "Elements", &CSPtr->Elements) != RedfishCS_status_success) {goto Error;}

  // ElementsCount 
  if (InsertJsonInt64Obj (CsJson, "ElementsCount", CSPtr->ElementsCount) != RedfishCS_status_success) {goto Error;}

  // Elements@odata.count 
  if (InsertJsonInt64Obj (CsJson, "Elements@odata.count", CSPtr->Elementsodata_count) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for Aggregate.V1_0_0.Aggregate
//
RedfishCS_status DestroyAggregate_V1_0_0_CS(RedfishAggregate_V1_0_0_Aggregate_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Aggregate.V1_0_0.Aggregate
//
RedfishCS_status DestroyAggregate_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Aggregate.V1_0_0.Aggregate
//
RedfishCS_status
Json_Aggregate_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishAggregate_V1_0_0_Aggregate_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAggregate_V1_0_0_Aggregate_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Aggregate", "v1_0_0", "Aggregate", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAggregate_V1_0_0_Aggregate_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // Elements
  InitializeLinkHead (&Cs->Elements);
  Status = CreateCsUriOrJsonByNodeArray (Cs, JsonObj, "Elements", Cs->Header.ThisUri, &Cs->Elements);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){goto Error;}}

  // Elements@odata.count
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "Elements@odata.count", &Cs->Elementsodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ElementsCount
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "ElementsCount", &Cs->ElementsCount);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
