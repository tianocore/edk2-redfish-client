...
#include"Redfish_Aggregate_v1_0_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenAddElementsCs(RedfishAggregate_V1_0_1_Aggregate_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregate_V1_0_1_AddElements_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregate_V1_0_1_AddElements_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenRemoveElementsCs(RedfishAggregate_V1_0_1_Aggregate_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregate_V1_0_1_RemoveElements_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregate_V1_0_1_RemoveElements_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenResetCs(RedfishAggregate_V1_0_1_Aggregate_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregate_V1_0_1_Reset_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregate_V1_0_1_Reset_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenSetDefaultBootOrderCs(RedfishAggregate_V1_0_1_Aggregate_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregate_V1_0_1_SetDefaultBootOrder_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregate_V1_0_1_SetDefaultBootOrder_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishAggregate_V1_0_1_Aggregate_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregate_V1_0_1_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregate_V1_0_1_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishAggregate_V1_0_1_Aggregate_CS *Cs, json_t *JsonObj, char *Key, RedfishAggregate_V1_0_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAggregate_V1_0_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishAggregate_V1_0_1_Aggregate_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsAggregate_AddElements(json_t *CsJson, char *Key, RedfishAggregate_V1_0_1_AddElements_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsAggregate_RemoveElements(json_t *CsJson, char *Key, RedfishAggregate_V1_0_1_RemoveElements_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsAggregate_Reset(json_t *CsJson, char *Key, RedfishAggregate_V1_0_1_Reset_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsAggregate_SetDefaultBootOrder(json_t *CsJson, char *Key, RedfishAggregate_V1_0_1_SetDefaultBootOrder_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishAggregate_V1_0_1_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishAggregate_V1_0_1_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
//
// C structure to JSON for Aggregate.V1_0_1.Aggregate
//
RedfishCS_status CS_To_Aggregate_V1_0_1_JSON(RedfishAggregate_V1_0_1_Aggregate_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Aggregate.V1_0_1.Aggregate
//
RedfishCS_status DestroyAggregate_V1_0_1_CS(RedfishAggregate_V1_0_1_Aggregate_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Aggregate.V1_0_1.Aggregate
//
RedfishCS_status DestroyAggregate_V1_0_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Aggregate.V1_0_1.Aggregate
//
RedfishCS_status
Json_Aggregate_V1_0_1_To_CS(RedfishCS_char *JsonRawText, RedfishAggregate_V1_0_1_Aggregate_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAggregate_V1_0_1_Aggregate_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Aggregate", "v1_0_1", "Aggregate", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAggregate_V1_0_1_Aggregate_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
