...
#include"Redfish_OutletCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishOutletCollection_OutletCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for OutletCollection.OutletCollection
//
RedfishCS_status CS_To_OutletCollection_JSON(RedfishOutletCollection_OutletCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for OutletCollection.OutletCollection
//
RedfishCS_status DestroyOutletCollection_CS(RedfishOutletCollection_OutletCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for OutletCollection.OutletCollection
//
RedfishCS_status DestroyOutletCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for OutletCollection.NOVERSIONED.OutletCollection
//
RedfishCS_status
Json_OutletCollection_To_CS(RedfishCS_char *JsonRawText, RedfishOutletCollection_OutletCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishOutletCollection_OutletCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "OutletCollection", "noversioned", "OutletCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishOutletCollection_OutletCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
