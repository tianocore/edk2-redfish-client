# Definition of Facility.V1_2_0 and functions<br><br>

## Actions
    typedef struct _RedfishFacility_V1_2_0_Actions_CS {
        RedfishFacility_V1_2_0_OemActions_CS *Oem;
    } RedfishFacility_V1_2_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishFacility_V1_2_0_OemActions_CS| Structure points to **Oem** property.| No| No
...
|**Actions**|RedfishFacility_V1_2_0_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishFacility_V1_2_0_Links_CS| Structure points to **Links** property.| No| No
|**Location**|RedfishCS_Link| Structure link list to **Location** property.| No| No
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**PowerDomains**|RedfishCS_Link| Structure link list to **PowerDomains** property.| No| Yes
|**Status**|RedfishResource_Status_CS| Structure points to **Status** property.| No| No
## Redfish Facility V1_2_0 to C Structure Function
    RedfishCS_status
    Json_Facility_V1_2_0_To_CS (RedfishCS_char *JsonRawText, RedfishFacility_V1_2_0_Facility_CS **ReturnedCS);

## C Structure to Redfish Facility V1_2_0 JSON Function
    RedfishCS_status
    CS_To_Facility_V1_2_0_JSON (RedfishFacility_V1_2_0_Facility_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Facility V1_2_0 C Structure Function
    RedfishCS_status
