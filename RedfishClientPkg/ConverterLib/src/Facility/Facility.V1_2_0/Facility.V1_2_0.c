...
#include"Redfish_Facility_v1_2_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishFacility_V1_2_0_Facility_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishFacility_V1_2_0_Facility_CS *Cs, json_t *JsonObj, char *Key, RedfishFacility_V1_2_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishFacility_V1_2_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishFacility_V1_2_0_Facility_CS *Cs, json_t *JsonObj, char *Key, RedfishFacility_V1_2_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishFacility_V1_2_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishFacility_V1_2_0_Facility_CS *Cs, json_t *JsonObj, char *Key, RedfishFacility_V1_2_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishFacility_V1_2_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ContainedByFacility
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishFacility_V1_2_0_Facility_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishFacility_V1_2_0_Facility_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishFacility_V1_2_0_Facility_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishFacility_V1_2_0_Facility_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishFacility_V1_2_0_Facility_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishFacility_V1_2_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishFacility_V1_2_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishFacility_V1_2_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Facility.V1_2_0.Facility
//
RedfishCS_status CS_To_Facility_V1_2_0_JSON(RedfishFacility_V1_2_0_Facility_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Facility.V1_2_0.Facility
//
RedfishCS_status DestroyFacility_V1_2_0_CS(RedfishFacility_V1_2_0_Facility_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Facility.V1_2_0.Facility
//
RedfishCS_status DestroyFacility_V1_2_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Facility.V1_2_0.Facility
//
RedfishCS_status
Json_Facility_V1_2_0_To_CS(RedfishCS_char *JsonRawText, RedfishFacility_V1_2_0_Facility_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishFacility_V1_2_0_Facility_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Facility", "v1_2_0", "Facility", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishFacility_V1_2_0_Facility_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
