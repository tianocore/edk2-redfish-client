# Definition of Facility.V1_3_0 and functions<br><br>

## Actions
    typedef struct _RedfishFacility_V1_3_0_Actions_CS {
        RedfishFacility_V1_3_0_OemActions_CS *Oem;
    } RedfishFacility_V1_3_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishFacility_V1_3_0_OemActions_CS| Structure points to **Oem** property.| No| No


## Links
    typedef struct _RedfishFacility_V1_3_0_Links_CS {
    ...
    } RedfishFacility_V1_3_0_Links_CS;
...
## OemActions
    typedef struct _RedfishFacility_V1_3_0_OemActions_CS {
        RedfishCS_Link Prop;
    } RedfishFacility_V1_3_0_OemActions_CS;
...
## Facility
    typedef struct _RedfishFacility_V1_3_0_Facility_CS {
        RedfishCS_Header     Header;
        RedfishCS_char *odata_context;
        RedfishCS_char *odata_etag;
        RedfishCS_char *odata_id;
        RedfishCS_char *odata_type;
        RedfishFacility_V1_3_0_Actions_CS *Actions;
        RedfishCS_Link AmbientMetrics;
        RedfishCS_char *Description;
        RedfishCS_Link EnvironmentMetrics;
        RedfishCS_char *FacilityType;
        RedfishCS_char *Id;
        RedfishFacility_V1_3_0_Links_CS *Links;
        RedfishCS_Link Location;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishCS_Link PowerDomains;
        RedfishResource_Status_CS *Status;
    } RedfishFacility_V1_3_0_Facility_CS;
...
|**Actions**|RedfishFacility_V1_3_0_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishFacility_V1_3_0_Links_CS| Structure points to **Links** property.| No| No
|**Location**|RedfishCS_Link| Structure link list to **Location** property.| No| No
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**PowerDomains**|RedfishCS_Link| Structure link list to **PowerDomains** property.| No| Yes
|**Status**|RedfishResource_Status_CS| Structure points to **Status** property.| No| No
## Redfish Facility V1_3_0 to C Structure Function
    RedfishCS_status
    Json_Facility_V1_3_0_To_CS (RedfishCS_char *JsonRawText, RedfishFacility_V1_3_0_Facility_CS **ReturnedCS);

## C Structure to Redfish Facility V1_3_0 JSON Function
    RedfishCS_status
    CS_To_Facility_V1_3_0_JSON (RedfishFacility_V1_3_0_Facility_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Facility V1_3_0 C Structure Function
    RedfishCS_status
    DestroyFacility_V1_3_0_CS (RedfishFacility_V1_3_0_Facility_CS *CSPtr);
