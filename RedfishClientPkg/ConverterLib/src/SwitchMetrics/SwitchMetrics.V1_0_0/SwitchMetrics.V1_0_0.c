...
#include"Redfish_SwitchMetrics_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
//Generate C structure for #SwitchMetrics.ClearCurrentPeriod
//
static RedfishCS_status GenClearCurrentPeriodCs(RedfishSwitchMetrics_V1_0_0_SwitchMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishSwitchMetrics_V1_0_0_ClearCurrentPeriod_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSwitchMetrics_V1_0_0_ClearCurrentPeriod_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishSwitchMetrics_V1_0_0_SwitchMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishSwitchMetrics_V1_0_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSwitchMetrics_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishSwitchMetrics_V1_0_0_SwitchMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishSwitchMetrics_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSwitchMetrics_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #SwitchMetrics.ClearCurrentPeriod
  Status = GenClearCurrentPeriodCs (Cs, TempJsonObj, "#SwitchMetrics.ClearCurrentPeriod", &(*Dst)->SwitchMetrics_ClearCurrentPeriod);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenCurrentPeriodCs(RedfishSwitchMetrics_V1_0_0_SwitchMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishSwitchMetrics_V1_0_0_CurrentPeriod_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSwitchMetrics_V1_0_0_CurrentPeriod_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenLifeTimeCs(RedfishSwitchMetrics_V1_0_0_SwitchMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishSwitchMetrics_V1_0_0_LifeTime_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSwitchMetrics_V1_0_0_LifeTime_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // CorrectableECCErrorCount
...
//
//Generate C structure for InternalMemoryMetrics
//
static RedfishCS_status GenInternalMemoryMetricsCs(RedfishSwitchMetrics_V1_0_0_SwitchMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishSwitchMetrics_V1_0_0_InternalMemoryMetrics_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSwitchMetrics_V1_0_0_InternalMemoryMetrics_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // CurrentPeriod
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishSwitchMetrics_V1_0_0_SwitchMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishSwitchMetrics_V1_0_0_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsSwitchMetrics_ClearCurrentPeriod(json_t *CsJson, char *Key, RedfishSwitchMetrics_V1_0_0_ClearCurrentPeriod_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishSwitchMetrics_V1_0_0_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
  ...
  // #SwitchMetrics.ClearCurrentPeriod
  if (CS_To_JSON_ActionsSwitchMetrics_ClearCurrentPeriod(CsJson, "#SwitchMetrics.ClearCurrentPeriod", CSPtr->SwitchMetrics_ClearCurrentPeriod) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_InternalMemoryMetricsCurrentPeriod(json_t *CsJson, char *Key, RedfishSwitchMetrics_V1_0_0_CurrentPeriod_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_InternalMemoryMetricsLifeTime(json_t *CsJson, char *Key, RedfishSwitchMetrics_V1_0_0_LifeTime_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_InternalMemoryMetrics(json_t *CsJson, char *Key, RedfishSwitchMetrics_V1_0_0_InternalMemoryMetrics_CS *CSPtr)
{
  json_t *CsParentJson;
  ...
  // CurrentPeriod
  if (CS_To_JSON_InternalMemoryMetricsCurrentPeriod(CsJson, "CurrentPeriod", CSPtr->CurrentPeriod) != RedfishCS_status_success) {goto Error;}

  // LifeTime
  if (CS_To_JSON_InternalMemoryMetricsLifeTime(CsJson, "LifeTime", CSPtr->LifeTime) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for SwitchMetrics.V1_0_0.SwitchMetrics
//
RedfishCS_status CS_To_SwitchMetrics_V1_0_0_JSON(RedfishSwitchMetrics_V1_0_0_SwitchMetrics_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  if (CS_To_JSON_InternalMemoryMetrics(CsJson, "InternalMemoryMetrics", CSPtr->InternalMemoryMetrics) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for SwitchMetrics.V1_0_0.SwitchMetrics
//
RedfishCS_status DestroySwitchMetrics_V1_0_0_CS(RedfishSwitchMetrics_V1_0_0_SwitchMetrics_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for SwitchMetrics.V1_0_0.SwitchMetrics
//
RedfishCS_status DestroySwitchMetrics_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for SwitchMetrics.V1_0_0.SwitchMetrics
//
RedfishCS_status
Json_SwitchMetrics_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishSwitchMetrics_V1_0_0_SwitchMetrics_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSwitchMetrics_V1_0_0_SwitchMetrics_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "SwitchMetrics", "v1_0_0", "SwitchMetrics", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSwitchMetrics_V1_0_0_SwitchMetrics_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // InternalMemoryMetrics
  Status = GenInternalMemoryMetricsCs (Cs, JsonObj, "InternalMemoryMetrics", &Cs->InternalMemoryMetrics);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroySwitchMetrics_V1_0_0_CS (Cs);
  return Status;
}
