...
#include"Redfish_MediaController_v1_0_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishMediaController_V1_0_1_MediaController_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #MediaController.Reset
//
static RedfishCS_status GenResetCs(RedfishMediaController_V1_0_1_MediaController_CS *Cs, json_t *JsonObj, char *Key, RedfishMediaController_V1_0_1_Reset_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMediaController_V1_0_1_Reset_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishMediaController_V1_0_1_MediaController_CS *Cs, json_t *JsonObj, char *Key, RedfishMediaController_V1_0_1_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMediaController_V1_0_1_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishMediaController_V1_0_1_MediaController_CS *Cs, json_t *JsonObj, char *Key, RedfishMediaController_V1_0_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMediaController_V1_0_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenLinksCs(RedfishMediaController_V1_0_1_MediaController_CS *Cs, json_t *JsonObj, char *Key, RedfishMediaController_V1_0_1_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMediaController_V1_0_1_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Endpoints
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishMediaController_V1_0_1_MediaController_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishMediaController_V1_0_1_MediaController_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishMediaController_V1_0_1_MediaController_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishMediaController_V1_0_1_MediaController_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishMediaController_V1_0_1_MediaController_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsMediaController_Reset(json_t *CsJson, char *Key, RedfishMediaController_V1_0_1_Reset_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishMediaController_V1_0_1_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishMediaController_V1_0_1_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishMediaController_V1_0_1_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for MediaController.V1_0_1.MediaController
//
RedfishCS_status CS_To_MediaController_V1_0_1_JSON(RedfishMediaController_V1_0_1_MediaController_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for MediaController.V1_0_1.MediaController
//
RedfishCS_status DestroyMediaController_V1_0_1_CS(RedfishMediaController_V1_0_1_MediaController_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MediaController.V1_0_1.MediaController
//
RedfishCS_status DestroyMediaController_V1_0_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MediaController.V1_0_1.MediaController
//
RedfishCS_status
Json_MediaController_V1_0_1_To_CS(RedfishCS_char *JsonRawText, RedfishMediaController_V1_0_1_MediaController_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMediaController_V1_0_1_MediaController_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MediaController", "v1_0_1", "MediaController", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMediaController_V1_0_1_MediaController_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyMediaController_V1_0_1_CS (Cs);
  return Status;
}
