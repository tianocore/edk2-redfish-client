...
#include"Redfish_SerialInterface_v1_1_5_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishSerialInterface_V1_1_5_SerialInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishSerialInterface_V1_1_5_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSerialInterface_V1_1_5_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishSerialInterface_V1_1_5_SerialInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishSerialInterface_V1_1_5_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSerialInterface_V1_1_5_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishSerialInterface_V1_1_5_SerialInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishSerialInterface_V1_1_5_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishSerialInterface_V1_1_5_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for SerialInterface.V1_1_5.SerialInterface
//
RedfishCS_status CS_To_SerialInterface_V1_1_5_JSON(RedfishSerialInterface_V1_1_5_SerialInterface_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for SerialInterface.V1_1_5.SerialInterface
//
RedfishCS_status DestroySerialInterface_V1_1_5_CS(RedfishSerialInterface_V1_1_5_SerialInterface_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for SerialInterface.V1_1_5.SerialInterface
//
RedfishCS_status DestroySerialInterface_V1_1_5_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for SerialInterface.V1_1_5.SerialInterface
//
RedfishCS_status
Json_SerialInterface_V1_1_5_To_CS(RedfishCS_char *JsonRawText, RedfishSerialInterface_V1_1_5_SerialInterface_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSerialInterface_V1_1_5_SerialInterface_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "SerialInterface", "v1_1_5", "SerialInterface", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSerialInterface_V1_1_5_SerialInterface_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroySerialInterface_V1_1_5_CS (Cs);
  return Status;
}
