...
#include"Redfish_SerialInterface_v1_0_11_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishSerialInterface_V1_0_11_SerialInterface_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for SerialInterface.V1_0_11.SerialInterface
//
RedfishCS_status CS_To_SerialInterface_V1_0_11_JSON(RedfishSerialInterface_V1_0_11_SerialInterface_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for SerialInterface.V1_0_11.SerialInterface
//
RedfishCS_status DestroySerialInterface_V1_0_11_CS(RedfishSerialInterface_V1_0_11_SerialInterface_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for SerialInterface.V1_0_11.SerialInterface
//
RedfishCS_status DestroySerialInterface_V1_0_11_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for SerialInterface.V1_0_11.SerialInterface
//
RedfishCS_status
Json_SerialInterface_V1_0_11_To_CS(RedfishCS_char *JsonRawText, RedfishSerialInterface_V1_0_11_SerialInterface_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSerialInterface_V1_0_11_SerialInterface_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "SerialInterface", "v1_0_11", "SerialInterface", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSerialInterface_V1_0_11_SerialInterface_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroySerialInterface_V1_0_11_CS (Cs);
  return Status;
}
