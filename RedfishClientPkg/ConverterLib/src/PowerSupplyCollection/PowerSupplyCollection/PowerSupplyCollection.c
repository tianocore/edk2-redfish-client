...
#include"Redfish_PowerSupplyCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishPowerSupplyCollection_PowerSupplyCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for PowerSupplyCollection.PowerSupplyCollection
//
RedfishCS_status CS_To_PowerSupplyCollection_JSON(RedfishPowerSupplyCollection_PowerSupplyCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for PowerSupplyCollection.PowerSupplyCollection
//
RedfishCS_status DestroyPowerSupplyCollection_CS(RedfishPowerSupplyCollection_PowerSupplyCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PowerSupplyCollection.PowerSupplyCollection
//
RedfishCS_status DestroyPowerSupplyCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PowerSupplyCollection.NOVERSIONED.PowerSupplyCollection
//
RedfishCS_status
Json_PowerSupplyCollection_To_CS(RedfishCS_char *JsonRawText, RedfishPowerSupplyCollection_PowerSupplyCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPowerSupplyCollection_PowerSupplyCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PowerSupplyCollection", "noversioned", "PowerSupplyCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPowerSupplyCollection_PowerSupplyCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyPowerSupplyCollection_CS (Cs);
  return Status;
}
