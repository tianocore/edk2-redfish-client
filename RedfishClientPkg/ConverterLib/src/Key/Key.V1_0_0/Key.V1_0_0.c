...
#include"Redfish_Key_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishKey_V1_0_0_Key_CS *Cs, json_t *JsonObj, char *Key, RedfishKey_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishKey_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishKey_V1_0_0_Key_CS *Cs, json_t *JsonObj, char *Key, RedfishKey_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishKey_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishKey_V1_0_0_Key_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenNVMeoFCs(RedfishKey_V1_0_0_Key_CS *Cs, json_t *JsonObj, char *Key, RedfishKey_V1_0_0_NVMeoF_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishKey_V1_0_0_NVMeoF_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // HostKeyId
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "HostKeyId", &(*Dst)->HostKeyId);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // NQN
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "NQN", &(*Dst)->NQN);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // OEMSecurityProtocolType
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "OEMSecurityProtocolType", &(*Dst)->OEMSecurityProtocolType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "SecurityProtocolType", &(*Dst)->SecurityProtocolType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishKey_V1_0_0_Key_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishKey_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishKey_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_NVMeoF(json_t *CsJson, char *Key, RedfishKey_V1_0_0_NVMeoF_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // HostKeyId 
  if (InsertJsonStringObj (CsJson, "HostKeyId", CSPtr->HostKeyId) != RedfishCS_status_success) {goto Error;}

  // NQN 
  if (InsertJsonStringObj (CsJson, "NQN", CSPtr->NQN) != RedfishCS_status_success) {goto Error;}

  // OEMSecurityProtocolType 
  if (InsertJsonStringObj (CsJson, "OEMSecurityProtocolType", CSPtr->OEMSecurityProtocolType) != RedfishCS_status_success) {goto Error;}

  // SecureHashAllowList 
  if (InsertJsonStringArrayObj (CsJson, "SecureHashAllowList", CSPtr->SecureHashAllowList) != RedfishCS_status_success) {goto Error;}

  // SecurityProtocolType 
  if (InsertJsonStringObj (CsJson, "SecurityProtocolType", CSPtr->SecurityProtocolType) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for Key.V1_0_0.Key
//
RedfishCS_status CS_To_Key_V1_0_0_JSON(RedfishKey_V1_0_0_Key_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // KeyString 
  if (InsertJsonStringObj (CsJson, "KeyString", CSPtr->KeyString) != RedfishCS_status_success) {goto Error;}

  // KeyType 
  if (InsertJsonStringObj (CsJson, "KeyType", CSPtr->KeyType) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for Key.V1_0_0.Key
//
RedfishCS_status DestroyKey_V1_0_0_CS(RedfishKey_V1_0_0_Key_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Key.V1_0_0.Key
//
RedfishCS_status DestroyKey_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Key.V1_0_0.Key
//
RedfishCS_status
Json_Key_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishKey_V1_0_0_Key_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishKey_V1_0_0_Key_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Key", "v1_0_0", "Key", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishKey_V1_0_0_Key_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // KeyString
  Status = GetRedfishPropertyStr (Cs, JsonObj, "KeyString", &Cs->KeyString);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // KeyType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "KeyType", &Cs->KeyType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
