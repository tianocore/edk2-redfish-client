# Definition of SoftwareInventory.V1_4_0 and functions<br><br>
...
## Actions
    typedef struct _RedfishSoftwareInventory_V1_4_0_Actions_CS {
        RedfishSoftwareInventory_V1_4_0_OemActions_CS *Oem;
    } RedfishSoftwareInventory_V1_4_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishSoftwareInventory_V1_4_0_OemActions_CS| Structure points to **Oem** property.| No| No
...
## SoftwareInventory
    typedef struct _RedfishSoftwareInventory_V1_4_0_SoftwareInventory_CS {
        ...
        RedfishSoftwareInventory_V1_4_0_Actions_CS *Actions;
...
|**Actions**|RedfishSoftwareInventory_V1_4_0_Actions_CS| Structure points to **Actions** property.| No| No
...
## Redfish SoftwareInventory V1_4_0 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish SoftwareInventory V1_4_0 JSON Function
    RedfishCS_status
    CS_To_SoftwareInventory_V1_4_0_JSON (RedfishSoftwareInventory_V1_4_0_SoftwareInventory_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish SoftwareInventory V1_4_0 C Structure Function
    RedfishCS_status
