...
#include"Redfish_SoftwareInventory_v1_3_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishSoftwareInventory_V1_3_0_SoftwareInventory_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishSoftwareInventory_V1_3_0_SoftwareInventory_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishSoftwareInventory_V1_3_0_SoftwareInventory_CS *Cs, json_t *JsonObj, char *Key, RedfishSoftwareInventory_V1_3_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSoftwareInventory_V1_3_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishSoftwareInventory_V1_3_0_SoftwareInventory_CS *Cs, json_t *JsonObj, char *Key, RedfishSoftwareInventory_V1_3_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSoftwareInventory_V1_3_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenidRef_Array_ElementCs(RedfishSoftwareInventory_V1_3_0_SoftwareInventory_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRef_ArrayCs(RedfishSoftwareInventory_V1_3_0_SoftwareInventory_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishSoftwareInventory_V1_3_0_SoftwareInventory_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishSoftwareInventory_V1_3_0_SoftwareInventory_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishSoftwareInventory_V1_3_0_SoftwareInventory_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishSoftwareInventory_V1_3_0_SoftwareInventory_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishSoftwareInventory_V1_3_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishSoftwareInventory_V1_3_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for SoftwareInventory.V1_3_0.SoftwareInventory
//
RedfishCS_status CS_To_SoftwareInventory_V1_3_0_JSON(RedfishSoftwareInventory_V1_3_0_SoftwareInventory_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for SoftwareInventory.V1_3_0.SoftwareInventory
//
RedfishCS_status DestroySoftwareInventory_V1_3_0_CS(RedfishSoftwareInventory_V1_3_0_SoftwareInventory_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for SoftwareInventory.V1_3_0.SoftwareInventory
//
RedfishCS_status DestroySoftwareInventory_V1_3_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for SoftwareInventory.V1_3_0.SoftwareInventory
//
RedfishCS_status
Json_SoftwareInventory_V1_3_0_To_CS(RedfishCS_char *JsonRawText, RedfishSoftwareInventory_V1_3_0_SoftwareInventory_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSoftwareInventory_V1_3_0_SoftwareInventory_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "SoftwareInventory", "v1_3_0", "SoftwareInventory", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSoftwareInventory_V1_3_0_SoftwareInventory_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroySoftwareInventory_V1_3_0_CS (Cs);
  return Status;
}
