...
#include"Redfish_MemoryDomain_v1_2_3_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishMemoryDomain_V1_2_3_MemoryDomain_CS *Cs, json_t *JsonObj, char *Key, RedfishMemoryDomain_V1_2_3_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemoryDomain_V1_2_3_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishMemoryDomain_V1_2_3_MemoryDomain_CS *Cs, json_t *JsonObj, char *Key, RedfishMemoryDomain_V1_2_3_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMemoryDomain_V1_2_3_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenMemorySet_Array_ElementCs(RedfishMemoryDomain_V1_2_3_MemoryDomain_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishMemoryDomain_V1_2_3_MemorySet_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishMemoryDomain_V1_2_3_MemorySet_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MemorySet
...
//
//Generate C structure for RedfishMemoryDomain_V1_2_3_MemorySet_Array_CS
//
static RedfishCS_status GenMemorySet_ArrayCs(RedfishMemoryDomain_V1_2_3_MemoryDomain_CS *Cs, json_t *JsonObj, char *Key, RedfishMemoryDomain_V1_2_3_MemorySet_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishMemoryDomain_V1_2_3_MemorySet_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishMemoryDomain_V1_2_3_MemorySet_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishMemoryDomain_V1_2_3_MemoryDomain_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishMemoryDomain_V1_2_3_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishMemoryDomain_V1_2_3_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_InterleavableMemorySets(json_t *CsJson, char *Key, RedfishMemoryDomain_V1_2_3_MemorySet_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishMemoryDomain_V1_2_3_MemorySet_Array_CS *NextArray;
  RedfishMemoryDomain_V1_2_3_MemorySet_CS *NextArrayItem;
...
//
// C structure to JSON for MemoryDomain.V1_2_3.MemoryDomain
//
RedfishCS_status CS_To_MemoryDomain_V1_2_3_JSON(RedfishMemoryDomain_V1_2_3_MemoryDomain_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for MemoryDomain.V1_2_3.MemoryDomain
//
RedfishCS_status DestroyMemoryDomain_V1_2_3_CS(RedfishMemoryDomain_V1_2_3_MemoryDomain_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MemoryDomain.V1_2_3.MemoryDomain
//
RedfishCS_status DestroyMemoryDomain_V1_2_3_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MemoryDomain.V1_2_3.MemoryDomain
//
RedfishCS_status
Json_MemoryDomain_V1_2_3_To_CS(RedfishCS_char *JsonRawText, RedfishMemoryDomain_V1_2_3_MemoryDomain_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMemoryDomain_V1_2_3_MemoryDomain_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MemoryDomain", "v1_2_3", "MemoryDomain", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMemoryDomain_V1_2_3_MemoryDomain_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyMemoryDomain_V1_2_3_CS (Cs);
  return Status;
}
