# Definition of MemoryDomain.V1_2_1 and functions<br><br>

## Actions
    typedef struct _RedfishMemoryDomain_V1_2_1_Actions_CS {
        RedfishMemoryDomain_V1_2_1_OemActions_CS *Oem;
    } RedfishMemoryDomain_V1_2_1_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishMemoryDomain_V1_2_1_OemActions_CS| Structure points to **Oem** property.| No| No
...
## MemoryDomain
    typedef struct _RedfishMemoryDomain_V1_2_1_MemoryDomain_CS {
        ...
        RedfishMemoryDomain_V1_2_1_Actions_CS *Actions;
        ...
        RedfishCS_char *Id;
        RedfishMemoryDomain_V1_2_1_MemorySet_CS *InterleavableMemorySets;
...
|**Actions**|RedfishMemoryDomain_V1_2_1_Actions_CS| Structure points to **Actions** property.| No| No
...
|**InterleavableMemorySets**|RedfishMemoryDomain_V1_2_1_MemorySet_CS| Structure points to **InterleavableMemorySets** property.| No| No
|**MemoryChunks**|RedfishCS_Link| Structure link list to **MemoryChunks** property.| No| Yes
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
## Redfish MemoryDomain V1_2_1 to C Structure Function
    RedfishCS_status
    Json_MemoryDomain_V1_2_1_To_CS (RedfishCS_char *JsonRawText, RedfishMemoryDomain_V1_2_1_MemoryDomain_CS **ReturnedCS);

## C Structure to Redfish MemoryDomain V1_2_1 JSON Function
    RedfishCS_status
    CS_To_MemoryDomain_V1_2_1_JSON (RedfishMemoryDomain_V1_2_1_MemoryDomain_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish MemoryDomain V1_2_1 C Structure Function
    RedfishCS_status
