...
#include"Redfish_DriveCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishDriveCollection_DriveCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for DriveCollection.DriveCollection
//
RedfishCS_status CS_To_DriveCollection_JSON(RedfishDriveCollection_DriveCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for DriveCollection.DriveCollection
//
RedfishCS_status DestroyDriveCollection_CS(RedfishDriveCollection_DriveCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for DriveCollection.DriveCollection
//
RedfishCS_status DestroyDriveCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for DriveCollection.NOVERSIONED.DriveCollection
//
RedfishCS_status
Json_DriveCollection_To_CS(RedfishCS_char *JsonRawText, RedfishDriveCollection_DriveCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishDriveCollection_DriveCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "DriveCollection", "noversioned", "DriveCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishDriveCollection_DriveCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
