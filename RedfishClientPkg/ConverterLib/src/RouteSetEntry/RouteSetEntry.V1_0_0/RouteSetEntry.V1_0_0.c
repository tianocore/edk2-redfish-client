...
#include"Redfish_RouteSetEntry_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishRouteSetEntry_V1_0_0_RouteSetEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishRouteSetEntry_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishRouteSetEntry_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishRouteSetEntry_V1_0_0_RouteSetEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishRouteSetEntry_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishRouteSetEntry_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishRouteSetEntry_V1_0_0_RouteSetEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishRouteSetEntry_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishRouteSetEntry_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for RouteSetEntry.V1_0_0.RouteSetEntry
//
RedfishCS_status CS_To_RouteSetEntry_V1_0_0_JSON(RedfishRouteSetEntry_V1_0_0_RouteSetEntry_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // EgressIdentifier 
  if (InsertJsonInt64Obj (CsJson, "EgressIdentifier", CSPtr->EgressIdentifier) != RedfishCS_status_success) {goto Error;}

  // HopCount 
  if (InsertJsonInt64Obj (CsJson, "HopCount", CSPtr->HopCount) != RedfishCS_status_success) {goto Error;}
  ...
  // VCAction 
  if (InsertJsonInt64Obj (CsJson, "VCAction", CSPtr->VCAction) != RedfishCS_status_success) {goto Error;}

  // Valid 
  if (InsertJsonBoolObj (CsJson, "Valid", CSPtr->Valid) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for RouteSetEntry.V1_0_0.RouteSetEntry
//
RedfishCS_status DestroyRouteSetEntry_V1_0_0_CS(RedfishRouteSetEntry_V1_0_0_RouteSetEntry_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for RouteSetEntry.V1_0_0.RouteSetEntry
//
RedfishCS_status DestroyRouteSetEntry_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for RouteSetEntry.V1_0_0.RouteSetEntry
//
RedfishCS_status
Json_RouteSetEntry_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishRouteSetEntry_V1_0_0_RouteSetEntry_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishRouteSetEntry_V1_0_0_RouteSetEntry_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "RouteSetEntry", "v1_0_0", "RouteSetEntry", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishRouteSetEntry_V1_0_0_RouteSetEntry_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // EgressIdentifier
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "EgressIdentifier", &Cs->EgressIdentifier);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // HopCount
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "HopCount", &Cs->HopCount);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // VCAction
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "VCAction", &Cs->VCAction);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Valid
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "Valid", &Cs->Valid);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyRouteSetEntry_V1_0_0_CS (Cs);
  return Status;
}
