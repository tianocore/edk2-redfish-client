...
#include"Redfish_RouteSetEntry_v1_0_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishRouteSetEntry_V1_0_1_RouteSetEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishRouteSetEntry_V1_0_1_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishRouteSetEntry_V1_0_1_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishRouteSetEntry_V1_0_1_RouteSetEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishRouteSetEntry_V1_0_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishRouteSetEntry_V1_0_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishRouteSetEntry_V1_0_1_RouteSetEntry_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishRouteSetEntry_V1_0_1_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishRouteSetEntry_V1_0_1_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for RouteSetEntry.V1_0_1.RouteSetEntry
//
RedfishCS_status CS_To_RouteSetEntry_V1_0_1_JSON(RedfishRouteSetEntry_V1_0_1_RouteSetEntry_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for RouteSetEntry.V1_0_1.RouteSetEntry
//
RedfishCS_status DestroyRouteSetEntry_V1_0_1_CS(RedfishRouteSetEntry_V1_0_1_RouteSetEntry_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for RouteSetEntry.V1_0_1.RouteSetEntry
//
RedfishCS_status DestroyRouteSetEntry_V1_0_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for RouteSetEntry.V1_0_1.RouteSetEntry
//
RedfishCS_status
Json_RouteSetEntry_V1_0_1_To_CS(RedfishCS_char *JsonRawText, RedfishRouteSetEntry_V1_0_1_RouteSetEntry_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishRouteSetEntry_V1_0_1_RouteSetEntry_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "RouteSetEntry", "v1_0_1", "RouteSetEntry", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishRouteSetEntry_V1_0_1_RouteSetEntry_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyRouteSetEntry_V1_0_1_CS (Cs);
  return Status;
}
