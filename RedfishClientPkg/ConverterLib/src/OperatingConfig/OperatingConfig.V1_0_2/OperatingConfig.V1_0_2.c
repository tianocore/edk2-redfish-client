...
#include"Redfish_OperatingConfig_v1_0_2_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishOperatingConfig_V1_0_2_OperatingConfig_CS *Cs, json_t *JsonObj, char *Key, RedfishOperatingConfig_V1_0_2_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishOperatingConfig_V1_0_2_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishOperatingConfig_V1_0_2_OperatingConfig_CS *Cs, json_t *JsonObj, char *Key, RedfishOperatingConfig_V1_0_2_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishOperatingConfig_V1_0_2_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for RedfishCS_int64_Array
//
static RedfishCS_status GenRedfishCS_int64_ArrayCs(RedfishOperatingConfig_V1_0_2_OperatingConfig_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_int64_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenBaseSpeedPrioritySettings_Array_ElementCs(RedfishOperatingConfig_V1_0_2_OperatingConfig_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishOperatingConfig_V1_0_2_BaseSpeedPrioritySettings_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishOperatingConfig_V1_0_2_BaseSpeedPrioritySettings_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // BaseSpeedMHz
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "BaseSpeedMHz", &(*Dst)->BaseSpeedMHz);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // CoreIDs
  Status = GenRedfishCS_int64_ArrayCs (Cs, TempJsonObj, "CoreIDs", &(*Dst)->CoreIDs);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishOperatingConfig_V1_0_2_BaseSpeedPrioritySettings_Array_CS
//
static RedfishCS_status GenBaseSpeedPrioritySettings_ArrayCs(RedfishOperatingConfig_V1_0_2_OperatingConfig_CS *Cs, json_t *JsonObj, char *Key, RedfishOperatingConfig_V1_0_2_BaseSpeedPrioritySettings_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishOperatingConfig_V1_0_2_BaseSpeedPrioritySettings_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishOperatingConfig_V1_0_2_BaseSpeedPrioritySettings_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
  ...
  ThisElement = *Dst;
  for (Index = 0; Index < ArraySize; Index ++) {
    Status = GenBaseSpeedPrioritySettings_Array_ElementCs(Cs, TempJsonObj, Index, &ThisElement->ArrayValue);
    if (Status != RedfishCS_status_success){
      goto Error;
    }
    ThisElement = ThisElement->Next;
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishOperatingConfig_V1_0_2_OperatingConfig_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status GenTurboProfileDatapoint_Array_ElementCs(RedfishOperatingConfig_V1_0_2_OperatingConfig_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishOperatingConfig_V1_0_2_TurboProfileDatapoint_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishOperatingConfig_V1_0_2_TurboProfileDatapoint_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ActiveCoreCount
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "ActiveCoreCount", &(*Dst)->ActiveCoreCount);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // MaxSpeedMHz
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "MaxSpeedMHz", &(*Dst)->MaxSpeedMHz);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishOperatingConfig_V1_0_2_TurboProfileDatapoint_Array_CS
//
static RedfishCS_status GenTurboProfileDatapoint_ArrayCs(RedfishOperatingConfig_V1_0_2_OperatingConfig_CS *Cs, json_t *JsonObj, char *Key, RedfishOperatingConfig_V1_0_2_TurboProfileDatapoint_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishOperatingConfig_V1_0_2_TurboProfileDatapoint_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishOperatingConfig_V1_0_2_TurboProfileDatapoint_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
  ...
  ThisElement = *Dst;
  for (Index = 0; Index < ArraySize; Index ++) {
    Status = GenTurboProfileDatapoint_Array_ElementCs(Cs, TempJsonObj, Index, &ThisElement->ArrayValue);
    if (Status != RedfishCS_status_success){
      goto Error;
    }
    ThisElement = ThisElement->Next;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishOperatingConfig_V1_0_2_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishOperatingConfig_V1_0_2_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_BaseSpeedPrioritySettings(json_t *CsJson, char *Key, RedfishOperatingConfig_V1_0_2_BaseSpeedPrioritySettings_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishOperatingConfig_V1_0_2_BaseSpeedPrioritySettings_Array_CS *NextArray;
  RedfishOperatingConfig_V1_0_2_BaseSpeedPrioritySettings_CS *NextArrayItem;
  ...
  do {
    ...
    // BaseSpeedMHz 
    if (InsertJsonInt64Obj (ArrayMember, "BaseSpeedMHz", NextArrayItem->BaseSpeedMHz) != RedfishCS_status_success) {goto Error;}

    // CoreCount 
    if (InsertJsonInt64Obj (ArrayMember, "CoreCount", NextArrayItem->CoreCount) != RedfishCS_status_success) {goto Error;}

    // CoreIDs 
    if (InsertJsonInt64ArrayObj (ArrayMember, "CoreIDs", NextArrayItem->CoreIDs) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_TurboProfile(json_t *CsJson, char *Key, RedfishOperatingConfig_V1_0_2_TurboProfileDatapoint_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishOperatingConfig_V1_0_2_TurboProfileDatapoint_Array_CS *NextArray;
  RedfishOperatingConfig_V1_0_2_TurboProfileDatapoint_CS *NextArrayItem;
  ...
  do {
    ...
    NextArrayItem = NextArray->ArrayValue;
    // ActiveCoreCount 
    if (InsertJsonInt64Obj (ArrayMember, "ActiveCoreCount", NextArrayItem->ActiveCoreCount) != RedfishCS_status_success) {goto Error;}

    // MaxSpeedMHz 
    if (InsertJsonInt64Obj (ArrayMember, "MaxSpeedMHz", NextArrayItem->MaxSpeedMHz) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for OperatingConfig.V1_0_2.OperatingConfig
//
RedfishCS_status CS_To_OperatingConfig_V1_0_2_JSON(RedfishOperatingConfig_V1_0_2_OperatingConfig_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  if (CS_To_JSON_BaseSpeedPrioritySettings(CsJson, "BaseSpeedPrioritySettings", CSPtr->BaseSpeedPrioritySettings) != RedfishCS_status_success) {goto Error;}
  ...
  if (InsertJsonInt64Obj (CsJson, "MaxJunctionTemperatureCelsius", CSPtr->MaxJunctionTemperatureCelsius) != RedfishCS_status_success) {goto Error;}
  ...
  if (InsertJsonInt64Obj (CsJson, "TotalAvailableCoreCount", CSPtr->TotalAvailableCoreCount) != RedfishCS_status_success) {goto Error;}

  // TurboProfile
  if (CS_To_JSON_TurboProfile(CsJson, "TurboProfile", CSPtr->TurboProfile) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for OperatingConfig.V1_0_2.OperatingConfig
//
RedfishCS_status DestroyOperatingConfig_V1_0_2_CS(RedfishOperatingConfig_V1_0_2_OperatingConfig_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for OperatingConfig.V1_0_2.OperatingConfig
//
RedfishCS_status DestroyOperatingConfig_V1_0_2_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for OperatingConfig.V1_0_2.OperatingConfig
//
RedfishCS_status
Json_OperatingConfig_V1_0_2_To_CS(RedfishCS_char *JsonRawText, RedfishOperatingConfig_V1_0_2_OperatingConfig_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishOperatingConfig_V1_0_2_OperatingConfig_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "OperatingConfig", "v1_0_2", "OperatingConfig", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishOperatingConfig_V1_0_2_OperatingConfig_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // BaseSpeedPrioritySettings
  Status = GenBaseSpeedPrioritySettings_ArrayCs (Cs, JsonObj, "BaseSpeedPrioritySettings", &Cs->BaseSpeedPrioritySettings);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // MaxJunctionTemperatureCelsius
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "MaxJunctionTemperatureCelsius", &Cs->MaxJunctionTemperatureCelsius);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // TotalAvailableCoreCount
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "TotalAvailableCoreCount", &Cs->TotalAvailableCoreCount);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // TurboProfile
  Status = GenTurboProfileDatapoint_ArrayCs (Cs, JsonObj, "TurboProfile", &Cs->TurboProfile);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyOperatingConfig_V1_0_2_CS (Cs);
  return Status;
}
