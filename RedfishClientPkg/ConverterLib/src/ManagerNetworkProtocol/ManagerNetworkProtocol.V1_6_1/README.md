# Definition of ManagerNetworkProtocol.V1_6_1 and functions<br><br>

## Actions
    typedef struct _RedfishManagerNetworkProtocol_V1_6_1_Actions_CS {
        RedfishManagerNetworkProtocol_V1_6_1_OemActions_CS *Oem;
    } RedfishManagerNetworkProtocol_V1_6_1_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishManagerNetworkProtocol_V1_6_1_OemActions_CS| Structure points to **Oem** property.| No| No
...
## SNMPProtocol
    typedef struct _RedfishManagerNetworkProtocol_V1_6_1_SNMPProtocol_CS {
        ...
        RedfishManagerNetworkProtocol_V1_6_1_SNMPCommunity_Array_CS *CommunityStrings;
        RedfishCS_bool *EnableSNMPv1;
        RedfishCS_bool *EnableSNMPv2c;
        RedfishCS_bool *EnableSNMPv3;
        RedfishCS_char *EncryptionProtocol;
        RedfishManagerNetworkProtocol_V1_6_1_EngineId_CS *EngineId;
...
|**CommunityStrings**|RedfishManagerNetworkProtocol_V1_6_1_SNMPCommunity_Array_CS| Structure array points to one or more than one **RedfishManagerNetworkProtocol_V1_6_1_SNMPCommunity_Array_CS** structures for property **CommunityStrings**.| No| No
...
|**EngineId**|RedfishManagerNetworkProtocol_V1_6_1_EngineId_CS| Structure points to **EngineId** property.| No| No
...
## ManagerNetworkProtocol
    typedef struct _RedfishManagerNetworkProtocol_V1_6_1_ManagerNetworkProtocol_CS {
        ...
        RedfishManagerNetworkProtocol_V1_6_1_Actions_CS *Actions;
        RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS *DHCP;
        RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS *DHCPv6;
        RedfishCS_char *Description;
        RedfishCS_char *FQDN;
        RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS *HTTP;
        RedfishManagerNetworkProtocol_V1_6_1_HTTPSProtocol_CS *HTTPS;
        RedfishCS_char *HostName;
        RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS *IPMI;
        RedfishCS_char *Id;
        RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS *KVMIP;
        RedfishManagerNetworkProtocol_V1_6_1_NTPProtocol_CS *NTP;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS *RDP;
        RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS *RFB;
        RedfishManagerNetworkProtocol_V1_6_1_SNMPProtocol_CS *SNMP;
        RedfishManagerNetworkProtocol_V1_6_1_SSDProtocol_CS *SSDP;
        RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS *SSH;
        RedfishResource_Status_CS *Status;
        RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS *Telnet;
        RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS *VirtualMedia;
...
|**Actions**|RedfishManagerNetworkProtocol_V1_6_1_Actions_CS| Structure points to **Actions** property.| No| No
|**DHCP**|RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS| Structure points to **DHCP** property.| No| No
|**DHCPv6**|RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS| Structure points to **DHCPv6** property.| No| No
|**Description**|RedfishCS_char| String pointer to **Description** property.| No| Yes
|**FQDN**|RedfishCS_char| String pointer to **FQDN** property.| No| Yes
|**HTTP**|RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS| Structure points to **HTTP** property.| No| No
|**HTTPS**|RedfishManagerNetworkProtocol_V1_6_1_HTTPSProtocol_CS| Structure points to **HTTPS** property.| No| No
|**HostName**|RedfishCS_char| String pointer to **HostName** property.| No| Yes
|**IPMI**|RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS| Structure points to **IPMI** property.| No| No
|**Id**|RedfishCS_char| String pointer to **Id** property.| Yes| Yes
|**KVMIP**|RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS| Structure points to **KVMIP** property.| No| No
|**NTP**|RedfishManagerNetworkProtocol_V1_6_1_NTPProtocol_CS| Structure points to **NTP** property.| No| No
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**RDP**|RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS| Structure points to **RDP** property.| No| No
|**RFB**|RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS| Structure points to **RFB** property.| No| No
|**SNMP**|RedfishManagerNetworkProtocol_V1_6_1_SNMPProtocol_CS| Structure points to **SNMP** property.| No| No
|**SSDP**|RedfishManagerNetworkProtocol_V1_6_1_SSDProtocol_CS| Structure points to **SSDP** property.| No| No
|**SSH**|RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS| Structure points to **SSH** property.| No| No
|**Status**|RedfishResource_Status_CS| Structure points to **Status** property.| No| No
|**Telnet**|RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS| Structure points to **Telnet** property.| No| No
|**VirtualMedia**|RedfishManagerNetworkProtocol_V1_6_1_Protocol_CS| Structure points to **VirtualMedia** property.| No| No
## Redfish ManagerNetworkProtocol V1_6_1 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish ManagerNetworkProtocol V1_6_1 JSON Function
    RedfishCS_status
    CS_To_ManagerNetworkProtocol_V1_6_1_JSON (RedfishManagerNetworkProtocol_V1_6_1_ManagerNetworkProtocol_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ManagerNetworkProtocol V1_6_1 C Structure Function
    RedfishCS_status
