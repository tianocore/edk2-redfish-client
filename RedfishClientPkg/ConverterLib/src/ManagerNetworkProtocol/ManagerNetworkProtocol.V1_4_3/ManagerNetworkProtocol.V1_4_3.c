...
#include"Redfish_ManagerNetworkProtocol_v1_4_3_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenProtocolCs(RedfishManagerNetworkProtocol_V1_4_3_ManagerNetworkProtocol_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerNetworkProtocol_V1_4_3_Protocol_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishManagerNetworkProtocol_V1_4_3_ManagerNetworkProtocol_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenOemCs(RedfishManagerNetworkProtocol_V1_4_3_ManagerNetworkProtocol_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishManagerNetworkProtocol_V1_4_3_ManagerNetworkProtocol_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerNetworkProtocol_V1_4_3_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerNetworkProtocol_V1_4_3_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishManagerNetworkProtocol_V1_4_3_ManagerNetworkProtocol_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerNetworkProtocol_V1_4_3_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerNetworkProtocol_V1_4_3_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenProtocolCs(RedfishManagerNetworkProtocol_V1_4_3_ManagerNetworkProtocol_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerNetworkProtocol_V1_4_3_Protocol_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerNetworkProtocol_V1_4_3_Protocol_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Port
...
//
static RedfishCS_status GenHTTPSProtocolCs(RedfishManagerNetworkProtocol_V1_4_3_ManagerNetworkProtocol_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerNetworkProtocol_V1_4_3_HTTPSProtocol_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerNetworkProtocol_V1_4_3_HTTPSProtocol_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Certificates
...
//
static RedfishCS_status GenNTPProtocolCs(RedfishManagerNetworkProtocol_V1_4_3_ManagerNetworkProtocol_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerNetworkProtocol_V1_4_3_NTPProtocol_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerNetworkProtocol_V1_4_3_NTPProtocol_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // NTPServers
...
//
static RedfishCS_status GenSNMPProtocolCs(RedfishManagerNetworkProtocol_V1_4_3_ManagerNetworkProtocol_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerNetworkProtocol_V1_4_3_SNMPProtocol_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerNetworkProtocol_V1_4_3_SNMPProtocol_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Port
...
//
static RedfishCS_status GenSSDProtocolCs(RedfishManagerNetworkProtocol_V1_4_3_ManagerNetworkProtocol_CS *Cs, json_t *JsonObj, char *Key, RedfishManagerNetworkProtocol_V1_4_3_SSDProtocol_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishManagerNetworkProtocol_V1_4_3_SSDProtocol_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // NotifyIPv6Scope
...
//
static RedfishCS_status GenidRefCs(RedfishManagerNetworkProtocol_V1_4_3_ManagerNetworkProtocol_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishManagerNetworkProtocol_V1_4_3_ManagerNetworkProtocol_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishManagerNetworkProtocol_V1_4_3_ManagerNetworkProtocol_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishManagerNetworkProtocol_V1_4_3_ManagerNetworkProtocol_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_4_3_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_4_3_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_DHCP(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_4_3_Protocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_DHCPv6(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_4_3_Protocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_HTTP(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_4_3_Protocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_HTTPS(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_4_3_HTTPSProtocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_IPMI(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_4_3_Protocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_KVMIP(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_4_3_Protocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_NTP(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_4_3_NTPProtocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_RDP(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_4_3_Protocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_RFB(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_4_3_Protocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_SNMP(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_4_3_SNMPProtocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_SSDP(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_4_3_SSDProtocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_SSH(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_4_3_Protocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Telnet(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_4_3_Protocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_VirtualMedia(json_t *CsJson, char *Key, RedfishManagerNetworkProtocol_V1_4_3_Protocol_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for ManagerNetworkProtocol.V1_4_3.ManagerNetworkProtocol
//
RedfishCS_status CS_To_ManagerNetworkProtocol_V1_4_3_JSON(RedfishManagerNetworkProtocol_V1_4_3_ManagerNetworkProtocol_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ManagerNetworkProtocol.V1_4_3.ManagerNetworkProtocol
//
RedfishCS_status DestroyManagerNetworkProtocol_V1_4_3_CS(RedfishManagerNetworkProtocol_V1_4_3_ManagerNetworkProtocol_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ManagerNetworkProtocol.V1_4_3.ManagerNetworkProtocol
//
RedfishCS_status DestroyManagerNetworkProtocol_V1_4_3_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ManagerNetworkProtocol.V1_4_3.ManagerNetworkProtocol
//
RedfishCS_status
Json_ManagerNetworkProtocol_V1_4_3_To_CS(RedfishCS_char *JsonRawText, RedfishManagerNetworkProtocol_V1_4_3_ManagerNetworkProtocol_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishManagerNetworkProtocol_V1_4_3_ManagerNetworkProtocol_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ManagerNetworkProtocol", "v1_4_3", "ManagerNetworkProtocol", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishManagerNetworkProtocol_V1_4_3_ManagerNetworkProtocol_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyManagerNetworkProtocol_V1_4_3_CS (Cs);
  return Status;
}
