...
#include"Redfish_MessageRegistry_v1_1_6_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishMessageRegistry_V1_1_6_MessageRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishMessageRegistry_V1_1_6_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMessageRegistry_V1_1_6_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishMessageRegistry_V1_1_6_MessageRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishMessageRegistry_V1_1_6_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMessageRegistry_V1_1_6_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenMessagePropertyCs(RedfishMessageRegistry_V1_1_6_MessageRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishMessageRegistry_V1_1_6_MessageProperty_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMessageRegistry_V1_1_6_MessageProperty_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  InitializeLinkHead (&(*Dst)->Prop);
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishMessageRegistry_V1_1_6_MessageRegistry_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishMessageRegistry_V1_1_6_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishMessageRegistry_V1_1_6_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Messages(json_t *CsJson, char *Key, RedfishMessageRegistry_V1_1_6_MessageProperty_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for MessageRegistry.V1_1_6.MessageRegistry
//
RedfishCS_status CS_To_MessageRegistry_V1_1_6_JSON(RedfishMessageRegistry_V1_1_6_MessageRegistry_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for MessageRegistry.V1_1_6.MessageRegistry
//
RedfishCS_status DestroyMessageRegistry_V1_1_6_CS(RedfishMessageRegistry_V1_1_6_MessageRegistry_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MessageRegistry.V1_1_6.MessageRegistry
//
RedfishCS_status DestroyMessageRegistry_V1_1_6_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MessageRegistry.V1_1_6.MessageRegistry
//
RedfishCS_status
Json_MessageRegistry_V1_1_6_To_CS(RedfishCS_char *JsonRawText, RedfishMessageRegistry_V1_1_6_MessageRegistry_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMessageRegistry_V1_1_6_MessageRegistry_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MessageRegistry", "v1_1_6", "MessageRegistry", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMessageRegistry_V1_1_6_MessageRegistry_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyMessageRegistry_V1_1_6_CS (Cs);
  return Status;
}
