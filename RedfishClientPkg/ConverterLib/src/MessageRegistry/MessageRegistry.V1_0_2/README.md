# Definition of MessageRegistry.V1_0_2 and functions<br><br>
...
## MessageRegistry
    typedef struct _RedfishMessageRegistry_V1_0_2_MessageRegistry_CS {
        ...
        RedfishMessageRegistry_V1_0_2_MessageProperty_CS *Messages;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
...
|**Messages**|RedfishMessageRegistry_V1_0_2_MessageProperty_CS| Structure points to **Messages** property.| Yes| Yes
...
## Redfish MessageRegistry V1_0_2 to C Structure Function
    RedfishCS_status
    Json_MessageRegistry_V1_0_2_To_CS (RedfishCS_char *JsonRawText, RedfishMessageRegistry_V1_0_2_MessageRegistry_CS **ReturnedCS);

## C Structure to Redfish MessageRegistry V1_0_2 JSON Function
    RedfishCS_status
    CS_To_MessageRegistry_V1_0_2_JSON (RedfishMessageRegistry_V1_0_2_MessageRegistry_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish MessageRegistry V1_0_2 C Structure Function
    RedfishCS_status
