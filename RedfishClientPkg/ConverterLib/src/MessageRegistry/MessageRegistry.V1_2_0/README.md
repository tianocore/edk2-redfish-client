# Definition of MessageRegistry.V1_2_0 and functions<br><br>

## Actions
    typedef struct _RedfishMessageRegistry_V1_2_0_Actions_CS {
        RedfishMessageRegistry_V1_2_0_OemActions_CS *Oem;
    } RedfishMessageRegistry_V1_2_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishMessageRegistry_V1_2_0_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Message
    typedef struct _RedfishMessageRegistry_V1_2_0_Message_CS {
        RedfishMessageRegistry_V1_2_0_ClearingLogic_CS *ClearingLogic;
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**ClearingLogic**|RedfishMessageRegistry_V1_2_0_ClearingLogic_CS| Structure points to **ClearingLogic** property.| No| No
...
## MessageRegistry
    typedef struct _RedfishMessageRegistry_V1_2_0_MessageRegistry_CS {
        ...
        RedfishMessageRegistry_V1_2_0_Actions_CS *Actions;
        RedfishCS_char *Description;
        RedfishCS_char *Id;
        RedfishCS_char *Language;
        RedfishMessageRegistry_V1_2_0_MessageProperty_CS *Messages;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
...
|**Actions**|RedfishMessageRegistry_V1_2_0_Actions_CS| Structure points to **Actions** property.| No| No
|**Description**|RedfishCS_char| String pointer to **Description** property.| No| Yes
|**Id**|RedfishCS_char| String pointer to **Id** property.| Yes| Yes
|**Language**|RedfishCS_char| String pointer to **Language** property.| Yes| Yes
|**Messages**|RedfishMessageRegistry_V1_2_0_MessageProperty_CS| Structure points to **Messages** property.| Yes| No
...
## Redfish MessageRegistry V1_2_0 to C Structure Function
    RedfishCS_status
    Json_MessageRegistry_V1_2_0_To_CS (RedfishCS_char *JsonRawText, RedfishMessageRegistry_V1_2_0_MessageRegistry_CS **ReturnedCS);

## C Structure to Redfish MessageRegistry V1_2_0 JSON Function
    RedfishCS_status
    CS_To_MessageRegistry_V1_2_0_JSON (RedfishMessageRegistry_V1_2_0_MessageRegistry_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish MessageRegistry V1_2_0 C Structure Function
    RedfishCS_status
