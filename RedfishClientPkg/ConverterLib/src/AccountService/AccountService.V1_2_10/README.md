# Definition of AccountService.V1_2_10 and functions<br><br>

## Actions
    typedef struct _RedfishAccountService_V1_2_10_Actions_CS {
        RedfishAccountService_V1_2_10_OemActions_CS *Oem;
    } RedfishAccountService_V1_2_10_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishAccountService_V1_2_10_OemActions_CS| Structure points to **Oem** property.| No| No
...
## AccountService
    typedef struct _RedfishAccountService_V1_2_10_AccountService_CS {
        ...
        RedfishAccountService_V1_2_10_Actions_CS *Actions;
...
|**Actions**|RedfishAccountService_V1_2_10_Actions_CS| Structure points to **Actions** property.| No| No
...
## Redfish AccountService V1_2_10 to C Structure Function
    RedfishCS_status
    Json_AccountService_V1_2_10_To_CS (RedfishCS_char *JsonRawText, RedfishAccountService_V1_2_10_AccountService_CS **ReturnedCS);

## C Structure to Redfish AccountService V1_2_10 JSON Function
    RedfishCS_status
    CS_To_AccountService_V1_2_10_JSON (RedfishAccountService_V1_2_10_AccountService_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish AccountService V1_2_10 C Structure Function
    RedfishCS_status
