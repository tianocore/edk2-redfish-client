...
#include"Redfish_AccountService_v1_3_4_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishAccountService_V1_3_4_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishAccountService_V1_3_4_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenExternalAccountProviderCs(RedfishAccountService_V1_3_4_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishAccountService_V1_3_4_ExternalAccountProvider_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishAccountService_V1_3_4_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishAccountService_V1_3_4_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAccountService_V1_3_4_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishAccountService_V1_3_4_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishAccountService_V1_3_4_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAccountService_V1_3_4_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenAuthenticationCs(RedfishAccountService_V1_3_4_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishAccountService_V1_3_4_Authentication_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAccountService_V1_3_4_Authentication_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AuthenticationType
...
//
static RedfishCS_status GenLDAPSearchSettingsCs(RedfishAccountService_V1_3_4_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishAccountService_V1_3_4_LDAPSearchSettings_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAccountService_V1_3_4_LDAPSearchSettings_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenLDAPServiceCs(RedfishAccountService_V1_3_4_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishAccountService_V1_3_4_LDAPService_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAccountService_V1_3_4_LDAPService_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenRoleMapping_Array_ElementCs(RedfishAccountService_V1_3_4_AccountService_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishAccountService_V1_3_4_RoleMapping_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishAccountService_V1_3_4_RoleMapping_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // LocalRole
...
//
//Generate C structure for RedfishAccountService_V1_3_4_RoleMapping_Array_CS
//
static RedfishCS_status GenRoleMapping_ArrayCs(RedfishAccountService_V1_3_4_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishAccountService_V1_3_4_RoleMapping_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishAccountService_V1_3_4_RoleMapping_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishAccountService_V1_3_4_RoleMapping_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenExternalAccountProviderCs(RedfishAccountService_V1_3_4_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishAccountService_V1_3_4_ExternalAccountProvider_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishAccountService_V1_3_4_ExternalAccountProvider_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AccountProviderType
...
//
static RedfishCS_status GenidRefCs(RedfishAccountService_V1_3_4_AccountService_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishAccountService_V1_3_4_AccountService_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishAccountService_V1_3_4_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishAccountService_V1_3_4_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishAccountService_V1_3_4_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishAccountService_V1_3_4_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActiveDirectoryAuthentication(json_t *CsJson, char *Key, RedfishAccountService_V1_3_4_Authentication_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActiveDirectoryLDAPServiceSearchSettings(json_t *CsJson, char *Key, RedfishAccountService_V1_3_4_LDAPSearchSettings_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActiveDirectoryLDAPService(json_t *CsJson, char *Key, RedfishAccountService_V1_3_4_LDAPService_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActiveDirectoryRemoteRoleMapping(json_t *CsJson, char *Key, RedfishAccountService_V1_3_4_RoleMapping_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishAccountService_V1_3_4_RoleMapping_Array_CS *NextArray;
  RedfishAccountService_V1_3_4_RoleMapping_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_ActiveDirectory(json_t *CsJson, char *Key, RedfishAccountService_V1_3_4_ExternalAccountProvider_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_LDAPAuthentication(json_t *CsJson, char *Key, RedfishAccountService_V1_3_4_Authentication_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_LDAPLDAPServiceSearchSettings(json_t *CsJson, char *Key, RedfishAccountService_V1_3_4_LDAPSearchSettings_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_LDAPLDAPService(json_t *CsJson, char *Key, RedfishAccountService_V1_3_4_LDAPService_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_LDAPRemoteRoleMapping(json_t *CsJson, char *Key, RedfishAccountService_V1_3_4_RoleMapping_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishAccountService_V1_3_4_RoleMapping_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_LDAP(json_t *CsJson, char *Key, RedfishAccountService_V1_3_4_ExternalAccountProvider_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for AccountService.V1_3_4.AccountService
//
RedfishCS_status CS_To_AccountService_V1_3_4_JSON(RedfishAccountService_V1_3_4_AccountService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for AccountService.V1_3_4.AccountService
//
RedfishCS_status DestroyAccountService_V1_3_4_CS(RedfishAccountService_V1_3_4_AccountService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for AccountService.V1_3_4.AccountService
//
RedfishCS_status DestroyAccountService_V1_3_4_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for AccountService.V1_3_4.AccountService
//
RedfishCS_status
Json_AccountService_V1_3_4_To_CS(RedfishCS_char *JsonRawText, RedfishAccountService_V1_3_4_AccountService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAccountService_V1_3_4_AccountService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "AccountService", "v1_3_4", "AccountService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAccountService_V1_3_4_AccountService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyAccountService_V1_3_4_CS (Cs);
  return Status;
}
