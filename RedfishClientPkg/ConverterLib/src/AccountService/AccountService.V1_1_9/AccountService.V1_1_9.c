...
#include"Redfish_AccountService_v1_1_9_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishAccountService_V1_1_9_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishAccountService_V1_1_9_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishAccountService_V1_1_9_AccountService_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishAccountService_V1_1_9_AccountService_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishAccountService_V1_1_9_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishAccountService_V1_1_9_AccountService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
// C structure to JSON for AccountService.V1_1_9.AccountService
//
RedfishCS_status CS_To_AccountService_V1_1_9_JSON(RedfishAccountService_V1_1_9_AccountService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for AccountService.V1_1_9.AccountService
//
RedfishCS_status DestroyAccountService_V1_1_9_CS(RedfishAccountService_V1_1_9_AccountService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for AccountService.V1_1_9.AccountService
//
RedfishCS_status DestroyAccountService_V1_1_9_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for AccountService.V1_1_9.AccountService
//
RedfishCS_status
Json_AccountService_V1_1_9_To_CS(RedfishCS_char *JsonRawText, RedfishAccountService_V1_1_9_AccountService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishAccountService_V1_1_9_AccountService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "AccountService", "v1_1_9", "AccountService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishAccountService_V1_1_9_AccountService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyAccountService_V1_1_9_CS (Cs);
  return Status;
}
