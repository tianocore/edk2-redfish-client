# Definition of AccountService.V1_5_4 and functions<br><br>

## Actions
    typedef struct _RedfishAccountService_V1_5_4_Actions_CS {
        RedfishAccountService_V1_5_4_OemActions_CS *Oem;
    } RedfishAccountService_V1_5_4_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishAccountService_V1_5_4_OemActions_CS| Structure points to **Oem** property.| No| No
...
## ExternalAccountProvider
    typedef struct _RedfishAccountService_V1_5_4_ExternalAccountProvider_CS {
        ...
        RedfishAccountService_V1_5_4_Authentication_CS *Authentication;
        RedfishCS_Link Certificates;
        RedfishAccountService_V1_5_4_LDAPService_CS *LDAPService;
        RedfishAccountService_V1_5_4_RoleMapping_Array_CS *RemoteRoleMapping;
...
|**Authentication**|RedfishAccountService_V1_5_4_Authentication_CS| Structure points to **Authentication** property.| No| No
|**Certificates**|RedfishCS_Link| Structure link list to **Certificates** property.| No| Yes
|**LDAPService**|RedfishAccountService_V1_5_4_LDAPService_CS| Structure points to **LDAPService** property.| No| No
|**RemoteRoleMapping**|RedfishAccountService_V1_5_4_RoleMapping_Array_CS| Structure array points to one or more than one **RedfishAccountService_V1_5_4_RoleMapping_Array_CS** structures for property **RemoteRoleMapping**.| No| No
