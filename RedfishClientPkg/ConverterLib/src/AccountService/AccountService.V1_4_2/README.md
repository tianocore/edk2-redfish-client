# Definition of AccountService.V1_4_2 and functions<br><br>

## Actions
    typedef struct _RedfishAccountService_V1_4_2_Actions_CS {
        RedfishAccountService_V1_4_2_OemActions_CS *Oem;
    } RedfishAccountService_V1_4_2_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishAccountService_V1_4_2_OemActions_CS| Structure points to **Oem** property.| No| No
...
## ExternalAccountProvider
    typedef struct _RedfishAccountService_V1_4_2_ExternalAccountProvider_CS {
        ...
        RedfishAccountService_V1_4_2_Authentication_CS *Authentication;
        RedfishCS_Link Certificates;
        RedfishAccountService_V1_4_2_LDAPService_CS *LDAPService;
        RedfishAccountService_V1_4_2_RoleMapping_Array_CS *RemoteRoleMapping;
...
|**Authentication**|RedfishAccountService_V1_4_2_Authentication_CS| Structure points to **Authentication** property.| No| No
|**Certificates**|RedfishCS_Link| Structure link list to **Certificates** property.| No| Yes
|**LDAPService**|RedfishAccountService_V1_4_2_LDAPService_CS| Structure points to **LDAPService** property.| No| No
|**RemoteRoleMapping**|RedfishAccountService_V1_4_2_RoleMapping_Array_CS| Structure array points to one or more than one **RedfishAccountService_V1_4_2_RoleMapping_Array_CS** structures for property **RemoteRoleMapping**.| No| No
...
## LDAPService
    typedef struct _RedfishAccountService_V1_4_2_LDAPService_CS {
        RedfishResource_Oem_CS *Oem;
        RedfishAccountService_V1_4_2_LDAPSearchSettings_CS *SearchSettings;
    } RedfishAccountService_V1_4_2_LDAPService_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**SearchSettings**|RedfishAccountService_V1_4_2_LDAPSearchSettings_CS| Structure points to **SearchSettings** property.| No| No
...
## AccountService
    typedef struct _RedfishAccountService_V1_4_2_AccountService_CS {
        ...
        RedfishAccountService_V1_4_2_Actions_CS *Actions;
        RedfishAccountService_V1_4_2_ExternalAccountProvider_CS *ActiveDirectory;
        RedfishCS_Link AdditionalExternalAccountProviders;
        RedfishCS_int64 *AuthFailureLoggingThreshold;
        RedfishCS_char *Description;
        RedfishCS_char *Id;
        RedfishAccountService_V1_4_2_ExternalAccountProvider_CS *LDAP;
...
|**Actions**|RedfishAccountService_V1_4_2_Actions_CS| Structure points to **Actions** property.| No| No
|**ActiveDirectory**|RedfishAccountService_V1_4_2_ExternalAccountProvider_CS| Structure points to **ActiveDirectory** property.| No| No
...
|**LDAP**|RedfishAccountService_V1_4_2_ExternalAccountProvider_CS| Structure points to **LDAP** property.| No| No
...
## Redfish AccountService V1_4_2 to C Structure Function
    RedfishCS_status
    Json_AccountService_V1_4_2_To_CS (RedfishCS_char *JsonRawText, RedfishAccountService_V1_4_2_AccountService_CS **ReturnedCS);

## C Structure to Redfish AccountService V1_4_2 JSON Function
    RedfishCS_status
    CS_To_AccountService_V1_4_2_JSON (RedfishAccountService_V1_4_2_AccountService_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish AccountService V1_4_2 C Structure Function
    RedfishCS_status
