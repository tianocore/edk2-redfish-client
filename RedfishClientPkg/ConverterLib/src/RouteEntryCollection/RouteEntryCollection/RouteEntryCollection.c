...
#include"Redfish_RouteEntryCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishRouteEntryCollection_RouteEntryCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for RouteEntryCollection.RouteEntryCollection
//
RedfishCS_status CS_To_RouteEntryCollection_JSON(RedfishRouteEntryCollection_RouteEntryCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for RouteEntryCollection.RouteEntryCollection
//
RedfishCS_status DestroyRouteEntryCollection_CS(RedfishRouteEntryCollection_RouteEntryCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for RouteEntryCollection.RouteEntryCollection
//
RedfishCS_status DestroyRouteEntryCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for RouteEntryCollection.NOVERSIONED.RouteEntryCollection
//
RedfishCS_status
Json_RouteEntryCollection_To_CS(RedfishCS_char *JsonRawText, RedfishRouteEntryCollection_RouteEntryCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishRouteEntryCollection_RouteEntryCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "RouteEntryCollection", "noversioned", "RouteEntryCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishRouteEntryCollection_RouteEntryCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyRouteEntryCollection_CS (Cs);
  return Status;
}
