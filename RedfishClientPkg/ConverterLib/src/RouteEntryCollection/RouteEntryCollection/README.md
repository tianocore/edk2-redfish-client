# Definition of RouteEntryCollection and functions<br><br>
...
## Redfish RouteEntryCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish RouteEntryCollection  JSON Function
    RedfishCS_status
    CS_To_RouteEntryCollection_JSON (RedfishRouteEntryCollection_RouteEntryCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish RouteEntryCollection  C Structure Function
    RedfishCS_status
