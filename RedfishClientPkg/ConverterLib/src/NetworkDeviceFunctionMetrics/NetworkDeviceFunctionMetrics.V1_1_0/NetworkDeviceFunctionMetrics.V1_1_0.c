...
#include"Redfish_NetworkDeviceFunctionMetrics_v1_1_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishNetworkDeviceFunctionMetrics_V1_1_0_NetworkDeviceFunctionMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunctionMetrics_V1_1_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkDeviceFunctionMetrics_V1_1_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishNetworkDeviceFunctionMetrics_V1_1_0_NetworkDeviceFunctionMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunctionMetrics_V1_1_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkDeviceFunctionMetrics_V1_1_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenEthernetCs(RedfishNetworkDeviceFunctionMetrics_V1_1_0_NetworkDeviceFunctionMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunctionMetrics_V1_1_0_Ethernet_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkDeviceFunctionMetrics_V1_1_0_Ethernet_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenFibreChannelCs(RedfishNetworkDeviceFunctionMetrics_V1_1_0_NetworkDeviceFunctionMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkDeviceFunctionMetrics_V1_1_0_FibreChannel_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkDeviceFunctionMetrics_V1_1_0_FibreChannel_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // PortLoginAccepts
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "PortLoginAccepts", &(*Dst)->PortLoginAccepts);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // PortLoginRejects
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "PortLoginRejects", &(*Dst)->PortLoginRejects);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // PortLoginRequests
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "PortLoginRequests", &(*Dst)->PortLoginRequests);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // RXCongestionFPINs
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "RXCongestionFPINs", &(*Dst)->RXCongestionFPINs);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // RXDeliveryFPINs
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "RXDeliveryFPINs", &(*Dst)->RXDeliveryFPINs);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "RXLinkIntegrityFPINs", &(*Dst)->RXLinkIntegrityFPINs);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // RXPeerCongestionFPINs
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "RXPeerCongestionFPINs", &(*Dst)->RXPeerCongestionFPINs);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // TXCongestionFPINs
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "TXCongestionFPINs", &(*Dst)->TXCongestionFPINs);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // TXDeliveryFPINs
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "TXDeliveryFPINs", &(*Dst)->TXDeliveryFPINs);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "TXLinkIntegrityFPINs", &(*Dst)->TXLinkIntegrityFPINs);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // TXPeerCongestionFPINs
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "TXPeerCongestionFPINs", &(*Dst)->TXPeerCongestionFPINs);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishNetworkDeviceFunctionMetrics_V1_1_0_NetworkDeviceFunctionMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishNetworkDeviceFunctionMetrics_V1_1_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishNetworkDeviceFunctionMetrics_V1_1_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Ethernet(json_t *CsJson, char *Key, RedfishNetworkDeviceFunctionMetrics_V1_1_0_Ethernet_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_FibreChannel(json_t *CsJson, char *Key, RedfishNetworkDeviceFunctionMetrics_V1_1_0_FibreChannel_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // PortLoginAccepts 
  if (InsertJsonInt64Obj (CsJson, "PortLoginAccepts", CSPtr->PortLoginAccepts) != RedfishCS_status_success) {goto Error;}

  // PortLoginRejects 
  if (InsertJsonInt64Obj (CsJson, "PortLoginRejects", CSPtr->PortLoginRejects) != RedfishCS_status_success) {goto Error;}

  // PortLoginRequests 
  if (InsertJsonInt64Obj (CsJson, "PortLoginRequests", CSPtr->PortLoginRequests) != RedfishCS_status_success) {goto Error;}

  // RXCongestionFPINs 
  if (InsertJsonInt64Obj (CsJson, "RXCongestionFPINs", CSPtr->RXCongestionFPINs) != RedfishCS_status_success) {goto Error;}

  // RXDeliveryFPINs 
  if (InsertJsonInt64Obj (CsJson, "RXDeliveryFPINs", CSPtr->RXDeliveryFPINs) != RedfishCS_status_success) {goto Error;}

  // RXExchanges 
  if (InsertJsonInt64Obj (CsJson, "RXExchanges", CSPtr->RXExchanges) != RedfishCS_status_success) {goto Error;}

  // RXLinkIntegrityFPINs 
  if (InsertJsonInt64Obj (CsJson, "RXLinkIntegrityFPINs", CSPtr->RXLinkIntegrityFPINs) != RedfishCS_status_success) {goto Error;}

  // RXPeerCongestionFPINs 
  if (InsertJsonInt64Obj (CsJson, "RXPeerCongestionFPINs", CSPtr->RXPeerCongestionFPINs) != RedfishCS_status_success) {goto Error;}

  // RXSequences 
  if (InsertJsonInt64Obj (CsJson, "RXSequences", CSPtr->RXSequences) != RedfishCS_status_success) {goto Error;}

  // TXCongestionFPINs 
  if (InsertJsonInt64Obj (CsJson, "TXCongestionFPINs", CSPtr->TXCongestionFPINs) != RedfishCS_status_success) {goto Error;}

  // TXDeliveryFPINs 
  if (InsertJsonInt64Obj (CsJson, "TXDeliveryFPINs", CSPtr->TXDeliveryFPINs) != RedfishCS_status_success) {goto Error;}

  // TXExchanges 
  if (InsertJsonInt64Obj (CsJson, "TXExchanges", CSPtr->TXExchanges) != RedfishCS_status_success) {goto Error;}

  // TXLinkIntegrityFPINs 
  if (InsertJsonInt64Obj (CsJson, "TXLinkIntegrityFPINs", CSPtr->TXLinkIntegrityFPINs) != RedfishCS_status_success) {goto Error;}

  // TXPeerCongestionFPINs 
  if (InsertJsonInt64Obj (CsJson, "TXPeerCongestionFPINs", CSPtr->TXPeerCongestionFPINs) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for NetworkDeviceFunctionMetrics.V1_1_0.NetworkDeviceFunctionMetrics
//
RedfishCS_status CS_To_NetworkDeviceFunctionMetrics_V1_1_0_JSON(RedfishNetworkDeviceFunctionMetrics_V1_1_0_NetworkDeviceFunctionMetrics_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for NetworkDeviceFunctionMetrics.V1_1_0.NetworkDeviceFunctionMetrics
//
RedfishCS_status DestroyNetworkDeviceFunctionMetrics_V1_1_0_CS(RedfishNetworkDeviceFunctionMetrics_V1_1_0_NetworkDeviceFunctionMetrics_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for NetworkDeviceFunctionMetrics.V1_1_0.NetworkDeviceFunctionMetrics
//
RedfishCS_status DestroyNetworkDeviceFunctionMetrics_V1_1_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for NetworkDeviceFunctionMetrics.V1_1_0.NetworkDeviceFunctionMetrics
//
RedfishCS_status
Json_NetworkDeviceFunctionMetrics_V1_1_0_To_CS(RedfishCS_char *JsonRawText, RedfishNetworkDeviceFunctionMetrics_V1_1_0_NetworkDeviceFunctionMetrics_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishNetworkDeviceFunctionMetrics_V1_1_0_NetworkDeviceFunctionMetrics_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "NetworkDeviceFunctionMetrics", "v1_1_0", "NetworkDeviceFunctionMetrics", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishNetworkDeviceFunctionMetrics_V1_1_0_NetworkDeviceFunctionMetrics_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyNetworkDeviceFunctionMetrics_V1_1_0_CS (Cs);
  return Status;
}
