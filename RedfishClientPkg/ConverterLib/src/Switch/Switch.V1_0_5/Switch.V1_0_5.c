...
#include"Redfish_Switch_v1_0_5_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishSwitch_V1_0_5_Switch_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #Switch.Reset
//
static RedfishCS_status GenResetCs(RedfishSwitch_V1_0_5_Switch_CS *Cs, json_t *JsonObj, char *Key, RedfishSwitch_V1_0_5_Reset_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSwitch_V1_0_5_Reset_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishSwitch_V1_0_5_Switch_CS *Cs, json_t *JsonObj, char *Key, RedfishSwitch_V1_0_5_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSwitch_V1_0_5_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishSwitch_V1_0_5_Switch_CS *Cs, json_t *JsonObj, char *Key, RedfishSwitch_V1_0_5_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSwitch_V1_0_5_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #Switch.Reset
...
//
static RedfishCS_status GenLinksCs(RedfishSwitch_V1_0_5_Switch_CS *Cs, json_t *JsonObj, char *Key, RedfishSwitch_V1_0_5_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishSwitch_V1_0_5_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Chassis
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishSwitch_V1_0_5_Switch_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishSwitch_V1_0_5_Switch_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishSwitch_V1_0_5_Switch_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishSwitch_V1_0_5_Switch_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishSwitch_V1_0_5_Switch_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishSwitch_V1_0_5_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsSwitch_Reset(json_t *CsJson, char *Key, RedfishSwitch_V1_0_5_Reset_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishSwitch_V1_0_5_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishSwitch_V1_0_5_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Switch.V1_0_5.Switch
//
RedfishCS_status CS_To_Switch_V1_0_5_JSON(RedfishSwitch_V1_0_5_Switch_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Switch.V1_0_5.Switch
//
RedfishCS_status DestroySwitch_V1_0_5_CS(RedfishSwitch_V1_0_5_Switch_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Switch.V1_0_5.Switch
//
RedfishCS_status DestroySwitch_V1_0_5_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Switch.V1_0_5.Switch
//
RedfishCS_status
Json_Switch_V1_0_5_To_CS(RedfishCS_char *JsonRawText, RedfishSwitch_V1_0_5_Switch_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSwitch_V1_0_5_Switch_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Switch", "v1_0_5", "Switch", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSwitch_V1_0_5_Switch_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
