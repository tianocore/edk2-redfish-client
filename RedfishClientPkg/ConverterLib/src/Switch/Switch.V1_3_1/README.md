# Definition of Switch.V1_3_1 and functions<br><br>
...
## Actions
    typedef struct _RedfishSwitch_V1_3_1_Actions_CS {
        ...
        RedfishSwitch_V1_3_1_OemActions_CS *Oem;
    } RedfishSwitch_V1_3_1_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Switch_Reset**|RedfishSwitch_V1_3_1_Reset_CS| Structure points to **#Switch.Reset** property.| No| No
|**Oem**|RedfishSwitch_V1_3_1_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Switch
    typedef struct _RedfishSwitch_V1_3_1_Switch_CS {
        ...
        RedfishSwitch_V1_3_1_Actions_CS *Actions;
        ...
        RedfishSwitch_V1_3_1_Links_CS *Links;
...
|**Actions**|RedfishSwitch_V1_3_1_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishSwitch_V1_3_1_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish Switch V1_3_1 to C Structure Function
    RedfishCS_status
    Json_Switch_V1_3_1_To_CS (RedfishCS_char *JsonRawText, RedfishSwitch_V1_3_1_Switch_CS **ReturnedCS);

## C Structure to Redfish Switch V1_3_1 JSON Function
    RedfishCS_status
    CS_To_Switch_V1_3_1_JSON (RedfishSwitch_V1_3_1_Switch_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Switch V1_3_1 C Structure Function
    RedfishCS_status
