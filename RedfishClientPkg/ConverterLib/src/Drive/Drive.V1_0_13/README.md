# Definition of Drive.V1_0_13 and functions<br><br>

## Actions
    typedef struct _RedfishDrive_V1_0_13_Actions_CS {
        RedfishDrive_V1_0_13_SecureErase_CS *Drive_SecureErase;
        RedfishDrive_V1_0_13_OemActions_CS *Oem;
    } RedfishDrive_V1_0_13_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Drive_SecureErase**|RedfishDrive_V1_0_13_SecureErase_CS| Structure points to **#Drive.SecureErase** property.| No| No
|**Oem**|RedfishDrive_V1_0_13_OemActions_CS| Structure points to **Oem** property.| No| No


## Links
    typedef struct _RedfishDrive_V1_0_13_Links_CS {
        RedfishResource_Oem_CS *Oem;
        RedfishCS_Link Volumes;
        RedfishCS_int64 *Volumesodata_count;
    } RedfishDrive_V1_0_13_Links_CS;
...
## OemActions
    typedef struct _RedfishDrive_V1_0_13_OemActions_CS {
        RedfishCS_Link Prop;
    } RedfishDrive_V1_0_13_OemActions_CS;
...
## SecureErase
    typedef struct _RedfishDrive_V1_0_13_SecureErase_CS {
        RedfishCS_char *target;
        RedfishCS_char *title;
    } RedfishDrive_V1_0_13_SecureErase_CS;
...
## Drive
    typedef struct _RedfishDrive_V1_0_13_Drive_CS {
        RedfishCS_Header     Header;
        RedfishCS_char *odata_context;
        RedfishCS_char *odata_etag;
        RedfishCS_char *odata_id;
        RedfishCS_char *odata_type;
        RedfishDrive_V1_0_13_Actions_CS *Actions;
        ...
        RedfishDrive_V1_0_13_Links_CS *Links;
...
|**Actions**|RedfishDrive_V1_0_13_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishDrive_V1_0_13_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish Drive V1_0_13 to C Structure Function
    RedfishCS_status
    Json_Drive_V1_0_13_To_CS (RedfishCS_char *JsonRawText, RedfishDrive_V1_0_13_Drive_CS **ReturnedCS);

## C Structure to Redfish Drive V1_0_13 JSON Function
    RedfishCS_status
    CS_To_Drive_V1_0_13_JSON (RedfishDrive_V1_0_13_Drive_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Drive V1_0_13 C Structure Function
    RedfishCS_status
    DestroyDrive_V1_0_13_CS (RedfishDrive_V1_0_13_Drive_CS *CSPtr);
