# Definition of Drive.V1_2_6 and functions<br><br>

## Actions
    typedef struct _RedfishDrive_V1_2_6_Actions_CS {
        RedfishDrive_V1_2_6_SecureErase_CS *Drive_SecureErase;
        RedfishDrive_V1_2_6_OemActions_CS *Oem;
    } RedfishDrive_V1_2_6_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Drive_SecureErase**|RedfishDrive_V1_2_6_SecureErase_CS| Structure points to **#Drive.SecureErase** property.| No| No
|**Oem**|RedfishDrive_V1_2_6_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Drive
    typedef struct _RedfishDrive_V1_2_6_Drive_CS {
        ...
        RedfishDrive_V1_2_6_Actions_CS *Actions;
        ...
        RedfishDrive_V1_2_6_Links_CS *Links;
        ...
        RedfishResource_Oem_CS *Oem;
        RedfishDrive_V1_2_6_Operations_CS *Operations;
...
|**Actions**|RedfishDrive_V1_2_6_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishDrive_V1_2_6_Links_CS| Structure points to **Links** property.| No| No
...
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**Operations**|RedfishDrive_V1_2_6_Operations_CS| Structure points to **Operations** property.| No| No
...
## Redfish Drive V1_2_6 to C Structure Function
    RedfishCS_status
    Json_Drive_V1_2_6_To_CS (RedfishCS_char *JsonRawText, RedfishDrive_V1_2_6_Drive_CS **ReturnedCS);

## C Structure to Redfish Drive V1_2_6 JSON Function
    RedfishCS_status
    CS_To_Drive_V1_2_6_JSON (RedfishDrive_V1_2_6_Drive_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Drive V1_2_6 C Structure Function
    RedfishCS_status
