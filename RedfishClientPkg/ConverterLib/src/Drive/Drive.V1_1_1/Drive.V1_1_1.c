...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishDrive_V1_1_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenidRefCs(RedfishDrive_V1_1_1_Drive_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishDrive_V1_1_1_Drive_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishDrive_V1_1_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
RedfishCS_status CS_To_Drive_V1_1_1_JSON(RedfishDrive_V1_1_1_Drive_CS *CSPtr, RedfishCS_char **JsonText)
{
  ...
  // Operations 
  if (InsertJsonLinkArrayObj (CsJson, "Operations", &CSPtr->Operations) != RedfishCS_status_success) {goto Error;}
...
Json_Drive_V1_1_1_To_CS(RedfishCS_char *JsonRawText, RedfishDrive_V1_1_1_Drive_CS **ReturnedCs)
{
  ...
  // Operations
  InitializeLinkHead (&Cs->Operations);
  Status = CreateCsUriOrJsonByNodeArray (Cs, JsonObj, "Operations", Cs->Header.ThisUri, &Cs->Operations);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
