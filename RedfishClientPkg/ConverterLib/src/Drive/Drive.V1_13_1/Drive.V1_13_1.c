...
#include"Redfish_Drive_v1_13_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishDrive_V1_13_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #Drive.Reset
//
static RedfishCS_status GenResetCs(RedfishDrive_V1_13_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishDrive_V1_13_1_Reset_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishDrive_V1_13_1_Reset_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenSecureEraseCs(RedfishDrive_V1_13_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishDrive_V1_13_1_SecureErase_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishDrive_V1_13_1_SecureErase_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishDrive_V1_13_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishDrive_V1_13_1_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishDrive_V1_13_1_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishDrive_V1_13_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishDrive_V1_13_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishDrive_V1_13_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #Drive.Reset
...
//
static RedfishCS_status GenLinksCs(RedfishDrive_V1_13_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishDrive_V1_13_1_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishDrive_V1_13_1_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Chassis
...
static RedfishCS_status GenOperations_Array_ElementCs(RedfishDrive_V1_13_1_Drive_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishDrive_V1_13_1_Operations_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishDrive_V1_13_1_Operations_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AssociatedTask
...
//
//Generate C structure for RedfishDrive_V1_13_1_Operations_Array_CS
//
static RedfishCS_status GenOperations_ArrayCs(RedfishDrive_V1_13_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishDrive_V1_13_1_Operations_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishDrive_V1_13_1_Operations_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishDrive_V1_13_1_Operations_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishDrive_V1_13_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenidRefCs(RedfishDrive_V1_13_1_Drive_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishDrive_V1_13_1_Drive_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishDrive_V1_13_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishDrive_V1_13_1_Drive_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsDrive_Reset(json_t *CsJson, char *Key, RedfishDrive_V1_13_1_Reset_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsDrive_SecureErase(json_t *CsJson, char *Key, RedfishDrive_V1_13_1_SecureErase_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishDrive_V1_13_1_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishDrive_V1_13_1_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishDrive_V1_13_1_Links_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Operations(json_t *CsJson, char *Key, RedfishDrive_V1_13_1_Operations_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishDrive_V1_13_1_Operations_Array_CS *NextArray;
  RedfishDrive_V1_13_1_Operations_CS *NextArrayItem;
...
//
// C structure to JSON for Drive.V1_13_1.Drive
//
RedfishCS_status CS_To_Drive_V1_13_1_JSON(RedfishDrive_V1_13_1_Drive_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Drive.V1_13_1.Drive
//
RedfishCS_status DestroyDrive_V1_13_1_CS(RedfishDrive_V1_13_1_Drive_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Drive.V1_13_1.Drive
//
RedfishCS_status DestroyDrive_V1_13_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Drive.V1_13_1.Drive
//
RedfishCS_status
Json_Drive_V1_13_1_To_CS(RedfishCS_char *JsonRawText, RedfishDrive_V1_13_1_Drive_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishDrive_V1_13_1_Drive_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Drive", "v1_13_1", "Drive", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishDrive_V1_13_1_Drive_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
