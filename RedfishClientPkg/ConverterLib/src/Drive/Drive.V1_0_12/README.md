# Definition of Drive.V1_0_12 and functions<br><br>

## Actions
    typedef struct _RedfishDrive_V1_0_12_Actions_CS {
        RedfishDrive_V1_0_12_SecureErase_CS *Drive_SecureErase;
        RedfishDrive_V1_0_12_OemActions_CS *Oem;
    } RedfishDrive_V1_0_12_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Drive_SecureErase**|RedfishDrive_V1_0_12_SecureErase_CS| Structure points to **#Drive.SecureErase** property.| No| No
|**Oem**|RedfishDrive_V1_0_12_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Drive
    typedef struct _RedfishDrive_V1_0_12_Drive_CS {
        ...
        RedfishDrive_V1_0_12_Actions_CS *Actions;
        ...
        RedfishDrive_V1_0_12_Links_CS *Links;
...
|**Actions**|RedfishDrive_V1_0_12_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishDrive_V1_0_12_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish Drive V1_0_12 to C Structure Function
    RedfishCS_status
    Json_Drive_V1_0_12_To_CS (RedfishCS_char *JsonRawText, RedfishDrive_V1_0_12_Drive_CS **ReturnedCS);

## C Structure to Redfish Drive V1_0_12 JSON Function
    RedfishCS_status
    CS_To_Drive_V1_0_12_JSON (RedfishDrive_V1_0_12_Drive_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Drive V1_0_12 C Structure Function
    RedfishCS_status
