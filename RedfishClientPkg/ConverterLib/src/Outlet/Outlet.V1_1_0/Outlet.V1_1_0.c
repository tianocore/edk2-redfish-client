...
#include"Redfish_Outlet_v1_1_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishOutlet_V1_1_0_Outlet_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #Outlet.PowerControl
//
static RedfishCS_status GenPowerControlCs(RedfishOutlet_V1_1_0_Outlet_CS *Cs, json_t *JsonObj, char *Key, RedfishOutlet_V1_1_0_PowerControl_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishOutlet_V1_1_0_PowerControl_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenResetMetricsCs(RedfishOutlet_V1_1_0_Outlet_CS *Cs, json_t *JsonObj, char *Key, RedfishOutlet_V1_1_0_ResetMetrics_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishOutlet_V1_1_0_ResetMetrics_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishOutlet_V1_1_0_Outlet_CS *Cs, json_t *JsonObj, char *Key, RedfishOutlet_V1_1_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishOutlet_V1_1_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishOutlet_V1_1_0_Outlet_CS *Cs, json_t *JsonObj, char *Key, RedfishOutlet_V1_1_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishOutlet_V1_1_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #Outlet.PowerControl
...
//
static RedfishCS_status GenLinksCs(RedfishOutlet_V1_1_0_Outlet_CS *Cs, json_t *JsonObj, char *Key, RedfishOutlet_V1_1_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishOutlet_V1_1_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // BranchCircuit
...
//
static RedfishCS_status GenCurrentSensorsCs(RedfishOutlet_V1_1_0_Outlet_CS *Cs, json_t *JsonObj, char *Key, RedfishOutlet_V1_1_0_CurrentSensors_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishOutlet_V1_1_0_CurrentSensors_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Line1
...
//
static RedfishCS_status GenVoltageSensorsCs(RedfishOutlet_V1_1_0_Outlet_CS *Cs, json_t *JsonObj, char *Key, RedfishOutlet_V1_1_0_VoltageSensors_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishOutlet_V1_1_0_VoltageSensors_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Line1ToLine2
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishOutlet_V1_1_0_Outlet_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishOutlet_V1_1_0_Outlet_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishOutlet_V1_1_0_Outlet_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishOutlet_V1_1_0_Outlet_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishOutlet_V1_1_0_Outlet_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishOutlet_V1_1_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOutlet_PowerControl(json_t *CsJson, char *Key, RedfishOutlet_V1_1_0_PowerControl_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOutlet_ResetMetrics(json_t *CsJson, char *Key, RedfishOutlet_V1_1_0_ResetMetrics_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishOutlet_V1_1_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishOutlet_V1_1_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_PolyPhaseCurrentAmps(json_t *CsJson, char *Key, RedfishOutlet_V1_1_0_CurrentSensors_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_PolyPhaseVoltage(json_t *CsJson, char *Key, RedfishOutlet_V1_1_0_VoltageSensors_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Outlet.V1_1_0.Outlet
//
RedfishCS_status CS_To_Outlet_V1_1_0_JSON(RedfishOutlet_V1_1_0_Outlet_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Outlet.V1_1_0.Outlet
//
RedfishCS_status DestroyOutlet_V1_1_0_CS(RedfishOutlet_V1_1_0_Outlet_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Outlet.V1_1_0.Outlet
//
RedfishCS_status DestroyOutlet_V1_1_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Outlet.V1_1_0.Outlet
//
RedfishCS_status
Json_Outlet_V1_1_0_To_CS(RedfishCS_char *JsonRawText, RedfishOutlet_V1_1_0_Outlet_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishOutlet_V1_1_0_Outlet_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Outlet", "v1_1_0", "Outlet", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishOutlet_V1_1_0_Outlet_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
