# Definition of Outlet.V1_2_0 and functions<br><br>
...
## Actions
    typedef struct _RedfishOutlet_V1_2_0_Actions_CS {
        ...
        RedfishOutlet_V1_2_0_OemActions_CS *Oem;
    } RedfishOutlet_V1_2_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Outlet_PowerControl**|RedfishOutlet_V1_2_0_PowerControl_CS| Structure points to **#Outlet.PowerControl** property.| No| No
|**Outlet_ResetMetrics**|RedfishOutlet_V1_2_0_ResetMetrics_CS| Structure points to **#Outlet.ResetMetrics** property.| No| No
|**Oem**|RedfishOutlet_V1_2_0_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Outlet
    typedef struct _RedfishOutlet_V1_2_0_Outlet_CS {
        ...
        RedfishOutlet_V1_2_0_Actions_CS *Actions;
        ...
        RedfishOutlet_V1_2_0_Links_CS *Links;
        ...
        RedfishOutlet_V1_2_0_CurrentSensors_CS *PolyPhaseCurrentAmps;
        RedfishOutlet_V1_2_0_VoltageSensors_CS *PolyPhaseVoltage;
...
|**Actions**|RedfishOutlet_V1_2_0_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishOutlet_V1_2_0_Links_CS| Structure points to **Links** property.| No| No
...
|**PolyPhaseCurrentAmps**|RedfishOutlet_V1_2_0_CurrentSensors_CS| Structure points to **PolyPhaseCurrentAmps** property.| No| No
|**PolyPhaseVoltage**|RedfishOutlet_V1_2_0_VoltageSensors_CS| Structure points to **PolyPhaseVoltage** property.| No| No
...
## Redfish Outlet V1_2_0 to C Structure Function
    RedfishCS_status
    Json_Outlet_V1_2_0_To_CS (RedfishCS_char *JsonRawText, RedfishOutlet_V1_2_0_Outlet_CS **ReturnedCS);

## C Structure to Redfish Outlet V1_2_0 JSON Function
    RedfishCS_status
    CS_To_Outlet_V1_2_0_JSON (RedfishOutlet_V1_2_0_Outlet_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Outlet V1_2_0 C Structure Function
    RedfishCS_status
