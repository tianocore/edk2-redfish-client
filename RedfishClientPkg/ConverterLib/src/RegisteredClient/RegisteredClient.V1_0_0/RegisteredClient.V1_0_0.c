...
#include"Redfish_RegisteredClient_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishRegisteredClient_V1_0_0_RegisteredClient_CS *Cs, json_t *JsonObj, char *Key, RedfishRegisteredClient_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishRegisteredClient_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishRegisteredClient_V1_0_0_RegisteredClient_CS *Cs, json_t *JsonObj, char *Key, RedfishRegisteredClient_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishRegisteredClient_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenManagedResource_Array_ElementCs(RedfishRegisteredClient_V1_0_0_RegisteredClient_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishRegisteredClient_V1_0_0_ManagedResource_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishRegisteredClient_V1_0_0_ManagedResource_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // IncludesSubordinates
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "IncludesSubordinates", &(*Dst)->IncludesSubordinates);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ManagedResourceURI
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "ManagedResourceURI", &(*Dst)->ManagedResourceURI);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // PreferExclusive
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "PreferExclusive", &(*Dst)->PreferExclusive);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishRegisteredClient_V1_0_0_ManagedResource_Array_CS
//
static RedfishCS_status GenManagedResource_ArrayCs(RedfishRegisteredClient_V1_0_0_RegisteredClient_CS *Cs, json_t *JsonObj, char *Key, RedfishRegisteredClient_V1_0_0_ManagedResource_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishRegisteredClient_V1_0_0_ManagedResource_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishRegisteredClient_V1_0_0_ManagedResource_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
  ...
  for (Index = 0; Index < ArraySize; Index ++) {
    Status = GenManagedResource_Array_ElementCs(Cs, TempJsonObj, Index, &ThisElement->ArrayValue);
    if (Status != RedfishCS_status_success){
      goto Error;
    }
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishRegisteredClient_V1_0_0_RegisteredClient_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishRegisteredClient_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishRegisteredClient_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ManagedResources(json_t *CsJson, char *Key, RedfishRegisteredClient_V1_0_0_ManagedResource_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishRegisteredClient_V1_0_0_ManagedResource_Array_CS *NextArray;
  RedfishRegisteredClient_V1_0_0_ManagedResource_CS *NextArrayItem;
  ...
  do {
    ...
    // IncludesSubordinates 
    if (InsertJsonBoolObj (ArrayMember, "IncludesSubordinates", NextArrayItem->IncludesSubordinates) != RedfishCS_status_success) {goto Error;}

    // ManagedResourceURI 
    if (InsertJsonStringObj (ArrayMember, "ManagedResourceURI", NextArrayItem->ManagedResourceURI) != RedfishCS_status_success) {goto Error;}

    // PreferExclusive 
    if (InsertJsonBoolObj (ArrayMember, "PreferExclusive", NextArrayItem->PreferExclusive) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for RegisteredClient.V1_0_0.RegisteredClient
//
RedfishCS_status CS_To_RegisteredClient_V1_0_0_JSON(RedfishRegisteredClient_V1_0_0_RegisteredClient_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // ClientType 
  if (InsertJsonStringObj (CsJson, "ClientType", CSPtr->ClientType) != RedfishCS_status_success) {goto Error;}

  // ClientURI 
  if (InsertJsonStringObj (CsJson, "ClientURI", CSPtr->ClientURI) != RedfishCS_status_success) {goto Error;}

  // CreatedDate 
  if (InsertJsonStringObj (CsJson, "CreatedDate", CSPtr->CreatedDate) != RedfishCS_status_success) {goto Error;}
  ...
  // ManagedResources
  if (CS_To_JSON_ManagedResources(CsJson, "ManagedResources", CSPtr->ManagedResources) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for RegisteredClient.V1_0_0.RegisteredClient
//
RedfishCS_status DestroyRegisteredClient_V1_0_0_CS(RedfishRegisteredClient_V1_0_0_RegisteredClient_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for RegisteredClient.V1_0_0.RegisteredClient
//
RedfishCS_status DestroyRegisteredClient_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for RegisteredClient.V1_0_0.RegisteredClient
//
RedfishCS_status
Json_RegisteredClient_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishRegisteredClient_V1_0_0_RegisteredClient_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishRegisteredClient_V1_0_0_RegisteredClient_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "RegisteredClient", "v1_0_0", "RegisteredClient", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishRegisteredClient_V1_0_0_RegisteredClient_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // ClientType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "ClientType", &Cs->ClientType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){goto Error;}}

  // ClientURI
  Status = GetRedfishPropertyStr (Cs, JsonObj, "ClientURI", &Cs->ClientURI);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // CreatedDate
  Status = GetRedfishPropertyStr (Cs, JsonObj, "CreatedDate", &Cs->CreatedDate);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // ManagedResources
  Status = GenManagedResource_ArrayCs (Cs, JsonObj, "ManagedResources", &Cs->ManagedResources);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyRegisteredClient_V1_0_0_CS (Cs);
  return Status;
}
