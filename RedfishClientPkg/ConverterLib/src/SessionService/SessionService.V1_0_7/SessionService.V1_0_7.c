...
#include"Redfish_SessionService_v1_0_7_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishSessionService_V1_0_7_SessionService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishSessionService_V1_0_7_SessionService_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishSessionService_V1_0_7_SessionService_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishSessionService_V1_0_7_SessionService_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishSessionService_V1_0_7_SessionService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishSessionService_V1_0_7_SessionService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
// C structure to JSON for SessionService.V1_0_7.SessionService
//
RedfishCS_status CS_To_SessionService_V1_0_7_JSON(RedfishSessionService_V1_0_7_SessionService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for SessionService.V1_0_7.SessionService
//
RedfishCS_status DestroySessionService_V1_0_7_CS(RedfishSessionService_V1_0_7_SessionService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for SessionService.V1_0_7.SessionService
//
RedfishCS_status DestroySessionService_V1_0_7_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for SessionService.V1_0_7.SessionService
//
RedfishCS_status
Json_SessionService_V1_0_7_To_CS(RedfishCS_char *JsonRawText, RedfishSessionService_V1_0_7_SessionService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishSessionService_V1_0_7_SessionService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "SessionService", "v1_0_7", "SessionService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishSessionService_V1_0_7_SessionService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroySessionService_V1_0_7_CS (Cs);
  return Status;
}
