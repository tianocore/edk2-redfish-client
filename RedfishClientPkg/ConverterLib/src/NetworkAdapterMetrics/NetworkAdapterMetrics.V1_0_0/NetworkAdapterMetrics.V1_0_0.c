...
#include"Redfish_NetworkAdapterMetrics_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishNetworkAdapterMetrics_V1_0_0_NetworkAdapterMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkAdapterMetrics_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkAdapterMetrics_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishNetworkAdapterMetrics_V1_0_0_NetworkAdapterMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishNetworkAdapterMetrics_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishNetworkAdapterMetrics_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishNetworkAdapterMetrics_V1_0_0_NetworkAdapterMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishNetworkAdapterMetrics_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishNetworkAdapterMetrics_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for NetworkAdapterMetrics.V1_0_0.NetworkAdapterMetrics
//
RedfishCS_status CS_To_NetworkAdapterMetrics_V1_0_0_JSON(RedfishNetworkAdapterMetrics_V1_0_0_NetworkAdapterMetrics_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // CPUCorePercent 
  if (InsertJsonInt64Obj (CsJson, "CPUCorePercent", CSPtr->CPUCorePercent) != RedfishCS_status_success) {goto Error;}

  // Description 
  if (InsertJsonStringObj (CsJson, "Description", CSPtr->Description) != RedfishCS_status_success) {goto Error;}

  // HostBusRXPercent 
  if (InsertJsonInt64Obj (CsJson, "HostBusRXPercent", CSPtr->HostBusRXPercent) != RedfishCS_status_success) {goto Error;}

  // HostBusTXPercent 
  if (InsertJsonInt64Obj (CsJson, "HostBusTXPercent", CSPtr->HostBusTXPercent) != RedfishCS_status_success) {goto Error;}

  // Id 
  if (InsertJsonStringObj (CsJson, "Id", CSPtr->Id) != RedfishCS_status_success) {goto Error;}

  // NCSIRXBytes 
  if (InsertJsonInt64Obj (CsJson, "NCSIRXBytes", CSPtr->NCSIRXBytes) != RedfishCS_status_success) {goto Error;}

  // NCSIRXFrames 
  if (InsertJsonInt64Obj (CsJson, "NCSIRXFrames", CSPtr->NCSIRXFrames) != RedfishCS_status_success) {goto Error;}

  // NCSITXBytes 
  if (InsertJsonInt64Obj (CsJson, "NCSITXBytes", CSPtr->NCSITXBytes) != RedfishCS_status_success) {goto Error;}

  // NCSITXFrames 
  if (InsertJsonInt64Obj (CsJson, "NCSITXFrames", CSPtr->NCSITXFrames) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for NetworkAdapterMetrics.V1_0_0.NetworkAdapterMetrics
//
RedfishCS_status DestroyNetworkAdapterMetrics_V1_0_0_CS(RedfishNetworkAdapterMetrics_V1_0_0_NetworkAdapterMetrics_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for NetworkAdapterMetrics.V1_0_0.NetworkAdapterMetrics
//
RedfishCS_status DestroyNetworkAdapterMetrics_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for NetworkAdapterMetrics.V1_0_0.NetworkAdapterMetrics
//
RedfishCS_status
Json_NetworkAdapterMetrics_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishNetworkAdapterMetrics_V1_0_0_NetworkAdapterMetrics_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishNetworkAdapterMetrics_V1_0_0_NetworkAdapterMetrics_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "NetworkAdapterMetrics", "v1_0_0", "NetworkAdapterMetrics", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishNetworkAdapterMetrics_V1_0_0_NetworkAdapterMetrics_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // CPUCorePercent
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "CPUCorePercent", &Cs->CPUCorePercent);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // HostBusRXPercent
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "HostBusRXPercent", &Cs->HostBusRXPercent);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // HostBusTXPercent
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "HostBusTXPercent", &Cs->HostBusTXPercent);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // NCSIRXBytes
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "NCSIRXBytes", &Cs->NCSIRXBytes);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // NCSIRXFrames
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "NCSIRXFrames", &Cs->NCSIRXFrames);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // NCSITXBytes
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "NCSITXBytes", &Cs->NCSITXBytes);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // NCSITXFrames
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "NCSITXFrames", &Cs->NCSITXFrames);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyNetworkAdapterMetrics_V1_0_0_CS (Cs);
  return Status;
}
