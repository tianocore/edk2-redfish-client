# Definition of ConnectionCollection and functions<br><br>
...
## Redfish ConnectionCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish ConnectionCollection  JSON Function
    RedfishCS_status
    CS_To_ConnectionCollection_JSON (RedfishConnectionCollection_ConnectionCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ConnectionCollection  C Structure Function
    RedfishCS_status
