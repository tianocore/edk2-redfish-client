...
#include"Redfish_PowerSupplyMetrics_v1_0_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishPowerSupplyMetrics_V1_0_1_PowerSupplyMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #PowerSupplyMetrics.ResetMetrics
//
static RedfishCS_status GenResetMetricsCs(RedfishPowerSupplyMetrics_V1_0_1_PowerSupplyMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerSupplyMetrics_V1_0_1_ResetMetrics_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerSupplyMetrics_V1_0_1_ResetMetrics_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishPowerSupplyMetrics_V1_0_1_PowerSupplyMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerSupplyMetrics_V1_0_1_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerSupplyMetrics_V1_0_1_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishPowerSupplyMetrics_V1_0_1_PowerSupplyMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerSupplyMetrics_V1_0_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerSupplyMetrics_V1_0_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishPowerSupplyMetrics_V1_0_1_PowerSupplyMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishPowerSupplyMetrics_V1_0_1_PowerSupplyMetrics_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishPowerSupplyMetrics_V1_0_1_PowerSupplyMetrics_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishPowerSupplyMetrics_V1_0_1_PowerSupplyMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishPowerSupplyMetrics_V1_0_1_PowerSupplyMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishPowerSupplyMetrics_V1_0_1_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsPowerSupplyMetrics_ResetMetrics(json_t *CsJson, char *Key, RedfishPowerSupplyMetrics_V1_0_1_ResetMetrics_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishPowerSupplyMetrics_V1_0_1_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for PowerSupplyMetrics.V1_0_1.PowerSupplyMetrics
//
RedfishCS_status CS_To_PowerSupplyMetrics_V1_0_1_JSON(RedfishPowerSupplyMetrics_V1_0_1_PowerSupplyMetrics_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for PowerSupplyMetrics.V1_0_1.PowerSupplyMetrics
//
RedfishCS_status DestroyPowerSupplyMetrics_V1_0_1_CS(RedfishPowerSupplyMetrics_V1_0_1_PowerSupplyMetrics_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PowerSupplyMetrics.V1_0_1.PowerSupplyMetrics
//
RedfishCS_status DestroyPowerSupplyMetrics_V1_0_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PowerSupplyMetrics.V1_0_1.PowerSupplyMetrics
//
RedfishCS_status
Json_PowerSupplyMetrics_V1_0_1_To_CS(RedfishCS_char *JsonRawText, RedfishPowerSupplyMetrics_V1_0_1_PowerSupplyMetrics_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPowerSupplyMetrics_V1_0_1_PowerSupplyMetrics_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PowerSupplyMetrics", "v1_0_1", "PowerSupplyMetrics", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPowerSupplyMetrics_V1_0_1_PowerSupplyMetrics_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyPowerSupplyMetrics_V1_0_1_CS (Cs);
  return Status;
}
