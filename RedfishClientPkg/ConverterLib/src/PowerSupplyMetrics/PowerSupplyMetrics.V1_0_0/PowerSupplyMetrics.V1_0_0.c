...
#include"Redfish_PowerSupplyMetrics_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishPowerSupplyMetrics_V1_0_0_PowerSupplyMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #PowerSupplyMetrics.ResetMetrics
//
static RedfishCS_status GenResetMetricsCs(RedfishPowerSupplyMetrics_V1_0_0_PowerSupplyMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerSupplyMetrics_V1_0_0_ResetMetrics_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerSupplyMetrics_V1_0_0_ResetMetrics_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishPowerSupplyMetrics_V1_0_0_PowerSupplyMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerSupplyMetrics_V1_0_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerSupplyMetrics_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishPowerSupplyMetrics_V1_0_0_PowerSupplyMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerSupplyMetrics_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerSupplyMetrics_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #PowerSupplyMetrics.ResetMetrics
  Status = GenResetMetricsCs (Cs, TempJsonObj, "#PowerSupplyMetrics.ResetMetrics", &(*Dst)->PowerSupplyMetrics_ResetMetrics);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishPowerSupplyMetrics_V1_0_0_PowerSupplyMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishPowerSupplyMetrics_V1_0_0_PowerSupplyMetrics_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishPowerSupplyMetrics_V1_0_0_PowerSupplyMetrics_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishPowerSupplyMetrics_V1_0_0_PowerSupplyMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishPowerSupplyMetrics_V1_0_0_PowerSupplyMetrics_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishPowerSupplyMetrics_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsPowerSupplyMetrics_ResetMetrics(json_t *CsJson, char *Key, RedfishPowerSupplyMetrics_V1_0_0_ResetMetrics_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishPowerSupplyMetrics_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // #PowerSupplyMetrics.ResetMetrics
  if (CS_To_JSON_ActionsPowerSupplyMetrics_ResetMetrics(CsJson, "#PowerSupplyMetrics.ResetMetrics", CSPtr->PowerSupplyMetrics_ResetMetrics) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for PowerSupplyMetrics.V1_0_0.PowerSupplyMetrics
//
RedfishCS_status CS_To_PowerSupplyMetrics_V1_0_0_JSON(RedfishPowerSupplyMetrics_V1_0_0_PowerSupplyMetrics_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // FanSpeedPercent 
  if (InsertJsonLinkObj (CsJson, "FanSpeedPercent", &CSPtr->FanSpeedPercent) != RedfishCS_status_success) {goto Error;}
  ...
  // InputCurrentAmps 
  if (InsertJsonLinkObj (CsJson, "InputCurrentAmps", &CSPtr->InputCurrentAmps) != RedfishCS_status_success) {goto Error;}

  // InputPowerWatts 
  if (InsertJsonLinkObj (CsJson, "InputPowerWatts", &CSPtr->InputPowerWatts) != RedfishCS_status_success) {goto Error;}

  // InputVoltage 
  if (InsertJsonLinkObj (CsJson, "InputVoltage", &CSPtr->InputVoltage) != RedfishCS_status_success) {goto Error;}
  ...
  // OutputPowerWatts 
  if (InsertJsonLinkObj (CsJson, "OutputPowerWatts", &CSPtr->OutputPowerWatts) != RedfishCS_status_success) {goto Error;}

  // RailCurrentAmps 
  if (InsertJsonLinkArrayObj (CsJson, "RailCurrentAmps", &CSPtr->RailCurrentAmps) != RedfishCS_status_success) {goto Error;}

  // RailCurrentAmps@odata.count 
  if (InsertJsonInt64Obj (CsJson, "RailCurrentAmps@odata.count", CSPtr->RailCurrentAmpsodata_count) != RedfishCS_status_success) {goto Error;}

  // RailPowerWatts 
  if (InsertJsonLinkArrayObj (CsJson, "RailPowerWatts", &CSPtr->RailPowerWatts) != RedfishCS_status_success) {goto Error;}

  // RailPowerWatts@odata.count 
  if (InsertJsonInt64Obj (CsJson, "RailPowerWatts@odata.count", CSPtr->RailPowerWattsodata_count) != RedfishCS_status_success) {goto Error;}

  // RailVoltage 
  if (InsertJsonLinkArrayObj (CsJson, "RailVoltage", &CSPtr->RailVoltage) != RedfishCS_status_success) {goto Error;}

  // RailVoltage@odata.count 
  if (InsertJsonInt64Obj (CsJson, "RailVoltage@odata.count", CSPtr->RailVoltageodata_count) != RedfishCS_status_success) {goto Error;}

  // Status
  if (CS_To_JSON_Status(CsJson, "Status", CSPtr->Status) != RedfishCS_status_success) {goto Error;}

  // TemperatureCelsius 
  if (InsertJsonLinkObj (CsJson, "TemperatureCelsius", &CSPtr->TemperatureCelsius) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for PowerSupplyMetrics.V1_0_0.PowerSupplyMetrics
//
RedfishCS_status DestroyPowerSupplyMetrics_V1_0_0_CS(RedfishPowerSupplyMetrics_V1_0_0_PowerSupplyMetrics_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PowerSupplyMetrics.V1_0_0.PowerSupplyMetrics
//
RedfishCS_status DestroyPowerSupplyMetrics_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PowerSupplyMetrics.V1_0_0.PowerSupplyMetrics
//
RedfishCS_status
Json_PowerSupplyMetrics_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishPowerSupplyMetrics_V1_0_0_PowerSupplyMetrics_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPowerSupplyMetrics_V1_0_0_PowerSupplyMetrics_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PowerSupplyMetrics", "v1_0_0", "PowerSupplyMetrics", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPowerSupplyMetrics_V1_0_0_PowerSupplyMetrics_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // FanSpeedPercent
  InitializeLinkHead (&Cs->FanSpeedPercent);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "FanSpeedPercent", Cs->Header.ThisUri, &Cs->FanSpeedPercent);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // InputCurrentAmps
  InitializeLinkHead (&Cs->InputCurrentAmps);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "InputCurrentAmps", Cs->Header.ThisUri, &Cs->InputCurrentAmps);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // InputPowerWatts
  InitializeLinkHead (&Cs->InputPowerWatts);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "InputPowerWatts", Cs->Header.ThisUri, &Cs->InputPowerWatts);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // InputVoltage
  InitializeLinkHead (&Cs->InputVoltage);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "InputVoltage", Cs->Header.ThisUri, &Cs->InputVoltage);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // OutputPowerWatts
  InitializeLinkHead (&Cs->OutputPowerWatts);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "OutputPowerWatts", Cs->Header.ThisUri, &Cs->OutputPowerWatts);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // RailCurrentAmps
  InitializeLinkHead (&Cs->RailCurrentAmps);
  Status = CreateCsUriOrJsonByNodeArray (Cs, JsonObj, "RailCurrentAmps", Cs->Header.ThisUri, &Cs->RailCurrentAmps);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // RailCurrentAmps@odata.count
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "RailCurrentAmps@odata.count", &Cs->RailCurrentAmpsodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // RailPowerWatts
  InitializeLinkHead (&Cs->RailPowerWatts);
  Status = CreateCsUriOrJsonByNodeArray (Cs, JsonObj, "RailPowerWatts", Cs->Header.ThisUri, &Cs->RailPowerWatts);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // RailPowerWatts@odata.count
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "RailPowerWatts@odata.count", &Cs->RailPowerWattsodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // RailVoltage
  InitializeLinkHead (&Cs->RailVoltage);
  Status = CreateCsUriOrJsonByNodeArray (Cs, JsonObj, "RailVoltage", Cs->Header.ThisUri, &Cs->RailVoltage);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // RailVoltage@odata.count
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "RailVoltage@odata.count", &Cs->RailVoltageodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // TemperatureCelsius
  InitializeLinkHead (&Cs->TemperatureCelsius);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "TemperatureCelsius", Cs->Header.ThisUri, &Cs->TemperatureCelsius);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyPowerSupplyMetrics_V1_0_0_CS (Cs);
  return Status;
}
