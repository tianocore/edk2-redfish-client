...
#include"Redfish_TelemetryService_v1_3_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishTelemetryService_V1_3_0_TelemetryService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishTelemetryService_V1_3_0_TelemetryService_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for #TelemetryService.ClearMetricReports
//
static RedfishCS_status GenClearMetricReportsCs(RedfishTelemetryService_V1_3_0_TelemetryService_CS *Cs, json_t *JsonObj, char *Key, RedfishTelemetryService_V1_3_0_ClearMetricReports_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTelemetryService_V1_3_0_ClearMetricReports_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenResetMetricReportDefinitionsToDefaultsCs(RedfishTelemetryService_V1_3_0_TelemetryService_CS *Cs, json_t *JsonObj, char *Key, RedfishTelemetryService_V1_3_0_ResetMetricReportDefinitionsToDefaults_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTelemetryService_V1_3_0_ResetMetricReportDefinitionsToDefaults_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenResetTriggersToDefaultsCs(RedfishTelemetryService_V1_3_0_TelemetryService_CS *Cs, json_t *JsonObj, char *Key, RedfishTelemetryService_V1_3_0_ResetTriggersToDefaults_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTelemetryService_V1_3_0_ResetTriggersToDefaults_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenSubmitTestMetricReportCs(RedfishTelemetryService_V1_3_0_TelemetryService_CS *Cs, json_t *JsonObj, char *Key, RedfishTelemetryService_V1_3_0_SubmitTestMetricReport_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTelemetryService_V1_3_0_SubmitTestMetricReport_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishTelemetryService_V1_3_0_TelemetryService_CS *Cs, json_t *JsonObj, char *Key, RedfishTelemetryService_V1_3_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTelemetryService_V1_3_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishTelemetryService_V1_3_0_TelemetryService_CS *Cs, json_t *JsonObj, char *Key, RedfishTelemetryService_V1_3_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTelemetryService_V1_3_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenidRefCs(RedfishTelemetryService_V1_3_0_TelemetryService_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishTelemetryService_V1_3_0_TelemetryService_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishTelemetryService_V1_3_0_TelemetryService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishTelemetryService_V1_3_0_TelemetryService_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishTelemetryService_V1_3_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsTelemetryService_ClearMetricReports(json_t *CsJson, char *Key, RedfishTelemetryService_V1_3_0_ClearMetricReports_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsTelemetryService_ResetMetricReportDefinitionsToDefaults(json_t *CsJson, char *Key, RedfishTelemetryService_V1_3_0_ResetMetricReportDefinitionsToDefaults_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsTelemetryService_ResetTriggersToDefaults(json_t *CsJson, char *Key, RedfishTelemetryService_V1_3_0_ResetTriggersToDefaults_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsTelemetryService_SubmitTestMetricReport(json_t *CsJson, char *Key, RedfishTelemetryService_V1_3_0_SubmitTestMetricReport_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishTelemetryService_V1_3_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for TelemetryService.V1_3_0.TelemetryService
//
RedfishCS_status CS_To_TelemetryService_V1_3_0_JSON(RedfishTelemetryService_V1_3_0_TelemetryService_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for TelemetryService.V1_3_0.TelemetryService
//
RedfishCS_status DestroyTelemetryService_V1_3_0_CS(RedfishTelemetryService_V1_3_0_TelemetryService_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for TelemetryService.V1_3_0.TelemetryService
//
RedfishCS_status DestroyTelemetryService_V1_3_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for TelemetryService.V1_3_0.TelemetryService
//
RedfishCS_status
Json_TelemetryService_V1_3_0_To_CS(RedfishCS_char *JsonRawText, RedfishTelemetryService_V1_3_0_TelemetryService_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishTelemetryService_V1_3_0_TelemetryService_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "TelemetryService", "v1_3_0", "TelemetryService", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishTelemetryService_V1_3_0_TelemetryService_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyTelemetryService_V1_3_0_CS (Cs);
  return Status;
}
