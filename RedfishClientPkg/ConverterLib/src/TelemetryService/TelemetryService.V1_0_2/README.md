# Definition of TelemetryService.V1_0_2 and functions<br><br>
...
## Actions
    typedef struct _RedfishTelemetryService_V1_0_2_Actions_CS {
        ...
        RedfishTelemetryService_V1_0_2_OemActions_CS *Oem;
    } RedfishTelemetryService_V1_0_2_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**TelemetryService_SubmitTestMetricReport**|RedfishTelemetryService_V1_0_2_SubmitTestMetricReport_CS| Structure points to **#TelemetryService.SubmitTestMetricReport** property.| No| No
|**Oem**|RedfishTelemetryService_V1_0_2_OemActions_CS| Structure points to **Oem** property.| No| No
...
## TelemetryService
    typedef struct _RedfishTelemetryService_V1_0_2_TelemetryService_CS {
        ...
        RedfishTelemetryService_V1_0_2_Actions_CS *Actions;
...
|**Actions**|RedfishTelemetryService_V1_0_2_Actions_CS| Structure points to **Actions** property.| No| No
...
## Redfish TelemetryService V1_0_2 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish TelemetryService V1_0_2 JSON Function
    RedfishCS_status
    CS_To_TelemetryService_V1_0_2_JSON (RedfishTelemetryService_V1_0_2_TelemetryService_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish TelemetryService V1_0_2 C Structure Function
    RedfishCS_status
