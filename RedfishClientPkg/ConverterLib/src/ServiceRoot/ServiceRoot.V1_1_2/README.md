# Definition of ServiceRoot.V1_1_2 and functions<br><br>
...
## ServiceRoot
    typedef struct _RedfishServiceRoot_V1_1_2_ServiceRoot_CS {
        ...
        RedfishServiceRoot_V1_1_2_ServiceRoot_Links_CS *Links;
...
|**Links**|RedfishServiceRoot_V1_1_2_ServiceRoot_Links_CS| Structure points to **Links** property.| Yes| No
...
## Redfish ServiceRoot V1_1_2 to C Structure Function
    RedfishCS_status
    Json_ServiceRoot_V1_1_2_To_CS (RedfishCS_char *JsonRawText, RedfishServiceRoot_V1_1_2_ServiceRoot_CS **ReturnedCS);

## C Structure to Redfish ServiceRoot V1_1_2 JSON Function
    RedfishCS_status
    CS_To_ServiceRoot_V1_1_2_JSON (RedfishServiceRoot_V1_1_2_ServiceRoot_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ServiceRoot V1_1_2 C Structure Function
    RedfishCS_status
