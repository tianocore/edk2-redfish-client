# Definition of ServiceRoot.V1_4_1 and functions<br><br>
...
## ProtocolFeaturesSupported
    typedef struct _RedfishServiceRoot_V1_4_1_ProtocolFeaturesSupported_CS {
        ...
        RedfishServiceRoot_V1_4_1_Expand_CS *ExpandQuery;
...
|**ExpandQuery**|RedfishServiceRoot_V1_4_1_Expand_CS| Structure points to **ExpandQuery** property.| No| No
...
## ServiceRoot
    typedef struct _RedfishServiceRoot_V1_4_1_ServiceRoot_CS {
        ...
        RedfishServiceRoot_V1_4_1_Links_CS *Links;
        RedfishCS_Link Managers;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishCS_char *Product;
        RedfishServiceRoot_V1_4_1_ProtocolFeaturesSupported_CS *ProtocolFeaturesSupported;
...
|**Links**|RedfishServiceRoot_V1_4_1_Links_CS| Structure points to **Links** property.| Yes| No
...
|**ProtocolFeaturesSupported**|RedfishServiceRoot_V1_4_1_ProtocolFeaturesSupported_CS| Structure points to **ProtocolFeaturesSupported** property.| No| No
...
## Redfish ServiceRoot V1_4_1 to C Structure Function
    RedfishCS_status
    Json_ServiceRoot_V1_4_1_To_CS (RedfishCS_char *JsonRawText, RedfishServiceRoot_V1_4_1_ServiceRoot_CS **ReturnedCS);

## C Structure to Redfish ServiceRoot V1_4_1 JSON Function
    RedfishCS_status
    CS_To_ServiceRoot_V1_4_1_JSON (RedfishServiceRoot_V1_4_1_ServiceRoot_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ServiceRoot V1_4_1 C Structure Function
    RedfishCS_status
