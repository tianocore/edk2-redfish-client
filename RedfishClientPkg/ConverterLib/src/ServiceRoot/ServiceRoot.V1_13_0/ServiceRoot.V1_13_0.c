...
#include"Redfish_ServiceRoot_v1_13_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishServiceRoot_V1_13_0_ServiceRoot_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
...
//
static RedfishCS_status GenLinksCs(RedfishServiceRoot_V1_13_0_ServiceRoot_CS *Cs, json_t *JsonObj, char *Key, RedfishServiceRoot_V1_13_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishServiceRoot_V1_13_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
//Generate C structure for DeepOperations
//
static RedfishCS_status GenDeepOperationsCs(RedfishServiceRoot_V1_13_0_ServiceRoot_CS *Cs, json_t *JsonObj, char *Key, RedfishServiceRoot_V1_13_0_DeepOperations_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishServiceRoot_V1_13_0_DeepOperations_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // DeepPATCH
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "DeepPATCH", &(*Dst)->DeepPATCH);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // DeepPOST
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "DeepPOST", &(*Dst)->DeepPOST);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenExpandCs(RedfishServiceRoot_V1_13_0_ServiceRoot_CS *Cs, json_t *JsonObj, char *Key, RedfishServiceRoot_V1_13_0_Expand_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishServiceRoot_V1_13_0_Expand_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ExpandAll
...
//
static RedfishCS_status GenProtocolFeaturesSupportedCs(RedfishServiceRoot_V1_13_0_ServiceRoot_CS *Cs, json_t *JsonObj, char *Key, RedfishServiceRoot_V1_13_0_ProtocolFeaturesSupported_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishServiceRoot_V1_13_0_ProtocolFeaturesSupported_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // DeepOperations
  Status = GenDeepOperationsCs (Cs, TempJsonObj, "DeepOperations", &(*Dst)->DeepOperations);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishServiceRoot_V1_13_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ProtocolFeaturesSupportedDeepOperations(json_t *CsJson, char *Key, RedfishServiceRoot_V1_13_0_DeepOperations_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // DeepPATCH 
  if (InsertJsonBoolObj (CsJson, "DeepPATCH", CSPtr->DeepPATCH) != RedfishCS_status_success) {goto Error;}

  // DeepPOST 
  if (InsertJsonBoolObj (CsJson, "DeepPOST", CSPtr->DeepPOST) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_ProtocolFeaturesSupportedExpandQuery(json_t *CsJson, char *Key, RedfishServiceRoot_V1_13_0_Expand_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ProtocolFeaturesSupported(json_t *CsJson, char *Key, RedfishServiceRoot_V1_13_0_ProtocolFeaturesSupported_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // DeepOperations
  if (CS_To_JSON_ProtocolFeaturesSupportedDeepOperations(CsJson, "DeepOperations", CSPtr->DeepOperations) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for ServiceRoot.V1_13_0.ServiceRoot
//
RedfishCS_status CS_To_ServiceRoot_V1_13_0_JSON(RedfishServiceRoot_V1_13_0_ServiceRoot_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // AggregationService 
  if (InsertJsonLinkObj (CsJson, "AggregationService", &CSPtr->AggregationService) != RedfishCS_status_success) {goto Error;}

  // Cables 
  if (InsertJsonLinkObj (CsJson, "Cables", &CSPtr->Cables) != RedfishCS_status_success) {goto Error;}
  ...
  // ComponentIntegrity 
  if (InsertJsonLinkObj (CsJson, "ComponentIntegrity", &CSPtr->ComponentIntegrity) != RedfishCS_status_success) {goto Error;}
  ...
  // KeyService 
  if (InsertJsonLinkObj (CsJson, "KeyService", &CSPtr->KeyService) != RedfishCS_status_success) {goto Error;}

  // LicenseService 
  if (InsertJsonLinkObj (CsJson, "LicenseService", &CSPtr->LicenseService) != RedfishCS_status_success) {goto Error;}
  ...
  // NVMeDomains 
  if (InsertJsonLinkObj (CsJson, "NVMeDomains", &CSPtr->NVMeDomains) != RedfishCS_status_success) {goto Error;}
  ...
  // RegisteredClients 
  if (InsertJsonLinkObj (CsJson, "RegisteredClients", &CSPtr->RegisteredClients) != RedfishCS_status_success) {goto Error;}
  ...
  // ServiceConditions 
  if (InsertJsonLinkObj (CsJson, "ServiceConditions", &CSPtr->ServiceConditions) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for ServiceRoot.V1_13_0.ServiceRoot
//
RedfishCS_status DestroyServiceRoot_V1_13_0_CS(RedfishServiceRoot_V1_13_0_ServiceRoot_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ServiceRoot.V1_13_0.ServiceRoot
//
RedfishCS_status DestroyServiceRoot_V1_13_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ServiceRoot.V1_13_0.ServiceRoot
//
RedfishCS_status
Json_ServiceRoot_V1_13_0_To_CS(RedfishCS_char *JsonRawText, RedfishServiceRoot_V1_13_0_ServiceRoot_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishServiceRoot_V1_13_0_ServiceRoot_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ServiceRoot", "v1_13_0", "ServiceRoot", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishServiceRoot_V1_13_0_ServiceRoot_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // AggregationService
  InitializeLinkHead (&Cs->AggregationService);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "AggregationService", Cs->Header.ThisUri, &Cs->AggregationService);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Cables
  InitializeLinkHead (&Cs->Cables);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "Cables", Cs->Header.ThisUri, &Cs->Cables);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // ComponentIntegrity
  InitializeLinkHead (&Cs->ComponentIntegrity);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "ComponentIntegrity", Cs->Header.ThisUri, &Cs->ComponentIntegrity);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // KeyService
  InitializeLinkHead (&Cs->KeyService);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "KeyService", Cs->Header.ThisUri, &Cs->KeyService);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // LicenseService
  InitializeLinkHead (&Cs->LicenseService);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "LicenseService", Cs->Header.ThisUri, &Cs->LicenseService);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // NVMeDomains
  InitializeLinkHead (&Cs->NVMeDomains);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "NVMeDomains", Cs->Header.ThisUri, &Cs->NVMeDomains);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // RegisteredClients
  InitializeLinkHead (&Cs->RegisteredClients);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "RegisteredClients", Cs->Header.ThisUri, &Cs->RegisteredClients);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // ServiceConditions
  InitializeLinkHead (&Cs->ServiceConditions);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "ServiceConditions", Cs->Header.ThisUri, &Cs->ServiceConditions);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyServiceRoot_V1_13_0_CS (Cs);
  return Status;
}
