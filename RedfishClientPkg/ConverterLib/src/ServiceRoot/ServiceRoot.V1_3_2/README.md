# Definition of ServiceRoot.V1_3_2 and functions<br><br>
...
## ProtocolFeaturesSupported
    typedef struct _RedfishServiceRoot_V1_3_2_ProtocolFeaturesSupported_CS {
        RedfishServiceRoot_V1_3_2_Expand_CS *ExpandQuery;
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**ExpandQuery**|RedfishServiceRoot_V1_3_2_Expand_CS| Structure points to **ExpandQuery** property.| No| No
...
## ServiceRoot
    typedef struct _RedfishServiceRoot_V1_3_2_ServiceRoot_CS {
        ...
        RedfishServiceRoot_V1_3_2_Links_CS *Links;
        RedfishCS_Link Managers;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishCS_char *Product;
        RedfishServiceRoot_V1_3_2_ProtocolFeaturesSupported_CS *ProtocolFeaturesSupported;
...
|**Links**|RedfishServiceRoot_V1_3_2_Links_CS| Structure points to **Links** property.| Yes| No
...
|**ProtocolFeaturesSupported**|RedfishServiceRoot_V1_3_2_ProtocolFeaturesSupported_CS| Structure points to **ProtocolFeaturesSupported** property.| No| No
...
## Redfish ServiceRoot V1_3_2 to C Structure Function
    RedfishCS_status
    Json_ServiceRoot_V1_3_2_To_CS (RedfishCS_char *JsonRawText, RedfishServiceRoot_V1_3_2_ServiceRoot_CS **ReturnedCS);

## C Structure to Redfish ServiceRoot V1_3_2 JSON Function
    RedfishCS_status
    CS_To_ServiceRoot_V1_3_2_JSON (RedfishServiceRoot_V1_3_2_ServiceRoot_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ServiceRoot V1_3_2 C Structure Function
    RedfishCS_status
