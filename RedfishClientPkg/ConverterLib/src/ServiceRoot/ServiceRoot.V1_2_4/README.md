# Definition of ServiceRoot.V1_2_4 and functions<br><br>
...
## ServiceRoot
    typedef struct _RedfishServiceRoot_V1_2_4_ServiceRoot_CS {
        ...
        RedfishServiceRoot_V1_2_4_Links_CS *Links;
...
|**Links**|RedfishServiceRoot_V1_2_4_Links_CS| Structure points to **Links** property.| Yes| No
...
## Redfish ServiceRoot V1_2_4 to C Structure Function
    RedfishCS_status
    Json_ServiceRoot_V1_2_4_To_CS (RedfishCS_char *JsonRawText, RedfishServiceRoot_V1_2_4_ServiceRoot_CS **ReturnedCS);

## C Structure to Redfish ServiceRoot V1_2_4 JSON Function
    RedfishCS_status
    CS_To_ServiceRoot_V1_2_4_JSON (RedfishServiceRoot_V1_2_4_ServiceRoot_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ServiceRoot V1_2_4 C Structure Function
    RedfishCS_status
