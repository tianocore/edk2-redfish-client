# Definition of ServiceRoot.V1_11_0 and functions<br><br>
...
## ProtocolFeaturesSupported
    typedef struct _RedfishServiceRoot_V1_11_0_ProtocolFeaturesSupported_CS {
        RedfishServiceRoot_V1_11_0_DeepOperations_CS *DeepOperations;
        RedfishCS_bool *ExcerptQuery;
        RedfishServiceRoot_V1_11_0_Expand_CS *ExpandQuery;
...
|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**DeepOperations**|RedfishServiceRoot_V1_11_0_DeepOperations_CS| Structure points to **DeepOperations** property.| No| No
|**ExcerptQuery**|RedfishCS_bool| Boolean pointer to **ExcerptQuery** property.| No| Yes
|**ExpandQuery**|RedfishServiceRoot_V1_11_0_Expand_CS| Structure points to **ExpandQuery** property.| No| No
...
## ServiceRoot
    typedef struct _RedfishServiceRoot_V1_11_0_ServiceRoot_CS {
        ...
        RedfishServiceRoot_V1_11_0_Links_CS *Links;
        ...
        RedfishServiceRoot_V1_11_0_ProtocolFeaturesSupported_CS *ProtocolFeaturesSupported;
...
|**Links**|RedfishServiceRoot_V1_11_0_Links_CS| Structure points to **Links** property.| Yes| No
...
|**ProtocolFeaturesSupported**|RedfishServiceRoot_V1_11_0_ProtocolFeaturesSupported_CS| Structure points to **ProtocolFeaturesSupported** property.| No| No
...
## Redfish ServiceRoot V1_11_0 to C Structure Function
    RedfishCS_status
    Json_ServiceRoot_V1_11_0_To_CS (RedfishCS_char *JsonRawText, RedfishServiceRoot_V1_11_0_ServiceRoot_CS **ReturnedCS);

## C Structure to Redfish ServiceRoot V1_11_0 JSON Function
    RedfishCS_status
    CS_To_ServiceRoot_V1_11_0_JSON (RedfishServiceRoot_V1_11_0_ServiceRoot_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ServiceRoot V1_11_0 C Structure Function
    RedfishCS_status
