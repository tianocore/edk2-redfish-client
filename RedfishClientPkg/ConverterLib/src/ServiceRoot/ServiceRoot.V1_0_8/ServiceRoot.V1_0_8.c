...
#include"Redfish_ServiceRoot_v1_0_8_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishServiceRoot_V1_0_8_ServiceRoot_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
...
//
static RedfishCS_status GenLinksCs(RedfishServiceRoot_V1_0_8_ServiceRoot_CS *Cs, json_t *JsonObj, char *Key, RedfishServiceRoot_V1_0_8_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishServiceRoot_V1_0_8_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishServiceRoot_V1_0_8_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for ServiceRoot.V1_0_8.ServiceRoot
//
RedfishCS_status CS_To_ServiceRoot_V1_0_8_JSON(RedfishServiceRoot_V1_0_8_ServiceRoot_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ServiceRoot.V1_0_8.ServiceRoot
//
RedfishCS_status DestroyServiceRoot_V1_0_8_CS(RedfishServiceRoot_V1_0_8_ServiceRoot_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ServiceRoot.V1_0_8.ServiceRoot
//
RedfishCS_status DestroyServiceRoot_V1_0_8_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ServiceRoot.V1_0_8.ServiceRoot
//
RedfishCS_status
Json_ServiceRoot_V1_0_8_To_CS(RedfishCS_char *JsonRawText, RedfishServiceRoot_V1_0_8_ServiceRoot_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishServiceRoot_V1_0_8_ServiceRoot_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ServiceRoot", "v1_0_8", "ServiceRoot", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishServiceRoot_V1_0_8_ServiceRoot_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyServiceRoot_V1_0_8_CS (Cs);
  return Status;
}
