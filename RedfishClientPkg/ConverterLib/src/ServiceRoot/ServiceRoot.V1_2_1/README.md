# Definition of ServiceRoot.V1_2_1 and functions<br><br>
...
## ServiceRoot
    typedef struct _RedfishServiceRoot_V1_2_1_ServiceRoot_CS {
        ...
        RedfishServiceRoot_V1_2_1_Links_CS *Links;
...
|**Links**|RedfishServiceRoot_V1_2_1_Links_CS| Structure points to **Links** property.| Yes| No
...
## Redfish ServiceRoot V1_2_1 to C Structure Function
    RedfishCS_status
    Json_ServiceRoot_V1_2_1_To_CS (RedfishCS_char *JsonRawText, RedfishServiceRoot_V1_2_1_ServiceRoot_CS **ReturnedCS);

## C Structure to Redfish ServiceRoot V1_2_1 JSON Function
    RedfishCS_status
    CS_To_ServiceRoot_V1_2_1_JSON (RedfishServiceRoot_V1_2_1_ServiceRoot_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ServiceRoot V1_2_1 C Structure Function
    RedfishCS_status
