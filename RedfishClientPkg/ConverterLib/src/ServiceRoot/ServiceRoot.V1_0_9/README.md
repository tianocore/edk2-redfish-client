# Definition of ServiceRoot.V1_0_9 and functions<br><br>
...
## ServiceRoot
    typedef struct _RedfishServiceRoot_V1_0_9_ServiceRoot_CS {
        ...
        RedfishServiceRoot_V1_0_9_Links_CS *Links;
...
|**Links**|RedfishServiceRoot_V1_0_9_Links_CS| Structure points to **Links** property.| Yes| No
...
## Redfish ServiceRoot V1_0_9 to C Structure Function
    RedfishCS_status
    Json_ServiceRoot_V1_0_9_To_CS (RedfishCS_char *JsonRawText, RedfishServiceRoot_V1_0_9_ServiceRoot_CS **ReturnedCS);

## C Structure to Redfish ServiceRoot V1_0_9 JSON Function
    RedfishCS_status
    CS_To_ServiceRoot_V1_0_9_JSON (RedfishServiceRoot_V1_0_9_ServiceRoot_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ServiceRoot V1_0_9 C Structure Function
    RedfishCS_status
