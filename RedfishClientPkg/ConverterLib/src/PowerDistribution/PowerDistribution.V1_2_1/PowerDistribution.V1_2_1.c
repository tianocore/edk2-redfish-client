...
#include"Redfish_PowerDistribution_v1_2_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishPowerDistribution_V1_2_1_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #PowerDistribution.TransferControl
//
static RedfishCS_status GenTransferControlCs(RedfishPowerDistribution_V1_2_1_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerDistribution_V1_2_1_TransferControl_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerDistribution_V1_2_1_TransferControl_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishPowerDistribution_V1_2_1_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerDistribution_V1_2_1_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerDistribution_V1_2_1_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishPowerDistribution_V1_2_1_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerDistribution_V1_2_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerDistribution_V1_2_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenLinksCs(RedfishPowerDistribution_V1_2_1_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerDistribution_V1_2_1_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerDistribution_V1_2_1_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Chassis
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishPowerDistribution_V1_2_1_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishPowerDistribution_V1_2_1_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishPowerDistribution_V1_2_1_PowerDistribution_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishPowerDistribution_V1_2_1_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishPowerDistribution_V1_2_1_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenTransferConfigurationCs(RedfishPowerDistribution_V1_2_1_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerDistribution_V1_2_1_TransferConfiguration_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerDistribution_V1_2_1_TransferConfiguration_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ActiveMainsId
...
//
static RedfishCS_status GenTransferCriteriaCs(RedfishPowerDistribution_V1_2_1_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerDistribution_V1_2_1_TransferCriteria_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerDistribution_V1_2_1_TransferCriteria_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishPowerDistribution_V1_2_1_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsPowerDistribution_TransferControl(json_t *CsJson, char *Key, RedfishPowerDistribution_V1_2_1_TransferControl_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishPowerDistribution_V1_2_1_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishPowerDistribution_V1_2_1_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_TransferConfiguration(json_t *CsJson, char *Key, RedfishPowerDistribution_V1_2_1_TransferConfiguration_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_TransferCriteria(json_t *CsJson, char *Key, RedfishPowerDistribution_V1_2_1_TransferCriteria_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for PowerDistribution.V1_2_1.PowerDistribution
//
RedfishCS_status CS_To_PowerDistribution_V1_2_1_JSON(RedfishPowerDistribution_V1_2_1_PowerDistribution_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for PowerDistribution.V1_2_1.PowerDistribution
//
RedfishCS_status DestroyPowerDistribution_V1_2_1_CS(RedfishPowerDistribution_V1_2_1_PowerDistribution_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PowerDistribution.V1_2_1.PowerDistribution
//
RedfishCS_status DestroyPowerDistribution_V1_2_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PowerDistribution.V1_2_1.PowerDistribution
//
RedfishCS_status
Json_PowerDistribution_V1_2_1_To_CS(RedfishCS_char *JsonRawText, RedfishPowerDistribution_V1_2_1_PowerDistribution_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPowerDistribution_V1_2_1_PowerDistribution_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PowerDistribution", "v1_2_1", "PowerDistribution", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPowerDistribution_V1_2_1_PowerDistribution_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyPowerDistribution_V1_2_1_CS (Cs);
  return Status;
}
