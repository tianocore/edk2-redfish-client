# Definition of PowerDistribution.V1_1_1 and functions<br><br>
...
## Actions
    typedef struct _RedfishPowerDistribution_V1_1_1_Actions_CS {
        ...
        RedfishPowerDistribution_V1_1_1_OemActions_CS *Oem;
    } RedfishPowerDistribution_V1_1_1_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**PowerDistribution_TransferControl**|RedfishPowerDistribution_V1_1_1_TransferControl_CS| Structure points to **#PowerDistribution.TransferControl** property.| No| No
|**Oem**|RedfishPowerDistribution_V1_1_1_OemActions_CS| Structure points to **Oem** property.| No| No
...
## PowerDistribution
    typedef struct _RedfishPowerDistribution_V1_1_1_PowerDistribution_CS {
        ...
        RedfishPowerDistribution_V1_1_1_Actions_CS *Actions;
        ...
        RedfishCS_char *Id;
        RedfishPowerDistribution_V1_1_1_Links_CS *Links;
        ...
        RedfishPowerDistribution_V1_1_1_TransferConfiguration_CS *TransferConfiguration;
        RedfishPowerDistribution_V1_1_1_TransferCriteria_CS *TransferCriteria;
        RedfishCS_char *UUID;
...
|**Actions**|RedfishPowerDistribution_V1_1_1_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishPowerDistribution_V1_1_1_Links_CS| Structure points to **Links** property.| No| No
...
|**TransferConfiguration**|RedfishPowerDistribution_V1_1_1_TransferConfiguration_CS| Structure points to **TransferConfiguration** property.| No| No
|**TransferCriteria**|RedfishPowerDistribution_V1_1_1_TransferCriteria_CS| Structure points to **TransferCriteria** property.| No| No
|**UUID**|RedfishCS_char| String pointer to **UUID** property.| No| Yes
|**Version**|RedfishCS_char| String pointer to **Version** property.| No| Yes
## Redfish PowerDistribution V1_1_1 to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish PowerDistribution V1_1_1 JSON Function
    RedfishCS_status
    CS_To_PowerDistribution_V1_1_1_JSON (RedfishPowerDistribution_V1_1_1_PowerDistribution_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish PowerDistribution V1_1_1 C Structure Function
    RedfishCS_status
