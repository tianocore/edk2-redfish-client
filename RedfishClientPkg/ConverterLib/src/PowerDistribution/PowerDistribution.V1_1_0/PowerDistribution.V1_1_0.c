...
#include"Redfish_PowerDistribution_v1_1_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishPowerDistribution_V1_1_0_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for #PowerDistribution.TransferControl
//
static RedfishCS_status GenTransferControlCs(RedfishPowerDistribution_V1_1_0_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerDistribution_V1_1_0_TransferControl_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerDistribution_V1_1_0_TransferControl_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishPowerDistribution_V1_1_0_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerDistribution_V1_1_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerDistribution_V1_1_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishPowerDistribution_V1_1_0_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerDistribution_V1_1_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerDistribution_V1_1_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #PowerDistribution.TransferControl
  Status = GenTransferControlCs (Cs, TempJsonObj, "#PowerDistribution.TransferControl", &(*Dst)->PowerDistribution_TransferControl);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenLinksCs(RedfishPowerDistribution_V1_1_0_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerDistribution_V1_1_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerDistribution_V1_1_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Chassis
  ...
  // Facility
  InitializeLinkHead (&(*Dst)->Facility);
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "Facility", Cs->Header.ThisUri, &(*Dst)->Facility);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishPowerDistribution_V1_1_0_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishPowerDistribution_V1_1_0_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishPowerDistribution_V1_1_0_PowerDistribution_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishPowerDistribution_V1_1_0_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishPowerDistribution_V1_1_0_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
//Generate C structure for TransferConfiguration
//
static RedfishCS_status GenTransferConfigurationCs(RedfishPowerDistribution_V1_1_0_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerDistribution_V1_1_0_TransferConfiguration_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerDistribution_V1_1_0_TransferConfiguration_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ActiveMainsId
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "ActiveMainsId", &(*Dst)->ActiveMainsId);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // AutoTransferEnabled
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "AutoTransferEnabled", &(*Dst)->AutoTransferEnabled);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ClosedTransitionAllowed
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "ClosedTransitionAllowed", &(*Dst)->ClosedTransitionAllowed);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // ClosedTransitionTimeoutSeconds
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "ClosedTransitionTimeoutSeconds", &(*Dst)->ClosedTransitionTimeoutSeconds);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // PreferredMainsId
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "PreferredMainsId", &(*Dst)->PreferredMainsId);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // RetransferDelaySeconds
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "RetransferDelaySeconds", &(*Dst)->RetransferDelaySeconds);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // RetransferEnabled
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "RetransferEnabled", &(*Dst)->RetransferEnabled);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // TransferDelaySeconds
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "TransferDelaySeconds", &(*Dst)->TransferDelaySeconds);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // TransferInhibit
  Status = GetRedfishPropertyBoolean (Cs, TempJsonObj, "TransferInhibit", &(*Dst)->TransferInhibit);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for TransferCriteria
//
static RedfishCS_status GenTransferCriteriaCs(RedfishPowerDistribution_V1_1_0_PowerDistribution_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerDistribution_V1_1_0_TransferCriteria_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerDistribution_V1_1_0_TransferCriteria_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // OverNominalFrequencyHz
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "OverNominalFrequencyHz", &(*Dst)->OverNominalFrequencyHz);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // OverVoltageRMSPercentage
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "OverVoltageRMSPercentage", &(*Dst)->OverVoltageRMSPercentage);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // TransferSensitivity
  Status = GetRedfishPropertyStr (Cs, TempJsonObj, "TransferSensitivity", &(*Dst)->TransferSensitivity);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // UnderNominalFrequencyHz
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "UnderNominalFrequencyHz", &(*Dst)->UnderNominalFrequencyHz);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // UnderVoltageRMSPercentage
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "UnderVoltageRMSPercentage", &(*Dst)->UnderVoltageRMSPercentage);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishPowerDistribution_V1_1_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsPowerDistribution_TransferControl(json_t *CsJson, char *Key, RedfishPowerDistribution_V1_1_0_TransferControl_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishPowerDistribution_V1_1_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // #PowerDistribution.TransferControl
  if (CS_To_JSON_ActionsPowerDistribution_TransferControl(CsJson, "#PowerDistribution.TransferControl", CSPtr->PowerDistribution_TransferControl) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishPowerDistribution_V1_1_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  ...
  // Facility 
  if (InsertJsonLinkObj (CsJson, "Facility", &CSPtr->Facility) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_TransferConfiguration(json_t *CsJson, char *Key, RedfishPowerDistribution_V1_1_0_TransferConfiguration_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // ActiveMainsId 
  if (InsertJsonStringObj (CsJson, "ActiveMainsId", CSPtr->ActiveMainsId) != RedfishCS_status_success) {goto Error;}

  // AutoTransferEnabled 
  if (InsertJsonBoolObj (CsJson, "AutoTransferEnabled", CSPtr->AutoTransferEnabled) != RedfishCS_status_success) {goto Error;}

  // ClosedTransitionAllowed 
  if (InsertJsonBoolObj (CsJson, "ClosedTransitionAllowed", CSPtr->ClosedTransitionAllowed) != RedfishCS_status_success) {goto Error;}

  // ClosedTransitionTimeoutSeconds 
  if (InsertJsonInt64Obj (CsJson, "ClosedTransitionTimeoutSeconds", CSPtr->ClosedTransitionTimeoutSeconds) != RedfishCS_status_success) {goto Error;}

  // PreferredMainsId 
  if (InsertJsonStringObj (CsJson, "PreferredMainsId", CSPtr->PreferredMainsId) != RedfishCS_status_success) {goto Error;}

  // RetransferDelaySeconds 
  if (InsertJsonInt64Obj (CsJson, "RetransferDelaySeconds", CSPtr->RetransferDelaySeconds) != RedfishCS_status_success) {goto Error;}

  // RetransferEnabled 
  if (InsertJsonBoolObj (CsJson, "RetransferEnabled", CSPtr->RetransferEnabled) != RedfishCS_status_success) {goto Error;}

  // TransferDelaySeconds 
  if (InsertJsonInt64Obj (CsJson, "TransferDelaySeconds", CSPtr->TransferDelaySeconds) != RedfishCS_status_success) {goto Error;}

  // TransferInhibit 
  if (InsertJsonBoolObj (CsJson, "TransferInhibit", CSPtr->TransferInhibit) != RedfishCS_status_success) {goto Error;}

  return RedfishCS_status_success;
Error:;
  return RedfishCS_status_unsupported;
}
static RedfishCS_status CS_To_JSON_TransferCriteria(json_t *CsJson, char *Key, RedfishPowerDistribution_V1_1_0_TransferCriteria_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
  // OverNominalFrequencyHz 
  if (InsertJsonInt64Obj (CsJson, "OverNominalFrequencyHz", CSPtr->OverNominalFrequencyHz) != RedfishCS_status_success) {goto Error;}

  // OverVoltageRMSPercentage 
  if (InsertJsonInt64Obj (CsJson, "OverVoltageRMSPercentage", CSPtr->OverVoltageRMSPercentage) != RedfishCS_status_success) {goto Error;}

  // TransferSensitivity 
  if (InsertJsonStringObj (CsJson, "TransferSensitivity", CSPtr->TransferSensitivity) != RedfishCS_status_success) {goto Error;}

  // UnderNominalFrequencyHz 
  if (InsertJsonInt64Obj (CsJson, "UnderNominalFrequencyHz", CSPtr->UnderNominalFrequencyHz) != RedfishCS_status_success) {goto Error;}

  // UnderVoltageRMSPercentage 
  if (InsertJsonInt64Obj (CsJson, "UnderVoltageRMSPercentage", CSPtr->UnderVoltageRMSPercentage) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for PowerDistribution.V1_1_0.PowerDistribution
//
RedfishCS_status CS_To_PowerDistribution_V1_1_0_JSON(RedfishPowerDistribution_V1_1_0_PowerDistribution_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // Branches 
  if (InsertJsonLinkObj (CsJson, "Branches", &CSPtr->Branches) != RedfishCS_status_success) {goto Error;}

  // Description 
  if (InsertJsonStringObj (CsJson, "Description", CSPtr->Description) != RedfishCS_status_success) {goto Error;}

  // EquipmentType 
  if (InsertJsonStringObj (CsJson, "EquipmentType", CSPtr->EquipmentType) != RedfishCS_status_success) {goto Error;}

  // Feeders 
  if (InsertJsonLinkObj (CsJson, "Feeders", &CSPtr->Feeders) != RedfishCS_status_success) {goto Error;}
  ...
  // Mains 
  if (InsertJsonLinkObj (CsJson, "Mains", &CSPtr->Mains) != RedfishCS_status_success) {goto Error;}

  // MainsRedundancy 
  if (InsertJsonLinkObj (CsJson, "MainsRedundancy", &CSPtr->MainsRedundancy) != RedfishCS_status_success) {goto Error;}
  ...
  // OutletGroups 
  if (InsertJsonLinkObj (CsJson, "OutletGroups", &CSPtr->OutletGroups) != RedfishCS_status_success) {goto Error;}

  // Outlets 
  if (InsertJsonLinkObj (CsJson, "Outlets", &CSPtr->Outlets) != RedfishCS_status_success) {goto Error;}

  // PartNumber 
  if (InsertJsonStringObj (CsJson, "PartNumber", CSPtr->PartNumber) != RedfishCS_status_success) {goto Error;}

  // PowerSupplies 
  if (InsertJsonLinkObj (CsJson, "PowerSupplies", &CSPtr->PowerSupplies) != RedfishCS_status_success) {goto Error;}

  // PowerSupplyRedundancy 
  if (InsertJsonLinkArrayObj (CsJson, "PowerSupplyRedundancy", &CSPtr->PowerSupplyRedundancy) != RedfishCS_status_success) {goto Error;}
  ...
  // Subfeeds 
  if (InsertJsonLinkObj (CsJson, "Subfeeds", &CSPtr->Subfeeds) != RedfishCS_status_success) {goto Error;}

  // TransferConfiguration
  if (CS_To_JSON_TransferConfiguration(CsJson, "TransferConfiguration", CSPtr->TransferConfiguration) != RedfishCS_status_success) {goto Error;}

  // TransferCriteria
  if (CS_To_JSON_TransferCriteria(CsJson, "TransferCriteria", CSPtr->TransferCriteria) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for PowerDistribution.V1_1_0.PowerDistribution
//
RedfishCS_status DestroyPowerDistribution_V1_1_0_CS(RedfishPowerDistribution_V1_1_0_PowerDistribution_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PowerDistribution.V1_1_0.PowerDistribution
//
RedfishCS_status DestroyPowerDistribution_V1_1_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PowerDistribution.V1_1_0.PowerDistribution
//
RedfishCS_status
Json_PowerDistribution_V1_1_0_To_CS(RedfishCS_char *JsonRawText, RedfishPowerDistribution_V1_1_0_PowerDistribution_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPowerDistribution_V1_1_0_PowerDistribution_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PowerDistribution", "v1_1_0", "PowerDistribution", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPowerDistribution_V1_1_0_PowerDistribution_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // Branches
  InitializeLinkHead (&Cs->Branches);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "Branches", Cs->Header.ThisUri, &Cs->Branches);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // EquipmentType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "EquipmentType", &Cs->EquipmentType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){goto Error;}}

  // Feeders
  InitializeLinkHead (&Cs->Feeders);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "Feeders", Cs->Header.ThisUri, &Cs->Feeders);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // Mains
  InitializeLinkHead (&Cs->Mains);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "Mains", Cs->Header.ThisUri, &Cs->Mains);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // MainsRedundancy
  InitializeLinkHead (&Cs->MainsRedundancy);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "MainsRedundancy", Cs->Header.ThisUri, &Cs->MainsRedundancy);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // OutletGroups
  InitializeLinkHead (&Cs->OutletGroups);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "OutletGroups", Cs->Header.ThisUri, &Cs->OutletGroups);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Outlets
  InitializeLinkHead (&Cs->Outlets);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "Outlets", Cs->Header.ThisUri, &Cs->Outlets);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // PowerSupplies
  InitializeLinkHead (&Cs->PowerSupplies);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "PowerSupplies", Cs->Header.ThisUri, &Cs->PowerSupplies);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // PowerSupplyRedundancy
  InitializeLinkHead (&Cs->PowerSupplyRedundancy);
  Status = CreateCsUriOrJsonByNodeArray (Cs, JsonObj, "PowerSupplyRedundancy", Cs->Header.ThisUri, &Cs->PowerSupplyRedundancy);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // Subfeeds
  InitializeLinkHead (&Cs->Subfeeds);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "Subfeeds", Cs->Header.ThisUri, &Cs->Subfeeds);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // TransferConfiguration
  Status = GenTransferConfigurationCs (Cs, JsonObj, "TransferConfiguration", &Cs->TransferConfiguration);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // TransferCriteria
  Status = GenTransferCriteriaCs (Cs, JsonObj, "TransferCriteria", &Cs->TransferCriteria);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyPowerDistribution_V1_1_0_CS (Cs);
  return Status;
}
