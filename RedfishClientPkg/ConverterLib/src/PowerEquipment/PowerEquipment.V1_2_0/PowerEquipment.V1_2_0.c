...
#include"Redfish_PowerEquipment_v1_2_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishPowerEquipment_V1_2_0_PowerEquipment_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishPowerEquipment_V1_2_0_PowerEquipment_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerEquipment_V1_2_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerEquipment_V1_2_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishPowerEquipment_V1_2_0_PowerEquipment_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerEquipment_V1_2_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerEquipment_V1_2_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishPowerEquipment_V1_2_0_PowerEquipment_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerEquipment_V1_2_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerEquipment_V1_2_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ManagedBy
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishPowerEquipment_V1_2_0_PowerEquipment_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishPowerEquipment_V1_2_0_PowerEquipment_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishPowerEquipment_V1_2_0_PowerEquipment_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishPowerEquipment_V1_2_0_PowerEquipment_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishPowerEquipment_V1_2_0_PowerEquipment_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishPowerEquipment_V1_2_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishPowerEquipment_V1_2_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishPowerEquipment_V1_2_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for PowerEquipment.V1_2_0.PowerEquipment
//
RedfishCS_status CS_To_PowerEquipment_V1_2_0_JSON(RedfishPowerEquipment_V1_2_0_PowerEquipment_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // ElectricalBuses 
  if (InsertJsonLinkObj (CsJson, "ElectricalBuses", &CSPtr->ElectricalBuses) != RedfishCS_status_success) {goto Error;}

  // FloorPDUs 
  if (InsertJsonLinkObj (CsJson, "FloorPDUs", &CSPtr->FloorPDUs) != RedfishCS_status_success) {goto Error;}
  ...
  // PowerShelves 
  if (InsertJsonLinkObj (CsJson, "PowerShelves", &CSPtr->PowerShelves) != RedfishCS_status_success) {goto Error;}

  // RackPDUs 
  if (InsertJsonLinkObj (CsJson, "RackPDUs", &CSPtr->RackPDUs) != RedfishCS_status_success) {goto Error;}

  // Status
  if (CS_To_JSON_Status(CsJson, "Status", CSPtr->Status) != RedfishCS_status_success) {goto Error;}

  // Switchgear 
  if (InsertJsonLinkObj (CsJson, "Switchgear", &CSPtr->Switchgear) != RedfishCS_status_success) {goto Error;}

  // TransferSwitches 
  if (InsertJsonLinkObj (CsJson, "TransferSwitches", &CSPtr->TransferSwitches) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for PowerEquipment.V1_2_0.PowerEquipment
//
RedfishCS_status DestroyPowerEquipment_V1_2_0_CS(RedfishPowerEquipment_V1_2_0_PowerEquipment_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PowerEquipment.V1_2_0.PowerEquipment
//
RedfishCS_status DestroyPowerEquipment_V1_2_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PowerEquipment.V1_2_0.PowerEquipment
//
RedfishCS_status
Json_PowerEquipment_V1_2_0_To_CS(RedfishCS_char *JsonRawText, RedfishPowerEquipment_V1_2_0_PowerEquipment_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPowerEquipment_V1_2_0_PowerEquipment_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PowerEquipment", "v1_2_0", "PowerEquipment", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPowerEquipment_V1_2_0_PowerEquipment_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // ElectricalBuses
  InitializeLinkHead (&Cs->ElectricalBuses);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "ElectricalBuses", Cs->Header.ThisUri, &Cs->ElectricalBuses);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // FloorPDUs
  InitializeLinkHead (&Cs->FloorPDUs);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "FloorPDUs", Cs->Header.ThisUri, &Cs->FloorPDUs);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // PowerShelves
  InitializeLinkHead (&Cs->PowerShelves);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "PowerShelves", Cs->Header.ThisUri, &Cs->PowerShelves);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // RackPDUs
  InitializeLinkHead (&Cs->RackPDUs);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "RackPDUs", Cs->Header.ThisUri, &Cs->RackPDUs);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // Switchgear
  InitializeLinkHead (&Cs->Switchgear);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "Switchgear", Cs->Header.ThisUri, &Cs->Switchgear);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // TransferSwitches
  InitializeLinkHead (&Cs->TransferSwitches);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "TransferSwitches", Cs->Header.ThisUri, &Cs->TransferSwitches);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyPowerEquipment_V1_2_0_CS (Cs);
  return Status;
}
