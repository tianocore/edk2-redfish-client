...
#include"Redfish_PowerEquipment_v1_0_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishPowerEquipment_V1_0_0_PowerEquipment_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishPowerEquipment_V1_0_0_PowerEquipment_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerEquipment_V1_0_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerEquipment_V1_0_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishPowerEquipment_V1_0_0_PowerEquipment_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerEquipment_V1_0_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerEquipment_V1_0_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishPowerEquipment_V1_0_0_PowerEquipment_CS *Cs, json_t *JsonObj, char *Key, RedfishPowerEquipment_V1_0_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPowerEquipment_V1_0_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ManagedBy
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishPowerEquipment_V1_0_0_PowerEquipment_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenidRefCs(RedfishPowerEquipment_V1_0_0_PowerEquipment_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishPowerEquipment_V1_0_0_PowerEquipment_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishPowerEquipment_V1_0_0_PowerEquipment_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishPowerEquipment_V1_0_0_PowerEquipment_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishPowerEquipment_V1_0_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishPowerEquipment_V1_0_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishPowerEquipment_V1_0_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for PowerEquipment.V1_0_0.PowerEquipment
//
RedfishCS_status CS_To_PowerEquipment_V1_0_0_JSON(RedfishPowerEquipment_V1_0_0_PowerEquipment_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for PowerEquipment.V1_0_0.PowerEquipment
//
RedfishCS_status DestroyPowerEquipment_V1_0_0_CS(RedfishPowerEquipment_V1_0_0_PowerEquipment_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for PowerEquipment.V1_0_0.PowerEquipment
//
RedfishCS_status DestroyPowerEquipment_V1_0_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for PowerEquipment.V1_0_0.PowerEquipment
//
RedfishCS_status
Json_PowerEquipment_V1_0_0_To_CS(RedfishCS_char *JsonRawText, RedfishPowerEquipment_V1_0_0_PowerEquipment_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPowerEquipment_V1_0_0_PowerEquipment_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "PowerEquipment", "v1_0_0", "PowerEquipment", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPowerEquipment_V1_0_0_PowerEquipment_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyPowerEquipment_V1_0_0_CS (Cs);
  return Status;
}
