...
#include"Redfish_Storage_v1_6_3_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishStorage_V1_6_3_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenStatusCs(RedfishStorage_V1_6_3_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishStorage_V1_6_3_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for #Storage.SetEncryptionKey
//
static RedfishCS_status GenSetEncryptionKeyCs(RedfishStorage_V1_6_3_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_6_3_SetEncryptionKey_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_6_3_SetEncryptionKey_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishStorage_V1_6_3_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_6_3_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_6_3_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishStorage_V1_6_3_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_6_3_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_6_3_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenLinksCs(RedfishStorage_V1_6_3_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_6_3_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_6_3_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Enclosures
...
//
static RedfishCS_status GenidRefCs(RedfishStorage_V1_6_3_Storage_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishStorage_V1_6_3_Storage_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishStorage_V1_6_3_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//Generate C structure for Oem
//
static RedfishCS_status GenStorageControllerOemActionsCs(RedfishStorage_V1_6_3_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_6_3_StorageControllerOemActions_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_6_3_StorageControllerOemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  InitializeLinkHead (&(*Dst)->Prop);
...
//Generate C structure for Actions
//
static RedfishCS_status GenStorageControllerActionsCs(RedfishStorage_V1_6_3_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_6_3_StorageControllerActions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_6_3_StorageControllerActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenCacheSummaryCs(RedfishStorage_V1_6_3_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_6_3_CacheSummary_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_6_3_CacheSummary_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//Generate C structure for Links
//
static RedfishCS_status GenStorageControllerLinksCs(RedfishStorage_V1_6_3_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_6_3_StorageControllerLinks_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_6_3_StorageControllerLinks_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Endpoints
...
static RedfishCS_status GenStorageController_Array_ElementCs(RedfishStorage_V1_6_3_Storage_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishStorage_V1_6_3_StorageController_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishStorage_V1_6_3_StorageController_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // @odata.id
...
//
//Generate C structure for RedfishStorage_V1_6_3_StorageController_Array_CS
//
static RedfishCS_status GenStorageController_ArrayCs(RedfishStorage_V1_6_3_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_6_3_StorageController_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishStorage_V1_6_3_StorageController_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishStorage_V1_6_3_StorageController_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishStorage_V1_6_3_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsStorage_SetEncryptionKey(json_t *CsJson, char *Key, RedfishStorage_V1_6_3_SetEncryptionKey_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishStorage_V1_6_3_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishStorage_V1_6_3_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_StorageControllersActionsOem(json_t *CsJson, char *Key, RedfishStorage_V1_6_3_StorageControllerOemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_StorageControllersActions(json_t *CsJson, char *Key, RedfishStorage_V1_6_3_StorageControllerActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_StorageControllersCacheSummary(json_t *CsJson, char *Key, RedfishStorage_V1_6_3_CacheSummary_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_StorageControllersLinks(json_t *CsJson, char *Key, RedfishStorage_V1_6_3_StorageControllerLinks_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_StorageControllers(json_t *CsJson, char *Key, RedfishStorage_V1_6_3_StorageController_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishStorage_V1_6_3_StorageController_Array_CS *NextArray;
  RedfishStorage_V1_6_3_StorageController_CS *NextArrayItem;
...
//
// C structure to JSON for Storage.V1_6_3.Storage
//
RedfishCS_status CS_To_Storage_V1_6_3_JSON(RedfishStorage_V1_6_3_Storage_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Storage.V1_6_3.Storage
//
RedfishCS_status DestroyStorage_V1_6_3_CS(RedfishStorage_V1_6_3_Storage_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Storage.V1_6_3.Storage
//
RedfishCS_status DestroyStorage_V1_6_3_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Storage.V1_6_3.Storage
//
RedfishCS_status
Json_Storage_V1_6_3_To_CS(RedfishCS_char *JsonRawText, RedfishStorage_V1_6_3_Storage_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishStorage_V1_6_3_Storage_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Storage", "v1_6_3", "Storage", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishStorage_V1_6_3_Storage_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
