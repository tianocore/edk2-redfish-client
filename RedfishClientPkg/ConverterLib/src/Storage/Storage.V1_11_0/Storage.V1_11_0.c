...
#include"Redfish_Storage_v1_11_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishStorage_V1_11_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenStatusCs(RedfishStorage_V1_11_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishStorage_V1_11_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for #Storage.ResetToDefaults
//
static RedfishCS_status GenResetToDefaultsCs(RedfishStorage_V1_11_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_11_0_ResetToDefaults_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_11_0_ResetToDefaults_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenSetEncryptionKeyCs(RedfishStorage_V1_11_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_11_0_SetEncryptionKey_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_11_0_SetEncryptionKey_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // target
...
//
static RedfishCS_status GenOemActionsCs(RedfishStorage_V1_11_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_11_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_11_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishStorage_V1_11_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_11_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_11_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #Storage.ResetToDefaults
  Status = GenResetToDefaultsCs (Cs, TempJsonObj, "#Storage.ResetToDefaults", &(*Dst)->Storage_ResetToDefaults);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenLinksCs(RedfishStorage_V1_11_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_11_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_11_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Enclosures
  ...
  InitializeLinkHead (&(*Dst)->HostingStorageSystems);
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "HostingStorageSystems", Cs->Header.ThisUri, &(*Dst)->HostingStorageSystems);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // HostingStorageSystems@odata.count
  Status = GetRedfishPropertyInt64 (Cs, TempJsonObj, "HostingStorageSystems@odata.count", &(*Dst)->HostingStorageSystemsodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // SimpleStorage
  InitializeLinkHead (&(*Dst)->SimpleStorage);
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "SimpleStorage", Cs->Header.ThisUri, &(*Dst)->SimpleStorage);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
static RedfishCS_status GenidRefCs(RedfishStorage_V1_11_0_Storage_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishStorage_V1_11_0_Storage_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishStorage_V1_11_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//Generate C structure for Oem
//
static RedfishCS_status GenStorageControllerOemActionsCs(RedfishStorage_V1_11_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_11_0_StorageControllerOemActions_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_11_0_StorageControllerOemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  InitializeLinkHead (&(*Dst)->Prop);
...
//Generate C structure for Actions
//
static RedfishCS_status GenStorageControllerActionsCs(RedfishStorage_V1_11_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_11_0_StorageControllerActions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_11_0_StorageControllerActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenCacheSummaryCs(RedfishStorage_V1_11_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_11_0_CacheSummary_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_11_0_CacheSummary_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenRatesCs(RedfishStorage_V1_11_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_11_0_Rates_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_11_0_Rates_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//Generate C structure for Links
//
static RedfishCS_status GenStorageControllerLinksCs(RedfishStorage_V1_11_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_11_0_StorageControllerLinks_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishStorage_V1_11_0_StorageControllerLinks_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Endpoints
...
static RedfishCS_status GenStorageController_Array_ElementCs(RedfishStorage_V1_11_0_Storage_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishStorage_V1_11_0_StorageController_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishStorage_V1_11_0_StorageController_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // @odata.id
  ...
  // ControllerRates
  Status = GenRatesCs (Cs, TempJsonObj, "ControllerRates", &(*Dst)->ControllerRates);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // Measurements
  InitializeLinkHead (&(*Dst)->Measurements);
  Status = CreateCsUriOrJsonByNodeArray (Cs, TempJsonObj, "Measurements", Cs->Header.ThisUri, &(*Dst)->Measurements);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  Status = CreateCsUriOrJsonByNode (Cs, TempJsonObj, "Ports", Cs->Header.ThisUri, &(*Dst)->Ports);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // SupportedRAIDTypes
  Status = GenRedfishCS_char_ArrayCs (Cs, TempJsonObj, "SupportedRAIDTypes", &(*Dst)->SupportedRAIDTypes);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
//
//Generate C structure for RedfishStorage_V1_11_0_StorageController_Array_CS
//
static RedfishCS_status GenStorageController_ArrayCs(RedfishStorage_V1_11_0_Storage_CS *Cs, json_t *JsonObj, char *Key, RedfishStorage_V1_11_0_StorageController_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishStorage_V1_11_0_StorageController_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishStorage_V1_11_0_StorageController_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishStorage_V1_11_0_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsStorage_ResetToDefaults(json_t *CsJson, char *Key, RedfishStorage_V1_11_0_ResetToDefaults_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsStorage_SetEncryptionKey(json_t *CsJson, char *Key, RedfishStorage_V1_11_0_SetEncryptionKey_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishStorage_V1_11_0_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
  ...
  // #Storage.ResetToDefaults
  if (CS_To_JSON_ActionsStorage_ResetToDefaults(CsJson, "#Storage.ResetToDefaults", CSPtr->Storage_ResetToDefaults) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishStorage_V1_11_0_Links_CS *CSPtr)
{
  json_t *CsParentJson;
  ...
  // HostingStorageSystems 
  if (InsertJsonLinkArrayObj (CsJson, "HostingStorageSystems", &CSPtr->HostingStorageSystems) != RedfishCS_status_success) {goto Error;}

  // HostingStorageSystems@odata.count 
  if (InsertJsonInt64Obj (CsJson, "HostingStorageSystems@odata.count", CSPtr->HostingStorageSystemsodata_count) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_StorageControllersActionsOem(json_t *CsJson, char *Key, RedfishStorage_V1_11_0_StorageControllerOemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_StorageControllersActions(json_t *CsJson, char *Key, RedfishStorage_V1_11_0_StorageControllerActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_StorageControllersCacheSummaryStatusConditionsOriginOfCondition(json_t *CsJson, char *Key, Redfishodatav4_idRef_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_StorageControllersCacheSummaryStatusConditions(json_t *CsJson, char *Key, RedfishResource_Condition_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishResource_Condition_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_StorageControllersCacheSummaryStatus(json_t *CsJson, char *Key, RedfishResource_Status_CS *CSPtr)
{
  ...
  // Conditions
  if (CS_To_JSON_StorageControllersCacheSummaryStatusConditions(CsJson, "Conditions", CSPtr->Conditions) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_StorageControllersCacheSummary(json_t *CsJson, char *Key, RedfishStorage_V1_11_0_CacheSummary_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_StorageControllersControllerRates(json_t *CsJson, char *Key, RedfishStorage_V1_11_0_Rates_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_StorageControllersLinks(json_t *CsJson, char *Key, RedfishStorage_V1_11_0_StorageControllerLinks_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_StorageControllersStatusConditionsOriginOfCondition(json_t *CsJson, char *Key, Redfishodatav4_idRef_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_StorageControllersStatusConditions(json_t *CsJson, char *Key, RedfishResource_Condition_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishResource_Condition_Array_CS *NextArray;
...
static RedfishCS_status CS_To_JSON_StorageControllersStatus(json_t *CsJson, char *Key, RedfishResource_Status_CS *CSPtr)
{
  ...
  // Conditions
  if (CS_To_JSON_StorageControllersStatusConditions(CsJson, "Conditions", CSPtr->Conditions) != RedfishCS_status_success) {goto Error;}
...
static RedfishCS_status CS_To_JSON_StorageControllers(json_t *CsJson, char *Key, RedfishStorage_V1_11_0_StorageController_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishStorage_V1_11_0_StorageController_Array_CS *NextArray;
  RedfishStorage_V1_11_0_StorageController_CS *NextArrayItem;
  ...
  do {
    ...
    // Certificates 
    if (InsertJsonLinkObj (ArrayMember, "Certificates", &NextArrayItem->Certificates) != RedfishCS_status_success) {goto Error;}

    // ControllerRates
    if (CS_To_JSON_StorageControllersControllerRates(ArrayMember, "ControllerRates", NextArrayItem->ControllerRates) != RedfishCS_status_success) {goto Error;}
    ...
    // Measurements 
    if (InsertJsonLinkArrayObj (ArrayMember, "Measurements", &NextArrayItem->Measurements) != RedfishCS_status_success) {goto Error;}
    ...
    // Ports 
    if (InsertJsonLinkObj (ArrayMember, "Ports", &NextArrayItem->Ports) != RedfishCS_status_success) {goto Error;}
    ...
    // SupportedRAIDTypes 
    if (InsertJsonStringArrayObj (ArrayMember, "SupportedRAIDTypes", NextArrayItem->SupportedRAIDTypes) != RedfishCS_status_success) {goto Error;}
...
//
// C structure to JSON for Storage.V1_11_0.Storage
//
RedfishCS_status CS_To_Storage_V1_11_0_JSON(RedfishStorage_V1_11_0_Storage_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // ConsistencyGroups 
  if (InsertJsonLinkObj (CsJson, "ConsistencyGroups", &CSPtr->ConsistencyGroups) != RedfishCS_status_success) {goto Error;}

  // Controllers 
  if (InsertJsonLinkObj (CsJson, "Controllers", &CSPtr->Controllers) != RedfishCS_status_success) {goto Error;}
  ...
  // EndpointGroups 
  if (InsertJsonLinkObj (CsJson, "EndpointGroups", &CSPtr->EndpointGroups) != RedfishCS_status_success) {goto Error;}

  // FileSystems 
  if (InsertJsonLinkObj (CsJson, "FileSystems", &CSPtr->FileSystems) != RedfishCS_status_success) {goto Error;}
  ...
  // StoragePools 
  if (InsertJsonLinkObj (CsJson, "StoragePools", &CSPtr->StoragePools) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for Storage.V1_11_0.Storage
//
RedfishCS_status DestroyStorage_V1_11_0_CS(RedfishStorage_V1_11_0_Storage_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Storage.V1_11_0.Storage
//
RedfishCS_status DestroyStorage_V1_11_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Storage.V1_11_0.Storage
//
RedfishCS_status
Json_Storage_V1_11_0_To_CS(RedfishCS_char *JsonRawText, RedfishStorage_V1_11_0_Storage_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishStorage_V1_11_0_Storage_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Storage", "v1_11_0", "Storage", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishStorage_V1_11_0_Storage_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // ConsistencyGroups
  InitializeLinkHead (&Cs->ConsistencyGroups);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "ConsistencyGroups", Cs->Header.ThisUri, &Cs->ConsistencyGroups);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Controllers
  InitializeLinkHead (&Cs->Controllers);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "Controllers", Cs->Header.ThisUri, &Cs->Controllers);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // EndpointGroups
  InitializeLinkHead (&Cs->EndpointGroups);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "EndpointGroups", Cs->Header.ThisUri, &Cs->EndpointGroups);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // FileSystems
  InitializeLinkHead (&Cs->FileSystems);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "FileSystems", Cs->Header.ThisUri, &Cs->FileSystems);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // StoragePools
  InitializeLinkHead (&Cs->StoragePools);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "StoragePools", Cs->Header.ThisUri, &Cs->StoragePools);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
