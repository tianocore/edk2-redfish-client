# Definition of Storage.V1_7_0 and functions<br><br>
...
## Actions
    typedef struct _RedfishStorage_V1_7_0_Actions_CS {
        ...
        RedfishStorage_V1_7_0_OemActions_CS *Oem;
    } RedfishStorage_V1_7_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Storage_SetEncryptionKey**|RedfishStorage_V1_7_0_SetEncryptionKey_CS| Structure points to **#Storage.SetEncryptionKey** property.| No| No
|**Oem**|RedfishStorage_V1_7_0_OemActions_CS| Structure points to **Oem** property.| No| No
...
## StorageController
    typedef struct _RedfishStorage_V1_7_0_StorageController_CS {
        ...
        RedfishStorage_V1_7_0_StorageControllerActions_CS *Actions;
        RedfishCS_Link Assembly;
        RedfishCS_char *AssetTag;
        RedfishStorage_V1_7_0_CacheSummary_CS *CacheSummary;
        RedfishStorage_V1_7_0_Rates_CS *ControllerRates;
        RedfishCS_char *FirmwareVersion;
        RedfishCS_Link Identifiers;
        RedfishStorage_V1_7_0_StorageControllerLinks_CS *Links;
...
|**Actions**|RedfishStorage_V1_7_0_StorageControllerActions_CS| Structure points to **Actions** property.| No| No
|**Assembly**|RedfishCS_Link| Structure link list to **Assembly** property.| No| Yes
|**AssetTag**|RedfishCS_char| String pointer to **AssetTag** property.| No| No
|**CacheSummary**|RedfishStorage_V1_7_0_CacheSummary_CS| Structure points to **CacheSummary** property.| No| No
|**ControllerRates**|RedfishStorage_V1_7_0_Rates_CS| Structure points to **ControllerRates** property.| No| No
|**FirmwareVersion**|RedfishCS_char| String pointer to **FirmwareVersion** property.| No| Yes
|**Identifiers**|RedfishCS_Link| Structure link list to **Identifiers** property.| No| No
|**Links**|RedfishStorage_V1_7_0_StorageControllerLinks_CS| Structure points to **Links** property.| No| No
...
## StorageControllerActions
    typedef struct _RedfishStorage_V1_7_0_StorageControllerActions_CS {
        RedfishStorage_V1_7_0_StorageControllerOemActions_CS *Oem;
    } RedfishStorage_V1_7_0_StorageControllerActions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishStorage_V1_7_0_StorageControllerOemActions_CS| Structure points to **Oem** property.| No| No
...
## Storage
    typedef struct _RedfishStorage_V1_7_0_Storage_CS {
        ...
        RedfishStorage_V1_7_0_Actions_CS *Actions;
        RedfishCS_char *Description;
        RedfishCS_Link Drives;
        RedfishCS_int64 *Drivesodata_count;
        RedfishCS_char *Id;
        RedfishStorage_V1_7_0_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
        RedfishCS_Link Redundancy;
        RedfishCS_int64 *Redundancyodata_count;
        RedfishResource_Status_CS *Status;
        RedfishStorage_V1_7_0_StorageController_CS *StorageControllers;
...
|**Actions**|RedfishStorage_V1_7_0_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishStorage_V1_7_0_Links_CS| Structure points to **Links** property.| No| No
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
...
|**Status**|RedfishResource_Status_CS| Structure points to **Status** property.| No| No
|**StorageControllers**|RedfishStorage_V1_7_0_StorageController_CS| Structure points to **StorageControllers** property.| No| Yes
...
## Redfish Storage V1_7_0 to C Structure Function
    RedfishCS_status
    Json_Storage_V1_7_0_To_CS (RedfishCS_char *JsonRawText, RedfishStorage_V1_7_0_Storage_CS **ReturnedCS);

## C Structure to Redfish Storage V1_7_0 JSON Function
    RedfishCS_status
    CS_To_Storage_V1_7_0_JSON (RedfishStorage_V1_7_0_Storage_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Storage V1_7_0 C Structure Function
    RedfishCS_status
