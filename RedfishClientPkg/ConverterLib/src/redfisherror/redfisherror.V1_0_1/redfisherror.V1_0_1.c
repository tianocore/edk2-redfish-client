...
#include"Redfish_redfisherror_v1_0_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenRedfishErrorContentsCs(Redfishredfisherror_V1_0_1_RedfishError_CS *Cs, json_t *JsonObj, char *Key, Redfishredfisherror_V1_0_1_RedfishErrorContents_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(Redfishredfisherror_V1_0_1_RedfishErrorContents_CS), (RedfishCS_void **)Dst);
...
static RedfishCS_status CS_To_JSON_error(json_t *CsJson, char *Key, Redfishredfisherror_V1_0_1_RedfishErrorContents_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
//
// C structure to JSON for redfisherror.V1_0_1.RedfishError
//
RedfishCS_status CS_To_redfisherror_V1_0_1_JSON(Redfishredfisherror_V1_0_1_RedfishError_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for redfisherror.V1_0_1.RedfishError
//
RedfishCS_status Destroyredfisherror_V1_0_1_CS(Redfishredfisherror_V1_0_1_RedfishError_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for redfisherror.V1_0_1.RedfishError
//
RedfishCS_status Destroyredfisherror_V1_0_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for redfisherror.V1_0_1.RedfishError
//
RedfishCS_status
Json_redfisherror_V1_0_1_To_CS(RedfishCS_char *JsonRawText, Redfishredfisherror_V1_0_1_RedfishError_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  Redfishredfisherror_V1_0_1_RedfishError_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "redfisherror", "v1_0_1", "RedfishError", &JsonObj, (RedfishCS_void **)&Cs, sizeof (Redfishredfisherror_V1_0_1_RedfishError_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  Destroyredfisherror_V1_0_1_CS (Cs);
  return Status;
}
