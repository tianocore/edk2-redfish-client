...
#include"Redfish_Task_v1_5_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishTask_V1_5_1_Task_CS *Cs, json_t *JsonObj, char *Key, RedfishTask_V1_5_1_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTask_V1_5_1_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishTask_V1_5_1_Task_CS *Cs, json_t *JsonObj, char *Key, RedfishTask_V1_5_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTask_V1_5_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishTask_V1_5_1_Task_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
//
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishTask_V1_5_1_Task_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenPayloadCs(RedfishTask_V1_5_1_Task_CS *Cs, json_t *JsonObj, char *Key, RedfishTask_V1_5_1_Payload_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishTask_V1_5_1_Payload_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // HttpHeaders
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishTask_V1_5_1_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishTask_V1_5_1_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Payload(json_t *CsJson, char *Key, RedfishTask_V1_5_1_Payload_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Task.V1_5_1.Task
//
RedfishCS_status CS_To_Task_V1_5_1_JSON(RedfishTask_V1_5_1_Task_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // SubTasks 
  if (InsertJsonLinkObj (CsJson, "SubTasks", &CSPtr->SubTasks) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for Task.V1_5_1.Task
//
RedfishCS_status DestroyTask_V1_5_1_CS(RedfishTask_V1_5_1_Task_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Task.V1_5_1.Task
//
RedfishCS_status DestroyTask_V1_5_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Task.V1_5_1.Task
//
RedfishCS_status
Json_Task_V1_5_1_To_CS(RedfishCS_char *JsonRawText, RedfishTask_V1_5_1_Task_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishTask_V1_5_1_Task_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Task", "v1_5_1", "Task", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishTask_V1_5_1_Task_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // SubTasks
  InitializeLinkHead (&Cs->SubTasks);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "SubTasks", Cs->Header.ThisUri, &Cs->SubTasks);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
