# Definition of Task.V1_4_0 and functions<br><br>
...
## Actions
    typedef struct _RedfishTask_V1_4_0_Actions_CS {
        RedfishTask_V1_4_0_OemActions_CS *Oem;
    } RedfishTask_V1_4_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishTask_V1_4_0_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Task
    typedef struct _RedfishTask_V1_4_0_Task_CS {
        ...
        RedfishTask_V1_4_0_Actions_CS *Actions;
        ...
        RedfishTask_V1_4_0_Payload_CS *Payload;
...
|**Actions**|RedfishTask_V1_4_0_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Payload**|RedfishTask_V1_4_0_Payload_CS| Structure points to **Payload** property.| No| No
...
## Redfish Task V1_4_0 to C Structure Function
    RedfishCS_status
    Json_Task_V1_4_0_To_CS (RedfishCS_char *JsonRawText, RedfishTask_V1_4_0_Task_CS **ReturnedCS);

## C Structure to Redfish Task V1_4_0 JSON Function
    RedfishCS_status
    CS_To_Task_V1_4_0_JSON (RedfishTask_V1_4_0_Task_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Task V1_4_0 C Structure Function
    RedfishCS_status
