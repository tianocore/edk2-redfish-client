...
#include"Redfish_Task_v1_0_7_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishTask_V1_0_7_Task_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for Task.V1_0_7.Task
//
RedfishCS_status CS_To_Task_V1_0_7_JSON(RedfishTask_V1_0_7_Task_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Task.V1_0_7.Task
//
RedfishCS_status DestroyTask_V1_0_7_CS(RedfishTask_V1_0_7_Task_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Task.V1_0_7.Task
//
RedfishCS_status DestroyTask_V1_0_7_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Task.V1_0_7.Task
//
RedfishCS_status
Json_Task_V1_0_7_To_CS(RedfishCS_char *JsonRawText, RedfishTask_V1_0_7_Task_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishTask_V1_0_7_Task_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Task", "v1_0_7", "Task", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishTask_V1_0_7_Task_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
