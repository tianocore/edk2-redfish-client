# Definition of ConnectionMethodCollection and functions<br><br>
...
## Redfish ConnectionMethodCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish ConnectionMethodCollection  JSON Function
    RedfishCS_status
    CS_To_ConnectionMethodCollection_JSON (RedfishConnectionMethodCollection_ConnectionMethodCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish ConnectionMethodCollection  C Structure Function
    RedfishCS_status
