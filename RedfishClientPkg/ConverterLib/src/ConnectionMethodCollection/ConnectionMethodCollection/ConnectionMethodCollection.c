...
#include"Redfish_ConnectionMethodCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishConnectionMethodCollection_ConnectionMethodCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for ConnectionMethodCollection.ConnectionMethodCollection
//
RedfishCS_status CS_To_ConnectionMethodCollection_JSON(RedfishConnectionMethodCollection_ConnectionMethodCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for ConnectionMethodCollection.ConnectionMethodCollection
//
RedfishCS_status DestroyConnectionMethodCollection_CS(RedfishConnectionMethodCollection_ConnectionMethodCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for ConnectionMethodCollection.ConnectionMethodCollection
//
RedfishCS_status DestroyConnectionMethodCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for ConnectionMethodCollection.NOVERSIONED.ConnectionMethodCollection
//
RedfishCS_status
Json_ConnectionMethodCollection_To_CS(RedfishCS_char *JsonRawText, RedfishConnectionMethodCollection_ConnectionMethodCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishConnectionMethodCollection_ConnectionMethodCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "ConnectionMethodCollection", "noversioned", "ConnectionMethodCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishConnectionMethodCollection_ConnectionMethodCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyConnectionMethodCollection_CS (Cs);
  return Status;
}
