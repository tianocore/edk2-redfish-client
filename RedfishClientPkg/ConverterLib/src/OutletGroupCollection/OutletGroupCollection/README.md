# Definition of OutletGroupCollection and functions<br><br>
...
## Redfish OutletGroupCollection  to C Structure Function
    RedfishCS_status
...
## C Structure to Redfish OutletGroupCollection  JSON Function
    RedfishCS_status
    CS_To_OutletGroupCollection_JSON (RedfishOutletGroupCollection_OutletGroupCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish OutletGroupCollection  C Structure Function
    RedfishCS_status
