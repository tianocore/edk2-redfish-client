...
#include"Redfish_OutletGroupCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishOutletGroupCollection_OutletGroupCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for OutletGroupCollection.OutletGroupCollection
//
RedfishCS_status CS_To_OutletGroupCollection_JSON(RedfishOutletGroupCollection_OutletGroupCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for OutletGroupCollection.OutletGroupCollection
//
RedfishCS_status DestroyOutletGroupCollection_CS(RedfishOutletGroupCollection_OutletGroupCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for OutletGroupCollection.OutletGroupCollection
//
RedfishCS_status DestroyOutletGroupCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for OutletGroupCollection.NOVERSIONED.OutletGroupCollection
//
RedfishCS_status
Json_OutletGroupCollection_To_CS(RedfishCS_char *JsonRawText, RedfishOutletGroupCollection_OutletGroupCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishOutletGroupCollection_OutletGroupCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "OutletGroupCollection", "noversioned", "OutletGroupCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishOutletGroupCollection_OutletGroupCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyOutletGroupCollection_CS (Cs);
  return Status;
}
