...
#include"Redfish_CableCollection_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemCs(RedfishCableCollection_CableCollection_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
...
//
// C structure to JSON for CableCollection.CableCollection
//
RedfishCS_status CS_To_CableCollection_JSON(RedfishCableCollection_CableCollection_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for CableCollection.CableCollection
//
RedfishCS_status DestroyCableCollection_CS(RedfishCableCollection_CableCollection_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for CableCollection.CableCollection
//
RedfishCS_status DestroyCableCollection_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for CableCollection.NOVERSIONED.CableCollection
//
RedfishCS_status
Json_CableCollection_To_CS(RedfishCS_char *JsonRawText, RedfishCableCollection_CableCollection_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishCableCollection_CableCollection_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "CableCollection", "noversioned", "CableCollection", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishCableCollection_CableCollection_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
