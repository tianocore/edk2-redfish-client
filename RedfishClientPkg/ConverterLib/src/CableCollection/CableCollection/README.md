# Definition of CableCollection and functions<br><br>
...
## Redfish CableCollection  to C Structure Function
    RedfishCS_status
    Json_CableCollection_To_CS (RedfishCS_char *JsonRawText, RedfishCableCollection_CableCollection_CS **ReturnedCS);

## C Structure to Redfish CableCollection  JSON Function
    RedfishCS_status
    CS_To_CableCollection_JSON (RedfishCableCollection_CableCollection_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish CableCollection  C Structure Function
    RedfishCS_status
