# Definition of MetricReport.V1_1_5 and functions<br><br>

## Actions
    typedef struct _RedfishMetricReport_V1_1_5_Actions_CS {
        RedfishMetricReport_V1_1_5_OemActions_CS *Oem;
    } RedfishMetricReport_V1_1_5_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishMetricReport_V1_1_5_OemActions_CS| Structure points to **Oem** property.| No| No
...
## MetricReport
    typedef struct _RedfishMetricReport_V1_1_5_MetricReport_CS {
        ...
        RedfishMetricReport_V1_1_5_Actions_CS *Actions;
        RedfishCS_char *Description;
        RedfishCS_char *Id;
        RedfishCS_Link MetricReportDefinition;
        RedfishMetricReport_V1_1_5_MetricValue_CS *MetricValues;
        RedfishCS_char *Name;
...
|**Actions**|RedfishMetricReport_V1_1_5_Actions_CS| Structure points to **Actions** property.| No| No
...
|**MetricValues**|RedfishMetricReport_V1_1_5_MetricValue_CS| Structure points to **MetricValues** property.| No| No
|**Name**|RedfishCS_char| String pointer to **Name** property.| Yes| Yes
|**Oem**|RedfishResource_Oem_CS| Structure points to **Oem** property.| No| No
|**ReportSequence**|RedfishCS_char| String pointer to **ReportSequence** property.| No| Yes
|**Timestamp**|RedfishCS_char| String pointer to **Timestamp** property.| No| Yes
## Redfish MetricReport V1_1_5 to C Structure Function
    RedfishCS_status
    Json_MetricReport_V1_1_5_To_CS (RedfishCS_char *JsonRawText, RedfishMetricReport_V1_1_5_MetricReport_CS **ReturnedCS);

## C Structure to Redfish MetricReport V1_1_5 JSON Function
    RedfishCS_status
    CS_To_MetricReport_V1_1_5_JSON (RedfishMetricReport_V1_1_5_MetricReport_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish MetricReport V1_1_5 C Structure Function
    RedfishCS_status
