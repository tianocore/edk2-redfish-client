...
#include"Redfish_MetricReport_v1_1_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
//
static RedfishCS_status GenOemActionsCs(RedfishMetricReport_V1_1_0_MetricReport_CS *Cs, json_t *JsonObj, char *Key, RedfishMetricReport_V1_1_0_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMetricReport_V1_1_0_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishMetricReport_V1_1_0_MetricReport_CS *Cs, json_t *JsonObj, char *Key, RedfishMetricReport_V1_1_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishMetricReport_V1_1_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status GenMetricValue_Array_ElementCs(RedfishMetricReport_V1_1_0_MetricReport_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishMetricReport_V1_1_0_MetricValue_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishMetricReport_V1_1_0_MetricValue_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // MetricDefinition
...
//
//Generate C structure for RedfishMetricReport_V1_1_0_MetricValue_Array_CS
//
static RedfishCS_status GenMetricValue_ArrayCs(RedfishMetricReport_V1_1_0_MetricReport_CS *Cs, json_t *JsonObj, char *Key, RedfishMetricReport_V1_1_0_MetricValue_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishMetricReport_V1_1_0_MetricValue_Array_CS *ThisElement;
  ...
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishMetricReport_V1_1_0_MetricValue_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishMetricReport_V1_1_0_MetricReport_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishMetricReport_V1_1_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishMetricReport_V1_1_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_MetricValues(json_t *CsJson, char *Key, RedfishMetricReport_V1_1_0_MetricValue_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishMetricReport_V1_1_0_MetricValue_Array_CS *NextArray;
  RedfishMetricReport_V1_1_0_MetricValue_CS *NextArrayItem;
...
//
// C structure to JSON for MetricReport.V1_1_0.MetricReport
//
RedfishCS_status CS_To_MetricReport_V1_1_0_JSON(RedfishMetricReport_V1_1_0_MetricReport_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for MetricReport.V1_1_0.MetricReport
//
RedfishCS_status DestroyMetricReport_V1_1_0_CS(RedfishMetricReport_V1_1_0_MetricReport_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for MetricReport.V1_1_0.MetricReport
//
RedfishCS_status DestroyMetricReport_V1_1_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for MetricReport.V1_1_0.MetricReport
//
RedfishCS_status
Json_MetricReport_V1_1_0_To_CS(RedfishCS_char *JsonRawText, RedfishMetricReport_V1_1_0_MetricReport_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishMetricReport_V1_1_0_MetricReport_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "MetricReport", "v1_1_0", "MetricReport", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishMetricReport_V1_1_0_MetricReport_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyMetricReport_V1_1_0_CS (Cs);
  return Status;
}
