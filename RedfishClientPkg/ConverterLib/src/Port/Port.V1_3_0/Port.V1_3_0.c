...
#include"Redfish_Port_v1_3_0_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishPort_V1_3_0_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishPort_V1_3_0_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for #Port.Reset
//
static RedfishCS_status GenResetCs(RedfishPort_V1_3_0_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_3_0_Reset_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_3_0_Reset_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishPort_V1_3_0_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_3_0_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_3_0_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishPort_V1_3_0_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_3_0_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_3_0_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #Port.Reset
...
//
static RedfishCS_status GenEthernetPropertiesCs(RedfishPort_V1_3_0_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_3_0_EthernetProperties_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_3_0_EthernetProperties_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenFibreChannelPropertiesCs(RedfishPort_V1_3_0_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_3_0_FibreChannelProperties_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_3_0_FibreChannelProperties_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // FabricName
...
//
static RedfishCS_status GenGenZCs(RedfishPort_V1_3_0_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_3_0_GenZ_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_3_0_GenZ_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // LPRT
...
//Generate C structure for RedfishCS_int64_Array
//
static RedfishCS_status GenRedfishCS_int64_ArrayCs(RedfishPort_V1_3_0_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_int64_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
static RedfishCS_status GenConfiguredNetworkLink_Array_ElementCs(RedfishPort_V1_3_0_Port_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPort_V1_3_0_ConfiguredNetworkLink_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPort_V1_3_0_ConfiguredNetworkLink_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
//Generate C structure for RedfishPort_V1_3_0_ConfiguredNetworkLink_Array_CS
//
static RedfishCS_status GenConfiguredNetworkLink_ArrayCs(RedfishPort_V1_3_0_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_3_0_ConfiguredNetworkLink_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPort_V1_3_0_ConfiguredNetworkLink_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPort_V1_3_0_ConfiguredNetworkLink_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenLinkConfiguration_Array_ElementCs(RedfishPort_V1_3_0_Port_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPort_V1_3_0_LinkConfiguration_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPort_V1_3_0_LinkConfiguration_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
//Generate C structure for RedfishPort_V1_3_0_LinkConfiguration_Array_CS
//
static RedfishCS_status GenLinkConfiguration_ArrayCs(RedfishPort_V1_3_0_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_3_0_LinkConfiguration_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPort_V1_3_0_LinkConfiguration_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPort_V1_3_0_LinkConfiguration_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenLinksCs(RedfishPort_V1_3_0_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_3_0_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_3_0_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AssociatedEndpoints
...
//
static RedfishCS_status GenidRefCs(RedfishPort_V1_3_0_Port_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishPort_V1_3_0_Port_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishPort_V1_3_0_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenStatusCs(RedfishPort_V1_3_0_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishPort_V1_3_0_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_ActionsPort_Reset(json_t *CsJson, char *Key, RedfishPort_V1_3_0_Reset_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishPort_V1_3_0_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Ethernet(json_t *CsJson, char *Key, RedfishPort_V1_3_0_EthernetProperties_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_FibreChannel(json_t *CsJson, char *Key, RedfishPort_V1_3_0_FibreChannelProperties_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_GenZ(json_t *CsJson, char *Key, RedfishPort_V1_3_0_GenZ_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_LinkConfigurationConfiguredNetworkLinks(json_t *CsJson, char *Key, RedfishPort_V1_3_0_ConfiguredNetworkLink_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPort_V1_3_0_ConfiguredNetworkLink_Array_CS *NextArray;
  RedfishPort_V1_3_0_ConfiguredNetworkLink_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_LinkConfiguration(json_t *CsJson, char *Key, RedfishPort_V1_3_0_LinkConfiguration_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPort_V1_3_0_LinkConfiguration_Array_CS *NextArray;
  RedfishPort_V1_3_0_LinkConfiguration_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishPort_V1_3_0_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Port.V1_3_0.Port
//
RedfishCS_status CS_To_Port_V1_3_0_JSON(RedfishPort_V1_3_0_Port_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Port.V1_3_0.Port
//
RedfishCS_status DestroyPort_V1_3_0_CS(RedfishPort_V1_3_0_Port_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Port.V1_3_0.Port
//
RedfishCS_status DestroyPort_V1_3_0_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Port.V1_3_0.Port
//
RedfishCS_status
Json_Port_V1_3_0_To_CS(RedfishCS_char *JsonRawText, RedfishPort_V1_3_0_Port_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPort_V1_3_0_Port_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Port", "v1_3_0", "Port", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPort_V1_3_0_Port_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
