# Definition of Port.V1_1_6 and functions<br><br>

## Actions
    typedef struct _RedfishPort_V1_1_6_Actions_CS {
        RedfishPort_V1_1_6_Reset_CS *Port_Reset;
        RedfishPort_V1_1_6_OemActions_CS *Oem;
    } RedfishPort_V1_1_6_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Port_Reset**|RedfishPort_V1_1_6_Reset_CS| Structure points to **#Port.Reset** property.| No| No
|**Oem**|RedfishPort_V1_1_6_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Port
    typedef struct _RedfishPort_V1_1_6_Port_CS {
        ...
        RedfishPort_V1_1_6_Actions_CS *Actions;
        RedfishCS_int64 *CurrentSpeedGbps;
        RedfishCS_char *Description;
        RedfishCS_char *Id;
        RedfishPort_V1_1_6_Links_CS *Links;
...
|**Actions**|RedfishPort_V1_1_6_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishPort_V1_1_6_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish Port V1_1_6 to C Structure Function
    RedfishCS_status
    Json_Port_V1_1_6_To_CS (RedfishCS_char *JsonRawText, RedfishPort_V1_1_6_Port_CS **ReturnedCS);

## C Structure to Redfish Port V1_1_6 JSON Function
    RedfishCS_status
    CS_To_Port_V1_1_6_JSON (RedfishPort_V1_1_6_Port_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Port V1_1_6 C Structure Function
    RedfishCS_status
