...
#include"Redfish_Port_v1_4_1_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
static RedfishCS_status GenOemCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
static RedfishCS_status GenStatusCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Status_CS **Dst);
//
//Generate C structure for #Port.Reset
//
static RedfishCS_status GenResetCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_4_1_Reset_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_4_1_Reset_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenOemActionsCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_4_1_OemActions_CS **Dst)
{
  RedfishCS_status Status;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_4_1_OemActions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenActionsCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_4_1_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_4_1_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // #Port.Reset
...
//
static RedfishCS_status GenLLDPReceiveCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_4_1_LLDPReceive_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_4_1_LLDPReceive_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ChassisId
...
//
static RedfishCS_status GenLLDPTransmitCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_4_1_LLDPTransmit_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_4_1_LLDPTransmit_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // ChassisId
...
//
static RedfishCS_status GenEthernetPropertiesCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_4_1_EthernetProperties_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_4_1_EthernetProperties_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
static RedfishCS_status GenFibreChannelPropertiesCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_4_1_FibreChannelProperties_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_4_1_FibreChannelProperties_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
static RedfishCS_status GenFunctionMaxBandwidth_Array_ElementCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPort_V1_4_1_FunctionMaxBandwidth_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPort_V1_4_1_FunctionMaxBandwidth_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AllocationPercent
...
//
//Generate C structure for RedfishPort_V1_4_1_FunctionMaxBandwidth_Array_CS
//
static RedfishCS_status GenFunctionMaxBandwidth_ArrayCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_4_1_FunctionMaxBandwidth_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPort_V1_4_1_FunctionMaxBandwidth_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPort_V1_4_1_FunctionMaxBandwidth_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenFunctionMinBandwidth_Array_ElementCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPort_V1_4_1_FunctionMinBandwidth_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPort_V1_4_1_FunctionMinBandwidth_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AllocationPercent
...
//
//Generate C structure for RedfishPort_V1_4_1_FunctionMinBandwidth_Array_CS
//
static RedfishCS_status GenFunctionMinBandwidth_ArrayCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_4_1_FunctionMinBandwidth_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPort_V1_4_1_FunctionMinBandwidth_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPort_V1_4_1_FunctionMinBandwidth_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenGenZCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_4_1_GenZ_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_4_1_GenZ_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // LPRT
...
//Generate C structure for RedfishCS_int64_Array
//
static RedfishCS_status GenRedfishCS_int64_ArrayCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_int64_Array **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
static RedfishCS_status GenConfiguredNetworkLink_Array_ElementCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPort_V1_4_1_ConfiguredNetworkLink_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPort_V1_4_1_ConfiguredNetworkLink_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
//Generate C structure for RedfishPort_V1_4_1_ConfiguredNetworkLink_Array_CS
//
static RedfishCS_status GenConfiguredNetworkLink_ArrayCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_4_1_ConfiguredNetworkLink_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPort_V1_4_1_ConfiguredNetworkLink_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPort_V1_4_1_ConfiguredNetworkLink_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
static RedfishCS_status GenLinkConfiguration_Array_ElementCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishPort_V1_4_1_LinkConfiguration_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsZeroMemory(Cs, sizeof(RedfishPort_V1_4_1_LinkConfiguration_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
...
//
//Generate C structure for RedfishPort_V1_4_1_LinkConfiguration_Array_CS
//
static RedfishCS_status GenLinkConfiguration_ArrayCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_4_1_LinkConfiguration_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
  RedfishCS_uint64 Index;
  RedfishPort_V1_4_1_LinkConfiguration_Array_CS *ThisElement;
  ...
  ArraySize = json_array_size (TempJsonObj);
  Status = allocateArrayRecordCsMemory(Cs, sizeof (RedfishPort_V1_4_1_LinkConfiguration_Array_CS), ArraySize, (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  if (*Dst == NULL) {
...
//
static RedfishCS_status GenLinksCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_4_1_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_4_1_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // AssociatedEndpoints
...
//
static RedfishCS_status GenidRefCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, Redfishodatav4_idRef_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
static RedfishCS_status GenCondition_Array_ElementCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, RedfishCS_uint64 Index,  RedfishResource_Condition_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
...
//
static RedfishCS_status GenCondition_ArrayCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Condition_Array_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  RedfishCS_uint64 ArraySize;
...
//
static RedfishCS_status GenSFPCs(RedfishPort_V1_4_1_Port_CS *Cs, json_t *JsonObj, char *Key, RedfishPort_V1_4_1_SFP_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishPort_V1_4_1_SFP_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // FiberConnectionType
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishPort_V1_4_1_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_ActionsPort_Reset(json_t *CsJson, char *Key, RedfishPort_V1_4_1_Reset_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishPort_V1_4_1_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetLLDPReceive(json_t *CsJson, char *Key, RedfishPort_V1_4_1_LLDPReceive_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_EthernetLLDPTransmit(json_t *CsJson, char *Key, RedfishPort_V1_4_1_LLDPTransmit_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Ethernet(json_t *CsJson, char *Key, RedfishPort_V1_4_1_EthernetProperties_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_FibreChannel(json_t *CsJson, char *Key, RedfishPort_V1_4_1_FibreChannelProperties_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_FunctionMaxBandwidth(json_t *CsJson, char *Key, RedfishPort_V1_4_1_FunctionMaxBandwidth_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPort_V1_4_1_FunctionMaxBandwidth_Array_CS *NextArray;
  RedfishPort_V1_4_1_FunctionMaxBandwidth_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_FunctionMinBandwidth(json_t *CsJson, char *Key, RedfishPort_V1_4_1_FunctionMinBandwidth_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPort_V1_4_1_FunctionMinBandwidth_Array_CS *NextArray;
  RedfishPort_V1_4_1_FunctionMinBandwidth_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_GenZ(json_t *CsJson, char *Key, RedfishPort_V1_4_1_GenZ_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_LinkConfigurationConfiguredNetworkLinks(json_t *CsJson, char *Key, RedfishPort_V1_4_1_ConfiguredNetworkLink_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPort_V1_4_1_ConfiguredNetworkLink_Array_CS *NextArray;
  RedfishPort_V1_4_1_ConfiguredNetworkLink_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_LinkConfiguration(json_t *CsJson, char *Key, RedfishPort_V1_4_1_LinkConfiguration_Array_CS *CSPtr)
{
  json_t *ArrayJson;
  json_t *ArrayMember;
  RedfishPort_V1_4_1_LinkConfiguration_Array_CS *NextArray;
  RedfishPort_V1_4_1_LinkConfiguration_CS *NextArrayItem;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishPort_V1_4_1_Links_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_SFP(json_t *CsJson, char *Key, RedfishPort_V1_4_1_SFP_CS *CSPtr)
{
  json_t *CsParentJson;
...
//
// C structure to JSON for Port.V1_4_1.Port
//
RedfishCS_status CS_To_Port_V1_4_1_JSON(RedfishPort_V1_4_1_Port_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Port.V1_4_1.Port
//
RedfishCS_status DestroyPort_V1_4_1_CS(RedfishPort_V1_4_1_Port_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Port.V1_4_1.Port
//
RedfishCS_status DestroyPort_V1_4_1_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Port.V1_4_1.Port
//
RedfishCS_status
Json_Port_V1_4_1_To_CS(RedfishCS_char *JsonRawText, RedfishPort_V1_4_1_Port_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishPort_V1_4_1_Port_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Port", "v1_4_1", "Port", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishPort_V1_4_1_Port_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
