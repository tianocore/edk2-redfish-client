# Definition of Job.V1_0_1 and functions<br><br>

## Actions
    typedef struct _RedfishJob_V1_0_1_Actions_CS {
        RedfishJob_V1_0_1_OemActions_CS *Oem;
    } RedfishJob_V1_0_1_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishJob_V1_0_1_OemActions_CS| Structure points to **Oem** property.| No| No
...
## Job
    typedef struct _RedfishJob_V1_0_1_Job_CS {
        ...
        RedfishJob_V1_0_1_Actions_CS *Actions;
        ...
        RedfishJob_V1_0_1_Payload_CS *Payload;
...
|**Actions**|RedfishJob_V1_0_1_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Payload**|RedfishJob_V1_0_1_Payload_CS| Structure points to **Payload** property.| No| No
...
## Redfish Job V1_0_1 to C Structure Function
    RedfishCS_status
    Json_Job_V1_0_1_To_CS (RedfishCS_char *JsonRawText, RedfishJob_V1_0_1_Job_CS **ReturnedCS);

## C Structure to Redfish Job V1_0_1 JSON Function
    RedfishCS_status
    CS_To_Job_V1_0_1_JSON (RedfishJob_V1_0_1_Job_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish Job V1_0_1 C Structure Function
    RedfishCS_status
