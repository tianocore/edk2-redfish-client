...
#include"Redfish_Job_v1_0_5_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenRedfishCS_char_ArrayCs(RedfishJob_V1_0_5_Job_CS *Cs, json_t *JsonObj, char *Key, RedfishCS_char_Array **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishJob_V1_0_5_Job_CS *Cs, json_t *JsonObj, char *Key, RedfishJob_V1_0_5_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishJob_V1_0_5_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishJob_V1_0_5_Job_CS *Cs, json_t *JsonObj, char *Key, RedfishJob_V1_0_5_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishJob_V1_0_5_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//Generate C structure for Oem
//
static RedfishCS_status GenOemCs(RedfishJob_V1_0_5_Job_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst)
{
  RedfishCS_status Status;
  RedfishCS_Type_JSON_Data *CsTypeJson;
  RedfishCS_Type_EmptyProp_CS_Data *CsTypeEmptyPropCS;
...
//
static RedfishCS_status GenPayloadCs(RedfishJob_V1_0_5_Job_CS *Cs, json_t *JsonObj, char *Key, RedfishJob_V1_0_5_Payload_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishJob_V1_0_5_Payload_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // HttpHeaders
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishJob_V1_0_5_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishJob_V1_0_5_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Payload(json_t *CsJson, char *Key, RedfishJob_V1_0_5_Payload_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for Job.V1_0_5.Job
//
RedfishCS_status CS_To_Job_V1_0_5_JSON(RedfishJob_V1_0_5_Job_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for Job.V1_0_5.Job
//
RedfishCS_status DestroyJob_V1_0_5_CS(RedfishJob_V1_0_5_Job_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for Job.V1_0_5.Job
//
RedfishCS_status DestroyJob_V1_0_5_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for Job.V1_0_5.Job
//
RedfishCS_status
Json_Job_V1_0_5_To_CS(RedfishCS_char *JsonRawText, RedfishJob_V1_0_5_Job_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishJob_V1_0_5_Job_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "Job", "v1_0_5", "Job", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishJob_V1_0_5_Job_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
