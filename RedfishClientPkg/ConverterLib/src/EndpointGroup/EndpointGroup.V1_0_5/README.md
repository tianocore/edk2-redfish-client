# Definition of EndpointGroup.V1_0_5 and functions<br><br>
...
## EndpointGroup
    typedef struct _RedfishEndpointGroup_V1_0_5_EndpointGroup_CS {
        ...
        RedfishEndpointGroup_V1_0_5_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
...
|**Links**|RedfishEndpointGroup_V1_0_5_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish EndpointGroup V1_0_5 to C Structure Function
    RedfishCS_status
    Json_EndpointGroup_V1_0_5_To_CS (RedfishCS_char *JsonRawText, RedfishEndpointGroup_V1_0_5_EndpointGroup_CS **ReturnedCS);

## C Structure to Redfish EndpointGroup V1_0_5 JSON Function
    RedfishCS_status
    CS_To_EndpointGroup_V1_0_5_JSON (RedfishEndpointGroup_V1_0_5_EndpointGroup_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish EndpointGroup V1_0_5 C Structure Function
    RedfishCS_status
