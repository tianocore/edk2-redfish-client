# Definition of EndpointGroup.V1_2_0 and functions<br><br>

## Actions
    typedef struct _RedfishEndpointGroup_V1_2_0_Actions_CS {
        RedfishEndpointGroup_V1_2_0_OemActions_CS *Oem;
    } RedfishEndpointGroup_V1_2_0_Actions_CS;

|Field |C Structure Data Type|Description |Required Property|Read only Property
| ---  | --- | --- | --- | ---
|**Oem**|RedfishEndpointGroup_V1_2_0_OemActions_CS| Structure points to **Oem** property.| No| No
...
## EndpointGroup
    typedef struct _RedfishEndpointGroup_V1_2_0_EndpointGroup_CS {
        ...
        RedfishEndpointGroup_V1_2_0_Actions_CS *Actions;
        ...
        RedfishEndpointGroup_V1_2_0_Links_CS *Links;
        RedfishCS_char *Name;
        RedfishResource_Oem_CS *Oem;
...
|**Actions**|RedfishEndpointGroup_V1_2_0_Actions_CS| Structure points to **Actions** property.| No| No
...
|**Links**|RedfishEndpointGroup_V1_2_0_Links_CS| Structure points to **Links** property.| No| No
...
## Redfish EndpointGroup V1_2_0 to C Structure Function
    RedfishCS_status
    Json_EndpointGroup_V1_2_0_To_CS (RedfishCS_char *JsonRawText, RedfishEndpointGroup_V1_2_0_EndpointGroup_CS **ReturnedCS);

## C Structure to Redfish EndpointGroup V1_2_0 JSON Function
    RedfishCS_status
    CS_To_EndpointGroup_V1_2_0_JSON (RedfishEndpointGroup_V1_2_0_EndpointGroup_CS *CSPtr, RedfishCS_char **JsonText);

## Destory Redfish EndpointGroup V1_2_0 C Structure Function
    RedfishCS_status
