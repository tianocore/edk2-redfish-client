...
#include"Redfish_EndpointGroup_v1_1_4_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishEndpointGroup_V1_1_4_EndpointGroup_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishEndpointGroup_V1_1_4_EndpointGroup_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpointGroup_V1_1_4_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEndpointGroup_V1_1_4_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishEndpointGroup_V1_1_4_EndpointGroup_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpointGroup_V1_1_4_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEndpointGroup_V1_1_4_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishEndpointGroup_V1_1_4_EndpointGroup_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpointGroup_V1_1_4_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEndpointGroup_V1_1_4_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishEndpointGroup_V1_1_4_OemActions_CS *CSPtr)
{
  if (CSPtr == NULL) {
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishEndpointGroup_V1_1_4_Actions_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishEndpointGroup_V1_1_4_Links_CS *CSPtr)
{
  if (CSPtr == NULL) {
    return RedfishCS_status_success;
  }
...
//
// C structure to JSON for EndpointGroup.V1_1_4.EndpointGroup
//
RedfishCS_status CS_To_EndpointGroup_V1_1_4_JSON(RedfishEndpointGroup_V1_1_4_EndpointGroup_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
...
//
// Destory C Structure for EndpointGroup.V1_1_4.EndpointGroup
//
RedfishCS_status DestroyEndpointGroup_V1_1_4_CS(RedfishEndpointGroup_V1_1_4_EndpointGroup_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for EndpointGroup.V1_1_4.EndpointGroup
//
RedfishCS_status DestroyEndpointGroup_V1_1_4_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for EndpointGroup.V1_1_4.EndpointGroup
//
RedfishCS_status
Json_EndpointGroup_V1_1_4_To_CS(RedfishCS_char *JsonRawText, RedfishEndpointGroup_V1_1_4_EndpointGroup_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEndpointGroup_V1_1_4_EndpointGroup_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "EndpointGroup", "v1_1_4", "EndpointGroup", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEndpointGroup_V1_1_4_EndpointGroup_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
...
Error:;
  json_decref(JsonObj);
  DestroyEndpointGroup_V1_1_4_CS (Cs);
  return Status;
}
