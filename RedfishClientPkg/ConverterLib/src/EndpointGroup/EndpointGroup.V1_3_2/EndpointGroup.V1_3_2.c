...
#include"Redfish_EndpointGroup_v1_3_2_CS.h"
#include <stdlib.h>
#include <string.h>
#include <jansson.h>
...
static RedfishCS_status GenOemCs(RedfishEndpointGroup_V1_3_2_EndpointGroup_CS *Cs, json_t *JsonObj, char *Key, RedfishResource_Oem_CS **Dst);
//
//Generate C structure for Oem
//
static RedfishCS_status GenOemActionsCs(RedfishEndpointGroup_V1_3_2_EndpointGroup_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpointGroup_V1_3_2_OemActions_CS **Dst)
{
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEndpointGroup_V1_3_2_OemActions_CS), (RedfishCS_void **)Dst);
...
//
static RedfishCS_status GenActionsCs(RedfishEndpointGroup_V1_3_2_EndpointGroup_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpointGroup_V1_3_2_Actions_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEndpointGroup_V1_3_2_Actions_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Oem
...
//
static RedfishCS_status GenLinksCs(RedfishEndpointGroup_V1_3_2_EndpointGroup_CS *Cs, json_t *JsonObj, char *Key, RedfishEndpointGroup_V1_3_2_Links_CS **Dst)
{
  RedfishCS_status Status;
  json_t *TempJsonObj;
  ...
  Status = allocateRecordCsMemory(Cs, sizeof(RedfishEndpointGroup_V1_3_2_Links_CS), (RedfishCS_void **)Dst);
  if (Status != RedfishCS_status_success){
    goto Error;
  }
  // Connections
...
static RedfishCS_status CS_To_JSON_ActionsOem(json_t *CsJson, char *Key, RedfishEndpointGroup_V1_3_2_OemActions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Actions(json_t *CsJson, char *Key, RedfishEndpointGroup_V1_3_2_Actions_CS *CSPtr)
{
  json_t *CsParentJson;
...
static RedfishCS_status CS_To_JSON_Links(json_t *CsJson, char *Key, RedfishEndpointGroup_V1_3_2_Links_CS *CSPtr)
{
  json_t *CsParentJson;
...
//
// C structure to JSON for EndpointGroup.V1_3_2.EndpointGroup
//
RedfishCS_status CS_To_EndpointGroup_V1_3_2_JSON(RedfishEndpointGroup_V1_3_2_EndpointGroup_CS *CSPtr, RedfishCS_char **JsonText)
{
  json_t  *CsJson;
  ...
  // AccessState 
  if (InsertJsonStringObj (CsJson, "AccessState", CSPtr->AccessState) != RedfishCS_status_success) {goto Error;}
  ...
  // GroupType 
  if (InsertJsonStringObj (CsJson, "GroupType", CSPtr->GroupType) != RedfishCS_status_success) {goto Error;}

  // Id 
  if (InsertJsonStringObj (CsJson, "Id", CSPtr->Id) != RedfishCS_status_success) {goto Error;}

  // Identifier 
  if (InsertJsonLinkObj (CsJson, "Identifier", &CSPtr->Identifier) != RedfishCS_status_success) {goto Error;}
  ...
  // Preferred 
  if (InsertJsonBoolObj (CsJson, "Preferred", CSPtr->Preferred) != RedfishCS_status_success) {goto Error;}

  // TargetEndpointGroupIdentifier 
  if (InsertJsonInt64Obj (CsJson, "TargetEndpointGroupIdentifier", CSPtr->TargetEndpointGroupIdentifier) != RedfishCS_status_success) {goto Error;}
...
//
// Destory C Structure for EndpointGroup.V1_3_2.EndpointGroup
//
RedfishCS_status DestroyEndpointGroup_V1_3_2_CS(RedfishEndpointGroup_V1_3_2_EndpointGroup_CS *CSPtr)
{
  RedfishCS_status Status;
...
//
// Destory JSON text for EndpointGroup.V1_3_2.EndpointGroup
//
RedfishCS_status DestroyEndpointGroup_V1_3_2_Json(RedfishCS_char *JsonText)
{
...
//
//Generate C structure for EndpointGroup.V1_3_2.EndpointGroup
//
RedfishCS_status
Json_EndpointGroup_V1_3_2_To_CS(RedfishCS_char *JsonRawText, RedfishEndpointGroup_V1_3_2_EndpointGroup_CS **ReturnedCs)
{
  RedfishCS_status  Status;
  json_t *JsonObj;
  RedfishEndpointGroup_V1_3_2_EndpointGroup_CS *Cs;

  Status = CreateJsonPayloadAndCs (JsonRawText, "EndpointGroup", "v1_3_2", "EndpointGroup", &JsonObj, (RedfishCS_void **)&Cs, sizeof (RedfishEndpointGroup_V1_3_2_EndpointGroup_CS));
  if (Status != RedfishCS_status_success) {
    goto Error;
  }
  ...
  // AccessState
  Status = GetRedfishPropertyStr (Cs, JsonObj, "AccessState", &Cs->AccessState);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  Status = CreateCsUriOrJsonByNodeArray (Cs, JsonObj, "Endpoints", Cs->Header.ThisUri, &Cs->Endpoints);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // Endpoints@odata.count
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "Endpoints@odata.count", &Cs->Endpointsodata_count);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // GroupType
  Status = GetRedfishPropertyStr (Cs, JsonObj, "GroupType", &Cs->GroupType);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // Identifier
  InitializeLinkHead (&Cs->Identifier);
  Status = CreateCsUriOrJsonByNode (Cs, JsonObj, "Identifier", Cs->Header.ThisUri, &Cs->Identifier);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
  ...
  // Preferred
  Status = GetRedfishPropertyBoolean (Cs, JsonObj, "Preferred", &Cs->Preferred);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}

  // TargetEndpointGroupIdentifier
  Status = GetRedfishPropertyInt64 (Cs, JsonObj, "TargetEndpointGroupIdentifier", &Cs->TargetEndpointGroupIdentifier);
  if (Status != RedfishCS_status_success && Status != RedfishCS_status_not_found) {goto Error;}
  else {if (Status == RedfishCS_status_not_found){/*This is not the required property.*/}}
...
Error:;
  json_decref(JsonObj);
  DestroyEndpointGroup_V1_3_2_CS (Cs);
  return Status;
}
