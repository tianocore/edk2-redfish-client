...
#ifndef RedfishPower_V1_0_9_CSTRUCT_H_
#define RedfishPower_V1_0_9_CSTRUCT_H_
...
#endif
typedef struct _RedfishPower_V1_0_9_PowerControl_Array_CS RedfishPower_V1_0_9_PowerControl_Array_CS;
typedef struct _RedfishPower_V1_0_9_PowerSupply_Array_CS RedfishPower_V1_0_9_PowerSupply_Array_CS;
typedef struct _RedfishPower_V1_0_9_Voltage_Array_CS RedfishPower_V1_0_9_Voltage_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishPower_V1_0_9_Power_CS RedfishPower_V1_0_9_Power_CS;
typedef struct _RedfishPower_V1_0_9_PowerControl_CS RedfishPower_V1_0_9_PowerControl_CS;
typedef struct _RedfishPower_V1_0_9_PowerLimit_CS RedfishPower_V1_0_9_PowerLimit_CS;
typedef struct _RedfishPower_V1_0_9_PowerMetric_CS RedfishPower_V1_0_9_PowerMetric_CS;
typedef struct _RedfishPower_V1_0_9_PowerSupply_CS RedfishPower_V1_0_9_PowerSupply_CS;
typedef struct _RedfishPower_V1_0_9_Voltage_CS RedfishPower_V1_0_9_Voltage_CS;
...
typedef struct _RedfishPower_V1_0_9_PowerControl_CS {
    ...
    RedfishPower_V1_0_9_PowerLimit_CS     *PowerLimit;               // Power limit status and
                                                                     // configuration information for
                                                                     // this chassis.
    RedfishPower_V1_0_9_PowerMetric_CS    *PowerMetrics;             // Power readings for this
                                                                     // chassis.
...
typedef struct _RedfishPower_V1_0_9_Power_CS {
    ...
    RedfishResource_Oem_CS                       *Oem;                        // This is the
                                                                              ...
                                                                              // divide the Oem object into
                                                                              // sections.
    RedfishPower_V1_0_9_PowerControl_Array_CS    *PowerControl;               // This is the definition for
                                                                              // power control function (power
                                                                              // reading/limiting).
    RedfishCS_int64                              *PowerControlodata_count;
    RedfishPower_V1_0_9_PowerSupply_Array_CS     *PowerSupplies;              // Details of the power supplies
    ...
    RedfishCS_Link                               Redundancy;                  // Redundancy information for the
                                                                              ...
                                                                              // or device.
    RedfishCS_int64                              *Redundancyodata_count;  
    RedfishPower_V1_0_9_Voltage_Array_CS         *Voltages;                   // This is the definition for
                                                                              // voltage sensors.
...
typedef struct _RedfishPower_V1_0_9_PowerControl_Array_CS  {
    RedfishPower_V1_0_9_PowerControl_Array_CS    *Next;
    RedfishPower_V1_0_9_PowerControl_CS    *ArrayValue;
} RedfishPower_V1_0_9_PowerControl_Array_CS;

typedef struct _RedfishPower_V1_0_9_PowerSupply_Array_CS  {
    RedfishPower_V1_0_9_PowerSupply_Array_CS    *Next;
    RedfishPower_V1_0_9_PowerSupply_CS    *ArrayValue;
} RedfishPower_V1_0_9_PowerSupply_Array_CS;

typedef struct _RedfishPower_V1_0_9_Voltage_Array_CS  {
    RedfishPower_V1_0_9_Voltage_Array_CS    *Next;
    RedfishPower_V1_0_9_Voltage_CS    *ArrayValue;
} RedfishPower_V1_0_9_Voltage_Array_CS;
...
RedfishCS_status
Json_Power_V1_0_9_To_CS (char *JsonRawText, RedfishPower_V1_0_9_Power_CS **ReturnedCS);

RedfishCS_status
CS_To_Power_V1_0_9_JSON (RedfishPower_V1_0_9_Power_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPower_V1_0_9_CS (RedfishPower_V1_0_9_Power_CS *CSPtr);

RedfishCS_status
DestroyPower_V1_0_9_Json (RedfishCS_char *JsonText);
