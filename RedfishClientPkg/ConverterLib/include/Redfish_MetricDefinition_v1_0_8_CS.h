...
#ifndef RedfishMetricdefinition_V1_0_8_CSTRUCT_H_
#define RedfishMetricdefinition_V1_0_8_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMetricDefinition_V1_0_8_CalculationParamsType_Array_CS RedfishMetricDefinition_V1_0_8_CalculationParamsType_Array_CS;
typedef struct _RedfishMetricDefinition_V1_0_8_Wildcard_Array_CS RedfishMetricDefinition_V1_0_8_Wildcard_Array_CS;
typedef struct _RedfishMetricDefinition_V1_0_8_Actions_CS RedfishMetricDefinition_V1_0_8_Actions_CS;
typedef struct _RedfishMetricDefinition_V1_0_8_CalculationParamsType_CS RedfishMetricDefinition_V1_0_8_CalculationParamsType_CS;
typedef struct _RedfishMetricDefinition_V1_0_8_MetricDefinition_CS RedfishMetricDefinition_V1_0_8_MetricDefinition_CS;
typedef struct _RedfishMetricDefinition_V1_0_8_OemActions_CS RedfishMetricDefinition_V1_0_8_OemActions_CS;
typedef struct _RedfishMetricDefinition_V1_0_8_Wildcard_CS RedfishMetricDefinition_V1_0_8_Wildcard_CS;
...
typedef struct _RedfishMetricDefinition_V1_0_8_Actions_CS {
    RedfishMetricDefinition_V1_0_8_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishMetricDefinition_V1_0_8_MetricDefinition_CS {
    ...
    RedfishMetricDefinition_V1_0_8_Actions_CS                        *Actions;                   // The available actions for this
                                                                                                 // resource.
    ...
    RedfishCS_char                                                   *CalculationAlgorithm;      // The calculation that is
                                                                                                 ...
                                                                                                 // defined.
    RedfishMetricDefinition_V1_0_8_CalculationParamsType_Array_CS    *CalculationParameters;     // The metric properties that are
    ...
    RedfishCS_char                                                   *Units;                     // The units of measure for this
                                                                                                 // metric.
    RedfishMetricDefinition_V1_0_8_Wildcard_Array_CS                 *Wildcards;                 // The wildcards and their
...
typedef struct _RedfishMetricDefinition_V1_0_8_CalculationParamsType_Array_CS  {
    RedfishMetricDefinition_V1_0_8_CalculationParamsType_Array_CS    *Next;
    RedfishMetricDefinition_V1_0_8_CalculationParamsType_CS    *ArrayValue;
} RedfishMetricDefinition_V1_0_8_CalculationParamsType_Array_CS;

typedef struct _RedfishMetricDefinition_V1_0_8_Wildcard_Array_CS  {
    RedfishMetricDefinition_V1_0_8_Wildcard_Array_CS    *Next;
    RedfishMetricDefinition_V1_0_8_Wildcard_CS    *ArrayValue;
} RedfishMetricDefinition_V1_0_8_Wildcard_Array_CS;

RedfishCS_status
Json_MetricDefinition_V1_0_8_To_CS (char *JsonRawText, RedfishMetricDefinition_V1_0_8_MetricDefinition_CS **ReturnedCS);

RedfishCS_status
CS_To_MetricDefinition_V1_0_8_JSON (RedfishMetricDefinition_V1_0_8_MetricDefinition_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMetricDefinition_V1_0_8_CS (RedfishMetricDefinition_V1_0_8_MetricDefinition_CS *CSPtr);

RedfishCS_status
DestroyMetricDefinition_V1_0_8_Json (RedfishCS_char *JsonText);
