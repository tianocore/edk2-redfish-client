...
#ifndef RedfishTaskservice_V1_1_4_CSTRUCT_H_
#define RedfishTaskservice_V1_1_4_CSTRUCT_H_
...
typedef struct _RedfishTaskService_V1_1_4_Actions_CS RedfishTaskService_V1_1_4_Actions_CS;
typedef struct _RedfishTaskService_V1_1_4_OemActions_CS RedfishTaskService_V1_1_4_OemActions_CS;
typedef struct _RedfishTaskService_V1_1_4_TaskService_CS RedfishTaskService_V1_1_4_TaskService_CS;
...
typedef struct _RedfishTaskService_V1_1_4_Actions_CS {
    RedfishTaskService_V1_1_4_OemActions_CS    *Oem;    // The available OEM-specific
...
// and has links to the actual Resource Collection of Tasks.
//
typedef struct _RedfishTaskService_V1_1_4_TaskService_CS {
    ...
    RedfishTaskService_V1_1_4_Actions_CS    *Actions;                           // The available actions for this
                                                                                // Resource.
    ...
    RedfishCS_Link                          Tasks;                              // The links to the Tasks
                                                                                // collection.
...
RedfishCS_status
Json_TaskService_V1_1_4_To_CS (char *JsonRawText, RedfishTaskService_V1_1_4_TaskService_CS **ReturnedCS);

RedfishCS_status
CS_To_TaskService_V1_1_4_JSON (RedfishTaskService_V1_1_4_TaskService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyTaskService_V1_1_4_CS (RedfishTaskService_V1_1_4_TaskService_CS *CSPtr);

RedfishCS_status
DestroyTaskService_V1_1_4_Json (RedfishCS_char *JsonText);
