...
#ifndef RedfishResourceblock_V1_1_5_CSTRUCT_H_
#define RedfishResourceblock_V1_1_5_CSTRUCT_H_
...
typedef struct _RedfishResourceBlock_V1_1_5_Actions_CS RedfishResourceBlock_V1_1_5_Actions_CS;
typedef struct _RedfishResourceBlock_V1_1_5_CompositionStatus_CS RedfishResourceBlock_V1_1_5_CompositionStatus_CS;
typedef struct _RedfishResourceBlock_V1_1_5_Links_CS RedfishResourceBlock_V1_1_5_Links_CS;
typedef struct _RedfishResourceBlock_V1_1_5_OemActions_CS RedfishResourceBlock_V1_1_5_OemActions_CS;
typedef struct _RedfishResourceBlock_V1_1_5_ResourceBlock_CS RedfishResourceBlock_V1_1_5_ResourceBlock_CS;
...
//
typedef struct _RedfishResourceBlock_V1_1_5_Actions_CS {
    RedfishResourceBlock_V1_1_5_OemActions_CS    *Oem;    // The available OEM-specific
                                                         // actions for this resource.
} RedfishResourceBlock_V1_1_5_Actions_CS;

//
// Composition status of the resource block.
//
typedef struct _RedfishResourceBlock_V1_1_5_CompositionStatus_CS {
...
} RedfishResourceBlock_V1_1_5_CompositionStatus_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishResourceBlock_V1_1_5_Links_CS {
...
} RedfishResourceBlock_V1_1_5_Links_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishResourceBlock_V1_1_5_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishResourceBlock_V1_1_5_OemActions_CS;
...
//
typedef struct _RedfishResourceBlock_V1_1_5_ResourceBlock_CS {
    RedfishCS_Header                                    Header;
    RedfishCS_char                                      *odata_context;               
    RedfishCS_char                                      *odata_etag;                  
    RedfishCS_char                                      *odata_id;                    
    RedfishCS_char                                      *odata_type;                  
    RedfishResourceBlock_V1_1_5_Actions_CS              *Actions;                         // The available actions for this
                                                                                          // resource.
    RedfishResourceBlock_V1_1_5_CompositionStatus_CS    *CompositionStatus;               // The composition status details
    ...
    RedfishCS_char                                      *Id;                          
    RedfishResourceBlock_V1_1_5_Links_CS                *Links;                           // The links to other resources
...
} RedfishResourceBlock_V1_1_5_ResourceBlock_CS;
...
RedfishCS_status
Json_ResourceBlock_V1_1_5_To_CS (char *JsonRawText, RedfishResourceBlock_V1_1_5_ResourceBlock_CS **ReturnedCS);

RedfishCS_status
CS_To_ResourceBlock_V1_1_5_JSON (RedfishResourceBlock_V1_1_5_ResourceBlock_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyResourceBlock_V1_1_5_CS (RedfishResourceBlock_V1_1_5_ResourceBlock_CS *CSPtr);
