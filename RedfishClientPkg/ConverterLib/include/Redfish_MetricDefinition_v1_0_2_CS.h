...
#ifndef RedfishMetricdefinition_V1_0_2_CSTRUCT_H_
#define RedfishMetricdefinition_V1_0_2_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMetricDefinition_V1_0_2_CalculationParamsType_Array_CS RedfishMetricDefinition_V1_0_2_CalculationParamsType_Array_CS;
typedef struct _RedfishMetricDefinition_V1_0_2_Wildcard_Array_CS RedfishMetricDefinition_V1_0_2_Wildcard_Array_CS;
typedef struct _RedfishMetricDefinition_V1_0_2_Actions_CS RedfishMetricDefinition_V1_0_2_Actions_CS;
typedef struct _RedfishMetricDefinition_V1_0_2_CalculationParamsType_CS RedfishMetricDefinition_V1_0_2_CalculationParamsType_CS;
typedef struct _RedfishMetricDefinition_V1_0_2_MetricDefinition_CS RedfishMetricDefinition_V1_0_2_MetricDefinition_CS;
typedef struct _RedfishMetricDefinition_V1_0_2_OemActions_CS RedfishMetricDefinition_V1_0_2_OemActions_CS;
typedef struct _RedfishMetricDefinition_V1_0_2_Wildcard_CS RedfishMetricDefinition_V1_0_2_Wildcard_CS;
...
typedef struct _RedfishMetricDefinition_V1_0_2_Actions_CS {
    RedfishMetricDefinition_V1_0_2_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishMetricDefinition_V1_0_2_MetricDefinition_CS {
    ...
    RedfishMetricDefinition_V1_0_2_Actions_CS                        *Actions;                   // The available actions for this
                                                                                                 // resource.
    ...
    RedfishCS_char                                                   *CalculationAlgorithm;      // The calculation which is
                                                                                                 ...
                                                                                                 // defined.
    RedfishMetricDefinition_V1_0_2_CalculationParamsType_Array_CS    *CalculationParameters;     // Specifies the metric
    ...
    RedfishCS_char                                                   *Units;                     // The units of measure for this
                                                                                                 // metric.
    RedfishMetricDefinition_V1_0_2_Wildcard_Array_CS                 *Wildcards;                 // A list of wildcards and their
...
typedef struct _RedfishMetricDefinition_V1_0_2_CalculationParamsType_Array_CS  {
    RedfishMetricDefinition_V1_0_2_CalculationParamsType_Array_CS    *Next;
    RedfishMetricDefinition_V1_0_2_CalculationParamsType_CS    *ArrayValue;
} RedfishMetricDefinition_V1_0_2_CalculationParamsType_Array_CS;

typedef struct _RedfishMetricDefinition_V1_0_2_Wildcard_Array_CS  {
    RedfishMetricDefinition_V1_0_2_Wildcard_Array_CS    *Next;
    RedfishMetricDefinition_V1_0_2_Wildcard_CS    *ArrayValue;
} RedfishMetricDefinition_V1_0_2_Wildcard_Array_CS;

RedfishCS_status
Json_MetricDefinition_V1_0_2_To_CS (char *JsonRawText, RedfishMetricDefinition_V1_0_2_MetricDefinition_CS **ReturnedCS);

RedfishCS_status
CS_To_MetricDefinition_V1_0_2_JSON (RedfishMetricDefinition_V1_0_2_MetricDefinition_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMetricDefinition_V1_0_2_CS (RedfishMetricDefinition_V1_0_2_MetricDefinition_CS *CSPtr);

RedfishCS_status
DestroyMetricDefinition_V1_0_2_Json (RedfishCS_char *JsonText);
