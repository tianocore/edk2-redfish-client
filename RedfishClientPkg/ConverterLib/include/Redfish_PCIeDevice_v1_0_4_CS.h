...
#ifndef RedfishPciedevice_V1_0_4_CSTRUCT_H_
#define RedfishPciedevice_V1_0_4_CSTRUCT_H_
...
#endif
typedef struct _RedfishPCIeDevice_V1_0_4_Links_CS RedfishPCIeDevice_V1_0_4_Links_CS;
typedef struct _RedfishPCIeDevice_V1_0_4_PCIeDevice_CS RedfishPCIeDevice_V1_0_4_PCIeDevice_CS;
...
//
typedef struct _RedfishPCIeDevice_V1_0_4_Links_CS {
...
} RedfishPCIeDevice_V1_0_4_Links_CS;
...
//
typedef struct _RedfishPCIeDevice_V1_0_4_PCIeDevice_CS {
    ...
    RedfishCS_char                       *FirmwareVersion;    // The version of firmware for
                                                             // this PCIe device.
    RedfishCS_char                       *Id;            
    RedfishPCIeDevice_V1_0_4_Links_CS    *Links;             // The links object contains the
...
} RedfishPCIeDevice_V1_0_4_PCIeDevice_CS;
...
RedfishCS_status
Json_PCIeDevice_V1_0_4_To_CS (char *JsonRawText, RedfishPCIeDevice_V1_0_4_PCIeDevice_CS **ReturnedCS);

RedfishCS_status
CS_To_PCIeDevice_V1_0_4_JSON (RedfishPCIeDevice_V1_0_4_PCIeDevice_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPCIeDevice_V1_0_4_CS (RedfishPCIeDevice_V1_0_4_PCIeDevice_CS *CSPtr);

RedfishCS_status
DestroyPCIeDevice_V1_0_4_Json (RedfishCS_char *JsonText);
