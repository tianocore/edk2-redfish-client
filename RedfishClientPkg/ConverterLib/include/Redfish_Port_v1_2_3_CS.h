...
#ifndef RedfishPort_V1_2_3_CSTRUCT_H_
#define RedfishPort_V1_2_3_CSTRUCT_H_
...
#endif
typedef struct _RedfishPort_V1_2_3_Actions_CS RedfishPort_V1_2_3_Actions_CS;
typedef struct _RedfishPort_V1_2_3_GenZ_CS RedfishPort_V1_2_3_GenZ_CS;
typedef struct _RedfishPort_V1_2_3_Links_CS RedfishPort_V1_2_3_Links_CS;
typedef struct _RedfishPort_V1_2_3_OemActions_CS RedfishPort_V1_2_3_OemActions_CS;
typedef struct _RedfishPort_V1_2_3_Port_CS RedfishPort_V1_2_3_Port_CS;
typedef struct _RedfishPort_V1_2_3_Reset_CS RedfishPort_V1_2_3_Reset_CS;
...
typedef struct _RedfishPort_V1_2_3_Actions_CS {
    ...
    RedfishPort_V1_2_3_OemActions_CS    *Oem;          // The available OEM-specific
...
typedef struct _RedfishPort_V1_2_3_Port_CS {
    ...
    RedfishPort_V1_2_3_Actions_CS    *Actions;                   // The available actions for this
                                                                 // resource.
    ...
    RedfishPort_V1_2_3_GenZ_CS       *GenZ;                      // Gen-Z specific properties.
    RedfishCS_char                   *Id;                    
    ...
    RedfishCS_int64                  *LinkTransitionIndicator;    // The number of link state
                                                                 ...
                                                                 // interface.
    RedfishPort_V1_2_3_Links_CS      *Links;                     // The links to other resources
...
RedfishCS_status
Json_Port_V1_2_3_To_CS (char *JsonRawText, RedfishPort_V1_2_3_Port_CS **ReturnedCS);

RedfishCS_status
CS_To_Port_V1_2_3_JSON (RedfishPort_V1_2_3_Port_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPort_V1_2_3_CS (RedfishPort_V1_2_3_Port_CS *CSPtr);

RedfishCS_status
DestroyPort_V1_2_3_Json (RedfishCS_char *JsonText);
