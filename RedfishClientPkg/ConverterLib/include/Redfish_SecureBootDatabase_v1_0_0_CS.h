...
#ifndef RedfishSecurebootdatabase_V1_0_0_CSTRUCT_H_
#define RedfishSecurebootdatabase_V1_0_0_CSTRUCT_H_
...
typedef struct _RedfishSecureBootDatabase_V1_0_0_Actions_CS RedfishSecureBootDatabase_V1_0_0_Actions_CS;
typedef struct _RedfishSecureBootDatabase_V1_0_0_OemActions_CS RedfishSecureBootDatabase_V1_0_0_OemActions_CS;
typedef struct _RedfishSecureBootDatabase_V1_0_0_ResetKeys_CS RedfishSecureBootDatabase_V1_0_0_ResetKeys_CS;
typedef struct _RedfishSecureBootDatabase_V1_0_0_SecureBootDatabase_CS RedfishSecureBootDatabase_V1_0_0_SecureBootDatabase_CS;
//
// The OEM extension.
//
#ifndef RedfishResource_Oem_CS_
...
typedef struct _RedfishSecureBootDatabase_V1_0_0_Actions_CS {
    ...
    RedfishSecureBootDatabase_V1_0_0_OemActions_CS    *Oem;                            // The available OEM-specific
...
typedef struct _RedfishSecureBootDatabase_V1_0_0_SecureBootDatabase_CS {
    ...
    RedfishSecureBootDatabase_V1_0_0_Actions_CS    *Actions;         // The available actions for this
                                                                     // resource.
...
RedfishCS_status
Json_SecureBootDatabase_V1_0_0_To_CS (char *JsonRawText, RedfishSecureBootDatabase_V1_0_0_SecureBootDatabase_CS **ReturnedCS);

RedfishCS_status
CS_To_SecureBootDatabase_V1_0_0_JSON (RedfishSecureBootDatabase_V1_0_0_SecureBootDatabase_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroySecureBootDatabase_V1_0_0_CS (RedfishSecureBootDatabase_V1_0_0_SecureBootDatabase_CS *CSPtr);

RedfishCS_status
DestroySecureBootDatabase_V1_0_0_Json (RedfishCS_char *JsonText);
