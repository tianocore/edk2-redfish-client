...
#ifndef RedfishAttributeregistry_V1_1_6_CSTRUCT_H_
#define RedfishAttributeregistry_V1_1_6_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishAttributeRegistry_V1_1_6_AttributeValue_Array_CS RedfishAttributeRegistry_V1_1_6_AttributeValue_Array_CS;
typedef struct _RedfishAttributeRegistry_V1_1_6_MapFrom_Array_CS RedfishAttributeRegistry_V1_1_6_MapFrom_Array_CS;
typedef struct _RedfishAttributeRegistry_V1_1_6_Attributes_Array_CS RedfishAttributeRegistry_V1_1_6_Attributes_Array_CS;
typedef struct _RedfishAttributeRegistry_V1_1_6_Dependencies_Array_CS RedfishAttributeRegistry_V1_1_6_Dependencies_Array_CS;
typedef struct _RedfishAttributeRegistry_V1_1_6_Menus_Array_CS RedfishAttributeRegistry_V1_1_6_Menus_Array_CS;
typedef struct _RedfishAttributeRegistry_V1_1_6_SupportedSystems_Array_CS RedfishAttributeRegistry_V1_1_6_SupportedSystems_Array_CS;
typedef struct _RedfishAttributeRegistry_V1_1_6_Actions_CS RedfishAttributeRegistry_V1_1_6_Actions_CS;
typedef struct _RedfishAttributeRegistry_V1_1_6_AttributeRegistry_CS RedfishAttributeRegistry_V1_1_6_AttributeRegistry_CS;
typedef struct _RedfishAttributeRegistry_V1_1_6_AttributeValue_CS RedfishAttributeRegistry_V1_1_6_AttributeValue_CS;
typedef struct _RedfishAttributeRegistry_V1_1_6_Attributes_CS RedfishAttributeRegistry_V1_1_6_Attributes_CS;
typedef struct _RedfishAttributeRegistry_V1_1_6_Dependencies_CS RedfishAttributeRegistry_V1_1_6_Dependencies_CS;
typedef struct _RedfishAttributeRegistry_V1_1_6_Dependency_CS RedfishAttributeRegistry_V1_1_6_Dependency_CS;
typedef struct _RedfishAttributeRegistry_V1_1_6_MapFrom_CS RedfishAttributeRegistry_V1_1_6_MapFrom_CS;
typedef struct _RedfishAttributeRegistry_V1_1_6_Menus_CS RedfishAttributeRegistry_V1_1_6_Menus_CS;
typedef struct _RedfishAttributeRegistry_V1_1_6_OemActions_CS RedfishAttributeRegistry_V1_1_6_OemActions_CS;
typedef struct _RedfishAttributeRegistry_V1_1_6_RegistryEntries_CS RedfishAttributeRegistry_V1_1_6_RegistryEntries_CS;
typedef struct _RedfishAttributeRegistry_V1_1_6_SupportedSystems_CS RedfishAttributeRegistry_V1_1_6_SupportedSystems_CS;
...
typedef struct _RedfishAttributeRegistry_V1_1_6_Actions_CS {
    RedfishAttributeRegistry_V1_1_6_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishAttributeRegistry_V1_1_6_Attributes_CS {
    ...
    RedfishCS_int64                                            *UpperBound;               // The upper limit for an integer
                                                                                          // attribute.
    RedfishAttributeRegistry_V1_1_6_AttributeValue_Array_CS    *Value;                    // An array of the possible
...
typedef struct _RedfishAttributeRegistry_V1_1_6_Dependencies_CS {
    RedfishAttributeRegistry_V1_1_6_Dependency_CS    *Dependency;      // The dependency expression for
...
typedef struct _RedfishAttributeRegistry_V1_1_6_Dependency_CS {
    RedfishAttributeRegistry_V1_1_6_MapFrom_Array_CS    *MapFrom;          // An array of the map-from
...
typedef struct _RedfishAttributeRegistry_V1_1_6_RegistryEntries_CS {
    RedfishAttributeRegistry_V1_1_6_Attributes_Array_CS      *Attributes;     // An array of attributes and
                                                                              // their possible values in the
                                                                              // Attribute Registry.
    RedfishAttributeRegistry_V1_1_6_Dependencies_Array_CS    *Dependencies;    // An array of dependencies of
                                                                              // attributes on this component.
    RedfishAttributeRegistry_V1_1_6_Menus_Array_CS           *Menus;          // An array for the attributes
...
typedef struct _RedfishAttributeRegistry_V1_1_6_AttributeRegistry_CS {
    ...
    RedfishAttributeRegistry_V1_1_6_Actions_CS                   *Actions;            // The available actions for this
                                                                                      // Resource.
    ...
    RedfishCS_char                                               *OwningEntity;       // The organization or company
                                                                                      ...
                                                                                      // Registry.
    RedfishAttributeRegistry_V1_1_6_RegistryEntries_CS           *RegistryEntries;    // The list of all attributes and
                                                                                      // their metadata for this
                                                                                      // component.
    RedfishCS_char                                               *RegistryVersion;    // The Attribute Registry
                                                                                      // version.
    RedfishAttributeRegistry_V1_1_6_SupportedSystems_Array_CS    *SupportedSystems;    // An array of systems that this
...
typedef struct _RedfishAttributeRegistry_V1_1_6_AttributeValue_Array_CS  {
    RedfishAttributeRegistry_V1_1_6_AttributeValue_Array_CS    *Next;
...
typedef struct _RedfishAttributeRegistry_V1_1_6_MapFrom_Array_CS  {
    RedfishAttributeRegistry_V1_1_6_MapFrom_Array_CS    *Next;
...
typedef struct _RedfishAttributeRegistry_V1_1_6_Attributes_Array_CS  {
    RedfishAttributeRegistry_V1_1_6_Attributes_Array_CS    *Next;
...
typedef struct _RedfishAttributeRegistry_V1_1_6_Dependencies_Array_CS  {
    RedfishAttributeRegistry_V1_1_6_Dependencies_Array_CS    *Next;
...
typedef struct _RedfishAttributeRegistry_V1_1_6_Menus_Array_CS  {
    RedfishAttributeRegistry_V1_1_6_Menus_Array_CS    *Next;
    RedfishAttributeRegistry_V1_1_6_Menus_CS    *ArrayValue;
} RedfishAttributeRegistry_V1_1_6_Menus_Array_CS;

typedef struct _RedfishAttributeRegistry_V1_1_6_SupportedSystems_Array_CS  {
    RedfishAttributeRegistry_V1_1_6_SupportedSystems_Array_CS    *Next;
    RedfishAttributeRegistry_V1_1_6_SupportedSystems_CS    *ArrayValue;
} RedfishAttributeRegistry_V1_1_6_SupportedSystems_Array_CS;

RedfishCS_status
Json_AttributeRegistry_V1_1_6_To_CS (char *JsonRawText, RedfishAttributeRegistry_V1_1_6_AttributeRegistry_CS **ReturnedCS);

RedfishCS_status
CS_To_AttributeRegistry_V1_1_6_JSON (RedfishAttributeRegistry_V1_1_6_AttributeRegistry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAttributeRegistry_V1_1_6_CS (RedfishAttributeRegistry_V1_1_6_AttributeRegistry_CS *CSPtr);

RedfishCS_status
DestroyAttributeRegistry_V1_1_6_Json (RedfishCS_char *JsonText);
