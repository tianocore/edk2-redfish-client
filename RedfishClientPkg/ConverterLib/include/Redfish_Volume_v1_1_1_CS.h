...
#ifndef RedfishVolume_V1_1_1_CSTRUCT_H_
#define RedfishVolume_V1_1_1_CSTRUCT_H_
...
typedef struct _RedfishVolume_V1_1_1_Actions_CS RedfishVolume_V1_1_1_Actions_CS;
typedef struct _RedfishVolume_V1_1_1_CheckConsistency_CS RedfishVolume_V1_1_1_CheckConsistency_CS;
typedef struct _RedfishVolume_V1_1_1_Links_CS RedfishVolume_V1_1_1_Links_CS;
typedef struct _RedfishVolume_V1_1_1_OemActions_CS RedfishVolume_V1_1_1_OemActions_CS;
typedef struct _RedfishVolume_V1_1_1_Operation_CS RedfishVolume_V1_1_1_Operation_CS;
typedef struct _RedfishVolume_V1_1_1_Volume_CS RedfishVolume_V1_1_1_Volume_CS;
...
typedef struct _RedfishVolume_V1_1_1_Volume_CS {
    ...
    RedfishCS_char                                     *AccessCapabilities;                 // Supported IO access
                                                                                            // capabilities.
    RedfishVolume_V1_1_1_Actions_CS                    *Actions;                            // The available actions for this
                                                                                            // resource.
    ...
    RedfishCS_Link                                     Identifiers;                         // The Durable names for the
                                                                                            // volume.
    RedfishVolume_V1_1_1_Links_CS                      *Links;                              // Contains references to other
    ...
    RedfishCS_char                                     *Name;                           
    RedfishResource_Oem_CS                             *Oem;                                // The OEM extension property.
    RedfishVolume_V1_1_1_Operation_CS                  *Operations;                         // The operations currently
...
RedfishCS_status
Json_Volume_V1_1_1_To_CS (char *JsonRawText, RedfishVolume_V1_1_1_Volume_CS **ReturnedCS);

RedfishCS_status
CS_To_Volume_V1_1_1_JSON (RedfishVolume_V1_1_1_Volume_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyVolume_V1_1_1_CS (RedfishVolume_V1_1_1_Volume_CS *CSPtr);

RedfishCS_status
DestroyVolume_V1_1_1_Json (RedfishCS_char *JsonText);
