...
#ifndef RedfishExternalaccountprovider_V1_1_4_CSTRUCT_H_
#define RedfishExternalaccountprovider_V1_1_4_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishExternalAccountProvider_V1_1_4_RoleMapping_Array_CS RedfishExternalAccountProvider_V1_1_4_RoleMapping_Array_CS;
typedef struct _RedfishExternalAccountProvider_V1_1_4_Actions_CS RedfishExternalAccountProvider_V1_1_4_Actions_CS;
typedef struct _RedfishExternalAccountProvider_V1_1_4_Authentication_CS RedfishExternalAccountProvider_V1_1_4_Authentication_CS;
typedef struct _RedfishExternalAccountProvider_V1_1_4_ExternalAccountProvider_CS RedfishExternalAccountProvider_V1_1_4_ExternalAccountProvider_CS;
typedef struct _RedfishExternalAccountProvider_V1_1_4_LDAPSearchSettings_CS RedfishExternalAccountProvider_V1_1_4_LDAPSearchSettings_CS;
typedef struct _RedfishExternalAccountProvider_V1_1_4_LDAPService_CS RedfishExternalAccountProvider_V1_1_4_LDAPService_CS;
typedef struct _RedfishExternalAccountProvider_V1_1_4_Links_CS RedfishExternalAccountProvider_V1_1_4_Links_CS;
typedef struct _RedfishExternalAccountProvider_V1_1_4_OemActions_CS RedfishExternalAccountProvider_V1_1_4_OemActions_CS;
typedef struct _RedfishExternalAccountProvider_V1_1_4_RoleMapping_CS RedfishExternalAccountProvider_V1_1_4_RoleMapping_CS;
...
typedef struct _RedfishExternalAccountProvider_V1_1_4_Actions_CS {
    RedfishExternalAccountProvider_V1_1_4_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishExternalAccountProvider_V1_1_4_LDAPService_CS {
    RedfishResource_Oem_CS                                         *Oem;              // The OEM extension property.
    RedfishExternalAccountProvider_V1_1_4_LDAPSearchSettings_CS    *SearchSettings;    // The required settings to
...
typedef struct _RedfishExternalAccountProvider_V1_1_4_ExternalAccountProvider_CS {
    ...
    RedfishCS_char                                                *AccountProviderType;    // The type of external account
                                                                                          ...
                                                                                          // connects.
    RedfishExternalAccountProvider_V1_1_4_Actions_CS              *Actions;               // The available actions for this
                                                                                          // resource.
    RedfishExternalAccountProvider_V1_1_4_Authentication_CS       *Authentication;        // The authentication information
    ...
    RedfishCS_char                                                *Id;                
    RedfishExternalAccountProvider_V1_1_4_LDAPService_CS          *LDAPService;           // The additional mapping
                                                                                          // information needed to parse a
                                                                                          // generic LDAP service.
    RedfishExternalAccountProvider_V1_1_4_Links_CS                *Links;                 // The links to other resources
                                                                                          // that are related to this
                                                                                          // resource.
    RedfishCS_char                                                *Name;              
    RedfishResource_Oem_CS                                        *Oem;                   // The OEM extension property.
    RedfishExternalAccountProvider_V1_1_4_RoleMapping_Array_CS    *RemoteRoleMapping;     // The mapping rules to convert
...
typedef struct _RedfishExternalAccountProvider_V1_1_4_RoleMapping_Array_CS  {
    RedfishExternalAccountProvider_V1_1_4_RoleMapping_Array_CS    *Next;
    RedfishExternalAccountProvider_V1_1_4_RoleMapping_CS    *ArrayValue;
} RedfishExternalAccountProvider_V1_1_4_RoleMapping_Array_CS;

RedfishCS_status
Json_ExternalAccountProvider_V1_1_4_To_CS (char *JsonRawText, RedfishExternalAccountProvider_V1_1_4_ExternalAccountProvider_CS **ReturnedCS);

RedfishCS_status
CS_To_ExternalAccountProvider_V1_1_4_JSON (RedfishExternalAccountProvider_V1_1_4_ExternalAccountProvider_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyExternalAccountProvider_V1_1_4_CS (RedfishExternalAccountProvider_V1_1_4_ExternalAccountProvider_CS *CSPtr);

RedfishCS_status
DestroyExternalAccountProvider_V1_1_4_Json (RedfishCS_char *JsonText);
