...
#ifndef RedfishJsonschemafilecollection_Noversioned_CSTRUCT_H_
#define RedfishJsonschemafilecollection_Noversioned_CSTRUCT_H_
...
//
// The JsonSchemaFileCollection schema describes a collection of JSON Schema file
// instances.
//
