...
#ifndef RedfishEthernetinterface_V1_2_6_CSTRUCT_H_
#define RedfishEthernetinterface_V1_2_6_CSTRUCT_H_
...
#endif
typedef struct _RedfishEthernetInterface_V1_2_6_IPv6AddressPolicyEntry_Array_CS RedfishEthernetInterface_V1_2_6_IPv6AddressPolicyEntry_Array_CS;
typedef struct _RedfishEthernetInterface_V1_2_6_EthernetInterface_CS RedfishEthernetInterface_V1_2_6_EthernetInterface_CS;
typedef struct _RedfishEthernetInterface_V1_2_6_IPv6AddressPolicyEntry_CS RedfishEthernetInterface_V1_2_6_IPv6AddressPolicyEntry_CS;
typedef struct _RedfishEthernetInterface_V1_2_6_Links_CS RedfishEthernetInterface_V1_2_6_Links_CS;
...
typedef struct _RedfishEthernetInterface_V1_2_6_EthernetInterface_CS {
    ...
    RedfishEthernetInterface_V1_2_6_IPv6AddressPolicyEntry_Array_CS    *IPv6AddressPolicyTable;    // An array that represents the
    ...
    RedfishCS_char                                                     *LinkStatus;               // The link status of this
                                                                                                  // interface, or port.
    RedfishEthernetInterface_V1_2_6_Links_CS                           *Links;                    // The links to other resources
...
typedef struct _RedfishEthernetInterface_V1_2_6_IPv6AddressPolicyEntry_Array_CS  {
    RedfishEthernetInterface_V1_2_6_IPv6AddressPolicyEntry_Array_CS    *Next;
    RedfishEthernetInterface_V1_2_6_IPv6AddressPolicyEntry_CS    *ArrayValue;
} RedfishEthernetInterface_V1_2_6_IPv6AddressPolicyEntry_Array_CS;

RedfishCS_status
Json_EthernetInterface_V1_2_6_To_CS (char *JsonRawText, RedfishEthernetInterface_V1_2_6_EthernetInterface_CS **ReturnedCS);

RedfishCS_status
CS_To_EthernetInterface_V1_2_6_JSON (RedfishEthernetInterface_V1_2_6_EthernetInterface_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEthernetInterface_V1_2_6_CS (RedfishEthernetInterface_V1_2_6_EthernetInterface_CS *CSPtr);

RedfishCS_status
DestroyEthernetInterface_V1_2_6_Json (RedfishCS_char *JsonText);
