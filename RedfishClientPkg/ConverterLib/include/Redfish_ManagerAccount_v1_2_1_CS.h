...
#ifndef RedfishManageraccount_V1_2_1_CSTRUCT_H_
#define RedfishManageraccount_V1_2_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishManagerAccount_V1_2_1_Actions_CS RedfishManagerAccount_V1_2_1_Actions_CS;
typedef struct _RedfishManagerAccount_V1_2_1_Links_CS RedfishManagerAccount_V1_2_1_Links_CS;
typedef struct _RedfishManagerAccount_V1_2_1_ManagerAccount_CS RedfishManagerAccount_V1_2_1_ManagerAccount_CS;
typedef struct _RedfishManagerAccount_V1_2_1_OemActions_CS RedfishManagerAccount_V1_2_1_OemActions_CS;
...
typedef struct _RedfishManagerAccount_V1_2_1_Actions_CS {
    RedfishManagerAccount_V1_2_1_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishManagerAccount_V1_2_1_ManagerAccount_CS {
    ...
    RedfishManagerAccount_V1_2_1_Actions_CS    *Actions;         // The available actions for this
                                                                 // resource.
    ...
    RedfishCS_bool                             *Enabled;         // This property is used by a
                                                                 ...
                                                                 // login.
    RedfishCS_char                             *Id;          
    RedfishManagerAccount_V1_2_1_Links_CS      *Links;           // Contains references to other
...
RedfishCS_status
Json_ManagerAccount_V1_2_1_To_CS (char *JsonRawText, RedfishManagerAccount_V1_2_1_ManagerAccount_CS **ReturnedCS);

RedfishCS_status
CS_To_ManagerAccount_V1_2_1_JSON (RedfishManagerAccount_V1_2_1_ManagerAccount_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyManagerAccount_V1_2_1_CS (RedfishManagerAccount_V1_2_1_ManagerAccount_CS *CSPtr);

RedfishCS_status
DestroyManagerAccount_V1_2_1_Json (RedfishCS_char *JsonText);
