...
#ifndef RedfishOutlet_V1_1_2_CSTRUCT_H_
#define RedfishOutlet_V1_1_2_CSTRUCT_H_
...
#endif
typedef struct _RedfishOutlet_V1_1_2_Actions_CS RedfishOutlet_V1_1_2_Actions_CS;
typedef struct _RedfishOutlet_V1_1_2_CurrentSensors_CS RedfishOutlet_V1_1_2_CurrentSensors_CS;
typedef struct _RedfishOutlet_V1_1_2_Links_CS RedfishOutlet_V1_1_2_Links_CS;
typedef struct _RedfishOutlet_V1_1_2_OemActions_CS RedfishOutlet_V1_1_2_OemActions_CS;
typedef struct _RedfishOutlet_V1_1_2_Outlet_CS RedfishOutlet_V1_1_2_Outlet_CS;
typedef struct _RedfishOutlet_V1_1_2_PowerControl_CS RedfishOutlet_V1_1_2_PowerControl_CS;
typedef struct _RedfishOutlet_V1_1_2_ResetMetrics_CS RedfishOutlet_V1_1_2_ResetMetrics_CS;
typedef struct _RedfishOutlet_V1_1_2_VoltageSensors_CS RedfishOutlet_V1_1_2_VoltageSensors_CS;
...
typedef struct _RedfishOutlet_V1_1_2_Actions_CS {
    ...
    RedfishOutlet_V1_1_2_OemActions_CS      *Oem;                   // The available OEM-specific
...
typedef struct _RedfishOutlet_V1_1_2_Outlet_CS {
    ...
    RedfishOutlet_V1_1_2_Actions_CS           *Actions;                    // The available actions for this
                                                                           // resource.
    ...
    RedfishCS_char                            *IndicatorLED;               // The state of the indicator
                                                                           ...
                                                                           // outlet.
    RedfishOutlet_V1_1_2_Links_CS             *Links;                      // The links to other resources
    ...
    RedfishCS_char                            *PhaseWiringType;            // The number of ungrounded
                                                                           ...
                                                                           // of conductors (wires).
    RedfishOutlet_V1_1_2_CurrentSensors_CS    *PolyPhaseCurrentAmps;       // The current readings for this
                                                                           // outlet.
    RedfishOutlet_V1_1_2_VoltageSensors_CS    *PolyPhaseVoltage;           // The voltage readings for this
                                                                           // outlet.
    ...
    RedfishCS_char                            *VoltageType;                // The type of voltage applied to
                                                                           // the outlet.
} RedfishOutlet_V1_1_2_Outlet_CS;
...
RedfishCS_status
Json_Outlet_V1_1_2_To_CS (char *JsonRawText, RedfishOutlet_V1_1_2_Outlet_CS **ReturnedCS);

RedfishCS_status
CS_To_Outlet_V1_1_2_JSON (RedfishOutlet_V1_1_2_Outlet_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyOutlet_V1_1_2_CS (RedfishOutlet_V1_1_2_Outlet_CS *CSPtr);

RedfishCS_status
DestroyOutlet_V1_1_2_Json (RedfishCS_char *JsonText);
