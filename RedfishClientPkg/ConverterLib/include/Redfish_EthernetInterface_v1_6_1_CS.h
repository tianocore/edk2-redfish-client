...
#ifndef RedfishEthernetinterface_V1_6_1_CSTRUCT_H_
#define RedfishEthernetinterface_V1_6_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishEthernetInterface_V1_6_1_IPv6AddressPolicyEntry_Array_CS RedfishEthernetInterface_V1_6_1_IPv6AddressPolicyEntry_Array_CS;
typedef struct _RedfishEthernetInterface_V1_6_1_Actions_CS RedfishEthernetInterface_V1_6_1_Actions_CS;
typedef struct _RedfishEthernetInterface_V1_6_1_DHCPv4Configuration_CS RedfishEthernetInterface_V1_6_1_DHCPv4Configuration_CS;
typedef struct _RedfishEthernetInterface_V1_6_1_DHCPv6Configuration_CS RedfishEthernetInterface_V1_6_1_DHCPv6Configuration_CS;
typedef struct _RedfishEthernetInterface_V1_6_1_EthernetInterface_CS RedfishEthernetInterface_V1_6_1_EthernetInterface_CS;
typedef struct _RedfishEthernetInterface_V1_6_1_IPv6AddressPolicyEntry_CS RedfishEthernetInterface_V1_6_1_IPv6AddressPolicyEntry_CS;
typedef struct _RedfishEthernetInterface_V1_6_1_Links_CS RedfishEthernetInterface_V1_6_1_Links_CS;
typedef struct _RedfishEthernetInterface_V1_6_1_OemActions_CS RedfishEthernetInterface_V1_6_1_OemActions_CS;
typedef struct _RedfishEthernetInterface_V1_6_1_StatelessAddressAutoConfiguration_CS RedfishEthernetInterface_V1_6_1_StatelessAddressAutoConfiguration_CS;
...
//
typedef struct _RedfishEthernetInterface_V1_6_1_Actions_CS {
    RedfishEthernetInterface_V1_6_1_OemActions_CS    *Oem;    // The available OEM-specific
                                                             // actions for this resource.
} RedfishEthernetInterface_V1_6_1_Actions_CS;

//
// DHCPv4 configuration for this interface.
//
typedef struct _RedfishEthernetInterface_V1_6_1_DHCPv4Configuration_CS {
...
} RedfishEthernetInterface_V1_6_1_DHCPv4Configuration_CS;

//
// DHCPv6 configuration for this interface.
//
typedef struct _RedfishEthernetInterface_V1_6_1_DHCPv6Configuration_CS {
...
} RedfishEthernetInterface_V1_6_1_DHCPv6Configuration_CS;

//
// The entry in the RFC6724-defined address selection policy table.
//
typedef struct _RedfishEthernetInterface_V1_6_1_IPv6AddressPolicyEntry_CS {
    ...
    RedfishCS_char     *Prefix;       // The IPv6 address prefix, as
                                      // defined in RFC6724, section
                                      // 2.1.
} RedfishEthernetInterface_V1_6_1_IPv6AddressPolicyEntry_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishEthernetInterface_V1_6_1_Links_CS {
...
} RedfishEthernetInterface_V1_6_1_Links_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishEthernetInterface_V1_6_1_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishEthernetInterface_V1_6_1_OemActions_CS;

//
// Stateless address autoconfiguration (SLAAC) parameters for this interface.
//
typedef struct _RedfishEthernetInterface_V1_6_1_StatelessAddressAutoConfiguration_CS {
    ...
    RedfishCS_bool    *IPv6AutoConfigEnabled;    // An indication of whether IPv6
                                                ...
                                                // autoconfiguration (SLAAC) is
                                                // enabled for this interface.
} RedfishEthernetInterface_V1_6_1_StatelessAddressAutoConfiguration_CS;
...
//
typedef struct _RedfishEthernetInterface_V1_6_1_EthernetInterface_CS {
    RedfishCS_Header                                                        Header;
    RedfishCS_char                                                          *odata_context;            
    RedfishCS_char                                                          *odata_etag;               
    RedfishCS_char                                                          *odata_id;                 
    RedfishCS_char                                                          *odata_type;               
    RedfishEthernetInterface_V1_6_1_Actions_CS                              *Actions;                      // The available actions for this
                                                                                                           // resource.
    RedfishCS_bool                                                          *AutoNeg;                      // An indication of whether the
                                                                                                           // speed and duplex are
                                                                                                           // automatically negotiated and
                                                                                                           // configured on this interface.
    RedfishEthernetInterface_V1_6_1_DHCPv4Configuration_CS                  *DHCPv4;                       // DHCPv4 configuration for this
                                                                                                           // interface.
    RedfishEthernetInterface_V1_6_1_DHCPv6Configuration_CS                  *DHCPv6;                       // DHCPv6 configuration for this
                                                                                                           // interface.
    ...
    RedfishCS_Link                                                          IPv4StaticAddresses;           // The IPv4 static addresses
                                                                                                           // assigned to this interface.
    RedfishEthernetInterface_V1_6_1_IPv6AddressPolicyEntry_Array_CS         *IPv6AddressPolicyTable;       // An array that represents the
    ...
    RedfishCS_char                                                          *LinkStatus;                   // The link status of this
                                                                                                           // interface, or port.
    RedfishEthernetInterface_V1_6_1_Links_CS                                *Links;                        // The links to other resources
    ...
    RedfishCS_int64                                                         *SpeedMbps;                    // The current speed, in Mbit/s,
                                                                                                           // of this interface.
    RedfishEthernetInterface_V1_6_1_StatelessAddressAutoConfiguration_CS    *StatelessAddressAutoConfig;    // Stateless address
...
} RedfishEthernetInterface_V1_6_1_EthernetInterface_CS;
...
typedef struct _RedfishEthernetInterface_V1_6_1_IPv6AddressPolicyEntry_Array_CS  {
    RedfishEthernetInterface_V1_6_1_IPv6AddressPolicyEntry_Array_CS    *Next;
    RedfishEthernetInterface_V1_6_1_IPv6AddressPolicyEntry_CS    *ArrayValue;
} RedfishEthernetInterface_V1_6_1_IPv6AddressPolicyEntry_Array_CS;

RedfishCS_status
Json_EthernetInterface_V1_6_1_To_CS (char *JsonRawText, RedfishEthernetInterface_V1_6_1_EthernetInterface_CS **ReturnedCS);

RedfishCS_status
CS_To_EthernetInterface_V1_6_1_JSON (RedfishEthernetInterface_V1_6_1_EthernetInterface_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEthernetInterface_V1_6_1_CS (RedfishEthernetInterface_V1_6_1_EthernetInterface_CS *CSPtr);

RedfishCS_status
DestroyEthernetInterface_V1_6_1_Json (RedfishCS_char *JsonText);
