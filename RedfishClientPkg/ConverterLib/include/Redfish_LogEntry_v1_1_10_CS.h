...
#ifndef RedfishLogentry_V1_1_10_CSTRUCT_H_
#define RedfishLogentry_V1_1_10_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishLogEntry_V1_1_10_Links_CS RedfishLogEntry_V1_1_10_Links_CS;
typedef struct _RedfishLogEntry_V1_1_10_LogEntry_CS RedfishLogEntry_V1_1_10_LogEntry_CS;
...
//
typedef struct _RedfishLogEntry_V1_1_10_LogEntry_CS {
    ...
    RedfishCS_char                      *EventType;         // The type of event recorded in
                                                            // this log.
    RedfishCS_char                      *Id;            
    RedfishLogEntry_V1_1_10_Links_CS    *Links;             // The links to other resources
...
} RedfishLogEntry_V1_1_10_LogEntry_CS;

RedfishCS_status
Json_LogEntry_V1_1_10_To_CS (char *JsonRawText, RedfishLogEntry_V1_1_10_LogEntry_CS **ReturnedCS);

RedfishCS_status
CS_To_LogEntry_V1_1_10_JSON (RedfishLogEntry_V1_1_10_LogEntry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyLogEntry_V1_1_10_CS (RedfishLogEntry_V1_1_10_LogEntry_CS *CSPtr);

RedfishCS_status
DestroyLogEntry_V1_1_10_Json (RedfishCS_char *JsonText);
