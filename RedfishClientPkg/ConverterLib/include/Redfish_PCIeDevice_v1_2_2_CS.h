...
#ifndef RedfishPciedevice_V1_2_2_CSTRUCT_H_
#define RedfishPciedevice_V1_2_2_CSTRUCT_H_
...
#endif
typedef struct _RedfishPCIeDevice_V1_2_2_Actions_CS RedfishPCIeDevice_V1_2_2_Actions_CS;
typedef struct _RedfishPCIeDevice_V1_2_2_Links_CS RedfishPCIeDevice_V1_2_2_Links_CS;
typedef struct _RedfishPCIeDevice_V1_2_2_OemActions_CS RedfishPCIeDevice_V1_2_2_OemActions_CS;
typedef struct _RedfishPCIeDevice_V1_2_2_PCIeDevice_CS RedfishPCIeDevice_V1_2_2_PCIeDevice_CS;
...
typedef struct _RedfishPCIeDevice_V1_2_2_Actions_CS {
    RedfishPCIeDevice_V1_2_2_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishPCIeDevice_V1_2_2_PCIeDevice_CS {
    ...
    RedfishPCIeDevice_V1_2_2_Actions_CS    *Actions;           // The available actions for this
                                                               // resource.
    ...
    RedfishCS_char                         *FirmwareVersion;    // The version of firmware for
                                                               // this PCIe device.
    RedfishCS_char                         *Id;            
    RedfishPCIeDevice_V1_2_2_Links_CS      *Links;             // The links object contains the
...
RedfishCS_status
Json_PCIeDevice_V1_2_2_To_CS (char *JsonRawText, RedfishPCIeDevice_V1_2_2_PCIeDevice_CS **ReturnedCS);

RedfishCS_status
CS_To_PCIeDevice_V1_2_2_JSON (RedfishPCIeDevice_V1_2_2_PCIeDevice_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPCIeDevice_V1_2_2_CS (RedfishPCIeDevice_V1_2_2_PCIeDevice_CS *CSPtr);

RedfishCS_status
DestroyPCIeDevice_V1_2_2_Json (RedfishCS_char *JsonText);
