...
#ifndef RedfishPciefunction_V1_2_2_CSTRUCT_H_
#define RedfishPciefunction_V1_2_2_CSTRUCT_H_
...
#endif
typedef struct _RedfishPCIeFunction_V1_2_2_Actions_CS RedfishPCIeFunction_V1_2_2_Actions_CS;
typedef struct _RedfishPCIeFunction_V1_2_2_Links_CS RedfishPCIeFunction_V1_2_2_Links_CS;
typedef struct _RedfishPCIeFunction_V1_2_2_OemActions_CS RedfishPCIeFunction_V1_2_2_OemActions_CS;
typedef struct _RedfishPCIeFunction_V1_2_2_PCIeFunction_CS RedfishPCIeFunction_V1_2_2_PCIeFunction_CS;
...
typedef struct _RedfishPCIeFunction_V1_2_2_Actions_CS {
    RedfishPCIeFunction_V1_2_2_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishPCIeFunction_V1_2_2_PCIeFunction_CS {
    ...
    RedfishPCIeFunction_V1_2_2_Actions_CS    *Actions;             // The available actions for this
                                                                   // resource.
    ...
    RedfishCS_char                           *Id;              
    RedfishPCIeFunction_V1_2_2_Links_CS      *Links;               // The links object contains the
...
RedfishCS_status
Json_PCIeFunction_V1_2_2_To_CS (char *JsonRawText, RedfishPCIeFunction_V1_2_2_PCIeFunction_CS **ReturnedCS);

RedfishCS_status
CS_To_PCIeFunction_V1_2_2_JSON (RedfishPCIeFunction_V1_2_2_PCIeFunction_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPCIeFunction_V1_2_2_CS (RedfishPCIeFunction_V1_2_2_PCIeFunction_CS *CSPtr);

RedfishCS_status
DestroyPCIeFunction_V1_2_2_Json (RedfishCS_char *JsonText);
