...
#ifndef RedfishChassis_V1_18_0_CSTRUCT_H_
#define RedfishChassis_V1_18_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishChassis_V1_18_0_Actions_CS RedfishChassis_V1_18_0_Actions_CS;
typedef struct _RedfishChassis_V1_18_0_Chassis_CS RedfishChassis_V1_18_0_Chassis_CS;
typedef struct _RedfishChassis_V1_18_0_Links_CS RedfishChassis_V1_18_0_Links_CS;
typedef struct _RedfishChassis_V1_18_0_OemActions_CS RedfishChassis_V1_18_0_OemActions_CS;
typedef struct _RedfishChassis_V1_18_0_PhysicalSecurity_CS RedfishChassis_V1_18_0_PhysicalSecurity_CS;
typedef struct _RedfishChassis_V1_18_0_Reset_CS RedfishChassis_V1_18_0_Reset_CS;
...
//
typedef struct _RedfishChassis_V1_18_0_Actions_CS {
    RedfishChassis_V1_18_0_Reset_CS         *Chassis_Reset;
    RedfishChassis_V1_18_0_OemActions_CS    *Oem;             // The available OEM-specific
                                                              // actions for this resource.
} RedfishChassis_V1_18_0_Actions_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishChassis_V1_18_0_Links_CS {
    RedfishCS_Link                   Cables;                          // An array of links to the
                                                                      // cables connected to this
                                                                      // chassis.
    ...
    RedfishCS_Link                   Drives;                          // An array of links to the
                                                                      // drives located in this
                                                                      // chassis.
    RedfishCS_int64                  *Drivesodata_count;          
    RedfishCS_Link                   Facility;                        // The link to the facility that
                                                                      // contains this chassis.
    RedfishCS_Link                   ManagedBy;                       // An array of links to the
                                                                      // managers responsible for
                                                                      // managing this chassis.
    RedfishCS_int64                  *ManagedByodata_count;       
    RedfishCS_Link                   ManagersInChassis;               // An array of links to the
    ...
    RedfishCS_Link                   PCIeDevices;                     // An array of links to the PCIe
                                                                      // devices located in this
                                                                      // chassis.
    RedfishCS_int64                  *PCIeDevicesodata_count;     
    RedfishCS_Link                   PowerOutlets;                    // An array of links to the
                                                                      // outlets that provide power to
                                                                      // this chassis.
    ...
    RedfishCS_Link                   Switches;                        // An array of links to the
                                                                      // switches located in this
                                                                      // chassis.
    RedfishCS_int64                  *Switchesodata_count;        
} RedfishChassis_V1_18_0_Links_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishChassis_V1_18_0_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishChassis_V1_18_0_OemActions_CS;

//
// The state of the physical security sensor.
//
typedef struct _RedfishChassis_V1_18_0_PhysicalSecurity_CS {
    ...
    RedfishCS_char     *IntrusionSensorReArm;    // The method that restores this
                                                 ...
                                                 // the normal state.
} RedfishChassis_V1_18_0_PhysicalSecurity_CS;

//
// This action resets the chassis but does not reset systems or other contained
// resources, although side effects can occur that affect those resources.
//
typedef struct _RedfishChassis_V1_18_0_Reset_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishChassis_V1_18_0_Reset_CS;
...
// the system.
//
typedef struct _RedfishChassis_V1_18_0_Chassis_CS {
    RedfishCS_Header                              Header;
    RedfishCS_char                                *odata_context;             
    RedfishCS_char                                *odata_etag;                
    RedfishCS_char                                *odata_id;                  
    RedfishCS_char                                *odata_type;                
    RedfishChassis_V1_18_0_Actions_CS             *Actions;                       // The available actions for this
                                                                                  // resource.
    ...
    RedfishCS_Link                                Controls;                       // The link to the collection of
                                                                                  // controls located in this
                                                                                  // chassis.
    RedfishCS_int64                               *DepthMm;                       // The depth of the chassis.
    RedfishCS_char                                *Description;               
    RedfishCS_Link                                Drives;                         // The link to the collection of
                                                                                  // drives within this chassis.
    RedfishCS_char_Array                          *ElectricalSourceManagerURIs;    // The URIs of the management
                                                                                  // interfaces for the upstream
                                                                                  // electrical source connections
                                                                                  // for this chassis.
    RedfishCS_char_Array                          *ElectricalSourceNames;         // The names of the upstream
                                                                                  // electrical sources, such as
                                                                                  // circuits or outlets, connected
                                                                                  // to this chassis.
    RedfishCS_Link                                EnvironmentMetrics;             // The link to the environment
                                                                                  // metrics for this chassis.
    RedfishCS_char                                *EnvironmentalClass;            // The ASHRAE Environmental Class
                                                                                  // for this chassis.
    ...
    RedfishCS_char                                *IndicatorLED;                  // The state of the indicator
                                                                                  ...
                                                                                  // chassis.
    RedfishChassis_V1_18_0_Links_CS               *Links;                         // The links to other resources
    ...
    RedfishCS_char                                *Manufacturer;                  // The manufacturer of this
                                                                                  // chassis.
    RedfishCS_int64                               *MaxPowerWatts;                 // The upper bound of the total
                                                                                  // power consumed by the chassis.
    RedfishCS_Link                                Measurements;                   // An array of DSP0274-defined
                                                                                  // measurement blocks.
    RedfishCS_Link                                MediaControllers;               // The link to the collection of
                                                                                  // media controllers located in
                                                                                  // this chassis.
    RedfishCS_Link                                Memory;                         // The link to the collection of
                                                                                  // memory located in this
                                                                                  // chassis.
    RedfishCS_Link                                MemoryDomains;                  // The link to the collection of
                                                                                  // memory domains located in this
                                                                                  // chassis.
    RedfishCS_int64                               *MinPowerWatts;                 // The lower bound of the total
                                                                                  // power consumed by the chassis.
    RedfishCS_char                                *Model;                         // The model number of the
                                                                                  // chassis.
    RedfishCS_char                                *Name;                      
    RedfishCS_Link                                NetworkAdapters;                // The link to the collection of
                                                                                  // network adapters associated
                                                                                  // with this chassis.
    RedfishResource_Oem_CS                        *Oem;                           // The OEM extension property.
    RedfishCS_Link                                PCIeDevices;                    // The link to the collection of
                                                                                  // PCIe devices located in this
                                                                                  // chassis.
    RedfishCS_Link                                PCIeSlots;                      // The link to the PCIe slot
                                                                                  // properties for this chassis.
    RedfishCS_char                                *PartNumber;                    // The part number of the
                                                                                  // chassis.
    RedfishChassis_V1_18_0_PhysicalSecurity_CS    *PhysicalSecurity;              // The state of the physical
                                                                                  // security sensor.
    ...
    RedfishCS_char                                *PowerState;                    // The current power state of the
                                                                                  // chassis.
    RedfishCS_Link                                PowerSubsystem;                 // The link to the power
                                                                                  // subsystem properties for this
                                                                                  // chassis.
    RedfishCS_char                                *SKU;                           // The SKU of the chassis.
    RedfishCS_Link                                Sensors;                        // The link to the collection of
    ...
    RedfishCS_Link                                Thermal;                        // The link to the thermal
                                                                                  ...
                                                                                  // chassis.
    RedfishCS_Link                                ThermalSubsystem;               // The link to the thermal
                                                                                  // subsystem properties for this
                                                                                  // chassis.
    RedfishCS_char                                *UUID;                          // The UUID for this chassis.
    RedfishCS_int64                               *WeightKg;                      // The weight of the chassis.
    RedfishCS_int64                               *WidthMm;                       // The width of the chassis.
} RedfishChassis_V1_18_0_Chassis_CS;
...
RedfishCS_status
Json_Chassis_V1_18_0_To_CS (char *JsonRawText, RedfishChassis_V1_18_0_Chassis_CS **ReturnedCS);

RedfishCS_status
CS_To_Chassis_V1_18_0_JSON (RedfishChassis_V1_18_0_Chassis_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyChassis_V1_18_0_CS (RedfishChassis_V1_18_0_Chassis_CS *CSPtr);

RedfishCS_status
DestroyChassis_V1_18_0_Json (RedfishCS_char *JsonText);
