...
#ifndef RedfishComputersystem_V1_9_1_CSTRUCT_H_
#define RedfishComputersystem_V1_9_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishComputerSystem_V1_9_1_TrustedModules_Array_CS RedfishComputerSystem_V1_9_1_TrustedModules_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishComputerSystem_V1_9_1_Actions_CS RedfishComputerSystem_V1_9_1_Actions_CS;
typedef struct _RedfishComputerSystem_V1_9_1_AddResourceBlock_CS RedfishComputerSystem_V1_9_1_AddResourceBlock_CS;
typedef struct _RedfishComputerSystem_V1_9_1_Boot_CS RedfishComputerSystem_V1_9_1_Boot_CS;
typedef struct _RedfishComputerSystem_V1_9_1_ComputerSystem_CS RedfishComputerSystem_V1_9_1_ComputerSystem_CS;
typedef struct _RedfishComputerSystem_V1_9_1_HostedServices_CS RedfishComputerSystem_V1_9_1_HostedServices_CS;
typedef struct _RedfishComputerSystem_V1_9_1_Links_CS RedfishComputerSystem_V1_9_1_Links_CS;
typedef struct _RedfishComputerSystem_V1_9_1_MemorySummary_CS RedfishComputerSystem_V1_9_1_MemorySummary_CS;
typedef struct _RedfishComputerSystem_V1_9_1_OemActions_CS RedfishComputerSystem_V1_9_1_OemActions_CS;
typedef struct _RedfishComputerSystem_V1_9_1_ProcessorSummary_CS RedfishComputerSystem_V1_9_1_ProcessorSummary_CS;
typedef struct _RedfishComputerSystem_V1_9_1_RemoveResourceBlock_CS RedfishComputerSystem_V1_9_1_RemoveResourceBlock_CS;
typedef struct _RedfishComputerSystem_V1_9_1_Reset_CS RedfishComputerSystem_V1_9_1_Reset_CS;
typedef struct _RedfishComputerSystem_V1_9_1_SetDefaultBootOrder_CS RedfishComputerSystem_V1_9_1_SetDefaultBootOrder_CS;
typedef struct _RedfishComputerSystem_V1_9_1_TrustedModules_CS RedfishComputerSystem_V1_9_1_TrustedModules_CS;
typedef struct _RedfishComputerSystem_V1_9_1_WatchdogTimer_CS RedfishComputerSystem_V1_9_1_WatchdogTimer_CS;
...
//
typedef struct _RedfishComputerSystem_V1_9_1_Actions_CS {
    RedfishComputerSystem_V1_9_1_AddResourceBlock_CS       *ComputerSystem_AddResourceBlock;  
    RedfishComputerSystem_V1_9_1_RemoveResourceBlock_CS    *ComputerSystem_RemoveResourceBlock;
    RedfishComputerSystem_V1_9_1_Reset_CS                  *ComputerSystem_Reset;             
    RedfishComputerSystem_V1_9_1_SetDefaultBootOrder_CS    *ComputerSystem_SetDefaultBootOrder;
    RedfishComputerSystem_V1_9_1_OemActions_CS             *Oem;                                  // The available OEM-specific
                                                                                                  // actions for this Resource.
} RedfishComputerSystem_V1_9_1_Actions_CS;

//
// This action adds a Resource Block to a system.
//
typedef struct _RedfishComputerSystem_V1_9_1_AddResourceBlock_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishComputerSystem_V1_9_1_AddResourceBlock_CS;

//
// The boot information for this Resource.
//
typedef struct _RedfishComputerSystem_V1_9_1_Boot_CS {
    ...
    RedfishCS_char          *UefiTargetBootSourceOverride;    // The UEFI device path of the
                                                             ...
                                                             // BootSourceOverrideTarget is
                                                             // `UefiTarget`.
} RedfishComputerSystem_V1_9_1_Boot_CS;

//
// The services that may be running or installed on the system.
//
typedef struct _RedfishComputerSystem_V1_9_1_HostedServices_CS {
    RedfishResource_Oem_CS    *Oem;              // The OEM extension property.
    RedfishCS_Link            StorageServices;    // The link to a collection of
                                                 // storage services that this
                                                 // computer system supports.
} RedfishComputerSystem_V1_9_1_HostedServices_CS;

//
// The links to other Resources that are related to this Resource.
//
typedef struct _RedfishComputerSystem_V1_9_1_Links_CS {
...
} RedfishComputerSystem_V1_9_1_Links_CS;

//
// The memory of the system in general detail.
//
typedef struct _RedfishComputerSystem_V1_9_1_MemorySummary_CS {
    ...
    RedfishCS_int64              *TotalSystemPersistentMemoryGiB;    // The total configured, system-
                                                                    ...
                                                                    // measured in GiB.
} RedfishComputerSystem_V1_9_1_MemorySummary_CS;

//
// The available OEM-specific actions for this Resource.
//
typedef struct _RedfishComputerSystem_V1_9_1_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishComputerSystem_V1_9_1_OemActions_CS;

//
// The central processors of the system in general detail.
//
typedef struct _RedfishComputerSystem_V1_9_1_ProcessorSummary_CS {
    ...
    RedfishResource_Status_CS    *Status;                  // The status and health of the
                                                           // Resource and its subordinate
                                                           // or dependent Resources.
} RedfishComputerSystem_V1_9_1_ProcessorSummary_CS;

//
// This action removes a Resource Block from a system.
//
typedef struct _RedfishComputerSystem_V1_9_1_RemoveResourceBlock_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishComputerSystem_V1_9_1_RemoveResourceBlock_CS;

//
// This action resets the system.
//
typedef struct _RedfishComputerSystem_V1_9_1_Reset_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishComputerSystem_V1_9_1_Reset_CS;

//
// This action sets the BootOrder to the default settings.
//
typedef struct _RedfishComputerSystem_V1_9_1_SetDefaultBootOrder_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishComputerSystem_V1_9_1_SetDefaultBootOrder_CS;

//
// The Trusted Module installed in the system.
//
typedef struct _RedfishComputerSystem_V1_9_1_TrustedModules_CS {
    ...
    RedfishResource_Status_CS    *Status;                   // The status and health of the
                                                            // Resource and its subordinate
                                                            // or dependent Resources.
} RedfishComputerSystem_V1_9_1_TrustedModules_CS;

//
// This type describes the host watchdog timer functionality for this system.
//
typedef struct _RedfishComputerSystem_V1_9_1_WatchdogTimer_CS {
    ...
    RedfishCS_char               *WarningAction;     // The action to perform when the
                                                     ...
                                                     // dependent on the
                                                     // implementation.
} RedfishComputerSystem_V1_9_1_WatchdogTimer_CS;
...
//
typedef struct _RedfishComputerSystem_V1_9_1_ComputerSystem_CS {
    RedfishCS_Header                                        Header;
    RedfishCS_char                                          *odata_context;          
    RedfishCS_char                                          *odata_etag;             
    RedfishCS_char                                          *odata_id;               
    RedfishCS_char                                          *odata_type;             
    RedfishComputerSystem_V1_9_1_Actions_CS                 *Actions;                    // The available actions for this
                                                                                         // Resource.
    ...
    RedfishComputerSystem_V1_9_1_Boot_CS                    *Boot;                       // The boot settings for this
                                                                                         // system.
    ...
    RedfishCS_char                                          *HostName;                   // The DNS host name, without any
                                                                                         // domain information.
    RedfishComputerSystem_V1_9_1_WatchdogTimer_CS           *HostWatchdogTimer;          // The host watchdog timer
                                                                                         // functionality for this system.
    RedfishComputerSystem_V1_9_1_HostedServices_CS          *HostedServices;             // The services that this
                                                                                         // computer system supports.
    ...
    RedfishCS_char                                          *IndicatorLED;               // The state of the indicator
                                                                                         ...
                                                                                         // system.
    RedfishComputerSystem_V1_9_1_Links_CS                   *Links;                      // The links to other Resources
    ...
    RedfishCS_Link                                          MemoryDomains;               // The link to the collection of
                                                                                         ...
                                                                                         // this system.
    RedfishComputerSystem_V1_9_1_MemorySummary_CS           *MemorySummary;              // The central memory of the
    ...
    RedfishCS_char                                          *PowerState;                 // The current power state of the
                                                                                         // system.
    RedfishComputerSystem_V1_9_1_ProcessorSummary_CS        *ProcessorSummary;           // The central processors of the
                                                                                         // system in general detail.
    ...
    RedfishComputerSystem_V1_9_1_TrustedModules_Array_CS    *TrustedModules;             // An array of trusted modules in
                                                                                         // the system.
    RedfishCS_char                                          *UUID;                       // The UUID for this system.
} RedfishComputerSystem_V1_9_1_ComputerSystem_CS;
...
typedef struct _RedfishComputerSystem_V1_9_1_TrustedModules_Array_CS  {
    RedfishComputerSystem_V1_9_1_TrustedModules_Array_CS    *Next;
    RedfishComputerSystem_V1_9_1_TrustedModules_CS    *ArrayValue;
} RedfishComputerSystem_V1_9_1_TrustedModules_Array_CS;
...
RedfishCS_status
Json_ComputerSystem_V1_9_1_To_CS (char *JsonRawText, RedfishComputerSystem_V1_9_1_ComputerSystem_CS **ReturnedCS);

RedfishCS_status
CS_To_ComputerSystem_V1_9_1_JSON (RedfishComputerSystem_V1_9_1_ComputerSystem_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyComputerSystem_V1_9_1_CS (RedfishComputerSystem_V1_9_1_ComputerSystem_CS *CSPtr);

RedfishCS_status
DestroyComputerSystem_V1_9_1_Json (RedfishCS_char *JsonText);
