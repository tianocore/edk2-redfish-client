...
#ifndef RedfishComputersystem_V1_15_1_CSTRUCT_H_
#define RedfishComputersystem_V1_15_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishComputerSystem_V1_15_1_TrustedModules_Array_CS RedfishComputerSystem_V1_15_1_TrustedModules_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishComputerSystem_V1_15_1_Actions_CS RedfishComputerSystem_V1_15_1_Actions_CS;
typedef struct _RedfishComputerSystem_V1_15_1_AddResourceBlock_CS RedfishComputerSystem_V1_15_1_AddResourceBlock_CS;
typedef struct _RedfishComputerSystem_V1_15_1_Boot_CS RedfishComputerSystem_V1_15_1_Boot_CS;
typedef struct _RedfishComputerSystem_V1_15_1_BootProgress_CS RedfishComputerSystem_V1_15_1_BootProgress_CS;
typedef struct _RedfishComputerSystem_V1_15_1_ComputerSystem_CS RedfishComputerSystem_V1_15_1_ComputerSystem_CS;
typedef struct _RedfishComputerSystem_V1_15_1_HostGraphicalConsole_CS RedfishComputerSystem_V1_15_1_HostGraphicalConsole_CS;
typedef struct _RedfishComputerSystem_V1_15_1_HostSerialConsole_CS RedfishComputerSystem_V1_15_1_HostSerialConsole_CS;
typedef struct _RedfishComputerSystem_V1_15_1_HostedServices_CS RedfishComputerSystem_V1_15_1_HostedServices_CS;
typedef struct _RedfishComputerSystem_V1_15_1_Links_CS RedfishComputerSystem_V1_15_1_Links_CS;
typedef struct _RedfishComputerSystem_V1_15_1_MemorySummary_CS RedfishComputerSystem_V1_15_1_MemorySummary_CS;
typedef struct _RedfishComputerSystem_V1_15_1_OemActions_CS RedfishComputerSystem_V1_15_1_OemActions_CS;
typedef struct _RedfishComputerSystem_V1_15_1_ProcessorSummary_CS RedfishComputerSystem_V1_15_1_ProcessorSummary_CS;
typedef struct _RedfishComputerSystem_V1_15_1_RemoveResourceBlock_CS RedfishComputerSystem_V1_15_1_RemoveResourceBlock_CS;
typedef struct _RedfishComputerSystem_V1_15_1_Reset_CS RedfishComputerSystem_V1_15_1_Reset_CS;
typedef struct _RedfishComputerSystem_V1_15_1_SerialConsoleProtocol_CS RedfishComputerSystem_V1_15_1_SerialConsoleProtocol_CS;
typedef struct _RedfishComputerSystem_V1_15_1_SetDefaultBootOrder_CS RedfishComputerSystem_V1_15_1_SetDefaultBootOrder_CS;
typedef struct _RedfishComputerSystem_V1_15_1_TrustedModules_CS RedfishComputerSystem_V1_15_1_TrustedModules_CS;
typedef struct _RedfishComputerSystem_V1_15_1_VirtualMediaConfig_CS RedfishComputerSystem_V1_15_1_VirtualMediaConfig_CS;
typedef struct _RedfishComputerSystem_V1_15_1_WatchdogTimer_CS RedfishComputerSystem_V1_15_1_WatchdogTimer_CS;
...
typedef struct _RedfishComputerSystem_V1_15_1_Actions_CS {
    ...
    RedfishComputerSystem_V1_15_1_OemActions_CS             *Oem;                                  // The available OEM-specific
...
typedef struct _RedfishComputerSystem_V1_15_1_HostSerialConsole_CS {
    RedfishComputerSystem_V1_15_1_SerialConsoleProtocol_CS    *IPMI;                    // The connection details for an
                                                                                        // IPMI Serial-over-LAN service.
    RedfishCS_int64                                           *MaxConcurrentSessions;    // The maximum number of service
                                                                                        // sessions, regardless of
                                                                                        // protocol, that this system can
                                                                                        // support.
    RedfishComputerSystem_V1_15_1_SerialConsoleProtocol_CS    *SSH;                     // The connection details for an
                                                                                        // SSH serial console service.
    RedfishComputerSystem_V1_15_1_SerialConsoleProtocol_CS    *Telnet;                  // The connection details for a
...
typedef struct _RedfishComputerSystem_V1_15_1_ComputerSystem_CS {
    ...
    RedfishComputerSystem_V1_15_1_Actions_CS                 *Actions;                    // The available actions for this
                                                                                          // resource.
    ...
    RedfishComputerSystem_V1_15_1_Boot_CS                    *Boot;                       // The boot settings for this
                                                                                          // system.
    RedfishComputerSystem_V1_15_1_BootProgress_CS            *BootProgress;               // This object describes the last
                                                                                          // boot progress state.
    RedfishCS_Link                                           Certificates;                // The link to a collection of
    ...
    RedfishCS_Link                                           FabricAdapters;              // The link to the collection of
                                                                                          ...
                                                                                          // with this system.
    RedfishComputerSystem_V1_15_1_HostGraphicalConsole_CS    *GraphicalConsole;           // The information about the
    ...
    RedfishCS_char                                           *HostName;                   // The DNS host name, without any
                                                                                          // domain information.
    RedfishComputerSystem_V1_15_1_WatchdogTimer_CS           *HostWatchdogTimer;          // The host watchdog timer
                                                                                          // functionality for this system.
    RedfishComputerSystem_V1_15_1_HostedServices_CS          *HostedServices;             // The services that this
                                                                                          // computer system supports.
    ...
    RedfishCS_char                                           *LastResetTime;              // The date and time when the
                                                                                          ...
                                                                                          // rebooted.
    RedfishComputerSystem_V1_15_1_Links_CS                   *Links;                      // The links to other resources
    ...
    RedfishCS_Link                                           MemoryDomains;               // The link to the collection of
                                                                                          ...
                                                                                          // this system.
    RedfishComputerSystem_V1_15_1_MemorySummary_CS           *MemorySummary;              // The central memory of the
    ...
    RedfishCS_char                                           *PowerState;                 // The current power state of the
                                                                                          // system.
    RedfishComputerSystem_V1_15_1_ProcessorSummary_CS        *ProcessorSummary;           // The central processors of the
                                                                                          // system in general detail.
    ...
    RedfishCS_Link                                           SecureBoot;                  // The link to the UEFI Secure
                                                                                          ...
                                                                                          // system.
    RedfishComputerSystem_V1_15_1_HostSerialConsole_CS       *SerialConsole;              // The serial console services
    ...
    RedfishComputerSystem_V1_15_1_TrustedModules_Array_CS    *TrustedModules;             // An array of trusted modules in
                                                                                          // the system.
    ...
    RedfishComputerSystem_V1_15_1_VirtualMediaConfig_CS      *VirtualMediaConfig;         // The information about the
...
typedef struct _RedfishComputerSystem_V1_15_1_TrustedModules_Array_CS  {
    RedfishComputerSystem_V1_15_1_TrustedModules_Array_CS    *Next;
    RedfishComputerSystem_V1_15_1_TrustedModules_CS    *ArrayValue;
} RedfishComputerSystem_V1_15_1_TrustedModules_Array_CS;
...
RedfishCS_status
Json_ComputerSystem_V1_15_1_To_CS (char *JsonRawText, RedfishComputerSystem_V1_15_1_ComputerSystem_CS **ReturnedCS);

RedfishCS_status
CS_To_ComputerSystem_V1_15_1_JSON (RedfishComputerSystem_V1_15_1_ComputerSystem_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyComputerSystem_V1_15_1_CS (RedfishComputerSystem_V1_15_1_ComputerSystem_CS *CSPtr);

RedfishCS_status
DestroyComputerSystem_V1_15_1_Json (RedfishCS_char *JsonText);
