...
#ifndef RedfishNetworkdevicefunction_V1_1_7_CSTRUCT_H_
#define RedfishNetworkdevicefunction_V1_1_7_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishNetworkDeviceFunction_V1_1_7_BootTargets_Array_CS RedfishNetworkDeviceFunction_V1_1_7_BootTargets_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishNetworkDeviceFunction_V1_1_7_Actions_CS RedfishNetworkDeviceFunction_V1_1_7_Actions_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_1_7_BootTargets_CS RedfishNetworkDeviceFunction_V1_1_7_BootTargets_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_1_7_Ethernet_CS RedfishNetworkDeviceFunction_V1_1_7_Ethernet_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_1_7_FibreChannel_CS RedfishNetworkDeviceFunction_V1_1_7_FibreChannel_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_1_7_Links_CS RedfishNetworkDeviceFunction_V1_1_7_Links_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_1_7_NetworkDeviceFunction_CS RedfishNetworkDeviceFunction_V1_1_7_NetworkDeviceFunction_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_1_7_OemActions_CS RedfishNetworkDeviceFunction_V1_1_7_OemActions_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_1_7_iSCSIBoot_CS RedfishNetworkDeviceFunction_V1_1_7_iSCSIBoot_CS;
...
//
typedef struct _RedfishNetworkDeviceFunction_V1_1_7_Actions_CS {
    RedfishNetworkDeviceFunction_V1_1_7_OemActions_CS    *Oem;    // The available OEM-specific
                                                                 // actions for this resource.
} RedfishNetworkDeviceFunction_V1_1_7_Actions_CS;

//
// A Fibre Channel boot target configured for a network device function.
//
typedef struct _RedfishNetworkDeviceFunction_V1_1_7_BootTargets_CS {
...
} RedfishNetworkDeviceFunction_V1_1_7_BootTargets_CS;

//
// This type describes Ethernet capabilities, status, and configuration for a
// network device function.
//
typedef struct _RedfishNetworkDeviceFunction_V1_1_7_Ethernet_CS {
...
} RedfishNetworkDeviceFunction_V1_1_7_Ethernet_CS;

//
// This type describes Fibre Channel capabilities, status, and configuration for a
// network device function.
//
typedef struct _RedfishNetworkDeviceFunction_V1_1_7_FibreChannel_CS {
    RedfishCS_bool                                              *AllowFIPVLANDiscovery;    // An indication of whether the
                                                                                          // FCoE Initialization Protocol
                                                                                          // (FIP) populates the FCoE VLAN
                                                                                          // ID.
    RedfishNetworkDeviceFunction_V1_1_7_BootTargets_Array_CS    *BootTargets;             // An array of Fibre Channel boot
    ...
    RedfishCS_char                                              *WWPN;                    // The currently configured World
                                                                                          ...
                                                                                          // of this function.
} RedfishNetworkDeviceFunction_V1_1_7_FibreChannel_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishNetworkDeviceFunction_V1_1_7_Links_CS {
    RedfishResource_Oem_CS    *Oem;           // The OEM extension property.
    RedfishCS_Link            PCIeFunction;    // The link to the PCIe function
                                              // associated with this network
                                              // device function.
} RedfishNetworkDeviceFunction_V1_1_7_Links_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishNetworkDeviceFunction_V1_1_7_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishNetworkDeviceFunction_V1_1_7_OemActions_CS;

//
// The iSCSI boot capabilities, status, and configuration for a network device
// function.
//
typedef struct _RedfishNetworkDeviceFunction_V1_1_7_iSCSIBoot_CS {
...
} RedfishNetworkDeviceFunction_V1_1_7_iSCSIBoot_CS;
...
// adapter exposes.
//
typedef struct _RedfishNetworkDeviceFunction_V1_1_7_NetworkDeviceFunction_CS {
    RedfishCS_Header                                       Header;
    RedfishCS_char                                         *odata_context;                    
    RedfishCS_char                                         *odata_etag;                       
    RedfishCS_char                                         *odata_id;                         
    RedfishCS_char                                         *odata_type;                       
    RedfishNetworkDeviceFunction_V1_1_7_Actions_CS         *Actions;                              // The available actions for this
                                                                                                  // resource.
    ...
    RedfishCS_bool                                         *DeviceEnabled;                        // An indication of whether the
                                                                                                  ...
                                                                                                  // enabled.
    RedfishNetworkDeviceFunction_V1_1_7_Ethernet_CS        *Ethernet;                             // The Ethernet capabilities,
                                                                                                  // status, and configuration
                                                                                                  // values for this network device
                                                                                                  // function.
    RedfishNetworkDeviceFunction_V1_1_7_FibreChannel_CS    *FibreChannel;                         // The Fibre Channel
                                                                                                  // capabilities, status, and
                                                                                                  // configuration values for this
                                                                                                  // network device function.
    RedfishCS_char                                         *Id;                               
    RedfishNetworkDeviceFunction_V1_1_7_Links_CS           *Links;                                // The links to other resources
    ...
    RedfishCS_bool                                         *VirtualFunctionsEnabled;              // An indication of whether
                                                                                                  ...
                                                                                                  // for this network device
                                                                                                  // function.
    RedfishNetworkDeviceFunction_V1_1_7_iSCSIBoot_CS       *iSCSIBoot;                            // The iSCSI boot capabilities,
                                                                                                  // status, and configuration
                                                                                                  // values for this network device
                                                                                                  // function.
} RedfishNetworkDeviceFunction_V1_1_7_NetworkDeviceFunction_CS;

typedef struct _RedfishNetworkDeviceFunction_V1_1_7_BootTargets_Array_CS  {
    RedfishNetworkDeviceFunction_V1_1_7_BootTargets_Array_CS    *Next;
    RedfishNetworkDeviceFunction_V1_1_7_BootTargets_CS    *ArrayValue;
} RedfishNetworkDeviceFunction_V1_1_7_BootTargets_Array_CS;
...
RedfishCS_status
Json_NetworkDeviceFunction_V1_1_7_To_CS (char *JsonRawText, RedfishNetworkDeviceFunction_V1_1_7_NetworkDeviceFunction_CS **ReturnedCS);

RedfishCS_status
CS_To_NetworkDeviceFunction_V1_1_7_JSON (RedfishNetworkDeviceFunction_V1_1_7_NetworkDeviceFunction_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyNetworkDeviceFunction_V1_1_7_CS (RedfishNetworkDeviceFunction_V1_1_7_NetworkDeviceFunction_CS *CSPtr);

RedfishCS_status
DestroyNetworkDeviceFunction_V1_1_7_Json (RedfishCS_char *JsonText);
