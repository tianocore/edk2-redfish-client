...
#ifndef RedfishThermal_V1_2_6_CSTRUCT_H_
#define RedfishThermal_V1_2_6_CSTRUCT_H_
...
#endif
typedef struct _RedfishThermal_V1_2_6_Fan_Array_CS RedfishThermal_V1_2_6_Fan_Array_CS;
typedef struct _RedfishThermal_V1_2_6_Temperature_Array_CS RedfishThermal_V1_2_6_Temperature_Array_CS;
...
typedef struct _RedfishThermal_V1_2_6_Fan_CS RedfishThermal_V1_2_6_Fan_CS;
typedef struct _RedfishThermal_V1_2_6_Temperature_CS RedfishThermal_V1_2_6_Temperature_CS;
typedef struct _RedfishThermal_V1_2_6_Thermal_CS RedfishThermal_V1_2_6_Thermal_CS;
...
typedef struct _RedfishThermal_V1_2_6_Fan_CS {
...
} RedfishThermal_V1_2_6_Fan_CS;

typedef struct _RedfishThermal_V1_2_6_Temperature_CS {
    RedfishCS_char                   *odata_id;                
    RedfishCS_int64                  *LowerThresholdCritical;      // Below normal range but not yet
                                                                   // fatal.
    RedfishCS_int64                  *LowerThresholdFatal;         // Below normal range and is
    ...
    RedfishCS_int64                  *UpperThresholdFatal;         // Above normal range and is
                                                                   // fatal.
    RedfishCS_int64                  *UpperThresholdNonCritical;    // Above normal range.
} RedfishThermal_V1_2_6_Temperature_CS;
...
//
typedef struct _RedfishThermal_V1_2_6_Thermal_CS {
    ...
    RedfishThermal_V1_2_6_Fan_Array_CS            *Fans;                      // This is the definition for
                                                                              // fans.
    ...
    RedfishResource_Status_CS                     *Status;                    // This property describes the
                                                                              // status and health of the
                                                                              // resource and its children.
    RedfishThermal_V1_2_6_Temperature_Array_CS    *Temperatures;              // This is the definition for
                                                                              // temperature sensors.
    RedfishCS_int64                               *Temperaturesodata_count;
} RedfishThermal_V1_2_6_Thermal_CS;
...
typedef struct _RedfishThermal_V1_2_6_Fan_Array_CS  {
    RedfishThermal_V1_2_6_Fan_Array_CS    *Next;
    RedfishThermal_V1_2_6_Fan_CS    *ArrayValue;
} RedfishThermal_V1_2_6_Fan_Array_CS;

typedef struct _RedfishThermal_V1_2_6_Temperature_Array_CS  {
    RedfishThermal_V1_2_6_Temperature_Array_CS    *Next;
    RedfishThermal_V1_2_6_Temperature_CS    *ArrayValue;
} RedfishThermal_V1_2_6_Temperature_Array_CS;

RedfishCS_status
Json_Thermal_V1_2_6_To_CS (char *JsonRawText, RedfishThermal_V1_2_6_Thermal_CS **ReturnedCS);

RedfishCS_status
CS_To_Thermal_V1_2_6_JSON (RedfishThermal_V1_2_6_Thermal_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyThermal_V1_2_6_CS (RedfishThermal_V1_2_6_Thermal_CS *CSPtr);

RedfishCS_status
DestroyThermal_V1_2_6_Json (RedfishCS_char *JsonText);
