...
#ifndef RedfishHostinterface_V1_2_2_CSTRUCT_H_
#define RedfishHostinterface_V1_2_2_CSTRUCT_H_
...
#endif
typedef struct _RedfishHostInterface_V1_2_2_Actions_CS RedfishHostInterface_V1_2_2_Actions_CS;
typedef struct _RedfishHostInterface_V1_2_2_HostInterface_CS RedfishHostInterface_V1_2_2_HostInterface_CS;
typedef struct _RedfishHostInterface_V1_2_2_Links_CS RedfishHostInterface_V1_2_2_Links_CS;
typedef struct _RedfishHostInterface_V1_2_2_OemActions_CS RedfishHostInterface_V1_2_2_OemActions_CS;
...
typedef struct _RedfishHostInterface_V1_2_2_Actions_CS {
    RedfishHostInterface_V1_2_2_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishHostInterface_V1_2_2_HostInterface_CS {
    ...
    RedfishHostInterface_V1_2_2_Actions_CS    *Actions;                   // The available actions for this
                                                                          // Resource.
    ...
    RedfishCS_char                            *KernelAuthRoleId;          // The Role used for kernel
                                                                          // authentication on this
                                                                          // interface.
    RedfishHostInterface_V1_2_2_Links_CS      *Links;                     // The links to other Resources
...
RedfishCS_status
Json_HostInterface_V1_2_2_To_CS (char *JsonRawText, RedfishHostInterface_V1_2_2_HostInterface_CS **ReturnedCS);

RedfishCS_status
CS_To_HostInterface_V1_2_2_JSON (RedfishHostInterface_V1_2_2_HostInterface_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyHostInterface_V1_2_2_CS (RedfishHostInterface_V1_2_2_HostInterface_CS *CSPtr);

RedfishCS_status
DestroyHostInterface_V1_2_2_Json (RedfishCS_char *JsonText);
