...
#ifndef RedfishMemorymetrics_V1_1_5_CSTRUCT_H_
#define RedfishMemorymetrics_V1_1_5_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMemoryMetrics_V1_1_5_Actions_CS RedfishMemoryMetrics_V1_1_5_Actions_CS;
typedef struct _RedfishMemoryMetrics_V1_1_5_AlarmTrips_CS RedfishMemoryMetrics_V1_1_5_AlarmTrips_CS;
typedef struct _RedfishMemoryMetrics_V1_1_5_ClearCurrentPeriod_CS RedfishMemoryMetrics_V1_1_5_ClearCurrentPeriod_CS;
typedef struct _RedfishMemoryMetrics_V1_1_5_CurrentPeriod_CS RedfishMemoryMetrics_V1_1_5_CurrentPeriod_CS;
typedef struct _RedfishMemoryMetrics_V1_1_5_HealthData_CS RedfishMemoryMetrics_V1_1_5_HealthData_CS;
typedef struct _RedfishMemoryMetrics_V1_1_5_LifeTime_CS RedfishMemoryMetrics_V1_1_5_LifeTime_CS;
typedef struct _RedfishMemoryMetrics_V1_1_5_MemoryMetrics_CS RedfishMemoryMetrics_V1_1_5_MemoryMetrics_CS;
typedef struct _RedfishMemoryMetrics_V1_1_5_OemActions_CS RedfishMemoryMetrics_V1_1_5_OemActions_CS;
...
typedef struct _RedfishMemoryMetrics_V1_1_5_Actions_CS {
    ...
    RedfishMemoryMetrics_V1_1_5_OemActions_CS            *Oem;                                // This property contains the
...
typedef struct _RedfishMemoryMetrics_V1_1_5_HealthData_CS {
    RedfishMemoryMetrics_V1_1_5_AlarmTrips_CS    *AlarmTrips;                      // Alarm trip information about
                                                                                   // the memory.
...
typedef struct _RedfishMemoryMetrics_V1_1_5_MemoryMetrics_CS {
    ...
    RedfishMemoryMetrics_V1_1_5_Actions_CS          *Actions;          // The available actions for this
                                                                       // resource.
    RedfishCS_int64                                 *BlockSizeBytes;    // Block size in bytes.
    RedfishMemoryMetrics_V1_1_5_CurrentPeriod_CS    *CurrentPeriod;    // This object contains the
                                                                       // Memory metrics since last
                                                                       // reset or ClearCurrentPeriod
                                                                       // action.
    RedfishCS_char                                  *Description;  
    RedfishMemoryMetrics_V1_1_5_HealthData_CS       *HealthData;       // This object describes the
                                                                       // health information of the
                                                                       // memory.
    RedfishCS_char                                  *Id;           
    RedfishMemoryMetrics_V1_1_5_LifeTime_CS         *LifeTime;         // This object contains the
...
RedfishCS_status
Json_MemoryMetrics_V1_1_5_To_CS (char *JsonRawText, RedfishMemoryMetrics_V1_1_5_MemoryMetrics_CS **ReturnedCS);

RedfishCS_status
CS_To_MemoryMetrics_V1_1_5_JSON (RedfishMemoryMetrics_V1_1_5_MemoryMetrics_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMemoryMetrics_V1_1_5_CS (RedfishMemoryMetrics_V1_1_5_MemoryMetrics_CS *CSPtr);

RedfishCS_status
DestroyMemoryMetrics_V1_1_5_Json (RedfishCS_char *JsonText);
