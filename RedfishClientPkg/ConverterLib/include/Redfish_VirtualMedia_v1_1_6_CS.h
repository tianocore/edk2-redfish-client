...
#ifndef RedfishVirtualmedia_V1_1_6_CSTRUCT_H_
#define RedfishVirtualmedia_V1_1_6_CSTRUCT_H_
...
typedef struct _RedfishVirtualMedia_V1_1_6_Actions_CS RedfishVirtualMedia_V1_1_6_Actions_CS;
typedef struct _RedfishVirtualMedia_V1_1_6_OemActions_CS RedfishVirtualMedia_V1_1_6_OemActions_CS;
typedef struct _RedfishVirtualMedia_V1_1_6_VirtualMedia_CS RedfishVirtualMedia_V1_1_6_VirtualMedia_CS;
//
// The OEM extension.
//
#ifndef RedfishResource_Oem_CS_
...
typedef struct _RedfishVirtualMedia_V1_1_6_Actions_CS {
    RedfishVirtualMedia_V1_1_6_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishVirtualMedia_V1_1_6_VirtualMedia_CS {
    ...
    RedfishVirtualMedia_V1_1_6_Actions_CS    *Actions;          // The available actions for this
                                                                // resource.
...
RedfishCS_status
Json_VirtualMedia_V1_1_6_To_CS (char *JsonRawText, RedfishVirtualMedia_V1_1_6_VirtualMedia_CS **ReturnedCS);

RedfishCS_status
CS_To_VirtualMedia_V1_1_6_JSON (RedfishVirtualMedia_V1_1_6_VirtualMedia_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyVirtualMedia_V1_1_6_CS (RedfishVirtualMedia_V1_1_6_VirtualMedia_CS *CSPtr);

RedfishCS_status
DestroyVirtualMedia_V1_1_6_Json (RedfishCS_char *JsonText);
