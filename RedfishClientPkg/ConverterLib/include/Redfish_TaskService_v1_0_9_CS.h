...
#ifndef RedfishTaskservice_V1_0_9_CSTRUCT_H_
#define RedfishTaskservice_V1_0_9_CSTRUCT_H_
...
typedef struct _RedfishTaskService_V1_0_9_TaskService_CS RedfishTaskService_V1_0_9_TaskService_CS;
...
//
typedef struct _RedfishTaskService_V1_0_9_TaskService_CS {
    ...
    RedfishCS_Link               Tasks;                              // The links to the collection of
                                                                     // tasks.
} RedfishTaskService_V1_0_9_TaskService_CS;
...
RedfishCS_status
Json_TaskService_V1_0_9_To_CS (char *JsonRawText, RedfishTaskService_V1_0_9_TaskService_CS **ReturnedCS);

RedfishCS_status
CS_To_TaskService_V1_0_9_JSON (RedfishTaskService_V1_0_9_TaskService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyTaskService_V1_0_9_CS (RedfishTaskService_V1_0_9_TaskService_CS *CSPtr);

RedfishCS_status
DestroyTaskService_V1_0_9_Json (RedfishCS_char *JsonText);
