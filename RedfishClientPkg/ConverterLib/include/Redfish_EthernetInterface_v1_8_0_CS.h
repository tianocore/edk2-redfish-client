...
#ifndef RedfishEthernetinterface_V1_8_0_CSTRUCT_H_
#define RedfishEthernetinterface_V1_8_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishEthernetInterface_V1_8_0_IPv6AddressPolicyEntry_Array_CS RedfishEthernetInterface_V1_8_0_IPv6AddressPolicyEntry_Array_CS;
typedef struct _RedfishEthernetInterface_V1_8_0_Actions_CS RedfishEthernetInterface_V1_8_0_Actions_CS;
typedef struct _RedfishEthernetInterface_V1_8_0_DHCPv4Configuration_CS RedfishEthernetInterface_V1_8_0_DHCPv4Configuration_CS;
typedef struct _RedfishEthernetInterface_V1_8_0_DHCPv6Configuration_CS RedfishEthernetInterface_V1_8_0_DHCPv6Configuration_CS;
typedef struct _RedfishEthernetInterface_V1_8_0_EthernetInterface_CS RedfishEthernetInterface_V1_8_0_EthernetInterface_CS;
typedef struct _RedfishEthernetInterface_V1_8_0_IPv6AddressPolicyEntry_CS RedfishEthernetInterface_V1_8_0_IPv6AddressPolicyEntry_CS;
typedef struct _RedfishEthernetInterface_V1_8_0_Links_CS RedfishEthernetInterface_V1_8_0_Links_CS;
typedef struct _RedfishEthernetInterface_V1_8_0_OemActions_CS RedfishEthernetInterface_V1_8_0_OemActions_CS;
typedef struct _RedfishEthernetInterface_V1_8_0_StatelessAddressAutoConfiguration_CS RedfishEthernetInterface_V1_8_0_StatelessAddressAutoConfiguration_CS;
...
typedef struct _RedfishEthernetInterface_V1_8_0_Actions_CS {
    RedfishEthernetInterface_V1_8_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishEthernetInterface_V1_8_0_EthernetInterface_CS {
    ...
    RedfishEthernetInterface_V1_8_0_Actions_CS                              *Actions;                      // The available actions for this
                                                                                                           // resource.
    RedfishCS_bool                                                          *AutoNeg;                      // An indication of whether the
                                                                                                           // speed and duplex are
                                                                                                           // automatically negotiated and
                                                                                                           // configured on this interface.
    RedfishEthernetInterface_V1_8_0_DHCPv4Configuration_CS                  *DHCPv4;                       // DHCPv4 configuration for this
                                                                                                           // interface.
    RedfishEthernetInterface_V1_8_0_DHCPv6Configuration_CS                  *DHCPv6;                       // DHCPv6 configuration for this
                                                                                                           // interface.
    ...
    RedfishCS_Link                                                          IPv4StaticAddresses;           // The IPv4 static addresses
                                                                                                           ...
                                                                                                           // interface.
    RedfishEthernetInterface_V1_8_0_IPv6AddressPolicyEntry_Array_CS         *IPv6AddressPolicyTable;       // An array that represents the
    ...
    RedfishCS_char                                                          *LinkStatus;                   // The link status of this
                                                                                                           // interface, or port.
    RedfishEthernetInterface_V1_8_0_Links_CS                                *Links;                        // The links to other resources
    ...
    RedfishCS_int64                                                         *SpeedMbps;                    // The current speed, in Mbit/s,
                                                                                                           // of this interface.
    RedfishEthernetInterface_V1_8_0_StatelessAddressAutoConfiguration_CS    *StatelessAddressAutoConfig;    // Stateless address
...
typedef struct _RedfishEthernetInterface_V1_8_0_IPv6AddressPolicyEntry_Array_CS  {
    RedfishEthernetInterface_V1_8_0_IPv6AddressPolicyEntry_Array_CS    *Next;
    RedfishEthernetInterface_V1_8_0_IPv6AddressPolicyEntry_CS    *ArrayValue;
} RedfishEthernetInterface_V1_8_0_IPv6AddressPolicyEntry_Array_CS;

RedfishCS_status
Json_EthernetInterface_V1_8_0_To_CS (char *JsonRawText, RedfishEthernetInterface_V1_8_0_EthernetInterface_CS **ReturnedCS);

RedfishCS_status
CS_To_EthernetInterface_V1_8_0_JSON (RedfishEthernetInterface_V1_8_0_EthernetInterface_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEthernetInterface_V1_8_0_CS (RedfishEthernetInterface_V1_8_0_EthernetInterface_CS *CSPtr);

RedfishCS_status
DestroyEthernetInterface_V1_8_0_Json (RedfishCS_char *JsonText);
