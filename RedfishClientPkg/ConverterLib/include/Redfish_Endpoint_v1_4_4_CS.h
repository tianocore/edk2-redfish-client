...
#ifndef RedfishEndpoint_V1_4_4_CSTRUCT_H_
#define RedfishEndpoint_V1_4_4_CSTRUCT_H_
...
#endif
typedef struct _RedfishEndpoint_V1_4_4_ConnectedEntity_Array_CS RedfishEndpoint_V1_4_4_ConnectedEntity_Array_CS;
typedef struct _RedfishEndpoint_V1_4_4_IPTransportDetails_Array_CS RedfishEndpoint_V1_4_4_IPTransportDetails_Array_CS;
typedef struct _RedfishEndpoint_V1_4_4_Actions_CS RedfishEndpoint_V1_4_4_Actions_CS;
typedef struct _RedfishEndpoint_V1_4_4_ConnectedEntity_CS RedfishEndpoint_V1_4_4_ConnectedEntity_CS;
typedef struct _RedfishEndpoint_V1_4_4_Endpoint_CS RedfishEndpoint_V1_4_4_Endpoint_CS;
typedef struct _RedfishEndpoint_V1_4_4_GCID_CS RedfishEndpoint_V1_4_4_GCID_CS;
typedef struct _RedfishEndpoint_V1_4_4_GenZ_CS RedfishEndpoint_V1_4_4_GenZ_CS;
typedef struct _RedfishEndpoint_V1_4_4_IPTransportDetails_CS RedfishEndpoint_V1_4_4_IPTransportDetails_CS;
typedef struct _RedfishEndpoint_V1_4_4_Links_CS RedfishEndpoint_V1_4_4_Links_CS;
typedef struct _RedfishEndpoint_V1_4_4_OemActions_CS RedfishEndpoint_V1_4_4_OemActions_CS;
typedef struct _RedfishEndpoint_V1_4_4_PciId_CS RedfishEndpoint_V1_4_4_PciId_CS;
...
typedef struct _RedfishEndpoint_V1_4_4_Actions_CS {
    RedfishEndpoint_V1_4_4_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishEndpoint_V1_4_4_ConnectedEntity_CS {
    RedfishCS_Link                     EntityLink;           // The link to the associated
                                                             // entity.
    RedfishEndpoint_V1_4_4_PciId_CS    *EntityPciId;         // The PCI ID of the connected
                                                             // entity.
    RedfishCS_char                     *EntityRole;          // The role of the connected
                                                             // entity.
    RedfishCS_char                     *EntityType;          // The type of the connected
                                                             // entity.
    RedfishEndpoint_V1_4_4_GenZ_CS     *GenZ;                // The Gen-Z related properties
                                                             // for the entity.
...
typedef struct _RedfishEndpoint_V1_4_4_GenZ_CS {
    ...
    RedfishEndpoint_V1_4_4_GCID_CS    *GCID;        // The Global Component ID (GCID)
                                                    // for the entity.
...
typedef struct _RedfishEndpoint_V1_4_4_Endpoint_CS {
    ...
    RedfishEndpoint_V1_4_4_Actions_CS                     *Actions;                      // The available actions for this
                                                                                         // resource.
    RedfishEndpoint_V1_4_4_ConnectedEntity_Array_CS       *ConnectedEntities;            // All the entities connected to
                                                                                         // this endpoint.
    ...
    RedfishEndpoint_V1_4_4_IPTransportDetails_Array_CS    *IPTransportDetails;           // An array of details for each
    ...
    RedfishEndpoint_V1_4_4_Links_CS                       *Links;                        // The links to other resources
                                                                                         // that are related to this
                                                                                         // resource.
    RedfishCS_char                                        *Name;                     
    RedfishResource_Oem_CS                                *Oem;                          // The OEM extension property.
    RedfishEndpoint_V1_4_4_PciId_CS                       *PciId;                        // The PCI ID of the endpoint.
...
typedef struct _RedfishEndpoint_V1_4_4_ConnectedEntity_Array_CS  {
    RedfishEndpoint_V1_4_4_ConnectedEntity_Array_CS    *Next;
    RedfishEndpoint_V1_4_4_ConnectedEntity_CS    *ArrayValue;
} RedfishEndpoint_V1_4_4_ConnectedEntity_Array_CS;

typedef struct _RedfishEndpoint_V1_4_4_IPTransportDetails_Array_CS  {
    RedfishEndpoint_V1_4_4_IPTransportDetails_Array_CS    *Next;
    RedfishEndpoint_V1_4_4_IPTransportDetails_CS    *ArrayValue;
} RedfishEndpoint_V1_4_4_IPTransportDetails_Array_CS;

RedfishCS_status
Json_Endpoint_V1_4_4_To_CS (char *JsonRawText, RedfishEndpoint_V1_4_4_Endpoint_CS **ReturnedCS);

RedfishCS_status
CS_To_Endpoint_V1_4_4_JSON (RedfishEndpoint_V1_4_4_Endpoint_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEndpoint_V1_4_4_CS (RedfishEndpoint_V1_4_4_Endpoint_CS *CSPtr);

RedfishCS_status
DestroyEndpoint_V1_4_4_Json (RedfishCS_char *JsonText);
