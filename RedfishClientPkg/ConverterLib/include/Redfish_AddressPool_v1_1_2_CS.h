...
#ifndef RedfishAddresspool_V1_1_2_CSTRUCT_H_
#define RedfishAddresspool_V1_1_2_CSTRUCT_H_
...
#endif
typedef struct _RedfishAddressPool_V1_1_2_ASNumberRange_CS RedfishAddressPool_V1_1_2_ASNumberRange_CS;
typedef struct _RedfishAddressPool_V1_1_2_Actions_CS RedfishAddressPool_V1_1_2_Actions_CS;
typedef struct _RedfishAddressPool_V1_1_2_AddressPool_CS RedfishAddressPool_V1_1_2_AddressPool_CS;
typedef struct _RedfishAddressPool_V1_1_2_BFDSingleHopOnly_CS RedfishAddressPool_V1_1_2_BFDSingleHopOnly_CS;
typedef struct _RedfishAddressPool_V1_1_2_BGPEvpn_CS RedfishAddressPool_V1_1_2_BGPEvpn_CS;
typedef struct _RedfishAddressPool_V1_1_2_BGPNeighbor_CS RedfishAddressPool_V1_1_2_BGPNeighbor_CS;
typedef struct _RedfishAddressPool_V1_1_2_BGPRoute_CS RedfishAddressPool_V1_1_2_BGPRoute_CS;
typedef struct _RedfishAddressPool_V1_1_2_CommonBGPProperties_CS RedfishAddressPool_V1_1_2_CommonBGPProperties_CS;
typedef struct _RedfishAddressPool_V1_1_2_DHCP_CS RedfishAddressPool_V1_1_2_DHCP_CS;
typedef struct _RedfishAddressPool_V1_1_2_EBGP_CS RedfishAddressPool_V1_1_2_EBGP_CS;
typedef struct _RedfishAddressPool_V1_1_2_ESINumberRange_CS RedfishAddressPool_V1_1_2_ESINumberRange_CS;
typedef struct _RedfishAddressPool_V1_1_2_EVINumberRange_CS RedfishAddressPool_V1_1_2_EVINumberRange_CS;
typedef struct _RedfishAddressPool_V1_1_2_Ethernet_CS RedfishAddressPool_V1_1_2_Ethernet_CS;
typedef struct _RedfishAddressPool_V1_1_2_GenZ_CS RedfishAddressPool_V1_1_2_GenZ_CS;
typedef struct _RedfishAddressPool_V1_1_2_GracefulRestart_CS RedfishAddressPool_V1_1_2_GracefulRestart_CS;
typedef struct _RedfishAddressPool_V1_1_2_IPv4_CS RedfishAddressPool_V1_1_2_IPv4_CS;
typedef struct _RedfishAddressPool_V1_1_2_IPv4AddressRange_CS RedfishAddressPool_V1_1_2_IPv4AddressRange_CS;
typedef struct _RedfishAddressPool_V1_1_2_Links_CS RedfishAddressPool_V1_1_2_Links_CS;
typedef struct _RedfishAddressPool_V1_1_2_MaxPrefix_CS RedfishAddressPool_V1_1_2_MaxPrefix_CS;
typedef struct _RedfishAddressPool_V1_1_2_MultiplePaths_CS RedfishAddressPool_V1_1_2_MultiplePaths_CS;
typedef struct _RedfishAddressPool_V1_1_2_OemActions_CS RedfishAddressPool_V1_1_2_OemActions_CS;
typedef struct _RedfishAddressPool_V1_1_2_RouteDistinguisherRange_CS RedfishAddressPool_V1_1_2_RouteDistinguisherRange_CS;
typedef struct _RedfishAddressPool_V1_1_2_RouteTargetRange_CS RedfishAddressPool_V1_1_2_RouteTargetRange_CS;
typedef struct _RedfishAddressPool_V1_1_2_VLANIdentifierAddressRange_CS RedfishAddressPool_V1_1_2_VLANIdentifierAddressRange_CS;
...
//
typedef struct _RedfishAddressPool_V1_1_2_ASNumberRange_CS {
    RedfishCS_int64    *Lower;    // Lower Autonomous System (AS)
                                 // number.
    RedfishCS_int64    *Upper;    // Upper Autonomous System (AS)
                                 // number.
} RedfishAddressPool_V1_1_2_ASNumberRange_CS;

//
// The available actions for this resource.
//
typedef struct _RedfishAddressPool_V1_1_2_Actions_CS {
    RedfishAddressPool_V1_1_2_OemActions_CS    *Oem;    // The available OEM-specific
                                                       // actions for this resource.
} RedfishAddressPool_V1_1_2_Actions_CS;

//
// Bidirectional Forwarding Detection (BFD) related properties for an Ethernet
// fabric.
//
typedef struct _RedfishAddressPool_V1_1_2_BFDSingleHopOnly_CS {
...
} RedfishAddressPool_V1_1_2_BFDSingleHopOnly_CS;

//
// BGP Ethernet Virtual Private Network (BGP EVPN) related properties for an
// Ethernet fabric.
//
typedef struct _RedfishAddressPool_V1_1_2_BGPEvpn_CS {
    ...
    RedfishCS_char                                             *AnycastGatewayMACAddress;           // The anycast gateway MAC
                                                                                                    // address.
    RedfishAddressPool_V1_1_2_ESINumberRange_CS                *ESINumberRange;                     // The Ethernet Segment
                                                                                                    // Identifier (ESI) number range
                                                                                                    // for the fabric.
    RedfishAddressPool_V1_1_2_EVINumberRange_CS                *EVINumberRange;                     // The Ethernet Virtual Private
    ...
    RedfishAddressPool_V1_1_2_RouteDistinguisherRange_CS       *RouteDistinguisherRange;            // The Route Distinguisher (RD)
                                                                                                    // number range for the fabric.
    RedfishAddressPool_V1_1_2_RouteTargetRange_CS              *RouteTargetRange;                   // The Route Target (RT) number
    ...
    RedfishCS_bool                                             *UnknownUnicastSuppressionEnabled;    // Suppression of unknown unicast
                                                                                                    // packets.
    RedfishAddressPool_V1_1_2_VLANIdentifierAddressRange_CS    *VLANIdentifierAddressRange;         // Virtual LAN (VLAN) tag related
                                                                                                    // address range applicable to
                                                                                                    // this Ethernet fabric or for
                                                                                                    // end host subnets.
} RedfishAddressPool_V1_1_2_BGPEvpn_CS;

//
// Border Gateway Protocol (BGP) neighbor related properties.
//
typedef struct _RedfishAddressPool_V1_1_2_BGPNeighbor_CS {
    ...
    RedfishCS_bool                            *LogStateChangesEnabled;                // Border Gateway Protocol (BGP)
                                                                                      ...
                                                                                      // status.
    RedfishAddressPool_V1_1_2_MaxPrefix_CS    *MaxPrefix;                             // Border Gateway Protocol (BGP)
...
} RedfishAddressPool_V1_1_2_BGPNeighbor_CS;

//
// Border Gateway Protocol (BGP) route properties.
//
typedef struct _RedfishAddressPool_V1_1_2_BGPRoute_CS {
...
} RedfishAddressPool_V1_1_2_BGPRoute_CS;

//
// Common BGP properties.
//
typedef struct _RedfishAddressPool_V1_1_2_CommonBGPProperties_CS {
    RedfishAddressPool_V1_1_2_ASNumberRange_CS      *ASNumberRange;          // Autonomous System (AS) number
                                                                             // range.
    RedfishAddressPool_V1_1_2_BGPNeighbor_CS        *BGPNeighbor;            // Border Gateway Protocol (BGP)
                                                                             // neighbor related properties.
    RedfishAddressPool_V1_1_2_BGPRoute_CS           *BGPRoute;               // Border Gateway Protocol (BGP)
                                                                             // route related properties.
    RedfishAddressPool_V1_1_2_GracefulRestart_CS    *GracefulRestart;        // Graceful restart related
                                                                             // properties.
    RedfishAddressPool_V1_1_2_MultiplePaths_CS      *MultiplePaths;          // Multiple path related
                                                                             // properties.
    RedfishCS_bool                                  *SendCommunityEnabled;    // This property shall indicate
                                                                             // whether community attributes
                                                                             // are sent.
} RedfishAddressPool_V1_1_2_CommonBGPProperties_CS;

//
// DHCP related properties for an Ethernet fabric.
//
typedef struct _RedfishAddressPool_V1_1_2_DHCP_CS {
...
} RedfishAddressPool_V1_1_2_DHCP_CS;

//
// External BGP (eBGP) related properties for an Ethernet fabric.
//
typedef struct _RedfishAddressPool_V1_1_2_EBGP_CS {
    RedfishAddressPool_V1_1_2_ASNumberRange_CS      *ASNumberRange;             // Autonomous System (AS) number
                                                                                // range.
...
typedef struct _RedfishAddressPool_V1_1_2_EVINumberRange_CS {
    ...
    RedfishCS_int64    *Upper;    // Upper Ethernet Virtual Private
                                 // Network (EVPN) Instance (EVI)
                                 // number.
} RedfishAddressPool_V1_1_2_EVINumberRange_CS;

//
// Ethernet related properties for an address pool.
//
typedef struct _RedfishAddressPool_V1_1_2_Ethernet_CS {
    RedfishAddressPool_V1_1_2_BFDSingleHopOnly_CS       *BFDSingleHopOnly;    // Bidirectional Forwarding
                                                                              // Detection (BFD) related
                                                                              // properties for this Ethernet
                                                                              // fabric.
    RedfishAddressPool_V1_1_2_BGPEvpn_CS                *BGPEvpn;             // BGP Ethernet Virtual Private
                                                                              // Network (EVPN) related
                                                                              // properties for this Ethernet
                                                                              // fabric.
    RedfishAddressPool_V1_1_2_EBGP_CS                   *EBGP;                // External BGP (eBGP) related
                                                                              // properties for this Ethernet
                                                                              // fabric.
    RedfishAddressPool_V1_1_2_IPv4_CS                   *IPv4;                // IPv4 and Virtual LAN (VLAN)
                                                                              // related addressing for this
                                                                              // Ethernet fabric.
    RedfishAddressPool_V1_1_2_EBGP_CS                   *MultiProtocolEBGP;    // Multi Protocol eBGP (MP eBGP)
                                                                              // related properties for this
                                                                              // Ethernet fabric.
    RedfishAddressPool_V1_1_2_CommonBGPProperties_CS    *MultiProtocolIBGP;    // Multi Protocol iBGP (MP iBGP)
                                                                              // related properties for this
                                                                              // Ethernet fabric.
} RedfishAddressPool_V1_1_2_Ethernet_CS;

//
// Gen-Z related properties for an address pool.
//
typedef struct _RedfishAddressPool_V1_1_2_GenZ_CS {
    ...
    RedfishCS_int64    *MinSID;      // The minimum value for the
                                     // Subnet Identifier (SID).
} RedfishAddressPool_V1_1_2_GenZ_CS;

//
// Border Gateway Protocol (BGP) graceful restart properties.
//
typedef struct _RedfishAddressPool_V1_1_2_GracefulRestart_CS {
    ...
    RedfishCS_int64    *TimeSeconds;              // Graceful restart timer in
                                                  // seconds.
} RedfishAddressPool_V1_1_2_GracefulRestart_CS;

//
// IPv4 and Virtual LAN (VLAN) related addressing for an Ethernet fabric.
//
typedef struct _RedfishAddressPool_V1_1_2_IPv4_CS {
    RedfishCS_char                                             *AnycastGatewayIPAddress;         // The anycast gateway IPv4
                                                                                                 // address.
    RedfishCS_char                                             *AnycastGatewayMACAddress;        // The anycast gateway MAC
                                                                                                 // address.
    RedfishAddressPool_V1_1_2_DHCP_CS                          *DHCP;                            // The Dynamic Host Configuration
    ...
    RedfishCS_bool                                             *DistributeIntoUnderlayEnabled;    // Indicates if host subnets
                                                                                                 ...
                                                                                                 // fabric underlay.
    RedfishAddressPool_V1_1_2_IPv4AddressRange_CS              *EBGPAddressRange;                // External BGP (eBGP) related
                                                                                                 // addressing for this Ethernet
                                                                                                 // fabric.
    RedfishAddressPool_V1_1_2_IPv4AddressRange_CS              *FabricLinkAddressRange;          // Link related IPv4 addressing
                                                                                                 // for this Ethernet fabric
                                                                                                 // typically applied to
                                                                                                 // connections between spine and
                                                                                                 // leaf Ethernet switches.
    RedfishCS_char                                             *GatewayIPAddress;                // The gateway IPv4 address.
    RedfishAddressPool_V1_1_2_IPv4AddressRange_CS              *HostAddressRange;                // IPv4 related host subnet
                                                                                                 // addressing for physical device
                                                                                                 // endpoints that connect to this
                                                                                                 // Ethernet fabric.
    RedfishAddressPool_V1_1_2_IPv4AddressRange_CS              *IBGPAddressRange;                // Internal BGP (iBGP) related
                                                                                                 // addressing for this Ethernet
                                                                                                 // fabric.
    RedfishAddressPool_V1_1_2_IPv4AddressRange_CS              *LoopbackAddressRange;            // Loopback related IPv4
                                                                                                 // addressing for this Ethernet
                                                                                                 // fabric.
    RedfishAddressPool_V1_1_2_IPv4AddressRange_CS              *ManagementAddressRange;          // Management related addressing
                                                                                                 // for this Ethernet fabric.
    ...
    RedfishAddressPool_V1_1_2_VLANIdentifierAddressRange_CS    *VLANIdentifierAddressRange;      // Virtual LAN (VLAN) tag related
                                                                                                 ...
                                                                                                 // networks.
} RedfishAddressPool_V1_1_2_IPv4_CS;

//
// IPv4 related address range for an Ethernet fabric.
//
typedef struct _RedfishAddressPool_V1_1_2_IPv4AddressRange_CS {
    RedfishCS_char    *Lower;    // Lower IPv4 network address.
    RedfishCS_char    *Upper;    // Upper IPv4 network address.
} RedfishAddressPool_V1_1_2_IPv4AddressRange_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishAddressPool_V1_1_2_Links_CS {
...
} RedfishAddressPool_V1_1_2_Links_CS;

//
// Border Gateway Protocol (BGP) max prefix properties.
//
typedef struct _RedfishAddressPool_V1_1_2_MaxPrefix_CS {
...
} RedfishAddressPool_V1_1_2_MaxPrefix_CS;

//
// Border Gateway Protocol (BGP) multiple path properties.
//
typedef struct _RedfishAddressPool_V1_1_2_MultiplePaths_CS {
...
} RedfishAddressPool_V1_1_2_MultiplePaths_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishAddressPool_V1_1_2_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishAddressPool_V1_1_2_OemActions_CS;

//
// The Route Distinguisher (RD) number range for an Ethernet fabric.
//
typedef struct _RedfishAddressPool_V1_1_2_RouteDistinguisherRange_CS {
    RedfishCS_int64    *Lower;    // Lower Route Distinguisher (RD)
                                 // number.
    RedfishCS_int64    *Upper;    // Upper Route Distinguisher (RD)
                                 // number.
} RedfishAddressPool_V1_1_2_RouteDistinguisherRange_CS;

//
// The Route Target (RT) number range for the fabric.
//
typedef struct _RedfishAddressPool_V1_1_2_RouteTargetRange_CS {
    RedfishCS_int64    *Lower;    // Lower Route Target (RT)
                                 // number.
    RedfishCS_int64    *Upper;    // Upper Route Target (RT)
                                 // number.
} RedfishAddressPool_V1_1_2_RouteTargetRange_CS;

//
// VLAN tag related addressing for an Ethernet fabric or for end host networks.
//
typedef struct _RedfishAddressPool_V1_1_2_VLANIdentifierAddressRange_CS {
    RedfishCS_int64    *Lower;    // Virtual LAN (VLAN) tag lower
                                 // value.
    RedfishCS_int64    *Upper;    // Virtual LAN (VLAN) tag upper
                                 // value.
} RedfishAddressPool_V1_1_2_VLANIdentifierAddressRange_CS;
...
//
typedef struct _RedfishAddressPool_V1_1_2_AddressPool_CS {
    RedfishCS_Header                         Header;
    RedfishCS_char                           *odata_context;
    RedfishCS_char                           *odata_etag;  
    RedfishCS_char                           *odata_id;    
    RedfishCS_char                           *odata_type;  
    RedfishAddressPool_V1_1_2_Actions_CS     *Actions;         // The available actions for this
                                                               // resource.
    RedfishCS_char                           *Description; 
    RedfishAddressPool_V1_1_2_Ethernet_CS    *Ethernet;        // The Ethernet related
                                                               // properties for this address
                                                               // pool.
    RedfishAddressPool_V1_1_2_GenZ_CS        *GenZ;            // The Gen-Z related properties
                                                               // for this address pool.
    RedfishCS_char                           *Id;          
    RedfishAddressPool_V1_1_2_Links_CS       *Links;           // The links to other resources
...
} RedfishAddressPool_V1_1_2_AddressPool_CS;
...
RedfishCS_status
Json_AddressPool_V1_1_2_To_CS (char *JsonRawText, RedfishAddressPool_V1_1_2_AddressPool_CS **ReturnedCS);

RedfishCS_status
CS_To_AddressPool_V1_1_2_JSON (RedfishAddressPool_V1_1_2_AddressPool_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAddressPool_V1_1_2_CS (RedfishAddressPool_V1_1_2_AddressPool_CS *CSPtr);

RedfishCS_status
DestroyAddressPool_V1_1_2_Json (RedfishCS_char *JsonText);
