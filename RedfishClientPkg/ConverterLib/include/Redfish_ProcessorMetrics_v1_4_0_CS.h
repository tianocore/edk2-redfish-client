...
#ifndef RedfishProcessormetrics_V1_4_0_CSTRUCT_H_
#define RedfishProcessormetrics_V1_4_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishProcessorMetrics_V1_4_0_CStateResidency_Array_CS RedfishProcessorMetrics_V1_4_0_CStateResidency_Array_CS;
typedef struct _RedfishProcessorMetrics_V1_4_0_CacheMetrics_Array_CS RedfishProcessorMetrics_V1_4_0_CacheMetrics_Array_CS;
typedef struct _RedfishProcessorMetrics_V1_4_0_CoreMetrics_Array_CS RedfishProcessorMetrics_V1_4_0_CoreMetrics_Array_CS;
typedef struct _RedfishProcessorMetrics_V1_4_0_Actions_CS RedfishProcessorMetrics_V1_4_0_Actions_CS;
typedef struct _RedfishProcessorMetrics_V1_4_0_CStateResidency_CS RedfishProcessorMetrics_V1_4_0_CStateResidency_CS;
typedef struct _RedfishProcessorMetrics_V1_4_0_CacheMetrics_CS RedfishProcessorMetrics_V1_4_0_CacheMetrics_CS;
typedef struct _RedfishProcessorMetrics_V1_4_0_CacheMetricsTotal_CS RedfishProcessorMetrics_V1_4_0_CacheMetricsTotal_CS;
typedef struct _RedfishProcessorMetrics_V1_4_0_ClearCurrentPeriod_CS RedfishProcessorMetrics_V1_4_0_ClearCurrentPeriod_CS;
typedef struct _RedfishProcessorMetrics_V1_4_0_CoreMetrics_CS RedfishProcessorMetrics_V1_4_0_CoreMetrics_CS;
typedef struct _RedfishProcessorMetrics_V1_4_0_CurrentPeriod_CS RedfishProcessorMetrics_V1_4_0_CurrentPeriod_CS;
typedef struct _RedfishProcessorMetrics_V1_4_0_LifeTime_CS RedfishProcessorMetrics_V1_4_0_LifeTime_CS;
typedef struct _RedfishProcessorMetrics_V1_4_0_OemActions_CS RedfishProcessorMetrics_V1_4_0_OemActions_CS;
typedef struct _RedfishProcessorMetrics_V1_4_0_ProcessorMetrics_CS RedfishProcessorMetrics_V1_4_0_ProcessorMetrics_CS;
...
typedef struct _RedfishProcessorMetrics_V1_4_0_Actions_CS {
    ...
    RedfishProcessorMetrics_V1_4_0_OemActions_CS            *Oem;                                   // The available OEM-specific
...
typedef struct _RedfishProcessorMetrics_V1_4_0_CacheMetricsTotal_CS {
    RedfishProcessorMetrics_V1_4_0_CurrentPeriod_CS    *CurrentPeriod;    // The cache metrics since the
                                                                         // last reset for this processor.
    RedfishProcessorMetrics_V1_4_0_LifeTime_CS         *LifeTime;        // The cache metrics for the
...
typedef struct _RedfishProcessorMetrics_V1_4_0_CoreMetrics_CS {
    RedfishProcessorMetrics_V1_4_0_CStateResidency_Array_CS    *CStateResidency;        // The C-state residency of this
                                                                                        // core in the processor.
    RedfishProcessorMetrics_V1_4_0_CacheMetrics_Array_CS       *CoreCache;              // The cache metrics of this core
                                                                                        // in the processor.
...
typedef struct _RedfishProcessorMetrics_V1_4_0_ProcessorMetrics_CS {
    ...
    RedfishProcessorMetrics_V1_4_0_Actions_CS               *Actions;                      // The available actions for this
                                                                                           // resource.
    ...
    RedfishProcessorMetrics_V1_4_0_CacheMetrics_Array_CS    *Cache;                        // The processor cache metrics.
    RedfishProcessorMetrics_V1_4_0_CacheMetricsTotal_CS     *CacheMetricsTotal;            // The total cache metrics for
                                                                                           // this processor.
    RedfishCS_int64                                         *ConsumedPowerWatt;            // The power, in watts, that the
                                                                                           // processor has consumed.
    RedfishProcessorMetrics_V1_4_0_CoreMetrics_Array_CS     *CoreMetrics;                  // The processor core metrics.
...
typedef struct _RedfishProcessorMetrics_V1_4_0_CStateResidency_Array_CS  {
    RedfishProcessorMetrics_V1_4_0_CStateResidency_Array_CS    *Next;
    RedfishProcessorMetrics_V1_4_0_CStateResidency_CS    *ArrayValue;
} RedfishProcessorMetrics_V1_4_0_CStateResidency_Array_CS;

typedef struct _RedfishProcessorMetrics_V1_4_0_CacheMetrics_Array_CS  {
    RedfishProcessorMetrics_V1_4_0_CacheMetrics_Array_CS    *Next;
    RedfishProcessorMetrics_V1_4_0_CacheMetrics_CS    *ArrayValue;
} RedfishProcessorMetrics_V1_4_0_CacheMetrics_Array_CS;

typedef struct _RedfishProcessorMetrics_V1_4_0_CoreMetrics_Array_CS  {
    RedfishProcessorMetrics_V1_4_0_CoreMetrics_Array_CS    *Next;
    RedfishProcessorMetrics_V1_4_0_CoreMetrics_CS    *ArrayValue;
} RedfishProcessorMetrics_V1_4_0_CoreMetrics_Array_CS;

RedfishCS_status
Json_ProcessorMetrics_V1_4_0_To_CS (char *JsonRawText, RedfishProcessorMetrics_V1_4_0_ProcessorMetrics_CS **ReturnedCS);

RedfishCS_status
CS_To_ProcessorMetrics_V1_4_0_JSON (RedfishProcessorMetrics_V1_4_0_ProcessorMetrics_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyProcessorMetrics_V1_4_0_CS (RedfishProcessorMetrics_V1_4_0_ProcessorMetrics_CS *CSPtr);

RedfishCS_status
DestroyProcessorMetrics_V1_4_0_Json (RedfishCS_char *JsonText);
