...
#ifndef RedfishManageraccount_V1_5_5_CSTRUCT_H_
#define RedfishManageraccount_V1_5_5_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishManagerAccount_V1_5_5_Actions_CS RedfishManagerAccount_V1_5_5_Actions_CS;
typedef struct _RedfishManagerAccount_V1_5_5_Links_CS RedfishManagerAccount_V1_5_5_Links_CS;
typedef struct _RedfishManagerAccount_V1_5_5_ManagerAccount_CS RedfishManagerAccount_V1_5_5_ManagerAccount_CS;
typedef struct _RedfishManagerAccount_V1_5_5_OemActions_CS RedfishManagerAccount_V1_5_5_OemActions_CS;
typedef struct _RedfishManagerAccount_V1_5_5_SNMPUserInfo_CS RedfishManagerAccount_V1_5_5_SNMPUserInfo_CS;
...
//
typedef struct _RedfishManagerAccount_V1_5_5_Actions_CS {
    RedfishManagerAccount_V1_5_5_OemActions_CS    *Oem;    // The available OEM-specific
                                                          // actions for this resource.
} RedfishManagerAccount_V1_5_5_Actions_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishManagerAccount_V1_5_5_Links_CS {
    RedfishResource_Oem_CS    *Oem;    // The OEM extension property.
    RedfishCS_Link            Role;    // The link to the Redfish role
                                      // that defines the privileges
                                      // for this account.
} RedfishManagerAccount_V1_5_5_Links_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishManagerAccount_V1_5_5_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishManagerAccount_V1_5_5_OemActions_CS;

//
// The SNMP settings for an account.
//
typedef struct _RedfishManagerAccount_V1_5_5_SNMPUserInfo_CS {
    ...
    RedfishCS_char    *EncryptionProtocol;       // The encryption protocol for
                                                 // SNMPv3.
} RedfishManagerAccount_V1_5_5_SNMPUserInfo_CS;
...
//
typedef struct _RedfishManagerAccount_V1_5_5_ManagerAccount_CS {
    ...
    RedfishCS_char_Array                            *AccountTypes;             // The list of services in the
                                                                               ...
                                                                               // allowed to access.
    RedfishManagerAccount_V1_5_5_Actions_CS         *Actions;                  // The available actions for this
                                                                               // resource.
    ...
    RedfishCS_bool                                  *Enabled;                  // An indication of whether an
                                                                               ...
                                                                               // log in.
    RedfishCS_char                                  *Id;                   
    RedfishManagerAccount_V1_5_5_Links_CS           *Links;                    // The links to other resources
    ...
    RedfishManagerAccount_V1_5_5_SNMPUserInfo_CS    *SNMP;                     // The SNMP settings for this
                                                                               // account.
    RedfishCS_char                                  *UserName;                 // The user name for the account.
} RedfishManagerAccount_V1_5_5_ManagerAccount_CS;

RedfishCS_status
Json_ManagerAccount_V1_5_5_To_CS (char *JsonRawText, RedfishManagerAccount_V1_5_5_ManagerAccount_CS **ReturnedCS);

RedfishCS_status
CS_To_ManagerAccount_V1_5_5_JSON (RedfishManagerAccount_V1_5_5_ManagerAccount_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyManagerAccount_V1_5_5_CS (RedfishManagerAccount_V1_5_5_ManagerAccount_CS *CSPtr);

RedfishCS_status
DestroyManagerAccount_V1_5_5_Json (RedfishCS_char *JsonText);
