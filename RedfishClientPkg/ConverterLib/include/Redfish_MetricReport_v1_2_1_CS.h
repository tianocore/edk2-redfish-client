...
#ifndef RedfishMetricreport_V1_2_1_CSTRUCT_H_
#define RedfishMetricreport_V1_2_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMetricReport_V1_2_1_MetricValue_Array_CS RedfishMetricReport_V1_2_1_MetricValue_Array_CS;
typedef struct _RedfishMetricReport_V1_2_1_Actions_CS RedfishMetricReport_V1_2_1_Actions_CS;
typedef struct _RedfishMetricReport_V1_2_1_MetricReport_CS RedfishMetricReport_V1_2_1_MetricReport_CS;
typedef struct _RedfishMetricReport_V1_2_1_MetricValue_CS RedfishMetricReport_V1_2_1_MetricValue_CS;
typedef struct _RedfishMetricReport_V1_2_1_OemActions_CS RedfishMetricReport_V1_2_1_OemActions_CS;
...
typedef struct _RedfishMetricReport_V1_2_1_Actions_CS {
    RedfishMetricReport_V1_2_1_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishMetricReport_V1_2_1_MetricReport_CS {
    ...
    RedfishMetricReport_V1_2_1_Actions_CS              *Actions;                 // The available actions for this
                                                                                 // Resource.
    RedfishCS_char                                     *Description;         
    RedfishCS_char                                     *Id;                  
    RedfishCS_Link                                     MetricReportDefinition;    // The definitions in the metric
                                                                                 // report.
    RedfishMetricReport_V1_2_1_MetricValue_Array_CS    *MetricValues;            // An array of metric values for
...
typedef struct _RedfishMetricReport_V1_2_1_MetricValue_Array_CS  {
    RedfishMetricReport_V1_2_1_MetricValue_Array_CS    *Next;
    RedfishMetricReport_V1_2_1_MetricValue_CS    *ArrayValue;
} RedfishMetricReport_V1_2_1_MetricValue_Array_CS;

RedfishCS_status
Json_MetricReport_V1_2_1_To_CS (char *JsonRawText, RedfishMetricReport_V1_2_1_MetricReport_CS **ReturnedCS);

RedfishCS_status
CS_To_MetricReport_V1_2_1_JSON (RedfishMetricReport_V1_2_1_MetricReport_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMetricReport_V1_2_1_CS (RedfishMetricReport_V1_2_1_MetricReport_CS *CSPtr);

RedfishCS_status
DestroyMetricReport_V1_2_1_Json (RedfishCS_char *JsonText);
