...
#ifndef RedfishMemorymetrics_V1_1_8_CSTRUCT_H_
#define RedfishMemorymetrics_V1_1_8_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMemoryMetrics_V1_1_8_Actions_CS RedfishMemoryMetrics_V1_1_8_Actions_CS;
typedef struct _RedfishMemoryMetrics_V1_1_8_AlarmTrips_CS RedfishMemoryMetrics_V1_1_8_AlarmTrips_CS;
typedef struct _RedfishMemoryMetrics_V1_1_8_ClearCurrentPeriod_CS RedfishMemoryMetrics_V1_1_8_ClearCurrentPeriod_CS;
typedef struct _RedfishMemoryMetrics_V1_1_8_CurrentPeriod_CS RedfishMemoryMetrics_V1_1_8_CurrentPeriod_CS;
typedef struct _RedfishMemoryMetrics_V1_1_8_HealthData_CS RedfishMemoryMetrics_V1_1_8_HealthData_CS;
typedef struct _RedfishMemoryMetrics_V1_1_8_LifeTime_CS RedfishMemoryMetrics_V1_1_8_LifeTime_CS;
typedef struct _RedfishMemoryMetrics_V1_1_8_MemoryMetrics_CS RedfishMemoryMetrics_V1_1_8_MemoryMetrics_CS;
typedef struct _RedfishMemoryMetrics_V1_1_8_OemActions_CS RedfishMemoryMetrics_V1_1_8_OemActions_CS;
...
typedef struct _RedfishMemoryMetrics_V1_1_8_Actions_CS {
    ...
    RedfishMemoryMetrics_V1_1_8_OemActions_CS            *Oem;                                // The available OEM-specific
...
typedef struct _RedfishMemoryMetrics_V1_1_8_HealthData_CS {
    RedfishMemoryMetrics_V1_1_8_AlarmTrips_CS    *AlarmTrips;                      // Alarm trip information about
                                                                                   // the memory.
...
typedef struct _RedfishMemoryMetrics_V1_1_8_MemoryMetrics_CS {
    ...
    RedfishMemoryMetrics_V1_1_8_Actions_CS          *Actions;          // The available actions for this
                                                                       // resource.
    RedfishCS_int64                                 *BlockSizeBytes;    // The block size, in bytes.
    RedfishMemoryMetrics_V1_1_8_CurrentPeriod_CS    *CurrentPeriod;    // The memory metrics since the
                                                                       // last reset or
                                                                       // ClearCurrentPeriod action.
    RedfishCS_char                                  *Description;  
    RedfishMemoryMetrics_V1_1_8_HealthData_CS       *HealthData;       // The health information of the
                                                                       // memory.
    RedfishCS_char                                  *Id;           
    RedfishMemoryMetrics_V1_1_8_LifeTime_CS         *LifeTime;         // The memory metrics for the
...
RedfishCS_status
Json_MemoryMetrics_V1_1_8_To_CS (char *JsonRawText, RedfishMemoryMetrics_V1_1_8_MemoryMetrics_CS **ReturnedCS);

RedfishCS_status
CS_To_MemoryMetrics_V1_1_8_JSON (RedfishMemoryMetrics_V1_1_8_MemoryMetrics_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMemoryMetrics_V1_1_8_CS (RedfishMemoryMetrics_V1_1_8_MemoryMetrics_CS *CSPtr);

RedfishCS_status
DestroyMemoryMetrics_V1_1_8_Json (RedfishCS_char *JsonText);
