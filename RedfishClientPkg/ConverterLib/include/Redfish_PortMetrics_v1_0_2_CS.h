...
#ifndef RedfishPortmetrics_V1_0_2_CSTRUCT_H_
#define RedfishPortmetrics_V1_0_2_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishPortMetrics_V1_0_2_Actions_CS RedfishPortMetrics_V1_0_2_Actions_CS;
typedef struct _RedfishPortMetrics_V1_0_2_GenZ_CS RedfishPortMetrics_V1_0_2_GenZ_CS;
typedef struct _RedfishPortMetrics_V1_0_2_OemActions_CS RedfishPortMetrics_V1_0_2_OemActions_CS;
typedef struct _RedfishPortMetrics_V1_0_2_PortMetrics_CS RedfishPortMetrics_V1_0_2_PortMetrics_CS;
...
typedef struct _RedfishPortMetrics_V1_0_2_Actions_CS {
    RedfishPortMetrics_V1_0_2_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishPortMetrics_V1_0_2_PortMetrics_CS {
    ...
    RedfishPortMetrics_V1_0_2_Actions_CS    *Actions;         // The available actions for this
                                                              // resource.
    RedfishCS_char                          *Description; 
    RedfishPortMetrics_V1_0_2_GenZ_CS       *GenZ;            // The port metrics specific to
                                                              // Gen-Z ports.
    RedfishCS_char                          *Id;          
    RedfishCS_char                          *Name;        
...
RedfishCS_status
Json_PortMetrics_V1_0_2_To_CS (char *JsonRawText, RedfishPortMetrics_V1_0_2_PortMetrics_CS **ReturnedCS);

RedfishCS_status
CS_To_PortMetrics_V1_0_2_JSON (RedfishPortMetrics_V1_0_2_PortMetrics_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPortMetrics_V1_0_2_CS (RedfishPortMetrics_V1_0_2_PortMetrics_CS *CSPtr);

RedfishCS_status
DestroyPortMetrics_V1_0_2_Json (RedfishCS_char *JsonText);
