...
#ifndef RedfishPciefunction_V1_3_0_CSTRUCT_H_
#define RedfishPciefunction_V1_3_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishPCIeFunction_V1_3_0_Actions_CS RedfishPCIeFunction_V1_3_0_Actions_CS;
typedef struct _RedfishPCIeFunction_V1_3_0_Links_CS RedfishPCIeFunction_V1_3_0_Links_CS;
typedef struct _RedfishPCIeFunction_V1_3_0_OemActions_CS RedfishPCIeFunction_V1_3_0_OemActions_CS;
typedef struct _RedfishPCIeFunction_V1_3_0_PCIeFunction_CS RedfishPCIeFunction_V1_3_0_PCIeFunction_CS;
...
//
typedef struct _RedfishPCIeFunction_V1_3_0_Actions_CS {
    RedfishPCIeFunction_V1_3_0_OemActions_CS    *Oem;    // The available OEM-specific
                                                        // actions for this Resource.
} RedfishPCIeFunction_V1_3_0_Actions_CS;

//
// The links to other Resources that are related to this Resource.
//
typedef struct _RedfishPCIeFunction_V1_3_0_Links_CS {
...
} RedfishPCIeFunction_V1_3_0_Links_CS;

//
// The available OEM-specific actions for this Resource.
//
typedef struct _RedfishPCIeFunction_V1_3_0_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishPCIeFunction_V1_3_0_OemActions_CS;
...
//
typedef struct _RedfishPCIeFunction_V1_3_0_PCIeFunction_CS {
    RedfishCS_Header                         Header;
    RedfishCS_char                           *odata_context;   
    RedfishCS_char                           *odata_etag;      
    RedfishCS_char                           *odata_id;        
    RedfishCS_char                           *odata_type;      
    RedfishPCIeFunction_V1_3_0_Actions_CS    *Actions;             // The available actions for this
                                                                   // Resource.
    ...
    RedfishCS_char                           *VendorId;            // The Vendor ID of this PCIe
                                                                   // function.
} RedfishPCIeFunction_V1_3_0_PCIeFunction_CS;
...
RedfishCS_status
Json_PCIeFunction_V1_3_0_To_CS (char *JsonRawText, RedfishPCIeFunction_V1_3_0_PCIeFunction_CS **ReturnedCS);

RedfishCS_status
CS_To_PCIeFunction_V1_3_0_JSON (RedfishPCIeFunction_V1_3_0_PCIeFunction_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPCIeFunction_V1_3_0_CS (RedfishPCIeFunction_V1_3_0_PCIeFunction_CS *CSPtr);
