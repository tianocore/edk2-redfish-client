...
#ifndef RedfishSensor_V1_0_0_CSTRUCT_H_
#define RedfishSensor_V1_0_0_CSTRUCT_H_
...
typedef struct _RedfishSensor_V1_0_0_Actions_CS RedfishSensor_V1_0_0_Actions_CS;
typedef struct _RedfishSensor_V1_0_0_OemActions_CS RedfishSensor_V1_0_0_OemActions_CS;
typedef struct _RedfishSensor_V1_0_0_ResetStatistics_CS RedfishSensor_V1_0_0_ResetStatistics_CS;
typedef struct _RedfishSensor_V1_0_0_Sensor_CS RedfishSensor_V1_0_0_Sensor_CS;
typedef struct _RedfishSensor_V1_0_0_SensorExcerpt_CS RedfishSensor_V1_0_0_SensorExcerpt_CS;
typedef struct _RedfishSensor_V1_0_0_SensorPowerExcerpt_CS RedfishSensor_V1_0_0_SensorPowerExcerpt_CS;
typedef struct _RedfishSensor_V1_0_0_Threshold_CS RedfishSensor_V1_0_0_Threshold_CS;
typedef struct _RedfishSensor_V1_0_0_Thresholds_CS RedfishSensor_V1_0_0_Thresholds_CS;
...
typedef struct _RedfishSensor_V1_0_0_Actions_CS {
    ...
    RedfishSensor_V1_0_0_OemActions_CS         *Oem;                      // This property contains the
...
typedef struct _RedfishSensor_V1_0_0_Thresholds_CS {
    RedfishSensor_V1_0_0_Threshold_CS    *LowerCaution;    // Below normal range.
    RedfishSensor_V1_0_0_Threshold_CS    *LowerCritical;    // Below normal range but not yet
                                                           // fatal.
    RedfishSensor_V1_0_0_Threshold_CS    *LowerFatal;      // Below normal range and fatal.
    RedfishSensor_V1_0_0_Threshold_CS    *UpperCaution;    // Above normal range.
    RedfishSensor_V1_0_0_Threshold_CS    *UpperCritical;    // Above normal range but not yet
                                                           // fatal.
    RedfishSensor_V1_0_0_Threshold_CS    *UpperFatal;      // Above normal range and fatal.
...
typedef struct _RedfishSensor_V1_0_0_Sensor_CS {
    ...
    RedfishSensor_V1_0_0_Actions_CS       *Actions;                              // The available actions for this
                                                                                 // resource.
    ...
    RedfishResource_Status_CS             *Status;                               // This property describes the
                                                                                 // status and health of the
                                                                                 // resource and its children.
    RedfishSensor_V1_0_0_Thresholds_CS    *Thresholds;                           // The set of thresholds defined
                                                                                 // for this sensor.
...
RedfishCS_status
Json_Sensor_V1_0_0_To_CS (char *JsonRawText, RedfishSensor_V1_0_0_Sensor_CS **ReturnedCS);

RedfishCS_status
CS_To_Sensor_V1_0_0_JSON (RedfishSensor_V1_0_0_Sensor_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroySensor_V1_0_0_CS (RedfishSensor_V1_0_0_Sensor_CS *CSPtr);

RedfishCS_status
DestroySensor_V1_0_0_Json (RedfishCS_char *JsonText);
