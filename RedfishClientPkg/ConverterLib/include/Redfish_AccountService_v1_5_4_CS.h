...
#ifndef RedfishAccountservice_V1_5_4_CSTRUCT_H_
#define RedfishAccountservice_V1_5_4_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishAccountService_V1_5_4_RoleMapping_Array_CS RedfishAccountService_V1_5_4_RoleMapping_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishAccountService_V1_5_4_AccountService_CS RedfishAccountService_V1_5_4_AccountService_CS;
typedef struct _RedfishAccountService_V1_5_4_Actions_CS RedfishAccountService_V1_5_4_Actions_CS;
typedef struct _RedfishAccountService_V1_5_4_Authentication_CS RedfishAccountService_V1_5_4_Authentication_CS;
typedef struct _RedfishAccountService_V1_5_4_ExternalAccountProvider_CS RedfishAccountService_V1_5_4_ExternalAccountProvider_CS;
typedef struct _RedfishAccountService_V1_5_4_LDAPSearchSettings_CS RedfishAccountService_V1_5_4_LDAPSearchSettings_CS;
typedef struct _RedfishAccountService_V1_5_4_LDAPService_CS RedfishAccountService_V1_5_4_LDAPService_CS;
typedef struct _RedfishAccountService_V1_5_4_OemActions_CS RedfishAccountService_V1_5_4_OemActions_CS;
typedef struct _RedfishAccountService_V1_5_4_RoleMapping_CS RedfishAccountService_V1_5_4_RoleMapping_CS;
...
//
typedef struct _RedfishAccountService_V1_5_4_Actions_CS {
    RedfishAccountService_V1_5_4_OemActions_CS    *Oem;    // The available OEM-specific
                                                          // actions for this resource.
} RedfishAccountService_V1_5_4_Actions_CS;

//
// The information required to authenticate to the external service.
//
typedef struct _RedfishAccountService_V1_5_4_Authentication_CS {
...
} RedfishAccountService_V1_5_4_Authentication_CS;

//
// The external account provider services that can provide accounts for this
// manager to use for authentication.
//
typedef struct _RedfishAccountService_V1_5_4_ExternalAccountProvider_CS {
    RedfishCS_char                                       *AccountProviderType;    // The type of external account
                                                                                 // provider to which this service
                                                                                 // connects.
    RedfishAccountService_V1_5_4_Authentication_CS       *Authentication;        // The authentication information
    ...
    RedfishAccountService_V1_5_4_LDAPService_CS          *LDAPService;           // The additional mapping
                                                                                 // information needed to parse a
                                                                                 // generic LDAP service.
    RedfishAccountService_V1_5_4_RoleMapping_Array_CS    *RemoteRoleMapping;     // The mapping rules to convert
    ...
    RedfishCS_bool                                       *ServiceEnabled;        // An indication of whether this
                                                                                 // service is enabled.
} RedfishAccountService_V1_5_4_ExternalAccountProvider_CS;
...
typedef struct _RedfishAccountService_V1_5_4_LDAPService_CS {
    RedfishResource_Oem_CS                                *Oem;              // The OEM extension property.
    RedfishAccountService_V1_5_4_LDAPSearchSettings_CS    *SearchSettings;    // The required settings to
...
typedef struct _RedfishAccountService_V1_5_4_AccountService_CS {
    ...
    RedfishCS_Link                                             Accounts;                             // The collection of manager
                                                                                                     // accounts.
    RedfishAccountService_V1_5_4_Actions_CS                    *Actions;                             // The available actions for this
                                                                                                     // resource.
    RedfishAccountService_V1_5_4_ExternalAccountProvider_CS    *ActiveDirectory;                     // The first Active Directory
    ...
    RedfishCS_char                                             *Id;                              
    RedfishAccountService_V1_5_4_ExternalAccountProvider_CS    *LDAP;                                // The first LDAP external
...
typedef struct _RedfishAccountService_V1_5_4_RoleMapping_Array_CS  {
    RedfishAccountService_V1_5_4_RoleMapping_Array_CS    *Next;
...
RedfishCS_status
Json_AccountService_V1_5_4_To_CS (char *JsonRawText, RedfishAccountService_V1_5_4_AccountService_CS **ReturnedCS);

RedfishCS_status
CS_To_AccountService_V1_5_4_JSON (RedfishAccountService_V1_5_4_AccountService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAccountService_V1_5_4_CS (RedfishAccountService_V1_5_4_AccountService_CS *CSPtr);

RedfishCS_status
DestroyAccountService_V1_5_4_Json (RedfishCS_char *JsonText);
