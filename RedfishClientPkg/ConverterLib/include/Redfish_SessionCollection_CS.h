...
#ifndef RedfishSessioncollection_Noversioned_CSTRUCT_H_
#define RedfishSessioncollection_Noversioned_CSTRUCT_H_
...
//
// The SessionCollection schema describes a collection of session instances.
//
