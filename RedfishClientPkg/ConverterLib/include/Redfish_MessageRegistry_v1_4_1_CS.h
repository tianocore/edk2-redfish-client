...
#ifndef RedfishMessageregistry_V1_4_1_CSTRUCT_H_
#define RedfishMessageregistry_V1_4_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMessageRegistry_V1_4_1_Actions_CS RedfishMessageRegistry_V1_4_1_Actions_CS;
typedef struct _RedfishMessageRegistry_V1_4_1_ClearingLogic_CS RedfishMessageRegistry_V1_4_1_ClearingLogic_CS;
typedef struct _RedfishMessageRegistry_V1_4_1_Message_CS RedfishMessageRegistry_V1_4_1_Message_CS;
typedef struct _RedfishMessageRegistry_V1_4_1_MessageProperty_CS RedfishMessageRegistry_V1_4_1_MessageProperty_CS;
typedef struct _RedfishMessageRegistry_V1_4_1_MessageRegistry_CS RedfishMessageRegistry_V1_4_1_MessageRegistry_CS;
typedef struct _RedfishMessageRegistry_V1_4_1_OemActions_CS RedfishMessageRegistry_V1_4_1_OemActions_CS;
...
typedef struct _RedfishMessageRegistry_V1_4_1_Actions_CS {
    RedfishMessageRegistry_V1_4_1_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishMessageRegistry_V1_4_1_Message_CS {
    ...
    RedfishCS_char_Array                              *ArgLongDescriptions;    // The MessageArg normative
                                                                              ...
                                                                              // for this message.
    RedfishMessageRegistry_V1_4_1_ClearingLogic_CS    *ClearingLogic;         // The clearing logic associated
...
typedef struct _RedfishMessageRegistry_V1_4_1_MessageRegistry_CS {
    ...
    RedfishMessageRegistry_V1_4_1_Actions_CS            *Actions;           // The available actions for this
                                                                            // resource.
    ...
    RedfishCS_char                                      *Language;          // The RFC5646-conformant
                                                                            ...
                                                                            // registry.
    RedfishMessageRegistry_V1_4_1_MessageProperty_CS    *Messages;          // The message keys contained in
...
RedfishCS_status
Json_MessageRegistry_V1_4_1_To_CS (char *JsonRawText, RedfishMessageRegistry_V1_4_1_MessageRegistry_CS **ReturnedCS);

RedfishCS_status
CS_To_MessageRegistry_V1_4_1_JSON (RedfishMessageRegistry_V1_4_1_MessageRegistry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMessageRegistry_V1_4_1_CS (RedfishMessageRegistry_V1_4_1_MessageRegistry_CS *CSPtr);

RedfishCS_status
DestroyMessageRegistry_V1_4_1_Json (RedfishCS_char *JsonText);
