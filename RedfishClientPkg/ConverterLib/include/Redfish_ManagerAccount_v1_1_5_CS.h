...
#ifndef RedfishManageraccount_V1_1_5_CSTRUCT_H_
#define RedfishManageraccount_V1_1_5_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishManagerAccount_V1_1_5_Actions_CS RedfishManagerAccount_V1_1_5_Actions_CS;
typedef struct _RedfishManagerAccount_V1_1_5_Links_CS RedfishManagerAccount_V1_1_5_Links_CS;
typedef struct _RedfishManagerAccount_V1_1_5_ManagerAccount_CS RedfishManagerAccount_V1_1_5_ManagerAccount_CS;
typedef struct _RedfishManagerAccount_V1_1_5_OemActions_CS RedfishManagerAccount_V1_1_5_OemActions_CS;
...
typedef struct _RedfishManagerAccount_V1_1_5_Actions_CS {
    RedfishManagerAccount_V1_1_5_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishManagerAccount_V1_1_5_ManagerAccount_CS {
    ...
    RedfishManagerAccount_V1_1_5_Actions_CS    *Actions;         // The available actions for this
                                                                 // Resource.
    ...
    RedfishCS_char                             *Id;          
    RedfishManagerAccount_V1_1_5_Links_CS      *Links;           // The links to other Resources
...
RedfishCS_status
Json_ManagerAccount_V1_1_5_To_CS (char *JsonRawText, RedfishManagerAccount_V1_1_5_ManagerAccount_CS **ReturnedCS);

RedfishCS_status
CS_To_ManagerAccount_V1_1_5_JSON (RedfishManagerAccount_V1_1_5_ManagerAccount_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyManagerAccount_V1_1_5_CS (RedfishManagerAccount_V1_1_5_ManagerAccount_CS *CSPtr);

RedfishCS_status
DestroyManagerAccount_V1_1_5_Json (RedfishCS_char *JsonText);
