...
#ifndef RedfishJob_V1_0_4_CSTRUCT_H_
#define RedfishJob_V1_0_4_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishJob_V1_0_4_Actions_CS RedfishJob_V1_0_4_Actions_CS;
typedef struct _RedfishJob_V1_0_4_Job_CS RedfishJob_V1_0_4_Job_CS;
typedef struct _RedfishJob_V1_0_4_OemActions_CS RedfishJob_V1_0_4_OemActions_CS;
typedef struct _RedfishJob_V1_0_4_Payload_CS RedfishJob_V1_0_4_Payload_CS;
...
typedef struct _RedfishJob_V1_0_4_Actions_CS {
    RedfishJob_V1_0_4_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishJob_V1_0_4_Job_CS {
    ...
    RedfishJob_V1_0_4_Actions_CS    *Actions;            // The available actions for this
                                                         // resource.
    ...
    RedfishJob_V1_0_4_Payload_CS    *Payload;            // The HTTP and JSON payload
...
RedfishCS_status
Json_Job_V1_0_4_To_CS (char *JsonRawText, RedfishJob_V1_0_4_Job_CS **ReturnedCS);

RedfishCS_status
CS_To_Job_V1_0_4_JSON (RedfishJob_V1_0_4_Job_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyJob_V1_0_4_CS (RedfishJob_V1_0_4_Job_CS *CSPtr);

RedfishCS_status
DestroyJob_V1_0_4_Json (RedfishCS_char *JsonText);
