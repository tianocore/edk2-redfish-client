...
#ifndef RedfishPort_V1_2_0_CSTRUCT_H_
#define RedfishPort_V1_2_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishPort_V1_2_0_Actions_CS RedfishPort_V1_2_0_Actions_CS;
typedef struct _RedfishPort_V1_2_0_GenZ_CS RedfishPort_V1_2_0_GenZ_CS;
typedef struct _RedfishPort_V1_2_0_Links_CS RedfishPort_V1_2_0_Links_CS;
typedef struct _RedfishPort_V1_2_0_OemActions_CS RedfishPort_V1_2_0_OemActions_CS;
typedef struct _RedfishPort_V1_2_0_Port_CS RedfishPort_V1_2_0_Port_CS;
typedef struct _RedfishPort_V1_2_0_Reset_CS RedfishPort_V1_2_0_Reset_CS;
...
//
typedef struct _RedfishPort_V1_2_0_Actions_CS {
    RedfishPort_V1_2_0_Reset_CS         *Port_Reset;
    RedfishPort_V1_2_0_OemActions_CS    *Oem;          // The available OEM-specific
                                                       // actions for this Resource.
} RedfishPort_V1_2_0_Actions_CS;

//
// This type defines Gen-Z specific port properties.
//
typedef struct _RedfishPort_V1_2_0_GenZ_CS {
    ...
    RedfishCS_Link    VCAT;    // the Virtual Channel Action
                              // Table for the port.
} RedfishPort_V1_2_0_GenZ_CS;

//
// The links to other Resources that are related to this Resource.
//
typedef struct _RedfishPort_V1_2_0_Links_CS {
...
} RedfishPort_V1_2_0_Links_CS;

//
// The available OEM-specific actions for this Resource.
//
typedef struct _RedfishPort_V1_2_0_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishPort_V1_2_0_OemActions_CS;

//
// This action resets this port.
//
typedef struct _RedfishPort_V1_2_0_Reset_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishPort_V1_2_0_Reset_CS;
...
// entity.
//
typedef struct _RedfishPort_V1_2_0_Port_CS {
    RedfishCS_Header                 Header;
    RedfishCS_char                   *odata_context;         
    RedfishCS_char                   *odata_etag;            
    RedfishCS_char                   *odata_id;              
    RedfishCS_char                   *odata_type;            
    RedfishPort_V1_2_0_Actions_CS    *Actions;                   // The available actions for this
                                                                 // Resource.
    ...
    RedfishPort_V1_2_0_GenZ_CS       *GenZ;                      // Gen-Z specific properties.
    RedfishCS_char                   *Id;                    
    ...
    RedfishCS_int64                  *LinkTransitionIndicator;    // The number of link state
                                                                 ...
                                                                 // interface.
    RedfishPort_V1_2_0_Links_CS      *Links;                     // The links to other Resources
...
RedfishCS_status
Json_Port_V1_2_0_To_CS (char *JsonRawText, RedfishPort_V1_2_0_Port_CS **ReturnedCS);

RedfishCS_status
CS_To_Port_V1_2_0_JSON (RedfishPort_V1_2_0_Port_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPort_V1_2_0_CS (RedfishPort_V1_2_0_Port_CS *CSPtr);

RedfishCS_status
DestroyPort_V1_2_0_Json (RedfishCS_char *JsonText);
