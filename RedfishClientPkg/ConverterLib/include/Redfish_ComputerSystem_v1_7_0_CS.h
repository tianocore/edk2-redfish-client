...
#ifndef RedfishComputersystem_V1_7_0_CSTRUCT_H_
#define RedfishComputersystem_V1_7_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishComputerSystem_V1_7_0_TrustedModules_Array_CS RedfishComputerSystem_V1_7_0_TrustedModules_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishComputerSystem_V1_7_0_Actions_CS RedfishComputerSystem_V1_7_0_Actions_CS;
typedef struct _RedfishComputerSystem_V1_7_0_AddResourceBlock_CS RedfishComputerSystem_V1_7_0_AddResourceBlock_CS;
typedef struct _RedfishComputerSystem_V1_7_0_Boot_CS RedfishComputerSystem_V1_7_0_Boot_CS;
typedef struct _RedfishComputerSystem_V1_7_0_ComputerSystem_CS RedfishComputerSystem_V1_7_0_ComputerSystem_CS;
typedef struct _RedfishComputerSystem_V1_7_0_HostedServices_CS RedfishComputerSystem_V1_7_0_HostedServices_CS;
typedef struct _RedfishComputerSystem_V1_7_0_Links_CS RedfishComputerSystem_V1_7_0_Links_CS;
typedef struct _RedfishComputerSystem_V1_7_0_MemorySummary_CS RedfishComputerSystem_V1_7_0_MemorySummary_CS;
typedef struct _RedfishComputerSystem_V1_7_0_OemActions_CS RedfishComputerSystem_V1_7_0_OemActions_CS;
typedef struct _RedfishComputerSystem_V1_7_0_ProcessorSummary_CS RedfishComputerSystem_V1_7_0_ProcessorSummary_CS;
typedef struct _RedfishComputerSystem_V1_7_0_RemoveResourceBlock_CS RedfishComputerSystem_V1_7_0_RemoveResourceBlock_CS;
typedef struct _RedfishComputerSystem_V1_7_0_Reset_CS RedfishComputerSystem_V1_7_0_Reset_CS;
typedef struct _RedfishComputerSystem_V1_7_0_SetDefaultBootOrder_CS RedfishComputerSystem_V1_7_0_SetDefaultBootOrder_CS;
typedef struct _RedfishComputerSystem_V1_7_0_TrustedModules_CS RedfishComputerSystem_V1_7_0_TrustedModules_CS;
typedef struct _RedfishComputerSystem_V1_7_0_WatchdogTimer_CS RedfishComputerSystem_V1_7_0_WatchdogTimer_CS;
...
//
typedef struct _RedfishComputerSystem_V1_7_0_Actions_CS {
    RedfishComputerSystem_V1_7_0_AddResourceBlock_CS       *ComputerSystem_AddResourceBlock;  
    RedfishComputerSystem_V1_7_0_RemoveResourceBlock_CS    *ComputerSystem_RemoveResourceBlock;
    RedfishComputerSystem_V1_7_0_Reset_CS                  *ComputerSystem_Reset;             
    RedfishComputerSystem_V1_7_0_SetDefaultBootOrder_CS    *ComputerSystem_SetDefaultBootOrder;
    RedfishComputerSystem_V1_7_0_OemActions_CS             *Oem;                                  // This property contains the
                                                                                                  // available OEM specific actions
                                                                                                  // for this resource.
} RedfishComputerSystem_V1_7_0_Actions_CS;

//
// This action is used to add a Resource Block to a system.
//
typedef struct _RedfishComputerSystem_V1_7_0_AddResourceBlock_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishComputerSystem_V1_7_0_AddResourceBlock_CS;

//
// This object contains the boot information for the current resource.
//
typedef struct _RedfishComputerSystem_V1_7_0_Boot_CS {
    ...
    RedfishCS_char          *BootOrderPropertySelection;     // Choice of which boot order
                                                             // property to use when
                                                             // specifying the boot order.
    ...
    RedfishCS_char          *UefiTargetBootSourceOverride;    // This property is the UEFI
                                                             ...
                                                             // BootSourceOverrideTarget is
                                                             // UefiTarget.
} RedfishComputerSystem_V1_7_0_Boot_CS;

//
// This object describes services that may be running or installed on the system.
//
typedef struct _RedfishComputerSystem_V1_7_0_HostedServices_CS {
    RedfishResource_Oem_CS    *Oem;              // Oem extension object.
    RedfishCS_Link            StorageServices;    // A reference to a collection of
                                                 // storage services supported by
                                                 // this computer system.
} RedfishComputerSystem_V1_7_0_HostedServices_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishComputerSystem_V1_7_0_Links_CS {
...
} RedfishComputerSystem_V1_7_0_Links_CS;

//
// This object describes the memory of the system in general detail.
//
typedef struct _RedfishComputerSystem_V1_7_0_MemorySummary_CS {
    ...
    RedfishCS_int64              *TotalSystemPersistentMemoryGiB;    // The total configured, system-
                                                                    ...
                                                                    // measured in GiB.
} RedfishComputerSystem_V1_7_0_MemorySummary_CS;

//
// The available OEM specific actions for this resource.
//
typedef struct _RedfishComputerSystem_V1_7_0_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishComputerSystem_V1_7_0_OemActions_CS;

//
// This object describes the central processors of the system in general detail.
//
typedef struct _RedfishComputerSystem_V1_7_0_ProcessorSummary_CS {
    ...
    RedfishResource_Status_CS    *Status;                  // This property describes the
                                                           // status and health of the
                                                           // resource and its children.
} RedfishComputerSystem_V1_7_0_ProcessorSummary_CS;

//
// This action is used to remove a Resource Block from a system.
//
typedef struct _RedfishComputerSystem_V1_7_0_RemoveResourceBlock_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishComputerSystem_V1_7_0_RemoveResourceBlock_CS;

//
// This action is used to reset the system.
//
typedef struct _RedfishComputerSystem_V1_7_0_Reset_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishComputerSystem_V1_7_0_Reset_CS;

//
// This action is used to set the Boot Order to the default settings.
//
typedef struct _RedfishComputerSystem_V1_7_0_SetDefaultBootOrder_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishComputerSystem_V1_7_0_SetDefaultBootOrder_CS;

//
// This object describes the inventory of a Trusted Modules installed in the
// system.
//
typedef struct _RedfishComputerSystem_V1_7_0_TrustedModules_CS {
    ...
    RedfishResource_Status_CS    *Status;                   // This property describes the
                                                            // status and health of the
                                                            // resource and its children.
} RedfishComputerSystem_V1_7_0_TrustedModules_CS;

//
// This type describes the Host Watchdog Timer functionality for this system.
//
typedef struct _RedfishComputerSystem_V1_7_0_WatchdogTimer_CS {
...
} RedfishComputerSystem_V1_7_0_WatchdogTimer_CS;
...
// machine.
//
typedef struct _RedfishComputerSystem_V1_7_0_ComputerSystem_CS {
    RedfishCS_Header                                        Header;
    RedfishCS_char                                          *odata_context;          
    RedfishCS_char                                          *odata_etag;             
    RedfishCS_char                                          *odata_id;               
    RedfishCS_char                                          *odata_type;             
    RedfishComputerSystem_V1_7_0_Actions_CS                 *Actions;                    // The available actions for this
                                                                                         // resource.
    ...
    RedfishComputerSystem_V1_7_0_Boot_CS                    *Boot;                       // Information about the boot
    ...
    RedfishCS_char                                          *HostName;                   // The DNS Host Name, without any
                                                                                         // domain information.
    RedfishComputerSystem_V1_7_0_WatchdogTimer_CS           *HostWatchdogTimer;          // This object describes the Host
                                                                                         // Watchdog Timer functionality
                                                                                         // for this system.
    RedfishComputerSystem_V1_7_0_HostedServices_CS          *HostedServices;             // The services that this
    ...
    RedfishCS_char                                          *IndicatorLED;               // The state of the indicator
                                                                                         ...
                                                                                         // system.
    RedfishComputerSystem_V1_7_0_Links_CS                   *Links;                      // Contains references to other
    ...
    RedfishCS_Link                                          MemoryDomains;               // A reference to the collection
                                                                                         ...
                                                                                         // with this system.
    RedfishComputerSystem_V1_7_0_MemorySummary_CS           *MemorySummary;              // This object describes the
    ...
    RedfishCS_char                                          *PowerState;                 // This is the current power
                                                                                         // state of the system.
    RedfishComputerSystem_V1_7_0_ProcessorSummary_CS        *ProcessorSummary;           // This object describes the
    ...
    RedfishComputerSystem_V1_7_0_TrustedModules_Array_CS    *TrustedModules;             // This object describes the
                                                                                         // array of Trusted Modules in
                                                                                         // the system.
    RedfishCS_char                                          *UUID;                       // The universal unique
                                                                                         // identifier (UUID) for this
                                                                                         // system.
} RedfishComputerSystem_V1_7_0_ComputerSystem_CS;
...
typedef struct _RedfishComputerSystem_V1_7_0_TrustedModules_Array_CS  {
    RedfishComputerSystem_V1_7_0_TrustedModules_Array_CS    *Next;
    RedfishComputerSystem_V1_7_0_TrustedModules_CS    *ArrayValue;
} RedfishComputerSystem_V1_7_0_TrustedModules_Array_CS;
...
RedfishCS_status
Json_ComputerSystem_V1_7_0_To_CS (char *JsonRawText, RedfishComputerSystem_V1_7_0_ComputerSystem_CS **ReturnedCS);

RedfishCS_status
CS_To_ComputerSystem_V1_7_0_JSON (RedfishComputerSystem_V1_7_0_ComputerSystem_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyComputerSystem_V1_7_0_CS (RedfishComputerSystem_V1_7_0_ComputerSystem_CS *CSPtr);

RedfishCS_status
DestroyComputerSystem_V1_7_0_Json (RedfishCS_char *JsonText);
