...
#ifndef RedfishDrive_V1_6_3_CSTRUCT_H_
#define RedfishDrive_V1_6_3_CSTRUCT_H_
...
#endif
typedef struct _RedfishDrive_V1_6_3_Operations_Array_CS RedfishDrive_V1_6_3_Operations_Array_CS;
typedef struct _RedfishDrive_V1_6_3_Actions_CS RedfishDrive_V1_6_3_Actions_CS;
typedef struct _RedfishDrive_V1_6_3_Drive_CS RedfishDrive_V1_6_3_Drive_CS;
typedef struct _RedfishDrive_V1_6_3_Links_CS RedfishDrive_V1_6_3_Links_CS;
typedef struct _RedfishDrive_V1_6_3_OemActions_CS RedfishDrive_V1_6_3_OemActions_CS;
typedef struct _RedfishDrive_V1_6_3_Operations_CS RedfishDrive_V1_6_3_Operations_CS;
typedef struct _RedfishDrive_V1_6_3_SecureErase_CS RedfishDrive_V1_6_3_SecureErase_CS;
...
typedef struct _RedfishDrive_V1_6_3_Actions_CS {
    ...
    RedfishDrive_V1_6_3_OemActions_CS     *Oem;                 // The available OEM-specific
...
typedef struct _RedfishDrive_V1_6_3_Drive_CS {
    ...
    RedfishDrive_V1_6_3_Actions_CS             *Actions;                         // The available actions for this
                                                                                 // resource.
    ...
    RedfishCS_char                             *IndicatorLED;                    // The state of the indicator
                                                                                 ...
                                                                                 // drive.
    RedfishDrive_V1_6_3_Links_CS               *Links;                           // The links to other resources
    ...
    RedfishResource_Oem_CS                     *Oem;                             // The OEM extension property.
    RedfishDrive_V1_6_3_Operations_Array_CS    *Operations;                      // The operations currently
...
typedef struct _RedfishDrive_V1_6_3_Operations_Array_CS  {
    RedfishDrive_V1_6_3_Operations_Array_CS    *Next;
    RedfishDrive_V1_6_3_Operations_CS    *ArrayValue;
} RedfishDrive_V1_6_3_Operations_Array_CS;

RedfishCS_status
Json_Drive_V1_6_3_To_CS (char *JsonRawText, RedfishDrive_V1_6_3_Drive_CS **ReturnedCS);

RedfishCS_status
CS_To_Drive_V1_6_3_JSON (RedfishDrive_V1_6_3_Drive_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyDrive_V1_6_3_CS (RedfishDrive_V1_6_3_Drive_CS *CSPtr);

RedfishCS_status
DestroyDrive_V1_6_3_Json (RedfishCS_char *JsonText);
