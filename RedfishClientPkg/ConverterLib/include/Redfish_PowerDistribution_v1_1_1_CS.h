...
#ifndef RedfishPowerdistribution_V1_1_1_CSTRUCT_H_
#define RedfishPowerdistribution_V1_1_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishPowerDistribution_V1_1_1_Actions_CS RedfishPowerDistribution_V1_1_1_Actions_CS;
typedef struct _RedfishPowerDistribution_V1_1_1_Links_CS RedfishPowerDistribution_V1_1_1_Links_CS;
typedef struct _RedfishPowerDistribution_V1_1_1_OemActions_CS RedfishPowerDistribution_V1_1_1_OemActions_CS;
typedef struct _RedfishPowerDistribution_V1_1_1_PowerDistribution_CS RedfishPowerDistribution_V1_1_1_PowerDistribution_CS;
typedef struct _RedfishPowerDistribution_V1_1_1_TransferConfiguration_CS RedfishPowerDistribution_V1_1_1_TransferConfiguration_CS;
typedef struct _RedfishPowerDistribution_V1_1_1_TransferControl_CS RedfishPowerDistribution_V1_1_1_TransferControl_CS;
typedef struct _RedfishPowerDistribution_V1_1_1_TransferCriteria_CS RedfishPowerDistribution_V1_1_1_TransferCriteria_CS;
...
//
typedef struct _RedfishPowerDistribution_V1_1_1_Actions_CS {
    RedfishPowerDistribution_V1_1_1_TransferControl_CS    *PowerDistribution_TransferControl;
    RedfishPowerDistribution_V1_1_1_OemActions_CS         *Oem;                                 // The available OEM-specific
                                                                                                // actions for this resource.
} RedfishPowerDistribution_V1_1_1_Actions_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishPowerDistribution_V1_1_1_Links_CS {
...
} RedfishPowerDistribution_V1_1_1_Links_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishPowerDistribution_V1_1_1_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishPowerDistribution_V1_1_1_OemActions_CS;

//
// The configuration settings for an automatic transfer switch.
//
typedef struct _RedfishPowerDistribution_V1_1_1_TransferConfiguration_CS {
    ...
    RedfishCS_bool     *TransferInhibit;                  // Indicates if any transfer is
                                                          // inhibited.
} RedfishPowerDistribution_V1_1_1_TransferConfiguration_CS;

//
// This action transfers control to the alternative input circuit.
//
typedef struct _RedfishPowerDistribution_V1_1_1_TransferControl_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishPowerDistribution_V1_1_1_TransferControl_CS;

//
// The criteria used to initiate a transfer for an automatic transfer switch.
//
typedef struct _RedfishPowerDistribution_V1_1_1_TransferCriteria_CS {
    ...
    RedfishCS_int64    *UnderVoltageRMSPercentage;    // The negative percentage of
                                                     ...
                                                     // value that satisfies a
                                                     // criterion for transfer.
} RedfishPowerDistribution_V1_1_1_TransferCriteria_CS;
...
//
typedef struct _RedfishPowerDistribution_V1_1_1_PowerDistribution_CS {
    RedfishCS_Header                                            Header;
    RedfishCS_char                                              *odata_context;       
    RedfishCS_char                                              *odata_etag;          
    RedfishCS_char                                              *odata_id;            
    RedfishCS_char                                              *odata_type;          
    RedfishPowerDistribution_V1_1_1_Actions_CS                  *Actions;                 // The available actions for this
                                                                                          // resource.
    ...
    RedfishCS_char                                              *FirmwareVersion;         // The firmware version of this
                                                                                          // equipment.
    RedfishCS_char                                              *Id;                  
    RedfishPowerDistribution_V1_1_1_Links_CS                    *Links;                   // The links to other resources
    ...
    RedfishCS_Link                                              Subfeeds;                 // A link to the subfeed circuits
                                                                                          // for this equipment.
    RedfishPowerDistribution_V1_1_1_TransferConfiguration_CS    *TransferConfiguration;    // The configuration settings for
                                                                                          // an automatic transfer switch.
    RedfishPowerDistribution_V1_1_1_TransferCriteria_CS         *TransferCriteria;        // The criteria used to initiate
    ...
    RedfishCS_char                                              *Version;                 // The hardware version of this
                                                                                          // equipment.
} RedfishPowerDistribution_V1_1_1_PowerDistribution_CS;
...
RedfishCS_status
Json_PowerDistribution_V1_1_1_To_CS (char *JsonRawText, RedfishPowerDistribution_V1_1_1_PowerDistribution_CS **ReturnedCS);

RedfishCS_status
CS_To_PowerDistribution_V1_1_1_JSON (RedfishPowerDistribution_V1_1_1_PowerDistribution_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPowerDistribution_V1_1_1_CS (RedfishPowerDistribution_V1_1_1_PowerDistribution_CS *CSPtr);

RedfishCS_status
DestroyPowerDistribution_V1_1_1_Json (RedfishCS_char *JsonText);
