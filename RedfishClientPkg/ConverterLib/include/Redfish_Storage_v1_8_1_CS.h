...
#ifndef RedfishStorage_V1_8_1_CSTRUCT_H_
#define RedfishStorage_V1_8_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishStorage_V1_8_1_StorageController_Array_CS RedfishStorage_V1_8_1_StorageController_Array_CS;
...
typedef struct _RedfishStorage_V1_8_1_Actions_CS RedfishStorage_V1_8_1_Actions_CS;
typedef struct _RedfishStorage_V1_8_1_CacheSummary_CS RedfishStorage_V1_8_1_CacheSummary_CS;
typedef struct _RedfishStorage_V1_8_1_Links_CS RedfishStorage_V1_8_1_Links_CS;
typedef struct _RedfishStorage_V1_8_1_OemActions_CS RedfishStorage_V1_8_1_OemActions_CS;
typedef struct _RedfishStorage_V1_8_1_Rates_CS RedfishStorage_V1_8_1_Rates_CS;
typedef struct _RedfishStorage_V1_8_1_SetEncryptionKey_CS RedfishStorage_V1_8_1_SetEncryptionKey_CS;
typedef struct _RedfishStorage_V1_8_1_Storage_CS RedfishStorage_V1_8_1_Storage_CS;
typedef struct _RedfishStorage_V1_8_1_StorageController_CS RedfishStorage_V1_8_1_StorageController_CS;
typedef struct _RedfishStorage_V1_8_1_StorageControllerActions_CS RedfishStorage_V1_8_1_StorageControllerActions_CS;
typedef struct _RedfishStorage_V1_8_1_StorageControllerLinks_CS RedfishStorage_V1_8_1_StorageControllerLinks_CS;
typedef struct _RedfishStorage_V1_8_1_StorageControllerOemActions_CS RedfishStorage_V1_8_1_StorageControllerOemActions_CS;
...
//
typedef struct _RedfishStorage_V1_8_1_Actions_CS {
    RedfishStorage_V1_8_1_SetEncryptionKey_CS    *Storage_SetEncryptionKey;
    RedfishStorage_V1_8_1_OemActions_CS          *Oem;                        // The available OEM-specific
                                                                              // actions for this resource.
} RedfishStorage_V1_8_1_Actions_CS;

//
// This type describes the cache memory of the storage controller in general
// detail.
//
typedef struct _RedfishStorage_V1_8_1_CacheSummary_CS {
...
} RedfishStorage_V1_8_1_CacheSummary_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishStorage_V1_8_1_Links_CS {
    ...
    RedfishResource_Oem_CS    *Oem;                     // The OEM extension property.
} RedfishStorage_V1_8_1_Links_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishStorage_V1_8_1_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishStorage_V1_8_1_OemActions_CS;

//
// This type describes the various controller rates used for processes such as
// volume rebuild or consistency checks.
//
typedef struct _RedfishStorage_V1_8_1_Rates_CS {
...
} RedfishStorage_V1_8_1_Rates_CS;

//
// This action sets the encryption key for the storage subsystem.
//
typedef struct _RedfishStorage_V1_8_1_SetEncryptionKey_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishStorage_V1_8_1_SetEncryptionKey_CS;
...
// produces volumes.
//
typedef struct _RedfishStorage_V1_8_1_StorageController_CS {
    RedfishCS_char                                       *odata_id;                   
    RedfishStorage_V1_8_1_StorageControllerActions_CS    *Actions;                        // The available actions for this
                                                                                          // resource.
    ...
    RedfishStorage_V1_8_1_CacheSummary_CS                *CacheSummary;                   // The cache memory of the
                                                                                          // storage controller in general
                                                                                          // detail.
    RedfishStorage_V1_8_1_Rates_CS                       *ControllerRates;                // This property describes the
    ...
    RedfishCS_Link                                       Identifiers;                     // The durable names for the
                                                                                          // storage controller.
    RedfishStorage_V1_8_1_StorageControllerLinks_CS      *Links;                          // The links to other resources
    ...
    RedfishCS_char_Array                                 *SupportedRAIDTypes;             // The set of RAID types
                                                                                          ...
                                                                                          // controller.
} RedfishStorage_V1_8_1_StorageController_CS;

//
// The available actions for this resource.
//
typedef struct _RedfishStorage_V1_8_1_StorageControllerActions_CS {
    RedfishStorage_V1_8_1_StorageControllerOemActions_CS    *Oem;    // The available OEM-specific
                                                                    // actions for this resource.
} RedfishStorage_V1_8_1_StorageControllerActions_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishStorage_V1_8_1_StorageControllerLinks_CS {
...
} RedfishStorage_V1_8_1_StorageControllerLinks_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishStorage_V1_8_1_StorageControllerOemActions_CS {
    RedfishCS_Link    Prop;
} RedfishStorage_V1_8_1_StorageControllerOemActions_CS;
...
//
typedef struct _RedfishStorage_V1_8_1_Storage_CS {
    RedfishCS_Header                                    Header;
    RedfishCS_char                                      *odata_context;               
    RedfishCS_char                                      *odata_etag;                  
    RedfishCS_char                                      *odata_id;                    
    RedfishCS_char                                      *odata_type;                  
    RedfishStorage_V1_8_1_Actions_CS                    *Actions;                         // The available actions for this
                                                                                          // resource.
    ...
    RedfishCS_Link                                      FileSystems;                      // All file systems that are
                                                                                          ...
                                                                                          // subsystem.
    RedfishCS_char                                      *Id;                          
    RedfishStorage_V1_8_1_Links_CS                      *Links;                           // The links to other resources
                                                                                          // that are related to this
                                                                                          // resource.
    RedfishCS_char                                      *Name;                        
    RedfishResource_Oem_CS                              *Oem;                             // The OEM extension property.
    ...
    RedfishResource_Status_CS                           *Status;                          // The status and health of the
                                                                                          // resource and its subordinate
                                                                                          // or dependent resources.
    RedfishStorage_V1_8_1_StorageController_Array_CS    *StorageControllers;              // The set of storage controllers
...
} RedfishStorage_V1_8_1_Storage_CS;
...
typedef struct _RedfishStorage_V1_8_1_StorageController_Array_CS  {
    RedfishStorage_V1_8_1_StorageController_Array_CS    *Next;
    RedfishStorage_V1_8_1_StorageController_CS    *ArrayValue;
} RedfishStorage_V1_8_1_StorageController_Array_CS;

RedfishCS_status
Json_Storage_V1_8_1_To_CS (char *JsonRawText, RedfishStorage_V1_8_1_Storage_CS **ReturnedCS);

RedfishCS_status
CS_To_Storage_V1_8_1_JSON (RedfishStorage_V1_8_1_Storage_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyStorage_V1_8_1_CS (RedfishStorage_V1_8_1_Storage_CS *CSPtr);

RedfishCS_status
DestroyStorage_V1_8_1_Json (RedfishCS_char *JsonText);
