...
#ifndef RedfishFabric_V1_1_3_CSTRUCT_H_
#define RedfishFabric_V1_1_3_CSTRUCT_H_
...
#endif
typedef struct _RedfishFabric_V1_1_3_Actions_CS RedfishFabric_V1_1_3_Actions_CS;
typedef struct _RedfishFabric_V1_1_3_Fabric_CS RedfishFabric_V1_1_3_Fabric_CS;
typedef struct _RedfishFabric_V1_1_3_Links_CS RedfishFabric_V1_1_3_Links_CS;
typedef struct _RedfishFabric_V1_1_3_OemActions_CS RedfishFabric_V1_1_3_OemActions_CS;
...
typedef struct _RedfishFabric_V1_1_3_Actions_CS {
    RedfishFabric_V1_1_3_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishFabric_V1_1_3_Fabric_CS {
    ...
    RedfishFabric_V1_1_3_Actions_CS    *Actions;         // The available actions for this
                                                         // Resource.
    ...
    RedfishCS_char                     *FabricType;      // The protocol being sent over
                                                         // this fabric.
    RedfishCS_char                     *Id;          
    RedfishFabric_V1_1_3_Links_CS      *Links;           // The links to other resources
...
RedfishCS_status
Json_Fabric_V1_1_3_To_CS (char *JsonRawText, RedfishFabric_V1_1_3_Fabric_CS **ReturnedCS);

RedfishCS_status
CS_To_Fabric_V1_1_3_JSON (RedfishFabric_V1_1_3_Fabric_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyFabric_V1_1_3_CS (RedfishFabric_V1_1_3_Fabric_CS *CSPtr);

RedfishCS_status
DestroyFabric_V1_1_3_Json (RedfishCS_char *JsonText);
