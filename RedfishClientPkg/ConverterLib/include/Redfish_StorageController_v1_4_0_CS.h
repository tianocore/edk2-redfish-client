...
#ifndef RedfishStoragecontroller_V1_4_0_CSTRUCT_H_
#define RedfishStoragecontroller_V1_4_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishStorageController_V1_4_0_ANACharacteristics_Array_CS RedfishStorageController_V1_4_0_ANACharacteristics_Array_CS;
...
typedef struct _RedfishStorageController_V1_4_0_ANACharacteristics_CS RedfishStorageController_V1_4_0_ANACharacteristics_CS;
typedef struct _RedfishStorageController_V1_4_0_Actions_CS RedfishStorageController_V1_4_0_Actions_CS;
typedef struct _RedfishStorageController_V1_4_0_CacheSummary_CS RedfishStorageController_V1_4_0_CacheSummary_CS;
typedef struct _RedfishStorageController_V1_4_0_Links_CS RedfishStorageController_V1_4_0_Links_CS;
typedef struct _RedfishStorageController_V1_4_0_NVMeControllerAttributes_CS RedfishStorageController_V1_4_0_NVMeControllerAttributes_CS;
typedef struct _RedfishStorageController_V1_4_0_NVMeControllerProperties_CS RedfishStorageController_V1_4_0_NVMeControllerProperties_CS;
typedef struct _RedfishStorageController_V1_4_0_NVMeSMARTCriticalWarnings_CS RedfishStorageController_V1_4_0_NVMeSMARTCriticalWarnings_CS;
typedef struct _RedfishStorageController_V1_4_0_OemActions_CS RedfishStorageController_V1_4_0_OemActions_CS;
typedef struct _RedfishStorageController_V1_4_0_Rates_CS RedfishStorageController_V1_4_0_Rates_CS;
typedef struct _RedfishStorageController_V1_4_0_StorageController_CS RedfishStorageController_V1_4_0_StorageController_CS;
...
//
typedef struct _RedfishStorageController_V1_4_0_ANACharacteristics_CS {
    RedfishCS_char    *AccessState;    // Reported ANA access state.
    RedfishCS_Link    Volume;         // The specified volume.
} RedfishStorageController_V1_4_0_ANACharacteristics_CS;

//
// The available actions for this resource.
//
typedef struct _RedfishStorageController_V1_4_0_Actions_CS {
    RedfishStorageController_V1_4_0_OemActions_CS    *Oem;    // The available OEM-specific
                                                             // actions for this resource.
} RedfishStorageController_V1_4_0_Actions_CS;

//
// This type describes the cache memory of the storage controller in general
// detail.
//
typedef struct _RedfishStorageController_V1_4_0_CacheSummary_CS {
...
} RedfishStorageController_V1_4_0_CacheSummary_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishStorageController_V1_4_0_Links_CS {
...
} RedfishStorageController_V1_4_0_Links_CS;

//
// The NVMe controller attributes for a storage controller.
//
typedef struct _RedfishStorageController_V1_4_0_NVMeControllerAttributes_CS {
...
} RedfishStorageController_V1_4_0_NVMeControllerAttributes_CS;

//
// NVMe related properties for a storage controller.
//
typedef struct _RedfishStorageController_V1_4_0_NVMeControllerProperties_CS {
    RedfishStorageController_V1_4_0_ANACharacteristics_Array_CS     *ANACharacteristics;          // The ANA characteristics and
                                                                                                  // volume information.
    ...
    RedfishCS_int64                                                 *MaxQueueSize;                // The maximum individual queue
                                                                                                  ...
                                                                                                  // controller supports.
    RedfishStorageController_V1_4_0_NVMeControllerAttributes_CS     *NVMeControllerAttributes;    // The NVMe controller
                                                                                                  // attributes.
    RedfishStorageController_V1_4_0_NVMeSMARTCriticalWarnings_CS    *NVMeSMARTCriticalWarnings;    // The NVMe SMART Critical
...
} RedfishStorageController_V1_4_0_NVMeControllerProperties_CS;

//
// The NVMe SMART Critical Warnings for a storage controller.
//
typedef struct _RedfishStorageController_V1_4_0_NVMeSMARTCriticalWarnings_CS {
    ...
    RedfishCS_bool    *SpareCapacityWornOut;       // Indicates that the available
                                                   ...
                                                   // below the threshold.
} RedfishStorageController_V1_4_0_NVMeSMARTCriticalWarnings_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishStorageController_V1_4_0_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishStorageController_V1_4_0_OemActions_CS;

//
// This type describes the various controller rates used for processes such as
// volume rebuild or consistency checks.
//
typedef struct _RedfishStorageController_V1_4_0_Rates_CS {
...
} RedfishStorageController_V1_4_0_Rates_CS;
...
// produces volumes.
//
typedef struct _RedfishStorageController_V1_4_0_StorageController_CS {
    RedfishCS_Header                                               Header;
    RedfishCS_char                                                 *odata_context;              
    RedfishCS_char                                                 *odata_etag;                 
    RedfishCS_char                                                 *odata_id;                   
    RedfishCS_char                                                 *odata_type;                 
    RedfishStorageController_V1_4_0_Actions_CS                     *Actions;                        // The available actions for this
                                                                                                    // resource.
    ...
    RedfishStorageController_V1_4_0_CacheSummary_CS                *CacheSummary;                   // The cache memory of the
                                                                                                    // storage controller in general
                                                                                                    // detail.
    RedfishCS_Link                                                 Certificates;                    // The link to a collection of
                                                                                                    // certificates for device
                                                                                                    // identity and attestation.
    RedfishStorageController_V1_4_0_Rates_CS                       *ControllerRates;                // This property describes the
    ...
    RedfishCS_Link                                                 Identifiers;                     // The durable names for the
                                                                                                    // storage controller.
    RedfishStorageController_V1_4_0_Links_CS                       *Links;                          // The links to other resources
    ...
    RedfishCS_char                                                 *Model;                          // The model number for the
                                                                                                    // storage controller.
    RedfishStorageController_V1_4_0_NVMeControllerProperties_CS    *NVMeControllerProperties;       // The NVMe related properties
                                                                                                    // for this storage controller.
    RedfishCS_char                                                 *Name;                       
    RedfishResource_Oem_CS                                         *Oem;                            // The OEM extension property.
    ...
    RedfishCS_char_Array                                           *SupportedRAIDTypes;             // The set of RAID types
                                                                                                    ...
                                                                                                    // controller.
} RedfishStorageController_V1_4_0_StorageController_CS;
...
typedef struct _RedfishStorageController_V1_4_0_ANACharacteristics_Array_CS  {
    RedfishStorageController_V1_4_0_ANACharacteristics_Array_CS    *Next;
    RedfishStorageController_V1_4_0_ANACharacteristics_CS    *ArrayValue;
} RedfishStorageController_V1_4_0_ANACharacteristics_Array_CS;

RedfishCS_status
Json_StorageController_V1_4_0_To_CS (char *JsonRawText, RedfishStorageController_V1_4_0_StorageController_CS **ReturnedCS);

RedfishCS_status
CS_To_StorageController_V1_4_0_JSON (RedfishStorageController_V1_4_0_StorageController_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyStorageController_V1_4_0_CS (RedfishStorageController_V1_4_0_StorageController_CS *CSPtr);

RedfishCS_status
DestroyStorageController_V1_4_0_Json (RedfishCS_char *JsonText);
