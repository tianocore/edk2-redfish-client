...
#ifndef RedfishProcessormetrics_V1_4_1_CSTRUCT_H_
#define RedfishProcessormetrics_V1_4_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishProcessorMetrics_V1_4_1_CStateResidency_Array_CS RedfishProcessorMetrics_V1_4_1_CStateResidency_Array_CS;
typedef struct _RedfishProcessorMetrics_V1_4_1_CacheMetrics_Array_CS RedfishProcessorMetrics_V1_4_1_CacheMetrics_Array_CS;
typedef struct _RedfishProcessorMetrics_V1_4_1_CoreMetrics_Array_CS RedfishProcessorMetrics_V1_4_1_CoreMetrics_Array_CS;
typedef struct _RedfishProcessorMetrics_V1_4_1_Actions_CS RedfishProcessorMetrics_V1_4_1_Actions_CS;
typedef struct _RedfishProcessorMetrics_V1_4_1_CStateResidency_CS RedfishProcessorMetrics_V1_4_1_CStateResidency_CS;
typedef struct _RedfishProcessorMetrics_V1_4_1_CacheMetrics_CS RedfishProcessorMetrics_V1_4_1_CacheMetrics_CS;
typedef struct _RedfishProcessorMetrics_V1_4_1_CacheMetricsTotal_CS RedfishProcessorMetrics_V1_4_1_CacheMetricsTotal_CS;
typedef struct _RedfishProcessorMetrics_V1_4_1_ClearCurrentPeriod_CS RedfishProcessorMetrics_V1_4_1_ClearCurrentPeriod_CS;
typedef struct _RedfishProcessorMetrics_V1_4_1_CoreMetrics_CS RedfishProcessorMetrics_V1_4_1_CoreMetrics_CS;
typedef struct _RedfishProcessorMetrics_V1_4_1_CurrentPeriod_CS RedfishProcessorMetrics_V1_4_1_CurrentPeriod_CS;
typedef struct _RedfishProcessorMetrics_V1_4_1_LifeTime_CS RedfishProcessorMetrics_V1_4_1_LifeTime_CS;
typedef struct _RedfishProcessorMetrics_V1_4_1_OemActions_CS RedfishProcessorMetrics_V1_4_1_OemActions_CS;
typedef struct _RedfishProcessorMetrics_V1_4_1_ProcessorMetrics_CS RedfishProcessorMetrics_V1_4_1_ProcessorMetrics_CS;
...
typedef struct _RedfishProcessorMetrics_V1_4_1_Actions_CS {
    ...
    RedfishProcessorMetrics_V1_4_1_OemActions_CS            *Oem;                                   // The available OEM-specific
...
typedef struct _RedfishProcessorMetrics_V1_4_1_CacheMetricsTotal_CS {
    RedfishProcessorMetrics_V1_4_1_CurrentPeriod_CS    *CurrentPeriod;    // The cache metrics since the
                                                                         // last reset for this processor.
    RedfishProcessorMetrics_V1_4_1_LifeTime_CS         *LifeTime;        // The cache metrics for the
...
typedef struct _RedfishProcessorMetrics_V1_4_1_CoreMetrics_CS {
    RedfishProcessorMetrics_V1_4_1_CStateResidency_Array_CS    *CStateResidency;        // The C-state residency of this
                                                                                        // core in the processor.
    RedfishProcessorMetrics_V1_4_1_CacheMetrics_Array_CS       *CoreCache;              // The cache metrics of this core
                                                                                        // in the processor.
...
typedef struct _RedfishProcessorMetrics_V1_4_1_ProcessorMetrics_CS {
    ...
    RedfishProcessorMetrics_V1_4_1_Actions_CS               *Actions;                      // The available actions for this
                                                                                           // resource.
    ...
    RedfishProcessorMetrics_V1_4_1_CacheMetrics_Array_CS    *Cache;                        // The processor cache metrics.
    RedfishProcessorMetrics_V1_4_1_CacheMetricsTotal_CS     *CacheMetricsTotal;            // The total cache metrics for
                                                                                           // this processor.
    RedfishCS_int64                                         *ConsumedPowerWatt;            // The power, in watts, that the
                                                                                           // processor has consumed.
    RedfishProcessorMetrics_V1_4_1_CoreMetrics_Array_CS     *CoreMetrics;                  // The processor core metrics.
    RedfishCS_Link                                          CoreVoltage;                   // The core voltage (V) of this
                                                                                           // processor.
...
typedef struct _RedfishProcessorMetrics_V1_4_1_CStateResidency_Array_CS  {
    RedfishProcessorMetrics_V1_4_1_CStateResidency_Array_CS    *Next;
    RedfishProcessorMetrics_V1_4_1_CStateResidency_CS    *ArrayValue;
} RedfishProcessorMetrics_V1_4_1_CStateResidency_Array_CS;

typedef struct _RedfishProcessorMetrics_V1_4_1_CacheMetrics_Array_CS  {
    RedfishProcessorMetrics_V1_4_1_CacheMetrics_Array_CS    *Next;
    RedfishProcessorMetrics_V1_4_1_CacheMetrics_CS    *ArrayValue;
} RedfishProcessorMetrics_V1_4_1_CacheMetrics_Array_CS;

typedef struct _RedfishProcessorMetrics_V1_4_1_CoreMetrics_Array_CS  {
    RedfishProcessorMetrics_V1_4_1_CoreMetrics_Array_CS    *Next;
    RedfishProcessorMetrics_V1_4_1_CoreMetrics_CS    *ArrayValue;
} RedfishProcessorMetrics_V1_4_1_CoreMetrics_Array_CS;

RedfishCS_status
Json_ProcessorMetrics_V1_4_1_To_CS (char *JsonRawText, RedfishProcessorMetrics_V1_4_1_ProcessorMetrics_CS **ReturnedCS);

RedfishCS_status
CS_To_ProcessorMetrics_V1_4_1_JSON (RedfishProcessorMetrics_V1_4_1_ProcessorMetrics_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyProcessorMetrics_V1_4_1_CS (RedfishProcessorMetrics_V1_4_1_ProcessorMetrics_CS *CSPtr);

RedfishCS_status
DestroyProcessorMetrics_V1_4_1_Json (RedfishCS_char *JsonText);
