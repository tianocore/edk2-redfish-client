...
#ifndef RedfishLogentry_V1_5_2_CSTRUCT_H_
#define RedfishLogentry_V1_5_2_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishLogEntry_V1_5_2_Actions_CS RedfishLogEntry_V1_5_2_Actions_CS;
typedef struct _RedfishLogEntry_V1_5_2_Links_CS RedfishLogEntry_V1_5_2_Links_CS;
typedef struct _RedfishLogEntry_V1_5_2_LogEntry_CS RedfishLogEntry_V1_5_2_LogEntry_CS;
typedef struct _RedfishLogEntry_V1_5_2_OemActions_CS RedfishLogEntry_V1_5_2_OemActions_CS;
...
typedef struct _RedfishLogEntry_V1_5_2_Actions_CS {
    RedfishLogEntry_V1_5_2_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishLogEntry_V1_5_2_LogEntry_CS {
    ...
    RedfishLogEntry_V1_5_2_Actions_CS    *Actions;           // The available actions for this
                                                             // resource.
    ...
    RedfishCS_char                       *GeneratorId;       // An identifier of the device
                                                             ...
                                                             // SEL Event Record.
    RedfishCS_char                       *Id;            
    RedfishLogEntry_V1_5_2_Links_CS      *Links;             // The links to other resources
...
RedfishCS_status
Json_LogEntry_V1_5_2_To_CS (char *JsonRawText, RedfishLogEntry_V1_5_2_LogEntry_CS **ReturnedCS);

RedfishCS_status
CS_To_LogEntry_V1_5_2_JSON (RedfishLogEntry_V1_5_2_LogEntry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyLogEntry_V1_5_2_CS (RedfishLogEntry_V1_5_2_LogEntry_CS *CSPtr);

RedfishCS_status
DestroyLogEntry_V1_5_2_Json (RedfishCS_char *JsonText);
