...
#ifndef RedfishNetworkdevicefunction_V1_4_2_CSTRUCT_H_
#define RedfishNetworkdevicefunction_V1_4_2_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishNetworkDeviceFunction_V1_4_2_BootTargets_Array_CS RedfishNetworkDeviceFunction_V1_4_2_BootTargets_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishNetworkDeviceFunction_V1_4_2_Actions_CS RedfishNetworkDeviceFunction_V1_4_2_Actions_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_4_2_BootTargets_CS RedfishNetworkDeviceFunction_V1_4_2_BootTargets_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_4_2_Ethernet_CS RedfishNetworkDeviceFunction_V1_4_2_Ethernet_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_4_2_FibreChannel_CS RedfishNetworkDeviceFunction_V1_4_2_FibreChannel_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_4_2_Links_CS RedfishNetworkDeviceFunction_V1_4_2_Links_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_4_2_NetworkDeviceFunction_CS RedfishNetworkDeviceFunction_V1_4_2_NetworkDeviceFunction_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_4_2_OemActions_CS RedfishNetworkDeviceFunction_V1_4_2_OemActions_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_4_2_iSCSIBoot_CS RedfishNetworkDeviceFunction_V1_4_2_iSCSIBoot_CS;
...
typedef struct _RedfishNetworkDeviceFunction_V1_4_2_Actions_CS {
    RedfishNetworkDeviceFunction_V1_4_2_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishNetworkDeviceFunction_V1_4_2_FibreChannel_CS {
    RedfishCS_bool                                              *AllowFIPVLANDiscovery;    // An indication of whether the
                                                                                          ...
                                                                                          // ID.
    RedfishNetworkDeviceFunction_V1_4_2_BootTargets_Array_CS    *BootTargets;             // An array of Fibre Channel boot
...
typedef struct _RedfishNetworkDeviceFunction_V1_4_2_NetworkDeviceFunction_CS {
    ...
    RedfishNetworkDeviceFunction_V1_4_2_Actions_CS         *Actions;                              // The available actions for this
                                                                                                  // resource.
    ...
    RedfishCS_bool                                         *DeviceEnabled;                        // An indication of whether the
                                                                                                  ...
                                                                                                  // enabled.
    RedfishNetworkDeviceFunction_V1_4_2_Ethernet_CS        *Ethernet;                             // The Ethernet capabilities,
                                                                                                  // status, and configuration
                                                                                                  // values for this network device
                                                                                                  // function.
    RedfishNetworkDeviceFunction_V1_4_2_FibreChannel_CS    *FibreChannel;                         // The Fibre Channel
                                                                                                  // capabilities, status, and
                                                                                                  // configuration values for this
                                                                                                  // network device function.
    RedfishCS_char                                         *Id;                               
    RedfishNetworkDeviceFunction_V1_4_2_Links_CS           *Links;                                // The links to other resources
    ...
    RedfishCS_bool                                         *VirtualFunctionsEnabled;              // An indication of whether
                                                                                                  ...
                                                                                                  // for this network device
                                                                                                  // function.
    RedfishNetworkDeviceFunction_V1_4_2_iSCSIBoot_CS       *iSCSIBoot;                            // The iSCSI boot capabilities,
                                                                                                  // status, and configuration
                                                                                                  // values for this network device
                                                                                                  // function.
...
typedef struct _RedfishNetworkDeviceFunction_V1_4_2_BootTargets_Array_CS  {
    RedfishNetworkDeviceFunction_V1_4_2_BootTargets_Array_CS    *Next;
...
RedfishCS_status
Json_NetworkDeviceFunction_V1_4_2_To_CS (char *JsonRawText, RedfishNetworkDeviceFunction_V1_4_2_NetworkDeviceFunction_CS **ReturnedCS);

RedfishCS_status
CS_To_NetworkDeviceFunction_V1_4_2_JSON (RedfishNetworkDeviceFunction_V1_4_2_NetworkDeviceFunction_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyNetworkDeviceFunction_V1_4_2_CS (RedfishNetworkDeviceFunction_V1_4_2_NetworkDeviceFunction_CS *CSPtr);

RedfishCS_status
DestroyNetworkDeviceFunction_V1_4_2_Json (RedfishCS_char *JsonText);
