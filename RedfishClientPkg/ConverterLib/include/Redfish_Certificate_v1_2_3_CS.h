...
#ifndef RedfishCertificate_V1_2_3_CSTRUCT_H_
#define RedfishCertificate_V1_2_3_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishCertificate_V1_2_3_Actions_CS RedfishCertificate_V1_2_3_Actions_CS;
typedef struct _RedfishCertificate_V1_2_3_Certificate_CS RedfishCertificate_V1_2_3_Certificate_CS;
typedef struct _RedfishCertificate_V1_2_3_Identifier_CS RedfishCertificate_V1_2_3_Identifier_CS;
typedef struct _RedfishCertificate_V1_2_3_OemActions_CS RedfishCertificate_V1_2_3_OemActions_CS;
typedef struct _RedfishCertificate_V1_2_3_Rekey_CS RedfishCertificate_V1_2_3_Rekey_CS;
typedef struct _RedfishCertificate_V1_2_3_RekeyResponse_CS RedfishCertificate_V1_2_3_RekeyResponse_CS;
typedef struct _RedfishCertificate_V1_2_3_Renew_CS RedfishCertificate_V1_2_3_Renew_CS;
typedef struct _RedfishCertificate_V1_2_3_RenewResponse_CS RedfishCertificate_V1_2_3_RenewResponse_CS;
...
typedef struct _RedfishCertificate_V1_2_3_Actions_CS {
    ...
    RedfishCertificate_V1_2_3_OemActions_CS    *Oem;                 // The available OEM-specific
...
typedef struct _RedfishCertificate_V1_2_3_Certificate_CS {
    ...
    RedfishCertificate_V1_2_3_Actions_CS       *Actions;              // The available actions for this
                                                                      // resource.
    ...
    RedfishCS_char                             *Id;               
    RedfishCertificate_V1_2_3_Identifier_CS    *Issuer;               // The issuer of the certificate.
    ...
    RedfishCertificate_V1_2_3_Identifier_CS    *Subject;              // The subject of the
                                                                      // certificate.
...
RedfishCS_status
Json_Certificate_V1_2_3_To_CS (char *JsonRawText, RedfishCertificate_V1_2_3_Certificate_CS **ReturnedCS);

RedfishCS_status
CS_To_Certificate_V1_2_3_JSON (RedfishCertificate_V1_2_3_Certificate_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyCertificate_V1_2_3_CS (RedfishCertificate_V1_2_3_Certificate_CS *CSPtr);

RedfishCS_status
DestroyCertificate_V1_2_3_Json (RedfishCS_char *JsonText);
