...
#ifndef RedfishAccountservice_V1_10_0_CSTRUCT_H_
#define RedfishAccountservice_V1_10_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishAccountService_V1_10_0_RoleMapping_Array_CS RedfishAccountService_V1_10_0_RoleMapping_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishAccountService_V1_10_0_AccountService_CS RedfishAccountService_V1_10_0_AccountService_CS;
typedef struct _RedfishAccountService_V1_10_0_Actions_CS RedfishAccountService_V1_10_0_Actions_CS;
typedef struct _RedfishAccountService_V1_10_0_Authentication_CS RedfishAccountService_V1_10_0_Authentication_CS;
typedef struct _RedfishAccountService_V1_10_0_ExternalAccountProvider_CS RedfishAccountService_V1_10_0_ExternalAccountProvider_CS;
typedef struct _RedfishAccountService_V1_10_0_LDAPSearchSettings_CS RedfishAccountService_V1_10_0_LDAPSearchSettings_CS;
typedef struct _RedfishAccountService_V1_10_0_LDAPService_CS RedfishAccountService_V1_10_0_LDAPService_CS;
typedef struct _RedfishAccountService_V1_10_0_OAuth2Service_CS RedfishAccountService_V1_10_0_OAuth2Service_CS;
typedef struct _RedfishAccountService_V1_10_0_OemActions_CS RedfishAccountService_V1_10_0_OemActions_CS;
typedef struct _RedfishAccountService_V1_10_0_RoleMapping_CS RedfishAccountService_V1_10_0_RoleMapping_CS;
typedef struct _RedfishAccountService_V1_10_0_TACACSplusService_CS RedfishAccountService_V1_10_0_TACACSplusService_CS;
...
typedef struct _RedfishAccountService_V1_10_0_Actions_CS {
    RedfishAccountService_V1_10_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishAccountService_V1_10_0_ExternalAccountProvider_CS {
    RedfishCS_char                                        *AccountProviderType;    // The type of external account
                                                                                  ...
                                                                                  // connects.
    RedfishAccountService_V1_10_0_Authentication_CS       *Authentication;        // The authentication information
    ...
    RedfishAccountService_V1_10_0_LDAPService_CS          *LDAPService;           // The additional mapping
                                                                                  // information needed to parse a
                                                                                  // generic LDAP service.
    RedfishAccountService_V1_10_0_OAuth2Service_CS        *OAuth2Service;         // The additional information
                                                                                  // needed to parse an OAuth 2.0
                                                                                  // service.
    ...
    RedfishCS_int64                                       *Priority;              // The authentication priority
                                                                                  // for the external account
                                                                                  // provider.
    RedfishAccountService_V1_10_0_RoleMapping_Array_CS    *RemoteRoleMapping;     // The mapping rules to convert
    ...
    RedfishCS_bool                                        *ServiceEnabled;        // An indication of whether this
                                                                                  // service is enabled.
    RedfishAccountService_V1_10_0_TACACSplusService_CS    *TACACSplusService;     // The additional information
...
typedef struct _RedfishAccountService_V1_10_0_LDAPService_CS {
    RedfishResource_Oem_CS                                 *Oem;              // The OEM extension property.
    RedfishAccountService_V1_10_0_LDAPSearchSettings_CS    *SearchSettings;    // The required settings to
...
typedef struct _RedfishAccountService_V1_10_0_OAuth2Service_CS {
    RedfishCS_char_Array    *Audience;                  // The allowable audience strings
                                                        // of the Redfish service.
    RedfishCS_char          *Issuer;                    // The issuer string of the OAuth
                                                        // 2.0 service.
    RedfishCS_char          *Mode;                      // The mode of operation for
                                                        // token validation.
    RedfishCS_char          *OAuthServiceSigningKeys;    // The Base64-encoded signing
                                                        // keys of the issuer of the
                                                        // OAuth 2.0 service.
...
typedef struct _RedfishAccountService_V1_10_0_AccountService_CS {
    ...
    RedfishCS_Link                                              Accounts;                             // The collection of manager
                                                                                                      // accounts.
    RedfishAccountService_V1_10_0_Actions_CS                    *Actions;                             // The available actions for this
                                                                                                      // resource.
    RedfishAccountService_V1_10_0_ExternalAccountProvider_CS    *ActiveDirectory;                     // The first Active Directory
    ...
    RedfishCS_char                                              *Id;                              
    RedfishAccountService_V1_10_0_ExternalAccountProvider_CS    *LDAP;                                // The first LDAP external
    ...
    RedfishCS_int64                                             *MinPasswordLength;                   // The minimum password length
                                                                                                      // for this account service.
    RedfishCS_char                                              *Name;                            
    RedfishAccountService_V1_10_0_ExternalAccountProvider_CS    *OAuth2;                              // The first OAuth 2.0 external
                                                                                                      // account provider that this
                                                                                                      // account service supports.
    RedfishResource_Oem_CS                                      *Oem;                                 // The OEM extension property.
    ...
    RedfishAccountService_V1_10_0_ExternalAccountProvider_CS    *TACACSplus;                          // The first TACACS+ external
                                                                                                      // account provider that this
                                                                                                      // account service supports.
} RedfishAccountService_V1_10_0_AccountService_CS;

typedef struct _RedfishAccountService_V1_10_0_RoleMapping_Array_CS  {
    RedfishAccountService_V1_10_0_RoleMapping_Array_CS    *Next;
...
RedfishCS_status
Json_AccountService_V1_10_0_To_CS (char *JsonRawText, RedfishAccountService_V1_10_0_AccountService_CS **ReturnedCS);

RedfishCS_status
CS_To_AccountService_V1_10_0_JSON (RedfishAccountService_V1_10_0_AccountService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAccountService_V1_10_0_CS (RedfishAccountService_V1_10_0_AccountService_CS *CSPtr);

RedfishCS_status
DestroyAccountService_V1_10_0_Json (RedfishCS_char *JsonText);
