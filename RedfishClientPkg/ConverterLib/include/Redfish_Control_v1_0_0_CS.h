...
#ifndef RedfishControl_V1_0_0_CSTRUCT_H_
#define RedfishControl_V1_0_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishControl_V1_0_0_Actions_CS RedfishControl_V1_0_0_Actions_CS;
typedef struct _RedfishControl_V1_0_0_Control_CS RedfishControl_V1_0_0_Control_CS;
typedef struct _RedfishControl_V1_0_0_ControlExcerpt_CS RedfishControl_V1_0_0_ControlExcerpt_CS;
typedef struct _RedfishControl_V1_0_0_ControlLoop_CS RedfishControl_V1_0_0_ControlLoop_CS;
typedef struct _RedfishControl_V1_0_0_ControlRangeExcerpt_CS RedfishControl_V1_0_0_ControlRangeExcerpt_CS;
typedef struct _RedfishControl_V1_0_0_ControlSingleExcerpt_CS RedfishControl_V1_0_0_ControlSingleExcerpt_CS;
typedef struct _RedfishControl_V1_0_0_OemActions_CS RedfishControl_V1_0_0_OemActions_CS;
...
typedef struct _RedfishControl_V1_0_0_Actions_CS {
    RedfishControl_V1_0_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishControl_V1_0_0_Control_CS {
    ...
    RedfishControl_V1_0_0_Actions_CS        *Actions;                        // The available actions for this
                                                                             // resource.
    RedfishCS_int64                         *AllowableMax;                   // The maximum possible setting
                                                                             // for this control.
    RedfishCS_int64                         *AllowableMin;                   // The minimum possible setting
    ...
    RedfishControl_V1_0_0_ControlLoop_CS    *ControlLoop;                    // The control loop details.
    RedfishCS_char                          *ControlMode;                    // The current operating mode of
                                                                             // the control.
...
RedfishCS_status
Json_Control_V1_0_0_To_CS (char *JsonRawText, RedfishControl_V1_0_0_Control_CS **ReturnedCS);

RedfishCS_status
CS_To_Control_V1_0_0_JSON (RedfishControl_V1_0_0_Control_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyControl_V1_0_0_CS (RedfishControl_V1_0_0_Control_CS *CSPtr);

RedfishCS_status
DestroyControl_V1_0_0_Json (RedfishCS_char *JsonText);
