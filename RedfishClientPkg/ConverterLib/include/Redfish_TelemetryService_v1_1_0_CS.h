...
#ifndef RedfishTelemetryservice_V1_1_0_CSTRUCT_H_
#define RedfishTelemetryservice_V1_1_0_CSTRUCT_H_
...
typedef struct _RedfishTelemetryService_V1_1_0_Actions_CS RedfishTelemetryService_V1_1_0_Actions_CS;
typedef struct _RedfishTelemetryService_V1_1_0_MetricValue_CS RedfishTelemetryService_V1_1_0_MetricValue_CS;
typedef struct _RedfishTelemetryService_V1_1_0_OemActions_CS RedfishTelemetryService_V1_1_0_OemActions_CS;
typedef struct _RedfishTelemetryService_V1_1_0_SubmitTestMetricReport_CS RedfishTelemetryService_V1_1_0_SubmitTestMetricReport_CS;
typedef struct _RedfishTelemetryService_V1_1_0_TelemetryService_CS RedfishTelemetryService_V1_1_0_TelemetryService_CS;
...
typedef struct _RedfishTelemetryService_V1_1_0_Actions_CS {
    ...
    RedfishTelemetryService_V1_1_0_OemActions_CS                *Oem;                                       // This property contains the
...
typedef struct _RedfishTelemetryService_V1_1_0_TelemetryService_CS {
    ...
    RedfishTelemetryService_V1_1_0_Actions_CS    *Actions;                        // The available actions for this
                                                                                  // resource.
...
RedfishCS_status
Json_TelemetryService_V1_1_0_To_CS (char *JsonRawText, RedfishTelemetryService_V1_1_0_TelemetryService_CS **ReturnedCS);

RedfishCS_status
CS_To_TelemetryService_V1_1_0_JSON (RedfishTelemetryService_V1_1_0_TelemetryService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyTelemetryService_V1_1_0_CS (RedfishTelemetryService_V1_1_0_TelemetryService_CS *CSPtr);

RedfishCS_status
DestroyTelemetryService_V1_1_0_Json (RedfishCS_char *JsonText);
