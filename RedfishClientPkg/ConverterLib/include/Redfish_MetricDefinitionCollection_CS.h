...
#ifndef RedfishMetricdefinitioncollection_Noversioned_CSTRUCT_H_
#define RedfishMetricdefinitioncollection_Noversioned_CSTRUCT_H_
...
//
// The collection of MetricDefinition resource instances.
//
