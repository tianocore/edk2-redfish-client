...
#ifndef RedfishBios_V1_0_9_CSTRUCT_H_
#define RedfishBios_V1_0_9_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishBios_V1_0_9_Actions_CS RedfishBios_V1_0_9_Actions_CS;
typedef struct _RedfishBios_V1_0_9_Attributes_CS RedfishBios_V1_0_9_Attributes_CS;
typedef struct _RedfishBios_V1_0_9_Bios_CS RedfishBios_V1_0_9_Bios_CS;
typedef struct _RedfishBios_V1_0_9_ChangePassword_CS RedfishBios_V1_0_9_ChangePassword_CS;
typedef struct _RedfishBios_V1_0_9_OemActions_CS RedfishBios_V1_0_9_OemActions_CS;
typedef struct _RedfishBios_V1_0_9_ResetBios_CS RedfishBios_V1_0_9_ResetBios_CS;
...
typedef struct _RedfishBios_V1_0_9_Actions_CS {
    ...
    RedfishBios_V1_0_9_OemActions_CS        *Oem;                   // The available OEM-specific
...
typedef struct _RedfishBios_V1_0_9_Bios_CS {
    ...
    RedfishBios_V1_0_9_Actions_CS       *Actions;             // The available actions for this
                                                              // resource.
    RedfishCS_char                      *AttributeRegistry;    // The resource ID of the
                                                              ...
                                                              // resource.
    RedfishBios_V1_0_9_Attributes_CS    *Attributes;          // The list of BIOS attributes
...
RedfishCS_status
Json_Bios_V1_0_9_To_CS (char *JsonRawText, RedfishBios_V1_0_9_Bios_CS **ReturnedCS);

RedfishCS_status
CS_To_Bios_V1_0_9_JSON (RedfishBios_V1_0_9_Bios_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyBios_V1_0_9_CS (RedfishBios_V1_0_9_Bios_CS *CSPtr);

RedfishCS_status
DestroyBios_V1_0_9_Json (RedfishCS_char *JsonText);
