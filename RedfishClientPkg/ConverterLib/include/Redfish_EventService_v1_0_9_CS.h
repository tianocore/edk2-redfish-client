...
#ifndef RedfishEventservice_V1_0_9_CSTRUCT_H_
#define RedfishEventservice_V1_0_9_CSTRUCT_H_
...
#endif
typedef struct _RedfishEventService_V1_0_9_Actions_CS RedfishEventService_V1_0_9_Actions_CS;
typedef struct _RedfishEventService_V1_0_9_EventService_CS RedfishEventService_V1_0_9_EventService_CS;
typedef struct _RedfishEventService_V1_0_9_OemActions_CS RedfishEventService_V1_0_9_OemActions_CS;
typedef struct _RedfishEventService_V1_0_9_SubmitTestEvent_CS RedfishEventService_V1_0_9_SubmitTestEvent_CS;
...
typedef struct _RedfishEventService_V1_0_9_Actions_CS {
    ...
    RedfishEventService_V1_0_9_OemActions_CS         *Oem;                            // This property contains the
...
typedef struct _RedfishEventService_V1_0_9_EventService_CS {
    ...
    RedfishEventService_V1_0_9_Actions_CS    *Actions;                        // The available actions for this
                                                                              // resource.
...
RedfishCS_status
Json_EventService_V1_0_9_To_CS (char *JsonRawText, RedfishEventService_V1_0_9_EventService_CS **ReturnedCS);

RedfishCS_status
CS_To_EventService_V1_0_9_JSON (RedfishEventService_V1_0_9_EventService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEventService_V1_0_9_CS (RedfishEventService_V1_0_9_EventService_CS *CSPtr);

RedfishCS_status
DestroyEventService_V1_0_9_Json (RedfishCS_char *JsonText);
