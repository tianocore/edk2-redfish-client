...
#ifndef RedfishPowerdomain_V1_0_1_CSTRUCT_H_
#define RedfishPowerdomain_V1_0_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishPowerDomain_V1_0_1_Actions_CS RedfishPowerDomain_V1_0_1_Actions_CS;
typedef struct _RedfishPowerDomain_V1_0_1_Links_CS RedfishPowerDomain_V1_0_1_Links_CS;
typedef struct _RedfishPowerDomain_V1_0_1_OemActions_CS RedfishPowerDomain_V1_0_1_OemActions_CS;
typedef struct _RedfishPowerDomain_V1_0_1_PowerDomain_CS RedfishPowerDomain_V1_0_1_PowerDomain_CS;
...
typedef struct _RedfishPowerDomain_V1_0_1_Actions_CS {
    RedfishPowerDomain_V1_0_1_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishPowerDomain_V1_0_1_PowerDomain_CS {
    ...
    RedfishPowerDomain_V1_0_1_Actions_CS    *Actions;         // The available actions for this
                                                              // resource.
    RedfishCS_char                          *Description; 
    RedfishCS_char                          *Id;          
    RedfishPowerDomain_V1_0_1_Links_CS      *Links;           // The links to other resources
...
RedfishCS_status
Json_PowerDomain_V1_0_1_To_CS (char *JsonRawText, RedfishPowerDomain_V1_0_1_PowerDomain_CS **ReturnedCS);

RedfishCS_status
CS_To_PowerDomain_V1_0_1_JSON (RedfishPowerDomain_V1_0_1_PowerDomain_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPowerDomain_V1_0_1_CS (RedfishPowerDomain_V1_0_1_PowerDomain_CS *CSPtr);

RedfishCS_status
DestroyPowerDomain_V1_0_1_Json (RedfishCS_char *JsonText);
