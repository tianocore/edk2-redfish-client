...
#ifndef RedfishNetworkport_V1_2_2_CSTRUCT_H_
#define RedfishNetworkport_V1_2_2_CSTRUCT_H_
...
#endif
typedef struct _RedfishNetworkPort_V1_2_2_NetDevFuncMaxBWAlloc_Array_CS RedfishNetworkPort_V1_2_2_NetDevFuncMaxBWAlloc_Array_CS;
typedef struct _RedfishNetworkPort_V1_2_2_NetDevFuncMinBWAlloc_Array_CS RedfishNetworkPort_V1_2_2_NetDevFuncMinBWAlloc_Array_CS;
typedef struct _RedfishNetworkPort_V1_2_2_SupportedLinkCapabilities_Array_CS RedfishNetworkPort_V1_2_2_SupportedLinkCapabilities_Array_CS;
typedef struct _RedfishNetworkPort_V1_2_2_Actions_CS RedfishNetworkPort_V1_2_2_Actions_CS;
typedef struct _RedfishNetworkPort_V1_2_2_NetDevFuncMaxBWAlloc_CS RedfishNetworkPort_V1_2_2_NetDevFuncMaxBWAlloc_CS;
typedef struct _RedfishNetworkPort_V1_2_2_NetDevFuncMinBWAlloc_CS RedfishNetworkPort_V1_2_2_NetDevFuncMinBWAlloc_CS;
typedef struct _RedfishNetworkPort_V1_2_2_NetworkPort_CS RedfishNetworkPort_V1_2_2_NetworkPort_CS;
typedef struct _RedfishNetworkPort_V1_2_2_OemActions_CS RedfishNetworkPort_V1_2_2_OemActions_CS;
typedef struct _RedfishNetworkPort_V1_2_2_SupportedLinkCapabilities_CS RedfishNetworkPort_V1_2_2_SupportedLinkCapabilities_CS;
...
typedef struct _RedfishNetworkPort_V1_2_2_Actions_CS {
    RedfishNetworkPort_V1_2_2_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishNetworkPort_V1_2_2_NetworkPort_CS {
    ...
    RedfishNetworkPort_V1_2_2_Actions_CS                            *Actions;                         // The available actions for this
                                                                                                      // resource.
    ...
    RedfishCS_char                                                  *Name;                        
    RedfishNetworkPort_V1_2_2_NetDevFuncMaxBWAlloc_Array_CS         *NetDevFuncMaxBWAlloc;            // The array of maximum bandwidth
                                                                                                      // allocation percentages for the
                                                                                                      // Network Device Functions
                                                                                                      // associated with this port.
    RedfishNetworkPort_V1_2_2_NetDevFuncMinBWAlloc_Array_CS         *NetDevFuncMinBWAlloc;            // The array of minimum bandwidth
                                                                                                      // allocation percentages for the
                                                                                                      // Network Device Functions
                                                                                                      // associated with this port.
    ...
    RedfishCS_char_Array                                            *SupportedEthernetCapabilities;    // The set of Ethernet
                                                                                                      ...
                                                                                                      // supports.
    RedfishNetworkPort_V1_2_2_SupportedLinkCapabilities_Array_CS    *SupportedLinkCapabilities;       // The self-described link
                                                                                                      // capabilities of this port.
...
typedef struct _RedfishNetworkPort_V1_2_2_NetDevFuncMaxBWAlloc_Array_CS  {
    RedfishNetworkPort_V1_2_2_NetDevFuncMaxBWAlloc_Array_CS    *Next;
    RedfishNetworkPort_V1_2_2_NetDevFuncMaxBWAlloc_CS    *ArrayValue;
} RedfishNetworkPort_V1_2_2_NetDevFuncMaxBWAlloc_Array_CS;

typedef struct _RedfishNetworkPort_V1_2_2_NetDevFuncMinBWAlloc_Array_CS  {
    RedfishNetworkPort_V1_2_2_NetDevFuncMinBWAlloc_Array_CS    *Next;
    RedfishNetworkPort_V1_2_2_NetDevFuncMinBWAlloc_CS    *ArrayValue;
} RedfishNetworkPort_V1_2_2_NetDevFuncMinBWAlloc_Array_CS;

typedef struct _RedfishNetworkPort_V1_2_2_SupportedLinkCapabilities_Array_CS  {
    RedfishNetworkPort_V1_2_2_SupportedLinkCapabilities_Array_CS    *Next;
    RedfishNetworkPort_V1_2_2_SupportedLinkCapabilities_CS    *ArrayValue;
} RedfishNetworkPort_V1_2_2_SupportedLinkCapabilities_Array_CS;

RedfishCS_status
Json_NetworkPort_V1_2_2_To_CS (char *JsonRawText, RedfishNetworkPort_V1_2_2_NetworkPort_CS **ReturnedCS);

RedfishCS_status
CS_To_NetworkPort_V1_2_2_JSON (RedfishNetworkPort_V1_2_2_NetworkPort_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyNetworkPort_V1_2_2_CS (RedfishNetworkPort_V1_2_2_NetworkPort_CS *CSPtr);

RedfishCS_status
DestroyNetworkPort_V1_2_2_Json (RedfishCS_char *JsonText);
