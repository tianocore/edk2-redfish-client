...
#ifndef RedfishThermal_V1_0_12_CSTRUCT_H_
#define RedfishThermal_V1_0_12_CSTRUCT_H_
...
#endif
typedef struct _RedfishThermal_V1_0_12_Fan_Array_CS RedfishThermal_V1_0_12_Fan_Array_CS;
typedef struct _RedfishThermal_V1_0_12_Temperature_Array_CS RedfishThermal_V1_0_12_Temperature_Array_CS;
...
typedef struct _RedfishThermal_V1_0_12_Fan_CS RedfishThermal_V1_0_12_Fan_CS;
typedef struct _RedfishThermal_V1_0_12_Temperature_CS RedfishThermal_V1_0_12_Temperature_CS;
typedef struct _RedfishThermal_V1_0_12_Thermal_CS RedfishThermal_V1_0_12_Thermal_CS;
...
typedef struct _RedfishThermal_V1_0_12_Fan_CS {
...
} RedfishThermal_V1_0_12_Fan_CS;

typedef struct _RedfishThermal_V1_0_12_Temperature_CS {
    RedfishCS_char                   *odata_id;                
    RedfishCS_int64                  *LowerThresholdCritical;      // The value at which the reading
                                                                   // is below normal range but not
                                                                   // yet fatal.
    ...
    RedfishCS_int64                  *UpperThresholdNonCritical;    // The value at which the reading
                                                                   // is above normal range.
} RedfishThermal_V1_0_12_Temperature_CS;
...
//
typedef struct _RedfishThermal_V1_0_12_Thermal_CS {
    ...
    RedfishThermal_V1_0_12_Fan_Array_CS            *Fans;                      // The set of fans for this
                                                                               // chassis.
    ...
    RedfishResource_Status_CS                      *Status;                    // The status and health of the
                                                                               // resource and its subordinate
                                                                               // or dependent resources.
    RedfishThermal_V1_0_12_Temperature_Array_CS    *Temperatures;              // The set of temperature sensors
                                                                               // for this chassis.
    RedfishCS_int64                                *Temperaturesodata_count;
} RedfishThermal_V1_0_12_Thermal_CS;
...
typedef struct _RedfishThermal_V1_0_12_Fan_Array_CS  {
    RedfishThermal_V1_0_12_Fan_Array_CS    *Next;
    RedfishThermal_V1_0_12_Fan_CS    *ArrayValue;
} RedfishThermal_V1_0_12_Fan_Array_CS;

typedef struct _RedfishThermal_V1_0_12_Temperature_Array_CS  {
    RedfishThermal_V1_0_12_Temperature_Array_CS    *Next;
    RedfishThermal_V1_0_12_Temperature_CS    *ArrayValue;
} RedfishThermal_V1_0_12_Temperature_Array_CS;

RedfishCS_status
Json_Thermal_V1_0_12_To_CS (char *JsonRawText, RedfishThermal_V1_0_12_Thermal_CS **ReturnedCS);

RedfishCS_status
CS_To_Thermal_V1_0_12_JSON (RedfishThermal_V1_0_12_Thermal_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyThermal_V1_0_12_CS (RedfishThermal_V1_0_12_Thermal_CS *CSPtr);

RedfishCS_status
DestroyThermal_V1_0_12_Json (RedfishCS_char *JsonText);
