...
#ifndef RedfishPort_V1_2_4_CSTRUCT_H_
#define RedfishPort_V1_2_4_CSTRUCT_H_
...
#endif
typedef struct _RedfishPort_V1_2_4_Actions_CS RedfishPort_V1_2_4_Actions_CS;
typedef struct _RedfishPort_V1_2_4_GenZ_CS RedfishPort_V1_2_4_GenZ_CS;
typedef struct _RedfishPort_V1_2_4_Links_CS RedfishPort_V1_2_4_Links_CS;
typedef struct _RedfishPort_V1_2_4_OemActions_CS RedfishPort_V1_2_4_OemActions_CS;
typedef struct _RedfishPort_V1_2_4_Port_CS RedfishPort_V1_2_4_Port_CS;
typedef struct _RedfishPort_V1_2_4_Reset_CS RedfishPort_V1_2_4_Reset_CS;
...
typedef struct _RedfishPort_V1_2_4_Actions_CS {
    ...
    RedfishPort_V1_2_4_OemActions_CS    *Oem;          // The available OEM-specific
...
typedef struct _RedfishPort_V1_2_4_Port_CS {
    ...
    RedfishPort_V1_2_4_Actions_CS    *Actions;                   // The available actions for this
                                                                 // resource.
    ...
    RedfishPort_V1_2_4_GenZ_CS       *GenZ;                      // Gen-Z specific properties.
    RedfishCS_char                   *Id;                    
    ...
    RedfishCS_int64                  *LinkTransitionIndicator;    // The number of link state
                                                                 ...
                                                                 // interface.
    RedfishPort_V1_2_4_Links_CS      *Links;                     // The links to other resources
...
RedfishCS_status
Json_Port_V1_2_4_To_CS (char *JsonRawText, RedfishPort_V1_2_4_Port_CS **ReturnedCS);

RedfishCS_status
CS_To_Port_V1_2_4_JSON (RedfishPort_V1_2_4_Port_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPort_V1_2_4_CS (RedfishPort_V1_2_4_Port_CS *CSPtr);

RedfishCS_status
DestroyPort_V1_2_4_Json (RedfishCS_char *JsonText);
