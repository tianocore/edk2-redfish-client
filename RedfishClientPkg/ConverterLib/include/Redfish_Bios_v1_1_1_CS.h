...
#ifndef RedfishBios_V1_1_1_CSTRUCT_H_
#define RedfishBios_V1_1_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishBios_V1_1_1_Actions_CS RedfishBios_V1_1_1_Actions_CS;
typedef struct _RedfishBios_V1_1_1_Attributes_CS RedfishBios_V1_1_1_Attributes_CS;
typedef struct _RedfishBios_V1_1_1_Bios_CS RedfishBios_V1_1_1_Bios_CS;
typedef struct _RedfishBios_V1_1_1_ChangePassword_CS RedfishBios_V1_1_1_ChangePassword_CS;
typedef struct _RedfishBios_V1_1_1_Links_CS RedfishBios_V1_1_1_Links_CS;
typedef struct _RedfishBios_V1_1_1_OemActions_CS RedfishBios_V1_1_1_OemActions_CS;
typedef struct _RedfishBios_V1_1_1_ResetBios_CS RedfishBios_V1_1_1_ResetBios_CS;
...
typedef struct _RedfishBios_V1_1_1_Actions_CS {
    ...
    RedfishBios_V1_1_1_OemActions_CS        *Oem;                   // The available OEM-specific
...
typedef struct _RedfishBios_V1_1_1_Bios_CS {
    ...
    RedfishBios_V1_1_1_Actions_CS       *Actions;             // The available actions for this
                                                              // resource.
    RedfishCS_char                      *AttributeRegistry;    // The resource ID of the
                                                              ...
                                                              // resource.
    RedfishBios_V1_1_1_Attributes_CS    *Attributes;          // The list of BIOS attributes
                                                              // specific to the manufacturer
                                                              // or provider.
    RedfishCS_char                      *Description;     
    RedfishCS_char                      *Id;              
    RedfishBios_V1_1_1_Links_CS         *Links;               // The links to other resources
...
RedfishCS_status
Json_Bios_V1_1_1_To_CS (char *JsonRawText, RedfishBios_V1_1_1_Bios_CS **ReturnedCS);

RedfishCS_status
CS_To_Bios_V1_1_1_JSON (RedfishBios_V1_1_1_Bios_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyBios_V1_1_1_CS (RedfishBios_V1_1_1_Bios_CS *CSPtr);

RedfishCS_status
DestroyBios_V1_1_1_Json (RedfishCS_char *JsonText);
