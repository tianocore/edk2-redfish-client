...
#ifndef RedfishCircuit_V1_2_0_CSTRUCT_H_
#define RedfishCircuit_V1_2_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishCircuit_V1_2_0_Actions_CS RedfishCircuit_V1_2_0_Actions_CS;
typedef struct _RedfishCircuit_V1_2_0_BreakerControl_CS RedfishCircuit_V1_2_0_BreakerControl_CS;
typedef struct _RedfishCircuit_V1_2_0_Circuit_CS RedfishCircuit_V1_2_0_Circuit_CS;
typedef struct _RedfishCircuit_V1_2_0_CurrentSensors_CS RedfishCircuit_V1_2_0_CurrentSensors_CS;
typedef struct _RedfishCircuit_V1_2_0_EnergySensors_CS RedfishCircuit_V1_2_0_EnergySensors_CS;
typedef struct _RedfishCircuit_V1_2_0_Links_CS RedfishCircuit_V1_2_0_Links_CS;
typedef struct _RedfishCircuit_V1_2_0_OemActions_CS RedfishCircuit_V1_2_0_OemActions_CS;
typedef struct _RedfishCircuit_V1_2_0_PowerControl_CS RedfishCircuit_V1_2_0_PowerControl_CS;
typedef struct _RedfishCircuit_V1_2_0_PowerSensors_CS RedfishCircuit_V1_2_0_PowerSensors_CS;
typedef struct _RedfishCircuit_V1_2_0_ResetMetrics_CS RedfishCircuit_V1_2_0_ResetMetrics_CS;
typedef struct _RedfishCircuit_V1_2_0_VoltageSensors_CS RedfishCircuit_V1_2_0_VoltageSensors_CS;
...
//
typedef struct _RedfishCircuit_V1_2_0_Actions_CS {
    RedfishCircuit_V1_2_0_BreakerControl_CS    *Circuit_BreakerControl;
    RedfishCircuit_V1_2_0_PowerControl_CS      *Circuit_PowerControl; 
    RedfishCircuit_V1_2_0_ResetMetrics_CS      *Circuit_ResetMetrics; 
    RedfishCircuit_V1_2_0_OemActions_CS        *Oem;                      // The available OEM-specific
                                                                          // actions for this resource.
} RedfishCircuit_V1_2_0_Actions_CS;

//
// This action attempts to reset the circuit breaker.
//
typedef struct _RedfishCircuit_V1_2_0_BreakerControl_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishCircuit_V1_2_0_BreakerControl_CS;

//
// The current sensors for this circuit.
//
typedef struct _RedfishCircuit_V1_2_0_CurrentSensors_CS {
...
} RedfishCircuit_V1_2_0_CurrentSensors_CS;

//
// The energy readings for this circuit.
//
typedef struct _RedfishCircuit_V1_2_0_EnergySensors_CS {
    ...
    RedfishCS_Link    Line3ToNeutral;    // The Line 3 to Neutral energy
                                        // reading for this circuit.
} RedfishCircuit_V1_2_0_EnergySensors_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishCircuit_V1_2_0_Links_CS {
...
} RedfishCircuit_V1_2_0_Links_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishCircuit_V1_2_0_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishCircuit_V1_2_0_OemActions_CS;

//
// This action turns the circuit on or off.
//
typedef struct _RedfishCircuit_V1_2_0_PowerControl_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishCircuit_V1_2_0_PowerControl_CS;

//
// This property contains the power sensors.
//
typedef struct _RedfishCircuit_V1_2_0_PowerSensors_CS {
    ...
    RedfishCS_Link    Line3ToNeutral;    // The Line 3 to Neutral power
                                        // reading for this circuit.
} RedfishCircuit_V1_2_0_PowerSensors_CS;

//
// This action resets metrics related to this circuit.
//
typedef struct _RedfishCircuit_V1_2_0_ResetMetrics_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishCircuit_V1_2_0_ResetMetrics_CS;

//
// The voltage readings for this circuit.
//
typedef struct _RedfishCircuit_V1_2_0_VoltageSensors_CS {
    ...
    RedfishCS_Link    Line3ToNeutral;    // The Line 3 to Neutral voltage
                                        // reading for this circuit.
} RedfishCircuit_V1_2_0_VoltageSensors_CS;
...
//
typedef struct _RedfishCircuit_V1_2_0_Circuit_CS {
    RedfishCS_Header                           Header;
    RedfishCS_char                             *odata_context;          
    RedfishCS_char                             *odata_etag;             
    RedfishCS_char                             *odata_id;               
    RedfishCS_char                             *odata_type;             
    RedfishCircuit_V1_2_0_Actions_CS           *Actions;                    // The available actions for this
                                                                            // resource.
    ...
    RedfishCS_char                             *IndicatorLED;               // The state of the indicator
                                                                            ...
                                                                            // circuit.
    RedfishCircuit_V1_2_0_Links_CS             *Links;                      // The links to other resources
    ...
    RedfishCS_char                             *PlugType;                   // The type of plug according to
                                                                            ...
                                                                            // standards.
    RedfishCircuit_V1_2_0_CurrentSensors_CS    *PolyPhaseCurrentAmps;       // The current readings for this
                                                                            // circuit.
    RedfishCircuit_V1_2_0_EnergySensors_CS     *PolyPhaseEnergykWh;         // The energy readings for this
                                                                            // circuit.
    RedfishCircuit_V1_2_0_PowerSensors_CS      *PolyPhasePowerWatts;        // The power readings for this
                                                                            // circuit.
    RedfishCircuit_V1_2_0_VoltageSensors_CS    *PolyPhaseVoltage;           // The voltage readings for this
                                                                            // circuit.
    ...
    RedfishCS_char                             *VoltageType;                // The type of voltage applied to
                                                                            // the circuit.
} RedfishCircuit_V1_2_0_Circuit_CS;
...
RedfishCS_status
Json_Circuit_V1_2_0_To_CS (char *JsonRawText, RedfishCircuit_V1_2_0_Circuit_CS **ReturnedCS);

RedfishCS_status
CS_To_Circuit_V1_2_0_JSON (RedfishCircuit_V1_2_0_Circuit_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyCircuit_V1_2_0_CS (RedfishCircuit_V1_2_0_Circuit_CS *CSPtr);

RedfishCS_status
DestroyCircuit_V1_2_0_Json (RedfishCS_char *JsonText);
