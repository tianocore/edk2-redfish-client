...
#ifndef RedfishManager_V1_3_6_CSTRUCT_H_
#define RedfishManager_V1_3_6_CSTRUCT_H_
...
#endif
typedef struct _RedfishManager_V1_3_6_Actions_CS RedfishManager_V1_3_6_Actions_CS;
typedef struct _RedfishManager_V1_3_6_CommandShell_CS RedfishManager_V1_3_6_CommandShell_CS;
typedef struct _RedfishManager_V1_3_6_ForceFailover_CS RedfishManager_V1_3_6_ForceFailover_CS;
typedef struct _RedfishManager_V1_3_6_GraphicalConsole_CS RedfishManager_V1_3_6_GraphicalConsole_CS;
typedef struct _RedfishManager_V1_3_6_Links_CS RedfishManager_V1_3_6_Links_CS;
typedef struct _RedfishManager_V1_3_6_Manager_CS RedfishManager_V1_3_6_Manager_CS;
typedef struct _RedfishManager_V1_3_6_ManagerService_CS RedfishManager_V1_3_6_ManagerService_CS;
typedef struct _RedfishManager_V1_3_6_ModifyRedundancySet_CS RedfishManager_V1_3_6_ModifyRedundancySet_CS;
typedef struct _RedfishManager_V1_3_6_OemActions_CS RedfishManager_V1_3_6_OemActions_CS;
typedef struct _RedfishManager_V1_3_6_Reset_CS RedfishManager_V1_3_6_Reset_CS;
typedef struct _RedfishManager_V1_3_6_SerialConsole_CS RedfishManager_V1_3_6_SerialConsole_CS;
...
//
typedef struct _RedfishManager_V1_3_6_Actions_CS {
    RedfishManager_V1_3_6_ForceFailover_CS          *Manager_ForceFailover;     
    RedfishManager_V1_3_6_ModifyRedundancySet_CS    *Manager_ModifyRedundancySet;
    RedfishManager_V1_3_6_Reset_CS                  *Manager_Reset;             
    RedfishManager_V1_3_6_OemActions_CS             *Oem;                           // This property contains the
                                                                                    // available OEM specific actions
                                                                                    // for this resource.
} RedfishManager_V1_3_6_Actions_CS;

//
// Information about a Command Shell service provided by a manager.
//
typedef struct _RedfishManager_V1_3_6_CommandShell_CS {
...
} RedfishManager_V1_3_6_CommandShell_CS;

//
// The ForceFailover action forces a failover of this manager to the manager used
// in the parameter.
//
typedef struct _RedfishManager_V1_3_6_ForceFailover_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishManager_V1_3_6_ForceFailover_CS;

//
// Information about a Graphical Console service provided by a manager.
//
typedef struct _RedfishManager_V1_3_6_GraphicalConsole_CS {
    RedfishCS_char_Array    *ConnectTypesSupported;    // This object is used to
    ...
    RedfishCS_bool          *ServiceEnabled;          // Indicates if the service is
                                                      // enabled for this manager.
} RedfishManager_V1_3_6_GraphicalConsole_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishManager_V1_3_6_Links_CS {
...
} RedfishManager_V1_3_6_Links_CS;

//
// Used for describing services like Serial Console, Command Shell or Graphical
// Console.
//
typedef struct _RedfishManager_V1_3_6_ManagerService_CS {
    RedfishCS_int64    *MaxConcurrentSessions;    // Indicates the maximum number
                                                 // of service sessions,
                                                 // regardless of protocol, this
                                                 // manager is able to support.
    RedfishCS_bool     *ServiceEnabled;          // Indicates if the service is
                                                 // enabled for this manager.
} RedfishManager_V1_3_6_ManagerService_CS;

//
// The ModifyRedundancySet operation is used to add or remove members to a
// redundant group of manager.
//
typedef struct _RedfishManager_V1_3_6_ModifyRedundancySet_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishManager_V1_3_6_ModifyRedundancySet_CS;

//
// The available OEM specific actions for this resource.
//
typedef struct _RedfishManager_V1_3_6_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishManager_V1_3_6_OemActions_CS;

//
// The reset action resets/reboots the manager.
//
typedef struct _RedfishManager_V1_3_6_Reset_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishManager_V1_3_6_Reset_CS;

//
// Information about a Serial Console service provided by a manager.
//
typedef struct _RedfishManager_V1_3_6_SerialConsole_CS {
    RedfishCS_char_Array    *ConnectTypesSupported;    // This object is used to
    ...
    RedfishCS_bool          *ServiceEnabled;          // Indicates if the service is
                                                      // enabled for this manager.
} RedfishManager_V1_3_6_SerialConsole_CS;
...
//
typedef struct _RedfishManager_V1_3_6_Manager_CS {
    RedfishCS_Header                             Header;
    RedfishCS_char                               *odata_context;       
    RedfishCS_char                               *odata_etag;          
    RedfishCS_char                               *odata_id;            
    RedfishCS_char                               *odata_type;          
    RedfishManager_V1_3_6_Actions_CS             *Actions;                 // The available actions for this
                                                                           // resource.
    RedfishManager_V1_3_6_CommandShell_CS        *CommandShell;            // Information about the Command
    ...
    RedfishCS_char                               *FirmwareVersion;         // The firmware version of this
                                                                           // Manager.
    RedfishManager_V1_3_6_GraphicalConsole_CS    *GraphicalConsole;        // The value of this property
    ...
    RedfishCS_char                               *Id;                  
    RedfishManager_V1_3_6_Links_CS               *Links;                   // Contains references to other
    ...
    RedfishManager_V1_3_6_SerialConsole_CS       *SerialConsole;           // Information about the Serial
...
} RedfishManager_V1_3_6_Manager_CS;
...
RedfishCS_status
Json_Manager_V1_3_6_To_CS (char *JsonRawText, RedfishManager_V1_3_6_Manager_CS **ReturnedCS);

RedfishCS_status
CS_To_Manager_V1_3_6_JSON (RedfishManager_V1_3_6_Manager_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyManager_V1_3_6_CS (RedfishManager_V1_3_6_Manager_CS *CSPtr);

RedfishCS_status
DestroyManager_V1_3_6_Json (RedfishCS_char *JsonText);
