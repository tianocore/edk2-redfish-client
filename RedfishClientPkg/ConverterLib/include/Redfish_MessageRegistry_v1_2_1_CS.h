...
#ifndef RedfishMessageregistry_V1_2_1_CSTRUCT_H_
#define RedfishMessageregistry_V1_2_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMessageRegistry_V1_2_1_Actions_CS RedfishMessageRegistry_V1_2_1_Actions_CS;
typedef struct _RedfishMessageRegistry_V1_2_1_ClearingLogic_CS RedfishMessageRegistry_V1_2_1_ClearingLogic_CS;
typedef struct _RedfishMessageRegistry_V1_2_1_Message_CS RedfishMessageRegistry_V1_2_1_Message_CS;
typedef struct _RedfishMessageRegistry_V1_2_1_MessageProperty_CS RedfishMessageRegistry_V1_2_1_MessageProperty_CS;
typedef struct _RedfishMessageRegistry_V1_2_1_MessageRegistry_CS RedfishMessageRegistry_V1_2_1_MessageRegistry_CS;
typedef struct _RedfishMessageRegistry_V1_2_1_OemActions_CS RedfishMessageRegistry_V1_2_1_OemActions_CS;
...
typedef struct _RedfishMessageRegistry_V1_2_1_Actions_CS {
    RedfishMessageRegistry_V1_2_1_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishMessageRegistry_V1_2_1_Message_CS {
    RedfishMessageRegistry_V1_2_1_ClearingLogic_CS    *ClearingLogic;    // The clearing logic associated
...
typedef struct _RedfishMessageRegistry_V1_2_1_MessageRegistry_CS {
    ...
    RedfishMessageRegistry_V1_2_1_Actions_CS            *Actions;           // The available actions for this
                                                                            // resource.
    ...
    RedfishCS_char                                      *Language;          // This is the RFC 5646 compliant
                                                                            ...
                                                                            // registry.
    RedfishMessageRegistry_V1_2_1_MessageProperty_CS    *Messages;          // The pattern property indicates
...
RedfishCS_status
Json_MessageRegistry_V1_2_1_To_CS (char *JsonRawText, RedfishMessageRegistry_V1_2_1_MessageRegistry_CS **ReturnedCS);

RedfishCS_status
CS_To_MessageRegistry_V1_2_1_JSON (RedfishMessageRegistry_V1_2_1_MessageRegistry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMessageRegistry_V1_2_1_CS (RedfishMessageRegistry_V1_2_1_MessageRegistry_CS *CSPtr);

RedfishCS_status
DestroyMessageRegistry_V1_2_1_Json (RedfishCS_char *JsonText);
