...
#ifndef RedfishProcessor_V1_9_1_CSTRUCT_H_
#define RedfishProcessor_V1_9_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishProcessor_V1_9_1_ProcessorInterface_Array_CS RedfishProcessor_V1_9_1_ProcessorInterface_Array_CS;
typedef struct _RedfishProcessor_V1_9_1_FpgaReconfigurationSlot_Array_CS RedfishProcessor_V1_9_1_FpgaReconfigurationSlot_Array_CS;
typedef struct _RedfishProcessor_V1_9_1_ProcessorMemory_Array_CS RedfishProcessor_V1_9_1_ProcessorMemory_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishProcessor_V1_9_1_Actions_CS RedfishProcessor_V1_9_1_Actions_CS;
typedef struct _RedfishProcessor_V1_9_1_EthernetInterface_CS RedfishProcessor_V1_9_1_EthernetInterface_CS;
typedef struct _RedfishProcessor_V1_9_1_FPGA_CS RedfishProcessor_V1_9_1_FPGA_CS;
typedef struct _RedfishProcessor_V1_9_1_FpgaReconfigurationSlot_CS RedfishProcessor_V1_9_1_FpgaReconfigurationSlot_CS;
typedef struct _RedfishProcessor_V1_9_1_Links_CS RedfishProcessor_V1_9_1_Links_CS;
typedef struct _RedfishProcessor_V1_9_1_OemActions_CS RedfishProcessor_V1_9_1_OemActions_CS;
typedef struct _RedfishProcessor_V1_9_1_Processor_CS RedfishProcessor_V1_9_1_Processor_CS;
typedef struct _RedfishProcessor_V1_9_1_ProcessorId_CS RedfishProcessor_V1_9_1_ProcessorId_CS;
typedef struct _RedfishProcessor_V1_9_1_ProcessorInterface_CS RedfishProcessor_V1_9_1_ProcessorInterface_CS;
typedef struct _RedfishProcessor_V1_9_1_ProcessorMemory_CS RedfishProcessor_V1_9_1_ProcessorMemory_CS;
typedef struct _RedfishProcessor_V1_9_1_Reset_CS RedfishProcessor_V1_9_1_Reset_CS;
...
//
typedef struct _RedfishProcessor_V1_9_1_Actions_CS {
    RedfishProcessor_V1_9_1_Reset_CS         *Processor_Reset;
    RedfishProcessor_V1_9_1_OemActions_CS    *Oem;               // The available OEM-specific
                                                                 // actions for this resource.
} RedfishProcessor_V1_9_1_Actions_CS;

//
// This type defines an Ethernet interface.
//
typedef struct _RedfishProcessor_V1_9_1_EthernetInterface_CS {
...
} RedfishProcessor_V1_9_1_EthernetInterface_CS;

//
// The properties of the FPGA device.
//
typedef struct _RedfishProcessor_V1_9_1_FPGA_CS {
    RedfishProcessor_V1_9_1_ProcessorInterface_Array_CS         *ExternalInterfaces;     // An array of the FPGA external
                                                                                         // interfaces.
    ...
    RedfishProcessor_V1_9_1_ProcessorInterface_CS               *HostInterface;          // The FPGA interface to the
                                                                                         // host.
    ...
    RedfishProcessor_V1_9_1_FpgaReconfigurationSlot_Array_CS    *ReconfigurationSlots;    // An array of the FPGA
                                                                                         ...
                                                                                         // provisioned.
} RedfishProcessor_V1_9_1_FPGA_CS;
...
// FPGA is provisioned.
//
typedef struct _RedfishProcessor_V1_9_1_FpgaReconfigurationSlot_CS {
...
} RedfishProcessor_V1_9_1_FpgaReconfigurationSlot_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishProcessor_V1_9_1_Links_CS {
...
} RedfishProcessor_V1_9_1_Links_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishProcessor_V1_9_1_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishProcessor_V1_9_1_OemActions_CS;

//
// The identification information for a processor.
//
typedef struct _RedfishProcessor_V1_9_1_ProcessorId_CS {
    ...
    RedfishCS_char    *VendorId;                  // The vendor identification for
                                                  // this processor.
} RedfishProcessor_V1_9_1_ProcessorId_CS;

//
// This type describes an interface between the system, or external connection,
// and the processor.
//
typedef struct _RedfishProcessor_V1_9_1_ProcessorInterface_CS {
    RedfishProcessor_V1_9_1_EthernetInterface_CS    *Ethernet;        // The Ethernet-related
                                                                      // information for this
                                                                      // interface.
    RedfishCS_char                                  *InterfaceType;    // The interface type.
    RedfishCS_Link                                  PCIe;             // The PCIe-related information
                                                                      // for this interface.
} RedfishProcessor_V1_9_1_ProcessorInterface_CS;

//
// This type describes the memory directly attached or integrated within a
// processor.
//
typedef struct _RedfishProcessor_V1_9_1_ProcessorMemory_CS {
    ...
    RedfishCS_int64    *SpeedMHz;           // The operating speed of the
                                            // memory in MHz.
} RedfishProcessor_V1_9_1_ProcessorMemory_CS;

//
// This action resets the processor.
//
typedef struct _RedfishProcessor_V1_9_1_Reset_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishProcessor_V1_9_1_Reset_CS;
...
//
typedef struct _RedfishProcessor_V1_9_1_Processor_CS {
    ...
    RedfishCS_Link                                      AccelerationFunctions;     // The link to the collection of
                                                                                   ...
                                                                                   // associated with this
                                                                                   // processor.
    RedfishProcessor_V1_9_1_Actions_CS                  *Actions;                  // The available actions for this
                                                                                   // resource.
    ...
    RedfishProcessor_V1_9_1_FPGA_CS                     *FPGA;                     // The properties for processors
                                                                                   // of the FPGA type.
    ...
    RedfishCS_char                                      *InstructionSet;           // The instruction set of the
                                                                                   // processor.
    RedfishProcessor_V1_9_1_Links_CS                    *Links;                    // The links to other resources
    ...
    RedfishCS_char                                      *ProcessorArchitecture;    // The architecture of the
                                                                                   // processor.
    RedfishProcessor_V1_9_1_ProcessorId_CS              *ProcessorId;              // The identification information
                                                                                   // for this processor.
    RedfishProcessor_V1_9_1_ProcessorMemory_Array_CS    *ProcessorMemory;          // The memory directly attached
    ...
    RedfishCS_Link                                      SubProcessors;             // The link to the collection of
                                                                                   ...
                                                                                   // processor.
    RedfishProcessor_V1_9_1_ProcessorInterface_CS       *SystemInterface;          // The interface between the
    ...
    RedfishCS_char                                      *Version;                  // The hardware version of the
                                                                                   // processor.
} RedfishProcessor_V1_9_1_Processor_CS;

typedef struct _RedfishProcessor_V1_9_1_ProcessorInterface_Array_CS  {
    RedfishProcessor_V1_9_1_ProcessorInterface_Array_CS    *Next;
    RedfishProcessor_V1_9_1_ProcessorInterface_CS    *ArrayValue;
} RedfishProcessor_V1_9_1_ProcessorInterface_Array_CS;

typedef struct _RedfishProcessor_V1_9_1_FpgaReconfigurationSlot_Array_CS  {
    RedfishProcessor_V1_9_1_FpgaReconfigurationSlot_Array_CS    *Next;
    RedfishProcessor_V1_9_1_FpgaReconfigurationSlot_CS    *ArrayValue;
} RedfishProcessor_V1_9_1_FpgaReconfigurationSlot_Array_CS;

typedef struct _RedfishProcessor_V1_9_1_ProcessorMemory_Array_CS  {
    RedfishProcessor_V1_9_1_ProcessorMemory_Array_CS    *Next;
    RedfishProcessor_V1_9_1_ProcessorMemory_CS    *ArrayValue;
} RedfishProcessor_V1_9_1_ProcessorMemory_Array_CS;
...
RedfishCS_status
Json_Processor_V1_9_1_To_CS (char *JsonRawText, RedfishProcessor_V1_9_1_Processor_CS **ReturnedCS);

RedfishCS_status
CS_To_Processor_V1_9_1_JSON (RedfishProcessor_V1_9_1_Processor_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyProcessor_V1_9_1_CS (RedfishProcessor_V1_9_1_Processor_CS *CSPtr);

RedfishCS_status
DestroyProcessor_V1_9_1_Json (RedfishCS_char *JsonText);
