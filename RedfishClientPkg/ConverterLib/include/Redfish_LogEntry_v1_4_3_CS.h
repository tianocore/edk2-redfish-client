...
#ifndef RedfishLogentry_V1_4_3_CSTRUCT_H_
#define RedfishLogentry_V1_4_3_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishLogEntry_V1_4_3_Actions_CS RedfishLogEntry_V1_4_3_Actions_CS;
typedef struct _RedfishLogEntry_V1_4_3_Links_CS RedfishLogEntry_V1_4_3_Links_CS;
typedef struct _RedfishLogEntry_V1_4_3_LogEntry_CS RedfishLogEntry_V1_4_3_LogEntry_CS;
typedef struct _RedfishLogEntry_V1_4_3_OemActions_CS RedfishLogEntry_V1_4_3_OemActions_CS;
...
typedef struct _RedfishLogEntry_V1_4_3_Actions_CS {
    RedfishLogEntry_V1_4_3_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishLogEntry_V1_4_3_LogEntry_CS {
    ...
    RedfishLogEntry_V1_4_3_Actions_CS    *Actions;           // The available actions for this
                                                             // Resource.
    ...
    RedfishCS_char                       *EventType;         // The type of event recorded in
                                                             // this log.
    RedfishCS_char                       *Id;            
    RedfishLogEntry_V1_4_3_Links_CS      *Links;             // The links to other Resources
...
RedfishCS_status
Json_LogEntry_V1_4_3_To_CS (char *JsonRawText, RedfishLogEntry_V1_4_3_LogEntry_CS **ReturnedCS);

RedfishCS_status
CS_To_LogEntry_V1_4_3_JSON (RedfishLogEntry_V1_4_3_LogEntry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyLogEntry_V1_4_3_CS (RedfishLogEntry_V1_4_3_LogEntry_CS *CSPtr);

RedfishCS_status
DestroyLogEntry_V1_4_3_Json (RedfishCS_char *JsonText);
