...
#ifndef RedfishUpdateservice_V1_4_2_CSTRUCT_H_
#define RedfishUpdateservice_V1_4_2_CSTRUCT_H_
...
typedef struct _RedfishUpdateService_V1_4_2_Actions_CS RedfishUpdateService_V1_4_2_Actions_CS;
typedef struct _RedfishUpdateService_V1_4_2_HttpPushUriApplyTime_CS RedfishUpdateService_V1_4_2_HttpPushUriApplyTime_CS;
typedef struct _RedfishUpdateService_V1_4_2_HttpPushUriOptions_CS RedfishUpdateService_V1_4_2_HttpPushUriOptions_CS;
typedef struct _RedfishUpdateService_V1_4_2_OemActions_CS RedfishUpdateService_V1_4_2_OemActions_CS;
typedef struct _RedfishUpdateService_V1_4_2_SimpleUpdate_CS RedfishUpdateService_V1_4_2_SimpleUpdate_CS;
typedef struct _RedfishUpdateService_V1_4_2_UpdateService_CS RedfishUpdateService_V1_4_2_UpdateService_CS;
...
typedef struct _RedfishUpdateService_V1_4_2_Actions_CS {
    ...
    RedfishUpdateService_V1_4_2_OemActions_CS      *Oem;                          // The available OEM-specific
...
typedef struct _RedfishUpdateService_V1_4_2_HttpPushUriOptions_CS {
    RedfishUpdateService_V1_4_2_HttpPushUriApplyTime_CS    *HttpPushUriApplyTime;    // The settings for when to apply
...
typedef struct _RedfishUpdateService_V1_4_2_UpdateService_CS {
    ...
    RedfishUpdateService_V1_4_2_Actions_CS               *Actions;                  // The available actions for this
                                                                                    // Resource.
    ...
    RedfishCS_char                                       *HttpPushUri;              // The URI used to perform an
                                                                                    ...
                                                                                    // vendor-specific.
    RedfishUpdateService_V1_4_2_HttpPushUriOptions_CS    *HttpPushUriOptions;       // The options for HttpPushUri-
...
RedfishCS_status
Json_UpdateService_V1_4_2_To_CS (char *JsonRawText, RedfishUpdateService_V1_4_2_UpdateService_CS **ReturnedCS);

RedfishCS_status
CS_To_UpdateService_V1_4_2_JSON (RedfishUpdateService_V1_4_2_UpdateService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyUpdateService_V1_4_2_CS (RedfishUpdateService_V1_4_2_UpdateService_CS *CSPtr);

RedfishCS_status
DestroyUpdateService_V1_4_2_Json (RedfishCS_char *JsonText);
