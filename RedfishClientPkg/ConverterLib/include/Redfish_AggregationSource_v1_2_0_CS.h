...
#ifndef RedfishAggregationsource_V1_2_0_CSTRUCT_H_
#define RedfishAggregationsource_V1_2_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishAggregationSource_V1_2_0_Actions_CS RedfishAggregationSource_V1_2_0_Actions_CS;
typedef struct _RedfishAggregationSource_V1_2_0_AggregationSource_CS RedfishAggregationSource_V1_2_0_AggregationSource_CS;
typedef struct _RedfishAggregationSource_V1_2_0_Links_CS RedfishAggregationSource_V1_2_0_Links_CS;
typedef struct _RedfishAggregationSource_V1_2_0_OemActions_CS RedfishAggregationSource_V1_2_0_OemActions_CS;
typedef struct _RedfishAggregationSource_V1_2_0_SNMPSettings_CS RedfishAggregationSource_V1_2_0_SNMPSettings_CS;
...
typedef struct _RedfishAggregationSource_V1_2_0_Actions_CS {
    RedfishAggregationSource_V1_2_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishAggregationSource_V1_2_0_AggregationSource_CS {
    ...
    RedfishAggregationSource_V1_2_0_Actions_CS         *Actions;           // The available actions for this
                                                                           // resource.
    RedfishCS_char                                     *AggregationType;    // The type of aggregation used
    ...
    RedfishCS_char                                     *HostName;          // The URI of the system to be
                                                                           // accessed.
    RedfishCS_char                                     *Id;            
    RedfishAggregationSource_V1_2_0_Links_CS           *Links;             // The links to other resources
    ...
    RedfishAggregationSource_V1_2_0_SNMPSettings_CS    *SNMP;              // SNMP settings of the
                                                                           // aggregation source.
...
RedfishCS_status
Json_AggregationSource_V1_2_0_To_CS (char *JsonRawText, RedfishAggregationSource_V1_2_0_AggregationSource_CS **ReturnedCS);

RedfishCS_status
CS_To_AggregationSource_V1_2_0_JSON (RedfishAggregationSource_V1_2_0_AggregationSource_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAggregationSource_V1_2_0_CS (RedfishAggregationSource_V1_2_0_AggregationSource_CS *CSPtr);

RedfishCS_status
DestroyAggregationSource_V1_2_0_Json (RedfishCS_char *JsonText);
