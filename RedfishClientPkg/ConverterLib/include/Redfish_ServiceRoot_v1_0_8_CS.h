...
#ifndef RedfishServiceroot_V1_0_8_CSTRUCT_H_
#define RedfishServiceroot_V1_0_8_CSTRUCT_H_
...
typedef struct _RedfishServiceRoot_V1_0_8_Links_CS RedfishServiceRoot_V1_0_8_Links_CS;
typedef struct _RedfishServiceRoot_V1_0_8_ServiceRoot_CS RedfishServiceRoot_V1_0_8_ServiceRoot_CS;
//
// The OEM extension.
//
#ifndef RedfishResource_Oem_CS_
...
//
typedef struct _RedfishServiceRoot_V1_0_8_Links_CS {
    RedfishResource_Oem_CS    *Oem;       // Oem extension object.
    RedfishCS_Link            Sessions;    // Link to a collection of
                                          // Sessions.
} RedfishServiceRoot_V1_0_8_Links_CS;

//
// This object represents the root Redfish service.
//
typedef struct _RedfishServiceRoot_V1_0_8_ServiceRoot_CS {
    ...
    RedfishServiceRoot_V1_0_8_Links_CS    *Links;            // Contains references to other
    ...
    RedfishCS_char                        *UUID;             // Unique identifier for a
                                                             ...
                                                             // discovery.
} RedfishServiceRoot_V1_0_8_ServiceRoot_CS;

RedfishCS_status
Json_ServiceRoot_V1_0_8_To_CS (char *JsonRawText, RedfishServiceRoot_V1_0_8_ServiceRoot_CS **ReturnedCS);

RedfishCS_status
CS_To_ServiceRoot_V1_0_8_JSON (RedfishServiceRoot_V1_0_8_ServiceRoot_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyServiceRoot_V1_0_8_CS (RedfishServiceRoot_V1_0_8_ServiceRoot_CS *CSPtr);

RedfishCS_status
DestroyServiceRoot_V1_0_8_Json (RedfishCS_char *JsonText);
