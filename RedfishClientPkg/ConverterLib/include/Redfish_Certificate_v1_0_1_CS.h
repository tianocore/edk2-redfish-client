...
#ifndef RedfishCertificate_V1_0_1_CSTRUCT_H_
#define RedfishCertificate_V1_0_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishCertificate_V1_0_1_Actions_CS RedfishCertificate_V1_0_1_Actions_CS;
typedef struct _RedfishCertificate_V1_0_1_Certificate_CS RedfishCertificate_V1_0_1_Certificate_CS;
typedef struct _RedfishCertificate_V1_0_1_Identifier_CS RedfishCertificate_V1_0_1_Identifier_CS;
typedef struct _RedfishCertificate_V1_0_1_OemActions_CS RedfishCertificate_V1_0_1_OemActions_CS;
...
typedef struct _RedfishCertificate_V1_0_1_Actions_CS {
    RedfishCertificate_V1_0_1_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishCertificate_V1_0_1_Certificate_CS {
    ...
    RedfishCertificate_V1_0_1_Actions_CS       *Actions;             // The available actions for this
                                                                     // resource.
    ...
    RedfishCS_char                             *Id;              
    RedfishCertificate_V1_0_1_Identifier_CS    *Issuer;              // The issuer of the certificate.
    ...
    RedfishResource_Oem_CS                     *Oem;                 // This is the
                                                                     ...
                                                                     // sections.
    RedfishCertificate_V1_0_1_Identifier_CS    *Subject;             // The subject of the
                                                                     // certificate.
...
RedfishCS_status
Json_Certificate_V1_0_1_To_CS (char *JsonRawText, RedfishCertificate_V1_0_1_Certificate_CS **ReturnedCS);

RedfishCS_status
CS_To_Certificate_V1_0_1_JSON (RedfishCertificate_V1_0_1_Certificate_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyCertificate_V1_0_1_CS (RedfishCertificate_V1_0_1_Certificate_CS *CSPtr);

RedfishCS_status
DestroyCertificate_V1_0_1_Json (RedfishCS_char *JsonText);
