...
#ifndef RedfishManageraccount_V1_7_0_CSTRUCT_H_
#define RedfishManageraccount_V1_7_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishManagerAccount_V1_7_0_Actions_CS RedfishManagerAccount_V1_7_0_Actions_CS;
typedef struct _RedfishManagerAccount_V1_7_0_Links_CS RedfishManagerAccount_V1_7_0_Links_CS;
typedef struct _RedfishManagerAccount_V1_7_0_ManagerAccount_CS RedfishManagerAccount_V1_7_0_ManagerAccount_CS;
typedef struct _RedfishManagerAccount_V1_7_0_OemActions_CS RedfishManagerAccount_V1_7_0_OemActions_CS;
typedef struct _RedfishManagerAccount_V1_7_0_SNMPUserInfo_CS RedfishManagerAccount_V1_7_0_SNMPUserInfo_CS;
...
typedef struct _RedfishManagerAccount_V1_7_0_Actions_CS {
    RedfishManagerAccount_V1_7_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishManagerAccount_V1_7_0_ManagerAccount_CS {
    ...
    RedfishManagerAccount_V1_7_0_Actions_CS         *Actions;                  // The available actions for this
                                                                               // resource.
    ...
    RedfishCS_bool                                  *Enabled;                  // An indication of whether an
                                                                               ...
                                                                               // log in.
    RedfishCS_char                                  *Id;                   
    RedfishManagerAccount_V1_7_0_Links_CS           *Links;                    // The links to other resources
    ...
    RedfishManagerAccount_V1_7_0_SNMPUserInfo_CS    *SNMP;                     // The SNMP settings for this
                                                                               // account.
...
RedfishCS_status
Json_ManagerAccount_V1_7_0_To_CS (char *JsonRawText, RedfishManagerAccount_V1_7_0_ManagerAccount_CS **ReturnedCS);

RedfishCS_status
CS_To_ManagerAccount_V1_7_0_JSON (RedfishManagerAccount_V1_7_0_ManagerAccount_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyManagerAccount_V1_7_0_CS (RedfishManagerAccount_V1_7_0_ManagerAccount_CS *CSPtr);

RedfishCS_status
DestroyManagerAccount_V1_7_0_Json (RedfishCS_char *JsonText);
