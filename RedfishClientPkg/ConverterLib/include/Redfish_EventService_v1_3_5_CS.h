...
#ifndef RedfishEventservice_V1_3_5_CSTRUCT_H_
#define RedfishEventservice_V1_3_5_CSTRUCT_H_
...
#endif
typedef struct _RedfishEventService_V1_3_5_Actions_CS RedfishEventService_V1_3_5_Actions_CS;
typedef struct _RedfishEventService_V1_3_5_EventService_CS RedfishEventService_V1_3_5_EventService_CS;
typedef struct _RedfishEventService_V1_3_5_OemActions_CS RedfishEventService_V1_3_5_OemActions_CS;
typedef struct _RedfishEventService_V1_3_5_SSEFilterPropertiesSupported_CS RedfishEventService_V1_3_5_SSEFilterPropertiesSupported_CS;
typedef struct _RedfishEventService_V1_3_5_SubmitTestEvent_CS RedfishEventService_V1_3_5_SubmitTestEvent_CS;
...
//
typedef struct _RedfishEventService_V1_3_5_Actions_CS {
    RedfishEventService_V1_3_5_SubmitTestEvent_CS    *EventService_SubmitTestEvent;
    RedfishEventService_V1_3_5_OemActions_CS         *Oem;                            // The available OEM-specific
                                                                                      // actions for this resource.
} RedfishEventService_V1_3_5_Actions_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishEventService_V1_3_5_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishEventService_V1_3_5_OemActions_CS;

//
// The set of properties that are supported in the `$filter` query parameter for
// the ServerSentEventUri.
//
typedef struct _RedfishEventService_V1_3_5_SSEFilterPropertiesSupported_CS {
...
} RedfishEventService_V1_3_5_SSEFilterPropertiesSupported_CS;

//
// This action generates a test event.
//
typedef struct _RedfishEventService_V1_3_5_SubmitTestEvent_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishEventService_V1_3_5_SubmitTestEvent_CS;
...
//
typedef struct _RedfishEventService_V1_3_5_EventService_CS {
    RedfishCS_Header                                              Header;
    RedfishCS_char                                                *odata_context;               
    RedfishCS_char                                                *odata_etag;                  
    RedfishCS_char                                                *odata_id;                    
    RedfishCS_char                                                *odata_type;                  
    RedfishEventService_V1_3_5_Actions_CS                         *Actions;                         // The available actions for this
                                                                                                    // resource.
    ...
    RedfishEventService_V1_3_5_SSEFilterPropertiesSupported_CS    *SSEFilterPropertiesSupported;    // The set of properties that are
    ...
    RedfishCS_Link                                                Subscriptions;                    // The link to a collection of
                                                                                                    // event destinations.
} RedfishEventService_V1_3_5_EventService_CS;
...
RedfishCS_status
Json_EventService_V1_3_5_To_CS (char *JsonRawText, RedfishEventService_V1_3_5_EventService_CS **ReturnedCS);

RedfishCS_status
CS_To_EventService_V1_3_5_JSON (RedfishEventService_V1_3_5_EventService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEventService_V1_3_5_CS (RedfishEventService_V1_3_5_EventService_CS *CSPtr);

RedfishCS_status
DestroyEventService_V1_3_5_Json (RedfishCS_char *JsonText);
