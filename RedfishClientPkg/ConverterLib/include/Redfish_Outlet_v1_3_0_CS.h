...
#ifndef RedfishOutlet_V1_3_0_CSTRUCT_H_
#define RedfishOutlet_V1_3_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishOutlet_V1_3_0_Actions_CS RedfishOutlet_V1_3_0_Actions_CS;
typedef struct _RedfishOutlet_V1_3_0_CurrentSensors_CS RedfishOutlet_V1_3_0_CurrentSensors_CS;
typedef struct _RedfishOutlet_V1_3_0_Links_CS RedfishOutlet_V1_3_0_Links_CS;
typedef struct _RedfishOutlet_V1_3_0_OemActions_CS RedfishOutlet_V1_3_0_OemActions_CS;
typedef struct _RedfishOutlet_V1_3_0_Outlet_CS RedfishOutlet_V1_3_0_Outlet_CS;
typedef struct _RedfishOutlet_V1_3_0_PowerControl_CS RedfishOutlet_V1_3_0_PowerControl_CS;
typedef struct _RedfishOutlet_V1_3_0_ResetMetrics_CS RedfishOutlet_V1_3_0_ResetMetrics_CS;
typedef struct _RedfishOutlet_V1_3_0_VoltageSensors_CS RedfishOutlet_V1_3_0_VoltageSensors_CS;
...
//
typedef struct _RedfishOutlet_V1_3_0_Actions_CS {
    RedfishOutlet_V1_3_0_PowerControl_CS    *Outlet_PowerControl;
    RedfishOutlet_V1_3_0_ResetMetrics_CS    *Outlet_ResetMetrics;
    RedfishOutlet_V1_3_0_OemActions_CS      *Oem;                   // The available OEM-specific
                                                                    // actions for this resource.
} RedfishOutlet_V1_3_0_Actions_CS;

//
// The current sensors for this outlet.
//
typedef struct _RedfishOutlet_V1_3_0_CurrentSensors_CS {
...
} RedfishOutlet_V1_3_0_CurrentSensors_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishOutlet_V1_3_0_Links_CS {
...
} RedfishOutlet_V1_3_0_Links_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishOutlet_V1_3_0_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishOutlet_V1_3_0_OemActions_CS;

//
// This action turns the outlet on or off.
//
typedef struct _RedfishOutlet_V1_3_0_PowerControl_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishOutlet_V1_3_0_PowerControl_CS;

//
// This action resets metrics related to this outlet.
//
typedef struct _RedfishOutlet_V1_3_0_ResetMetrics_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishOutlet_V1_3_0_ResetMetrics_CS;

//
// The voltage readings for this outlet.
//
typedef struct _RedfishOutlet_V1_3_0_VoltageSensors_CS {
    ...
    RedfishCS_Link    Line3ToNeutral;    // The Line 3 to Neutral voltage
                                        // reading for this outlet.
} RedfishOutlet_V1_3_0_VoltageSensors_CS;
...
//
typedef struct _RedfishOutlet_V1_3_0_Outlet_CS {
    RedfishCS_Header                          Header;
    RedfishCS_char                            *odata_context;          
    RedfishCS_char                            *odata_etag;             
    RedfishCS_char                            *odata_id;               
    RedfishCS_char                            *odata_type;             
    RedfishOutlet_V1_3_0_Actions_CS           *Actions;                    // The available actions for this
                                                                           // resource.
    ...
    RedfishCS_char                            *IndicatorLED;               // The state of the indicator
                                                                           ...
                                                                           // outlet.
    RedfishOutlet_V1_3_0_Links_CS             *Links;                      // The links to other resources
    ...
    RedfishCS_char                            *PhaseWiringType;            // The number of ungrounded
                                                                           ...
                                                                           // of conductors (wires).
    RedfishOutlet_V1_3_0_CurrentSensors_CS    *PolyPhaseCurrentAmps;       // The current readings for this
                                                                           // outlet.
    RedfishOutlet_V1_3_0_VoltageSensors_CS    *PolyPhaseVoltage;           // The voltage readings for this
                                                                           // outlet.
    ...
    RedfishCS_char                            *VoltageType;                // The type of voltage applied to
                                                                           // the outlet.
} RedfishOutlet_V1_3_0_Outlet_CS;
...
RedfishCS_status
Json_Outlet_V1_3_0_To_CS (char *JsonRawText, RedfishOutlet_V1_3_0_Outlet_CS **ReturnedCS);

RedfishCS_status
CS_To_Outlet_V1_3_0_JSON (RedfishOutlet_V1_3_0_Outlet_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyOutlet_V1_3_0_CS (RedfishOutlet_V1_3_0_Outlet_CS *CSPtr);

RedfishCS_status
DestroyOutlet_V1_3_0_Json (RedfishCS_char *JsonText);
