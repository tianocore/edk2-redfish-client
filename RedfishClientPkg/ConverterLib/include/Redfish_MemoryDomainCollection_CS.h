...
#ifndef RedfishMemorydomaincollection_Noversioned_CSTRUCT_H_
#define RedfishMemorydomaincollection_Noversioned_CSTRUCT_H_
...
//
// The collection of MemoryDomain Resource instances.
//
