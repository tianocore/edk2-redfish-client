...
#ifndef RedfishMediacontroller_V1_1_0_CSTRUCT_H_
#define RedfishMediacontroller_V1_1_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishMediaController_V1_1_0_Actions_CS RedfishMediaController_V1_1_0_Actions_CS;
typedef struct _RedfishMediaController_V1_1_0_Links_CS RedfishMediaController_V1_1_0_Links_CS;
typedef struct _RedfishMediaController_V1_1_0_MediaController_CS RedfishMediaController_V1_1_0_MediaController_CS;
typedef struct _RedfishMediaController_V1_1_0_OemActions_CS RedfishMediaController_V1_1_0_OemActions_CS;
typedef struct _RedfishMediaController_V1_1_0_Reset_CS RedfishMediaController_V1_1_0_Reset_CS;
...
typedef struct _RedfishMediaController_V1_1_0_Actions_CS {
    ...
    RedfishMediaController_V1_1_0_OemActions_CS    *Oem;                     // The available OEM-specific
...
typedef struct _RedfishMediaController_V1_1_0_MediaController_CS {
    ...
    RedfishMediaController_V1_1_0_Actions_CS    *Actions;               // The available actions for this
                                                                        // resource.
    RedfishCS_char                              *Description;       
    RedfishCS_char                              *Id;                
    RedfishMediaController_V1_1_0_Links_CS      *Links;                 // The links to other resources
...
RedfishCS_status
Json_MediaController_V1_1_0_To_CS (char *JsonRawText, RedfishMediaController_V1_1_0_MediaController_CS **ReturnedCS);

RedfishCS_status
CS_To_MediaController_V1_1_0_JSON (RedfishMediaController_V1_1_0_MediaController_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMediaController_V1_1_0_CS (RedfishMediaController_V1_1_0_MediaController_CS *CSPtr);

RedfishCS_status
DestroyMediaController_V1_1_0_Json (RedfishCS_char *JsonText);
