...
#ifndef RedfishAssembly_V1_2_2_CSTRUCT_H_
#define RedfishAssembly_V1_2_2_CSTRUCT_H_
...
#endif
typedef struct _RedfishAssembly_V1_2_2_AssemblyData_Array_CS RedfishAssembly_V1_2_2_AssemblyData_Array_CS;
typedef struct _RedfishAssembly_V1_2_2_Actions_CS RedfishAssembly_V1_2_2_Actions_CS;
typedef struct _RedfishAssembly_V1_2_2_Assembly_CS RedfishAssembly_V1_2_2_Assembly_CS;
typedef struct _RedfishAssembly_V1_2_2_AssemblyData_CS RedfishAssembly_V1_2_2_AssemblyData_CS;
typedef struct _RedfishAssembly_V1_2_2_AssemblyDataActions_CS RedfishAssembly_V1_2_2_AssemblyDataActions_CS;
typedef struct _RedfishAssembly_V1_2_2_AssemblyDataOemActions_CS RedfishAssembly_V1_2_2_AssemblyDataOemActions_CS;
typedef struct _RedfishAssembly_V1_2_2_OemActions_CS RedfishAssembly_V1_2_2_OemActions_CS;
...
typedef struct _RedfishAssembly_V1_2_2_Actions_CS {
    RedfishAssembly_V1_2_2_OemActions_CS    *Oem;    // The available OEM-specific
                                                    // actions for this Resource.
} RedfishAssembly_V1_2_2_Actions_CS;

typedef struct _RedfishAssembly_V1_2_2_AssemblyData_CS {
    RedfishCS_char                                   *odata_id;             
    RedfishAssembly_V1_2_2_AssemblyDataActions_CS    *Actions;                  // The available actions for this
                                                                                // Resource.
...
typedef struct _RedfishAssembly_V1_2_2_AssemblyDataActions_CS {
    RedfishAssembly_V1_2_2_AssemblyDataOemActions_CS    *Oem;    // The available OEM-specific
                                                                // actions for this Resource.
...
typedef struct _RedfishAssembly_V1_2_2_Assembly_CS {
    ...
    RedfishAssembly_V1_2_2_Actions_CS               *Actions;                 // The available actions for this
                                                                              // Resource.
    RedfishAssembly_V1_2_2_AssemblyData_Array_CS    *Assemblies;              // The assembly records.
...
typedef struct _RedfishAssembly_V1_2_2_AssemblyData_Array_CS  {
    RedfishAssembly_V1_2_2_AssemblyData_Array_CS    *Next;
    RedfishAssembly_V1_2_2_AssemblyData_CS    *ArrayValue;
} RedfishAssembly_V1_2_2_AssemblyData_Array_CS;

RedfishCS_status
Json_Assembly_V1_2_2_To_CS (char *JsonRawText, RedfishAssembly_V1_2_2_Assembly_CS **ReturnedCS);

RedfishCS_status
CS_To_Assembly_V1_2_2_JSON (RedfishAssembly_V1_2_2_Assembly_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAssembly_V1_2_2_CS (RedfishAssembly_V1_2_2_Assembly_CS *CSPtr);

RedfishCS_status
DestroyAssembly_V1_2_2_Json (RedfishCS_char *JsonText);
