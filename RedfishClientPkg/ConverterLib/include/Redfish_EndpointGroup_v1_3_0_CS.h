...
#ifndef RedfishEndpointgroup_V1_3_0_CSTRUCT_H_
#define RedfishEndpointgroup_V1_3_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishEndpointGroup_V1_3_0_Actions_CS RedfishEndpointGroup_V1_3_0_Actions_CS;
typedef struct _RedfishEndpointGroup_V1_3_0_EndpointGroup_CS RedfishEndpointGroup_V1_3_0_EndpointGroup_CS;
typedef struct _RedfishEndpointGroup_V1_3_0_Links_CS RedfishEndpointGroup_V1_3_0_Links_CS;
typedef struct _RedfishEndpointGroup_V1_3_0_OemActions_CS RedfishEndpointGroup_V1_3_0_OemActions_CS;
...
typedef struct _RedfishEndpointGroup_V1_3_0_Actions_CS {
    RedfishEndpointGroup_V1_3_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishEndpointGroup_V1_3_0_EndpointGroup_CS {
    ...
    RedfishCS_char                            *AccessState;                     // The access state for this
                                                                                // group.
    RedfishEndpointGroup_V1_3_0_Actions_CS    *Actions;                         // The available actions for this
                                                                                // resource.
    ...
    RedfishCS_Link                            Identifier;                       // The durable name for the
                                                                                // endpoint group.
    RedfishEndpointGroup_V1_3_0_Links_CS      *Links;                           // The links to other resources
...
RedfishCS_status
Json_EndpointGroup_V1_3_0_To_CS (char *JsonRawText, RedfishEndpointGroup_V1_3_0_EndpointGroup_CS **ReturnedCS);

RedfishCS_status
CS_To_EndpointGroup_V1_3_0_JSON (RedfishEndpointGroup_V1_3_0_EndpointGroup_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEndpointGroup_V1_3_0_CS (RedfishEndpointGroup_V1_3_0_EndpointGroup_CS *CSPtr);

RedfishCS_status
DestroyEndpointGroup_V1_3_0_Json (RedfishCS_char *JsonText);
