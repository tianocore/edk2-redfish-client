...
#ifndef RedfishSimplestoragecollection_Noversioned_CSTRUCT_H_
#define RedfishSimplestoragecollection_Noversioned_CSTRUCT_H_
...
//
// The SimpleStorageCollection schema contains a collection of simple storage
// instances.
//
