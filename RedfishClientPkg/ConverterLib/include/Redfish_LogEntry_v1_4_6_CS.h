...
#ifndef RedfishLogentry_V1_4_6_CSTRUCT_H_
#define RedfishLogentry_V1_4_6_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishLogEntry_V1_4_6_Actions_CS RedfishLogEntry_V1_4_6_Actions_CS;
typedef struct _RedfishLogEntry_V1_4_6_Links_CS RedfishLogEntry_V1_4_6_Links_CS;
typedef struct _RedfishLogEntry_V1_4_6_LogEntry_CS RedfishLogEntry_V1_4_6_LogEntry_CS;
typedef struct _RedfishLogEntry_V1_4_6_OemActions_CS RedfishLogEntry_V1_4_6_OemActions_CS;
...
//
typedef struct _RedfishLogEntry_V1_4_6_Actions_CS {
    RedfishLogEntry_V1_4_6_OemActions_CS    *Oem;    // The available OEM-specific
                                                    // actions for this resource.
} RedfishLogEntry_V1_4_6_Actions_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishLogEntry_V1_4_6_Links_CS {
    RedfishResource_Oem_CS     *Oem;                 // The OEM extension property.
    Redfishodatav4_idRef_CS    *OriginOfCondition;    // The link to the resource that
                                                     // caused the log entry.
} RedfishLogEntry_V1_4_6_Links_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishLogEntry_V1_4_6_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishLogEntry_V1_4_6_OemActions_CS;
...
//
typedef struct _RedfishLogEntry_V1_4_6_LogEntry_CS {
    RedfishCS_Header                     Header;
    RedfishCS_char                       *odata_context; 
    RedfishCS_char                       *odata_etag;    
    RedfishCS_char                       *odata_id;      
    RedfishCS_char                       *odata_type;    
    RedfishLogEntry_V1_4_6_Actions_CS    *Actions;           // The available actions for this
                                                             // resource.
    ...
    RedfishCS_char                       *EventType;         // The type of event recorded in
                                                             // this log.
    RedfishCS_char                       *Id;            
    RedfishLogEntry_V1_4_6_Links_CS      *Links;             // The links to other resources
...
} RedfishLogEntry_V1_4_6_LogEntry_CS;

RedfishCS_status
Json_LogEntry_V1_4_6_To_CS (char *JsonRawText, RedfishLogEntry_V1_4_6_LogEntry_CS **ReturnedCS);

RedfishCS_status
CS_To_LogEntry_V1_4_6_JSON (RedfishLogEntry_V1_4_6_LogEntry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyLogEntry_V1_4_6_CS (RedfishLogEntry_V1_4_6_LogEntry_CS *CSPtr);

RedfishCS_status
DestroyLogEntry_V1_4_6_Json (RedfishCS_char *JsonText);
