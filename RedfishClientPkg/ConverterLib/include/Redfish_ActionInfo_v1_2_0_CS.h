...
#ifndef RedfishActioninfo_V1_2_0_CSTRUCT_H_
#define RedfishActioninfo_V1_2_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishActionInfo_V1_2_0_Parameters_Array_CS RedfishActionInfo_V1_2_0_Parameters_Array_CS;
typedef struct _RedfishActionInfo_V1_2_0_ActionInfo_CS RedfishActionInfo_V1_2_0_ActionInfo_CS;
typedef struct _RedfishActionInfo_V1_2_0_Parameters_CS RedfishActionInfo_V1_2_0_Parameters_CS;
...
typedef struct _RedfishActionInfo_V1_2_0_Parameters_CS {
    RedfishCS_char_Array    *AllowableValues;    // The allowable values for this
                                                 ...
                                                 // action target.
    RedfishCS_int64         *ArraySizeMaximum;    // The maximum number of array
                                                 // elements allowed for this
                                                 // parameter.
    RedfishCS_int64         *ArraySizeMinimum;    // The minimum number of array
...
typedef struct _RedfishActionInfo_V1_2_0_ActionInfo_CS {
    ...
    RedfishActionInfo_V1_2_0_Parameters_Array_CS    *Parameters;      // The list of parameters
                                                                      // included in the specified
                                                                      // Redfish action.
} RedfishActionInfo_V1_2_0_ActionInfo_CS;

typedef struct _RedfishActionInfo_V1_2_0_Parameters_Array_CS  {
    RedfishActionInfo_V1_2_0_Parameters_Array_CS    *Next;
    RedfishActionInfo_V1_2_0_Parameters_CS    *ArrayValue;
} RedfishActionInfo_V1_2_0_Parameters_Array_CS;

RedfishCS_status
Json_ActionInfo_V1_2_0_To_CS (char *JsonRawText, RedfishActionInfo_V1_2_0_ActionInfo_CS **ReturnedCS);

RedfishCS_status
CS_To_ActionInfo_V1_2_0_JSON (RedfishActionInfo_V1_2_0_ActionInfo_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyActionInfo_V1_2_0_CS (RedfishActionInfo_V1_2_0_ActionInfo_CS *CSPtr);

RedfishCS_status
DestroyActionInfo_V1_2_0_Json (RedfishCS_char *JsonText);
