...
#ifndef RedfishSwitch_V1_3_1_CSTRUCT_H_
#define RedfishSwitch_V1_3_1_CSTRUCT_H_
...
typedef struct _RedfishSwitch_V1_3_1_Actions_CS RedfishSwitch_V1_3_1_Actions_CS;
typedef struct _RedfishSwitch_V1_3_1_Links_CS RedfishSwitch_V1_3_1_Links_CS;
typedef struct _RedfishSwitch_V1_3_1_OemActions_CS RedfishSwitch_V1_3_1_OemActions_CS;
typedef struct _RedfishSwitch_V1_3_1_Reset_CS RedfishSwitch_V1_3_1_Reset_CS;
typedef struct _RedfishSwitch_V1_3_1_Switch_CS RedfishSwitch_V1_3_1_Switch_CS;
...
//
typedef struct _RedfishSwitch_V1_3_1_Actions_CS {
    RedfishSwitch_V1_3_1_Reset_CS         *Switch_Reset;
    RedfishSwitch_V1_3_1_OemActions_CS    *Oem;            // The available OEM-specific
                                                           // actions for this resource.
} RedfishSwitch_V1_3_1_Actions_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishSwitch_V1_3_1_Links_CS {
    ...
    RedfishResource_Oem_CS    *Oem;                    // The OEM extension property.
} RedfishSwitch_V1_3_1_Links_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishSwitch_V1_3_1_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishSwitch_V1_3_1_OemActions_CS;

//
// This action resets this switch.
//
typedef struct _RedfishSwitch_V1_3_1_Reset_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishSwitch_V1_3_1_Reset_CS;
...
//
typedef struct _RedfishSwitch_V1_3_1_Switch_CS {
    RedfishCS_Header                   Header;
    RedfishCS_char                     *odata_context;       
    RedfishCS_char                     *odata_etag;          
    RedfishCS_char                     *odata_id;            
    RedfishCS_char                     *odata_type;          
    RedfishSwitch_V1_3_1_Actions_CS    *Actions;                 // The available actions for this
                                                                 // resource.
    ...
    RedfishCS_bool                     *IsManaged;               // An indication of whether the
                                                                 ...
                                                                 // unmanaged state.
    RedfishSwitch_V1_3_1_Links_CS      *Links;                   // The links to other resources
...
} RedfishSwitch_V1_3_1_Switch_CS;
...
RedfishCS_status
Json_Switch_V1_3_1_To_CS (char *JsonRawText, RedfishSwitch_V1_3_1_Switch_CS **ReturnedCS);

RedfishCS_status
CS_To_Switch_V1_3_1_JSON (RedfishSwitch_V1_3_1_Switch_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroySwitch_V1_3_1_CS (RedfishSwitch_V1_3_1_Switch_CS *CSPtr);

RedfishCS_status
DestroySwitch_V1_3_1_Json (RedfishCS_char *JsonText);
