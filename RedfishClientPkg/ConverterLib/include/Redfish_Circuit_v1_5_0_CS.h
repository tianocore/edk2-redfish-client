...
#ifndef RedfishCircuit_V1_5_0_CSTRUCT_H_
#define RedfishCircuit_V1_5_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishCircuit_V1_5_0_Actions_CS RedfishCircuit_V1_5_0_Actions_CS;
typedef struct _RedfishCircuit_V1_5_0_BreakerControl_CS RedfishCircuit_V1_5_0_BreakerControl_CS;
typedef struct _RedfishCircuit_V1_5_0_Circuit_CS RedfishCircuit_V1_5_0_Circuit_CS;
typedef struct _RedfishCircuit_V1_5_0_CurrentSensors_CS RedfishCircuit_V1_5_0_CurrentSensors_CS;
typedef struct _RedfishCircuit_V1_5_0_EnergySensors_CS RedfishCircuit_V1_5_0_EnergySensors_CS;
typedef struct _RedfishCircuit_V1_5_0_Links_CS RedfishCircuit_V1_5_0_Links_CS;
typedef struct _RedfishCircuit_V1_5_0_OemActions_CS RedfishCircuit_V1_5_0_OemActions_CS;
typedef struct _RedfishCircuit_V1_5_0_PowerControl_CS RedfishCircuit_V1_5_0_PowerControl_CS;
typedef struct _RedfishCircuit_V1_5_0_PowerSensors_CS RedfishCircuit_V1_5_0_PowerSensors_CS;
typedef struct _RedfishCircuit_V1_5_0_ResetMetrics_CS RedfishCircuit_V1_5_0_ResetMetrics_CS;
typedef struct _RedfishCircuit_V1_5_0_VoltageSensors_CS RedfishCircuit_V1_5_0_VoltageSensors_CS;
...
typedef struct _RedfishCircuit_V1_5_0_Actions_CS {
    ...
    RedfishCircuit_V1_5_0_OemActions_CS        *Oem;                      // The available OEM-specific
...
typedef struct _RedfishCircuit_V1_5_0_Circuit_CS {
    ...
    RedfishCircuit_V1_5_0_Actions_CS           *Actions;                      // The available actions for this
                                                                              // resource.
    RedfishCS_char                             *BreakerState;                 // The state of the over current
                                                                              // protection device.
    RedfishCS_char                             *CircuitType;                  // The type of circuit.
    RedfishCS_bool                             *ConfigurationLocked;          // Indicates whether the
    ...
    RedfishCS_char                             *IndicatorLED;                 // The state of the indicator
                                                                              ...
                                                                              // circuit.
    RedfishCircuit_V1_5_0_Links_CS             *Links;                        // The links to other resources
    ...
    RedfishCS_char                             *PlugType;                     // The type of plug according to
                                                                              ...
                                                                              // standards.
    RedfishCircuit_V1_5_0_CurrentSensors_CS    *PolyPhaseCurrentAmps;         // The current readings for this
                                                                              // circuit.
    RedfishCircuit_V1_5_0_EnergySensors_CS     *PolyPhaseEnergykWh;           // The energy readings for this
                                                                              // circuit.
    RedfishCircuit_V1_5_0_PowerSensors_CS      *PolyPhasePowerWatts;          // The power readings for this
                                                                              // circuit.
    RedfishCircuit_V1_5_0_VoltageSensors_CS    *PolyPhaseVoltage;             // The voltage readings for this
                                                                              // circuit.
    RedfishCS_bool                             *PowerControlLocked;           // Indicates whether power
                                                                              // control requests are locked.
    ...
    RedfishCS_char                             *PowerState;                   // The power state of the
                                                                              // circuit.
    RedfishCS_bool                             *PowerStateInTransition;       // Indicates whether the power
                                                                              // state is undergoing a delayed
                                                                              // transition.
    ...
    RedfishCS_Link                             UnbalancedCurrentPercent;      // The current imbalance
                                                                              // (percent) between phases.
    RedfishCS_Link                             UnbalancedVoltagePercent;      // The voltage imbalance
                                                                              // (percent) between phases.
...
RedfishCS_status
Json_Circuit_V1_5_0_To_CS (char *JsonRawText, RedfishCircuit_V1_5_0_Circuit_CS **ReturnedCS);

RedfishCS_status
CS_To_Circuit_V1_5_0_JSON (RedfishCircuit_V1_5_0_Circuit_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyCircuit_V1_5_0_CS (RedfishCircuit_V1_5_0_Circuit_CS *CSPtr);

RedfishCS_status
DestroyCircuit_V1_5_0_Json (RedfishCS_char *JsonText);
