...
#ifndef RedfishEventservice_V1_3_1_CSTRUCT_H_
#define RedfishEventservice_V1_3_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishEventService_V1_3_1_Actions_CS RedfishEventService_V1_3_1_Actions_CS;
typedef struct _RedfishEventService_V1_3_1_EventService_CS RedfishEventService_V1_3_1_EventService_CS;
typedef struct _RedfishEventService_V1_3_1_OemActions_CS RedfishEventService_V1_3_1_OemActions_CS;
typedef struct _RedfishEventService_V1_3_1_SSEFilterPropertiesSupported_CS RedfishEventService_V1_3_1_SSEFilterPropertiesSupported_CS;
typedef struct _RedfishEventService_V1_3_1_SubmitTestEvent_CS RedfishEventService_V1_3_1_SubmitTestEvent_CS;
...
typedef struct _RedfishEventService_V1_3_1_Actions_CS {
    ...
    RedfishEventService_V1_3_1_OemActions_CS         *Oem;                            // The available OEM-specific
...
typedef struct _RedfishEventService_V1_3_1_EventService_CS {
    ...
    RedfishEventService_V1_3_1_Actions_CS                         *Actions;                         // The available actions for this
                                                                                                    // Resource.
    ...
    RedfishEventService_V1_3_1_SSEFilterPropertiesSupported_CS    *SSEFilterPropertiesSupported;    // The set of properties that are
...
RedfishCS_status
Json_EventService_V1_3_1_To_CS (char *JsonRawText, RedfishEventService_V1_3_1_EventService_CS **ReturnedCS);

RedfishCS_status
CS_To_EventService_V1_3_1_JSON (RedfishEventService_V1_3_1_EventService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEventService_V1_3_1_CS (RedfishEventService_V1_3_1_EventService_CS *CSPtr);

RedfishCS_status
DestroyEventService_V1_3_1_Json (RedfishCS_char *JsonText);
