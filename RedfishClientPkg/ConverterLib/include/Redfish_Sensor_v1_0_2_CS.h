...
#ifndef RedfishSensor_V1_0_2_CSTRUCT_H_
#define RedfishSensor_V1_0_2_CSTRUCT_H_
...
typedef struct _RedfishSensor_V1_0_2_Actions_CS RedfishSensor_V1_0_2_Actions_CS;
typedef struct _RedfishSensor_V1_0_2_OemActions_CS RedfishSensor_V1_0_2_OemActions_CS;
typedef struct _RedfishSensor_V1_0_2_ResetStatistics_CS RedfishSensor_V1_0_2_ResetStatistics_CS;
typedef struct _RedfishSensor_V1_0_2_Sensor_CS RedfishSensor_V1_0_2_Sensor_CS;
typedef struct _RedfishSensor_V1_0_2_SensorExcerpt_CS RedfishSensor_V1_0_2_SensorExcerpt_CS;
typedef struct _RedfishSensor_V1_0_2_SensorPowerExcerpt_CS RedfishSensor_V1_0_2_SensorPowerExcerpt_CS;
typedef struct _RedfishSensor_V1_0_2_Threshold_CS RedfishSensor_V1_0_2_Threshold_CS;
typedef struct _RedfishSensor_V1_0_2_Thresholds_CS RedfishSensor_V1_0_2_Thresholds_CS;
...
typedef struct _RedfishSensor_V1_0_2_Actions_CS {
    ...
    RedfishSensor_V1_0_2_OemActions_CS         *Oem;                      // The available OEM-specific
...
typedef struct _RedfishSensor_V1_0_2_Thresholds_CS {
    RedfishSensor_V1_0_2_Threshold_CS    *LowerCaution;    // The value at which the reading
                                                           // is below normal range.
    RedfishSensor_V1_0_2_Threshold_CS    *LowerCritical;    // The value at which the reading
                                                           // is below normal range but not
                                                           // yet fatal.
    RedfishSensor_V1_0_2_Threshold_CS    *LowerFatal;      // The value at which the reading
                                                           // is below normal range and
                                                           // fatal.
    RedfishSensor_V1_0_2_Threshold_CS    *UpperCaution;    // The value at which the reading
                                                           // is above normal range.
    RedfishSensor_V1_0_2_Threshold_CS    *UpperCritical;    // The value at which the reading
                                                           // is above normal range but not
                                                           // yet fatal.
    RedfishSensor_V1_0_2_Threshold_CS    *UpperFatal;      // The value at which the reading
...
typedef struct _RedfishSensor_V1_0_2_Sensor_CS {
    ...
    RedfishSensor_V1_0_2_Actions_CS       *Actions;                              // The available actions for this
                                                                                 // Resource.
    ...
    RedfishResource_Status_CS             *Status;                               // The status and health of the
                                                                                 // Resource and its subordinate
                                                                                 // or dependent Resources.
    RedfishSensor_V1_0_2_Thresholds_CS    *Thresholds;                           // The set of thresholds defined
                                                                                 // for this sensor.
...
RedfishCS_status
Json_Sensor_V1_0_2_To_CS (char *JsonRawText, RedfishSensor_V1_0_2_Sensor_CS **ReturnedCS);

RedfishCS_status
CS_To_Sensor_V1_0_2_JSON (RedfishSensor_V1_0_2_Sensor_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroySensor_V1_0_2_CS (RedfishSensor_V1_0_2_Sensor_CS *CSPtr);

RedfishCS_status
DestroySensor_V1_0_2_Json (RedfishCS_char *JsonText);
