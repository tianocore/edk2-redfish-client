...
#ifndef RedfishResourceblock_V1_2_2_CSTRUCT_H_
#define RedfishResourceblock_V1_2_2_CSTRUCT_H_
...
typedef struct _RedfishResourceBlock_V1_2_2_Actions_CS RedfishResourceBlock_V1_2_2_Actions_CS;
typedef struct _RedfishResourceBlock_V1_2_2_CompositionStatus_CS RedfishResourceBlock_V1_2_2_CompositionStatus_CS;
typedef struct _RedfishResourceBlock_V1_2_2_Links_CS RedfishResourceBlock_V1_2_2_Links_CS;
typedef struct _RedfishResourceBlock_V1_2_2_OemActions_CS RedfishResourceBlock_V1_2_2_OemActions_CS;
typedef struct _RedfishResourceBlock_V1_2_2_ResourceBlock_CS RedfishResourceBlock_V1_2_2_ResourceBlock_CS;
...
//
typedef struct _RedfishResourceBlock_V1_2_2_Actions_CS {
    RedfishResourceBlock_V1_2_2_OemActions_CS    *Oem;    // This property contains the
                                                         // available OEM specific actions
                                                         // for this resource.
} RedfishResourceBlock_V1_2_2_Actions_CS;

//
// Composition status of the Resource Block.
//
typedef struct _RedfishResourceBlock_V1_2_2_CompositionStatus_CS {
    ...
    RedfishCS_bool     *SharingEnabled;         // Indicates if this Resource
                                                ...
                                                // compositions simultaneously.
} RedfishResourceBlock_V1_2_2_CompositionStatus_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishResourceBlock_V1_2_2_Links_CS {
...
} RedfishResourceBlock_V1_2_2_Links_CS;

//
// The available OEM specific actions for this resource.
//
typedef struct _RedfishResourceBlock_V1_2_2_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishResourceBlock_V1_2_2_OemActions_CS;
...
//
typedef struct _RedfishResourceBlock_V1_2_2_ResourceBlock_CS {
    RedfishCS_Header                                    Header;
    RedfishCS_char                                      *odata_context;               
    RedfishCS_char                                      *odata_etag;                  
    RedfishCS_char                                      *odata_id;                    
    RedfishCS_char                                      *odata_type;                  
    RedfishResourceBlock_V1_2_2_Actions_CS              *Actions;                         // The available actions for this
                                                                                          // resource.
    RedfishResourceBlock_V1_2_2_CompositionStatus_CS    *CompositionStatus;               // This property describes the
    ...
    RedfishCS_char                                      *Id;                          
    RedfishResourceBlock_V1_2_2_Links_CS                *Links;                           // Contains references to other
...
} RedfishResourceBlock_V1_2_2_ResourceBlock_CS;
...
RedfishCS_status
Json_ResourceBlock_V1_2_2_To_CS (char *JsonRawText, RedfishResourceBlock_V1_2_2_ResourceBlock_CS **ReturnedCS);

RedfishCS_status
CS_To_ResourceBlock_V1_2_2_JSON (RedfishResourceBlock_V1_2_2_ResourceBlock_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyResourceBlock_V1_2_2_CS (RedfishResourceBlock_V1_2_2_ResourceBlock_CS *CSPtr);

RedfishCS_status
DestroyResourceBlock_V1_2_2_Json (RedfishCS_char *JsonText);
