...
#ifndef RedfishBios_V1_0_6_CSTRUCT_H_
#define RedfishBios_V1_0_6_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishBios_V1_0_6_Actions_CS RedfishBios_V1_0_6_Actions_CS;
typedef struct _RedfishBios_V1_0_6_Attributes_CS RedfishBios_V1_0_6_Attributes_CS;
typedef struct _RedfishBios_V1_0_6_Bios_CS RedfishBios_V1_0_6_Bios_CS;
typedef struct _RedfishBios_V1_0_6_ChangePassword_CS RedfishBios_V1_0_6_ChangePassword_CS;
typedef struct _RedfishBios_V1_0_6_OemActions_CS RedfishBios_V1_0_6_OemActions_CS;
typedef struct _RedfishBios_V1_0_6_ResetBios_CS RedfishBios_V1_0_6_ResetBios_CS;
...
typedef struct _RedfishBios_V1_0_6_Actions_CS {
    ...
    RedfishBios_V1_0_6_OemActions_CS        *Oem;                   // This property contains the
...
typedef struct _RedfishBios_V1_0_6_Bios_CS {
    ...
    RedfishBios_V1_0_6_Actions_CS       *Actions;             // The available actions for this
                                                              // resource.
    RedfishCS_char                      *AttributeRegistry;    // The Resource ID of the
                                                              ...
                                                              // resource.
    RedfishBios_V1_0_6_Attributes_CS    *Attributes;          // The list of BIOS attributes
...
RedfishCS_status
Json_Bios_V1_0_6_To_CS (char *JsonRawText, RedfishBios_V1_0_6_Bios_CS **ReturnedCS);

RedfishCS_status
CS_To_Bios_V1_0_6_JSON (RedfishBios_V1_0_6_Bios_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyBios_V1_0_6_CS (RedfishBios_V1_0_6_Bios_CS *CSPtr);

RedfishCS_status
DestroyBios_V1_0_6_Json (RedfishCS_char *JsonText);
