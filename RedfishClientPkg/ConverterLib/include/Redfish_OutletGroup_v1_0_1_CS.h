...
#ifndef RedfishOutletgroup_V1_0_1_CSTRUCT_H_
#define RedfishOutletgroup_V1_0_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishOutletGroup_V1_0_1_Actions_CS RedfishOutletGroup_V1_0_1_Actions_CS;
typedef struct _RedfishOutletGroup_V1_0_1_Links_CS RedfishOutletGroup_V1_0_1_Links_CS;
typedef struct _RedfishOutletGroup_V1_0_1_OemActions_CS RedfishOutletGroup_V1_0_1_OemActions_CS;
typedef struct _RedfishOutletGroup_V1_0_1_OutletGroup_CS RedfishOutletGroup_V1_0_1_OutletGroup_CS;
typedef struct _RedfishOutletGroup_V1_0_1_PowerControl_CS RedfishOutletGroup_V1_0_1_PowerControl_CS;
typedef struct _RedfishOutletGroup_V1_0_1_ResetMetrics_CS RedfishOutletGroup_V1_0_1_ResetMetrics_CS;
...
typedef struct _RedfishOutletGroup_V1_0_1_Actions_CS {
    ...
    RedfishOutletGroup_V1_0_1_OemActions_CS      *Oem;                        // The available OEM-specific
...
typedef struct _RedfishOutletGroup_V1_0_1_OutletGroup_CS {
    ...
    RedfishOutletGroup_V1_0_1_Actions_CS    *Actions;                    // The available actions for this
                                                                         // resource.
    ...
    RedfishCS_Link                          EnergykWh;                   // The energy reading for this
                                                                         // outlet group.
    RedfishCS_char                          *Id;                     
    RedfishOutletGroup_V1_0_1_Links_CS      *Links;                      // The links to other resources
...
RedfishCS_status
Json_OutletGroup_V1_0_1_To_CS (char *JsonRawText, RedfishOutletGroup_V1_0_1_OutletGroup_CS **ReturnedCS);

RedfishCS_status
CS_To_OutletGroup_V1_0_1_JSON (RedfishOutletGroup_V1_0_1_OutletGroup_CS *CSPtr, char **JsonText);
