...
#ifndef RedfishPower_V1_1_7_CSTRUCT_H_
#define RedfishPower_V1_1_7_CSTRUCT_H_
...
#endif
typedef struct _RedfishPower_V1_1_7_InputRange_Array_CS RedfishPower_V1_1_7_InputRange_Array_CS;
typedef struct _RedfishPower_V1_1_7_PowerControl_Array_CS RedfishPower_V1_1_7_PowerControl_Array_CS;
typedef struct _RedfishPower_V1_1_7_PowerSupply_Array_CS RedfishPower_V1_1_7_PowerSupply_Array_CS;
typedef struct _RedfishPower_V1_1_7_Voltage_Array_CS RedfishPower_V1_1_7_Voltage_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishPower_V1_1_7_InputRange_CS RedfishPower_V1_1_7_InputRange_CS;
typedef struct _RedfishPower_V1_1_7_Power_CS RedfishPower_V1_1_7_Power_CS;
typedef struct _RedfishPower_V1_1_7_PowerControl_CS RedfishPower_V1_1_7_PowerControl_CS;
typedef struct _RedfishPower_V1_1_7_PowerLimit_CS RedfishPower_V1_1_7_PowerLimit_CS;
typedef struct _RedfishPower_V1_1_7_PowerMetric_CS RedfishPower_V1_1_7_PowerMetric_CS;
typedef struct _RedfishPower_V1_1_7_PowerSupply_CS RedfishPower_V1_1_7_PowerSupply_CS;
typedef struct _RedfishPower_V1_1_7_Voltage_CS RedfishPower_V1_1_7_Voltage_CS;
...
//
typedef struct _RedfishPower_V1_1_7_InputRange_CS {
    ...
    RedfishCS_int64           *OutputWattage;        // The maximum capacity of this
                                                     ...
                                                     // this input range.
} RedfishPower_V1_1_7_InputRange_CS;

typedef struct _RedfishPower_V1_1_7_PowerControl_CS {
    ...
    RedfishPower_V1_1_7_PowerLimit_CS     *PowerLimit;               // Power limit status and
                                                                     // configuration information for
                                                                     // this chassis.
    RedfishPower_V1_1_7_PowerMetric_CS    *PowerMetrics;             // Power readings for this
                                                                     // chassis.
...
} RedfishPower_V1_1_7_PowerControl_CS;

//
// This object contains power limit status and configuration information for the
// chassis.
//
typedef struct _RedfishPower_V1_1_7_PowerLimit_CS {
    ...
    RedfishCS_int64    *LimitInWatts;     // The Power limit in watts. Set
                                          ...
                                          // capping.
} RedfishPower_V1_1_7_PowerLimit_CS;

//
// This type describe the power metrics for a resource.
//
typedef struct _RedfishPower_V1_1_7_PowerMetric_CS {
    ...
    RedfishCS_int64    *MinConsumedWatts;       // The lowest power consumption
                                                ...
                                                // minutes).
} RedfishPower_V1_1_7_PowerMetric_CS;

//
// Details of a power supplies associated with this system or device.
//
typedef struct _RedfishPower_V1_1_7_PowerSupply_CS {
    RedfishCS_char                             *odata_id;             
    RedfishCS_char                             *FirmwareVersion;          // The firmware version for this
                                                                          // Power Supply.
    RedfishPower_V1_1_7_InputRange_Array_CS    *InputRanges;              // This is the input ranges that
    ...
    RedfishResource_Status_CS                  *Status;                   // This property describes the
                                                                          // status and health of the
                                                                          // resource and its children.
} RedfishPower_V1_1_7_PowerSupply_CS;

typedef struct _RedfishPower_V1_1_7_Voltage_CS {
    RedfishCS_char                   *odata_id;                
...
} RedfishPower_V1_1_7_Voltage_CS;
...
//
typedef struct _RedfishPower_V1_1_7_Power_CS {
    ...
    RedfishResource_Oem_CS                       *Oem;                        // This is the
                                                                              ...
                                                                              // divide the Oem object into
                                                                              // sections.
    RedfishPower_V1_1_7_PowerControl_Array_CS    *PowerControl;               // This is the definition for
                                                                              // power control function (power
                                                                              // reading/limiting).
    RedfishCS_int64                              *PowerControlodata_count;
    RedfishPower_V1_1_7_PowerSupply_Array_CS     *PowerSupplies;              // Details of the power supplies
    ...
    RedfishCS_Link                               Redundancy;                  // Redundancy information for the
                                                                              ...
                                                                              // or device.
    RedfishCS_int64                              *Redundancyodata_count;  
    RedfishPower_V1_1_7_Voltage_Array_CS         *Voltages;                   // This is the definition for
                                                                              // voltage sensors.
    RedfishCS_int64                              *Voltagesodata_count;    
} RedfishPower_V1_1_7_Power_CS;
...
typedef struct _RedfishPower_V1_1_7_InputRange_Array_CS  {
    RedfishPower_V1_1_7_InputRange_Array_CS    *Next;
    RedfishPower_V1_1_7_InputRange_CS    *ArrayValue;
} RedfishPower_V1_1_7_InputRange_Array_CS;

typedef struct _RedfishPower_V1_1_7_PowerControl_Array_CS  {
    RedfishPower_V1_1_7_PowerControl_Array_CS    *Next;
    RedfishPower_V1_1_7_PowerControl_CS    *ArrayValue;
} RedfishPower_V1_1_7_PowerControl_Array_CS;

typedef struct _RedfishPower_V1_1_7_PowerSupply_Array_CS  {
    RedfishPower_V1_1_7_PowerSupply_Array_CS    *Next;
    RedfishPower_V1_1_7_PowerSupply_CS    *ArrayValue;
} RedfishPower_V1_1_7_PowerSupply_Array_CS;

typedef struct _RedfishPower_V1_1_7_Voltage_Array_CS  {
    RedfishPower_V1_1_7_Voltage_Array_CS    *Next;
    RedfishPower_V1_1_7_Voltage_CS    *ArrayValue;
} RedfishPower_V1_1_7_Voltage_Array_CS;
...
RedfishCS_status
Json_Power_V1_1_7_To_CS (char *JsonRawText, RedfishPower_V1_1_7_Power_CS **ReturnedCS);

RedfishCS_status
CS_To_Power_V1_1_7_JSON (RedfishPower_V1_1_7_Power_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPower_V1_1_7_CS (RedfishPower_V1_1_7_Power_CS *CSPtr);

RedfishCS_status
DestroyPower_V1_1_7_Json (RedfishCS_char *JsonText);
