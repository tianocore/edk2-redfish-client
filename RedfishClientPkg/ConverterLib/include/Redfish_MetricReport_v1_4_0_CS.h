...
#ifndef RedfishMetricreport_V1_4_0_CSTRUCT_H_
#define RedfishMetricreport_V1_4_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMetricReport_V1_4_0_MetricValue_Array_CS RedfishMetricReport_V1_4_0_MetricValue_Array_CS;
typedef struct _RedfishMetricReport_V1_4_0_Actions_CS RedfishMetricReport_V1_4_0_Actions_CS;
typedef struct _RedfishMetricReport_V1_4_0_MetricReport_CS RedfishMetricReport_V1_4_0_MetricReport_CS;
typedef struct _RedfishMetricReport_V1_4_0_MetricValue_CS RedfishMetricReport_V1_4_0_MetricValue_CS;
typedef struct _RedfishMetricReport_V1_4_0_OemActions_CS RedfishMetricReport_V1_4_0_OemActions_CS;
...
typedef struct _RedfishMetricReport_V1_4_0_Actions_CS {
    RedfishMetricReport_V1_4_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishMetricReport_V1_4_0_MetricReport_CS {
    ...
    RedfishMetricReport_V1_4_0_Actions_CS              *Actions;                 // The available actions for this
                                                                                 // resource.
    ...
    RedfishCS_Link                                     MetricReportDefinition;    // The link to the definition of
                                                                                 // this metric report.
    RedfishMetricReport_V1_4_0_MetricValue_Array_CS    *MetricValues;            // An array of metric values for
...
typedef struct _RedfishMetricReport_V1_4_0_MetricValue_Array_CS  {
    RedfishMetricReport_V1_4_0_MetricValue_Array_CS    *Next;
    RedfishMetricReport_V1_4_0_MetricValue_CS    *ArrayValue;
} RedfishMetricReport_V1_4_0_MetricValue_Array_CS;

RedfishCS_status
Json_MetricReport_V1_4_0_To_CS (char *JsonRawText, RedfishMetricReport_V1_4_0_MetricReport_CS **ReturnedCS);

RedfishCS_status
CS_To_MetricReport_V1_4_0_JSON (RedfishMetricReport_V1_4_0_MetricReport_CS *CSPtr, char **JsonText);
