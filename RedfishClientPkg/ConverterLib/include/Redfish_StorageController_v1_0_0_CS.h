...
#ifndef RedfishStoragecontroller_V1_0_0_CSTRUCT_H_
#define RedfishStoragecontroller_V1_0_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishStorageController_V1_0_0_ANACharacteristics_Array_CS RedfishStorageController_V1_0_0_ANACharacteristics_Array_CS;
...
typedef struct _RedfishStorageController_V1_0_0_ANACharacteristics_CS RedfishStorageController_V1_0_0_ANACharacteristics_CS;
typedef struct _RedfishStorageController_V1_0_0_Actions_CS RedfishStorageController_V1_0_0_Actions_CS;
typedef struct _RedfishStorageController_V1_0_0_CacheSummary_CS RedfishStorageController_V1_0_0_CacheSummary_CS;
typedef struct _RedfishStorageController_V1_0_0_Links_CS RedfishStorageController_V1_0_0_Links_CS;
typedef struct _RedfishStorageController_V1_0_0_NVMeControllerAttributes_CS RedfishStorageController_V1_0_0_NVMeControllerAttributes_CS;
typedef struct _RedfishStorageController_V1_0_0_NVMeControllerProperties_CS RedfishStorageController_V1_0_0_NVMeControllerProperties_CS;
typedef struct _RedfishStorageController_V1_0_0_NVMeSMARTCriticalWarnings_CS RedfishStorageController_V1_0_0_NVMeSMARTCriticalWarnings_CS;
typedef struct _RedfishStorageController_V1_0_0_OemActions_CS RedfishStorageController_V1_0_0_OemActions_CS;
typedef struct _RedfishStorageController_V1_0_0_Rates_CS RedfishStorageController_V1_0_0_Rates_CS;
typedef struct _RedfishStorageController_V1_0_0_StorageController_CS RedfishStorageController_V1_0_0_StorageController_CS;
...
typedef struct _RedfishStorageController_V1_0_0_Actions_CS {
    RedfishStorageController_V1_0_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishStorageController_V1_0_0_NVMeControllerProperties_CS {
    RedfishStorageController_V1_0_0_ANACharacteristics_Array_CS     *ANACharacteristics;          // The ANA characteristics and
                                                                                                  // volume information.
    ...
    RedfishCS_int64                                                 *MaxQueueSize;                // The maximum individual queue
                                                                                                  ...
                                                                                                  // controller supports.
    RedfishStorageController_V1_0_0_NVMeControllerAttributes_CS     *NVMeControllerAttributes;    // The NVMe controller
                                                                                                  // attributes.
    RedfishStorageController_V1_0_0_NVMeSMARTCriticalWarnings_CS    *NVMeSMARTCriticalWarnings;    // The NVMe SMART Critical
...
typedef struct _RedfishStorageController_V1_0_0_StorageController_CS {
    ...
    RedfishStorageController_V1_0_0_Actions_CS                     *Actions;                        // The available actions for this
                                                                                                    // resource.
    ...
    RedfishStorageController_V1_0_0_CacheSummary_CS                *CacheSummary;                   // The cache memory of the
                                                                                                    // storage controller in general
                                                                                                    // detail.
    RedfishStorageController_V1_0_0_Rates_CS                       *ControllerRates;                // This property describes the
    ...
    RedfishCS_Link                                                 Identifiers;                     // The durable names for the
                                                                                                    // storage controller.
    RedfishStorageController_V1_0_0_Links_CS                       *Links;                          // The links to other resources
    ...
    RedfishCS_char                                                 *Model;                          // The model number for the
                                                                                                    // storage controller.
    RedfishStorageController_V1_0_0_NVMeControllerProperties_CS    *NVMeControllerProperties;       // The NVMe related properties
                                                                                                    // for this storage controller.
    RedfishCS_char                                                 *Name;                       
    RedfishResource_Oem_CS                                         *Oem;                            // The OEM extension property.
...
typedef struct _RedfishStorageController_V1_0_0_ANACharacteristics_Array_CS  {
    RedfishStorageController_V1_0_0_ANACharacteristics_Array_CS    *Next;
...
RedfishCS_status
Json_StorageController_V1_0_0_To_CS (char *JsonRawText, RedfishStorageController_V1_0_0_StorageController_CS **ReturnedCS);

RedfishCS_status
CS_To_StorageController_V1_0_0_JSON (RedfishStorageController_V1_0_0_StorageController_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyStorageController_V1_0_0_CS (RedfishStorageController_V1_0_0_StorageController_CS *CSPtr);

RedfishCS_status
DestroyStorageController_V1_0_0_Json (RedfishCS_char *JsonText);
