...
#ifndef RedfishMessageregistry_V1_2_4_CSTRUCT_H_
#define RedfishMessageregistry_V1_2_4_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMessageRegistry_V1_2_4_Actions_CS RedfishMessageRegistry_V1_2_4_Actions_CS;
typedef struct _RedfishMessageRegistry_V1_2_4_ClearingLogic_CS RedfishMessageRegistry_V1_2_4_ClearingLogic_CS;
typedef struct _RedfishMessageRegistry_V1_2_4_Message_CS RedfishMessageRegistry_V1_2_4_Message_CS;
typedef struct _RedfishMessageRegistry_V1_2_4_MessageProperty_CS RedfishMessageRegistry_V1_2_4_MessageProperty_CS;
typedef struct _RedfishMessageRegistry_V1_2_4_MessageRegistry_CS RedfishMessageRegistry_V1_2_4_MessageRegistry_CS;
typedef struct _RedfishMessageRegistry_V1_2_4_OemActions_CS RedfishMessageRegistry_V1_2_4_OemActions_CS;
...
typedef struct _RedfishMessageRegistry_V1_2_4_Actions_CS {
    RedfishMessageRegistry_V1_2_4_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishMessageRegistry_V1_2_4_Message_CS {
    RedfishMessageRegistry_V1_2_4_ClearingLogic_CS    *ClearingLogic;    // The clearing logic associated
...
typedef struct _RedfishMessageRegistry_V1_2_4_MessageRegistry_CS {
    ...
    RedfishMessageRegistry_V1_2_4_Actions_CS            *Actions;           // The available actions for this
                                                                            // resource.
    ...
    RedfishCS_char                                      *Language;          // The RFC5646-conformant
                                                                            ...
                                                                            // registry.
    RedfishMessageRegistry_V1_2_4_MessageProperty_CS    *Messages;          // The message keys contained in
...
RedfishCS_status
Json_MessageRegistry_V1_2_4_To_CS (char *JsonRawText, RedfishMessageRegistry_V1_2_4_MessageRegistry_CS **ReturnedCS);

RedfishCS_status
CS_To_MessageRegistry_V1_2_4_JSON (RedfishMessageRegistry_V1_2_4_MessageRegistry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMessageRegistry_V1_2_4_CS (RedfishMessageRegistry_V1_2_4_MessageRegistry_CS *CSPtr);

RedfishCS_status
DestroyMessageRegistry_V1_2_4_Json (RedfishCS_char *JsonText);
