...
#ifndef RedfishEthernetinterface_V1_1_7_CSTRUCT_H_
#define RedfishEthernetinterface_V1_1_7_CSTRUCT_H_
...
#endif
typedef struct _RedfishEthernetInterface_V1_1_7_IPv6AddressPolicyEntry_Array_CS RedfishEthernetInterface_V1_1_7_IPv6AddressPolicyEntry_Array_CS;
typedef struct _RedfishEthernetInterface_V1_1_7_EthernetInterface_CS RedfishEthernetInterface_V1_1_7_EthernetInterface_CS;
typedef struct _RedfishEthernetInterface_V1_1_7_IPv6AddressPolicyEntry_CS RedfishEthernetInterface_V1_1_7_IPv6AddressPolicyEntry_CS;
typedef struct _RedfishEthernetInterface_V1_1_7_Links_CS RedfishEthernetInterface_V1_1_7_Links_CS;
...
//
typedef struct _RedfishEthernetInterface_V1_1_7_IPv6AddressPolicyEntry_CS {
    ...
    RedfishCS_char     *Prefix;       // The IPv6 address prefix, as
                                      // defined in RFC6724, section
                                      // 2.1.
} RedfishEthernetInterface_V1_1_7_IPv6AddressPolicyEntry_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishEthernetInterface_V1_1_7_Links_CS {
    RedfishCS_Link            Endpoints;               // An array of links to the
                                                       // endpoints that connect to this
                                                       // Ethernet interface.
    RedfishCS_int64           *Endpointsodata_count;
    RedfishResource_Oem_CS    *Oem;                    // The OEM extension property.
} RedfishEthernetInterface_V1_1_7_Links_CS;
...
//
typedef struct _RedfishEthernetInterface_V1_1_7_EthernetInterface_CS {
    ...
    RedfishEthernetInterface_V1_1_7_IPv6AddressPolicyEntry_Array_CS    *IPv6AddressPolicyTable;    // An array that represents the
    ...
    RedfishCS_char                                                     *LinkStatus;               // The link status of this
                                                                                                  // interface, or port.
    RedfishEthernetInterface_V1_1_7_Links_CS                           *Links;                    // The links to other resources
...
} RedfishEthernetInterface_V1_1_7_EthernetInterface_CS;
...
typedef struct _RedfishEthernetInterface_V1_1_7_IPv6AddressPolicyEntry_Array_CS  {
    RedfishEthernetInterface_V1_1_7_IPv6AddressPolicyEntry_Array_CS    *Next;
    RedfishEthernetInterface_V1_1_7_IPv6AddressPolicyEntry_CS    *ArrayValue;
} RedfishEthernetInterface_V1_1_7_IPv6AddressPolicyEntry_Array_CS;

RedfishCS_status
Json_EthernetInterface_V1_1_7_To_CS (char *JsonRawText, RedfishEthernetInterface_V1_1_7_EthernetInterface_CS **ReturnedCS);

RedfishCS_status
CS_To_EthernetInterface_V1_1_7_JSON (RedfishEthernetInterface_V1_1_7_EthernetInterface_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEthernetInterface_V1_1_7_CS (RedfishEthernetInterface_V1_1_7_EthernetInterface_CS *CSPtr);

RedfishCS_status
DestroyEthernetInterface_V1_1_7_Json (RedfishCS_char *JsonText);
