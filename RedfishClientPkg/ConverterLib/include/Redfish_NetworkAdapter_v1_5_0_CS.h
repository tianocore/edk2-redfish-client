...
#ifndef RedfishNetworkadapter_V1_5_0_CSTRUCT_H_
#define RedfishNetworkadapter_V1_5_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishNetworkAdapter_V1_5_0_Controllers_Array_CS RedfishNetworkAdapter_V1_5_0_Controllers_Array_CS;
typedef struct _RedfishNetworkAdapter_V1_5_0_Actions_CS RedfishNetworkAdapter_V1_5_0_Actions_CS;
typedef struct _RedfishNetworkAdapter_V1_5_0_ControllerCapabilities_CS RedfishNetworkAdapter_V1_5_0_ControllerCapabilities_CS;
typedef struct _RedfishNetworkAdapter_V1_5_0_ControllerLinks_CS RedfishNetworkAdapter_V1_5_0_ControllerLinks_CS;
typedef struct _RedfishNetworkAdapter_V1_5_0_Controllers_CS RedfishNetworkAdapter_V1_5_0_Controllers_CS;
typedef struct _RedfishNetworkAdapter_V1_5_0_DataCenterBridging_CS RedfishNetworkAdapter_V1_5_0_DataCenterBridging_CS;
typedef struct _RedfishNetworkAdapter_V1_5_0_NPIV_CS RedfishNetworkAdapter_V1_5_0_NPIV_CS;
typedef struct _RedfishNetworkAdapter_V1_5_0_NetworkAdapter_CS RedfishNetworkAdapter_V1_5_0_NetworkAdapter_CS;
typedef struct _RedfishNetworkAdapter_V1_5_0_NicPartitioning_CS RedfishNetworkAdapter_V1_5_0_NicPartitioning_CS;
typedef struct _RedfishNetworkAdapter_V1_5_0_OemActions_CS RedfishNetworkAdapter_V1_5_0_OemActions_CS;
typedef struct _RedfishNetworkAdapter_V1_5_0_ResetSettingsToDefault_CS RedfishNetworkAdapter_V1_5_0_ResetSettingsToDefault_CS;
typedef struct _RedfishNetworkAdapter_V1_5_0_SRIOV_CS RedfishNetworkAdapter_V1_5_0_SRIOV_CS;
typedef struct _RedfishNetworkAdapter_V1_5_0_VirtualFunction_CS RedfishNetworkAdapter_V1_5_0_VirtualFunction_CS;
typedef struct _RedfishNetworkAdapter_V1_5_0_VirtualizationOffload_CS RedfishNetworkAdapter_V1_5_0_VirtualizationOffload_CS;
...
typedef struct _RedfishNetworkAdapter_V1_5_0_Actions_CS {
    ...
    RedfishNetworkAdapter_V1_5_0_OemActions_CS                *Oem;                                     // The available OEM-specific
...
typedef struct _RedfishNetworkAdapter_V1_5_0_ControllerCapabilities_CS {
    RedfishNetworkAdapter_V1_5_0_DataCenterBridging_CS       *DataCenterBridging;           // Data center bridging (DCB) for
                                                                                            // this controller.
    RedfishNetworkAdapter_V1_5_0_NicPartitioning_CS          *NPAR;                         // NIC Partitioning (NPAR)
                                                                                            // capabilities for this
                                                                                            // controller.
    RedfishNetworkAdapter_V1_5_0_NPIV_CS                     *NPIV;                         // N_Port ID Virtualization
    ...
    RedfishCS_int64                                          *NetworkPortCount;             // The number of physical ports
                                                                                            // on this controller.
    RedfishNetworkAdapter_V1_5_0_VirtualizationOffload_CS    *VirtualizationOffload;        // Virtualization offload for
                                                                                            // this controller.
...
typedef struct _RedfishNetworkAdapter_V1_5_0_Controllers_CS {
    RedfishNetworkAdapter_V1_5_0_ControllerCapabilities_CS    *ControllerCapabilities;    // The capabilities of this
                                                                                         // controller.
    ...
    RedfishNetworkAdapter_V1_5_0_ControllerLinks_CS           *Links;                    // The links to other resources
...
typedef struct _RedfishNetworkAdapter_V1_5_0_VirtualizationOffload_CS {
    RedfishNetworkAdapter_V1_5_0_SRIOV_CS              *SRIOV;             // Single-root input/output
                                                                           // virtualization (SR-IOV)
                                                                           // capabilities.
    RedfishNetworkAdapter_V1_5_0_VirtualFunction_CS    *VirtualFunction;    // The virtual function of the
                                                                           // controller.
...
typedef struct _RedfishNetworkAdapter_V1_5_0_NetworkAdapter_CS {
    ...
    RedfishNetworkAdapter_V1_5_0_Actions_CS              *Actions;                 // The available actions for this
                                                                                   // resource.
    RedfishCS_Link                                       Assembly;                 // The link to the assembly
                                                                                   // resource associated with this
                                                                                   // adapter.
    RedfishNetworkAdapter_V1_5_0_Controllers_Array_CS    *Controllers;             // The set of network controllers
...
typedef struct _RedfishNetworkAdapter_V1_5_0_Controllers_Array_CS  {
    RedfishNetworkAdapter_V1_5_0_Controllers_Array_CS    *Next;
    RedfishNetworkAdapter_V1_5_0_Controllers_CS    *ArrayValue;
} RedfishNetworkAdapter_V1_5_0_Controllers_Array_CS;

RedfishCS_status
Json_NetworkAdapter_V1_5_0_To_CS (char *JsonRawText, RedfishNetworkAdapter_V1_5_0_NetworkAdapter_CS **ReturnedCS);

RedfishCS_status
CS_To_NetworkAdapter_V1_5_0_JSON (RedfishNetworkAdapter_V1_5_0_NetworkAdapter_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyNetworkAdapter_V1_5_0_CS (RedfishNetworkAdapter_V1_5_0_NetworkAdapter_CS *CSPtr);

RedfishCS_status
DestroyNetworkAdapter_V1_5_0_Json (RedfishCS_char *JsonText);
