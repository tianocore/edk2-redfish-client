...
#ifndef RedfishEventservice_V1_4_2_CSTRUCT_H_
#define RedfishEventservice_V1_4_2_CSTRUCT_H_
...
#endif
typedef struct _RedfishEventService_V1_4_2_Actions_CS RedfishEventService_V1_4_2_Actions_CS;
typedef struct _RedfishEventService_V1_4_2_EventService_CS RedfishEventService_V1_4_2_EventService_CS;
typedef struct _RedfishEventService_V1_4_2_OemActions_CS RedfishEventService_V1_4_2_OemActions_CS;
typedef struct _RedfishEventService_V1_4_2_SSEFilterPropertiesSupported_CS RedfishEventService_V1_4_2_SSEFilterPropertiesSupported_CS;
typedef struct _RedfishEventService_V1_4_2_SubmitTestEvent_CS RedfishEventService_V1_4_2_SubmitTestEvent_CS;
...
typedef struct _RedfishEventService_V1_4_2_Actions_CS {
    ...
    RedfishEventService_V1_4_2_OemActions_CS         *Oem;                            // The available OEM-specific
...
typedef struct _RedfishEventService_V1_4_2_EventService_CS {
    ...
    RedfishEventService_V1_4_2_Actions_CS                         *Actions;                         // The available actions for this
                                                                                                    // resource.
    ...
    RedfishEventService_V1_4_2_SSEFilterPropertiesSupported_CS    *SSEFilterPropertiesSupported;    // The set of properties that are
...
RedfishCS_status
Json_EventService_V1_4_2_To_CS (char *JsonRawText, RedfishEventService_V1_4_2_EventService_CS **ReturnedCS);

RedfishCS_status
CS_To_EventService_V1_4_2_JSON (RedfishEventService_V1_4_2_EventService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEventService_V1_4_2_CS (RedfishEventService_V1_4_2_EventService_CS *CSPtr);

RedfishCS_status
DestroyEventService_V1_4_2_Json (RedfishCS_char *JsonText);
