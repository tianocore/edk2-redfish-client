...
#ifndef RedfishChassis_V1_9_4_CSTRUCT_H_
#define RedfishChassis_V1_9_4_CSTRUCT_H_
...
#endif
typedef struct _RedfishChassis_V1_9_4_Actions_CS RedfishChassis_V1_9_4_Actions_CS;
typedef struct _RedfishChassis_V1_9_4_Chassis_CS RedfishChassis_V1_9_4_Chassis_CS;
typedef struct _RedfishChassis_V1_9_4_Links_CS RedfishChassis_V1_9_4_Links_CS;
typedef struct _RedfishChassis_V1_9_4_OemActions_CS RedfishChassis_V1_9_4_OemActions_CS;
typedef struct _RedfishChassis_V1_9_4_PhysicalSecurity_CS RedfishChassis_V1_9_4_PhysicalSecurity_CS;
typedef struct _RedfishChassis_V1_9_4_Reset_CS RedfishChassis_V1_9_4_Reset_CS;
...
typedef struct _RedfishChassis_V1_9_4_Actions_CS {
    ...
    RedfishChassis_V1_9_4_OemActions_CS    *Oem;             // The available OEM-specific
...
typedef struct _RedfishChassis_V1_9_4_Chassis_CS {
    ...
    RedfishChassis_V1_9_4_Actions_CS             *Actions;              // The available actions for this
                                                                        // resource.
    ...
    RedfishCS_char                               *IndicatorLED;         // The state of the indicator
                                                                        ...
                                                                        // chassis.
    RedfishChassis_V1_9_4_Links_CS               *Links;                // The links to other resources
    ...
    RedfishCS_char                               *PartNumber;           // The part number of the
                                                                        // chassis.
    RedfishChassis_V1_9_4_PhysicalSecurity_CS    *PhysicalSecurity;     // The state of the physical
                                                                        // security sensor.
...
RedfishCS_status
Json_Chassis_V1_9_4_To_CS (char *JsonRawText, RedfishChassis_V1_9_4_Chassis_CS **ReturnedCS);

RedfishCS_status
CS_To_Chassis_V1_9_4_JSON (RedfishChassis_V1_9_4_Chassis_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyChassis_V1_9_4_CS (RedfishChassis_V1_9_4_Chassis_CS *CSPtr);

RedfishCS_status
DestroyChassis_V1_9_4_Json (RedfishCS_char *JsonText);
