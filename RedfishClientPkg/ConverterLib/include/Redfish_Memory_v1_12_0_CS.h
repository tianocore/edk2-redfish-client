...
#ifndef RedfishMemory_V1_12_0_CSTRUCT_H_
#define RedfishMemory_V1_12_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishMemory_V1_12_0_RegionSet_Array_CS RedfishMemory_V1_12_0_RegionSet_Array_CS;
typedef struct _RedfishMemory_V1_12_0_Actions_CS RedfishMemory_V1_12_0_Actions_CS;
typedef struct _RedfishMemory_V1_12_0_DisablePassphrase_CS RedfishMemory_V1_12_0_DisablePassphrase_CS;
typedef struct _RedfishMemory_V1_12_0_Links_CS RedfishMemory_V1_12_0_Links_CS;
typedef struct _RedfishMemory_V1_12_0_Memory_CS RedfishMemory_V1_12_0_Memory_CS;
typedef struct _RedfishMemory_V1_12_0_MemoryLocation_CS RedfishMemory_V1_12_0_MemoryLocation_CS;
typedef struct _RedfishMemory_V1_12_0_OemActions_CS RedfishMemory_V1_12_0_OemActions_CS;
typedef struct _RedfishMemory_V1_12_0_OverwriteUnit_CS RedfishMemory_V1_12_0_OverwriteUnit_CS;
typedef struct _RedfishMemory_V1_12_0_PowerManagementPolicy_CS RedfishMemory_V1_12_0_PowerManagementPolicy_CS;
typedef struct _RedfishMemory_V1_12_0_RegionSet_CS RedfishMemory_V1_12_0_RegionSet_CS;
typedef struct _RedfishMemory_V1_12_0_Reset_CS RedfishMemory_V1_12_0_Reset_CS;
typedef struct _RedfishMemory_V1_12_0_SecureEraseUnit_CS RedfishMemory_V1_12_0_SecureEraseUnit_CS;
typedef struct _RedfishMemory_V1_12_0_SecurityCapabilities_CS RedfishMemory_V1_12_0_SecurityCapabilities_CS;
typedef struct _RedfishMemory_V1_12_0_SetPassphrase_CS RedfishMemory_V1_12_0_SetPassphrase_CS;
typedef struct _RedfishMemory_V1_12_0_UnlockUnit_CS RedfishMemory_V1_12_0_UnlockUnit_CS;
...
typedef struct _RedfishMemory_V1_12_0_Actions_CS {
    ...
    RedfishMemory_V1_12_0_OemActions_CS           *Oem;                        // The available OEM-specific
...
typedef struct _RedfishMemory_V1_12_0_Memory_CS {
    ...
    RedfishMemory_V1_12_0_Actions_CS                  *Actions;                                   // The available actions for this
                                                                                                  // resource.
    ...
    RedfishCS_bool                                    *IsSpareDeviceEnabled;                      // An indication of whether a
                                                                                                  ...
                                                                                                  // this memory device.
    RedfishMemory_V1_12_0_Links_CS                    *Links;                                     // The links to other resources
    ...
    RedfishCS_char                                    *MemoryDeviceType;                          // Type details of the memory
                                                                                                  // device.
    RedfishMemory_V1_12_0_MemoryLocation_CS           *MemoryLocation;                            // Memory connection information
    ...
    RedfishCS_int64                                   *PersistentRegionSizeMaxMiB;                // Maximum size of a single
                                                                                                  ...
                                                                                                  // (MiB).
    RedfishMemory_V1_12_0_PowerManagementPolicy_CS    *PowerManagementPolicy;                     // Power management policy
                                                                                                  // information.
    RedfishCS_int64                                   *RankCount;                                 // Number of ranks available in
                                                                                                  // the memory device.
    RedfishMemory_V1_12_0_RegionSet_Array_CS          *Regions;                                   // Memory regions information
                                                                                                  // within the memory device.
    RedfishMemory_V1_12_0_SecurityCapabilities_CS     *SecurityCapabilities;                      // Security capabilities of the
                                                                                                  // memory device.
...
typedef struct _RedfishMemory_V1_12_0_RegionSet_Array_CS  {
    RedfishMemory_V1_12_0_RegionSet_Array_CS    *Next;
    RedfishMemory_V1_12_0_RegionSet_CS    *ArrayValue;
} RedfishMemory_V1_12_0_RegionSet_Array_CS;

RedfishCS_status
Json_Memory_V1_12_0_To_CS (char *JsonRawText, RedfishMemory_V1_12_0_Memory_CS **ReturnedCS);

RedfishCS_status
CS_To_Memory_V1_12_0_JSON (RedfishMemory_V1_12_0_Memory_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMemory_V1_12_0_CS (RedfishMemory_V1_12_0_Memory_CS *CSPtr);

RedfishCS_status
DestroyMemory_V1_12_0_Json (RedfishCS_char *JsonText);
