...
#ifndef RedfishComputersystem_V1_0_10_CSTRUCT_H_
#define RedfishComputersystem_V1_0_10_CSTRUCT_H_
...
#endif
typedef struct _RedfishComputerSystem_V1_0_10_Actions_CS RedfishComputerSystem_V1_0_10_Actions_CS;
typedef struct _RedfishComputerSystem_V1_0_10_Boot_CS RedfishComputerSystem_V1_0_10_Boot_CS;
typedef struct _RedfishComputerSystem_V1_0_10_ComputerSystem_CS RedfishComputerSystem_V1_0_10_ComputerSystem_CS;
typedef struct _RedfishComputerSystem_V1_0_10_Links_CS RedfishComputerSystem_V1_0_10_Links_CS;
typedef struct _RedfishComputerSystem_V1_0_10_MemorySummary_CS RedfishComputerSystem_V1_0_10_MemorySummary_CS;
typedef struct _RedfishComputerSystem_V1_0_10_OemActions_CS RedfishComputerSystem_V1_0_10_OemActions_CS;
typedef struct _RedfishComputerSystem_V1_0_10_ProcessorSummary_CS RedfishComputerSystem_V1_0_10_ProcessorSummary_CS;
typedef struct _RedfishComputerSystem_V1_0_10_Reset_CS RedfishComputerSystem_V1_0_10_Reset_CS;
...
//
typedef struct _RedfishComputerSystem_V1_0_10_Actions_CS {
    RedfishComputerSystem_V1_0_10_Reset_CS         *ComputerSystem_Reset;
    RedfishComputerSystem_V1_0_10_OemActions_CS    *Oem;                    // This property contains the
                                                                            // available OEM specific actions
                                                                            // for this resource.
} RedfishComputerSystem_V1_0_10_Actions_CS;

//
// This object contains the boot information for the current resource.
//
typedef struct _RedfishComputerSystem_V1_0_10_Boot_CS {
    ...
    RedfishCS_char    *UefiTargetBootSourceOverride;    // This property is the UEFI
                                                       ...
                                                       // UefiTarget.
} RedfishComputerSystem_V1_0_10_Boot_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishComputerSystem_V1_0_10_Links_CS {
...
} RedfishComputerSystem_V1_0_10_Links_CS;

//
// This object describes the memory of the system in general detail.
//
typedef struct _RedfishComputerSystem_V1_0_10_MemorySummary_CS {
    ...
    RedfishCS_int64              *TotalSystemMemoryGiB;    // The total configured operating
                                                          ...
                                                          // (RAM), measured in GiB.
} RedfishComputerSystem_V1_0_10_MemorySummary_CS;

//
// The available OEM specific actions for this resource.
//
typedef struct _RedfishComputerSystem_V1_0_10_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishComputerSystem_V1_0_10_OemActions_CS;

//
// This object describes the central processors of the system in general detail.
//
typedef struct _RedfishComputerSystem_V1_0_10_ProcessorSummary_CS {
    ...
    RedfishResource_Status_CS    *Status;    // This property describes the
                                            // status and health of the
                                            // resource and its children.
} RedfishComputerSystem_V1_0_10_ProcessorSummary_CS;

//
// This action is used to reset the system.
//
typedef struct _RedfishComputerSystem_V1_0_10_Reset_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishComputerSystem_V1_0_10_Reset_CS;
...
// machine.
//
typedef struct _RedfishComputerSystem_V1_0_10_ComputerSystem_CS {
    RedfishCS_Header                                     Header;
    RedfishCS_char                                       *odata_context;   
    RedfishCS_char                                       *odata_etag;      
    RedfishCS_char                                       *odata_id;        
    RedfishCS_char                                       *odata_type;      
    RedfishComputerSystem_V1_0_10_Actions_CS             *Actions;             // The available actions for this
                                                                               // resource.
    ...
    RedfishComputerSystem_V1_0_10_Boot_CS                *Boot;                // Information about the boot
    ...
    RedfishCS_char                                       *IndicatorLED;        // The state of the indicator
                                                                               ...
                                                                               // system.
    RedfishComputerSystem_V1_0_10_Links_CS               *Links;               // Contains references to other
    ...
    RedfishCS_char                                       *Manufacturer;        // The manufacturer or OEM of
                                                                               // this system.
    RedfishComputerSystem_V1_0_10_MemorySummary_CS       *MemorySummary;       // This object describes the
    ...
    RedfishCS_char                                       *PowerState;          // This is the current power
                                                                               // state of the system.
    RedfishComputerSystem_V1_0_10_ProcessorSummary_CS    *ProcessorSummary;    // This object describes the
    ...
    RedfishCS_char                                       *UUID;                // The universal unique
                                                                               ...
                                                                               // system.
} RedfishComputerSystem_V1_0_10_ComputerSystem_CS;
...
RedfishCS_status
Json_ComputerSystem_V1_0_10_To_CS (char *JsonRawText, RedfishComputerSystem_V1_0_10_ComputerSystem_CS **ReturnedCS);

RedfishCS_status
CS_To_ComputerSystem_V1_0_10_JSON (RedfishComputerSystem_V1_0_10_ComputerSystem_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyComputerSystem_V1_0_10_CS (RedfishComputerSystem_V1_0_10_ComputerSystem_CS *CSPtr);

RedfishCS_status
DestroyComputerSystem_V1_0_10_Json (RedfishCS_char *JsonText);
