...
#ifndef RedfishVirtualmedia_V1_4_0_CSTRUCT_H_
#define RedfishVirtualmedia_V1_4_0_CSTRUCT_H_
...
typedef struct _RedfishVirtualMedia_V1_4_0_Actions_CS RedfishVirtualMedia_V1_4_0_Actions_CS;
typedef struct _RedfishVirtualMedia_V1_4_0_EjectMedia_CS RedfishVirtualMedia_V1_4_0_EjectMedia_CS;
typedef struct _RedfishVirtualMedia_V1_4_0_InsertMedia_CS RedfishVirtualMedia_V1_4_0_InsertMedia_CS;
typedef struct _RedfishVirtualMedia_V1_4_0_OemActions_CS RedfishVirtualMedia_V1_4_0_OemActions_CS;
typedef struct _RedfishVirtualMedia_V1_4_0_VirtualMedia_CS RedfishVirtualMedia_V1_4_0_VirtualMedia_CS;
...
typedef struct _RedfishVirtualMedia_V1_4_0_Actions_CS {
    ...
    RedfishVirtualMedia_V1_4_0_OemActions_CS     *Oem;                        // The available OEM-specific
...
typedef struct _RedfishVirtualMedia_V1_4_0_VirtualMedia_CS {
    ...
    RedfishVirtualMedia_V1_4_0_Actions_CS    *Actions;                // The available actions for this
                                                                      // Resource.
...
RedfishCS_status
Json_VirtualMedia_V1_4_0_To_CS (char *JsonRawText, RedfishVirtualMedia_V1_4_0_VirtualMedia_CS **ReturnedCS);

RedfishCS_status
CS_To_VirtualMedia_V1_4_0_JSON (RedfishVirtualMedia_V1_4_0_VirtualMedia_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyVirtualMedia_V1_4_0_CS (RedfishVirtualMedia_V1_4_0_VirtualMedia_CS *CSPtr);

RedfishCS_status
DestroyVirtualMedia_V1_4_0_Json (RedfishCS_char *JsonText);
