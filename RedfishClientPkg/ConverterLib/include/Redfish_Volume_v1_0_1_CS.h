...
#ifndef RedfishVolume_V1_0_1_CSTRUCT_H_
#define RedfishVolume_V1_0_1_CSTRUCT_H_
...
typedef struct _RedfishVolume_V1_0_1_Actions_CS RedfishVolume_V1_0_1_Actions_CS;
typedef struct _RedfishVolume_V1_0_1_CheckConsistency_CS RedfishVolume_V1_0_1_CheckConsistency_CS;
typedef struct _RedfishVolume_V1_0_1_Links_CS RedfishVolume_V1_0_1_Links_CS;
typedef struct _RedfishVolume_V1_0_1_OemActions_CS RedfishVolume_V1_0_1_OemActions_CS;
typedef struct _RedfishVolume_V1_0_1_Operation_CS RedfishVolume_V1_0_1_Operation_CS;
...
typedef struct _RedfishVolume_V1_0_1_Volume_CS {
    ...
    RedfishVolume_V1_0_1_Actions_CS      *Actions;              // The available actions for this
                                                                // resource.
    ...
    RedfishCS_Link                       Identifiers;           // The Durable names for the
                                                                // volume.
    RedfishVolume_V1_0_1_Links_CS        *Links;                // Contains references to other
                                                                // resources that are related to
                                                                // this resource.
    RedfishCS_char                       *Name;             
    RedfishResource_Oem_CS               *Oem;                  // The OEM extension property.
    RedfishVolume_V1_0_1_Operation_CS    *Operations;           // The operations currently
