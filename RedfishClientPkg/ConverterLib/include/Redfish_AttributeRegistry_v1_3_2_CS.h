...
#ifndef RedfishAttributeregistry_V1_3_2_CSTRUCT_H_
#define RedfishAttributeregistry_V1_3_2_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishAttributeRegistry_V1_3_2_AttributeValue_Array_CS RedfishAttributeRegistry_V1_3_2_AttributeValue_Array_CS;
typedef struct _RedfishAttributeRegistry_V1_3_2_MapFrom_Array_CS RedfishAttributeRegistry_V1_3_2_MapFrom_Array_CS;
typedef struct _RedfishAttributeRegistry_V1_3_2_Attributes_Array_CS RedfishAttributeRegistry_V1_3_2_Attributes_Array_CS;
typedef struct _RedfishAttributeRegistry_V1_3_2_Dependencies_Array_CS RedfishAttributeRegistry_V1_3_2_Dependencies_Array_CS;
typedef struct _RedfishAttributeRegistry_V1_3_2_Menus_Array_CS RedfishAttributeRegistry_V1_3_2_Menus_Array_CS;
typedef struct _RedfishAttributeRegistry_V1_3_2_SupportedSystems_Array_CS RedfishAttributeRegistry_V1_3_2_SupportedSystems_Array_CS;
typedef struct _RedfishAttributeRegistry_V1_3_2_Actions_CS RedfishAttributeRegistry_V1_3_2_Actions_CS;
typedef struct _RedfishAttributeRegistry_V1_3_2_AttributeRegistry_CS RedfishAttributeRegistry_V1_3_2_AttributeRegistry_CS;
typedef struct _RedfishAttributeRegistry_V1_3_2_AttributeValue_CS RedfishAttributeRegistry_V1_3_2_AttributeValue_CS;
typedef struct _RedfishAttributeRegistry_V1_3_2_Attributes_CS RedfishAttributeRegistry_V1_3_2_Attributes_CS;
typedef struct _RedfishAttributeRegistry_V1_3_2_Dependencies_CS RedfishAttributeRegistry_V1_3_2_Dependencies_CS;
typedef struct _RedfishAttributeRegistry_V1_3_2_Dependency_CS RedfishAttributeRegistry_V1_3_2_Dependency_CS;
typedef struct _RedfishAttributeRegistry_V1_3_2_MapFrom_CS RedfishAttributeRegistry_V1_3_2_MapFrom_CS;
typedef struct _RedfishAttributeRegistry_V1_3_2_Menus_CS RedfishAttributeRegistry_V1_3_2_Menus_CS;
typedef struct _RedfishAttributeRegistry_V1_3_2_OemActions_CS RedfishAttributeRegistry_V1_3_2_OemActions_CS;
typedef struct _RedfishAttributeRegistry_V1_3_2_RegistryEntries_CS RedfishAttributeRegistry_V1_3_2_RegistryEntries_CS;
typedef struct _RedfishAttributeRegistry_V1_3_2_SupportedSystems_CS RedfishAttributeRegistry_V1_3_2_SupportedSystems_CS;
...
typedef struct _RedfishAttributeRegistry_V1_3_2_Actions_CS {
    RedfishAttributeRegistry_V1_3_2_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishAttributeRegistry_V1_3_2_Attributes_CS {
    ...
    RedfishCS_bool                                             *ResetRequired;            // An indication of whether a
                                                                                          // system or device reset is
                                                                                          // required for this attribute
                                                                                          // value change to take effect.
    ...
    RedfishCS_char                                             *UefiKeywordName;          // The UEFI keyword string for
                                                                                          // this attribute.
    RedfishCS_char                                             *UefiNamespaceId;          // The UEFI namespace ID for the
                                                                                          // attribute.
    RedfishCS_int64                                            *UpperBound;               // The upper limit for an integer
                                                                                          // attribute.
    RedfishAttributeRegistry_V1_3_2_AttributeValue_Array_CS    *Value;                    // An array of the possible
...
typedef struct _RedfishAttributeRegistry_V1_3_2_Dependencies_CS {
    RedfishAttributeRegistry_V1_3_2_Dependency_CS    *Dependency;      // The dependency expression for
...
typedef struct _RedfishAttributeRegistry_V1_3_2_Dependency_CS {
    RedfishAttributeRegistry_V1_3_2_MapFrom_Array_CS    *MapFrom;          // An array of the map-from
...
typedef struct _RedfishAttributeRegistry_V1_3_2_RegistryEntries_CS {
    RedfishAttributeRegistry_V1_3_2_Attributes_Array_CS      *Attributes;     // An array of attributes and
                                                                              // their possible values in the
                                                                              // Attribute Registry.
    RedfishAttributeRegistry_V1_3_2_Dependencies_Array_CS    *Dependencies;    // An array of dependencies of
                                                                              // attributes on this component.
    RedfishAttributeRegistry_V1_3_2_Menus_Array_CS           *Menus;          // An array for the attributes
...
typedef struct _RedfishAttributeRegistry_V1_3_2_AttributeRegistry_CS {
    ...
    RedfishAttributeRegistry_V1_3_2_Actions_CS                   *Actions;            // The available actions for this
                                                                                      // Resource.
    ...
    RedfishCS_char                                               *OwningEntity;       // The organization or company
                                                                                      ...
                                                                                      // Registry.
    RedfishAttributeRegistry_V1_3_2_RegistryEntries_CS           *RegistryEntries;    // The list of all attributes and
                                                                                      // their metadata for this
                                                                                      // component.
    RedfishCS_char                                               *RegistryVersion;    // The Attribute Registry
                                                                                      // version.
    RedfishAttributeRegistry_V1_3_2_SupportedSystems_Array_CS    *SupportedSystems;    // An array of systems that this
...
typedef struct _RedfishAttributeRegistry_V1_3_2_AttributeValue_Array_CS  {
    RedfishAttributeRegistry_V1_3_2_AttributeValue_Array_CS    *Next;
...
typedef struct _RedfishAttributeRegistry_V1_3_2_MapFrom_Array_CS  {
    RedfishAttributeRegistry_V1_3_2_MapFrom_Array_CS    *Next;
...
typedef struct _RedfishAttributeRegistry_V1_3_2_Attributes_Array_CS  {
    RedfishAttributeRegistry_V1_3_2_Attributes_Array_CS    *Next;
...
typedef struct _RedfishAttributeRegistry_V1_3_2_Dependencies_Array_CS  {
    RedfishAttributeRegistry_V1_3_2_Dependencies_Array_CS    *Next;
...
typedef struct _RedfishAttributeRegistry_V1_3_2_Menus_Array_CS  {
    RedfishAttributeRegistry_V1_3_2_Menus_Array_CS    *Next;
    RedfishAttributeRegistry_V1_3_2_Menus_CS    *ArrayValue;
} RedfishAttributeRegistry_V1_3_2_Menus_Array_CS;

typedef struct _RedfishAttributeRegistry_V1_3_2_SupportedSystems_Array_CS  {
    RedfishAttributeRegistry_V1_3_2_SupportedSystems_Array_CS    *Next;
    RedfishAttributeRegistry_V1_3_2_SupportedSystems_CS    *ArrayValue;
} RedfishAttributeRegistry_V1_3_2_SupportedSystems_Array_CS;

RedfishCS_status
Json_AttributeRegistry_V1_3_2_To_CS (char *JsonRawText, RedfishAttributeRegistry_V1_3_2_AttributeRegistry_CS **ReturnedCS);

RedfishCS_status
CS_To_AttributeRegistry_V1_3_2_JSON (RedfishAttributeRegistry_V1_3_2_AttributeRegistry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAttributeRegistry_V1_3_2_CS (RedfishAttributeRegistry_V1_3_2_AttributeRegistry_CS *CSPtr);

RedfishCS_status
DestroyAttributeRegistry_V1_3_2_Json (RedfishCS_char *JsonText);
