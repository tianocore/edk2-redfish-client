...
#ifndef RedfishManagernetworkprotocol_V1_6_0_CSTRUCT_H_
#define RedfishManagernetworkprotocol_V1_6_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishManagerNetworkProtocol_V1_6_0_SNMPCommunity_Array_CS RedfishManagerNetworkProtocol_V1_6_0_SNMPCommunity_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishManagerNetworkProtocol_V1_6_0_Actions_CS RedfishManagerNetworkProtocol_V1_6_0_Actions_CS;
typedef struct _RedfishManagerNetworkProtocol_V1_6_0_EngineId_CS RedfishManagerNetworkProtocol_V1_6_0_EngineId_CS;
typedef struct _RedfishManagerNetworkProtocol_V1_6_0_HTTPSProtocol_CS RedfishManagerNetworkProtocol_V1_6_0_HTTPSProtocol_CS;
typedef struct _RedfishManagerNetworkProtocol_V1_6_0_ManagerNetworkProtocol_CS RedfishManagerNetworkProtocol_V1_6_0_ManagerNetworkProtocol_CS;
typedef struct _RedfishManagerNetworkProtocol_V1_6_0_NTPProtocol_CS RedfishManagerNetworkProtocol_V1_6_0_NTPProtocol_CS;
typedef struct _RedfishManagerNetworkProtocol_V1_6_0_OemActions_CS RedfishManagerNetworkProtocol_V1_6_0_OemActions_CS;
typedef struct _RedfishManagerNetworkProtocol_V1_6_0_Protocol_CS RedfishManagerNetworkProtocol_V1_6_0_Protocol_CS;
typedef struct _RedfishManagerNetworkProtocol_V1_6_0_SNMPCommunity_CS RedfishManagerNetworkProtocol_V1_6_0_SNMPCommunity_CS;
typedef struct _RedfishManagerNetworkProtocol_V1_6_0_SNMPProtocol_CS RedfishManagerNetworkProtocol_V1_6_0_SNMPProtocol_CS;
typedef struct _RedfishManagerNetworkProtocol_V1_6_0_SSDProtocol_CS RedfishManagerNetworkProtocol_V1_6_0_SSDProtocol_CS;
...
typedef struct _RedfishManagerNetworkProtocol_V1_6_0_Actions_CS {
    RedfishManagerNetworkProtocol_V1_6_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishManagerNetworkProtocol_V1_6_0_SNMPProtocol_CS {
    ...
    RedfishCS_char                                                 *CommunityAccessMode;      // The access level of the SNMP
                                                                                              // community.
    RedfishManagerNetworkProtocol_V1_6_0_SNMPCommunity_Array_CS    *CommunityStrings;         // The SNMP community strings.
    ...
    RedfishCS_char                                                 *EncryptionProtocol;       // The encryption protocol for
                                                                                              // SNMPv3.
    RedfishManagerNetworkProtocol_V1_6_0_EngineId_CS               *EngineId;                 // The engine ID.
...
typedef struct _RedfishManagerNetworkProtocol_V1_6_0_ManagerNetworkProtocol_CS {
    ...
    RedfishManagerNetworkProtocol_V1_6_0_Actions_CS          *Actions;         // The available actions for this
                                                                               // Resource.
    RedfishManagerNetworkProtocol_V1_6_0_Protocol_CS         *DHCP;            // The settings for this
                                                                               // manager's DHCPv4 protocol
                                                                               // support.
    RedfishManagerNetworkProtocol_V1_6_0_Protocol_CS         *DHCPv6;          // The settings for this
    ...
    RedfishManagerNetworkProtocol_V1_6_0_Protocol_CS         *HTTP;            // The settings for this
                                                                               // manager's HTTP protocol
                                                                               // support.
    RedfishManagerNetworkProtocol_V1_6_0_HTTPSProtocol_CS    *HTTPS;           // The settings for this
                                                                               // manager's HTTPS protocol
                                                                               // support.
    RedfishCS_char                                           *HostName;        // The DNS host name of this
                                                                               // manager, without any domain
                                                                               // information.
    RedfishManagerNetworkProtocol_V1_6_0_Protocol_CS         *IPMI;            // The settings for this
                                                                               // manager's IPMI-over-LAN
                                                                               // protocol support.
    RedfishCS_char                                           *Id;          
    RedfishManagerNetworkProtocol_V1_6_0_Protocol_CS         *KVMIP;           // The settings for this
                                                                               // manager's KVM-IP protocol
                                                                               // support.
    RedfishManagerNetworkProtocol_V1_6_0_NTPProtocol_CS      *NTP;             // The settings for this
                                                                               // manager's NTP protocol
                                                                               // support.
    RedfishCS_char                                           *Name;        
    RedfishResource_Oem_CS                                   *Oem;             // The OEM extension property.
    RedfishManagerNetworkProtocol_V1_6_0_Protocol_CS         *RDP;             // The settings for this
                                                                               // manager's Remote Desktop
                                                                               // Protocol support.
    RedfishManagerNetworkProtocol_V1_6_0_Protocol_CS         *RFB;             // The settings for this
                                                                               // manager's Remote Frame Buffer
                                                                               // protocol support, which can
                                                                               // support VNC.
    RedfishManagerNetworkProtocol_V1_6_0_SNMPProtocol_CS     *SNMP;            // The settings for this
                                                                               // manager's SNMP support.
    RedfishManagerNetworkProtocol_V1_6_0_SSDProtocol_CS      *SSDP;            // The settings for this
                                                                               // manager's SSDP support.
    RedfishManagerNetworkProtocol_V1_6_0_Protocol_CS         *SSH;             // The settings for this
                                                                               // manager's Secure Shell (SSH)
                                                                               // protocol support.
    RedfishResource_Status_CS                                *Status;          // The status and health of the
                                                                               // Resource and its subordinate
                                                                               // or dependent Resources.
    RedfishManagerNetworkProtocol_V1_6_0_Protocol_CS         *Telnet;          // The settings for this
                                                                               // manager's Telnet protocol
                                                                               // support.
    RedfishManagerNetworkProtocol_V1_6_0_Protocol_CS         *VirtualMedia;    // The settings for this
...
typedef struct _RedfishManagerNetworkProtocol_V1_6_0_SNMPCommunity_Array_CS  {
    RedfishManagerNetworkProtocol_V1_6_0_SNMPCommunity_Array_CS    *Next;
...
RedfishCS_status
Json_ManagerNetworkProtocol_V1_6_0_To_CS (char *JsonRawText, RedfishManagerNetworkProtocol_V1_6_0_ManagerNetworkProtocol_CS **ReturnedCS);

RedfishCS_status
CS_To_ManagerNetworkProtocol_V1_6_0_JSON (RedfishManagerNetworkProtocol_V1_6_0_ManagerNetworkProtocol_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyManagerNetworkProtocol_V1_6_0_CS (RedfishManagerNetworkProtocol_V1_6_0_ManagerNetworkProtocol_CS *CSPtr);

RedfishCS_status
DestroyManagerNetworkProtocol_V1_6_0_Json (RedfishCS_char *JsonText);
