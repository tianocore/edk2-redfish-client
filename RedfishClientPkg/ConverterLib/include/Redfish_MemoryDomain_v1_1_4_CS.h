...
#ifndef RedfishMemorydomain_V1_1_4_CSTRUCT_H_
#define RedfishMemorydomain_V1_1_4_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMemoryDomain_V1_1_4_MemorySet_Array_CS RedfishMemoryDomain_V1_1_4_MemorySet_Array_CS;
typedef struct _RedfishMemoryDomain_V1_1_4_MemoryDomain_CS RedfishMemoryDomain_V1_1_4_MemoryDomain_CS;
typedef struct _RedfishMemoryDomain_V1_1_4_MemorySet_CS RedfishMemoryDomain_V1_1_4_MemorySet_CS;
...
typedef struct _RedfishMemoryDomain_V1_1_4_MemoryDomain_CS {
    ...
    RedfishCS_char                                   *Id;                      
    RedfishMemoryDomain_V1_1_4_MemorySet_Array_CS    *InterleavableMemorySets;     // The interleave sets for the
                                                                                   // memory chunk.
...
typedef struct _RedfishMemoryDomain_V1_1_4_MemorySet_Array_CS  {
    RedfishMemoryDomain_V1_1_4_MemorySet_Array_CS    *Next;
    RedfishMemoryDomain_V1_1_4_MemorySet_CS    *ArrayValue;
} RedfishMemoryDomain_V1_1_4_MemorySet_Array_CS;

RedfishCS_status
Json_MemoryDomain_V1_1_4_To_CS (char *JsonRawText, RedfishMemoryDomain_V1_1_4_MemoryDomain_CS **ReturnedCS);

RedfishCS_status
CS_To_MemoryDomain_V1_1_4_JSON (RedfishMemoryDomain_V1_1_4_MemoryDomain_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMemoryDomain_V1_1_4_CS (RedfishMemoryDomain_V1_1_4_MemoryDomain_CS *CSPtr);

RedfishCS_status
DestroyMemoryDomain_V1_1_4_Json (RedfishCS_char *JsonText);
