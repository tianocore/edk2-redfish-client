...
#ifndef RedfishExternalaccountprovidercollection_Noversioned_CSTRUCT_H_
#define RedfishExternalaccountprovidercollection_Noversioned_CSTRUCT_H_
...
//
// The collection of ExternalAccountProvider resource instances.
//
