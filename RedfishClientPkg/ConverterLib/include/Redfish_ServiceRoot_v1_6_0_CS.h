...
#ifndef RedfishServiceroot_V1_6_0_CSTRUCT_H_
#define RedfishServiceroot_V1_6_0_CSTRUCT_H_
...
typedef struct _RedfishServiceRoot_V1_6_0_Expand_CS RedfishServiceRoot_V1_6_0_Expand_CS;
typedef struct _RedfishServiceRoot_V1_6_0_Links_CS RedfishServiceRoot_V1_6_0_Links_CS;
typedef struct _RedfishServiceRoot_V1_6_0_ProtocolFeaturesSupported_CS RedfishServiceRoot_V1_6_0_ProtocolFeaturesSupported_CS;
typedef struct _RedfishServiceRoot_V1_6_0_ServiceRoot_CS RedfishServiceRoot_V1_6_0_ServiceRoot_CS;
//
// The OEM extension.
//
#ifndef RedfishResource_Oem_CS_
...
//
typedef struct _RedfishServiceRoot_V1_6_0_Expand_CS {
    ...
    RedfishCS_bool     *NoLinks;     // An indication of whether the
                                     ...
                                     // (`.`) option of the $expand
                                     // query parameter.
} RedfishServiceRoot_V1_6_0_Expand_CS;

//
// The links to other Resources that are related to this Resource.
//
typedef struct _RedfishServiceRoot_V1_6_0_Links_CS {
    RedfishResource_Oem_CS    *Oem;       // The OEM extension property.
    RedfishCS_Link            Sessions;    // The link to a collection of
                                          // Sessions.
} RedfishServiceRoot_V1_6_0_Links_CS;

//
// The information about protocol features that the service supports.
//
typedef struct _RedfishServiceRoot_V1_6_0_ProtocolFeaturesSupported_CS {
    RedfishCS_bool                         *ExcerptQuery;      // An indication of whether the
                                                               // service supports the excerpt
                                                               // query parameter.
    RedfishServiceRoot_V1_6_0_Expand_CS    *ExpandQuery;       // The information about the use
    ...
    RedfishCS_bool                         *SelectQuery;       // An indication of whether the
                                                               ...
                                                               // query parameter.
} RedfishServiceRoot_V1_6_0_ProtocolFeaturesSupported_CS;
...
// Root.
//
typedef struct _RedfishServiceRoot_V1_6_0_ServiceRoot_CS {
    ...
    RedfishCS_Link                                            JsonSchemas;                  // The link to a collection of
                                                                                            // JSON Schema files.
    RedfishServiceRoot_V1_6_0_Links_CS                        *Links;                       // The links to other Resources
    ...
    RedfishServiceRoot_V1_6_0_ProtocolFeaturesSupported_CS    *ProtocolFeaturesSupported;    // The information about protocol
    ...
    RedfishCS_char                                            *Vendor;                      // The vendor or manufacturer
                                                                                            ...
                                                                                            // Service.
} RedfishServiceRoot_V1_6_0_ServiceRoot_CS;

RedfishCS_status
Json_ServiceRoot_V1_6_0_To_CS (char *JsonRawText, RedfishServiceRoot_V1_6_0_ServiceRoot_CS **ReturnedCS);

RedfishCS_status
CS_To_ServiceRoot_V1_6_0_JSON (RedfishServiceRoot_V1_6_0_ServiceRoot_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyServiceRoot_V1_6_0_CS (RedfishServiceRoot_V1_6_0_ServiceRoot_CS *CSPtr);

RedfishCS_status
DestroyServiceRoot_V1_6_0_Json (RedfishCS_char *JsonText);
