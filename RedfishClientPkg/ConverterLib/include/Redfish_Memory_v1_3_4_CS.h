...
#ifndef RedfishMemory_V1_3_4_CSTRUCT_H_
#define RedfishMemory_V1_3_4_CSTRUCT_H_
...
#endif
typedef struct _RedfishMemory_V1_3_4_RegionSet_Array_CS RedfishMemory_V1_3_4_RegionSet_Array_CS;
typedef struct _RedfishMemory_V1_3_4_Actions_CS RedfishMemory_V1_3_4_Actions_CS;
typedef struct _RedfishMemory_V1_3_4_DisablePassphrase_CS RedfishMemory_V1_3_4_DisablePassphrase_CS;
typedef struct _RedfishMemory_V1_3_4_Links_CS RedfishMemory_V1_3_4_Links_CS;
typedef struct _RedfishMemory_V1_3_4_Memory_CS RedfishMemory_V1_3_4_Memory_CS;
typedef struct _RedfishMemory_V1_3_4_MemoryLocation_CS RedfishMemory_V1_3_4_MemoryLocation_CS;
typedef struct _RedfishMemory_V1_3_4_OemActions_CS RedfishMemory_V1_3_4_OemActions_CS;
typedef struct _RedfishMemory_V1_3_4_PowerManagementPolicy_CS RedfishMemory_V1_3_4_PowerManagementPolicy_CS;
typedef struct _RedfishMemory_V1_3_4_RegionSet_CS RedfishMemory_V1_3_4_RegionSet_CS;
typedef struct _RedfishMemory_V1_3_4_SecureEraseUnit_CS RedfishMemory_V1_3_4_SecureEraseUnit_CS;
typedef struct _RedfishMemory_V1_3_4_SecurityCapabilities_CS RedfishMemory_V1_3_4_SecurityCapabilities_CS;
typedef struct _RedfishMemory_V1_3_4_SetPassphrase_CS RedfishMemory_V1_3_4_SetPassphrase_CS;
typedef struct _RedfishMemory_V1_3_4_UnlockUnit_CS RedfishMemory_V1_3_4_UnlockUnit_CS;
...
//
typedef struct _RedfishMemory_V1_3_4_Actions_CS {
    RedfishMemory_V1_3_4_DisablePassphrase_CS    *Memory_DisablePassphrase;
    RedfishMemory_V1_3_4_SecureEraseUnit_CS      *Memory_SecureEraseUnit; 
    RedfishMemory_V1_3_4_SetPassphrase_CS        *Memory_SetPassphrase;   
    RedfishMemory_V1_3_4_UnlockUnit_CS           *Memory_UnlockUnit;      
    RedfishMemory_V1_3_4_OemActions_CS           *Oem;                        // This property contains the
                                                                              // available OEM specific actions
                                                                              // for this resource.
} RedfishMemory_V1_3_4_Actions_CS;

//
// Disable passphrase for given regions.
//
typedef struct _RedfishMemory_V1_3_4_DisablePassphrase_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishMemory_V1_3_4_DisablePassphrase_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishMemory_V1_3_4_Links_CS {
    RedfishCS_Link            Chassis;    // A reference to the Chassis
                                         // which contains this Memory.
    RedfishResource_Oem_CS    *Oem;      // Oem extension object.
} RedfishMemory_V1_3_4_Links_CS;

//
// Memory connection information to sockets and memory controllers.
//
typedef struct _RedfishMemory_V1_3_4_MemoryLocation_CS {
    ...
    RedfishCS_int64    *Socket;             // Socket number in which Memory
                                            // is connected.
} RedfishMemory_V1_3_4_MemoryLocation_CS;

//
// The available OEM specific actions for this resource.
//
typedef struct _RedfishMemory_V1_3_4_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishMemory_V1_3_4_OemActions_CS;

//
// Power management policy information.
//
typedef struct _RedfishMemory_V1_3_4_PowerManagementPolicy_CS {
    ...
    RedfishCS_bool     *PolicyEnabled;                  // Power management policy
                                                        // enabled status.
} RedfishMemory_V1_3_4_PowerManagementPolicy_CS;

//
// Memory region information within a Memory entity.
//
typedef struct _RedfishMemory_V1_3_4_RegionSet_CS {
    ...
    RedfishCS_int64    *SizeMiB;                // Size of this memory region in
                                                // mebibytes (MiB).
} RedfishMemory_V1_3_4_RegionSet_CS;

//
// This defines the action for securely erasing given regions using the NIST
// SP800-88 Purge: Cryptograhic Erase.
//
typedef struct _RedfishMemory_V1_3_4_SecureEraseUnit_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishMemory_V1_3_4_SecureEraseUnit_CS;

//
// This type contains security capabilities of a Memory entity.
//
typedef struct _RedfishMemory_V1_3_4_SecurityCapabilities_CS {
    ...
    RedfishCS_char_Array    *SecurityStates;       // Security states supported by
                                                   // the Memory.
} RedfishMemory_V1_3_4_SecurityCapabilities_CS;

//
// Set passphrase for the given regions.
//
typedef struct _RedfishMemory_V1_3_4_SetPassphrase_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishMemory_V1_3_4_SetPassphrase_CS;

//
// This defines the action for unlocking given regions.
//
typedef struct _RedfishMemory_V1_3_4_UnlockUnit_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishMemory_V1_3_4_UnlockUnit_CS;
...
//
typedef struct _RedfishMemory_V1_3_4_Memory_CS {
    RedfishCS_Header                                 Header;
    RedfishCS_char                                   *odata_context;                         
    RedfishCS_char                                   *odata_etag;                            
    RedfishCS_char                                   *odata_id;                              
    RedfishCS_char                                   *odata_type;                            
    RedfishMemory_V1_3_4_Actions_CS                  *Actions;                                   // The available actions for this
                                                                                                 // resource.
    ...
    RedfishMemory_V1_3_4_Links_CS                    *Links;                                     // Contains references to other
    ...
    RedfishMemory_V1_3_4_MemoryLocation_CS           *MemoryLocation;                            // Memory connection information
    ...
    RedfishCS_int64                                  *PersistentRegionSizeMaxMiB;                // Maximum size of a single
                                                                                                 ...
                                                                                                 // (MiB).
    RedfishMemory_V1_3_4_PowerManagementPolicy_CS    *PowerManagementPolicy;                     // Power management policy
                                                                                                 // information.
    RedfishCS_int64                                  *RankCount;                                 // Number of ranks available in
                                                                                                 // the Memory.
    RedfishMemory_V1_3_4_RegionSet_Array_CS          *Regions;                                   // Memory regions information
                                                                                                 // within the Memory.
    RedfishMemory_V1_3_4_SecurityCapabilities_CS     *SecurityCapabilities;                      // This object contains security
    ...
    RedfishCS_int64                                  *VolatileRegionSizeMaxMiB;                  // Maximum size of a single
                                                                                                 ...
                                                                                                 // (MiB).
} RedfishMemory_V1_3_4_Memory_CS;
...
typedef struct _RedfishMemory_V1_3_4_RegionSet_Array_CS  {
    RedfishMemory_V1_3_4_RegionSet_Array_CS    *Next;
    RedfishMemory_V1_3_4_RegionSet_CS    *ArrayValue;
} RedfishMemory_V1_3_4_RegionSet_Array_CS;

RedfishCS_status
Json_Memory_V1_3_4_To_CS (char *JsonRawText, RedfishMemory_V1_3_4_Memory_CS **ReturnedCS);

RedfishCS_status
CS_To_Memory_V1_3_4_JSON (RedfishMemory_V1_3_4_Memory_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMemory_V1_3_4_CS (RedfishMemory_V1_3_4_Memory_CS *CSPtr);

RedfishCS_status
DestroyMemory_V1_3_4_Json (RedfishCS_char *JsonText);
