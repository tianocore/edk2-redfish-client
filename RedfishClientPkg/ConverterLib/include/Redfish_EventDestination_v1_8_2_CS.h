...
#ifndef RedfishEventdestination_V1_8_2_CSTRUCT_H_
#define RedfishEventdestination_V1_8_2_CSTRUCT_H_
...
#endif
typedef struct _RedfishEventDestination_V1_8_2_HttpHeaderProperty_Array_CS RedfishEventDestination_V1_8_2_HttpHeaderProperty_Array_CS;
#ifndef Redfishodatav4_idRef_Array_CS_
typedef struct _Redfishodatav4_idRef_Array_CS Redfishodatav4_idRef_Array_CS;
#endif
typedef struct _RedfishEventDestination_V1_8_2_Actions_CS RedfishEventDestination_V1_8_2_Actions_CS;
typedef struct _RedfishEventDestination_V1_8_2_EventDestination_CS RedfishEventDestination_V1_8_2_EventDestination_CS;
typedef struct _RedfishEventDestination_V1_8_2_HttpHeaderProperty_CS RedfishEventDestination_V1_8_2_HttpHeaderProperty_CS;
typedef struct _RedfishEventDestination_V1_8_2_OemActions_CS RedfishEventDestination_V1_8_2_OemActions_CS;
typedef struct _RedfishEventDestination_V1_8_2_ResumeSubscription_CS RedfishEventDestination_V1_8_2_ResumeSubscription_CS;
typedef struct _RedfishEventDestination_V1_8_2_SNMPSettings_CS RedfishEventDestination_V1_8_2_SNMPSettings_CS;
...
//
typedef struct _RedfishEventDestination_V1_8_2_Actions_CS {
    RedfishEventDestination_V1_8_2_ResumeSubscription_CS    *EventDestination_ResumeSubscription;
    RedfishEventDestination_V1_8_2_OemActions_CS            *Oem;                                   // The available OEM-specific
                                                                                                    // actions for this Resource.
} RedfishEventDestination_V1_8_2_Actions_CS;

//
// The HTTP header value is the property value.  The header name is the property
// name.
//
typedef struct _RedfishEventDestination_V1_8_2_HttpHeaderProperty_CS {
    RedfishCS_Link    Prop;
} RedfishEventDestination_V1_8_2_HttpHeaderProperty_CS;

//
// The available OEM-specific actions for this Resource.
//
typedef struct _RedfishEventDestination_V1_8_2_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishEventDestination_V1_8_2_OemActions_CS;

//
// This action resumes a suspended event subscription.
//
typedef struct _RedfishEventDestination_V1_8_2_ResumeSubscription_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishEventDestination_V1_8_2_ResumeSubscription_CS;

//
// Settings for an SNMP event destination.
//
typedef struct _RedfishEventDestination_V1_8_2_SNMPSettings_CS {
    ...
    RedfishCS_char    *TrapCommunity;            // The SNMP trap community
                                                 // string.
} RedfishEventDestination_V1_8_2_SNMPSettings_CS;
...
// payload.
//
typedef struct _RedfishEventDestination_V1_8_2_EventDestination_CS {
    RedfishCS_Header                                              Header;
    RedfishCS_char                                                *odata_context;                    
    RedfishCS_char                                                *odata_etag;                       
    RedfishCS_char                                                *odata_id;                         
    RedfishCS_char                                                *odata_type;                       
    RedfishEventDestination_V1_8_2_Actions_CS                     *Actions;                              // The available actions for this
                                                                                                         // Resource.
    ...
    RedfishEventDestination_V1_8_2_HttpHeaderProperty_Array_CS    *HttpHeaders;                          // An array of settings for HTTP
    ...
    RedfishEventDestination_V1_8_2_SNMPSettings_CS                *SNMP;                                 // Settings for an SNMP event
                                                                                                         // destination.
    ...
    RedfishCS_char                                                *SubscriptionType;                     // The subscription type for
                                                                                                         // events.
} RedfishEventDestination_V1_8_2_EventDestination_CS;
...
typedef struct _RedfishEventDestination_V1_8_2_HttpHeaderProperty_Array_CS  {
    RedfishEventDestination_V1_8_2_HttpHeaderProperty_Array_CS    *Next;
    RedfishEventDestination_V1_8_2_HttpHeaderProperty_CS    *ArrayValue;
} RedfishEventDestination_V1_8_2_HttpHeaderProperty_Array_CS;
...
RedfishCS_status
Json_EventDestination_V1_8_2_To_CS (char *JsonRawText, RedfishEventDestination_V1_8_2_EventDestination_CS **ReturnedCS);

RedfishCS_status
CS_To_EventDestination_V1_8_2_JSON (RedfishEventDestination_V1_8_2_EventDestination_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEventDestination_V1_8_2_CS (RedfishEventDestination_V1_8_2_EventDestination_CS *CSPtr);

RedfishCS_status
DestroyEventDestination_V1_8_2_Json (RedfishCS_char *JsonText);
