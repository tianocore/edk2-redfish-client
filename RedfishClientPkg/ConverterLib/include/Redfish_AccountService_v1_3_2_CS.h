...
#ifndef RedfishAccountservice_V1_3_2_CSTRUCT_H_
#define RedfishAccountservice_V1_3_2_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishAccountService_V1_3_2_RoleMapping_Array_CS RedfishAccountService_V1_3_2_RoleMapping_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishAccountService_V1_3_2_AccountService_CS RedfishAccountService_V1_3_2_AccountService_CS;
typedef struct _RedfishAccountService_V1_3_2_Actions_CS RedfishAccountService_V1_3_2_Actions_CS;
typedef struct _RedfishAccountService_V1_3_2_Authentication_CS RedfishAccountService_V1_3_2_Authentication_CS;
typedef struct _RedfishAccountService_V1_3_2_ExternalAccountProvider_CS RedfishAccountService_V1_3_2_ExternalAccountProvider_CS;
typedef struct _RedfishAccountService_V1_3_2_LDAPSearchSettings_CS RedfishAccountService_V1_3_2_LDAPSearchSettings_CS;
typedef struct _RedfishAccountService_V1_3_2_LDAPService_CS RedfishAccountService_V1_3_2_LDAPService_CS;
typedef struct _RedfishAccountService_V1_3_2_OemActions_CS RedfishAccountService_V1_3_2_OemActions_CS;
typedef struct _RedfishAccountService_V1_3_2_RoleMapping_CS RedfishAccountService_V1_3_2_RoleMapping_CS;
...
//
typedef struct _RedfishAccountService_V1_3_2_Actions_CS {
    RedfishAccountService_V1_3_2_OemActions_CS    *Oem;    // This property contains the
                                                          // available OEM specific actions
                                                          // for this resource.
} RedfishAccountService_V1_3_2_Actions_CS;

//
// Contains the authentication information for the external service.
//
typedef struct _RedfishAccountService_V1_3_2_Authentication_CS {
    ...
    RedfishCS_char            *Username;             // This property contains the
                                                     ...
                                                     // service.
} RedfishAccountService_V1_3_2_Authentication_CS;

//
// A remote service that can provide accounts for this manager to utilize for
// authentication.
//
typedef struct _RedfishAccountService_V1_3_2_ExternalAccountProvider_CS {
    RedfishCS_char                                       *AccountProviderType;    // This property contains the
                                                                                 // type of external account
                                                                                 // provider this resource
                                                                                 // references.
    RedfishAccountService_V1_3_2_Authentication_CS       *Authentication;        // This property contains the
                                                                                 // authentication information for
                                                                                 // the external account provider.
    RedfishAccountService_V1_3_2_LDAPService_CS          *LDAPService;           // This property contains
                                                                                 // additional mapping information
                                                                                 // needed to parse a generic LDAP
                                                                                 // service.
    RedfishAccountService_V1_3_2_RoleMapping_Array_CS    *RemoteRoleMapping;     // This property contains a
    ...
    RedfishCS_bool                                       *ServiceEnabled;        // This indicates whether this
                                                                                 // service is enabled.
} RedfishAccountService_V1_3_2_ExternalAccountProvider_CS;

//
// Contains settings for searching a generic LDAP service.
//
typedef struct _RedfishAccountService_V1_3_2_LDAPSearchSettings_CS {
    ...
    RedfishCS_char          *UsernameAttribute;        // The attribute name that
                                                       ...
                                                       // user LDAP entry.
} RedfishAccountService_V1_3_2_LDAPSearchSettings_CS;

//
// Contains settings for parsing a generic LDAP service.
//
typedef struct _RedfishAccountService_V1_3_2_LDAPService_CS {
    RedfishResource_Oem_CS                                *Oem;              // Oem extension object.
    RedfishAccountService_V1_3_2_LDAPSearchSettings_CS    *SearchSettings;    // This property contains the
                                                                             // settings needed to search an
                                                                             // external LDAP service.
} RedfishAccountService_V1_3_2_LDAPService_CS;

//
// The available OEM specific actions for this resource.
//
typedef struct _RedfishAccountService_V1_3_2_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishAccountService_V1_3_2_OemActions_CS;

//
// Contains mapping rules to convert the external account providers account
// information to the local Redfish Role.
//
typedef struct _RedfishAccountService_V1_3_2_RoleMapping_CS {
    ...
    RedfishCS_char            *RemoteUser;    // This property is the name of
                                              ...
                                              // mapped to the local role
                                              // referenced by this entity.
} RedfishAccountService_V1_3_2_RoleMapping_CS;
...
//
typedef struct _RedfishAccountService_V1_3_2_AccountService_CS {
    ...
    RedfishCS_Link                                             Accounts;                             // A link to a collection of
                                                                                                     // Manager Accounts.
    RedfishAccountService_V1_3_2_Actions_CS                    *Actions;                             // The available actions for this
                                                                                                     // resource.
    RedfishAccountService_V1_3_2_ExternalAccountProvider_CS    *ActiveDirectory;                     // The first ActiveDirectory
    ...
    RedfishCS_char                                             *Id;                              
    RedfishAccountService_V1_3_2_ExternalAccountProvider_CS    *LDAP;                                // The first LDAP external
...
} RedfishAccountService_V1_3_2_AccountService_CS;

typedef struct _RedfishAccountService_V1_3_2_RoleMapping_Array_CS  {
    RedfishAccountService_V1_3_2_RoleMapping_Array_CS    *Next;
    RedfishAccountService_V1_3_2_RoleMapping_CS    *ArrayValue;
} RedfishAccountService_V1_3_2_RoleMapping_Array_CS;
...
RedfishCS_status
Json_AccountService_V1_3_2_To_CS (char *JsonRawText, RedfishAccountService_V1_3_2_AccountService_CS **ReturnedCS);

RedfishCS_status
CS_To_AccountService_V1_3_2_JSON (RedfishAccountService_V1_3_2_AccountService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAccountService_V1_3_2_CS (RedfishAccountService_V1_3_2_AccountService_CS *CSPtr);

RedfishCS_status
DestroyAccountService_V1_3_2_Json (RedfishCS_char *JsonText);
