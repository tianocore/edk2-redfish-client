...
#ifndef RedfishAttributeregistry_V1_0_9_CSTRUCT_H_
#define RedfishAttributeregistry_V1_0_9_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishAttributeRegistry_V1_0_9_AttributeValue_Array_CS RedfishAttributeRegistry_V1_0_9_AttributeValue_Array_CS;
typedef struct _RedfishAttributeRegistry_V1_0_9_MapFrom_Array_CS RedfishAttributeRegistry_V1_0_9_MapFrom_Array_CS;
typedef struct _RedfishAttributeRegistry_V1_0_9_Attributes_Array_CS RedfishAttributeRegistry_V1_0_9_Attributes_Array_CS;
typedef struct _RedfishAttributeRegistry_V1_0_9_Dependencies_Array_CS RedfishAttributeRegistry_V1_0_9_Dependencies_Array_CS;
typedef struct _RedfishAttributeRegistry_V1_0_9_Menus_Array_CS RedfishAttributeRegistry_V1_0_9_Menus_Array_CS;
typedef struct _RedfishAttributeRegistry_V1_0_9_SupportedSystems_Array_CS RedfishAttributeRegistry_V1_0_9_SupportedSystems_Array_CS;
typedef struct _RedfishAttributeRegistry_V1_0_9_AttributeRegistry_CS RedfishAttributeRegistry_V1_0_9_AttributeRegistry_CS;
typedef struct _RedfishAttributeRegistry_V1_0_9_AttributeValue_CS RedfishAttributeRegistry_V1_0_9_AttributeValue_CS;
typedef struct _RedfishAttributeRegistry_V1_0_9_Attributes_CS RedfishAttributeRegistry_V1_0_9_Attributes_CS;
typedef struct _RedfishAttributeRegistry_V1_0_9_Dependencies_CS RedfishAttributeRegistry_V1_0_9_Dependencies_CS;
typedef struct _RedfishAttributeRegistry_V1_0_9_Dependency_CS RedfishAttributeRegistry_V1_0_9_Dependency_CS;
typedef struct _RedfishAttributeRegistry_V1_0_9_MapFrom_CS RedfishAttributeRegistry_V1_0_9_MapFrom_CS;
typedef struct _RedfishAttributeRegistry_V1_0_9_Menus_CS RedfishAttributeRegistry_V1_0_9_Menus_CS;
typedef struct _RedfishAttributeRegistry_V1_0_9_RegistryEntries_CS RedfishAttributeRegistry_V1_0_9_RegistryEntries_CS;
typedef struct _RedfishAttributeRegistry_V1_0_9_SupportedSystems_CS RedfishAttributeRegistry_V1_0_9_SupportedSystems_CS;
...
typedef struct _RedfishAttributeRegistry_V1_0_9_Attributes_CS {
    ...
    RedfishCS_int64                                            *UpperBound;               // The upper limit for an integer
                                                                                          // attribute.
    RedfishAttributeRegistry_V1_0_9_AttributeValue_Array_CS    *Value;                    // An array of the possible
...
typedef struct _RedfishAttributeRegistry_V1_0_9_Dependencies_CS {
    RedfishAttributeRegistry_V1_0_9_Dependency_CS    *Dependency;      // The dependency expression for
...
typedef struct _RedfishAttributeRegistry_V1_0_9_Dependency_CS {
    RedfishAttributeRegistry_V1_0_9_MapFrom_Array_CS    *MapFrom;          // An array of the map-from
...
typedef struct _RedfishAttributeRegistry_V1_0_9_RegistryEntries_CS {
    RedfishAttributeRegistry_V1_0_9_Attributes_Array_CS      *Attributes;     // An array of attributes and
                                                                              // their possible values in the
                                                                              // attribute registry.
    RedfishAttributeRegistry_V1_0_9_Dependencies_Array_CS    *Dependencies;    // An array of dependencies of
                                                                              // attributes on this component.
    RedfishAttributeRegistry_V1_0_9_Menus_Array_CS           *Menus;          // An array for the attributes
...
typedef struct _RedfishAttributeRegistry_V1_0_9_AttributeRegistry_CS {
    ...
    RedfishCS_char                                               *OwningEntity;       // The organization or company
                                                                                      ...
                                                                                      // registry.
    RedfishAttributeRegistry_V1_0_9_RegistryEntries_CS           *RegistryEntries;    // The list of all attributes and
                                                                                      // their metadata for this
                                                                                      // component.
    RedfishCS_char                                               *RegistryVersion;    // The attribute registry
                                                                                      // version.
    RedfishAttributeRegistry_V1_0_9_SupportedSystems_Array_CS    *SupportedSystems;    // An array of systems that this
...
typedef struct _RedfishAttributeRegistry_V1_0_9_AttributeValue_Array_CS  {
    RedfishAttributeRegistry_V1_0_9_AttributeValue_Array_CS    *Next;
...
typedef struct _RedfishAttributeRegistry_V1_0_9_MapFrom_Array_CS  {
    RedfishAttributeRegistry_V1_0_9_MapFrom_Array_CS    *Next;
...
typedef struct _RedfishAttributeRegistry_V1_0_9_Attributes_Array_CS  {
    RedfishAttributeRegistry_V1_0_9_Attributes_Array_CS    *Next;
...
typedef struct _RedfishAttributeRegistry_V1_0_9_Dependencies_Array_CS  {
    RedfishAttributeRegistry_V1_0_9_Dependencies_Array_CS    *Next;
...
typedef struct _RedfishAttributeRegistry_V1_0_9_Menus_Array_CS  {
    RedfishAttributeRegistry_V1_0_9_Menus_Array_CS    *Next;
    RedfishAttributeRegistry_V1_0_9_Menus_CS    *ArrayValue;
} RedfishAttributeRegistry_V1_0_9_Menus_Array_CS;

typedef struct _RedfishAttributeRegistry_V1_0_9_SupportedSystems_Array_CS  {
    RedfishAttributeRegistry_V1_0_9_SupportedSystems_Array_CS    *Next;
    RedfishAttributeRegistry_V1_0_9_SupportedSystems_CS    *ArrayValue;
} RedfishAttributeRegistry_V1_0_9_SupportedSystems_Array_CS;

RedfishCS_status
Json_AttributeRegistry_V1_0_9_To_CS (char *JsonRawText, RedfishAttributeRegistry_V1_0_9_AttributeRegistry_CS **ReturnedCS);

RedfishCS_status
CS_To_AttributeRegistry_V1_0_9_JSON (RedfishAttributeRegistry_V1_0_9_AttributeRegistry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAttributeRegistry_V1_0_9_CS (RedfishAttributeRegistry_V1_0_9_AttributeRegistry_CS *CSPtr);

RedfishCS_status
DestroyAttributeRegistry_V1_0_9_Json (RedfishCS_char *JsonText);
