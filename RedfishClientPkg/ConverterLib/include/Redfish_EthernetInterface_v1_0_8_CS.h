...
#ifndef RedfishEthernetinterface_V1_0_8_CSTRUCT_H_
#define RedfishEthernetinterface_V1_0_8_CSTRUCT_H_
...
#endif
typedef struct _RedfishEthernetInterface_V1_0_8_IPv6AddressPolicyEntry_Array_CS RedfishEthernetInterface_V1_0_8_IPv6AddressPolicyEntry_Array_CS;
typedef struct _RedfishEthernetInterface_V1_0_8_EthernetInterface_CS RedfishEthernetInterface_V1_0_8_EthernetInterface_CS;
typedef struct _RedfishEthernetInterface_V1_0_8_IPv6AddressPolicyEntry_CS RedfishEthernetInterface_V1_0_8_IPv6AddressPolicyEntry_CS;
...
//
typedef struct _RedfishEthernetInterface_V1_0_8_IPv6AddressPolicyEntry_CS {
    ...
    RedfishCS_char     *Prefix;       // The IPv6 address prefix, as
                                      // defined in RFC6724, section
                                      // 2.1.
} RedfishEthernetInterface_V1_0_8_IPv6AddressPolicyEntry_CS;
...
//
typedef struct _RedfishEthernetInterface_V1_0_8_EthernetInterface_CS {
    ...
    RedfishEthernetInterface_V1_0_8_IPv6AddressPolicyEntry_Array_CS    *IPv6AddressPolicyTable;    // An array that represents the
...
} RedfishEthernetInterface_V1_0_8_EthernetInterface_CS;
...
typedef struct _RedfishEthernetInterface_V1_0_8_IPv6AddressPolicyEntry_Array_CS  {
    RedfishEthernetInterface_V1_0_8_IPv6AddressPolicyEntry_Array_CS    *Next;
    RedfishEthernetInterface_V1_0_8_IPv6AddressPolicyEntry_CS    *ArrayValue;
} RedfishEthernetInterface_V1_0_8_IPv6AddressPolicyEntry_Array_CS;

RedfishCS_status
Json_EthernetInterface_V1_0_8_To_CS (char *JsonRawText, RedfishEthernetInterface_V1_0_8_EthernetInterface_CS **ReturnedCS);

RedfishCS_status
CS_To_EthernetInterface_V1_0_8_JSON (RedfishEthernetInterface_V1_0_8_EthernetInterface_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEthernetInterface_V1_0_8_CS (RedfishEthernetInterface_V1_0_8_EthernetInterface_CS *CSPtr);

RedfishCS_status
DestroyEthernetInterface_V1_0_8_Json (RedfishCS_char *JsonText);
