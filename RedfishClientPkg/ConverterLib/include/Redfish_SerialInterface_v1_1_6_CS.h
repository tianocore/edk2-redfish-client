...
#ifndef RedfishSerialinterface_V1_1_6_CSTRUCT_H_
#define RedfishSerialinterface_V1_1_6_CSTRUCT_H_
...
typedef struct _RedfishSerialInterface_V1_1_6_Actions_CS RedfishSerialInterface_V1_1_6_Actions_CS;
typedef struct _RedfishSerialInterface_V1_1_6_OemActions_CS RedfishSerialInterface_V1_1_6_OemActions_CS;
typedef struct _RedfishSerialInterface_V1_1_6_SerialInterface_CS RedfishSerialInterface_V1_1_6_SerialInterface_CS;
//
// The OEM extension.
//
#ifndef RedfishResource_Oem_CS_
...
typedef struct _RedfishSerialInterface_V1_1_6_Actions_CS {
    RedfishSerialInterface_V1_1_6_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishSerialInterface_V1_1_6_SerialInterface_CS {
    ...
    RedfishSerialInterface_V1_1_6_Actions_CS    *Actions;            // The available actions for this
                                                                     // resource.
...
RedfishCS_status
Json_SerialInterface_V1_1_6_To_CS (char *JsonRawText, RedfishSerialInterface_V1_1_6_SerialInterface_CS **ReturnedCS);

RedfishCS_status
CS_To_SerialInterface_V1_1_6_JSON (RedfishSerialInterface_V1_1_6_SerialInterface_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroySerialInterface_V1_1_6_CS (RedfishSerialInterface_V1_1_6_SerialInterface_CS *CSPtr);

RedfishCS_status
DestroySerialInterface_V1_1_6_Json (RedfishCS_char *JsonText);
