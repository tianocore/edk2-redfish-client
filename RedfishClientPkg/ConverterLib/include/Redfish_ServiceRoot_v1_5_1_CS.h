...
#ifndef RedfishServiceroot_V1_5_1_CSTRUCT_H_
#define RedfishServiceroot_V1_5_1_CSTRUCT_H_
...
typedef struct _RedfishServiceRoot_V1_5_1_Expand_CS RedfishServiceRoot_V1_5_1_Expand_CS;
typedef struct _RedfishServiceRoot_V1_5_1_Links_CS RedfishServiceRoot_V1_5_1_Links_CS;
typedef struct _RedfishServiceRoot_V1_5_1_ProtocolFeaturesSupported_CS RedfishServiceRoot_V1_5_1_ProtocolFeaturesSupported_CS;
typedef struct _RedfishServiceRoot_V1_5_1_ServiceRoot_CS RedfishServiceRoot_V1_5_1_ServiceRoot_CS;
//
// The OEM extension.
//
#ifndef RedfishResource_Oem_CS_
...
typedef struct _RedfishServiceRoot_V1_5_1_ProtocolFeaturesSupported_CS {
    RedfishCS_bool                         *ExcerptQuery;      // This indicates whether the
                                                               ...
                                                               // supported.
    RedfishServiceRoot_V1_5_1_Expand_CS    *ExpandQuery;       // Contains information about the
...
typedef struct _RedfishServiceRoot_V1_5_1_ServiceRoot_CS {
    ...
    RedfishCS_Link                                            AccountService;               // This is a link to the Account
                                                                                            // Service.
    RedfishCS_Link                                            CertificateService;           // This is a link to the
                                                                                            // CertificateService.
    ...
    RedfishServiceRoot_V1_5_1_Links_CS                        *Links;                       // Contains references to other
    ...
    RedfishServiceRoot_V1_5_1_ProtocolFeaturesSupported_CS    *ProtocolFeaturesSupported;    // Contains information about
    ...
    RedfishCS_Link                                            Registries;                   // This is a link to a collection
                                                                                            // of Registries.
    RedfishCS_Link                                            ResourceBlocks;               // A link to a collection of all
                                                                                            // resource block entities.  This
                                                                                            // collection is intended for
                                                                                            // implementations that do not
                                                                                            // contain a Composition Service,
                                                                                            // but will expose resources to
                                                                                            // an orchestrator that
                                                                                            // implements a Composition
                                                                                            // Service.
...
RedfishCS_status
Json_ServiceRoot_V1_5_1_To_CS (char *JsonRawText, RedfishServiceRoot_V1_5_1_ServiceRoot_CS **ReturnedCS);

RedfishCS_status
CS_To_ServiceRoot_V1_5_1_JSON (RedfishServiceRoot_V1_5_1_ServiceRoot_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyServiceRoot_V1_5_1_CS (RedfishServiceRoot_V1_5_1_ServiceRoot_CS *CSPtr);

RedfishCS_status
DestroyServiceRoot_V1_5_1_Json (RedfishCS_char *JsonText);
