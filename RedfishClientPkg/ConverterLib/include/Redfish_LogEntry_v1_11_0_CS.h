...
#ifndef RedfishLogentry_V1_11_0_CSTRUCT_H_
#define RedfishLogentry_V1_11_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishLogEntry_V1_11_0_Actions_CS RedfishLogEntry_V1_11_0_Actions_CS;
typedef struct _RedfishLogEntry_V1_11_0_Links_CS RedfishLogEntry_V1_11_0_Links_CS;
typedef struct _RedfishLogEntry_V1_11_0_LogEntry_CS RedfishLogEntry_V1_11_0_LogEntry_CS;
typedef struct _RedfishLogEntry_V1_11_0_OemActions_CS RedfishLogEntry_V1_11_0_OemActions_CS;
...
typedef struct _RedfishLogEntry_V1_11_0_Actions_CS {
    RedfishLogEntry_V1_11_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishLogEntry_V1_11_0_LogEntry_CS {
    ...
    RedfishLogEntry_V1_11_0_Actions_CS    *Actions;                   // The available actions for this
                                                                      // resource.
    ...
    RedfishCS_char                        *GeneratorId;               // An identifier of the device
                                                                      ...
                                                                      // SEL Event Record.
    RedfishCS_char                        *Id;                    
    RedfishLogEntry_V1_11_0_Links_CS      *Links;                     // The links to other resources
    ...
    RedfishCS_char                        *Originator;                // The source of the log entry.
    RedfishCS_char                        *OriginatorType;            // The type of originator data.
...
RedfishCS_status
Json_LogEntry_V1_11_0_To_CS (char *JsonRawText, RedfishLogEntry_V1_11_0_LogEntry_CS **ReturnedCS);

RedfishCS_status
CS_To_LogEntry_V1_11_0_JSON (RedfishLogEntry_V1_11_0_LogEntry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyLogEntry_V1_11_0_CS (RedfishLogEntry_V1_11_0_LogEntry_CS *CSPtr);

RedfishCS_status
DestroyLogEntry_V1_11_0_Json (RedfishCS_char *JsonText);
