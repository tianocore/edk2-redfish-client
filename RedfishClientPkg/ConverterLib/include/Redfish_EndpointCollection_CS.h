...
#ifndef RedfishEndpointcollection_Noversioned_CSTRUCT_H_
#define RedfishEndpointcollection_Noversioned_CSTRUCT_H_
...
//
// The collection of Endpoint resource instances.
//
