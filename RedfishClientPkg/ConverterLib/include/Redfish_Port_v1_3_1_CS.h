...
#ifndef RedfishPort_V1_3_1_CSTRUCT_H_
#define RedfishPort_V1_3_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishPort_V1_3_1_ConfiguredNetworkLink_Array_CS RedfishPort_V1_3_1_ConfiguredNetworkLink_Array_CS;
typedef struct _RedfishPort_V1_3_1_LinkConfiguration_Array_CS RedfishPort_V1_3_1_LinkConfiguration_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishPort_V1_3_1_Actions_CS RedfishPort_V1_3_1_Actions_CS;
typedef struct _RedfishPort_V1_3_1_ConfiguredNetworkLink_CS RedfishPort_V1_3_1_ConfiguredNetworkLink_CS;
typedef struct _RedfishPort_V1_3_1_EthernetProperties_CS RedfishPort_V1_3_1_EthernetProperties_CS;
typedef struct _RedfishPort_V1_3_1_FibreChannelProperties_CS RedfishPort_V1_3_1_FibreChannelProperties_CS;
typedef struct _RedfishPort_V1_3_1_GenZ_CS RedfishPort_V1_3_1_GenZ_CS;
typedef struct _RedfishPort_V1_3_1_LinkConfiguration_CS RedfishPort_V1_3_1_LinkConfiguration_CS;
typedef struct _RedfishPort_V1_3_1_Links_CS RedfishPort_V1_3_1_Links_CS;
typedef struct _RedfishPort_V1_3_1_OemActions_CS RedfishPort_V1_3_1_OemActions_CS;
typedef struct _RedfishPort_V1_3_1_Port_CS RedfishPort_V1_3_1_Port_CS;
typedef struct _RedfishPort_V1_3_1_Reset_CS RedfishPort_V1_3_1_Reset_CS;
...
typedef struct _RedfishPort_V1_3_1_Actions_CS {
    ...
    RedfishPort_V1_3_1_OemActions_CS    *Oem;          // The available OEM-specific
...
typedef struct _RedfishPort_V1_3_1_LinkConfiguration_CS {
    ...
    RedfishPort_V1_3_1_ConfiguredNetworkLink_Array_CS    *ConfiguredNetworkLinks;        // The set of link speed and
...
typedef struct _RedfishPort_V1_3_1_Port_CS {
    ...
    RedfishPort_V1_3_1_Actions_CS                    *Actions;                   // The available actions for this
                                                                                 // resource.
    ...
    RedfishPort_V1_3_1_EthernetProperties_CS         *Ethernet;                  // Ethernet properties for this
                                                                                 // port.
    RedfishPort_V1_3_1_FibreChannelProperties_CS     *FibreChannel;              // Fibre Channel properties for
                                                                                 // this port.
    RedfishPort_V1_3_1_GenZ_CS                       *GenZ;                      // Gen-Z specific properties.
    RedfishCS_char                                   *Id;                    
    RedfishCS_bool                                   *InterfaceEnabled;          // An indication of whether the
                                                                                 // interface is enabled.
    RedfishPort_V1_3_1_LinkConfiguration_Array_CS    *LinkConfiguration;         // The link configuration of this
                                                                                 // port.
    ...
    RedfishCS_int64                                  *LinkTransitionIndicator;    // The number of link state
                                                                                 ...
                                                                                 // interface.
    RedfishPort_V1_3_1_Links_CS                      *Links;                     // The links to other resources
...
typedef struct _RedfishPort_V1_3_1_ConfiguredNetworkLink_Array_CS  {
    RedfishPort_V1_3_1_ConfiguredNetworkLink_Array_CS    *Next;
    RedfishPort_V1_3_1_ConfiguredNetworkLink_CS    *ArrayValue;
} RedfishPort_V1_3_1_ConfiguredNetworkLink_Array_CS;

typedef struct _RedfishPort_V1_3_1_LinkConfiguration_Array_CS  {
    RedfishPort_V1_3_1_LinkConfiguration_Array_CS    *Next;
    RedfishPort_V1_3_1_LinkConfiguration_CS    *ArrayValue;
} RedfishPort_V1_3_1_LinkConfiguration_Array_CS;
...
RedfishCS_status
Json_Port_V1_3_1_To_CS (char *JsonRawText, RedfishPort_V1_3_1_Port_CS **ReturnedCS);

RedfishCS_status
CS_To_Port_V1_3_1_JSON (RedfishPort_V1_3_1_Port_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPort_V1_3_1_CS (RedfishPort_V1_3_1_Port_CS *CSPtr);

RedfishCS_status
DestroyPort_V1_3_1_Json (RedfishCS_char *JsonText);
