...
#ifndef RedfishProcessor_V1_9_0_CSTRUCT_H_
#define RedfishProcessor_V1_9_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishProcessor_V1_9_0_ProcessorInterface_Array_CS RedfishProcessor_V1_9_0_ProcessorInterface_Array_CS;
typedef struct _RedfishProcessor_V1_9_0_FpgaReconfigurationSlot_Array_CS RedfishProcessor_V1_9_0_FpgaReconfigurationSlot_Array_CS;
typedef struct _RedfishProcessor_V1_9_0_ProcessorMemory_Array_CS RedfishProcessor_V1_9_0_ProcessorMemory_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishProcessor_V1_9_0_Actions_CS RedfishProcessor_V1_9_0_Actions_CS;
typedef struct _RedfishProcessor_V1_9_0_EthernetInterface_CS RedfishProcessor_V1_9_0_EthernetInterface_CS;
typedef struct _RedfishProcessor_V1_9_0_FPGA_CS RedfishProcessor_V1_9_0_FPGA_CS;
typedef struct _RedfishProcessor_V1_9_0_FpgaReconfigurationSlot_CS RedfishProcessor_V1_9_0_FpgaReconfigurationSlot_CS;
typedef struct _RedfishProcessor_V1_9_0_Links_CS RedfishProcessor_V1_9_0_Links_CS;
typedef struct _RedfishProcessor_V1_9_0_OemActions_CS RedfishProcessor_V1_9_0_OemActions_CS;
typedef struct _RedfishProcessor_V1_9_0_Processor_CS RedfishProcessor_V1_9_0_Processor_CS;
typedef struct _RedfishProcessor_V1_9_0_ProcessorId_CS RedfishProcessor_V1_9_0_ProcessorId_CS;
typedef struct _RedfishProcessor_V1_9_0_ProcessorInterface_CS RedfishProcessor_V1_9_0_ProcessorInterface_CS;
typedef struct _RedfishProcessor_V1_9_0_ProcessorMemory_CS RedfishProcessor_V1_9_0_ProcessorMemory_CS;
typedef struct _RedfishProcessor_V1_9_0_Reset_CS RedfishProcessor_V1_9_0_Reset_CS;
...
//
typedef struct _RedfishProcessor_V1_9_0_Actions_CS {
    RedfishProcessor_V1_9_0_Reset_CS         *Processor_Reset;
    RedfishProcessor_V1_9_0_OemActions_CS    *Oem;               // The available OEM-specific
                                                                 // actions for this resource.
} RedfishProcessor_V1_9_0_Actions_CS;

//
// This type defines an Ethernet interface.
//
typedef struct _RedfishProcessor_V1_9_0_EthernetInterface_CS {
...
} RedfishProcessor_V1_9_0_EthernetInterface_CS;

//
// The properties of the FPGA device.
//
typedef struct _RedfishProcessor_V1_9_0_FPGA_CS {
    RedfishProcessor_V1_9_0_ProcessorInterface_Array_CS         *ExternalInterfaces;     // An array of the FPGA external
                                                                                         // interfaces.
    ...
    RedfishProcessor_V1_9_0_ProcessorInterface_CS               *HostInterface;          // The FPGA interface to the
                                                                                         // host.
    ...
    RedfishProcessor_V1_9_0_FpgaReconfigurationSlot_Array_CS    *ReconfigurationSlots;    // An array of the FPGA
                                                                                         ...
                                                                                         // provisioned.
} RedfishProcessor_V1_9_0_FPGA_CS;
...
typedef struct _RedfishProcessor_V1_9_0_ProcessorInterface_CS {
    RedfishProcessor_V1_9_0_EthernetInterface_CS    *Ethernet;        // The Ethernet-related
...
typedef struct _RedfishProcessor_V1_9_0_Processor_CS {
    ...
    RedfishCS_Link                                      AccelerationFunctions;     // The link to the collection of
                                                                                   ...
                                                                                   // associated with this
                                                                                   // processor.
    RedfishProcessor_V1_9_0_Actions_CS                  *Actions;                  // The available actions for this
                                                                                   // resource.
    ...
    RedfishProcessor_V1_9_0_FPGA_CS                     *FPGA;                     // The properties for processors
                                                                                   // of the FPGA type.
    ...
    RedfishCS_char                                      *InstructionSet;           // The instruction set of the
                                                                                   // processor.
    RedfishProcessor_V1_9_0_Links_CS                    *Links;                    // The links to other resources
    ...
    RedfishCS_char                                      *ProcessorArchitecture;    // The architecture of the
                                                                                   // processor.
    RedfishProcessor_V1_9_0_ProcessorId_CS              *ProcessorId;              // The identification information
                                                                                   // for this processor.
    RedfishProcessor_V1_9_0_ProcessorMemory_Array_CS    *ProcessorMemory;          // The memory directly attached
    ...
    RedfishCS_Link                                      SubProcessors;             // The link to the collection of
                                                                                   ...
                                                                                   // processor.
    RedfishProcessor_V1_9_0_ProcessorInterface_CS       *SystemInterface;          // The interface between the
...
typedef struct _RedfishProcessor_V1_9_0_ProcessorInterface_Array_CS  {
    RedfishProcessor_V1_9_0_ProcessorInterface_Array_CS    *Next;
...
typedef struct _RedfishProcessor_V1_9_0_FpgaReconfigurationSlot_Array_CS  {
    RedfishProcessor_V1_9_0_FpgaReconfigurationSlot_Array_CS    *Next;
    RedfishProcessor_V1_9_0_FpgaReconfigurationSlot_CS    *ArrayValue;
} RedfishProcessor_V1_9_0_FpgaReconfigurationSlot_Array_CS;

typedef struct _RedfishProcessor_V1_9_0_ProcessorMemory_Array_CS  {
    RedfishProcessor_V1_9_0_ProcessorMemory_Array_CS    *Next;
    RedfishProcessor_V1_9_0_ProcessorMemory_CS    *ArrayValue;
} RedfishProcessor_V1_9_0_ProcessorMemory_Array_CS;
...
RedfishCS_status
Json_Processor_V1_9_0_To_CS (char *JsonRawText, RedfishProcessor_V1_9_0_Processor_CS **ReturnedCS);

RedfishCS_status
CS_To_Processor_V1_9_0_JSON (RedfishProcessor_V1_9_0_Processor_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyProcessor_V1_9_0_CS (RedfishProcessor_V1_9_0_Processor_CS *CSPtr);

RedfishCS_status
DestroyProcessor_V1_9_0_Json (RedfishCS_char *JsonText);
