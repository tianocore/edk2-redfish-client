...
#ifndef RedfishLogentry_V1_5_1_CSTRUCT_H_
#define RedfishLogentry_V1_5_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishLogEntry_V1_5_1_Actions_CS RedfishLogEntry_V1_5_1_Actions_CS;
typedef struct _RedfishLogEntry_V1_5_1_Links_CS RedfishLogEntry_V1_5_1_Links_CS;
typedef struct _RedfishLogEntry_V1_5_1_LogEntry_CS RedfishLogEntry_V1_5_1_LogEntry_CS;
typedef struct _RedfishLogEntry_V1_5_1_OemActions_CS RedfishLogEntry_V1_5_1_OemActions_CS;
...
//
typedef struct _RedfishLogEntry_V1_5_1_Actions_CS {
    RedfishLogEntry_V1_5_1_OemActions_CS    *Oem;    // The available OEM-specific
                                                    // actions for this Resource.
} RedfishLogEntry_V1_5_1_Actions_CS;

//
// The links to other Resources that are related to this Resource.
//
typedef struct _RedfishLogEntry_V1_5_1_Links_CS {
    RedfishResource_Oem_CS     *Oem;                 // The OEM extension property.
    Redfishodatav4_idRef_CS    *OriginOfCondition;    // The URI of the Resource that
                                                     // caused the log entry.
} RedfishLogEntry_V1_5_1_Links_CS;

//
// The available OEM-specific actions for this Resource.
//
typedef struct _RedfishLogEntry_V1_5_1_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishLogEntry_V1_5_1_OemActions_CS;
...
//
typedef struct _RedfishLogEntry_V1_5_1_LogEntry_CS {
    RedfishCS_Header                     Header;
    RedfishCS_char                       *odata_context; 
    RedfishCS_char                       *odata_etag;    
    RedfishCS_char                       *odata_id;      
    RedfishCS_char                       *odata_type;    
    RedfishLogEntry_V1_5_1_Actions_CS    *Actions;           // The available actions for this
                                                             // Resource.
    ...
    RedfishCS_char                       *GeneratorId;       // An identifier of the device
                                                             ...
                                                             // SEL Event Record.
    RedfishCS_char                       *Id;            
    RedfishLogEntry_V1_5_1_Links_CS      *Links;             // The links to other Resources
...
} RedfishLogEntry_V1_5_1_LogEntry_CS;

RedfishCS_status
Json_LogEntry_V1_5_1_To_CS (char *JsonRawText, RedfishLogEntry_V1_5_1_LogEntry_CS **ReturnedCS);

RedfishCS_status
CS_To_LogEntry_V1_5_1_JSON (RedfishLogEntry_V1_5_1_LogEntry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyLogEntry_V1_5_1_CS (RedfishLogEntry_V1_5_1_LogEntry_CS *CSPtr);

RedfishCS_status
DestroyLogEntry_V1_5_1_Json (RedfishCS_char *JsonText);
