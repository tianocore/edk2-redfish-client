...
#ifndef RedfishResourceblock_V1_4_0_CSTRUCT_H_
#define RedfishResourceblock_V1_4_0_CSTRUCT_H_
...
typedef struct _RedfishResourceBlock_V1_4_0_Actions_CS RedfishResourceBlock_V1_4_0_Actions_CS;
typedef struct _RedfishResourceBlock_V1_4_0_CompositionStatus_CS RedfishResourceBlock_V1_4_0_CompositionStatus_CS;
typedef struct _RedfishResourceBlock_V1_4_0_Links_CS RedfishResourceBlock_V1_4_0_Links_CS;
typedef struct _RedfishResourceBlock_V1_4_0_OemActions_CS RedfishResourceBlock_V1_4_0_OemActions_CS;
typedef struct _RedfishResourceBlock_V1_4_0_ResourceBlock_CS RedfishResourceBlock_V1_4_0_ResourceBlock_CS;
typedef struct _RedfishResourceBlock_V1_4_0_ResourceBlockLimits_CS RedfishResourceBlock_V1_4_0_ResourceBlockLimits_CS;
...
typedef struct _RedfishResourceBlock_V1_4_0_Actions_CS {
    RedfishResourceBlock_V1_4_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishResourceBlock_V1_4_0_Links_CS {
    ...
    RedfishCS_Link            ConsumingResourceBlocks;               // An array of links to resource
                                                                     // blocks that depend on this
                                                                     // resource block.
    RedfishCS_int64           *ConsumingResourceBlocksodata_count;
    RedfishResource_Oem_CS    *Oem;                                  // The OEM extension property.
    RedfishCS_Link            SupplyingResourceBlocks;               // An array of links to resource
                                                                     // blocks that this resource
                                                                     // block depends on.
...
typedef struct _RedfishResourceBlock_V1_4_0_ResourceBlock_CS {
    ...
    RedfishResourceBlock_V1_4_0_Actions_CS              *Actions;                         // The available actions for this
                                                                                          // resource.
    RedfishCS_char                                      *Client;                          // The client to which this
                                                                                          // resource block is assigned.
    RedfishResourceBlock_V1_4_0_CompositionStatus_CS    *CompositionStatus;               // The composition status details
    ...
    RedfishCS_char                                      *Id;                          
    RedfishResourceBlock_V1_4_0_Links_CS                *Links;                           // The links to other resources
    ...
    RedfishResource_Oem_CS                              *Oem;                             // The OEM extension property.
    RedfishCS_char                                      *Pool;                            // The pool to which this
                                                                                          // resource block belongs.
...
RedfishCS_status
Json_ResourceBlock_V1_4_0_To_CS (char *JsonRawText, RedfishResourceBlock_V1_4_0_ResourceBlock_CS **ReturnedCS);

RedfishCS_status
CS_To_ResourceBlock_V1_4_0_JSON (RedfishResourceBlock_V1_4_0_ResourceBlock_CS *CSPtr, char **JsonText);
