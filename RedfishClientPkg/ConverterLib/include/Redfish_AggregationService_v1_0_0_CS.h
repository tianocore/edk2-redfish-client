...
#ifndef RedfishAggregationservice_V1_0_0_CSTRUCT_H_
#define RedfishAggregationservice_V1_0_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishAggregationService_V1_0_0_Actions_CS RedfishAggregationService_V1_0_0_Actions_CS;
typedef struct _RedfishAggregationService_V1_0_0_AggregationService_CS RedfishAggregationService_V1_0_0_AggregationService_CS;
typedef struct _RedfishAggregationService_V1_0_0_OemActions_CS RedfishAggregationService_V1_0_0_OemActions_CS;
typedef struct _RedfishAggregationService_V1_0_0_Reset_CS RedfishAggregationService_V1_0_0_Reset_CS;
typedef struct _RedfishAggregationService_V1_0_0_SetDefaultBootOrder_CS RedfishAggregationService_V1_0_0_SetDefaultBootOrder_CS;
...
typedef struct _RedfishAggregationService_V1_0_0_Actions_CS {
    ...
    RedfishAggregationService_V1_0_0_OemActions_CS             *Oem;                                      // The available OEM-specific
...
typedef struct _RedfishAggregationService_V1_0_0_AggregationService_CS {
    ...
    RedfishAggregationService_V1_0_0_Actions_CS    *Actions;             // The available actions for this
                                                                         // resource.
...
RedfishCS_status
Json_AggregationService_V1_0_0_To_CS (char *JsonRawText, RedfishAggregationService_V1_0_0_AggregationService_CS **ReturnedCS);

RedfishCS_status
CS_To_AggregationService_V1_0_0_JSON (RedfishAggregationService_V1_0_0_AggregationService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAggregationService_V1_0_0_CS (RedfishAggregationService_V1_0_0_AggregationService_CS *CSPtr);

RedfishCS_status
DestroyAggregationService_V1_0_0_Json (RedfishCS_char *JsonText);
