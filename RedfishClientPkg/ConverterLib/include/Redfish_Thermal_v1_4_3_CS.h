...
#ifndef RedfishThermal_V1_4_3_CSTRUCT_H_
#define RedfishThermal_V1_4_3_CSTRUCT_H_
...
#endif
typedef struct _RedfishThermal_V1_4_3_Fan_Array_CS RedfishThermal_V1_4_3_Fan_Array_CS;
typedef struct _RedfishThermal_V1_4_3_Temperature_Array_CS RedfishThermal_V1_4_3_Temperature_Array_CS;
...
typedef struct _RedfishThermal_V1_4_3_Fan_CS RedfishThermal_V1_4_3_Fan_CS;
typedef struct _RedfishThermal_V1_4_3_FanActions_CS RedfishThermal_V1_4_3_FanActions_CS;
typedef struct _RedfishThermal_V1_4_3_FanOemActions_CS RedfishThermal_V1_4_3_FanOemActions_CS;
typedef struct _RedfishThermal_V1_4_3_Temperature_CS RedfishThermal_V1_4_3_Temperature_CS;
typedef struct _RedfishThermal_V1_4_3_TemperatureActions_CS RedfishThermal_V1_4_3_TemperatureActions_CS;
typedef struct _RedfishThermal_V1_4_3_TemperatureOemActions_CS RedfishThermal_V1_4_3_TemperatureOemActions_CS;
typedef struct _RedfishThermal_V1_4_3_Thermal_CS RedfishThermal_V1_4_3_Thermal_CS;
typedef struct _RedfishThermal_V1_4_3_ThermalActions_CS RedfishThermal_V1_4_3_ThermalActions_CS;
typedef struct _RedfishThermal_V1_4_3_ThermalOemActions_CS RedfishThermal_V1_4_3_ThermalOemActions_CS;
...
typedef struct _RedfishThermal_V1_4_3_Fan_CS {
    ...
    RedfishThermal_V1_4_3_FanActions_CS    *Actions;                     // The available actions for this
                                                                         // resource.
...
typedef struct _RedfishThermal_V1_4_3_FanActions_CS {
    RedfishThermal_V1_4_3_FanOemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishThermal_V1_4_3_Temperature_CS {
    RedfishCS_char                                 *odata_id;                         
    RedfishThermal_V1_4_3_TemperatureActions_CS    *Actions;                              // The available actions for this
                                                                                          // resource.
...
typedef struct _RedfishThermal_V1_4_3_TemperatureActions_CS {
    RedfishThermal_V1_4_3_TemperatureOemActions_CS    *Oem;    // This property contains the
                                                              // available OEM specific actions
                                                              // for this resource.
...
typedef struct _RedfishThermal_V1_4_3_ThermalActions_CS {
    RedfishThermal_V1_4_3_ThermalOemActions_CS    *Oem;    // This property contains the
                                                          // available OEM specific actions
                                                          // for this resource.
...
typedef struct _RedfishThermal_V1_4_3_Thermal_CS {
    ...
    RedfishThermal_V1_4_3_ThermalActions_CS       *Actions;                   // The available actions for this
                                                                              // resource.
    RedfishCS_char                                *Description;           
    RedfishThermal_V1_4_3_Fan_Array_CS            *Fans;                      // This is the definition for
                                                                              // fans.
    ...
    RedfishResource_Status_CS                     *Status;                    // This property describes the
                                                                              // status and health of the
                                                                              // resource and its children.
    RedfishThermal_V1_4_3_Temperature_Array_CS    *Temperatures;              // This is the definition for
                                                                              // temperature sensors.
...
typedef struct _RedfishThermal_V1_4_3_Fan_Array_CS  {
    RedfishThermal_V1_4_3_Fan_Array_CS    *Next;
    RedfishThermal_V1_4_3_Fan_CS    *ArrayValue;
} RedfishThermal_V1_4_3_Fan_Array_CS;

typedef struct _RedfishThermal_V1_4_3_Temperature_Array_CS  {
    RedfishThermal_V1_4_3_Temperature_Array_CS    *Next;
    RedfishThermal_V1_4_3_Temperature_CS    *ArrayValue;
} RedfishThermal_V1_4_3_Temperature_Array_CS;

RedfishCS_status
Json_Thermal_V1_4_3_To_CS (char *JsonRawText, RedfishThermal_V1_4_3_Thermal_CS **ReturnedCS);

RedfishCS_status
CS_To_Thermal_V1_4_3_JSON (RedfishThermal_V1_4_3_Thermal_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyThermal_V1_4_3_CS (RedfishThermal_V1_4_3_Thermal_CS *CSPtr);

RedfishCS_status
DestroyThermal_V1_4_3_Json (RedfishCS_char *JsonText);
