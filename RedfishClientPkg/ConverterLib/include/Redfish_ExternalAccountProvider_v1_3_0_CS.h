...
#ifndef RedfishExternalaccountprovider_V1_3_0_CSTRUCT_H_
#define RedfishExternalaccountprovider_V1_3_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishExternalAccountProvider_V1_3_0_RoleMapping_Array_CS RedfishExternalAccountProvider_V1_3_0_RoleMapping_Array_CS;
typedef struct _RedfishExternalAccountProvider_V1_3_0_Actions_CS RedfishExternalAccountProvider_V1_3_0_Actions_CS;
typedef struct _RedfishExternalAccountProvider_V1_3_0_Authentication_CS RedfishExternalAccountProvider_V1_3_0_Authentication_CS;
typedef struct _RedfishExternalAccountProvider_V1_3_0_ExternalAccountProvider_CS RedfishExternalAccountProvider_V1_3_0_ExternalAccountProvider_CS;
typedef struct _RedfishExternalAccountProvider_V1_3_0_LDAPSearchSettings_CS RedfishExternalAccountProvider_V1_3_0_LDAPSearchSettings_CS;
typedef struct _RedfishExternalAccountProvider_V1_3_0_LDAPService_CS RedfishExternalAccountProvider_V1_3_0_LDAPService_CS;
typedef struct _RedfishExternalAccountProvider_V1_3_0_Links_CS RedfishExternalAccountProvider_V1_3_0_Links_CS;
typedef struct _RedfishExternalAccountProvider_V1_3_0_OAuth2Service_CS RedfishExternalAccountProvider_V1_3_0_OAuth2Service_CS;
typedef struct _RedfishExternalAccountProvider_V1_3_0_OemActions_CS RedfishExternalAccountProvider_V1_3_0_OemActions_CS;
typedef struct _RedfishExternalAccountProvider_V1_3_0_RoleMapping_CS RedfishExternalAccountProvider_V1_3_0_RoleMapping_CS;
typedef struct _RedfishExternalAccountProvider_V1_3_0_TACACSplusService_CS RedfishExternalAccountProvider_V1_3_0_TACACSplusService_CS;
...
typedef struct _RedfishExternalAccountProvider_V1_3_0_Actions_CS {
    RedfishExternalAccountProvider_V1_3_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishExternalAccountProvider_V1_3_0_LDAPService_CS {
    RedfishResource_Oem_CS                                         *Oem;              // The OEM extension property.
    RedfishExternalAccountProvider_V1_3_0_LDAPSearchSettings_CS    *SearchSettings;    // The required settings to
...
typedef struct _RedfishExternalAccountProvider_V1_3_0_ExternalAccountProvider_CS {
    ...
    RedfishCS_char                                                *AccountProviderType;    // The type of external account
                                                                                          ...
                                                                                          // connects.
    RedfishExternalAccountProvider_V1_3_0_Actions_CS              *Actions;               // The available actions for this
                                                                                          // resource.
    RedfishExternalAccountProvider_V1_3_0_Authentication_CS       *Authentication;        // The authentication information
    ...
    RedfishCS_char                                                *Id;                
    RedfishExternalAccountProvider_V1_3_0_LDAPService_CS          *LDAPService;           // The additional mapping
                                                                                          // information needed to parse a
                                                                                          // generic LDAP service.
    RedfishExternalAccountProvider_V1_3_0_Links_CS                *Links;                 // The links to other resources
                                                                                          // that are related to this
                                                                                          // resource.
    RedfishCS_char                                                *Name;              
    RedfishExternalAccountProvider_V1_3_0_OAuth2Service_CS        *OAuth2Service;         // The additional information
    ...
    RedfishCS_int64                                               *Priority;              // The authentication priority
                                                                                          // for the external account
                                                                                          // provider.
    RedfishExternalAccountProvider_V1_3_0_RoleMapping_Array_CS    *RemoteRoleMapping;     // The mapping rules to convert
    ...
    RedfishCS_bool                                                *ServiceEnabled;        // An indication of whether this
                                                                                          // service is enabled.
    RedfishExternalAccountProvider_V1_3_0_TACACSplusService_CS    *TACACSplusService;     // The additional information
                                                                                          // needed to parse a TACACS+
                                                                                          // services.
} RedfishExternalAccountProvider_V1_3_0_ExternalAccountProvider_CS;

typedef struct _RedfishExternalAccountProvider_V1_3_0_RoleMapping_Array_CS  {
    RedfishExternalAccountProvider_V1_3_0_RoleMapping_Array_CS    *Next;
    RedfishExternalAccountProvider_V1_3_0_RoleMapping_CS    *ArrayValue;
} RedfishExternalAccountProvider_V1_3_0_RoleMapping_Array_CS;

RedfishCS_status
Json_ExternalAccountProvider_V1_3_0_To_CS (char *JsonRawText, RedfishExternalAccountProvider_V1_3_0_ExternalAccountProvider_CS **ReturnedCS);

RedfishCS_status
CS_To_ExternalAccountProvider_V1_3_0_JSON (RedfishExternalAccountProvider_V1_3_0_ExternalAccountProvider_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyExternalAccountProvider_V1_3_0_CS (RedfishExternalAccountProvider_V1_3_0_ExternalAccountProvider_CS *CSPtr);

RedfishCS_status
DestroyExternalAccountProvider_V1_3_0_Json (RedfishCS_char *JsonText);
