...
#ifndef RedfishServiceroot_V1_2_4_CSTRUCT_H_
#define RedfishServiceroot_V1_2_4_CSTRUCT_H_
...
typedef struct _RedfishServiceRoot_V1_2_4_Links_CS RedfishServiceRoot_V1_2_4_Links_CS;
typedef struct _RedfishServiceRoot_V1_2_4_ServiceRoot_CS RedfishServiceRoot_V1_2_4_ServiceRoot_CS;
//
// The OEM extension.
//
#ifndef RedfishResource_Oem_CS_
...
//
typedef struct _RedfishServiceRoot_V1_2_4_Links_CS {
    RedfishResource_Oem_CS    *Oem;       // The OEM extension property.
    RedfishCS_Link            Sessions;    // The link to a collection of
                                          // Sessions.
} RedfishServiceRoot_V1_2_4_Links_CS;
...
// Root.
//
typedef struct _RedfishServiceRoot_V1_2_4_ServiceRoot_CS {
    ...
    RedfishCS_Link                        JsonSchemas;          // The link to a collection of
                                                                // JSON Schema files.
    RedfishServiceRoot_V1_2_4_Links_CS    *Links;               // The links to other Resources
    ...
    RedfishCS_Link                        UpdateService;        // The link to the Update
                                                                // Service.
} RedfishServiceRoot_V1_2_4_ServiceRoot_CS;

RedfishCS_status
Json_ServiceRoot_V1_2_4_To_CS (char *JsonRawText, RedfishServiceRoot_V1_2_4_ServiceRoot_CS **ReturnedCS);

RedfishCS_status
CS_To_ServiceRoot_V1_2_4_JSON (RedfishServiceRoot_V1_2_4_ServiceRoot_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyServiceRoot_V1_2_4_CS (RedfishServiceRoot_V1_2_4_ServiceRoot_CS *CSPtr);

RedfishCS_status
DestroyServiceRoot_V1_2_4_Json (RedfishCS_char *JsonText);
