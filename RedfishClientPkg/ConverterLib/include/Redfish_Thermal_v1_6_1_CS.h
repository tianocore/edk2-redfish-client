...
#ifndef RedfishThermal_V1_6_1_CSTRUCT_H_
#define RedfishThermal_V1_6_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishThermal_V1_6_1_Fan_Array_CS RedfishThermal_V1_6_1_Fan_Array_CS;
typedef struct _RedfishThermal_V1_6_1_Temperature_Array_CS RedfishThermal_V1_6_1_Temperature_Array_CS;
...
typedef struct _RedfishThermal_V1_6_1_Fan_CS RedfishThermal_V1_6_1_Fan_CS;
typedef struct _RedfishThermal_V1_6_1_FanActions_CS RedfishThermal_V1_6_1_FanActions_CS;
typedef struct _RedfishThermal_V1_6_1_FanOemActions_CS RedfishThermal_V1_6_1_FanOemActions_CS;
typedef struct _RedfishThermal_V1_6_1_Temperature_CS RedfishThermal_V1_6_1_Temperature_CS;
typedef struct _RedfishThermal_V1_6_1_TemperatureActions_CS RedfishThermal_V1_6_1_TemperatureActions_CS;
typedef struct _RedfishThermal_V1_6_1_TemperatureOemActions_CS RedfishThermal_V1_6_1_TemperatureOemActions_CS;
typedef struct _RedfishThermal_V1_6_1_Thermal_CS RedfishThermal_V1_6_1_Thermal_CS;
typedef struct _RedfishThermal_V1_6_1_ThermalActions_CS RedfishThermal_V1_6_1_ThermalActions_CS;
typedef struct _RedfishThermal_V1_6_1_ThermalOemActions_CS RedfishThermal_V1_6_1_ThermalOemActions_CS;
...
typedef struct _RedfishThermal_V1_6_1_Fan_CS {
    ...
    RedfishThermal_V1_6_1_FanActions_CS    *Actions;                     // The available actions for this
                                                                         // resource.
...
typedef struct _RedfishThermal_V1_6_1_FanActions_CS {
    RedfishThermal_V1_6_1_FanOemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishThermal_V1_6_1_Temperature_CS {
    RedfishCS_char                                 *odata_id;                         
    RedfishThermal_V1_6_1_TemperatureActions_CS    *Actions;                              // The available actions for this
                                                                                          // resource.
...
typedef struct _RedfishThermal_V1_6_1_TemperatureActions_CS {
    RedfishThermal_V1_6_1_TemperatureOemActions_CS    *Oem;    // The available OEM-specific
                                                              // actions for this resource.
...
typedef struct _RedfishThermal_V1_6_1_ThermalActions_CS {
    RedfishThermal_V1_6_1_ThermalOemActions_CS    *Oem;    // The available OEM-specific
                                                          // actions for this resource.
...
typedef struct _RedfishThermal_V1_6_1_Thermal_CS {
    ...
    RedfishThermal_V1_6_1_ThermalActions_CS       *Actions;                   // The available actions for this
                                                                              // resource.
    RedfishCS_char                                *Description;           
    RedfishThermal_V1_6_1_Fan_Array_CS            *Fans;                      // The set of fans for this
                                                                              // chassis.
    ...
    RedfishResource_Status_CS                     *Status;                    // The status and health of the
                                                                              // resource and its subordinate
                                                                              // or dependent resources.
    RedfishThermal_V1_6_1_Temperature_Array_CS    *Temperatures;              // The set of temperature sensors
                                                                              // for this chassis.
...
typedef struct _RedfishThermal_V1_6_1_Fan_Array_CS  {
    RedfishThermal_V1_6_1_Fan_Array_CS    *Next;
    RedfishThermal_V1_6_1_Fan_CS    *ArrayValue;
} RedfishThermal_V1_6_1_Fan_Array_CS;

typedef struct _RedfishThermal_V1_6_1_Temperature_Array_CS  {
    RedfishThermal_V1_6_1_Temperature_Array_CS    *Next;
    RedfishThermal_V1_6_1_Temperature_CS    *ArrayValue;
} RedfishThermal_V1_6_1_Temperature_Array_CS;

RedfishCS_status
Json_Thermal_V1_6_1_To_CS (char *JsonRawText, RedfishThermal_V1_6_1_Thermal_CS **ReturnedCS);

RedfishCS_status
CS_To_Thermal_V1_6_1_JSON (RedfishThermal_V1_6_1_Thermal_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyThermal_V1_6_1_CS (RedfishThermal_V1_6_1_Thermal_CS *CSPtr);

RedfishCS_status
DestroyThermal_V1_6_1_Json (RedfishCS_char *JsonText);
