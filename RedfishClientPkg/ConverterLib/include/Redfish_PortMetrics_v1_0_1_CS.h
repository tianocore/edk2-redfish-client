...
#ifndef RedfishPortmetrics_V1_0_1_CSTRUCT_H_
#define RedfishPortmetrics_V1_0_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishPortMetrics_V1_0_1_Actions_CS RedfishPortMetrics_V1_0_1_Actions_CS;
typedef struct _RedfishPortMetrics_V1_0_1_GenZ_CS RedfishPortMetrics_V1_0_1_GenZ_CS;
typedef struct _RedfishPortMetrics_V1_0_1_OemActions_CS RedfishPortMetrics_V1_0_1_OemActions_CS;
typedef struct _RedfishPortMetrics_V1_0_1_PortMetrics_CS RedfishPortMetrics_V1_0_1_PortMetrics_CS;
...
typedef struct _RedfishPortMetrics_V1_0_1_Actions_CS {
    RedfishPortMetrics_V1_0_1_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishPortMetrics_V1_0_1_PortMetrics_CS {
    ...
    RedfishPortMetrics_V1_0_1_Actions_CS    *Actions;         // The available actions for this
                                                              // Resource.
    RedfishCS_char                          *Description; 
    RedfishPortMetrics_V1_0_1_GenZ_CS       *GenZ;            // The port metrics specific to
                                                              // Gen-Z ports.
    RedfishCS_char                          *Id;          
    RedfishCS_char                          *Name;        
...
RedfishCS_status
Json_PortMetrics_V1_0_1_To_CS (char *JsonRawText, RedfishPortMetrics_V1_0_1_PortMetrics_CS **ReturnedCS);

RedfishCS_status
CS_To_PortMetrics_V1_0_1_JSON (RedfishPortMetrics_V1_0_1_PortMetrics_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPortMetrics_V1_0_1_CS (RedfishPortMetrics_V1_0_1_PortMetrics_CS *CSPtr);

RedfishCS_status
DestroyPortMetrics_V1_0_1_Json (RedfishCS_char *JsonText);
