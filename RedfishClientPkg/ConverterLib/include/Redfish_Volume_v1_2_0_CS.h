...
#ifndef RedfishVolume_V1_2_0_CSTRUCT_H_
#define RedfishVolume_V1_2_0_CSTRUCT_H_
...
typedef struct _RedfishVolume_V1_2_0_Actions_CS RedfishVolume_V1_2_0_Actions_CS;
typedef struct _RedfishVolume_V1_2_0_CheckConsistency_CS RedfishVolume_V1_2_0_CheckConsistency_CS;
typedef struct _RedfishVolume_V1_2_0_Links_CS RedfishVolume_V1_2_0_Links_CS;
typedef struct _RedfishVolume_V1_2_0_OemActions_CS RedfishVolume_V1_2_0_OemActions_CS;
typedef struct _RedfishVolume_V1_2_0_Operation_CS RedfishVolume_V1_2_0_Operation_CS;
typedef struct _RedfishVolume_V1_2_0_Volume_CS RedfishVolume_V1_2_0_Volume_CS;
...
typedef struct _RedfishVolume_V1_2_0_Actions_CS {
    RedfishVolume_V1_2_0_CheckConsistency_CS    *Volume_CheckConsistency;
    RedfishVolume_V1_2_0_OemActions_CS          *Oem;                   
} RedfishVolume_V1_2_0_Actions_CS;

//
// This action is used to force a check of the Volume's parity or redundant data
// to ensure it matches calculated values.
//
typedef struct _RedfishVolume_V1_2_0_CheckConsistency_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishVolume_V1_2_0_CheckConsistency_CS;

typedef struct _RedfishVolume_V1_2_0_Links_CS {
    ...
    RedfishResource_Oem_CS    *Oem;                               // The OEM extension property.
} RedfishVolume_V1_2_0_Links_CS;

typedef struct _RedfishVolume_V1_2_0_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishVolume_V1_2_0_OemActions_CS;

typedef struct _RedfishVolume_V1_2_0_Operation_CS {
    ...
    RedfishCS_int64    *PercentageComplete;          // The percentage of the
                                                     ...
                                                     // completed.
} RedfishVolume_V1_2_0_Operation_CS;
...
//
typedef struct _RedfishVolume_V1_2_0_Volume_CS {
    ...
    RedfishCS_char                                     *AccessCapabilities;                 // Supported IO access
                                                                                            // capabilities.
    RedfishVolume_V1_2_0_Actions_CS                    *Actions;                            // The available actions for this
                                                                                            // resource.
    ...
    RedfishCS_Link                                     Identifiers;                         // The Durable names for the
                                                                                            // volume.
    RedfishVolume_V1_2_0_Links_CS                      *Links;                              // Contains references to other
    ...
    RedfishCS_char                                     *Name;                           
    RedfishResource_Oem_CS                             *Oem;                                // The OEM extension property.
    RedfishVolume_V1_2_0_Operation_CS                  *Operations;                         // The operations currently
...
} RedfishVolume_V1_2_0_Volume_CS;
...
RedfishCS_status
Json_Volume_V1_2_0_To_CS (char *JsonRawText, RedfishVolume_V1_2_0_Volume_CS **ReturnedCS);

RedfishCS_status
CS_To_Volume_V1_2_0_JSON (RedfishVolume_V1_2_0_Volume_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyVolume_V1_2_0_CS (RedfishVolume_V1_2_0_Volume_CS *CSPtr);

RedfishCS_status
DestroyVolume_V1_2_0_Json (RedfishCS_char *JsonText);
