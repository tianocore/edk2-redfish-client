...
#ifndef RedfishPortmetrics_V1_1_1_CSTRUCT_H_
#define RedfishPortmetrics_V1_1_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishPortMetrics_V1_1_1_SAS_Array_CS RedfishPortMetrics_V1_1_1_SAS_Array_CS;
typedef struct _RedfishPortMetrics_V1_1_1_Transceiver_Array_CS RedfishPortMetrics_V1_1_1_Transceiver_Array_CS;
typedef struct _RedfishPortMetrics_V1_1_1_Actions_CS RedfishPortMetrics_V1_1_1_Actions_CS;
typedef struct _RedfishPortMetrics_V1_1_1_GenZ_CS RedfishPortMetrics_V1_1_1_GenZ_CS;
typedef struct _RedfishPortMetrics_V1_1_1_Networking_CS RedfishPortMetrics_V1_1_1_Networking_CS;
typedef struct _RedfishPortMetrics_V1_1_1_OemActions_CS RedfishPortMetrics_V1_1_1_OemActions_CS;
typedef struct _RedfishPortMetrics_V1_1_1_PortMetrics_CS RedfishPortMetrics_V1_1_1_PortMetrics_CS;
typedef struct _RedfishPortMetrics_V1_1_1_SAS_CS RedfishPortMetrics_V1_1_1_SAS_CS;
typedef struct _RedfishPortMetrics_V1_1_1_Transceiver_CS RedfishPortMetrics_V1_1_1_Transceiver_CS;
...
typedef struct _RedfishPortMetrics_V1_1_1_Actions_CS {
    RedfishPortMetrics_V1_1_1_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishPortMetrics_V1_1_1_PortMetrics_CS {
    ...
    RedfishPortMetrics_V1_1_1_Actions_CS              *Actions;         // The available actions for this
                                                                        // resource.
    RedfishCS_char                                    *Description; 
    RedfishPortMetrics_V1_1_1_GenZ_CS                 *GenZ;            // The port metrics specific to
                                                                        // Gen-Z ports.
    RedfishCS_char                                    *Id;          
    RedfishCS_char                                    *Name;        
    RedfishPortMetrics_V1_1_1_Networking_CS           *Networking;      // The port metrics for network
    ...
    RedfishPortMetrics_V1_1_1_SAS_Array_CS            *SAS;             // The physical (phy) metrics for
    ...
    RedfishCS_int64                                   *TXErrors;        // The total number of
                                                                        ...
                                                                        // since reset.
    RedfishPortMetrics_V1_1_1_Transceiver_Array_CS    *Transceivers;    // The metrics for the
                                                                        // transceivers in this port.
                                                                        // Each member represents a
                                                                        // single transceiver.
} RedfishPortMetrics_V1_1_1_PortMetrics_CS;

typedef struct _RedfishPortMetrics_V1_1_1_SAS_Array_CS  {
    RedfishPortMetrics_V1_1_1_SAS_Array_CS    *Next;
    RedfishPortMetrics_V1_1_1_SAS_CS    *ArrayValue;
} RedfishPortMetrics_V1_1_1_SAS_Array_CS;

typedef struct _RedfishPortMetrics_V1_1_1_Transceiver_Array_CS  {
    RedfishPortMetrics_V1_1_1_Transceiver_Array_CS    *Next;
    RedfishPortMetrics_V1_1_1_Transceiver_CS    *ArrayValue;
} RedfishPortMetrics_V1_1_1_Transceiver_Array_CS;

RedfishCS_status
Json_PortMetrics_V1_1_1_To_CS (char *JsonRawText, RedfishPortMetrics_V1_1_1_PortMetrics_CS **ReturnedCS);

RedfishCS_status
CS_To_PortMetrics_V1_1_1_JSON (RedfishPortMetrics_V1_1_1_PortMetrics_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPortMetrics_V1_1_1_CS (RedfishPortMetrics_V1_1_1_PortMetrics_CS *CSPtr);

RedfishCS_status
DestroyPortMetrics_V1_1_1_Json (RedfishCS_char *JsonText);
