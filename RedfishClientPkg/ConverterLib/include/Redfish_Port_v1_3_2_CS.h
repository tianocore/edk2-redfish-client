...
#ifndef RedfishPort_V1_3_2_CSTRUCT_H_
#define RedfishPort_V1_3_2_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishPort_V1_3_2_ConfiguredNetworkLink_Array_CS RedfishPort_V1_3_2_ConfiguredNetworkLink_Array_CS;
typedef struct _RedfishPort_V1_3_2_LinkConfiguration_Array_CS RedfishPort_V1_3_2_LinkConfiguration_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishPort_V1_3_2_Actions_CS RedfishPort_V1_3_2_Actions_CS;
typedef struct _RedfishPort_V1_3_2_ConfiguredNetworkLink_CS RedfishPort_V1_3_2_ConfiguredNetworkLink_CS;
typedef struct _RedfishPort_V1_3_2_EthernetProperties_CS RedfishPort_V1_3_2_EthernetProperties_CS;
typedef struct _RedfishPort_V1_3_2_FibreChannelProperties_CS RedfishPort_V1_3_2_FibreChannelProperties_CS;
typedef struct _RedfishPort_V1_3_2_GenZ_CS RedfishPort_V1_3_2_GenZ_CS;
typedef struct _RedfishPort_V1_3_2_LinkConfiguration_CS RedfishPort_V1_3_2_LinkConfiguration_CS;
typedef struct _RedfishPort_V1_3_2_Links_CS RedfishPort_V1_3_2_Links_CS;
typedef struct _RedfishPort_V1_3_2_OemActions_CS RedfishPort_V1_3_2_OemActions_CS;
typedef struct _RedfishPort_V1_3_2_Port_CS RedfishPort_V1_3_2_Port_CS;
typedef struct _RedfishPort_V1_3_2_Reset_CS RedfishPort_V1_3_2_Reset_CS;
...
//
typedef struct _RedfishPort_V1_3_2_Actions_CS {
    RedfishPort_V1_3_2_Reset_CS         *Port_Reset;
    RedfishPort_V1_3_2_OemActions_CS    *Oem;          // The available OEM-specific
                                                       // actions for this resource.
} RedfishPort_V1_3_2_Actions_CS;

//
// A set of link settings that a port is configured to use for autonegotiation.
//
typedef struct _RedfishPort_V1_3_2_ConfiguredNetworkLink_CS {
    ...
    RedfishCS_int64    *ConfiguredWidth;           // The link width this port is
                                                   ...
                                                   // with the link speed.
} RedfishPort_V1_3_2_ConfiguredNetworkLink_CS;

//
// Ethernet-specific properties for a port.
//
typedef struct _RedfishPort_V1_3_2_EthernetProperties_CS {
    ...
    RedfishCS_char_Array    *SupportedEthernetCapabilities;    // The set of Ethernet
                                                              ...
                                                              // supports.
} RedfishPort_V1_3_2_EthernetProperties_CS;

//
// Fibre Channel-specific properties for a port.
//
typedef struct _RedfishPort_V1_3_2_FibreChannelProperties_CS {
    ...
    RedfishCS_char     *PortConnectionType;            // The connection type of this
                                                       // port.
} RedfishPort_V1_3_2_FibreChannelProperties_CS;

//
// This type defines Gen-Z specific port properties.
//
typedef struct _RedfishPort_V1_3_2_GenZ_CS {
    ...
    RedfishCS_Link    VCAT;    // the Virtual Channel Action
                              // Table for the port.
} RedfishPort_V1_3_2_GenZ_CS;

//
// Properties of the link for which this port is configured.
//
typedef struct _RedfishPort_V1_3_2_LinkConfiguration_CS {
    ...
    RedfishPort_V1_3_2_ConfiguredNetworkLink_Array_CS    *ConfiguredNetworkLinks;        // The set of link speed and
                                                                                         // width pairs this port is
                                                                                         // configured to use for
                                                                                         // autonegotiation.
} RedfishPort_V1_3_2_LinkConfiguration_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishPort_V1_3_2_Links_CS {
...
} RedfishPort_V1_3_2_Links_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishPort_V1_3_2_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishPort_V1_3_2_OemActions_CS;

//
// This action resets this port.
//
typedef struct _RedfishPort_V1_3_2_Reset_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishPort_V1_3_2_Reset_CS;
...
// entity.
//
typedef struct _RedfishPort_V1_3_2_Port_CS {
    RedfishCS_Header                                 Header;
    RedfishCS_char                                   *odata_context;         
    RedfishCS_char                                   *odata_etag;            
    RedfishCS_char                                   *odata_id;              
    RedfishCS_char                                   *odata_type;            
    RedfishPort_V1_3_2_Actions_CS                    *Actions;                   // The available actions for this
                                                                                 // resource.
    ...
    RedfishPort_V1_3_2_EthernetProperties_CS         *Ethernet;                  // Ethernet properties for this
                                                                                 // port.
    RedfishPort_V1_3_2_FibreChannelProperties_CS     *FibreChannel;              // Fibre Channel properties for
                                                                                 // this port.
    RedfishPort_V1_3_2_GenZ_CS                       *GenZ;                      // Gen-Z specific properties.
    RedfishCS_char                                   *Id;                    
    RedfishCS_bool                                   *InterfaceEnabled;          // An indication of whether the
                                                                                 // interface is enabled.
    RedfishPort_V1_3_2_LinkConfiguration_Array_CS    *LinkConfiguration;         // The link configuration of this
                                                                                 // port.
    ...
    RedfishCS_int64                                  *LinkTransitionIndicator;    // The number of link state
                                                                                 ...
                                                                                 // interface.
    RedfishPort_V1_3_2_Links_CS                      *Links;                     // The links to other resources
...
} RedfishPort_V1_3_2_Port_CS;

typedef struct _RedfishPort_V1_3_2_ConfiguredNetworkLink_Array_CS  {
    RedfishPort_V1_3_2_ConfiguredNetworkLink_Array_CS    *Next;
    RedfishPort_V1_3_2_ConfiguredNetworkLink_CS    *ArrayValue;
} RedfishPort_V1_3_2_ConfiguredNetworkLink_Array_CS;

typedef struct _RedfishPort_V1_3_2_LinkConfiguration_Array_CS  {
    RedfishPort_V1_3_2_LinkConfiguration_Array_CS    *Next;
    RedfishPort_V1_3_2_LinkConfiguration_CS    *ArrayValue;
} RedfishPort_V1_3_2_LinkConfiguration_Array_CS;
...
RedfishCS_status
Json_Port_V1_3_2_To_CS (char *JsonRawText, RedfishPort_V1_3_2_Port_CS **ReturnedCS);

RedfishCS_status
CS_To_Port_V1_3_2_JSON (RedfishPort_V1_3_2_Port_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPort_V1_3_2_CS (RedfishPort_V1_3_2_Port_CS *CSPtr);

RedfishCS_status
DestroyPort_V1_3_2_Json (RedfishCS_char *JsonText);
