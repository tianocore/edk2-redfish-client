...
#ifndef RedfishChassis_V1_8_2_CSTRUCT_H_
#define RedfishChassis_V1_8_2_CSTRUCT_H_
...
#endif
typedef struct _RedfishChassis_V1_8_2_Actions_CS RedfishChassis_V1_8_2_Actions_CS;
typedef struct _RedfishChassis_V1_8_2_Chassis_CS RedfishChassis_V1_8_2_Chassis_CS;
typedef struct _RedfishChassis_V1_8_2_Links_CS RedfishChassis_V1_8_2_Links_CS;
typedef struct _RedfishChassis_V1_8_2_OemActions_CS RedfishChassis_V1_8_2_OemActions_CS;
typedef struct _RedfishChassis_V1_8_2_PhysicalSecurity_CS RedfishChassis_V1_8_2_PhysicalSecurity_CS;
typedef struct _RedfishChassis_V1_8_2_Reset_CS RedfishChassis_V1_8_2_Reset_CS;
...
//
typedef struct _RedfishChassis_V1_8_2_Actions_CS {
    RedfishChassis_V1_8_2_Reset_CS         *Chassis_Reset;
    RedfishChassis_V1_8_2_OemActions_CS    *Oem;             // This property contains the
                                                             // available OEM specific actions
                                                             // for this resource.
} RedfishChassis_V1_8_2_Actions_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishChassis_V1_8_2_Links_CS {
...
} RedfishChassis_V1_8_2_Links_CS;

//
// The available OEM specific actions for this resource.
//
typedef struct _RedfishChassis_V1_8_2_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishChassis_V1_8_2_OemActions_CS;

//
// The state of the physical security sensor.
//
typedef struct _RedfishChassis_V1_8_2_PhysicalSecurity_CS {
...
} RedfishChassis_V1_8_2_PhysicalSecurity_CS;
...
//
typedef struct _RedfishChassis_V1_8_2_Reset_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishChassis_V1_8_2_Reset_CS;
...
//
typedef struct _RedfishChassis_V1_8_2_Chassis_CS {
    RedfishCS_Header                             Header;
    RedfishCS_char                               *odata_context;  
    RedfishCS_char                               *odata_etag;     
    RedfishCS_char                               *odata_id;       
    RedfishCS_char                               *odata_type;     
    RedfishChassis_V1_8_2_Actions_CS             *Actions;            // The available actions for this
                                                                      // resource.
    ...
    RedfishCS_char                               *IndicatorLED;       // The state of the indicator
                                                                      ...
                                                                      // chassis.
    RedfishChassis_V1_8_2_Links_CS               *Links;              // Contains references to other
    ...
    RedfishCS_char                               *PartNumber;         // The part number of the
                                                                      // chassis.
    RedfishChassis_V1_8_2_PhysicalSecurity_CS    *PhysicalSecurity;    // The state of the physical
                                                                      // security sensor.
...
} RedfishChassis_V1_8_2_Chassis_CS;
...
RedfishCS_status
Json_Chassis_V1_8_2_To_CS (char *JsonRawText, RedfishChassis_V1_8_2_Chassis_CS **ReturnedCS);

RedfishCS_status
CS_To_Chassis_V1_8_2_JSON (RedfishChassis_V1_8_2_Chassis_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyChassis_V1_8_2_CS (RedfishChassis_V1_8_2_Chassis_CS *CSPtr);

RedfishCS_status
DestroyChassis_V1_8_2_Json (RedfishCS_char *JsonText);
