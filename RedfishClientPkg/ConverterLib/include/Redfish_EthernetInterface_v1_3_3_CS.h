...
#ifndef RedfishEthernetinterface_V1_3_3_CSTRUCT_H_
#define RedfishEthernetinterface_V1_3_3_CSTRUCT_H_
...
#endif
typedef struct _RedfishEthernetInterface_V1_3_3_IPv6AddressPolicyEntry_Array_CS RedfishEthernetInterface_V1_3_3_IPv6AddressPolicyEntry_Array_CS;
typedef struct _RedfishEthernetInterface_V1_3_3_Actions_CS RedfishEthernetInterface_V1_3_3_Actions_CS;
typedef struct _RedfishEthernetInterface_V1_3_3_EthernetInterface_CS RedfishEthernetInterface_V1_3_3_EthernetInterface_CS;
typedef struct _RedfishEthernetInterface_V1_3_3_IPv6AddressPolicyEntry_CS RedfishEthernetInterface_V1_3_3_IPv6AddressPolicyEntry_CS;
typedef struct _RedfishEthernetInterface_V1_3_3_Links_CS RedfishEthernetInterface_V1_3_3_Links_CS;
typedef struct _RedfishEthernetInterface_V1_3_3_OemActions_CS RedfishEthernetInterface_V1_3_3_OemActions_CS;
...
//
typedef struct _RedfishEthernetInterface_V1_3_3_Actions_CS {
    RedfishEthernetInterface_V1_3_3_OemActions_CS    *Oem;    // This property contains the
                                                             // available OEM specific actions
                                                             // for this resource.
} RedfishEthernetInterface_V1_3_3_Actions_CS;

//
// A entry in the RFC 6724 Address Selection Policy Table.
//
typedef struct _RedfishEthernetInterface_V1_3_3_IPv6AddressPolicyEntry_CS {
    ...
    RedfishCS_char     *Prefix;       // The IPv6 Address Prefix (as
                                      // defined in RFC 6724 section
                                      // 2.1).
} RedfishEthernetInterface_V1_3_3_IPv6AddressPolicyEntry_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishEthernetInterface_V1_3_3_Links_CS {
...
} RedfishEthernetInterface_V1_3_3_Links_CS;

//
// The available OEM specific actions for this resource.
//
typedef struct _RedfishEthernetInterface_V1_3_3_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishEthernetInterface_V1_3_3_OemActions_CS;
...
//
typedef struct _RedfishEthernetInterface_V1_3_3_EthernetInterface_CS {
    RedfishCS_Header                                                   Header;
    RedfishCS_char                                                     *odata_context;        
    RedfishCS_char                                                     *odata_etag;           
    RedfishCS_char                                                     *odata_id;             
    RedfishCS_char                                                     *odata_type;           
    RedfishEthernetInterface_V1_3_3_Actions_CS                         *Actions;                  // The available actions for this
                                                                                                  // resource.
    ...
    RedfishEthernetInterface_V1_3_3_IPv6AddressPolicyEntry_Array_CS    *IPv6AddressPolicyTable;    // An array representing the RFC
    ...
    RedfishCS_char                                                     *LinkStatus;               // The link status of this
                                                                                                  // interface (port).
    RedfishEthernetInterface_V1_3_3_Links_CS                           *Links;                    // Contains references to other
...
} RedfishEthernetInterface_V1_3_3_EthernetInterface_CS;
...
typedef struct _RedfishEthernetInterface_V1_3_3_IPv6AddressPolicyEntry_Array_CS  {
    RedfishEthernetInterface_V1_3_3_IPv6AddressPolicyEntry_Array_CS    *Next;
    RedfishEthernetInterface_V1_3_3_IPv6AddressPolicyEntry_CS    *ArrayValue;
} RedfishEthernetInterface_V1_3_3_IPv6AddressPolicyEntry_Array_CS;

RedfishCS_status
Json_EthernetInterface_V1_3_3_To_CS (char *JsonRawText, RedfishEthernetInterface_V1_3_3_EthernetInterface_CS **ReturnedCS);

RedfishCS_status
CS_To_EthernetInterface_V1_3_3_JSON (RedfishEthernetInterface_V1_3_3_EthernetInterface_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEthernetInterface_V1_3_3_CS (RedfishEthernetInterface_V1_3_3_EthernetInterface_CS *CSPtr);

RedfishCS_status
DestroyEthernetInterface_V1_3_3_Json (RedfishCS_char *JsonText);
