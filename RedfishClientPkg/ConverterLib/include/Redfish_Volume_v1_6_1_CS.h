...
#ifndef RedfishVolume_V1_6_1_CSTRUCT_H_
#define RedfishVolume_V1_6_1_CSTRUCT_H_
...
typedef struct _RedfishVolume_V1_6_1_Actions_CS RedfishVolume_V1_6_1_Actions_CS;
typedef struct _RedfishVolume_V1_6_1_AssignReplicaTarget_CS RedfishVolume_V1_6_1_AssignReplicaTarget_CS;
typedef struct _RedfishVolume_V1_6_1_ChangeRAIDLayout_CS RedfishVolume_V1_6_1_ChangeRAIDLayout_CS;
typedef struct _RedfishVolume_V1_6_1_CheckConsistency_CS RedfishVolume_V1_6_1_CheckConsistency_CS;
typedef struct _RedfishVolume_V1_6_1_CreateReplicaTarget_CS RedfishVolume_V1_6_1_CreateReplicaTarget_CS;
typedef struct _RedfishVolume_V1_6_1_ForceEnable_CS RedfishVolume_V1_6_1_ForceEnable_CS;
typedef struct _RedfishVolume_V1_6_1_Initialize_CS RedfishVolume_V1_6_1_Initialize_CS;
typedef struct _RedfishVolume_V1_6_1_Links_CS RedfishVolume_V1_6_1_Links_CS;
typedef struct _RedfishVolume_V1_6_1_NVMeNamespaceProperties_CS RedfishVolume_V1_6_1_NVMeNamespaceProperties_CS;
typedef struct _RedfishVolume_V1_6_1_NamespaceFeatures_CS RedfishVolume_V1_6_1_NamespaceFeatures_CS;
typedef struct _RedfishVolume_V1_6_1_OemActions_CS RedfishVolume_V1_6_1_OemActions_CS;
typedef struct _RedfishVolume_V1_6_1_Operation_CS RedfishVolume_V1_6_1_Operation_CS;
typedef struct _RedfishVolume_V1_6_1_RemoveReplicaRelationship_CS RedfishVolume_V1_6_1_RemoveReplicaRelationship_CS;
typedef struct _RedfishVolume_V1_6_1_ResumeReplication_CS RedfishVolume_V1_6_1_ResumeReplication_CS;
typedef struct _RedfishVolume_V1_6_1_ReverseReplicationRelationship_CS RedfishVolume_V1_6_1_ReverseReplicationRelationship_CS;
typedef struct _RedfishVolume_V1_6_1_SplitReplication_CS RedfishVolume_V1_6_1_SplitReplication_CS;
typedef struct _RedfishVolume_V1_6_1_SuspendReplication_CS RedfishVolume_V1_6_1_SuspendReplication_CS;
typedef struct _RedfishVolume_V1_6_1_Volume_CS RedfishVolume_V1_6_1_Volume_CS;
...
typedef struct _RedfishVolume_V1_6_1_Actions_CS {
    RedfishVolume_V1_6_1_AssignReplicaTarget_CS               *Volume_AssignReplicaTarget;          
    RedfishVolume_V1_6_1_ChangeRAIDLayout_CS                  *Volume_ChangeRAIDLayout;             
    RedfishVolume_V1_6_1_CheckConsistency_CS                  *Volume_CheckConsistency;             
    RedfishVolume_V1_6_1_CreateReplicaTarget_CS               *Volume_CreateReplicaTarget;          
    RedfishVolume_V1_6_1_ForceEnable_CS                       *Volume_ForceEnable;                  
    RedfishVolume_V1_6_1_Initialize_CS                        *Volume_Initialize;                   
    RedfishVolume_V1_6_1_RemoveReplicaRelationship_CS         *Volume_RemoveReplicaRelationship;    
    RedfishVolume_V1_6_1_ResumeReplication_CS                 *Volume_ResumeReplication;            
    RedfishVolume_V1_6_1_ReverseReplicationRelationship_CS    *Volume_ReverseReplicationRelationship;
    RedfishVolume_V1_6_1_SplitReplication_CS                  *Volume_SplitReplication;             
    RedfishVolume_V1_6_1_SuspendReplication_CS                *Volume_SuspendReplication;           
    RedfishVolume_V1_6_1_OemActions_CS                        *Oem;                                 
} RedfishVolume_V1_6_1_Actions_CS;
...
//
typedef struct _RedfishVolume_V1_6_1_AssignReplicaTarget_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishVolume_V1_6_1_AssignReplicaTarget_CS;

//
// Request system change the RAID layout of the volume.
//
typedef struct _RedfishVolume_V1_6_1_ChangeRAIDLayout_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishVolume_V1_6_1_ChangeRAIDLayout_CS;

//
// This action is used to force a check of the Volume's parity or redundant data
// to ensure it matches calculated values.
//
typedef struct _RedfishVolume_V1_6_1_CheckConsistency_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishVolume_V1_6_1_CheckConsistency_CS;
...
//
typedef struct _RedfishVolume_V1_6_1_CreateReplicaTarget_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishVolume_V1_6_1_CreateReplicaTarget_CS;

//
// Request system force the volume to an enabled state regardless of data loss.
//
typedef struct _RedfishVolume_V1_6_1_ForceEnable_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishVolume_V1_6_1_ForceEnable_CS;
...
// Foreground.
//
typedef struct _RedfishVolume_V1_6_1_Initialize_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishVolume_V1_6_1_Initialize_CS;

//
// Add ability to manage spare capacity.
//
typedef struct _RedfishVolume_V1_6_1_Links_CS {
    RedfishCS_Link            CacheDataVolumes;                   // A pointer to the data volumes
                                                                  // this volume serves as a cache
                                                                  // volume.
    RedfishCS_int64           *CacheDataVolumesodata_count;   
    RedfishCS_Link            CacheVolumeSource;                  // A pointer to the cache volume
...
} RedfishVolume_V1_6_1_Links_CS;

//
// This contains properties to use when Volume is used to describe an NVMe
// Namespace.
//
typedef struct _RedfishVolume_V1_6_1_NVMeNamespaceProperties_CS {
    ...
    RedfishVolume_V1_6_1_NamespaceFeatures_CS    *NamespaceFeatures;                   // This property contains a set
    ...
    RedfishCS_int64                              *NumberLBAFormats;                    // The number of LBA data size
                                                                                       ...
                                                                                       // between 0 and 16.
} RedfishVolume_V1_6_1_NVMeNamespaceProperties_CS;

typedef struct _RedfishVolume_V1_6_1_NamespaceFeatures_CS {
    ...
    RedfishCS_bool    *SupportsThinProvisioning;                // This property indicates
                                                                ...
                                                                // provisioning.
} RedfishVolume_V1_6_1_NamespaceFeatures_CS;

typedef struct _RedfishVolume_V1_6_1_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishVolume_V1_6_1_OemActions_CS;

typedef struct _RedfishVolume_V1_6_1_Operation_CS {
    ...
    RedfishCS_int64    *PercentageComplete;          // The percentage of the
                                                     ...
                                                     // completed.
} RedfishVolume_V1_6_1_Operation_CS;
...
// volume.
//
typedef struct _RedfishVolume_V1_6_1_RemoveReplicaRelationship_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishVolume_V1_6_1_RemoveReplicaRelationship_CS;
...
//
typedef struct _RedfishVolume_V1_6_1_ResumeReplication_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishVolume_V1_6_1_ResumeReplication_CS;

//
// This action is used to reverse the replication relationship between a source
// and target volume.
//
typedef struct _RedfishVolume_V1_6_1_ReverseReplicationRelationship_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishVolume_V1_6_1_ReverseReplicationRelationship_CS;
...
//
typedef struct _RedfishVolume_V1_6_1_SplitReplication_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishVolume_V1_6_1_SplitReplication_CS;
...
//
typedef struct _RedfishVolume_V1_6_1_SuspendReplication_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishVolume_V1_6_1_SuspendReplication_CS;
...
//
typedef struct _RedfishVolume_V1_6_1_Volume_CS {
    ...
    RedfishCS_char                                     *AccessCapabilities;                 // Supported IO access
                                                                                            // capabilities.
    RedfishVolume_V1_6_1_Actions_CS                    *Actions;                            // The available actions for this
                                                                                            // resource.
    ...
    RedfishCS_Link                                     Identifiers;                         // The Durable names for the
                                                                                            // volume.
    RedfishCS_char                                     *InitializeMethod;                   // Indicates the Initialization
                                                                                            // Method used for this volume.
                                                                                            // If InitializeMethod is not
                                                                                            // specified, the
                                                                                            // InitializeMethod should be
                                                                                            // Foreground.
    RedfishVolume_V1_6_1_Links_CS                      *Links;                              // Contains references to other
    ...
    RedfishCS_char                                     *Model;                              // The model number for this
                                                                                            // storage volume.
    RedfishVolume_V1_6_1_NVMeNamespaceProperties_CS    *NVMeNamespaceProperties;            // This property contains
                                                                                            // properties to use when Volume
                                                                                            // is used to describe an NVMe
                                                                                            // Namespace.
    RedfishCS_char                                     *Name;                           
    RedfishResource_Oem_CS                             *Oem;                                // The OEM extension property.
    RedfishVolume_V1_6_1_Operation_CS                  *Operations;                         // The operations currently
    ...
    RedfishCS_char                                     *WriteHoleProtectionPolicy;          // The policy that the RAID
                                                                                            ...
                                                                                            // write hole issue.
} RedfishVolume_V1_6_1_Volume_CS;
...
RedfishCS_status
Json_Volume_V1_6_1_To_CS (char *JsonRawText, RedfishVolume_V1_6_1_Volume_CS **ReturnedCS);

RedfishCS_status
CS_To_Volume_V1_6_1_JSON (RedfishVolume_V1_6_1_Volume_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyVolume_V1_6_1_CS (RedfishVolume_V1_6_1_Volume_CS *CSPtr);

RedfishCS_status
DestroyVolume_V1_6_1_Json (RedfishCS_char *JsonText);
