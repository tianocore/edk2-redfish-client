...
#ifndef RedfishOutletgroup_V1_1_0_CSTRUCT_H_
#define RedfishOutletgroup_V1_1_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishOutletGroup_V1_1_0_Actions_CS RedfishOutletGroup_V1_1_0_Actions_CS;
typedef struct _RedfishOutletGroup_V1_1_0_Links_CS RedfishOutletGroup_V1_1_0_Links_CS;
typedef struct _RedfishOutletGroup_V1_1_0_OemActions_CS RedfishOutletGroup_V1_1_0_OemActions_CS;
typedef struct _RedfishOutletGroup_V1_1_0_OutletGroup_CS RedfishOutletGroup_V1_1_0_OutletGroup_CS;
typedef struct _RedfishOutletGroup_V1_1_0_PowerControl_CS RedfishOutletGroup_V1_1_0_PowerControl_CS;
typedef struct _RedfishOutletGroup_V1_1_0_ResetMetrics_CS RedfishOutletGroup_V1_1_0_ResetMetrics_CS;
...
typedef struct _RedfishOutletGroup_V1_1_0_Actions_CS {
    ...
    RedfishOutletGroup_V1_1_0_OemActions_CS      *Oem;                        // The available OEM-specific
...
typedef struct _RedfishOutletGroup_V1_1_0_OutletGroup_CS {
    ...
    RedfishOutletGroup_V1_1_0_Actions_CS    *Actions;                    // The available actions for this
                                                                         // resource.
    ...
    RedfishCS_Link                          EnergykWh;                   // The energy (kWh) for this
                                                                         // outlet group.
    RedfishCS_char                          *Id;                     
    RedfishOutletGroup_V1_1_0_Links_CS      *Links;                      // The links to other resources
...
RedfishCS_status
Json_OutletGroup_V1_1_0_To_CS (char *JsonRawText, RedfishOutletGroup_V1_1_0_OutletGroup_CS **ReturnedCS);

RedfishCS_status
CS_To_OutletGroup_V1_1_0_JSON (RedfishOutletGroup_V1_1_0_OutletGroup_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyOutletGroup_V1_1_0_CS (RedfishOutletGroup_V1_1_0_OutletGroup_CS *CSPtr);

RedfishCS_status
DestroyOutletGroup_V1_1_0_Json (RedfishCS_char *JsonText);
