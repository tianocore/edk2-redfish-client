...
#ifndef RedfishMemorymetrics_V1_4_1_CSTRUCT_H_
#define RedfishMemorymetrics_V1_4_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMemoryMetrics_V1_4_1_Actions_CS RedfishMemoryMetrics_V1_4_1_Actions_CS;
typedef struct _RedfishMemoryMetrics_V1_4_1_AlarmTrips_CS RedfishMemoryMetrics_V1_4_1_AlarmTrips_CS;
typedef struct _RedfishMemoryMetrics_V1_4_1_ClearCurrentPeriod_CS RedfishMemoryMetrics_V1_4_1_ClearCurrentPeriod_CS;
typedef struct _RedfishMemoryMetrics_V1_4_1_CurrentPeriod_CS RedfishMemoryMetrics_V1_4_1_CurrentPeriod_CS;
typedef struct _RedfishMemoryMetrics_V1_4_1_HealthData_CS RedfishMemoryMetrics_V1_4_1_HealthData_CS;
typedef struct _RedfishMemoryMetrics_V1_4_1_LifeTime_CS RedfishMemoryMetrics_V1_4_1_LifeTime_CS;
typedef struct _RedfishMemoryMetrics_V1_4_1_MemoryMetrics_CS RedfishMemoryMetrics_V1_4_1_MemoryMetrics_CS;
typedef struct _RedfishMemoryMetrics_V1_4_1_OemActions_CS RedfishMemoryMetrics_V1_4_1_OemActions_CS;
...
typedef struct _RedfishMemoryMetrics_V1_4_1_Actions_CS {
    ...
    RedfishMemoryMetrics_V1_4_1_OemActions_CS            *Oem;                                // The available OEM-specific
...
typedef struct _RedfishMemoryMetrics_V1_4_1_HealthData_CS {
    RedfishMemoryMetrics_V1_4_1_AlarmTrips_CS    *AlarmTrips;                      // Alarm trip information about
                                                                                   // the memory.
...
typedef struct _RedfishMemoryMetrics_V1_4_1_MemoryMetrics_CS {
    ...
    RedfishMemoryMetrics_V1_4_1_Actions_CS          *Actions;             // The available actions for this
                                                                          // resource.
    RedfishCS_int64                                 *BandwidthPercent;    // The memory bandwidth
                                                                          // utilization as a percentage.
    RedfishCS_int64                                 *BlockSizeBytes;      // The block size, in bytes.
    RedfishMemoryMetrics_V1_4_1_CurrentPeriod_CS    *CurrentPeriod;       // The memory metrics since the
                                                                          // last reset or
                                                                          // ClearCurrentPeriod action.
    RedfishCS_char                                  *Description;     
    RedfishMemoryMetrics_V1_4_1_HealthData_CS       *HealthData;          // The health information of the
                                                                          // memory.
    RedfishCS_char                                  *Id;              
    RedfishMemoryMetrics_V1_4_1_LifeTime_CS         *LifeTime;            // The memory metrics for the
                                                                          // lifetime of the memory.
    RedfishCS_char                                  *Name;            
...
RedfishCS_status
Json_MemoryMetrics_V1_4_1_To_CS (char *JsonRawText, RedfishMemoryMetrics_V1_4_1_MemoryMetrics_CS **ReturnedCS);

RedfishCS_status
CS_To_MemoryMetrics_V1_4_1_JSON (RedfishMemoryMetrics_V1_4_1_MemoryMetrics_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMemoryMetrics_V1_4_1_CS (RedfishMemoryMetrics_V1_4_1_MemoryMetrics_CS *CSPtr);

RedfishCS_status
DestroyMemoryMetrics_V1_4_1_Json (RedfishCS_char *JsonText);
