...
#ifndef RedfishExternalaccountprovider_V1_1_1_CSTRUCT_H_
#define RedfishExternalaccountprovider_V1_1_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishExternalAccountProvider_V1_1_1_RoleMapping_Array_CS RedfishExternalAccountProvider_V1_1_1_RoleMapping_Array_CS;
typedef struct _RedfishExternalAccountProvider_V1_1_1_Actions_CS RedfishExternalAccountProvider_V1_1_1_Actions_CS;
typedef struct _RedfishExternalAccountProvider_V1_1_1_Authentication_CS RedfishExternalAccountProvider_V1_1_1_Authentication_CS;
typedef struct _RedfishExternalAccountProvider_V1_1_1_ExternalAccountProvider_CS RedfishExternalAccountProvider_V1_1_1_ExternalAccountProvider_CS;
typedef struct _RedfishExternalAccountProvider_V1_1_1_LDAPSearchSettings_CS RedfishExternalAccountProvider_V1_1_1_LDAPSearchSettings_CS;
typedef struct _RedfishExternalAccountProvider_V1_1_1_LDAPService_CS RedfishExternalAccountProvider_V1_1_1_LDAPService_CS;
typedef struct _RedfishExternalAccountProvider_V1_1_1_Links_CS RedfishExternalAccountProvider_V1_1_1_Links_CS;
typedef struct _RedfishExternalAccountProvider_V1_1_1_OemActions_CS RedfishExternalAccountProvider_V1_1_1_OemActions_CS;
typedef struct _RedfishExternalAccountProvider_V1_1_1_RoleMapping_CS RedfishExternalAccountProvider_V1_1_1_RoleMapping_CS;
...
typedef struct _RedfishExternalAccountProvider_V1_1_1_Actions_CS {
    RedfishExternalAccountProvider_V1_1_1_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishExternalAccountProvider_V1_1_1_LDAPService_CS {
    RedfishResource_Oem_CS                                         *Oem;              // Oem extension object.
    RedfishExternalAccountProvider_V1_1_1_LDAPSearchSettings_CS    *SearchSettings;    // This property contains the
...
typedef struct _RedfishExternalAccountProvider_V1_1_1_ExternalAccountProvider_CS {
    ...
    RedfishCS_char                                                *AccountProviderType;    // This property contains the
                                                                                          ...
                                                                                          // references.
    RedfishExternalAccountProvider_V1_1_1_Actions_CS              *Actions;               // The available actions for this
                                                                                          // resource.
    RedfishExternalAccountProvider_V1_1_1_Authentication_CS       *Authentication;        // This property contains the
    ...
    RedfishCS_char                                                *Id;                
    RedfishExternalAccountProvider_V1_1_1_LDAPService_CS          *LDAPService;           // This property contains
                                                                                          // additional mapping information
                                                                                          // needed to parse a generic LDAP
                                                                                          // service.
    RedfishExternalAccountProvider_V1_1_1_Links_CS                *Links;                 // Contains references to other
    ...
    RedfishResource_Oem_CS                                        *Oem;                   // This is the
                                                                                          ...
                                                                                          // sections.
    RedfishExternalAccountProvider_V1_1_1_RoleMapping_Array_CS    *RemoteRoleMapping;     // This property contains a
...
typedef struct _RedfishExternalAccountProvider_V1_1_1_RoleMapping_Array_CS  {
    RedfishExternalAccountProvider_V1_1_1_RoleMapping_Array_CS    *Next;
    RedfishExternalAccountProvider_V1_1_1_RoleMapping_CS    *ArrayValue;
} RedfishExternalAccountProvider_V1_1_1_RoleMapping_Array_CS;

RedfishCS_status
Json_ExternalAccountProvider_V1_1_1_To_CS (char *JsonRawText, RedfishExternalAccountProvider_V1_1_1_ExternalAccountProvider_CS **ReturnedCS);

RedfishCS_status
CS_To_ExternalAccountProvider_V1_1_1_JSON (RedfishExternalAccountProvider_V1_1_1_ExternalAccountProvider_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyExternalAccountProvider_V1_1_1_CS (RedfishExternalAccountProvider_V1_1_1_ExternalAccountProvider_CS *CSPtr);

RedfishCS_status
DestroyExternalAccountProvider_V1_1_1_Json (RedfishCS_char *JsonText);
