...
#ifndef RedfishTask_V1_3_3_CSTRUCT_H_
#define RedfishTask_V1_3_3_CSTRUCT_H_
...
typedef struct _RedfishTask_V1_3_3_Actions_CS RedfishTask_V1_3_3_Actions_CS;
typedef struct _RedfishTask_V1_3_3_OemActions_CS RedfishTask_V1_3_3_OemActions_CS;
typedef struct _RedfishTask_V1_3_3_Payload_CS RedfishTask_V1_3_3_Payload_CS;
typedef struct _RedfishTask_V1_3_3_Task_CS RedfishTask_V1_3_3_Task_CS;
//
// The OEM extension.
//
#ifndef RedfishResource_Oem_CS_
...
typedef struct _RedfishTask_V1_3_3_Actions_CS {
    RedfishTask_V1_3_3_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishTask_V1_3_3_Task_CS {
    ...
    RedfishTask_V1_3_3_Actions_CS    *Actions;         // The available actions for this
                                                       // Resource.
    ...
    RedfishTask_V1_3_3_Payload_CS    *Payload;         // The HTTP and JSON payload
...
RedfishCS_status
Json_Task_V1_3_3_To_CS (char *JsonRawText, RedfishTask_V1_3_3_Task_CS **ReturnedCS);

RedfishCS_status
CS_To_Task_V1_3_3_JSON (RedfishTask_V1_3_3_Task_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyTask_V1_3_3_CS (RedfishTask_V1_3_3_Task_CS *CSPtr);

RedfishCS_status
DestroyTask_V1_3_3_Json (RedfishCS_char *JsonText);
