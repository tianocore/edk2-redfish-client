...
#ifndef RedfishMessageregistry_V1_3_0_CSTRUCT_H_
#define RedfishMessageregistry_V1_3_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMessageRegistry_V1_3_0_Actions_CS RedfishMessageRegistry_V1_3_0_Actions_CS;
typedef struct _RedfishMessageRegistry_V1_3_0_ClearingLogic_CS RedfishMessageRegistry_V1_3_0_ClearingLogic_CS;
typedef struct _RedfishMessageRegistry_V1_3_0_Message_CS RedfishMessageRegistry_V1_3_0_Message_CS;
typedef struct _RedfishMessageRegistry_V1_3_0_MessageProperty_CS RedfishMessageRegistry_V1_3_0_MessageProperty_CS;
typedef struct _RedfishMessageRegistry_V1_3_0_MessageRegistry_CS RedfishMessageRegistry_V1_3_0_MessageRegistry_CS;
typedef struct _RedfishMessageRegistry_V1_3_0_OemActions_CS RedfishMessageRegistry_V1_3_0_OemActions_CS;
...
typedef struct _RedfishMessageRegistry_V1_3_0_Actions_CS {
    RedfishMessageRegistry_V1_3_0_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishMessageRegistry_V1_3_0_Message_CS {
    ...
    RedfishCS_char_Array                              *ArgLongDescriptions;    // The MessageArg normative
                                                                              ...
                                                                              // for this Message.
    RedfishMessageRegistry_V1_3_0_ClearingLogic_CS    *ClearingLogic;         // The clearing logic associated
    ...
    RedfishCS_char                                    *Description;           // This is a short description of
                                                                              ...
                                                                              // to be used.
    RedfishCS_char                                    *LongDescription;       // The normative language
                                                                              // describing the usage of this
                                                                              // Message.
...
typedef struct _RedfishMessageRegistry_V1_3_0_MessageRegistry_CS {
    ...
    RedfishMessageRegistry_V1_3_0_Actions_CS            *Actions;           // The available actions for this
                                                                            // resource.
    ...
    RedfishCS_char                                      *Language;          // This is the RFC 5646 compliant
                                                                            ...
                                                                            // registry.
    RedfishMessageRegistry_V1_3_0_MessageProperty_CS    *Messages;          // The pattern property indicates
...
RedfishCS_status
Json_MessageRegistry_V1_3_0_To_CS (char *JsonRawText, RedfishMessageRegistry_V1_3_0_MessageRegistry_CS **ReturnedCS);

RedfishCS_status
CS_To_MessageRegistry_V1_3_0_JSON (RedfishMessageRegistry_V1_3_0_MessageRegistry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMessageRegistry_V1_3_0_CS (RedfishMessageRegistry_V1_3_0_MessageRegistry_CS *CSPtr);

RedfishCS_status
DestroyMessageRegistry_V1_3_0_Json (RedfishCS_char *JsonText);
