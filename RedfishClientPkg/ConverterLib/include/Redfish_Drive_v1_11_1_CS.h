...
#ifndef RedfishDrive_V1_11_1_CSTRUCT_H_
#define RedfishDrive_V1_11_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishDrive_V1_11_1_Operations_Array_CS RedfishDrive_V1_11_1_Operations_Array_CS;
typedef struct _RedfishDrive_V1_11_1_Actions_CS RedfishDrive_V1_11_1_Actions_CS;
typedef struct _RedfishDrive_V1_11_1_Drive_CS RedfishDrive_V1_11_1_Drive_CS;
typedef struct _RedfishDrive_V1_11_1_Links_CS RedfishDrive_V1_11_1_Links_CS;
typedef struct _RedfishDrive_V1_11_1_OemActions_CS RedfishDrive_V1_11_1_OemActions_CS;
typedef struct _RedfishDrive_V1_11_1_Operations_CS RedfishDrive_V1_11_1_Operations_CS;
typedef struct _RedfishDrive_V1_11_1_Reset_CS RedfishDrive_V1_11_1_Reset_CS;
typedef struct _RedfishDrive_V1_11_1_SecureErase_CS RedfishDrive_V1_11_1_SecureErase_CS;
...
//
typedef struct _RedfishDrive_V1_11_1_Actions_CS {
    RedfishDrive_V1_11_1_Reset_CS          *Drive_Reset;     
    RedfishDrive_V1_11_1_SecureErase_CS    *Drive_SecureErase;
    RedfishDrive_V1_11_1_OemActions_CS     *Oem;                 // The available OEM-specific
                                                                 // actions for this resource.
} RedfishDrive_V1_11_1_Actions_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishDrive_V1_11_1_Links_CS {
...
} RedfishDrive_V1_11_1_Links_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishDrive_V1_11_1_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishDrive_V1_11_1_OemActions_CS;

//
// An operation currently running on this resource.
//
typedef struct _RedfishDrive_V1_11_1_Operations_CS {
    ...
    RedfishCS_int64    *PercentageComplete;    // The percentage of the
                                              ...
                                              // completed.
} RedfishDrive_V1_11_1_Operations_CS;

//
// This action resets this drive.
//
typedef struct _RedfishDrive_V1_11_1_Reset_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishDrive_V1_11_1_Reset_CS;

//
// This action securely erases the contents of the drive.
//
typedef struct _RedfishDrive_V1_11_1_SecureErase_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishDrive_V1_11_1_SecureErase_CS;
...
//
typedef struct _RedfishDrive_V1_11_1_Drive_CS {
    RedfishCS_Header                            Header;
    RedfishCS_char                              *odata_context;               
    RedfishCS_char                              *odata_etag;                  
    RedfishCS_char                              *odata_id;                    
    RedfishCS_char                              *odata_type;                  
    RedfishDrive_V1_11_1_Actions_CS             *Actions;                         // The available actions for this
                                                                                  // resource.
    ...
    RedfishCS_char                              *IndicatorLED;                    // The state of the indicator
                                                                                  ...
                                                                                  // drive.
    RedfishDrive_V1_11_1_Links_CS               *Links;                           // The links to other resources
    ...
    RedfishResource_Oem_CS                      *Oem;                             // The OEM extension property.
    RedfishDrive_V1_11_1_Operations_Array_CS    *Operations;                      // The operations currently
...
typedef struct _RedfishDrive_V1_11_1_Operations_Array_CS  {
    RedfishDrive_V1_11_1_Operations_Array_CS    *Next;
    RedfishDrive_V1_11_1_Operations_CS    *ArrayValue;
} RedfishDrive_V1_11_1_Operations_Array_CS;

RedfishCS_status
Json_Drive_V1_11_1_To_CS (char *JsonRawText, RedfishDrive_V1_11_1_Drive_CS **ReturnedCS);

RedfishCS_status
CS_To_Drive_V1_11_1_JSON (RedfishDrive_V1_11_1_Drive_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyDrive_V1_11_1_CS (RedfishDrive_V1_11_1_Drive_CS *CSPtr);

RedfishCS_status
DestroyDrive_V1_11_1_Json (RedfishCS_char *JsonText);
