...
#ifndef RedfishEthernetinterface_V1_2_4_CSTRUCT_H_
#define RedfishEthernetinterface_V1_2_4_CSTRUCT_H_
...
#endif
typedef struct _RedfishEthernetInterface_V1_2_4_IPv6AddressPolicyEntry_Array_CS RedfishEthernetInterface_V1_2_4_IPv6AddressPolicyEntry_Array_CS;
typedef struct _RedfishEthernetInterface_V1_2_4_EthernetInterface_CS RedfishEthernetInterface_V1_2_4_EthernetInterface_CS;
typedef struct _RedfishEthernetInterface_V1_2_4_IPv6AddressPolicyEntry_CS RedfishEthernetInterface_V1_2_4_IPv6AddressPolicyEntry_CS;
typedef struct _RedfishEthernetInterface_V1_2_4_Links_CS RedfishEthernetInterface_V1_2_4_Links_CS;
...
//
typedef struct _RedfishEthernetInterface_V1_2_4_IPv6AddressPolicyEntry_CS {
    ...
    RedfishCS_char     *Prefix;       // The IPv6 Address Prefix (as
                                      // defined in RFC 6724 section
                                      // 2.1).
} RedfishEthernetInterface_V1_2_4_IPv6AddressPolicyEntry_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishEthernetInterface_V1_2_4_Links_CS {
...
} RedfishEthernetInterface_V1_2_4_Links_CS;
...
//
typedef struct _RedfishEthernetInterface_V1_2_4_EthernetInterface_CS {
    ...
    RedfishEthernetInterface_V1_2_4_IPv6AddressPolicyEntry_Array_CS    *IPv6AddressPolicyTable;    // An array representing the RFC
    ...
    RedfishCS_char                                                     *LinkStatus;               // The link status of this
                                                                                                  // interface (port).
    RedfishEthernetInterface_V1_2_4_Links_CS                           *Links;                    // Contains references to other
...
} RedfishEthernetInterface_V1_2_4_EthernetInterface_CS;
...
typedef struct _RedfishEthernetInterface_V1_2_4_IPv6AddressPolicyEntry_Array_CS  {
    RedfishEthernetInterface_V1_2_4_IPv6AddressPolicyEntry_Array_CS    *Next;
    RedfishEthernetInterface_V1_2_4_IPv6AddressPolicyEntry_CS    *ArrayValue;
} RedfishEthernetInterface_V1_2_4_IPv6AddressPolicyEntry_Array_CS;

RedfishCS_status
Json_EthernetInterface_V1_2_4_To_CS (char *JsonRawText, RedfishEthernetInterface_V1_2_4_EthernetInterface_CS **ReturnedCS);

RedfishCS_status
CS_To_EthernetInterface_V1_2_4_JSON (RedfishEthernetInterface_V1_2_4_EthernetInterface_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEthernetInterface_V1_2_4_CS (RedfishEthernetInterface_V1_2_4_EthernetInterface_CS *CSPtr);

RedfishCS_status
DestroyEthernetInterface_V1_2_4_Json (RedfishCS_char *JsonText);
