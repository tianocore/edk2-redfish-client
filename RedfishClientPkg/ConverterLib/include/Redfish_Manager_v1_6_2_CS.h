...
#ifndef RedfishManager_V1_6_2_CSTRUCT_H_
#define RedfishManager_V1_6_2_CSTRUCT_H_
...
#endif
typedef struct _RedfishManager_V1_6_2_Actions_CS RedfishManager_V1_6_2_Actions_CS;
typedef struct _RedfishManager_V1_6_2_CommandShell_CS RedfishManager_V1_6_2_CommandShell_CS;
typedef struct _RedfishManager_V1_6_2_ForceFailover_CS RedfishManager_V1_6_2_ForceFailover_CS;
typedef struct _RedfishManager_V1_6_2_GraphicalConsole_CS RedfishManager_V1_6_2_GraphicalConsole_CS;
typedef struct _RedfishManager_V1_6_2_Links_CS RedfishManager_V1_6_2_Links_CS;
typedef struct _RedfishManager_V1_6_2_Manager_CS RedfishManager_V1_6_2_Manager_CS;
typedef struct _RedfishManager_V1_6_2_ManagerService_CS RedfishManager_V1_6_2_ManagerService_CS;
typedef struct _RedfishManager_V1_6_2_ModifyRedundancySet_CS RedfishManager_V1_6_2_ModifyRedundancySet_CS;
typedef struct _RedfishManager_V1_6_2_OemActions_CS RedfishManager_V1_6_2_OemActions_CS;
typedef struct _RedfishManager_V1_6_2_Reset_CS RedfishManager_V1_6_2_Reset_CS;
typedef struct _RedfishManager_V1_6_2_SerialConsole_CS RedfishManager_V1_6_2_SerialConsole_CS;
...
typedef struct _RedfishManager_V1_6_2_Actions_CS {
    ...
    RedfishManager_V1_6_2_OemActions_CS             *Oem;                           // The available OEM-specific
...
typedef struct _RedfishManager_V1_6_2_Manager_CS {
    ...
    RedfishManager_V1_6_2_Actions_CS             *Actions;                   // The available actions for this
                                                                             // resource.
    RedfishCS_bool                               *AutoDSTEnabled;            // An indication of whether the
                                                                             // manager is configured for
                                                                             // automatic Daylight Saving Time
                                                                             // (DST) adjustment.
    RedfishManager_V1_6_2_CommandShell_CS        *CommandShell;              // The command shell service that
    ...
    RedfishCS_char                               *FirmwareVersion;           // The firmware version of this
                                                                             // manager.
    RedfishManager_V1_6_2_GraphicalConsole_CS    *GraphicalConsole;          // The information about the
    ...
    RedfishCS_Link                               HostInterfaces;             // The link to a collection of
                                                                             ...
                                                                             // property.
    RedfishCS_char                               *Id;                    
    RedfishManager_V1_6_2_Links_CS               *Links;                     // The links to other resources
    ...
    RedfishManager_V1_6_2_SerialConsole_CS       *SerialConsole;             // The serial console service
    ...
    RedfishCS_Link                               VirtualMedia;               // The link to the Virtual Media
                                                                             ...
                                                                             // manager.
} RedfishManager_V1_6_2_Manager_CS;
...
RedfishCS_status
Json_Manager_V1_6_2_To_CS (char *JsonRawText, RedfishManager_V1_6_2_Manager_CS **ReturnedCS);

RedfishCS_status
CS_To_Manager_V1_6_2_JSON (RedfishManager_V1_6_2_Manager_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyManager_V1_6_2_CS (RedfishManager_V1_6_2_Manager_CS *CSPtr);

RedfishCS_status
DestroyManager_V1_6_2_Json (RedfishCS_char *JsonText);
