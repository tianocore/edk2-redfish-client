...
#ifndef RedfishPciedevice_V1_7_0_CSTRUCT_H_
#define RedfishPciedevice_V1_7_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishPCIeDevice_V1_7_0_Actions_CS RedfishPCIeDevice_V1_7_0_Actions_CS;
typedef struct _RedfishPCIeDevice_V1_7_0_Links_CS RedfishPCIeDevice_V1_7_0_Links_CS;
typedef struct _RedfishPCIeDevice_V1_7_0_OemActions_CS RedfishPCIeDevice_V1_7_0_OemActions_CS;
typedef struct _RedfishPCIeDevice_V1_7_0_PCIeDevice_CS RedfishPCIeDevice_V1_7_0_PCIeDevice_CS;
typedef struct _RedfishPCIeDevice_V1_7_0_PCIeInterface_CS RedfishPCIeDevice_V1_7_0_PCIeInterface_CS;
...
typedef struct _RedfishPCIeDevice_V1_7_0_Actions_CS {
    RedfishPCIeDevice_V1_7_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishPCIeDevice_V1_7_0_PCIeDevice_CS {
    ...
    RedfishPCIeDevice_V1_7_0_Actions_CS          *Actions;             // The available actions for this
                                                                       // resource.
    ...
    RedfishCS_char                               *FirmwareVersion;     // The version of firmware for
                                                                       // this PCIe device.
    RedfishCS_char                               *Id;              
    RedfishPCIeDevice_V1_7_0_Links_CS            *Links;               // The links to other resources
    ...
    RedfishCS_Link                               PCIeFunctions;        // The link to the collection of
                                                                       ...
                                                                       // this PCIe device.
    RedfishPCIeDevice_V1_7_0_PCIeInterface_CS    *PCIeInterface;       // The PCIe interface details for
                                                                       // this PCIe device.
...
RedfishCS_status
Json_PCIeDevice_V1_7_0_To_CS (char *JsonRawText, RedfishPCIeDevice_V1_7_0_PCIeDevice_CS **ReturnedCS);

RedfishCS_status
CS_To_PCIeDevice_V1_7_0_JSON (RedfishPCIeDevice_V1_7_0_PCIeDevice_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPCIeDevice_V1_7_0_CS (RedfishPCIeDevice_V1_7_0_PCIeDevice_CS *CSPtr);

RedfishCS_status
DestroyPCIeDevice_V1_7_0_Json (RedfishCS_char *JsonText);
