...
#ifndef RedfishManageraccount_V1_0_8_CSTRUCT_H_
#define RedfishManageraccount_V1_0_8_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishManagerAccount_V1_0_8_Links_CS RedfishManagerAccount_V1_0_8_Links_CS;
typedef struct _RedfishManagerAccount_V1_0_8_ManagerAccount_CS RedfishManagerAccount_V1_0_8_ManagerAccount_CS;
...
//
typedef struct _RedfishManagerAccount_V1_0_8_Links_CS {
    ...
    RedfishCS_Link            Role;    // A reference to the Role object
                                      ...
                                      // property RoleId.
} RedfishManagerAccount_V1_0_8_Links_CS;
...
//
typedef struct _RedfishManagerAccount_V1_0_8_ManagerAccount_CS {
    ...
    RedfishCS_bool                           *Enabled;         // This property is used by a
                                                               ...
                                                               // login.
    RedfishCS_char                           *Id;          
    RedfishManagerAccount_V1_0_8_Links_CS    *Links;           // Contains references to other
...
} RedfishManagerAccount_V1_0_8_ManagerAccount_CS;

RedfishCS_status
Json_ManagerAccount_V1_0_8_To_CS (char *JsonRawText, RedfishManagerAccount_V1_0_8_ManagerAccount_CS **ReturnedCS);

RedfishCS_status
CS_To_ManagerAccount_V1_0_8_JSON (RedfishManagerAccount_V1_0_8_ManagerAccount_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyManagerAccount_V1_0_8_CS (RedfishManagerAccount_V1_0_8_ManagerAccount_CS *CSPtr);

RedfishCS_status
DestroyManagerAccount_V1_0_8_Json (RedfishCS_char *JsonText);
