...
#ifndef RedfishResourceblock_V1_3_0_CSTRUCT_H_
#define RedfishResourceblock_V1_3_0_CSTRUCT_H_
...
typedef struct _RedfishResourceBlock_V1_3_0_Actions_CS RedfishResourceBlock_V1_3_0_Actions_CS;
typedef struct _RedfishResourceBlock_V1_3_0_CompositionStatus_CS RedfishResourceBlock_V1_3_0_CompositionStatus_CS;
typedef struct _RedfishResourceBlock_V1_3_0_Links_CS RedfishResourceBlock_V1_3_0_Links_CS;
typedef struct _RedfishResourceBlock_V1_3_0_OemActions_CS RedfishResourceBlock_V1_3_0_OemActions_CS;
typedef struct _RedfishResourceBlock_V1_3_0_ResourceBlock_CS RedfishResourceBlock_V1_3_0_ResourceBlock_CS;
typedef struct _RedfishResourceBlock_V1_3_0_ResourceBlockLimits_CS RedfishResourceBlock_V1_3_0_ResourceBlockLimits_CS;
...
typedef struct _RedfishResourceBlock_V1_3_0_Actions_CS {
    RedfishResourceBlock_V1_3_0_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishResourceBlock_V1_3_0_ResourceBlock_CS {
    ...
    RedfishResourceBlock_V1_3_0_Actions_CS              *Actions;                         // The available actions for this
                                                                                          // resource.
    RedfishResourceBlock_V1_3_0_CompositionStatus_CS    *CompositionStatus;               // This property describes the
    ...
    RedfishCS_char                                      *Id;                          
    RedfishResourceBlock_V1_3_0_Links_CS                *Links;                           // Contains references to other
...
RedfishCS_status
Json_ResourceBlock_V1_3_0_To_CS (char *JsonRawText, RedfishResourceBlock_V1_3_0_ResourceBlock_CS **ReturnedCS);

RedfishCS_status
CS_To_ResourceBlock_V1_3_0_JSON (RedfishResourceBlock_V1_3_0_ResourceBlock_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyResourceBlock_V1_3_0_CS (RedfishResourceBlock_V1_3_0_ResourceBlock_CS *CSPtr);

RedfishCS_status
DestroyResourceBlock_V1_3_0_Json (RedfishCS_char *JsonText);
