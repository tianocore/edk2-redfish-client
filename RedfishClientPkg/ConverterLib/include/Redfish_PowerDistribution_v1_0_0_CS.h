...
#ifndef RedfishPowerdistribution_V1_0_0_CSTRUCT_H_
#define RedfishPowerdistribution_V1_0_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishPowerDistribution_V1_0_0_Actions_CS RedfishPowerDistribution_V1_0_0_Actions_CS;
typedef struct _RedfishPowerDistribution_V1_0_0_Links_CS RedfishPowerDistribution_V1_0_0_Links_CS;
typedef struct _RedfishPowerDistribution_V1_0_0_OemActions_CS RedfishPowerDistribution_V1_0_0_OemActions_CS;
typedef struct _RedfishPowerDistribution_V1_0_0_PowerDistribution_CS RedfishPowerDistribution_V1_0_0_PowerDistribution_CS;
typedef struct _RedfishPowerDistribution_V1_0_0_TransferConfiguration_CS RedfishPowerDistribution_V1_0_0_TransferConfiguration_CS;
typedef struct _RedfishPowerDistribution_V1_0_0_TransferControl_CS RedfishPowerDistribution_V1_0_0_TransferControl_CS;
typedef struct _RedfishPowerDistribution_V1_0_0_TransferCriteria_CS RedfishPowerDistribution_V1_0_0_TransferCriteria_CS;
...
typedef struct _RedfishPowerDistribution_V1_0_0_Actions_CS {
    ...
    RedfishPowerDistribution_V1_0_0_OemActions_CS         *Oem;                                 // The available OEM-specific
...
typedef struct _RedfishPowerDistribution_V1_0_0_PowerDistribution_CS {
    ...
    RedfishPowerDistribution_V1_0_0_Actions_CS                  *Actions;                 // The available actions for this
                                                                                          // resource.
    ...
    RedfishCS_char                                              *FirmwareVersion;         // The firmware version of this
                                                                                          // equipment.
    RedfishCS_char                                              *Id;                  
    RedfishPowerDistribution_V1_0_0_Links_CS                    *Links;                   // The links to other resources
    ...
    RedfishCS_Link                                              Subfeeds;                 // A link to the subfeed circuits
                                                                                          // for this equipment.
    RedfishPowerDistribution_V1_0_0_TransferConfiguration_CS    *TransferConfiguration;    // The configuration settings for
                                                                                          // an automatic transfer switch.
    RedfishPowerDistribution_V1_0_0_TransferCriteria_CS         *TransferCriteria;        // The criteria used to initiate
...
RedfishCS_status
Json_PowerDistribution_V1_0_0_To_CS (char *JsonRawText, RedfishPowerDistribution_V1_0_0_PowerDistribution_CS **ReturnedCS);

RedfishCS_status
CS_To_PowerDistribution_V1_0_0_JSON (RedfishPowerDistribution_V1_0_0_PowerDistribution_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPowerDistribution_V1_0_0_CS (RedfishPowerDistribution_V1_0_0_PowerDistribution_CS *CSPtr);

RedfishCS_status
DestroyPowerDistribution_V1_0_0_Json (RedfishCS_char *JsonText);
