...
#ifndef RedfishManageraccount_V1_2_2_CSTRUCT_H_
#define RedfishManageraccount_V1_2_2_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishManagerAccount_V1_2_2_Actions_CS RedfishManagerAccount_V1_2_2_Actions_CS;
typedef struct _RedfishManagerAccount_V1_2_2_Links_CS RedfishManagerAccount_V1_2_2_Links_CS;
typedef struct _RedfishManagerAccount_V1_2_2_ManagerAccount_CS RedfishManagerAccount_V1_2_2_ManagerAccount_CS;
typedef struct _RedfishManagerAccount_V1_2_2_OemActions_CS RedfishManagerAccount_V1_2_2_OemActions_CS;
...
typedef struct _RedfishManagerAccount_V1_2_2_Actions_CS {
    RedfishManagerAccount_V1_2_2_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishManagerAccount_V1_2_2_ManagerAccount_CS {
    ...
    RedfishManagerAccount_V1_2_2_Actions_CS    *Actions;         // The available actions for this
                                                                 // Resource.
    ...
    RedfishCS_char                             *Id;          
    RedfishManagerAccount_V1_2_2_Links_CS      *Links;           // The links to other Resources
...
RedfishCS_status
Json_ManagerAccount_V1_2_2_To_CS (char *JsonRawText, RedfishManagerAccount_V1_2_2_ManagerAccount_CS **ReturnedCS);

RedfishCS_status
CS_To_ManagerAccount_V1_2_2_JSON (RedfishManagerAccount_V1_2_2_ManagerAccount_CS *CSPtr, char **JsonText);
