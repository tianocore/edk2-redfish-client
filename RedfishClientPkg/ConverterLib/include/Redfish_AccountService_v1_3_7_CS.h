...
#ifndef RedfishAccountservice_V1_3_7_CSTRUCT_H_
#define RedfishAccountservice_V1_3_7_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishAccountService_V1_3_7_RoleMapping_Array_CS RedfishAccountService_V1_3_7_RoleMapping_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishAccountService_V1_3_7_AccountService_CS RedfishAccountService_V1_3_7_AccountService_CS;
typedef struct _RedfishAccountService_V1_3_7_Actions_CS RedfishAccountService_V1_3_7_Actions_CS;
typedef struct _RedfishAccountService_V1_3_7_Authentication_CS RedfishAccountService_V1_3_7_Authentication_CS;
typedef struct _RedfishAccountService_V1_3_7_ExternalAccountProvider_CS RedfishAccountService_V1_3_7_ExternalAccountProvider_CS;
typedef struct _RedfishAccountService_V1_3_7_LDAPSearchSettings_CS RedfishAccountService_V1_3_7_LDAPSearchSettings_CS;
typedef struct _RedfishAccountService_V1_3_7_LDAPService_CS RedfishAccountService_V1_3_7_LDAPService_CS;
typedef struct _RedfishAccountService_V1_3_7_OemActions_CS RedfishAccountService_V1_3_7_OemActions_CS;
typedef struct _RedfishAccountService_V1_3_7_RoleMapping_CS RedfishAccountService_V1_3_7_RoleMapping_CS;
...
//
typedef struct _RedfishAccountService_V1_3_7_Actions_CS {
    RedfishAccountService_V1_3_7_OemActions_CS    *Oem;    // The available OEM-specific
                                                          // actions for this resource.
} RedfishAccountService_V1_3_7_Actions_CS;

//
// The information required to authenticate to the external service.
//
typedef struct _RedfishAccountService_V1_3_7_Authentication_CS {
...
} RedfishAccountService_V1_3_7_Authentication_CS;

//
// The external account provider services that can provide accounts for this
// manager to use for authentication.
//
typedef struct _RedfishAccountService_V1_3_7_ExternalAccountProvider_CS {
    RedfishCS_char                                       *AccountProviderType;    // The type of external account
                                                                                 // provider to which this service
                                                                                 // connects.
    RedfishAccountService_V1_3_7_Authentication_CS       *Authentication;        // The authentication information
                                                                                 // for the external account
                                                                                 // provider.
    RedfishAccountService_V1_3_7_LDAPService_CS          *LDAPService;           // The additional mapping
                                                                                 // information needed to parse a
                                                                                 // generic LDAP service.
    RedfishAccountService_V1_3_7_RoleMapping_Array_CS    *RemoteRoleMapping;     // The mapping rules to convert
    ...
    RedfishCS_bool                                       *ServiceEnabled;        // An indication of whether this
                                                                                 // service is enabled.
} RedfishAccountService_V1_3_7_ExternalAccountProvider_CS;

//
// The settings to search a generic LDAP service.
//
typedef struct _RedfishAccountService_V1_3_7_LDAPSearchSettings_CS {
    ...
    RedfishCS_char          *UsernameAttribute;        // The attribute name that
                                                       ...
                                                       // entry.
} RedfishAccountService_V1_3_7_LDAPSearchSettings_CS;

//
// The settings required to parse a generic LDAP service.
//
typedef struct _RedfishAccountService_V1_3_7_LDAPService_CS {
    RedfishResource_Oem_CS                                *Oem;              // The OEM extension property.
    RedfishAccountService_V1_3_7_LDAPSearchSettings_CS    *SearchSettings;    // The required settings to
                                                                             // search an external LDAP
                                                                             // service.
} RedfishAccountService_V1_3_7_LDAPService_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishAccountService_V1_3_7_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishAccountService_V1_3_7_OemActions_CS;

//
// The mapping rules that are used to convert the external account providers
// account information to the local Redfish role.
//
typedef struct _RedfishAccountService_V1_3_7_RoleMapping_CS {
    ...
    RedfishCS_char            *RemoteUser;    // The name of the remote user
                                              ...
                                              // links.
} RedfishAccountService_V1_3_7_RoleMapping_CS;
...
//
typedef struct _RedfishAccountService_V1_3_7_AccountService_CS {
    ...
    RedfishCS_Link                                             Accounts;                             // The collection of manager
                                                                                                     // accounts.
    RedfishAccountService_V1_3_7_Actions_CS                    *Actions;                             // The available actions for this
                                                                                                     // resource.
    RedfishAccountService_V1_3_7_ExternalAccountProvider_CS    *ActiveDirectory;                     // The first Active Directory
    ...
    RedfishCS_char                                             *Id;                              
    RedfishAccountService_V1_3_7_ExternalAccountProvider_CS    *LDAP;                                // The first LDAP external
...
} RedfishAccountService_V1_3_7_AccountService_CS;

typedef struct _RedfishAccountService_V1_3_7_RoleMapping_Array_CS  {
    RedfishAccountService_V1_3_7_RoleMapping_Array_CS    *Next;
    RedfishAccountService_V1_3_7_RoleMapping_CS    *ArrayValue;
} RedfishAccountService_V1_3_7_RoleMapping_Array_CS;
...
RedfishCS_status
Json_AccountService_V1_3_7_To_CS (char *JsonRawText, RedfishAccountService_V1_3_7_AccountService_CS **ReturnedCS);

RedfishCS_status
CS_To_AccountService_V1_3_7_JSON (RedfishAccountService_V1_3_7_AccountService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAccountService_V1_3_7_CS (RedfishAccountService_V1_3_7_AccountService_CS *CSPtr);

RedfishCS_status
DestroyAccountService_V1_3_7_Json (RedfishCS_char *JsonText);
