...
#ifndef RedfishHostinterface_V1_0_4_CSTRUCT_H_
#define RedfishHostinterface_V1_0_4_CSTRUCT_H_
...
#endif
typedef struct _RedfishHostInterface_V1_0_4_HostInterface_CS RedfishHostInterface_V1_0_4_HostInterface_CS;
typedef struct _RedfishHostInterface_V1_0_4_Links_CS RedfishHostInterface_V1_0_4_Links_CS;
...
//
typedef struct _RedfishHostInterface_V1_0_4_Links_CS {
...
} RedfishHostInterface_V1_0_4_Links_CS;
...
//
typedef struct _RedfishHostInterface_V1_0_4_HostInterface_CS {
    ...
    RedfishCS_char                          *KernelAuthRoleId;          // The Role used for kernel
                                                                        // authentication on this
                                                                        // interface.
    RedfishHostInterface_V1_0_4_Links_CS    *Links;                     // Contains references to other
...
} RedfishHostInterface_V1_0_4_HostInterface_CS;
...
RedfishCS_status
Json_HostInterface_V1_0_4_To_CS (char *JsonRawText, RedfishHostInterface_V1_0_4_HostInterface_CS **ReturnedCS);

RedfishCS_status
CS_To_HostInterface_V1_0_4_JSON (RedfishHostInterface_V1_0_4_HostInterface_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyHostInterface_V1_0_4_CS (RedfishHostInterface_V1_0_4_HostInterface_CS *CSPtr);

RedfishCS_status
DestroyHostInterface_V1_0_4_Json (RedfishCS_char *JsonText);
