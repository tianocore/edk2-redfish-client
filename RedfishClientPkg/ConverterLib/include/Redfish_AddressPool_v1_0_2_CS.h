...
#ifndef RedfishAddresspool_V1_0_2_CSTRUCT_H_
#define RedfishAddresspool_V1_0_2_CSTRUCT_H_
...
#endif
typedef struct _RedfishAddressPool_V1_0_2_Actions_CS RedfishAddressPool_V1_0_2_Actions_CS;
typedef struct _RedfishAddressPool_V1_0_2_AddressPool_CS RedfishAddressPool_V1_0_2_AddressPool_CS;
typedef struct _RedfishAddressPool_V1_0_2_GenZ_CS RedfishAddressPool_V1_0_2_GenZ_CS;
typedef struct _RedfishAddressPool_V1_0_2_Links_CS RedfishAddressPool_V1_0_2_Links_CS;
typedef struct _RedfishAddressPool_V1_0_2_OemActions_CS RedfishAddressPool_V1_0_2_OemActions_CS;
...
typedef struct _RedfishAddressPool_V1_0_2_Actions_CS {
    RedfishAddressPool_V1_0_2_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishAddressPool_V1_0_2_AddressPool_CS {
    ...
    RedfishAddressPool_V1_0_2_Actions_CS    *Actions;         // The available actions for this
                                                              // resource.
    RedfishCS_char                          *Description; 
    RedfishAddressPool_V1_0_2_GenZ_CS       *GenZ;            // The Gen-Z related properties
                                                              // for this address pool.
    RedfishCS_char                          *Id;          
    RedfishAddressPool_V1_0_2_Links_CS      *Links;           // The links to other resources
...
RedfishCS_status
Json_AddressPool_V1_0_2_To_CS (char *JsonRawText, RedfishAddressPool_V1_0_2_AddressPool_CS **ReturnedCS);

RedfishCS_status
CS_To_AddressPool_V1_0_2_JSON (RedfishAddressPool_V1_0_2_AddressPool_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAddressPool_V1_0_2_CS (RedfishAddressPool_V1_0_2_AddressPool_CS *CSPtr);

RedfishCS_status
DestroyAddressPool_V1_0_2_Json (RedfishCS_char *JsonText);
