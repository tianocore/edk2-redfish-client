...
#ifndef RedfishThermal_V1_4_6_CSTRUCT_H_
#define RedfishThermal_V1_4_6_CSTRUCT_H_
...
#endif
typedef struct _RedfishThermal_V1_4_6_Fan_Array_CS RedfishThermal_V1_4_6_Fan_Array_CS;
typedef struct _RedfishThermal_V1_4_6_Temperature_Array_CS RedfishThermal_V1_4_6_Temperature_Array_CS;
...
typedef struct _RedfishThermal_V1_4_6_Fan_CS RedfishThermal_V1_4_6_Fan_CS;
typedef struct _RedfishThermal_V1_4_6_FanActions_CS RedfishThermal_V1_4_6_FanActions_CS;
typedef struct _RedfishThermal_V1_4_6_FanOemActions_CS RedfishThermal_V1_4_6_FanOemActions_CS;
typedef struct _RedfishThermal_V1_4_6_Temperature_CS RedfishThermal_V1_4_6_Temperature_CS;
typedef struct _RedfishThermal_V1_4_6_TemperatureActions_CS RedfishThermal_V1_4_6_TemperatureActions_CS;
typedef struct _RedfishThermal_V1_4_6_TemperatureOemActions_CS RedfishThermal_V1_4_6_TemperatureOemActions_CS;
typedef struct _RedfishThermal_V1_4_6_Thermal_CS RedfishThermal_V1_4_6_Thermal_CS;
typedef struct _RedfishThermal_V1_4_6_ThermalActions_CS RedfishThermal_V1_4_6_ThermalActions_CS;
typedef struct _RedfishThermal_V1_4_6_ThermalOemActions_CS RedfishThermal_V1_4_6_ThermalOemActions_CS;
...
typedef struct _RedfishThermal_V1_4_6_Fan_CS {
    RedfishCS_char                         *odata_id;                
    RedfishThermal_V1_4_6_FanActions_CS    *Actions;                     // The available actions for this
                                                                         // resource.
...
} RedfishThermal_V1_4_6_Fan_CS;

//
// The available actions for this resource.
//
typedef struct _RedfishThermal_V1_4_6_FanActions_CS {
    RedfishThermal_V1_4_6_FanOemActions_CS    *Oem;    // The available OEM-specific
                                                      // actions for this resource.
} RedfishThermal_V1_4_6_FanActions_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishThermal_V1_4_6_FanOemActions_CS {
    RedfishCS_Link    Prop;
} RedfishThermal_V1_4_6_FanOemActions_CS;

typedef struct _RedfishThermal_V1_4_6_Temperature_CS {
    RedfishCS_char                                 *odata_id;                         
    RedfishThermal_V1_4_6_TemperatureActions_CS    *Actions;                              // The available actions for this
                                                                                          // resource.
    ...
    RedfishCS_int64                                *UpperThresholdNonCritical;            // The value at which the reading
                                                                                          // is above normal range.
} RedfishThermal_V1_4_6_Temperature_CS;

//
// The available actions for this resource.
//
typedef struct _RedfishThermal_V1_4_6_TemperatureActions_CS {
    RedfishThermal_V1_4_6_TemperatureOemActions_CS    *Oem;    // The available OEM-specific
                                                              // actions for this resource.
} RedfishThermal_V1_4_6_TemperatureActions_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishThermal_V1_4_6_TemperatureOemActions_CS {
    RedfishCS_Link    Prop;
} RedfishThermal_V1_4_6_TemperatureOemActions_CS;

//
// The available actions for this resource.
//
typedef struct _RedfishThermal_V1_4_6_ThermalActions_CS {
    RedfishThermal_V1_4_6_ThermalOemActions_CS    *Oem;    // The available OEM-specific
                                                          // actions for this resource.
} RedfishThermal_V1_4_6_ThermalActions_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishThermal_V1_4_6_ThermalOemActions_CS {
    RedfishCS_Link    Prop;
} RedfishThermal_V1_4_6_ThermalOemActions_CS;
...
//
typedef struct _RedfishThermal_V1_4_6_Thermal_CS {
    RedfishCS_Header                              Header;
    RedfishCS_char                                *odata_context;         
    RedfishCS_char                                *odata_etag;            
    RedfishCS_char                                *odata_id;              
    RedfishCS_char                                *odata_type;            
    RedfishThermal_V1_4_6_ThermalActions_CS       *Actions;                   // The available actions for this
                                                                              // resource.
    RedfishCS_char                                *Description;           
    RedfishThermal_V1_4_6_Fan_Array_CS            *Fans;                      // The set of fans for this
                                                                              // chassis.
    ...
    RedfishResource_Status_CS                     *Status;                    // The status and health of the
                                                                              // resource and its subordinate
                                                                              // or dependent resources.
    RedfishThermal_V1_4_6_Temperature_Array_CS    *Temperatures;              // The set of temperature sensors
                                                                              // for this chassis.
    RedfishCS_int64                               *Temperaturesodata_count;
} RedfishThermal_V1_4_6_Thermal_CS;
...
typedef struct _RedfishThermal_V1_4_6_Fan_Array_CS  {
    RedfishThermal_V1_4_6_Fan_Array_CS    *Next;
    RedfishThermal_V1_4_6_Fan_CS    *ArrayValue;
} RedfishThermal_V1_4_6_Fan_Array_CS;

typedef struct _RedfishThermal_V1_4_6_Temperature_Array_CS  {
    RedfishThermal_V1_4_6_Temperature_Array_CS    *Next;
    RedfishThermal_V1_4_6_Temperature_CS    *ArrayValue;
} RedfishThermal_V1_4_6_Temperature_Array_CS;

RedfishCS_status
Json_Thermal_V1_4_6_To_CS (char *JsonRawText, RedfishThermal_V1_4_6_Thermal_CS **ReturnedCS);

RedfishCS_status
CS_To_Thermal_V1_4_6_JSON (RedfishThermal_V1_4_6_Thermal_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyThermal_V1_4_6_CS (RedfishThermal_V1_4_6_Thermal_CS *CSPtr);

RedfishCS_status
DestroyThermal_V1_4_6_Json (RedfishCS_char *JsonText);
