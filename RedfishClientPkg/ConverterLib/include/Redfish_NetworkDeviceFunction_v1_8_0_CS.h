...
#ifndef RedfishNetworkdevicefunction_V1_8_0_CSTRUCT_H_
#define RedfishNetworkdevicefunction_V1_8_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishNetworkDeviceFunction_V1_8_0_BootTargets_Array_CS RedfishNetworkDeviceFunction_V1_8_0_BootTargets_Array_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_8_0_Limit_Array_CS RedfishNetworkDeviceFunction_V1_8_0_Limit_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishNetworkDeviceFunction_V1_8_0_Actions_CS RedfishNetworkDeviceFunction_V1_8_0_Actions_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_8_0_BootTargets_CS RedfishNetworkDeviceFunction_V1_8_0_BootTargets_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_8_0_Ethernet_CS RedfishNetworkDeviceFunction_V1_8_0_Ethernet_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_8_0_FibreChannel_CS RedfishNetworkDeviceFunction_V1_8_0_FibreChannel_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_8_0_InfiniBand_CS RedfishNetworkDeviceFunction_V1_8_0_InfiniBand_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_8_0_Limit_CS RedfishNetworkDeviceFunction_V1_8_0_Limit_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_8_0_Links_CS RedfishNetworkDeviceFunction_V1_8_0_Links_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_8_0_NetworkDeviceFunction_CS RedfishNetworkDeviceFunction_V1_8_0_NetworkDeviceFunction_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_8_0_OemActions_CS RedfishNetworkDeviceFunction_V1_8_0_OemActions_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_8_0_iSCSIBoot_CS RedfishNetworkDeviceFunction_V1_8_0_iSCSIBoot_CS;
...
typedef struct _RedfishNetworkDeviceFunction_V1_8_0_Actions_CS {
    RedfishNetworkDeviceFunction_V1_8_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishNetworkDeviceFunction_V1_8_0_Ethernet_CS {
    RedfishCS_Link     EthernetInterfaces;     // The Ethernet interface
                                               // collection that represents all
                                               // the Ethernet Interfaces on
    ...
    RedfishCS_int64    *MTUSize;               // The maximum transmission unit
                                               ...
                                               // network device function.
    RedfishCS_int64    *MTUSizeMaximum;        // The largest maximum
    ...
    RedfishCS_Link     VLAN;                   // The VLAN information for this
                                               // interface.  If this network
                                               // interface supports more than
                                               // one VLAN, this property is not
                                               // present.
    RedfishCS_Link     VLANs;                  // The link to a collection of
                                               // VLANs.  This property is used
                                               // only if the interface supports
                                               // more than one VLAN.
...
// network device function.
//
typedef struct _RedfishNetworkDeviceFunction_V1_8_0_FibreChannel_CS {
    RedfishCS_bool                                              *AllowFIPVLANDiscovery;    // An indication of whether the
                                                                                          // FCoE Initialization Protocol
                                                                                          // (FIP) populates the FCoE VLAN
                                                                                          // ID.
    RedfishNetworkDeviceFunction_V1_8_0_BootTargets_Array_CS    *BootTargets;             // An array of Fibre Channel boot
    ...
    RedfishCS_int64                                             *FCoELocalVLANId;         // The locally configured FCoE
                                                                                          // VLAN ID.
    RedfishCS_char                                              *FibreChannelId;          // The Fibre Channel ID that the
                                                                                          // switch assigns for this
                                                                                          // interface.
    ...
    RedfishCS_char                                              *WWPN;                    // The currently configured World
                                                                                          ...
                                                                                          // of this function.
} RedfishNetworkDeviceFunction_V1_8_0_FibreChannel_CS;

//
// This type describes InfiniBand capabilities, status, and configuration of a
// network device function.
//
typedef struct _RedfishNetworkDeviceFunction_V1_8_0_InfiniBand_CS {
    RedfishCS_int64          *MTUSize;               // The maximum transmission unit
                                                     // (MTU) configured for this
                                                     // network device function.
    RedfishCS_char           *NodeGUID;              // This is the currently
                                                     // configured node GUID of the
                                                     // network device function.
    RedfishCS_char           *PermanentNodeGUID;     // The permanent node GUID
                                                     // assigned to this network
                                                     // device function.
    RedfishCS_char           *PermanentPortGUID;     // The permanent port GUID
                                                     // assigned to this network
                                                     // device function.
    RedfishCS_char           *PermanentSystemGUID;    // The permanent system GUID
                                                     // assigned to this network
                                                     // device function.
    RedfishCS_char           *PortGUID;              // The currently configured port
                                                     // GUID of the network device
                                                     // function.
    RedfishCS_int64_Array    *SupportedMTUSizes;     // The maximum transmission unit
                                                     // (MTU) sizes supported for this
                                                     // network device function.
    RedfishCS_char           *SystemGUID;            // This is the currently
                                                     // configured system GUID of the
                                                     // network device function.
} RedfishNetworkDeviceFunction_V1_8_0_InfiniBand_CS;
...
typedef struct _RedfishNetworkDeviceFunction_V1_8_0_Limit_CS {
    RedfishCS_int64    *BurstBytesPerSecond;         // The maximum number of bytes
                                                     // per second in a burst for this
                                                     // network device function.
    RedfishCS_int64    *BurstPacketsPerSecond;       // The maximum number of packets
                                                     // per second in a burst for this
                                                     // network device function.
    RedfishCS_char     *Direction;                   // Indicates the direction of the
                                                     // data to which this limit
                                                     // applies.
    RedfishCS_int64    *SustainedBytesPerSecond;     // The maximum number of
                                                     // sustained bytes per second for
                                                     // this network device function.
    RedfishCS_int64    *SustainedPacketsPerSecond;    // The maximum number of
...
typedef struct _RedfishNetworkDeviceFunction_V1_8_0_Links_CS {
    ...
    RedfishCS_Link            EthernetInterface;                // The link to a virtual Ethernet
                                                                // interface that was created
                                                                // when one of the network device
                                                                // function VLANs is represented
                                                                // as a virtual NIC for the
                                                                // purpose of showing the IP
                                                                // address associated with that
                                                                // VLAN.
    RedfishCS_Link            EthernetInterfaces;               // The links to Ethernet
                                                                // interfaces that were created
                                                                // when one of the network device
                                                                // function VLANs is represented
                                                                // as a virtual NIC for the
                                                                // purpose of showing the IP
    ...
    RedfishCS_Link            OffloadProcessors;                // The processors that perform
                                                                // offload computation for this
                                                                // network function, such as with
                                                                // a SmartNIC.
    RedfishCS_int64           *OffloadProcessorsodata_count;
    RedfishCS_Link            OffloadSystem;                    // The system that performs
                                                                // offload computation for this
                                                                // network function, such as with
                                                                // a SmartNIC.
    RedfishCS_Link            PCIeFunction;                     // The link to the PCIe function
                                                                // associated with this network
                                                                // device function.
    RedfishCS_Link            PhysicalNetworkPortAssignment;    // The physical port to which
                                                                // this network device function
...
typedef struct _RedfishNetworkDeviceFunction_V1_8_0_NetworkDeviceFunction_CS {
    ...
    RedfishNetworkDeviceFunction_V1_8_0_Actions_CS         *Actions;                                     // The available actions for this
                                                                                                         // resource.
    RedfishCS_Link                                         AllowDeny;                                    // The link to the collection of
                                                                                                         // allow and deny permissions for
                                                                                                         // packets leaving and arriving
                                                                                                         // to this network device
                                                                                                         // function.
    RedfishCS_Link                                         AssignablePhysicalNetworkPorts;               // An array of physical ports to
    ...
    RedfishCS_bool                                         *DeviceEnabled;                               // An indication of whether the
                                                                                                         ...
                                                                                                         // enabled.
    RedfishNetworkDeviceFunction_V1_8_0_Ethernet_CS        *Ethernet;                                    // The Ethernet capabilities,
                                                                                                         // status, and configuration
                                                                                                         // values for this network device
                                                                                                         // function.
    RedfishNetworkDeviceFunction_V1_8_0_FibreChannel_CS    *FibreChannel;                                // The Fibre Channel
                                                                                                         // capabilities, status, and
                                                                                                         // configuration values for this
                                                                                                         // network device function.
    RedfishCS_char                                         *Id;                                      
    RedfishNetworkDeviceFunction_V1_8_0_InfiniBand_CS      *InfiniBand;                                  // The InfiniBand capabilities,
                                                                                                         // status, and configuration
                                                                                                         // values for this network device
                                                                                                         // function.
    RedfishNetworkDeviceFunction_V1_8_0_Limit_Array_CS     *Limits;                                      // The byte and packet limits for
                                                                                                         // this network device function.
    RedfishNetworkDeviceFunction_V1_8_0_Links_CS           *Links;                                       // The links to other resources
    ...
    RedfishCS_Link                                         PhysicalPortAssignment;                       // The physical port to which
                                                                                                         // this network device function
                                                                                                         // is currently assigned.
    RedfishCS_bool                                         *SAVIEnabled;                                 // Indicates if Source Address
                                                                                                         // Validation Improvement (SAVI)
                                                                                                         // is enabled for this network
                                                                                                         // device function.
    ...
    RedfishCS_bool                                         *VirtualFunctionsEnabled;                     // An indication of whether
                                                                                                         ...
                                                                                                         // for this network device
                                                                                                         // function.
    RedfishNetworkDeviceFunction_V1_8_0_iSCSIBoot_CS       *iSCSIBoot;                                   // The iSCSI boot capabilities,
                                                                                                         // status, and configuration
                                                                                                         // values for this network device
                                                                                                         // function.
...
typedef struct _RedfishNetworkDeviceFunction_V1_8_0_BootTargets_Array_CS  {
    RedfishNetworkDeviceFunction_V1_8_0_BootTargets_Array_CS    *Next;
    RedfishNetworkDeviceFunction_V1_8_0_BootTargets_CS    *ArrayValue;
} RedfishNetworkDeviceFunction_V1_8_0_BootTargets_Array_CS;

typedef struct _RedfishNetworkDeviceFunction_V1_8_0_Limit_Array_CS  {
    RedfishNetworkDeviceFunction_V1_8_0_Limit_Array_CS    *Next;
    RedfishNetworkDeviceFunction_V1_8_0_Limit_CS    *ArrayValue;
} RedfishNetworkDeviceFunction_V1_8_0_Limit_Array_CS;
...
RedfishCS_status
Json_NetworkDeviceFunction_V1_8_0_To_CS (char *JsonRawText, RedfishNetworkDeviceFunction_V1_8_0_NetworkDeviceFunction_CS **ReturnedCS);

RedfishCS_status
CS_To_NetworkDeviceFunction_V1_8_0_JSON (RedfishNetworkDeviceFunction_V1_8_0_NetworkDeviceFunction_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyNetworkDeviceFunction_V1_8_0_CS (RedfishNetworkDeviceFunction_V1_8_0_NetworkDeviceFunction_CS *CSPtr);

RedfishCS_status
DestroyNetworkDeviceFunction_V1_8_0_Json (RedfishCS_char *JsonText);
