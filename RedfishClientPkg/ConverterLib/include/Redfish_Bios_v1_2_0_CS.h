...
#ifndef RedfishBios_V1_2_0_CSTRUCT_H_
#define RedfishBios_V1_2_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishBios_V1_2_0_Actions_CS RedfishBios_V1_2_0_Actions_CS;
typedef struct _RedfishBios_V1_2_0_Attributes_CS RedfishBios_V1_2_0_Attributes_CS;
typedef struct _RedfishBios_V1_2_0_Bios_CS RedfishBios_V1_2_0_Bios_CS;
typedef struct _RedfishBios_V1_2_0_ChangePassword_CS RedfishBios_V1_2_0_ChangePassword_CS;
typedef struct _RedfishBios_V1_2_0_Links_CS RedfishBios_V1_2_0_Links_CS;
typedef struct _RedfishBios_V1_2_0_OemActions_CS RedfishBios_V1_2_0_OemActions_CS;
typedef struct _RedfishBios_V1_2_0_ResetBios_CS RedfishBios_V1_2_0_ResetBios_CS;
...
typedef struct _RedfishBios_V1_2_0_Actions_CS {
    ...
    RedfishBios_V1_2_0_OemActions_CS        *Oem;                   // The available OEM-specific
...
typedef struct _RedfishBios_V1_2_0_Bios_CS {
    ...
    RedfishBios_V1_2_0_Actions_CS       *Actions;                      // The available actions for this
                                                                       // resource.
    RedfishCS_char                      *AttributeRegistry;            // The resource ID of the
                                                                       ...
                                                                       // resource.
    RedfishBios_V1_2_0_Attributes_CS    *Attributes;                   // The list of BIOS attributes
                                                                       // specific to the manufacturer
                                                                       // or provider.
    RedfishCS_char                      *Description;              
    RedfishCS_char                      *Id;                       
    RedfishBios_V1_2_0_Links_CS         *Links;                        // The links to other resources
                                                                       // that are related to this
                                                                       // resource.
    RedfishCS_char                      *Name;                     
    RedfishResource_Oem_CS              *Oem;                          // The OEM extension property.
    RedfishCS_bool                      *ResetBiosToDefaultsPending;    // An indication of whether there
                                                                       // is a pending request to reset
                                                                       // the BIOS attributes to default
                                                                       // values.
} RedfishBios_V1_2_0_Bios_CS;

RedfishCS_status
Json_Bios_V1_2_0_To_CS (char *JsonRawText, RedfishBios_V1_2_0_Bios_CS **ReturnedCS);

RedfishCS_status
CS_To_Bios_V1_2_0_JSON (RedfishBios_V1_2_0_Bios_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyBios_V1_2_0_CS (RedfishBios_V1_2_0_Bios_CS *CSPtr);

RedfishCS_status
DestroyBios_V1_2_0_Json (RedfishCS_char *JsonText);
