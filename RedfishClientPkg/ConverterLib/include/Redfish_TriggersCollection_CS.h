...
#ifndef RedfishTriggerscollection_Noversioned_CSTRUCT_H_
#define RedfishTriggerscollection_Noversioned_CSTRUCT_H_
...
//
// The collection of Triggers resource instances.
//
