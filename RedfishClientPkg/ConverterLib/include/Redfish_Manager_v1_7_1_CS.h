...
#ifndef RedfishManager_V1_7_1_CSTRUCT_H_
#define RedfishManager_V1_7_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishManager_V1_7_1_Actions_CS RedfishManager_V1_7_1_Actions_CS;
typedef struct _RedfishManager_V1_7_1_CommandShell_CS RedfishManager_V1_7_1_CommandShell_CS;
typedef struct _RedfishManager_V1_7_1_ForceFailover_CS RedfishManager_V1_7_1_ForceFailover_CS;
typedef struct _RedfishManager_V1_7_1_GraphicalConsole_CS RedfishManager_V1_7_1_GraphicalConsole_CS;
typedef struct _RedfishManager_V1_7_1_Links_CS RedfishManager_V1_7_1_Links_CS;
typedef struct _RedfishManager_V1_7_1_Manager_CS RedfishManager_V1_7_1_Manager_CS;
typedef struct _RedfishManager_V1_7_1_ManagerService_CS RedfishManager_V1_7_1_ManagerService_CS;
typedef struct _RedfishManager_V1_7_1_ModifyRedundancySet_CS RedfishManager_V1_7_1_ModifyRedundancySet_CS;
typedef struct _RedfishManager_V1_7_1_OemActions_CS RedfishManager_V1_7_1_OemActions_CS;
typedef struct _RedfishManager_V1_7_1_Reset_CS RedfishManager_V1_7_1_Reset_CS;
typedef struct _RedfishManager_V1_7_1_SerialConsole_CS RedfishManager_V1_7_1_SerialConsole_CS;
...
//
typedef struct _RedfishManager_V1_7_1_Actions_CS {
    RedfishManager_V1_7_1_ForceFailover_CS          *Manager_ForceFailover;     
    RedfishManager_V1_7_1_ModifyRedundancySet_CS    *Manager_ModifyRedundancySet;
    RedfishManager_V1_7_1_Reset_CS                  *Manager_Reset;             
    RedfishManager_V1_7_1_OemActions_CS             *Oem;                           // The available OEM-specific
                                                                                    // actions for this resource.
} RedfishManager_V1_7_1_Actions_CS;

//
// The information about a command shell service that this manager provides.
//
typedef struct _RedfishManager_V1_7_1_CommandShell_CS {
    ...
    RedfishCS_bool          *ServiceEnabled;          // An indication of whether the
                                                      ...
                                                      // manager.
} RedfishManager_V1_7_1_CommandShell_CS;

//
// The ForceFailover action forces a failover of this manager to the manager used
// in the parameter.
//
typedef struct _RedfishManager_V1_7_1_ForceFailover_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishManager_V1_7_1_ForceFailover_CS;

//
// The information about a graphical console service that this manager provides.
//
typedef struct _RedfishManager_V1_7_1_GraphicalConsole_CS {
    RedfishCS_char_Array    *ConnectTypesSupported;    // This property enumerates the
    ...
    RedfishCS_bool          *ServiceEnabled;          // An indication of whether the
                                                      // service is enabled for this
                                                      // manager.
} RedfishManager_V1_7_1_GraphicalConsole_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishManager_V1_7_1_Links_CS {
...
} RedfishManager_V1_7_1_Links_CS;

//
// The manager services, such as serial console, command shell, or graphical
// console service.
//
typedef struct _RedfishManager_V1_7_1_ManagerService_CS {
    RedfishCS_int64    *MaxConcurrentSessions;    // The maximum number of service
                                                 // sessions, regardless of
                                                 // protocol, that this manager
                                                 // can support.
    RedfishCS_bool     *ServiceEnabled;          // An indication of whether the
                                                 // service is enabled for this
                                                 // manager.
} RedfishManager_V1_7_1_ManagerService_CS;

//
// The ModifyRedundancySet operation adds members to or removes members from a
// redundant group of managers.
//
typedef struct _RedfishManager_V1_7_1_ModifyRedundancySet_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishManager_V1_7_1_ModifyRedundancySet_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishManager_V1_7_1_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishManager_V1_7_1_OemActions_CS;

//
// The reset action resets/reboots the manager.
//
typedef struct _RedfishManager_V1_7_1_Reset_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishManager_V1_7_1_Reset_CS;

//
// The information about a serial console service that this manager provides.
//
typedef struct _RedfishManager_V1_7_1_SerialConsole_CS {
    RedfishCS_char_Array    *ConnectTypesSupported;    // This property enumerates the
    ...
    RedfishCS_bool          *ServiceEnabled;          // An indication of whether the
                                                      // service is enabled for this
                                                      // manager.
} RedfishManager_V1_7_1_SerialConsole_CS;
...
//
typedef struct _RedfishManager_V1_7_1_Manager_CS {
    RedfishCS_Header                             Header;
    RedfishCS_char                               *odata_context;         
    RedfishCS_char                               *odata_etag;            
    RedfishCS_char                               *odata_id;              
    RedfishCS_char                               *odata_type;            
    RedfishManager_V1_7_1_Actions_CS             *Actions;                   // The available actions for this
                                                                             // resource.
    RedfishCS_bool                               *AutoDSTEnabled;            // An indication of whether the
                                                                             // manager is configured for
                                                                             // automatic Daylight Saving Time
                                                                             // (DST) adjustment.
    RedfishManager_V1_7_1_CommandShell_CS        *CommandShell;              // The command shell service that
    ...
    RedfishCS_char                               *FirmwareVersion;           // The firmware version of this
                                                                             // manager.
    RedfishManager_V1_7_1_GraphicalConsole_CS    *GraphicalConsole;          // The information about the
    ...
    RedfishCS_Link                               HostInterfaces;             // The link to a collection of
                                                                             ...
                                                                             // property.
    RedfishCS_char                               *Id;                    
    RedfishManager_V1_7_1_Links_CS               *Links;                     // The links to other resources
    ...
    RedfishManager_V1_7_1_SerialConsole_CS       *SerialConsole;             // The serial console service
    ...
    RedfishCS_Link                               VirtualMedia;               // The link to the Virtual Media
                                                                             ...
                                                                             // manager.
} RedfishManager_V1_7_1_Manager_CS;
...
RedfishCS_status
Json_Manager_V1_7_1_To_CS (char *JsonRawText, RedfishManager_V1_7_1_Manager_CS **ReturnedCS);

RedfishCS_status
CS_To_Manager_V1_7_1_JSON (RedfishManager_V1_7_1_Manager_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyManager_V1_7_1_CS (RedfishManager_V1_7_1_Manager_CS *CSPtr);

RedfishCS_status
DestroyManager_V1_7_1_Json (RedfishCS_char *JsonText);
