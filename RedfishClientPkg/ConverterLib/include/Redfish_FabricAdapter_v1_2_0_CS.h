...
#ifndef RedfishFabricadapter_V1_2_0_CSTRUCT_H_
#define RedfishFabricadapter_V1_2_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishFabricAdapter_V1_2_0_Actions_CS RedfishFabricAdapter_V1_2_0_Actions_CS;
typedef struct _RedfishFabricAdapter_V1_2_0_FabricAdapter_CS RedfishFabricAdapter_V1_2_0_FabricAdapter_CS;
typedef struct _RedfishFabricAdapter_V1_2_0_GenZ_CS RedfishFabricAdapter_V1_2_0_GenZ_CS;
typedef struct _RedfishFabricAdapter_V1_2_0_Links_CS RedfishFabricAdapter_V1_2_0_Links_CS;
typedef struct _RedfishFabricAdapter_V1_2_0_OemActions_CS RedfishFabricAdapter_V1_2_0_OemActions_CS;
...
typedef struct _RedfishFabricAdapter_V1_2_0_Actions_CS {
    RedfishFabricAdapter_V1_2_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishFabricAdapter_V1_2_0_FabricAdapter_CS {
    ...
    RedfishCS_char                            *ASICRevisionIdentifier;    // The revision identifier for
                                                                         ...
                                                                         // adapter.
    RedfishFabricAdapter_V1_2_0_Actions_CS    *Actions;                  // The available actions for this
                                                                         // Resource.
    RedfishCS_char                            *Description;          
    RedfishCS_char                            *FirmwareVersion;          // The firmware version of this
                                                                         // fabric adapter.
    RedfishFabricAdapter_V1_2_0_GenZ_CS       *GenZ;                     // The Gen-Z specific properties
                                                                         // for this fabric adapter.
    RedfishCS_char                            *Id;                   
    RedfishFabricAdapter_V1_2_0_Links_CS      *Links;                    // The links to other Resources
...
RedfishCS_status
Json_FabricAdapter_V1_2_0_To_CS (char *JsonRawText, RedfishFabricAdapter_V1_2_0_FabricAdapter_CS **ReturnedCS);

RedfishCS_status
CS_To_FabricAdapter_V1_2_0_JSON (RedfishFabricAdapter_V1_2_0_FabricAdapter_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyFabricAdapter_V1_2_0_CS (RedfishFabricAdapter_V1_2_0_FabricAdapter_CS *CSPtr);

RedfishCS_status
DestroyFabricAdapter_V1_2_0_Json (RedfishCS_char *JsonText);
