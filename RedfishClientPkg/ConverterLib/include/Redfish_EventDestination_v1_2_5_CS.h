...
#ifndef RedfishEventdestination_V1_2_5_CSTRUCT_H_
#define RedfishEventdestination_V1_2_5_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishEventDestination_V1_2_5_HttpHeaderProperty_Array_CS RedfishEventDestination_V1_2_5_HttpHeaderProperty_Array_CS;
#ifndef Redfishodatav4_idRef_Array_CS_
typedef struct _Redfishodatav4_idRef_Array_CS Redfishodatav4_idRef_Array_CS;
#endif
typedef struct _RedfishEventDestination_V1_2_5_Actions_CS RedfishEventDestination_V1_2_5_Actions_CS;
typedef struct _RedfishEventDestination_V1_2_5_EventDestination_CS RedfishEventDestination_V1_2_5_EventDestination_CS;
typedef struct _RedfishEventDestination_V1_2_5_HttpHeaderProperty_CS RedfishEventDestination_V1_2_5_HttpHeaderProperty_CS;
typedef struct _RedfishEventDestination_V1_2_5_OemActions_CS RedfishEventDestination_V1_2_5_OemActions_CS;
typedef struct _RedfishEventDestination_V1_2_5_ResumeSubscription_CS RedfishEventDestination_V1_2_5_ResumeSubscription_CS;
...
typedef struct _RedfishEventDestination_V1_2_5_Actions_CS {
    ...
    RedfishEventDestination_V1_2_5_OemActions_CS            *Oem;                                   // The available OEM-specific
...
typedef struct _RedfishEventDestination_V1_2_5_EventDestination_CS {
    ...
    RedfishEventDestination_V1_2_5_Actions_CS                     *Actions;                      // The available actions for this
                                                                                                 // Resource.
    ...
    RedfishEventDestination_V1_2_5_HttpHeaderProperty_Array_CS    *HttpHeaders;                  // An array of settings for HTTP
...
typedef struct _RedfishEventDestination_V1_2_5_HttpHeaderProperty_Array_CS  {
    RedfishEventDestination_V1_2_5_HttpHeaderProperty_Array_CS    *Next;
    RedfishEventDestination_V1_2_5_HttpHeaderProperty_CS    *ArrayValue;
} RedfishEventDestination_V1_2_5_HttpHeaderProperty_Array_CS;
...
RedfishCS_status
Json_EventDestination_V1_2_5_To_CS (char *JsonRawText, RedfishEventDestination_V1_2_5_EventDestination_CS **ReturnedCS);

RedfishCS_status
CS_To_EventDestination_V1_2_5_JSON (RedfishEventDestination_V1_2_5_EventDestination_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEventDestination_V1_2_5_CS (RedfishEventDestination_V1_2_5_EventDestination_CS *CSPtr);

RedfishCS_status
DestroyEventDestination_V1_2_5_Json (RedfishCS_char *JsonText);
