...
#ifndef RedfishPowersupply_V1_0_1_CSTRUCT_H_
#define RedfishPowersupply_V1_0_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishPowerSupply_V1_0_1_EfficiencyRating_Array_CS RedfishPowerSupply_V1_0_1_EfficiencyRating_Array_CS;
typedef struct _RedfishPowerSupply_V1_0_1_InputRange_Array_CS RedfishPowerSupply_V1_0_1_InputRange_Array_CS;
typedef struct _RedfishPowerSupply_V1_0_1_OutputRail_Array_CS RedfishPowerSupply_V1_0_1_OutputRail_Array_CS;
typedef struct _RedfishPowerSupply_V1_0_1_Actions_CS RedfishPowerSupply_V1_0_1_Actions_CS;
typedef struct _RedfishPowerSupply_V1_0_1_EfficiencyRating_CS RedfishPowerSupply_V1_0_1_EfficiencyRating_CS;
typedef struct _RedfishPowerSupply_V1_0_1_InputRange_CS RedfishPowerSupply_V1_0_1_InputRange_CS;
typedef struct _RedfishPowerSupply_V1_0_1_Links_CS RedfishPowerSupply_V1_0_1_Links_CS;
typedef struct _RedfishPowerSupply_V1_0_1_OemActions_CS RedfishPowerSupply_V1_0_1_OemActions_CS;
typedef struct _RedfishPowerSupply_V1_0_1_OutputRail_CS RedfishPowerSupply_V1_0_1_OutputRail_CS;
typedef struct _RedfishPowerSupply_V1_0_1_PowerSupply_CS RedfishPowerSupply_V1_0_1_PowerSupply_CS;
typedef struct _RedfishPowerSupply_V1_0_1_Reset_CS RedfishPowerSupply_V1_0_1_Reset_CS;
...
typedef struct _RedfishPowerSupply_V1_0_1_Actions_CS {
    ...
    RedfishPowerSupply_V1_0_1_OemActions_CS    *Oem;                 // The available OEM-specific
...
typedef struct _RedfishPowerSupply_V1_0_1_PowerSupply_CS {
    ...
    RedfishPowerSupply_V1_0_1_Actions_CS                   *Actions;                   // The available actions for this
                                                                                       // resource.
    RedfishCS_Link                                         Assembly;                   // The link to the assembly
                                                                                       // associated with this power
                                                                                       // supply.
    RedfishCS_char                                         *Description;           
    RedfishPowerSupply_V1_0_1_EfficiencyRating_Array_CS    *EfficiencyRatings;         // The efficiency ratings of this
                                                                                       // power supply.
    ...
    RedfishCS_char                                         *InputNominalVoltageType;    // The nominal voltage type of
                                                                                       ...
                                                                                       // supply.
    RedfishPowerSupply_V1_0_1_InputRange_Array_CS          *InputRanges;               // The input ranges that the
                                                                                       // power supply can use.
    RedfishPowerSupply_V1_0_1_Links_CS                     *Links;                     // The links to other resources
    ...
    RedfishCS_char                                         *Name;                  
    RedfishResource_Oem_CS                                 *Oem;                       // The OEM extension property.
    RedfishPowerSupply_V1_0_1_OutputRail_Array_CS          *OutputRails;               // The output power rails
...
typedef struct _RedfishPowerSupply_V1_0_1_EfficiencyRating_Array_CS  {
    RedfishPowerSupply_V1_0_1_EfficiencyRating_Array_CS    *Next;
    RedfishPowerSupply_V1_0_1_EfficiencyRating_CS    *ArrayValue;
} RedfishPowerSupply_V1_0_1_EfficiencyRating_Array_CS;

typedef struct _RedfishPowerSupply_V1_0_1_InputRange_Array_CS  {
    RedfishPowerSupply_V1_0_1_InputRange_Array_CS    *Next;
    RedfishPowerSupply_V1_0_1_InputRange_CS    *ArrayValue;
} RedfishPowerSupply_V1_0_1_InputRange_Array_CS;

typedef struct _RedfishPowerSupply_V1_0_1_OutputRail_Array_CS  {
    RedfishPowerSupply_V1_0_1_OutputRail_Array_CS    *Next;
    RedfishPowerSupply_V1_0_1_OutputRail_CS    *ArrayValue;
} RedfishPowerSupply_V1_0_1_OutputRail_Array_CS;

RedfishCS_status
Json_PowerSupply_V1_0_1_To_CS (char *JsonRawText, RedfishPowerSupply_V1_0_1_PowerSupply_CS **ReturnedCS);

RedfishCS_status
CS_To_PowerSupply_V1_0_1_JSON (RedfishPowerSupply_V1_0_1_PowerSupply_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPowerSupply_V1_0_1_CS (RedfishPowerSupply_V1_0_1_PowerSupply_CS *CSPtr);

RedfishCS_status
DestroyPowerSupply_V1_0_1_Json (RedfishCS_char *JsonText);
