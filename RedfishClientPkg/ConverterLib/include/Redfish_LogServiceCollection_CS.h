...
#ifndef RedfishLogservicecollection_Noversioned_CSTRUCT_H_
#define RedfishLogservicecollection_Noversioned_CSTRUCT_H_
...
//
// The LogServiceCollection schema describes a Resource Collection of LogService
// instances.
//
