...
#ifndef RedfishRole_V1_3_1_CSTRUCT_H_
#define RedfishRole_V1_3_1_CSTRUCT_H_
...
typedef struct _RedfishRole_V1_3_1_Actions_CS RedfishRole_V1_3_1_Actions_CS;
typedef struct _RedfishRole_V1_3_1_OemActions_CS RedfishRole_V1_3_1_OemActions_CS;
typedef struct _RedfishRole_V1_3_1_Role_CS RedfishRole_V1_3_1_Role_CS;
//
// The OEM extension.
//
#ifndef RedfishResource_Oem_CS_
...
typedef struct _RedfishRole_V1_3_1_Actions_CS {
    RedfishRole_V1_3_1_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishRole_V1_3_1_Role_CS {
    ...
    RedfishRole_V1_3_1_Actions_CS    *Actions;              // The available actions for this
                                                            // resource.
...
RedfishCS_status
Json_Role_V1_3_1_To_CS (char *JsonRawText, RedfishRole_V1_3_1_Role_CS **ReturnedCS);

RedfishCS_status
CS_To_Role_V1_3_1_JSON (RedfishRole_V1_3_1_Role_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyRole_V1_3_1_CS (RedfishRole_V1_3_1_Role_CS *CSPtr);

RedfishCS_status
DestroyRole_V1_3_1_Json (RedfishCS_char *JsonText);
