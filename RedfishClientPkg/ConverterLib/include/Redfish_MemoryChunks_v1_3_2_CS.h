...
#ifndef RedfishMemorychunks_V1_3_2_CSTRUCT_H_
#define RedfishMemorychunks_V1_3_2_CSTRUCT_H_
...
#endif
typedef struct _RedfishMemoryChunks_V1_3_2_InterleaveSet_Array_CS RedfishMemoryChunks_V1_3_2_InterleaveSet_Array_CS;
typedef struct _RedfishMemoryChunks_V1_3_2_Actions_CS RedfishMemoryChunks_V1_3_2_Actions_CS;
typedef struct _RedfishMemoryChunks_V1_3_2_InterleaveSet_CS RedfishMemoryChunks_V1_3_2_InterleaveSet_CS;
typedef struct _RedfishMemoryChunks_V1_3_2_Links_CS RedfishMemoryChunks_V1_3_2_Links_CS;
typedef struct _RedfishMemoryChunks_V1_3_2_MemoryChunks_CS RedfishMemoryChunks_V1_3_2_MemoryChunks_CS;
typedef struct _RedfishMemoryChunks_V1_3_2_OemActions_CS RedfishMemoryChunks_V1_3_2_OemActions_CS;
...
typedef struct _RedfishMemoryChunks_V1_3_2_Actions_CS {
    RedfishMemoryChunks_V1_3_2_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishMemoryChunks_V1_3_2_MemoryChunks_CS {
    ...
    RedfishMemoryChunks_V1_3_2_Actions_CS                *Actions;                 // The available actions for this
                                                                                   // resource.
    ...
    RedfishCS_char                                       *Id;                  
    RedfishMemoryChunks_V1_3_2_InterleaveSet_Array_CS    *InterleaveSets;          // The interleave sets for the
                                                                                   // memory chunk.
    ...
    RedfishCS_bool                                       *IsSpare;                 // An indication of whether
                                                                                   ...
                                                                                   // memory chunk.
    RedfishMemoryChunks_V1_3_2_Links_CS                  *Links;                   // The links to other resources
...
typedef struct _RedfishMemoryChunks_V1_3_2_InterleaveSet_Array_CS  {
    RedfishMemoryChunks_V1_3_2_InterleaveSet_Array_CS    *Next;
    RedfishMemoryChunks_V1_3_2_InterleaveSet_CS    *ArrayValue;
} RedfishMemoryChunks_V1_3_2_InterleaveSet_Array_CS;

RedfishCS_status
Json_MemoryChunks_V1_3_2_To_CS (char *JsonRawText, RedfishMemoryChunks_V1_3_2_MemoryChunks_CS **ReturnedCS);

RedfishCS_status
CS_To_MemoryChunks_V1_3_2_JSON (RedfishMemoryChunks_V1_3_2_MemoryChunks_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMemoryChunks_V1_3_2_CS (RedfishMemoryChunks_V1_3_2_MemoryChunks_CS *CSPtr);

RedfishCS_status
DestroyMemoryChunks_V1_3_2_Json (RedfishCS_char *JsonText);
