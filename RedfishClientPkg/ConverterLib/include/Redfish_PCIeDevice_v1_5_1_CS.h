...
#ifndef RedfishPciedevice_V1_5_1_CSTRUCT_H_
#define RedfishPciedevice_V1_5_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishPCIeDevice_V1_5_1_Actions_CS RedfishPCIeDevice_V1_5_1_Actions_CS;
typedef struct _RedfishPCIeDevice_V1_5_1_Links_CS RedfishPCIeDevice_V1_5_1_Links_CS;
typedef struct _RedfishPCIeDevice_V1_5_1_OemActions_CS RedfishPCIeDevice_V1_5_1_OemActions_CS;
typedef struct _RedfishPCIeDevice_V1_5_1_PCIeDevice_CS RedfishPCIeDevice_V1_5_1_PCIeDevice_CS;
typedef struct _RedfishPCIeDevice_V1_5_1_PCIeInterface_CS RedfishPCIeDevice_V1_5_1_PCIeInterface_CS;
...
typedef struct _RedfishPCIeDevice_V1_5_1_Actions_CS {
    RedfishPCIeDevice_V1_5_1_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishPCIeDevice_V1_5_1_PCIeDevice_CS {
    ...
    RedfishPCIeDevice_V1_5_1_Actions_CS          *Actions;           // The available actions for this
                                                                     // resource.
    ...
    RedfishCS_char                               *FirmwareVersion;    // The version of firmware for
                                                                     // this PCIe device.
    RedfishCS_char                               *Id;            
    RedfishPCIeDevice_V1_5_1_Links_CS            *Links;             // The links to other resources
    ...
    RedfishCS_Link                               PCIeFunctions;      // The link to the collection of
                                                                     ...
                                                                     // this PCIe device.
    RedfishPCIeDevice_V1_5_1_PCIeInterface_CS    *PCIeInterface;     // The PCIe interface details for
                                                                     // this PCIe device.
...
RedfishCS_status
Json_PCIeDevice_V1_5_1_To_CS (char *JsonRawText, RedfishPCIeDevice_V1_5_1_PCIeDevice_CS **ReturnedCS);

RedfishCS_status
CS_To_PCIeDevice_V1_5_1_JSON (RedfishPCIeDevice_V1_5_1_PCIeDevice_CS *CSPtr, char **JsonText);
