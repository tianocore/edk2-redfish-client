...
#ifndef RedfishMetricreportdefinition_V1_1_6_CSTRUCT_H_
#define RedfishMetricreportdefinition_V1_1_6_CSTRUCT_H_
...
#endif
typedef struct _RedfishMetricReportDefinition_V1_1_6_Metric_Array_CS RedfishMetricReportDefinition_V1_1_6_Metric_Array_CS;
typedef struct _RedfishMetricReportDefinition_V1_1_6_Wildcard_Array_CS RedfishMetricReportDefinition_V1_1_6_Wildcard_Array_CS;
typedef struct _RedfishMetricReportDefinition_V1_1_6_Actions_CS RedfishMetricReportDefinition_V1_1_6_Actions_CS;
typedef struct _RedfishMetricReportDefinition_V1_1_6_Metric_CS RedfishMetricReportDefinition_V1_1_6_Metric_CS;
typedef struct _RedfishMetricReportDefinition_V1_1_6_MetricReportDefinition_CS RedfishMetricReportDefinition_V1_1_6_MetricReportDefinition_CS;
typedef struct _RedfishMetricReportDefinition_V1_1_6_OemActions_CS RedfishMetricReportDefinition_V1_1_6_OemActions_CS;
typedef struct _RedfishMetricReportDefinition_V1_1_6_Wildcard_CS RedfishMetricReportDefinition_V1_1_6_Wildcard_CS;
...
typedef struct _RedfishMetricReportDefinition_V1_1_6_Actions_CS {
    RedfishMetricReportDefinition_V1_1_6_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishMetricReportDefinition_V1_1_6_MetricReportDefinition_CS {
    ...
    RedfishMetricReportDefinition_V1_1_6_Actions_CS           *Actions;                      // The available actions for this
                                                                                             // resource.
    ...
    RedfishCS_char                                            *MetricReportDefinitionType;    // Specifies when the metric
                                                                                             // report is generated.
    RedfishMetricReportDefinition_V1_1_6_Metric_Array_CS      *Metrics;                      // The list of metrics to include
    ...
    RedfishMetricReportDefinition_V1_1_6_Wildcard_Array_CS    *Wildcards;                    // The set of wildcards and their
...
typedef struct _RedfishMetricReportDefinition_V1_1_6_Metric_Array_CS  {
    RedfishMetricReportDefinition_V1_1_6_Metric_Array_CS    *Next;
    RedfishMetricReportDefinition_V1_1_6_Metric_CS    *ArrayValue;
} RedfishMetricReportDefinition_V1_1_6_Metric_Array_CS;

typedef struct _RedfishMetricReportDefinition_V1_1_6_Wildcard_Array_CS  {
    RedfishMetricReportDefinition_V1_1_6_Wildcard_Array_CS    *Next;
    RedfishMetricReportDefinition_V1_1_6_Wildcard_CS    *ArrayValue;
} RedfishMetricReportDefinition_V1_1_6_Wildcard_Array_CS;

RedfishCS_status
Json_MetricReportDefinition_V1_1_6_To_CS (char *JsonRawText, RedfishMetricReportDefinition_V1_1_6_MetricReportDefinition_CS **ReturnedCS);

RedfishCS_status
CS_To_MetricReportDefinition_V1_1_6_JSON (RedfishMetricReportDefinition_V1_1_6_MetricReportDefinition_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMetricReportDefinition_V1_1_6_CS (RedfishMetricReportDefinition_V1_1_6_MetricReportDefinition_CS *CSPtr);

RedfishCS_status
DestroyMetricReportDefinition_V1_1_6_Json (RedfishCS_char *JsonText);
