...
#ifndef RedfishAccountservice_V1_3_3_CSTRUCT_H_
#define RedfishAccountservice_V1_3_3_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishAccountService_V1_3_3_RoleMapping_Array_CS RedfishAccountService_V1_3_3_RoleMapping_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishAccountService_V1_3_3_AccountService_CS RedfishAccountService_V1_3_3_AccountService_CS;
typedef struct _RedfishAccountService_V1_3_3_Actions_CS RedfishAccountService_V1_3_3_Actions_CS;
typedef struct _RedfishAccountService_V1_3_3_Authentication_CS RedfishAccountService_V1_3_3_Authentication_CS;
typedef struct _RedfishAccountService_V1_3_3_ExternalAccountProvider_CS RedfishAccountService_V1_3_3_ExternalAccountProvider_CS;
typedef struct _RedfishAccountService_V1_3_3_LDAPSearchSettings_CS RedfishAccountService_V1_3_3_LDAPSearchSettings_CS;
typedef struct _RedfishAccountService_V1_3_3_LDAPService_CS RedfishAccountService_V1_3_3_LDAPService_CS;
typedef struct _RedfishAccountService_V1_3_3_OemActions_CS RedfishAccountService_V1_3_3_OemActions_CS;
typedef struct _RedfishAccountService_V1_3_3_RoleMapping_CS RedfishAccountService_V1_3_3_RoleMapping_CS;
...
typedef struct _RedfishAccountService_V1_3_3_Actions_CS {
    RedfishAccountService_V1_3_3_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishAccountService_V1_3_3_ExternalAccountProvider_CS {
    RedfishCS_char                                       *AccountProviderType;    // The type of external account
                                                                                 ...
                                                                                 // connects.
    RedfishAccountService_V1_3_3_Authentication_CS       *Authentication;        // The authentication information
                                                                                 // for the external account
                                                                                 // provider.
    RedfishAccountService_V1_3_3_LDAPService_CS          *LDAPService;           // The additional mapping
                                                                                 // information needed to parse a
                                                                                 // generic LDAP service.
    RedfishAccountService_V1_3_3_RoleMapping_Array_CS    *RemoteRoleMapping;     // The mapping rules to convert
...
typedef struct _RedfishAccountService_V1_3_3_LDAPService_CS {
    RedfishResource_Oem_CS                                *Oem;              // The OEM extension property.
    RedfishAccountService_V1_3_3_LDAPSearchSettings_CS    *SearchSettings;    // The required settings to
...
typedef struct _RedfishAccountService_V1_3_3_AccountService_CS {
    ...
    RedfishCS_Link                                             Accounts;                             // The collection of manager
                                                                                                     // accounts.
    RedfishAccountService_V1_3_3_Actions_CS                    *Actions;                             // The available actions for this
                                                                                                     // Resource.
    RedfishAccountService_V1_3_3_ExternalAccountProvider_CS    *ActiveDirectory;                     // The first Active Directory
    ...
    RedfishCS_char                                             *Id;                              
    RedfishAccountService_V1_3_3_ExternalAccountProvider_CS    *LDAP;                                // The first LDAP external
...
typedef struct _RedfishAccountService_V1_3_3_RoleMapping_Array_CS  {
    RedfishAccountService_V1_3_3_RoleMapping_Array_CS    *Next;
...
RedfishCS_status
Json_AccountService_V1_3_3_To_CS (char *JsonRawText, RedfishAccountService_V1_3_3_AccountService_CS **ReturnedCS);

RedfishCS_status
CS_To_AccountService_V1_3_3_JSON (RedfishAccountService_V1_3_3_AccountService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAccountService_V1_3_3_CS (RedfishAccountService_V1_3_3_AccountService_CS *CSPtr);

RedfishCS_status
DestroyAccountService_V1_3_3_Json (RedfishCS_char *JsonText);
