...
#ifndef RedfishStorage_V1_2_6_CSTRUCT_H_
#define RedfishStorage_V1_2_6_CSTRUCT_H_
...
#endif
typedef struct _RedfishStorage_V1_2_6_StorageController_Array_CS RedfishStorage_V1_2_6_StorageController_Array_CS;
...
typedef struct _RedfishStorage_V1_2_6_Actions_CS RedfishStorage_V1_2_6_Actions_CS;
typedef struct _RedfishStorage_V1_2_6_Links_CS RedfishStorage_V1_2_6_Links_CS;
typedef struct _RedfishStorage_V1_2_6_OemActions_CS RedfishStorage_V1_2_6_OemActions_CS;
typedef struct _RedfishStorage_V1_2_6_SetEncryptionKey_CS RedfishStorage_V1_2_6_SetEncryptionKey_CS;
typedef struct _RedfishStorage_V1_2_6_Storage_CS RedfishStorage_V1_2_6_Storage_CS;
typedef struct _RedfishStorage_V1_2_6_StorageController_CS RedfishStorage_V1_2_6_StorageController_CS;
typedef struct _RedfishStorage_V1_2_6_StorageControllerActions_CS RedfishStorage_V1_2_6_StorageControllerActions_CS;
typedef struct _RedfishStorage_V1_2_6_StorageControllerLinks_CS RedfishStorage_V1_2_6_StorageControllerLinks_CS;
typedef struct _RedfishStorage_V1_2_6_StorageControllerOemActions_CS RedfishStorage_V1_2_6_StorageControllerOemActions_CS;
...
typedef struct _RedfishStorage_V1_2_6_Actions_CS {
    ...
    RedfishStorage_V1_2_6_OemActions_CS          *Oem;                        // The available OEM-specific
...
typedef struct _RedfishStorage_V1_2_6_StorageController_CS {
    ...
    RedfishStorage_V1_2_6_StorageControllerActions_CS    *Actions;                        // The available actions for this
                                                                                          // resource.
    ...
    RedfishCS_Link                                       Identifiers;                     // The durable names for the
                                                                                          // storage controller.
    RedfishStorage_V1_2_6_StorageControllerLinks_CS      *Links;                          // The links to other resources
...
typedef struct _RedfishStorage_V1_2_6_StorageControllerActions_CS {
    RedfishStorage_V1_2_6_StorageControllerOemActions_CS    *Oem;    // The available OEM-specific
                                                                    // actions for this resource.
...
typedef struct _RedfishStorage_V1_2_6_Storage_CS {
    ...
    RedfishStorage_V1_2_6_Actions_CS                    *Actions;                         // The available actions for this
                                                                                          // resource.
    ...
    RedfishCS_char                                      *Id;                          
    RedfishStorage_V1_2_6_Links_CS                      *Links;                           // The links to other resources
                                                                                          // that are related to this
                                                                                          // resource.
    RedfishCS_char                                      *Name;                        
    RedfishResource_Oem_CS                              *Oem;                             // The OEM extension property.
    ...
    RedfishResource_Status_CS                           *Status;                          // The status and health of the
                                                                                          // resource and its subordinate
                                                                                          // or dependent resources.
    RedfishStorage_V1_2_6_StorageController_Array_CS    *StorageControllers;              // The set of storage controllers
...
typedef struct _RedfishStorage_V1_2_6_StorageController_Array_CS  {
    RedfishStorage_V1_2_6_StorageController_Array_CS    *Next;
    RedfishStorage_V1_2_6_StorageController_CS    *ArrayValue;
} RedfishStorage_V1_2_6_StorageController_Array_CS;

RedfishCS_status
Json_Storage_V1_2_6_To_CS (char *JsonRawText, RedfishStorage_V1_2_6_Storage_CS **ReturnedCS);

RedfishCS_status
CS_To_Storage_V1_2_6_JSON (RedfishStorage_V1_2_6_Storage_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyStorage_V1_2_6_CS (RedfishStorage_V1_2_6_Storage_CS *CSPtr);

RedfishCS_status
DestroyStorage_V1_2_6_Json (RedfishCS_char *JsonText);
