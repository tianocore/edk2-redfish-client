...
#ifndef RedfishPower_V1_4_6_CSTRUCT_H_
#define RedfishPower_V1_4_6_CSTRUCT_H_
...
#endif
typedef struct _RedfishPower_V1_4_6_InputRange_Array_CS RedfishPower_V1_4_6_InputRange_Array_CS;
typedef struct _RedfishPower_V1_4_6_PowerControl_Array_CS RedfishPower_V1_4_6_PowerControl_Array_CS;
typedef struct _RedfishPower_V1_4_6_PowerSupply_Array_CS RedfishPower_V1_4_6_PowerSupply_Array_CS;
typedef struct _RedfishPower_V1_4_6_Voltage_Array_CS RedfishPower_V1_4_6_Voltage_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishPower_V1_4_6_Actions_CS RedfishPower_V1_4_6_Actions_CS;
typedef struct _RedfishPower_V1_4_6_InputRange_CS RedfishPower_V1_4_6_InputRange_CS;
typedef struct _RedfishPower_V1_4_6_OemActions_CS RedfishPower_V1_4_6_OemActions_CS;
typedef struct _RedfishPower_V1_4_6_Power_CS RedfishPower_V1_4_6_Power_CS;
typedef struct _RedfishPower_V1_4_6_PowerControl_CS RedfishPower_V1_4_6_PowerControl_CS;
typedef struct _RedfishPower_V1_4_6_PowerControlActions_CS RedfishPower_V1_4_6_PowerControlActions_CS;
typedef struct _RedfishPower_V1_4_6_PowerControlOemActions_CS RedfishPower_V1_4_6_PowerControlOemActions_CS;
typedef struct _RedfishPower_V1_4_6_PowerLimit_CS RedfishPower_V1_4_6_PowerLimit_CS;
typedef struct _RedfishPower_V1_4_6_PowerMetric_CS RedfishPower_V1_4_6_PowerMetric_CS;
typedef struct _RedfishPower_V1_4_6_PowerSupply_CS RedfishPower_V1_4_6_PowerSupply_CS;
typedef struct _RedfishPower_V1_4_6_PowerSupplyActions_CS RedfishPower_V1_4_6_PowerSupplyActions_CS;
typedef struct _RedfishPower_V1_4_6_PowerSupplyOemActions_CS RedfishPower_V1_4_6_PowerSupplyOemActions_CS;
typedef struct _RedfishPower_V1_4_6_Voltage_CS RedfishPower_V1_4_6_Voltage_CS;
typedef struct _RedfishPower_V1_4_6_VoltageActions_CS RedfishPower_V1_4_6_VoltageActions_CS;
typedef struct _RedfishPower_V1_4_6_VoltageOemActions_CS RedfishPower_V1_4_6_VoltageOemActions_CS;
...
typedef struct _RedfishPower_V1_4_6_Actions_CS {
    RedfishPower_V1_4_6_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishPower_V1_4_6_PowerControl_CS {
    ...
    RedfishPower_V1_4_6_PowerControlActions_CS    *Actions;                  // The available actions for this
                                                                             // resource.
    ...
    RedfishPower_V1_4_6_PowerLimit_CS             *PowerLimit;               // The power limit status and
                                                                             // configuration information for
                                                                             // this chassis.
    RedfishPower_V1_4_6_PowerMetric_CS            *PowerMetrics;             // The power readings for this
                                                                             // chassis.
...
typedef struct _RedfishPower_V1_4_6_PowerControlActions_CS {
    RedfishPower_V1_4_6_PowerControlOemActions_CS    *Oem;    // The available OEM-specific
                                                             // actions for this resource.
...
typedef struct _RedfishPower_V1_4_6_PowerSupply_CS {
    RedfishCS_char                               *odata_id;             
    RedfishPower_V1_4_6_PowerSupplyActions_CS    *Actions;                  // The available actions for this
                                                                            // resource.
    ...
    RedfishCS_char                               *IndicatorLED;             // The state of The indicator
                                                                            ...
                                                                            // power supply.
    RedfishPower_V1_4_6_InputRange_Array_CS      *InputRanges;              // The input ranges that the
...
typedef struct _RedfishPower_V1_4_6_PowerSupplyActions_CS {
    RedfishPower_V1_4_6_PowerSupplyOemActions_CS    *Oem;    // The available OEM-specific
                                                            // actions for this resource.
...
typedef struct _RedfishPower_V1_4_6_Voltage_CS {
    RedfishCS_char                           *odata_id;                
    RedfishPower_V1_4_6_VoltageActions_CS    *Actions;                     // The available actions for this
                                                                           // resource.
...
typedef struct _RedfishPower_V1_4_6_VoltageActions_CS {
    RedfishPower_V1_4_6_VoltageOemActions_CS    *Oem;    // The available OEM-specific
                                                        // actions for this resource.
...
typedef struct _RedfishPower_V1_4_6_Power_CS {
    ...
    RedfishPower_V1_4_6_Actions_CS               *Actions;                    // The available actions for this
                                                                              // resource.
    RedfishCS_char                               *Description;            
    RedfishCS_char                               *Id;                     
    RedfishCS_char                               *Name;                   
    RedfishResource_Oem_CS                       *Oem;                        // The OEM extension property.
    RedfishPower_V1_4_6_PowerControl_Array_CS    *PowerControl;               // The set of power control
                                                                              // functions, including power
                                                                              // reading and limiting.
    RedfishCS_int64                              *PowerControlodata_count;
    RedfishPower_V1_4_6_PowerSupply_Array_CS     *PowerSupplies;              // The set of power supplies
    ...
    RedfishCS_Link                               Redundancy;                  // The redundancy information for
                                                                              ...
                                                                              // this chassis.
    RedfishCS_int64                              *Redundancyodata_count;  
    RedfishPower_V1_4_6_Voltage_Array_CS         *Voltages;                   // The set of voltage sensors for
                                                                              // this chassis.
...
typedef struct _RedfishPower_V1_4_6_InputRange_Array_CS  {
    RedfishPower_V1_4_6_InputRange_Array_CS    *Next;
    RedfishPower_V1_4_6_InputRange_CS    *ArrayValue;
} RedfishPower_V1_4_6_InputRange_Array_CS;

typedef struct _RedfishPower_V1_4_6_PowerControl_Array_CS  {
    RedfishPower_V1_4_6_PowerControl_Array_CS    *Next;
    RedfishPower_V1_4_6_PowerControl_CS    *ArrayValue;
} RedfishPower_V1_4_6_PowerControl_Array_CS;

typedef struct _RedfishPower_V1_4_6_PowerSupply_Array_CS  {
    RedfishPower_V1_4_6_PowerSupply_Array_CS    *Next;
    RedfishPower_V1_4_6_PowerSupply_CS    *ArrayValue;
} RedfishPower_V1_4_6_PowerSupply_Array_CS;

typedef struct _RedfishPower_V1_4_6_Voltage_Array_CS  {
    RedfishPower_V1_4_6_Voltage_Array_CS    *Next;
    RedfishPower_V1_4_6_Voltage_CS    *ArrayValue;
} RedfishPower_V1_4_6_Voltage_Array_CS;
...
RedfishCS_status
Json_Power_V1_4_6_To_CS (char *JsonRawText, RedfishPower_V1_4_6_Power_CS **ReturnedCS);

RedfishCS_status
CS_To_Power_V1_4_6_JSON (RedfishPower_V1_4_6_Power_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPower_V1_4_6_CS (RedfishPower_V1_4_6_Power_CS *CSPtr);

RedfishCS_status
DestroyPower_V1_4_6_Json (RedfishCS_char *JsonText);
