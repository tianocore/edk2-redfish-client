...
#ifndef RedfishAggregate_V1_0_0_CSTRUCT_H_
#define RedfishAggregate_V1_0_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishAggregate_V1_0_0_Actions_CS RedfishAggregate_V1_0_0_Actions_CS;
typedef struct _RedfishAggregate_V1_0_0_AddElements_CS RedfishAggregate_V1_0_0_AddElements_CS;
typedef struct _RedfishAggregate_V1_0_0_Aggregate_CS RedfishAggregate_V1_0_0_Aggregate_CS;
typedef struct _RedfishAggregate_V1_0_0_OemActions_CS RedfishAggregate_V1_0_0_OemActions_CS;
typedef struct _RedfishAggregate_V1_0_0_RemoveElements_CS RedfishAggregate_V1_0_0_RemoveElements_CS;
typedef struct _RedfishAggregate_V1_0_0_Reset_CS RedfishAggregate_V1_0_0_Reset_CS;
typedef struct _RedfishAggregate_V1_0_0_SetDefaultBootOrder_CS RedfishAggregate_V1_0_0_SetDefaultBootOrder_CS;
...
typedef struct _RedfishAggregate_V1_0_0_Actions_CS {
    ...
    RedfishAggregate_V1_0_0_OemActions_CS             *Oem;                             // The available OEM-specific
...
typedef struct _RedfishAggregate_V1_0_0_Aggregate_CS {
    ...
    RedfishAggregate_V1_0_0_Actions_CS    *Actions;               // The available actions for this
                                                                  // resource.
...
RedfishCS_status
Json_Aggregate_V1_0_0_To_CS (char *JsonRawText, RedfishAggregate_V1_0_0_Aggregate_CS **ReturnedCS);

RedfishCS_status
CS_To_Aggregate_V1_0_0_JSON (RedfishAggregate_V1_0_0_Aggregate_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAggregate_V1_0_0_CS (RedfishAggregate_V1_0_0_Aggregate_CS *CSPtr);

RedfishCS_status
DestroyAggregate_V1_0_0_Json (RedfishCS_char *JsonText);
