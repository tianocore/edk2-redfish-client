...
#ifndef RedfishMessageregistry_V1_1_5_CSTRUCT_H_
#define RedfishMessageregistry_V1_1_5_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMessageRegistry_V1_1_5_Actions_CS RedfishMessageRegistry_V1_1_5_Actions_CS;
typedef struct _RedfishMessageRegistry_V1_1_5_Message_CS RedfishMessageRegistry_V1_1_5_Message_CS;
typedef struct _RedfishMessageRegistry_V1_1_5_MessageProperty_CS RedfishMessageRegistry_V1_1_5_MessageProperty_CS;
typedef struct _RedfishMessageRegistry_V1_1_5_MessageRegistry_CS RedfishMessageRegistry_V1_1_5_MessageRegistry_CS;
typedef struct _RedfishMessageRegistry_V1_1_5_OemActions_CS RedfishMessageRegistry_V1_1_5_OemActions_CS;
...
typedef struct _RedfishMessageRegistry_V1_1_5_Actions_CS {
    RedfishMessageRegistry_V1_1_5_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishMessageRegistry_V1_1_5_MessageRegistry_CS {
    ...
    RedfishMessageRegistry_V1_1_5_Actions_CS            *Actions;           // The available actions for this
                                                                            // resource.
    ...
    RedfishCS_char                                      *Language;          // The RFC5646-conformant
                                                                            ...
                                                                            // registry.
    RedfishMessageRegistry_V1_1_5_MessageProperty_CS    *Messages;          // The message keys contained in
...
RedfishCS_status
Json_MessageRegistry_V1_1_5_To_CS (char *JsonRawText, RedfishMessageRegistry_V1_1_5_MessageRegistry_CS **ReturnedCS);

RedfishCS_status
CS_To_MessageRegistry_V1_1_5_JSON (RedfishMessageRegistry_V1_1_5_MessageRegistry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMessageRegistry_V1_1_5_CS (RedfishMessageRegistry_V1_1_5_MessageRegistry_CS *CSPtr);

RedfishCS_status
DestroyMessageRegistry_V1_1_5_Json (RedfishCS_char *JsonText);
