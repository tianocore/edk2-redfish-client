...
#ifndef RedfishAddresspool_V1_2_1_CSTRUCT_H_
#define RedfishAddresspool_V1_2_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishAddressPool_V1_2_1_ASNumberRange_CS RedfishAddressPool_V1_2_1_ASNumberRange_CS;
typedef struct _RedfishAddressPool_V1_2_1_Actions_CS RedfishAddressPool_V1_2_1_Actions_CS;
typedef struct _RedfishAddressPool_V1_2_1_AddressPool_CS RedfishAddressPool_V1_2_1_AddressPool_CS;
typedef struct _RedfishAddressPool_V1_2_1_BFDSingleHopOnly_CS RedfishAddressPool_V1_2_1_BFDSingleHopOnly_CS;
typedef struct _RedfishAddressPool_V1_2_1_BGPEvpn_CS RedfishAddressPool_V1_2_1_BGPEvpn_CS;
typedef struct _RedfishAddressPool_V1_2_1_BGPNeighbor_CS RedfishAddressPool_V1_2_1_BGPNeighbor_CS;
typedef struct _RedfishAddressPool_V1_2_1_BGPRoute_CS RedfishAddressPool_V1_2_1_BGPRoute_CS;
typedef struct _RedfishAddressPool_V1_2_1_CommonBGPProperties_CS RedfishAddressPool_V1_2_1_CommonBGPProperties_CS;
typedef struct _RedfishAddressPool_V1_2_1_DHCP_CS RedfishAddressPool_V1_2_1_DHCP_CS;
typedef struct _RedfishAddressPool_V1_2_1_EBGP_CS RedfishAddressPool_V1_2_1_EBGP_CS;
typedef struct _RedfishAddressPool_V1_2_1_ESINumberRange_CS RedfishAddressPool_V1_2_1_ESINumberRange_CS;
typedef struct _RedfishAddressPool_V1_2_1_EVINumberRange_CS RedfishAddressPool_V1_2_1_EVINumberRange_CS;
typedef struct _RedfishAddressPool_V1_2_1_Ethernet_CS RedfishAddressPool_V1_2_1_Ethernet_CS;
typedef struct _RedfishAddressPool_V1_2_1_GatewayIPAddressRange_CS RedfishAddressPool_V1_2_1_GatewayIPAddressRange_CS;
typedef struct _RedfishAddressPool_V1_2_1_GenZ_CS RedfishAddressPool_V1_2_1_GenZ_CS;
typedef struct _RedfishAddressPool_V1_2_1_GracefulRestart_CS RedfishAddressPool_V1_2_1_GracefulRestart_CS;
typedef struct _RedfishAddressPool_V1_2_1_IPv4_CS RedfishAddressPool_V1_2_1_IPv4_CS;
typedef struct _RedfishAddressPool_V1_2_1_IPv4AddressRange_CS RedfishAddressPool_V1_2_1_IPv4AddressRange_CS;
typedef struct _RedfishAddressPool_V1_2_1_Links_CS RedfishAddressPool_V1_2_1_Links_CS;
typedef struct _RedfishAddressPool_V1_2_1_MaxPrefix_CS RedfishAddressPool_V1_2_1_MaxPrefix_CS;
typedef struct _RedfishAddressPool_V1_2_1_MultiplePaths_CS RedfishAddressPool_V1_2_1_MultiplePaths_CS;
typedef struct _RedfishAddressPool_V1_2_1_OemActions_CS RedfishAddressPool_V1_2_1_OemActions_CS;
typedef struct _RedfishAddressPool_V1_2_1_RouteDistinguisherRange_CS RedfishAddressPool_V1_2_1_RouteDistinguisherRange_CS;
typedef struct _RedfishAddressPool_V1_2_1_RouteTargetRange_CS RedfishAddressPool_V1_2_1_RouteTargetRange_CS;
typedef struct _RedfishAddressPool_V1_2_1_SystemMACRange_CS RedfishAddressPool_V1_2_1_SystemMACRange_CS;
typedef struct _RedfishAddressPool_V1_2_1_VLANIdentifierAddressRange_CS RedfishAddressPool_V1_2_1_VLANIdentifierAddressRange_CS;
...
typedef struct _RedfishAddressPool_V1_2_1_Actions_CS {
    RedfishAddressPool_V1_2_1_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishAddressPool_V1_2_1_BGPEvpn_CS {
    ...
    RedfishCS_char                                             *AnycastGatewayMACAddress;                  // The anycast gateway MAC
                                                                                                           // address.
    RedfishAddressPool_V1_2_1_ESINumberRange_CS                *ESINumberRange;                            // The Ethernet Segment
                                                                                                           // Identifier (ESI) number range
                                                                                                           // for the fabric.
    RedfishAddressPool_V1_2_1_EVINumberRange_CS                *EVINumberRange;                            // The Ethernet Virtual Private
                                                                                                           // Network (EVPN) Instance number
                                                                                                           // (EVI) number range for the
                                                                                                           // fabric.
    RedfishCS_char                                             *GatewayIPAddress;                          // The gateway IPv4 address.
    RedfishAddressPool_V1_2_1_GatewayIPAddressRange_CS         *GatewayIPAddressRange;                     // The IPv4 address range for
                                                                                                           // gateways.
    ...
    RedfishAddressPool_V1_2_1_RouteDistinguisherRange_CS       *RouteDistinguisherRange;                   // The Route Distinguisher (RD)
                                                                                                           // number range for the fabric.
    RedfishCS_char                                             *RouteTargetAdministratorSubfield;          // The Route Target (RT)
                                                                                                           // Administrator Subfield.
    RedfishAddressPool_V1_2_1_RouteTargetRange_CS              *RouteTargetRange;                          // The Route Target (RT) number
    ...
    RedfishCS_bool                                             *UnknownUnicastSuppressionEnabled;          // Suppression of unknown unicast
                                                                                                           // packets.
    RedfishAddressPool_V1_2_1_VLANIdentifierAddressRange_CS    *VLANIdentifierAddressRange;                // Virtual LAN (VLAN) tag related
...
typedef struct _RedfishAddressPool_V1_2_1_BGPNeighbor_CS {
    ...
    RedfishCS_bool                            *LogStateChangesEnabled;                // Border Gateway Protocol (BGP)
                                                                                      ...
                                                                                      // status.
    RedfishAddressPool_V1_2_1_MaxPrefix_CS    *MaxPrefix;                             // Border Gateway Protocol (BGP)
...
typedef struct _RedfishAddressPool_V1_2_1_CommonBGPProperties_CS {
    RedfishAddressPool_V1_2_1_ASNumberRange_CS      *ASNumberRange;          // Autonomous System (AS) number
                                                                             // range.
    RedfishAddressPool_V1_2_1_BGPNeighbor_CS        *BGPNeighbor;            // Border Gateway Protocol (BGP)
                                                                             // neighbor related properties.
    RedfishAddressPool_V1_2_1_BGPRoute_CS           *BGPRoute;               // Border Gateway Protocol (BGP)
                                                                             // route related properties.
    RedfishAddressPool_V1_2_1_GracefulRestart_CS    *GracefulRestart;        // Graceful restart related
                                                                             // properties.
    RedfishAddressPool_V1_2_1_MultiplePaths_CS      *MultiplePaths;          // Multiple path related
                                                                             // properties.
...
typedef struct _RedfishAddressPool_V1_2_1_Ethernet_CS {
    RedfishAddressPool_V1_2_1_BFDSingleHopOnly_CS       *BFDSingleHopOnly;    // Bidirectional Forwarding
                                                                              // Detection (BFD) related
                                                                              // properties for this Ethernet
                                                                              // fabric.
    RedfishAddressPool_V1_2_1_BGPEvpn_CS                *BGPEvpn;             // BGP Ethernet Virtual Private
                                                                              // Network (EVPN) related
                                                                              // properties for this Ethernet
                                                                              // fabric.
    RedfishAddressPool_V1_2_1_EBGP_CS                   *EBGP;                // External BGP (eBGP) related
                                                                              // properties for this Ethernet
                                                                              // fabric.
    RedfishAddressPool_V1_2_1_IPv4_CS                   *IPv4;                // IPv4 and Virtual LAN (VLAN)
                                                                              // related addressing for this
                                                                              // Ethernet fabric.
    RedfishAddressPool_V1_2_1_EBGP_CS                   *MultiProtocolEBGP;    // Multi Protocol eBGP (MP eBGP)
                                                                              // related properties for this
                                                                              // Ethernet fabric.
    RedfishAddressPool_V1_2_1_CommonBGPProperties_CS    *MultiProtocolIBGP;    // Multi Protocol iBGP (MP iBGP)
                                                                              // related properties for this
                                                                              // Ethernet fabric.
...
typedef struct _RedfishAddressPool_V1_2_1_IPv4_CS {
    ...
    RedfishCS_char                                             *AnycastGatewayMACAddress;        // The anycast gateway MAC
                                                                                                 // address.
    RedfishAddressPool_V1_2_1_DHCP_CS                          *DHCP;                            // The Dynamic Host Configuration
    ...
    RedfishCS_bool                                             *DistributeIntoUnderlayEnabled;    // Indicates if host subnets
                                                                                                 ...
                                                                                                 // fabric underlay.
    RedfishAddressPool_V1_2_1_IPv4AddressRange_CS              *EBGPAddressRange;                // External BGP (eBGP) related
                                                                                                 // addressing for this Ethernet
                                                                                                 // fabric.
    RedfishAddressPool_V1_2_1_IPv4AddressRange_CS              *FabricLinkAddressRange;          // Link related IPv4 addressing
                                                                                                 // for this Ethernet fabric
                                                                                                 // typically applied to
                                                                                                 // connections between spine and
                                                                                                 // leaf Ethernet switches.
    RedfishCS_char                                             *GatewayIPAddress;                // The gateway IPv4 address.
    RedfishAddressPool_V1_2_1_IPv4AddressRange_CS              *HostAddressRange;                // IPv4 related host subnet
                                                                                                 // addressing for physical device
                                                                                                 // endpoints that connect to this
                                                                                                 // Ethernet fabric.
    RedfishAddressPool_V1_2_1_IPv4AddressRange_CS              *IBGPAddressRange;                // Internal BGP (iBGP) related
                                                                                                 // addressing for this Ethernet
                                                                                                 // fabric.
    RedfishAddressPool_V1_2_1_IPv4AddressRange_CS              *LoopbackAddressRange;            // Loopback related IPv4
                                                                                                 // addressing for this Ethernet
                                                                                                 // fabric.
    RedfishAddressPool_V1_2_1_IPv4AddressRange_CS              *ManagementAddressRange;          // Management related addressing
                                                                                                 // for this Ethernet fabric.
    ...
    RedfishCS_int64                                            *NativeVLAN;                      // The native Virtual LAN (VLAN)
                                                                                                 // tag value.
    RedfishAddressPool_V1_2_1_SystemMACRange_CS                *SystemMACRange;                  // The MAC address range for
...
typedef struct _RedfishAddressPool_V1_2_1_AddressPool_CS {
    ...
    RedfishAddressPool_V1_2_1_Actions_CS     *Actions;         // The available actions for this
                                                               // resource.
    RedfishCS_char                           *Description; 
    RedfishAddressPool_V1_2_1_Ethernet_CS    *Ethernet;        // The Ethernet related
                                                               // properties for this address
                                                               // pool.
    RedfishAddressPool_V1_2_1_GenZ_CS        *GenZ;            // The Gen-Z related properties
                                                               // for this address pool.
    RedfishCS_char                           *Id;          
    RedfishAddressPool_V1_2_1_Links_CS       *Links;           // The links to other resources
...
RedfishCS_status
Json_AddressPool_V1_2_1_To_CS (char *JsonRawText, RedfishAddressPool_V1_2_1_AddressPool_CS **ReturnedCS);

RedfishCS_status
CS_To_AddressPool_V1_2_1_JSON (RedfishAddressPool_V1_2_1_AddressPool_CS *CSPtr, char **JsonText);
