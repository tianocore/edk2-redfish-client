...
#ifndef RedfishZone_V1_5_1_CSTRUCT_H_
#define RedfishZone_V1_5_1_CSTRUCT_H_
...
typedef struct _RedfishZone_V1_5_1_Actions_CS RedfishZone_V1_5_1_Actions_CS;
typedef struct _RedfishZone_V1_5_1_AddEndpoint_CS RedfishZone_V1_5_1_AddEndpoint_CS;
typedef struct _RedfishZone_V1_5_1_Links_CS RedfishZone_V1_5_1_Links_CS;
typedef struct _RedfishZone_V1_5_1_OemActions_CS RedfishZone_V1_5_1_OemActions_CS;
typedef struct _RedfishZone_V1_5_1_RemoveEndpoint_CS RedfishZone_V1_5_1_RemoveEndpoint_CS;
typedef struct _RedfishZone_V1_5_1_Zone_CS RedfishZone_V1_5_1_Zone_CS;
...
typedef struct _RedfishZone_V1_5_1_Actions_CS {
    ...
    RedfishZone_V1_5_1_OemActions_CS        *Oem;                   // The available OEM-specific
...
typedef struct _RedfishZone_V1_5_1_Zone_CS {
    ...
    RedfishZone_V1_5_1_Actions_CS    *Actions;                 // The available actions for this
                                                               // resource.
    ...
    RedfishCS_Link                   Identifiers;              // The durable names for the
                                                               // zone.
    RedfishZone_V1_5_1_Links_CS      *Links;                   // The links to other resources
...
RedfishCS_status
Json_Zone_V1_5_1_To_CS (char *JsonRawText, RedfishZone_V1_5_1_Zone_CS **ReturnedCS);

RedfishCS_status
CS_To_Zone_V1_5_1_JSON (RedfishZone_V1_5_1_Zone_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyZone_V1_5_1_CS (RedfishZone_V1_5_1_Zone_CS *CSPtr);

RedfishCS_status
DestroyZone_V1_5_1_Json (RedfishCS_char *JsonText);
