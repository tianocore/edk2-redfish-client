...
#ifndef RedfishMemorychunks_V1_0_5_CSTRUCT_H_
#define RedfishMemorychunks_V1_0_5_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMemoryChunks_V1_0_5_InterleaveSet_Array_CS RedfishMemoryChunks_V1_0_5_InterleaveSet_Array_CS;
typedef struct _RedfishMemoryChunks_V1_0_5_InterleaveSet_CS RedfishMemoryChunks_V1_0_5_InterleaveSet_CS;
typedef struct _RedfishMemoryChunks_V1_0_5_MemoryChunks_CS RedfishMemoryChunks_V1_0_5_MemoryChunks_CS;
...
typedef struct _RedfishMemoryChunks_V1_0_5_MemoryChunks_CS {
    ...
    RedfishCS_char                                       *Id;               
    RedfishMemoryChunks_V1_0_5_InterleaveSet_Array_CS    *InterleaveSets;       // The interleave sets for the
                                                                                // memory chunk.
...
typedef struct _RedfishMemoryChunks_V1_0_5_InterleaveSet_Array_CS  {
    RedfishMemoryChunks_V1_0_5_InterleaveSet_Array_CS    *Next;
    RedfishMemoryChunks_V1_0_5_InterleaveSet_CS    *ArrayValue;
} RedfishMemoryChunks_V1_0_5_InterleaveSet_Array_CS;

RedfishCS_status
Json_MemoryChunks_V1_0_5_To_CS (char *JsonRawText, RedfishMemoryChunks_V1_0_5_MemoryChunks_CS **ReturnedCS);

RedfishCS_status
CS_To_MemoryChunks_V1_0_5_JSON (RedfishMemoryChunks_V1_0_5_MemoryChunks_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMemoryChunks_V1_0_5_CS (RedfishMemoryChunks_V1_0_5_MemoryChunks_CS *CSPtr);

RedfishCS_status
DestroyMemoryChunks_V1_0_5_Json (RedfishCS_char *JsonText);
