...
#ifndef RedfishComputersystem_V1_0_17_CSTRUCT_H_
#define RedfishComputersystem_V1_0_17_CSTRUCT_H_
...
#endif
typedef struct _RedfishComputerSystem_V1_0_17_Actions_CS RedfishComputerSystem_V1_0_17_Actions_CS;
typedef struct _RedfishComputerSystem_V1_0_17_Boot_CS RedfishComputerSystem_V1_0_17_Boot_CS;
typedef struct _RedfishComputerSystem_V1_0_17_ComputerSystem_CS RedfishComputerSystem_V1_0_17_ComputerSystem_CS;
typedef struct _RedfishComputerSystem_V1_0_17_Links_CS RedfishComputerSystem_V1_0_17_Links_CS;
typedef struct _RedfishComputerSystem_V1_0_17_MemorySummary_CS RedfishComputerSystem_V1_0_17_MemorySummary_CS;
typedef struct _RedfishComputerSystem_V1_0_17_OemActions_CS RedfishComputerSystem_V1_0_17_OemActions_CS;
typedef struct _RedfishComputerSystem_V1_0_17_ProcessorSummary_CS RedfishComputerSystem_V1_0_17_ProcessorSummary_CS;
typedef struct _RedfishComputerSystem_V1_0_17_Reset_CS RedfishComputerSystem_V1_0_17_Reset_CS;
...
//
typedef struct _RedfishComputerSystem_V1_0_17_Actions_CS {
    RedfishComputerSystem_V1_0_17_Reset_CS         *ComputerSystem_Reset;
    RedfishComputerSystem_V1_0_17_OemActions_CS    *Oem;                    // The available OEM-specific
                                                                            // actions for this resource.
} RedfishComputerSystem_V1_0_17_Actions_CS;

//
// The boot information for this resource.
//
typedef struct _RedfishComputerSystem_V1_0_17_Boot_CS {
    ...
    RedfishCS_char    *UefiTargetBootSourceOverride;    // The UEFI device path of the
                                                       ...
                                                       // `UefiTarget`.
} RedfishComputerSystem_V1_0_17_Boot_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishComputerSystem_V1_0_17_Links_CS {
...
} RedfishComputerSystem_V1_0_17_Links_CS;

//
// The memory of the system in general detail.
//
typedef struct _RedfishComputerSystem_V1_0_17_MemorySummary_CS {
    ...
    RedfishCS_int64              *TotalSystemMemoryGiB;    // The total configured operating
                                                          ...
                                                          // (RAM), measured in GiB.
} RedfishComputerSystem_V1_0_17_MemorySummary_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishComputerSystem_V1_0_17_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishComputerSystem_V1_0_17_OemActions_CS;

//
// The central processors of the system in general detail.
//
typedef struct _RedfishComputerSystem_V1_0_17_ProcessorSummary_CS {
    ...
    RedfishResource_Status_CS    *Status;    // The status and health of the
                                            // resource and its subordinate
                                            // or dependent resources.
} RedfishComputerSystem_V1_0_17_ProcessorSummary_CS;

//
// This action resets the system.
//
typedef struct _RedfishComputerSystem_V1_0_17_Reset_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishComputerSystem_V1_0_17_Reset_CS;
...
//
typedef struct _RedfishComputerSystem_V1_0_17_ComputerSystem_CS {
    RedfishCS_Header                                     Header;
    RedfishCS_char                                       *odata_context;   
    RedfishCS_char                                       *odata_etag;      
    RedfishCS_char                                       *odata_id;        
    RedfishCS_char                                       *odata_type;      
    RedfishComputerSystem_V1_0_17_Actions_CS             *Actions;             // The available actions for this
                                                                               // resource.
    ...
    RedfishComputerSystem_V1_0_17_Boot_CS                *Boot;                // The boot settings for this
                                                                               // system.
    ...
    RedfishCS_char                                       *IndicatorLED;        // The state of the indicator
                                                                               ...
                                                                               // system.
    RedfishComputerSystem_V1_0_17_Links_CS               *Links;               // The links to other resources
    ...
    RedfishCS_char                                       *Manufacturer;        // The manufacturer or OEM of
                                                                               // this system.
    RedfishComputerSystem_V1_0_17_MemorySummary_CS       *MemorySummary;       // The central memory of the
    ...
    RedfishCS_char                                       *PowerState;          // The current power state of the
                                                                               // system.
    RedfishComputerSystem_V1_0_17_ProcessorSummary_CS    *ProcessorSummary;    // The central processors of the
                                                                               // system in general detail.
...
} RedfishComputerSystem_V1_0_17_ComputerSystem_CS;
...
RedfishCS_status
Json_ComputerSystem_V1_0_17_To_CS (char *JsonRawText, RedfishComputerSystem_V1_0_17_ComputerSystem_CS **ReturnedCS);

RedfishCS_status
CS_To_ComputerSystem_V1_0_17_JSON (RedfishComputerSystem_V1_0_17_ComputerSystem_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyComputerSystem_V1_0_17_CS (RedfishComputerSystem_V1_0_17_ComputerSystem_CS *CSPtr);

RedfishCS_status
DestroyComputerSystem_V1_0_17_Json (RedfishCS_char *JsonText);
