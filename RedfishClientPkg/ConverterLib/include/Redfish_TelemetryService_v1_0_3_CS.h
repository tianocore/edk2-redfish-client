...
#ifndef RedfishTelemetryservice_V1_0_3_CSTRUCT_H_
#define RedfishTelemetryservice_V1_0_3_CSTRUCT_H_
...
typedef struct _RedfishTelemetryService_V1_0_3_Actions_CS RedfishTelemetryService_V1_0_3_Actions_CS;
typedef struct _RedfishTelemetryService_V1_0_3_OemActions_CS RedfishTelemetryService_V1_0_3_OemActions_CS;
typedef struct _RedfishTelemetryService_V1_0_3_SubmitTestMetricReport_CS RedfishTelemetryService_V1_0_3_SubmitTestMetricReport_CS;
typedef struct _RedfishTelemetryService_V1_0_3_TelemetryService_CS RedfishTelemetryService_V1_0_3_TelemetryService_CS;
...
typedef struct _RedfishTelemetryService_V1_0_3_Actions_CS {
    ...
    RedfishTelemetryService_V1_0_3_OemActions_CS                *Oem;                                       // The available OEM-specific
...
typedef struct _RedfishTelemetryService_V1_0_3_TelemetryService_CS {
    ...
    RedfishTelemetryService_V1_0_3_Actions_CS    *Actions;                        // The available actions for this
                                                                                  // resource.
...
RedfishCS_status
Json_TelemetryService_V1_0_3_To_CS (char *JsonRawText, RedfishTelemetryService_V1_0_3_TelemetryService_CS **ReturnedCS);

RedfishCS_status
CS_To_TelemetryService_V1_0_3_JSON (RedfishTelemetryService_V1_0_3_TelemetryService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyTelemetryService_V1_0_3_CS (RedfishTelemetryService_V1_0_3_TelemetryService_CS *CSPtr);

RedfishCS_status
DestroyTelemetryService_V1_0_3_Json (RedfishCS_char *JsonText);
