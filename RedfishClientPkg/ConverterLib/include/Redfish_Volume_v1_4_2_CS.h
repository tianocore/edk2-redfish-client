...
#ifndef RedfishVolume_V1_4_2_CSTRUCT_H_
#define RedfishVolume_V1_4_2_CSTRUCT_H_
...
typedef struct _RedfishVolume_V1_4_2_Actions_CS RedfishVolume_V1_4_2_Actions_CS;
typedef struct _RedfishVolume_V1_4_2_AssignReplicaTarget_CS RedfishVolume_V1_4_2_AssignReplicaTarget_CS;
typedef struct _RedfishVolume_V1_4_2_CheckConsistency_CS RedfishVolume_V1_4_2_CheckConsistency_CS;
typedef struct _RedfishVolume_V1_4_2_CreateReplicaTarget_CS RedfishVolume_V1_4_2_CreateReplicaTarget_CS;
typedef struct _RedfishVolume_V1_4_2_Links_CS RedfishVolume_V1_4_2_Links_CS;
typedef struct _RedfishVolume_V1_4_2_OemActions_CS RedfishVolume_V1_4_2_OemActions_CS;
typedef struct _RedfishVolume_V1_4_2_Operation_CS RedfishVolume_V1_4_2_Operation_CS;
typedef struct _RedfishVolume_V1_4_2_RemoveReplicaRelationship_CS RedfishVolume_V1_4_2_RemoveReplicaRelationship_CS;
typedef struct _RedfishVolume_V1_4_2_ResumeReplication_CS RedfishVolume_V1_4_2_ResumeReplication_CS;
typedef struct _RedfishVolume_V1_4_2_ReverseReplicationRelationship_CS RedfishVolume_V1_4_2_ReverseReplicationRelationship_CS;
typedef struct _RedfishVolume_V1_4_2_SplitReplication_CS RedfishVolume_V1_4_2_SplitReplication_CS;
typedef struct _RedfishVolume_V1_4_2_SuspendReplication_CS RedfishVolume_V1_4_2_SuspendReplication_CS;
typedef struct _RedfishVolume_V1_4_2_Volume_CS RedfishVolume_V1_4_2_Volume_CS;
...
typedef struct _RedfishVolume_V1_4_2_Volume_CS {
    ...
    RedfishCS_char                                     *AccessCapabilities;                 // Supported IO access
                                                                                            // capabilities.
    RedfishVolume_V1_4_2_Actions_CS                    *Actions;                            // The available actions for this
                                                                                            // resource.
    ...
    RedfishCS_Link                                     Identifiers;                         // The Durable names for the
                                                                                            // volume.
    RedfishVolume_V1_4_2_Links_CS                      *Links;                              // Contains references to other
    ...
    RedfishCS_char                                     *Name;                           
    RedfishResource_Oem_CS                             *Oem;                                // The OEM extension property.
    RedfishVolume_V1_4_2_Operation_CS                  *Operations;                         // The operations currently
...
RedfishCS_status
Json_Volume_V1_4_2_To_CS (char *JsonRawText, RedfishVolume_V1_4_2_Volume_CS **ReturnedCS);

RedfishCS_status
CS_To_Volume_V1_4_2_JSON (RedfishVolume_V1_4_2_Volume_CS *CSPtr, char **JsonText);
