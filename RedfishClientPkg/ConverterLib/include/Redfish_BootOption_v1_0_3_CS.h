...
#ifndef RedfishBootoption_V1_0_3_CSTRUCT_H_
#define RedfishBootoption_V1_0_3_CSTRUCT_H_
...
#endif
typedef struct _RedfishBootOption_V1_0_3_Actions_CS RedfishBootOption_V1_0_3_Actions_CS;
typedef struct _RedfishBootOption_V1_0_3_BootOption_CS RedfishBootOption_V1_0_3_BootOption_CS;
typedef struct _RedfishBootOption_V1_0_3_OemActions_CS RedfishBootOption_V1_0_3_OemActions_CS;
...
typedef struct _RedfishBootOption_V1_0_3_Actions_CS {
    RedfishBootOption_V1_0_3_OemActions_CS    *Oem;    // The available OEM-specific
...
//
// The BootOption schema describes a boot option.  It represents the properties of
// a bootable device available in the system.
//
typedef struct _RedfishBootOption_V1_0_3_BootOption_CS {
    ...
    RedfishBootOption_V1_0_3_Actions_CS    *Actions;                  // The available actions for this
                                                                      // Resource.
    ...
    Redfishodatav4_idRef_Array_CS          *RelatedItem;              // An array of one or more IDs
                                                                      // for the Resources associated
...
RedfishCS_status
Json_BootOption_V1_0_3_To_CS (char *JsonRawText, RedfishBootOption_V1_0_3_BootOption_CS **ReturnedCS);

RedfishCS_status
CS_To_BootOption_V1_0_3_JSON (RedfishBootOption_V1_0_3_BootOption_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyBootOption_V1_0_3_CS (RedfishBootOption_V1_0_3_BootOption_CS *CSPtr);

RedfishCS_status
DestroyBootOption_V1_0_3_Json (RedfishCS_char *JsonText);
