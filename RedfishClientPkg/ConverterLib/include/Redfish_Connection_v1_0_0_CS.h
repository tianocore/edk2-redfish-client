...
#ifndef RedfishConnection_V1_0_0_CSTRUCT_H_
#define RedfishConnection_V1_0_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishConnection_V1_0_0_VolumeInfo_Array_CS RedfishConnection_V1_0_0_VolumeInfo_Array_CS;
typedef struct _RedfishConnection_V1_0_0_Actions_CS RedfishConnection_V1_0_0_Actions_CS;
typedef struct _RedfishConnection_V1_0_0_Connection_CS RedfishConnection_V1_0_0_Connection_CS;
typedef struct _RedfishConnection_V1_0_0_Links_CS RedfishConnection_V1_0_0_Links_CS;
typedef struct _RedfishConnection_V1_0_0_OemActions_CS RedfishConnection_V1_0_0_OemActions_CS;
typedef struct _RedfishConnection_V1_0_0_VolumeInfo_CS RedfishConnection_V1_0_0_VolumeInfo_CS;
...
typedef struct _RedfishConnection_V1_0_0_Actions_CS {
    RedfishConnection_V1_0_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishConnection_V1_0_0_Connection_CS {
    ...
    RedfishConnection_V1_0_0_Actions_CS             *Actions;          // The available actions for this
                                                                       // resource.
    RedfishCS_char                                  *ConnectionType;    // The type of resources this
                                                                       // connection specifies.
    RedfishCS_char                                  *Description;  
    RedfishCS_char                                  *Id;           
    RedfishConnection_V1_0_0_Links_CS               *Links;            // The links to other resources
    ...
    RedfishConnection_V1_0_0_VolumeInfo_Array_CS    *VolumeInfo;       // The set of volumes and access
...
typedef struct _RedfishConnection_V1_0_0_VolumeInfo_Array_CS  {
    RedfishConnection_V1_0_0_VolumeInfo_Array_CS    *Next;
    RedfishConnection_V1_0_0_VolumeInfo_CS    *ArrayValue;
} RedfishConnection_V1_0_0_VolumeInfo_Array_CS;

RedfishCS_status
Json_Connection_V1_0_0_To_CS (char *JsonRawText, RedfishConnection_V1_0_0_Connection_CS **ReturnedCS);

RedfishCS_status
CS_To_Connection_V1_0_0_JSON (RedfishConnection_V1_0_0_Connection_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyConnection_V1_0_0_CS (RedfishConnection_V1_0_0_Connection_CS *CSPtr);

RedfishCS_status
DestroyConnection_V1_0_0_Json (RedfishCS_char *JsonText);
