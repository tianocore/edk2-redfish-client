...
#ifndef RedfishLogservice_V1_2_0_CSTRUCT_H_
#define RedfishLogservice_V1_2_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishLogService_V1_2_0_SyslogFilter_Array_CS RedfishLogService_V1_2_0_SyslogFilter_Array_CS;
typedef struct _RedfishLogService_V1_2_0_Actions_CS RedfishLogService_V1_2_0_Actions_CS;
typedef struct _RedfishLogService_V1_2_0_ClearLog_CS RedfishLogService_V1_2_0_ClearLog_CS;
typedef struct _RedfishLogService_V1_2_0_CollectDiagnosticData_CS RedfishLogService_V1_2_0_CollectDiagnosticData_CS;
typedef struct _RedfishLogService_V1_2_0_LogService_CS RedfishLogService_V1_2_0_LogService_CS;
typedef struct _RedfishLogService_V1_2_0_OemActions_CS RedfishLogService_V1_2_0_OemActions_CS;
typedef struct _RedfishLogService_V1_2_0_SyslogFilter_CS RedfishLogService_V1_2_0_SyslogFilter_CS;
...
typedef struct _RedfishLogService_V1_2_0_Actions_CS {
    ...
    RedfishLogService_V1_2_0_OemActions_CS               *Oem;                                // The available OEM-specific
...
typedef struct _RedfishLogService_V1_2_0_LogService_CS {
    ...
    RedfishLogService_V1_2_0_Actions_CS               *Actions;               // The available actions for this
                                                                              // Resource.
    ...
    RedfishLogService_V1_2_0_SyslogFilter_Array_CS    *SyslogFilters;         // A list of syslog message
...
typedef struct _RedfishLogService_V1_2_0_SyslogFilter_Array_CS  {
    RedfishLogService_V1_2_0_SyslogFilter_Array_CS    *Next;
    RedfishLogService_V1_2_0_SyslogFilter_CS    *ArrayValue;
} RedfishLogService_V1_2_0_SyslogFilter_Array_CS;

RedfishCS_status
Json_LogService_V1_2_0_To_CS (char *JsonRawText, RedfishLogService_V1_2_0_LogService_CS **ReturnedCS);

RedfishCS_status
CS_To_LogService_V1_2_0_JSON (RedfishLogService_V1_2_0_LogService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyLogService_V1_2_0_CS (RedfishLogService_V1_2_0_LogService_CS *CSPtr);

RedfishCS_status
DestroyLogService_V1_2_0_Json (RedfishCS_char *JsonText);
