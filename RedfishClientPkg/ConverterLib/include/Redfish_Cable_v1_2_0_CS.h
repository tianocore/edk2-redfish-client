...
#ifndef RedfishCable_V1_2_0_CSTRUCT_H_
#define RedfishCable_V1_2_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishCable_V1_2_0_Actions_CS RedfishCable_V1_2_0_Actions_CS;
typedef struct _RedfishCable_V1_2_0_Cable_CS RedfishCable_V1_2_0_Cable_CS;
typedef struct _RedfishCable_V1_2_0_Links_CS RedfishCable_V1_2_0_Links_CS;
typedef struct _RedfishCable_V1_2_0_OemActions_CS RedfishCable_V1_2_0_OemActions_CS;
...
typedef struct _RedfishCable_V1_2_0_Actions_CS {
    RedfishCable_V1_2_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishCable_V1_2_0_Cable_CS {
    ...
    RedfishCable_V1_2_0_Actions_CS    *Actions;                    // The available actions for this
                                                                   // resource.
    ...
    RedfishCS_int64                   *LengthMeters;               // The length of the cable in
                                                                   // meters.
    RedfishCable_V1_2_0_Links_CS      *Links;                      // The links to other resources
...
RedfishCS_status
Json_Cable_V1_2_0_To_CS (char *JsonRawText, RedfishCable_V1_2_0_Cable_CS **ReturnedCS);

RedfishCS_status
CS_To_Cable_V1_2_0_JSON (RedfishCable_V1_2_0_Cable_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyCable_V1_2_0_CS (RedfishCable_V1_2_0_Cable_CS *CSPtr);

RedfishCS_status
DestroyCable_V1_2_0_Json (RedfishCS_char *JsonText);
