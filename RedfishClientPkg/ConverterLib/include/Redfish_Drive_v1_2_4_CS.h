...
#ifndef RedfishDrive_V1_2_4_CSTRUCT_H_
#define RedfishDrive_V1_2_4_CSTRUCT_H_
...
#endif
typedef struct _RedfishDrive_V1_2_4_Operations_Array_CS RedfishDrive_V1_2_4_Operations_Array_CS;
typedef struct _RedfishDrive_V1_2_4_Actions_CS RedfishDrive_V1_2_4_Actions_CS;
typedef struct _RedfishDrive_V1_2_4_Drive_CS RedfishDrive_V1_2_4_Drive_CS;
typedef struct _RedfishDrive_V1_2_4_Links_CS RedfishDrive_V1_2_4_Links_CS;
typedef struct _RedfishDrive_V1_2_4_OemActions_CS RedfishDrive_V1_2_4_OemActions_CS;
typedef struct _RedfishDrive_V1_2_4_Operations_CS RedfishDrive_V1_2_4_Operations_CS;
typedef struct _RedfishDrive_V1_2_4_SecureErase_CS RedfishDrive_V1_2_4_SecureErase_CS;
...
//
typedef struct _RedfishDrive_V1_2_4_Actions_CS {
    RedfishDrive_V1_2_4_SecureErase_CS    *Drive_SecureErase;
    RedfishDrive_V1_2_4_OemActions_CS     *Oem;                 // This property contains the
                                                                // available OEM specific actions
                                                                // for this resource.
} RedfishDrive_V1_2_4_Actions_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishDrive_V1_2_4_Links_CS {
...
} RedfishDrive_V1_2_4_Links_CS;

//
// The available OEM specific actions for this resource.
//
typedef struct _RedfishDrive_V1_2_4_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishDrive_V1_2_4_OemActions_CS;

//
// An operation currently running on this resource.
//
typedef struct _RedfishDrive_V1_2_4_Operations_CS {
    ...
    RedfishCS_int64    *PercentageComplete;    // The percentage of the
                                              ...
                                              // completed.
} RedfishDrive_V1_2_4_Operations_CS;

//
// This action is used to securely erase the contents of the drive.
//
typedef struct _RedfishDrive_V1_2_4_SecureErase_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishDrive_V1_2_4_SecureErase_CS;
...
//
typedef struct _RedfishDrive_V1_2_4_Drive_CS {
    RedfishCS_Header                           Header;
    RedfishCS_char                             *odata_context;               
    RedfishCS_char                             *odata_etag;                  
    RedfishCS_char                             *odata_id;                    
    RedfishCS_char                             *odata_type;                  
    RedfishDrive_V1_2_4_Actions_CS             *Actions;                         // The available actions for this
                                                                                 // resource.
    ...
    RedfishCS_char                             *IndicatorLED;                    // The state of the indicator
                                                                                 ...
                                                                                 // drive.
    RedfishDrive_V1_2_4_Links_CS               *Links;                           // Contains references to other
    ...
    RedfishResource_Oem_CS                     *Oem;                             // This is the
                                                                                 ...
                                                                                 // sections.
    RedfishDrive_V1_2_4_Operations_Array_CS    *Operations;                      // The operations currently
...
typedef struct _RedfishDrive_V1_2_4_Operations_Array_CS  {
    RedfishDrive_V1_2_4_Operations_Array_CS    *Next;
    RedfishDrive_V1_2_4_Operations_CS    *ArrayValue;
} RedfishDrive_V1_2_4_Operations_Array_CS;

RedfishCS_status
Json_Drive_V1_2_4_To_CS (char *JsonRawText, RedfishDrive_V1_2_4_Drive_CS **ReturnedCS);

RedfishCS_status
CS_To_Drive_V1_2_4_JSON (RedfishDrive_V1_2_4_Drive_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyDrive_V1_2_4_CS (RedfishDrive_V1_2_4_Drive_CS *CSPtr);

RedfishCS_status
DestroyDrive_V1_2_4_Json (RedfishCS_char *JsonText);
