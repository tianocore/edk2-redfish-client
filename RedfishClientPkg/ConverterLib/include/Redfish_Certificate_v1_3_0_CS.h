...
#ifndef RedfishCertificate_V1_3_0_CSTRUCT_H_
#define RedfishCertificate_V1_3_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishCertificate_V1_3_0_Actions_CS RedfishCertificate_V1_3_0_Actions_CS;
typedef struct _RedfishCertificate_V1_3_0_Certificate_CS RedfishCertificate_V1_3_0_Certificate_CS;
typedef struct _RedfishCertificate_V1_3_0_Identifier_CS RedfishCertificate_V1_3_0_Identifier_CS;
typedef struct _RedfishCertificate_V1_3_0_OemActions_CS RedfishCertificate_V1_3_0_OemActions_CS;
typedef struct _RedfishCertificate_V1_3_0_Rekey_CS RedfishCertificate_V1_3_0_Rekey_CS;
typedef struct _RedfishCertificate_V1_3_0_RekeyResponse_CS RedfishCertificate_V1_3_0_RekeyResponse_CS;
typedef struct _RedfishCertificate_V1_3_0_Renew_CS RedfishCertificate_V1_3_0_Renew_CS;
typedef struct _RedfishCertificate_V1_3_0_RenewResponse_CS RedfishCertificate_V1_3_0_RenewResponse_CS;
...
typedef struct _RedfishCertificate_V1_3_0_Actions_CS {
    ...
    RedfishCertificate_V1_3_0_OemActions_CS    *Oem;                 // The available OEM-specific
...
typedef struct _RedfishCertificate_V1_3_0_Certificate_CS {
    ...
    RedfishCertificate_V1_3_0_Actions_CS       *Actions;                    // The available actions for this
                                                                            // resource.
    ...
    RedfishCS_char                             *FingerprintHashAlgorithm;    // The hash algorithm for the
                                                                            ...
                                                                            // certificate.
    RedfishCS_char                             *Id;                     
    RedfishCertificate_V1_3_0_Identifier_CS    *Issuer;                     // The issuer of the certificate.
    ...
    RedfishCS_char                             *SignatureAlgorithm;         // The algorithm used for
                                                                            ...
                                                                            // certificate.
    RedfishCertificate_V1_3_0_Identifier_CS    *Subject;                    // The subject of the
                                                                            // certificate.
...
RedfishCS_status
Json_Certificate_V1_3_0_To_CS (char *JsonRawText, RedfishCertificate_V1_3_0_Certificate_CS **ReturnedCS);

RedfishCS_status
CS_To_Certificate_V1_3_0_JSON (RedfishCertificate_V1_3_0_Certificate_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyCertificate_V1_3_0_CS (RedfishCertificate_V1_3_0_Certificate_CS *CSPtr);

RedfishCS_status
DestroyCertificate_V1_3_0_Json (RedfishCS_char *JsonText);
