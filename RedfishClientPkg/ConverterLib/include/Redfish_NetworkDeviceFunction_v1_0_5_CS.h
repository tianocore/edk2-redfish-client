...
#ifndef RedfishNetworkdevicefunction_V1_0_5_CSTRUCT_H_
#define RedfishNetworkdevicefunction_V1_0_5_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishNetworkDeviceFunction_V1_0_5_BootTargets_Array_CS RedfishNetworkDeviceFunction_V1_0_5_BootTargets_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishNetworkDeviceFunction_V1_0_5_BootTargets_CS RedfishNetworkDeviceFunction_V1_0_5_BootTargets_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_0_5_Ethernet_CS RedfishNetworkDeviceFunction_V1_0_5_Ethernet_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_0_5_FibreChannel_CS RedfishNetworkDeviceFunction_V1_0_5_FibreChannel_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_0_5_Links_CS RedfishNetworkDeviceFunction_V1_0_5_Links_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_0_5_NetworkDeviceFunction_CS RedfishNetworkDeviceFunction_V1_0_5_NetworkDeviceFunction_CS;
typedef struct _RedfishNetworkDeviceFunction_V1_0_5_iSCSIBoot_CS RedfishNetworkDeviceFunction_V1_0_5_iSCSIBoot_CS;
...
//
typedef struct _RedfishNetworkDeviceFunction_V1_0_5_BootTargets_CS {
    ...
    RedfishCS_char     *WWPN;           // The World-Wide Port Name to
                                        // boot from.
} RedfishNetworkDeviceFunction_V1_0_5_BootTargets_CS;

//
// This type describes Ethernet capabilities, status, and configuration of a
// network device function.
//
typedef struct _RedfishNetworkDeviceFunction_V1_0_5_Ethernet_CS {
    ...
    RedfishCS_char     *PermanentMACAddress;    // This is the permanent MAC
                                               ...
                                               // network device function
                                               // (physical function).
} RedfishNetworkDeviceFunction_V1_0_5_Ethernet_CS;

//
// This type describes Fibre Channel capabilities, status, and configuration of a
// network device function.
//
typedef struct _RedfishNetworkDeviceFunction_V1_0_5_FibreChannel_CS {
    RedfishCS_bool                                              *AllowFIPVLANDiscovery;    // Whether the FCoE
                                                                                          // Initialization Protocol (FIP)
                                                                                          // is used for populating the
                                                                                          // FCoE VLAN Id.
    RedfishNetworkDeviceFunction_V1_0_5_BootTargets_Array_CS    *BootTargets;             // An array of Fibre Channel boot
    ...
    RedfishCS_char                                              *WWPN;                    // This is the currently
                                                                                          ...
                                                                                          // network device function
                                                                                          // (physical function).
} RedfishNetworkDeviceFunction_V1_0_5_FibreChannel_CS;
...
typedef struct _RedfishNetworkDeviceFunction_V1_0_5_NetworkDeviceFunction_CS {
    ...
    RedfishCS_bool                                         *DeviceEnabled;                        // Whether the network device
                                                                                                  // function is enabled.
    RedfishNetworkDeviceFunction_V1_0_5_Ethernet_CS        *Ethernet;                             // Ethernet.
    RedfishNetworkDeviceFunction_V1_0_5_FibreChannel_CS    *FibreChannel;                         // Fibre Channel.
    RedfishCS_char                                         *Id;                               
    RedfishNetworkDeviceFunction_V1_0_5_Links_CS           *Links;                                // Links.
    ...
    RedfishCS_bool                                         *VirtualFunctionsEnabled;              // Whether Single Root I/O
                                                                                                  ...
                                                                                                  // Function.
    RedfishNetworkDeviceFunction_V1_0_5_iSCSIBoot_CS       *iSCSIBoot;                            // iSCSI Boot.
...
typedef struct _RedfishNetworkDeviceFunction_V1_0_5_BootTargets_Array_CS  {
    RedfishNetworkDeviceFunction_V1_0_5_BootTargets_Array_CS    *Next;
...
RedfishCS_status
Json_NetworkDeviceFunction_V1_0_5_To_CS (char *JsonRawText, RedfishNetworkDeviceFunction_V1_0_5_NetworkDeviceFunction_CS **ReturnedCS);

RedfishCS_status
CS_To_NetworkDeviceFunction_V1_0_5_JSON (RedfishNetworkDeviceFunction_V1_0_5_NetworkDeviceFunction_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyNetworkDeviceFunction_V1_0_5_CS (RedfishNetworkDeviceFunction_V1_0_5_NetworkDeviceFunction_CS *CSPtr);

RedfishCS_status
DestroyNetworkDeviceFunction_V1_0_5_Json (RedfishCS_char *JsonText);
