...
#ifndef RedfishSoftwareinventorycollection_Noversioned_CSTRUCT_H_
#define RedfishSoftwareinventorycollection_Noversioned_CSTRUCT_H_
...
//
// The SoftwareInventoryCollection schema contains a collection of software
// inventory instances.
//
