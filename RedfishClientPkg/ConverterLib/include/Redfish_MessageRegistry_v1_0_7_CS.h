...
#ifndef RedfishMessageregistry_V1_0_7_CSTRUCT_H_
#define RedfishMessageregistry_V1_0_7_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishMessageRegistry_V1_0_7_Message_CS RedfishMessageRegistry_V1_0_7_Message_CS;
typedef struct _RedfishMessageRegistry_V1_0_7_MessageProperty_CS RedfishMessageRegistry_V1_0_7_MessageProperty_CS;
typedef struct _RedfishMessageRegistry_V1_0_7_MessageRegistry_CS RedfishMessageRegistry_V1_0_7_MessageRegistry_CS;
...
//
typedef struct _RedfishMessageRegistry_V1_0_7_Message_CS {
    ...
    RedfishCS_char            *Severity;       // This is the severity of the
                                               // message.
} RedfishMessageRegistry_V1_0_7_Message_CS;

//
// The pattern type indicates that a free-form string is the unique identifier for
// the message within the registry.
//
typedef struct _RedfishMessageRegistry_V1_0_7_MessageProperty_CS {
    RedfishCS_Link    Prop;
} RedfishMessageRegistry_V1_0_7_MessageProperty_CS;
...
//
typedef struct _RedfishMessageRegistry_V1_0_7_MessageRegistry_CS {
    ...
    RedfishCS_char                                      *Language;          // This is the RFC 5646 compliant
                                                                            ...
                                                                            // registry.
    RedfishMessageRegistry_V1_0_7_MessageProperty_CS    *Messages;          // The pattern property indicates
...
} RedfishMessageRegistry_V1_0_7_MessageRegistry_CS;

RedfishCS_status
Json_MessageRegistry_V1_0_7_To_CS (char *JsonRawText, RedfishMessageRegistry_V1_0_7_MessageRegistry_CS **ReturnedCS);

RedfishCS_status
CS_To_MessageRegistry_V1_0_7_JSON (RedfishMessageRegistry_V1_0_7_MessageRegistry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyMessageRegistry_V1_0_7_CS (RedfishMessageRegistry_V1_0_7_MessageRegistry_CS *CSPtr);

RedfishCS_status
DestroyMessageRegistry_V1_0_7_Json (RedfishCS_char *JsonText);
