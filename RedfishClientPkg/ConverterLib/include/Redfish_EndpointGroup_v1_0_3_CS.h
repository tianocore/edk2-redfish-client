...
#ifndef RedfishEndpointgroup_V1_0_3_CSTRUCT_H_
#define RedfishEndpointgroup_V1_0_3_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishEndpointGroup_V1_0_3_EndpointGroup_CS RedfishEndpointGroup_V1_0_3_EndpointGroup_CS;
typedef struct _RedfishEndpointGroup_V1_0_3_Links_CS RedfishEndpointGroup_V1_0_3_Links_CS;
...
typedef struct _RedfishEndpointGroup_V1_0_3_EndpointGroup_CS {
    ...
    RedfishCS_Link                          Identifier;                       // The durable name for the
                                                                              // endpoint group.
    RedfishEndpointGroup_V1_0_3_Links_CS    *Links;                           // The links to other resources
...
RedfishCS_status
Json_EndpointGroup_V1_0_3_To_CS (char *JsonRawText, RedfishEndpointGroup_V1_0_3_EndpointGroup_CS **ReturnedCS);

RedfishCS_status
CS_To_EndpointGroup_V1_0_3_JSON (RedfishEndpointGroup_V1_0_3_EndpointGroup_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEndpointGroup_V1_0_3_CS (RedfishEndpointGroup_V1_0_3_EndpointGroup_CS *CSPtr);

RedfishCS_status
DestroyEndpointGroup_V1_0_3_Json (RedfishCS_char *JsonText);
