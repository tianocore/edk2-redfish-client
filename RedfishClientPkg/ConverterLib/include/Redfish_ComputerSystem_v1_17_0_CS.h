...
#ifndef RedfishComputersystem_V1_17_0_CSTRUCT_H_
#define RedfishComputersystem_V1_17_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishComputerSystem_V1_17_0_KMIPServer_Array_CS RedfishComputerSystem_V1_17_0_KMIPServer_Array_CS;
#ifndef Redfishodatav4_idRef_Array_CS_
typedef struct _Redfishodatav4_idRef_Array_CS Redfishodatav4_idRef_Array_CS;
#endif
typedef struct _RedfishComputerSystem_V1_17_0_TrustedModules_Array_CS RedfishComputerSystem_V1_17_0_TrustedModules_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishComputerSystem_V1_17_0_Actions_CS RedfishComputerSystem_V1_17_0_Actions_CS;
typedef struct _RedfishComputerSystem_V1_17_0_AddResourceBlock_CS RedfishComputerSystem_V1_17_0_AddResourceBlock_CS;
typedef struct _RedfishComputerSystem_V1_17_0_Boot_CS RedfishComputerSystem_V1_17_0_Boot_CS;
typedef struct _RedfishComputerSystem_V1_17_0_BootProgress_CS RedfishComputerSystem_V1_17_0_BootProgress_CS;
typedef struct _RedfishComputerSystem_V1_17_0_ComputerSystem_CS RedfishComputerSystem_V1_17_0_ComputerSystem_CS;
typedef struct _RedfishComputerSystem_V1_17_0_HostGraphicalConsole_CS RedfishComputerSystem_V1_17_0_HostGraphicalConsole_CS;
typedef struct _RedfishComputerSystem_V1_17_0_HostSerialConsole_CS RedfishComputerSystem_V1_17_0_HostSerialConsole_CS;
typedef struct _RedfishComputerSystem_V1_17_0_HostedServices_CS RedfishComputerSystem_V1_17_0_HostedServices_CS;
typedef struct _RedfishComputerSystem_V1_17_0_IdlePowerSaver_CS RedfishComputerSystem_V1_17_0_IdlePowerSaver_CS;
typedef struct _RedfishComputerSystem_V1_17_0_KMIPServer_CS RedfishComputerSystem_V1_17_0_KMIPServer_CS;
typedef struct _RedfishComputerSystem_V1_17_0_KeyManagement_CS RedfishComputerSystem_V1_17_0_KeyManagement_CS;
typedef struct _RedfishComputerSystem_V1_17_0_Links_CS RedfishComputerSystem_V1_17_0_Links_CS;
typedef struct _RedfishComputerSystem_V1_17_0_MemorySummary_CS RedfishComputerSystem_V1_17_0_MemorySummary_CS;
typedef struct _RedfishComputerSystem_V1_17_0_OemActions_CS RedfishComputerSystem_V1_17_0_OemActions_CS;
typedef struct _RedfishComputerSystem_V1_17_0_ProcessorSummary_CS RedfishComputerSystem_V1_17_0_ProcessorSummary_CS;
typedef struct _RedfishComputerSystem_V1_17_0_RemoveResourceBlock_CS RedfishComputerSystem_V1_17_0_RemoveResourceBlock_CS;
typedef struct _RedfishComputerSystem_V1_17_0_Reset_CS RedfishComputerSystem_V1_17_0_Reset_CS;
typedef struct _RedfishComputerSystem_V1_17_0_SerialConsoleProtocol_CS RedfishComputerSystem_V1_17_0_SerialConsoleProtocol_CS;
typedef struct _RedfishComputerSystem_V1_17_0_SetDefaultBootOrder_CS RedfishComputerSystem_V1_17_0_SetDefaultBootOrder_CS;
typedef struct _RedfishComputerSystem_V1_17_0_TrustedModules_CS RedfishComputerSystem_V1_17_0_TrustedModules_CS;
typedef struct _RedfishComputerSystem_V1_17_0_VirtualMediaConfig_CS RedfishComputerSystem_V1_17_0_VirtualMediaConfig_CS;
typedef struct _RedfishComputerSystem_V1_17_0_WatchdogTimer_CS RedfishComputerSystem_V1_17_0_WatchdogTimer_CS;
...
//
typedef struct _RedfishComputerSystem_V1_17_0_Actions_CS {
    RedfishComputerSystem_V1_17_0_AddResourceBlock_CS       *ComputerSystem_AddResourceBlock;  
    RedfishComputerSystem_V1_17_0_RemoveResourceBlock_CS    *ComputerSystem_RemoveResourceBlock;
    RedfishComputerSystem_V1_17_0_Reset_CS                  *ComputerSystem_Reset;             
    RedfishComputerSystem_V1_17_0_SetDefaultBootOrder_CS    *ComputerSystem_SetDefaultBootOrder;
    RedfishComputerSystem_V1_17_0_OemActions_CS             *Oem;                                  // The available OEM-specific
                                                                                                   // actions for this resource.
} RedfishComputerSystem_V1_17_0_Actions_CS;

//
// This action adds a resource block to a system.
//
typedef struct _RedfishComputerSystem_V1_17_0_AddResourceBlock_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishComputerSystem_V1_17_0_AddResourceBlock_CS;

//
// The boot information for this resource.
//
typedef struct _RedfishComputerSystem_V1_17_0_Boot_CS {
    ...
    RedfishCS_char_Array    *BootOrder;                         // An array of
                                                                ...
                                                                // computer system.  Changes to
                                                                // the boot order typically
                                                                // require a system reset before
                                                                // they take effect.  It is
                                                                // likely that a client finds the
                                                                // `@Redfish.Settings` term in
                                                                // this resource, and if it is
                                                                // found, the client makes
                                                                // requests to change boot order
    ...
    RedfishCS_char          *StopBootOnFault;                   // If the boot should stop on a
                                                                // fault.
    ...
    RedfishCS_char          *UefiTargetBootSourceOverride;      // The UEFI device path of the
                                                                ...
                                                                // BootSourceOverrideTarget is
                                                                // `UefiTarget`.
} RedfishComputerSystem_V1_17_0_Boot_CS;

//
// This object describes the last boot progress state.
//
typedef struct _RedfishComputerSystem_V1_17_0_BootProgress_CS {
    ...
    RedfishCS_char            *OemLastState;    // The OEM-specific last state,
                                                ...
                                                // `OEM`.
} RedfishComputerSystem_V1_17_0_BootProgress_CS;

//
// The information about a graphical console service for this system.
//
typedef struct _RedfishComputerSystem_V1_17_0_HostGraphicalConsole_CS {
    ...
    RedfishCS_bool          *ServiceEnabled;          // An indication of whether the
                                                      ...
                                                      // system.
} RedfishComputerSystem_V1_17_0_HostGraphicalConsole_CS;

//
// The information about the serial console services that this system provides.
//
typedef struct _RedfishComputerSystem_V1_17_0_HostSerialConsole_CS {
    RedfishComputerSystem_V1_17_0_SerialConsoleProtocol_CS    *IPMI;                    // The connection details for an
                                                                                        // IPMI Serial-over-LAN service.
    RedfishCS_int64                                           *MaxConcurrentSessions;    // The maximum number of service
                                                                                        // sessions, regardless of
                                                                                        // protocol, that this system can
                                                                                        // support.
    RedfishComputerSystem_V1_17_0_SerialConsoleProtocol_CS    *SSH;                     // The connection details for an
                                                                                        // SSH serial console service.
    RedfishComputerSystem_V1_17_0_SerialConsoleProtocol_CS    *Telnet;                  // The connection details for a
                                                                                        // Telnet serial console service.
} RedfishComputerSystem_V1_17_0_HostSerialConsole_CS;

//
// The services that might be running or installed on the system.
//
typedef struct _RedfishComputerSystem_V1_17_0_HostedServices_CS {
    RedfishResource_Oem_CS    *Oem;              // The OEM extension property.
    RedfishCS_Link            StorageServices;    // The link to a collection of
                                                 // storage services that this
                                                 // computer system supports.
} RedfishComputerSystem_V1_17_0_HostedServices_CS;

//
// The idle power saver settings of a computer system.
//
typedef struct _RedfishComputerSystem_V1_17_0_IdlePowerSaver_CS {
    RedfishCS_bool     *Enabled;                   // An indication of whether idle
                                                   // power saver is enabled.
    RedfishCS_int64    *EnterDwellTimeSeconds;     // The duration in seconds the
                                                   // computer system is below the
                                                   // EnterUtilizationPercent value
                                                   // before the idle power save is
                                                   // activated.
    RedfishCS_int64    *EnterUtilizationPercent;    // The percentage of utilization
                                                   // that the computer system shall
                                                   // be lower than to enter idle
                                                   // power save.
    RedfishCS_int64    *ExitDwellTimeSeconds;      // The duration in seconds the
                                                   // computer system is above the
                                                   // ExitUtilizationPercent value
                                                   // before the idle power save is
                                                   // stopped.
    RedfishCS_int64    *ExitUtilizationPercent;    // The percentage of utilization
                                                   // that the computer system shall
                                                   // be higher than to exit idle
                                                   // power save.
} RedfishComputerSystem_V1_17_0_IdlePowerSaver_CS;

//
// The KMIP server settings for a computer system.
//
typedef struct _RedfishComputerSystem_V1_17_0_KMIPServer_CS {
    RedfishCS_char     *Address;    // The KMIP server address.
    RedfishCS_char     *Password;    // The password to access the
                                    // KMIP server.  The value is
                                    // `null` in responses.
    RedfishCS_int64    *Port;       // The KMIP server port.
    RedfishCS_char     *Username;    // The username to access the
                                    // KMIP server.
} RedfishComputerSystem_V1_17_0_KMIPServer_CS;

//
// The key management settings of a computer system.
//
typedef struct _RedfishComputerSystem_V1_17_0_KeyManagement_CS {
    RedfishCS_Link                                       KMIPCertificates;    // The link to a collection of
                                                                             // server certificates for the
                                                                             // servers referenced by the
                                                                             // KMIPServers property.
    RedfishComputerSystem_V1_17_0_KMIPServer_Array_CS    *KMIPServers;       // The KMIP servers to which this
                                                                             // computer system is subscribed.
} RedfishComputerSystem_V1_17_0_KeyManagement_CS;

//
// The links to other resources that are related to this resource.
//
typedef struct _RedfishComputerSystem_V1_17_0_Links_CS {
    ...
    RedfishResource_Oem_CS           *Oem;                                          // The OEM extension property.
    RedfishCS_Link                   OffloadedNetworkDeviceFunctions;               // The network device functions
                                                                                    // to which this system performs
                                                                                    // offload computation, such as
                                                                                    // with a SmartNIC.
    RedfishCS_int64                  *OffloadedNetworkDeviceFunctionsodata_count;
...
} RedfishComputerSystem_V1_17_0_Links_CS;

//
// The memory of the system in general detail.
//
typedef struct _RedfishComputerSystem_V1_17_0_MemorySummary_CS {
    ...
    RedfishCS_int64              *TotalSystemPersistentMemoryGiB;    // The total configured, system-
                                                                    ...
                                                                    // measured in GiB.
} RedfishComputerSystem_V1_17_0_MemorySummary_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishComputerSystem_V1_17_0_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishComputerSystem_V1_17_0_OemActions_CS;

//
// The central processors of the system in general detail.
//
typedef struct _RedfishComputerSystem_V1_17_0_ProcessorSummary_CS {
    ...
    RedfishResource_Status_CS    *Status;                  // The status and health of the
                                                           // resource and its subordinate
                                                           // or dependent resources.
    RedfishCS_bool               *ThreadingEnabled;        // An indication of whether
                                                           // threading is enabled on all
                                                           // processors in this system.
} RedfishComputerSystem_V1_17_0_ProcessorSummary_CS;

//
// This action removes a resource block from a system.
//
typedef struct _RedfishComputerSystem_V1_17_0_RemoveResourceBlock_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishComputerSystem_V1_17_0_RemoveResourceBlock_CS;

//
// This action resets the system.
//
typedef struct _RedfishComputerSystem_V1_17_0_Reset_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishComputerSystem_V1_17_0_Reset_CS;

//
// The information about a serial console service that this system provides.
//
typedef struct _RedfishComputerSystem_V1_17_0_SerialConsoleProtocol_CS {
...
} RedfishComputerSystem_V1_17_0_SerialConsoleProtocol_CS;

//
// This action sets the BootOrder to the default settings.
//
typedef struct _RedfishComputerSystem_V1_17_0_SetDefaultBootOrder_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishComputerSystem_V1_17_0_SetDefaultBootOrder_CS;

//
// The Trusted Module installed in the system.
//
typedef struct _RedfishComputerSystem_V1_17_0_TrustedModules_CS {
    ...
    RedfishResource_Status_CS    *Status;                   // The status and health of the
                                                            // resource and its subordinate
                                                            // or dependent resources.
} RedfishComputerSystem_V1_17_0_TrustedModules_CS;

//
// The information about virtual media service for this system.
//
typedef struct _RedfishComputerSystem_V1_17_0_VirtualMediaConfig_CS {
    RedfishCS_int64    *Port;             // The protocol port.
    RedfishCS_bool     *ServiceEnabled;    // An indication of whether the
                                          // service is enabled for this
                                          // system.
} RedfishComputerSystem_V1_17_0_VirtualMediaConfig_CS;

//
// This type describes the host watchdog timer functionality for this system.
//
typedef struct _RedfishComputerSystem_V1_17_0_WatchdogTimer_CS {
    ...
    RedfishCS_char               *WarningAction;     // The action to perform when the
                                                     ...
                                                     // dependent on the
                                                     // implementation.
} RedfishComputerSystem_V1_17_0_WatchdogTimer_CS;
...
//
typedef struct _RedfishComputerSystem_V1_17_0_ComputerSystem_CS {
    RedfishCS_Header                                         Header;
    RedfishCS_char                                           *odata_context;          
    RedfishCS_char                                           *odata_etag;             
    RedfishCS_char                                           *odata_id;               
    RedfishCS_char                                           *odata_type;             
    RedfishComputerSystem_V1_17_0_Actions_CS                 *Actions;                    // The available actions for this
                                                                                          // resource.
    ...
    RedfishComputerSystem_V1_17_0_Boot_CS                    *Boot;                       // The boot settings for this
                                                                                          // system.
    RedfishComputerSystem_V1_17_0_BootProgress_CS            *BootProgress;               // This object describes the last
                                                                                          // boot progress state.
    RedfishCS_Link                                           Certificates;                // The link to a collection of
    ...
    RedfishCS_Link                                           FabricAdapters;              // The link to the collection of
                                                                                          ...
                                                                                          // with this system.
    RedfishComputerSystem_V1_17_0_HostGraphicalConsole_CS    *GraphicalConsole;           // The information about the
                                                                                          // graphical console (KVM-IP)
                                                                                          // service of this system.
    RedfishCS_Link                                           GraphicsControllers;         // The link to a collection of
                                                                                          // graphics controllers that can
                                                                                          // output video for this system.
    RedfishCS_char                                           *HostName;                   // The DNS host name, without any
                                                                                          // domain information.
    RedfishComputerSystem_V1_17_0_WatchdogTimer_CS           *HostWatchdogTimer;          // The host watchdog timer
                                                                                          // functionality for this system.
    RedfishComputerSystem_V1_17_0_HostedServices_CS          *HostedServices;             // The services that this
                                                                                          // computer system supports.
    RedfishCS_char_Array                                     *HostingRoles;               // The hosting roles that this
                                                                                          // computer system supports.
    RedfishCS_char                                           *Id;                     
    RedfishComputerSystem_V1_17_0_IdlePowerSaver_CS          *IdlePowerSaver;             // The idle power saver settings
                                                                                          // of the computer system.
    RedfishCS_char                                           *IndicatorLED;               // The state of the indicator
                                                                                          // LED, which identifies the
                                                                                          // system.
    RedfishComputerSystem_V1_17_0_KeyManagement_CS           *KeyManagement;              // The key management settings of
                                                                                          // the computer system.
    RedfishCS_char                                           *LastResetTime;              // The date and time when the
                                                                                          // system was last reset or
                                                                                          // rebooted.
    RedfishComputerSystem_V1_17_0_Links_CS                   *Links;                      // The links to other resources
    ...
    RedfishCS_Link                                           MemoryDomains;               // The link to the collection of
                                                                                          ...
                                                                                          // this system.
    RedfishComputerSystem_V1_17_0_MemorySummary_CS           *MemorySummary;              // The central memory of the
    ...
    RedfishCS_int64                                          *PowerCycleDelaySeconds;     // The number of seconds to delay
                                                                                          ...
                                                                                          // indicates no delay.
    RedfishCS_char                                           *PowerMode;                  // The power mode setting of the
                                                                                          // computer system.
    ...
    RedfishCS_char                                           *PowerState;                 // The current power state of the
                                                                                          // system.
    RedfishComputerSystem_V1_17_0_ProcessorSummary_CS        *ProcessorSummary;           // The central processors of the
                                                                                          // system in general detail.
    ...
    RedfishCS_Link                                           SecureBoot;                  // The link to the UEFI Secure
                                                                                          ...
                                                                                          // system.
    RedfishComputerSystem_V1_17_0_HostSerialConsole_CS       *SerialConsole;              // The serial console services
    ...
    RedfishComputerSystem_V1_17_0_TrustedModules_Array_CS    *TrustedModules;             // An array of trusted modules in
                                                                                          // the system.
    RedfishCS_Link                                           USBControllers;              // The link to a collection of
                                                                                          // USB controllers for this
                                                                                          // system.
    ...
    RedfishComputerSystem_V1_17_0_VirtualMediaConfig_CS      *VirtualMediaConfig;         // The information about the
                                                                                          // virtual media service of this
                                                                                          // system.
} RedfishComputerSystem_V1_17_0_ComputerSystem_CS;

typedef struct _RedfishComputerSystem_V1_17_0_KMIPServer_Array_CS  {
    RedfishComputerSystem_V1_17_0_KMIPServer_Array_CS    *Next;
    RedfishComputerSystem_V1_17_0_KMIPServer_CS    *ArrayValue;
} RedfishComputerSystem_V1_17_0_KMIPServer_Array_CS;
...
typedef struct _RedfishComputerSystem_V1_17_0_TrustedModules_Array_CS  {
    RedfishComputerSystem_V1_17_0_TrustedModules_Array_CS    *Next;
    RedfishComputerSystem_V1_17_0_TrustedModules_CS    *ArrayValue;
} RedfishComputerSystem_V1_17_0_TrustedModules_Array_CS;
...
RedfishCS_status
Json_ComputerSystem_V1_17_0_To_CS (char *JsonRawText, RedfishComputerSystem_V1_17_0_ComputerSystem_CS **ReturnedCS);

RedfishCS_status
CS_To_ComputerSystem_V1_17_0_JSON (RedfishComputerSystem_V1_17_0_ComputerSystem_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyComputerSystem_V1_17_0_CS (RedfishComputerSystem_V1_17_0_ComputerSystem_CS *CSPtr);

RedfishCS_status
DestroyComputerSystem_V1_17_0_Json (RedfishCS_char *JsonText);
