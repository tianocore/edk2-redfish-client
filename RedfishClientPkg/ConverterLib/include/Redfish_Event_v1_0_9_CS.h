...
#ifndef RedfishEvent_V1_0_9_CSTRUCT_H_
#define RedfishEvent_V1_0_9_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishEvent_V1_0_9_EventRecord_Array_CS RedfishEvent_V1_0_9_EventRecord_Array_CS;
typedef struct _RedfishEvent_V1_0_9_Event_CS RedfishEvent_V1_0_9_Event_CS;
typedef struct _RedfishEvent_V1_0_9_EventRecord_CS RedfishEvent_V1_0_9_EventRecord_CS;
...
typedef struct _RedfishEvent_V1_0_9_EventRecord_CS {
    ...
    RedfishCS_char             *Severity;            // This is the severity of the
                                                     // event.
} RedfishEvent_V1_0_9_EventRecord_CS;
...
//
typedef struct _RedfishEvent_V1_0_9_Event_CS {
    RedfishCS_Header                            Header;
    RedfishCS_char                              *odata_context;   
    RedfishCS_char                              *odata_type;      
    RedfishCS_char                              *Description;     
    RedfishEvent_V1_0_9_EventRecord_Array_CS    *Events;              // Each event in this array has a
    ...
    RedfishResource_Oem_CS                      *Oem;                 // This is the
                                                                      ...
                                                                      // divide the Oem object into
                                                                      // sections.
} RedfishEvent_V1_0_9_Event_CS;

typedef struct _RedfishEvent_V1_0_9_EventRecord_Array_CS  {
    RedfishEvent_V1_0_9_EventRecord_Array_CS    *Next;
    RedfishEvent_V1_0_9_EventRecord_CS    *ArrayValue;
} RedfishEvent_V1_0_9_EventRecord_Array_CS;

RedfishCS_status
Json_Event_V1_0_9_To_CS (char *JsonRawText, RedfishEvent_V1_0_9_Event_CS **ReturnedCS);

RedfishCS_status
CS_To_Event_V1_0_9_JSON (RedfishEvent_V1_0_9_Event_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEvent_V1_0_9_CS (RedfishEvent_V1_0_9_Event_CS *CSPtr);

RedfishCS_status
DestroyEvent_V1_0_9_Json (RedfishCS_char *JsonText);
