...
#ifndef RedfishActioninfo_V1_1_1_CSTRUCT_H_
#define RedfishActioninfo_V1_1_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishActionInfo_V1_1_1_Parameters_Array_CS RedfishActionInfo_V1_1_1_Parameters_Array_CS;
typedef struct _RedfishActionInfo_V1_1_1_ActionInfo_CS RedfishActionInfo_V1_1_1_ActionInfo_CS;
typedef struct _RedfishActionInfo_V1_1_1_Parameters_CS RedfishActionInfo_V1_1_1_Parameters_CS;
...
typedef struct _RedfishActionInfo_V1_1_1_ActionInfo_CS {
    ...
    RedfishResource_Oem_CS                          *Oem;             // This is the
                                                                      ...
                                                                      // sections.
    RedfishActionInfo_V1_1_1_Parameters_Array_CS    *Parameters;      // The parameters associated with
                                                                      // the specified Redfish Action.
} RedfishActionInfo_V1_1_1_ActionInfo_CS;

typedef struct _RedfishActionInfo_V1_1_1_Parameters_Array_CS  {
    RedfishActionInfo_V1_1_1_Parameters_Array_CS    *Next;
    RedfishActionInfo_V1_1_1_Parameters_CS    *ArrayValue;
} RedfishActionInfo_V1_1_1_Parameters_Array_CS;

RedfishCS_status
Json_ActionInfo_V1_1_1_To_CS (char *JsonRawText, RedfishActionInfo_V1_1_1_ActionInfo_CS **ReturnedCS);

RedfishCS_status
CS_To_ActionInfo_V1_1_1_JSON (RedfishActionInfo_V1_1_1_ActionInfo_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyActionInfo_V1_1_1_CS (RedfishActionInfo_V1_1_1_ActionInfo_CS *CSPtr);

RedfishCS_status
DestroyActionInfo_V1_1_1_Json (RedfishCS_char *JsonText);
