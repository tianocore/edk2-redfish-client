...
#ifndef RedfishFan_V1_0_1_CSTRUCT_H_
#define RedfishFan_V1_0_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishFan_V1_0_1_Actions_CS RedfishFan_V1_0_1_Actions_CS;
typedef struct _RedfishFan_V1_0_1_Fan_CS RedfishFan_V1_0_1_Fan_CS;
typedef struct _RedfishFan_V1_0_1_OemActions_CS RedfishFan_V1_0_1_OemActions_CS;
...
//
typedef struct _RedfishFan_V1_0_1_Actions_CS {
    RedfishFan_V1_0_1_OemActions_CS    *Oem;    // The available OEM-specific
                                               // actions for this resource.
} RedfishFan_V1_0_1_Actions_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishFan_V1_0_1_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishFan_V1_0_1_OemActions_CS;
...
//
typedef struct _RedfishFan_V1_0_1_Fan_CS {
    RedfishCS_Header                Header;
    RedfishCS_char                  *odata_context;         
    RedfishCS_char                  *odata_etag;            
    RedfishCS_char                  *odata_id;              
    RedfishCS_char                  *odata_type;            
    RedfishFan_V1_0_1_Actions_CS    *Actions;                   // The available actions for this
                                                                // resource.
...
RedfishCS_status
Json_Fan_V1_0_1_To_CS (char *JsonRawText, RedfishFan_V1_0_1_Fan_CS **ReturnedCS);

RedfishCS_status
CS_To_Fan_V1_0_1_JSON (RedfishFan_V1_0_1_Fan_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyFan_V1_0_1_CS (RedfishFan_V1_0_1_Fan_CS *CSPtr);

RedfishCS_status
DestroyFan_V1_0_1_Json (RedfishCS_char *JsonText);
