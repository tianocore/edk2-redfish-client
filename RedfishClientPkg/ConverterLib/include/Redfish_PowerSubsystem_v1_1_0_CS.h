...
#ifndef RedfishPowersubsystem_V1_1_0_CSTRUCT_H_
#define RedfishPowersubsystem_V1_1_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishPowerSubsystem_V1_1_0_Actions_CS RedfishPowerSubsystem_V1_1_0_Actions_CS;
typedef struct _RedfishPowerSubsystem_V1_1_0_OemActions_CS RedfishPowerSubsystem_V1_1_0_OemActions_CS;
typedef struct _RedfishPowerSubsystem_V1_1_0_PowerAllocation_CS RedfishPowerSubsystem_V1_1_0_PowerAllocation_CS;
typedef struct _RedfishPowerSubsystem_V1_1_0_PowerSubsystem_CS RedfishPowerSubsystem_V1_1_0_PowerSubsystem_CS;
...
typedef struct _RedfishPowerSubsystem_V1_1_0_Actions_CS {
    RedfishPowerSubsystem_V1_1_0_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishPowerSubsystem_V1_1_0_PowerSubsystem_CS {
    ...
    RedfishPowerSubsystem_V1_1_0_Actions_CS            *Actions;                // The available actions for this
                                                                                // resource.
    RedfishPowerSubsystem_V1_1_0_PowerAllocation_CS    *Allocation;             // Power allocation for this
                                                                                // subsystem.
    RedfishCS_Link                                     Batteries;               // The link to the collection of
                                                                                // batteries within this
                                                                                // subsystem.
...
RedfishCS_status
Json_PowerSubsystem_V1_1_0_To_CS (char *JsonRawText, RedfishPowerSubsystem_V1_1_0_PowerSubsystem_CS **ReturnedCS);

RedfishCS_status
CS_To_PowerSubsystem_V1_1_0_JSON (RedfishPowerSubsystem_V1_1_0_PowerSubsystem_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPowerSubsystem_V1_1_0_CS (RedfishPowerSubsystem_V1_1_0_PowerSubsystem_CS *CSPtr);

RedfishCS_status
DestroyPowerSubsystem_V1_1_0_Json (RedfishCS_char *JsonText);
