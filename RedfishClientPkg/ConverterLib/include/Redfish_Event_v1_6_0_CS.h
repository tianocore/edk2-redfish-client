...
#ifndef RedfishEvent_V1_6_0_CSTRUCT_H_
#define RedfishEvent_V1_6_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishEvent_V1_6_0_EventRecord_Array_CS RedfishEvent_V1_6_0_EventRecord_Array_CS;
typedef struct _RedfishEvent_V1_6_0_Actions_CS RedfishEvent_V1_6_0_Actions_CS;
typedef struct _RedfishEvent_V1_6_0_Event_CS RedfishEvent_V1_6_0_Event_CS;
typedef struct _RedfishEvent_V1_6_0_EventRecord_CS RedfishEvent_V1_6_0_EventRecord_CS;
typedef struct _RedfishEvent_V1_6_0_EventRecordActions_CS RedfishEvent_V1_6_0_EventRecordActions_CS;
typedef struct _RedfishEvent_V1_6_0_EventRecordOemActions_CS RedfishEvent_V1_6_0_EventRecordOemActions_CS;
typedef struct _RedfishEvent_V1_6_0_OemActions_CS RedfishEvent_V1_6_0_OemActions_CS;
...
typedef struct _RedfishEvent_V1_6_0_Actions_CS {
    RedfishEvent_V1_6_0_OemActions_CS    *Oem;    // The available OEM-specific
                                                 // actions for this resource.
} RedfishEvent_V1_6_0_Actions_CS;

typedef struct _RedfishEvent_V1_6_0_EventRecord_CS {
    RedfishEvent_V1_6_0_EventRecordActions_CS    *Actions;                      // The available actions for this
                                                                                // resource.
...
typedef struct _RedfishEvent_V1_6_0_EventRecordActions_CS {
    RedfishEvent_V1_6_0_EventRecordOemActions_CS    *Oem;    // The available OEM-specific
                                                            // actions for this resource.
...
typedef struct _RedfishEvent_V1_6_0_Event_CS {
    ...
    RedfishEvent_V1_6_0_Actions_CS              *Actions;             // The available actions for this
                                                                      // resource.
    RedfishCS_char                              *Context;             // A context can be supplied at
                                                                      // subscription time.  This
                                                                      // property is the context value
    ...
    RedfishEvent_V1_6_0_EventRecord_Array_CS    *Events;              // Each event in this array has a
...
typedef struct _RedfishEvent_V1_6_0_EventRecord_Array_CS  {
    RedfishEvent_V1_6_0_EventRecord_Array_CS    *Next;
    RedfishEvent_V1_6_0_EventRecord_CS    *ArrayValue;
} RedfishEvent_V1_6_0_EventRecord_Array_CS;

RedfishCS_status
Json_Event_V1_6_0_To_CS (char *JsonRawText, RedfishEvent_V1_6_0_Event_CS **ReturnedCS);

RedfishCS_status
CS_To_Event_V1_6_0_JSON (RedfishEvent_V1_6_0_Event_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEvent_V1_6_0_CS (RedfishEvent_V1_6_0_Event_CS *CSPtr);

RedfishCS_status
DestroyEvent_V1_6_0_Json (RedfishCS_char *JsonText);
