...
#ifndef RedfishZone_V1_1_3_CSTRUCT_H_
#define RedfishZone_V1_1_3_CSTRUCT_H_
...
typedef struct _RedfishZone_V1_1_3_Actions_CS RedfishZone_V1_1_3_Actions_CS;
typedef struct _RedfishZone_V1_1_3_Links_CS RedfishZone_V1_1_3_Links_CS;
typedef struct _RedfishZone_V1_1_3_OemActions_CS RedfishZone_V1_1_3_OemActions_CS;
typedef struct _RedfishZone_V1_1_3_Zone_CS RedfishZone_V1_1_3_Zone_CS;
...
typedef struct _RedfishZone_V1_1_3_Actions_CS {
    RedfishZone_V1_1_3_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishZone_V1_1_3_Zone_CS {
    ...
    RedfishZone_V1_1_3_Actions_CS    *Actions;         // The available actions for this
                                                       // resource.
    RedfishCS_char                   *Description; 
    RedfishCS_char                   *Id;          
    RedfishZone_V1_1_3_Links_CS      *Links;           // Contains references to other
...
RedfishCS_status
Json_Zone_V1_1_3_To_CS (char *JsonRawText, RedfishZone_V1_1_3_Zone_CS **ReturnedCS);

RedfishCS_status
CS_To_Zone_V1_1_3_JSON (RedfishZone_V1_1_3_Zone_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyZone_V1_1_3_CS (RedfishZone_V1_1_3_Zone_CS *CSPtr);

RedfishCS_status
DestroyZone_V1_1_3_Json (RedfishCS_char *JsonText);
