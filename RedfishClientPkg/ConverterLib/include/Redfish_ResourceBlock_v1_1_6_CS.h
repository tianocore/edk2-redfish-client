...
#ifndef RedfishResourceblock_V1_1_6_CSTRUCT_H_
#define RedfishResourceblock_V1_1_6_CSTRUCT_H_
...
typedef struct _RedfishResourceBlock_V1_1_6_Actions_CS RedfishResourceBlock_V1_1_6_Actions_CS;
typedef struct _RedfishResourceBlock_V1_1_6_CompositionStatus_CS RedfishResourceBlock_V1_1_6_CompositionStatus_CS;
typedef struct _RedfishResourceBlock_V1_1_6_Links_CS RedfishResourceBlock_V1_1_6_Links_CS;
typedef struct _RedfishResourceBlock_V1_1_6_OemActions_CS RedfishResourceBlock_V1_1_6_OemActions_CS;
typedef struct _RedfishResourceBlock_V1_1_6_ResourceBlock_CS RedfishResourceBlock_V1_1_6_ResourceBlock_CS;
...
typedef struct _RedfishResourceBlock_V1_1_6_Actions_CS {
    RedfishResourceBlock_V1_1_6_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishResourceBlock_V1_1_6_ResourceBlock_CS {
    ...
    RedfishResourceBlock_V1_1_6_Actions_CS              *Actions;                         // The available actions for this
                                                                                          // resource.
    RedfishResourceBlock_V1_1_6_CompositionStatus_CS    *CompositionStatus;               // The composition status details
    ...
    RedfishCS_char                                      *Id;                          
    RedfishResourceBlock_V1_1_6_Links_CS                *Links;                           // The links to other resources
...
RedfishCS_status
Json_ResourceBlock_V1_1_6_To_CS (char *JsonRawText, RedfishResourceBlock_V1_1_6_ResourceBlock_CS **ReturnedCS);

RedfishCS_status
CS_To_ResourceBlock_V1_1_6_JSON (RedfishResourceBlock_V1_1_6_ResourceBlock_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyResourceBlock_V1_1_6_CS (RedfishResourceBlock_V1_1_6_ResourceBlock_CS *CSPtr);

RedfishCS_status
DestroyResourceBlock_V1_1_6_Json (RedfishCS_char *JsonText);
