...
#ifndef RedfishServiceroot_V1_12_0_CSTRUCT_H_
#define RedfishServiceroot_V1_12_0_CSTRUCT_H_
...
typedef struct _RedfishServiceRoot_V1_12_0_DeepOperations_CS RedfishServiceRoot_V1_12_0_DeepOperations_CS;
typedef struct _RedfishServiceRoot_V1_12_0_Expand_CS RedfishServiceRoot_V1_12_0_Expand_CS;
typedef struct _RedfishServiceRoot_V1_12_0_Links_CS RedfishServiceRoot_V1_12_0_Links_CS;
typedef struct _RedfishServiceRoot_V1_12_0_ProtocolFeaturesSupported_CS RedfishServiceRoot_V1_12_0_ProtocolFeaturesSupported_CS;
typedef struct _RedfishServiceRoot_V1_12_0_ServiceRoot_CS RedfishServiceRoot_V1_12_0_ServiceRoot_CS;
//
// The OEM extension.
//
#ifndef RedfishResource_Oem_CS_
...
typedef struct _RedfishServiceRoot_V1_12_0_ProtocolFeaturesSupported_CS {
    RedfishServiceRoot_V1_12_0_DeepOperations_CS    *DeepOperations;    // The information about deep
                                                                        // operations that the service
                                                                        // supports.
    RedfishCS_bool                                  *ExcerptQuery;      // An indication of whether the
                                                                        // service supports the excerpt
                                                                        // query parameter.
    RedfishServiceRoot_V1_12_0_Expand_CS            *ExpandQuery;       // The information about the use
...
typedef struct _RedfishServiceRoot_V1_12_0_ServiceRoot_CS {
    ...
    RedfishCS_Link                                             LicenseService;               // The link to the license
                                                                                             // service.
    RedfishServiceRoot_V1_12_0_Links_CS                        *Links;                       // The links to other Resources
    ...
    RedfishServiceRoot_V1_12_0_ProtocolFeaturesSupported_CS    *ProtocolFeaturesSupported;    // The information about protocol
    ...
    RedfishCS_char                                             *Vendor;                      // The vendor or manufacturer
                                                                                             ...
                                                                                             // Service.
} RedfishServiceRoot_V1_12_0_ServiceRoot_CS;

RedfishCS_status
Json_ServiceRoot_V1_12_0_To_CS (char *JsonRawText, RedfishServiceRoot_V1_12_0_ServiceRoot_CS **ReturnedCS);

RedfishCS_status
CS_To_ServiceRoot_V1_12_0_JSON (RedfishServiceRoot_V1_12_0_ServiceRoot_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyServiceRoot_V1_12_0_CS (RedfishServiceRoot_V1_12_0_ServiceRoot_CS *CSPtr);

RedfishCS_status
DestroyServiceRoot_V1_12_0_Json (RedfishCS_char *JsonText);
