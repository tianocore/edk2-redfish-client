...
#ifndef RedfishServiceroot_V1_3_4_CSTRUCT_H_
#define RedfishServiceroot_V1_3_4_CSTRUCT_H_
...
typedef struct _RedfishServiceRoot_V1_3_4_Expand_CS RedfishServiceRoot_V1_3_4_Expand_CS;
typedef struct _RedfishServiceRoot_V1_3_4_Links_CS RedfishServiceRoot_V1_3_4_Links_CS;
typedef struct _RedfishServiceRoot_V1_3_4_ProtocolFeaturesSupported_CS RedfishServiceRoot_V1_3_4_ProtocolFeaturesSupported_CS;
typedef struct _RedfishServiceRoot_V1_3_4_ServiceRoot_CS RedfishServiceRoot_V1_3_4_ServiceRoot_CS;
//
// The OEM extension.
//
#ifndef RedfishResource_Oem_CS_
...
//
typedef struct _RedfishServiceRoot_V1_3_4_Expand_CS {
    ...
    RedfishCS_bool     *NoLinks;     // This indicates whether the
                                     ...
                                     // supported.
} RedfishServiceRoot_V1_3_4_Expand_CS;

//
// Contains references to other resources that are related to this resource.
//
typedef struct _RedfishServiceRoot_V1_3_4_Links_CS {
    RedfishResource_Oem_CS    *Oem;       // Oem extension object.
    RedfishCS_Link            Sessions;    // Link to a collection of
                                          // Sessions.
} RedfishServiceRoot_V1_3_4_Links_CS;

//
// Contains information about protocol features supported by the service.
//
typedef struct _RedfishServiceRoot_V1_3_4_ProtocolFeaturesSupported_CS {
    RedfishServiceRoot_V1_3_4_Expand_CS    *ExpandQuery;    // Contains information about the
    ...
    RedfishCS_bool                         *SelectQuery;    // This indicates whether the
                                                           ...
                                                           // supported.
} RedfishServiceRoot_V1_3_4_ProtocolFeaturesSupported_CS;

//
// This object represents the root Redfish service.
//
typedef struct _RedfishServiceRoot_V1_3_4_ServiceRoot_CS {
    ...
    RedfishServiceRoot_V1_3_4_Links_CS                        *Links;                       // Contains references to other
    ...
    RedfishServiceRoot_V1_3_4_ProtocolFeaturesSupported_CS    *ProtocolFeaturesSupported;    // Contains information about
    ...
    RedfishCS_Link                                            UpdateService;                // This is a link to the
                                                                                            // UpdateService.
} RedfishServiceRoot_V1_3_4_ServiceRoot_CS;

RedfishCS_status
Json_ServiceRoot_V1_3_4_To_CS (char *JsonRawText, RedfishServiceRoot_V1_3_4_ServiceRoot_CS **ReturnedCS);

RedfishCS_status
CS_To_ServiceRoot_V1_3_4_JSON (RedfishServiceRoot_V1_3_4_ServiceRoot_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyServiceRoot_V1_3_4_CS (RedfishServiceRoot_V1_3_4_ServiceRoot_CS *CSPtr);

RedfishCS_status
DestroyServiceRoot_V1_3_4_Json (RedfishCS_char *JsonText);
