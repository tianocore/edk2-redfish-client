...
#ifndef RedfishProcessor_V1_0_12_CSTRUCT_H_
#define RedfishProcessor_V1_0_12_CSTRUCT_H_
...
#endif
typedef struct _RedfishProcessor_V1_0_12_Processor_CS RedfishProcessor_V1_0_12_Processor_CS;
typedef struct _RedfishProcessor_V1_0_12_ProcessorId_CS RedfishProcessor_V1_0_12_ProcessorId_CS;
...
//
typedef struct _RedfishProcessor_V1_0_12_ProcessorId_CS {
    ...
    RedfishCS_char    *VendorId;                  // The vendor identification for
                                                  // this processor.
} RedfishProcessor_V1_0_12_ProcessorId_CS;
...
//
typedef struct _RedfishProcessor_V1_0_12_Processor_CS {
    ...
    RedfishCS_char                             *ProcessorArchitecture;    // The architecture of the
                                                                         // processor.
    RedfishProcessor_V1_0_12_ProcessorId_CS    *ProcessorId;             // The identification information
                                                                         // for this processor.
    ...
    RedfishCS_int64                            *TotalThreads;            // The total number of execution
                                                                         ...
                                                                         // supports.
} RedfishProcessor_V1_0_12_Processor_CS;
...
RedfishCS_status
Json_Processor_V1_0_12_To_CS (char *JsonRawText, RedfishProcessor_V1_0_12_Processor_CS **ReturnedCS);

RedfishCS_status
CS_To_Processor_V1_0_12_JSON (RedfishProcessor_V1_0_12_Processor_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyProcessor_V1_0_12_CS (RedfishProcessor_V1_0_12_Processor_CS *CSPtr);

RedfishCS_status
DestroyProcessor_V1_0_12_Json (RedfishCS_char *JsonText);
