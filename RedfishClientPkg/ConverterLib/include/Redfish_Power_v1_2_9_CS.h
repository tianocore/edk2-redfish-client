...
#ifndef RedfishPower_V1_2_9_CSTRUCT_H_
#define RedfishPower_V1_2_9_CSTRUCT_H_
...
#endif
typedef struct _RedfishPower_V1_2_9_InputRange_Array_CS RedfishPower_V1_2_9_InputRange_Array_CS;
typedef struct _RedfishPower_V1_2_9_PowerControl_Array_CS RedfishPower_V1_2_9_PowerControl_Array_CS;
typedef struct _RedfishPower_V1_2_9_PowerSupply_Array_CS RedfishPower_V1_2_9_PowerSupply_Array_CS;
typedef struct _RedfishPower_V1_2_9_Voltage_Array_CS RedfishPower_V1_2_9_Voltage_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishPower_V1_2_9_InputRange_CS RedfishPower_V1_2_9_InputRange_CS;
typedef struct _RedfishPower_V1_2_9_Power_CS RedfishPower_V1_2_9_Power_CS;
typedef struct _RedfishPower_V1_2_9_PowerControl_CS RedfishPower_V1_2_9_PowerControl_CS;
typedef struct _RedfishPower_V1_2_9_PowerLimit_CS RedfishPower_V1_2_9_PowerLimit_CS;
typedef struct _RedfishPower_V1_2_9_PowerMetric_CS RedfishPower_V1_2_9_PowerMetric_CS;
typedef struct _RedfishPower_V1_2_9_PowerSupply_CS RedfishPower_V1_2_9_PowerSupply_CS;
typedef struct _RedfishPower_V1_2_9_Voltage_CS RedfishPower_V1_2_9_Voltage_CS;
...
//
typedef struct _RedfishPower_V1_2_9_InputRange_CS {
    ...
    RedfishCS_int64           *OutputWattage;        // The maximum capacity of this
                                                     ...
                                                     // this input range.
} RedfishPower_V1_2_9_InputRange_CS;

typedef struct _RedfishPower_V1_2_9_PowerControl_CS {
    ...
    RedfishPower_V1_2_9_PowerLimit_CS     *PowerLimit;               // The power limit status and
                                                                     // configuration information for
                                                                     // this chassis.
    RedfishPower_V1_2_9_PowerMetric_CS    *PowerMetrics;             // The power readings for this
                                                                     // chassis.
...
} RedfishPower_V1_2_9_PowerControl_CS;

//
// The power limit status and configuration information for the chassis.
//
typedef struct _RedfishPower_V1_2_9_PowerLimit_CS {
    ...
    RedfishCS_int64    *LimitInWatts;     // The power limit, in watts.  If
                                          ...
                                          // disabled.
} RedfishPower_V1_2_9_PowerLimit_CS;

//
// The power metrics for a resource.
//
typedef struct _RedfishPower_V1_2_9_PowerMetric_CS {
    ...
    RedfishCS_int64    *MinConsumedWatts;       // The lowest power consumption
                                                ...
                                                // IntervalInMin minutes.
} RedfishPower_V1_2_9_PowerMetric_CS;

//
// Details of a power supplies associated with this system or device.
//
typedef struct _RedfishPower_V1_2_9_PowerSupply_CS {
    RedfishCS_char                             *odata_id;             
    ...
    RedfishCS_char                             *IndicatorLED;             // The state of The indicator
                                                                          ...
                                                                          // power supply.
    RedfishPower_V1_2_9_InputRange_Array_CS    *InputRanges;              // The input ranges that the
    ...
    RedfishResource_Status_CS                  *Status;                   // The status and health of the
                                                                          // resource and its subordinate
                                                                          // or dependent resources.
} RedfishPower_V1_2_9_PowerSupply_CS;

typedef struct _RedfishPower_V1_2_9_Voltage_CS {
    RedfishCS_char                   *odata_id;                
...
} RedfishPower_V1_2_9_Voltage_CS;
...
//
typedef struct _RedfishPower_V1_2_9_Power_CS {
    ...
    RedfishCS_char                               *Name;                   
    RedfishResource_Oem_CS                       *Oem;                        // The OEM extension property.
    RedfishPower_V1_2_9_PowerControl_Array_CS    *PowerControl;               // The set of power control
                                                                              // functions, including power
                                                                              // reading and limiting.
    RedfishCS_int64                              *PowerControlodata_count;
    RedfishPower_V1_2_9_PowerSupply_Array_CS     *PowerSupplies;              // The set of power supplies
    ...
    RedfishCS_Link                               Redundancy;                  // The redundancy information for
                                                                              ...
                                                                              // this chassis.
    RedfishCS_int64                              *Redundancyodata_count;  
    RedfishPower_V1_2_9_Voltage_Array_CS         *Voltages;                   // The set of voltage sensors for
                                                                              // this chassis.
    RedfishCS_int64                              *Voltagesodata_count;    
} RedfishPower_V1_2_9_Power_CS;
...
typedef struct _RedfishPower_V1_2_9_InputRange_Array_CS  {
    RedfishPower_V1_2_9_InputRange_Array_CS    *Next;
    RedfishPower_V1_2_9_InputRange_CS    *ArrayValue;
} RedfishPower_V1_2_9_InputRange_Array_CS;

typedef struct _RedfishPower_V1_2_9_PowerControl_Array_CS  {
    RedfishPower_V1_2_9_PowerControl_Array_CS    *Next;
    RedfishPower_V1_2_9_PowerControl_CS    *ArrayValue;
} RedfishPower_V1_2_9_PowerControl_Array_CS;

typedef struct _RedfishPower_V1_2_9_PowerSupply_Array_CS  {
    RedfishPower_V1_2_9_PowerSupply_Array_CS    *Next;
    RedfishPower_V1_2_9_PowerSupply_CS    *ArrayValue;
} RedfishPower_V1_2_9_PowerSupply_Array_CS;

typedef struct _RedfishPower_V1_2_9_Voltage_Array_CS  {
    RedfishPower_V1_2_9_Voltage_Array_CS    *Next;
    RedfishPower_V1_2_9_Voltage_CS    *ArrayValue;
} RedfishPower_V1_2_9_Voltage_Array_CS;
...
RedfishCS_status
Json_Power_V1_2_9_To_CS (char *JsonRawText, RedfishPower_V1_2_9_Power_CS **ReturnedCS);

RedfishCS_status
CS_To_Power_V1_2_9_JSON (RedfishPower_V1_2_9_Power_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPower_V1_2_9_CS (RedfishPower_V1_2_9_Power_CS *CSPtr);

RedfishCS_status
DestroyPower_V1_2_9_Json (RedfishCS_char *JsonText);
