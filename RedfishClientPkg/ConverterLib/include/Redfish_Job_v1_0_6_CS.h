...
#ifndef RedfishJob_V1_0_6_CSTRUCT_H_
#define RedfishJob_V1_0_6_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishJob_V1_0_6_Actions_CS RedfishJob_V1_0_6_Actions_CS;
typedef struct _RedfishJob_V1_0_6_Job_CS RedfishJob_V1_0_6_Job_CS;
typedef struct _RedfishJob_V1_0_6_OemActions_CS RedfishJob_V1_0_6_OemActions_CS;
typedef struct _RedfishJob_V1_0_6_Payload_CS RedfishJob_V1_0_6_Payload_CS;
...
//
typedef struct _RedfishJob_V1_0_6_Actions_CS {
    RedfishJob_V1_0_6_OemActions_CS    *Oem;    // The available OEM-specific
                                               // actions for this resource.
} RedfishJob_V1_0_6_Actions_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishJob_V1_0_6_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishJob_V1_0_6_OemActions_CS;

//
// The HTTP and JSON payload details for this job.
//
typedef struct _RedfishJob_V1_0_6_Payload_CS {
...
//
typedef struct _RedfishJob_V1_0_6_Job_CS {
    RedfishCS_Header                Header;
    RedfishCS_char                  *odata_context;  
    RedfishCS_char                  *odata_etag;     
    RedfishCS_char                  *odata_id;       
    RedfishCS_char                  *odata_type;     
    RedfishJob_V1_0_6_Actions_CS    *Actions;            // The available actions for this
                                                         // resource.
    ...
    RedfishJob_V1_0_6_Payload_CS    *Payload;            // The HTTP and JSON payload
    ...
    RedfishCS_Link                  Steps;               // The link to a collection of
                                                         // steps for this job.
} RedfishJob_V1_0_6_Job_CS;

RedfishCS_status
Json_Job_V1_0_6_To_CS (char *JsonRawText, RedfishJob_V1_0_6_Job_CS **ReturnedCS);

RedfishCS_status
CS_To_Job_V1_0_6_JSON (RedfishJob_V1_0_6_Job_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyJob_V1_0_6_CS (RedfishJob_V1_0_6_Job_CS *CSPtr);
