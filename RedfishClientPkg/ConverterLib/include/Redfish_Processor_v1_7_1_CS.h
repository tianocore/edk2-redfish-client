...
#ifndef RedfishProcessor_V1_7_1_CSTRUCT_H_
#define RedfishProcessor_V1_7_1_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishProcessor_V1_7_1_ProcessorInterface_Array_CS RedfishProcessor_V1_7_1_ProcessorInterface_Array_CS;
typedef struct _RedfishProcessor_V1_7_1_FpgaReconfigurationSlot_Array_CS RedfishProcessor_V1_7_1_FpgaReconfigurationSlot_Array_CS;
typedef struct _RedfishProcessor_V1_7_1_ProcessorMemory_Array_CS RedfishProcessor_V1_7_1_ProcessorMemory_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishProcessor_V1_7_1_Actions_CS RedfishProcessor_V1_7_1_Actions_CS;
typedef struct _RedfishProcessor_V1_7_1_EthernetInterface_CS RedfishProcessor_V1_7_1_EthernetInterface_CS;
typedef struct _RedfishProcessor_V1_7_1_FPGA_CS RedfishProcessor_V1_7_1_FPGA_CS;
typedef struct _RedfishProcessor_V1_7_1_FpgaReconfigurationSlot_CS RedfishProcessor_V1_7_1_FpgaReconfigurationSlot_CS;
typedef struct _RedfishProcessor_V1_7_1_Links_CS RedfishProcessor_V1_7_1_Links_CS;
typedef struct _RedfishProcessor_V1_7_1_OemActions_CS RedfishProcessor_V1_7_1_OemActions_CS;
typedef struct _RedfishProcessor_V1_7_1_Processor_CS RedfishProcessor_V1_7_1_Processor_CS;
typedef struct _RedfishProcessor_V1_7_1_ProcessorId_CS RedfishProcessor_V1_7_1_ProcessorId_CS;
typedef struct _RedfishProcessor_V1_7_1_ProcessorInterface_CS RedfishProcessor_V1_7_1_ProcessorInterface_CS;
typedef struct _RedfishProcessor_V1_7_1_ProcessorMemory_CS RedfishProcessor_V1_7_1_ProcessorMemory_CS;
typedef struct _RedfishProcessor_V1_7_1_Reset_CS RedfishProcessor_V1_7_1_Reset_CS;
...
typedef struct _RedfishProcessor_V1_7_1_Actions_CS {
    ...
    RedfishProcessor_V1_7_1_OemActions_CS    *Oem;               // The available OEM-specific
...
typedef struct _RedfishProcessor_V1_7_1_FPGA_CS {
    RedfishProcessor_V1_7_1_ProcessorInterface_Array_CS         *ExternalInterfaces;     // An array of the FPGA external
                                                                                         // interfaces.
    ...
    RedfishProcessor_V1_7_1_ProcessorInterface_CS               *HostInterface;          // The FPGA interface to the
                                                                                         // host.
    ...
    RedfishProcessor_V1_7_1_FpgaReconfigurationSlot_Array_CS    *ReconfigurationSlots;    // An array of the FPGA
...
typedef struct _RedfishProcessor_V1_7_1_ProcessorInterface_CS {
    RedfishProcessor_V1_7_1_EthernetInterface_CS    *Ethernet;        // The Ethernet-related
...
typedef struct _RedfishProcessor_V1_7_1_Processor_CS {
    ...
    RedfishCS_Link                                      AccelerationFunctions;    // The link to the collection of
                                                                                  ...
                                                                                  // associated with this
                                                                                  // processor.
    RedfishProcessor_V1_7_1_Actions_CS                  *Actions;                 // The available actions for this
                                                                                  // resource.
    RedfishCS_Link                                      Assembly;                 // The link to an assembly
                                                                                  // associated with this
                                                                                  // processor.
    RedfishCS_char                                      *Description;         
    RedfishProcessor_V1_7_1_FPGA_CS                     *FPGA;                    // The properties for processors
                                                                                  // of the FPGA type.
    ...
    RedfishCS_char                                      *InstructionSet;          // The instruction set of the
                                                                                  // processor.
    RedfishProcessor_V1_7_1_Links_CS                    *Links;                   // The links to other resources
    ...
    RedfishCS_char                                      *ProcessorArchitecture;    // The architecture of the
                                                                                  // processor.
    RedfishProcessor_V1_7_1_ProcessorId_CS              *ProcessorId;             // The identification information
                                                                                  // for this processor.
    RedfishProcessor_V1_7_1_ProcessorMemory_Array_CS    *ProcessorMemory;         // The memory directly attached
...
typedef struct _RedfishProcessor_V1_7_1_ProcessorInterface_Array_CS  {
    RedfishProcessor_V1_7_1_ProcessorInterface_Array_CS    *Next;
...
typedef struct _RedfishProcessor_V1_7_1_FpgaReconfigurationSlot_Array_CS  {
    RedfishProcessor_V1_7_1_FpgaReconfigurationSlot_Array_CS    *Next;
    RedfishProcessor_V1_7_1_FpgaReconfigurationSlot_CS    *ArrayValue;
} RedfishProcessor_V1_7_1_FpgaReconfigurationSlot_Array_CS;

typedef struct _RedfishProcessor_V1_7_1_ProcessorMemory_Array_CS  {
    RedfishProcessor_V1_7_1_ProcessorMemory_Array_CS    *Next;
    RedfishProcessor_V1_7_1_ProcessorMemory_CS    *ArrayValue;
} RedfishProcessor_V1_7_1_ProcessorMemory_Array_CS;
...
RedfishCS_status
Json_Processor_V1_7_1_To_CS (char *JsonRawText, RedfishProcessor_V1_7_1_Processor_CS **ReturnedCS);

RedfishCS_status
CS_To_Processor_V1_7_1_JSON (RedfishProcessor_V1_7_1_Processor_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyProcessor_V1_7_1_CS (RedfishProcessor_V1_7_1_Processor_CS *CSPtr);

RedfishCS_status
DestroyProcessor_V1_7_1_Json (RedfishCS_char *JsonText);
