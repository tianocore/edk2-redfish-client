...
#ifndef RedfishCompositionservice_V1_1_1_CSTRUCT_H_
#define RedfishCompositionservice_V1_1_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishCompositionService_V1_1_1_Actions_CS RedfishCompositionService_V1_1_1_Actions_CS;
typedef struct _RedfishCompositionService_V1_1_1_CompositionService_CS RedfishCompositionService_V1_1_1_CompositionService_CS;
typedef struct _RedfishCompositionService_V1_1_1_OemActions_CS RedfishCompositionService_V1_1_1_OemActions_CS;
...
typedef struct _RedfishCompositionService_V1_1_1_Actions_CS {
    RedfishCompositionService_V1_1_1_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishCompositionService_V1_1_1_CompositionService_CS {
    ...
    RedfishCompositionService_V1_1_1_Actions_CS    *Actions;                 // The available actions for this
                                                                             // resource.
...
RedfishCS_status
Json_CompositionService_V1_1_1_To_CS (char *JsonRawText, RedfishCompositionService_V1_1_1_CompositionService_CS **ReturnedCS);

RedfishCS_status
CS_To_CompositionService_V1_1_1_JSON (RedfishCompositionService_V1_1_1_CompositionService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyCompositionService_V1_1_1_CS (RedfishCompositionService_V1_1_1_CompositionService_CS *CSPtr);

RedfishCS_status
DestroyCompositionService_V1_1_1_Json (RedfishCS_char *JsonText);
