...
#ifndef RedfishProcessormetrics_V1_0_5_CSTRUCT_H_
#define RedfishProcessormetrics_V1_0_5_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishProcessorMetrics_V1_0_5_CStateResidency_Array_CS RedfishProcessorMetrics_V1_0_5_CStateResidency_Array_CS;
typedef struct _RedfishProcessorMetrics_V1_0_5_CacheMetrics_Array_CS RedfishProcessorMetrics_V1_0_5_CacheMetrics_Array_CS;
typedef struct _RedfishProcessorMetrics_V1_0_5_CoreMetrics_Array_CS RedfishProcessorMetrics_V1_0_5_CoreMetrics_Array_CS;
typedef struct _RedfishProcessorMetrics_V1_0_5_Actions_CS RedfishProcessorMetrics_V1_0_5_Actions_CS;
typedef struct _RedfishProcessorMetrics_V1_0_5_CStateResidency_CS RedfishProcessorMetrics_V1_0_5_CStateResidency_CS;
typedef struct _RedfishProcessorMetrics_V1_0_5_CacheMetrics_CS RedfishProcessorMetrics_V1_0_5_CacheMetrics_CS;
typedef struct _RedfishProcessorMetrics_V1_0_5_CoreMetrics_CS RedfishProcessorMetrics_V1_0_5_CoreMetrics_CS;
typedef struct _RedfishProcessorMetrics_V1_0_5_OemActions_CS RedfishProcessorMetrics_V1_0_5_OemActions_CS;
typedef struct _RedfishProcessorMetrics_V1_0_5_ProcessorMetrics_CS RedfishProcessorMetrics_V1_0_5_ProcessorMetrics_CS;
...
typedef struct _RedfishProcessorMetrics_V1_0_5_Actions_CS {
    RedfishProcessorMetrics_V1_0_5_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishProcessorMetrics_V1_0_5_CoreMetrics_CS {
    RedfishProcessorMetrics_V1_0_5_CStateResidency_Array_CS    *CStateResidency;        // The C-state residency of this
                                                                                        // core in the processor.
    RedfishProcessorMetrics_V1_0_5_CacheMetrics_Array_CS       *CoreCache;              // The cache metrics of this core
                                                                                        // in the processor.
...
typedef struct _RedfishProcessorMetrics_V1_0_5_ProcessorMetrics_CS {
    ...
    RedfishProcessorMetrics_V1_0_5_Actions_CS               *Actions;                      // The available actions for this
                                                                                           // resource.
    ...
    RedfishProcessorMetrics_V1_0_5_CacheMetrics_Array_CS    *Cache;                        // The processor cache metrics.
    RedfishCS_int64                                         *ConsumedPowerWatt;            // The power, in watts, that the
                                                                                           // processor has consumed.
    RedfishProcessorMetrics_V1_0_5_CoreMetrics_Array_CS     *CoreMetrics;                  // The processor core metrics.
...
typedef struct _RedfishProcessorMetrics_V1_0_5_CStateResidency_Array_CS  {
    RedfishProcessorMetrics_V1_0_5_CStateResidency_Array_CS    *Next;
    RedfishProcessorMetrics_V1_0_5_CStateResidency_CS    *ArrayValue;
} RedfishProcessorMetrics_V1_0_5_CStateResidency_Array_CS;

typedef struct _RedfishProcessorMetrics_V1_0_5_CacheMetrics_Array_CS  {
    RedfishProcessorMetrics_V1_0_5_CacheMetrics_Array_CS    *Next;
    RedfishProcessorMetrics_V1_0_5_CacheMetrics_CS    *ArrayValue;
} RedfishProcessorMetrics_V1_0_5_CacheMetrics_Array_CS;

typedef struct _RedfishProcessorMetrics_V1_0_5_CoreMetrics_Array_CS  {
    RedfishProcessorMetrics_V1_0_5_CoreMetrics_Array_CS    *Next;
    RedfishProcessorMetrics_V1_0_5_CoreMetrics_CS    *ArrayValue;
} RedfishProcessorMetrics_V1_0_5_CoreMetrics_Array_CS;

RedfishCS_status
Json_ProcessorMetrics_V1_0_5_To_CS (char *JsonRawText, RedfishProcessorMetrics_V1_0_5_ProcessorMetrics_CS **ReturnedCS);

RedfishCS_status
CS_To_ProcessorMetrics_V1_0_5_JSON (RedfishProcessorMetrics_V1_0_5_ProcessorMetrics_CS *CSPtr, char **JsonText);
