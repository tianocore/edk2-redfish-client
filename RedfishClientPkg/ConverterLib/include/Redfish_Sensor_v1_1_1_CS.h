...
#ifndef RedfishSensor_V1_1_1_CSTRUCT_H_
#define RedfishSensor_V1_1_1_CSTRUCT_H_
...
typedef struct _RedfishSensor_V1_1_1_Actions_CS RedfishSensor_V1_1_1_Actions_CS;
typedef struct _RedfishSensor_V1_1_1_OemActions_CS RedfishSensor_V1_1_1_OemActions_CS;
typedef struct _RedfishSensor_V1_1_1_ResetMetrics_CS RedfishSensor_V1_1_1_ResetMetrics_CS;
typedef struct _RedfishSensor_V1_1_1_Sensor_CS RedfishSensor_V1_1_1_Sensor_CS;
typedef struct _RedfishSensor_V1_1_1_SensorArrayExcerpt_CS RedfishSensor_V1_1_1_SensorArrayExcerpt_CS;
typedef struct _RedfishSensor_V1_1_1_SensorCurrentExcerpt_CS RedfishSensor_V1_1_1_SensorCurrentExcerpt_CS;
typedef struct _RedfishSensor_V1_1_1_SensorEnergykWhExcerpt_CS RedfishSensor_V1_1_1_SensorEnergykWhExcerpt_CS;
typedef struct _RedfishSensor_V1_1_1_SensorExcerpt_CS RedfishSensor_V1_1_1_SensorExcerpt_CS;
typedef struct _RedfishSensor_V1_1_1_SensorPowerExcerpt_CS RedfishSensor_V1_1_1_SensorPowerExcerpt_CS;
typedef struct _RedfishSensor_V1_1_1_SensorVoltageExcerpt_CS RedfishSensor_V1_1_1_SensorVoltageExcerpt_CS;
typedef struct _RedfishSensor_V1_1_1_Threshold_CS RedfishSensor_V1_1_1_Threshold_CS;
typedef struct _RedfishSensor_V1_1_1_Thresholds_CS RedfishSensor_V1_1_1_Thresholds_CS;
...
typedef struct _RedfishSensor_V1_1_1_Actions_CS {
    ...
    RedfishSensor_V1_1_1_OemActions_CS      *Oem;                   // The available OEM-specific
...
typedef struct _RedfishSensor_V1_1_1_Thresholds_CS {
    RedfishSensor_V1_1_1_Threshold_CS    *LowerCaution;    // The value at which the reading
                                                           // is below normal range.
    RedfishSensor_V1_1_1_Threshold_CS    *LowerCritical;    // The value at which the reading
                                                           // is below normal range but not
                                                           // yet fatal.
    RedfishSensor_V1_1_1_Threshold_CS    *LowerFatal;      // The value at which the reading
                                                           // is below normal range and
                                                           // fatal.
    RedfishSensor_V1_1_1_Threshold_CS    *UpperCaution;    // The value at which the reading
                                                           // is above normal range.
    RedfishSensor_V1_1_1_Threshold_CS    *UpperCritical;    // The value at which the reading
                                                           // is above normal range but not
                                                           // yet fatal.
    RedfishSensor_V1_1_1_Threshold_CS    *UpperFatal;      // The value at which the reading
...
typedef struct _RedfishSensor_V1_1_1_Sensor_CS {
    ...
    RedfishSensor_V1_1_1_Actions_CS       *Actions;                              // The available actions for this
                                                                                 // resource.
    ...
    RedfishCS_int64                       *THDPercent;                           // The total harmonic distortion
                                                                                 // (THD).
    RedfishSensor_V1_1_1_Thresholds_CS    *Thresholds;                           // The set of thresholds defined
                                                                                 // for this sensor.
...
RedfishCS_status
Json_Sensor_V1_1_1_To_CS (char *JsonRawText, RedfishSensor_V1_1_1_Sensor_CS **ReturnedCS);

RedfishCS_status
CS_To_Sensor_V1_1_1_JSON (RedfishSensor_V1_1_1_Sensor_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroySensor_V1_1_1_CS (RedfishSensor_V1_1_1_Sensor_CS *CSPtr);

RedfishCS_status
DestroySensor_V1_1_1_Json (RedfishCS_char *JsonText);
