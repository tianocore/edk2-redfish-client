...
#ifndef RedfishManageraccount_V1_0_10_CSTRUCT_H_
#define RedfishManageraccount_V1_0_10_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishManagerAccount_V1_0_10_Links_CS RedfishManagerAccount_V1_0_10_Links_CS;
typedef struct _RedfishManagerAccount_V1_0_10_ManagerAccount_CS RedfishManagerAccount_V1_0_10_ManagerAccount_CS;
...
//
typedef struct _RedfishManagerAccount_V1_0_10_Links_CS {
    RedfishResource_Oem_CS    *Oem;    // The OEM extension property.
    RedfishCS_Link            Role;    // The link to the Redfish Role
                                      // that defines the privileges
                                      // for this account.
} RedfishManagerAccount_V1_0_10_Links_CS;
...
//
typedef struct _RedfishManagerAccount_V1_0_10_ManagerAccount_CS {
    ...
    RedfishCS_bool                            *Enabled;         // An indication of whether an
                                                                ...
                                                                // log in.
    RedfishCS_char                            *Id;          
    RedfishManagerAccount_V1_0_10_Links_CS    *Links;           // The links to other Resources
...
} RedfishManagerAccount_V1_0_10_ManagerAccount_CS;

RedfishCS_status
Json_ManagerAccount_V1_0_10_To_CS (char *JsonRawText, RedfishManagerAccount_V1_0_10_ManagerAccount_CS **ReturnedCS);

RedfishCS_status
CS_To_ManagerAccount_V1_0_10_JSON (RedfishManagerAccount_V1_0_10_ManagerAccount_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyManagerAccount_V1_0_10_CS (RedfishManagerAccount_V1_0_10_ManagerAccount_CS *CSPtr);

RedfishCS_status
DestroyManagerAccount_V1_0_10_Json (RedfishCS_char *JsonText);
