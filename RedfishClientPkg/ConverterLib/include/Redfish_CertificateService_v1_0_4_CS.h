...
#ifndef RedfishCertificateservice_V1_0_4_CSTRUCT_H_
#define RedfishCertificateservice_V1_0_4_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishCertificateService_V1_0_4_Actions_CS RedfishCertificateService_V1_0_4_Actions_CS;
typedef struct _RedfishCertificateService_V1_0_4_CertificateService_CS RedfishCertificateService_V1_0_4_CertificateService_CS;
typedef struct _RedfishCertificateService_V1_0_4_GenerateCSR_CS RedfishCertificateService_V1_0_4_GenerateCSR_CS;
typedef struct _RedfishCertificateService_V1_0_4_GenerateCSRResponse_CS RedfishCertificateService_V1_0_4_GenerateCSRResponse_CS;
typedef struct _RedfishCertificateService_V1_0_4_OemActions_CS RedfishCertificateService_V1_0_4_OemActions_CS;
typedef struct _RedfishCertificateService_V1_0_4_ReplaceCertificate_CS RedfishCertificateService_V1_0_4_ReplaceCertificate_CS;
...
typedef struct _RedfishCertificateService_V1_0_4_Actions_CS {
    ...
    RedfishCertificateService_V1_0_4_OemActions_CS            *Oem;                                     // The available OEM-specific
...
typedef struct _RedfishCertificateService_V1_0_4_CertificateService_CS {
    ...
    RedfishCertificateService_V1_0_4_Actions_CS    *Actions;               // The available actions for this
                                                                           // resource.
...
RedfishCS_status
Json_CertificateService_V1_0_4_To_CS (char *JsonRawText, RedfishCertificateService_V1_0_4_CertificateService_CS **ReturnedCS);

RedfishCS_status
CS_To_CertificateService_V1_0_4_JSON (RedfishCertificateService_V1_0_4_CertificateService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyCertificateService_V1_0_4_CS (RedfishCertificateService_V1_0_4_CertificateService_CS *CSPtr);

RedfishCS_status
DestroyCertificateService_V1_0_4_Json (RedfishCS_char *JsonText);
