...
#ifndef RedfishNetworkdevicefunctionmetrics_V1_1_0_CSTRUCT_H_
#define RedfishNetworkdevicefunctionmetrics_V1_1_0_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishNetworkDeviceFunctionMetrics_V1_1_0_Actions_CS RedfishNetworkDeviceFunctionMetrics_V1_1_0_Actions_CS;
typedef struct _RedfishNetworkDeviceFunctionMetrics_V1_1_0_Ethernet_CS RedfishNetworkDeviceFunctionMetrics_V1_1_0_Ethernet_CS;
typedef struct _RedfishNetworkDeviceFunctionMetrics_V1_1_0_FibreChannel_CS RedfishNetworkDeviceFunctionMetrics_V1_1_0_FibreChannel_CS;
typedef struct _RedfishNetworkDeviceFunctionMetrics_V1_1_0_NetworkDeviceFunctionMetrics_CS RedfishNetworkDeviceFunctionMetrics_V1_1_0_NetworkDeviceFunctionMetrics_CS;
typedef struct _RedfishNetworkDeviceFunctionMetrics_V1_1_0_OemActions_CS RedfishNetworkDeviceFunctionMetrics_V1_1_0_OemActions_CS;
...
typedef struct _RedfishNetworkDeviceFunctionMetrics_V1_1_0_Actions_CS {
    RedfishNetworkDeviceFunctionMetrics_V1_1_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishNetworkDeviceFunctionMetrics_V1_1_0_FibreChannel_CS {
    RedfishCS_int64    *PortLoginAccepts;        // The total number of port login
                                                 // (PLOGI) accept (ACC)
                                                 // responses.
    RedfishCS_int64    *PortLoginRejects;        // The total number of port login
                                                 // (PLOGI) reject (RJT)
                                                 // responses.
    RedfishCS_int64    *PortLoginRequests;       // The total number of port login
                                                 // (PLOGI) requests transmitted.
    RedfishCS_int64    *RXCongestionFPINs;       // The total number of Congestion
                                                 // Fabric Performance Impact
                                                 // Notifications (FPINs)
                                                 // received.
    RedfishCS_int64    *RXDeliveryFPINs;         // The total number of Delivery
                                                 // Fabric Performance Impact
                                                 // Notifications (FPINs)
                                                 // received.
    RedfishCS_int64    *RXExchanges;             // The total number of Fibre
                                                 // Channel exchanges received.
    RedfishCS_int64    *RXLinkIntegrityFPINs;    // The total number of Link
                                                 // Integrity Fabric Performance
                                                 // Impact Notifications (FPINs)
                                                 // received.
    RedfishCS_int64    *RXPeerCongestionFPINs;    // The total number of Peer
                                                 // Congestion Fabric Performance
                                                 // Impact Notifications (FPINs)
                                                 // received.
    RedfishCS_int64    *RXSequences;             // The total number of Fibre
                                                 // Channel sequences received.
    RedfishCS_int64    *TXCongestionFPINs;       // The total number of Congestion
                                                 // Fabric Performance Impact
                                                 // Notifications (FPINs) sent.
    RedfishCS_int64    *TXDeliveryFPINs;         // The total number of Delivery
                                                 // Fabric Performance Impact
                                                 // Notifications (FPINs) sent.
    RedfishCS_int64    *TXExchanges;             // The total number of Fibre
                                                 // Channel exchanges transmitted.
    RedfishCS_int64    *TXLinkIntegrityFPINs;    // The total number of Link
                                                 // Integrity Fabric Performance
                                                 // Impact Notifications (FPINs)
                                                 // sent.
    RedfishCS_int64    *TXPeerCongestionFPINs;    // The total number of Peer
                                                 // Congestion Fabric Performance
                                                 // Impact Notifications (FPINs)
                                                 // sent.
...
typedef struct _RedfishNetworkDeviceFunctionMetrics_V1_1_0_NetworkDeviceFunctionMetrics_CS {
    ...
    RedfishNetworkDeviceFunctionMetrics_V1_1_0_Actions_CS         *Actions;                  // The available actions for this
                                                                                             // resource.
    RedfishCS_char                                                *Description;          
    RedfishNetworkDeviceFunctionMetrics_V1_1_0_Ethernet_CS        *Ethernet;                 // The network function metrics
                                                                                             // specific to Ethernet adapters.
    RedfishNetworkDeviceFunctionMetrics_V1_1_0_FibreChannel_CS    *FibreChannel;             // The network function metrics
...
RedfishCS_status
Json_NetworkDeviceFunctionMetrics_V1_1_0_To_CS (char *JsonRawText, RedfishNetworkDeviceFunctionMetrics_V1_1_0_NetworkDeviceFunctionMetrics_CS **ReturnedCS);

RedfishCS_status
CS_To_NetworkDeviceFunctionMetrics_V1_1_0_JSON (RedfishNetworkDeviceFunctionMetrics_V1_1_0_NetworkDeviceFunctionMetrics_CS *CSPtr, char **JsonText);
...
RedfishCS_status
DestroyNetworkDeviceFunctionMetrics_V1_1_0_Json (RedfishCS_char *JsonText);
