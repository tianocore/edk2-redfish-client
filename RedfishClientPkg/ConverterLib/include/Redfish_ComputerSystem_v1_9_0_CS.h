...
#ifndef RedfishComputersystem_V1_9_0_CSTRUCT_H_
#define RedfishComputersystem_V1_9_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishComputerSystem_V1_9_0_TrustedModules_Array_CS RedfishComputerSystem_V1_9_0_TrustedModules_Array_CS;
#ifndef RedfishResource_Condition_Array_CS_
typedef struct _RedfishResource_Condition_Array_CS RedfishResource_Condition_Array_CS;
#endif
typedef struct _RedfishComputerSystem_V1_9_0_Actions_CS RedfishComputerSystem_V1_9_0_Actions_CS;
typedef struct _RedfishComputerSystem_V1_9_0_AddResourceBlock_CS RedfishComputerSystem_V1_9_0_AddResourceBlock_CS;
typedef struct _RedfishComputerSystem_V1_9_0_Boot_CS RedfishComputerSystem_V1_9_0_Boot_CS;
typedef struct _RedfishComputerSystem_V1_9_0_ComputerSystem_CS RedfishComputerSystem_V1_9_0_ComputerSystem_CS;
typedef struct _RedfishComputerSystem_V1_9_0_HostedServices_CS RedfishComputerSystem_V1_9_0_HostedServices_CS;
typedef struct _RedfishComputerSystem_V1_9_0_Links_CS RedfishComputerSystem_V1_9_0_Links_CS;
typedef struct _RedfishComputerSystem_V1_9_0_MemorySummary_CS RedfishComputerSystem_V1_9_0_MemorySummary_CS;
typedef struct _RedfishComputerSystem_V1_9_0_OemActions_CS RedfishComputerSystem_V1_9_0_OemActions_CS;
typedef struct _RedfishComputerSystem_V1_9_0_ProcessorSummary_CS RedfishComputerSystem_V1_9_0_ProcessorSummary_CS;
typedef struct _RedfishComputerSystem_V1_9_0_RemoveResourceBlock_CS RedfishComputerSystem_V1_9_0_RemoveResourceBlock_CS;
typedef struct _RedfishComputerSystem_V1_9_0_Reset_CS RedfishComputerSystem_V1_9_0_Reset_CS;
typedef struct _RedfishComputerSystem_V1_9_0_SetDefaultBootOrder_CS RedfishComputerSystem_V1_9_0_SetDefaultBootOrder_CS;
typedef struct _RedfishComputerSystem_V1_9_0_TrustedModules_CS RedfishComputerSystem_V1_9_0_TrustedModules_CS;
typedef struct _RedfishComputerSystem_V1_9_0_WatchdogTimer_CS RedfishComputerSystem_V1_9_0_WatchdogTimer_CS;
...
typedef struct _RedfishComputerSystem_V1_9_0_Actions_CS {
    ...
    RedfishComputerSystem_V1_9_0_OemActions_CS             *Oem;                                  // The available OEM-specific
...
typedef struct _RedfishComputerSystem_V1_9_0_ComputerSystem_CS {
    ...
    RedfishComputerSystem_V1_9_0_Actions_CS                 *Actions;                    // The available actions for this
                                                                                         // Resource.
    ...
    RedfishComputerSystem_V1_9_0_Boot_CS                    *Boot;                       // The boot settings for this
                                                                                         // system.
    ...
    RedfishCS_char                                          *HostName;                   // The DNS host name, without any
                                                                                         // domain information.
    RedfishComputerSystem_V1_9_0_WatchdogTimer_CS           *HostWatchdogTimer;          // The host watchdog timer
                                                                                         // functionality for this system.
    RedfishComputerSystem_V1_9_0_HostedServices_CS          *HostedServices;             // The services that this
                                                                                         // computer system supports.
    ...
    RedfishCS_char                                          *IndicatorLED;               // The state of the indicator
                                                                                         ...
                                                                                         // system.
    RedfishComputerSystem_V1_9_0_Links_CS                   *Links;                      // The links to other Resources
    ...
    RedfishCS_Link                                          MemoryDomains;               // The link to the collection of
                                                                                         ...
                                                                                         // this system.
    RedfishComputerSystem_V1_9_0_MemorySummary_CS           *MemorySummary;              // The central memory of the
    ...
    RedfishCS_char                                          *PowerState;                 // The current power state of the
                                                                                         // system.
    RedfishComputerSystem_V1_9_0_ProcessorSummary_CS        *ProcessorSummary;           // The central processors of the
                                                                                         // system in general detail.
    ...
    RedfishComputerSystem_V1_9_0_TrustedModules_Array_CS    *TrustedModules;             // An array of trusted modules in
                                                                                         // the system.
...
typedef struct _RedfishComputerSystem_V1_9_0_TrustedModules_Array_CS  {
    RedfishComputerSystem_V1_9_0_TrustedModules_Array_CS    *Next;
    RedfishComputerSystem_V1_9_0_TrustedModules_CS    *ArrayValue;
} RedfishComputerSystem_V1_9_0_TrustedModules_Array_CS;
...
RedfishCS_status
Json_ComputerSystem_V1_9_0_To_CS (char *JsonRawText, RedfishComputerSystem_V1_9_0_ComputerSystem_CS **ReturnedCS);

RedfishCS_status
CS_To_ComputerSystem_V1_9_0_JSON (RedfishComputerSystem_V1_9_0_ComputerSystem_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyComputerSystem_V1_9_0_CS (RedfishComputerSystem_V1_9_0_ComputerSystem_CS *CSPtr);

RedfishCS_status
DestroyComputerSystem_V1_9_0_Json (RedfishCS_char *JsonText);
