...
#ifndef RedfishSoftwareinventory_V1_2_2_CSTRUCT_H_
#define RedfishSoftwareinventory_V1_2_2_CSTRUCT_H_
...
typedef struct _RedfishSoftwareInventory_V1_2_2_Actions_CS RedfishSoftwareInventory_V1_2_2_Actions_CS;
typedef struct _RedfishSoftwareInventory_V1_2_2_OemActions_CS RedfishSoftwareInventory_V1_2_2_OemActions_CS;
typedef struct _RedfishSoftwareInventory_V1_2_2_SoftwareInventory_CS RedfishSoftwareInventory_V1_2_2_SoftwareInventory_CS;
...
typedef struct _RedfishSoftwareInventory_V1_2_2_Actions_CS {
    RedfishSoftwareInventory_V1_2_2_OemActions_CS    *Oem;    // This property contains the
...
typedef struct _RedfishSoftwareInventory_V1_2_2_SoftwareInventory_CS {
    ...
    RedfishSoftwareInventory_V1_2_2_Actions_CS    *Actions;                  // The available actions for this
                                                                             // resource.
...
RedfishCS_status
Json_SoftwareInventory_V1_2_2_To_CS (char *JsonRawText, RedfishSoftwareInventory_V1_2_2_SoftwareInventory_CS **ReturnedCS);

RedfishCS_status
CS_To_SoftwareInventory_V1_2_2_JSON (RedfishSoftwareInventory_V1_2_2_SoftwareInventory_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroySoftwareInventory_V1_2_2_CS (RedfishSoftwareInventory_V1_2_2_SoftwareInventory_CS *CSPtr);

RedfishCS_status
DestroySoftwareInventory_V1_2_2_Json (RedfishCS_char *JsonText);
