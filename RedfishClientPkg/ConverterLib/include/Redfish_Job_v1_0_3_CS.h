...
#ifndef RedfishJob_V1_0_3_CSTRUCT_H_
#define RedfishJob_V1_0_3_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishJob_V1_0_3_Actions_CS RedfishJob_V1_0_3_Actions_CS;
typedef struct _RedfishJob_V1_0_3_Job_CS RedfishJob_V1_0_3_Job_CS;
typedef struct _RedfishJob_V1_0_3_OemActions_CS RedfishJob_V1_0_3_OemActions_CS;
typedef struct _RedfishJob_V1_0_3_Payload_CS RedfishJob_V1_0_3_Payload_CS;
...
//
typedef struct _RedfishJob_V1_0_3_Actions_CS {
    RedfishJob_V1_0_3_OemActions_CS    *Oem;    // The available OEM-specific
                                               // actions for this Resource.
} RedfishJob_V1_0_3_Actions_CS;

//
// The available OEM-specific actions for this Resource.
//
typedef struct _RedfishJob_V1_0_3_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishJob_V1_0_3_OemActions_CS;

//
// The HTTP and JSON payload details for this job.
//
typedef struct _RedfishJob_V1_0_3_Payload_CS {
...
//
// The Job schema contains information about a job that a a Redfish Job Service
// schedules or executes.  Clients create jobs to describe a series of operations
// that occur at periodic intervals.
//
typedef struct _RedfishJob_V1_0_3_Job_CS {
    RedfishCS_Header                Header;
    RedfishCS_char                  *odata_context;  
    RedfishCS_char                  *odata_etag;     
    RedfishCS_char                  *odata_id;       
    RedfishCS_char                  *odata_type;     
    RedfishJob_V1_0_3_Actions_CS    *Actions;            // The available actions for this
                                                         // Resource.
    ...
    RedfishJob_V1_0_3_Payload_CS    *Payload;            // The HTTP and JSON payload
    ...
    RedfishCS_Link                  Steps;               // The link to a collection of
                                                         // steps for this job.
} RedfishJob_V1_0_3_Job_CS;

RedfishCS_status
Json_Job_V1_0_3_To_CS (char *JsonRawText, RedfishJob_V1_0_3_Job_CS **ReturnedCS);

RedfishCS_status
CS_To_Job_V1_0_3_JSON (RedfishJob_V1_0_3_Job_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyJob_V1_0_3_CS (RedfishJob_V1_0_3_Job_CS *CSPtr);

RedfishCS_status
DestroyJob_V1_0_3_Json (RedfishCS_char *JsonText);
