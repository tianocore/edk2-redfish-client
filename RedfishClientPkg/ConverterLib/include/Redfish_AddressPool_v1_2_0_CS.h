...
#ifndef RedfishAddresspool_V1_2_0_CSTRUCT_H_
#define RedfishAddresspool_V1_2_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishAddressPool_V1_2_0_ASNumberRange_CS RedfishAddressPool_V1_2_0_ASNumberRange_CS;
typedef struct _RedfishAddressPool_V1_2_0_Actions_CS RedfishAddressPool_V1_2_0_Actions_CS;
typedef struct _RedfishAddressPool_V1_2_0_AddressPool_CS RedfishAddressPool_V1_2_0_AddressPool_CS;
typedef struct _RedfishAddressPool_V1_2_0_BFDSingleHopOnly_CS RedfishAddressPool_V1_2_0_BFDSingleHopOnly_CS;
typedef struct _RedfishAddressPool_V1_2_0_BGPEvpn_CS RedfishAddressPool_V1_2_0_BGPEvpn_CS;
typedef struct _RedfishAddressPool_V1_2_0_BGPNeighbor_CS RedfishAddressPool_V1_2_0_BGPNeighbor_CS;
typedef struct _RedfishAddressPool_V1_2_0_BGPRoute_CS RedfishAddressPool_V1_2_0_BGPRoute_CS;
typedef struct _RedfishAddressPool_V1_2_0_CommonBGPProperties_CS RedfishAddressPool_V1_2_0_CommonBGPProperties_CS;
typedef struct _RedfishAddressPool_V1_2_0_DHCP_CS RedfishAddressPool_V1_2_0_DHCP_CS;
typedef struct _RedfishAddressPool_V1_2_0_EBGP_CS RedfishAddressPool_V1_2_0_EBGP_CS;
typedef struct _RedfishAddressPool_V1_2_0_ESINumberRange_CS RedfishAddressPool_V1_2_0_ESINumberRange_CS;
typedef struct _RedfishAddressPool_V1_2_0_EVINumberRange_CS RedfishAddressPool_V1_2_0_EVINumberRange_CS;
typedef struct _RedfishAddressPool_V1_2_0_Ethernet_CS RedfishAddressPool_V1_2_0_Ethernet_CS;
typedef struct _RedfishAddressPool_V1_2_0_GatewayIPAddressRange_CS RedfishAddressPool_V1_2_0_GatewayIPAddressRange_CS;
typedef struct _RedfishAddressPool_V1_2_0_GenZ_CS RedfishAddressPool_V1_2_0_GenZ_CS;
typedef struct _RedfishAddressPool_V1_2_0_GracefulRestart_CS RedfishAddressPool_V1_2_0_GracefulRestart_CS;
typedef struct _RedfishAddressPool_V1_2_0_IPv4_CS RedfishAddressPool_V1_2_0_IPv4_CS;
typedef struct _RedfishAddressPool_V1_2_0_IPv4AddressRange_CS RedfishAddressPool_V1_2_0_IPv4AddressRange_CS;
typedef struct _RedfishAddressPool_V1_2_0_Links_CS RedfishAddressPool_V1_2_0_Links_CS;
typedef struct _RedfishAddressPool_V1_2_0_MaxPrefix_CS RedfishAddressPool_V1_2_0_MaxPrefix_CS;
typedef struct _RedfishAddressPool_V1_2_0_MultiplePaths_CS RedfishAddressPool_V1_2_0_MultiplePaths_CS;
typedef struct _RedfishAddressPool_V1_2_0_OemActions_CS RedfishAddressPool_V1_2_0_OemActions_CS;
typedef struct _RedfishAddressPool_V1_2_0_RouteDistinguisherRange_CS RedfishAddressPool_V1_2_0_RouteDistinguisherRange_CS;
typedef struct _RedfishAddressPool_V1_2_0_RouteTargetRange_CS RedfishAddressPool_V1_2_0_RouteTargetRange_CS;
typedef struct _RedfishAddressPool_V1_2_0_SystemMACRange_CS RedfishAddressPool_V1_2_0_SystemMACRange_CS;
typedef struct _RedfishAddressPool_V1_2_0_VLANIdentifierAddressRange_CS RedfishAddressPool_V1_2_0_VLANIdentifierAddressRange_CS;
...
typedef struct _RedfishAddressPool_V1_2_0_Actions_CS {
    RedfishAddressPool_V1_2_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishAddressPool_V1_2_0_BGPEvpn_CS {
    ...
    RedfishCS_char                                             *AnycastGatewayMACAddress;                  // The anycast gateway MAC
                                                                                                           // address.
    RedfishAddressPool_V1_2_0_ESINumberRange_CS                *ESINumberRange;                            // The Ethernet Segment
                                                                                                           // Identifier (ESI) number range
                                                                                                           // for the fabric.
    RedfishAddressPool_V1_2_0_EVINumberRange_CS                *EVINumberRange;                            // The Ethernet Virtual Private
                                                                                                           // Network (EVPN) Instance number
                                                                                                           // (EVI) number range for the
                                                                                                           // fabric.
    RedfishCS_char                                             *GatewayIPAddress;                          // The gateway IPv4 address.
    RedfishAddressPool_V1_2_0_GatewayIPAddressRange_CS         *GatewayIPAddressRange;                     // The IPv4 address range for
                                                                                                           // gateways.
    ...
    RedfishCS_char                                             *RouteDistinguisherAdministratorSubfield;    // The Route Distinguisher (RD)
                                                                                                           // Administrator subfield.
    RedfishAddressPool_V1_2_0_RouteDistinguisherRange_CS       *RouteDistinguisherRange;                   // The Route Distinguisher (RD)
                                                                                                           // number range for the fabric.
    RedfishCS_char                                             *RouteTargetAdministratorSubfield;          // The Route Target (RT)
                                                                                                           // Administrator Subfield.
    RedfishAddressPool_V1_2_0_RouteTargetRange_CS              *RouteTargetRange;                          // The Route Target (RT) number
    ...
    RedfishCS_bool                                             *UnknownUnicastSuppressionEnabled;          // Suppression of unknown unicast
                                                                                                           // packets.
    RedfishAddressPool_V1_2_0_VLANIdentifierAddressRange_CS    *VLANIdentifierAddressRange;                // The VLAN tag range for the
                                                                                                           // fabric.
...
typedef struct _RedfishAddressPool_V1_2_0_BGPNeighbor_CS {
    ...
    RedfishCS_bool                            *AllowOwnASEnabled;                     // Allow own Autonomous System
                                                                                      // (AS) status.
    RedfishCS_int64                           *CIDR;                                  // The Classless Inter-Domain
                                                                                      // Routing (CIDR) value used for
                                                                                      // neighbor communication.  This
                                                                                      // is the number of ones before
                                                                                      // the first zero in the subnet
                                                                                      // mask.
    RedfishCS_int64                           *ConnectRetrySeconds;                   // Border Gateway Protocol (BGP)
                                                                                      // retry timer in seconds.
    RedfishCS_bool                            *Enabled;                               // An indication of whether BGP
                                                                                      // neighbor communication is
                                                                                      // enabled.
    ...
    RedfishCS_bool                            *LogStateChangesEnabled;                // Border Gateway Protocol (BGP)
                                                                                      ...
                                                                                      // status.
    RedfishAddressPool_V1_2_0_MaxPrefix_CS    *MaxPrefix;                             // Border Gateway Protocol (BGP)
...
typedef struct _RedfishAddressPool_V1_2_0_CommonBGPProperties_CS {
    RedfishAddressPool_V1_2_0_ASNumberRange_CS      *ASNumberRange;          // Autonomous System (AS) number
                                                                             // range.
    RedfishAddressPool_V1_2_0_BGPNeighbor_CS        *BGPNeighbor;            // Border Gateway Protocol (BGP)
                                                                             // neighbor related properties.
    RedfishAddressPool_V1_2_0_BGPRoute_CS           *BGPRoute;               // Border Gateway Protocol (BGP)
                                                                             // route related properties.
    RedfishAddressPool_V1_2_0_GracefulRestart_CS    *GracefulRestart;        // Graceful restart related
                                                                             // properties.
    RedfishAddressPool_V1_2_0_MultiplePaths_CS      *MultiplePaths;          // Multiple path related
                                                                             // properties.
...
typedef struct _RedfishAddressPool_V1_2_0_Ethernet_CS {
    RedfishAddressPool_V1_2_0_BFDSingleHopOnly_CS       *BFDSingleHopOnly;    // Bidirectional Forwarding
                                                                              // Detection (BFD) related
                                                                              // properties for this Ethernet
                                                                              // fabric.
    RedfishAddressPool_V1_2_0_BGPEvpn_CS                *BGPEvpn;             // BGP Ethernet Virtual Private
                                                                              // Network (EVPN) related
                                                                              // properties for this Ethernet
                                                                              // fabric.
    RedfishAddressPool_V1_2_0_EBGP_CS                   *EBGP;                // External BGP (eBGP) related
                                                                              // properties for this Ethernet
                                                                              // fabric.
    RedfishAddressPool_V1_2_0_IPv4_CS                   *IPv4;                // IPv4 and Virtual LAN (VLAN)
                                                                              // related addressing for this
                                                                              // Ethernet fabric.
    RedfishAddressPool_V1_2_0_EBGP_CS                   *MultiProtocolEBGP;    // Multi Protocol eBGP (MP eBGP)
                                                                              // related properties for this
                                                                              // Ethernet fabric.
    RedfishAddressPool_V1_2_0_CommonBGPProperties_CS    *MultiProtocolIBGP;    // Multi Protocol iBGP (MP iBGP)
                                                                              // related properties for this
                                                                              // Ethernet fabric.
} RedfishAddressPool_V1_2_0_Ethernet_CS;

//
// The IPv4 address range for gateway nodes for Ethernet Virtual Private Network
// (EVPN) based fabrics.
//
typedef struct _RedfishAddressPool_V1_2_0_GatewayIPAddressRange_CS {
    RedfishCS_char    *Lower;    // The lower IPv4 address.
    RedfishCS_char    *Upper;    // The upper IPv4 address.
...
typedef struct _RedfishAddressPool_V1_2_0_IPv4_CS {
    ...
    RedfishCS_char                                             *AnycastGatewayMACAddress;        // The anycast gateway MAC
                                                                                                 // address.
    RedfishAddressPool_V1_2_0_DHCP_CS                          *DHCP;                            // The Dynamic Host Configuration
    ...
    RedfishCS_bool                                             *DistributeIntoUnderlayEnabled;    // Indicates if host subnets
                                                                                                 ...
                                                                                                 // fabric underlay.
    RedfishAddressPool_V1_2_0_IPv4AddressRange_CS              *EBGPAddressRange;                // External BGP (eBGP) related
                                                                                                 // addressing for this Ethernet
                                                                                                 // fabric.
    RedfishAddressPool_V1_2_0_IPv4AddressRange_CS              *FabricLinkAddressRange;          // Link related addressing for
                                                                                                 // this Ethernet fabric.
    RedfishCS_char                                             *GatewayIPAddress;                // The gateway IPv4 address.
    RedfishAddressPool_V1_2_0_IPv4AddressRange_CS              *HostAddressRange;                // IPv4 related end host subnet
                                                                                                 // addressing for this Ethernet
                                                                                                 // fabric.
    RedfishAddressPool_V1_2_0_IPv4AddressRange_CS              *IBGPAddressRange;                // Internal BGP (iBGP) related
                                                                                                 // addressing for this Ethernet
                                                                                                 // fabric.
    RedfishAddressPool_V1_2_0_IPv4AddressRange_CS              *LoopbackAddressRange;            // Loopback related addressing
                                                                                                 // for this Ethernet fabric.
    RedfishAddressPool_V1_2_0_IPv4AddressRange_CS              *ManagementAddressRange;          // Management related addressing
                                                                                                 // for this Ethernet fabric.
    ...
    RedfishCS_int64                                            *NativeVLAN;                      // The native Virtual LAN (VLAN)
                                                                                                 // tag value.
    RedfishAddressPool_V1_2_0_SystemMACRange_CS                *SystemMACRange;                  // The MAC address range for
                                                                                                 // systems in this subnet.
    RedfishAddressPool_V1_2_0_VLANIdentifierAddressRange_CS    *VLANIdentifierAddressRange;      // Virtual LAN (VLAN) tag related
                                                                                                 // addressing for this Ethernet
...
typedef struct _RedfishAddressPool_V1_2_0_SystemMACRange_CS {
    RedfishCS_char    *Lower;    // The lower system MAC address.
    RedfishCS_char    *Upper;    // The upper system MAC address.
...
typedef struct _RedfishAddressPool_V1_2_0_AddressPool_CS {
    ...
    RedfishAddressPool_V1_2_0_Actions_CS     *Actions;         // The available actions for this
                                                               // resource.
    RedfishCS_char                           *Description; 
    RedfishAddressPool_V1_2_0_Ethernet_CS    *Ethernet;        // The Ethernet related
                                                               // properties for this address
                                                               // pool.
    RedfishAddressPool_V1_2_0_GenZ_CS        *GenZ;            // The Gen-Z related properties
                                                               // for this address pool.
    RedfishCS_char                           *Id;          
    RedfishAddressPool_V1_2_0_Links_CS       *Links;           // The links to other resources
...
RedfishCS_status
Json_AddressPool_V1_2_0_To_CS (char *JsonRawText, RedfishAddressPool_V1_2_0_AddressPool_CS **ReturnedCS);

RedfishCS_status
CS_To_AddressPool_V1_2_0_JSON (RedfishAddressPool_V1_2_0_AddressPool_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAddressPool_V1_2_0_CS (RedfishAddressPool_V1_2_0_AddressPool_CS *CSPtr);

RedfishCS_status
DestroyAddressPool_V1_2_0_Json (RedfishCS_char *JsonText);
