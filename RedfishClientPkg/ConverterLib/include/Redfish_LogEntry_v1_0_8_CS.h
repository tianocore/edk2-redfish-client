...
#ifndef RedfishLogentry_V1_0_8_CSTRUCT_H_
#define RedfishLogentry_V1_0_8_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishLogEntry_V1_0_8_Links_CS RedfishLogEntry_V1_0_8_Links_CS;
typedef struct _RedfishLogEntry_V1_0_8_LogEntry_CS RedfishLogEntry_V1_0_8_LogEntry_CS;
...
//
typedef struct _RedfishLogEntry_V1_0_8_LogEntry_CS {
    ...
    RedfishCS_char                     *Id;            
    RedfishLogEntry_V1_0_8_Links_CS    *Links;             // Contains references to other
    ...
    RedfishCS_char                     *Severity;          // This is the severity of the
                                                           // log entry.
} RedfishLogEntry_V1_0_8_LogEntry_CS;

RedfishCS_status
Json_LogEntry_V1_0_8_To_CS (char *JsonRawText, RedfishLogEntry_V1_0_8_LogEntry_CS **ReturnedCS);

RedfishCS_status
CS_To_LogEntry_V1_0_8_JSON (RedfishLogEntry_V1_0_8_LogEntry_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyLogEntry_V1_0_8_CS (RedfishLogEntry_V1_0_8_LogEntry_CS *CSPtr);

RedfishCS_status
DestroyLogEntry_V1_0_8_Json (RedfishCS_char *JsonText);
