...
#ifndef RedfishAccountservice_V1_2_7_CSTRUCT_H_
#define RedfishAccountservice_V1_2_7_CSTRUCT_H_
...
#endif
typedef struct _RedfishAccountService_V1_2_7_AccountService_CS RedfishAccountService_V1_2_7_AccountService_CS;
typedef struct _RedfishAccountService_V1_2_7_Actions_CS RedfishAccountService_V1_2_7_Actions_CS;
typedef struct _RedfishAccountService_V1_2_7_OemActions_CS RedfishAccountService_V1_2_7_OemActions_CS;
...
typedef struct _RedfishAccountService_V1_2_7_Actions_CS {
    RedfishAccountService_V1_2_7_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishAccountService_V1_2_7_AccountService_CS {
    ...
    RedfishCS_Link                             Accounts;                           // The collection of manager
                                                                                   // accounts.
    RedfishAccountService_V1_2_7_Actions_CS    *Actions;                           // The available actions for this
                                                                                   // resource.
...
RedfishCS_status
Json_AccountService_V1_2_7_To_CS (char *JsonRawText, RedfishAccountService_V1_2_7_AccountService_CS **ReturnedCS);

RedfishCS_status
CS_To_AccountService_V1_2_7_JSON (RedfishAccountService_V1_2_7_AccountService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyAccountService_V1_2_7_CS (RedfishAccountService_V1_2_7_AccountService_CS *CSPtr);

RedfishCS_status
DestroyAccountService_V1_2_7_Json (RedfishCS_char *JsonText);
