...
#ifndef RedfishBattery_V1_0_1_CSTRUCT_H_
#define RedfishBattery_V1_0_1_CSTRUCT_H_
...
#endif
typedef struct _RedfishBattery_V1_0_1_Actions_CS RedfishBattery_V1_0_1_Actions_CS;
typedef struct _RedfishBattery_V1_0_1_Battery_CS RedfishBattery_V1_0_1_Battery_CS;
typedef struct _RedfishBattery_V1_0_1_Calibrate_CS RedfishBattery_V1_0_1_Calibrate_CS;
typedef struct _RedfishBattery_V1_0_1_OemActions_CS RedfishBattery_V1_0_1_OemActions_CS;
typedef struct _RedfishBattery_V1_0_1_Reset_CS RedfishBattery_V1_0_1_Reset_CS;
typedef struct _RedfishBattery_V1_0_1_SelfTest_CS RedfishBattery_V1_0_1_SelfTest_CS;
...
typedef struct _RedfishBattery_V1_0_1_Actions_CS {
    ...
    RedfishBattery_V1_0_1_OemActions_CS    *Oem;                 // The available OEM-specific
...
typedef struct _RedfishBattery_V1_0_1_Battery_CS {
    ...
    RedfishBattery_V1_0_1_Actions_CS    *Actions;                   // The available actions for this
                                                                    // resource.
    ...
    RedfishCS_char                      *SparePartNumber;           // The spare part number for this
                                                                    // battery.
    RedfishCS_Link                      StateOfHealthPercent;       // The state of health (percent)
                                                                    // of this battery.
...
RedfishCS_status
Json_Battery_V1_0_1_To_CS (char *JsonRawText, RedfishBattery_V1_0_1_Battery_CS **ReturnedCS);

RedfishCS_status
CS_To_Battery_V1_0_1_JSON (RedfishBattery_V1_0_1_Battery_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyBattery_V1_0_1_CS (RedfishBattery_V1_0_1_Battery_CS *CSPtr);

RedfishCS_status
DestroyBattery_V1_0_1_Json (RedfishCS_char *JsonText);
