...
#ifndef RedfishPort_V1_1_2_CSTRUCT_H_
#define RedfishPort_V1_1_2_CSTRUCT_H_
...
#endif
typedef struct _RedfishPort_V1_1_2_Actions_CS RedfishPort_V1_1_2_Actions_CS;
typedef struct _RedfishPort_V1_1_2_Links_CS RedfishPort_V1_1_2_Links_CS;
typedef struct _RedfishPort_V1_1_2_OemActions_CS RedfishPort_V1_1_2_OemActions_CS;
typedef struct _RedfishPort_V1_1_2_Port_CS RedfishPort_V1_1_2_Port_CS;
typedef struct _RedfishPort_V1_1_2_Reset_CS RedfishPort_V1_1_2_Reset_CS;
...
typedef struct _RedfishPort_V1_1_2_Actions_CS {
    ...
    RedfishPort_V1_1_2_OemActions_CS    *Oem;          // This property contains the
...
typedef struct _RedfishPort_V1_1_2_Port_CS {
    ...
    RedfishPort_V1_1_2_Actions_CS    *Actions;            // The available actions for this
                                                          // resource.
    RedfishCS_int64                  *CurrentSpeedGbps;    // The current speed of this
                                                          // port.
    RedfishCS_char                   *Description;    
    RedfishCS_char                   *Id;             
    RedfishPort_V1_1_2_Links_CS      *Links;              // Contains references to other
...
RedfishCS_status
Json_Port_V1_1_2_To_CS (char *JsonRawText, RedfishPort_V1_1_2_Port_CS **ReturnedCS);

RedfishCS_status
CS_To_Port_V1_1_2_JSON (RedfishPort_V1_1_2_Port_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyPort_V1_1_2_CS (RedfishPort_V1_1_2_Port_CS *CSPtr);

RedfishCS_status
DestroyPort_V1_1_2_Json (RedfishCS_char *JsonText);
