...
#ifndef RedfishEventservice_V1_6_0_CSTRUCT_H_
#define RedfishEventservice_V1_6_0_CSTRUCT_H_
...
#endif
typedef struct _RedfishEventService_V1_6_0_Actions_CS RedfishEventService_V1_6_0_Actions_CS;
typedef struct _RedfishEventService_V1_6_0_EventService_CS RedfishEventService_V1_6_0_EventService_CS;
typedef struct _RedfishEventService_V1_6_0_OemActions_CS RedfishEventService_V1_6_0_OemActions_CS;
typedef struct _RedfishEventService_V1_6_0_SMTP_CS RedfishEventService_V1_6_0_SMTP_CS;
typedef struct _RedfishEventService_V1_6_0_SSEFilterPropertiesSupported_CS RedfishEventService_V1_6_0_SSEFilterPropertiesSupported_CS;
typedef struct _RedfishEventService_V1_6_0_SubmitTestEvent_CS RedfishEventService_V1_6_0_SubmitTestEvent_CS;
...
//
typedef struct _RedfishEventService_V1_6_0_Actions_CS {
    RedfishEventService_V1_6_0_SubmitTestEvent_CS    *EventService_SubmitTestEvent;
    RedfishEventService_V1_6_0_OemActions_CS         *Oem;                            // The available OEM-specific
                                                                                      // actions for this resource.
} RedfishEventService_V1_6_0_Actions_CS;

//
// The available OEM-specific actions for this resource.
//
typedef struct _RedfishEventService_V1_6_0_OemActions_CS {
    RedfishCS_Link    Prop;
} RedfishEventService_V1_6_0_OemActions_CS;

//
// Settings for SMTP event delivery.
//
typedef struct _RedfishEventService_V1_6_0_SMTP_CS {
    ...
    RedfishCS_char     *Username;             // The username for
                                              // authentication with the SMTP
                                              // server.
} RedfishEventService_V1_6_0_SMTP_CS;

//
// The set of properties that are supported in the `$filter` query parameter for
// the ServerSentEventUri.
//
typedef struct _RedfishEventService_V1_6_0_SSEFilterPropertiesSupported_CS {
    ...
    RedfishCS_bool    *SubordinateResources;     // An indication of whether the
                                                 ...
                                                 // property.
} RedfishEventService_V1_6_0_SSEFilterPropertiesSupported_CS;

//
// This action generates a test event.
//
typedef struct _RedfishEventService_V1_6_0_SubmitTestEvent_CS {
    RedfishCS_char    *target;    // Link to invoke action
    RedfishCS_char    *title;    // Friendly action name
} RedfishEventService_V1_6_0_SubmitTestEvent_CS;
...
//
typedef struct _RedfishEventService_V1_6_0_EventService_CS {
    RedfishCS_Header                                              Header;
    RedfishCS_char                                                *odata_context;                   
    RedfishCS_char                                                *odata_etag;                      
    RedfishCS_char                                                *odata_id;                        
    RedfishCS_char                                                *odata_type;                      
    RedfishEventService_V1_6_0_Actions_CS                         *Actions;                             // The available actions for this
                                                                                                        // resource.
    ...
    RedfishEventService_V1_6_0_SMTP_CS                            *SMTP;                                // Settings for SMTP event
                                                                                                        // delivery.
    RedfishEventService_V1_6_0_SSEFilterPropertiesSupported_CS    *SSEFilterPropertiesSupported;        // The set of properties that are
    ...
    RedfishCS_Link                                                Subscriptions;                        // The link to a collection of
                                                                                                        // event destinations.
} RedfishEventService_V1_6_0_EventService_CS;
...
RedfishCS_status
Json_EventService_V1_6_0_To_CS (char *JsonRawText, RedfishEventService_V1_6_0_EventService_CS **ReturnedCS);

RedfishCS_status
CS_To_EventService_V1_6_0_JSON (RedfishEventService_V1_6_0_EventService_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyEventService_V1_6_0_CS (RedfishEventService_V1_6_0_EventService_CS *CSPtr);

RedfishCS_status
DestroyEventService_V1_6_0_Json (RedfishCS_char *JsonText);
