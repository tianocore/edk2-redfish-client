...
#ifndef RedfishZone_V1_4_0_CSTRUCT_H_
#define RedfishZone_V1_4_0_CSTRUCT_H_
...
typedef struct _RedfishZone_V1_4_0_Actions_CS RedfishZone_V1_4_0_Actions_CS;
typedef struct _RedfishZone_V1_4_0_Links_CS RedfishZone_V1_4_0_Links_CS;
typedef struct _RedfishZone_V1_4_0_OemActions_CS RedfishZone_V1_4_0_OemActions_CS;
typedef struct _RedfishZone_V1_4_0_Zone_CS RedfishZone_V1_4_0_Zone_CS;
...
typedef struct _RedfishZone_V1_4_0_Actions_CS {
    RedfishZone_V1_4_0_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishZone_V1_4_0_Zone_CS {
    ...
    RedfishZone_V1_4_0_Actions_CS    *Actions;                 // The available actions for this
                                                               // Resource.
    ...
    RedfishZone_V1_4_0_Links_CS      *Links;                   // The links to Resources related
...
RedfishCS_status
Json_Zone_V1_4_0_To_CS (char *JsonRawText, RedfishZone_V1_4_0_Zone_CS **ReturnedCS);

RedfishCS_status
CS_To_Zone_V1_4_0_JSON (RedfishZone_V1_4_0_Zone_CS *CSPtr, char **JsonText);

RedfishCS_status
DestroyZone_V1_4_0_CS (RedfishZone_V1_4_0_Zone_CS *CSPtr);

RedfishCS_status
DestroyZone_V1_4_0_Json (RedfishCS_char *JsonText);
