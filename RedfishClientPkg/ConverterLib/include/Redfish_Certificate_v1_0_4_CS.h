...
#ifndef RedfishCertificate_V1_0_4_CSTRUCT_H_
#define RedfishCertificate_V1_0_4_CSTRUCT_H_

#include "RedfishCsCommon.h"

typedef struct _RedfishCertificate_V1_0_4_Actions_CS RedfishCertificate_V1_0_4_Actions_CS;
typedef struct _RedfishCertificate_V1_0_4_Certificate_CS RedfishCertificate_V1_0_4_Certificate_CS;
typedef struct _RedfishCertificate_V1_0_4_Identifier_CS RedfishCertificate_V1_0_4_Identifier_CS;
typedef struct _RedfishCertificate_V1_0_4_OemActions_CS RedfishCertificate_V1_0_4_OemActions_CS;
...
typedef struct _RedfishCertificate_V1_0_4_Actions_CS {
    RedfishCertificate_V1_0_4_OemActions_CS    *Oem;    // The available OEM-specific
...
typedef struct _RedfishCertificate_V1_0_4_Certificate_CS {
    ...
    RedfishCertificate_V1_0_4_Actions_CS       *Actions;             // The available actions for this
                                                                     // resource.
    ...
    RedfishCS_char                             *Id;              
    RedfishCertificate_V1_0_4_Identifier_CS    *Issuer;              // The issuer of the certificate.
    ...
    RedfishCertificate_V1_0_4_Identifier_CS    *Subject;             // The subject of the
                                                                     // certificate.
...
RedfishCS_status
Json_Certificate_V1_0_4_To_CS (char *JsonRawText, RedfishCertificate_V1_0_4_Certificate_CS **ReturnedCS);

RedfishCS_status
CS_To_Certificate_V1_0_4_JSON (RedfishCertificate_V1_0_4_Certificate_CS *CSPtr, char **JsonText);
