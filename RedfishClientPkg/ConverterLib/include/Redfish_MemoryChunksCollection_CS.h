...
#ifndef RedfishMemorychunkscollection_Noversioned_CSTRUCT_H_
#define RedfishMemorychunkscollection_Noversioned_CSTRUCT_H_
...
//
// The collection of MemoryChunks resource instances.
//
