...
#ifndef EFI_REDFISH_INTERP_SWITCHCOLLECTION_H__
#define EFI_REDFISH_INTERP_SWITCHCOLLECTION_H__

#include <Uefi.h>
#include <Protocol/RestJsonStructure.h>
#include "ConverterLib/edk2library/SwitchCollection/Redfish_SwitchCollection_CS.h"
//
