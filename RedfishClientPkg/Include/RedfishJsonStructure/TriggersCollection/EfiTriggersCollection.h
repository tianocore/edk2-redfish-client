...
#ifndef EFI_REDFISH_INTERP_TRIGGERSCOLLECTION_H__
#define EFI_REDFISH_INTERP_TRIGGERSCOLLECTION_H__

#include <Uefi.h>
#include <Protocol/RestJsonStructure.h>
#include "ConverterLib/edk2library/TriggersCollection/Redfish_TriggersCollection_CS.h"
//
