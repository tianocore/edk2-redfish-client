...
#ifndef EFI_REDFISH_INTERP_ZONECOLLECTION_H__
#define EFI_REDFISH_INTERP_ZONECOLLECTION_H__

#include <Uefi.h>
#include <Protocol/RestJsonStructure.h>
#include "ConverterLib/edk2library/ZoneCollection/Redfish_ZoneCollection_CS.h"
//
