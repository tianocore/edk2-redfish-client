...
#ifndef EFI_REDFISH_INTERP_LOGENTRYCOLLECTION_H__
#define EFI_REDFISH_INTERP_LOGENTRYCOLLECTION_H__

#include <Uefi.h>
#include <Protocol/RestJsonStructure.h>
#include "ConverterLib/edk2library/LogEntryCollection/Redfish_LogEntryCollection_CS.h"
//
