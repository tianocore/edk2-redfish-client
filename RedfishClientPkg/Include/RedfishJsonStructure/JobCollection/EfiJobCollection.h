...
#ifndef EFI_REDFISH_INTERP_JOBCOLLECTION_H__
#define EFI_REDFISH_INTERP_JOBCOLLECTION_H__

#include <Uefi.h>
#include <Protocol/RestJsonStructure.h>
#include "ConverterLib/edk2library/JobCollection/Redfish_JobCollection_CS.h"
//
