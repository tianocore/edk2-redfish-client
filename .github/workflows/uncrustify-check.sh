...
do
  if [ -e "$file" ]
  then
    # Skip all files under \ConverterLib, as the source files under
    # this folder are auto-generated by the script in native C language.
    if [[$(dirname "$file") == */"ConverterLib"/*]]
    then
